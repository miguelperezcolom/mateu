 ...
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */console.warn('WARNING: Since Vaadin 23.2, "@vaadin/vaadin-tabs" is deprecated. Use "@vaadin/tabs" instead.');var __defProp$y=Object.defineProperty,__getOwnPropDesc$y=Object.getOwnPropertyDescriptor,__decorateClass$y=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$y(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$y(C,T,K),K};let InputText=class extends s$2{constructor(){super(...arguments),this.name="",this.onChange=$=>{const C=$.target;console.log("input-text",C.value)},this.enabled=!0}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}render(){return y$1`
            <p>Label</p>
            <input type="text" 
        ...
        ></input>`}};__decorateClass$y([e()],InputText.prototype,"name",2);__decorateClass$y([e()],InputText.prototype,"onChange",2);__decorateClass$y([e()],InputText.prototype,"value",2);__decorateClass$y([e()],InputText.prototype,"enabled",2);InputText=__decorateClass$y([e$1("input-text")],InputText);var __defProp$x=Object.defineProperty,__getOwnPropDesc$x=Object.getOwnPropertyDescriptor,__decorateClass$x=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$x(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$x(C,T,K),K};let InputNumber=class extends s$2{constructor(){super(...arguments),this.name="",this.enabled=!0,this.onChange=$=>{const C=$.target;this.onValueChanged({value:C.value})},this.value=""}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}render(){return y$1`
            <p>Label</p>
            <input type="number" 
                           @change=${this.onChange} 
                           name="${this.name}" 
                           ...
                           value=${this.value}
                   disabled=${this.enabled}
        ></input>`}};__decorateClass$x([e()],InputNumber.prototype,"name",2);__decorateClass$x([e()],InputNumber.prototype,"enabled",2);__decorateClass$x([e()],InputNumber.prototype,"onChange",2);__decorateClass$x([e()],InputNumber.prototype,"value",2);InputNumber=__decorateClass$x([e$1("input-number")],InputNumber);var __defProp$w=Object.defineProperty,__getOwnPropDesc$w=Object.getOwnPropertyDescriptor,__decorateClass$w=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$w(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$w(C,T,K),K};let DynamicForm=class extends s$2{constructor(){super(...arguments),this.avalue="5",this.componentName="input-text",this.onChange=$=>{const C=$.target;console.log("dynamic-form",C.value)},this.onSelect=$=>{const C=$.target;this.changeInput(C.value)}}changeInput($){this.componentName=$;const C=document.createElement(this.componentName),T=this.shadowRoot.getElementById("cxx"),V=C;V.onValueChanged=K=>{console.log("new value",K.value)},V.setValue("1111"),T.appendChild(C)}render(){return y$1`<h1>Hello ${this.avalue}</h1>
  ...
  `;__decorateClass$w([e()],DynamicForm.prototype,"avalue",2);__decorateClass$w([e()],DynamicForm.prototype,"componentName",2);DynamicForm=__decorateClass$w([e$1("dynamic-form")],DynamicForm);const horizontalLayout=i$2`
  :host([theme~='margin']) {
    margin: var(--lumo-space-m);
  }
 ...
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */console.warn('WARNING: Since Vaadin 23.2, "@vaadin/vaadin-text-field" is deprecated. Use "@vaadin/text-field" instead.');var __defProp$v=Object.defineProperty,__getOwnPropDesc$v=Object.getOwnPropertyDescriptor,__decorateClass$v=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$v(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$v(C,T,K),K};let FieldText=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="",this.name="",this.onChange=$=>{const C=$.target;this.onValueChanged({value:C.value})},this.enabled=!0}setRequired($){this.required=$}setField($){this.field=$}setLabel($){this.label=$}setPlaceholder($){this.placeholder=$}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}render(){return y$1`
            <vaadin-text-field
                label="${this.label}"
                @change=${this.onChange} 
                           name="${this.name}" 
    ...
    `;__decorateClass$v([e()],FieldText.prototype,"required",2);__decorateClass$v([e()],FieldText.prototype,"label",2);__decorateClass$v([e()],FieldText.prototype,"placeholder",2);__decorateClass$v([e()],FieldText.prototype,"name",2);__decorateClass$v([e()],FieldText.prototype,"onChange",2);__decorateClass$v([e()],FieldText.prototype,"value",2);__decorateClass$v([e()],FieldText.prototype,"enabled",2);__decorateClass$v([e()],FieldText.prototype,"field",2);FieldText=__decorateClass$v([e$1("field-text")],FieldText);/**
 * @license
 * Copyright (c) 2021 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 ...
 */class IntegerField extends NumberField{static get is(){return"vaadin-integer-field"}constructor(){super(),this.allowedCharPattern="[-+\\d]"}_valueChanged(C,T){if(C!==""&&!this.__isInteger(C)){console.warn(`Trying to set non-integer value "${C}" to <vaadin-integer-field>. Clearing the value.`),this.value="";return}super._valueChanged(C,T)}_stepChanged(C,T){if(C!=null&&!this.__hasOnlyDigits(C)){console.warn(`<vaadin-integer-field> The \`step\` property must be a positive integer but \`${C}\` was provided, so the property was reset to \`null\`.`),this.step=null;return}super._stepChanged(C,T)}__isInteger(C){return/^(-\d)?\d*$/.test(String(C))}__hasOnlyDigits(C){return/^\d+$/.test(String(C))}}customElements.define(IntegerField.is,IntegerField);var __defProp$u=Object.defineProperty,__getOwnPropDesc$u=Object.getOwnPropertyDescriptor,__decorateClass$u=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$u(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$u(C,T,K),K};let FieldNumber=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="",this.name="",this.enabled=!0,this.onChange=$=>{const C=$.target;this.onValueChanged({value:C.value})},this.value=""}setRequired($){this.required=$}setField($){this.field=$}setLabel($){this.label=$}setPlaceholder($){this.placeholder=$}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}render(){return y$1`
    ...
    `;__decorateClass$u([e()],FieldNumber.prototype,"required",2);__decorateClass$u([e()],FieldNumber.prototype,"label",2);__decorateClass$u([e()],FieldNumber.prototype,"placeholder",2);__decorateClass$u([e()],FieldNumber.prototype,"name",2);__decorateClass$u([e()],FieldNumber.prototype,"enabled",2);__decorateClass$u([e()],FieldNumber.prototype,"field",2);__decorateClass$u([e()],FieldNumber.prototype,"onChange",2);__decorateClass$u([e()],FieldNumber.prototype,"value",2);FieldNumber=__decorateClass$u([e$1("field-number")],FieldNumber);var __defProp$t=Object.defineProperty,__getOwnPropDesc$t=Object.getOwnPropertyDescriptor,__decorateClass$t=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$t(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$t(C,T,K),K};let FieldDouble=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="",this.name="",this.enabled=!0,this.onChange=$=>{const C=$.target;this.onValueChanged({value:C.value})},this.value=""}setRequired($){this.required=$}setField($){this.field=$}setLabel($){this.label=$}setPlaceholder($){this.placeholder=$}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}render(){return y$1`
            <vaadin-number-field
                    label="${this.label}"
                    @change=${this.onChange} 
                           name="${this.name}" 
    ...
    `;__decorateClass$t([e()],FieldDouble.prototype,"required",2);__decorateClass$t([e()],FieldDouble.prototype,"label",2);__decorateClass$t([e()],FieldDouble.prototype,"placeholder",2);__decorateClass$t([e()],FieldDouble.prototype,"name",2);__decorateClass$t([e()],FieldDouble.prototype,"enabled",2);__decorateClass$t([e()],FieldDouble.prototype,"field",2);__decorateClass$t([e()],FieldDouble.prototype,"onChange",2);__decorateClass$t([e()],FieldDouble.prototype,"value",2);FieldDouble=__decorateClass$t([e$1("field-double")],FieldDouble);registerStyles("vaadin-radio-button",i$2`
    :host {
      color: var(--lumo-body-text-color);
      font-size: var(--lumo-font-size-m);
      font-family: var(--lumo-font-family);
 ...
 */class RadioGroup extends FieldMixin(FocusMixin(DisabledMixin(KeyboardMixin(ElementMixin(ThemableMixin(PolymerElement)))))){static get is(){return"vaadin-radio-group"}static get template(){return html`
    ...
    `}static get properties(){return{value:{type:String,notify:!0,value:"",observer:"__valueChanged"},readonly:{type:Boolean,value:!1,reflectToAttribute:!0,observer:"__readonlyChanged"},_fieldName:{type:String}}}constructor(){super(),this.__registerRadioButton=this.__registerRadioButton.bind(this),this.__unregisterRadioButton=this.__unregisterRadioButton.bind(this),this.__onRadioButtonCheckedChange=this.__onRadioButtonCheckedChange.bind(this)}ready(){super.ready(),this.ariaTarget=this,this.setAttribute("role","radiogroup"),this._fieldName=`${this.localName}-${generateUniqueId()}`,this._observer=new FlattenedNodesObserver(this,({addedNodes:C,removedNodes:T})=>{this.__filterRadioButtons(C).reverse().forEach(this.__registerRadioButton),this.__filterRadioButtons(T).forEach(this.__unregisterRadioButton)}),this._tooltipController=new TooltipController(this),this.addController(this._tooltipController)}__filterRadioButtons(C){return C.filter(T=>T instanceof RadioButton)}get __radioButtons(){return this.__filterRadioButtons([...this.children])}get __selectedRadioButton(){return this.__radioButtons.find(C=>C.checked)}get isHorizontalRTL(){return this.getAttribute("dir")==="rtl"&&this._theme!=="vertical"}_onKeyDown(C){super._onKeyDown(C);const T=C.composedPath().find(V=>V instanceof RadioButton);["ArrowLeft","ArrowUp"].includes(C.key)&&(C.preventDefault(),this.__selectNextRadioButton(T)),["ArrowRight","ArrowDown"].includes(C.key)&&(C.preventDefault(),this.__selectPrevRadioButton(T))}_invalidChanged(C){super._invalidChanged(C),C?this.setAttribute("aria-invalid","true"):this.removeAttribute("aria-invalid")}__selectNextRadioButton(C){const T=this.__radioButtons.indexOf(C);this.__selectIncRadioButton(T,this.isHorizontalRTL?1:-1)}__selectPrevRadioButton(C){const T=this.__radioButtons.indexOf(C);this.__selectIncRadioButton(T,this.isHorizontalRTL?-1:1)}__selectIncRadioButton(C,T){const V=(this.__radioButtons.length+C+T)%this.__radioButtons.length,K=this.__radioButtons[V];K.disabled?this.__selectIncRadioButton(V,T):(K.focusElement.focus(),K.focusElement.click())}__registerRadioButton(C){C.name=this._fieldName,C.addEventListener("checked-changed",this.__onRadioButtonCheckedChange),(this.disabled||this.readonly)&&(C.disabled=!0),C.checked&&this.__selectRadioButton(C)}__unregisterRadioButton(C){C.removeEventListener("checked-changed",this.__onRadioButtonCheckedChange),C.value===this.value&&this.__selectRadioButton(null)}__onRadioButtonCheckedChange(C){C.target.checked&&this.__selectRadioButton(C.target)}__valueChanged(C,T){if(!(T===void 0&&C==="")){if(C){const V=this.__radioButtons.find(K=>K.value===C);V?(this.__selectRadioButton(V),this.toggleAttribute("has-value",!0)):console.warn(`The radio button with the value "${C}" was not found.`)}else this.__selectRadioButton(null),this.removeAttribute("has-value");T!==void 0&&this.validate()}}__readonlyChanged(C,T){!C&&T===void 0||T!==C&&this.__updateRadioButtonsDisabledProperty()}_disabledChanged(C,T){super._disabledChanged(C,T),!(!C&&T===void 0)&&T!==C&&this.__updateRadioButtonsDisabledProperty()}_shouldRemoveFocus(C){return!this.contains(C.relatedTarget)}_setFocused(C){super._setFocused(C),C||this.validate()}__selectRadioButton(C){C?this.value=C.value:this.value="",this.__radioButtons.forEach(T=>{T.checked=T===C}),this.readonly&&this.__updateRadioButtonsDisabledProperty()}__updateRadioButtonsDisabledProperty(){this.__radioButtons.forEach(C=>{this.readonly?C.disabled=C!==this.__selectedRadioButton:C.disabled=this.disabled})}}customElements.define(RadioGroup.is,RadioGroup);var __defProp$s=Object.defineProperty,__getOwnPropDesc$s=Object.getOwnPropertyDescriptor,__decorateClass$s=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$s(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$s(C,T,K),K};let FieldRadiobuttons=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="",this.name="",this.onChange=$=>{const C=$.target;this.onValueChanged({value:C.value})},this.enabled=!0}setRequired($){this.required=$}setField($){this.field=$}setLabel($){this.label=$}setPlaceholder($){this.placeholder=$}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}render(){return y$1`
            ...
            `}};__decorateClass$s([e()],FieldRadiobuttons.prototype,"required",2);__decorateClass$s([e()],FieldRadiobuttons.prototype,"label",2);__decorateClass$s([e()],FieldRadiobuttons.prototype,"placeholder",2);__decorateClass$s([e()],FieldRadiobuttons.prototype,"name",2);__decorateClass$s([e()],FieldRadiobuttons.prototype,"onChange",2);__decorateClass$s([e()],FieldRadiobuttons.prototype,"value",2);__decorateClass$s([e()],FieldRadiobuttons.prototype,"enabled",2);__decorateClass$s([e()],FieldRadiobuttons.prototype,"field",2);FieldRadiobuttons=__decorateClass$s([e$1("field-radiobuttons")],FieldRadiobuttons);registerStyles("vaadin-checkbox",i$2`
    :host {
      color: var(--lumo-body-text-color);
      font-size: var(--lumo-font-size-m);
      font-family: var(--lumo-font-family);
 ...
 */class CheckboxGroup extends FieldMixin(FocusMixin(DisabledMixin(ElementMixin(ThemableMixin(PolymerElement))))){static get is(){return"vaadin-checkbox-group"}static get template(){return html`
    ...
    `}static get properties(){return{value:{type:Array,value:()=>[],notify:!0,observer:"__valueChanged"}}}constructor(){super(),this.__registerCheckbox=this.__registerCheckbox.bind(this),this.__unregisterCheckbox=this.__unregisterCheckbox.bind(this),this.__onCheckboxCheckedChanged=this.__onCheckboxCheckedChanged.bind(this)}ready(){super.ready(),this.ariaTarget=this,this.setAttribute("role","group"),this._observer=new FlattenedNodesObserver(this,({addedNodes:C,removedNodes:T})=>{const V=this.__filterCheckboxes(C),K=this.__filterCheckboxes(T);V.forEach(this.__registerCheckbox),K.forEach(this.__unregisterCheckbox),this.__warnOfCheckboxesWithoutValue(V)}),this._tooltipController=new TooltipController(this),this.addController(this._tooltipController)}checkValidity(){return!this.required||this.value.length>0}__filterCheckboxes(C){return C.filter(T=>T instanceof Checkbox)}get __checkboxes(){return this.__filterCheckboxes([...this.children])}__warnOfCheckboxesWithoutValue(C){C.some(V=>{const{value:K}=V;return!V.hasAttribute("value")&&(!K||K==="on")})&&console.warn("Please provide the value attribute to all the checkboxes inside the checkbox group.")}__registerCheckbox(C){C.addEventListener("checked-changed",this.__onCheckboxCheckedChanged),this.disabled&&(C.disabled=!0),C.checked?this.__addCheckboxToValue(C.value):this.value.includes(C.value)&&(C.checked=!0)}__unregisterCheckbox(C){C.removeEventListener("checked-changed",this.__onCheckboxCheckedChanged),C.checked&&this.__removeCheckboxFromValue(C.value)}_disabledChanged(C,T){super._disabledChanged(C,T),!(!C&&T===void 0)&&T!==C&&this.__checkboxes.forEach(V=>{V.disabled=C})}__addCheckboxToValue(C){this.value.includes(C)||(this.value=[...this.value,C])}__removeCheckboxFromValue(C){this.value.includes(C)&&(this.value=this.value.filter(T=>T!==C))}__onCheckboxCheckedChanged(C){const T=C.target;T.checked?this.__addCheckboxToValue(T.value):this.__removeCheckboxFromValue(T.value)}__valueChanged(C,T){C.length===0&&T===void 0||(this.toggleAttribute("has-value",C.length>0),this.__checkboxes.forEach(V=>{V.checked=C.includes(V.value)}),T!==void 0&&this.validate())}_shouldRemoveFocus(C){return!this.contains(C.relatedTarget)}_setFocused(C){super._setFocused(C),C||this.validate()}}customElements.define(CheckboxGroup.is,CheckboxGroup);var __defProp$r=Object.defineProperty,__getOwnPropDesc$r=Object.getOwnPropertyDescriptor,__decorateClass$r=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$r(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$r(C,T,K),K};let FieldBoolean=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="",this.name="",this.onChange=$=>{const C=$.target;this.onValueChanged({value:C.checked})},this.enabled=!0}setRequired($){this.required=$}setField($){this.field=$}setLabel($){this.label=$}setPlaceholder($){this.placeholder=$}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}render(){return y$1`
            ...
            `}};__decorateClass$r([e()],FieldBoolean.prototype,"required",2);__decorateClass$r([e()],FieldBoolean.prototype,"label",2);__decorateClass$r([e()],FieldBoolean.prototype,"placeholder",2);__decorateClass$r([e()],FieldBoolean.prototype,"name",2);__decorateClass$r([e()],FieldBoolean.prototype,"onChange",2);__decorateClass$r([e()],FieldBoolean.prototype,"value",2);__decorateClass$r([e()],FieldBoolean.prototype,"enabled",2);__decorateClass$r([e()],FieldBoolean.prototype,"field",2);FieldBoolean=__decorateClass$r([e$1("field-boolean")],FieldBoolean);registerStyles("vaadin-overlay",overlay,{moduleId:"lumo-vaadin-overlay"});/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
 ...
 */registerStyles("vaadin-date-picker",[inputFieldShared,datePickerStyles],{moduleId:"vaadin-date-picker-styles"});class DatePicker extends DatePickerMixin(InputControlMixin(ThemableMixin(ElementMixin(PolymerElement)))){static get is(){return"vaadin-date-picker"}static get template(){return html`
    ...
    `;__decorateClass$q([e()],FieldDate.prototype,"required",2);__decorateClass$q([e()],FieldDate.prototype,"label",2);__decorateClass$q([e()],FieldDate.prototype,"placeholder",2);__decorateClass$q([e()],FieldDate.prototype,"name",2);__decorateClass$q([e()],FieldDate.prototype,"onChange",2);__decorateClass$q([e()],FieldDate.prototype,"value",2);__decorateClass$q([e()],FieldDate.prototype,"enabled",2);__decorateClass$q([e()],FieldDate.prototype,"field",2);FieldDate=__decorateClass$q([e$1("field-date")],FieldDate);/**
 * @license
 * Copyright (c) 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const loader=i$2`
 ...
 */registerStyles("vaadin-date-time-picker",inputFieldShared,{moduleId:"vaadin-date-time-picker"});function getPropertyFromPrototype($,C){for(;$;){if($.properties&&$.properties[C])return $.properties[C];$=Object.getPrototypeOf($)}}const datePickerClass=customElements.get("vaadin-date-time-picker-date-picker"),timePickerClass=customElements.get("vaadin-date-time-picker-time-picker"),datePickerI18nDefaults=getPropertyFromPrototype(datePickerClass,"i18n").value(),timePickerI18nDefaults=getPropertyFromPrototype(timePickerClass,"i18n").value(),datePickerI18nProps=Object.keys(datePickerI18nDefaults),timePickerI18nProps=Object.keys(timePickerI18nDefaults);class DateTimePicker extends FieldMixin(SlotMixin(DisabledMixin(FocusMixin(ThemableMixin(ElementMixin(PolymerElement)))))){static get template(){return html`
    ...
    `;__decorateClass$p([e()],FieldDateTime.prototype,"required",2);__decorateClass$p([e()],FieldDateTime.prototype,"label",2);__decorateClass$p([e()],FieldDateTime.prototype,"placeholder",2);__decorateClass$p([e()],FieldDateTime.prototype,"name",2);__decorateClass$p([e()],FieldDateTime.prototype,"onChange",2);__decorateClass$p([e()],FieldDateTime.prototype,"value",2);__decorateClass$p([e()],FieldDateTime.prototype,"enabled",2);__decorateClass$p([e()],FieldDateTime.prototype,"field",2);FieldDateTime=__decorateClass$p([e$1("field-datetime")],FieldDateTime);var __defProp$o=Object.defineProperty,__getOwnPropDesc$o=Object.getOwnPropertyDescriptor,__decorateClass$o=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$o(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$o(C,T,K),K};let FieldTime=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="",this.name="",this.onChange=$=>{const C=$.target;this.onValueChanged({value:C.value})},this.enabled=!0}setRequired($){this.required=$}setField($){this.field=$}setLabel($){this.label=$}setPlaceholder($){this.placeholder=$}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}render(){return y$1`
            <vaadin-time-picker
                    label="${this.label}"
                    @change=${this.onChange} 
                           name="${this.name}" 
    ...
    `;__decorateClass$o([e()],FieldTime.prototype,"required",2);__decorateClass$o([e()],FieldTime.prototype,"label",2);__decorateClass$o([e()],FieldTime.prototype,"placeholder",2);__decorateClass$o([e()],FieldTime.prototype,"name",2);__decorateClass$o([e()],FieldTime.prototype,"onChange",2);__decorateClass$o([e()],FieldTime.prototype,"value",2);__decorateClass$o([e()],FieldTime.prototype,"enabled",2);__decorateClass$o([e()],FieldTime.prototype,"field",2);FieldTime=__decorateClass$o([e$1("field-time")],FieldTime);/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const textArea=i$2`
 ...
 */registerStyles("vaadin-text-area",inputFieldShared,{moduleId:"vaadin-text-area-styles"});class TextArea extends ResizeMixin(PatternMixin(InputFieldMixin(ThemableMixin(ElementMixin(PolymerElement))))){static get is(){return"vaadin-text-area"}static get template(){return html`
    ...
    `;__decorateClass$n([e()],FieldReadonly.prototype,"required",2);__decorateClass$n([e()],FieldReadonly.prototype,"label",2);__decorateClass$n([e()],FieldReadonly.prototype,"name",2);__decorateClass$n([e()],FieldReadonly.prototype,"onChange",2);__decorateClass$n([e()],FieldReadonly.prototype,"value",2);__decorateClass$n([e()],FieldReadonly.prototype,"enabled",2);__decorateClass$n([e()],FieldReadonly.prototype,"field",2);FieldReadonly=__decorateClass$n([e$1("field-readonly")],FieldReadonly);var __defProp$m=Object.defineProperty,__getOwnPropDesc$m=Object.getOwnPropertyDescriptor,__decorateClass$m=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$m(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$m(C,T,K),K};let FieldTextarea=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="",this.name="",this.onChange=$=>{const C=$.target;this.onValueChanged({value:C.value})},this.enabled=!0}setRequired($){this.required=$}setField($){this.field=$}setLabel($){this.label=$}setPlaceholder($){this.placeholder=$}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}render(){return y$1`
            <vaadin-text-area
                label="${this.label}"
                @change=${this.onChange} 
                           name="${this.name}" 
    ...
    `;__decorateClass$m([e()],FieldTextarea.prototype,"required",2);__decorateClass$m([e()],FieldTextarea.prototype,"label",2);__decorateClass$m([e()],FieldTextarea.prototype,"placeholder",2);__decorateClass$m([e()],FieldTextarea.prototype,"name",2);__decorateClass$m([e()],FieldTextarea.prototype,"onChange",2);__decorateClass$m([e()],FieldTextarea.prototype,"value",2);__decorateClass$m([e()],FieldTextarea.prototype,"enabled",2);__decorateClass$m([e()],FieldTextarea.prototype,"field",2);FieldTextarea=__decorateClass$m([e$1("field-textarea")],FieldTextarea);const comboBox=i$2`
  :host {
    outline: none;
  }
 ...
 */registerStyles("vaadin-combo-box",inputFieldShared,{moduleId:"vaadin-combo-box-styles"});class ComboBox extends ComboBoxDataProviderMixin(ComboBoxMixin(PatternMixin(InputControlMixin(ThemableMixin(ElementMixin(PolymerElement)))))){static get is(){return"vaadin-combo-box"}static get template(){return html`
    ...
    `;__decorateClass$k([e()],FieldExternalRef.prototype,"required",2);__decorateClass$k([e()],FieldExternalRef.prototype,"label",2);__decorateClass$k([e()],FieldExternalRef.prototype,"placeholder",2);__decorateClass$k([e()],FieldExternalRef.prototype,"name",2);__decorateClass$k([e()],FieldExternalRef.prototype,"onChange",2);__decorateClass$k([e()],FieldExternalRef.prototype,"value",2);__decorateClass$k([e()],FieldExternalRef.prototype,"enabled",2);__decorateClass$k([e()],FieldExternalRef.prototype,"field",2);__decorateClass$k([t$1()],FieldExternalRef.prototype,"dataProvider",2);FieldExternalRef=__decorateClass$k([e$1("field-externalref")],FieldExternalRef);/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
*/const template$3=html`
  ...
  `;template$3.setAttribute("strip-whitespace","");Polymer({_template:template$3,is:"paper-toggle-button",behaviors:[PaperCheckedElementBehavior],hostAttributes:{role:"button","aria-pressed":"false",tabindex:0},properties:{},listeners:{track:"_ontrack"},attached:function(){afterNextRender(this,function(){setTouchAction(this,"pan-y")})},_ontrack:function($){var C=$.detail;C.state==="start"?this._trackStart(C):C.state==="track"?this._trackMove(C):C.state==="end"&&this._trackEnd(C)},_trackStart:function($){this._width=this.$.toggleBar.offsetWidth/2,this._trackChecked=this.checked,this.$.toggleButton.classList.add("dragging")},_trackMove:function($){var C=$.dx;this._x=Math.min(this._width,Math.max(0,this._trackChecked?this._width+C:C)),this.translate3d(this._x+"px",0,0,this.$.toggleButton),this._userActivate(this._x>this._width/2)},_trackEnd:function($){this.$.toggleButton.classList.remove("dragging"),this.transform("",this.$.toggleButton)},_createRipple:function(){this._rippleContainer=this.$.toggleButton;var $=PaperRippleBehavior._createRipple();return $.id="ink",$.setAttribute("recenters",""),$.classList.add("circle","toggle-ink"),$}});var __defProp$j=Object.defineProperty,__getOwnPropDesc$j=Object.getOwnPropertyDescriptor,__decorateClass$j=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$j(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$j(C,T,K),K};let FieldToggle=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="",this.name="",this.onChange=$=>{const C=$.target;this.onValueChanged({value:C.checked})},this.enabled=!0}setRequired($){this.required=$}setField($){this.field=$}setLabel($){this.label=$}setPlaceholder($){this.placeholder=$}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}render(){return y$1`
            ...
            `}};__decorateClass$j([e()],FieldToggle.prototype,"required",2);__decorateClass$j([e()],FieldToggle.prototype,"label",2);__decorateClass$j([e()],FieldToggle.prototype,"placeholder",2);__decorateClass$j([e()],FieldToggle.prototype,"name",2);__decorateClass$j([e()],FieldToggle.prototype,"onChange",2);__decorateClass$j([e()],FieldToggle.prototype,"value",2);__decorateClass$j([e()],FieldToggle.prototype,"enabled",2);__decorateClass$j([e()],FieldToggle.prototype,"field",2);FieldToggle=__decorateClass$j([e$1("field-toggle")],FieldToggle);registerStyles("vaadin-progress-bar",i$2`
    :host {
 ...
 */console.warn('WARNING: Since Vaadin 23.2, "@vaadin/vaadin-upload" is deprecated. Use "@vaadin/upload" instead.');let nanoid=($=21)=>crypto.getRandomValues(new Uint8Array($)).reduce((C,T)=>(T&=63,T<36?C+=T.toString(36):T<62?C+=(T-26).toString(36).toUpperCase():T>62?C+="-":C+="_",C),"");var __defProp$i=Object.defineProperty,__getOwnPropDesc$i=Object.getOwnPropertyDescriptor,__decorateClass$i=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$i(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$i(C,T,K),K};let FieldFile=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="",this.name="",this.onChange=$=>{const C=$.target;$.detail.value==100&&(console.log("upload complete",$,C.files),this.onValueChanged({value:C.files.map(T=>({targetUrl:T.uploadTarget,id:this.fileid,name:T.name,type:T.type}))}))},this.enabled=!0}setRequired($){this.required=$}setField($){var C,T;this.field=$,this.fileidprefix=(C=$.attributes.find(V=>V.key=="fileidprefix"))==null?void 0:C.value,this.fileid=nanoid(),this.maxfiles=(T=$.attributes.find(V=>V.key=="maxfiles"))==null?void 0:T.value}setLabel($){this.label=$}setPlaceholder($){this.placeholder=$}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}render(){return y$1`
    ...
    `;__decorateClass$i([e()],FieldFile.prototype,"required",2);__decorateClass$i([e()],FieldFile.prototype,"label",2);__decorateClass$i([e()],FieldFile.prototype,"placeholder",2);__decorateClass$i([e()],FieldFile.prototype,"name",2);__decorateClass$i([e()],FieldFile.prototype,"onChange",2);__decorateClass$i([e()],FieldFile.prototype,"value",2);__decorateClass$i([e()],FieldFile.prototype,"enabled",2);__decorateClass$i([e()],FieldFile.prototype,"field",2);__decorateClass$i([e()],FieldFile.prototype,"maxfiles",2);__decorateClass$i([e()],FieldFile.prototype,"fileidprefix",2);__decorateClass$i([e()],FieldFile.prototype,"fileid",2);FieldFile=__decorateClass$i([e$1("field-file")],FieldFile);var __defProp$h=Object.defineProperty,__getOwnPropDesc$h=Object.getOwnPropertyDescriptor,__decorateClass$h=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$h(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$h(C,T,K),K};let FieldBooleanArray=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="type 0011110001",this.name="",this.onChange=$=>{const C=$.target;this.onValueChanged({value:this.toArray(C.value)})},this.enabled=!0}setRequired($){this.required=$}setField($){this.field=$}setLabel($){this.label=$}setPlaceholder($){$&&(this.placeholder=$)}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){const C=$;let T;if(C){T="";for(let V=0;V<C.length;V++)T+=C[V]?"1":"0"}this.value=T}toArray($){let C=[];if($)for(let T=0;T<$.length;T++)C[T]=$[T]=="1";return C}render(){return y$1`
            <vaadin-text-field
                label="${this.label}"
                @change=${this.onChange} 
                           name="${this.name}" 
    ...
    `;__decorateClass$h([e()],FieldBooleanArray.prototype,"required",2);__decorateClass$h([e()],FieldBooleanArray.prototype,"label",2);__decorateClass$h([e()],FieldBooleanArray.prototype,"placeholder",2);__decorateClass$h([e()],FieldBooleanArray.prototype,"name",2);__decorateClass$h([e()],FieldBooleanArray.prototype,"onChange",2);__decorateClass$h([e()],FieldBooleanArray.prototype,"value",2);__decorateClass$h([e()],FieldBooleanArray.prototype,"enabled",2);__decorateClass$h([e()],FieldBooleanArray.prototype,"field",2);FieldBooleanArray=__decorateClass$h([e$1("field-boolean-array")],FieldBooleanArray);var __defProp$g=Object.defineProperty,__getOwnPropDesc$g=Object.getOwnPropertyDescriptor,__decorateClass$g=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$g(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$g(C,T,K),K};let FieldIntArray=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="type 1,2,3,4",this.name="",this.onChange=$=>{const C=$.target;this.onValueChanged({value:this.toArray(C.value)})},this.enabled=!0}setRequired($){this.required=$}setField($){this.field=$}setLabel($){this.label=$}setPlaceholder($){$&&(this.placeholder=$)}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}toArray($){let C=[];if($){const T=$.split(",");for(let V=0;V<T.length;V++)C[V]=parseInt(T[V])}return C}render(){return y$1`
            <vaadin-text-field
                label="${this.label}"
                @change=${this.onChange} 
                           name="${this.name}" 
    ...
    `;__decorateClass$g([e()],FieldIntArray.prototype,"required",2);__decorateClass$g([e()],FieldIntArray.prototype,"label",2);__decorateClass$g([e()],FieldIntArray.prototype,"placeholder",2);__decorateClass$g([e()],FieldIntArray.prototype,"name",2);__decorateClass$g([e()],FieldIntArray.prototype,"onChange",2);__decorateClass$g([e()],FieldIntArray.prototype,"value",2);__decorateClass$g([e()],FieldIntArray.prototype,"enabled",2);__decorateClass$g([e()],FieldIntArray.prototype,"field",2);FieldIntArray=__decorateClass$g([e$1("field-int-array")],FieldIntArray);var __defProp$f=Object.defineProperty,__getOwnPropDesc$f=Object.getOwnPropertyDescriptor,__decorateClass$f=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$f(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$f(C,T,K),K};let FieldDoubleArray=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="type 1.3,2.1,3.32",this.name="",this.onChange=$=>{const C=$.target;this.onValueChanged({value:this.toArray(C.value)})},this.enabled=!0}setRequired($){this.required=$}setField($){this.field=$}setLabel($){this.label=$}setPlaceholder($){$&&(this.placeholder=$)}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}toArray($){let C=[];if($){const T=$.split(",");for(let V=0;V<T.length;V++)C[V]=parseFloat(T[V])}return C}render(){return y$1`
            <vaadin-text-field
                label="${this.label}"
                @change=${this.onChange} 
                           name="${this.name}" 
    ...
    `;__decorateClass$f([e()],FieldDoubleArray.prototype,"required",2);__decorateClass$f([e()],FieldDoubleArray.prototype,"label",2);__decorateClass$f([e()],FieldDoubleArray.prototype,"placeholder",2);__decorateClass$f([e()],FieldDoubleArray.prototype,"name",2);__decorateClass$f([e()],FieldDoubleArray.prototype,"onChange",2);__decorateClass$f([e()],FieldDoubleArray.prototype,"value",2);__decorateClass$f([e()],FieldDoubleArray.prototype,"enabled",2);__decorateClass$f([e()],FieldDoubleArray.prototype,"field",2);FieldDoubleArray=__decorateClass$f([e$1("field-double-array")],FieldDoubleArray);var __defProp$e=Object.defineProperty,__getOwnPropDesc$e=Object.getOwnPropertyDescriptor,__decorateClass$e=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$e(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$e(C,T,K),K};let FieldStringArray=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="type Mateu,Antònia,Miguel",this.name="",this.onChange=$=>{const C=$.target;this.onValueChanged({value:this.toArray(C.value)})},this.enabled=!0}setRequired($){this.required=$}setField($){this.field=$}setLabel($){this.label=$}setPlaceholder($){$&&(this.placeholder=$)}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}toArray($){let C=[];return $&&(C=$.split(",")),C}render(){return y$1`
            <vaadin-text-field
                label="${this.label}"
                @change=${this.onChange} 
                           name="${this.name}" 
    ...
    `;__decorateClass$e([e()],FieldStringArray.prototype,"required",2);__decorateClass$e([e()],FieldStringArray.prototype,"label",2);__decorateClass$e([e()],FieldStringArray.prototype,"placeholder",2);__decorateClass$e([e()],FieldStringArray.prototype,"name",2);__decorateClass$e([e()],FieldStringArray.prototype,"onChange",2);__decorateClass$e([e()],FieldStringArray.prototype,"value",2);__decorateClass$e([e()],FieldStringArray.prototype,"enabled",2);__decorateClass$e([e()],FieldStringArray.prototype,"field",2);FieldStringArray=__decorateClass$e([e$1("field-string-array")],FieldStringArray);var __defProp$d=Object.defineProperty,__getOwnPropDesc$d=Object.getOwnPropertyDescriptor,__decorateClass$d=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$d(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$d(C,T,K),K};let FieldEnumArray=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="",this.name="",this.onChange=$=>{this.onValueChanged({value:$.detail.value})},this.enabled=!0}setRequired($){this.required=$}setField($){this.field=$}setLabel($){this.label=$}setPlaceholder($){this.placeholder=$}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){this.value=$}render(){return y$1`
            <vaadin-checkbox-group label="${this.label}" theme="vertical"
            ...
            `}};__decorateClass$d([e()],FieldEnumArray.prototype,"required",2);__decorateClass$d([e()],FieldEnumArray.prototype,"label",2);__decorateClass$d([e()],FieldEnumArray.prototype,"placeholder",2);__decorateClass$d([e()],FieldEnumArray.prototype,"name",2);__decorateClass$d([e()],FieldEnumArray.prototype,"onChange",2);__decorateClass$d([e()],FieldEnumArray.prototype,"value",2);__decorateClass$d([e()],FieldEnumArray.prototype,"enabled",2);__decorateClass$d([e()],FieldEnumArray.prototype,"field",2);FieldEnumArray=__decorateClass$d([e$1("field-enum-array")],FieldEnumArray);/**
 * @license
 * Copyright (c) 2021 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const chip=i$2`
...
`;registerStyles("vaadin-multi-select-combo-box",[inputFieldShared,multiSelectComboBox],{moduleId:"vaadin-multi-select-combo-box-styles"});class MultiSelectComboBox extends ResizeMixin(InputControlMixin(ThemableMixin(ElementMixin(PolymerElement)))){static get is(){return"vaadin-multi-select-combo-box"}static get template(){return html`
    ...
    `;__decorateClass$c([e()],FieldExternalrefArray.prototype,"required",2);__decorateClass$c([e()],FieldExternalrefArray.prototype,"label",2);__decorateClass$c([e()],FieldExternalrefArray.prototype,"placeholder",2);__decorateClass$c([e()],FieldExternalrefArray.prototype,"name",2);__decorateClass$c([e()],FieldExternalrefArray.prototype,"onChange",2);__decorateClass$c([e()],FieldExternalrefArray.prototype,"value",2);__decorateClass$c([e()],FieldExternalrefArray.prototype,"items",2);__decorateClass$c([e()],FieldExternalrefArray.prototype,"enabled",2);__decorateClass$c([e()],FieldExternalrefArray.prototype,"field",2);__decorateClass$c([t$1()],FieldExternalrefArray.prototype,"dataProvider",2);FieldExternalrefArray=__decorateClass$c([e$1("field-externalref-array")],FieldExternalrefArray);var __defProp$b=Object.defineProperty,__getOwnPropDesc$b=Object.getOwnPropertyDescriptor,__decorateClass$b=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$b(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$b(C,T,K),K};let FieldClosedList=class extends s$2{constructor(){super(...arguments),this.required=!1,this.label="",this.placeholder="",this.name="",this.onChange=$=>{console.log("onchange",$.detail.value),this.onValueChanged({value:$.detail.value})},this.enabled=!0}setRequired($){this.required=$}setField($){this.field=$}setLabel($){this.label=$}setPlaceholder($){this.placeholder=$}setEnabled($){this.enabled=$}onValueChanged($){console.log($)}setValue($){console.log("setvalue",$);const C=$;this.value=C.map(T=>""+T)}render(){return y$1`
            <vaadin-checkbox-group label="${this.label}" theme="vertical"
                                @value-changed=${this.onChange} 
                                   .value=${this.value}
                           name="${this.name}" 
            ...
            `}};__decorateClass$b([e()],FieldClosedList.prototype,"required",2);__decorateClass$b([e()],FieldClosedList.prototype,"label",2);__decorateClass$b([e()],FieldClosedList.prototype,"placeholder",2);__decorateClass$b([e()],FieldClosedList.prototype,"name",2);__decorateClass$b([e()],FieldClosedList.prototype,"onChange",2);__decorateClass$b([e()],FieldClosedList.prototype,"value",2);__decorateClass$b([e()],FieldClosedList.prototype,"enabled",2);__decorateClass$b([e()],FieldClosedList.prototype,"field",2);FieldClosedList=__decorateClass$b([e$1("field-closedlist")],FieldClosedList);var __defProp$a=Object.defineProperty,__getOwnPropDesc$a=Object.getOwnPropertyDescriptor,__decorateClass$a=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$a(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$a(C,T,K),K};let MateuField=class extends s$2{firstUpdated(){const $=document.createElement(mapInputTypeToFieldType(this.field.type,this.field.stereotype)),C=this.shadowRoot.getElementById("container"),T=$;T.onValueChanged=K=>{let Y=new CustomEvent("change",{detail:{key:this.field.id,value:K.value}});this.dispatchEvent(Y)},T.setLabel(this.field.caption),T.setPlaceholder(this.field.placeholder),T.setField(this.field),T.setValue(this.value),T.setRequired(this.field.validations.length>0),C.appendChild($);const V=this.shadowRoot.getElementById("wrapper");this.fieldWrapper.container=V}render(){return y$1`
      <div id="wrapper">
...
*/
  `;__decorateClass$a([e()],MateuField.prototype,"field",2);__decorateClass$a([e()],MateuField.prototype,"value",2);__decorateClass$a([e()],MateuField.prototype,"visible",2);__decorateClass$a([e()],MateuField.prototype,"enabled",2);__decorateClass$a([e()],MateuField.prototype,"fieldWrapper",2);MateuField=__decorateClass$a([e$1("mateu-field")],MateuField);var __defProp$9=Object.defineProperty,__getOwnPropDesc$9=Object.getOwnPropertyDescriptor,__decorateClass$9=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$9(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$9(C,T,K),K};let MateuFieldGroup=class extends s$2{connectedCallback(){super.connectedCallback()}onValueChange($){this.formElement.valueChanged($.detail.key,$.detail.value)}render(){return y$1`
      <div>
  ...
  /*
    ...
    */
  `;__decorateClass$9([e()],MateuFieldGroup.prototype,"fieldGroup",2);__decorateClass$9([e()],MateuFieldGroup.prototype,"formElement",2);MateuFieldGroup=__decorateClass$9([e$1("mateu-fieldgroup")],MateuFieldGroup);var __defProp$8=Object.defineProperty,__getOwnPropDesc$8=Object.getOwnPropertyDescriptor,__decorateClass$8=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$8(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$8(C,T,K),K};let MateuSection=class extends s$2{render(){return y$1`
  ...
  `;__decorateClass$8([e()],MateuSection.prototype,"section",2);__decorateClass$8([e()],MateuSection.prototype,"formElement",2);MateuSection=__decorateClass$8([e$1("mateu-section")],MateuSection);registerStyles("vaadin-notification-card",i$2`
    :host {
      position: relative;
...
<g id="lumo:user"><path d="M500 500c-69 0-125-56-125-125s56-125 125-125 125 56 125 125-56 125-125 125z m-292 292c0-115 131-208 292-209s292 93 292 209H208z"></path></g>
      ...
      <div>
        ...
        <vaadin-horizontal-layout style="justify-content: end;" theme="spacing">
          ...
          ${this.metadata.mainActions.map($=>y$1`
            <vaadin-button theme="primary" @click=${this.runAction} actionId=${$.id}>${$.caption}</vaadin-button>
          `)}
        </vaadin-horizontal-layout>
  ...
  `;__decorateClass$7([e()],MateuForm.prototype,"metadata",2);__decorateClass$7([e()],MateuForm.prototype,"data",2);__decorateClass$7([e()],MateuForm.prototype,"journeyId",2);__decorateClass$7([e()],MateuForm.prototype,"stepId",2);__decorateClass$7([e()],MateuForm.prototype,"rules",2);__decorateClass$7([e()],MateuForm.prototype,"notificationOpened",2);__decorateClass$7([e()],MateuForm.prototype,"notificationMessage",2);__decorateClass$7([e()],MateuForm.prototype,"fieldsMap",2);__decorateClass$7([e()],MateuForm.prototype,"setLoading",2);MateuForm=__decorateClass$7([e$1("mateu-form")],MateuForm);registerStyles("vaadin-grid",i$2`
    :host {
      font-family: var(--lumo-font-family);
      font-size: var(--lumo-font-size-m);
      line-height: var(--lumo-line-height-s);
 ...
 */class AbstractGridColumnRendererDirective extends LitRendererDirective{get rendererProperty(){throw new Error("The `rendererProperty` getter must be implemented.")}addRenderer(){this.element[this.rendererProperty]=(C,T)=>{this.renderRenderer(C,T)}}runRenderer(){const C=this.element._grid;C[CONTENT_UPDATE_DEBOUNCER]=Debouncer$1.debounce(C[CONTENT_UPDATE_DEBOUNCER],microTask,()=>{C.requestContentUpdate()})}removeRenderer(){this.element[this.rendererProperty]=null}}class GridColumnBodyRendererDirective extends AbstractGridColumnRendererDirective{get rendererProperty(){return"renderer"}addRenderer(){this.element[this.rendererProperty]=(C,T,V)=>{this.renderRenderer(C,V.item,V,T)}}}const columnBodyRenderer=e$2(GridColumnBodyRendererDirective);var __defProp$6=Object.defineProperty,__getOwnPropDesc$6=Object.getOwnPropertyDescriptor,__decorateClass$6=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$6(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$6(C,T,K),K};let MateuCrud=class extends connect(store)(s$2){constructor(){super(...arguments),this.dataProvider=async($,C)=>{const{page:T,pageSize:V,sortOrders:K}=$,{rows:Y,count:J}=await this.fetchData({page:T,pageSize:V,sortOrders:K,filters:btoa(JSON.stringify(this.data))});C(Y,J)}}search(){this.shadowRoot.getElementById("grid").clearCache()}async fetchData($){const C=await this.fetchRows($),T=await this.fetchCount($.filters);return{rows:C,count:T}}async fetchRows($){return(await api.get("/journeys/"+this.journeyId+"/steps/"+this.stepId+"/lists/main/rows?page="+$.page+"&page_size="+$.pageSize+"&ordering=&filters="+$.filters)).data}async fetchCount($){return(await api.get("/journeys/"+this.journeyId+"/steps/"+this.stepId+"/lists/main/count?filters="+$)).data}connectedCallback(){super.connectedCallback()}stateChanged($){console.log("state changed in crud",$)}filterChanged($){const C=$.target,T={};T[C.id]=C.value,this.data={...this.data,...T}}edit($){const C=$.currentTarget;console.log(C.row);const T={_selectedRow:C.row};this.data={...this.data,...T},store.dispatch(runStepAction(this.journeyId,this.stepId,"edit",this.data))}runAction($){var Y;const C=$.currentTarget,V={_selectedRows:((Y=this.shadowRoot)==null?void 0:Y.getElementById("grid")).selectedItems},K={...this.data,...V};store.dispatch(runStepAction(this.journeyId,this.stepId,C.getAttribute("actionid"),K))}render(){var $,C;return y$1`
      ...
      <vaadin-horizontal-layout class="header">
        ...
        <vaadin-horizontal-layout style="justify-content: end; flex-grow: 1; align-items: center;" theme="spacing">
          ${this.metadata.actions.map(T=>y$1`
            <vaadin-button theme="secondary" @click=${this.runAction} actionId=${T.id}>${T.caption}</vaadin-button>
          `)}
        </vaadin-horizontal-layout>
      </vaadin-horizontal-layout>
      <vaadin-horizontal-layout style="align-items: baseline;" theme="spacing">
        
        ${($=this.metadata)==null?void 0:$.searchForm.fields.map(T=>y$1`
          <vaadin-text-field id="${T.id}" label="${T.caption}" @change=${this.filterChanged}></vaadin-text-field>
        `)}
      ...
      ${(C=this.metadata)==null?void 0:C.columns.map(T=>y$1`
        <vaadin-grid-column path="${T.id}" header="${T.caption}"></vaadin-grid-column>
      `)}
        ...
        <vaadin-grid-column
            ...
            auto-width
            flex-grow="0"
            ${columnBodyRenderer(T=>y$1`<vaadin-button theme="tertiary-inline" .row="${T}" @click="${this.edit}">Edit</vaadin-button>`,[])}
  ...
  `;__decorateClass$6([e()],MateuCrud.prototype,"journeyId",2);__decorateClass$6([e()],MateuCrud.prototype,"stepId",2);__decorateClass$6([e()],MateuCrud.prototype,"metadata",2);__decorateClass$6([e()],MateuCrud.prototype,"data",2);__decorateClass$6([t$1()],MateuCrud.prototype,"dataProvider",2);MateuCrud=__decorateClass$6([e$1("mateu-crud")],MateuCrud);var __defProp$5=Object.defineProperty,__getOwnPropDesc$5=Object.getOwnPropertyDescriptor,__decorateClass$5=($,C,T,V)=>{for(var K=V>1?void 0:V?__getOwnPropDesc$5(C,T):C,Y=$.length-1,J;Y>=0;Y--)(J=$[Y])&&(K=(V?J(C,T,K):J(K))||K);return V&&K&&__defProp$5(C,T,K),K};let MateuComponent=class extends s$2{connectedCallback(){super.connectedCallback()}render(){var $,C;return y$1`
