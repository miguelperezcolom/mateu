...
- **Multi-frontend** — the same backend renders on [three web design systems](/design-systems/) (Vaadin, SAP UI5, Oracle Redwood) and on [native desktop and mobile](/native/) (the IntelliJ plugin on the desktop, React Native on iOS/Android), without touching your code.
