...
- **Multi-frontend** — the same backend renders on [five web design systems](/design-systems/) (Vaadin, SAP UI5, Oracle Redwood, PatternFly, SLDS) and on [native desktop and mobile](/native/) (JavaFX, Compose Multiplatform, React Native), without touching your code.
