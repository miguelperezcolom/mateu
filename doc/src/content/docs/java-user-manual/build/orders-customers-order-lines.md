...
> Depending on your application structure, you may rely on the default detail generated by `AutoCrud`, or provide an explicit route when you need custom composition.
