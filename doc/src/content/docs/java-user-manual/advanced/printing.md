...
When the user triggers a print, the browser applies any `@media print` rules on top of the existing styles. The design system (Vaadin, Redwood, …) may already include sensible print defaults — hiding sidebars, removing decorative shadows, linearising layouts.
