...
Use `Container` to give a page a centred, readable column layout. For edge-to-edge content (full browser width), use [FullWidth](/java-ui-definition/components/full-width/) instead.
