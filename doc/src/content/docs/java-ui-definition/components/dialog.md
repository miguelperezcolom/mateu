...
For simple yes/no confirmations use [ConfirmDialog](/java-ui-definition/components/confirm-dialog/) instead, which wires the confirm/cancel buttons automatically.
