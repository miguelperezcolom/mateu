...
Use `Popover` when you need a click-triggered overlay with rich content (images, lists, formatted text). Use [Tooltip](/java-ui-definition/components/tooltip/) for simple hover hints.
