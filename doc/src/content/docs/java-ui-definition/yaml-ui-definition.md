...
All component types from the [`io.mateu.uidl.data`](/java-ui-definition/supported-components/) package are supported.
...
See [`@UISpec`](/java-ui-definition/annotations/uispec/) for the full reference.
