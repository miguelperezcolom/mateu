...
export default defineConfig({
    ...
    server: {
        ...
        proxy: {
            '/fluent/mateu': 'http://localhost:8591',
            '/declarative/mateu': 'http://localhost:8591',
            '/counter/mateu': 'http://localhost:8591',
            '/anothercounter/mateu': 'http://localhost:8591',
            '/mateu': 'http://localhost:8591',
            '/images': 'http://localhost:8591',
            '/assets': 'http://localhost:8591',
            '/myassets': 'http://localhost:8591',
            '/sse': 'http://localhost:8591',
            '/upload': 'http://localhost:8591',
            '/master-data': 'http://localhost:8591',
            '/call-center': 'http://localhost:8591',
            '/_product': 'http://localhost:8591',
            '/_crm': 'http://localhost:8591',
            '/_financial': 'http://localhost:8591',
            '/control-plane': 'http://localhost:8591',
            '/workflow': 'http://localhost:8591',
            '/_users': 'http://localhost:8591',
            '/_shell': 'http://localhost:8591',
            '/_content': 'http://localhost:8591',
            '/_booking': 'http://localhost:8591',
            '/_cp-data': 'http://localhost:8591',
            '/_control-plane': 'http://localhost:8591',
            '/_workflow': 'http://localhost:8591',
            '/_forms': 'http://localhost:8591',
        '/home2/mateu': 'http://localhost:8591',
            '/nested-crud/mateu': 'http://localhost:8591',
            '/users/mateu': 'http://localhost:8591',
            '/chat/mateu': 'http://localhost:8591',
            '/ai': 'http://localhost:8591',
        },
    },
    optimizeDeps: {
