...
export default defineConfig({
    ...
    server: {
        ...
        proxy: {
            '/fluent/mateu': 'http://localhost:8191',
            '/declarative/mateu': 'http://localhost:8191',
            '/counter/mateu': 'http://localhost:8191',
            '/anothercounter/mateu': 'http://localhost:8191',
            '/mateu': 'http://localhost:8191',
            '/images': 'http://localhost:8191',
            '/assets': 'http://localhost:8191',
            '/myassets': 'http://localhost:8191',
            '/sse': 'http://localhost:8191',
            '/upload': 'http://localhost:8191',
            '/master-data': 'http://localhost:8191',
            '/call-center': 'http://localhost:8191',
            '/_product': 'http://localhost:8191',
            '/_crm': 'http://localhost:8191',
            '/_financial': 'http://localhost:8191',
            '/control-plane': 'http://localhost:8191',
            '/workflow': 'http://localhost:8191',
            '/_users': 'http://localhost:8191',
            '/_shell': 'http://localhost:8191',
            '/_content': 'http://localhost:8191',
            '/_booking': 'http://localhost:8191',
            '/_cp-data': 'http://localhost:8191',
            '/_control-plane': 'http://localhost:8191',
            '/_workflow': 'http://localhost:8191',
            '/_forms': 'http://localhost:8191',
        '/home2/mateu': 'http://localhost:8191',
            '/nested-crud/mateu': 'http://localhost:8191',
            '/users/mateu': 'http://localhost:8191',
            '/chat/mateu': 'http://localhost:8191',
            '/ai': 'http://localhost:8191',
        },
    },
    optimizeDeps: {
