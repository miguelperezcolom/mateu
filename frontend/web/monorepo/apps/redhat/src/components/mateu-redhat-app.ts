...
export class MateuRedhatApp extends MetadataDrivenElement {
    ...
    renderSubmenu = (menu: MenuOption) => html`
    ...
    render() {
        ...
        if (AppVariant.HAMBURGUER_MENU == metadata.variant) {
            return html`
            <rh-navigation-primary role="navigation" style="width: 100vw;">
                ${metadata.menu.map(menu => html`
                    <rh-navigation-primary-item variant="dropdown">
                        <span slot="summary">${menu.label}</span>
                        <h2>${menu.label}</h2>
                        <div class="grid">
                            ${menu.submenus && menu.submenus.length > 0?menu.submenus
                                    .map(sub => this.renderSubmenu(sub)):html`
                                <div class="column">
                                    <ul>
                                        <li>
...
`
    ...
    static styles = css`
        ...
        .grid {
            ...
            fon-size: var(--rh-font-size-body-text-md, 1rem);
            ...
            #profile {
                margin-inline-start: var(--rh-space-4xl);
                display: grid;
...
declare global {
    interface HTMLElementTagNameMap {
        'mateu-redhat-app': MateuRedhatApp
    }
}
