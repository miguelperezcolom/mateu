...
/**
 * Jewel port of the shared `FormRenderer`. Lays fields out in a `formColumns`-wide grid, honouring
 * per-field `colspan`, with a header (title/subtitle/actions) and bottom buttons.
 */
@Composable
