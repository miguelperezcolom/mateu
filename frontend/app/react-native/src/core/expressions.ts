 ...
 * hand-rolled recursive-descent parser over the pragmatic subset rule expressions use:
 * literals, identifier paths (`state.total`, `state['a b']`, `data.rows.length`), unary `!`/`-`,
