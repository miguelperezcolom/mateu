...
public record Dispo(
    ...
    public Dispo(
            ...
            List<HotelFound> results) {
        this(destinationCode, LocalDate.now().plusDays(7), 7, LocalDate.now().plusDays(14), 0, 0, children1, ages1, rooms2, adults2, children2, ages2, rooms3, adults3, children3, ages3, bookingDate, includeOnRequest, ignoreClosedSales, results);
    }
}