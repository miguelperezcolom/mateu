...
exports.InputTimeMaskWebElementBase = void 0;
const elements_1 = require("@oracle/oraclejet-webdriver/elements");
/**
 * This is the base class for oj-c-input-time-mask WebElement, and is generated from the
 * component's metadata. Do not modify these contents since they'll be replaced
 * during the next generation.
 * Put overrides into the WebElements's subclass, InputTimeMaskWebElement.ts.
 */
class InputTimeMaskWebElementBase extends elements_1.OjWebElement {
    /**
    ...
    /**
     * Gets the value of <code>granularity</code> property.
     * Specifies the smallest time unit that is displayed by the component.
     * @return The value of <code>granularity</code> property.
     *
     */
    getGranularity() {
        return this.getProperty('granularity');
    }
    /**
     * Gets the value of <code>leadingZeroForHour</code> property.
     * Specifies whether to show or hide a leading zero in the hour field or determine it from the locale.
     * @return The value of <code>leadingZeroForHour</code> property.
     *
     */
    getLeadingZeroForHour() {
        return this.getProperty('leadingZeroForHour');
    }
    /**
    ...
    /**
     * Gets the value of <code>hourClock</code> property.
     * Specifies whether to display the time as a 12-hour clock or 24-hour clock or if the hour clock is determined from the locale.
     * @return The value of <code>hourClock</code> property.
     *
     */
    getHourClock() {
        return this.getProperty('hourClock');
    }
    /**
    ...
    /**
     * Gets the value of <code>timeRangeOverflowMessageDetail</code> property.
     * Overrides the default validator's rangeOverflow message detail.
     * @return The value of <code>timeRangeOverflowMessageDetail</code> property.
     *
     */
    getTimeRangeOverflowMessageDetail() {
        return this.getProperty('timeRangeOverflowMessageDetail');
    }
    /**
     * Gets the value of <code>timeRangeUnderflowMessageDetail</code> property.
     * Overrides the default validator's rangeUnderflow message detail.
     * @return The value of <code>timeRangeUnderflowMessageDetail</code> property.
     *
     */
    getTimeRangeUnderflowMessageDetail() {
        return this.getProperty('timeRangeUnderflowMessageDetail');
    }
    /**
...
exports.InputTimeMaskWebElementBase = InputTimeMaskWebElementBase;
//# sourceMappingURL=InputTimeMaskWebElementBase.js.map