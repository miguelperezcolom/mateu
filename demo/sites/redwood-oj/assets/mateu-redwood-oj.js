...
import{d as o,A as d,a as C,j as h,r as $,i as S,k,m as ge,D as xr,c as T,w as X,p as Uo,q as at,s as Bo}from"./vendor-lit.js";import{v as Vo,b as kt,e as Wo,f as Ho,n as wr,p as kr,N as ra,i as Kt,j as Vi,k as Cr,l as ls,m as _s,o as Go}from"./vendor-vaadin.js";import{S as Ko,n as ye,a as Yo,b as Jo}from"./vendor.js";import{_ as Te,N as yi}from"./vendor-ui5.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=a(i);fetch(i.href,r)}})();var v=(e=>(e.Page="Page",e.Div="Div",e.Element="Element",e.MicroFrontend="MicroFrontend",e.Form="Form",e.Crud="Crud",e.Result="Result",e.Card="Card",e.Directory="Directory",e.Stepper="Stepper",e.HorizontalLayout="HorizontalLayout",e.VerticalLayout="VerticalLayout",e.SplitLayout="SplitLayout",e.MasterDetailLayout="MasterDetailLayout",e.TabLayout="TabLayout",e.AccordionLayout="AccordionLayout",e.FormLayout="FormLayout",e.FormRow="FormRow",e.FormItem="FormItem",e.BoardLayout="BoardLayout",e.BoardLayoutRow="BoardLayoutRow",e.BoardLayoutItem="BoardLayoutItem",e.Scroller="Scroller",e.FullWidth="FullWidth",e.Container="Container",e.FormField="FormField",e.Table="Table",e.App="App",e.Text="Text",e.Avatar="Avatar",e.Chat="Chat",e.AvatarGroup="AvatarGroup",e.Badge="Badge",e.Breadcrumbs="Breadcrumbs",e.Anchor="Anchor",e.Button="Button",e.Chart="Chart",e.Icon="Icon",e.ConfirmDialog="ConfirmDialog",e.ContextMenu="ContextMenu",e.CookieConsent="CookieConsent",e.Details="Details",e.Dialog="Dialog",e.Drawer="Drawer",e.Image="Image",e.Map="Map",e.Markdown="Markdown",e.Notification="Notification",e.ProgressBar="ProgressBar",e.Popover="Popover",e.CarouselLayout="CarouselLayout",e.Tooltip="Tooltip",e.MessageInput="MessageInput",e.MessageList="MessageList",e.CustomField="CustomField",e.MenuBar="MenuBar",e.Grid="Grid",e.GridColumn="GridColumn",e.GridGroupColumn="GridGroupColumn",e.VirtualList="VirtualList",e.FormSection="FormSection",e.FormSubSection="FormSubSection",e.Bpmn="Bpmn",e.Workflow="Workflow",e.WorkflowElk="WorkflowElk",e.FormEditor="FormEditor",e.MetricCard="MetricCard",e.Scoreboard="Scoreboard",e.DashboardPanel="DashboardPanel",e.DashboardLayout="DashboardLayout",e.FoldoutLayout="FoldoutLayout",e.HeroSection="HeroSection",e.EmptyState="EmptyState",e.Skeleton="Skeleton",e.Gantt="Gantt",e.PlanningBoard="PlanningBoard",e.Kanban="Kanban",e.Timeline="Timeline",e.ProgressSteps="ProgressSteps",e.Stat="Stat",e.Calendar="Calendar",e.PricingTable="PricingTable",e.OrgChart="OrgChart",e.Heatmap="Heatmap",e.Funnel="Funnel",e.TrendChart="TrendChart",e.FeatureGrid="FeatureGrid",e.Testimonials="Testimonials",e.Faq="Faq",e.CalloutCard="CalloutCard",e.CommentThread="CommentThread",e.FileList="FileList",e.Checklist="Checklist",e.ComparisonCard="ComparisonCard",e.EntityHeader="EntityHeader",e.Meter="Meter",e.TaskProgress="TaskProgress",e.StatusList="StatusList",e.BulletedList="BulletedList",e.Separator="Separator",e.Notice="Notice",e.TaskQueue="TaskQueue",e.ResourceGrid="ResourceGrid",e.OfferCard="OfferCard",e.AddOnPicker="AddOnPicker",e.Ledger="Ledger",e.PaymentPicker="PaymentPicker",e.ProcessMonitor="ProcessMonitor",e))(v||{}),oe=(e=>(e.ServerSide="ServerSide",e.ClientSide="ClientSide",e))(oe||{});class Xo{constructor(){this.afterRenderHook=void 0,this.useShadowRoot=!0,this.componentRenderer=void 0}set(t){if(this.componentRenderer=t,typeof window<"u"){const a=t.supportedClientSideTypes?.();window.__mateuRendererInfo={name:t.rendererName?.()??t.constructor?.name??"unknown",supportedTypes:a?[...a].sort():null}}}get(){return this.componentRenderer}setUseShadowRoot(t){this.useShadowRoot=t}mustUseShadowRoot(){return this.useShadowRoot}setAfterRenderHook(t){this.afterRenderHook=t}getAfterRenderHook(){return this.afterRenderHook}}const te=new Xo,ia=(e,t,a,s,i,r,n,l,c)=>(t.slot=l,w(e,t,a,s,i,r,n,c)),w=(e,t,a,s,i,r,n,l)=>{if(!t)return o``;if(t.type==oe.ClientSide)return te.get().renderClientSideComponent(e,t,a,s,i,r,n,l);const c=e.route,u=e.consumedRoute;return o`
        <mateu-component id="${t.id}"
                        ...
                        route="${c}"
                         ...
                         .appData="${n}"
        >
       </mateu-component>`},Qo=640,Zo=e=>e>0&&e<Qo?"accordion":"tabs";var en=Object.defineProperty,tn=Object.getOwnPropertyDescriptor,Wi=(e,t,a,s)=>{for(var i=s>1?void 0:s?tn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&en(t,a,i),i};let _a=class extends S{constructor(){super(...arguments),this.tabLabels=[],this.mode="tabs",this.selected=0,this.selectedChangedListener=e=>{const t=e.detail?.value;typeof t=="number"&&t>=0&&(this.selected=t)}}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{for(const t of e)this.mode=Zo(t.contentRect.width)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.resizeObserver=void 0,this.detachTabsListener()}detachTabsListener(){this.slottedTabs?.removeEventListener("selected-changed",this.selectedChangedListener),this.slottedTabs=void 0}tabsSlotChanged(e){this.detachTabsListener();const a=e.target.assignedElements().find(s=>"selected"in s);a&&(this.slottedTabs=a,a.addEventListener("selected-changed",this.selectedChangedListener),a.selected=this.selected)}select(e){this.selected=e,this.slottedTabs&&(this.slottedTabs.selected=e)}updated(){this.slottedTabs&&this.slottedTabs.selected!=this.selected&&(this.slottedTabs.selected=this.selected)}render(){return o`
    ...
    `;Wi([h({type:Array})],_a.prototype,"tabLabels",2);Wi([$()],_a.prototype,"mode",2);Wi([$()],_a.prototype,"selected",2);_a=Wi([k("mateu-adaptive-tabs")],_a);const an=(e,t,a,s,i,r,n)=>{const l=t.metadata;let c=t.style;return c==null&&(c=""),l.columnSpacing&&(c+="--vaadin-form-layout-column-spacing: "+l.columnSpacing+";"),l.itemRowSpacing&&(c+="--vaadin-form-layout-row-spacing: "+l.itemRowSpacing+";"),l.itemLabelSpacing&&(c+="--vaadin-form-layout-label-spacing: "+l.itemLabelSpacing+";"),l.labelsAside&&(c+="--vaadin-form-item-label-width: 10rem;"),l.fullWidth&&(c+="width: 100%;"),o`
               <vaadin-form-layout 
                       ...
                       slot="${t.slot||d}"
               >
                   ${t.children?.map(u=>Sr(l,e,u,a,s,i,r,n))}
               </vaadin-form-layout>
            `},Sr=(e,t,a,s,i,r,n,l)=>a.type==oe.ClientSide&&a.metadata?.type==v.FormRow?rn(e,t,a,s,i,r,n,l):e.labelsAside?sn(t,a,s,i,r,n,l):w(t,a,s,i,r,n,l),sn=(e,t,a,s,i,r,n)=>{if(t.type==oe.ClientSide&&t.metadata?.type==v.FormField&&t.metadata.label){const l=t.metadata,c=l.label?.includes("${")?e._evalTemplate(l.label):l.label;return o`
                       <vaadin-form-item data-colspan="${l.colspan}">
                           <label slot="label">${c}</label>
                           ${w(e,t,a,s,i,r,n,!0)}
                       </vaadin-form-item>
                   `}return w(e,t,a,s,i,r,n)},rn=(e,t,a,s,i,r,n,l)=>o`
        <vaadin-form-row>
            ${a.children?.map(c=>Sr(e,t,c,s,i,r,n,l))}
        </vaadin-form-row>
            `,on=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=(l.padding?" padding":"")+(l.spacing?" spacing":"")+(l.spacingVariant?" spacing-"+l.spacingVariant:"")+(l.wrap?" wrap":"");let u=t.style;return l.fullWidth&&(u=u?"width: 100%;"+u:"width: 100%;"),l.justification&&(u=u?"justify-content: "+l.justification+";"+u:"justify-content: "+l.justification+";"),l.verticalAlignment&&(u=u?"align-items: "+l.verticalAlignment+";"+u:"align-items: "+l.verticalAlignment+";"),o`
    ...
    `},ln=(e,t,a,s,i,r,n)=>{const l=t.metadata;let c=t.style;return l.fullWidth&&(c=c?"width: 100%;"+c:"width: 100%;"),o`
               <vaadin-split-layout 
                       style="${c}" 
                       class="${t.cssClasses}"
            ...
            `},dn=(e,t,a,s,i,r,n)=>{const l=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,u=!!i?.hasDetail||!!l,m=c??l;return o`
            ...
            `},cn=(e,t,a,s,i,r,n)=>{const l=t.metadata;let c=t.style;c==null&&(c=""),l.fullWidth&&(c+="width: 100%;");let u=l.variant;u=="equalWidth"&&(u="equal-width-tabs");const m=Math.max(0,(t.children??[]).findIndex(f=>f.metadata.active)),p=f=>{f.target.selected=m};if(l.adaptable){const f=(t.children??[]).map(g=>{const y=g.metadata.label;return y?.includes("${")?e._evalTemplate(y):y});return o`
            <mateu-adaptive-tabs
                    .tabLabels="${f}"
                    style="${c}"
                    class="${t.cssClasses}"
        ...
        >
            ...
            ${t.children?.map(f=>un(e,f,a,s,i,r,n))}
        </vaadin-tabsheet>
            `},un=(e,t,a,s,i,r,n)=>{const l=t.metadata.label,c=l?.includes("${")?e._evalTemplate(l):l;return o`
        <div tab="${c}" style="padding: var(--lumo-space-m) 0;">
                   ${t.children?.map(u=>w(e,u,a,s,i,r,n))}
               </div>
            `},pn=(e,t,a,s,i,r,n)=>{const l=t.metadata;t.style,l.fullWidth;let c=0;if(t.children){for(let u=0;u<t.children.length;u++)if(t.children[u].metadata?.active){c=u;break}}return o`
               <vaadin-accordion
                       style="${t.style}"
                       class="${t.cssClasses}"
                       opened="${c}"
                       slot="${t.slot??d}"
               >
                   ${t.children?.map(u=>hn(e,u,a,s,i,r,n,l.variant))}
               </vaadin-accordion>
            `},hn=(e,t,a,s,i,r,n,l)=>{const c=t.metadata,u=c.label?.includes("${")?e._evalTemplate(c.label):c.label;return o`
        ...
        <vaadin-board-row style="${t.style}" class="${t.cssClasses}">
            ...
            `,$n=(e,t,a,s,i,r,n)=>{const l=t.metadata;return o`
        <div style="${t.style}" 
             class="${t.cssClasses}"
        ...
        >
            ...
            `},Ea=(e,t)=>new Function(...Object.keys(t),"return `"+e+"`")(...Object.values(t)),za=(e,t,a)=>({state:e??{},data:t??{},...a});function Oe(e,t,a,s){if(!e?.includes("${"))return e;try{return Ea(e,za(t,a,s))}catch(i){return console.warn(`Mateu: could not interpolate "${e}":`,i),e}}const wt=(e,t,a)=>{if(e&&e.indexOf("${")>=0)try{return Ea(e,za(t,a))}catch(s){return s.message}return e},Hi=(e,t,a,s,i)=>{if(!e)return e;const r=za(t,a,{appState:s??{},appData:i??{}});let n=e;try{if(n=Ea(e,r),n.includes("${"))try{n=Ea(n,r)}catch(l){n="when evaluating nested "+e+" :"+l+", where data is "+a+" and state is "+t+" and app state is "+s+" and app data is "+i,console.error(l,n,t,a,s,i)}}catch(l){n="when evaluating "+e+" :"+l+", where data is "+a+" and state is "+t+" and app state is "+s+" and app data is "+i,console.error(l,n,t,a,s,i)}return n},Ir=(e,t,a,s,i,r)=>{const n=za(t,a,{appState:s??{},appData:i??{},...r}),l=Ea(e,n);return new Function(...Object.keys(n),`return (${l})`)(...Object.values(n))},_r=(e,t,a,s)=>{const i=za(t,a,s);return new Function(...Object.keys(i),`return (${e})`)(...Object.values(i))},yn=(e,t,a,s)=>Ea(e,za(t,a,s)),xn=(e,t,a)=>{const s=e.metadata;return o`<vaadin-avatar
            img="${s.image}"
            name="${de(s.name,t,a)}"
            abbr="${s.abbreviation}"
            style="${e.style}" class="${e.cssClasses}"
            slot="${e.slot??d}"
    ></vaadin-avatar>`},de=(e,t,a)=>typeof e=="string"&&e.includes("${")?Oe(e,t,a):e,wn=e=>{const t=e.metadata;return o`<vaadin-avatar-group max-items-visible="${t.maxItemsVisible}"
                                     .items="${t.avatars}"
                                     style="${e.style}" class="${e.cssClasses}"
                                     slot="${e.slot??d}">
    </vaadin-avatar-group>`},kn=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=u=>o`
            ${w(e,u,a,s,i,r,n)}
`;return o`
        <vaadin-virtual-list
                ...
                slot="${t.slot??d}"
        ></vaadin-virtual-list>
    `};var Cn=Object.defineProperty,Sn=Object.getOwnPropertyDescriptor,Es=(e,t,a,s)=>{for(var i=s>1?void 0:s?Sn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Cn(t,a,i),i};let Xa=class extends S{constructor(){super(...arguments),this.variant="text",this.count=3}render(){const e=Array.from({length:Math.max(1,this.count)});return this.variant=="card"?o`${e.map(()=>o`<div class="bone card" style="margin: .5em 0;"></div>`)}`:this.variant=="grid"?o`${e.map(()=>o`<div class="bone row"></div>`)}`:this.variant=="form"?o`${e.map(()=>o`
                <div class="form-pair">
                    <div class="bone label"></div>
                    <div class="bone field"></div>
                </div>
            `)}`:o`${e.map(()=>o`<div class="bone line"></div>`)}`}};Xa.styles=C`
        :host {
            display: block;
            flex: 1 1 0;
            min-width: 6rem;
    ...
    `;Es([h()],Xa.prototype,"variant",2);Es([h({type:Number})],Xa.prototype,"count",2);Xa=Es([k("mateu-skeleton")],Xa);const In=(e,t)=>{t&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},sa=(e,t,a,s,i,r)=>o`
        <div class="mateu-empty-state"
            ...
            ${i&&r?o`
                <vaadin-button theme="tertiary" style="margin-top: .25rem;" @click="${n=>In(n,i)}">${r}</vaadin-button>
            `:d}
        </div>
    `,_n=e=>{const t=e.metadata;return o`
        <div style="${e.style??d}" class="${e.cssClasses??d}" slot="${e.slot??d}">
            ${sa(void 0,t.icon,t.title,t.description,t.actionId,t.actionLabel)}
        </div>
    `},En=e=>{const t=e.metadata;return o`
        <mateu-skeleton
                ...
                slot="${e.slot??d}"
        ></mateu-skeleton>
    `},Ja=e=>!!e&&typeof e=="object"&&"__mateuGroup"in e,ds=e=>String(e??""),Er=(e,t,a)=>{const s=e??[];if(!t||!a||a.length===0)return s;const i=[];let r,n=!1;return s.forEach((l,c)=>{const u=ds(l?.[t]);if(!n||u!==r){const m=a.find(p=>ds(p.value)===u)??{value:u,count:s.filter(p=>ds(p?.[t])===u).length,aggregates:{}};i.push({__mateuGroup:m,__mateuGroupBy:t,_rowNumber:`__mateuGroup:${c}:${u}`}),n=!0,r=u}i.push(l)}),i},Pr=(e,t)=>e==null?"":t.dataType==="money"||t.stereotype==="money"?new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(e):t.aggregate==="count"?new Intl.NumberFormat(void 0,{maximumFractionDigits:0}).format(Math.round(e)):new Intl.NumberFormat(void 0,{maximumFractionDigits:2}).format(e),Tr=(e,t)=>e&&t.includes(e)?e:t.find(a=>!!a),Or=(e,t,a)=>{const s=e.__mateuGroup;return t.id===a?`${s.value} (${s.count})`:t.aggregate?Pr(s.aggregates?.[t.id],t):""},Rr=(e,t,a)=>{const s=t?.aggregates;if(!s||!e.some(n=>n.aggregate))return;const i={};e.forEach(n=>{n.aggregate&&s[n.id]!=null&&(i[n.id]=Pr(s[n.id],n))});const r=e[0];if(r&&i[r.id]===void 0){const n=t?.page?.totalElements;i[r.id]=a&&r.id===a&&n!=null?`Total (${n})`:"Total"}return i};var Ya=(e=>(e.NONE="NONE",e.INFO="INFO",e.SUCCESS="SUCCESS",e.WARNING="WARNING",e.DANGER="DANGER",e))(Ya||{});const Pn=(e,t,a)=>{const s=e[a.path];return s?o`<span theme="badge pill ${Gi(s.type)}">${s.message}</span>`:o``},Gi=e=>{switch(e){case Ya.SUCCESS:return"success";case Ya.WARNING:return"warning";case Ya.DANGER:return"error";case Ya.NONE:return"contrast"}return""},Tn=(e,t,a)=>{const i=e[a.path]?"vaadin:check":"vaadin:minus";return o`<vaadin-icon 
                    icon="${i}"
                    style="height: 16px; width: 16px; color: ${"var(--lumo-body-text-color)"};"
            ></vaadin-icon>`},On=(e,t,a,s,i)=>{const r=e[a.path];let n=r;return s=="money"&&r&&r.locale&&r.currency?n=new Intl.NumberFormat(r.locale,{style:"currency",currency:r.currency}).format(r.value):i=="money"&&(n=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(r)),o`${n}`},Ys=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},Rn=(e,t,a,s,i,r)=>{const n=a.xcolumn??r;if(n.text){if(n.actionId)return o`<a href="javascript: void(0);" @click="${u=>Ys(a,n,e)}">${n.text}</a>`;const c=e[a.path];return o`<a href="${c}">${n.text}</a>`}if(s=="string"){if(n.actionId){const u=e[a.path];return o`<a href="javascript: void(0);" @click="${m=>Ys(a,n,e)}">${u}</a>`}const c=e[a.path];return o`<a href="${c}">${c}</a>`}const l=e[a.path];return o`<a href="${l.href}">${l.text}</a>`},An=(e,t,a,s,i)=>s=="string"?e[a.path].split(",").map(l=>o`<vaadin-icon icon="${l}" style="width: 16px;"></vaadin-icon>`):e[a.path].split(",").map(n=>o`<vaadin-icon icon="${n.icon}" style="width: 16px;"></vaadin-icon>`),zn=(e,t,a,s,i)=>{const r=e[a.path];return o`${ge(r)}`},jn=(e,t,a,s,i,r)=>{if(s=="string"){const l=e[a.path],c="max-height: 40px; "+(r.style??"");return o`<img src="${l}" style="${c}">`}const n=e[a.path];return o`<img src="${n.src}" style="${r.style??""}">`},Ln=e=>{const t={_clickedRow:e.target.row};e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-"+e.detail.value.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},Js=e=>{const t={_clickedRow:e.target.row},a=e.target.action;e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-"+a.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},Dn=e=>{const t=document.createElement("vaadin-context-menu-item"),a=document.createElement("vaadin-icon");return a.style.color="var(--lumo-secondary-text-color)",a.style.marginInlineEnd="var(--lumo-space-s)",a.style.padding="var(--lumo-space-xs)",a.setAttribute("icon",e.icon),t.appendChild(a),e.label&&t.appendChild(document.createTextNode(e.label)),t.disabled=e.disabled,t},Xs=(e,t,a)=>{const s=e[a.path]?.actions?.map(i=>i.icon?{component:Dn(i),methodNameInCrud:i.methodNameInCrud}:{...i,text:i.label});return!s||s.length==0?o``:o`
                                     <vaadin-menu-bar
                                         ...
                                         @item-selected="${Ln}"
                                     ></vaadin-menu-bar>
                                   `},Fn=(e,t,a)=>{if(a.path=="select"){const r={actionId:a.path,icon:"",label:"Select",disabled:!1,methodNameInCrud:"select"};return o`
         <vaadin-button theme="tertiary" title="Select" @click="${Js}" .row="${e}" .action="${r}">
             Select
         </vaadin-button>
    `}const s=a.path&&e[a.path]?.methodNameInCrud?e[a.path]:e.action;if(!s)return o``;const i=s.icon&&!s.label;return o`
         <vaadin-button theme="tertiary${i?" icon":""}" title="${s.label||d}" @click="${Js}" .row="${e}" .action="${s}">
             ${s.icon?o`<vaadin-icon icon="${s.icon}"></vaadin-icon>`:d}
             ${s.label?s.label:d}
         </vaadin-button>
    `},Nn=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},Mn=(e,t,a,s,i,r)=>{const n=a.xcolumn??r;if(n.actionId){const c=n.text||e[a.path];return o`
            <vaadin-button theme="tertiary" @click="${u=>Nn(a,n,e)}" .row="${e}">
                ${c}
            </vaadin-button>
        `}const l=e[a.path];return o`<a href="${l}">${n.text||l}</a>`},qn=(e,t,a,s,i,r,n,l,c)=>{const u=e[a.path];return w(s,u,i,r,n,l,c)},$s=new WeakMap,Un=(e,t)=>$s.get(e)?.[t],Bn=(e,t,a)=>{let s=$s.get(e);s||(s={},$s.set(e,s)),s[t]=a},Qs=e=>{if(e==null||e==="")return null;const t=Number(e);return Number.isNaN(t)?null:t},Vn=(e,t,a,s)=>{const i=a?.field?.fieldId,r=c=>{if(e[t.id]===c||e[t.id]==null&&(c===""||c==null))return;if(e[t.id]=c,!i){a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"update-row",parameters:{_editedRow:{...e}}},bubbles:!0,composed:!0}));return}const m=(a?.state??s)[i];a.dispatchEvent(new CustomEvent("value-changed",{detail:{fieldId:i,value:Array.isArray(m)?[...m]:m},bubbles:!0,composed:!0}))},n=e[t.id],l=n==null?"":String(n);switch(t.editorType){case"boolean":return o`<vaadin-checkbox ?checked=${!!n} @checked-changed=${c=>r(c.detail.value)}></vaadin-checkbox>`;case"integer":return o`<vaadin-integer-field theme="small" style="width:100%;" .value=${l} @change=${c=>r(Qs(c.target.value))}></vaadin-integer-field>`;case"number":return o`<vaadin-number-field theme="small" style="width:100%;" .value=${l} @change=${c=>r(Qs(c.target.value))}></vaadin-number-field>`;case"date":return o`<vaadin-date-picker theme="small" style="width:100%;" .value=${l} @value-changed=${c=>r(c.detail.value)}></vaadin-date-picker>`;case"time":return o`<vaadin-time-picker theme="small" style="width:100%;" .value=${l} @value-changed=${c=>r(c.detail.value)}></vaadin-time-picker>`;case"datetime":return o`<vaadin-date-time-picker theme="small" style="width:100%;" .value=${l} @value-changed=${c=>r(c.detail.value)}></vaadin-date-time-picker>`;case"select":return o`<vaadin-combo-box
                ...
                .value=${l}
                @value-changed=${c=>r(c.detail.value)}></vaadin-combo-box>`;case"lookup":{const c=a?.field?.fieldId,u=`search-${c}-${t.id}`,m=`${c}-${t.id}`,f=(t.editorOptions??[]).find(y=>String(y.value)===l)??(l?{value:l,label:Un(e,t.id)??l}:void 0);return o`<vaadin-combo-box
                theme="small" style="width:100%;"
                item-label-path="label" item-id-path="value"
                .dataProvider=${(y,x)=>{a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:u,parameters:{searchText:y.filter,size:y.pageSize,page:y.page},callback:P=>{const U=P?.fragments?.[0]?.data?.[m];x(U?.content??[],U?.totalElements??0)},callbackonly:!0},bubbles:!0,composed:!0}))}}
                .selectedItem=${f}
                @selected-item-changed=${y=>{const x=y.detail.value,P=x?x.value:null;String(P??"")!==l&&(x&&Bn(e,t.id,x.label),r(P))}}></vaadin-combo-box>`}default:return o`<vaadin-text-field theme="small" style="width:100%;" .value=${l} @change=${c=>r(c.target.value)}></vaadin-text-field>`}},cs=e=>Wo(()=>o`<span title="${e}" style="white-space:normal;overflow-wrap:break-word;">${e}</span>`,[e]),us=e=>e!==void 0?Ho(()=>o`<span style="font-weight: 600; white-space: nowrap;">${e}</span>`,[e]):d,Wn=e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget?.dispatchEvent(new CustomEvent("sort-direction-changed",{detail:{grid:e.currentTarget.parentElement},bubbles:!0,composed:!0}))},Hn=(e,t,a,s,i,r,n,l)=>{const c=Oe(e.label,s,i);return o`
<vaadin-grid-column-group header="${c}">
    ${e.columns.map(u=>Ar(u.metadata,t,a,s,i,r,n,l?.[u.metadata?.id]))}
</vaadin-grid-column-group>
`},Ps=(e,t,a,s,i,r,n,l)=>v.GridGroupColumn==e.metadata?.type?Hn(e.metadata,t,a,s,i,r,n,l):Ar(e.metadata,t,a,s,i,r,n,l?.[e.metadata?.id]),Ar=(e,t,a,s,i,r,n,l)=>{const c=Oe(e.label,s,i);return e.sortable?o`
                    ...
                    `:o`
                        <vaadin-grid-column
                                ...
                                ${kt((u,m,p)=>ki(u,m,p,e,t,a,s,i,r,n),[])}
                        ></vaadin-grid-column>
                    `},ki=(e,t,a,s,i,r,n,l,c,u)=>{const m=a.dataset.dataType??"",p=a.dataset.stereotype??"";if(Ja(e)){const g=i?.metadata,y=(g?.columns??[]).flatMap(N=>N?.metadata?.type===v.GridGroupColumn?(N.metadata.columns??[]).map(ne=>ne?.metadata?.id):[N?.metadata?.id]),x=Tr(e.__mateuGroupBy,y),P=Or(e,s,x),U=e.__mateuGroup.hiddenActions??[],ae=s.id===y[y.length-1]?(g?.groupActions??[]).filter(N=>!U.includes(N.actionId??N.id)):[];return ae.length?o`<span style="display: flex; align-items: center; justify-content: flex-end; gap: var(--lumo-space-s); overflow: hidden;">
                ...
                `)}
            </span>`:o`<span title="${P}" style="font-weight: 600; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; display: block;">${P}</span>`}if(s.editable)return Vn(e,s,i,n);if(m=="status")return Pn(e,t,a);if(m=="bool")return Tn(e,t,a);if(m=="money"||p=="money")return On(e,t,a,m,p);if(m=="link"||p=="link")return Rn(e,t,a,m,p,s);if(m=="icon"||p=="icon")return An(e,t,a,m);if(p=="html")return zn(e,t,a);if(p=="image")return jn(e,t,a,m,p,s);if(m=="menu")return Xs(e,t,a);if(m=="component")return qn(e,t,a,i,r,n,l,c,u);if(m=="action")return Fn(e,t,a);if(m=="actionGroup")return Xs(e,t,a);if(p=="button"||s.actionId)return Mn(e,t,a,m,p,s);const f=e[a.path];return o`<span title="${f}" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; display: block;">${f}</span>`},Gn=(e,t,a,s,i,r,n)=>{const l=t.metadata;if(l.tree){const u=async(m,p)=>{const f=m.parentItem?m.parentItem.children:l.page.content;p(f,f.length)};return o`
        <vaadin-grid style="${t.style}" class="${t.cssClasses}"
                     .itemHasChildrenPath="${"children"}" .dataProvider="${u}"
                     slot="${t.slot??d}"
                     all-rows-visible
        >
            ${l.content.map((m,p)=>{const f=m.metadata;return p>0?o`
            <vaadin-grid-column path="${m.id}"
                                ...
                                width="${f?.width??d}"
                                .column="${m.metadata}"
                                ${kt((g,y,x)=>ki(g,y,x,f,e,a,s,i,r,n),[])}></vaadin-grid-column>
`:o`
...
`})}
    ...
    `}let c=l.page?.content;return t.id&&s&&s[t.id]&&(c=s[t.id]),c||(c=[]),o`
        <vaadin-grid 
                ...
                all-rows-visible
        >
            ${l?.content?.map(u=>Ps(u,e,a,s,i,r,n))}
        </vaadin-grid>
    `},Kn=e=>{const a=(e.metadata.items??[]).map(s=>({text:s.text,time:s.time,userName:s.userName,userImg:s.userImg,userAbbr:s.userAbbr,userColorIndex:s.userColorIndex}));return o`
        <vaadin-message-list
                markdown
                style="${e.style}" class="${e.cssClasses}"
                slot="${e.slot??d}"
                .items="${a}"
        ></vaadin-message-list>
    `},Ft=new Ko,le={value:{}},Qa={value:{}},Yn=(e,t,a,s,i,r,n)=>{const l=t.metadata;return o`
        <vaadin-context-menu .items=${Ts(e,l.menu,a,s,i,r,n)} 
                             style="${t.style}" 
                             class="${t.cssClasses}"
            ...
            `},Jn=(e,t,a,s,i)=>{const r=t.metadata;return o`
        <vaadin-menu-bar .items=${Ts(e,r.options,a,s,i,le,Qa)}
                         style="${t.style}" class="${t.cssClasses}"
                         slot="${t.slot??d}">
        </vaadin-menu-bar>
            `},Zs=(e,t,a,s,i,r,n)=>{const l=document.createElement("vaadin-context-menu-item");return xr(w(e,t,a,s,i,r,n),l),l},Ts=(e,t,a,s,i,r,n)=>t.map(l=>l.submenus?{text:l.component?void 0:l.label,route:l.path,checked:l.selected,disabled:l.disabled,className:l.className,component:l.component?Zs(e,l.component,a,s,i,r,n):void 0,children:Ts(e,l.submenus,a,s,i,r,n)}:l.separator?{component:"hr"}:{text:l.component?void 0:l.label,route:l.path,checked:l.selected,disabled:l.disabled,className:l.className,component:l.component?Zs(e,l.component,a,s,i,r,n):void 0}),Xn=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=l.content?.metadata,u=c?.type==v.Notice&&c.fullWidth===!0;return o`
        ...
        >
            ...
            `},Qn=e=>{const t=e.metadata,a=s=>{const i=s.detail?.value??"";!t.actionId||!i.trim()||s.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:{message:i}},bubbles:!0,composed:!0}))};return o`
        <vaadin-message-input
                style="${e.style}" class="${e.cssClasses}"
                slot="${e.slot??d}"
                @submit="${a}"
        ></vaadin-message-input>
    `},Zn=(e,t,a,s,i,r,n)=>{const l=t.metadata;return o`
    ...
    `},el=e=>{if(e instanceof CustomEvent)return e.detail;const t={};for(const a in e){const s=e[a];["number","string","boolean"].indexOf(typeof s)>=0&&(t[a]=e[a])}return t},er=(e,t,a)=>{for(let s in t.attributes)e.setAttribute(s,t.attributes[s]);a.style&&e.setAttribute("style",a.style),a.cssClasses&&e.setAttribute("class",a.cssClasses),a.slot&&e.setAttribute("slot",a.slot),t.content&&(t.html?e.innerHTML=t.content:e.append(t.content))},tl=e=>{const t=e.name;t.startsWith("vaadin-chart")&&!customElements.get(t)&&Te(()=>import("./vendor-highcharts.js"),__vite__mapDeps([0,1,2,3,4]));const a=e.attributes?e.attributes.import:void 0;a&&t.includes("-")&&!customElements.get(t)&&import(a)},al=(e,t,a)=>{tl(t);let s=t.name;return t.attributes&&t.attributes.id&&(s="#"+t.attributes.id),setTimeout(()=>{const i=e.shadowRoot?.querySelector(".element-container")?.querySelector(s);if(i){for(;i.firstChild;)i.removeChild(i.lastChild);er(i,t,a)}else{const r=document.createElement(t.name);er(r,t,a);for(let n in t.on)r.addEventListener(n,l=>{const c=el(l);e.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.on[n],parameters:{event:c}},bubbles:!0,composed:!0}))});e.shadowRoot?.querySelector(".element-container")?.appendChild(r)}}),o`<div class="element-container"></div>`};var ot=(e=>(e.div="div",e.p="p",e.h1="h1",e.h2="h2",e.h3="h3",e.h4="h4",e.h5="h5",e.h6="h6",e.span="span",e))(ot||{});const il=(e,t,a,s,i)=>{const r=e.metadata,n=r.attributes?.["data-colspan"],l=Hi(r.text,t,a,s,i),c={xl:"var(--lumo-font-size-xl, 1.375rem)",l:"var(--lumo-font-size-l, 1.125rem)",s:"var(--lumo-font-size-s, .875rem)",xs:"var(--lumo-font-size-xs, .8125rem)"},u=(r.size&&c[r.size]?`font-size: ${c[r.size]}; `:"")+(r.noMargins?"margin-block-start: 0; margin-block-end: 0; ":"");return ot.h1==r.container?o`
        ...
        `:ot.p==r.container?o`
            ...
            `},sl=(e,t,a)=>{const s=e.metadata;return o`<span theme="badge ${s.color} ${s.pill?"pill":""} ${s.small?"small":""} ${s.primary?"primary":""}"
                      style="${e.style}" class="${e.cssClasses}"
                      slot="${e.slot??d}">${de(s.text,t,a)}</span>`},rl=(e,t,a)=>{const s=de(e.text,t,a);if(!s)return d;let i=de(e.color,t,a);return i=="SUCCESS"&&(i="success"),i=="ERROR"&&(i="error"),i=="DANGER"&&(i="error"),i=="WARNING"&&(i="warning"),i=="INFO"&&(i="info"),i=="PRIMARY"&&(i="primary"),i=="SECONDARY"&&(i="secondary"),i=="TERTIARY"&&(i="tertiary"),i=="QUATERNARY"&&(i="quaternary"),i=="LIGHT"&&(i="light"),i=="DARK"&&(i="dark"),o`<span theme="badge ${i} ${e.pill?"pill":""} ${e.small?"small":""} ${e.primary?"primary":""}">${s}</span>`},ol=e=>{const t=e.metadata;return o`<a href="${t.url}" target="${t.target??d}"
                   rel="${t.target==="_blank"?"noopener":d}"
                   style="${e.style}" class="${e.cssClasses}"
                   slot="${e.slot??d}">${t.text}</a>`},zr=(e,t)=>{const a=e.toLowerCase().split("+");return t.ctrlKey===a.includes("ctrl")&&t.altKey===a.includes("alt")&&t.shiftKey===a.includes("shift")&&t.metaKey===a.includes("meta")},nl=(e,t)=>{if(!zr(e,t))return!1;const a=e.toLowerCase().split("+"),s=a[a.length-1];return!!(t.key.toLowerCase()===s||/^[a-z]$/.test(s)&&t.code==="Key"+s.toUpperCase()||/^[0-9]$/.test(s)&&(t.code==="Digit"+s||t.code==="Numpad"+s))},ll=e=>e?e.split("+").map(t=>t.length<=1?t.toUpperCase():t.charAt(0).toUpperCase()+t.slice(1)).join("+"):void 0,dl=(e,t)=>{const a=e.target.dataset.actionId;e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a,parameters:t.parameters},bubbles:!0,composed:!0}))},cl=(e,t,a)=>{const s=e.metadata,i=Oe(s.label,t,a);let r="";return s.buttonStyle&&(r+=" "+s.buttonStyle),s.color&&s.color!=="none"&&s.color!=="normal"&&(r+=" "+s.color),s.size&&s.size!=="none"&&s.size!=="normal"&&(r+=" "+s.size),o`<vaadin-button
id="${e.id}"
            ...
            theme="${r}"
            ?disabled="${s.disabled}"
            title="${s.shortcut?`${i} (${ll(s.shortcut)})`:d}"
            slot="${e.slot??d}"
    >${s.iconOnLeft?o`<vaadin-icon icon="${s.iconOnLeft}"></vaadin-icon>`:d}${i}${s.iconOnRight?o`<vaadin-icon icon="${s.iconOnRight}"></vaadin-icon>`:d}</vaadin-button>`},ul=(e,t,a,s,i,r,n)=>{const l=t.metadata;if(!l)return o``;let c="";return l.variants?.map(u=>u=="stretchMedia"?"stretch-media":u=="coverMedia"?"cover-media":u).forEach(u=>c+=" "+u),c=c.trim(),o`
        <vaadin-card
                style="${t.style}" 
                class="${t.cssClasses}" 
                theme="${c}"
                slot="${t.slot??d}"
        >
            ${l.media?ia(e,l.media,a,s,i,r,n,"media",!1):d}
            ${l.title?ia(e,l.title,a,s,i,r,n,"title",!1):d}
            ${l.subtitle?ia(e,l.subtitle,a,s,i,r,n,"subtitle",!1):d}
            ${l.header?ia(e,l.header,a,s,i,r,n,"header",!1):d}
            ${l.headerPrefix?ia(e,l.headerPrefix,a,s,i,r,n,"header-prefix",!1):d}
            ${l.headerSuffix?ia(e,l.headerSuffix,a,s,i,r,n,"header-suffix",!1):d}
            ${l.footer?ia(e,l.footer,a,s,i,r,n,"footer",!1):d}
    ...
    `},ml=(e,t,a,s,i,r,n)=>{const l=t.metadata;let c=!1;if(l.openedCondition)try{c=Ir(l.openedCondition,s,i,r,n)}catch(u){console.error("when evaluating "+l.openedCondition+" :"+u+", where data is "+i+" and state is "+s)}return o`
...
>
  ${t.children?.map(u=>w(e,u,a,s,i,r,n))}
            ...
            `},vl=e=>{const t=e.metadata;let a;return t.position&&(a={Top:"top",Bottom:"bottom",TopLeft:"top-left",TopRight:"top-right",BottomLeft:"bottom-left",BottomRight:"bottom-right"}[t.position]),o`
    ...
    `},fl=(e,t,a,s,i,r,n)=>{const l=t.metadata;return o`
        <vaadin-details 
                ?opened="${l.opened}" 
                style="${t.style}" 
                class="${t.cssClasses}"
        ...
        <vaadin-notification
                ...
                `,[])}
        ></vaadin-notification>
            `},wl=(e,t={})=>{const a=e.metadata,s=a.valueKey?t[a.valueKey]:a.value;return o`
        <div style="${e.style}">
        <vaadin-progress-bar
    ...
    `},kl=(e,t,a,s,i,r,n)=>{const l=t.metadata;return o`
        <div id="show-notifications" slot="${t.slot??d}">${w(e,l.wrapped,a,s,i,r,n)}</div>
        <vaadin-popover
                ...
                content-width="300px"
                position="bottom"
                ${kr(()=>o`${w(e,l.content,a,s,i,r,n)}`,[])}
                style="${t.style}" class="${t.cssClasses}"
        ></vaadin-popover>
    `},Cl=e=>{const t=e.metadata;return o`
        <mateu-map position="${t.position}" zoom="${t.zoom}"
                   style="${e.style}" class="${e.cssClasses}"
                   slot="${e.slot??d}"></mateu-map>
            `},Sl=e=>{const t=e.metadata;return o`
        <img src="${t.src}" style="${e.style}" class="${e.cssClasses}"
             slot="${e.slot??d}">
            `},Il=e=>{const t=e.metadata;return o`<vaadin-horizontal-layout theme="spacing"
                                          slot="${e.slot??d}">
    ...
    </vaadin-horizontal-layout>`},_l=(e,t,a,s,i,r,n)=>{const l=t.metadata;return o`
        <skeleton-carousel 
                id="${t.id}"
                ?dots = "${l.dots}" 
                ?nav = "${l.nav}" 
    ...
    `},El=(e,t,a,s)=>{const i=e.metadata;return o`
        ...
        ${e.submenus?o`
                <vaadin-details summary="${e.label}" opened>
                    <vaadin-vertical-layout theme="spacing">
                        ${e.submenus.map(t=>jr(t))}
                    </vaadin-vertical-layout>
                </vaadin-details>
            `:o`
                <a href="${e.path}">${e.label}</a>
        `}
        `,Pl=(e,t,a,s,i,r,n)=>{const l=t.metadata;return o`<div
                slot="${t.slot??d}"
                style="${t.style}" class="${t.cssClasses}"
        >${l.content?ge(l.content):d}${t.children?.map(c=>w(e,c,a,s,i,r,n))}</div>
    `},Tl=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=l.title?.includes("${")?e._evalTemplate(l.title):l.title;return o`<div
                slot="${t.slot??d}"
    ...
    `},Ol=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=l.title?.includes("${")?e._evalTemplate(l.title):l.title;return o`
        <div
                slot="${t.slot??d}"
                style="${t.style}" class="${t.cssClasses}"
        >
    ...
    `},ys=(e,t,a,s,i,r,n,l)=>{const c=t.metadata,u=c?.fabs??[];return o`<mateu-page
            .component="${t}"
            baseUrl="${a}"
            .state="${s}"
            .data="${i}"
...
`)}
    ...
    `},xs=(e,t,a,s,i,r,n,l)=>o`<mateu-table-crud
            id="${t.id}"
            baseUrl="${a}"
            .component="${t}"
            .metadata="${t.metadata}"
    ...
    >
        ${t.children?.map(c=>w(e,c,a,s,i,r,n))}
    </mateu-table-crud>`,Rl=e=>{const t=e.metadata;return o`
        <mateu-bpmn
                style="${e.style}"
                class="${e.cssClasses}"
                slot="${e.slot??d}"
    ...
    `},Al=(e,t,a)=>{const s=e.metadata;return o`<mateu-chat sseUrl="${s.sseUrl}"
                            style="${e.style}" 
                            class="${e.cssClasses}" 
                            slot="${e.slot??d}"></mateu-chat>`},zl=e=>{const t=e.metadata;return o`
        <mateu-workflow
                style="${e.style??d}"
                class="${e.cssClasses??d}"
                slot="${e.slot??d}"
        ...
        ></mateu-workflow>
    `},jl=e=>{const t=e.metadata;return o`
        <mateu-workflow-elk
                style="${e.style??d}"
                class="${e.cssClasses??d}"
                slot="${e.slot??d}"
...
`,Dl=e=>e=="up"?"var(--lumo-success-text-color, #1a7f37)":e=="down"?"var(--lumo-error-text-color, #c5221f)":"var(--lumo-secondary-text-color, #666)",Fl=e=>e=="up"?"▲":e=="down"?"▼":"",Nl=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},Ml=e=>{const t=e.metadata,a=!!t.actionId;return o`
        <div class="mateu-metric-card ${e.cssClasses??""}"
             style="${Lr} display: flex; flex-direction: column; gap: .25rem; min-width: 11rem; flex: 1; ${a?"cursor: pointer;":""} ${e.style??""}"
             slot="${e.slot??d}"
             role="${a?"button":d}"
             @click="${s=>Nl(s,t)}"
        >
    ...
    `,Ul=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=l.colSpan&&l.colSpan>1?`grid-column: span ${l.colSpan};`:"",u=l.rowSpan&&l.rowSpan>1?`grid-row: span ${l.rowSpan};`:"";return o`
        <div class="mateu-dashboard-panel ${t.cssClasses??""}"
             style="${Lr} display: flex; flex-direction: column; gap: .5rem; min-width: 0; ${c} ${u} ${t.style??""}"
             slot="${t.slot??d}"
        >
            ${l.title?o`
                <div>
    ...
    `},Bl=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=l.columns&&l.columns>0?`repeat(${l.columns}, minmax(0, 1fr))`:"repeat(auto-fit, minmax(20rem, 1fr))";return o`
    ...
    `};var Vl=Object.defineProperty,Wl=Object.getOwnPropertyDescriptor,_t=(e,t,a,s)=>{for(var i=s>1?void 0:s?Wl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Vl(t,a,i),i};let Je=class extends S{constructor(){super(...arguments),this.panels=[],this.headerTitle="",this.badges=[],this.orientation="vertical",this.navigation=null,this.overviewEditActionId="",this.openPanels=new Set,this.expandedPanel=null,this._onPopState=()=>{const e=decodeURIComponent((location.hash||"").replace(/^#/,""));if(e.startsWith("expand=")){const t=e.slice(7),a=this.panels.findIndex((s,i)=>this.panelAnchor(s,i)===t);this.expandedPanel=a>=0?a:null}else this.expandedPanel=null},this.initialized=!1}navAction(e){e&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e,parameters:{}},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._onPopState)}disconnectedCallback(){window.removeEventListener("popstate",this._onPopState),super.disconnectedCallback()}willUpdate(){if(!this.initialized&&this.panels.length){this.openPanels=new Set(this.panels.map((t,a)=>t.open?a:-1).filter(t=>t>=0));const e=decodeURIComponent((location.hash||"").replace(/^#/,""));if(e.startsWith("expand=")){const t=e.slice(7),a=this.panels.findIndex((s,i)=>this.panelAnchor(s,i)===t);a>=0&&(this.expandedPanel=a)}else if(e){const t=this.panels.findIndex((a,s)=>this.panelAnchor(a,s)===e);t>=0&&this.openPanels.add(t)}this.initialized=!0}}firstUpdated(){const e=decodeURIComponent((location.hash||"").replace(/^#/,""));if(!e)return;const t=this.renderRoot.querySelector(`[data-anchor="${CSS.escape(e)}"]`);t&&t.scrollIntoView({block:"nearest"})}panelAnchor(e,t){return(e.title??"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")||`panel-${t}`}bookmarkPanel(e){const t=this.panelAnchor(this.panels[e],e);try{history.replaceState(history.state,"","#"+t)}catch{}}clearBookmark(e){const t=this.panelAnchor(this.panels[e],e);if(decodeURIComponent((location.hash||"").replace(/^#/,""))===t)try{history.replaceState(history.state,"",location.pathname+location.search)}catch{}}expandPanel(e,t){t?.stopPropagation(),this.expandedPanel=e;const a=this.panelAnchor(this.panels[e],e);try{history.pushState(history.state,"","#expand="+a)}catch{}}collapsePanel(){try{history.back()}catch{this.expandedPanel=null}}toggle(e){const t=new Set(this.openPanels);t.has(e)?(t.delete(e),this.clearBookmark(e)):(t.add(e),this.bookmarkPanel(e)),this.openPanels=t}render(){if(this.expandedPanel!=null&&this.panels[this.expandedPanel]){const t=this.panels[this.expandedPanel];return o`
    ...
    `;_t([h({type:Array})],Je.prototype,"panels",2);_t([h({type:String})],Je.prototype,"headerTitle",2);_t([h({type:Array})],Je.prototype,"badges",2);_t([h({type:String,reflect:!0})],Je.prototype,"orientation",2);_t([h({attribute:!1})],Je.prototype,"navigation",2);_t([h({type:String})],Je.prototype,"overviewEditActionId",2);_t([$()],Je.prototype,"openPanels",2);_t([$()],Je.prototype,"expandedPanel",2);Je=_t([k("mateu-foldout")],Je);const Hl=(e,t,a,s,i,r,n)=>{const l=t.metadata;return o`
        <mateu-foldout
                .panels="${l.panels??[]}"
    ...
    `},Gl=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=!!l.image,u=c?`background-image: linear-gradient(rgba(0,0,0,.35), rgba(0,0,0,.35)), url('${l.image}'); background-size: cover; background-position: center; color: #fff;`:"",m=l.centered===!1?"flex-start":"center",p=l.centered===!1?"left":"center";return o`
        <div class="mateu-hero ${t.cssClasses??""}"
             style="display: flex; flex-direction: column; align-items: ${m}; justify-content: center; gap: var(--lumo-space-m, 1rem); text-align: ${p}; padding: var(--lumo-space-xl, 2.5rem) var(--lumo-space-l, 1.5rem); border-radius: var(--lumo-border-radius-l, 12px); min-height: ${l.height??"12rem"}; box-sizing: border-box; ${u} ${t.style??""}"
             slot="${t.slot??d}"
        >
    ...
    `};var Kl=Object.defineProperty,Yl=Object.getOwnPropertyDescriptor,Dr=(e,t,a,s)=>{for(var i=s>1?void 0:s?Yl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Kl(t,a,i),i};const ps=1440*60*1e3;let Ci=class extends S{constructor(){super(...arguments),this.tasks=[]}range(){const e=this.tasks.flatMap(t=>[t.start,t.end]).filter(t=>!!t).map(t=>new Date(t+"T00:00:00").getTime());return e.length?{min:Math.min(...e)-ps,max:Math.max(...e)+2*ps}:null}months(e,t){const a=[],s=new Date(e);for(s.setDate(1);s.getTime()<=t;){const i=Math.max(s.getTime(),e),r=new Date(s.getFullYear(),s.getMonth()+1,1),n=Math.min(r.getTime(),t);a.push({label:s.toLocaleDateString(void 0,{month:"short",year:"2-digit"}),from:i,to:n}),s.setMonth(s.getMonth()+1)}return a}render(){const e=this.range();if(!e)return o``;const t=e.max-e.min,a=i=>(i-e.min)/t*100,s=Date.now();return o`
            <div class="frame">
                ...
                ${this.tasks.map(i=>{const r=new Date(i.start+"T00:00:00").getTime(),n=new Date(i.end+"T00:00:00").getTime()+ps;return o`
    ...
    `;Dr([h({type:Array})],Ci.prototype,"tasks",2);Ci=Dr([k("mateu-gantt")],Ci);const Jl=e=>{const t=e.metadata;return o`
        <mateu-gantt
                .tasks="${t.tasks??[]}"
                style="${e.style??d}"
                class="${e.cssClasses??d}"
    ...
    `};var Xl=Object.defineProperty,Ql=Object.getOwnPropertyDescriptor,Yt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ql(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Xl(t,a,i),i};let M=class extends S{constructor(){super(...arguments),this.resources=[],this.blocks=[],this.drag=null,this.dragStartX=0,this.dragStartY=0,this.laneRects=[],this.onDragKeydown=e=>{e.key==="Escape"&&this.drag&&(e.stopPropagation(),this.endDrag())}}static parse(e){return new Date(e+"T00:00:00")}static iso(e){const t=a=>String(a).padStart(2,"0");return`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}`}static addDays(e,t){return new Date(e.getFullYear(),e.getMonth(),e.getDate()+t)}static daysBetween(e,t){return Math.round((t.getTime()-e.getTime())/864e5)}window(){if(this.from&&this.to){const s=M.parse(this.from),i=M.daysBetween(s,M.parse(this.to))+1;return i>0?{from:s,days:i}:null}const e=this.blocks.flatMap(s=>[s.start,s.end]).filter(s=>!!s).map(s=>M.parse(s));if(!e.length)return null;const t=new Date(Math.min(...e.map(s=>s.getTime()))),a=new Date(Math.max(...e.map(s=>s.getTime())));return{from:t,days:M.daysBetween(t,a)+1}}onBlockPointerDown(e,t,a){if(!this.moveActionId&&!this.selectActionId||(e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),this.dragStartX=e.clientX,this.dragStartY=e.clientY,!this.window()))return;const r=M.parse(t.start),n=M.parse(t.end),l=Math.max(1,M.daysBetween(r,n)+1);this.laneRects=[...this.renderRoot.querySelectorAll(".lane[data-resource-id]")].map(u=>({resourceId:u.dataset.resourceId,rect:u.getBoundingClientRect()}));const c=this.dayAt(t.resourceId,e.clientX)??a;this.drag={blockId:t.id,duration:l,grabOffsetDays:c-a,originResourceId:t.resourceId,originStartIdx:a,targetResourceId:t.resourceId,targetStartIdx:a,moved:!1},window.addEventListener("keydown",this.onDragKeydown)}dayAt(e,t){const a=this.laneRects.find(r=>r.resourceId===e),s=this.window();if(!a||!s||a.rect.width===0)return null;const i=Math.floor((t-a.rect.left)/a.rect.width*s.days);return Math.max(0,Math.min(s.days-1,i))}onBlockPointerMove(e){if(!this.drag||!this.drag.moved&&Math.abs(e.clientX-this.dragStartX)<4&&Math.abs(e.clientY-this.dragStartY)<4||!this.moveActionId)return;const t=this.window();if(!t)return;const a=this.laneRects.find(r=>e.clientY>=r.rect.top&&e.clientY<=r.rect.bottom)??this.laneRects.find(r=>r.resourceId===this.drag.targetResourceId);if(!a)return;const s=this.dayAt(a.resourceId,e.clientX);if(s==null)return;const i=Math.max(0,Math.min(t.days-this.drag.duration,s-this.drag.grabOffsetDays));this.drag={...this.drag,moved:!0,targetResourceId:a.resourceId,targetStartIdx:i}}onBlockPointerUp(e){const t=this.drag;if(this.endDrag(),!t)return;if(!t.moved){this.selectActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.selectActionId,parameters:{_blockId:e.id}},bubbles:!0,composed:!0}));return}if(!this.moveActionId||t.targetResourceId===t.originResourceId&&t.targetStartIdx===t.originStartIdx)return;const a=this.window();if(!a)return;const s=M.addDays(a.from,t.targetStartIdx),i=M.addDays(s,t.duration-1);this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.moveActionId,parameters:{_blockId:t.blockId,_resourceId:t.targetResourceId,_start:M.iso(s),_end:M.iso(i)}},bubbles:!0,composed:!0}))}endDrag(){this.drag=null,window.removeEventListener("keydown",this.onDragKeydown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onDragKeydown)}render(){const e=this.window();if(!e||!this.resources.length)return o``;const t=[...Array(e.days).keys()].map(l=>M.addDays(e.from,l)),a=new Date,s=M.daysBetween(e.from,new Date(a.getFullYear(),a.getMonth(),a.getDate())),i=s>=0&&s<e.days,r=[];let n;return this.resources.forEach(l=>{l.group&&l.group!==n&&r.push(o`<div class="group">${l.group}</div>`),n=l.group,r.push(this.renderRow(l,e,t,i?s:null))}),o`
        ...
        `}isWeekend(e){return e.getDay()===0||e.getDay()===6}renderRow(e,t,a,s){const i=100/t.days,r=this.blocks.filter(l=>l.resourceId===e.id&&l.start&&l.end),n=this.drag?.moved&&this.drag.targetResourceId===e.id?this.drag:null;return o`
            ...
            <div class="lane" data-resource-id="${e.id}">
                ...
                ${r.map(l=>{const c=M.daysBetween(t.from,M.parse(l.start)),u=M.daysBetween(t.from,M.parse(l.end));if(u<0||c>=t.days)return d;const m=Math.max(0,c),p=Math.min(t.days-1,u),f=this.drag?.moved&&this.drag.blockId===l.id;return o`
                        <div class="block ${this.selectActionId?"clickable":""} ${this.moveActionId?"draggable":""} ${f?"dragging":""}"
                             ...
                             style="left: ${m*i}%; width: ${(p-m+1)*i}%; ${l.color?`--mateu-planning-block: ${l.color};`:""}"
    ...
    `;Yt([h({type:Array})],M.prototype,"resources",2);Yt([h({type:Array})],M.prototype,"blocks",2);Yt([h()],M.prototype,"from",2);Yt([h()],M.prototype,"to",2);Yt([h()],M.prototype,"moveActionId",2);Yt([h()],M.prototype,"selectActionId",2);Yt([$()],M.prototype,"drag",2);M=Yt([k("mateu-planning-board")],M);const Zl=e=>{const t=e.metadata;return o`
        <mateu-planning-board
                ...
                slot="${e.slot??d}"
        ></mateu-planning-board>
    `};var ed=Object.defineProperty,td=Object.getOwnPropertyDescriptor,Fr=(e,t,a,s)=>{for(var i=s>1?void 0:s?td(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ed(t,a,i),i};let Si=class extends S{constructor(){super(...arguments),this.columns=[]}clickCard(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedCard:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="board">
    ...
    `;Fr([h({type:Array})],Si.prototype,"columns",2);Si=Fr([k("mateu-kanban")],Si);const ad=e=>{const t=e.metadata;return o`
        <mateu-kanban
                .columns="${t.columns??[]}"
                style="${e.style??d}"
                class="${e.cssClasses??d}"
                slot="${e.slot??d}"
        ></mateu-kanban>
    `};var id=Object.defineProperty,sd=Object.getOwnPropertyDescriptor,Nr=(e,t,a,s)=>{for(var i=s>1?void 0:s?sd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&id(t,a,i),i};let Ii=class extends S{constructor(){super(...arguments),this.items=[]}clickItem(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedItem:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="feed">
                ${this.items.map(e=>o`
    ...
    `;Nr([h({type:Array})],Ii.prototype,"items",2);Ii=Nr([k("mateu-timeline")],Ii);const rd=e=>{const t=e.metadata;return o`
        <mateu-timeline
                .items="${t.items??[]}"
                style="${e.style??d}"
                class="${e.cssClasses??d}"
                slot="${e.slot??d}"
        ></mateu-timeline>
    `};var od=Object.defineProperty,nd=Object.getOwnPropertyDescriptor,Os=(e,t,a,s)=>{for(var i=s>1?void 0:s?nd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&od(t,a,i),i};let Za=class extends S{constructor(){super(...arguments),this.steps=[],this.vertical=!1}render(){return o`
            <div class="steps">
    ...
    `;Os([h({type:Array})],Za.prototype,"steps",2);Os([h({type:Boolean,reflect:!0})],Za.prototype,"vertical",2);Za=Os([k("mateu-progress-steps")],Za);const ld=e=>{const t=e.metadata;return o`
        <mateu-progress-steps
                ...
                slot="${e.slot??d}"
        ></mateu-progress-steps>
    `};var dd=Object.defineProperty,cd=Object.getOwnPropertyDescriptor,Jt=(e,t,a,s)=>{for(var i=s>1?void 0:s?cd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&dd(t,a,i),i};let nt=class extends S{constructor(){super(...arguments),this.spark=[]}sparkline(){const e=this.spark;if(!e||e.length<2)return d;const t=84,a=30,s=2,i=Math.min(...e),n=Math.max(...e)-i||1,l=(t-s*2)/(e.length-1),c=e.map((f,g)=>{const y=s+g*l,x=s+(a-s*2)*(1-(f-i)/n);return[y,x]}),u=c.map(([f,g],y)=>`${y===0?"M":"L"}${f.toFixed(1)} ${g.toFixed(1)}`).join(" "),m=`${u} L${c[c.length-1][0].toFixed(1)} ${a} L${c[0][0].toFixed(1)} ${a} Z`,p=this.trend==="down"?"var(--lumo-error-color, #e11d48)":this.trend==="flat"?"var(--lumo-secondary-text-color, #888)":"var(--lumo-success-color, #12b76a)";return X`
            <svg width="${t}" height="${a}" viewBox="0 0 ${t} ${a}">
                <path d="${m}" fill="${p}" opacity="0.12"></path>
    ...
    `;Jt([h()],nt.prototype,"label",2);Jt([h()],nt.prototype,"value",2);Jt([h()],nt.prototype,"unit",2);Jt([h()],nt.prototype,"delta",2);Jt([h()],nt.prototype,"trend",2);Jt([h({type:Array})],nt.prototype,"spark",2);Jt([h()],nt.prototype,"actionId",2);nt=Jt([k("mateu-stat")],nt);const ud=e=>{const t=e.metadata;return o`
        <mateu-stat
                label="${t.label??d}"
                value="${t.value??d}"
                unit="${t.unit??d}"
                ...
                slot="${e.slot??d}"
        ></mateu-stat>
    `};var pd=Object.defineProperty,hd=Object.getOwnPropertyDescriptor,Rs=(e,t,a,s)=>{for(var i=s>1?void 0:s?hd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&pd(t,a,i),i};let ei=class extends S{constructor(){super(...arguments),this.events=[]}clickEvent(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedEvent:e}},bubbles:!0,composed:!0}))}render(){const e=this.month?new Date(this.month+"T00:00:00"):new Date,t=e.getFullYear(),a=e.getMonth(),s=new Date(t,a,1),i=(s.getDay()+6)%7,r=new Date(t,a+1,0).getDate(),n=new Date,l=f=>n.getFullYear()===t&&n.getMonth()===a&&n.getDate()===f,c={};for(const f of this.events){if(!f.date)continue;const g=new Date(f.date+"T00:00:00");g.getFullYear()===t&&g.getMonth()===a&&(c[g.getDate()]??=[]).push(f)}const u=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],m=[];for(let f=0;f<i;f++)m.push(o`<div class="cell blank"></div>`);for(let f=1;f<=r;f++)m.push(o`
    ...
    `;Rs([h()],ei.prototype,"month",2);Rs([h({type:Array})],ei.prototype,"events",2);ei=Rs([k("mateu-calendar")],ei);const md=e=>{const t=e.metadata;return o`
        <mateu-calendar
                month="${t.month??d}"
                .events="${t.events??[]}"
                style="${e.style??d}"
                ...
                slot="${e.slot??d}"
        ></mateu-calendar>
    `};var vd=Object.defineProperty,fd=Object.getOwnPropertyDescriptor,Mr=(e,t,a,s)=>{for(var i=s>1?void 0:s?fd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&vd(t,a,i),i};let _i=class extends S{constructor(){super(...arguments),this.plans=[]}cta(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){return o`
            <div class="plans">
                ${this.plans.map(e=>o`
    ...
    `;Mr([h({type:Array})],_i.prototype,"plans",2);_i=Mr([k("mateu-pricing-table")],_i);const bd=e=>{const t=e.metadata;return o`
        <mateu-pricing-table
                .plans="${t.plans??[]}"
                style="${e.style??d}"
                class="${e.cssClasses??d}"
                slot="${e.slot??d}"
        ></mateu-pricing-table>
    `};var gd=Object.defineProperty,$d=Object.getOwnPropertyDescriptor,qr=(e,t,a,s)=>{for(var i=s>1?void 0:s?$d(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&gd(t,a,i),i};let Ei=class extends S{clickNode(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedNode:e}},bubbles:!0,composed:!0}))}renderNode(e){const t=e.avatar,a=t&&(t.startsWith("http")||t.startsWith("data:"));return o`
            <li>
        ...
        `}render(){return this.root?o`<div class="tree"><ul>${this.renderNode(this.root)}</ul></div>`:o``}};Ei.styles=C`
        :host {
            display: block;
            width: 100%;
            overflow-x: auto;
    ...
    `;qr([h({attribute:!1})],Ei.prototype,"root",2);Ei=qr([k("mateu-org-chart")],Ei);const yd=e=>{const t=e.metadata;return o`
        <mateu-org-chart
                .root="${t.root}"
                style="${e.style??d}"
                class="${e.cssClasses??d}"
                slot="${e.slot??d}"
        ></mateu-org-chart>
    `};var xd=Object.defineProperty,wd=Object.getOwnPropertyDescriptor,Ur=(e,t,a,s)=>{for(var i=s>1?void 0:s?wd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&xd(t,a,i),i};const kd=1440*60*1e3;let Pi=class extends S{constructor(){super(...arguments),this.cells=[]}color(e,t){if(e<=0||t<=0)return"var(--lumo-contrast-10pct, #ebedf0)";const a=e/t,s=a>.75?1:a>.5?.75:a>.25?.5:.3;return`color-mix(in srgb, var(--lumo-primary-color, #1a73e8) ${Math.round(s*100)}%, transparent)`}render(){const e=this.cells.filter(c=>!!c.date);if(!e.length)return o``;const t=e.map(c=>new Date(c.date+"T00:00:00").getTime()),a=Math.min(...t),s=Math.max(...t),i=new Date(a);i.setDate(i.getDate()-(i.getDay()+6)%7);const r={};for(const c of e)r[c.date]=c;const n=Math.max(...e.map(c=>c.value??0),1),l=[];for(let c=i.getTime();c<=s;c+=kd){const u=new Date(c),m=u.toISOString().slice(0,10),p=r[m],f=p?.value??0,g=(u.getDay()+6)%7+1,y=p?.label??`${m}: ${f}`;l.push(o`
    ...
    `;Ur([h({type:Array})],Pi.prototype,"cells",2);Pi=Ur([k("mateu-heatmap")],Pi);const Cd=e=>{const t=e.metadata;return o`
        <mateu-heatmap
                .cells="${t.cells??[]}"
                style="${e.style??d}"
                class="${e.cssClasses??d}"
                slot="${e.slot??d}"
        ></mateu-heatmap>
    `};var Sd=Object.defineProperty,Id=Object.getOwnPropertyDescriptor,Br=(e,t,a,s)=>{for(var i=s>1?void 0:s?Id(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Sd(t,a,i),i};let Ti=class extends S{constructor(){super(...arguments),this.stages=[]}render(){const e=this.stages;if(!e.length)return o``;const t=e[0].value??0,a=Math.max(...e.map(s=>s.value??0),1);return o`
            <div class="funnel">
    ...
    `;Br([h({type:Array})],Ti.prototype,"stages",2);Ti=Br([k("mateu-funnel")],Ti);const _d=e=>{const t=e.metadata;return o`
        <mateu-funnel
                .stages="${t.stages??[]}"
                style="${e.style??d}"
                class="${e.cssClasses??d}"
                slot="${e.slot??d}"
        ></mateu-funnel>
    `};var Ed=Object.defineProperty,Pd=Object.getOwnPropertyDescriptor,ja=(e,t,a,s)=>{for(var i=s>1?void 0:s?Pd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ed(t,a,i),i};let Mt=class extends S{constructor(){super(...arguments),this.values=[],this.labels=[],this.area=!1}render(){const e=this.values;if(!e||e.length<2)return o``;const t=600,a=160,s=8,i=Math.min(...e),r=Math.max(...e),n=r-i||1,l=(t-s*2)/(e.length-1),c=e.map((y,x)=>{const P=s+x*l,U=s+(a-s*2)*(1-(y-i)/n);return[P,U]}),u=c.map(([y,x],P)=>`${P===0?"M":"L"}${y.toFixed(1)} ${x.toFixed(1)}`).join(" "),m=`${u} L${c[c.length-1][0].toFixed(1)} ${a-s} L${c[0][0].toFixed(1)} ${a-s} Z`,p=this.color||"var(--lumo-primary-color, #1a73e8)",f=e.indexOf(r),g=e.indexOf(i);return o`
            ${this.heading?o`<div class="title">${this.heading}</div>`:d}
            <svg viewBox="0 0 ${t} ${a}" preserveAspectRatio="none">
                ${this.area?X`<path d="${m}" fill="${p}" opacity="0.12"></path>`:d}
                <path d="${u}" fill="none" stroke="${p}" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"></path>
                ${c.map((y,x)=>x===f||x===g?X`<circle cx="${y[0]}" cy="${y[1]}" r="3.2" fill="${p}"><title>${this.labels[x]??""}: ${e[x]}</title></circle>`:X`<circle cx="${y[0]}" cy="${y[1]}" r="6" fill="transparent"><title>${this.labels[x]??""}: ${e[x]}</title></circle>`)}
            </svg>
    ...
    `;ja([h()],Mt.prototype,"heading",2);ja([h({type:Array})],Mt.prototype,"values",2);ja([h({type:Array})],Mt.prototype,"labels",2);ja([h()],Mt.prototype,"color",2);ja([h({type:Boolean})],Mt.prototype,"area",2);Mt=ja([k("mateu-trend-chart")],Mt);const Td=e=>{const t=e.metadata;return o`
        <mateu-trend-chart
                heading="${t.title??d}"
                color="${t.color??d}"
                ?area="${t.area??!1}"
                ...
                slot="${e.slot??d}"
        ></mateu-trend-chart>
    `};var Od=Object.defineProperty,Rd=Object.getOwnPropertyDescriptor,As=(e,t,a,s)=>{for(var i=s>1?void 0:s?Rd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Od(t,a,i),i};let ti=class extends S{constructor(){super(...arguments),this.features=[],this.columns=0}clickFeature(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){const e=this.columns&&this.columns>0?`repeat(${this.columns}, minmax(0, 1fr))`:"repeat(auto-fit, minmax(15rem, 1fr))";return o`
    ...
    `;As([h({type:Array})],ti.prototype,"features",2);As([h({type:Number})],ti.prototype,"columns",2);ti=As([k("mateu-feature-grid")],ti);const Ad=e=>{const t=e.metadata;return o`
        <mateu-feature-grid
                .features="${t.features??[]}"
                .columns="${t.columns??0}"
                style="${e.style??d}"
                ...
                slot="${e.slot??d}"
        ></mateu-feature-grid>
    `};var zd=Object.defineProperty,jd=Object.getOwnPropertyDescriptor,Vr=(e,t,a,s)=>{for(var i=s>1?void 0:s?jd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&zd(t,a,i),i};let Oi=class extends S{constructor(){super(...arguments),this.items=[]}stars(e){const t=Math.max(0,Math.min(5,e||0));return"★".repeat(t)+"☆".repeat(5-t)}render(){return o`
            <div class="grid">
    ...
    `;Vr([h({type:Array})],Oi.prototype,"items",2);Oi=Vr([k("mateu-testimonials")],Oi);const Ld=e=>{const t=e.metadata;return o`
        <mateu-testimonials
                .items="${t.items??[]}"
                style="${e.style??d}"
                class="${e.cssClasses??d}"
                slot="${e.slot??d}"
        ></mateu-testimonials>
    `};var Dd=Object.defineProperty,Fd=Object.getOwnPropertyDescriptor,zs=(e,t,a,s)=>{for(var i=s>1?void 0:s?Fd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Dd(t,a,i),i};let ai=class extends S{constructor(){super(...arguments),this.items=[],this.openSet=new Set,this.seeded=!1}seed(){this.seeded||(this.seeded=!0,this.items.forEach((e,t)=>{e.open&&this.openSet.add(t)}))}toggle(e){this.openSet.has(e)?this.openSet.delete(e):this.openSet.add(e),this.requestUpdate()}render(){return this.seed(),o`
            <div class="list">
    ...
    `;zs([h({type:Array})],ai.prototype,"items",2);zs([$()],ai.prototype,"openSet",2);ai=zs([k("mateu-faq")],ai);const Nd=e=>{const t=e.metadata;return o`
        <mateu-faq
                .items="${t.items??[]}"
                style="${e.style??d}"
                class="${e.cssClasses??d}"
    ...
    `;ga([h()],Ct.prototype,"heading",2);ga([h()],Ct.prototype,"description",2);ga([h()],Ct.prototype,"icon",2);ga([h()],Ct.prototype,"ctaLabel",2);ga([h()],Ct.prototype,"actionId",2);ga([h()],Ct.prototype,"theme",2);Ct=ga([k("mateu-callout-card")],Ct);const Ud=e=>{const t=e.metadata;return o`
        <mateu-callout-card
                heading="${t.title??d}"
                ...
                slot="${e.slot??d}"
        ></mateu-callout-card>
    `};var Bd=Object.defineProperty,Vd=Object.getOwnPropertyDescriptor,Wr=(e,t,a,s)=>{for(var i=s>1?void 0:s?Vd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Bd(t,a,i),i};let Ri=class extends S{constructor(){super(...arguments),this.comments=[]}renderComment(e){const t=e.avatar&&(e.avatar.startsWith("http")||e.avatar.startsWith("data:"));return o`
            <div class="comment">
        ...
        `}render(){return o`<div class="thread">${this.comments.map(e=>this.renderComment(e))}</div>`}};Ri.styles=C`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
    ...
    `;Wr([h({type:Array})],Ri.prototype,"comments",2);Ri=Wr([k("mateu-comment-thread")],Ri);const Wd=e=>{const t=e.metadata;return o`
        <mateu-comment-thread
                ...
                slot="${e.slot??d}"
        ></mateu-comment-thread>
    `};var Hd=Object.defineProperty,Gd=Object.getOwnPropertyDescriptor,Hr=(e,t,a,s)=>{for(var i=s>1?void 0:s?Gd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Hd(t,a,i),i};const Kd={pdf:"📕",image:"🖼️",img:"🖼️",doc:"📘",docx:"📘",word:"📘",xls:"📗",xlsx:"📗",excel:"📗",sheet:"📗",zip:"🗜️",archive:"🗜️",video:"🎬",audio:"🎵",code:"💻",csv:"📄",txt:"📄"};let Ai=class extends S{constructor(){super(...arguments),this.files=[]}icon(e){return e&&Kd[e.toLowerCase()]||"📄"}clickFile(e,t){e.url||e.actionId&&(t.preventDefault(),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_file:e}},bubbles:!0,composed:!0})))}render(){return o`
            <div class="list">
    ...
    `;Hr([h({type:Array})],Ai.prototype,"files",2);Ai=Hr([k("mateu-file-list")],Ai);const Yd=e=>{const t=e.metadata;return o`
        <mateu-file-list
                .files="${t.files??[]}"
                style="${e.style??d}"
                class="${e.cssClasses??d}"
                slot="${e.slot??d}"
        ></mateu-file-list>
    `};var Jd=Object.defineProperty,Xd=Object.getOwnPropertyDescriptor,Ki=(e,t,a,s)=>{for(var i=s>1?void 0:s?Xd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Jd(t,a,i),i};let Pa=class extends S{constructor(){super(...arguments),this.items=[],this.localDone=new Map}isDone(e,t){return this.localDone.has(t)?!!this.localDone.get(t):!!e.done}toggle(e,t){const a=!this.isDone(e,t);this.localDone.set(t,a),this.requestUpdate(),e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_item:e,_done:a}},bubbles:!0,composed:!0}))}render(){const e=this.items.length,t=this.items.filter((s,i)=>this.isDone(s,i)).length,a=e>0?Math.round(t/e*100):0;return o`
            <div class="head">
    ...
    `;Ki([h()],Pa.prototype,"heading",2);Ki([h({type:Array})],Pa.prototype,"items",2);Ki([$()],Pa.prototype,"localDone",2);Pa=Ki([k("mateu-checklist")],Pa);const Qd=e=>{const t=e.metadata;return o`
        <mateu-checklist
                heading="${t.title??d}"
                .items="${t.items??[]}"
                style="${e.style??d}"
                ...
                slot="${e.slot??d}"
        ></mateu-checklist>
    `};var Zd=Object.defineProperty,ec=Object.getOwnPropertyDescriptor,Xt=(e,t,a,s)=>{for(var i=s>1?void 0:s?ec(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Zd(t,a,i),i};let lt=class extends S{render(){const e=this.trend??"flat";return o`
            <div class="card">
                ${this.heading?o`<div class="title">${this.heading}</div>`:d}
                <div class="row">
                    <div class="side">
        ...
        @media (prefers-color-scheme: dark) { .card { background: var(--lumo-contrast-5pct, #2a2a2a); } }
    `;Xt([h()],lt.prototype,"heading",2);Xt([h()],lt.prototype,"leftLabel",2);Xt([h()],lt.prototype,"leftValue",2);Xt([h()],lt.prototype,"rightLabel",2);Xt([h()],lt.prototype,"rightValue",2);Xt([h()],lt.prototype,"delta",2);Xt([h()],lt.prototype,"trend",2);lt=Xt([k("mateu-comparison-card")],lt);const tc=e=>{const t=e.metadata;return o`
...
`,ac=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}),ws=e=>ac.format(e),zi=(e,t)=>{const a=e<0?"-":"",s=ws(Math.abs(e));return t?`${a}${t} ${s}`:`${a}${s}`},ic=(e,t)=>t?`${ws(e)} ${t}`:ws(e);var sc=Object.defineProperty,rc=Object.getOwnPropertyDescriptor,Qt=(e,t,a,s)=>{for(var i=s>1?void 0:s?rc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&sc(t,a,i),i};let dt=class extends S{constructor(){super(...arguments),this.title="",this.badges=[],this.facts=[]}render(){const e=!!(this.metricLabel||this.metricValue||this.metricCaption);return o`
            <div class="card">
                <div class="main">
                    <div class="title-row">
    ...
    `];Qt([h()],dt.prototype,"title",2);Qt([h({type:Array})],dt.prototype,"badges",2);Qt([h()],dt.prototype,"subtitle",2);Qt([h({type:Array})],dt.prototype,"facts",2);Qt([h()],dt.prototype,"metricLabel",2);Qt([h()],dt.prototype,"metricValue",2);Qt([h()],dt.prototype,"metricCaption",2);dt=Qt([k("mateu-entity-header")],dt);const oc=e=>{const t=e.metadata;return o`
        <mateu-entity-header
                .title="${t.title??""}"
                .badges="${t.badges??[]}"
                .subtitle="${t.subtitle}"
                ...
                slot="${e.slot??d}"
        ></mateu-entity-header>
    `};var nc=Object.defineProperty,lc=Object.getOwnPropertyDescriptor,Zt=(e,t,a,s)=>{for(var i=s>1?void 0:s?lc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&nc(t,a,i),i};let ct=class extends S{constructor(){super(...arguments),this.value=0,this.max=0}fillColor(){return this.dangerAt!=null&&this.value>=this.dangerAt?"error":this.warnAt!=null&&this.value>=this.warnAt?"warning":this.warnAt!=null||this.dangerAt!=null?"success":"primary"}render(){const e=this.max>0?Math.min(Math.max(this.value/this.max,0),1):0,t=Math.round(e*100);return o`
            <div class="meter">
                ${this.label?o`<span class="label">${this.label}</span>`:d}
                <span class="value">${ic(this.value,this.unit)}</span>
                <div class="track">
    ...
    `;Zt([h()],ct.prototype,"label",2);Zt([h({type:Number})],ct.prototype,"value",2);Zt([h({type:Number})],ct.prototype,"max",2);Zt([h()],ct.prototype,"unit",2);Zt([h()],ct.prototype,"caption",2);Zt([h({type:Number})],ct.prototype,"warnAt",2);Zt([h({type:Number})],ct.prototype,"dangerAt",2);ct=Zt([k("mateu-meter")],ct);const dc=e=>{const t=e.metadata;return o`
        <mateu-meter
                .label="${t.label}"
                .value="${t.value??0}"
                .max="${t.max??0}"
                ...
                slot="${e.slot??d}"
        ></mateu-meter>
    `};var cc=Object.defineProperty,uc=Object.getOwnPropertyDescriptor,La=(e,t,a,s)=>{for(var i=s>1?void 0:s?uc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&cc(t,a,i),i};let qt=class extends S{constructor(){super(...arguments),this.total=0,this.done=0}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){const e=this.total>0&&this.done>=this.total,t=!e&&!!this.actionLabel&&!!this.actionId;return o`
    ...
    `;La([h()],qt.prototype,"label",2);La([h({type:Number})],qt.prototype,"total",2);La([h({type:Number})],qt.prototype,"done",2);La([h()],qt.prototype,"actionLabel",2);La([h()],qt.prototype,"actionId",2);qt=La([k("mateu-task-progress")],qt);const pc=e=>{const t=e.metadata;return o`
        <mateu-task-progress
                .label="${t.label}"
                .total="${t.total??0}"
                .done="${t.done??0}"
                ...
                slot="${e.slot??d}"
        ></mateu-task-progress>
    `};var hc=Object.defineProperty,mc=Object.getOwnPropertyDescriptor,oi=(e,t,a,s)=>{for(var i=s>1?void 0:s?mc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&hc(t,a,i),i};let oa=class extends S{constructor(){super(...arguments),this.items=[],this.compact=!1,this.frameless=!1}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}rowClicked(e){this.rowActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.rowActionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}render(){return o`
    ...
    `];oi([h({type:Array})],oa.prototype,"items",2);oi([h({type:Boolean})],oa.prototype,"compact",2);oi([h({type:Boolean})],oa.prototype,"frameless",2);oi([h()],oa.prototype,"rowActionId",2);oa=oi([k("mateu-status-list")],oa);const vc=e=>{const t=e.metadata;return o`
        <mateu-status-list
                .items="${t.items??[]}"
                ?compact="${t.compact??!1}"
                ...
                slot="${e.slot??d}"
        ></mateu-status-list>
    `};var fc=Object.defineProperty,bc=Object.getOwnPropertyDescriptor,Gr=(e,t,a,s)=>{for(var i=s>1?void 0:s?bc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&fc(t,a,i),i};let ji=class extends S{constructor(){super(...arguments),this.items=[]}render(){return o`
            <ul>
    ...
    `;Gr([h({type:Array})],ji.prototype,"items",2);ji=Gr([k("mateu-bulleted-list")],ji);const gc=e=>{const t=e.metadata;return o`
        <mateu-bulleted-list
                .items="${t.items??[]}"
                style="${e.style??d}"
                class="${e.cssClasses??d}"
                slot="${e.slot??d}"
        ></mateu-bulleted-list>
    `},$c=e=>{const a=e.metadata.attributes?.["data-colspan"];return o`
    ...
    `;Ue([h()],xe.prototype,"text",2);Ue([h()],xe.prototype,"theme",2);Ue([h()],xe.prototype,"icon",2);Ue([h({type:Boolean})],xe.prototype,"noIcon",2);Ue([h()],xe.prototype,"actionLabel",2);Ue([h()],xe.prototype,"actionId",2);Ue([h()],xe.prototype,"status",2);Ue([h({type:Boolean})],xe.prototype,"slim",2);Ue([h({type:Boolean})],xe.prototype,"fullWidth",2);Ue([h({type:Boolean})],xe.prototype,"hasContent",2);Ue([h({type:Boolean})],xe.prototype,"inlineContent",2);xe=Ue([k("mateu-notice")],xe);const kc=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=Hi(l.text??"",s,i,r,n)??"",u=t.children??[];return o`
        <mateu-notice
                text="${c}"
                theme="${l.theme??"info"}"
    ...
    `};var Cc=Object.defineProperty,Sc=Object.getOwnPropertyDescriptor,Ji=(e,t,a,s)=>{for(var i=s>1?void 0:s?Sc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Cc(t,a,i),i};let Ta=class extends S{constructor(){super(...arguments),this.groups=[]}willUpdate(e){e.has("groups")&&(this.selectedId=this.groups.flatMap(t=>t.items??[]).find(t=>t.selected)?.id)}select(e){this.selectedId=e,this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{_item:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="rail">
                ${this.groups.map(e=>o`
                    <div class="group">
    ...
    `];Ji([h()],Ta.prototype,"actionId",2);Ji([h({type:Array})],Ta.prototype,"groups",2);Ji([$()],Ta.prototype,"selectedId",2);Ta=Ji([k("mateu-task-queue")],Ta);const Ic=e=>{const t=e.metadata;return o`
        <mateu-task-queue
                .actionId="${t.actionId}"
                .groups="${t.groups??[]}"
                style="${e.style??d}"
    ...
    `];Da([h()],Ut.prototype,"actionId",2);Da([h({type:Number})],Ut.prototype,"columns",2);Da([h()],Ut.prototype,"recommendedLabel",2);Da([h({type:Array})],Ut.prototype,"items",2);Da([$()],Ut.prototype,"selectedId",2);Ut=Da([k("mateu-resource-grid")],Ut);const Pc=e=>{const t=e.metadata;return o`
        <mateu-resource-grid
                .actionId="${t.actionId}"
                .columns="${t.columns??0}"
                ...
                slot="${e.slot??d}"
        ></mateu-resource-grid>
    `};var Tc=Object.defineProperty,Oc=Object.getOwnPropertyDescriptor,ze=(e,t,a,s)=>{for(var i=s>1?void 0:s?Oc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Tc(t,a,i),i};let he=class extends S{constructor(){super(...arguments),this.title="",this.features=[],this.current=!1,this.added=!1}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return o`
    ...
    `;ze([h()],he.prototype,"tag",2);ze([h()],he.prototype,"title",2);ze([h()],he.prototype,"subtitle",2);ze([h()],he.prototype,"image",2);ze([h({type:Array})],he.prototype,"features",2);ze([h()],he.prototype,"priceLabel",2);ze([h()],he.prototype,"actionLabel",2);ze([h()],he.prototype,"actionId",2);ze([h({type:Boolean})],he.prototype,"current",2);ze([h()],he.prototype,"currentLabel",2);ze([h({type:Boolean})],he.prototype,"added",2);ze([h()],he.prototype,"addedLabel",2);he=ze([k("mateu-offer-card")],he);const Rc=e=>{const t=e.metadata;return o`
        <mateu-offer-card
                .tag="${t.tag}"
                .title="${t.title??""}"
                .subtitle="${t.subtitle}"
                ...
                ${this.items.map(e=>{const t=e.id!=null&&this.added.has(e.id);return o`
                        <div class="card ${t?"added":""}">
                            ...
                            ${e.includedLabel?o`<span class="included">${e.includedLabel}</span>`:o`
                                    ${e.price!=null?o`
                                        <span class="price">${zi(e.price,this.currency)}${e.unit?` / ${e.unit}`:""}</span>
                                    `:d}
    ...
    `;Fa([h()],Bt.prototype,"totalLabel",2);Fa([h()],Bt.prototype,"currency",2);Fa([h()],Bt.prototype,"actionId",2);Fa([h({type:Array})],Bt.prototype,"items",2);Fa([$()],Bt.prototype,"added",2);Bt=Fa([k("mateu-addon-picker")],Bt);const jc=e=>{const t=e.metadata;return o`
        <mateu-addon-picker
                ...
                slot="${e.slot??d}"
        ></mateu-addon-picker>
    `};var Lc=Object.defineProperty,Dc=Object.getOwnPropertyDescriptor,ni=(e,t,a,s)=>{for(var i=s>1?void 0:s?Dc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Lc(t,a,i),i};let na=class extends S{constructor(){super(...arguments),this.lines=[]}computedTotal(){return this.total!=null?this.total:this.lines.filter(e=>!e.included).reduce((e,t)=>e+(t.amount??0),0)}render(){return o`
            ${this.lines.map(e=>o`
                <div class="row">
                    <span class="dot"></span>
                    <span class="concept">${e.concept}</span>
                    ${e.included?o`<span class="included-label">${e.includedLabel||"Included"}</span>`:o`<span class="amount ${(e.amount??0)<0?"negative":""}">${zi(e.amount??0,this.currency)}</span>`}
                </div>
            `)}
            <div class="total-row">
                <span class="total-label">${this.totalLabel||"Total"}</span>
                <span class="total">${zi(this.computedTotal(),this.currency)}</span>
            </div>
        `}};na.styles=C`
        :host {
    ...
    `;ni([h()],na.prototype,"currency",2);ni([h()],na.prototype,"totalLabel",2);ni([h({type:Array})],na.prototype,"lines",2);ni([h({type:Number})],na.prototype,"total",2);na=ni([k("mateu-ledger")],na);const Fc=e=>{const t=e.metadata;return o`
        <mateu-ledger
                .currency="${t.currency}"
                .totalLabel="${t.totalLabel}"
                .lines="${t.lines??[]}"
    ...
    `;Et([h()],Xe.prototype,"actionId",2);Et([h()],Xe.prototype,"methodActionId",2);Et([h({type:Array})],Xe.prototype,"methods",2);Et([h()],Xe.prototype,"selected",2);Et([h()],Xe.prototype,"contextLabel",2);Et([h()],Xe.prototype,"contextValue",2);Et([h()],Xe.prototype,"confirmLabel",2);Et([$()],Xe.prototype,"selectedId",2);Xe=Et([k("mateu-payment-picker")],Xe);const qc=e=>{const t=e.metadata;return o`
        <mateu-payment-picker
                ...
                slot="${e.slot??d}"
        ></mateu-payment-picker>
    `};var Uc=Object.defineProperty,Bc=Object.getOwnPropertyDescriptor,Kr=(e,t,a,s)=>{for(var i=s>1?void 0:s?Bc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Uc(t,a,i),i};let Li=class extends S{constructor(){super(...arguments),this.items=[]}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="list">
                ${this.items.map(e=>o`
                    <div class="row">
    ...
    `;Kr([h({type:Array})],Li.prototype,"items",2);Li=Kr([k("mateu-process-monitor")],Li);const Vc=e=>{const t=e.metadata;return o`
        <mateu-process-monitor
                ...
                slot="${e.slot??d}"
        ></mateu-process-monitor>
    `},Wc=(e,t)=>{let a=e.style;return e.id&&(a&&!a.endsWith(";")&&(a+=";"),a==null&&(a=""),t[e.id+".hidden"]==!0&&(a+="display: none;")),a},Hc=(e,t)=>{let a={...e.metadata};if(e.id&&a){if(a.type==v.Button){const s=a;t[e.id+".disabled"]==!0&&(s.disabled=!0)}if(a.type==v.FormField){const s=a;t[e.id+".disabled"]==!0&&(s.disabled=!0)}}return a},j=e=>t=>e(t.container,t.component,t.baseUrl,t.state,t.data,t.appState,t.appData),Gc={[v.Bpmn]:({component:e})=>Rl(e),[v.Workflow]:({component:e})=>zl(e),[v.WorkflowElk]:({component:e})=>jl(e),[v.FormEditor]:({component:e})=>Ll(e),[v.Page]:j(ys),[v.Div]:j(Pl),[v.Directory]:({component:e,baseUrl:t,state:a,data:s})=>El(e),[v.FormLayout]:j(an),[v.HorizontalLayout]:j(on),[v.VerticalLayout]:j(nn),[v.SplitLayout]:j(ln),[v.MasterDetailLayout]:j(dn),[v.TabLayout]:j(cn),[v.AccordionLayout]:j(pn),[v.BoardLayout]:j(bn),[v.BoardLayoutRow]:j(gn),[v.BoardLayoutItem]:j($n),[v.Scroller]:j(mn),[v.FullWidth]:j(vn),[v.Container]:j(fn),[v.Form]:({container:e,component:t,baseUrl:a,state:s,data:i,appState:r,appData:n})=>{const l=t.metadata;return o`<mateu-form
            id="${t.id}"
        baseUrl="${a}"
            .component="${t}"
            .values="${s}"
...
`)}
        ...
        baseUrl="${a}"
            ...
            >
             ${t.children?.map(l=>w(e,l,a,s,i,r,n))}
            </mateu-table>`,[v.Crud]:j(xs),[v.App]:({container:e,component:t,baseUrl:a,state:s,data:i,appState:r,appData:n})=>o`
            <mateu-app
                        id="${t.id}"
                        baseUrl="${a}"
                        .component="${t}"
            ...
            >
             ${t.children?.map(l=>w(e,l,a,s,i,r,n))}
         </mateu-app>`,[v.Element]:({container:e,component:t})=>al(e,t.metadata,t),[v.FormField]:({container:e,component:t,baseUrl:a,state:s,data:i,appState:r,appData:n,labelAlreadyRendered:l})=>{const c=t.metadata;return o`
    <mateu-field
                   id="${t.id}"
                   .component="${t}"
            .field="${t.metadata}"
        ...
        `},[v.Text]:({component:e,state:t,data:a,appState:s,appData:i})=>il(e,t,a,s,i),[v.Avatar]:({component:e,state:t,data:a})=>xn(e,t,a),[v.Chat]:({component:e,state:t,data:a})=>Al(e),[v.AvatarGroup]:({component:e})=>wn(e),[v.Badge]:({component:e,state:t,data:a})=>sl(e,t,a),[v.Breadcrumbs]:({component:e})=>Il(e),[v.Anchor]:({component:e})=>ol(e),[v.Button]:({component:e,state:t,data:a})=>cl(e,t,a),[v.Card]:j(ul),[v.Chart]:({component:e})=>pl(e),[v.Icon]:({component:e})=>hl(e),[v.ConfirmDialog]:j(ml),[v.ContextMenu]:j(Yn),[v.CookieConsent]:({component:e})=>vl(e),[v.Details]:j(fl),[v.Dialog]:({component:e,baseUrl:t,state:a,data:s,appState:i,appData:r})=>bl(e,t,a,s,i,r),[v.Drawer]:({component:e,baseUrl:t,state:a,data:s,appState:i,appData:r})=>gl(e,t,a,s,i,r),[v.Image]:({component:e})=>Sl(e),[v.Map]:({component:e})=>Cl(e),[v.Markdown]:({component:e})=>yl(e),[v.MicroFrontend]:({component:e})=>$l(e),[v.Notification]:({component:e})=>xl(e),[v.ProgressBar]:({component:e,state:t})=>wl(e,t),[v.Popover]:j(kl),[v.CarouselLayout]:j(_l),[v.Tooltip]:j(Zn),[v.MessageInput]:({component:e})=>Qn(e),[v.MessageList]:({component:e})=>Kn(e),[v.CustomField]:j(Xn),[v.MenuBar]:({container:e,component:t,baseUrl:a,state:s,data:i})=>Jn(e,t,a,s,i),[v.Grid]:j(Gn),[v.VirtualList]:j(kn),[v.FormSection]:j(Tl),[v.FormSubSection]:j(Ol),[v.MetricCard]:({component:e})=>Ml(e),[v.Scoreboard]:j(ql),[v.DashboardPanel]:j(Ul),[v.DashboardLayout]:j(Bl),[v.FoldoutLayout]:j(Hl),[v.HeroSection]:j(Gl),[v.EmptyState]:({component:e})=>_n(e),[v.Skeleton]:({component:e})=>En(e),[v.Gantt]:({component:e})=>Jl(e),[v.PlanningBoard]:({component:e})=>Zl(e),[v.Kanban]:({component:e})=>ad(e),[v.Timeline]:({component:e})=>rd(e),[v.ProgressSteps]:({component:e})=>ld(e),[v.Stat]:({component:e})=>ud(e),[v.Calendar]:({component:e})=>md(e),[v.PricingTable]:({component:e})=>bd(e),[v.OrgChart]:({component:e})=>yd(e),[v.Heatmap]:({component:e})=>Cd(e),[v.Funnel]:({component:e})=>_d(e),[v.TrendChart]:({component:e})=>Td(e),[v.FeatureGrid]:({component:e})=>Ad(e),[v.Testimonials]:({component:e})=>Ld(e),[v.Faq]:({component:e})=>Nd(e),[v.CalloutCard]:({component:e})=>Ud(e),[v.CommentThread]:({component:e})=>Wd(e),[v.FileList]:({component:e})=>Yd(e),[v.Checklist]:({component:e})=>Qd(e),[v.ComparisonCard]:({component:e})=>tc(e),[v.EntityHeader]:({component:e})=>oc(e),[v.Meter]:({component:e})=>dc(e),[v.TaskProgress]:({component:e})=>pc(e),[v.StatusList]:({component:e})=>vc(e),[v.BulletedList]:({component:e})=>gc(e),[v.Separator]:({component:e})=>$c(e),[v.Notice]:j(kc),[v.TaskQueue]:({component:e})=>Ic(e),[v.ResourceGrid]:({component:e})=>Pc(e),[v.OfferCard]:({component:e})=>Rc(e),[v.AddOnPicker]:({component:e})=>jc(e),[v.Ledger]:({component:e})=>Fc(e),[v.PaymentPicker]:({component:e})=>qc(e),[v.ProcessMonitor]:({component:e})=>Vc(e)},js=(e,t,a,s,i,r,n,l)=>{if(!t?.metadata)return t==null?(console.warn("No metadata for component",t),o`<p>No metadata for component</p>`):js(e,{id:ye(),metadata:t,type:oe.ClientSide},a,s,i,r,n,l);const c=t.metadata.type,u={...t,style:Wc(t,i),metadata:Hc(t,i)},m=Gc[c];return m?m({container:e,component:u,baseUrl:a,state:s,data:i,appState:r,appData:n,labelAlreadyRendered:l}):o`<p ${u?.slot??d}>Unknown metadata type ${c} for component ${u?.id}</p>`};var $e=(e=>(e.HAMBURGUER_MENU="HAMBURGUER_MENU",e.MENU_ON_LEFT="MENU_ON_LEFT",e.MENU_ON_TOP="MENU_ON_TOP",e.TABS="TABS",e.TILES="TILES",e.RAIL="RAIL",e.AUTO="AUTO",e.MEDIATOR="MEDIATOR",e))($e||{});const Ls="mateu-app-context",Yr="mateu-app-context-labels",Jr=e=>{try{return JSON.parse(localStorage.getItem(e)??"{}")}catch{return{}}},tr=(e,t)=>{try{localStorage.setItem(e,JSON.stringify(t))}catch{}},Xi=()=>Jr(Ls),Ds=()=>Jr(Yr),Xr=(e,t,a)=>{const s=Xi(),i=Ds();t==null||t===""?(delete s[e],delete i[e]):(s[e]=t,a!==void 0&&(i[e]=a)),tr(Ls,s),tr(Yr,i)};let ar=!1;const Qr=()=>{ar||(ar=!0,window.addEventListener("storage",e=>{e.key===Ls&&e.newValue!==e.oldValue&&window.location.reload()}))},Kc=(e,t)=>new Promise((a,s)=>{let i=!1;const r={retry:()=>{i||(i=!0,t().then(a,s))},giveUp:()=>{i||(i=!0,s(e))}},n=new CustomEvent("mateu-session-expired",{detail:r,cancelable:!0,bubbles:!1});typeof document<"u"&&!document.dispatchEvent(n)||r.giveUp()}),Yc=(e,t)=>e.includes("json")?!0:t!==null&&typeof t=="object",Jc=(e,t)=>{const a=e.finalUrl;if(!a)return;const s=typeof window<"u"?window.location.href:void 0;let i;try{i=new URL(e.requestedUrl,s).href}catch{return}if(i!==a&&!Yc(e.contentType??"",e.data))return a};let Ca=[];class Xc{constructor(){this.axiosInstance=Yo.create({timeout:6e4}),this.axiosInstance.interceptors.request.use(t=>(this.addAuthToken(t),this.addSessionId(t),t)),this.axiosInstance.interceptors.response.use(t=>{const a=Jc({requestedUrl:this.axiosInstance.getUri(t.config),finalUrl:t.request?.responseURL,contentType:String(t.headers?.["content-type"]??""),data:t.data});if(a)throw window.location.assign(a),Object.assign(new Error("session lost — redirecting to "+a),{code:"ERR_CANCELED"});return t},t=>{const a=t;if(a?.response?.status===401&&a.config&&!a.config.__mateuRetried){const s=a.config;return s.__mateuRetried=!0,Kc(t,()=>this.axiosInstance.request(s))}throw t})}addSessionId(t){let a=sessionStorage.getItem("__mateu_sesion_id");a||(a=ye(),sessionStorage.setItem("__mateu_sesion_id",a)),t.headers["X-Session-Id"]=a}addAuthToken(t){const a=localStorage.getItem("__mateu_auth_token");a&&(t.headers.Authorization="Bearer "+a)}async wrap(t,a,s,i){return s||a.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),t.then(r=>(a.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:i}})),r)).catch(r=>{throw r?.code=="ERR_CANCELED"?a.dispatchEvent(new CustomEvent("backend-cancelled-event",{bubbles:!0,composed:!0,detail:{}})):a.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:i,reason:this.serialize(r)}})),r})}serialize(t){return t?.message?t:JSON.stringify(t)}async get(t){const a=new AbortController;return Ca=[...Ca,a],this.axiosInstance.get(t,{signal:a.signal})}async post(t,a){const s=new AbortController;return Ca=[...Ca,s],this.axiosInstance.post(t,a,{signal:s.signal})}async abortAll(){Ca.forEach(t=>t.abort()),Ca=[]}async runAction(t,a,s,i,r,n,l,c,u,m,p){return a&&a.startsWith("/")&&(a=a.substring(1)),n={...Xi(),...n},await this.wrap(this.post(t+"/mateu/v3/sync/"+(a&&a!=""?a:"_no_route"),{serverSideType:l,appState:n,componentState:c,parameters:u,initiatorComponentId:r,consumedRoute:s,route:a&&a!=""?"/"+a:"",actionId:i}).then(f=>f.data),m,p,i)}}const $a=new Xc;var Qc=Object.defineProperty,Zc=Object.getOwnPropertyDescriptor,Qi=(e,t,a,s)=>{for(var i=s>1?void 0:s?Zc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Qc(t,a,i),i};let Vt=class extends S{constructor(){super(...arguments),this.baseUrl="",this.dataProvider=async(e,t)=>{const a=e.filter??"",i=await this.remoteSearch(a)??(this.selector.options??[]).filter(r=>r.label.toLowerCase().includes(a.toLowerCase()));t(i,i.length)}}connectedCallback(){super.connectedCallback(),Qr()}currentValue(){return String(Xi()[this.selector.fieldName]??"")}currentLabel(){const e=this.currentValue();if(!e)return"";const t=(this.selector.options??[]).find(s=>String(s.value)===e);if(t)return t.label;const a=Ds()[this.selector.fieldName];return a!==void 0?String(a):e}pick(e,t){String(e??"")!==this.currentValue()&&(Xr(this.selector.fieldName,e,t),window.location.reload())}async remoteSearch(e){const t=this.app;if(t?.serverSideType)try{const a=await $a.runAction(this.baseUrl??"",t.rootRoute??t.initialRoute??"","",`_appcontext-search-${this.selector.fieldName}`,`appcontext-${this.selector.fieldName}`,void 0,t.serverSideType,{},{searchText:e},this,!0);for(const s of a?.fragments??[]){const n=s.data?.[`_appcontext_${this.selector.fieldName}`]?.content;if(Array.isArray(n))return n.map(l=>({value:l.value,label:l.label??String(l.value)}))}}catch{}}renderSelect(){const e=[{label:"—",value:""},...(this.selector.options??[]).map(t=>({label:t.label,value:String(t.value)}))];return o`
            ...
            <vaadin-combo-box theme="small"
                              ...
                              .selectedItem="${t}"
                              @selected-item-changed="${a=>{const s=a.detail.value;this.pick(s?.value??"",s?.label)}}"></vaadin-combo-box>`}render(){if(!this.selector)return o``;const e=(this.selector.options?.length??0)>Vt.SEARCHABLE_THRESHOLD;return o`
            <label class="root">
                <span class="label">${this.selector.label}</span>
                ${e?this.renderComboBox():this.renderSelect()}
            </label>`}};Vt.SEARCHABLE_THRESHOLD=7;Vt.styles=C`
        :host {
            display: inline-flex;
            flex-shrink: 0;
        }
    ...
    `;li([h()],la.prototype,"app",2);li([h()],la.prototype,"baseUrl",2);li([$()],la.prototype,"opened",2);li([$()],la.prototype,"notifications",2);la=li([k("mateu-notification-bell")],la);class iu{async handle(t,a){return await t.runAction(a.baseUrl,a.route,a.consumedRoute,a.actionId,a.initiatorComponentId,a.appState,a.serverSideType,a.componentState,a.parameters,a.initiator,a.background)}}const su=new iu;class ru{constructor(){this.mapPosition=t=>{switch(t){case"topStretch":return"top-stretch";case"topStart":return"top-start";case"topCenter":return"top-center";case"topEnd":return"top-end";case"middle":return"middle";case"bottomStart":return"bottom-start";case"bottomEnd":return"bottom-end";case"bottomStretch":return"bottom-stretch";case"bottomCenter":return"bottom-center"}return"bottom-end"},this.handleUIIncrement=(t,a,s)=>{if(t?.fragments?.forEach(i=>{Ft.next({command:void 0,fragment:i,ui:void 0,error:void 0,callbackToken:s})}),t?.appState&&(le.value={...t.appState},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))),t?.appData){const i=t?.appData;Qa.value={...t.appData,...i},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))}t?.messages?.forEach(i=>{ra.show(i.text,{position:i.position?this.mapPosition(i.position):void 0,theme:i.variant,duration:i.duration})}),t?.banners&&t.banners.length>0&&document.dispatchEvent(new CustomEvent("page-banners-received",{detail:{banners:t.banners,append:t.appendBanners??!1},bubbles:!1,composed:!1})),t?.commands?.forEach(i=>{Ft.next({command:i,fragment:void 0,ui:void 0,error:void 0,callbackToken:s})})}}async runAction(t,a,s,i,r,n,l,c,u,m,p,f,g,y,x){try{const P=await su.handle(t,{baseUrl:a,route:s,consumedRoute:i,actionId:r,appState:le.value,initiatorComponentId:n,componentState:u,parameters:m,serverSideType:c,initiator:p,background:f});g&&g(P),y||this.handleUIIncrement(P,p,x),P.messages&&P.messages.length==1&&P.messages[0].variant=="error"&&p.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0})),p.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:r,evevntId:ye()},bubbles:!0,composed:!0}))}catch(P){console.warn("Action request failed",P),p.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:r,reason:this.serialize(P)}})),p.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))}}serialize(t){return t?.message?t:JSON.stringify(t)}}const ou=new ru;class nu{constructor(){this.mapPosition=t=>{switch(t){case"topStretch":return"top-stretch";case"topStart":return"top-start";case"topCenter":return"top-center";case"topEnd":return"top-end";case"middle":return"middle";case"bottomStart":return"bottom-start";case"bottomEnd":return"bottom-end";case"bottomStretch":return"bottom-stretch";case"bottomCenter":return"bottom-center"}return"bottom-end"},this.handleUIIncrement=(t,a,s)=>{if(t?.messages?.forEach(i=>{if(i.undoActionId){this.showUndoableMessage(i,a);return}ra.show(i.text,{position:i.position?this.mapPosition(i.position):"bottom-end",theme:i.variant,duration:i.duration})}),t?.banners&&t.banners.length>0&&document.dispatchEvent(new CustomEvent("page-banners-received",{detail:{banners:t.banners,append:t.appendBanners??!1},bubbles:!1,composed:!1})),t?.commands?.forEach(i=>{Ft.next({command:i,fragment:void 0,ui:void 0,error:void 0,callbackToken:s})}),t?.fragments?.forEach(i=>{Ft.next({command:void 0,fragment:i,ui:void 0,error:void 0,callbackToken:s})}),t?.appState&&(le.value={...t.appState},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))),t?.appData){const i=t?.appData;Qa.value={...t.appData,...i},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))}}}async runAction(t,a,s,i,r,n,l,c,u,m,p,f,g,y,x){if(s){s=s||"_no_route",s&&s.startsWith("/")&&(s=s.substring(1));const P={serverSideType:c,appState:le.value,componentState:u,parameters:m,initiatorComponentId:n,consumedRoute:i,route:"/"+s,actionId:r};f||p.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),fetch(a+"/mateu/v3/sse/"+s,{method:"POST",headers:{Accept:"text/event-stream","Content-Type":"application/json"},body:JSON.stringify(P)}).then(async U=>{const ae=U.body?.pipeThrough(new TextDecoderStream).getReader();if(ae){let N="";for(;;){const{value:ne,done:ue}=await ae.read();if(ue)break;N+=ne;const ie=N.split(`

`);N=ie.pop()??"";for(const Y of ie){const ee=Y.trim();if(ee)if(ee.startsWith("data:")){const fe=JSON.parse(ee.substring(5).trim());g&&g(fe),y||this.handleUIIncrement(fe,p,x),fe.messages&&fe.messages.length==1&&fe.messages[0].variant=="error"&&p.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))}else{let fe=ee;try{const I=JSON.parse(ee);fe=I.message,I._embedded?.errors?.length>0&&I._embedded.errors[0].message&&(fe=I._embedded.errors[0].message)}catch{}throw new Error(fe)}}}}f||p.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:r}})),p.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:r},bubbles:!0,composed:!0}))}).catch(U=>{p.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:r,reason:this.serialize(U)}})),p.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))})}}serialize(t){return t?.message?t:JSON.stringify(t)}showUndoableMessage(t,a){const s=new ra;s.position=t.position?this.mapPosition(t.position):"bottom-end",s.duration=t.duration??1e4,t.variant&&s.setAttribute("theme",t.variant),s.renderer=i=>{if(i.firstElementChild)return;const r=document.createElement("span");r.textContent=t.text;const n=document.createElement("button");n.textContent=t.undoLabel??"Undo",n.style.cssText="margin-left: 0.75rem; background: none; border: 1px solid currentColor; border-radius: var(--lumo-border-radius-s, 4px); color: inherit; cursor: pointer; padding: 0.15rem 0.6rem; font: inherit; font-weight: 600;",n.addEventListener("click",()=>{a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.undoActionId,parameters:t.undoParameters??{}},bubbles:!0,composed:!0})),s.opened=!1}),i.append(r,n)},document.body.appendChild(s),s.opened=!0,s.addEventListener("opened-changed",i=>{i.detail.value||s.remove()})}}const Zr=new nu,eo=e=>{if(!e||!("querySelectorAll"in e))return null;for(const t of e.querySelectorAll("*")){if(t.tagName?.toLowerCase()==="mateu-component")return t;const a=eo(t.shadowRoot);if(a)return a}return null},to=async(e,t,a)=>{const s=t.renderRoot??t,i=eo(s);await Zr.runAction($a,t.baseUrl??"",e.rootRoute||"_no_route","",a,i?.id??"app-header-action",{},e.serverSideType??"",{},{},i??t,!0,void 0,!1,"")},ir=async(e,t,a)=>{try{await to(e,t,a)}catch(s){ra.show("La acción falló: "+s,{position:"bottom-start",duration:6e3,theme:"error"})}},Wa=(e,t)=>{const a=e.contextSelectors??[],s=e.contextActions??[];return a.length===0&&s.length===0&&!e.notificationsEnabled?d:o`${e.notificationsEnabled?o`
        ...
        <vaadin-menu-bar theme="primary small" style="margin-left: 0.5rem; flex-shrink: 0;"
            ...
            @item-selected="${r=>{const n=r.detail?.value?.actionId;n&&ir(e,t,n)}}"></vaadin-menu-bar>`:o`
        <vaadin-button theme="primary small" style="margin-left: 0.5rem; flex-shrink: 0;"
            @click="${()=>i.actionId&&ir(e,t,i.actionId)}" title="${i.label}">
            ${i.icon?o`<vaadin-icon icon="${i.icon}" slot="prefix"></vaadin-icon>`:d}${i.label}
        </vaadin-button>`)}`},xi=(e,t)=>e.themeToggle?o`
    ...
    `:d,lu=(e,t)=>{t.filter!=e.detail.value&&(t.filter=e.detail.value)},sr=(e,t,a)=>{const s=Fe(e,t,a),i=re(t,a);return s=="list"||s==i?"new":s},Fe=(e,t,a)=>{const s=e?._route;if(s!=null&&(s===""||s.startsWith("/"))){const i=a.homeRoute??"",r=i.indexOf("?"),n=r>=0?i.substring(r+1):"",l=re(t,a)+s;if(!n)return l;const c=l.indexOf("?")>=0?"&":"?";return l+c+n}return t.selectedRoute?t.selectedRoute:a.homeRoute},re=(e,t)=>e.selectedRoute?e.selectedConsumedRoute??t.route:t.homeConsumedRoute,_e=(e,t)=>e.selectedRoute?e.selectedBaseUrl??e.baseUrl:t.homeBaseUrl,Ee=(e,t)=>e.selectedRoute?e.selectedServerSideType??t.serverSideType:t.homeServerSideType,Pe=(e,t)=>e.selectedRoute?e.selectedUriPrefix:t.homeUriPrefix,du=(e,t,a,s,i,r,n)=>{const l=e.mapItems(t.menu,e.filter?.toLowerCase()??""),c=re(e,t),u=sr(s,e,t),m=u&&u!=="new"&&u.startsWith(c+"/")?u.substring(c.length+1).split("/")[0]:void 0;return o`
...
`:d}
                ...
                <vaadin-app-layout style="${t?.style}" class="${t?.cssClasses}" .drawerOpened=${!t.drawerClosed}>
                    ...
                    <vaadin-scroller slot="drawer" class="p-s"
                        ...
                        ${t.menu&&t.totalMenuOptions>10?o`
                            <vaadin-text-field style="width: calc(100% - 20px); padding-left: 10px; padding-right: 10px;" @value-changed="${p=>lu(p,e)}">
            ...
            <slot></slot>
       `},cu=(e,t)=>t!=null&&e!=null&&!e.has(t),uu=typeof HTMLElement<"u"?HTMLElement:class{};class pu extends uu{static get observedAttributes(){return["type","renderer"]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){const t=this.getAttribute("type")??"unknown",a=this.getAttribute("renderer")??"unknown";this.shadowRoot||this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host { display: block; }
                .mateu-unsupported {
                    box-sizing: border-box;
        ...
        `}}typeof customElements<"u"&&!customElements.get("mateu-unsupported")&&customElements.define("mateu-unsupported",pu);const rr=new Set,hu=(e,t,a)=>{const s=`${a}/${t}`;return rr.has(s)||(rr.add(s),console.warn(`[mateu] Component type "${t}" is not supported by the "${a}" renderer — rendering <mateu-unsupported> placeholder.`)),o`<mateu-unsupported
            type="${t}"
            renderer="${a}"
            data-component-id="${e?.id??d}"
            slot="${e?.slot??d}"
    ></mateu-unsupported>`};class mu{renderFilterBar(t,a,s,i,r,n,l,c){const u=a?.metadata,m=f=>{const{fieldId:g,value:y}=f.detail;t.state={...t.state,[g]:y}},p=f=>{const{fieldIds:g}=f.detail,y={};g.forEach(x=>{y[x]=void 0}),y.searchText=void 0,t.state={...t.state,...y}};return o`
            <mateu-filter-bar
                .metadata="${u}"
        ...
        <mateu-table id="${t.id}"
                     ...
                     baseUrl="${s}"
        ></mateu-table>
        `}rendererName(){return this.constructor?.name??"unknown"}supportedClientSideTypes(){}renderClientSideComponent(t,a,s,i,r,n,l,c){const u=a?.metadata?.type??a?.type,m=Object.values(v).includes(u)?u:void 0;return cu(this.supportedClientSideTypes(),m)?hu(a,m,this.rendererName()):js(t,a,s,i,r,n,l,c)}renderAppComponent(t,a,s,i,r,n,l){return du(t,a?.metadata,s,i,r,n,l)}}const or="border-left: 1px solid var(--oj-core-text-color-secondary, #888); height: 1.5rem; display: inline-block; align-self: center;",vu=(e,t,a,s)=>{const i=e.metadata,r=e.slot??d;if(i.children&&i.children.length>0){const l=i.children.map(c=>({key:c.actionId,label:c.label,disabled:c.disabled??!1}));return o`
            ${i.separatorBefore?o`<span slot="${r}" style="${or}"></span>`:d}
            <oj-c-menu-button
    ...
    `;ci([h()],ca.prototype,"fieldId",2);ci([h()],ca.prototype,"value",2);ci([$()],ca.prototype,"cameraOpen",2);ci([$()],ca.prototype,"cameraError",2);ca=ci([k("mateu-camera-capture")],ca);var wu=Object.defineProperty,ku=Object.getOwnPropertyDescriptor,ui=(e,t,a,s)=>{for(var i=s>1?void 0:s?ku(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&wu(t,a,i),i};const ao=(e,t)=>{if(!e)return;if(Array.isArray(e)){const s=e.find(i=>i.key==t);return s?.value!=null?String(s.value):void 0}const a=e[t];return a!=null?String(a):void 0};let Wt=class extends S{constructor(){super(...arguments),this.fieldId="",this.editable=!0,this.filePicked=e=>{const t=e.target,a=t.files?.[0];if(!a)return;const s=new FileReader;s.onload=()=>{const i=s.result,r=i.indexOf(","),n=i.substring(0,r).replace(";base64",`;name=${encodeURIComponent(a.name)};base64`);this.emit(n+i.substring(r))},s.readAsDataURL(a),t.value=""}}static fileName(e){if(!e)return"";if(e.startsWith("data:")){const t=e.indexOf(","),s=e.substring(5,t<0?e.length:t).split(";").find(i=>i.startsWith("name="));if(s)try{return decodeURIComponent(s.substring(5))}catch{return s.substring(5)}return"Attached file"}return e.split("/").pop()||e}emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e,fieldId:this.fieldId},bubbles:!0,composed:!0}))}triggerPick(){this.renderRoot.querySelector("input[type=file]")?.click()}render(){const e=this.value!=null&&this.value!=="",t=Wt.fileName(this.value),a=e&&this.value.startsWith("data:"),s=e?o`<span class="file" title="${t}">📄 ${a?o`<a href="${this.value}" download="${t}">${t}</a>`:o`<a href="${this.value}" target="_blank">${t}</a>`}</span>`:d;return this.editable?o`
            ...
            </div>`:o`${e?s:o`<span class="empty">—</span>`}`}};Wt.styles=C`
        :host {
            display: block;
        }
        .row {
    ...
    `;ui([h()],Wt.prototype,"fieldId",2);ui([h()],Wt.prototype,"value",2);ui([h()],Wt.prototype,"accept",2);ui([h({type:Boolean})],Wt.prototype,"editable",2);Wt=ui([k("mateu-file-upload")],Wt);const Cu=76;function nr(e){if(e.weight!=null)return e.weight;const t=e.stereotype??"";if(t==="icon")return 1;if(t==="image")return 4;if(t==="html"||t==="richText"||t==="markdown"||t==="textarea")return 5;if(t==="link")return 2.5;if(t==="combobox"||t==="select")return 2;const a=e.dataType??"";return a==="bool"?1:a==="status"||a==="integer"?1.5:a==="number"||a==="date"||a==="money"?2:a==="dateTime"||a==="dateRange"?2.5:3}function io(e,t){if(e.length===0)return"table";const a=e.reduce((c,u)=>c+nr(u),0),s=t/Cu,i=a/s;if(i<=1)return"table";const r=e.filter(c=>c.identifier||(c.priority??Number.MAX_SAFE_INTEGER)<=2),n=r.reduce((c,u)=>c+nr(u),0);return i>1.6||e.length>10?"masterDetail":r.length>0&&n<=8?"list":e.some(c=>c.stereotype==="image"||c.stereotype==="html")||r.length===0&&e.length>=4&&e.length<=8?"cards":"masterDetail"}function Di(e){return e.filter(t=>t.identifier||(t.priority??Number.MAX_SAFE_INTEGER)<=2).sort((t,a)=>(t.priority??Number.MAX_SAFE_INTEGER)-(a.priority??Number.MAX_SAFE_INTEGER))}function Su(e){const t=Di(e);return t.length>0?t:e.slice(0,3)}var Iu=Object.defineProperty,_u=Object.getOwnPropertyDescriptor,Fs=(e,t,a,s)=>{for(var i=s>1?void 0:s?_u(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Iu(t,a,i),i};let Fi=class extends S{constructor(){super(...arguments),this.actions=[],this.rowdata={}}createRenderRoot(){return this}handleMenuAction(e){e.stopPropagation();const t=e.detail?.key;t&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t,parameters:{_clickedRow:this.rowdata}},bubbles:!0,composed:!0}))}render(){const e=this.actions??[];if(!e.length)return o`${d}`;const t=e.map(a=>({label:a.label??a.text??"",key:a.methodNameInCrud??a.actionId??a.id??a.key??a.label,disabled:a.disabled??!1}));return o`
            <oj-c-menu-button
                data-oj-binding-provider="preact"
                label="···"
                chroming="borderless"
...
data-oj-binding-provider="preact" label="[[cell.data == null ? '' : '' + cell.data]]" chroming="borderless"></oj-c-button>`,e+="</span>",e+="</template>"}else if(a.dataType==="status")e+=`<template slot="${a.id}Template" data-oj-as="cell">`,e+="<oj-c-badge",e+=` label="[[cell.data ? (cell.data.message || String(cell.data)) : '']]"`,e+=` variant="[[cell.data ? (cell.data.type === 'SUCCESS' ? 'successSubtle' : cell.data.type === 'DANGER' ? 'dangerSubtle' : cell.data.type === 'WARNING' ? 'warningSubtle' : cell.data.type === 'INFO' ? 'infoSubtle' : 'neutral') : 'neutral']]"`,e+="></oj-c-badge>",e+="</template>";else if(a.dataType==="actionGroup"||a.dataType==="menu")e+=`<template slot="${a.id}Template" data-oj-as="cell">`,e+="<oj-c-menu-button",e+=' data-oj-binding-provider="preact"',e+=' label="···"',e+=' chroming="borderless"',e+=` :items="[[cell.data && cell.data.actions ? cell.data.actions.map(function(a){return {label:a.label||a.text||'',key:(cell.item.key+'')+'|'+(a.methodNameInCrud||a.actionId||a.id||a.key||(a.label||'')),disabled:!!a.disabled};}) : []]]"`,e+="></oj-c-menu-button>",e+="</template>";else if(a.dataType==="action"){const s=a.actionId||a.id;e+=`<template slot="${a.id}Template" data-oj-as="cell">`,e+="<oj-c-menu-button",e+=' data-oj-binding-provider="preact"',e+=' label="···"',e+=' chroming="borderless"',e+=` :items="[[cell.data ? [{label:cell.data.label||cell.data.text||'${s}',key:(cell.item.key+'')+'|'+(cell.data.methodNameInCrud||'${s}'),disabled:!!cell.data.disabled}] : []]]"`,e+="></oj-c-menu-button>",e+="</template>"}}),e}refreshDataProvider(){const e=()=>{const t=this.data[this.id]?.page?.content??[];this.dataProvider=new H._ADP(t,{keyAttributes:"@index"}),this.scheduleMount()};H._ADP?e():require(["ojs/ojarraydataprovider"],t=>{H._ADP=t.default??t,this.isConnected&&e()})}scheduleMount(){this.mountTimer&&clearTimeout(this.mountTimer),this.mountTimer=setTimeout(()=>{this.mountTimer=null,this.mountTable()},60)}mountTable(){const e=this.querySelector(".rwt-table-host");if(!e)return;const t=document.createElement("oj-c-table");t.setAttribute("data-oj-binding-provider","preact"),t.setAttribute("aria-label","Data table"),t.setAttribute("layout","contents"),t.style.width="100%";const a=this.getTemplateSlots();if(a){const s=document.createElement("div");s.innerHTML=a,Array.from(s.childNodes).forEach(i=>t.appendChild(i))}t.columns=this.getOjColumns(),t.selectionMode=this.metadata?.rowsSelectionEnabled?{row:"multiple"}:{row:"none"},t.addEventListener("ojRowAction",s=>this.handleRowAction(s)),t.addEventListener("ojAction",s=>this.handleCellButtonAction(s)),t.addEventListener("selectedChanged",s=>this.handleSelectedChanged(s)),t.addEventListener("ojMenuAction",s=>this.handleMenuAction(s)),t.data=this.dataProvider,e.replaceChildren(t)}updated(e){super.updated(e),e.has("metadata")&&(this.lastContentRef=!1);const t=this.data?.[this.id]?.page?.content,a=Array.isArray(t)?t.length:0,s=t!==this.lastContentRef||a!==this.lastContentLen;if(s&&(this.lastContentRef=t,this.lastContentLen=a),this.effectiveGridLayout==="table"&&!this.groupedTableActive){const i=this.querySelector(".rwt-table-host");(s||i&&i.childElementCount===0)&&this.refreshDataProvider()}else s&&(this.collapsedNodes.clear(),this.requestUpdate())}handleRowAction(e){const t=e.detail?.context?.item?.data;if(!t)return;const a=this.metadata?.columns?.find(s=>{const i=s.metadata;return i.stereotype==="button"&&i.actionId});if(a){const s=a.metadata;this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:s.actionId,parameters:t},bubbles:!0,composed:!0}))}}handleCellButtonAction(e){const t=e.composedPath();let a=null,s=null;for(const n of t){const l=n;if(l.getAttribute("data-mateu-row-key")){const c=l.getAttribute("data-mateu-row-key");if(c!==null){a=c,s=l.getAttribute("data-mateu-action-id");break}}}if(a===null)return;const r=(this.data[this.id]?.page?.content??[]).find((n,l)=>n._rowNumber==a)??{};this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:s??"",parameters:r},bubbles:!0,composed:!0}))}handleMenuAction(e){const t=e.detail?.key;if(!t)return;const a=t.indexOf("|");if(a<0)return;const s=parseInt(t.substring(0,a)),i=t.substring(a+1),n=(this.data[this.id]?.page?.content??[])[s]??{};this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:i,parameters:n},bubbles:!0,composed:!0}))}handleSelectedChanged(e){const t=e.detail.value?.row;if(!t)return;const a=this.data[this.id]?.page?.content??[],s=t.isAddAll()?a:a.filter((i,r)=>t.has(r));this.state.crud_selected_items=s}dispatchAction(e,t){this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e,parameters:t},bubbles:!0,composed:!0}))}openRow(e){const t=this.identifierFieldName;t&&e[t]!==void 0&&(this.state._selectedId=String(e[t])),this.dispatchAction("view",e),this.requestUpdate()}isSelectedRow(e){const t=this.identifierFieldName,a=this.state?._selectedId??this.appState?._splitDetailId;return!!t&&a!==void 0&&String(e[t])===String(a)}static isActionButtonCol(e){return e.dataType==="action"||e.dataType==="actionGroup"||e.dataType==="menu"||e.stereotype==="button"}statusBadge(e){const t=(e?.type??"").toUpperCase();return o`<span style="${t==="SUCCESS"?"background: rgba(104, 150, 90, 0.18); color: rgb(49, 93, 36);":t==="DANGER"||t==="ERROR"?"background: rgba(179, 49, 31, 0.14); color: rgb(150, 40, 27);":t==="WARNING"?"background: rgba(190, 120, 0, 0.16); color: rgb(124, 79, 4);":t==="INFO"?"background: rgba(28, 101, 154, 0.14); color: rgb(28, 90, 131);":"background: rgba(22, 21, 19, 0.08); color: rgb(70, 68, 66);"} border-radius: 1rem; padding: 0.1rem 0.6rem; font-size: 0.75rem; font-weight: 600; white-space: nowrap;">${e?.message??String(e??"")}</span>`}formatValue(e,t){const a=t[e.id];return a==null?o``:e.dataType==="status"?this.statusBadge(a):e.dataType==="bool"||e.dataType==="boolean"?o`${a?"✓":"✗"}`:typeof a=="object"?o`${a.label??a.name??a.message??""}`:o`${a}`}linkButton(e,t,a){return o`
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 0.25rem; margin-top: 0.35rem; ${a?`padding-top: 0.5rem; border-top: 1px solid ${Ge};`:""}">
                ${s}
            </div>`:d}renderEmpty(){return o`
            <div style="padding: 1.5rem; text-align: center; color: ${zt}; font-size: 0.875rem;">
                ${this.emptyStateMessage??this.metadata?.emptyStateMessage??"No data."}
            </div>`}renderListItem(e,t,a,s,i,r){return o`
            <div role="listitem"
                 style="padding: 0.6rem 0.75rem; border-bottom: 1px solid ${Ge}; cursor: pointer; ${s?`background: ${wi};`:""}"
                 onmouseover="this.style.background='rgba(22,21,19,0.04)'"
                 onmouseout="this.style.background='${s?wi:"transparent"}'"
                 @click="${i}">
                <div style="font-weight: 600; color: ${Sa}; font-size: 0.875rem;">${t?e[t.id]??"":""}</div>
                <div style="font-size: 0.8125rem; color: ${zt}; display: flex; flex-wrap: wrap; gap: 0.25rem 0.75rem; align-items: center;">
                    ${a.map(n=>o`<span>${n.label}: ${this.formatValue(n,e)}</span>`)}
                </div>
                ${r}
            </div>`}renderTwoLineList(e){const t=this.getRows(),a=Di(e),s=a.find(n=>n.identifier)??a[0],i=a.filter(n=>n!==s&&!H.isActionButtonCol(n)),r=e.filter(n=>H.isActionButtonCol(n));return o`
            <div role="list" style="width: 100%; background: ${Ha}; border: 1px solid ${Ge}; border-radius: 8px; overflow: hidden;">
            ...
            </div>`}renderCards(e){const t=this.getRows(),a=e.slice(0,6),s=a.filter(p=>p.stereotype==="image"),i=a.find(p=>p.identifier)??a[0],r=p=>!!p.actionId&&!H.isActionButtonCol(p),n=a.find(p=>p.id==="select"&&p.dataType==="action"),l=!!n,c=a.filter(p=>p!==i&&!s.includes(p)&&!r(p)&&!H.isActionButtonCol(p)),u=a.filter(p=>H.isActionButtonCol(p)&&!(l&&p===n)),m=(p,f)=>{l?(p.stopPropagation(),this.dispatchAction("action-on-row-select",{_clickedRow:f})):this.openRow(f)};return o`
            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 1rem; padding: 0.5rem 0;">
                ...
                ${t.map(p=>o`
                    <div style="background: ${Ha}; border: 1px solid ${this.isSelectedRow(p)?lr:Ge}; border-radius: 8px; box-shadow: 0 1px 4px rgba(0,0,0,0.08); overflow: hidden; cursor: pointer; display: flex; flex-direction: column;"
                        ...
                        <div style="padding: 0.75rem 1rem 1rem; display: flex; flex-direction: column; gap: 0.35rem; flex: 1;">
                            ${i?o`<div style="font-weight: 600; color: ${Sa}; font-size: 1rem; margin-bottom: 0.25rem;">${p[i.id]??""}</div>`:d}
                            ${c.map(f=>o`
                                <div style="display: flex; gap: 0.5rem; font-size: 0.8125rem; align-items: baseline;">
                                    <span style="color: ${zt}; min-width: 80px;">${f.label}</span>
                                    <span style="color: ${Sa};">${this.formatValue(f,p)}</span>
                                </div>
                            `)}
                ...
                `)}
            </div>`}renderMasterDetail(e){const t=this.getRows(),a=Di(e),s=a.find(r=>r.identifier)??a[0],i=a.filter(r=>r!==s);return o`
            <div style="display: flex; gap: 0; min-height: 400px; background: ${Ha}; border: 1px solid ${Ge}; border-radius: 8px; overflow: hidden;">
                <!-- Left: compact row list -->
                <div role="list" style="width: 280px; flex-shrink: 0; border-right: 1px solid ${Ge}; overflow-y: auto;">
                    ${t.length===0?this.renderEmpty():d}
                ...
                <div style="flex: 1; overflow-y: auto; padding: 1rem;">
                    ${this.selectedItem?o`
                        <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                            ${e.filter(r=>!H.isActionButtonCol(r)).map(r=>o`
                                <div style="display: flex; gap: 0.75rem; align-items: baseline;">
                                    <span style="min-width: 140px; color: ${zt}; font-size: 0.8125rem;">${r.label}</span>
                                    <span style="color: ${Sa}; font-size: 0.875rem;">${this.formatValue(r,this.selectedItem)}</span>
                                </div>
                            `)}
                        </div>
                    `:o`
                        <p style="color: ${zt}; font-size: 0.875rem;">Select a row to view details.</p>
                    `}
                </div>
            </div>`}renderTree(e){const t=this.getRows(),a=e[0],s=e.slice(1),i=!!a?.actionId,r=`text-align: left; padding: 0.5rem 0.75rem; border-bottom: 2px solid ${Ge}; color: ${zt}; font-size: 0.8125rem; font-weight: 600; white-space: nowrap;`,n=`padding: 0.4rem 0.75rem; border-bottom: 1px solid ${Ge}; color: ${Sa}; font-size: 0.875rem;`,l=1+(i?1:0)+s.length,c=(m,p)=>{m.stopPropagation(),this.collapsedNodes.has(p)?this.collapsedNodes.delete(p):this.collapsedNodes.add(p),this.requestUpdate()},u=(m,p)=>{const f=Array.isArray(m.children)?m.children:[],g=f.length>0,y=this.collapsedNodes.has(m);return[o`
                <tr style="${this.isSelectedRow(m)?`background: ${wi};`:""}">
                    <td style="${n} padding-left: ${.75+p*1.25}rem;">
                        <span style="display: inline-flex; align-items: center; gap: 0.25rem;">
                            ${g?o`
                                <button aria-label="${y?"Expand":"Collapse"}"
                                        style="background: transparent; border: none; cursor: pointer; color: ${zt}; font-size: 0.7rem; padding: 0 0.2rem; width: 1.2rem;"
                                        @click="${P=>c(P,m)}">${y?"▸":"▾"}</button>
                    ...
                    ${i?o`
                        <td style="${n} text-align: end; width: 6rem;">
                            ${m?.viewable===!1?d:this.linkButton("View",P=>{P.stopPropagation(),this.openRow(m)})}
                        </td>`:d}
                    ${s.map(P=>P.id==="select"&&P.dataType==="action"?o`
                            ...
                            </td>`:o`<td style="${n}">${this.formatValue(P,m)}</td>`)}
                </tr>`,...y?[]:f.flatMap(P=>u(P,p+1))]};return o`
            <table style="width: 100%; border-collapse: collapse; background: ${Ha};">
                <thead>
                    <tr>
                ...
                <tbody>
                    ${t.length===0?o`<tr><td colspan="${l}">${this.renderEmpty()}</td></tr>`:t.flatMap(m=>u(m,0))}
                </tbody>
            </table>`}renderGroupedTable(e){const t=this.getRows(),a=this.data[this.id],s=this.metadata?.groupBy,i=Er(t,s,a?.groups),r=Rr(e,a,s),n=Tr(s,e.map(m=>m.id)),l=`text-align: left; padding: 0.5rem 0.75rem; border-bottom: 2px solid ${Ge}; color: ${zt}; font-size: 0.8125rem; font-weight: 600; white-space: nowrap;`,c=`padding: 0.4rem 0.75rem; border-bottom: 1px solid ${Ge}; color: ${Sa}; font-size: 0.875rem;`,u=(m,p)=>{const f=m[p.id];if(p.dataType==="action"){if(p.id==="select")return this.linkButton("Select",y=>{y.stopPropagation(),this.dispatchAction("action-on-row-select",{_clickedRow:m})});const g=f?.methodNameInCrud?f:{methodNameInCrud:p.id,label:p.label};return this.linkButton(g.label??"",y=>{y.stopPropagation(),this.dispatchAction("action-on-row-"+g.methodNameInCrud,{_clickedRow:m})},g.label)}if(p.dataType==="actionGroup"||p.dataType==="menu"){const g=f?.actions??[];return o`${g.map(y=>this.linkButton(y.label??"",x=>{x.stopPropagation(),this.dispatchAction("action-on-row-"+y.methodNameInCrud,{_clickedRow:m})},y.label))}`}return p.stereotype==="button"?this.linkButton(p.text??p.label??"View",g=>{g.stopPropagation(),this.dispatchAction(p.actionId??p.id,m)},p.label):this.isLinkColumn(p)?this.linkButton(""+(f??""),g=>{g.stopPropagation(),p.actionId==="view"?this.openRow(m):this.dispatchAction(p.actionId,m)},p.label):this.formatValue(p,m)};return o`
            <table style="width: 100%; border-collapse: collapse; background: ${Ha};">
                <thead>
                    <tr>
                        ${e.map(m=>o`<th style="${l}">${m.label??""}</th>`)}
                    </tr>
                </thead>
                <tbody>
                    ...
                    ${i.map(m=>Ja(m)?o`
                        <tr>
                            ${e.map(p=>o`<td style="${c} font-weight: 600; background: rgba(22, 21, 19, 0.05);">${Or(m,p,n)}</td>`)}
                        </tr>
                    `:o`
                        <tr style="${this.isSelectedRow(m)?`background: ${wi};`:""}">
                            ${e.map(p=>o`<td style="${c}">${u(m,p)}</td>`)}
                        </tr>
                    `)}
                </tbody>
                ${r?o`
                    <tfoot>
                        <tr>
                            ${e.map(m=>o`<td style="${c} font-weight: 700; border-top: 2px solid ${Ge}; border-bottom: none;">${r[m.id]??""}</td>`)}
                        </tr>
                    </tfoot>
                `:d}
            ...
            <slot></slot>
        `}};H._ADP=null;Be([h()],H.prototype,"id",2);Be([h()],H.prototype,"metadata",2);Be([h()],H.prototype,"baseUrl",2);Be([h()],H.prototype,"state",2);Be([h()],H.prototype,"data",2);Be([h()],H.prototype,"appState",2);Be([h()],H.prototype,"appData",2);Be([h()],H.prototype,"emptyStateMessage",2);Be([$()],H.prototype,"_connected",2);Be([$()],H.prototype,"availableWidthPx",2);Be([$()],H.prototype,"selectedItem",2);H=Be([k("mateu-redwood-table")],H);const Zi="var(--oj-core-text-color-secondary, #666)",so="var(--oj-core-divider-color, rgba(22,21,19,.12))",Tu=`text-align: left; padding: 0.5rem 0.75rem; border-bottom: 2px solid ${so}; color: ${Zi}; font-size: 0.8125rem; font-weight: 600; white-space: nowrap;`,dr=`padding: 0.5rem 0.75rem; border-bottom: 1px solid ${so};`,Ou=e=>{const t=(e??"").toUpperCase();return t==="SUCCESS"?"successSubtle":t==="DANGER"||t==="ERROR"?"dangerSubtle":t==="WARNING"?"warningSubtle":t==="INFO"?"infoSubtle":"neutral"},Ru=(e,t,a)=>{e?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t,parameters:a},bubbles:!0,composed:!0}))},Au=(e,t)=>{const a=e[t.id];if(t.stereotype==="button"||t.dataType==="action"){const s=a?.label??a?.text??t.text??t.label??"View",i=a?.methodNameInCrud??t.actionId??t.id;return o`<oj-c-button
            data-oj-binding-provider="preact"
            label="${s}"
            chroming="borderless"
            @ojAction="${r=>Ru(r.target,i,e)}"
        ></oj-c-button>`}return t.dataType==="status"?a==null?o``:o`<oj-c-badge
            data-oj-binding-provider="preact"
            label="${a.message??""+a}"
            variant="${Ou(a.type)}"
        ></oj-c-badge>`:t.dataType==="bool"||t.dataType==="boolean"?o`<span aria-label="${a?"yes":"no"}">${a?"✓":"✕"}</span>`:o`${a??""}`},ro=e=>{const t=[];return e?.forEach(a=>{const s=a.metadata;s?.type===v.GridGroupColumn?t.push(...ro(s.columns??s.content??a.children)):s&&t.push({...s,id:s.id??a.id})}),t},oo=(e,t,a=!1,s)=>{const i=(r,n)=>{const l=o`
            <tr style="${s?"cursor: pointer;":""}" @click="${s?u=>s(u,r):d}">
                ${e.map((u,m)=>o`
                    <td style="${dr} ${m===0&&a?`padding-left: ${.75+n*1.25}rem;`:""} ${u.align?`text-align: ${u.align};`:""}">
                        ${Au(r,u)}
                    </td>`)}
            </tr>`,c=a?r.children??[]:[];return[l,...c.flatMap(u=>i(u,n+1))]};return o`
        <table style="width: 100%; border-collapse: collapse;">
            <thead>
                <tr>${e.map(r=>o`<th style="${Tu} ${r.align?`text-align: ${r.align};`:""}" width="${r.width??d}">${r.label??""}</th>`)}</tr>
            </thead>
            <tbody>
                ${t.length===0?o`<tr><td colspan="${e.length}" style="${dr} color: ${Zi}; text-align: center;">No data.</td></tr>`:t.flatMap(r=>i(r,0))}
            </tbody>
        </table>`},zu=(e,t)=>{const a=e.metadata,s=ro(a.content);let i=a.page?.content??[];return e.id&&t&&Array.isArray(t[e.id])&&(i=t[e.id]),o`
        <div style="width: 100%; overflow-x: auto; ${e.style??""}" class="${e.cssClasses??d}"
             slot="${e.slot??d}">
            ${oo(s,i,a.tree)}
        </div>`},ju=(e,t,a,s,i,r,n)=>o`
    <mateu-redwood-table
        id="${t.id}"
        .metadata="${t.metadata}"
        .data="${i}"
    ...
    >
        ${t.children?.map(l=>w(e,l,a,s,i,r,n))}
    </mateu-redwood-table>`,Lu=(e,t,a,s,i,r,n)=>{const c=t.metadata.page?.content??[];return o`
        <div style="overflow-y: auto; ${t.style??""}" class="${t.cssClasses??d}"
             slot="${t.slot??d}">
            ${c.map(u=>w(e,u,a,s,i,r,n))}
        </div>`},Du=e=>{const t=s=>s.submenus?o`
        ...
        <div style="${t.style??d}" class="${t.cssClasses??d}"
            ...
            ${l.label?o`<div style="font-size: 0.75rem; color: ${Zi}; margin-bottom: 4px;">${l.label}</div>`:d}
            <div>${w(e,l.content,a,s,i,r,n)}</div>
        </div>`},Nu=e=>{const t=e.state?.items??e.metadata?.items??[];return o`
        <div style="display: flex; flex-direction: column; gap: 0.75rem; padding: 0.5rem; ${e.style??""}"
            ...
            ${t.map(a=>o`
                <div style="display: flex; gap: 0.5rem; align-items: flex-start;">
                    ...
                    <div>
                        ${a.userName?o`<div style="font-size: 0.75rem; color: ${Zi};">${a.userName}</div>`:d}
                        <div>${a.text}</div>
                    </div>
                </div>
            `)}
        </div>`},Mu=e=>{const t=a=>{const i=a.target.closest(".rw-message-input")?.querySelector("oj-c-input-text"),r=i?.rawValue??i?.value??"";r&&(a.target.dispatchEvent(new CustomEvent("submit",{detail:{value:r},bubbles:!0,composed:!0})),i&&(i.value=""))};return o`
        ...
        </div>`},Ia="var(--oj-core-text-color-secondary, #666)",Ns="var(--oj-core-divider-color, rgba(22,21,19,.12))",Ms="var(--oj-core-bg-color-content, #fff)",no="var(--oj-core-border-radius-md, 6px)",Na=e=>"oj-ux-ico-"+(e??"").replace(/^vaadin:/,"").replace(/^lumo:/,""),qu=e=>{const t=e.metadata;return o`<span class="${Na(t?.icon)} ${e.cssClasses??""}"
                      style="font-size: 1.25rem; ${e.style??""}"
                      slot="${e.slot??d}"
                      aria-label="${t?.icon??d}"></span>`},Uu=e=>{const t=e.metadata,a=t?.breadcrumbs??[];return o`
        <nav aria-label="Breadcrumb"
             style="display: flex; align-items: center; gap: 0.4rem; flex-wrap: wrap; ${e.style??""}"
             class="${e.cssClasses??d}" slot="${e.slot??d}">
            ${a.map((s,i)=>o`
                ${i>0?o`<span style="color: ${Ia};">/</span>`:d}
                ${s.link?o`<a class="oj-link-standalone" href="${s.link}">${s.text}</a>`:o`<span>${s.text}</span>`}
            `)}
            ${t?.currentItemText?o`
                ${a.length>0?o`<span style="color: ${Ia};">/</span>`:d}
                <span style="color: ${Ia};">${t.currentItemText}</span>
            `:d}
        </nav>`},Bu=e=>{const t=e.metadata;return o`
        <div role="status"
             style="display: flex; gap: 0.5rem; align-items: baseline; padding: 0.75rem 1rem; border: 1px solid ${Ns}; border-left: 4px solid var(--oj-core-info-color, #0572ce); border-radius: ${no}; background: ${Ms}; ${e.style??""}"
             class="${e.cssClasses??d}" slot="${e.slot??d}">
            ${t?.title?o`<span class="oj-typography-body-md oj-typography-bold">${t.title}</span>`:d}
            <span class="oj-typography-body-md">${t?.text??""}</span>
        </div>`},Vu=(e,t={})=>{const a=e.metadata,s=a.valueKey?t[a.valueKey]:a.value;return o`
        <div style="${e.style??""}" class="${e.cssClasses??d}" slot="${e.slot??d}">
            <oj-c-progress-bar
                ...
                style="width: 100%;"
            ></oj-c-progress-bar>
            ${a.text?o`<div style="font-size: 0.75rem; color: ${Ia}; margin-top: 2px;">${a.text}</div>`:d}
        </div>`},Wu=(e,t,a,s,i,r,n)=>{const l=t.metadata;return o`
        <oj-c-collapsible data-oj-binding-provider="preact"
        ...
        </oj-c-collapsible>`},lo=e=>e.abbreviation||(e.name?e.name.split(/\s+/).map(t=>t[0]).slice(0,2).join(""):""),Hu=(e,t,a)=>{const s=e.metadata;return o`<oj-c-avatar
            data-oj-binding-provider="preact"
            initials="${lo(s)||d}"
            src="${s.image??d}"
            role="img"
            ...
            slot="${e.slot??d}"
    ></oj-c-avatar>`},Gu=e=>{const t=e.metadata,a=t.avatars??[],s=t.maxItemsVisible||a.length,i=a.slice(0,s),r=a.length-i.length;return o`
        <div style="display: flex; align-items: center; ${e.style??""}"
            ...
            ${i.map((n,l)=>o`
                <oj-c-avatar
                    ...
                    src="${n.image??d}"
                    title="${n.name??d}"
                    style="${l>0?"margin-left: -0.5rem;":""} border: 2px solid ${Ms}; border-radius: 50%;"
                ></oj-c-avatar>
            `)}
            ${r>0?o`<span style="margin-left: 0.4rem; font-size: 0.8125rem; color: ${Ia};">+${r}</span>`:d}
        </div>`},Ku=(e,t,a,s,i,r,n)=>{const l=t.metadata;return o`
        <span title="${l.text??""}" style="${t.style??d}"
              class="${t.cssClasses??d}" slot="${t.slot??d}">
            ${l.wrapped?w(e,l.wrapped,a,s,i,r,n):d}
        </span>`},ks=e=>{const a=e?.closest(".rw-pop-wrap")?.querySelector(":scope > .rw-pop-panel");a&&(a.hidden=!a.hidden)},co=`position: absolute; top: 100%; left: 0; margin-top: 4px; z-index: 1000; background: ${Ms}; border: 1px solid ${Ns}; border-radius: ${no}; box-shadow: 0 4px 12px rgba(0,0,0,.15); min-width: 10rem;`,Yu=(e,t,a,s,i,r,n)=>{const l=t.metadata;return o`
        <span class="rw-pop-wrap ${t.cssClasses??""}"
              style="position: relative; display: inline-block; ${t.style??""}"
              slot="${t.slot??d}">
            <span style="cursor: pointer;" @click="${c=>ks(c.currentTarget)}">
                ${l.wrapped?w(e,l.wrapped,a,s,i,r,n):d}
            </span>
            <div class="rw-pop-panel" hidden style="${co} padding: 0.75rem;">
                ${l.content?w(e,l.content,a,s,i,r,n):d}
            </div>
        </span>`},Cs=(e,t)=>{t&&e?.dispatchEvent(new CustomEvent("update-route",{detail:{route:t},bubbles:!0,composed:!0}))},Ju=(e,t)=>{const s=t.metadata.options??[],i=r=>{if(r.submenus&&r.submenus.length>0){const n=r.submenus.map(l=>({key:l.path??l.label,label:l.label,disabled:l.disabled??!1}));return o`
                <oj-c-menu-button
                    data-oj-binding-provider="preact"
                    label="${r.label}"
                    chroming="borderless"
                    .items="${n}"
                    @ojMenuAction="${l=>Cs(e,l.detail.key)}"
            ...
            <oj-c-button
                ...
                chroming="borderless"
                ?disabled="${r.disabled}"
                @ojAction="${n=>Cs(n.target,r.path)}"
            ></oj-c-button>`};return o`
        <div style="display: flex; flex-direction: row; gap: 0.25rem; align-items: center; ${t.style??""}"
             class="${t.cssClasses??d}" slot="${t.slot??d}">
            ${s.map(i)}
        </div>`},Xu=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=p=>{p.preventDefault(),ks(p.currentTarget)},u=(p,f)=>{ks(p.currentTarget),Cs(p.target,f.path)},m=(p,f=0)=>o`
        ${p.map(g=>g.separator?o`<div style="border-top: 1px solid ${Ns}; margin: 0.25rem 0;"></div>`:o`
                <div role="menuitem"
                     style="padding: 0.4rem 1rem 0.4rem ${1+f*1.25}rem; cursor: ${g.disabled?"default":"pointer"}; ${g.disabled?`color: ${Ia}; opacity: 0.6;`:""} white-space: nowrap;"
                     @click="${g.disabled?d:y=>u(y,g)}">
                    ${g.icon?o`<span class="${Na(g.icon)}" style="margin-right: 0.4rem;"></span>`:d}
                    ${g.label}
                </div>
                ${g.submenus?m(g.submenus,f+1):d}`)}
    `;return o`
        <span class="rw-pop-wrap ${t.cssClasses??""}"
              style="position: relative; display: inline-block; ${t.style??""}"
              slot="${t.slot??d}"
            ...
            ${w(e,l.wrapped,a,s,i,r,n)}
            <div class="rw-pop-panel" hidden role="menu" style="${co} padding: 0.25rem 0;">
                ${m(l.menu??[])}
            </div>
        </span>`},xa="var(--oj-core-text-color-secondary, #666)",ii="var(--oj-core-divider-color, rgba(22,21,19,.12))",xt=`display:block;font-size:0.75rem;color:${xa};margin-bottom:4px;`,uo=e=>{const t=window.require;if(!t)return null;try{const a=t("ojs/ojarraydataprovider");return new a(e,{keyAttributes:"value"})}catch{return null}},V=(e,t,a)=>{e.target?.dispatchEvent(new CustomEvent("value-changed",{detail:{value:a,fieldId:t},bubbles:!0,composed:!0}))},pi=(e,t,a)=>{e?.dispatchEvent(new CustomEvent("value-changed",{detail:{value:a,fieldId:t},bubbles:!0,composed:!0}))},Ss=(e,t,a)=>{e?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t,parameters:a},bubbles:!0,composed:!0}))},W=(e,t,a="")=>o`
    <div style="${a}">
        ${e?o`<div style="${xt}">${e}</div>`:d}
        ${t}
    </div>`,po=(e,t)=>{const a=typeof e=="number"?e:parseFloat(""+e);return isNaN(a)?""+e:t&&t.locale&&t.currency?new Intl.NumberFormat(t.locale,{style:"currency",currency:t.currency}).format(a):new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(a)},cr=new WeakMap,ho=(e,t,a,s,i)=>{const r=i?.[a]??i?.[s],n=r?.content??(Array.isArray(r)?r:void 0);if(n)return n;const l=t.remoteCoordinates?.action;if(l){let c=cr.get(e);c||(c=new Set,cr.set(e,c)),c.has(s)||(c.add(s),setTimeout(()=>Ss(e,l,{searchText:"",fieldId:s,size:200,page:0,sort:void 0})))}return[]},yt=(e,t,a,s,i)=>t.remoteCoordinates?ho(e,t,a,s,i):t.options??[],ms=(e,t,a,s,i)=>{const r=uo(i.map(n=>({value:n.value,label:n.label??""})));return o`<oj-c-select-single
        data-oj-binding-provider="preact"
        id="${t}"
        label-hint="${a}"
        label-edge="top"
    ...
    ></oj-c-select-single>`},Qu=(e,t,a,s,i)=>{const r=uo(i.map(n=>({value:n.value,label:n.label??""})));return o`<oj-c-select-multiple
        data-oj-binding-provider="preact"
        id="${t}"
        label-hint="${a}"
        label-edge="top"
        ...
        ?disabled="${e.disabled}"
        @valueChanged="${n=>V(n,t,n.detail.value)}"
    ></oj-c-select-multiple>`},ur=(e,t,a,s)=>{const i=n=>s?Array.isArray(t)&&t.includes(n.value):t===n.value,r=n=>{if(!s)return n.value;const l=Array.isArray(t)?t:[];return l.includes(n.value)?l.filter(c=>c!==n.value):[...l,n.value]};return o`
        <div role="listbox" aria-multiselectable="${s}"
             style="border: 1px solid ${ii}; border-radius: var(--oj-core-border-radius-md, 6px); max-height: 14rem; overflow-y: auto;">
            ${a.map(n=>{const l=i(n);return o`
                    <div role="option" aria-selected="${l}" tabindex="0"
                         ...
                         @click="${e.disabled?d:c=>pi(c.target,e.fieldId,r(n))}">
                        ${n.icon?o`<span class="${Na(n.icon)}"></span>`:d}
                        <span style="pointer-events: none;">
                            <span>${n.label}</span>
                            ${n.description?o`<span style="display: block; font-size: 0.8125rem; color: ${xa};">${n.description}</span>`:d}
                        </span>
                    </div>`})}
        </div>`},vs=(e,t,a,s)=>o`
    <div style="display: flex; gap: 0.75rem; padding: 0.25rem 0; flex-wrap: wrap;">
        ${a.map(i=>{const r=s?Array.isArray(t)&&t.includes(i.value):t==i.value,n=()=>{if(!s)return i.value;const l=Array.isArray(t)?t:[];return l.includes(i.value)?l.filter(c=>c!==i.value):[...l,i.value]};return o`
                <div role="button" tabindex="0"
                     style="min-width: 10rem; min-height: 3rem; padding: 0.75rem 1rem; cursor: pointer; border-radius: var(--oj-core-border-radius-lg, .375rem); border: 1px solid ${r?"var(--oj-core-info-color, #0572ce)":ii}; background: ${r?"var(--oj-core-bg-color-selected, #e5f0fa)":"transparent"};"
                     @click="${l=>pi(l.target,e.fieldId,n())}">
                    <div style="display: flex; align-items: center; gap: 0.5rem; pointer-events: none;">
                        ${i.icon?o`<span class="${Na(i.icon)}"></span>`:d}
                        ${i.image?o`<img src="${i.image}" alt="${i.label}" style="${i.imageStyle??"width: 2rem;"}" />`:d}
                        <div>
                            <div>${i.label}</div>
                            ${i.description?o`
                                <div style="font-size: 0.8125rem; color: ${xa};">${i.description}</div>
                            `:d}
                        </div>
                    </div>
                </div>`})}
    </div>`,Zu=(e,t,a)=>{let s=typeof e=="number"?e:parseInt(""+e,10);return isNaN(s)&&(s=0),o`<oj-c-rating-gauge
        data-oj-binding-provider="preact"
        .value="${s}"
        max="5"
        step="1"
        size="md"
        ?readonly="${a}"
        @valueChanged="${i=>pi(i.target,t,i.detail.value)}"
    ></oj-c-rating-gauge>`},ep=e=>t=>{const a=t.target,s=a.files?.[0];if(!s)return;const i=new FileReader;i.onload=()=>pi(a,e,i.result),i.readAsDataURL(s),a.value=""},tp=e=>t=>{t.target.getRootNode().querySelector(`#${CSS.escape(e)}`)?.click()},ap=(e,t,a)=>{const s=a!=null&&a!=="",i=`${t}_file`;return o`
        <div style="display: flex; flex-direction: column; align-items: stretch; gap: 0.5rem; max-width: 320px;">
            ${s?o`
                <img src="${a}"
                     style="max-width: 100%; max-height: 240px; object-fit: contain; border: 1px solid ${ii}; border-radius: var(--oj-core-border-radius-lg, .375rem); ${e.style??""}">
            `:o`
                <div style="height: 135px; display: flex; align-items: center; justify-content: center; border: 1px dashed ${ii}; border-radius: var(--oj-core-border-radius-lg, .375rem); color: ${xa};">
                    <span class="oj-ux-ico-image" style="font-size: 2rem;"></span>
                </div>
            `}
            <input type="file" id="${i}" accept="image/*" style="display: none;" @change="${ep(e.fieldId)}">
            <div style="display: flex; gap: 0.5rem;">
                <oj-c-button data-oj-binding-provider="preact" label="${s?"Replace":"Upload"}" chroming="outlined"
                             @ojAction="${tp(i)}"></oj-c-button>
                ${s?o`
                    <oj-c-button data-oj-binding-provider="preact" label="Delete" chroming="borderless"
                                 @ojAction="${r=>pi(r.target,e.fieldId,"")}"></oj-c-button>`:d}
            </div>
        </div>`},ip=(e,t,a)=>{const s=t===!0||t==="true";return o`
        <div style="${e.style??d}">
            <oj-c-badge data-oj-binding-provider="preact"
                        variant="${s?"success":"neutral"}"
                        style="${s?"":"opacity: 0.4;"}">${a}</oj-c-badge>
        </div>`},sp=(e,t,a,s,i)=>{let r=de(t,s,i);const n=r&&typeof r=="object"&&"value"in r?r:null;r&&r.value&&(r=r.value);const l=e.dataType=="bool"||r===!0||r===!1,c=e.dataType=="money",u=r!=null&&r!=="";let m=u?""+r:"—";c&&u&&(m=po(r,n));const p=l?o`<span>${r===!0||r==="true"?"✓":"—"}</span>`:e.multiline?o`<span style="font-weight: 500; white-space: pre-wrap; word-break: break-word;">${m}</span>`:o`<span style="display: block; font-weight: 500; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;${c?" font-variant-numeric: tabular-nums;":""}">${m}</span>`;return W(a,p,c?"text-align: right; ":"")},rp=(e,t,a,s,i)=>{let r=de(t,s,i);const n=r&&typeof r=="object"&&"value"in r?r:null;r&&r.value&&(r=r.value);const l=e.dataType=="bool"||r===!0||r===!1,c=e.dataType=="money",u=r!=null&&r!=="";let m=u?""+r:"—";c&&u&&(m=po(r,n));const p=l?o`<span style="margin-left: auto;">${r===!0||r==="true"?"✓":"—"}</span>`:o`<span style="font-weight: 500; text-align: right; word-break: break-word; margin-left: auto;${c?" font-variant-numeric: tabular-nums;":""}">${m}</span>`,f=a!=null&&a!==""&&a!=="null"?""+a:"";return o`<div style="display: flex; justify-content: space-between; align-items: baseline; gap: 1rem; width: 100%; padding: 0.4rem 0; border-bottom: 1px solid rgba(0,0,0,.08); ${e.style??""}"
    >${f?o`<span style="color: ${xa}; white-space: nowrap;">${f}</span>`:d}${p}</div>`},op=(e,t,a,s,i)=>{const r=de(t,s,i),n=Array.isArray(r)?r.map(l=>""+l):r!=null&&r!==""?[""+r]:[];return W(a,o`<mateu-bulleted-list .items="${n}" style="${e.style??d}"></mateu-bulleted-list>`)},np=(e,t,a,s,i)=>{let r=de(t,s,i)||i?.[e.fieldId];if(r&&r.value&&(r=r.value),e.stereotype=="image"||e.stereotype=="uploadableImage"||e.stereotype=="signature"||e.stereotype=="camera")return W(a,o`<img src="${r}" style="${e.style??d}">`);if(e.stereotype=="fileUpload")return W(a,o`<mateu-file-upload .fieldId="${e.fieldId}" .value="${r}" .editable="${!1}"></mateu-file-upload>`);if(e.dataType=="bool")return W(a,o`<span>${r?"✓":"—"}</span>`);if(e.stereotype=="link")return W(a,o`<a class="oj-link-standalone" href="${r??""}" target="_blank">${r??""}</a>`);if(e.stereotype=="color")return W(a,o`<span style="background-color: ${r}; display: block; height: 20px; width: 40px; border: 1px solid ${xa}; border-radius: 4px;"></span>`);const n=r!=null&&r!=="";return W(a,o`<span style="display: block; font-weight: 500; overflow: hidden; text-overflow: ellipsis;">${n?r:"—"}</span>`)},lp=X`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>`,dp=X`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>`,mo=(e,t,a)=>{const s=e.link,i=Oe(s.href,t,a)??s.href,r=Oe(s.title,t,a)||i;return{href:i,title:r}},cp=e=>{const t=e;if(!t||t.__navlinkPositioned)return;t.__navlinkPositioned=!0;const a=()=>{const r=t.parentElement,n=r?.firstElementChild?.querySelector("input, textarea, select");if(!r||!n)return;const l=n.getBoundingClientRect();l.height!==0&&(t.style.marginTop=`${Math.max(0,Math.round(l.top+l.height/2-t.offsetHeight/2-r.getBoundingClientRect().top))}px`)};let s=0;const i=()=>{a(),s++<32&&setTimeout(i,250)};setTimeout(i),document.fonts?.ready.then(()=>setTimeout(a))},up=(e,t,a)=>{const s=e.link,{href:i,title:r}=mo(e,t,a),n=s.icon?o`<span class="${Na(s.icon)}" style="font-size: 1.125rem;"></span>`:i.startsWith("http")?lp:dp;return o`<a data-navlink
        href="${i}"
        title="${r}"
        target="${s.target||d}"
        ${Uo(cp)}
        style="display: flex; align-items: center; color: ${xa}; align-self: flex-start; margin-top: 1.9rem;"
    >${n}</a>`},pp=(e,t,a)=>s=>{const i=s.composedPath()[0]?.value;if(i==null)return;const n=s.currentTarget.querySelector("a[data-navlink]");if(!n)return;const{href:l,title:c}=mo(e,{...t,[e.fieldId]:i},a);n.setAttribute("href",l),n.setAttribute("title",c)},hp=(e,t,a,s,i)=>{const r=t.metadata,n=mp(e,t,a,s,i);return r?.link?.href?o`<div style="display: flex; gap: 0.5rem;" @input="${pp(r,s,i)}">
        <div style="flex: 1; min-width: 0;">${n}</div>
        ${up(r,s,i)}
    </div>`:n},mp=(e,t,a,s,i)=>{const r=t.metadata,n=r?.fieldId??"",l=s&&n in s?s[n]:r?.initialValue,c=r.label??"",u=t.id??n,m=r.stereotype;if(r.propertyRow)return rp(r,l,c,s,i);if(m==="badge")return ip(t,l,c||n);if(m==="plainText")return sp(r,l,c,s,i);if(m==="bulletedList")return op(r,l,c,s,i);if(r.readOnly&&m!="grid"&&r.dataType!="status"&&r.dataType!="money")return np(r,l,c,s,i);if(m==="grid"&&r.columns&&r.columns.length>0){const p=Array.isArray(l)?l:[],f=r.columns.map(x=>({...x.metadata,id:x.metadata.id??x.id})),g=r.onItemSelectionActionId;return W(c,o`<div style="overflow-x: auto;">${oo(f,p,!1,g?(x,P)=>x.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:g,parameters:{_clickedRow:P}},bubbles:!0,composed:!0})):void 0)}</div>`)}if(r.dataType==="string"){if(m==="searchable"){const p=g=>Ss(g.target,"code-"+n,{code:g.detail?.value??g.target?.value??""}),f=g=>Ss(g.target,"codesearch-"+n,{});return W(c,o`
                ...
                ?disabled="${r.disabled}"
                ?readonly="${r.readOnly}"
                @valueChanged="${p=>V(p,u,p.detail.value)}"
            ></oj-c-text-area>`;if(m==="richText"||m==="richtext")return o`<oj-c-text-area
                ...
                ?readonly="${r.readOnly}"
                @valueChanged="${p=>V(p,u,p.detail.value)}"
            ></oj-c-text-area>`;if(m==="markdown")return W(c,o`<mateu-markdown .content="${l??""}"></mateu-markdown>`);if(m==="password")return o`<oj-c-input-password
                data-oj-binding-provider="preact"
                id="${u}"
                label-hint="${c}"
                label-edge="top"
                ...
                ?disabled="${r.disabled}"
                @valueChanged="${p=>V(p,u,p.detail.value)}"
            ></oj-c-input-password>`;if(m==="select"||m==="combobox"){const p=l&&l.value?l.value:l;return ms(r,u,c,p,yt(e,r,u,n,i))}if(m==="listBox")return W(c,ur(r,l,yt(e,r,u,n,i),!1));if(m==="choice")return W(c,vs(r,l,yt(e,r,u,n,i),!1));if(m==="popover"){const p=yt(e,r,u,n,i),f=p.find(y=>y.value===l)?.label??l??"";return W(c,o`
                <span class="rw-pop-wrap" style="position: relative; display: inline-block;">
                    ...
                    <div class="rw-pop-panel" hidden
                         style="position: absolute; top: 100%; left: 0; margin-top: 4px; z-index: 1000; background: var(--oj-core-bg-color-content, #fff); border: 1px solid ${ii}; border-radius: var(--oj-core-border-radius-md, 6px); box-shadow: 0 4px 12px rgba(0,0,0,.15); padding: 0.5rem;">
                        ${vs(r,l,p,!1)}
                    </div>
                </span>`)}if(m==="radio"){const p=yt(e,r,u,n,i).map(f=>({value:f.value,label:f.label??""}));return o`<oj-c-radioset
                data-oj-binding-provider="preact"
                id="${u}"
                label-hint="${c}"
                label-edge="top"
            ...
            ></oj-c-radioset>`}return m==="html"?o`<div id="${u}">${ge(""+(l??""))}</div>`:m==="image"?o`<figure style="margin: 0;">
                <figcaption style="${xt}">${c}</figcaption>
                <img src="${l}" alt="${c}" style="${r.style??""}" />
            </figure>`:m==="uploadableImage"?W(c,ap(r,u,l)):m==="treeSelect"?W(c,o`<mateu-tree-select
                .fieldId="${u}" .value="${l}"
                .options="${r.options??[]}"
                .leavesOnly="${r.treeLeavesOnly??!1}"></mateu-tree-select>`):m==="signature"?W(c,o`<mateu-signature-pad .fieldId="${u}" .value="${l}"></mateu-signature-pad>`):m==="camera"?W(c,o`<mateu-camera-capture .fieldId="${u}" .value="${l}"></mateu-camera-capture>`):m==="fileUpload"?W(c,o`<mateu-file-upload
                .fieldId="${u}" .value="${l}"
                .accept="${ao(r.attributes,"accept")}"></mateu-file-upload>`):m==="icon"?W(c,o`
                <div style="display: flex; gap: 0.5rem; align-items: center;">
                    <oj-c-input-text data-oj-binding-provider="preact" label-edge="none" style="flex: 1;"
                                     ...
                                     @valueChanged="${p=>V(p,u,p.detail.value)}"
                    ></oj-c-input-text>
                    ${l?o`<span class="${Na(l)}" style="font-size: 1.25rem;"></span>`:d}
                </div>`):m==="color"?o`<div>
                <label for="${u}" style="${xt}">${c}</label>
                <input id="${u}" type="color" .value="${l??"#000000"}" ?disabled="${r.disabled}"
                    @input="${p=>V(p,u,p.target.value)}" />
            </div>`:m==="link"?o`<div>
                <div style="${xt}">${c}</div>
                <a class="oj-link-standalone" href="${l}" target="_blank">${l}</a>
            </div>`:r.options&&r.options.length>0?ms(r,u,c,l,r.options):r.remoteCoordinates?ms(r,u,c,l,ho(e,r,u,n,i)):o`<oj-c-input-text
            data-oj-binding-provider="preact"
            id="${u}"
            label-hint="${c}"
            label-edge="top"
        ...
        ></oj-c-input-text>`}if(r.dataType==="number")return o`<oj-c-input-number
            ...
            ?disabled="${r.disabled}"
            @valueChanged="${p=>V(p,u,p.detail.value)}"
        ></oj-c-input-number>`;if(r.dataType==="integer")return m==="stars"?W(c,Zu(l,n,r.disabled)):m==="slider"?o`<div>
                <label for="${u}" style="${xt}">${c}</label>
                <input id="${u}" type="range"
                    min="${r.sliderMin??0}"
                    max="${r.sliderMax??10}"
                    .value="${""+(l??0)}"
                    @input="${p=>V(p,u,parseInt(p.target.value))}" />
        ...
        ></oj-c-input-time-mask>`;if(r.dataType==="dateRange"){const p=l;return o`<div style="display:flex;gap:0.5rem;align-items:flex-end;">
            <oj-c-input-date-picker
                ...
                label-edge="top"
                .value="${p?.from??null}"
                @valueChanged="${f=>V(f,u,{...p,from:f.detail.value})}"
            ></oj-c-input-date-picker>
            <oj-c-input-date-picker
                data-oj-binding-provider="preact"
                id="${u}_to"
                ...
                label-edge="top"
                .value="${p?.to??null}"
                @valueChanged="${f=>V(f,u,{...p,to:f.detail.value})}"
            ></oj-c-input-date-picker>
        </div>`}if(r.dataType==="array"){if(m==="choice")return W(c,vs(r,l,yt(e,r,u,n,i),!0));if(m==="listBox")return W(c,ur(r,l,yt(e,r,u,n,i),!0));if(m==="combobox"||m==="select")return Qu(r,u,c,l,yt(e,r,u,n,i));const p=yt(e,r,u,n,i).map(f=>({value:f.value,label:f.label??""}));return o`<oj-c-checkboxset
            data-oj-binding-provider="preact"
            id="${u}"
            label-hint="${c}"
            label-edge="top"
        ...
        ></oj-c-input-number>`}if(r.dataType==="file")return o`<oj-c-file-picker
            ...
            label-hint="${c}"
            ?disabled="${r.disabled}"
            @ojSelect="${p=>{const f=p.detail.files?.[0];V(p,u,f?{name:f.name,size:f.size}:null)}}"
        ></oj-c-file-picker>`;if(r.dataType==="range"){const p=l;return o`<div>
            ...
            <label class="root">
                ...
                ${this.opened?this.renderPanel():d}
            </label>`:o``}};Qe.SEARCHABLE_THRESHOLD=7;Qe.styles=C`
        :host {
            display: inline-flex;
            position: relative;
            flex-shrink: 0;
    ...
    `;wa([h()],Qe.prototype,"selector",2);wa([h()],Qe.prototype,"app",2);wa([h()],Qe.prototype,"baseUrl",2);wa([$()],Qe.prototype,"opened",2);wa([$()],Qe.prototype,"searchText",2);wa([$()],Qe.prototype,"searchedOptions",2);Qe=wa([k("mateu-app-context-picker")],Qe);var si=(e=>(e.Add="Add",e.Replace="Replace",e.ReplaceKeepData="ReplaceKeepData",e))(si||{}),bp=Object.defineProperty,vo=(e,t,a,s)=>{for(var i=void 0,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(t,a,i)||i);return i&&bp(t,a,i),i};class es extends S{constructor(){super(...arguments),this.id="",this.baseUrl="",this.callbackToken="",this.createElement=t=>{const a=t.data,s=document.createElement(a.name);for(let i in a.attributes)s.setAttribute(i,a.attributes[i]);for(let i in a.on)s.addEventListener(i,r=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.on[i],parameters:{event:r}},bubbles:!0,composed:!0}))});return s},this.closeModal=()=>{const t=(this.shadowRoot??this).querySelectorAll("mateu-dialog, mateu-drawer");if(t&&t.length>0){t[t.length-1].close(),this.removeTopOverlayChild();return}this.dispatchEvent(new CustomEvent("close-modal-requested",{bubbles:!0,composed:!0}))},this.changeFavicon=t=>{let a=document.querySelector('link[rel="icon"]');a!==null?a.setAttribute("href",t):(a=document.createElement("link"),a.setAttribute("rel","icon"),a.setAttribute("href",t),document.head.appendChild(a))}}connectedCallback(){super.connectedCallback(),this.upstreamSubscription=Ft.subscribe(t=>{if(t.command){const a=t.command;this.id==a.targetComponentId&&this.applyCommand(a)}if((!t.callbackToken||!this.callbackToken||t.callbackToken===this.callbackToken)&&t.fragment){const a=t.fragment;this.id==a.targetComponentId&&(this.applyFragment(a),this.completeMenu(a))}})}completeMenu(t){if(t.component&&t.component.type==oe.ClientSide){const a=t.component,s=a.metadata;if(s?.type==v.App){const i=s,r=this.getRemoteMenus(i.menu);if(r.length>0){const n=r.map(l=>$a.runAction(l.baseUrl,l.route,"_empty","",l.baseUrl+"#"+l.route,void 0,void 0,void 0,l.params,this,!0));Promise.all(n).then(l=>{i.menu=this.updateMenu(i.menu,l.map(c=>c.fragments).filter(c=>c).map(c=>c).flat()),i.variant=$e.MENU_ON_TOP,Ft.next({fragment:{component:a,data:void 0,state:void 0,action:si.Replace,targetComponentId:this.id,containerId:void 0},callbackToken:this.callbackToken})})}}}}updateMenu(t,a){const s=[];return t.forEach(i=>{if(i.remote){const r=a.find(n=>n.targetComponentId==i.baseUrl+"#"+i.route);if(r&&r.component?.type==oe.ClientSide){const n=r.component;if(n.metadata?.type==v.App){const l=n.metadata,c=i.serverSideType&&i.serverSideType!=""?i.serverSideType:l.serverSideType;this.changeBaseUrl(l.menu,i.baseUrl,c,i.route,l.route),s.push(...l.menu)}}}else s.push(i)}),s}changeBaseUrl(t,a,s,i,r){t.forEach(n=>{n.baseUrl||(n.submenus&&n.submenus.length>0?this.changeBaseUrl(n.submenus,a,s,i,r):(n.consumedRoute=r??"",n.baseUrl=a,n.serverSideType=s,n.uriPrefix=i))})}getRemoteMenus(t){const a=[];return t.forEach(s=>{s.remote&&a.push(s)}),a}disconnectedCallback(){super.disconnectedCallback(),this.upstreamSubscription?.unsubscribe()}applyCommand(t){if(t.type=="SetWindowTitle"&&(document.title=t.data),t.type=="SetFavicon"&&this.changeFavicon(t.data),t.type=="DispatchEvent"&&this.dispatchNamedEvent(t.data),t.type=="NavigateTo"){const a=t.data;a&&(a.startsWith("http:")||a.startsWith("https:")?window.open(t.data,"_blank"):window.location.href=t.data)}if(t.type=="PushStateToHistory"){const a=t.data;a!==void 0&&this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:a},bubbles:!0,composed:!0}))}if(t.type=="RunAction"){const a=t.data;if(a&&a.actionId)if(a.targetComponentId){const s={command:{type:"RunAction",data:{actionId:a.actionId},targetComponentId:a.targetComponentId},fragment:void 0,ui:void 0,error:void 0,callbackToken:""};setTimeout(()=>Ft.next(s))}else this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.actionId,parameters:{}},bubbles:!0,composed:!0}))}if(t.type=="MarkAsDirty"&&this.dispatchEvent(new CustomEvent("dirty",{detail:{},bubbles:!0,composed:!0})),t.type=="MarkAsClean"&&this.dispatchEvent(new CustomEvent("clean",{detail:{},bubbles:!0,composed:!0})),t.type=="DownloadFile"){const a=t.data;if(a&&a.base64Content){const s=atob(a.base64Content),i=new Uint8Array(s.length);for(let c=0;c<s.length;c++)i[c]=s.charCodeAt(c);const r=new Blob([i],{type:a.mimeType}),n=URL.createObjectURL(r),l=document.createElement("a");l.href=n,l.download=a.filename??"export",l.click(),URL.revokeObjectURL(n)}}if(t.type=="CloseModal"&&(this.closeModal(),this.dispatchNamedEvent(t.data)),t.type=="AddContentToHead"){const a=t.data;if(a&&a.name){if(a.attributes&&a.attributes.id&&document.getElementById(a.attributes.id))return;document.head.appendChild(this.createElement(t))}}if(t.type=="AddContentToBody"){const a=t.data;if(a&&a.name){if(a.attributes&&a.attributes.id&&document.getElementById(a.attributes.id))return;document.body.appendChild(this.createElement(t))}}}dispatchNamedEvent(t){if(t&&t.eventName){const a=this.component,s=a?.emitsName??a?.serverSideType;let i=t.payload??t.detail;s&&i&&typeof i=="object"&&(i={...i,__source:s}),this.dispatchEvent(new CustomEvent(t.eventName,{detail:i,bubbles:!0,composed:!0}))}}removeTopOverlayChild(){const t=this.component?.children;if(t)for(let a=t.length-1;a>=0;a--){const s=t[a]?.metadata?.type;if(s==v.Drawer||s==v.Dialog){t.splice(a,1);return}}}}vo([h()],es.prototype,"id");vo([h()],es.prototype,"baseUrl");var gp=Object.defineProperty,$p=(e,t,a,s)=>{for(var i=void 0,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(t,a,i)||i);return i&&gp(t,a,i),i};class hi extends es{applyFragment(t){}manageActionRequestedEvent(t){}}$p([h()],hi.prototype,"component");var yp=Object.defineProperty,xp=Object.getOwnPropertyDescriptor,ea=(e,t,a,s)=>{for(var i=s>1?void 0:s?xp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&yp(t,a,i),i};const wp=()=>{let e=document.activeElement;for(;e?.shadowRoot?.activeElement;)e=e.shadowRoot.activeElement;return e},kp=(e,t)=>{let a=t;for(;a;){if(a===e)return!0;a=a.assignedSlot??a.parentNode??a.host??null}return!1};let ut=class extends hi{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={},this.detailsOpenedItems=[],this.hoveredItem=null,this.onGridHoverMove=e=>{const t=e.currentTarget,a=t.getEventContext(e)?.item??null;a!==this.hoveredItem&&(this.hoveredItem=a,t.generateCellPartNames())},this.onGridHoverLeave=e=>{this.hoveredItem!==null&&(this.hoveredItem=null,e.currentTarget.generateCellPartNames())},this.hoverCellPartNameGenerator=(e,t)=>t?.item!=null&&t.item===this.hoveredItem?"hovered-cell":"",this._onRowKey=e=>{const t=this.field?.rowSelectionShortcut;if(!t||!this.field?.onItemSelectionActionId||!this._isRowShortcutRelevant()||!zr(t,e))return;const a=/^(?:Digit|Numpad)([1-9])$/.exec(e.code);if(!a)return;const s=this.currentItems(),i=parseInt(a[1],10)-1;i>=s.length||(e.preventDefault(),this.selectRow(s[i]))},this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._onRowKey)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._onRowKey)}currentItems(){return this.field?.remoteCoordinates?this.data?.[this.id]?.content??[]:this.field?.fieldId&&this.state?this.state[this.field.fieldId]??[]:[]}selectRow(e){!e||!this.field?.onItemSelectionActionId||(this.selectedItems=[e],this.state[this.id+"_selected_items"]=[e],this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.field.onItemSelectionActionId,parameters:{_clickedRow:e}},bubbles:!0,composed:!0})))}_isRowShortcutRelevant(){if(this.offsetParent===null&&this.getClientRects().length===0)return!1;const e=wp();if(e&&e!==document.body&&!kp(this,e)){const t=e.tagName?.toLowerCase()??"";if(e.isContentEditable||/^(input|textarea|select)$/.test(t)||t.startsWith("vaadin-")&&/(field|combo|picker|area|select)/.test(t))return!1}return!0}handleItemToggle(e){const{item:t,selected:a,shiftKey:s}=e.detail;if(this.rangeStartItem??=t,s){let i=[];this.field?.fieldId&&this.state&&this.state[this.field.fieldId]&&(i=this.state[this.field.fieldId]);const[r,n]=[this.rangeStartItem,t].map(u=>i.indexOf(u)).sort((u,m)=>u-m),l=i.slice(r,n+1),c=new Set(this.selectedItems);l.forEach(u=>{a?c.add(u):c.delete(u)}),this.selectedItems=[...c],this.state[this.id+"_selected_items"]=this.selectedItems}this.rangeStartItem=t}render(){let e=[];this.field?.fieldId&&this.state&&this.state[this.field.fieldId]&&(e=this.state[this.field.fieldId]);const t=this.state[this.field?.fieldId+"_show_detail"]||this.state._show_detail&&this.state._show_detail[this.field.fieldId];if(this.field?.remoteCoordinates){const a=this.field.remoteCoordinates,s="";this.data[this.id]&&(this.data[this.id].searchSignature||s)&&this.data[this.id].searchSignature!=s&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements?e=this.data[this.id].content:this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a.action,parameters:{searchText:s,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0}))}if(Array.isArray(e)&&e.forEach((a,s)=>{a&&typeof a=="object"&&a._rowNumber===void 0&&(a._rowNumber=s)}),this.field?.inlineEditing)return this.renderMaster(e);if(this.field?.formPosition&&this.field?.formPosition.startsWith("modal")){const a=this;return o`
            ...
            <vaadin-grid
                    ...
                    ${T(this.field?.detailPath?Cr(a=>o`${w(this,a[this.field?.detailPath],this.baseUrl,this.state,this.data,this.appState,this.appData)}`):void 0)}
            ...
            >
                ...
                `}
                ${this.field?.columns?.map(a=>Ps(a,this,this.baseUrl,this.state,this.data,this.appState,this.appData))}
            ...
            ${this.field?.readOnly?d:this.field?.inlineEditing?o`
                ...
                `}
        </vaadin-vertical-layout>`}};ut.styles=C`
        ${Kt}
    ...
    `;ea([h()],ut.prototype,"field",2);ea([h()],ut.prototype,"state",2);ea([h()],ut.prototype,"data",2);ea([h()],ut.prototype,"appState",2);ea([h()],ut.prototype,"appData",2);ea([h()],ut.prototype,"selectedItems",2);ea([$()],ut.prototype,"detailsOpenedItems",2);ut=ea([k("mateu-grid")],ut);var Cp=Object.defineProperty,Sp=Object.getOwnPropertyDescriptor,Ma=(e,t,a,s)=>{for(var i=s>1?void 0:s?Sp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Cp(t,a,i),i};let Ht=class extends S{constructor(){super(...arguments),this.getNewValue=e=>{if(this.field?.dataType=="array"){if(!this.value)return[e];const t=this.value;return t.indexOf(e)>=0?t.filter(a=>a!==e):[...t,e]}return e}}render(){let e=this.field?.options;if(this.field?.remoteCoordinates){const a=this.field.remoteCoordinates;this.data?.[this.field.fieldId]&&this.data[this.field.fieldId].content&&this.data[this.field.fieldId].totalElements?e=this.data[this.field.fieldId].content:this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a.action,parameters:{searchText:"",fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0}))}const t=this.field?.attributes?.divStyle;return o`
  ...
  `;Ma([h()],Ht.prototype,"field",2);Ma([h()],Ht.prototype,"baseUrl",2);Ma([h()],Ht.prototype,"state",2);Ma([h()],Ht.prototype,"data",2);Ma([h()],Ht.prototype,"value",2);Ht=Ma([k("mateu-choice")],Ht);var Ip=Object.defineProperty,_p=Object.getOwnPropertyDescriptor,mt=(e,t,a,s)=>{for(var i=s>1?void 0:s?_p(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ip(t,a,i),i};let Ne=class extends S{constructor(){super(...arguments),this.currencyChanged=e=>{this.value||(this.value={value:0,currency:"EUR",locale:"es-ES"}),this.value.currency=e.detail.value,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:{...this.value},fieldId:this.fieldId}}))},this.valueChanged=e=>{this.value||(this.value={value:0,currency:"EUR",locale:"es-ES"}),e.detail.value&&(this.value.value=e.detail.value?parseFloat(e.detail.value):0,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:{...this.value},fieldId:this.fieldId}})))}}render(){return o`
            <vaadin-number-field
                    id="${this.fieldId}"
                    label="${this.label}"
...
`,this.comboRenderer=e=>o`
        ...
        `:d}
                            ...
                            `:e.label}
`,this.filteredIcons=[],this.navLinkOffset=null,this.iconFilterChanged=e=>{this.filteredIcons=pr.filter(t=>!e.detail.value||t.indexOf(e.detail.value)>=0)}}remoteComboDataProvider(e){return(t,a)=>{const{filter:s,page:i,pageSize:r}=t,n=s??"";this._comboFilter=n,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e,parameters:{searchText:s,fieldId:this.field?.fieldId,size:r,page:i,sort:void 0},callback:l=>{if(n===this._comboFilter)if(l?.messages?.forEach(c=>{ra.show(c.text,{position:c.position?this.mapPosition(c.position):void 0,theme:c.variant,duration:c.duration})}),!l.fragments||l.fragments.length==0)this.comboData=[],a([],0);else{const c=l.fragments[0].data?.[this.id];this.comboData=c?.content,a(c?.content,c?.totalElements)}},callbackonly:!0},bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.rendered=!1}renderNavLink(){const e=this.field?.link;if(!e?.href)return d;const t=Oe(e.href,this.state,this.data)??e.href,a=Oe(e.title,this.state,this.data)||t,s=e.icon||(t.startsWith("http")?"vaadin:external-link":"vaadin:link"),i=this.navLinkOffset??"calc(var(--lumo-font-size-s) * 1.6 + (var(--lumo-size-m) - var(--lumo-icon-size-s)) / 2)";return o`<a
                data-navlink
                href="${t}"
                title="${a}"
        ...
        ><vaadin-icon icon="${s}" style="width: var(--lumo-icon-size-s); height: var(--lumo-icon-size-s);"></vaadin-icon></a>`}positionNavLink(){const e=this.renderRoot?.querySelector("a[data-navlink]");e&&setTimeout(()=>{const t=e.parentElement,a=t?.firstElementChild?.firstElementChild;if(!t||!a)return;const i=(a.shadowRoot?.querySelector('[part="input-field"]')??a).getBoundingClientRect();if(i.height===0)return;const r=Math.max(0,i.top+i.height/2-e.offsetHeight/2-t.getBoundingClientRect().top),n=`${Math.round(r)}px`;this.navLinkOffset!==n&&(this.navLinkOffset=n)})}helperText(){return this.helperShownInControl=!0,de(this.field?.description??"",this.state,this.data)??""}render(){const e=this.field?.fieldId??"";this.rendered=!0;const t=this.renderNavLink();this.helperShownInControl=!1;const a=this.renderField(),s=this.field?.description&&!this.helperShownInControl?de(this.field.description,this.state,this.data):void 0;return o`<div style="display: block;">
            ...
            >${p?o`<span style="color: var(--lumo-secondary-text-color, #888); white-space: nowrap;">${s}</span>`:d}${m}</div>`}renderBulletedListField(e,t,a,s){if(!this.field)return o``;const i=de(t,this.state,this.data),r=Array.isArray(i)?i.map(n=>String(n)):i!=null&&i!==""?[String(i)]:[];return o`<vaadin-custom-field
                    id="${this.field.fieldId}"
                    label="${a}"
                    .helperText="${this.helperText()}"
                    data-colspan="${this.field?.colspan}"
...
`}renderFileField(e,t,a,s){if(!this.field)return o``;const i=t?.map(r=>({id:r.id,name:r.name,type:"",uploadTarget:"",complete:!0}))??[];return o`
            ...
            `}renderStringField(e,t,a,s){if(!this.field)return o``;if(this.field?.stereotype=="searchable"){const i=n=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"code-"+this.field?.fieldId,parameters:{code:n.currentTarget.value}},bubbles:!0,composed:!0}))},r=n=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"codesearch-"+this.field?.fieldId,parameters:{}},bubbles:!0,composed:!0}))};return o`
              ...
              ${i.description}
                ...
                `;if(this.field?.stereotype=="fileUpload"){const i=ao(this.field.attributes,"accept");return o`
                    <vaadin-custom-field
                            id="${this.field.fieldId}"
                            label="${a}"
                            .helperText="${this.helperText()}"
  ...
  ${_s(this.renderColorPickerFooter,[])}
></vaadin-dialog>
                `:o`
                <vaadin-text-field
                        id="${this.field.fieldId}"
...
`;if(this.field?.stereotype=="listBox"){if(this.field?.remoteCoordinates){const i=this.field.remoteCoordinates,r="";return this.data[this.id]&&(this.data[this.id].searchSignature||r)&&this.data[this.id].searchSignature!=r&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements||this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:i.action,parameters:{searchText:r,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0})),o`
  ...
  `;je([h()],me.prototype,"component",2);je([h()],me.prototype,"field",2);je([h()],me.prototype,"baseUrl",2);je([h()],me.prototype,"state",2);je([h()],me.prototype,"data",2);je([h()],me.prototype,"appState",2);je([h()],me.prototype,"appData",2);je([h()],me.prototype,"labelAlreadyRendered",2);je([$()],me.prototype,"colorPickerOpened",2);je([$()],me.prototype,"colorPickerValue",2);je([$()],me.prototype,"filteredIcons",2);je([$()],me.prototype,"navLinkOffset",2);me=je([k("mateu-field")],me);var Dt=(e=>(e.OnLoad="OnLoad",e.OnSuccess="OnSuccess",e.OnError="OnError",e.OnValueChange="OnValueChange",e.OnCustomEvent="OnCustomEvent",e.AutoSave="AutoSave",e))(Dt||{}),Tp=Object.defineProperty,ts=(e,t,a,s)=>{for(var i=void 0,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(t,a,i)||i);return i&&Tp(t,a,i),i};class ta extends hi{constructor(){super(...arguments),this.state={},this.data={},this.appData={},this.appState={},this.triggerOnLoad=()=>{const t=this.component;this.registerCustomEventListeners(),t.triggers?.filter(a=>a.type==Dt.OnLoad).forEach(a=>{if((!a.condition||this._evalExpr(a.condition))&&!a.triggered){const i=a;i.triggered=!0;var s=i.times-1;i.timeoutMillis>0?this.scheduleOnload(i,s,this.id):this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:i.actionId},bubbles:!0,composed:!0}))}})},this.scheduleOnload=(t,a,s)=>{if(s!=this.component?.id)return;const i=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,callbackToken:i},bubbles:!0,composed:!0}))},t.timeoutMillis)},this._registeredCustomEventListeners=[],this.customEventManager=t=>{if(!(t instanceof CustomEvent))return;const a=t,i=(this.component.triggers??[]).filter(r=>r.type==Dt.OnCustomEvent).filter(r=>r.eventName==a.type).filter(r=>r.source!=="COMPONENT"||a.detail?.__source===r.from);i.length!==0&&(i.some(r=>!r.source||r.source==="SELF")&&(t.stopPropagation(),t.preventDefault()),i.forEach(r=>{(!r.condition||this._evalExpr(r.condition))&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.actionId,parameters:a.detail},bubbles:!0,composed:!0}))}))}}_interpolationExtra(){return{appState:this.appState??{},appData:this.appData??{},component:this.component}}_evalExpr(t){return _r(t,this.state??{},this.data??{},this._interpolationExtra())}_evalTemplate(t){return yn(t,this.state??{},this.data??{},this._interpolationExtra())}applyFragment(t){if(this.id==t.targetComponentId){if(t.component)if(si.Add==t.action)this.component&&this.component.children?.push(t.component);else{if(this.callbackToken=ye(),t.component?.type==oe.ServerSide)if(this.component){const s=this.component,i=t.component;s.actions=i.actions,s.type=i.type,s.rules=i.rules,s.triggers=i.triggers,s.serverSideType=i.serverSideType,s.route=i.route,s.initialData=i.initialData,s.validations=i.validations,s.cssClasses=i.cssClasses,s.slot=i.slot,s.style=i.style,s.children=i.children,(s.serverSideType!=i.serverSideType||s.id!=i.id)&&setTimeout(()=>this.triggerOnLoad())}else this.component=t.component,setTimeout(()=>this.triggerOnLoad());else{const s=[t.component];this.component&&(this.component.children=s)}t.action!==si.ReplaceKeepData&&(this.state={},this.data={})}if(t.state&&(this.state={...this.state,...t.state}),t.data){for(const s in t.data){const i=t.data[s]?.page;i?.pageNumber>0&&this.data[s]&&this.data[s].page.content&&(i.content?i.content=[...this.data[s].page.content,...i.content]:i.content=[...this.data[s].page.content])}this.data={...this.data,...t.data}}this.registerCustomEventListeners();const a=te.getAfterRenderHook();a&&setTimeout(()=>a(this)),this.requestUpdate()}}registerCustomEventListeners(){this._registeredCustomEventListeners.forEach(({target:a,name:s})=>a.removeEventListener(s,this.customEventManager)),this._registeredCustomEventListeners=[],this.component?.triggers?.filter(a=>a.type==Dt.OnCustomEvent).forEach(a=>{const s=a.source==="DOCUMENT"||a.source==="COMPONENT"?document:this;s.addEventListener(a.eventName,this.customEventManager),this._registeredCustomEventListeners.push({target:s,name:a.eventName})})}disconnectedCallback(){this._registeredCustomEventListeners.forEach(({target:t,name:a})=>t.removeEventListener(a,this.customEventManager)),this._registeredCustomEventListeners=[],super.disconnectedCallback()}connectedCallback(){super.connectedCallback(),this.component&&this.registerCustomEventListeners()}}ts([h()],ta.prototype,"state");ts([h()],ta.prototype,"data");ts([h()],ta.prototype,"appData");ts([h()],ta.prototype,"appState");const Op={lon:0,lat:0},hr=3,Rp=e=>{if(!e)return;const t=e.split(",").map(i=>i.trim());if(t.length!==2)return;const a=Number(t[0]),s=Number(t[1]);if(!(t[0]===""||t[1]===""||!Number.isFinite(a)||!Number.isFinite(s)))return{lon:s,lat:a}},Ap=e=>{if(e==null||e.trim()==="")return hr;const t=Number(e);return Number.isFinite(t)?t:hr};var zp=Object.defineProperty,jp=Object.getOwnPropertyDescriptor,as=(e,t,a,s)=>{for(var i=s>1?void 0:s?jp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&zp(t,a,i),i};let Oa=class extends S{constructor(){super(...arguments),this.renderSeq=0}updated(e){super.updated(e),this.createMap()}disconnectedCallback(){super.disconnectedCallback(),this.map?.setTarget(void 0),this.map=void 0}async createMap(){const e=++this.renderSeq,[{default:t},{default:a},{default:s},{default:i},{fromLonLat:r},{default:n}]=await Promise.all([Te(()=>import("./vendor-ol.js").then(c=>c.M),[]),Te(()=>import("./vendor-ol.js").then(c=>c.V),[]),Te(()=>import("./vendor-ol.js").then(c=>c.T),[]),Te(()=>import("./vendor-ol.js").then(c=>c.O),[]),Te(()=>import("./vendor-ol.js").then(c=>c.p),[]),Te(()=>import("./vendor-ol.js").then(c=>c.o),[])]);if(e!==this.renderSeq||!this.isConnected)return;if(!this.shadowRoot.querySelector("style[data-ol]")){const c=document.createElement("style");c.setAttribute("data-ol",""),c.textContent=n,this.shadowRoot.appendChild(c)}this.map&&(this.map.setTarget(void 0),this.map=void 0);const l=Rp(this.position)??Op;this.map=new t({target:this.mapElement,layers:[new s({source:new i})],view:new a({center:r([l.lon,l.lat]),zoom:Ap(this.zoom)})})}render(){return o`<div id="map"></div>`}};Oa.styles=C`
        :host {
            display: block;
            width: 100%;
            height: 25rem;
    ...
    `;as([h()],Oa.prototype,"position",2);as([h()],Oa.prototype,"zoom",2);as([at("#map")],Oa.prototype,"mapElement",2);Oa=as([k("mateu-map")],Oa);const Lp=typeof HTMLElement<"u"?HTMLElement:class{};class Dp extends Lp{static get observedAttributes(){return["content"]}#e;#t=0;get content(){return this.#e}set content(t){this.#e=t,this.#a()}attributeChangedCallback(t,a,s){this.content=s??void 0}connectedCallback(){this.style.display="block",this.#a()}async#a(){if(!this.isConnected)return;const t=this.#e??"",a=++this.#t,[{marked:s},{default:i}]=await Promise.all([Te(()=>import("./vendor.js").then(r=>r.f),[]),Te(()=>import("./vendor.js").then(r=>r.c),[])]);a===this.#t&&(this.innerHTML=i.sanitize(await s.parse(t),{USE_PROFILES:{html:!0,svg:!0,svgFilters:!0},CUSTOM_ELEMENT_HANDLING:{tagNameCheck:r=>!0}}))}}typeof customElements<"u"&&!customElements.get("mateu-markdown")&&customElements.define("mateu-markdown",Dp);var Fp=Object.defineProperty,Np=Object.getOwnPropertyDescriptor,ka=(e,t,a,s)=>{for(var i=s>1?void 0:s?Np(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Fp(t,a,i),i};const Mp=e=>{const t=[];return e.color&&e.color!=="normal"&&e.color!=="none"&&t.push(e.color),e.buttonStyle&&t.push(e.buttonStyle==="tertiaryInline"?"tertiary-inline":e.buttonStyle),e.size&&e.size!=="none"&&e.size!=="normal"&&t.push(e.size),t.length?t.join(" "):void 0},mr=e=>e==="back"||e==="backToList"||!!e&&e.startsWith("cancel");let It=class extends S{constructor(){super(...arguments),this.appState={},this.appData={},this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.evalLabel=e=>Oe(e,this.state,this.data),this.renderBtn=e=>{if((this.data??{})[e.actionId+".hidden"])return d;const t=this.evalLabel(e.label),a=te.get()?.renderToolbarButton?.(e,t,()=>this.handleButtonClick(e.actionId));return a||o`
        <vaadin-button
                data-action-id="${e.id}"
                theme="${Mp(e)||d}"
    ...
    `}}render(){const e=this.metadata;if(!e)return o``;const t=e.toolbar??[],a=t.filter(l=>mr(l.actionId)),s=t.filter(l=>!mr(l.actionId)),i=a.length>0&&s.length>0?o`<span class="toolbar-divider"></span>`:d,r=e.avatar||e.title||e.subtitle||e.kpis?.length>0||e.header?.length>0||t.length>0,n=e.level??0;return n>0?this.setAttribute("data-nested",""):this.removeAttribute("data-nested"),o`
            ...
            `:r?o`
                <div style="display: flex; gap: var(--lumo-space-m, 1rem); width: 100%; align-items: center;" class="form-header">
                    ...
                    <div style="flex: 1; min-width: 0; overflow: hidden;">
                        ${e?.title&&n==0?o`<h2 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ge(wt(e?.title,this.state??{},this.data??{}))}</h2>`:d}
                        ${e?.title&&n==1?o`<h3 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ge(wt(e?.title,this.state??{},this.data??{}))}</h3>`:d}
                        ${e?.title&&n==2?o`<h4 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ge(wt(e?.title,this.state??{},this.data??{}))}</h4>`:d}
                        ${e?.title&&n==3?o`<h5 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ge(wt(e?.title,this.state??{},this.data??{}))}</h5>`:d}
                        ${e?.title&&n>3?o`<h6 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ge(wt(e?.title,this.state??{},this.data??{}))}</h6>`:d}

                        ${e?.subtitle?o`<span style="display: inline-block; margin-block-end: 0.83em;">${ge(wt(e?.subtitle,this.state??{},this.data??{}))}</span>`:d}
                    </div>
                    <div style="display: flex; gap: var(--lumo-space-m, 1rem); align-items: center;">
                        ${e?.kpis?.map(l=>o`
                            <div style="display: flex; flex-direction: column; align-items: center;">
                                <div>${this.evalLabel(l.title)}</div>
                                <div>${ge(wt(l.text,this.state??{},this.data??{}))}</div>
                            </div>
                        `)}
                        ${e?.header?.map(l=>w(this,l,this.baseUrl,this.state??{},this.data??{},this.appState,this.appData))}
                        ${a.map(this.renderBtn)}
            ...
            ${e.badges&&e.badges.length>0?o`
                <div style="display: flex; gap: var(--lumo-space-s, .5rem); padding-bottom: var(--lumo-space-s, .5rem);">
                    ${e.badges.map(l=>rl(l,this.state??{},this.data??{}))}
                </div>
            `:d}
        `}};It.styles=C`
        :host {
        ...
        ${Kt}
    `;ka([h()],It.prototype,"metadata",2);ka([h()],It.prototype,"baseUrl",2);ka([h()],It.prototype,"state",2);ka([h()],It.prototype,"data",2);ka([h()],It.prototype,"appState",2);ka([h()],It.prototype,"appData",2);It=ka([k("mateu-content-header")],It);var qp=Object.defineProperty,Up=Object.getOwnPropertyDescriptor,mi=(e,t,a,s)=>{for(var i=s>1?void 0:s?Up(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&qp(t,a,i),i};let ua=class extends hi{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={}}render(){const e=this.component?.metadata;return o`
    ...
    `;mi([h()],ua.prototype,"state",2);mi([h()],ua.prototype,"data",2);mi([h()],ua.prototype,"appState",2);mi([h()],ua.prototype,"appData",2);ua=mi([k("mateu-form")],ua);var Bp=Object.defineProperty,Vp=Object.getOwnPropertyDescriptor,it=(e,t,a,s)=>{for(var i=s>1?void 0:s?Vp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Bp(t,a,i),i};let Re=class extends S{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.detailsOpenedItems=[],this.pagesRequested=[],this.emptyArray=e=>!e||e.length==0,this.dataProvider=(e,t)=>{const a=this.data[this.id]?.page;if(this.metadata?.infiniteScrolling&&e.page>0){let s=!1;a&&a.content&&(a.content.length>=(e.page+1)*e.pageSize||a.content.length==a.totalElements)&&(t(a.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),a.totalElements),s=!0,this.grid&&this.grid.recalculateColumnWidths()),s||this.pagesRequested.find(i=>i==e.page)||(this.pagesRequested.push(e.page),this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:e,callback:()=>{this.data[this.id]?.page?.content&&(t(this.data[this.id].page.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),this.data[this.id].page.totalElements),this.grid&&this.grid.recalculateColumnWidths())}},bubbles:!0,composed:!0})))}else{const s=this.metadata?.infiniteScrolling?a?.totalElements:a?.content?.length??0;t(a?.content??[],s),this.grid&&this.grid.recalculateColumnWidths()}},this._onActionRequested=e=>{const t=e.detail,a=this.identifierFieldName;if(!a||!t.parameters||t.actionId?.startsWith("action-on-row-"))return;const s=t.parameters[a];s!==void 0&&(this.state._selectedId=String(s),this._applyCellPartNameGenerator(),this.grid?.requestContentUpdate())},this.tooltipGenerator=e=>{let t="";const{column:a,item:s}=e,i=this.metadata?.columns?.find(r=>r.metadata.id==a?.path);if(i?.metadata){const r=(i?.metadata).tooltipPath;r&&a&&s&&(t=s[r])}return t}}get identifierFieldName(){const e=this.metadata?.columns?.find(a=>a.metadata?.identifier);if(e)return e.metadata?.id;if(this.metadata?.columns?.find(a=>a.metadata?.id==="id"))return"id"}_applyCellPartNameGenerator(){if(!this.grid)return;const e=this.identifierFieldName,t=this.state?._selectedId??this.appState?._splitDetailId,a=!!this.metadata?.groupBy;e&&t!==void 0||a?this.grid.cellPartNameGenerator=(s,i)=>{const r=i.item;return Ja(r)?"mateu-group-row":e&&t!==void 0&&String(r[e])===String(t)?"selected-row":""}:this.grid.cellPartNameGenerator=null}connectedCallback(){super.connectedCallback(),this.addEventListener("action-requested",this._onActionRequested)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("action-requested",this._onActionRequested)}updated(e){super.updated(e),this._applyCellPartNameGenerator(),this.grid?.clearCache(),this.grid?.requestContentUpdate(),this.grid?.recalculateColumnWidths(),this.pagesRequested=[]}render(){const e=this.data[this.id],t=e?.page,a=this.metadata?.groupBy,s=this.metadata?.infiniteScrolling?void 0:t?.content?Er(t.content,a,e?.groups):t?.content,i=(this.metadata?.columns??[]).flatMap(c=>c.metadata?.type===v.GridGroupColumn?(c.metadata.columns??[]).map(u=>u.metadata):[c.metadata]),r=Rr(i,e,a);let n="";this.metadata?.wrapCellContent&&(n+=" wrap-cell-content"),this.metadata?.compact&&(n+=" compact"),this.metadata?.noBorder&&(n+=" no-border"),this.metadata?.noRowBorder&&(n+=" no-row-borders"),this.metadata?.columnBorders&&(n+=" column-borders"),this.metadata?.rowStripes&&(n+=" row-stripes");const l=this.state[this.id+"_selected_items"]||[];return o`
            <vaadin-grid
                    ...
                    @selected-items-changed="${c=>{const u=(c.detail.value??[]).filter(m=>!Ja(m));this.emptyArray(this.state[this.id+"_selected_items"])&&this.emptyArray(u)||(this.state[this.id+"_selected_items"]=u,this.metadata?.onRowSelectionChangedActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.metadata?.onRowSelectionChangedActionId},bubbles:!0,composed:!0})))}}"
                    @active-item-changed="${T(this.metadata?.detailPath&&!this.metadata?.useButtonForDetail?c=>{if(this.metadata?.detailPath){const u=c.detail.value;if(u&&Ja(u))return;u?this.detailsOpenedItems=[u]:this.detailsOpenedItems=[]}}:void 0)}"
                    .detailsOpenedItems="${this.detailsOpenedItems}"
                    ${T(this.metadata?.detailPath?Cr(c=>o`${w(this,c[this.metadata?.detailPath],this.baseUrl,this.state,this.data,this.appState,this.appData)}`):void 0)}
                    theme="${n}"
            ...
            >
                ...
                `:d}
                ${this.metadata?.columns?.map(c=>Ps(c,this,this.baseUrl,this.state,this.data,this.appState,this.appData,r))}
                ${this.metadata?.useButtonForDetail?o`
                    <vaadin-grid-column
                            width="44px"
                            flex-grow="0"
                            ${kt((c,{detailsOpened:u})=>o`
              <vaadin-button
                theme="tertiary icon"
            ...
            `,[])}
                    ></vaadin-grid-column>
                `:d}
                <span slot="empty-state">${sa(this.emptyStateMessage??this.metadata?.emptyStateMessage)}</span>
  ...
  `;it([h()],Re.prototype,"id",2);it([h()],Re.prototype,"metadata",2);it([h()],Re.prototype,"baseUrl",2);it([h()],Re.prototype,"state",2);it([h()],Re.prototype,"data",2);it([h()],Re.prototype,"appState",2);it([h()],Re.prototype,"appData",2);it([h()],Re.prototype,"emptyStateMessage",2);it([$()],Re.prototype,"detailsOpenedItems",2);it([at("vaadin-grid")],Re.prototype,"grid",2);Re=it([k("mateu-table")],Re);const fo="mateu-saved-views",is=()=>{try{return JSON.parse(localStorage.getItem(fo)??"{}")}catch{return{}}},qs=e=>{try{localStorage.setItem(fo,JSON.stringify(e))}catch{}},Ni=e=>is()[e]??[],bo=(e,t)=>{const a=t.name?.trim();if(!a||Object.keys(t.values??{}).length===0)return;const s=is(),i=(s[e]??[]).filter(r=>r.name!==a);i.push({...t,name:a}),s[e]=i,qs(s)},go=(e,t)=>{const a=is(),s=(a[e]??[]).filter(i=>i.name!==t);s.length===0?delete a[e]:a[e]=s,qs(a)},$o=(e,t)=>{const a=is();a[e]=(a[e]??[]).map(s=>({...s,isDefault:s.name===t?!s.isDefault:!1})),qs(a)},yo=e=>Ni(e).find(t=>t.isDefault);var Wp=Object.defineProperty,Hp=Object.getOwnPropertyDescriptor,Ve=(e,t,a,s)=>{for(var i=s>1?void 0:s?Hp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Wp(t,a,i),i};let we=class extends S{constructor(){super(...arguments),this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.searchOnly=!1,this.panelOpened=!1,this.viewsOpened=!1,this.draftText="",this.openPanel=()=>{this.panelOpened||this.filters.length===0||(this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick))},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1,this.activeFilter=void 0},this.clearAllFilters=()=>{const e=this.filters.flatMap(a=>this.isRangeFilter(a)?[`${a.fieldId}_from`,`${a.fieldId}_to`]:[a.fieldId]),t={searchText:void 0};e.forEach(a=>{t[a]=void 0}),this.state={...this.state,...t},this.dispatchEvent(new CustomEvent("filter-reset-requested",{detail:{fieldIds:e},bubbles:!0,composed:!0})),this.requestSearch()},this.keepFocus=e=>e.preventDefault()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}get filters(){return this.metadata?.filters??[]}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}requestSearch(){this.closePanel(),this.dispatchEvent(new CustomEvent("search-requested",{detail:{},bubbles:!0,composed:!0}))}emitValueChanged(e,t){this.state={...this.state,[e]:t},this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t,fieldId:e},bubbles:!0,composed:!0}))}applyFilter(e,t){this.emitValueChanged(e,t),this.requestSearch()}removeChip(e){const t=this.filters.find(a=>a.fieldId===e);t&&this.isRangeFilter(t)?(this.emitValueChanged(`${e}_from`,void 0),this.emitValueChanged(`${e}_to`,void 0)):this.emitValueChanged(e,e==="searchText"?"":void 0),this.requestSearch()}commitText(e){this.emitValueChanged("searchText",e.value),this.draftText="",e.value="",this.requestSearch()}get viewsScope(){return window.location.pathname}allFilterKeys(){return["searchText",...this.filters.flatMap(e=>this.isRangeFilter(e)?[`${e.fieldId}_from`,`${e.fieldId}_to`]:[e.fieldId])]}snapshotValues(){const e={};return this.state.searchText&&(e.searchText=this.state.searchText),this.filters.forEach(t=>{if(this.isSet(t))if(this.isRangeFilter(t)){const a=this.rangeBound(t,"from"),s=this.rangeBound(t,"to");a&&(e[`${t.fieldId}_from`]=a),s&&(e[`${t.fieldId}_to`]=s)}else this.isMultiFilter(t)?e[t.fieldId]=this.multiValues(t):e[t.fieldId]=this.state[t.fieldId]}),e}applyView(e){const t=this.allFilterKeys(),a={};t.forEach(s=>{a[s]=void 0}),this.state={...this.state,...a},this.dispatchEvent(new CustomEvent("filter-reset-requested",{detail:{fieldIds:t},bubbles:!0,composed:!0})),Object.entries(e.values).forEach(([s,i])=>this.emitValueChanged(s,i)),this.viewsOpened=!1,this.detachOutsideClick(),this.requestSearch()}saveCurrentView(e){const t=e.value.trim();t&&(bo(this.viewsScope,{name:t,values:this.snapshotValues()}),e.value="",this.requestUpdate())}firstUpdated(){if(window.location.search)return;const e=yo(this.viewsScope);e&&setTimeout(()=>{this.state.searchText||this.filters.some(a=>this.isSet(a))||this.applyView(e)},0)}isBooleanFilter(e){return e.dataType==="boolean"||e.dataType==="bool"||e.stereotype==="checkbox"||e.stereotype==="toggle"}isNumericFilter(e){return["integer","decimal","number","money"].includes(e.dataType??"")}isRangeFilter(e){return e.stereotype==="dateRange"||e.stereotype==="numberRange"}isMultiFilter(e){return e.stereotype==="multiSelect"}hasOptions(e){return(e.options?.length??0)>0}multiValues(e){const t=this.state[e.fieldId];return Array.isArray(t)?t.map(String):typeof t=="string"&&t!==""?t.split(",").map(a=>a.trim()).filter(a=>a):[]}rangeBound(e,t){const a=this.state[`${e.fieldId}_${t}`];return a==null?"":String(a)}isSet(e){if(this.isRangeFilter(e))return this.rangeBound(e,"from")!==""||this.rangeBound(e,"to")!=="";if(this.isMultiFilter(e))return this.multiValues(e).length>0;const t=this.state[e.fieldId];return t!=null&&t!==""&&!Number.isNaN(t)}getFilterDisplayValue(e,t){if(e.options?.length){const a=e.options.find(s=>s.value===String(t));if(a)return a.label??a.value}return typeof t=="boolean"?t?"Yes":"No":String(t)}conditionDisplay(e){if(this.isRangeFilter(e)){const t=this.rangeBound(e,"from"),a=this.rangeBound(e,"to");return t&&a?`${t} – ${a}`:t?`≥ ${t}`:`≤ ${a}`}return this.isMultiFilter(e)?this.multiValues(e).map(t=>this.getFilterDisplayValue(e,t)).join(", "):this.getFilterDisplayValue(e,this.state[e.fieldId])}labelOf(e){return Oe(e.label,this.state,this.data)||e.fieldId}panelRow(e,t,a="panel-row"){return o`
        ...
        `,()=>a(s.value)))}`}renderActiveFilterWidget(e){if(this.isRangeFilter(e))return this.renderRangeWidget(e);if(this.isMultiFilter(e))return this.renderMultiWidget(e);if(this.hasOptions(e))return o`${e.options.map(s=>this.panelRow(s.label??s.value,()=>this.applyFilter(e.fieldId,s.value)))}`;if(this.isBooleanFilter(e))return o`
            ...
            </div>`}renderViewsPanel(){if(!this.viewsOpened)return d;const e=Ni(this.viewsScope),t=!!this.state.searchText||this.filters.some(a=>this.isSet(a));return o`
                ...
                ${e.map(a=>o`
                    <div class="panel-row view-row" @mousedown="${this.keepFocus}">
                        ...
                        <button class="view-star ${a.isDefault?"view-star--on":""}"
                                ...
                                @click="${()=>{$o(this.viewsScope,a.name),this.requestUpdate()}}">★</button>
    ...
    `;Ve([h()],we.prototype,"metadata",2);Ve([h()],we.prototype,"baseUrl",2);Ve([$()],we.prototype,"state",2);Ve([$()],we.prototype,"data",2);Ve([h()],we.prototype,"appState",2);Ve([h()],we.prototype,"appData",2);Ve([h({type:Boolean})],we.prototype,"searchOnly",2);Ve([$()],we.prototype,"panelOpened",2);Ve([$()],we.prototype,"viewsOpened",2);Ve([$()],we.prototype,"activeFilter",2);Ve([$()],we.prototype,"draftText",2);we=Ve([k("mateu-filter-bar")],we);const xo="mateu-column-prefs",Us=()=>{try{const e=JSON.parse(localStorage.getItem(xo)??"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}},wo=e=>{try{localStorage.setItem(xo,JSON.stringify(e))}catch{}},Bs=e=>{if(!e||typeof e!="object")return;const t=a=>Array.isArray(a)?a.filter(s=>typeof s=="string"):[];return{hidden:t(e.hidden),order:t(e.order)}},ko=e=>Bs(Us()[e]),Gp=(e,t)=>{const a=Us(),s=Bs(t);s.hidden.length===0&&s.order.length===0?delete a[e]:a[e]=s,wo(a)},Kp=e=>{const t=Us();delete t[e],wo(t)},Co=e=>e?!!e.identifier||e.dataType==="action"||e.dataType==="actionGroup"||e.dataType==="menu"||e.id==="select"||e.id==="menu":!1,So=(e,t,a=s=>s)=>{const s=Bs(t);if(!s||s.hidden.length===0&&s.order.length===0)return e;const i=p=>a(p)?.id??p.id,r=new Set(s.hidden),n=e.filter(p=>{const f=i(p);return!f||!r.has(f)||Co(a(p))});if(s.order.length===0)return n.length===e.length?e:n;const l=new Map;n.forEach(p=>{const f=i(p);f&&!l.has(f)&&l.set(f,p)});const c=[],u=new Set;return s.order.forEach(p=>{const f=l.get(p);f&&!u.has(f)&&(c.push(f),u.add(f))}),n.forEach(p=>{u.has(p)||(c.push(p),u.add(p))}),c.length===e.length&&c.every((p,f)=>p===e[f])?e:c};var Yp=Object.defineProperty,Jp=Object.getOwnPropertyDescriptor,vi=(e,t,a,s)=>{for(var i=s>1?void 0:s?Jp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Yp(t,a,i),i};let pa=class extends S{constructor(){super(...arguments),this.columns=[],this.scope="",this.panelOpened=!1,this.revision=0,this.togglePanel=()=>{if(this.panelOpened){this.closePanel();return}this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick)},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1},this.reset=()=>{Kp(this.scope),this.revision++,this.dispatchEvent(new CustomEvent("column-prefs-changed",{bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}get prefs(){return ko(this.scope)??{hidden:[],order:[]}}effectiveEntries(e){return So(this.columns,{hidden:[],order:e.order})}commit(e){Gp(this.scope,e),this.revision++,this.dispatchEvent(new CustomEvent("column-prefs-changed",{bubbles:!0,composed:!0}))}toggleVisibility(e){const t=this.prefs,a=t.hidden.includes(e)?t.hidden.filter(s=>s!==e):[...t.hidden,e];this.commit({...t,hidden:a})}move(e,t){const a=this.prefs,s=[...this.effectiveEntries(a)],i=s.findIndex(l=>l.id===e);if(i<0)return;let r=i+t;for(;r>=0&&r<s.length&&s[r].protected;)r+=t;if(r<0||r>=s.length)return;const n=s[i];s[i]=s[r],s[r]=n,this.commit({...a,order:s.map(l=>l.id)})}render(){this.revision;const e=this.prefs,t=this.effectiveEntries(e).filter(s=>!s.protected);if(t.length===0)return o``;const a=e.hidden.length>0||e.order.length>0;return o`
            <div class="chooser">
                <button
    ...
    `;vi([h()],pa.prototype,"columns",2);vi([h()],pa.prototype,"scope",2);vi([$()],pa.prototype,"panelOpened",2);vi([$()],pa.prototype,"revision",2);pa=vi([k("mateu-column-chooser")],pa);var Xp=Object.defineProperty,Qp=Object.getOwnPropertyDescriptor,fi=(e,t,a,s)=>{for(var i=s>1?void 0:s?Qp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Xp(t,a,i),i};let ha=class extends S{constructor(){super(...arguments),this.totalElements=0,this.pageSize=100,this.pageNumber=0,this.totalPages=0}updated(e){super.updated(e),(e.has("totalElements")||e.has("pageSize"))&&(this.totalPages=Math.ceil(this.totalElements/this.pageSize))}dispatch(e){this.dispatchEvent(new CustomEvent("page-changed",{bubbles:!0,composed:!0,detail:{page:e}}))}render(){if(!this.totalElements)return d;const e=this.totalPages>1,t=this.pageNumber,a=t===0,s=t>=this.totalPages-1;return o`
    ...
    `;fi([h()],ha.prototype,"totalElements",2);fi([h()],ha.prototype,"pageSize",2);fi([h()],ha.prototype,"pageNumber",2);fi([$()],ha.prototype,"totalPages",2);ha=fi([k("mateu-pagination")],ha);var Zp=Object.defineProperty,eh=Object.getOwnPropertyDescriptor,We=(e,t,a,s)=>{for(var i=s>1?void 0:s?eh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Zp(t,a,i),i};let ke=class extends S{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.dataProvider=(e,t)=>{const a=this.data[this.id]?.page;t(a?.content??[],a?.content?.length??0)},this.respondToVisibility=(e,t)=>{var a={root:document.documentElement},s=new IntersectionObserver(i=>{i.forEach(r=>{t(r.intersectionRatio>0)})},a);s.observe(e)},this.keepAsking=!1,this.askToUpper=()=>{const e=this.data[this.id]?.page,t=e?.content?.length/e?.pageSize;this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:{page:t,pageSize:this.metadata?.pageSize},callback:()=>{this.keepAsking&&this.askToUpper()}},bubbles:!0,composed:!0}))},this.renderItem=e=>e.card?js(this,e.card,this.baseUrl,this.state,this.data,this.appState,this.appData,!1):e.title?o`<vaadin-card
        >
                ...
                `:d}
                ${e.status?o`
                    <span slot="header-suffix" theme="badge ${Gi(e.status.type)}">${e.status.message}</span>
                `:d}
                ${e.image?o`
    ...
    `;We([h()],ke.prototype,"id",2);We([h()],ke.prototype,"metadata",2);We([h()],ke.prototype,"baseUrl",2);We([h()],ke.prototype,"state",2);We([h()],ke.prototype,"data",2);We([h()],ke.prototype,"appState",2);We([h()],ke.prototype,"appData",2);We([h()],ke.prototype,"emptyStateMessage",2);We([$()],ke.prototype,"keepAsking",2);We([at("#ask-for-more")],ke.prototype,"askForMore",2);We([$()],ke.prototype,"hasMore",2);ke=We([k("mateu-card-list")],ke);var Io=(e=>(e.none="none",e.success="success",e.error="error",e.warning="warning",e.contrast="contrast",e.normal="normal",e))(Io||{}),_o=(e=>(e.primary="primary",e.secondary="secondary",e.tertiary="tertiary",e.tertiaryInline="tertiaryInline",e))(_o||{}),th=Object.defineProperty,ah=Object.getOwnPropertyDescriptor,He=(e,t,a,s)=>{for(var i=s>1?void 0:s?ah(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&th(t,a,i),i};const ih={asc:"ascending",desc:"descending"};let Ce=class extends S{constructor(){super(...arguments),this.component=void 0,this.standalone=!1,this.state={},this.data={},this.appState={},this.appData={},this.showImportDialog=!1,this.availableWidthPx=1024,this.selectedItem=null,this._columnPrefsRevision=0,this._prefsRevisionApplied=-1,this.search=()=>{const e=this.component.metadata;this.state={...this.state,size:e.pageSize,page:0,crud_selected_items:[]},this._syncStateToUrl(e),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}}},bubbles:!0,composed:!0}))},this.notify=e=>{ra.show(e,{position:"bottom-end",theme:"error",duration:3e3})},this.handleSearchRequested=e=>{this.state={...this.state,crud_selected_items:[]};const t=this.component.metadata;this._syncStateToUrl(t),!t.infiniteScrolling&&this.data?.[this.id]?.page&&(this.data[this.id].page.content=[]),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}},callback:e},bubbles:!0,composed:!0}))},this.fetchMoreElements=e=>{const{params:t,callback:a}=e.detail;this.state={...this.state,size:t.pageSize,page:t.page},this.handleSearchRequested(a)},this.directionChanged=e=>{const t=e.detail.grid._sorters;this.state={...this.state,sort:t.map(a=>({fieldId:a.__data.path,direction:a.__data.direction?ih[a.__data.direction]:void 0}))},this.handleSearchRequested(void 0)},this._initializedForComponentId=void 0,this.evalLabel=e=>Oe(e,this.state,this.data),this.handleToolbarButtonClick=e=>{if(e==="import"){this.showImportDialog=!0;return}this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.handleImportUploadSuccess=e=>{const t=e.detail.xhr.responseText;this.showImportDialog=!1,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"process-import",parameters:{fileId:t}},bubbles:!0,composed:!0}))}}get columnPrefsScope(){return window.location.pathname}get effectiveComponent(){const e=this.component,t=e?.metadata;if(!e||!t?.columns)return e;if(this._prefsSource===e&&this._prefsRevisionApplied===this._columnPrefsRevision)return this._prefsApplied;const a=ko(this.columnPrefsScope),s=So(t.columns,a,i=>i.metadata??{});return this._prefsApplied=s===t.columns?e:{...e,metadata:{...t,columns:s}},this._prefsSource=e,this._prefsRevisionApplied=this._columnPrefsRevision,this._prefsApplied}get columnChooserEntries(){return(this.component?.metadata?.columns??[]).map(t=>{const a=t.metadata??{},s=a.id??t.id;return s?{id:s,label:a.label??s,protected:Co(a)}:void 0}).filter(t=>!!t)}renderColumnChooser(){const e=this.columnChooserEntries;return e.filter(t=>!t.protected).length===0?d:o`
            <mateu-column-chooser
                .columns="${e}"
                .scope="${this.columnPrefsScope}"
                @column-prefs-changed="${t=>{t.stopPropagation(),this._columnPrefsRevision++}}"
            ></mateu-column-chooser>
        `}get cols(){return this.effectiveComponent?.metadata?.columns?.map(t=>t.metadata)??[]}get identifierFieldName(){const e=this.cols.find(t=>t.identifier);return e?e.id:this.cols.find(t=>t.id==="id")?.id}get effectiveGridLayout(){const e=this.component?.metadata,t=e?.gridLayout??"auto";return t==="auto"?e?.crudlType==="card"?"cards":io(this.cols,this.availableWidthPx):t}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{const t=e[0]?.contentRect.width;t&&Math.abs(t-this.availableWidthPx)>10&&(this.availableWidthPx=t)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}_filterIds(e){return new Set(["searchText",...(e.filters??[]).flatMap(t=>t.stereotype==="dateRange"||t.stereotype==="numberRange"?[`${t.fieldId}_from`,`${t.fieldId}_to`]:[t.fieldId])])}_syncStateToUrl(e){const t=this._filterIds(e),a=new URLSearchParams(window.location.search);t.forEach(l=>a.delete(l)),a.delete("page"),a.delete("sort"),t.forEach(l=>{const c=this.state[l];c!=null&&c!==""&&a.set(l,String(c))});const s=this.state.page;s&&s>0&&a.set("page",String(s));const i=this.state.sort;if(i&&i.length>0){const l=i.filter(c=>c.fieldId&&c.direction).map(c=>`${c.fieldId}:${c.direction}`).join(",");l&&a.set("sort",l)}const r=a.toString(),n=r?`${window.location.pathname}?${r}`:window.location.pathname;window.location.pathname+window.location.search!==n&&history.replaceState(null,"",n)}_initStateFromUrl(e,t){const a=new URLSearchParams(window.location.search),s=this._filterIds(e),i={...t};a.forEach((l,c)=>{s.has(c)&&(i[c]=l)});const r=a.get("page");if(r!==null){const l=parseInt(r,10);!isNaN(l)&&l>0&&(i.page=l)}const n=a.get("sort");if(n){const l=n.split(",").map(c=>{const[u,m]=c.split(":");return u&&m?{fieldId:u,direction:m}:null}).filter(Boolean);l.length>0&&(i.sort=l)}return i}pageChanged(e){this.state={...this.state,page:e.detail.page},this.handleSearchRequested(void 0)}updated(e){if(super.updated(e),e.has("component")){const t=this.component?.id;if(t!==this._initializedForComponentId){this._initializedForComponentId=t;const a=this.component?.metadata,s=a.initialPage&&a.initialPage>0?a.initialPage:0;this.state=this._initStateFromUrl(a,{...this.state,size:a.pageSize,page:s,sort:[]}),(this.state.page!==s||this.state.sort?.length>0||[...this._filterIds(a)].some(r=>this.state[r]!=null))&&this.handleSearchRequested(void 0)}}}render(){const e=I=>{const L=[];return I.color&&I.color!==Io.normal&&L.push(I.color),I.buttonStyle&&L.push(I.buttonStyle===_o.tertiaryInline?"tertiary-inline":I.buttonStyle),L.length?L.join(" "):void 0},t=I=>I==="back"||I==="backToList"||!!I&&I.startsWith("cancel"),a=I=>{const L=te.get()?.renderToolbarButton?.(I,this.evalLabel(I.label),()=>this.handleToolbarButtonClick(I.actionId));return L||o`
                <vaadin-button
                        data-action-id="${I.id}"
                        theme="${e(I)||d}"
                        @click="${()=>this.handleToolbarButtonClick(I.actionId)}"
                >${this.evalLabel(I.label)}</vaadin-button>
            `};if(!this.component)return o`no component`;const s=this.effectiveComponent,i=s.metadata;i.serverSideOrdering=!0;const r=i?.toolbar??[],n=r.filter(I=>t(I.actionId)),l=r.filter(I=>!t(I.actionId)),c=n.length>0&&l.length>0,u=!!i?.title||!!i?.subtitle||r.length>0,m=this.effectiveGridLayout,p=this.cols,f=Di(p),y=this.data[this.id]?.page?.content??[],x=this.state[this.component?.id]?.emptyStateMessage,P=(I,L)=>{const O=L[I.id];if(O==null)return o``;if(I.dataType==="status"){const D=Gi(O.type);return o`<span theme="badge pill ${D}">${O.message}</span>`}return I.dataType==="bool"?o`${O?"✓":"✗"}`:typeof O=="object"?o`${O.label??O.name??O.message??""}`:o`${O}`},U=()=>{const I=this.identifierFieldName,L=this.state._selectedId??this.appState?._splitDetailId,O=f.find(R=>R.identifier)??f[0],D=R=>R.dataType==="action"||R.dataType==="actionGroup"||R.dataType==="menu"||R.stereotype==="button",De=f.filter(R=>R!==O&&!D(R)),Ie=p.filter(R=>D(R)),st=(R,se,pe)=>{R.stopPropagation(),R.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:se,parameters:{_clickedRow:pe}},bubbles:!0,composed:!0}))},bt=R=>{const se=[];for(const pe of Ie){const F=R[pe.id];if(pe.dataType==="action"){const z=F?.methodNameInCrud?F:R.action?.methodNameInCrud?R.action:{methodNameInCrud:pe.id,label:pe.label,icon:null};se.push(o`
                            <vaadin-button theme="tertiary small" title="${z.label||d}"
                                @click="${_=>st(_,"action-on-row-"+z.methodNameInCrud,R)}">
                                ${z.icon?o`<vaadin-icon icon="${z.icon}"></vaadin-icon>`:d}
                                ${z.label??d}
                            </vaadin-button>`)}else(pe.dataType==="actionGroup"||pe.dataType==="menu")&&(F?.actions??[]).forEach(_=>se.push(o`
                            <vaadin-button theme="tertiary small" title="${_.label||d}"
                                @click="${q=>st(q,"action-on-row-"+_.methodNameInCrud,R)}">
                ...
                <vaadin-list-box style="width: 100%;">
                    ${y.length===0?o`<vaadin-item disabled>${sa(x)}</vaadin-item>`:d}
                    ${y.map(R=>o`
                        <vaadin-item
                        ...
                        >
                            ...
                            <div style="font-size: var(--lumo-font-size-s); color: var(--lumo-secondary-text-color); display: flex; flex-wrap: wrap; gap: var(--lumo-space-xs); align-items: center;">
                                ${De.map(se=>o`<span>${se.label}: ${P(se,R)}</span>`)}
                            </div>
                            ${bt(R)}
                        </vaadin-item>
                    `)}
                </vaadin-list-box>`},ae=(I,L,O)=>{const D=this.identifierFieldName;D&&O[D]!==void 0&&(this.state={...this.state,_selectedId:String(O[D])}),I.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:L,parameters:O},bubbles:!0,composed:!0}))},N=()=>{const I=this.identifierFieldName,L=this.state._selectedId??this.appState?._splitDetailId,O=p.slice(0,6),D=O.filter(_=>_.stereotype==="image"),De=O.find(_=>_.identifier)??O[0],Ie=_=>!!_.actionId,st=_=>_.dataType==="action"||_.dataType==="actionGroup"||_.dataType==="menu"||_.stereotype==="button",bt=O.find(_=>_.id==="select"&&_.dataType==="action"),R=!!bt,se=O.filter(_=>_!==De&&!D.includes(_)&&!Ie(_)&&!st(_)),pe=O.filter(_=>st(_)&&!(R&&_===bt)),F=(_,q,be)=>{_.stopPropagation(),_.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:q,parameters:{_clickedRow:be}},bubbles:!0,composed:!0}))},z=_=>{const q=[];for(const be of pe){const aa=_[be.id];if(be.dataType==="action"){const gt=aa?.methodNameInCrud?aa:_.action?.methodNameInCrud?_.action:{methodNameInCrud:be.id,label:be.label,icon:null};q.push(o`
                            <vaadin-button theme="tertiary" title="${gt.label||d}"
                                @click="${$t=>F($t,"action-on-row-"+gt.methodNameInCrud,_)}">
                                ${gt.icon?o`<vaadin-icon icon="${gt.icon}"></vaadin-icon>`:d}
                                ${gt.label??d}
                            </vaadin-button>`)}else(be.dataType==="actionGroup"||be.dataType==="menu")&&(aa?.actions??[]).forEach($t=>q.push(o`
                            <vaadin-button theme="tertiary" title="${$t.label||d}"
                                @click="${ns=>F(ns,"action-on-row-"+$t.methodNameInCrud,_)}">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: var(--lumo-space-m); padding: var(--lumo-space-s) 0;">
                    ${y.length===0?o`<div style="grid-column: 1 / -1;">${sa(x)}</div>`:d}
                    ${y.map(_=>o`
                        <vaadin-card
                            clickable
                            ?data-selected="${I&&L!==void 0&&String(_[I])===String(L)}"
                            style="cursor: pointer;"
                            @click="${q=>R?F(q,"action-on-row-select",_):ae(q.target,"view",_)}"
                        >
                            ${D.length?o`<img slot="media" src="${_[D[0].id]??""}" alt="" style="width: 100%; max-height: 160px; object-fit: cover;" />`:d}
                            ${De?o`<div slot="title">${_[De.id]??""}</div>`:d}
                    ...
                    `)}
                </div>`},ne=()=>{const I=Su(p),L=I.find(D=>D.identifier)??I[0],O=I.filter(D=>D!==L);return o`
                ...
                </div>`},ue=()=>{const I=this.identifierFieldName,L=this.state._selectedId??this.appState?._splitDetailId,O=p[0],D=p.slice(1),De=!!O?.actionId,Ie=F=>(F??[]).map(z=>{const _=Array.isArray(z.children)?z.children:[];return _.length>0?{...z,children:Ie(_)}:{...z,children:void 0}}),st=Ie(y),bt=(F,z)=>{const _=F.parentItem?F.parentItem.children??[]:st;z(_,_.length)},R=(F,z)=>{for(const _ of F??[]){if(I&&String(_[I])===z)return _;const q=R(_.children,z);if(q)return q}},se=I&&L!==void 0?R(st,String(L)):void 0,pe=(F,z,_)=>{F.stopPropagation(),I&&z[I]!==void 0&&(this.state={...this.state,_selectedId:String(z[I])}),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:_,parameters:z},bubbles:!0,composed:!0}))};return o`
                <vaadin-grid
                    style="width: 100%;"
                    all-rows-visible
                    ...
                    .selectedItems="${se?[se]:[]}"
                >
                    ${O?o`<vaadin-grid-tree-column path="${O.id}" header="${O.label??d}" flex-grow="1"></vaadin-grid-tree-column>`:d}
                    ${De?o`
                    <vaadin-grid-column width="6rem" flex-grow="0" text-align="end" ${kt(F=>F?.viewable===!1?d:o`
                        <vaadin-button theme="tertiary small" @click="${z=>pe(z,F,"view")}">View</vaadin-button>
                    `,[])}></vaadin-grid-column>`:d}
                    ${D.map(F=>F.id==="select"?o`<vaadin-grid-column width="7rem" flex-grow="0" text-align="end" header="${F.label??d}" ${kt(z=>o`
                            <vaadin-button theme="tertiary small" @click="${_=>{_.stopPropagation(),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-select",parameters:{_clickedRow:z}},bubbles:!0,composed:!0}))}}">Select</vaadin-button>
                        `,[])}></vaadin-grid-column>`:o`<vaadin-grid-column path="${F.id}" header="${F.label??d}" auto-width></vaadin-grid-column>`)}
                    <span slot="empty-state">${sa(x)}</span>
                </vaadin-grid>`},ie=te.get()?.rendersCrudLayouts?.()===!0,Y=o`
            ${i.infiniteScrolling?o`
                <div>${this.data[this.id]?.page?.totalElements} items found.</div>
            `:d}
            ${!ie&&m==="list"?U():!ie&&m==="cards"?i.contentHeight?o`
                <vaadin-scroller style="width: 100%; height: ${i.contentHeight};">
                    ${N()}
                </vaadin-scroller>
            `:N():!ie&&m==="masterDetail"?ne():!ie&&m==="tree"?ue():te.get()?.renderTableComponent(this,s,this.baseUrl,this.state,this.data,this.appState,this.appData)}
            <slot></slot>
        `,ee=i.infiniteScrolling?d:te.get()?.renderPagination(this,this.component),fe=o`
            <vaadin-dialog
    ...
    `;He([h()],Ce.prototype,"component",2);He([h()],Ce.prototype,"baseUrl",2);He([h({type:Boolean})],Ce.prototype,"standalone",2);He([h()],Ce.prototype,"state",2);He([h()],Ce.prototype,"data",2);He([h()],Ce.prototype,"appState",2);He([h()],Ce.prototype,"appData",2);He([$()],Ce.prototype,"showImportDialog",2);He([$()],Ce.prototype,"availableWidthPx",2);He([$()],Ce.prototype,"selectedItem",2);He([$()],Ce.prototype,"_columnPrefsRevision",2);Ce=He([k("mateu-table-crud")],Ce);var sh=Object.defineProperty,rh=Object.getOwnPropertyDescriptor,ss=(e,t,a,s)=>{for(var i=s>1?void 0:s?rh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&sh(t,a,i),i};let Ra=class extends S{constructor(){super(...arguments),this.notificationOpened=!1,this.fetchStarted=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!0},this.fetchFinished=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1},this.fetchFailed=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1,this.error=e.detail.reason,this.openNotification()},this.openNotification=()=>{this.notificationOpened=!0},this.closeNotification=()=>{this.notificationOpened=!1},this.notificationRenderer=()=>o`
    <vaadin-horizontal-layout theme="spacing" style="align-items: center;">
  ...
  `}connectedCallback(){super.connectedCallback(),this.addEventListener("backend-called-event",this.fetchStarted),this.addEventListener("backend-succeeded-event",this.fetchFinished),this.addEventListener("backend-cancelled-event",this.fetchFailed),this.addEventListener("backend-failed-event",this.fetchFailed)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("backend-succeeded-event",this.fetchStarted),this.removeEventListener("backend-succeeded-event",this.fetchFinished),this.removeEventListener("backend-cancelled-event",this.fetchFailed),this.removeEventListener("backend-failed-event",this.fetchFailed)}render(){return o`<div class="loader-container"><vaadin-vertical-layout>
        ...
        <vaadin-notification
                ...
                ${wr(this.notificationRenderer,[])}
        ></vaadin-notification>`}};Ra.styles=C`
        :host {
        }
  ...
  `;Eo([h()],Mi.prototype,"target",2);Mi=Eo([k("mateu-event-interceptor")],Mi);var ch=Object.defineProperty,uh=Object.getOwnPropertyDescriptor,Po=(e,t,a,s)=>{for(var i=s>1?void 0:s?uh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ch(t,a,i),i};let qi=class extends ta{constructor(){super(...arguments),this.opened=!0,this.close=()=>{this.opened=!1,setTimeout(()=>this.parentElement?.removeChild(this),500)}}applyFragment(e){super.applyFragment(e);const t=e.state?._closeAfterMillis;t&&setTimeout(()=>this.close(),t)}updated(e){if(super.updated(e),e.has("component")&&this.component){const t=this.component.metadata;this.state=t.initialData}}render(){const e=this.component.metadata;let t="";e.noPadding&&(t+=" no-padding");const a=Hi(e.headerTitle,this.state,this.data,this.appState,this.appData);return o`
        <vaadin-dialog
                ...
                width="${e.width??d}"
                height="${e.height??d}"
                ${e.header||e.closeButtonOnHeader?Go(()=>o`<mateu-event-interceptor .target="${this}" style="width: 100%;">${e.header?w(this,e.header,this.baseUrl,this.state,this.data,this.appState,this.appData):d}${e.closeButtonOnHeader?o`
                            <vaadin-button theme="tertiary" @click="${this.close}">
                                <vaadin-icon icon="lumo:cross"></vaadin-icon>
                            </vaadin-button>
                        `:d}</mateu-event-interceptor>`,[this.state,this.data]):d}
                ${e.footer?_s(()=>o`<mateu-event-interceptor .target="${this}" style="width: 100%;">${w(this,e.footer,this.baseUrl,this.state,this.data,this.appState,this.appData)}</mateu-event-interceptor>`,[this.state,this.data]):d}
                ${e.content?Vi(()=>o`<mateu-event-interceptor .target="${this}" style="--mateu-section-border: none; width: 100%;">${w(this,e.content,this.baseUrl,this.state,this.data,this.appState,this.appData)}</mateu-event-interceptor>`,[this.state,this.data]):d}
       ...
       `}};qi.styles=C`
  `;Po([$()],qi.prototype,"opened",2);qi=Po([k("mateu-dialog")],qi);var ph=Object.defineProperty,hh=Object.getOwnPropertyDescriptor,To=(e,t,a,s)=>{for(var i=s>1?void 0:s?hh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ph(t,a,i),i};let Ui=class extends ta{constructor(){super(...arguments),this.opened=!1,this.close=()=>{this.opened=!1,setTimeout(()=>this.parentElement?.removeChild(this),300)},this._escListener=e=>{if(e.key!=="Escape")return;const a=this.getRootNode().querySelectorAll("mateu-drawer, mateu-dialog");a[a.length-1]===this&&(e.stopPropagation(),this.close())}}firstUpdated(){requestAnimationFrame(()=>this.opened=!0)}applyFragment(e){super.applyFragment(e);const t=e.state?._closeAfterMillis;t&&setTimeout(()=>this.close(),t)}updated(e){if(super.updated(e),e.has("component")&&this.component){const t=this.component.metadata;this.state=t.initialData}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._escListener)}disconnectedCallback(){document.removeEventListener("keydown",this._escListener),super.disconnectedCallback()}render(){const e=this.component.metadata,t=e.position??"end",a=Hi(e.headerTitle,this.state,this.data,this.appState,this.appData);return o`
        ${e.modeless?d:o`
  ...
  `;To([$()],Ui.prototype,"opened",2);Ui=To([k("mateu-drawer")],Ui);var mh=Object.defineProperty,vh=Object.getOwnPropertyDescriptor,Se=(e,t,a,s)=>{for(var i=s>1?void 0:s?vh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&mh(t,a,i),i};function vr(e){if(e.parentElement)return e.parentElement;const t=e.getRootNode();return t instanceof ShadowRoot?t.host:null}let ce=class extends S{constructor(){super(...arguments),this.appState={},this.appData={},this.standalone=!1,this.actionBanners=[],this.dismissedStaticBannerIndices=new Set,this._tocEntries=[],this._activeToc=0,this._tocVisible=!1,this._tocRebuildScheduled=!1,this._headerH=0,this._onResize=()=>this._layoutStickyTops(),this._tocLocked=!1,this._unlockToc=e=>{if(e&&e.type==="keydown"){const t=e;if(t.ctrlKey&&t.altKey&&!t.shiftKey&&!t.metaKey&&/^(?:Digit|Numpad)[1-9]$/.test(t.code))return}this._tocLocked=!1},this._actionBannerTimers=[],this._staticBannerTimers=[],this._bannersHandler=e=>{const t=e.detail,a=t.banners??[],s=t.append??!1;s?this.actionBanners=[...this.actionBanners,...a]:(this._clearActionBannerTimers(),this.actionBanners=a);const i=s?this.actionBanners.length-a.length:0;a.forEach((r,n)=>{if(r.timeoutSeconds&&r.timeoutSeconds>0){const l=i+n;this._actionBannerTimers.push(setTimeout(()=>{this.actionBanners=this.actionBanners.filter((c,u)=>u!==l)},r.timeoutSeconds*1e3))}})},this._onTocKey=e=>{if(!this._tocVisible||!e.ctrlKey||!e.altKey||e.shiftKey||e.metaKey)return;const t=/^(?:Digit|Numpad)([1-9])$/.exec(e.code);if(!t)return;const a=parseInt(t[1],10)-1;a>=this._tocEntries.length||(e.preventDefault(),this._scrollToSection(a))},this._onScrollSpy=()=>{if(this._tocLocked)return;const e=this._sectionCards();if(!e.length)return;const t=12,a=this.shadowRoot?.querySelector("mateu-content-header");let s=a?a.getBoundingClientRect().bottom:0;for(const n of e){if(!n.classList.contains("mateu-section--sticky"))continue;const l=n.getBoundingClientRect();l.top<=s+t+2&&(s=Math.max(s,l.bottom))}const i=s+t+4;let r=0;this._tocEntries.forEach((n,l)=>{n.el.getBoundingClientRect().top<=i&&(r=l)}),this._activeToc=r}}connectedCallback(){super.connectedCallback(),document.addEventListener("page-banners-received",this._bannersHandler),window.addEventListener("resize",this._onResize),document.addEventListener("keydown",this._onTocKey)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("page-banners-received",this._bannersHandler),window.removeEventListener("resize",this._onResize),document.removeEventListener("keydown",this._onTocKey),this._clearAllTimers(),this._teardownScrollSpy()}updated(e){super.updated(e),e.has("component")&&e.get("component")!==void 0&&(this._clearAllTimers(),this.actionBanners=[],this.dismissedStaticBannerIndices=new Set),e.has("component")&&(this._scheduleStaticBannerTimeouts(),this.dispatchEvent(new CustomEvent("compact-changed",{detail:{compact:!!this.component?.style?.includes("--mateu-compact:1")},bubbles:!0,composed:!0})),this._scheduleTocRebuild())}_scheduleStaticBannerTimeouts(){this._staticBannerTimers.forEach(a=>clearTimeout(a)),this._staticBannerTimers=[],(this.component?.metadata?.banners??[]).forEach((a,s)=>{a.timeoutSeconds&&a.timeoutSeconds>0&&this._staticBannerTimers.push(setTimeout(()=>{this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,s])},a.timeoutSeconds*1e3))})}_clearActionBannerTimers(){this._actionBannerTimers.forEach(e=>clearTimeout(e)),this._actionBannerTimers=[]}_clearAllTimers(){this._clearActionBannerTimers(),this._staticBannerTimers.forEach(e=>clearTimeout(e)),this._staticBannerTimers=[]}_dismissActionBanner(e){this.actionBanners=this.actionBanners.filter((t,a)=>a!==e)}_dismissStaticBanner(e){this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,e])}bannerThemeClass(e){const t=e.theme?.toLowerCase()??"info";return t==="none"?"":t}_evalBannerText(e){return Oe(e,this.state,this.data)}_renderBanner(e,t){const a=this._evalBannerText(e.title),s=this._evalBannerText(e.description);return o`
    ...
    `;Se([h()],ce.prototype,"component",2);Se([h()],ce.prototype,"baseUrl",2);Se([h()],ce.prototype,"state",2);Se([h()],ce.prototype,"data",2);Se([h()],ce.prototype,"appState",2);Se([h()],ce.prototype,"appData",2);Se([h()],ce.prototype,"value",2);Se([h({type:Boolean})],ce.prototype,"standalone",2);Se([$()],ce.prototype,"actionBanners",2);Se([$()],ce.prototype,"dismissedStaticBannerIndices",2);Se([$()],ce.prototype,"_tocEntries",2);Se([$()],ce.prototype,"_activeToc",2);Se([$()],ce.prototype,"_tocVisible",2);ce=Se([k("mateu-page")],ce);const rs=C`
    .nbtn {
        display: inline-flex;
        align-items: center;
        gap: .35em;
...
`,ne=!0)}ne&&this.updateMessage(r,n)}n||this.updateMessage(r,"⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).")}catch(l){console.error("Error en el flujo SSE:",l);const c=l?.message??String(l);(c==="Failed to fetch"||c==="network error"||c==="Load failed")&&!n?this.updateMessage(r,"⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible."):this.updateMessage(r,"⚠️ Error: "+c)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value="")},250),this.messageInputElement?.removeAttribute("disabled"),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent("close-requested",{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{const e=this.messageInputElement?.value?.trim()??"";e&&this.send(new CustomEvent("submit",{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key==="Enter"&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback(),this.probeLocalAgent();const e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){const t=new e;this.recognition=t,t.lang="es-ES",t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=a=>{console.error("Error de reconocimiento: "+a.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:"smooth"})},0)}addMessage(e,t){const a={text:e,time:new Date().toLocaleTimeString(),userName:t.includes("agent")?"Asistente":"Tú",userColorIndex:t.includes("agent")?2:1};return this.items=[...this.items,a],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((a,s)=>s===e?{...a,text:t}:a),this.scrollBottom()}tryParseCustomEvent(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if(typeof a.event=="string")return{event:a.event,detail:a.detail??{}}}catch{}return null}tryParseTokenUsage(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if("inputTokens"in a||"outputTokens"in a||"totalTokens"in a)return a}catch{}return null}buildMenuContext(e,t=[]){const a=[];for(const s of e){if(s.separator||s.remote)continue;const i=[...t,s.label];if(s.submenus&&s.submenus.length>0)a.push(...this.buildMenuContext(s.submenus,i));else{const r={path:i,navigation:{route:s.route,consumedRoute:s.consumedRoute,actionId:s.actionId??"",baseUrl:s.baseUrl,serverSideType:s.serverSideType,uriPrefix:s.uriPrefix}};s.description&&(r.description=s.description),a.push(r)}}return a}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return o`
                    ...
                    <div class="message-list" role="list">
                        ${this.items.map(e=>o`
                            <div class="message" role="listitem">
                                <div class="avatar" style="background: ${xh(e.userColorIndex)};">${wh(e.userName)}</div>
    ...
    `];Q([h({attribute:!1})],G.prototype,"contextProvider",2);Q([h()],G.prototype,"localAgentUrl",2);Q([h({attribute:!1})],G.prototype,"mcpUrl",2);Q([$()],G.prototype,"localAgentAlive",2);Q([h()],G.prototype,"sseUrl",2);Q([h()],G.prototype,"uploadUrl",2);Q([h({attribute:!1})],G.prototype,"menu",2);Q([$()],G.prototype,"attachments",2);Q([$()],G.prototype,"uploading",2);Q([at(".file-input")],G.prototype,"fileInputElement",2);Q([h({type:Boolean,reflect:!0})],G.prototype,"expanded",2);Q([h()],G.prototype,"items",2);Q([at(".scroll-container")],G.prototype,"scrollContainer",2);Q([at(".msg-input")],G.prototype,"messageInputElement",2);Q([$()],G.prototype,"recognition",2);Q([$()],G.prototype,"listening",2);Q([$()],G.prototype,"recognitionAvailable",2);Q([$()],G.prototype,"loading",2);Q([$()],G.prototype,"elapsedSeconds",2);Q([$()],G.prototype,"tokenUsage",2);G=Q([k("mateu-chat")],G);var kh=Object.defineProperty,Ch=Object.getOwnPropertyDescriptor,bi=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ch(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&kh(t,a,i),i};let ma=class extends S{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.data&&this.createChart(this.data)}async createChart(e){const[{default:t}]=await Promise.all([Te(()=>import("./vendor-chartjs.js").then(s=>s.a),[]),Te(()=>import("./vendor-chartjs.js").then(s=>s.c),[])]);if(e!==this.data)return;this.chart&&this.chart.destroy();const a={type:this.type,data:this.data,options:this.options};this.chart=new t(this.chartElement,a)}handleSlotChange(){}render(){return o`
            <div class="container">
       ...
       `}};ma.styles=C`
  `;bi([h()],ma.prototype,"type",2);bi([h()],ma.prototype,"data",2);bi([h()],ma.prototype,"options",2);bi([at("#chart")],ma.prototype,"chartElement",2);ma=bi([k("mateu-chart")],ma);var Sh=Object.defineProperty,Ih=Object.getOwnPropertyDescriptor,Gs=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ih(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Sh(t,a,i),i};let ri=class extends S{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){const{default:t}=await Te(async()=>{const{default:s}=await import("./vendor-diagrams.js").then(i=>i.i);return{default:s}},__vite__mapDeps([5,3,1,2,4]));if(e!==this.xml)return;this.chart&&this.chart.destroy();const a={container:this.divElement};this.chart=new t(a),this.chart.importXML(e)}handleSlotChange(){}render(){return o`
       ...
       `}};ri.styles=C`
  `;Gs([h()],ri.prototype,"xml",2);Gs([at("#canvas")],ri.prototype,"divElement",2);ri=Gs([k("mateu-bpmn")],ri);var _h=Object.defineProperty,Eh=Object.getOwnPropertyDescriptor,Ua=(e,t,a,s)=>{for(var i=s>1?void 0:s?Eh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&_h(t,a,i),i};const fs=160,rt=56,Ph=220,br=110,jt=60,Th={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},Oh={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},Rh=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];function Ah(){return"step-"+Math.random().toString(36).slice(2,8)}let Gt=class extends S{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.wf={name:"New Workflow",steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value")){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){const e=this.wf.steps??[],t={};e.forEach(n=>{t[n.id]=0});let a=!0;for(;a;)a=!1,e.forEach(n=>{if(n.preconditionStepId!=null&&t[n.preconditionStepId]!==void 0){const l=t[n.preconditionStepId]+1;l>t[n.id]&&(t[n.id]=l,a=!0)}});const s={};e.forEach(n=>{const l=t[n.id]??0;(s[l]??=[]).push(n.id)});const i={...this.positions};let r=!1;Object.entries(s).forEach(([n,l])=>{const c=Number(n);l.forEach((u,m)=>{i[u]||(i[u]={x:jt+c*Ph,y:jt+m*br},r=!0)})}),r&&(this.positions=i)}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addStep(){const e=Ah(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(i=>i.y),s=a.length?Math.max(...a)+br:jt;this.positions={...this.positions,[e]:{x:jt,y:s}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(s=>s.id!==e).map(s=>s.preconditionStepId===e?{...s,preconditionStepId:void 0}:s)};const{[e]:t,...a}=this.positions;this.positions=a,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},s=this.toSvgPoint(e);this.dragOffset={x:s.x-a.x,y:s.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(s=>s.x))+fs+jt:600,a=e.length?Math.max(...e.map(s=>s.y))+rt+jt:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return X``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return X``;const s=t.x+fs,i=t.y+rt/2,r=a.x,n=a.y+rt/2,l=(s+r)/2;return X`
            <path d="M${s},${i} C${l},${i} ${l},${n} ${r},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:jt,y:jt},a=Th[e.type]??"#64748b",s=Oh[e.type]??"•",i=this.selectedId===e.id;return X`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${r=>this.onNodeMouseDown(r,e.id)}"
               @click="${r=>{r.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${fs}" height="${rt}" rx="8"
                      fill="white"
                      stroke="${i?a:"#e2e8f0"}"
                      stroke-width="${i?2.5:1.5}"
                      filter="url(#shadow)"/>
                <!-- type badge -->
                <rect x="0" y="0" width="32" height="${rt}" rx="8" fill="${a}" clip-path="inset(0 -8px 0 0 round 8px)"/>
                <rect x="24" y="0" width="8" height="${rt}" fill="${a}"/>
                <text x="16" y="${rt/2+5}" text-anchor="middle"
                      font-size="14" fill="white">${s}</text>
                <!-- name -->
                <text x="44" y="${rt/2-6}" font-size="11" fill="#1e293b" font-weight="600">
                    ${e.name.length>16?e.name.slice(0,15)+"…":e.name}
                </text>
                <text x="44" y="${rt/2+8}" font-size="9" fill="#94a3b8">${e.id}</text>
                <text x="44" y="${rt/2+20}" font-size="9" fill="${a}">${e.type}</text>
            </g>
                ...
                <div class="prop-body">
                    ...
                    ${a("Type",o`
                        <select class="inp" @change="${s=>this.updateStep(e.id,{type:s.target.value})}">
                            ${Rh.map(s=>o`<option value="${s}" ?selected="${e.type===s}">${s}</option>`)}
                        </select>`)}
        ...
        `}exportJson(){const e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),s=document.createElement("a");s.href=a,s.download=(this.wf.name??"workflow").replace(/\s+/g,"-").toLowerCase()+".json",s.click(),URL.revokeObjectURL(a)}};Gt.styles=[rs,C`
    ...
    `];Ua([h()],Gt.prototype,"value",2);Ua([$()],Gt.prototype,"wf",2);Ua([$()],Gt.prototype,"positions",2);Ua([$()],Gt.prototype,"selectedId",2);Ua([$()],Gt.prototype,"showMeta",2);Gt=Ua([k("mateu-workflow")],Gt);var zh=Object.defineProperty,jh=Object.getOwnPropertyDescriptor,Pt=(e,t,a,s)=>{for(var i=s>1?void 0:s?jh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&zh(t,a,i),i};const Ga=160,Ke=56,Lt=60,Lh={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},Dh={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},Fh=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];let bs;const Nh=()=>(bs||(bs=Te(()=>import("./vendor-diagrams.js").then(e=>e.e),__vite__mapDeps([5,3,1,2,4])).then(e=>new e.default)),bs);function Mh(){return"step-"+Math.random().toString(36).slice(2,8)}let Ze=class extends S{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.readOnly=!1,this.wf={name:"New Workflow",steps:[]},this.positions={},this.layoutReady=!1,this.selectedId=null,this.showMeta=!1,this.layoutError=null,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.elkPositioned=new Set,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.elkPositioned.add(this.draggingId),this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value"))try{const t=JSON.parse(this.value),a=new Set((this.wf.steps??[]).map(r=>r.id)),s=new Set((t.steps??[]).map(r=>r.id)),i=a.size!==s.size||[...s].some(r=>!a.has(r))||[...s].some(r=>{const n=(this.wf.steps??[]).find(c=>c.id===r),l=(t.steps??[]).find(c=>c.id===r);return n?.preconditionStepId!==l?.preconditionStepId});this.wf=t,(i||!this.layoutReady)&&this.runElkLayout()}catch{}}async runElkLayout(){const e=this.wf.steps??[];if(e.length===0){this.positions={},this.layoutReady=!0;return}const t={id:"root",layoutOptions:{"elk.algorithm":"layered","elk.direction":"RIGHT","elk.spacing.nodeNode":"40","elk.layered.spacing.nodeNodeBetweenLayers":"80","elk.edgeRouting":"ORTHOGONAL","elk.layered.nodePlacement.strategy":"BRANDES_KOEPF"},children:e.map(a=>({id:a.id,width:Ga,height:Ke})),edges:e.filter(a=>a.preconditionStepId).map(a=>({id:`${a.preconditionStepId}->${a.id}`,sources:[a.preconditionStepId],targets:[a.id]}))};try{const s=await(await Nh()).layout(t),i={...this.positions};for(const r of s.children??[])(!this.elkPositioned.has(r.id)||!i[r.id])&&(i[r.id]={x:(r.x??0)+Lt,y:(r.y??0)+Lt},this.elkPositioned.add(r.id));this.positions=i,this.layoutReady=!0,this.layoutError=null}catch(a){this.layoutError=a?.message??"ELK layout failed",this.layoutReady=!0}}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){const a=this.wf.steps.map(r=>r.id===e?{...r,...t}:r),s=this.wf.steps.find(r=>r.id===e),i=t.preconditionStepId!==void 0&&t.preconditionStepId!==s?.preconditionStepId;this.wf={...this.wf,steps:a},i&&(this.elkPositioned.clear(),this.runElkLayout()),this.emit()}addStep(){const e=Mh(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(s=>s.x);this.positions={...this.positions,[e]:{x:a.length?Math.max(...a)+Ga+80:Lt,y:Lt}},this.selectedId=e,this.elkPositioned.clear(),this.runElkLayout(),this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(s=>s.id!==e).map(s=>s.preconditionStepId===e?{...s,preconditionStepId:void 0}:s)};const{[e]:t,...a}=this.positions;this.positions=a,this.elkPositioned.delete(e),this.selectedId===e&&(this.selectedId=null),this.runElkLayout(),this.emit()}onNodeMouseDown(e,t){if(this.readOnly)return;e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},s=this.toSvgPoint(e);this.dragOffset={x:s.x-a.x,y:s.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}relayout(){this.elkPositioned.clear(),this.runElkLayout()}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(s=>s.x))+Ga+Lt:600,a=e.length?Math.max(...e.map(s=>s.y))+Ke+Lt:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){if(!this.layoutReady)return o`<div class="loading">Computing layout…</div>`;const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return X``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return X``;const s=t.x+Ga,i=t.y+Ke/2,r=a.x,n=a.y+Ke/2,l=(s+r)/2;return X`
            <path d="M${s},${i} C${l},${i} ${l},${n} ${r},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:Lt,y:Lt},a=Lh[e.type]??"#64748b",s=Dh[e.type]??"•",i=this.selectedId===e.id,r=e.name.length>16?e.name.slice(0,15)+"…":e.name;return X`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${n=>this.onNodeMouseDown(n,e.id)}"
               @click="${n=>{n.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${Ga}" height="${Ke}" rx="8"
                      fill="white"
                      stroke="${i?a:"#e2e8f0"}"
                      stroke-width="${i?2.5:1.5}"
                      filter="url(#shadow)"/>
        ...
        `}exportJson(){const e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),s=document.createElement("a");s.href=a,s.download=(this.wf.name??"workflow").replace(/\s+/g,"-").toLowerCase()+".json",s.click(),URL.revokeObjectURL(a)}};Ze.styles=[rs,C`
        :host {display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif);}
        ...
        textarea.inp {resize: vertical;}
        input[readonly].inp {background: #f8fafc; color: #94a3b8;}
    `];Pt([h()],Ze.prototype,"value",2);Pt([h({type:Boolean})],Ze.prototype,"readOnly",2);Pt([$()],Ze.prototype,"wf",2);Pt([$()],Ze.prototype,"positions",2);Pt([$()],Ze.prototype,"layoutReady",2);Pt([$()],Ze.prototype,"selectedId",2);Pt([$()],Ze.prototype,"showMeta",2);Pt([$()],Ze.prototype,"layoutError",2);Ze=Pt([k("mateu-workflow-elk")],Ze);var qh=Object.defineProperty,Uh=Object.getOwnPropertyDescriptor,gi=(e,t,a,s)=>{for(var i=s>1?void 0:s?Uh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&qh(t,a,i),i};const Bh=["string","integer","number","bool","date","time","dateTime","dateRange","money","file","array","status","component","menu","range","action","actionGroup"],Vh=["regular","radio","checkbox","textarea","toggle","combobox","select","email","password","richText","listBox","html","markdown","image","icon","link","money","grid","color","choice","popover","slider","button","stars"],Wh={string:"#3B82F6",integer:"#8B5CF6",number:"#6366F1",bool:"#10B981",date:"#F59E0B",time:"#F59E0B",dateTime:"#F59E0B",dateRange:"#F59E0B",money:"#EF4444",file:"#64748B",array:"#0EA5E9",status:"#EC4899",component:"#14B8A6",menu:"#94A3B8",range:"#A855F7",action:"#F97316",actionGroup:"#FB923C"};function gr(){return"field-"+Math.random().toString(36).slice(2,8)}let va=class extends S{constructor(){super(...arguments),this.value='{"name":"New Form","fields":[]}',this.form={name:"New Form",fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has("value"))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){const e=this.shadowRoot?.querySelector(".field-list");!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=Jo.create(e,{animation:150,handle:".drag-handle",ghostClass:"sortable-ghost",onEnd:t=>{const{oldIndex:a,newIndex:s}=t;if(a===void 0||s===void 0||a===s)return;const i=[...this.form.fields],[r]=i.splice(a,1);i.splice(s,0,r),this.form={...this.form,fields:i},this.emit()}}))}emit(){const e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addField(){const e=gr(),t={id:e,label:"New Field",dataType:"string"};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){const t=this.form.fields.find(r=>r.id===e);if(!t)return;const a={...t,id:gr(),label:t.label+" (copy)"},s=this.form.fields.findIndex(r=>r.id===e),i=[...this.form.fields];i.splice(s+1,0,a),this.form={...this.form,fields:i},this.selectedId=a.id,this.emit()}render(){return o`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderRow(e){const t=Wh[e.dataType]??"#64748b",a=this.selectedId===e.id;return o`
        ...
        `}exportJson(){const e=JSON.stringify(this.form,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),s=document.createElement("a");s.href=a,s.download=(this.form.name??"form").replace(/\s+/g,"-").toLowerCase()+".json",s.click(),URL.revokeObjectURL(a)}};va.styles=[rs,C`
        :host { display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif); }
        ...
        textarea.inp { resize: vertical; }
        input[readonly].inp { background: #f8fafc; color: #94a3b8; }
    `];gi([h()],va.prototype,"value",2);gi([$()],va.prototype,"form",2);gi([$()],va.prototype,"selectedId",2);gi([$()],va.prototype,"showMeta",2);va=gi([k("mateu-form-editor")],va);var Hh=Object.defineProperty,Gh=Object.getOwnPropertyDescriptor,ft=(e,t,a,s)=>{for(var i=s>1?void 0:s?Gh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Hh(t,a,i),i};let qe=class extends S{constructor(){super(...arguments),this.appState={},this.appData={},this.open=!1,this.activeTab="appstate",this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null,this._prevTarget=null,this._onMouseover=e=>{let t=e.target;for(;t&&!(t.tagName?.toLowerCase().startsWith("mateu-")&&t!==this);)t=t.parentElement;if(t===this||t===null){t===null&&this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset="",this._prevTarget=null,this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null);return}t!==this._prevTarget&&(this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset=""),this._prevTarget=t,t.style.outline="2px solid #0070f3",t.style.outlineOffset="-2px",this.hoveredTag=t.tagName.toLowerCase(),this.hoveredId=t.id||"",this.hoveredState=t.state,this.hoveredData=t.data,this.hoveredMeta=t.component?.metadata)}}connectedCallback(){super.connectedCallback(),document.addEventListener("mouseover",this._onMouseover,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mouseover",this._onMouseover,!0),this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget=null)}_fmt(e){try{return JSON.stringify(e,null,2)??"null"}catch{return String(e)}}_renderTab(e,t){return o`
    ...
    `;ft([h()],qe.prototype,"appState",2);ft([h()],qe.prototype,"appData",2);ft([$()],qe.prototype,"open",2);ft([$()],qe.prototype,"activeTab",2);ft([$()],qe.prototype,"hoveredTag",2);ft([$()],qe.prototype,"hoveredId",2);ft([$()],qe.prototype,"hoveredState",2);ft([$()],qe.prototype,"hoveredData",2);ft([$()],qe.prototype,"hoveredMeta",2);qe=ft([k("mateu-debug-overlay")],qe);var Ye=(e=>(e.SetAppDataValue="SetAppDataValue",e.SetAppStateValue="SetAppStateValue",e.SetDataValue="SetDataValue",e.RunAction="RunAction",e.RunJS="RunJS",e.SetAttributeValue="SetAttributeValue",e.SetStateValue="SetStateValue",e.SetCssClass="SetCssClass",e.SetStyle="SetStyle",e))(Ye||{}),Oo=(e=>(e.required="required",e.disabled="disabled",e.hidden="hidden",e.pattern="pattern",e.minValue="minValue",e.maxValue="maxValue",e.minLength="minLength",e.maxLength="maxLength",e.css="css",e.style="style",e.theme="theme",e.errorMessage="errorMessage",e.description="description",e.none="none",e))(Oo||{}),Ro=(e=>(e.Continue="Continue",e.Stop="Stop",e))(Ro||{}),Kh=Object.defineProperty,Yh=Object.getOwnPropertyDescriptor,os=(e,t,a,s)=>{for(var i=s>1?void 0:s?Yh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Kh(t,a,i),i};let Ka=null,Aa=class extends ta{constructor(){super(...arguments),this.baseUrl="",this.route="",this.consumedRoute="",this.formerState={},this.applyRules=()=>{const e=this.component.rules;if(e&&e.length>0){const t=this.state,a=this.data,s=this.appState,i=this.appData,r=this.component,n=y=>_r(y,t,a,{appState:s,appData:i,component:r}),l=y=>Ir(y,t,a,s,i,{component:r}),c=["state","data","appState","appData","component"],u=[t,a,s,i,r],m={...this.state},p={...this.data};let f=!1,g=!1;for(let y=0;y<e.length;y++){const x=e[y];try{if(n(x.filter)){if(Ye.SetStateValue==x.action||Ye.SetDataValue==x.action){const P=Ye.SetStateValue==x.action?m:p,U=x.fieldName.split(",");for(let ae=0;ae<U.length;ae++){const N=U[ae];if(!P[N]||P[N]!=x.value){const ne=x.expression?l(x.expression):x.value,ue=Oo.none==x.fieldAttribute?N:N+"."+x.fieldAttribute;ne!=P[ue]&&(P[ue]=ne,Ye.SetStateValue==x.action&&(f=!0),Ye.SetDataValue==x.action&&(g=!0))}}}if(Ye.RunAction==x.action&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:x.actionId},bubbles:!0,composed:!0})),Ye.RunJS==x.action&&new Function(...c,x.value)(...u),Ye.SetAttributeValue==x.action){const P=x.expression?n(x.expression):x.value;if(x.fieldAttribute=="disabled"){P?this.shadowRoot?.getElementById(x.fieldName)?.setAttribute(x.fieldAttribute,"disabled"):this.shadowRoot?.getElementById(x.fieldName)?.removeAttribute(x.fieldAttribute);continue}this.shadowRoot?.getElementById(x.fieldName)?.setAttribute(x.fieldAttribute,P)}if(Ye.SetCssClass==x.action&&this.shadowRoot?.getElementById(x.fieldName)?.setAttribute("class",x.value),Ye.SetStyle==x.action&&this.shadowRoot?.getElementById(x.fieldName)?.style.setProperty(x.expression,x.value),Ro.Stop==x.result)break}}catch(P){console.error("rule failed",x,P)}}f&&(this.state=m),g&&(this.data=p),f&&this.checkValidations()}},this.skipValidation=(e,t)=>e&&t.fieldId&&!e.includes(t.fieldId)||!e&&t.fieldId&&t.fieldId.includes("-"),this.checkValidations=e=>{const t=e?e.split(","):void 0,a=this.component.validations;let s=!0,i=!1;const r=this.data??{},n={...this.data??{},errors:{}};if(a){for(let l=0;l<a.length;l++){const c=a[l];if(this.skipValidation(t,c))continue;const u=(c.fieldId??"_component").split(",");for(let m=0;m<u.length;m++){const p=u[m];n.errors[p]=[]}}for(let l=0;l<a.length;l++){const c=a[l];if(!this.skipValidation(t,c))try{const u=c.condition&&c.condition.includes("${")?this._evalTemplate(c.condition):this._evalExpr(c.condition);if(c.condition&&!u){s=!1;const p=(c.fieldId??"_component").split(",");for(let f=0;f<p.length;f++){const g=p[f];let y=n.errors[g];if(y||(n.errors[g]=[]),y=n.errors[g],!r[g]){let x=c.message;try{x=this._evalTemplate(c.message)}catch{}y.push(x)}}}}catch(u){console.error("validation failed",c,u)}}for(let l=0;l<a.length;l++){const c=a[l];if(this.skipValidation(t,c))continue;const u=(c.fieldId??"_component").split(",");for(let m=0;m<u.length;m++){const p=u[m];if(r.errors?[p].join(","):n.errors==""&&[p].join(",")){i=!0;break}}}(r.errors?["_component"].join(","):n.errors==""&&["_component"].join(","))&&(i=!0)}n._valid=s,n._valid!=r._valid&&(i=!0),i&&(this.data=n)},this._autoSaveTimers=new Map,this.onChange=()=>{this.applyRules()},this.closeModalRequestedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&this.closeModal()},this.resetFilters=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail,a={};t.fieldIds.forEach(s=>{a[s]=void 0}),a.searchText=void 0,this.state={...this.state,...a}}},this.dataChangedListener=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail,a={};a[t.key]=t.value,e.type=="data-changed"&&(this.data={...this.data,...a})}},this.valueChangedListener=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail;if(e.type=="value-changed"){const a={...this.state};a[t.fieldId]=t.value,this.state=a,(this.state[t.fieldId]||this.formerState[t.fieldId])&&this.state[t.fieldId]!=this.formerState[t.fieldId]&&this.component?.confirmOnNavigationIfDirty&&this.dispatchEvent(new CustomEvent("dirty",{detail:e.detail,bubbles:!0,composed:!0}));const s=this.component;s.triggers?.filter(i=>i.type==Dt.OnValueChange).filter(i=>!i.propertyName||t.fieldId==i.propertyName).forEach(i=>{(!i.condition||this._evalExpr(i.condition))&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:i.actionId},bubbles:!0,composed:!0}))}),s.triggers?.filter(i=>i.type==Dt.AutoSave).forEach(i=>{const r=i.actionId,n=this._autoSaveTimers.get(r);n!==void 0&&clearTimeout(n),this._autoSaveTimers.set(r,setTimeout(()=>{this._autoSaveTimers.delete(r),this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:i.actionId},bubbles:!0,composed:!0}))},i.debounceMillis??800))})}}},this.actionRequestedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&this.manageActionRequestedEvent(e)},this.manageActionRequestedEvent=e=>{const t=e.detail;if(e.type=="action-requested"){e.preventDefault(),e.stopPropagation();const a=this.component,s=a.actions?.find(i=>i.id==t.actionId||i.id.endsWith("*")&&t.actionId.startsWith(i.id.replace("*","")));if(s){if(s&&s.rowsSelectedRequired&&(!this.state.crud_selected_items||this.state.crud_selected_items.length==0)){this.notify("You first need to select some rows");return}if(s&&s.validationRequired){const r=Ka??this;if(Ka=null,r.checkValidations(s.fieldsToValidate),!r.data._valid){r.notifyValidationErrors();return}}Ka=null;const i={...t,initiatorComponentId:this.id};s&&s.confirmationRequired?this.callAfterConfirmation(s,()=>this.requestActionCallToServerOrBubble(i,a,s)):this.requestActionCallToServerOrBubble(i,a,s)}else{const i={...t.parameters};i.initiatorState||(i.initiatorState=this.state),Ka||(Ka=this),this.dispatchEvent(new CustomEvent(e.type,{detail:{...e.detail,parameters:i},bubbles:!0,composed:!0}))}}},this.buildFieldLabelMap=()=>{const e={},t=a=>{if(a)for(const s of a){const i=s.metadata;if(i?.type===v.FormField){const r=i;r.fieldId&&r.label&&(e[r.fieldId]=r.label)}t(s.children)}};return t(this.component?.children),e},this.notifyValidationErrors=()=>{const e=this.data?.errors??{},t=this.buildFieldLabelMap(),a=[];if(Object.entries(e).forEach(([i,r])=>{if(!Array.isArray(r))return;const n=i==="_component"?void 0:t[i]??i;r.forEach(l=>{l&&!a.some(c=>c.label===n&&c.msg===l)&&a.push({label:n,msg:l})})}),a.length===0){this.notify("There are validation errors");return}const s=document.createElement("vaadin-notification");s.position="bottom-end",s.setAttribute("theme","error"),s.duration=Math.max(3e3,1500+a.length*1e3),s.renderer=i=>{xr(o`
            ...
            `:d}</div>`}_render(){if(this.component?.type==oe.ClientSide){const e=this.component;return e.metadata?.type==v.Page?ys(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):e.metadata?.type==v.Crud?xs(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):te.get()?.renderClientSideComponent(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!1)}return o`
            <mateu-api-caller 
            ...
            ${this.component?.children?.map(e=>{if(e.type==oe.ClientSide){const t=e;if(t.metadata?.type==v.Page)return ys(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0);if(t.metadata?.type==v.Crud)return xs(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0)}return w(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData)})}
            </mateu-api-caller>
        `}};Aa.styles=C`
        :host {
        }
  ...
  `;os([h()],Aa.prototype,"baseUrl",2);os([h()],Aa.prototype,"route",2);os([h()],Aa.prototype,"consumedRoute",2);Aa=os([k("mateu-component")],Aa);const $r=e=>{if(e)try{return JSON.parse(e)}catch{return{value:e}}else return{}},Jh=ou,Xh={fixed:"fixed",fullWidth:"full",edgeToEdge:"edge"},Qh=new Set([v.Gantt,v.PlanningBoard,v.Kanban,v.Bpmn,v.Workflow,v.WorkflowElk,v.Map]),Zh={landing:"fixed",form:"fixed",process:"fixed"},Ao=e=>e?Xh[e]:void 0,fa=e=>e.type==oe.ClientSide?e.metadata:void 0,zo=e=>{const t=fa(e);if(t?.type==v.Page){const a=Ao(t.pageWidth);if(a)return a}for(const a of e.children??[]){const s=zo(a);if(s)return s}},jo=e=>{const t=e.pageType;if(t)return t;const a=s=>{const i=fa(s);if(i?.type==v.Page&&i.pageType)return i.pageType;for(const r of s.children??[]){const n=a(r);if(n)return n}};return a(e)},em=e=>{const t=fa(e);if(t?.type!=v.Crud)return!1;const a=t;return a.compact?!0:(a.columns??[]).some(s=>s.metadata?.editable)},Bi=(e,t)=>t(e)||(e.children??[]).some(a=>Bi(a,t)),tm=e=>!!e&&Bi(e,t=>fa(t)?.type==v.HeroSection),am=e=>fa(e)?.type==v.App?!0:(e.children??[]).some(t=>fa(t)?.type==v.App),im=(e,t)=>{if(!e)return"fixed";const a=Ao(e.pageWidth)??zo(e);if(a)return a;if(t?.top&&am(e))return"edge";const s=Zh[jo(e)??""];return s||(Bi(e,i=>{const r=fa(i)?.type;return r!=null&&Qh.has(r)})?"edge":Bi(e,em)?"full":"fixed")};var sm=Object.defineProperty,rm=Object.getOwnPropertyDescriptor,Le=(e,t,a,s)=>{for(var i=s>1?void 0:s?rm(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&sm(t,a,i),i};let ve=class extends es{constructor(){super(...arguments),this.consumedRoute="",this.serverSideType=void 0,this.uriPrefix=void 0,this.overrides=void 0,this.homeRoute=void 0,this.route=void 0,this.top=void 0,this.appState={},this.appData={},this.preventNavigation=!1,this.overridesParsed={},this.fragment=void 0,this.actionRequestedListener=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.manageActionEvent(e))},this.historyPushed=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.preventNavigation=!0,this.route=e.detail.route)},this.routeChangedListener=e=>{if(e instanceof CustomEvent){e.preventDefault(),e.stopPropagation();let t=e.detail.route;typeof t=="string"&&(t===""||t.startsWith("/"))&&this.consumedRoute&&this.consumedRoute!=="_empty"&&this.consumedRoute.startsWith("/")&&!t.startsWith(this.consumedRoute)&&(t=this.consumedRoute+t),this.uriPrefix&&(t.startsWith("/")&&this.uriPrefix.endsWith("/")?t=this.uriPrefix+t.substring(1):!t.startsWith("/")&&!this.uriPrefix.endsWith("/")?t=this.uriPrefix+"/"+t:t=this.uriPrefix+t),this.dispatchEvent(new CustomEvent("url-update-requested",{detail:{route:t},bubbles:!0,composed:!0}))}},this.backendFailedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&e.detail.actionId==""&&(this.fragment={targetComponentId:this.id,data:{},state:{},component:{type:oe.ClientSide,metadata:{type:v.Element,name:"div",content:"Not found"},id:"fieldId"},action:si.Replace,containerId:void 0})},this.detail1=void 0,this.manageActionEvent=e=>{e.preventDefault(),e.stopPropagation(),this.detail1=e.detail;const t=this.detail1;if(e.type=="server-side-action-requested"){let a=Jh;t.sse&&(a=Zr),a.runAction($a,this.baseUrl,t.route??"",t.consumedRoute,t.actionId,t.initiatorComponentId,this.getCustomisedAppState(),t.serverSideType,t.componentState,t.parameters,t.initiator,t.background,t.callback,t.callbackonly,t.callbackToken)}},this.getCustomisedAppState=()=>{let e={...le.value};if(this.overrides){const t=$r(this.overrides);e={...e,...t}}return e}}manageActionRequestedEvent(e){throw new Error("Method not implemented.")}createRenderRoot(){return te.mustUseShadowRoot()?super.createRenderRoot():this}connectedCallback(){super.connectedCallback(),this.overridesParsed=$r(this.overrides),this.addEventListener("server-side-action-requested",this.actionRequestedListener),this.addEventListener("backend-call-failed",this.backendFailedListener),this.addEventListener("history-pushed",this.historyPushed),this.addEventListener("route-changed",this.routeChangedListener),window.Vaadin.featureFlags.masterDetailLayoutComponent=!0}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("server-side-action-requested",this.actionRequestedListener),this.removeEventListener("backend-call-failed",this.backendFailedListener),this.removeEventListener("history-pushed",this.historyPushed),this.removeEventListener("route-changed",this.routeChangedListener)}shouldUpdate(e){if(this.fragment?.component&&[...e.keys()].every(a=>a==="appState"||a==="appData")){const a=this.renderRoot.querySelector("mateu-component");if(a)return e.has("appState")&&(a.appState=this.appState),e.has("appData")&&(a.appData=this.appData),!1}return!0}updated(e){(e.has("id")||e.has("baseurl")||e.has("route")||e.has("consumedRoute")||e.has("instant"))&&(this.preventNavigation||(this.callbackToken=this.instant||ye(),this.manageActionEvent(new CustomEvent("server-side-action-requested",{detail:{route:this.route,consumedRoute:this.consumedRoute,userData:void 0,actionId:"",serverSideType:this.serverSideType,initiatorComponentId:this.id,initiator:this,componentState:this.initialState,callbackToken:this.callbackToken},bubbles:!0,composed:!0})))),e.has("route")&&this.top&&(this.preventNavigation||this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:this.route},bubbles:!0,composed:!0}))),this.preventNavigation&&(this.preventNavigation=!1)}applyFragment(e){if(!e.component&&this.fragment?.component){this.fragment={...this.fragment,state:{...this.fragment.state??{},...e.state??{}},data:{...this.fragment.data??{},...e.data??{}}};return}this.fragment=e,e.component&&(this.dataset.pageWidth=im(e.component,{top:this.top}),this.dataset.pageType=jo(e.component)??"",this.dataset.hasWelcomeBanner=String(tm(e.component)))}render(){return o`
...
`;if($e.TABS==e.variant){const i=e.menu.map(r=>({label:r.label,itemKey:r.route}));return o`<div>
        ...
        </div>`}if($e.MENU_ON_LEFT==e.variant){const i=e.menu.map(m=>({label:m.label,itemKey:m.route}));if(!e.homeRoute||e.homeRoute==="_no_home_route"){const m=e.menu[0];e.homeRoute=m?.submenus?.length?m.submenus[0].route:m?.route??""}const r=this.data.activeTopRoute??e.menu.find(m=>m.route===e.homeRoute||m.submenus?.some(p=>p.route===e.homeRoute))?.route??e.menu[0]?.route??"";this.data.activeTopRoute=r;const n=e.menu.find(m=>m.route===r),l=(n?.submenus??[]).map(m=>({label:m.label,itemKey:m.route}));if(this.data.activeConsumedRoute===void 0){const m=n?.submenus?.find(p=>p.route===e.homeRoute);this.data.activeConsumedRoute=m?.consumedRoute??n?.consumedRoute??e.homeConsumedRoute??"",this.data.activeServerSideType=m?.serverSideType??n?.serverSideType??e.homeServerSideType??""}const c=m=>{const p=m.detail.value;this.data.activeTopRoute=p;const f=e.menu.find(g=>g.route===p);if(f?.submenus?.length){const g=f.submenus[0];this.data.activeConsumedRoute=g.consumedRoute??"",this.data.activeServerSideType=g.serverSideType??f.serverSideType??e.serverSideType??"",this.selected({...m,detail:{...m.detail,value:g.route}},this,this.baseUrl??"",e)}else this.data.activeConsumedRoute=f?.consumedRoute??"",this.data.activeServerSideType=f?.serverSideType??e.serverSideType??"",this.selected({...m,detail:{...m.detail,value:p}},this,this.baseUrl??"",e)},u=m=>{const p=m.detail.value,g=e.menu.flatMap(y=>y.submenus??[]).find(y=>y.route===p);this.data.activeConsumedRoute=g?.consumedRoute??"",this.data.activeServerSideType=g?.serverSideType??e.serverSideType??"",this.selected(m,this,this.baseUrl??"",e)};return o`<div style="${this.style??d}">
            <oj-c-tab-bar
                    .data="${i}"
                    .selection="${r}"
                    @ojSelectionAction="${c}"
...
>
  ...
  `;Tt([$()],et.prototype,"filter",2);Tt([$()],et.prototype,"instant",2);Tt([$()],et.prototype,"selectedConsumedRoute",2);Tt([$()],et.prototype,"selectedRoute",2);Tt([$()],et.prototype,"selectedUriPrefix",2);Tt([$()],et.prototype,"selectedBaseUrl",2);Tt([$()],et.prototype,"selectedServerSideType",2);Tt([$()],et.prototype,"selectedParams",2);et=Tt([k("mateu-redwood-app")],et);const cm=(e,t,a,s,i,r,n)=>o`
        <mateu-redwood-app
                id="${t.id}"
                baseUrl="${a}"
                .component="${t}"
                ...
                style="width: 100%;"
        ></mateu-redwood-app>
    `,um=(e,t,a,s,i,r,n)=>{const l=t.metadata;return o`
...
`)}
    ...
    `},pm=e=>{const t=e.color==="error"||e.variant==="danger"?"danger":e.buttonStyle==="primary"?"callToAction":"outlined",a=t==="danger"?"background: var(--mateu-redwood-danger-bg, rgb(179, 49, 31)); color: #fff; border: 1px solid transparent;":t==="callToAction"?"background: var(--mateu-redwood-cta-bg, rgb(49, 45, 42)); color: #fff; border: 1px solid transparent;":"background: transparent; color: var(--mateu-redwood-text, rgb(22, 21, 19)); border: 1px solid rgba(22, 21, 19, 0.5);",s=i=>i.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId},bubbles:!0,composed:!0}));return o`
        <button
            ...
            ?disabled="${e.disabled}"
            @click="${s}"
        >${e.label}</button>`},hm=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=l.title||l.subtitle||l.toolbar?.length||l.header?.length||l.avatar;return o`
        <div style="display: flex; flex-direction: column; width: 100%; ${t.style??""}" slot="${t.slot??d}" class="${t.cssClasses}">
            ...
            ${c?o`
                <div style="display: flex; align-items: center; width: 100%; gap: 1rem; padding: 0.5rem 0;">
                    <div style="flex: 1;">
                        <h2 style="margin-block-end: 0px;">${ge(wt(l.title,s,i))}</h2>
                        <span style="display: inline-block;">${ge(wt(l.subtitle,s,i))}</span>
                    </div>
    ...
    `},$i=(e,t)=>e?e.includes("${")&&t._evalTemplate?t._evalTemplate(e):e:"",Ae=(e,t,a,s,i,r,n)=>(t.children??[]).map(l=>w(e,l,a,s,i,r,n)),Lo=e=>{const t=e?.metadata?.type;return t==="FormRow"||t==="FormItem"?(e.children??[]).flatMap(Lo):[e]},mm=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=Math.max(1,l.maxColumns??1),u=(t.children??[]).flatMap(Lo),m=p=>{const f=p?.metadata?.colspan,g=typeof f=="number"?f:parseInt(f??"1",10);return Math.min(Math.max(isNaN(g)?1:g,1),c)};return o`
        <div style="display:grid; grid-template-columns: repeat(${c}, minmax(0,1fr)); gap:.5rem 1.5rem; align-items:start;">
            ${u.map(p=>o`<div style="grid-column: span ${m(p)}; min-width:0; overflow:hidden;">${w(e,p,a,s,i,r,n)}</div>`)}
        </div>`},vm=(e,t,a,s,i,r,n)=>o`<div style="display:flex; flex-direction:row; gap:1rem; flex-wrap:wrap;">${Ae(e,t,a,s,i,r,n)}</div>`,fm=(e,t,a,s,i,r,n)=>{const l=$i(t.metadata.title,e);return o`
        ...
        </div>`},bm=(e,t,a,s,i,r,n)=>{const l=$i(t.metadata.title,e);return o`
        ...
        </div>`},gm=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=l?.spacing===!1?"0":"1rem";return o`<div style="display:flex; flex-direction:row; gap:${c}; ${l?.wrap?"flex-wrap:wrap;":""} ${l?.fullWidth?"width:100%;":""} ${t.style??""}"
                     slot="${t.slot??d}">${Ae(e,t,a,s,i,r,n)}</div>`},$m=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=l?.spacing===!1?"0":".75rem";return o`<div style="display:flex; flex-direction:column; gap:${c}; ${l?.fullWidth?"width:100%;":""} ${t.style??""}"
                     slot="${t.slot??d}">${Ae(e,t,a,s,i,r,n)}</div>`},ym=(e,t,a,s,i,r,n)=>{const l=t.metadata?.orientation==="vertical"?"column":"row";return o`<div style="display:flex; flex-direction:${l}; gap:1rem; width:100%; ${t.style??""}" slot="${t.slot??d}">
        ${(t.children??[]).map(c=>o`<div style="flex:1; min-width:0;">${w(e,c,a,s,i,r,n)}</div>`)}
    </div>`},xm=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=m=>m?w(e,m,a,s,i,r,n):d,u=typeof l.title=="string"?l.title:"";if(t.cssClasses?.includes("mateu-section")){const m=u?o`<h2 class="oj-typography-heading-sm" style="margin: 0;">${u}</h2>`:typeof l.title=="object"&&l.title?c(l.title):d;return o`
        ...
        <div class="oj-panel oj-panel-shadow-sm" style="border-radius:var(--oj-core-border-radius-lg, .375rem); overflow:hidden;"
             slot="${t.slot??d}">
            ${u?o`<h2 class="oj-typography-heading-sm" style="margin:0; padding:.75rem 1rem; border-bottom:1px solid var(--oj-core-divider-color, rgba(22,21,19,.12));">${u}</h2>`:d}
            <div style="padding:1rem;">
        ...
        </div>`},wm=e=>{switch(e){case"h1":return"oj-typography-heading-xl";case"h2":return"oj-typography-heading-lg";case"h3":return"oj-typography-heading-md";case"h4":return"oj-typography-heading-sm";case"h5":case"h6":return"oj-typography-subheading-sm";default:return"oj-typography-body-md"}},km=(e,t,a)=>{const s=t.metadata,i=$i(s.text,e);return o`<div class="${wm(s.container)}" style="${t.style??""}">${i}</div>`},Cm=e=>{const t=e.metadata,a=t.color;return o`<oj-c-badge variant="${a==="success"?"success":a==="error"||a==="danger"?"danger":a==="warning"?"warning":a==="info"?"info":"neutral"}" slot="${e.slot??d}">${t.text??""}</oj-c-badge>`},Sm=e=>{const t=e.metadata;return o`<a class="oj-link-standalone" href="${t.url??"#"}" slot="${e.slot??d}">${t.text??t.url??""}</a>`},gs=(e,t)=>{t&&e?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t,parameters:{}},bubbles:!0,composed:!0}))},Do=(e,t,a)=>o`
    <div style="position:fixed; inset:0; background:rgba(0,0,0,.4); display:flex; align-items:center; justify-content:center; z-index:1000;">
        <div class="oj-panel oj-panel-shadow-lg" role="dialog" aria-modal="true"
            ...
            ${e?o`<h2 class="oj-typography-heading-sm" style="margin:0; padding:1rem; border-bottom:1px solid var(--oj-core-divider-color, rgba(22,21,19,.12));">${e}</h2>`:d}
            <div style="padding:1rem;">${t}</div>
            ${a?o`<div style="display:flex; gap:.5rem; justify-content:flex-end; padding:.75rem 1rem; border-top:1px solid var(--oj-core-divider-color, rgba(22,21,19,.12));">${a}</div>`:d}
        </div>
    </div>`,Im=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=$i(l.headerTitle,e),u=p=>p?w(e,p,a,s,i,r,n):d,m=o`${u(l.content)}${Ae(e,t,a,s,i,r,n)}`;return Do(c,m,u(l.footer))},_m=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=$i(l.header,e),u=l.content?w(e,l.content,a,s,i,r,n):d,m=o`
        ${l.canCancel?o`<oj-c-button label="${l.cancelText??"Cancel"}" @ojAction="${p=>gs(p.target,l.cancelActionId)}"></oj-c-button>`:d}
        ${l.canReject?o`<oj-c-button label="${l.rejectText??"No"}" @ojAction="${p=>gs(p.target,l.rejectActionId)}"></oj-c-button>`:d}
        <oj-c-button chroming="callToAction" label="${l.confirmText??"OK"}" @ojAction="${p=>gs(p.target,l.confirmActionId)}"></oj-c-button>`;return Do(c,u,m)},Em=(e,t,a,s,i,r,n)=>o`<div style="overflow: auto; ${t.style??""}" class="${t.cssClasses??d}"
              slot="${t.slot??d}">${Ae(e,t,a,s,i,r,n)}</div>`,Pm=(e,t,a,s,i,r,n)=>o`<div style="width: 100%; ${t.style??""}" class="${t.cssClasses??d}"
              slot="${t.slot??d}">${Ae(e,t,a,s,i,r,n)}</div>`,Tm=(e,t,a,s,i,r,n)=>o`<div style="max-width: min(100%, 1200px); margin: auto; ${t.style??""}" class="${t.cssClasses??d}"
              slot="${t.slot??d}">${Ae(e,t,a,s,i,r,n)}</div>`,Om=(e,t,a,s,i,r,n)=>o`<div style="display: flex; flex-direction: column; gap: 1rem; width: 100%; ${t.style??""}"
              class="${t.cssClasses??d}" slot="${t.slot??d}">
        ${Ae(e,t,a,s,i,r,n)}</div>`,Rm=(e,t,a,s,i,r,n)=>{const l=c=>c?.metadata?.type==="BoardLayoutItem"?c.metadata.boardCols??1:1;return o`<div style="display: flex; flex-direction: row; gap: 1rem; width: 100%; ${t.style??""}"
                     class="${t.cssClasses??d}" slot="${t.slot??d}">
        ${(t.children??[]).map(c=>o`
            <div style="flex: ${l(c)} 1 0; min-width: 0;">${w(e,c,a,s,i,r,n)}</div>`)}
    </div>`},Am=(e,t,a,s,i,r,n)=>o`<div style="${t.style??""}" class="${t.cssClasses??d}">
        ${Ae(e,t,a,s,i,r,n)}</div>`,zm=(e,t,a,s,i,r,n)=>{const l=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,u=!!i?.hasDetail||!!l,m=c??l;return o`
        ...
        </div>`},jm=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=m=>p=>{const g=p.target.closest(".rw-carousel-wrap")?.querySelector(":scope > .rw-carousel");g?.scrollBy({left:m*g.clientWidth,behavior:"smooth"})},u=l?.nav!==!1;return o`
        <div class="rw-carousel-wrap ${t.cssClasses??""}" style="position: relative; width: 100%; ${t.style??""}"
            ...
            `:d}
        </div>`};var Lm=Object.defineProperty,Dm=Object.getOwnPropertyDescriptor,Ot=(e,t,a,s)=>{for(var i=s>1?void 0:s?Dm(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Lm(t,a,i),i};let pt=class extends S{constructor(){super(...arguments),this.selected=0}createRenderRoot(){return this}label(e){const t=e?.metadata?.label;return t&&typeof t=="string"&&t.includes("${")&&this.container?._evalTemplate?this.container._evalTemplate(t):t??""}render(){const e=this.component?.children??[],t=e.map((s,i)=>({itemKey:String(i),label:this.label(s)})),a=e[this.selected];return o`
            <div>
            ...
            </div>`}};Ot([h({attribute:!1})],pt.prototype,"component",2);Ot([h({attribute:!1})],pt.prototype,"container",2);Ot([h()],pt.prototype,"baseUrl",2);Ot([h({attribute:!1})],pt.prototype,"compState",2);Ot([h({attribute:!1})],pt.prototype,"compData",2);Ot([h({attribute:!1})],pt.prototype,"appState",2);Ot([h({attribute:!1})],pt.prototype,"appData",2);Ot([$()],pt.prototype,"selected",2);pt=Ot([k("mateu-redwood-tabs")],pt);var Fm=Object.defineProperty,Nm=Object.getOwnPropertyDescriptor,Rt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Nm(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Fm(t,a,i),i};let ht=class extends S{constructor(){super(...arguments),this.open={},this.initialized=!1}createRenderRoot(){return this}label(e){const t=e?.metadata?.label;return t&&typeof t=="string"&&t.includes("${")&&this.container?._evalTemplate?this.container._evalTemplate(t):t??""}render(){const e=this.component?.children??[];return this.initialized||(e.forEach((t,a)=>{t?.metadata?.active&&(this.open[a]=!0)}),this.initialized=!0),o`
            <div style="display:flex; flex-direction:column; gap:.5rem;">
            ...
            <div style="display: flex; gap: 0.5rem; align-items: center; flex-wrap: wrap; padding: 0.25rem 0; font-size: 0.859rem; color: var(--oj-core-text-color-secondary, rgba(22,21,19,.7));">
                ${this.totalElements<=this.pageSize?d:o`
        ...
        `:o`${d}`}};Ba([h({type:Number})],ba.prototype,"totalElements",2);Ba([h({type:Number})],ba.prototype,"pageSize",2);Ba([h({type:Number})],ba.prototype,"pageNumber",2);Ba([$()],ba.prototype,"pages",2);Ba([$()],ba.prototype,"summary",2);ba=Ba([k("mateu-redwood-pagination")],ba);const Um=e=>{let t=e;for(;t;){if(t.tagName?.toLowerCase()==="mateu-ux")return t;t=t.parentElement??t.getRootNode?.()?.host??null}return null},yr=new WeakMap,Bm=e=>{const t=e.target.dataset.actionId;e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},Vm=new Set([v.App,v.Page,v.Form,v.Button,v.FormField,v.FormLayout,v.FormRow,v.FormSection,v.FormSubSection,v.HorizontalLayout,v.VerticalLayout,v.SplitLayout,v.MasterDetailLayout,v.Scroller,v.FullWidth,v.Container,v.BoardLayout,v.BoardLayoutRow,v.BoardLayoutItem,v.CarouselLayout,v.Card,v.Text,v.Badge,v.Anchor,v.Icon,v.Breadcrumbs,v.Notification,v.ProgressBar,v.Details,v.Avatar,v.AvatarGroup,v.Tooltip,v.Popover,v.MenuBar,v.ContextMenu,v.TabLayout,v.AccordionLayout,v.Dialog,v.Drawer,v.ConfirmDialog,v.Grid,v.Table,v.VirtualList,v.Directory,v.CustomField,v.MessageList,v.MessageInput,v.Crud,v.Element,v.Div,v.Image,v.MicroFrontend,v.Markdown,v.Chart,v.Bpmn,v.Map,v.Chat,v.CookieConsent,v.Workflow,v.WorkflowElk,v.FormEditor,v.MetricCard,v.Scoreboard,v.DashboardPanel,v.DashboardLayout,v.FoldoutLayout,v.HeroSection,v.EmptyState,v.Skeleton,v.Gantt,v.PlanningBoard,v.Kanban,v.Timeline,v.ProgressSteps,v.Stat,v.Calendar,v.PricingTable,v.OrgChart,v.Heatmap,v.Funnel,v.TrendChart,v.FeatureGrid,v.Testimonials,v.Faq,v.CalloutCard,v.CommentThread,v.FileList,v.Checklist,v.ComparisonCard,v.EntityHeader,v.Meter,v.TaskProgress,v.StatusList,v.BulletedList,v.Separator,v.Notice,v.TaskQueue,v.ResourceGrid,v.OfferCard,v.AddOnPicker,v.Ledger,v.PaymentPicker,v.ProcessMonitor]);class Wm extends mu{rendererName(){return"redwood-oj"}supportedClientSideTypes(){return Vm}rendersCrudLayouts(){return!0}renderFilterBar(t,a,s,i,r,n,l){const c=a?.metadata,u=c?.filters??[],m=yr.get(t)??{open:!1,text:"",viewsOpen:!1};yr.set(t,m);const p=()=>t.requestUpdate(),f=()=>{m.outsideClick&&(document.removeEventListener("mousedown",m.outsideClick),m.outsideClick=void 0)},g=()=>{f(),m.open=!1,m.viewsOpen=!1,m.activeFilter=void 0,p()},y=()=>{f(),m.outsideClick=b=>{b.composedPath().some(A=>A instanceof HTMLElement&&A.classList?.contains("mateu-smart-search"))||g()},document.addEventListener("mousedown",m.outsideClick)},x=()=>{m.open||(m.open=!0,m.viewsOpen=!1,y(),p())},P=()=>{const b=!m.viewsOpen;m.open=!1,m.activeFilter=void 0,m.viewsOpen=b,b?y():f(),p()},U=()=>{f(),m.open=!1,m.viewsOpen=!1,m.activeFilter=void 0,t.search()},ae=(b,E)=>{i[b]=E,U()},N=b=>{const E=u.find(A=>A.fieldId===b);E&&Y(E)?(i[`${b}_from`]=void 0,i[`${b}_to`]=void 0):i[b]=b==="searchText"?"":void 0,U()},ne=b=>{i.searchText=b.value,m.text="",b.value="",U()},ue=b=>b.dataType==="boolean"||b.dataType==="bool"||b.stereotype==="checkbox"||b.stereotype==="toggle",ie=b=>["integer","decimal","number","money"].includes(b.dataType),Y=b=>b.stereotype==="dateRange"||b.stereotype==="numberRange",ee=b=>b.stereotype==="multiSelect",fe=b=>(b.options?.length??0)>0,I=b=>{const E=i[b.fieldId];return Array.isArray(E)?E.map(String):typeof E=="string"&&E!==""?E.split(",").map(A=>A.trim()).filter(A=>A):[]},L=(b,E)=>{const A=i[`${b.fieldId}_${E}`];return A==null?"":String(A)},O=b=>{if(Y(b))return L(b,"from")!==""||L(b,"to")!=="";if(ee(b))return I(b).length>0;const E=i[b.fieldId];return E!=null&&E!==""},D=(b,E)=>{const A=b?.options?.find(B=>B.value===String(E));return A?A.label??A.value:typeof E=="boolean"?E?"Yes":"No":String(E)},De=b=>{if(Y(b)){const E=L(b,"from"),A=L(b,"to");return E&&A?`${E} – ${A}`:E?`≥ ${E}`:`≤ ${A}`}return ee(b)?I(b).map(E=>D(b,E)).join(", "):D(b,i[b.fieldId])},Ie=window.location.pathname,st=()=>["searchText",...u.flatMap(b=>Y(b)?[`${b.fieldId}_from`,`${b.fieldId}_to`]:[b.fieldId])],bt=()=>!!i.searchText||u.some(b=>O(b)),R=()=>{const b={};return i.searchText&&(b.searchText=i.searchText),u.forEach(E=>{if(O(E))if(Y(E)){const A=L(E,"from"),B=L(E,"to");A&&(b[`${E.fieldId}_from`]=A),B&&(b[`${E.fieldId}_to`]=B)}else ee(E)?b[E.fieldId]=I(E):b[E.fieldId]=i[E.fieldId]}),b},se=b=>{st().forEach(E=>{i[E]=void 0}),Object.entries(b.values).forEach(([E,A])=>{i[E]=A}),U()},pe=b=>{const E=b.value.trim();E&&(bo(Ie,{name:E,values:R()}),b.value="",p())};if(!m.defaultViewChecked&&(m.defaultViewChecked=!0,!window.location.search)){const b=yo(Ie);b&&setTimeout(()=>{bt()||se(b)},0)}const F=[];i.searchText&&F.push({fieldId:"searchText",label:"Text",display:String(i.searchText)}),u.forEach(b=>{O(b)&&F.push({fieldId:b.fieldId,label:b.label||b.fieldId,display:De(b)})});const z="var(--mateu-redwood-text, rgb(22, 21, 19))",_=`display: flex; align-items: center; gap: 0.5rem; padding: 0.45rem 0.75rem; cursor: pointer; color: ${z}; font-size: 0.875rem;`,q=b=>b.preventDefault(),be=(b,E,A=!1)=>o`
            <div style="${_} ${A?"font-weight: 600;":""}"
                 @mousedown="${q}"
                 @click="${E}"
                 onmouseover="this.style.background='rgba(22,21,19,0.06)'"
                 onmouseout="this.style.background='transparent'">${b}</div>`,aa=`flex: 1; min-width: 0; font: inherit; font-size: 0.875rem; color: ${z}; border: 1px solid rgba(22,21,19,0.5); border-radius: 4px; padding: 0.35rem 0.5rem; outline: none;`,gt="font: inherit; font-size: 0.875rem; background: var(--mateu-redwood-cta-bg, rgb(49, 45, 42)); color: #fff; border: 1px solid transparent; border-radius: 4px; padding: 0.35rem 0.75rem; cursor: pointer;",$t=b=>{const E=b.stereotype==="numberRange"?"number":b.dataType==="dateTime"?"datetime-local":b.dataType==="time"?"time":"date",A=J=>{const Va=J.closest(".range-row");i[`${b.fieldId}_from`]=Va.querySelector("input.range-from").value||void 0,i[`${b.fieldId}_to`]=Va.querySelector("input.range-to").value||void 0,U()},B=J=>{J.key==="Enter"&&A(J.target),J.key==="Escape"&&g()};return o`
                <div class="range-row" style="display: flex; gap: 0.5rem; align-items: center; padding: 0.5rem 0.75rem;">
                    <input class="range-from" type="${E}" placeholder="From" style="${aa}"
                           .value="${L(b,"from")}"
                           @mousedown="${J=>J.stopPropagation()}"
                           @keydown="${B}"/>
                    <span aria-hidden="true" style="color: rgba(22,21,19,0.55);">–</span>
                    <input class="range-to" type="${E}" placeholder="To" style="${aa}"
                           .value="${L(b,"to")}"
                           @mousedown="${J=>J.stopPropagation()}"
                           @keydown="${B}"/>
                    <button style="${gt}"
                            @mousedown="${q}"
                            @click="${J=>A(J.target)}">Apply</button>
                </div>`},ns=b=>{const E=I(b),A=J=>{const Va=E.includes(J)?E.filter(qo=>qo!==J):[...E,J];i[b.fieldId]=Va.length>0?Va:void 0,t.search(),p()},B="display: inline-flex; align-items: center; justify-content: center; width: 1rem; height: 1rem; border-radius: 3px; font-size: 0.7rem; line-height: 1; flex: none;";return o`${(b.options??[]).map(J=>be(o`
                ...
                ${J.label??J.value}
            `,()=>A(J.value)))}`},Fo=b=>{if(Y(b))return $t(b);if(ee(b))return ns(b);if(fe(b))return o`${b.options.map(B=>be(B.label??B.value,()=>ae(b.fieldId,B.value)))}`;if(ue(b))return o`
                    ${be("Yes",()=>ae(b.fieldId,!0))}
                    ${be("No",()=>ae(b.fieldId,!1))}`;const E=ie(b),A=B=>{B.value!==""&&ae(b.fieldId,E?Number(B.value):B.value)};return o`
                <div style="display: flex; gap: 0.5rem; padding: 0.5rem 0.75rem;">
                    <input type="${E?"number":"text"}"
                           ...
                           style="flex: 1; font: inherit; font-size: 0.875rem; color: ${z}; border: 1px solid rgba(22,21,19,0.5); border-radius: 4px; padding: 0.35rem 0.5rem; outline: none;"
                           @mousedown="${B=>B.stopPropagation()}"
                           @keydown="${B=>{B.key==="Enter"&&A(B.target),B.key==="Escape"&&g()}}"/>
                    <button style="font: inherit; font-size: 0.875rem; background: var(--mateu-redwood-cta-bg, rgb(49, 45, 42)); color: #fff; border: 1px solid transparent; border-radius: 4px; padding: 0.35rem 0.75rem; cursor: pointer;"
                            @mousedown="${q}"
                            @click="${B=>A(B.target.previousElementSibling)}">Apply</button>
                </div>`},No=m.open&&u.length>0?o`
            <div style="position: absolute; top: calc(100% + 4px); left: 0; min-width: 20rem; max-width: 100%; background: var(--mateu-redwood-panel-bg, #fff); border: 1px solid rgba(22,21,19,0.25); border-radius: 8px; box-shadow: 0 6px 16px rgba(0,0,0,0.15); z-index: 30; overflow: hidden; padding: 0.25rem 0;">
                ...
                `:o`
                    ...
                    ${u.map(b=>be(o`
                        ${b.label||b.fieldId}
                        ${O(b)?o`<span style="margin-left: auto; color: rgba(22,21,19,0.55); font-size: 0.8125rem;">${De(b)}</span>`:d}
                    `,()=>{m.activeFilter=b,p()}))}
                `}
            </div>`:d,Ks=`${_} cursor: default; color: rgba(22,21,19,0.6);`,Mo=m.viewsOpen?o`
            <div style="position: absolute; top: calc(100% + 4px); right: 0; left: auto; min-width: 20rem; max-width: 100%; background: var(--mateu-redwood-panel-bg, #fff); border: 1px solid rgba(22,21,19,0.25); border-radius: 8px; box-shadow: 0 6px 16px rgba(0,0,0,0.15); z-index: 30; overflow: hidden; padding: 0.25rem 0;">
                ...
                ${Ni(Ie).length===0?o`
                    <div style="${Ks}">No saved views yet</div>`:d}
                ${Ni(Ie).map(b=>o`
                    <div style="${_}"
                         @mousedown="${q}"
                         onmouseover="this.style.background='rgba(22,21,19,0.06)'"
            ...
            <div class="mateu-smart-search" style="position: relative; padding: 0.25rem 0;">
                <div style="display: flex; align-items: center; gap: 0.35rem; flex-wrap: wrap; border: 1px solid rgba(22,21,19,0.5); border-radius: 8px; padding: 0.3rem 0.6rem; background: var(--mateu-redwood-panel-bg, #fff); cursor: text;"
                    ...
                    <svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" style="flex: none; opacity: 0.6;">
                        <path fill="${z.startsWith("var")?"rgb(22,21,19)":z}" d="M15.5 14h-.79l-.28-.27a6.5 6.5 0 1 0-.7.7l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0A4.5 4.5 0 1 1 14 9.5 4.5 4.5 0 0 1 9.5 14z"/>
                    </svg>
                    ${F.map(b=>o`
                        <span style="display: inline-flex; align-items: center; gap: 0.3rem; background: rgba(22,21,19,0.08); border-radius: 1rem; padding: 0.15rem 0.3rem 0.15rem 0.6rem; font-size: 0.8125rem; color: ${z}; white-space: nowrap;">
                    ...
                    ${c?.searchable!==!1?o`
                        <input class="smart-search-input" type="text"
                               placeholder="${F.length===0?"Search":""}"
                               .value="${m.text??""}"
                               style="flex: 1 1 8rem; min-width: 7rem; border: none; outline: none; background: transparent; font: inherit; font-size: 0.875rem; color: ${z}; padding: 0.25rem 0;"
            ...
            ${Um(t)?.getAttribute("data-has-welcome-banner")==="true"?d:o`
        ...
        <mateu-redwood-table id="${t.id}"
                     ...
                     baseUrl="${s}"
        ></mateu-redwood-table>
        `}renderClientSideComponent(t,a,s,i,r,n,l,c){return v.Page==a?.metadata?.type?hm(t,a,s,i,r,n,l):v.Form==a?.metadata?.type?um(t,a,s,i,r,n,l):v.Button==a?.metadata?.type?vu(a):v.FormField==a?.metadata?.type?hp(t,a,s,i,r):v.FormLayout==a?.metadata?.type?mm(t,a,s,i,r,n,l):v.FormRow==a?.metadata?.type?vm(t,a,s,i,r,n,l):v.FormSection==a?.metadata?.type?fm(t,a,s,i,r,n,l):v.FormSubSection==a?.metadata?.type?bm(t,a,s,i,r,n,l):v.HorizontalLayout==a?.metadata?.type?gm(t,a,s,i,r,n,l):v.VerticalLayout==a?.metadata?.type?$m(t,a,s,i,r,n,l):v.SplitLayout==a?.metadata?.type?ym(t,a,s,i,r,n,l):v.MasterDetailLayout==a?.metadata?.type?zm(t,a,s,i,r,n,l):v.Scroller==a?.metadata?.type?Em(t,a,s,i,r,n,l):v.FullWidth==a?.metadata?.type?Pm(t,a,s,i,r,n,l):v.Container==a?.metadata?.type?Tm(t,a,s,i,r,n,l):v.BoardLayout==a?.metadata?.type?Om(t,a,s,i,r,n,l):v.BoardLayoutRow==a?.metadata?.type?Rm(t,a,s,i,r,n,l):v.BoardLayoutItem==a?.metadata?.type?Am(t,a,s,i,r,n,l):v.CarouselLayout==a?.metadata?.type?jm(t,a,s,i,r,n,l):v.Card==a?.metadata?.type?xm(t,a,s,i,r,n,l):v.Text==a?.metadata?.type?km(t,a):v.Badge==a?.metadata?.type?Cm(a):v.Anchor==a?.metadata?.type?Sm(a):v.Icon==a?.metadata?.type?qu(a):v.Breadcrumbs==a?.metadata?.type?Uu(a):v.Notification==a?.metadata?.type?Bu(a):v.ProgressBar==a?.metadata?.type?Vu(a,i):v.Details==a?.metadata?.type?Wu(t,a,s,i,r,n,l):v.Avatar==a?.metadata?.type?Hu(a,i,r):v.AvatarGroup==a?.metadata?.type?Gu(a):v.Tooltip==a?.metadata?.type?Ku(t,a,s,i,r,n,l):v.Popover==a?.metadata?.type?Yu(t,a,s,i,r,n,l):v.MenuBar==a?.metadata?.type?Ju(t,a):v.ContextMenu==a?.metadata?.type?Xu(t,a,s,i,r,n,l):v.Grid==a?.metadata?.type?zu(a,i):v.Table==a?.metadata?.type?ju(t,a,s,i,r,n,l):v.VirtualList==a?.metadata?.type?Lu(t,a,s,i,r,n,l):v.Directory==a?.metadata?.type?Du(a):v.CustomField==a?.metadata?.type?Fu(t,a,s,i,r,n,l):v.MessageList==a?.metadata?.type?Nu(a):v.MessageInput==a?.metadata?.type?Mu(a):v.TabLayout==a?.metadata?.type?o`<mateu-redwood-tabs
  ...
  `;At([h()],tt.prototype,"baseUrl",2);At([h()],tt.prototype,"route",2);At([h()],tt.prototype,"consumedRoute",2);At([h()],tt.prototype,"config",2);At([h()],tt.prototype,"top",2);At([h()],tt.prototype,"pathPrefix",2);At([$()],tt.prototype,"instant",2);At([h({type:Boolean})],tt.prototype,"debug",2);tt=At([k("mateu-ui")],tt);var Km=Object.getOwnPropertyDescriptor,Ym=(e,t,a,s)=>{for(var i=s>1?void 0:s?Km(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(i)||i);return i};let Is=class extends hi{constructor(){super(...arguments),this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))}}render(){const e=this.component?.metadata;return o`
