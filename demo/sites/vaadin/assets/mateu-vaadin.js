...
import{r as Us,f as js,m as Bs,o as Vs,a as Hs,b as Ws,c as Gs,s as Ks,d as Ys,e as Js,t as Xs,u as Qs,g as Zs,_ as me,v as eo,n as to,h as ot,i as ao,j as ro,k as zi,l as Oi,N as Ja,p as Ir,q as Ri,w as io}from"./vendor-vaadin.js";import{a as $,j as p,k as ee,i as C,x as o,m as k,A as l,p as ye,q as b,l as E,c as X,r as so,D as Li}from"./vendor-lit.js";import{S as oo,a as no,n as xe,b as lo}from"./vendor.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=a(i);fetch(i.href,s)}})();Us("vaadin-card",$`
      :host(.mateu-section) {
    ...
    `);const Ai=document.createElement("style");Ai.innerHTML=`
${js.cssText}
${Bs.cssText}
${Vs.cssText}
${Hs.cssText}
...
${Qs.cssText}
${Zs.cssText}
`;document.body.appendChild(Ai);{const e=window.Vaadin;e&&((e.featureFlags??={}).masterDetailLayoutComponent=!0)}const Mt=new oo,G={value:{}},_a={value:{}},It=$`
  [theme~='badge'] {
    display: inline-flex;
    align-items: center;
...
`,co={lon:0,lat:0},ii=3,uo=e=>{if(!e)return;const t=e.split(",").map(i=>i.trim());if(t.length!==2)return;const a=Number(t[0]),r=Number(t[1]);if(!(t[0]===""||t[1]===""||!Number.isFinite(a)||!Number.isFinite(r)))return{lon:r,lat:a}},po=e=>{if(e==null||e.trim()==="")return ii;const t=Number(e);return Number.isFinite(t)?t:ii};var ho=Object.defineProperty,mo=Object.getOwnPropertyDescriptor,hr=(e,t,a,r)=>{for(var i=r>1?void 0:r?mo(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&ho(t,a,i),i};let na=class extends C{constructor(){super(...arguments),this.renderSeq=0}updated(e){super.updated(e),this.createMap()}disconnectedCallback(){super.disconnectedCallback(),this.map?.setTarget(void 0),this.map=void 0}async createMap(){const e=++this.renderSeq,[{default:t},{default:a},{default:r},{default:i},{fromLonLat:s},{default:n}]=await Promise.all([me(()=>import("./vendor-ol.js").then(c=>c.M),[]),me(()=>import("./vendor-ol.js").then(c=>c.V),[]),me(()=>import("./vendor-ol.js").then(c=>c.T),[]),me(()=>import("./vendor-ol.js").then(c=>c.O),[]),me(()=>import("./vendor-ol.js").then(c=>c.p),[]),me(()=>import("./vendor-ol.js").then(c=>c.o),[])]);if(e!==this.renderSeq||!this.isConnected)return;if(!this.shadowRoot.querySelector("style[data-ol]")){const c=document.createElement("style");c.setAttribute("data-ol",""),c.textContent=n,this.shadowRoot.appendChild(c)}this.map&&(this.map.setTarget(void 0),this.map=void 0);const d=uo(this.position)??co;this.map=new t({target:this.mapElement,layers:[new r({source:new i})],view:new a({center:s([d.lon,d.lat]),zoom:po(this.zoom)})})}render(){return o`<div id="map"></div>`}};na.styles=$`
        :host {
            display: block;
            width: 100%;
            height: 25rem;
    ...
    `;hr([p()],na.prototype,"position",2);hr([p()],na.prototype,"zoom",2);hr([ee("#map")],na.prototype,"mapElement",2);na=hr([k("mateu-map")],na);const vo=typeof HTMLElement<"u"?HTMLElement:class{};class fo extends vo{static get observedAttributes(){return["content"]}#e;#t=0;get content(){return this.#e}set content(t){this.#e=t,this.#a()}attributeChangedCallback(t,a,r){this.content=r??void 0}connectedCallback(){this.style.display="block",this.#a()}async#a(){if(!this.isConnected)return;const t=this.#e??"",a=++this.#t,[{marked:r},{default:i}]=await Promise.all([me(()=>import("./vendor.js").then(s=>s.f),[]),me(()=>import("./vendor.js").then(s=>s.c),[])]);a===this.#t&&(this.innerHTML=i.sanitize(await r.parse(t),{USE_PROFILES:{html:!0,svg:!0,svgFilters:!0},CUSTOM_ELEMENT_HANDLING:{tagNameCheck:s=>!0}}))}}typeof customElements<"u"&&!customElements.get("mateu-markdown")&&customElements.define("mateu-markdown",fo);var W=(e=>(e.ServerSide="ServerSide",e.ClientSide="ClientSide",e))(W||{}),h=(e=>(e.Page="Page",e.Div="Div",e.Element="Element",e.MicroFrontend="MicroFrontend",e.Form="Form",e.Crud="Crud",e.Result="Result",e.Card="Card",e.Directory="Directory",e.Stepper="Stepper",e.HorizontalLayout="HorizontalLayout",e.VerticalLayout="VerticalLayout",e.SplitLayout="SplitLayout",e.MasterDetailLayout="MasterDetailLayout",e.TabLayout="TabLayout",e.AccordionLayout="AccordionLayout",e.FormLayout="FormLayout",e.FormRow="FormRow",e.FormItem="FormItem",e.BoardLayout="BoardLayout",e.BoardLayoutRow="BoardLayoutRow",e.BoardLayoutItem="BoardLayoutItem",e.Scroller="Scroller",e.FullWidth="FullWidth",e.Container="Container",e.FormField="FormField",e.Table="Table",e.App="App",e.Text="Text",e.Avatar="Avatar",e.Chat="Chat",e.AvatarGroup="AvatarGroup",e.Badge="Badge",e.Breadcrumbs="Breadcrumbs",e.Anchor="Anchor",e.Button="Button",e.Chart="Chart",e.Icon="Icon",e.ConfirmDialog="ConfirmDialog",e.ContextMenu="ContextMenu",e.CookieConsent="CookieConsent",e.Details="Details",e.Dialog="Dialog",e.Drawer="Drawer",e.Image="Image",e.Map="Map",e.Markdown="Markdown",e.Notification="Notification",e.ProgressBar="ProgressBar",e.Popover="Popover",e.CarouselLayout="CarouselLayout",e.Tooltip="Tooltip",e.MessageInput="MessageInput",e.MessageList="MessageList",e.CustomField="CustomField",e.MenuBar="MenuBar",e.Grid="Grid",e.GridColumn="GridColumn",e.GridGroupColumn="GridGroupColumn",e.VirtualList="VirtualList",e.FormSection="FormSection",e.FormSubSection="FormSubSection",e.Bpmn="Bpmn",e.Workflow="Workflow",e.FormEditor="FormEditor",e.MetricCard="MetricCard",e.Scoreboard="Scoreboard",e.DashboardPanel="DashboardPanel",e.DashboardLayout="DashboardLayout",e.FoldoutLayout="FoldoutLayout",e.HeroSection="HeroSection",e.EmptyState="EmptyState",e.Skeleton="Skeleton",e.Gantt="Gantt",e.PlanningBoard="PlanningBoard",e.Kanban="Kanban",e.Timeline="Timeline",e.ProgressSteps="ProgressSteps",e.Stat="Stat",e.Calendar="Calendar",e.PricingTable="PricingTable",e.OrgChart="OrgChart",e.Heatmap="Heatmap",e.Funnel="Funnel",e.TrendChart="TrendChart",e.FeatureGrid="FeatureGrid",e.Testimonials="Testimonials",e.Faq="Faq",e.CalloutCard="CalloutCard",e.CommentThread="CommentThread",e.FileList="FileList",e.Checklist="Checklist",e.ComparisonCard="ComparisonCard",e.EntityHeader="EntityHeader",e.Meter="Meter",e.TaskProgress="TaskProgress",e.StatusList="StatusList",e.BulletedList="BulletedList",e.Separator="Separator",e.Notice="Notice",e.TaskQueue="TaskQueue",e.ResourceGrid="ResourceGrid",e.OfferCard="OfferCard",e.AddOnPicker="AddOnPicker",e.Ledger="Ledger",e.PaymentPicker="PaymentPicker",e.ProcessMonitor="ProcessMonitor",e))(h||{});const Ur="mateu-app-context",Di="mateu-app-context-labels",Fi=e=>{try{return JSON.parse(localStorage.getItem(e)??"{}")}catch{return{}}},si=(e,t)=>{try{localStorage.setItem(e,JSON.stringify(t))}catch{}},jr=()=>Fi(Ur),qi=()=>Fi(Di),bo=(e,t,a)=>{const r=jr(),i=qi();t==null||t===""?(delete r[e],delete i[e]):(r[e]=t,a!==void 0&&(i[e]=a)),si(Ur,r),si(Di,i)};let oi=!1;const go=()=>{oi||(oi=!0,window.addEventListener("storage",e=>{e.key===Ur&&e.newValue!==e.oldValue&&window.location.reload()}))},yo=(e,t)=>new Promise((a,r)=>{let i=!1;const s={retry:()=>{i||(i=!0,t().then(a,r))},giveUp:()=>{i||(i=!0,r(e))}},n=new CustomEvent("mateu-session-expired",{detail:s,cancelable:!0,bubbles:!1});typeof document<"u"&&!document.dispatchEvent(n)||s.giveUp()}),$o=(e,t)=>e.includes("json")?!0:t!==null&&typeof t=="object",xo=(e,t)=>{const a=e.finalUrl;if(!a)return;const r=typeof window<"u"?window.location.href:void 0;let i;try{i=new URL(e.requestedUrl,r).href}catch{return}if(i!==a&&!$o(e.contentType??"",e.data))return a};class wo{constructor(){this.windowMs=4e3,this.threshold=12,this.events=[],this.reported=new Set}check(t,a=Date.now()){this.events.push({sig:t,t:a});const r=a-this.windowMs;this.events=this.events.filter(s=>s.t>=r);let i=0;for(const s of this.events)s.sig===t&&i++;if(i>=this.threshold){const s=!this.reported.has(t);return this.reported.add(t),{blocked:!0,firstTrip:s}}return this.reported.delete(t),{blocked:!1,firstTrip:!1}}reset(){this.events=[],this.reported.clear()}configure(t){t.windowMs!==void 0&&(this.windowMs=t.windowMs),t.threshold!==void 0&&(this.threshold=t.threshold)}}const ko=new wo;let oa=[];class Co{constructor(){this.axiosInstance=no.create({timeout:6e4}),this.axiosInstance.interceptors.request.use(t=>(this.addAuthToken(t),this.addSessionId(t),t)),this.axiosInstance.interceptors.response.use(t=>{const a=xo({requestedUrl:this.axiosInstance.getUri(t.config),finalUrl:t.request?.responseURL,contentType:String(t.headers?.["content-type"]??""),data:t.data});if(a)throw window.location.assign(a),Object.assign(new Error("session lost — redirecting to "+a),{code:"ERR_CANCELED"});return t},t=>{const a=t;if(a?.response?.status===401&&a.config&&!a.config.__mateuRetried){const r=a.config;return r.__mateuRetried=!0,yo(t,()=>this.axiosInstance.request(r))}throw t})}addSessionId(t){let a=sessionStorage.getItem("__mateu_sesion_id");a||(a=xe(),sessionStorage.setItem("__mateu_sesion_id",a)),t.headers["X-Session-Id"]=a}addAuthToken(t){const a=localStorage.getItem("__mateu_auth_token");a&&(t.headers.Authorization="Bearer "+a)}async wrap(t,a,r,i){return r||a.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),t.then(s=>(a.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:i}})),s)).catch(s=>{throw s?.code=="ERR_CANCELED"?a.dispatchEvent(new CustomEvent("backend-cancelled-event",{bubbles:!0,composed:!0,detail:{}})):a.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:i,reason:this.serialize(s)}})),s})}serialize(t){return t?.message?t:JSON.stringify(t)}async get(t){const a=new AbortController;return oa=[...oa,a],this.axiosInstance.get(t,{signal:a.signal})}async post(t,a){const r=new AbortController;return oa=[...oa,r],this.axiosInstance.post(t,a,{signal:r.signal})}async abortAll(){oa.forEach(t=>t.abort()),oa=[]}async runAction(t,a,r,i,s,n,d,c,u,m,v){a&&a.startsWith("/")&&(a=a.substring(1));const f=[t,a,r,d??"",i,s].join(""),w=ko.check(f);return w.blocked?(await this.abortAll(),w.firstTrip&&console.error("[mateu] request loop detected — aborting repeated request",f),{messages:w.firstTrip?[{title:"",text:"A repeating request was detected and stopped to protect the server. Reload the page or navigate elsewhere.",position:"bottom-end",variant:"error",duration:6e3}]:[],commands:[],fragments:[],banners:[],appendBanners:!1,appData:void 0,appState:void 0}):(n={...jr(),...n},await this.wrap(this.post(t+"/mateu/v3/sync/"+(a&&a!=""?a:"_no_route"),{serverSideType:d,appState:n,componentState:c,parameters:u,initiatorComponentId:s,consumedRoute:r,route:a&&a!=""?"/"+a:"",actionId:i}).then(x=>x.data),m,v,i))}}const Zt=new Co;var Ia=(e=>(e.Add="Add",e.Replace="Replace",e.ReplaceKeepData="ReplaceKeepData",e))(Ia||{}),st=(e=>(e.HAMBURGUER_MENU="HAMBURGUER_MENU",e.MENU_ON_LEFT="MENU_ON_LEFT",e.MENU_ON_TOP="MENU_ON_TOP",e.TABS="TABS",e.TILES="TILES",e.RAIL="RAIL",e.AUTO="AUTO",e.MEDIATOR="MEDIATOR",e))(st||{}),_o=Object.defineProperty,Mi=(e,t,a,r)=>{for(var i=void 0,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=n(t,a,i)||i);return i&&_o(t,a,i),i};class mr extends C{constructor(){super(...arguments),this.id="",this.baseUrl="",this.callbackToken="",this.createElement=t=>{const a=t.data,r=document.createElement(a.name);for(let i in a.attributes)r.setAttribute(i,a.attributes[i]);for(let i in a.on)r.addEventListener(i,s=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.on[i],parameters:{event:s}},bubbles:!0,composed:!0}))});return r},this.closeModal=()=>{const t=(this.shadowRoot??this).querySelectorAll("mateu-dialog, mateu-drawer");if(t&&t.length>0){t[t.length-1].close(),this.removeTopOverlayChild();return}this.dispatchEvent(new CustomEvent("close-modal-requested",{bubbles:!0,composed:!0}))},this.changeFavicon=t=>{let a=document.querySelector('link[rel="icon"]');a!==null?a.setAttribute("href",t):(a=document.createElement("link"),a.setAttribute("rel","icon"),a.setAttribute("href",t),document.head.appendChild(a))}}connectedCallback(){super.connectedCallback(),this.upstreamSubscription=Mt.subscribe(t=>{if(t.command){const a=t.command;this.id==a.targetComponentId&&this.applyCommand(a)}if((!t.callbackToken||!this.callbackToken||t.callbackToken===this.callbackToken)&&t.fragment){const a=t.fragment;this.id==a.targetComponentId&&(this.applyFragment(a),this.completeMenu(a))}})}completeMenu(t){if(t.component&&t.component.type==W.ClientSide){const a=t.component,r=a.metadata;if(r?.type==h.App){const i=r,s=this.getRemoteMenus(i.menu);if(s.length>0){const n=s.map(d=>Zt.runAction(d.baseUrl,d.route,"_empty","",d.baseUrl+"#"+d.route,void 0,void 0,void 0,d.params,this,!0));Promise.all(n).then(d=>{i.menu=this.updateMenu(i.menu,d.map(c=>c.fragments).filter(c=>c).map(c=>c).flat()),i.variant=st.MENU_ON_TOP,Mt.next({fragment:{component:a,data:void 0,state:void 0,action:Ia.Replace,targetComponentId:this.id,containerId:void 0},callbackToken:this.callbackToken})})}}}}updateMenu(t,a){const r=[];return t.forEach(i=>{if(i.remote){const s=a.find(n=>n.targetComponentId==i.baseUrl+"#"+i.route);if(s&&s.component?.type==W.ClientSide){const n=s.component;if(n.metadata?.type==h.App){const d=n.metadata,c=i.serverSideType&&i.serverSideType!=""?i.serverSideType:d.serverSideType;this.changeBaseUrl(d.menu,i.baseUrl,c,i.route,d.route),r.push(...d.menu)}}}else r.push(i)}),r}changeBaseUrl(t,a,r,i,s){t.forEach(n=>{n.baseUrl||(n.submenus&&n.submenus.length>0?this.changeBaseUrl(n.submenus,a,r,i,s):(n.consumedRoute=s??"",n.baseUrl=a,n.serverSideType=r,n.uriPrefix=i))})}getRemoteMenus(t){const a=[];return t.forEach(r=>{r.remote&&a.push(r)}),a}disconnectedCallback(){super.disconnectedCallback(),this.upstreamSubscription?.unsubscribe()}applyCommand(t){if(t.type=="SetWindowTitle"&&(document.title=t.data),t.type=="SetFavicon"&&this.changeFavicon(t.data),t.type=="DispatchEvent"&&this.dispatchNamedEvent(t.data),t.type=="NavigateTo"){const a=t.data;a&&(a.startsWith("http:")||a.startsWith("https:")?window.open(t.data,"_blank"):window.location.href=t.data)}if(t.type=="PushStateToHistory"){const a=t.data;a!==void 0&&this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:a},bubbles:!0,composed:!0}))}if(t.type=="RunAction"){const a=t.data;if(a&&a.actionId)if(a.targetComponentId){const r={command:{type:"RunAction",data:{actionId:a.actionId},targetComponentId:a.targetComponentId},fragment:void 0,ui:void 0,error:void 0,callbackToken:""};setTimeout(()=>Mt.next(r))}else this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.actionId,parameters:{}},bubbles:!0,composed:!0}))}if(t.type=="MarkAsDirty"&&this.dispatchEvent(new CustomEvent("dirty",{detail:{},bubbles:!0,composed:!0})),t.type=="MarkAsClean"&&this.dispatchEvent(new CustomEvent("clean",{detail:{},bubbles:!0,composed:!0})),t.type=="DownloadFile"){const a=t.data;if(a&&a.base64Content){const r=atob(a.base64Content),i=new Uint8Array(r.length);for(let c=0;c<r.length;c++)i[c]=r.charCodeAt(c);const s=new Blob([i],{type:a.mimeType}),n=URL.createObjectURL(s),d=document.createElement("a");d.href=n,d.download=a.filename??"export",d.click(),URL.revokeObjectURL(n)}}if(t.type=="CloseModal"&&(this.closeModal(),this.dispatchNamedEvent(t.data)),t.type=="AddContentToHead"){const a=t.data;if(a&&a.name){if(a.attributes&&a.attributes.id&&document.getElementById(a.attributes.id))return;document.head.appendChild(this.createElement(t))}}if(t.type=="AddContentToBody"){const a=t.data;if(a&&a.name){if(a.attributes&&a.attributes.id&&document.getElementById(a.attributes.id))return;document.body.appendChild(this.createElement(t))}}}dispatchNamedEvent(t){if(t&&t.eventName){const a=this.component,r=a?.emitsName??a?.serverSideType;let i=t.payload??t.detail;r&&i&&typeof i=="object"&&(i={...i,__source:r}),this.dispatchEvent(new CustomEvent(t.eventName,{detail:i,bubbles:!0,composed:!0}))}}removeTopOverlayChild(){const t=this.component?.children;if(t)for(let a=t.length-1;a>=0;a--){const r=t[a]?.metadata?.type;if(r==h.Drawer||r==h.Dialog){t.splice(a,1);return}}}}Mi([p()],mr.prototype,"id");Mi([p()],mr.prototype,"baseUrl");var Io=Object.defineProperty,So=(e,t,a,r)=>{for(var i=void 0,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=n(t,a,i)||i);return i&&Io(t,a,i),i};class vr extends mr{applyFragment(t){}manageActionRequestedEvent(t){}}So([p()],vr.prototype,"component");const la=(e,t)=>new Function(...Object.keys(t),"return `"+e+"`")(...Object.values(t)),ha=(e,t,a)=>({state:e??{},data:t??{},...a});function $e(e,t,a,r){if(!e?.includes("${"))return e;try{return la(e,ha(t,a,r))}catch(i){return console.warn(`Mateu: could not interpolate "${e}":`,i),e}}const ft=(e,t,a)=>{if(e&&e.indexOf("${")>=0)try{return la(e,ha(t,a))}catch(r){return r.message}return e},Sa=(e,t,a,r,i)=>{if(!e)return e;const s=ha(t,a,{appState:r??{},appData:i??{}});let n=e;try{if(n=la(e,s),n.includes("${"))try{n=la(n,s)}catch(d){n="when evaluating nested "+e+" :"+d+", where data is "+a+" and state is "+t+" and app state is "+r+" and app data is "+i,console.error(d,n,t,a,r,i)}}catch(d){n="when evaluating "+e+" :"+d+", where data is "+a+" and state is "+t+" and app state is "+r+" and app data is "+i,console.error(d,n,t,a,r,i)}return n},Br=(e,t,a,r,i,s)=>{const n=ha(t,a,{appState:r??{},appData:i??{},...s}),d=la(e,n);return new Function(...Object.keys(n),`return (${d})`)(...Object.values(n))},Ni=(e,t,a,r)=>{const i=ha(t,a,r);return new Function(...Object.keys(i),`return (${e})`)(...Object.values(i))},Eo=(e,t,a,r)=>la(e,ha(t,a,r)),Ar="display:inline-flex; align-items:center; justify-content:center; width:2rem; height:2rem; border-radius:50%; background:var(--lumo-contrast-10pct,#e0e0e0); color:var(--lumo-secondary-text-color,#555); font-size:.8rem; font-weight:600; overflow:hidden; flex:none;",Ui=(e,t)=>t||(typeof e=="string"&&e?e.trim().split(/\s+/).map(a=>a[0]).slice(0,2).join("").toUpperCase():""),Po=(e,t,a)=>{const r=e.metadata,i=Oe(r.name,t,a);return o`<span style="${Ar}${e.style}" class="${e.cssClasses}"
                      title="${i||l}" slot="${e.slot??l}">
        ${r.image?o`<img src="${r.image}" alt="${i}" style="width:100%;height:100%;object-fit:cover;">`:Ui(i,r.abbreviation)}
    </span>`},Oe=(e,t,a)=>typeof e=="string"&&e.includes("${")?$e(e,t,a):e,To=e=>{const t=e.metadata,a=t.avatars??[],r=t.maxItemsVisible&&t.maxItemsVisible>0?t.maxItemsVisible:a.length,i=a.slice(0,r),s=a.length-i.length,n="margin-left:-0.4rem; border:2px solid var(--lumo-base-color,#fff);";return o`<span style="display:inline-flex; ${e.style}" class="${e.cssClasses}" slot="${e.slot??l}">
        ${i.map(d=>o`<span style="${Ar}${n}" title="${d.name||l}">
            ${d.img?o`<img src="${d.img}" style="width:100%;height:100%;object-fit:cover;">`:Ui(d.name??"",d.abbr)}
        </span>`)}
        ${s>0?o`<span style="${Ar}${n}">+${s}</span>`:l}
    </span>`},zo=(e,t,a)=>{const r=e.metadata;return o`<span theme="badge ${r.color} ${r.pill?"pill":""} ${r.small?"small":""} ${r.primary?"primary":""}"
                      style="${e.style}" class="${e.cssClasses}"
                      slot="${e.slot??l}">${Oe(r.text,t,a)}</span>`},Oo=(e,t,a)=>{const r=Oe(e.text,t,a);if(!r)return l;let i=Oe(e.color,t,a);return i=="SUCCESS"&&(i="success"),i=="ERROR"&&(i="error"),i=="DANGER"&&(i="error"),i=="WARNING"&&(i="warning"),i=="INFO"&&(i="info"),i=="PRIMARY"&&(i="primary"),i=="SECONDARY"&&(i="secondary"),i=="TERTIARY"&&(i="tertiary"),i=="QUATERNARY"&&(i="quaternary"),i=="LIGHT"&&(i="light"),i=="DARK"&&(i="dark"),o`<span theme="badge ${i} ${e.pill?"pill":""} ${e.small?"small":""} ${e.primary?"primary":""}">${r}</span>`};class Ro{constructor(){this.afterRenderHook=void 0,this.useShadowRoot=!0,this.componentRenderer=void 0}set(t){if(this.componentRenderer=t,typeof window<"u"){const a=t.supportedClientSideTypes?.();window.__mateuRendererInfo={name:t.rendererName?.()??t.constructor?.name??"unknown",supportedTypes:a?[...a].sort():null}}}get(){return this.componentRenderer}setUseShadowRoot(t){this.useShadowRoot=t}mustUseShadowRoot(){return this.useShadowRoot}setAfterRenderHook(t){this.afterRenderHook=t}getAfterRenderHook(){return this.afterRenderHook}}const N=new Ro,Ft=(e,t,a,r,i,s,n,d,c)=>(t.slot=d,g(e,t,a,r,i,s,n,c)),g=(e,t,a,r,i,s,n,d)=>{if(!t)return o``;if(t.type==W.ClientSide)return N.get().renderClientSideComponent(e,t,a,r,i,s,n,d);const c=e.route,u=e.consumedRoute;return o`
        <mateu-component id="${t.id}"
                        ...
                        route="${c}"
                         ...
                         .appData="${n}"
        >
       </mateu-component>`};var Lo=Object.defineProperty,Ao=Object.getOwnPropertyDescriptor,ea=(e,t,a,r)=>{for(var i=r>1?void 0:r?Ao(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Lo(t,a,i),i};const ji=e=>{const t=[];return e.color&&e.color!=="normal"&&e.color!=="none"&&t.push(e.color),e.buttonStyle&&t.push(e.buttonStyle==="tertiaryInline"?"tertiary-inline":e.buttonStyle),e.size&&e.size!=="none"&&e.size!=="normal"&&t.push(e.size),t.length?t.join(" "):void 0},Do=e=>{const t=ji(e)??"",a=[];return t.includes("primary")&&a.push("primary"),t.includes("tertiary")&&a.push("tertiary"),(t.includes("error")||e.color==="error")&&a.push("danger"),a.join(" ")},ni=e=>e==="back"||e==="backToList"||!!e&&e.startsWith("cancel");let nt=class extends C{constructor(){super(...arguments),this.appState={},this.appData={},this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.evalLabel=e=>$e(e,this.state,this.data),this.renderBtn=e=>{if((this.data??{})[e.actionId+".hidden"])return l;const t=this.evalLabel(e.label),a=N.get()?.renderToolbarButton?.(e,t,()=>this.handleButtonClick(e.actionId));return a||o`
        <button class="mtb ${Do(e)}"
                data-action-id="${e.id}"
                @click="${()=>this.handleButtonClick(e.actionId)}"
                ?disabled="${e.disabled}"
        >${t}</button>
    `},this.renderPeerNav=e=>{const t=N.get()?.renderPeerNav?.(e);return t||o`
            ...
            `:n?o`
                <div style="display: flex; gap: var(--lumo-space-m, 1rem); width: 100%; align-items: center;" class="form-header">
                    ...
                    <div style="flex: 1; min-width: 0; overflow: hidden;">
                        ${e?.title&&d==0?o`<h2 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ye(ft(e?.title,this.state??{},this.data??{}))}</h2>`:l}
                        ${e?.title&&d==1?o`<h3 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ye(ft(e?.title,this.state??{},this.data??{}))}</h3>`:l}
                        ${e?.title&&d==2?o`<h4 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ye(ft(e?.title,this.state??{},this.data??{}))}</h4>`:l}
                        ${e?.title&&d==3?o`<h5 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ye(ft(e?.title,this.state??{},this.data??{}))}</h5>`:l}
                        ${e?.title&&d>3?o`<h6 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ye(ft(e?.title,this.state??{},this.data??{}))}</h6>`:l}

                        ${e?.subtitle?o`<span style="display: inline-block; margin-block-end: 0.83em;">${ye(ft(e?.subtitle,this.state??{},this.data??{}))}</span>`:l}
                        ${e?.timestamp?o`<span class="page-timestamp" style="display: block; color: var(--lumo-secondary-text-color, #6b7280); font-size: var(--lumo-font-size-s, .875rem);">${ye(ft(e.timestamp,this.state??{},this.data??{}))}</span>`:l}
                    </div>
                    <div style="display: flex; gap: var(--lumo-space-m, 1rem); align-items: center;">
                        ${e?.kpis?.map(c=>o`
                            <div style="display: flex; flex-direction: column; align-items: center;">
                                <div>${this.evalLabel(c.title)}</div>
                                <div>${ye(ft(c.text,this.state??{},this.data??{}))}</div>
                            </div>
                        `)}
                        ${e?.header?.map(c=>g(this,c,this.baseUrl,this.state??{},this.data??{},this.appState,this.appData))}
                        ${t?this.renderPeerNav(t):l}
        ...
        ${It}
    `;ea([p()],nt.prototype,"metadata",2);ea([p()],nt.prototype,"baseUrl",2);ea([p()],nt.prototype,"state",2);ea([p()],nt.prototype,"data",2);ea([p()],nt.prototype,"appState",2);ea([p()],nt.prototype,"appData",2);nt=ea([k("mateu-content-header")],nt);var Fo=Object.defineProperty,qo=Object.getOwnPropertyDescriptor,Aa=(e,t,a,r)=>{for(var i=r>1?void 0:r?qo(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Fo(t,a,i),i};let Ut=class extends vr{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={}}render(){const e=this.component?.metadata;return o`
    ...
    `;Aa([p()],Ut.prototype,"state",2);Aa([p()],Ut.prototype,"data",2);Aa([p()],Ut.prototype,"appState",2);Aa([p()],Ut.prototype,"appData",2);Ut=Aa([k("mateu-form")],Ut);var Mo=Object.defineProperty,No=Object.getOwnPropertyDescriptor,Vr=(e,t,a,r)=>{for(var i=r>1?void 0:r?No(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Mo(t,a,i),i};let Ea=class extends C{constructor(){super(...arguments),this.variant="text",this.count=3}render(){const e=Array.from({length:Math.max(1,this.count)});return this.variant=="card"?o`${e.map(()=>o`<div class="bone card" style="margin: .5em 0;"></div>`)}`:this.variant=="grid"?o`${e.map(()=>o`<div class="bone row"></div>`)}`:this.variant=="form"?o`${e.map(()=>o`
                <div class="form-pair">
    ...
    `;Vr([p()],Ea.prototype,"variant",2);Vr([p({type:Number})],Ea.prototype,"count",2);Ea=Vr([k("mateu-skeleton")],Ea);const Uo=(e,t)=>{t&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},qt=(e,t,a,r,i,s)=>o`
                ...
                ${e.map(a=>o`
                    <div class="panel-row view-row" @mousedown="${this.keepFocus}">
                        ...
                        <button class="chip-remove" aria-label="Delete view ${a.name}"
                                @click="${()=>{Ho(this.viewsScope,a.name),this.requestUpdate()}}">✕</button>
                    </div>`)}
                ${t?o`
    ...
    `;Se([p()],se.prototype,"metadata",2);Se([p()],se.prototype,"baseUrl",2);Se([b()],se.prototype,"state",2);Se([b()],se.prototype,"data",2);Se([p()],se.prototype,"appState",2);Se([p()],se.prototype,"appData",2);Se([p({type:Boolean})],se.prototype,"searchOnly",2);Se([b()],se.prototype,"panelOpened",2);Se([b()],se.prototype,"viewsOpened",2);Se([b()],se.prototype,"activeFilter",2);Se([b()],se.prototype,"draftText",2);se=Se([k("mateu-filter-bar")],se);const Hi="mateu-column-prefs",Wr=()=>{try{const e=JSON.parse(localStorage.getItem(Hi)??"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}},Wi=e=>{try{localStorage.setItem(Hi,JSON.stringify(e))}catch{}},Gr=e=>{if(!e||typeof e!="object")return;const t=a=>Array.isArray(a)?a.filter(r=>typeof r=="string"):[];return{hidden:t(e.hidden),order:t(e.order)}},Gi=e=>Gr(Wr()[e]),Jo=(e,t)=>{const a=Wr(),r=Gr(t);r.hidden.length===0&&r.order.length===0?delete a[e]:a[e]=r,Wi(a)},Xo=e=>{const t=Wr();delete t[e],Wi(t)},Ki=e=>e?!!e.identifier||e.dataType==="action"||e.dataType==="actionGroup"||e.dataType==="menu"||e.id==="select"||e.id==="menu":!1,Yi=(e,t,a=r=>r)=>{const r=Gr(t);if(!r||r.hidden.length===0&&r.order.length===0)return e;const i=v=>a(v)?.id??v.id,s=new Set(r.hidden),n=e.filter(v=>{const f=i(v);return!f||!s.has(f)||Ki(a(v))});if(r.order.length===0)return n.length===e.length?e:n;const d=new Map;n.forEach(v=>{const f=i(v);f&&!d.has(f)&&d.set(f,v)});const c=[],u=new Set;return r.order.forEach(v=>{const f=d.get(v);f&&!u.has(f)&&(c.push(f),u.add(f))}),n.forEach(v=>{u.has(v)||(c.push(v),u.add(v))}),c.length===e.length&&c.every((v,f)=>v===e[f])?e:c};var Qo=Object.defineProperty,Zo=Object.getOwnPropertyDescriptor,Da=(e,t,a,r)=>{for(var i=r>1?void 0:r?Zo(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Qo(t,a,i),i};let jt=class extends C{constructor(){super(...arguments),this.columns=[],this.scope="",this.panelOpened=!1,this.revision=0,this.togglePanel=()=>{if(this.panelOpened){this.closePanel();return}this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick)},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1},this.reset=()=>{Xo(this.scope),this.revision++,this.dispatchEvent(new CustomEvent("column-prefs-changed",{bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}get prefs(){return Gi(this.scope)??{hidden:[],order:[]}}effectiveEntries(e){return Yi(this.columns,{hidden:[],order:e.order})}commit(e){Jo(this.scope,e),this.revision++,this.dispatchEvent(new CustomEvent("column-prefs-changed",{bubbles:!0,composed:!0}))}toggleVisibility(e){const t=this.prefs,a=t.hidden.includes(e)?t.hidden.filter(r=>r!==e):[...t.hidden,e];this.commit({...t,hidden:a})}move(e,t){const a=this.prefs,r=[...this.effectiveEntries(a)],i=r.findIndex(d=>d.id===e);if(i<0)return;let s=i+t;for(;s>=0&&s<r.length&&r[s].protected;)s+=t;if(s<0||s>=r.length)return;const n=r[i];r[i]=r[s],r[s]=n,this.commit({...a,order:r.map(d=>d.id)})}render(){this.revision;const e=this.prefs,t=this.effectiveEntries(e).filter(r=>!r.protected);if(t.length===0)return o``;const a=e.hidden.length>0||e.order.length>0;return o`
            <div class="chooser">
                <button
    ...
    `;Da([p()],jt.prototype,"columns",2);Da([p()],jt.prototype,"scope",2);Da([b()],jt.prototype,"panelOpened",2);Da([b()],jt.prototype,"revision",2);jt=Da([k("mateu-column-chooser")],jt);var en=Object.defineProperty,tn=Object.getOwnPropertyDescriptor,Fa=(e,t,a,r)=>{for(var i=r>1?void 0:r?tn(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&en(t,a,i),i};let Bt=class extends C{constructor(){super(...arguments),this.totalElements=0,this.pageSize=100,this.pageNumber=0,this.totalPages=0}updated(e){super.updated(e),(e.has("totalElements")||e.has("pageSize"))&&(this.totalPages=Math.ceil(this.totalElements/this.pageSize))}dispatch(e){this.dispatchEvent(new CustomEvent("page-changed",{bubbles:!0,composed:!0,detail:{page:e}}))}render(){if(!this.totalElements)return l;const e=this.totalPages>1,t=this.pageNumber,a=t===0,r=t>=this.totalPages-1;return o`
            <div class="bar">
                ${e?o`
    ...
    `;Fa([p()],Bt.prototype,"totalElements",2);Fa([p()],Bt.prototype,"pageSize",2);Fa([p()],Bt.prototype,"pageNumber",2);Fa([b()],Bt.prototype,"totalPages",2);Bt=Fa([k("mateu-pagination")],Bt);const ma="var(--lumo-space-m, 1rem)",an=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=d.columnWidth||"13rem";let m=`display: grid; grid-template-columns: ${d.maxColumns&&d.maxColumns>0?`repeat(${d.maxColumns}, minmax(0, 1fr))`:`repeat(auto-fill, minmax(min(100%, ${c}), 1fr))`}; gap: ${ma} var(--lumo-space-l, 1.5rem); align-items: start;`;return d.labelsAside&&(m+=" --mateu-label-width: 10rem;"),d.fullWidth&&(m+=" width: 100%;"),m+=t.style??"",o`
        <div style="${m}" class="${t.cssClasses}" slot="${t.slot||l}">
            ${t.children?.map(v=>Ji(d,e,v,a,r,i,s,n))}
        </div>
    `},Ji=(e,t,a,r,i,s,n,d)=>{if(a.type==W.ClientSide&&a.metadata?.type==h.FormRow)return on(e,t,a,r,i,s,n,d);const c=rn(a),u=e.labelsAside?sn(t,a,r,i,s,n,d):g(t,a,r,i,s,n,d);return o`<div style="grid-column: span ${c}; min-width: 0;">${u}</div>`},rn=e=>{if(e.type==W.ClientSide){const t=e.metadata;if(t?.type==h.FormField)return t.colspan||1}return 1},sn=(e,t,a,r,i,s,n)=>{if(t.type==W.ClientSide&&t.metadata?.type==h.FormField&&t.metadata.label){const d=t.metadata,c=d.label?.includes("${")?e._evalTemplate(d.label):d.label;return o`
            <div style="display: flex; gap: ${ma}; align-items: baseline;">
        ...
        `}return g(e,t,a,r,i,s,n)},on=(e,t,a,r,i,s,n,d)=>o`
        <div style="grid-column: 1 / -1; display: flex; gap: ${ma}; flex-wrap: wrap;">
            ${a.children?.map(c=>o`<div style="flex: 1 1 ${100/Math.max(1,a.children.length)}%; min-width: min(100%, 13rem);">${Ji(e,t,c,r,i,s,n,d)}</div>`)}
        </div>
    `,Xi=(e,t,a,r,i,s,n,d)=>{const c=a.metadata;let u=`display: flex; flex-direction: ${e};`;c.spacing&&(u+=` gap: ${ma};`),c.padding&&(u+=" padding: var(--lumo-space-m, 1rem);"),c.wrap&&(u+=" flex-wrap: wrap;"),c.fullWidth&&(u+=" width: 100%;"),c.justification&&(u+=` justify-content: ${c.justification};`);const m=e==="row"?c.verticalAlignment:c.horizontalAlignment;return m&&(u+=` align-items: ${m};`),u+=a.style??"",o`
        <div style="${u}" class="${a.cssClasses}" slot="${a.slot??l}">
            ${a.children?.map(v=>g(t,v,r,i,s,n,d))}
        </div>
    `},nn=(e,t,a,r,i,s,n)=>Xi("row",e,t,a,r,i,s,n),ln=(e,t,a,r,i,s,n)=>Xi("column",e,t,a,r,i,s,n),dn=(e,t,a,r,i,s,n)=>{const d=t.metadata;let u=`display: flex; flex-direction: ${d.orientation==="vertical"?"column":"row"}; gap: var(--lumo-space-s, 0.5rem);`;return d.fullWidth&&(u+=" width: 100%;"),u+=t.style??"",o`
    ...
    `},cn=(e,t,a,r,i,s,n)=>{const d=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,u=!!i?.hasDetail||!!d,m=c??d;return o`
    ...
    `},un=(e,t,a,r,i,s,n)=>{let d=t.style??"";t.metadata.fullWidth&&(d+=" width: 100%;");const c=Math.max(0,(t.children??[]).findIndex(u=>u.metadata.active));return o`
    ...
    `},pn=(e,t,a,r,i,s,n)=>{const d=t.metadata;let c=t.style??"";return d.fullWidth&&(c+=" width: 100%;"),o`
        <div style="${c}" class="${t.cssClasses}" slot="${t.slot??l}">
            ${t.children?.map(u=>hn(e,u,a,r,i,s,n,d.variant))}
        </div>
    `},hn=(e,t,a,r,i,s,n,d)=>{const c=t.metadata,u=c.label?.includes("${")?e._evalTemplate(c.label):c.label;return o`
    ...
    `,bn=(e,t,a,r,i,s,n)=>o`
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 16rem), 1fr)); gap: ${ma}; ${t.style}" class="${t.cssClasses}" slot="${t.slot??l}">
            ${t.children?.map(d=>g(e,d,a,r,i,s,n))}
        </div>
    `,gn=(e,t,a,r,i,s,n)=>o`
        <div style="display: flex; gap: ${ma}; flex-wrap: wrap; ${t.style}" class="${t.cssClasses}">
            ${t.children?.map(d=>g(e,d,a,r,i,s,n))}
        </div>
    ...
    `},xn=e=>{const t=e.metadata;return(t?.content??t?.columns??[]).filter(r=>r&&r.metadata).map(r=>{const i=r.metadata;return{id:r.id??"",label:i?.label??r.id??"",autoWidth:i?.autoWidth,width:i?.width}})},li=(e,t)=>{const a=e?.[t];return a==null?"":typeof a=="object"?a.text??a.label??a.value??"":String(a)},Dr=(e,t,a)=>{const r=xn(e),i="text-align:left; padding:.45rem .6rem; border-bottom:2px solid var(--lumo-contrast-20pct,rgba(0,0,0,.2)); font-weight:600; white-space:nowrap; color: var(--lumo-secondary-text-color,#556);",s="padding:.4rem .6rem; border-bottom:1px solid var(--lumo-contrast-10pct,rgba(0,0,0,.08)); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:24rem;";return o`
        <div style="overflow:auto; width:100%; ${e.style}" class="${e.cssClasses}" slot="${e.slot??l}">
            <table style="border-collapse:collapse; width:100%; font-size: var(--lumo-font-size-s,.875rem);">
                ...
                <tbody>
                    ${(t??[]).length===0?o`<tr><td colspan="${Math.max(1,r.length)}" style="padding:1.5rem; text-align:center; color: var(--lumo-secondary-text-color,#888);">${a??"No data."}</td></tr>`:t.map(n=>o`<tr>${r.map(d=>o`<td style="${s}" title="${li(n,d.id)}">${li(n,d.id)}</td>`)}</tr>`)}
                </tbody>
            </table>
        </div>
    `},di=(e,t)=>{const a=e.metadata;return e.id&&t&&t[e.id]?t[e.id]:a?.page?.content??[]},wn=e=>{const a=e.metadata.items??[];return o`
    ...
    `},Qi=(e,t,a,r,i,s,n)=>t.separator?o`<span style="align-self: stretch; width: 1px; background: var(--lumo-contrast-20pct, rgba(0,0,0,.2));"></span>`:t.submenus?o`
            <details style="position: relative;">
                ...
                <div style="display: flex; flex-direction: column; gap: .1rem; padding: .3rem; min-width: 10rem;
                    ...
                    ${t.submenus.map(d=>Qi(e,d,a,r,i,s,n))}
                </div>
            </details>
        `:o`
    ...
    `,kn=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
        <div style="display: flex; flex-wrap: wrap; gap: .25rem; align-items: center; ${t.style}"
            ...
            ${d.options?.map(c=>Qi(e,c,a,r,i,{},{}))}
        </div>
    `},Cn=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
        <div style="${t.style}" class="${t.cssClasses}" slot="${t.slot??l}">
            ${g(e,d.wrapped,a,r,i,s,n)}
        </div>
    `},_n=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=d.content?.metadata,u=c?.type==h.Notice&&c.fullWidth===!0;return o`
        ...
        >
            ...
            `},In=e=>{const t=e.metadata,a=r=>{const i=r.closest(".mateu-message-input")?.querySelector("input"),s=i?.value??"";!t.actionId||!s.trim()||(r.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:{message:s}},bubbles:!0,composed:!0})),i&&(i.value=""))};return o`
    ...
    `},Sn=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`<span title="${d.text}" style="${t.style}" class="${t.cssClasses}" slot="${t.slot??l}"
        >${g(e,d.wrapped,a,r,i,s,n)}</span>`},En=e=>{if(e instanceof CustomEvent)return e.detail;const t={};for(const a in e){const r=e[a];["number","string","boolean"].indexOf(typeof r)>=0&&(t[a]=e[a])}return t},ci=(e,t,a)=>{for(let r in t.attributes)e.setAttribute(r,t.attributes[r]);a.style&&e.setAttribute("style",a.style),a.cssClasses&&e.setAttribute("class",a.cssClasses),a.slot&&e.setAttribute("slot",a.slot),t.content&&(t.html?e.innerHTML=t.content:e.append(t.content))},Pn=e=>{const t=e.name,a=e.attributes?e.attributes.import:void 0;a&&t.includes("-")&&!customElements.get(t)&&import(a)},Tn=(e,t,a)=>{Pn(t);let r=t.name;return t.attributes&&t.attributes.id&&(r="#"+t.attributes.id),setTimeout(()=>{const i=e.shadowRoot?.querySelector(".element-container")?.querySelector(r);if(i){for(;i.firstChild;)i.removeChild(i.lastChild);ci(i,t,a)}else{const s=document.createElement(t.name);ci(s,t,a);for(let n in t.on)s.addEventListener(n,d=>{const c=En(d);e.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.on[n],parameters:{event:c}},bubbles:!0,composed:!0}))});e.shadowRoot?.querySelector(".element-container")?.appendChild(s)}}),o`<div class="element-container"></div>`};var We=(e=>(e.div="div",e.p="p",e.h1="h1",e.h2="h2",e.h3="h3",e.h4="h4",e.h5="h5",e.h6="h6",e.span="span",e))(We||{});const zn=(e,t,a,r,i)=>{const s=e.metadata,n=s.attributes?.["data-colspan"],d=Sa(s.text,t,a,r,i),c={xl:"var(--lumo-font-size-xl, 1.375rem)",l:"var(--lumo-font-size-l, 1.125rem)",s:"var(--lumo-font-size-s, .875rem)",xs:"var(--lumo-font-size-xs, .8125rem)"},u=(s.size&&c[s.size]?`font-size: ${c[s.size]}; `:"")+(s.noMargins?"margin-block-start: 0; margin-block-end: 0; ":"");return We.h1==s.container?o`
        ...
        `:We.p==s.container?o`
            ...
            `},On=e=>{const t=e.metadata;return o`<a href="${t.url}" target="${t.target??l}"
                   rel="${t.target==="_blank"?"noopener":l}"
                   style="${e.style}" class="${e.cssClasses}"
                   slot="${e.slot??l}">${t.text}</a>`},Zi=(e,t)=>{const a=e.toLowerCase().split("+");return t.ctrlKey===a.includes("ctrl")&&t.altKey===a.includes("alt")&&t.shiftKey===a.includes("shift")&&t.metaKey===a.includes("meta")},Rn=(e,t)=>{if(!Zi(e,t))return!1;const a=e.toLowerCase().split("+"),r=a[a.length-1];return!!(t.key.toLowerCase()===r||/^[a-z]$/.test(r)&&t.code==="Key"+r.toUpperCase()||/^[0-9]$/.test(r)&&(t.code==="Digit"+r||t.code==="Numpad"+r))},es=e=>e?e.split("+").map(t=>t.length<=1?t.toUpperCase():t.charAt(0).toUpperCase()+t.slice(1)).join("+"):void 0,ts=(e,t)=>{const a=e.currentTarget.dataset.actionId;e.currentTarget?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a,parameters:t.parameters},bubbles:!0,composed:!0}))},Ln="display:inline-flex; align-items:center; justify-content:center; gap:.4em; box-sizing:border-box; font:inherit; font-weight:500; cursor:pointer; border-radius:var(--lumo-border-radius-m,6px); border:1px solid transparent; line-height:1; white-space:nowrap;",An=e=>{const t=e.buttonStyle??"",a=e.color&&e.color!=="none"&&e.color!=="normal"?e.color:"",r=e.size,i=a==="success"?"var(--lumo-success-color,#1a7f37)":a==="error"?"var(--lumo-error-color,#c5221f)":a==="contrast"?"var(--lumo-contrast,#161513)":"var(--lumo-primary-color,#3b5bdb)",s=a==="success"?"var(--lumo-success-contrast-color,#fff)":a==="error"?"var(--lumo-error-contrast-color,#fff)":a==="contrast"?"var(--lumo-base-color,#fff)":"var(--lumo-primary-contrast-color,#fff)",n=a==="success"?"var(--lumo-success-text-color,#1a7f37)":a==="error"?"var(--lumo-error-text-color,#c5221f)":a==="contrast"?"var(--lumo-body-text-color,#161513)":"var(--lumo-primary-text-color,#3b5bdb)";let d;return t==="primary"?d=`background:${i}; color:${s};`:t==="tertiary"||t==="tertiaryInline"?d=`background:transparent; color:${n};`:d=`background:var(--lumo-contrast-5pct,rgba(0,0,0,.04)); color:${n}; border-color:var(--lumo-contrast-20pct,rgba(0,0,0,.16));`,`${Ln}${d}${r==="small"?"padding:.25rem .6rem; font-size:var(--lumo-font-size-s,.875rem);":r==="large"?"padding:.65rem 1.4rem; font-size:var(--lumo-font-size-l,1.125rem);":"padding:.45rem 1rem; font-size:var(--lumo-font-size-m,1rem);"}`},Dn=(e,t,a)=>{const r=e.metadata,i=$e(r.label,t,a);return o`<button
            id="${e.id}"
            ...
            class="${e.cssClasses}"
            ?disabled="${r.disabled}"
            title="${r.shortcut?`${i} (${es(r.shortcut)})`:l}"
            slot="${e.slot??l}"
    >${r.iconOnLeft?j(r.iconOnLeft):l}${i}${r.iconOnRight?j(r.iconOnRight):l}</button>`},Fn="display:block; box-sizing:border-box; background:var(--lumo-base-color,#fff); border:1px solid var(--lumo-contrast-10pct,rgba(0,0,0,.1)); border-radius:var(--lumo-border-radius-l,12px); box-shadow:var(--lumo-box-shadow-xs,0 1px 3px rgba(0,0,0,.08)); overflow:hidden;",qn=(e,t,a,r,i,s,n)=>{const d=t.metadata;if(!d)return o``;const c=m=>m?g(e,m,a,r,i,s,n,!1):l,u=d.header||d.headerPrefix||d.headerSuffix||d.title||d.subtitle;return o`
        <div style="${Fn}${t.style}" class="${t.cssClasses}" slot="${t.slot??l}">
            ${d.media?c(d.media):l}
    ...
    `},Nn=e=>{const t=e.metadata;return j(t.icon,e.style,e.cssClasses,e.slot)},Sr=(e,t)=>{e&&e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},as="font:inherit; font-weight:500; cursor:pointer; padding:.45rem 1rem; border-radius:var(--lumo-border-radius-m,6px);",ui=`${as} background:var(--lumo-contrast-5pct,rgba(0,0,0,.04)); color:var(--lumo-body-text-color,#161513); border:1px solid var(--lumo-contrast-20pct,rgba(0,0,0,.16));`,Un=`${as} background:var(--lumo-primary-color,#3b5bdb); color:var(--lumo-primary-contrast-color,#fff); border:1px solid transparent;`,jn=(e,t,a,r,i,s,n)=>{const d=t.metadata;let c=!1;if(d.openedCondition)try{c=Br(d.openedCondition,r,i,s,n)}catch(u){console.error("when evaluating "+d.openedCondition+" :"+u+", where data is "+i+" and state is "+r)}return c?o`
        <div class="mateu-confirm-dialog ${t.cssClasses??""}"
            ...
            <div style="background:var(--lumo-base-color,#fff); color:var(--lumo-body-text-color,#161513); border-radius:var(--lumo-border-radius-l,12px); box-shadow:var(--lumo-box-shadow-l,0 8px 24px rgba(0,0,0,.2)); width:100%; max-width:min(90vw,32rem); padding:1.5rem; box-sizing:border-box;">
                ...
                <div style="display:flex; gap:.5rem; justify-content:flex-end; margin-top:1.25rem;">
                    ${d.canCancel?o`<button style="${ui}" @click="${u=>Sr(u.currentTarget,d.cancelActionId)}">${d.rejectText&&!d.canReject?d.rejectText:"Cancel"}</button>`:l}
                    ${d.canReject?o`<button style="${ui}" @click="${u=>Sr(u.currentTarget,d.rejectActionId)}">${d.rejectText||"No"}</button>`:l}
                    <button style="${Un}" @click="${u=>Sr(u.currentTarget,d.confirmActionId)}">${d.confirmText||"OK"}</button>
                </div>
            </div>
        </div>
    `:o``},Bn=e=>{const t=e.metadata;let a;return t.position&&(a={Top:"top",Bottom:"bottom",TopLeft:"top-left",TopRight:"top-right",BottomLeft:"bottom-left",BottomRight:"bottom-right"}[t.position]),o`
    ...
    `},Jn=(e,t={})=>{const a=e.metadata,r=a.valueKey?t[a.valueKey]:a.value,i=a.max&&a.max!=0?a.max:1,s=!a.indeterminate&&r!=null;return o`
    ...
    `},Qn=e=>{const t=e.metadata;return o`
        ...
        <img src="${t.src}" style="${e.style}" class="${e.cssClasses}"
             slot="${e.slot??l}">
            `},el=e=>{const t=e.metadata;return o`<div style="display:flex; align-items:center; gap:0.5rem;" slot="${e.slot??l}">
        ${t.breadcrumbs.map(a=>o`
            <a href="${a.link}">${a.text}</a>
            <span>/</span>
        `)}
        <span style="${e.style}" class="${e.cssClasses}">${t.currentItemText}</span>
    </div>`},tl=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
        <skeleton-carousel 
                id="${t.id}"
                ?dots = "${d.dots}" 
                ?nav = "${d.nav}" 
    ...
    `},al=(e,t,a,r)=>{const i=e.metadata;return o`
        ...
        `}
        `,rl=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`<div
                slot="${t.slot??l}"
                style="${t.style}" class="${t.cssClasses}"
        >${d.content?ye(d.content):l}${t.children?.map(c=>g(e,c,a,r,i,s,n))}</div>
    `},il=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=d.title?.includes("${")?e._evalTemplate(d.title):d.title;return o`<div
                slot="${t.slot??l}"
    ...
    `},sl=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=d.title?.includes("${")?e._evalTemplate(d.title):d.title;return o`
        <div
                slot="${t.slot??l}"
                style="${t.style}" class="${t.cssClasses}"
        >
    ...
    `},Fr=(e,t,a,r,i,s,n,d)=>{const c=t.metadata,u=c?.fabs??[];return o`<mateu-page
            .component="${t}"
            baseUrl="${a}"
            .state="${r}"
            .data="${i}"
...
`)}
    ...
    `},qr=(e,t,a,r,i,s,n,d)=>o`<mateu-table-crud
            id="${t.id}"
            baseUrl="${a}"
            .component="${t}"
            .metadata="${t.metadata}"
    ...
    >
        ${t.children?.map(c=>g(e,c,a,r,i,s,n))}
    </mateu-table-crud>`,ll=e=>{const t=e.metadata;return o`
        <mateu-bpmn
                style="${e.style}"
                class="${e.cssClasses}"
                slot="${e.slot??l}"
    ...
    `},dl=(e,t,a)=>{const r=e.metadata;return o`<mateu-chat sseUrl="${r.sseUrl}"
                            style="${e.style}" 
                            class="${e.cssClasses}" 
                            slot="${e.slot??l}"></mateu-chat>`},cl=e=>{const t=e.metadata;return o`
        <mateu-workflow
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
    ...
    box-sizing: border-box;
`,pl=e=>e=="up"?"var(--lumo-success-text-color, #1a7f37)":e=="down"?"var(--lumo-error-text-color, #c5221f)":"var(--lumo-secondary-text-color, #666)",hl=e=>e=="up"?"▲":e=="down"?"▼":"",ml=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},vl=e=>{const t=e.metadata,a=!!t.actionId;return o`
        <div class="mateu-metric-card ${e.cssClasses??""}"
             style="${is} display: flex; flex-direction: column; gap: .25rem; min-width: 11rem; flex: 1; ${a?"cursor: pointer;":""} ${e.style??""}"
             slot="${e.slot??l}"
             role="${a?"button":l}"
             @click="${r=>ml(r,t)}"
        >
            <div style="display: flex; align-items: center; justify-content: space-between; gap: .5rem;">
                ...
                ${t.icon?j(t.icon,"color: var(--lumo-tertiary-text-color, #999); width: 1.1em; height: 1.1em;"):l}
            </div>
            ...
            ${t.trend||t.trendLabel?o`
                <span style="font-size: var(--lumo-font-size-s, .875rem); color: ${pl(t.trend)};">
                    ${hl(t.trend)} ${t.trendLabel??l}
                </span>
            `:l}
    ...
    `,bl=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=d.colSpan&&d.colSpan>1?`grid-column: span ${d.colSpan};`:"",u=d.rowSpan&&d.rowSpan>1?`grid-row: span ${d.rowSpan};`:"";return o`
        <div class="mateu-dashboard-panel ${t.cssClasses??""}"
             style="${is} display: flex; flex-direction: column; gap: .5rem; min-width: 0; ${c} ${u} ${t.style??""}"
             slot="${t.slot??l}"
        >
            ${d.title?o`
                <div>
    ...
    `},gl=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=d.columns&&d.columns>0?`repeat(${d.columns}, minmax(0, 1fr))`:"repeat(auto-fit, minmax(20rem, 1fr))";return o`
    ...
    `};var yl=Object.defineProperty,$l=Object.getOwnPropertyDescriptor,ct=(e,t,a,r)=>{for(var i=r>1?void 0:r?$l(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&yl(t,a,i),i};let Le=class extends C{constructor(){super(...arguments),this.panels=[],this.headerTitle="",this.badges=[],this.orientation="vertical",this.navigation=null,this.overviewEditActionId="",this.openPanels=new Set,this.expandedPanel=null,this._onPopState=()=>{const e=decodeURIComponent((location.hash||"").replace(/^#/,""));if(e.startsWith("expand=")){const t=e.slice(7),a=this.panels.findIndex((r,i)=>this.panelAnchor(r,i)===t);this.expandedPanel=a>=0?a:null}else this.expandedPanel=null},this.initialized=!1}navAction(e){e&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e,parameters:{}},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._onPopState)}disconnectedCallback(){window.removeEventListener("popstate",this._onPopState),super.disconnectedCallback()}willUpdate(){if(!this.initialized&&this.panels.length){this.openPanels=new Set(this.panels.map((t,a)=>t.open?a:-1).filter(t=>t>=0));const e=decodeURIComponent((location.hash||"").replace(/^#/,""));if(e.startsWith("expand=")){const t=e.slice(7),a=this.panels.findIndex((r,i)=>this.panelAnchor(r,i)===t);a>=0&&(this.expandedPanel=a)}else if(e){const t=this.panels.findIndex((a,r)=>this.panelAnchor(a,r)===e);t>=0&&this.openPanels.add(t)}this.initialized=!0}}firstUpdated(){const e=decodeURIComponent((location.hash||"").replace(/^#/,""));if(!e)return;const t=this.renderRoot.querySelector(`[data-anchor="${CSS.escape(e)}"]`);t&&t.scrollIntoView({block:"nearest"})}panelAnchor(e,t){return(e.title??"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")||`panel-${t}`}bookmarkPanel(e){const t=this.panelAnchor(this.panels[e],e);try{history.replaceState(history.state,"","#"+t)}catch{}}clearBookmark(e){const t=this.panelAnchor(this.panels[e],e);if(decodeURIComponent((location.hash||"").replace(/^#/,""))===t)try{history.replaceState(history.state,"",location.pathname+location.search)}catch{}}expandPanel(e,t){t?.stopPropagation(),this.expandedPanel=e;const a=this.panelAnchor(this.panels[e],e);try{history.pushState(history.state,"","#expand="+a)}catch{}}collapsePanel(){try{history.back()}catch{this.expandedPanel=null}}toggle(e){const t=new Set(this.openPanels);t.has(e)?(t.delete(e),this.clearBookmark(e)):(t.add(e),this.bookmarkPanel(e)),this.openPanels=t}render(){if(this.expandedPanel!=null&&this.panels[this.expandedPanel]){const t=this.panels[this.expandedPanel];return o`
    ...
    `;ct([p({type:Array})],Le.prototype,"panels",2);ct([p({type:String})],Le.prototype,"headerTitle",2);ct([p({type:Array})],Le.prototype,"badges",2);ct([p({type:String,reflect:!0})],Le.prototype,"orientation",2);ct([p({attribute:!1})],Le.prototype,"navigation",2);ct([p({type:String})],Le.prototype,"overviewEditActionId",2);ct([b()],Le.prototype,"openPanels",2);ct([b()],Le.prototype,"expandedPanel",2);Le=ct([k("mateu-foldout")],Le);const xl=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
        <mateu-foldout
                .panels="${d.panels??[]}"
    ...
    `},wl=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=!!d.image,u=c?`background-image: linear-gradient(rgba(0,0,0,.35), rgba(0,0,0,.35)), url('${d.image}'); background-size: cover; background-position: center; color: #fff;`:"",m=d.centered===!1?"flex-start":"center",v=d.centered===!1?"left":"center";return o`
    ...
    `};var kl=Object.defineProperty,Cl=Object.getOwnPropertyDescriptor,Kr=(e,t,a,r)=>{for(var i=r>1?void 0:r?Cl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&kl(t,a,i),i};const Er=1440*60*1e3;let Pa=class extends C{constructor(){super(...arguments),this.tasks=[],this.onTaskSelectionActionId=""}selectTask(e){this.onTaskSelectionActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.onTaskSelectionActionId,parameters:{_clickedTaskId:e.id}},bubbles:!0,composed:!0}))}range(){const e=this.tasks.flatMap(t=>[t.start,t.end]).filter(t=>!!t).map(t=>new Date(t+"T00:00:00").getTime());return e.length?{min:Math.min(...e)-Er,max:Math.max(...e)+2*Er}:null}months(e,t){const a=[],r=new Date(e);for(r.setDate(1);r.getTime()<=t;){const i=Math.max(r.getTime(),e),s=new Date(r.getFullYear(),r.getMonth()+1,1),n=Math.min(s.getTime(),t);a.push({label:r.toLocaleDateString(void 0,{month:"short",year:"2-digit"}),from:i,to:n}),r.setMonth(r.getMonth()+1)}return a}render(){const e=this.range();if(!e)return o``;const t=e.max-e.min,a=i=>(i-e.min)/t*100,r=Date.now();return o`
            <div class="frame">
                ...
                ${this.tasks.map(i=>{const s=new Date(i.start+"T00:00:00").getTime(),n=new Date(i.end+"T00:00:00").getTime()+Er;return o`
    ...
    `;Kr([p({type:Array})],Pa.prototype,"tasks",2);Kr([p()],Pa.prototype,"onTaskSelectionActionId",2);Pa=Kr([k("mateu-gantt")],Pa);const _l=e=>{const t=e.metadata;return o`
        <mateu-gantt
                .tasks="${t.tasks??[]}"
    ...
    `};var Il=Object.defineProperty,Sl=Object.getOwnPropertyDescriptor,St=(e,t,a,r)=>{for(var i=r>1?void 0:r?Sl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Il(t,a,i),i};let A=class extends C{constructor(){super(...arguments),this.resources=[],this.blocks=[],this.drag=null,this.dragStartX=0,this.dragStartY=0,this.laneRects=[],this.onDragKeydown=e=>{e.key==="Escape"&&this.drag&&(e.stopPropagation(),this.endDrag())}}static parse(e){return new Date(e+"T00:00:00")}static iso(e){const t=a=>String(a).padStart(2,"0");return`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}`}static addDays(e,t){return new Date(e.getFullYear(),e.getMonth(),e.getDate()+t)}static daysBetween(e,t){return Math.round((t.getTime()-e.getTime())/864e5)}window(){if(this.from&&this.to){const r=A.parse(this.from),i=A.daysBetween(r,A.parse(this.to))+1;return i>0?{from:r,days:i}:null}const e=this.blocks.flatMap(r=>[r.start,r.end]).filter(r=>!!r).map(r=>A.parse(r));if(!e.length)return null;const t=new Date(Math.min(...e.map(r=>r.getTime()))),a=new Date(Math.max(...e.map(r=>r.getTime())));return{from:t,days:A.daysBetween(t,a)+1}}onBlockPointerDown(e,t,a){if(!this.moveActionId&&!this.selectActionId||(e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),this.dragStartX=e.clientX,this.dragStartY=e.clientY,!this.window()))return;const s=A.parse(t.start),n=A.parse(t.end),d=Math.max(1,A.daysBetween(s,n)+1);this.laneRects=[...this.renderRoot.querySelectorAll(".lane[data-resource-id]")].map(u=>({resourceId:u.dataset.resourceId,rect:u.getBoundingClientRect()}));const c=this.dayAt(t.resourceId,e.clientX)??a;this.drag={blockId:t.id,duration:d,grabOffsetDays:c-a,originResourceId:t.resourceId,originStartIdx:a,targetResourceId:t.resourceId,targetStartIdx:a,moved:!1},window.addEventListener("keydown",this.onDragKeydown)}dayAt(e,t){const a=this.laneRects.find(s=>s.resourceId===e),r=this.window();if(!a||!r||a.rect.width===0)return null;const i=Math.floor((t-a.rect.left)/a.rect.width*r.days);return Math.max(0,Math.min(r.days-1,i))}onBlockPointerMove(e){if(!this.drag||!this.drag.moved&&Math.abs(e.clientX-this.dragStartX)<4&&Math.abs(e.clientY-this.dragStartY)<4||!this.moveActionId)return;const t=this.window();if(!t)return;const a=this.laneRects.find(s=>e.clientY>=s.rect.top&&e.clientY<=s.rect.bottom)??this.laneRects.find(s=>s.resourceId===this.drag.targetResourceId);if(!a)return;const r=this.dayAt(a.resourceId,e.clientX);if(r==null)return;const i=Math.max(0,Math.min(t.days-this.drag.duration,r-this.drag.grabOffsetDays));this.drag={...this.drag,moved:!0,targetResourceId:a.resourceId,targetStartIdx:i}}onBlockPointerUp(e){const t=this.drag;if(this.endDrag(),!t)return;if(!t.moved){this.selectActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.selectActionId,parameters:{_blockId:e.id}},bubbles:!0,composed:!0}));return}if(!this.moveActionId||t.targetResourceId===t.originResourceId&&t.targetStartIdx===t.originStartIdx)return;const a=this.window();if(!a)return;const r=A.addDays(a.from,t.targetStartIdx),i=A.addDays(r,t.duration-1);this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.moveActionId,parameters:{_blockId:t.blockId,_resourceId:t.targetResourceId,_start:A.iso(r),_end:A.iso(i)}},bubbles:!0,composed:!0}))}endDrag(){this.drag=null,window.removeEventListener("keydown",this.onDragKeydown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onDragKeydown)}render(){const e=this.window();if(!e||!this.resources.length)return o``;const t=[...Array(e.days).keys()].map(d=>A.addDays(e.from,d)),a=new Date,r=A.daysBetween(e.from,new Date(a.getFullYear(),a.getMonth(),a.getDate())),i=r>=0&&r<e.days,s=[];let n;return this.resources.forEach(d=>{d.group&&d.group!==n&&s.push(o`<div class="group">${d.group}</div>`),n=d.group,s.push(this.renderRow(d,e,t,i?r:null))}),o`
        ...
        `}isWeekend(e){return e.getDay()===0||e.getDay()===6}renderRow(e,t,a,r){const i=100/t.days,s=this.blocks.filter(d=>d.resourceId===e.id&&d.start&&d.end),n=this.drag?.moved&&this.drag.targetResourceId===e.id?this.drag:null;return o`
            ...
            <div class="lane" data-resource-id="${e.id}">
                ...
                ${s.map(d=>{const c=A.daysBetween(t.from,A.parse(d.start)),u=A.daysBetween(t.from,A.parse(d.end));if(u<0||c>=t.days)return l;const m=Math.max(0,c),v=Math.min(t.days-1,u),f=this.drag?.moved&&this.drag.blockId===d.id;return o`
    ...
    `;St([p({type:Array})],A.prototype,"resources",2);St([p({type:Array})],A.prototype,"blocks",2);St([p()],A.prototype,"from",2);St([p()],A.prototype,"to",2);St([p()],A.prototype,"moveActionId",2);St([p()],A.prototype,"selectActionId",2);St([b()],A.prototype,"drag",2);A=St([k("mateu-planning-board")],A);const El=e=>{const t=e.metadata;return o`
        <mateu-planning-board
                ...
                slot="${e.slot??l}"
        ></mateu-planning-board>
    `};var Pl=Object.defineProperty,Tl=Object.getOwnPropertyDescriptor,ss=(e,t,a,r)=>{for(var i=r>1?void 0:r?Tl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Pl(t,a,i),i};let Xa=class extends C{constructor(){super(...arguments),this.columns=[]}clickCard(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedCard:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="board">
    ...
    `;ss([p({type:Array})],Xa.prototype,"columns",2);Xa=ss([k("mateu-kanban")],Xa);const zl=e=>{const t=e.metadata;return o`
        <mateu-kanban
                .columns="${t.columns??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-kanban>
    `};var Ol=Object.defineProperty,Rl=Object.getOwnPropertyDescriptor,os=(e,t,a,r)=>{for(var i=r>1?void 0:r?Rl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Ol(t,a,i),i};let Qa=class extends C{constructor(){super(...arguments),this.items=[]}clickItem(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedItem:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="feed">
                ${this.items.map(e=>o`
    ...
    `;os([p({type:Array})],Qa.prototype,"items",2);Qa=os([k("mateu-timeline")],Qa);const Ll=e=>{const t=e.metadata;return o`
        <mateu-timeline
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-timeline>
    `};var Al=Object.defineProperty,Dl=Object.getOwnPropertyDescriptor,Yr=(e,t,a,r)=>{for(var i=r>1?void 0:r?Dl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Al(t,a,i),i};let Ta=class extends C{constructor(){super(...arguments),this.steps=[],this.vertical=!1}render(){return o`
            <div class="steps">
    ...
    `;Yr([p({type:Array})],Ta.prototype,"steps",2);Yr([p({type:Boolean,reflect:!0})],Ta.prototype,"vertical",2);Ta=Yr([k("mateu-progress-steps")],Ta);const Fl=e=>{const t=e.metadata;return o`
        <mateu-progress-steps
                ...
                slot="${e.slot??l}"
        ></mateu-progress-steps>
    `};var ql=Object.defineProperty,Ml=Object.getOwnPropertyDescriptor,Et=(e,t,a,r)=>{for(var i=r>1?void 0:r?Ml(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&ql(t,a,i),i};let Ge=class extends C{constructor(){super(...arguments),this.spark=[]}sparkline(){const e=this.spark;if(!e||e.length<2)return l;const t=84,a=30,r=2,i=Math.min(...e),n=Math.max(...e)-i||1,d=(t-r*2)/(e.length-1),c=e.map((f,w)=>{const x=r+w*d,y=r+(a-r*2)*(1-(f-i)/n);return[x,y]}),u=c.map(([f,w],x)=>`${x===0?"M":"L"}${f.toFixed(1)} ${w.toFixed(1)}`).join(" "),m=`${u} L${c[c.length-1][0].toFixed(1)} ${a} L${c[0][0].toFixed(1)} ${a} Z`,v=this.trend==="down"?"var(--lumo-error-color, #e11d48)":this.trend==="flat"?"var(--lumo-secondary-text-color, #888)":"var(--lumo-success-color, #12b76a)";return X`
    ...
    `;Et([p()],Ge.prototype,"label",2);Et([p()],Ge.prototype,"value",2);Et([p()],Ge.prototype,"unit",2);Et([p()],Ge.prototype,"delta",2);Et([p()],Ge.prototype,"trend",2);Et([p({type:Array})],Ge.prototype,"spark",2);Et([p()],Ge.prototype,"actionId",2);Ge=Et([k("mateu-stat")],Ge);const Nl=e=>{const t=e.metadata;return o`
        <mateu-stat
                label="${t.label??l}"
                value="${t.value??l}"
                unit="${t.unit??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-stat>
    `};var Ul=Object.defineProperty,jl=Object.getOwnPropertyDescriptor,Jr=(e,t,a,r)=>{for(var i=r>1?void 0:r?jl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Ul(t,a,i),i};let za=class extends C{constructor(){super(...arguments),this.events=[]}clickEvent(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedEvent:e}},bubbles:!0,composed:!0}))}render(){const e=this.month?new Date(this.month+"T00:00:00"):new Date,t=e.getFullYear(),a=e.getMonth(),r=new Date(t,a,1),i=(r.getDay()+6)%7,s=new Date(t,a+1,0).getDate(),n=new Date,d=f=>n.getFullYear()===t&&n.getMonth()===a&&n.getDate()===f,c={};for(const f of this.events){if(!f.date)continue;const w=new Date(f.date+"T00:00:00");w.getFullYear()===t&&w.getMonth()===a&&(c[w.getDate()]??=[]).push(f)}const u=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],m=[];for(let f=0;f<i;f++)m.push(o`<div class="cell blank"></div>`);for(let f=1;f<=s;f++)m.push(o`
    ...
    `;Jr([p()],za.prototype,"month",2);Jr([p({type:Array})],za.prototype,"events",2);za=Jr([k("mateu-calendar")],za);const Bl=e=>{const t=e.metadata;return o`
        <mateu-calendar
                month="${t.month??l}"
                .events="${t.events??[]}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-calendar>
    `};var Vl=Object.defineProperty,Hl=Object.getOwnPropertyDescriptor,ns=(e,t,a,r)=>{for(var i=r>1?void 0:r?Hl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Vl(t,a,i),i};let Za=class extends C{constructor(){super(...arguments),this.plans=[]}cta(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){return o`
            <div class="plans">
                ${this.plans.map(e=>o`
    ...
    `;ns([p({type:Array})],Za.prototype,"plans",2);Za=ns([k("mateu-pricing-table")],Za);const Wl=e=>{const t=e.metadata;return o`
        <mateu-pricing-table
                .plans="${t.plans??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-pricing-table>
    `};var Gl=Object.defineProperty,Kl=Object.getOwnPropertyDescriptor,ls=(e,t,a,r)=>{for(var i=r>1?void 0:r?Kl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Gl(t,a,i),i};let er=class extends C{clickNode(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedNode:e}},bubbles:!0,composed:!0}))}renderNode(e){const t=e.avatar,a=t&&(t.startsWith("http")||t.startsWith("data:"));return o`
            <li>
        ...
        `}render(){return this.root?o`<div class="tree"><ul>${this.renderNode(this.root)}</ul></div>`:o``}};er.styles=$`
        :host {
            display: block;
            width: 100%;
            overflow-x: auto;
    ...
    `;ls([p({attribute:!1})],er.prototype,"root",2);er=ls([k("mateu-org-chart")],er);const Yl=e=>{const t=e.metadata;return o`
        <mateu-org-chart
                .root="${t.root}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-org-chart>
    `};var Jl=Object.defineProperty,Xl=Object.getOwnPropertyDescriptor,ds=(e,t,a,r)=>{for(var i=r>1?void 0:r?Xl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Jl(t,a,i),i};const Ql=1440*60*1e3;let tr=class extends C{constructor(){super(...arguments),this.cells=[]}color(e,t){if(e<=0||t<=0)return"var(--lumo-contrast-10pct, #ebedf0)";const a=e/t,r=a>.75?1:a>.5?.75:a>.25?.5:.3;return`color-mix(in srgb, var(--lumo-primary-color, #1a73e8) ${Math.round(r*100)}%, transparent)`}render(){const e=this.cells.filter(c=>!!c.date);if(!e.length)return o``;const t=e.map(c=>new Date(c.date+"T00:00:00").getTime()),a=Math.min(...t),r=Math.max(...t),i=new Date(a);i.setDate(i.getDate()-(i.getDay()+6)%7);const s={};for(const c of e)s[c.date]=c;const n=Math.max(...e.map(c=>c.value??0),1),d=[];for(let c=i.getTime();c<=r;c+=Ql){const u=new Date(c),m=u.toISOString().slice(0,10),v=s[m],f=v?.value??0,w=(u.getDay()+6)%7+1,x=v?.label??`${m}: ${f}`;d.push(o`
    ...
    `;ds([p({type:Array})],tr.prototype,"cells",2);tr=ds([k("mateu-heatmap")],tr);const Zl=e=>{const t=e.metadata;return o`
        <mateu-heatmap
                .cells="${t.cells??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-heatmap>
    `};var ed=Object.defineProperty,td=Object.getOwnPropertyDescriptor,cs=(e,t,a,r)=>{for(var i=r>1?void 0:r?td(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&ed(t,a,i),i};let ar=class extends C{constructor(){super(...arguments),this.stages=[]}render(){const e=this.stages;if(!e.length)return o``;const t=e[0].value??0,a=Math.max(...e.map(r=>r.value??0),1);return o`
            <div class="funnel">
    ...
    `;cs([p({type:Array})],ar.prototype,"stages",2);ar=cs([k("mateu-funnel")],ar);const ad=e=>{const t=e.metadata;return o`
        <mateu-funnel
                .stages="${t.stages??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;va([p()],yt.prototype,"heading",2);va([p({type:Array})],yt.prototype,"values",2);va([p({type:Array})],yt.prototype,"labels",2);va([p()],yt.prototype,"color",2);va([p({type:Boolean})],yt.prototype,"area",2);yt=va([k("mateu-trend-chart")],yt);const sd=e=>{const t=e.metadata;return o`
        <mateu-trend-chart
                heading="${t.title??l}"
                color="${t.color??l}"
                ?area="${t.area??!1}"
    ...
    `;Xr([p({type:Array})],Oa.prototype,"features",2);Xr([p({type:Number})],Oa.prototype,"columns",2);Oa=Xr([k("mateu-feature-grid")],Oa);const ld=e=>{const t=e.metadata;return o`
        <mateu-feature-grid
                .features="${t.features??[]}"
                .columns="${t.columns??0}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-feature-grid>
    `};var dd=Object.defineProperty,cd=Object.getOwnPropertyDescriptor,us=(e,t,a,r)=>{for(var i=r>1?void 0:r?cd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&dd(t,a,i),i};let rr=class extends C{constructor(){super(...arguments),this.items=[]}stars(e){const t=Math.max(0,Math.min(5,e||0));return"★".repeat(t)+"☆".repeat(5-t)}render(){return o`
            <div class="grid">
    ...
    `;us([p({type:Array})],rr.prototype,"items",2);rr=us([k("mateu-testimonials")],rr);const ud=e=>{const t=e.metadata;return o`
        <mateu-testimonials
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-testimonials>
    `};var pd=Object.defineProperty,hd=Object.getOwnPropertyDescriptor,Qr=(e,t,a,r)=>{for(var i=r>1?void 0:r?hd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&pd(t,a,i),i};let Ra=class extends C{constructor(){super(...arguments),this.items=[],this.openSet=new Set,this.seeded=!1}seed(){this.seeded||(this.seeded=!0,this.items.forEach((e,t)=>{e.open&&this.openSet.add(t)}))}toggle(e){this.openSet.has(e)?this.openSet.delete(e):this.openSet.add(e),this.requestUpdate()}render(){return this.seed(),o`
            <div class="list">
    ...
    `;Qr([p({type:Array})],Ra.prototype,"items",2);Qr([b()],Ra.prototype,"openSet",2);Ra=Qr([k("mateu-faq")],Ra);const md=e=>{const t=e.metadata;return o`
        <mateu-faq
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;ta([p()],lt.prototype,"heading",2);ta([p()],lt.prototype,"description",2);ta([p()],lt.prototype,"icon",2);ta([p()],lt.prototype,"ctaLabel",2);ta([p()],lt.prototype,"actionId",2);ta([p()],lt.prototype,"theme",2);lt=ta([k("mateu-callout-card")],lt);const bd=e=>{const t=e.metadata;return o`
        <mateu-callout-card
                heading="${t.title??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-callout-card>
    `};var gd=Object.defineProperty,yd=Object.getOwnPropertyDescriptor,ps=(e,t,a,r)=>{for(var i=r>1?void 0:r?yd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&gd(t,a,i),i};let ir=class extends C{constructor(){super(...arguments),this.comments=[]}renderComment(e){const t=e.avatar&&(e.avatar.startsWith("http")||e.avatar.startsWith("data:"));return o`
            <div class="comment">
        ...
        `}render(){return o`<div class="thread">${this.comments.map(e=>this.renderComment(e))}</div>`}};ir.styles=$`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
    ...
    `;ps([p({type:Array})],ir.prototype,"comments",2);ir=ps([k("mateu-comment-thread")],ir);const $d=e=>{const t=e.metadata;return o`
        <mateu-comment-thread
                ...
                slot="${e.slot??l}"
        ></mateu-comment-thread>
    `};var xd=Object.defineProperty,wd=Object.getOwnPropertyDescriptor,hs=(e,t,a,r)=>{for(var i=r>1?void 0:r?wd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&xd(t,a,i),i};const kd={pdf:"📕",image:"🖼️",img:"🖼️",doc:"📘",docx:"📘",word:"📘",xls:"📗",xlsx:"📗",excel:"📗",sheet:"📗",zip:"🗜️",archive:"🗜️",video:"🎬",audio:"🎵",code:"💻",csv:"📄",txt:"📄"};let sr=class extends C{constructor(){super(...arguments),this.files=[]}icon(e){return e&&kd[e.toLowerCase()]||"📄"}clickFile(e,t){e.url||e.actionId&&(t.preventDefault(),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_file:e}},bubbles:!0,composed:!0})))}render(){return o`
            <div class="list">
    ...
    `;hs([p({type:Array})],sr.prototype,"files",2);sr=hs([k("mateu-file-list")],sr);const Cd=e=>{const t=e.metadata;return o`
        <mateu-file-list
                .files="${t.files??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-file-list>
    `};var _d=Object.defineProperty,Id=Object.getOwnPropertyDescriptor,br=(e,t,a,r)=>{for(var i=r>1?void 0:r?Id(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&_d(t,a,i),i};let da=class extends C{constructor(){super(...arguments),this.items=[],this.localDone=new Map}isDone(e,t){return this.localDone.has(t)?!!this.localDone.get(t):!!e.done}toggle(e,t){const a=!this.isDone(e,t);this.localDone.set(t,a),this.requestUpdate(),e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_item:e,_done:a}},bubbles:!0,composed:!0}))}render(){const e=this.items.length,t=this.items.filter((r,i)=>this.isDone(r,i)).length,a=e>0?Math.round(t/e*100):0;return o`
            <div class="head">
    ...
    `;br([p()],da.prototype,"heading",2);br([p({type:Array})],da.prototype,"items",2);br([b()],da.prototype,"localDone",2);da=br([k("mateu-checklist")],da);const Sd=e=>{const t=e.metadata;return o`
        <mateu-checklist
                heading="${t.title??l}"
                .items="${t.items??[]}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-checklist>
    `};var Ed=Object.defineProperty,Pd=Object.getOwnPropertyDescriptor,Pt=(e,t,a,r)=>{for(var i=r>1?void 0:r?Pd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Ed(t,a,i),i};let Ke=class extends C{render(){const e=this.trend??"flat";return o`
            <div class="card">
                ${this.heading?o`<div class="title">${this.heading}</div>`:l}
                <div class="row">
                    <div class="side">
        ...
        @media (prefers-color-scheme: dark) { .card { background: var(--lumo-contrast-5pct, #2a2a2a); } }
    `;Pt([p()],Ke.prototype,"heading",2);Pt([p()],Ke.prototype,"leftLabel",2);Pt([p()],Ke.prototype,"leftValue",2);Pt([p()],Ke.prototype,"rightLabel",2);Pt([p()],Ke.prototype,"rightValue",2);Pt([p()],Ke.prototype,"delta",2);Pt([p()],Ke.prototype,"trend",2);Ke=Pt([k("mateu-comparison-card")],Ke);const Td=e=>{const t=e.metadata;return o`
...
`,zd=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}),Mr=e=>zd.format(e),or=(e,t)=>{const a=e<0?"-":"",r=Mr(Math.abs(e));return t?`${a}${t} ${r}`:`${a}${r}`},Od=(e,t)=>t?`${Mr(e)} ${t}`:Mr(e);var Rd=Object.defineProperty,Ld=Object.getOwnPropertyDescriptor,Tt=(e,t,a,r)=>{for(var i=r>1?void 0:r?Ld(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Rd(t,a,i),i};let Ye=class extends C{constructor(){super(...arguments),this.title="",this.badges=[],this.facts=[]}render(){const e=!!(this.metricLabel||this.metricValue||this.metricCaption);return o`
            <div class="card">
                <div class="main">
                    <div class="title-row">
    ...
    `];Tt([p()],Ye.prototype,"title",2);Tt([p({type:Array})],Ye.prototype,"badges",2);Tt([p()],Ye.prototype,"subtitle",2);Tt([p({type:Array})],Ye.prototype,"facts",2);Tt([p()],Ye.prototype,"metricLabel",2);Tt([p()],Ye.prototype,"metricValue",2);Tt([p()],Ye.prototype,"metricCaption",2);Ye=Tt([k("mateu-entity-header")],Ye);const Ad=e=>{const t=e.metadata;return o`
        <mateu-entity-header
                .title="${t.title??""}"
                .badges="${t.badges??[]}"
                .subtitle="${t.subtitle}"
                ...
                slot="${e.slot??l}"
        ></mateu-entity-header>
    `};var Dd=Object.defineProperty,Fd=Object.getOwnPropertyDescriptor,zt=(e,t,a,r)=>{for(var i=r>1?void 0:r?Fd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Dd(t,a,i),i};let Je=class extends C{constructor(){super(...arguments),this.value=0,this.max=0}fillColor(){return this.dangerAt!=null&&this.value>=this.dangerAt?"error":this.warnAt!=null&&this.value>=this.warnAt?"warning":this.warnAt!=null||this.dangerAt!=null?"success":"primary"}render(){const e=this.max>0?Math.min(Math.max(this.value/this.max,0),1):0,t=Math.round(e*100);return o`
            <div class="meter">
                ${this.label?o`<span class="label">${this.label}</span>`:l}
    ...
    `;zt([p()],Je.prototype,"label",2);zt([p({type:Number})],Je.prototype,"value",2);zt([p({type:Number})],Je.prototype,"max",2);zt([p()],Je.prototype,"unit",2);zt([p()],Je.prototype,"caption",2);zt([p({type:Number})],Je.prototype,"warnAt",2);zt([p({type:Number})],Je.prototype,"dangerAt",2);Je=zt([k("mateu-meter")],Je);const qd=e=>{const t=e.metadata;return o`
        <mateu-meter
                .label="${t.label}"
                .value="${t.value??0}"
                .max="${t.max??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-meter>
    `};var Md=Object.defineProperty,Nd=Object.getOwnPropertyDescriptor,fa=(e,t,a,r)=>{for(var i=r>1?void 0:r?Nd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Md(t,a,i),i};let $t=class extends C{constructor(){super(...arguments),this.total=0,this.done=0}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){const e=this.total>0&&this.done>=this.total,t=!e&&!!this.actionLabel&&!!this.actionId;return o`
    ...
    `;fa([p()],$t.prototype,"label",2);fa([p({type:Number})],$t.prototype,"total",2);fa([p({type:Number})],$t.prototype,"done",2);fa([p()],$t.prototype,"actionLabel",2);fa([p()],$t.prototype,"actionId",2);$t=fa([k("mateu-task-progress")],$t);const Ud=e=>{const t=e.metadata;return o`
        <mateu-task-progress
                .label="${t.label}"
                .total="${t.total??0}"
                .done="${t.done??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-task-progress>
    `};var jd=Object.defineProperty,Bd=Object.getOwnPropertyDescriptor,qa=(e,t,a,r)=>{for(var i=r>1?void 0:r?Bd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&jd(t,a,i),i};let Vt=class extends C{constructor(){super(...arguments),this.items=[],this.compact=!1,this.frameless=!1}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}rowClicked(e){this.rowActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.rowActionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}render(){return o`
    ...
    `];qa([p({type:Array})],Vt.prototype,"items",2);qa([p({type:Boolean})],Vt.prototype,"compact",2);qa([p({type:Boolean})],Vt.prototype,"frameless",2);qa([p()],Vt.prototype,"rowActionId",2);Vt=qa([k("mateu-status-list")],Vt);const Vd=e=>{const t=e.metadata;return o`
        <mateu-status-list
                .items="${t.items??[]}"
                ?compact="${t.compact??!1}"
                ...
                slot="${e.slot??l}"
        ></mateu-status-list>
    `};var Hd=Object.defineProperty,Wd=Object.getOwnPropertyDescriptor,ms=(e,t,a,r)=>{for(var i=r>1?void 0:r?Wd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Hd(t,a,i),i};let nr=class extends C{constructor(){super(...arguments),this.items=[]}render(){return o`
            <ul>
    ...
    `;ms([p({type:Array})],nr.prototype,"items",2);nr=ms([k("mateu-bulleted-list")],nr);const Gd=e=>{const t=e.metadata;return o`
        <mateu-bulleted-list
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-bulleted-list>
    `},Kd=e=>{const a=e.metadata.attributes?.["data-colspan"];return o`
    ...
    `};var Zd=Object.defineProperty,ec=Object.getOwnPropertyDescriptor,yr=(e,t,a,r)=>{for(var i=r>1?void 0:r?ec(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Zd(t,a,i),i};let ca=class extends C{constructor(){super(...arguments),this.groups=[]}willUpdate(e){e.has("groups")&&(this.selectedId=this.groups.flatMap(t=>t.items??[]).find(t=>t.selected)?.id)}select(e){this.selectedId=e,this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{_item:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="rail">
                ${this.groups.map(e=>o`
                    <div class="group">
    ...
    `];yr([p()],ca.prototype,"actionId",2);yr([p({type:Array})],ca.prototype,"groups",2);yr([b()],ca.prototype,"selectedId",2);ca=yr([k("mateu-task-queue")],ca);const tc=e=>{const t=e.metadata;return o`
        <mateu-task-queue
                .actionId="${t.actionId}"
                .groups="${t.groups??[]}"
                style="${e.style??l}"
    ...
    `];ba([p()],xt.prototype,"actionId",2);ba([p({type:Number})],xt.prototype,"columns",2);ba([p()],xt.prototype,"recommendedLabel",2);ba([p({type:Array})],xt.prototype,"items",2);ba([b()],xt.prototype,"selectedId",2);xt=ba([k("mateu-resource-grid")],xt);const ic=e=>{const t=e.metadata;return o`
        <mateu-resource-grid
                .actionId="${t.actionId}"
                .columns="${t.columns??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-resource-grid>
    `};var sc=Object.defineProperty,oc=Object.getOwnPropertyDescriptor,fe=(e,t,a,r)=>{for(var i=r>1?void 0:r?oc(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&sc(t,a,i),i};let Q=class extends C{constructor(){super(...arguments),this.title="",this.features=[],this.current=!1,this.added=!1}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return o`
                ...
                ${this.items.map(e=>{const t=e.id!=null&&this.added.has(e.id);return o`
                        <div class="card ${t?"added":""}">
                            ...
                            ${e.includedLabel?o`<span class="included">${e.includedLabel}</span>`:o`
                                    ${e.price!=null?o`
                                        <span class="price">${or(e.price,this.currency)}${e.unit?` / ${e.unit}`:""}</span>
                                    `:l}
    ...
    `;ga([p()],wt.prototype,"totalLabel",2);ga([p()],wt.prototype,"currency",2);ga([p()],wt.prototype,"actionId",2);ga([p({type:Array})],wt.prototype,"items",2);ga([b()],wt.prototype,"added",2);wt=ga([k("mateu-addon-picker")],wt);const cc=e=>{const t=e.metadata;return o`
        <mateu-addon-picker
                ...
                slot="${e.slot??l}"
        ></mateu-addon-picker>
    `};var uc=Object.defineProperty,pc=Object.getOwnPropertyDescriptor,Ma=(e,t,a,r)=>{for(var i=r>1?void 0:r?pc(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&uc(t,a,i),i};let Ht=class extends C{constructor(){super(...arguments),this.lines=[]}computedTotal(){return this.total!=null?this.total:this.lines.filter(e=>!e.included).reduce((e,t)=>e+(t.amount??0),0)}render(){return o`
            ${this.lines.map(e=>o`
                <div class="row">
                    <span class="dot"></span>
                    <span class="concept">${e.concept}</span>
                    ${e.included?o`<span class="included-label">${e.includedLabel||"Included"}</span>`:o`<span class="amount ${(e.amount??0)<0?"negative":""}">${or(e.amount??0,this.currency)}</span>`}
                </div>
            `)}
            <div class="total-row">
                <span class="total-label">${this.totalLabel||"Total"}</span>
                <span class="total">${or(this.computedTotal(),this.currency)}</span>
            </div>
        `}};Ht.styles=$`
        :host {
    ...
    `;Ma([p()],Ht.prototype,"currency",2);Ma([p()],Ht.prototype,"totalLabel",2);Ma([p({type:Array})],Ht.prototype,"lines",2);Ma([p({type:Number})],Ht.prototype,"total",2);Ht=Ma([k("mateu-ledger")],Ht);const hc=e=>{const t=e.metadata;return o`
        <mateu-ledger
                .currency="${t.currency}"
                .totalLabel="${t.totalLabel}"
                .lines="${t.lines??[]}"
    ...
    `;ut([p()],Ae.prototype,"actionId",2);ut([p()],Ae.prototype,"methodActionId",2);ut([p({type:Array})],Ae.prototype,"methods",2);ut([p()],Ae.prototype,"selected",2);ut([p()],Ae.prototype,"contextLabel",2);ut([p()],Ae.prototype,"contextValue",2);ut([p()],Ae.prototype,"confirmLabel",2);ut([b()],Ae.prototype,"selectedId",2);Ae=ut([k("mateu-payment-picker")],Ae);const fc=e=>{const t=e.metadata;return o`
        <mateu-payment-picker
                ...
                slot="${e.slot??l}"
        ></mateu-payment-picker>
    `};var bc=Object.defineProperty,gc=Object.getOwnPropertyDescriptor,vs=(e,t,a,r)=>{for(var i=r>1?void 0:r?gc(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&bc(t,a,i),i};let lr=class extends C{constructor(){super(...arguments),this.items=[]}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="list">
                ${this.items.map(e=>o`
                    <div class="row">
    ...
    `;vs([p({type:Array})],lr.prototype,"items",2);lr=vs([k("mateu-process-monitor")],lr);const yc=e=>{const t=e.metadata;return o`
        <mateu-process-monitor
                ...
                slot="${e.slot??l}"
        ></mateu-process-monitor>
    `},$c=(e,t)=>{let a=e.style;return e.id&&(a&&!a.endsWith(";")&&(a+=";"),a==null&&(a=""),t[e.id+".hidden"]==!0&&(a+="display: none;")),a},xc=(e,t)=>{let a={...e.metadata};if(e.id&&a){if(a.type==h.Button){const r=a;t[e.id+".disabled"]==!0&&(r.disabled=!0)}if(a.type==h.FormField){const r=a;t[e.id+".disabled"]==!0&&(r.disabled=!0)}}return a},z=e=>t=>e(t.container,t.component,t.baseUrl,t.state,t.data,t.appState,t.appData),wc={[h.Bpmn]:({component:e})=>ll(e),[h.Workflow]:({component:e})=>cl(e),[h.FormEditor]:({component:e})=>ul(e),[h.Page]:z(Fr),[h.Div]:z(rl),[h.Directory]:({component:e,baseUrl:t,state:a,data:r})=>al(e),[h.FormLayout]:z(an),[h.HorizontalLayout]:z(nn),[h.VerticalLayout]:z(ln),[h.SplitLayout]:z(dn),[h.MasterDetailLayout]:z(cn),[h.TabLayout]:z(un),[h.AccordionLayout]:z(pn),[h.BoardLayout]:z(bn),[h.BoardLayoutRow]:z(gn),[h.BoardLayoutItem]:z(yn),[h.Scroller]:z(mn),[h.FullWidth]:z(vn),[h.Container]:z(fn),[h.Form]:({container:e,component:t,baseUrl:a,state:r,data:i,appState:s,appData:n})=>{const d=t.metadata;return o`<mateu-form
            id="${t.id}"
        baseUrl="${a}"
            .component="${t}"
            .values="${r}"
...
`)}
            ...
            </mateu-form>`},[h.Table]:({component:e,state:t,data:a})=>Dr(e,(e.id?a?.[e.id]:void 0)?.page?.content??di(e,t)),[h.Crud]:z(qr),[h.App]:({container:e,component:t,baseUrl:a,state:r,data:i,appState:s,appData:n})=>o`
            <mateu-app
                        id="${t.id}"
                        baseUrl="${a}"
                        .component="${t}"
            ...
            >
             ${t.children?.map(d=>g(e,d,a,r,i,s,n))}
         </mateu-app>`,[h.Element]:({container:e,component:t})=>Tn(e,t.metadata,t),[h.FormField]:({component:e,state:t})=>nl(e,t),[h.Text]:({component:e,state:t,data:a,appState:r,appData:i})=>zn(e,t,a,r,i),[h.Avatar]:({component:e,state:t,data:a})=>Po(e,t,a),[h.Chat]:({component:e,state:t,data:a})=>dl(e),[h.AvatarGroup]:({component:e})=>To(e),[h.Badge]:({component:e,state:t,data:a})=>zo(e,t,a),[h.Breadcrumbs]:({component:e})=>el(e),[h.Anchor]:({component:e})=>On(e),[h.Button]:({component:e,state:t,data:a})=>Dn(e,t,a),[h.Card]:z(qn),[h.Chart]:({component:e})=>Mn(e),[h.Icon]:({component:e})=>Nn(e),[h.ConfirmDialog]:z(jn),[h.ContextMenu]:z(Cn),[h.CookieConsent]:({component:e})=>Bn(e),[h.Details]:z(Vn),[h.Dialog]:({component:e,baseUrl:t,state:a,data:r,appState:i,appData:s})=>Hn(e,t,a,r,i,s),[h.Drawer]:({component:e,baseUrl:t,state:a,data:r,appState:i,appData:s})=>Wn(e,t,a,r,i,s),[h.Image]:({component:e})=>Zn(e),[h.Map]:({component:e})=>Qn(e),[h.Markdown]:({component:e})=>Kn(e),[h.MicroFrontend]:({component:e})=>Gn(e),[h.Notification]:({component:e})=>Yn(e),[h.ProgressBar]:({component:e,state:t})=>Jn(e,t),[h.Popover]:z(Xn),[h.CarouselLayout]:z(tl),[h.Tooltip]:z(Sn),[h.MessageInput]:({component:e})=>In(e),[h.MessageList]:({component:e})=>wn(e),[h.CustomField]:z(_n),[h.MenuBar]:({container:e,component:t,baseUrl:a,state:r,data:i})=>kn(e,t,a,r,i),[h.Grid]:({component:e,state:t})=>Dr(e,di(e,t)),[h.VirtualList]:z($n),[h.FormSection]:z(il),[h.FormSubSection]:z(sl),[h.MetricCard]:({component:e})=>vl(e),[h.Scoreboard]:z(fl),[h.DashboardPanel]:z(bl),[h.DashboardLayout]:z(gl),[h.FoldoutLayout]:z(xl),[h.HeroSection]:z(wl),[h.EmptyState]:({component:e})=>jo(e),[h.Skeleton]:({component:e})=>Bo(e),[h.Gantt]:({component:e})=>_l(e),[h.PlanningBoard]:({component:e})=>El(e),[h.Kanban]:({component:e})=>zl(e),[h.Timeline]:({component:e})=>Ll(e),[h.ProgressSteps]:({component:e})=>Fl(e),[h.Stat]:({component:e})=>Nl(e),[h.Calendar]:({component:e})=>Bl(e),[h.PricingTable]:({component:e})=>Wl(e),[h.OrgChart]:({component:e})=>Yl(e),[h.Heatmap]:({component:e})=>Zl(e),[h.Funnel]:({component:e})=>ad(e),[h.TrendChart]:({component:e})=>sd(e),[h.FeatureGrid]:({component:e})=>ld(e),[h.Testimonials]:({component:e})=>ud(e),[h.Faq]:({component:e})=>md(e),[h.CalloutCard]:({component:e})=>bd(e),[h.CommentThread]:({component:e})=>$d(e),[h.FileList]:({component:e})=>Cd(e),[h.Checklist]:({component:e})=>Sd(e),[h.ComparisonCard]:({component:e})=>Td(e),[h.EntityHeader]:({component:e})=>Ad(e),[h.Meter]:({component:e})=>qd(e),[h.TaskProgress]:({component:e})=>Ud(e),[h.StatusList]:({component:e})=>Vd(e),[h.BulletedList]:({component:e})=>Gd(e),[h.Separator]:({component:e})=>Kd(e),[h.Notice]:z(Qd),[h.TaskQueue]:({component:e})=>tc(e),[h.ResourceGrid]:({component:e})=>ic(e),[h.OfferCard]:({component:e})=>nc(e),[h.AddOnPicker]:({component:e})=>cc(e),[h.Ledger]:({component:e})=>hc(e),[h.PaymentPicker]:({component:e})=>fc(e),[h.ProcessMonitor]:({component:e})=>yc(e)},Zr=(e,t,a,r,i,s,n,d)=>{if(!t?.metadata)return t==null?(console.warn("No metadata for component",t),o`<p>No metadata for component</p>`):Zr(e,{id:xe(),metadata:t,type:W.ClientSide},a,r,i,s,n,d);const c=t.metadata.type,u={...t,style:$c(t,i),metadata:xc(t,i)},m=wc[c];return m?m({container:e,component:u,baseUrl:a,state:r,data:i,appState:s,appData:n,labelAlreadyRendered:d}):o`<p ${u?.slot??l}>Unknown metadata type ${c} for component ${u?.id}</p>`};var Ca=(e=>(e.NONE="NONE",e.INFO="INFO",e.SUCCESS="SUCCESS",e.WARNING="WARNING",e.DANGER="DANGER",e))(Ca||{});const kc=(e,t,a)=>{const r=e[a.path];return r?o`<span theme="badge pill ${$r(r.type)}">${r.message}</span>`:o``},$r=e=>{switch(e){case Ca.SUCCESS:return"success";case Ca.WARNING:return"warning";case Ca.DANGER:return"error";case Ca.NONE:return"contrast"}return""};var Cc=Object.defineProperty,_c=Object.getOwnPropertyDescriptor,Pe=(e,t,a,r)=>{for(var i=r>1?void 0:r?_c(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Cc(t,a,i),i};let ne=class extends C{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.respondToVisibility=(e,t)=>{var a={root:document.documentElement},r=new IntersectionObserver(i=>{i.forEach(s=>{t(s.intersectionRatio>0)})},a);r.observe(e)},this.keepAsking=!1,this.askToUpper=()=>{const e=this.data[this.id]?.page,t=e?.content?.length/e?.pageSize;this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:{page:t,pageSize:this.metadata?.pageSize},callback:()=>{this.keepAsking&&this.askToUpper()}},bubbles:!0,composed:!0}))},this.renderItem=e=>e.card?Zr(this,e.card,this.baseUrl,this.state,this.data,this.appState,this.appData,!1):e.title?o`<div class="neutral-card">
                ${e.image?o`<img class="card-media" src="${e.image}" alt="" />`:l}
                <div class="card-body">
                    <div class="card-head">
                        ${e.title?o`<span class="card-title">${e.title}</span>`:l}
                        ${e.status?o`<span theme="badge ${$r(e.status.type)}">${e.status.message}</span>`:l}
                    </div>
    ...
    `;Pe([p()],ne.prototype,"id",2);Pe([p()],ne.prototype,"metadata",2);Pe([p()],ne.prototype,"baseUrl",2);Pe([p()],ne.prototype,"state",2);Pe([p()],ne.prototype,"data",2);Pe([p()],ne.prototype,"appState",2);Pe([p()],ne.prototype,"appData",2);Pe([p()],ne.prototype,"emptyStateMessage",2);Pe([b()],ne.prototype,"keepAsking",2);Pe([ee("#ask-for-more")],ne.prototype,"askForMore",2);Pe([b()],ne.prototype,"hasMore",2);ne=Pe([k("mateu-card-list")],ne);const Ic={show:e=>console.debug("[mateu] no notifier registered, dropping toast:",e.text)};let fs=Ic;function bs(e){fs=e}function Wt(e,t){fs.show(e,t)}var gs=(e=>(e.none="none",e.success="success",e.error="error",e.warning="warning",e.contrast="contrast",e.normal="normal",e))(gs||{}),ys=(e=>(e.primary="primary",e.secondary="secondary",e.tertiary="tertiary",e.tertiaryInline="tertiaryInline",e))(ys||{});const Sc=76;function pi(e){if(e.weight!=null)return e.weight;const t=e.stereotype??"";if(t==="icon")return 1;if(t==="image")return 4;if(t==="html"||t==="richText"||t==="markdown"||t==="textarea")return 5;if(t==="link")return 2.5;if(t==="combobox"||t==="select")return 2;const a=e.dataType??"";return a==="bool"?1:a==="status"||a==="integer"?1.5:a==="number"||a==="date"||a==="money"?2:a==="dateTime"||a==="dateRange"?2.5:3}function Ec(e,t){if(e.length===0)return"table";const a=e.reduce((c,u)=>c+pi(u),0),r=t/Sc,i=a/r;if(i<=1)return"table";if(i>1.6||e.length>10)return"masterDetail";const s=e.filter(c=>c.identifier||(c.priority??Number.MAX_SAFE_INTEGER)<=2),n=s.reduce((c,u)=>c+pi(u),0);return s.length>0&&n<=8?"list":e.some(c=>c.stereotype==="image"||c.stereotype==="html")||s.length===0&&e.length>=4&&e.length<=8?"cards":"masterDetail"}function $s(e){return e.filter(t=>t.identifier||(t.priority??Number.MAX_SAFE_INTEGER)<=2).sort((t,a)=>(t.priority??Number.MAX_SAFE_INTEGER)-(a.priority??Number.MAX_SAFE_INTEGER))}function Pc(e){const t=$s(e);return t.length>0?t:e.slice(0,3)}var Tc=Object.defineProperty,zc=Object.getOwnPropertyDescriptor,Te=(e,t,a,r)=>{for(var i=r>1?void 0:r?zc(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Tc(t,a,i),i};const Oc={asc:"ascending",desc:"descending"};let le=class extends C{constructor(){super(...arguments),this.component=void 0,this.standalone=!1,this.state={},this.data={},this.appState={},this.appData={},this.showImportDialog=!1,this.availableWidthPx=1024,this.selectedItem=null,this._columnPrefsRevision=0,this._prefsRevisionApplied=-1,this.search=()=>{const e=this.component.metadata;this.state={...this.state,size:e.pageSize,page:0,crud_selected_items:[]},this._syncStateToUrl(e),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}}},bubbles:!0,composed:!0}))},this.notify=e=>{Wt({text:e,position:"bottomEnd",variant:"error",duration:3e3},this)},this.handleSearchRequested=e=>{this.state={...this.state,crud_selected_items:[]};const t=this.component.metadata;this._syncStateToUrl(t),!t.infiniteScrolling&&this.data?.[this.id]?.page&&(this.data[this.id].page.content=[]),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}},callback:e},bubbles:!0,composed:!0}))},this.fetchMoreElements=e=>{const{params:t,callback:a}=e.detail;this.state={...this.state,size:t.pageSize,page:t.page},this.handleSearchRequested(a)},this.directionChanged=e=>{const t=e.detail.grid._sorters;this.state={...this.state,sort:t.map(a=>({fieldId:a.__data.path,direction:a.__data.direction?Oc[a.__data.direction]:void 0}))},this.handleSearchRequested(void 0)},this._initializedForComponentId=void 0,this.evalLabel=e=>$e(e,this.state,this.data),this.handleToolbarButtonClick=e=>{if(e==="import"){this.showImportDialog=!0;return}this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.handleImportUploadSuccess=e=>{const t=e.detail.xhr.responseText;this.showImportDialog=!1,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"process-import",parameters:{fileId:t}},bubbles:!0,composed:!0}))}}get columnPrefsScope(){return window.location.pathname}get effectiveComponent(){const e=this.component,t=e?.metadata;if(!e||!t?.columns)return e;if(this._prefsSource===e&&this._prefsRevisionApplied===this._columnPrefsRevision)return this._prefsApplied;const a=Gi(this.columnPrefsScope),r=Yi(t.columns,a,i=>i.metadata??{});return this._prefsApplied=r===t.columns?e:{...e,metadata:{...t,columns:r}},this._prefsSource=e,this._prefsRevisionApplied=this._columnPrefsRevision,this._prefsApplied}get columnChooserEntries(){return(this.component?.metadata?.columns??[]).map(t=>{const a=t.metadata??{},r=a.id??t.id;return r?{id:r,label:a.label??r,protected:Ki(a)}:void 0}).filter(t=>!!t)}renderColumnChooser(){const e=this.columnChooserEntries;return e.filter(t=>!t.protected).length===0?l:o`
            <mateu-column-chooser
                .columns="${e}"
                .scope="${this.columnPrefsScope}"
                @column-prefs-changed="${t=>{t.stopPropagation(),this._columnPrefsRevision++}}"
            ></mateu-column-chooser>
        `}get cols(){return this.effectiveComponent?.metadata?.columns?.map(t=>t.metadata)??[]}get identifierFieldName(){const e=this.cols.find(t=>t.identifier);return e?e.id:this.cols.find(t=>t.id==="id")?.id}get effectiveGridLayout(){const e=this.component?.metadata,t=e?.gridLayout??"auto";return t==="auto"?e?.crudlType==="card"?"cards":Ec(this.cols,this.availableWidthPx):t}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{const t=e[0]?.contentRect.width;t&&Math.abs(t-this.availableWidthPx)>10&&(this.availableWidthPx=t)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}_filterIds(e){return new Set(["searchText",...(e.filters??[]).flatMap(t=>t.stereotype==="dateRange"||t.stereotype==="numberRange"?[`${t.fieldId}_from`,`${t.fieldId}_to`]:[t.fieldId])])}_syncStateToUrl(e){const t=this._filterIds(e),a=new URLSearchParams(window.location.search);t.forEach(d=>a.delete(d)),a.delete("page"),a.delete("sort"),t.forEach(d=>{const c=this.state[d];c!=null&&c!==""&&a.set(d,String(c))});const r=this.state.page;r&&r>0&&a.set("page",String(r));const i=this.state.sort;if(i&&i.length>0){const d=i.filter(c=>c.fieldId&&c.direction).map(c=>`${c.fieldId}:${c.direction}`).join(",");d&&a.set("sort",d)}const s=a.toString(),n=s?`${window.location.pathname}?${s}`:window.location.pathname;window.location.pathname+window.location.search!==n&&history.replaceState(null,"",n)}_initStateFromUrl(e,t){const a=new URLSearchParams(window.location.search),r=this._filterIds(e),i={...t};a.forEach((d,c)=>{r.has(c)&&(i[c]=d)});const s=a.get("page");if(s!==null){const d=parseInt(s,10);!isNaN(d)&&d>0&&(i.page=d)}const n=a.get("sort");if(n){const d=n.split(",").map(c=>{const[u,m]=c.split(":");return u&&m?{fieldId:u,direction:m}:null}).filter(Boolean);d.length>0&&(i.sort=d)}return i}pageChanged(e){this.state={...this.state,page:e.detail.page},this.handleSearchRequested(void 0)}updated(e){if(super.updated(e),e.has("component")){const t=this.component?.id;if(t!==this._initializedForComponentId){this._initializedForComponentId=t;const a=this.component?.metadata,r=a.initialPage&&a.initialPage>0?a.initialPage:0;this.state=this._initStateFromUrl(a,{...this.state,size:a.pageSize,page:r,sort:[]}),(this.state.page!==r||this.state.sort?.length>0||[...this._filterIds(a)].some(s=>this.state[s]!=null))&&this.handleSearchRequested(void 0)}}}render(){const e=_=>{const R=[];return _.color&&_.color!==gs.normal&&R.push(_.color),_.buttonStyle&&R.push(_.buttonStyle===ys.tertiaryInline?"tertiary-inline":_.buttonStyle),R.length?R.join(" "):void 0},t=_=>_==="back"||_==="backToList"||!!_&&_.startsWith("cancel"),a=_=>{const R=N.get()?.renderToolbarButton?.(_,this.evalLabel(_.label),()=>this.handleToolbarButtonClick(_.actionId));return R||o`
                <button class="crud-btn"
                        data-action-id="${_.id}"
                        theme="${e(_)||l}"
                        @click="${()=>this.handleToolbarButtonClick(_.actionId)}"
                >${this.evalLabel(_.label)}</button>
            `};if(!this.component)return o`no component`;const r=this.effectiveComponent,i=r.metadata;i.serverSideOrdering=!0;const s=i?.toolbar??[],n=s.filter(_=>t(_.actionId)),d=s.filter(_=>!t(_.actionId)),c=n.length>0&&d.length>0,u=!!i?.title||!!i?.subtitle||s.length>0,m=this.effectiveGridLayout,v=this.cols,f=$s(v),x=this.data[this.id]?.page?.content??[],y=this.state[this.component?.id]?.emptyStateMessage,S=(_,R)=>{const P=R[_.id];if(P==null)return o``;if(_.dataType==="status"){const O=$r(P.type);return o`<span theme="badge pill ${O}">${P.message}</span>`}return _.dataType==="bool"?o`${P?"✓":"✗"}`:typeof P=="object"?o`${P.label??P.name??P.message??""}`:o`${P}`},H=()=>{const _=this.identifierFieldName,R=this.state._selectedId??this.appState?._splitDetailId,P=f.find(T=>T.identifier)??f[0],O=T=>T.dataType==="action"||T.dataType==="actionGroup"||T.dataType==="menu"||T.stereotype==="button",Me=f.filter(T=>T!==P&&!O(T)),ia=v.filter(T=>O(T)),mt=(T,L,M)=>{T.stopPropagation(),T.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:L,parameters:{_clickedRow:M}},bubbles:!0,composed:!0}))},At=T=>{const L=[];for(const M of ia){const U=T[M.id];if(M.dataType==="action"){const Ne=U?.methodNameInCrud?U:T.action?.methodNameInCrud?T.action:{methodNameInCrud:M.id,label:M.label,icon:null};L.push(o`
                            <button class="crud-btn" theme="tertiary small" title="${Ne.label||l}"
                                @click="${I=>mt(I,"action-on-row-"+Ne.methodNameInCrud,T)}">
                                ${Ne.icon?j(Ne.icon):l}
                                ${Ne.label??l}
                            </button>`)}else(M.dataType==="actionGroup"||M.dataType==="menu")&&(U?.actions??[]).forEach(I=>L.push(o`
                            <button class="crud-btn" theme="tertiary small" title="${I.label||l}"
                                @click="${re=>mt(re,"action-on-row-"+I.methodNameInCrud,T)}">
                                ${I.icon?j(I.icon):l}
                                ${I.label??l}
                            </button>`))}return L.length?o`
                ...
                <div class="m-listbox" style="width: 100%;">
                    ${x.length===0?o`<div class="m-item" disabled>${qt(y)}</div>`:l}
                    ${x.map(T=>o`
                        <div class="m-item"
                            ?selected="${_&&R!==void 0&&String(T[_])===String(R)}"
                        ...
                        >
                            ...
                            <div style="font-size: var(--lumo-font-size-s); color: var(--lumo-secondary-text-color); display: flex; flex-wrap: wrap; gap: var(--lumo-space-xs); align-items: center;">
                                ${Me.map(L=>o`<span>${L.label}: ${S(L,T)}</span>`)}
                            </div>
                            ${At(T)}
                        </div>
                    `)}
                </div>`},ue=(_,R,P)=>{const O=this.identifierFieldName;O&&P[O]!==void 0&&(this.state={...this.state,_selectedId:String(P[O])}),_.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:R,parameters:P},bubbles:!0,composed:!0}))},F=()=>{const _=this.identifierFieldName,R=this.state._selectedId??this.appState?._splitDetailId,P=v.slice(0,6),O=P.filter(I=>I.stereotype==="image"),Me=P.find(I=>I.identifier)??P[0],ia=I=>!!I.actionId,mt=I=>I.dataType==="action"||I.dataType==="actionGroup"||I.dataType==="menu"||I.stereotype==="button",At=P.find(I=>I.id==="select"&&I.dataType==="action"),T=!!At,L=P.filter(I=>I!==Me&&!O.includes(I)&&!ia(I)&&!mt(I)),M=P.filter(I=>mt(I)&&!(T&&I===At)),U=(I,re,vt)=>{I.stopPropagation(),I.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:re,parameters:{_clickedRow:vt}},bubbles:!0,composed:!0}))},Ne=I=>{const re=[];for(const vt of M){const _r=I[vt.id];if(vt.dataType==="action"){const sa=_r?.methodNameInCrud?_r:I.action?.methodNameInCrud?I.action:{methodNameInCrud:vt.id,label:vt.label,icon:null};re.push(o`
                            <button class="crud-btn" theme="tertiary" title="${sa.label||l}"
                                @click="${Dt=>U(Dt,"action-on-row-"+sa.methodNameInCrud,I)}">
                                ${sa.icon?j(sa.icon):l}
                                ${sa.label??l}
                            </button>`)}else(vt.dataType==="actionGroup"||vt.dataType==="menu")&&(_r?.actions??[]).forEach(Dt=>re.push(o`
                            <button class="crud-btn" theme="tertiary" title="${Dt.label||l}"
                                @click="${Ns=>U(Ns,"action-on-row-"+Dt.methodNameInCrud,I)}">
                                ${Dt.icon?j(Dt.icon):l}
                                ${Dt.label??l}
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: var(--lumo-space-m); padding: var(--lumo-space-s) 0;">
                    ${x.length===0?o`<div style="grid-column: 1 / -1;">${qt(y)}</div>`:l}
                    ${x.map(I=>o`
                        <div class="crud-card"
                            ?data-selected="${_&&R!==void 0&&String(I[_])===String(R)}"
                            style="cursor: pointer;"
                            @click="${re=>T?U(re,"action-on-row-select",I):ue(re.target,"view",I)}"
                        >
                    ...
                    `)}
                </div>`},te=()=>{const _=Pc(v),R=_.find(O=>O.identifier)??_[0],P=_.filter(O=>O!==R);return o`
                        ...
                        <div class="m-listbox" style="width: 100%;">
                            ...
                            ${x.map(O=>o`
                                <div class="m-item"
                                    ...
                                    style="cursor: pointer;"
                                >
                                    <div style="font-weight: 600;">${R?O[R.id]??"":""}</div>
                                    <div style="font-size: var(--lumo-font-size-s); color: var(--lumo-secondary-text-color); display: flex; flex-wrap: wrap; gap: var(--lumo-space-xs); align-items: center;">
                                        ${P.map(Me=>o`${S(Me,O)} `)}
                                    </div>
                                </div>
                ...
                </div>`},pe=()=>{const _=this.identifierFieldName,R=this.state._selectedId??this.appState?._splitDetailId,P=v[0],O=v.slice(1),Me=!!P?.actionId,ia=L=>(L??[]).map(M=>{const U=Array.isArray(M.children)?M.children:[];return U.length>0?{...M,children:ia(U)}:{...M,children:void 0}}),mt=ia(x),At=(L,M,U)=>{L.stopPropagation(),_&&M[_]!==void 0&&(this.state={...this.state,_selectedId:String(M[_])}),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:U,parameters:M},bubbles:!0,composed:!0}))},T=(L,M)=>o`
                <tr class="${_&&R!==void 0&&String(L[_])===String(R)?"selected":""}"
                    style="cursor: pointer;" @click="${U=>At(U,L,"view")}">
                    ${P?o`<td style="padding-left: ${M*1.2+.6}rem;">${L[P.id]??""}</td>`:l}
                    ${O.map(U=>U.id==="select"?o`<td><button class="crud-btn small" @click="${Ne=>{Ne.stopPropagation(),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-select",parameters:{_clickedRow:L}},bubbles:!0,composed:!0}))}}">Select</button></td>`:o`<td>${L[U.id]??""}</td>`)}
                    ${Me?o`<td style="text-align: end;">${L?.viewable===!1?l:o`<button class="crud-btn small" @click="${U=>At(U,L,"view")}">View</button>`}</td>`:l}
                </tr>
                ${(L.children??[]).map(U=>T(U,M+1))}
            `;return o`
                <table class="crud-table">
                    <thead><tr>
                        ${P?o`<th>${P.label??l}</th>`:l}
                        ${O.map(L=>o`<th>${L.label??l}</th>`)}
                        ${Me?o`<th></th>`:l}
                    </tr></thead>
                    <tbody>
                        ${mt.length===0?o`<tr><td colspan="99" style="padding: 1.5rem; text-align: center; color: var(--lumo-secondary-text-color, #888);">${qt(y)}</td></tr>`:l}
                        ${mt.map(L=>T(L,0))}
                    </tbody>
                </table>`},J=N.get()?.rendersCrudLayouts?.()===!0,he=()=>{const _=N.get();return _?.renderTreeComponent?_.renderTreeComponent(this,{rows:x,columns:v.map(R=>({id:R.id,label:R.label})),idField:this.identifierFieldName,navigable:!!v[0]?.actionId,selectedId:this.state._selectedId??this.appState?._splitDetailId}):pe()},ae=o`
            ...
            `:F():!J&&m==="masterDetail"?te():!J&&m==="tree"?he():N.get()?.renderTableComponent(this,r,this.baseUrl,this.state,this.data,this.appState,this.appData)}
            <slot></slot>
        `,ge=i.infiniteScrolling?l:N.get()?.renderPagination(this,this.component),ht=this.showImportDialog?o`
            <div class="crud-modal-backdrop" @click="${_=>{_.target===_.currentTarget&&(this.showImportDialog=!1)}}">
                <div class="crud-modal">
                    ...
                    <input type="file" @change="${_=>{const R=_.target.files?.[0];if(R){const P=new FormData;P.append("file",R),fetch("/upload",{method:"POST",body:P}).then(O=>O.json()).then(O=>this.handleImportUploadSuccess({detail:O})).catch(()=>this.notify("Import failed"))}}}">
        ...
        `:l;return this.standalone?o`
                ...
                <div style="border: var(--mateu-section-border, none); background: var(--mateu-section-bg, transparent); overflow: hidden; max-height: calc(100dvh - 12rem); width: 100%; box-sizing: border-box; padding: var(--mateu-section-padding, 0); display: flex; flex-direction: column;">
                    ...
                    <div style="flex-shrink: 0;">${ge}</div>
                </div>
            `:o`
            ${ht}
            ${u?o`
        ...
        `}createRenderRoot(){return N.mustUseShadowRoot()?super.createRenderRoot():this}};le.styles=$`
        ${It}
    ...
    `;Te([p()],le.prototype,"component",2);Te([p()],le.prototype,"baseUrl",2);Te([p({type:Boolean})],le.prototype,"standalone",2);Te([p()],le.prototype,"state",2);Te([p()],le.prototype,"data",2);Te([p()],le.prototype,"appState",2);Te([p()],le.prototype,"appData",2);Te([b()],le.prototype,"showImportDialog",2);Te([b()],le.prototype,"availableWidthPx",2);Te([b()],le.prototype,"selectedItem",2);Te([b()],le.prototype,"_columnPrefsRevision",2);le=Te([k("mateu-table-crud")],le);var gt=(e=>(e.OnLoad="OnLoad",e.OnSuccess="OnSuccess",e.OnError="OnError",e.OnValueChange="OnValueChange",e.OnCustomEvent="OnCustomEvent",e.AutoSave="AutoSave",e))(gt||{}),Rc=Object.defineProperty,xr=(e,t,a,r)=>{for(var i=void 0,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=n(t,a,i)||i);return i&&Rc(t,a,i),i};class Ot extends vr{constructor(){super(...arguments),this.state={},this.data={},this.appData={},this.appState={},this.triggerOnLoad=()=>{const t=this.component;this.registerCustomEventListeners(),t.triggers?.filter(a=>a.type==gt.OnLoad).forEach(a=>{if((!a.condition||this._evalExpr(a.condition))&&!a.triggered){const i=a;i.triggered=!0;var r=i.times-1;i.timeoutMillis>0?this.scheduleOnload(i,r,this.id):this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:i.actionId},bubbles:!0,composed:!0}))}})},this.scheduleOnload=(t,a,r)=>{if(r!=this.component?.id)return;const i=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,callbackToken:i},bubbles:!0,composed:!0}))},t.timeoutMillis)},this._registeredCustomEventListeners=[],this.customEventManager=t=>{if(!(t instanceof CustomEvent))return;const a=t,i=(this.component.triggers??[]).filter(s=>s.type==gt.OnCustomEvent).filter(s=>s.eventName==a.type).filter(s=>s.source!=="COMPONENT"||a.detail?.__source===s.from);i.length!==0&&(i.some(s=>!s.source||s.source==="SELF")&&(t.stopPropagation(),t.preventDefault()),i.forEach(s=>{(!s.condition||this._evalExpr(s.condition))&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:s.actionId,parameters:a.detail},bubbles:!0,composed:!0}))}))}}_interpolationExtra(){return{appState:this.appState??{},appData:this.appData??{},component:this.component}}_evalExpr(t){return Ni(t,this.state??{},this.data??{},this._interpolationExtra())}_evalTemplate(t){return Eo(t,this.state??{},this.data??{},this._interpolationExtra())}applyFragment(t){if(this.id==t.targetComponentId){if(t.component)if(Ia.Add==t.action)this.component&&this.component.children?.push(t.component);else{if(this.callbackToken=xe(),t.component?.type==W.ServerSide)if(this.component){const r=this.component,i=t.component;r.actions=i.actions,r.type=i.type,r.rules=i.rules,r.triggers=i.triggers,r.serverSideType=i.serverSideType,r.route=i.route,r.initialData=i.initialData,r.validations=i.validations,r.cssClasses=i.cssClasses,r.slot=i.slot,r.style=i.style,r.children=i.children,(r.serverSideType!=i.serverSideType||r.id!=i.id)&&setTimeout(()=>this.triggerOnLoad())}else this.component=t.component,setTimeout(()=>this.triggerOnLoad());else{const r=[t.component];this.component&&(this.component.children=r)}t.action!==Ia.ReplaceKeepData&&(this.state={},this.data={})}if(t.state&&(this.state={...this.state,...t.state}),t.data){for(const r in t.data){const i=t.data[r]?.page;i?.pageNumber>0&&this.data[r]&&this.data[r].page.content&&(i.content?i.content=[...this.data[r].page.content,...i.content]:i.content=[...this.data[r].page.content])}this.data={...this.data,...t.data}}this.registerCustomEventListeners();const a=N.getAfterRenderHook();a&&setTimeout(()=>a(this)),this.requestUpdate()}}registerCustomEventListeners(){this._registeredCustomEventListeners.forEach(({target:a,name:r})=>a.removeEventListener(r,this.customEventManager)),this._registeredCustomEventListeners=[],this.component?.triggers?.filter(a=>a.type==gt.OnCustomEvent).forEach(a=>{const r=a.source==="DOCUMENT"||a.source==="COMPONENT"?document:this;r.addEventListener(a.eventName,this.customEventManager),this._registeredCustomEventListeners.push({target:r,name:a.eventName})})}disconnectedCallback(){this._registeredCustomEventListeners.forEach(({target:t,name:a})=>t.removeEventListener(a,this.customEventManager)),this._registeredCustomEventListeners=[],super.disconnectedCallback()}connectedCallback(){super.connectedCallback(),this.component&&this.registerCustomEventListeners()}}xr([p()],Ot.prototype,"state");xr([p()],Ot.prototype,"data");xr([p()],Ot.prototype,"appData");xr([p()],Ot.prototype,"appState");const xs="mateu-recent-routes",Lc=8;function ws(){try{return JSON.parse(localStorage.getItem(xs)??"{}")}catch{return{}}}function Ac(e){try{localStorage.setItem(xs,JSON.stringify(e))}catch{}}function hi(e){return ws()[e||"_"]??[]}function Dc(e,t){if(!t?.route||!t.label)return;const a=e||"_",r=ws(),s=(r[a]??[]).filter(n=>n.route!==t.route);s.unshift({route:t.route,label:t.label}),r[a]=s.slice(0,Lc),Ac(r)}var Fc=Object.defineProperty,qc=Object.getOwnPropertyDescriptor,Ze=(e,t,a,r)=>{for(var i=r>1?void 0:r?qc(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Fc(t,a,i),i};let we=class extends C{constructor(){super(...arguments),this.baseUrl="",this.open=!1,this.queryText="",this.dataHits=[],this.loading=!1,this.selectedIndex=0,this.fabOffset=0,this.keydownHandler=null}connectedCallback(){super.connectedCallback(),this.keydownHandler=e=>{(e.metaKey||e.ctrlKey)&&(e.key==="k"||e.key==="K")?(e.preventDefault(),this.toggle()):e.key==="Escape"&&this.open&&this.close()},document.addEventListener("keydown",this.keydownHandler),this.setupFabObserver()}disconnectedCallback(){super.disconnectedCallback(),this.keydownHandler&&document.removeEventListener("keydown",this.keydownHandler),clearTimeout(this.searchTimer),this.fabObserver?.disconnect(),this.fabObserver=void 0}setupFabObserver(){const e=this.getRootNode(),t=e instanceof ShadowRoot?e:document.body;this.measureFabStack(),this.fabObserver?.disconnect(),this.fabObserver=new MutationObserver(()=>this.measureFabStack()),this.fabObserver.observe(t,{childList:!0,subtree:!0})}measureFabStack(){const a=(this.getRootNode().querySelectorAll?.(".ai-fab, .app-fab, .page-fab").length??0)*4;a!==this.fabOffset&&(this.fabOffset=a)}updated(e){e.has("open")&&this.open&&requestAnimationFrame(()=>this.inputEl?.focus())}toggle(){this.open?this.close():this.openCenter()}openCenter(){this.open=!0,this.queryText="",this.dataHits=[],this.selectedIndex=0}close(){this.open=!1,this.queryText="",this.dataHits=[],clearTimeout(this.searchTimer)}flattenMenu(e,t){const a=[];for(const r of e??[])if(!r.separator)if(r.submenus&&r.submenus.length>0){const i=t?`${t} › ${r.label}`:r.label;a.push(...this.flattenMenu(r.submenus,i))}else r.route!==void 0&&r.route!==null&&a.push({label:r.label,breadcrumb:t,route:r.route});return a}onInput(e){this.queryText=e,this.selectedIndex=0;const t=e.trim();if(clearTimeout(this.searchTimer),!t||!this.app?.globalSearchEnabled){this.dataHits=[],this.loading=!1;return}this.loading=!0,this.searchTimer=setTimeout(()=>this.fetchGlobalSearch(t),250)}async fetchGlobalSearch(e){const t=this.app;if(!t?.globalSearchEnabled){this.loading=!1;return}try{const r=(await Zt.runAction(this.baseUrl??"",t.rootRoute??"","","_globalsearch","command-center",void 0,t.serverSideType,{},{searchText:e},this,!0))?.fragments?.map(i=>i.data).find(i=>i&&i._globalsearch);this.dataHits=r?._globalsearch??[]}catch{this.dataHits=[]}finally{this.loading=!1}}navigateTo(e,t){Dc(this.app?.serverSideType??"",{route:e,label:t}),this.close();for(const a of["route-changed","navigate-to-requested"])this.dispatchEvent(new CustomEvent(a,{detail:{route:e},bubbles:!0,composed:!0}))}askAi(){const e=this.queryText.trim();this.close(),this.dispatchEvent(new CustomEvent("mateu-open-ai",{detail:{query:e},bubbles:!0,composed:!0}))}visibleTargets(e){if(!this.queryText.trim()){const t=this.flattenMenu(this.app?.menu,"").map(r=>({route:r.route,label:r.label})),a=hi(this.app?.serverSideType??"");return[...t,...a]}return[...e.map(t=>({route:t.route,label:t.label})),...this.dataHits.map(t=>({route:t.route,label:t.label}))]}onKeydown(e,t){if(e.key==="ArrowDown")e.preventDefault(),this.selectedIndex=Math.min(this.selectedIndex+1,t.length-1);else if(e.key==="ArrowUp")e.preventDefault(),this.selectedIndex=Math.max(this.selectedIndex-1,0);else if(e.key==="Enter"){const a=t[this.selectedIndex];a&&this.navigateTo(a.route,a.label)}}render(){return o`
        ...
        `}renderDefault(){const e=this.flattenMenu(this.app?.menu,""),t=hi(this.app?.serverSideType??"");let a=-1;return o`
    ...
    `;Ze([p({attribute:!1})],we.prototype,"app",2);Ze([p()],we.prototype,"baseUrl",2);Ze([b()],we.prototype,"open",2);Ze([b()],we.prototype,"queryText",2);Ze([b()],we.prototype,"dataHits",2);Ze([b()],we.prototype,"loading",2);Ze([b()],we.prototype,"selectedIndex",2);Ze([b()],we.prototype,"fabOffset",2);Ze([ee(".cc-input")],we.prototype,"inputEl",2);we=Ze([k("mateu-command-center")],we);let Ue=null;function Mc(e){const t=e.component?.metadata;!!(t&&(t.commandCenterEnabled||t.chromeless)&&t.variant!=="MEDIATOR")?((!Ue||!Ue.isConnected)&&(Ue=document.createElement("mateu-command-center"),e.renderRoot.appendChild(Ue)),Ue.app=t,Ue.baseUrl=e.baseUrl??""):Ue&&e.renderRoot.contains(Ue)&&(Ue.remove(),Ue=null)}var Nc=Object.defineProperty,Uc=Object.getOwnPropertyDescriptor,ks=(e,t,a,r)=>{for(var i=r>1?void 0:r?Uc(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Nc(t,a,i),i};let dr=class extends C{constructor(){super(...arguments),this.fetchStarted=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!0},this.fetchFinished=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1},this.fetchFailed=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1;const t=e.detail.reason,a=t?.message??String(t);Wt({text:a,variant:"error",duration:3e3,position:"bottomEnd"},this)}}connectedCallback(){super.connectedCallback(),this.addEventListener("backend-called-event",this.fetchStarted),this.addEventListener("backend-succeeded-event",this.fetchFinished),this.addEventListener("backend-cancelled-event",this.fetchFailed),this.addEventListener("backend-failed-event",this.fetchFailed)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("backend-succeeded-event",this.fetchStarted),this.removeEventListener("backend-succeeded-event",this.fetchFinished),this.removeEventListener("backend-cancelled-event",this.fetchFailed),this.removeEventListener("backend-failed-event",this.fetchFailed)}render(){return o`<div class="loader-container">
  ...
  `;ks([b()],dr.prototype,"loading",2);dr=ks([k("mateu-api-caller")],dr);class jc{constructor(){this._dirty=!1,this._installed=!1,this.message="You have unsaved changes. Are you sure you want to leave this page?",this._onDirty=()=>{this._dirty=!0},this._onClean=()=>{this._dirty=!1},this._onBeforeUnload=t=>{this._dirty&&(t.preventDefault(),t.returnValue="")}}install(){this._installed||(this._installed=!0,document.addEventListener("dirty",this._onDirty),document.addEventListener("clean",this._onClean),window.addEventListener("beforeunload",this._onBeforeUnload))}get dirty(){return this._dirty}markDirty(){this._dirty=!0}markClean(){this._dirty=!1}confirmLeave(){if(!this._dirty)return!0;const t=window.confirm(this.message);return t&&(this._dirty=!1),t}}const Nt=new jc;var Bc=Object.defineProperty,Vc=Object.getOwnPropertyDescriptor,V=(e,t,a,r)=>{for(var i=r>1?void 0:r?Vc(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Bc(t,a,i),i};let D=class extends Ot{constructor(){super(...arguments),this.filter="",this.instant=void 0,this.selectedConsumedRoute=void 0,this.selectedRoute=void 0,this.selectedUriPrefix=void 0,this.selectedBaseUrl=void 0,this.selectedServerSideType=void 0,this.selectedParams=void 0,this.tilesMenuOption=null,this.railOpenOption=null,this.commandPaletteOpen=!1,this.commandPaletteQuery="",this.commandPaletteSelectedIndex=0,this.commandPaletteDataHits=[],this.openDataHit=e=>{Nt.confirmLeave()&&(this.commandPaletteOpen=!1,this.commandPaletteQuery="",this.commandPaletteDataHits=[],this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:e.route},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("navigate-to-requested",{detail:{route:e.route},bubbles:!0,composed:!0})))},this._commandPaletteHandler=null,this.pageCompact=!1,this._compactHandler=e=>{this.pageCompact=e.detail?.compact??!1},this._openAiHandler=()=>{this.chatOpen||this.showHideIa()},this.isDark=document.documentElement.getAttribute("theme")==="dark",this.chatOpen=!1,this.toggleTheme=()=>{this.isDark=!this.isDark;const e=this.isDark?"dark":"light";document.documentElement.setAttribute("theme",e),localStorage.setItem("mateu-theme",e)},this.showHideIa=()=>{this.chat&&(this.chatOpen=!this.chatOpen,this.chat.slot=this.chatOpen?"detail":"detail-hidden")},this.runAction=e=>{const a=this.renderRoot.querySelector?.("mateu-component");a&&a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.getSelectedOption=e=>{if(e)for(let t=0;t<e.length;t++){const a=e[t];if(a.selected)return a;const r=this.getSelectedOption(a.submenus);if(r)return r}return null},this.itemSelected=e=>{const t=e.detail.value;this.selectRoute(t.consumedRoute,t.route,t.actionId,t.baseUrl,t.serverSideType,t.uriPrefix)},this.itemSelectedTiles=e=>{const t=e.detail.value._menuOption;t.submenus&&t.submenus.length>0?this.tilesMenuOption=t:(this.tilesMenuOption=null,this.selectRoute(t.consumedRoute,t.route,t.actionId,t.baseUrl,t.serverSideType,t.uriPrefix))},this.mapItemsForTiles=e=>e.map(t=>({text:t.label,consumedRoute:t.consumedRoute,route:t.route,baseUrl:t.baseUrl,serverSideType:t.serverSideType,uriPrefix:t.uriPrefix,actionId:t.actionId,selected:t.selected,_menuOption:t})),this.flattenMenuForPalette=(e,t)=>{const a=[];for(const r of e)if(!r.separator)if(r.submenus&&r.submenus.length>0){const i=t?`${t} › ${r.label}`:r.label;a.push(...this.flattenMenuForPalette(r.submenus,i))}else a.push({label:r.label,breadcrumb:t,consumedRoute:r.consumedRoute,route:r.route,actionId:r.actionId,baseUrl:r.baseUrl,serverSideType:r.serverSideType,uriPrefix:r.uriPrefix});return a},this.handleCommandPaletteKeydown=(e,t)=>{const a=Math.min(t.length,10),r=a+Math.min(this.commandPaletteDataHits.length,8);if(e.key==="ArrowDown")e.preventDefault(),this.commandPaletteSelectedIndex=Math.min(this.commandPaletteSelectedIndex+1,r-1);else if(e.key==="ArrowUp")e.preventDefault(),this.commandPaletteSelectedIndex=Math.max(this.commandPaletteSelectedIndex-1,0);else if(e.key==="Enter"){if(this.commandPaletteSelectedIndex>=a){const s=this.commandPaletteDataHits[this.commandPaletteSelectedIndex-a];s&&this.openDataHit(s);return}const i=t[this.commandPaletteSelectedIndex];i&&(this.selectRoute(i.consumedRoute,i.route,i.actionId,i.baseUrl,i.serverSideType,i.uriPrefix),this.commandPaletteOpen=!1,this.commandPaletteQuery="")}},this.renderCommandPalette=()=>{if(!this.commandPaletteOpen)return l;const e=this.component?.metadata;if(e?.commandCenterEnabled)return l;if(!e?.menu)return l;const t=this.flattenMenuForPalette(e.menu,""),a=this.commandPaletteQuery.toLowerCase(),r=a?t.filter(i=>i.label.toLowerCase().includes(a)||i.breadcrumb.toLowerCase().includes(a)):t;return o`
            <div class="cmd-backdrop" @click=${()=>{this.commandPaletteOpen=!1,this.commandPaletteQuery=""}}>
                <div class="cmd-palette" @click=${i=>i.stopPropagation()}>
                    <div class="cmd-search-wrapper">
                        ${j("vaadin:search",void 0,"cmd-search-icon")}
                        <input
                            class="cmd-input"
                            placeholder="Go to…"
        ...
        `,this.renderRailItem=e=>{const t=e.submenus?.length>0?this.railOpenOption?.label===e.label:e.selected;return o`
            ...
            >
                ${e.icon?j(e.icon,void 0,"rail-icon"):o`<div class="rail-icon-placeholder">${e.label.charAt(0).toUpperCase()}</div>`}
            ...
            <div style="padding: 2rem;">
                ...
                <div class="tiles-hub-grid">
                    ${e.submenus.map(t=>o`
                        ...
                        >
                            ${t.icon?j(t.icon,"font-size: 2rem; color: var(--lumo-primary-color); display: block; margin-bottom: 0.75rem;"):l}
...
`,te=!0)}te&&this.updateMessage(s,n)}n||this.updateMessage(s,"⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).")}catch(d){console.error("Error en el flujo SSE:",d);const c=d?.message??String(d);(c==="Failed to fetch"||c==="network error"||c==="Load failed")&&!n?this.updateMessage(s,"⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible."):this.updateMessage(s,"⚠️ Error: "+c)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value="")},250),this.messageInputElement?.removeAttribute("disabled"),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent("close-requested",{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{const e=this.messageInputElement?.value?.trim()??"";e&&this.send(new CustomEvent("submit",{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key==="Enter"&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback(),this.probeLocalAgent();const e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){const t=new e;this.recognition=t,t.lang="es-ES",t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=a=>{console.error("Error de reconocimiento: "+a.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:"smooth"})},0)}addMessage(e,t){const a={text:e,time:new Date().toLocaleTimeString(),userName:t.includes("agent")?"Asistente":"Tú",userColorIndex:t.includes("agent")?2:1};return this.items=[...this.items,a],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((a,r)=>r===e?{...a,text:t}:a),this.scrollBottom()}tryParseCustomEvent(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if(typeof a.event=="string")return{event:a.event,detail:a.detail??{}}}catch{}return null}tryParseTokenUsage(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if("inputTokens"in a||"outputTokens"in a||"totalTokens"in a)return a}catch{}return null}buildMenuContext(e,t=[]){const a=[];for(const r of e){if(r.separator||r.remote)continue;const i=[...t,r.label];if(r.submenus&&r.submenus.length>0)a.push(...this.buildMenuContext(r.submenus,i));else{const s={path:i,navigation:{route:r.route,consumedRoute:r.consumedRoute,actionId:r.actionId??"",baseUrl:r.baseUrl,serverSideType:r.serverSideType,uriPrefix:r.uriPrefix}};r.description&&(s.description=r.description),a.push(s)}}return a}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return o`
                    ...
                    <div class="message-list" role="list">
                        ${this.items.map(e=>o`
                            <div class="message" role="listitem">
                                <div class="avatar" style="background: ${su(e.userColorIndex)};">${ou(e.userName)}</div>
    ...
    `];B([p({attribute:!1})],q.prototype,"contextProvider",2);B([p()],q.prototype,"localAgentUrl",2);B([p({attribute:!1})],q.prototype,"mcpUrl",2);B([b()],q.prototype,"localAgentAlive",2);B([p()],q.prototype,"sseUrl",2);B([p()],q.prototype,"uploadUrl",2);B([p({attribute:!1})],q.prototype,"menu",2);B([b()],q.prototype,"attachments",2);B([b()],q.prototype,"uploading",2);B([ee(".file-input")],q.prototype,"fileInputElement",2);B([p({type:Boolean,reflect:!0})],q.prototype,"expanded",2);B([p()],q.prototype,"items",2);B([ee(".scroll-container")],q.prototype,"scrollContainer",2);B([ee(".msg-input")],q.prototype,"messageInputElement",2);B([b()],q.prototype,"recognition",2);B([b()],q.prototype,"listening",2);B([b()],q.prototype,"recognitionAvailable",2);B([b()],q.prototype,"loading",2);B([b()],q.prototype,"elapsedSeconds",2);B([b()],q.prototype,"tokenUsage",2);q=B([k("mateu-chat")],q);var nu=Object.defineProperty,lu=Object.getOwnPropertyDescriptor,Na=(e,t,a,r)=>{for(var i=r>1?void 0:r?lu(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&nu(t,a,i),i};let Gt=class extends C{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.data&&this.createChart(this.data)}async createChart(e){const[{default:t}]=await Promise.all([me(()=>import("./vendor-chartjs.js").then(r=>r.a),[]),me(()=>import("./vendor-chartjs.js").then(r=>r.c),[])]);if(e!==this.data)return;this.chart&&this.chart.destroy();const a={type:this.type,data:this.data,options:this.options};this.chart=new t(this.chartElement,a)}handleSlotChange(){}render(){return o`
            <div class="container">
       ...
       `}};Gt.styles=$`
  `;Na([p()],Gt.prototype,"type",2);Na([p()],Gt.prototype,"data",2);Na([p()],Gt.prototype,"options",2);Na([ee("#chart")],Gt.prototype,"chartElement",2);Gt=Na([k("mateu-chart")],Gt);var du=Object.defineProperty,cu=Object.getOwnPropertyDescriptor,ti=(e,t,a,r)=>{for(var i=r>1?void 0:r?cu(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&du(t,a,i),i};let La=class extends C{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){const{default:t}=await me(async()=>{const{default:r}=await import("./vendor-diagrams.js");return{default:r}},__vite__mapDeps([0,1]));if(e!==this.xml)return;this.chart&&this.chart.destroy();const a={container:this.divElement};this.chart=new t(a),this.chart.importXML(e)}handleSlotChange(){}render(){return o`
       ...
       `}};La.styles=$`
  `;ti([p()],La.prototype,"xml",2);ti([ee("#canvas")],La.prototype,"divElement",2);La=ti([k("mateu-bpmn")],La);var uu=Object.defineProperty,pu=Object.getOwnPropertyDescriptor,$a=(e,t,a,r)=>{for(var i=r>1?void 0:r?pu(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&uu(t,a,i),i};const Pr=160,je=56,hu=220,fi=110,bt=60,mu={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},vu={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},fu=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];function bu(){return"step-"+Math.random().toString(36).slice(2,8)}let kt=class extends C{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.wf={name:"New Workflow",steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value")){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){const e=this.wf.steps??[],t={};e.forEach(n=>{t[n.id]=0});let a=!0;for(;a;)a=!1,e.forEach(n=>{if(n.preconditionStepId!=null&&t[n.preconditionStepId]!==void 0){const d=t[n.preconditionStepId]+1;d>t[n.id]&&(t[n.id]=d,a=!0)}});const r={};e.forEach(n=>{const d=t[n.id]??0;(r[d]??=[]).push(n.id)});const i={...this.positions};let s=!1;Object.entries(r).forEach(([n,d])=>{const c=Number(n);d.forEach((u,m)=>{i[u]||(i[u]={x:bt+c*hu,y:bt+m*fi},s=!0)})}),s&&(this.positions=i)}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addStep(){const e=bu(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(i=>i.y),r=a.length?Math.max(...a)+fi:bt;this.positions={...this.positions,[e]:{x:bt,y:r}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(r=>r.id!==e).map(r=>r.preconditionStepId===e?{...r,preconditionStepId:void 0}:r)};const{[e]:t,...a}=this.positions;this.positions=a,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},r=this.toSvgPoint(e);this.dragOffset={x:r.x-a.x,y:r.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(r=>r.x))+Pr+bt:600,a=e.length?Math.max(...e.map(r=>r.y))+je+bt:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return X``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return X``;const r=t.x+Pr,i=t.y+je/2,s=a.x,n=a.y+je/2,d=(r+s)/2;return X`
            <path d="M${r},${i} C${d},${i} ${d},${n} ${s},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:bt,y:bt},a=mu[e.type]??"#64748b",r=vu[e.type]??"•",i=this.selectedId===e.id;return X`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${s=>this.onNodeMouseDown(s,e.id)}"
               @click="${s=>{s.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${Pr}" height="${je}" rx="8"
                      fill="white"
                      stroke="${i?a:"#e2e8f0"}"
                ...
                <div class="prop-body">
                    ...
                    ${a("Type",o`
                        <select class="inp" @change="${r=>this.updateStep(e.id,{type:r.target.value})}">
                            ${fu.map(r=>o`<option value="${r}" ?selected="${e.type===r}">${r}</option>`)}
                        </select>`)}
        ...
        `}exportJson(){const e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),r=document.createElement("a");r.href=a,r.download=(this.wf.name??"workflow").replace(/\s+/g,"-").toLowerCase()+".json",r.click(),URL.revokeObjectURL(a)}};kt.styles=[ei,$`
    ...
    `];$a([p()],kt.prototype,"value",2);$a([b()],kt.prototype,"wf",2);$a([b()],kt.prototype,"positions",2);$a([b()],kt.prototype,"selectedId",2);$a([b()],kt.prototype,"showMeta",2);kt=$a([k("mateu-workflow")],kt);var gu=Object.defineProperty,yu=Object.getOwnPropertyDescriptor,Ua=(e,t,a,r)=>{for(var i=r>1?void 0:r?yu(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&gu(t,a,i),i};const $u=["string","integer","number","bool","date","time","dateTime","dateRange","money","file","array","status","component","menu","range","action","actionGroup"],xu=["regular","radio","checkbox","textarea","toggle","combobox","select","email","password","richText","listBox","html","markdown","image","icon","link","money","grid","color","choice","popover","slider","button","stars"],wu={string:"#3B82F6",integer:"#8B5CF6",number:"#6366F1",bool:"#10B981",date:"#F59E0B",time:"#F59E0B",dateTime:"#F59E0B",dateRange:"#F59E0B",money:"#EF4444",file:"#64748B",array:"#0EA5E9",status:"#EC4899",component:"#14B8A6",menu:"#94A3B8",range:"#A855F7",action:"#F97316",actionGroup:"#FB923C"};function bi(){return"field-"+Math.random().toString(36).slice(2,8)}let Kt=class extends C{constructor(){super(...arguments),this.value='{"name":"New Form","fields":[]}',this.form={name:"New Form",fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has("value"))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){const e=this.shadowRoot?.querySelector(".field-list");!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=lo.create(e,{animation:150,handle:".drag-handle",ghostClass:"sortable-ghost",onEnd:t=>{const{oldIndex:a,newIndex:r}=t;if(a===void 0||r===void 0||a===r)return;const i=[...this.form.fields],[s]=i.splice(a,1);i.splice(r,0,s),this.form={...this.form,fields:i},this.emit()}}))}emit(){const e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addField(){const e=bi(),t={id:e,label:"New Field",dataType:"string"};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){const t=this.form.fields.find(s=>s.id===e);if(!t)return;const a={...t,id:bi(),label:t.label+" (copy)"},r=this.form.fields.findIndex(s=>s.id===e),i=[...this.form.fields];i.splice(r+1,0,a),this.form={...this.form,fields:i},this.selectedId=a.id,this.emit()}render(){return o`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderRow(e){const t=wu[e.dataType]??"#64748b",a=this.selectedId===e.id;return o`
        ...
        `}exportJson(){const e=JSON.stringify(this.form,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),r=document.createElement("a");r.href=a,r.download=(this.form.name??"form").replace(/\s+/g,"-").toLowerCase()+".json",r.click(),URL.revokeObjectURL(a)}};Kt.styles=[ei,$`
        :host { display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif); }
        ...
        textarea.inp { resize: vertical; }
        input[readonly].inp { background: #f8fafc; color: #94a3b8; }
    `];Ua([p()],Kt.prototype,"value",2);Ua([b()],Kt.prototype,"form",2);Ua([b()],Kt.prototype,"selectedId",2);Ua([b()],Kt.prototype,"showMeta",2);Kt=Ua([k("mateu-form-editor")],Kt);var ku=Object.defineProperty,Cu=Object.getOwnPropertyDescriptor,tt=(e,t,a,r)=>{for(var i=r>1?void 0:r?Cu(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&ku(t,a,i),i};let Ce=class extends C{constructor(){super(...arguments),this.appState={},this.appData={},this.open=!1,this.activeTab="appstate",this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null,this._prevTarget=null,this._onMouseover=e=>{let t=e.target;for(;t&&!(t.tagName?.toLowerCase().startsWith("mateu-")&&t!==this);)t=t.parentElement;if(t===this||t===null){t===null&&this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset="",this._prevTarget=null,this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null);return}t!==this._prevTarget&&(this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset=""),this._prevTarget=t,t.style.outline="2px solid #0070f3",t.style.outlineOffset="-2px",this.hoveredTag=t.tagName.toLowerCase(),this.hoveredId=t.id||"",this.hoveredState=t.state,this.hoveredData=t.data,this.hoveredMeta=t.component?.metadata)}}connectedCallback(){super.connectedCallback(),document.addEventListener("mouseover",this._onMouseover,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mouseover",this._onMouseover,!0),this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget=null)}_fmt(e){try{return JSON.stringify(e,null,2)??"null"}catch{return String(e)}}_renderTab(e,t){return o`
...
`);Wt({text:r,variant:"error",position:"bottomEnd",duration:Math.max(3e3,1500+a.length*1e3)},this)},this.notify=e=>{Wt({text:e,variant:"error",position:"bottomEnd",duration:3e3},this)},this.callAfterConfirmation=(e,t)=>{let a="One moment, please",r="Are you sure?",i="Yes",s="No";e.confirmationTexts&&(a=e.confirmationTexts.title,r=e.confirmationTexts.message,i=e.confirmationTexts.confirmationText,s=e.confirmationTexts.denialText);const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;z-index:1100;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.35);padding:1rem;";const d=document.createElement("div");d.style.cssText="background:var(--lumo-base-color,#fff);color:var(--lumo-body-text-color,#1a1a1a);border-radius:var(--lumo-border-radius-l,12px);box-shadow:var(--lumo-box-shadow-xl,0 12px 40px rgba(0,0,0,.3));padding:1.2rem;max-width:min(90vw,26rem);";const c=()=>{n.parentElement&&document.body.removeChild(n)},u="font:inherit;font-weight:600;padding:.45rem 1rem;border-radius:var(--lumo-border-radius-m,6px);cursor:pointer;";Li(o`
        ...
        `,d),n.appendChild(d),n.addEventListener("click",m=>{m.target===n&&c()}),document.body.appendChild(n)},this.requestActionCallToServerOrBubble=(e,t,a)=>{if(a&&a.bubble){const r={...e.parameters};r.initiatorState||(r.initiatorState=this.state),this.dispatchEvent(new CustomEvent("action-requested",{detail:{...e,parameters:r},bubbles:!0,composed:!0}))}else this.requestActionCallToServer(e,t,a)},this.requestActionCallToServer=(e,t,a)=>{if(a&&a.href){window.location.href=a.href;return}if(a&&a.js)try{new Function("state","data","appState","appData","component",a.js).call(this,this.state??{},this.data??{},this.appState??{},this.appData??{},this.component),this.state={...this.state},this.data={...this.data}}catch(r){console.error("when evaluating "+a.js,r,this.component,this.state,this.data)}if(a&&a.customEvent&&this.dispatchEvent(new CustomEvent(a.customEvent.name,{detail:a.customEvent.detail,bubbles:!0,composed:!0})),!(a&&(a.js||a.customEvent))){if(e.actionId=="search"){const r=e.parameters?._searchState;r?this.state={...this.state,...r}:this.state.size||(this.state={...this.state,size:10,page:0,sort:[]})}this.dispatchEvent(new CustomEvent("server-side-action-requested",{detail:{route:this.route,consumedRoute:this.consumedRoute,componentState:{...this.state},parameters:e.parameters??{},actionId:e.actionId,serverSideType:t.serverSideType,serverSideComponentRoute:t.route,initiatorComponentId:e.initiatorComponentId??t.id,initiator:this,background:a?.background,sse:a?.sse,callback:e.callback,callbackonly:e.callbackonly,callbackToken:e.callbackToken??this.callbackToken},bubbles:!0,composed:!0}))}},this.handleBackendSucceeded=e=>{e.detail.actionId&&this.component.triggers?.filter(r=>r.type==gt.OnSuccess).filter(r=>e.detail.actionId==r.calledActionId).forEach(r=>{if(!r.condition||this._evalExpr(r.condition))if(e.preventDefault(),e.stopPropagation(),r.timeoutMillis>0){const i=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.actionId,callbackToken:i},bubbles:!0,composed:!0}))},r.timeoutMillis)}else this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.actionId},bubbles:!0,composed:!0}))})},this.handleBackendFailed=e=>{e.detail.actionId&&this.component.triggers?.filter(r=>r.type==gt.OnError).filter(r=>e.detail.actionId==r.calledActionId).forEach(r=>{(!r.condition||this._evalExpr(r.condition))&&(e.preventDefault(),e.stopPropagation(),this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.actionId},bubbles:!0,composed:!0})))})},this._keydownListener=e=>{if(this._handleTabShortcut(e))return;const t=this.component;if(t)for(const a of t.actions??[]){const r=a.shortcut||(a.runOnEnter?"enter":null);if(r&&this._shortcutMatchesEvent(r,e)){e.preventDefault(),this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.id},bubbles:!0,composed:!0}));return}}}}createRenderRoot(){return N.mustUseShadowRoot()?super.createRenderRoot():this}updated(e){super.updated(e),e.has("state")&&this.state&&JSON.stringify(this.state)!=JSON.stringify({})&&this.onChange(),e.has("component")&&(this.formerState={...this.state},this.component?.confirmOnNavigationIfDirty&&this.dispatchEvent(new CustomEvent("clean",{detail:{},bubbles:!0,composed:!0})),setTimeout(()=>this.triggerOnLoad()))}_shortcutMatchesEvent(e,t){return Rn(e,t)}_collectShortcutTabs(){const e=this.renderRoot;if(!e)return[];const t=Array.from(e.querySelectorAll("vaadin-tab[data-shortcut]"));return e.querySelectorAll("mateu-drawer, mateu-dialog").forEach(a=>{const r=a.shadowRoot;r&&t.push(...Array.from(r.querySelectorAll("vaadin-tab[data-shortcut]")))}),t}_handleTabShortcut(e){const t=this._collectShortcutTabs();if(t.length===0)return!1;for(const a of Array.from(t)){const r=a.dataset.shortcut;if(!r||!this._shortcutMatchesEvent(r,e))continue;const i=a.closest("vaadin-tabs");if(!i)continue;const s=Array.from(i.querySelectorAll("vaadin-tab")).indexOf(a);if(!(s<0))return e.preventDefault(),i.selected=s,!0}return!1}connectedCallback(){super.connectedCallback(),this.addEventListener("backend-call-succeeded",this.handleBackendSucceeded),this.addEventListener("backend-call-failed",this.handleBackendFailed),document.addEventListener("keydown",this._keydownListener)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("backend-call-succeeded",this.handleBackendSucceeded),this.removeEventListener("backend-call-failed",this.handleBackendFailed),document.removeEventListener("keydown",this._keydownListener)}render(){return o`<div>
            ...
            `:l}</div>`}_render(){if(this.component?.type==W.ClientSide){const e=this.component;return e.metadata?.type==h.Page?Fr(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):e.metadata?.type==h.Crud?qr(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):N.get()?.renderClientSideComponent(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!1)}return o`
            <mateu-api-caller 
            ...
            ${this.component?.children?.map(e=>{if(e.type==W.ClientSide){const t=e;if(t.metadata?.type==h.Page)return Fr(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0);if(t.metadata?.type==h.Crud)return qr(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0)}return g(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData)})}
            </mateu-api-caller>
        `}};ua.styles=$`
        :host {
        }
  ...
  `;kr([p()],ua.prototype,"baseUrl",2);kr([p()],ua.prototype,"route",2);kr([p()],ua.prototype,"consumedRoute",2);ua=kr([k("mateu-component")],ua);const gi=e=>{if(e)try{return JSON.parse(e)}catch{return{value:e}}else return{}};class Su{async handle(t,a){return await t.runAction(a.baseUrl,a.route,a.consumedRoute,a.actionId,a.initiatorComponentId,a.appState,a.serverSideType,a.componentState,a.parameters,a.initiator,a.background)}}const Eu=new Su;class Pu{constructor(){this.handleUIIncrement=(t,a,r)=>{if(t?.fragments?.forEach(i=>{Mt.next({command:void 0,fragment:i,ui:void 0,error:void 0,callbackToken:r})}),t?.appState&&(G.value={...t.appState},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))),t?.appData){const i=t?.appData;_a.value={...t.appData,...i},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))}t?.messages?.forEach(i=>{Wt({text:i.text,position:i.position,variant:i.variant,duration:i.duration,undoLabel:i.undoLabel,undoActionId:i.undoActionId,undoParameters:i.undoParameters},a)}),t?.banners&&t.banners.length>0&&document.dispatchEvent(new CustomEvent("page-banners-received",{detail:{banners:t.banners,append:t.appendBanners??!1},bubbles:!1,composed:!1})),t?.commands?.forEach(i=>{Mt.next({command:i,fragment:void 0,ui:void 0,error:void 0,callbackToken:r})})}}async runAction(t,a,r,i,s,n,d,c,u,m,v,f,w,x,y){try{const S=await Eu.handle(t,{baseUrl:a,route:r,consumedRoute:i,actionId:s,appState:G.value,initiatorComponentId:n,componentState:u,parameters:m,serverSideType:c,initiator:v,background:f});w&&w(S),x||this.handleUIIncrement(S,v,y),S.messages&&S.messages.length==1&&S.messages[0].variant=="error"&&v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:s},bubbles:!0,composed:!0})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:s,evevntId:xe()},bubbles:!0,composed:!0}))}catch(S){console.warn("Action request failed",S),v.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:s,reason:this.serialize(S)}})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:s},bubbles:!0,composed:!0}))}}serialize(t){return t?.message?t:JSON.stringify(t)}}const Tu=new Pu,zu=Tu;class Ou{constructor(){this.handleUIIncrement=(t,a,r)=>{if(t?.messages?.forEach(i=>{Wt({text:i.text,position:i.position,variant:i.variant,duration:i.duration,undoLabel:i.undoLabel,undoActionId:i.undoActionId,undoParameters:i.undoParameters},a)}),t?.banners&&t.banners.length>0&&document.dispatchEvent(new CustomEvent("page-banners-received",{detail:{banners:t.banners,append:t.appendBanners??!1},bubbles:!1,composed:!1})),t?.commands?.forEach(i=>{Mt.next({command:i,fragment:void 0,ui:void 0,error:void 0,callbackToken:r})}),t?.fragments?.forEach(i=>{Mt.next({command:void 0,fragment:i,ui:void 0,error:void 0,callbackToken:r})}),t?.appState&&(G.value={...t.appState},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))),t?.appData){const i=t?.appData;_a.value={...t.appData,...i},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))}}}async runAction(t,a,r,i,s,n,d,c,u,m,v,f,w,x,y){if(r){r=r||"_no_route",r&&r.startsWith("/")&&(r=r.substring(1));const S={serverSideType:c,appState:G.value,componentState:u,parameters:m,initiatorComponentId:n,consumedRoute:i,route:"/"+r,actionId:s};f||v.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),fetch(a+"/mateu/v3/sse/"+r,{method:"POST",headers:{Accept:"text/event-stream","Content-Type":"application/json"},body:JSON.stringify(S)}).then(async H=>{const ue=H.body?.pipeThrough(new TextDecoderStream).getReader();if(ue){let F="";for(;;){const{value:te,done:pe}=await ue.read();if(pe)break;F+=te;const J=F.split(`

`);F=J.pop()??"";for(const he of J){const ae=he.trim();if(ae)if(ae.startsWith("data:")){const ge=JSON.parse(ae.substring(5).trim());w&&w(ge),x||this.handleUIIncrement(ge,v,y),ge.messages&&ge.messages.length==1&&ge.messages[0].variant=="error"&&v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:s},bubbles:!0,composed:!0}))}else{let ge=ae;try{const ht=JSON.parse(ae);ge=ht.message,ht._embedded?.errors?.length>0&&ht._embedded.errors[0].message&&(ge=ht._embedded.errors[0].message)}catch{}throw new Error(ge)}}}}f||v.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:s}})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:s},bubbles:!0,composed:!0}))}).catch(H=>{v.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:s,reason:this.serialize(H)}})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:s},bubbles:!0,composed:!0}))})}}serialize(t){return t?.message?t:JSON.stringify(t)}}const zs=new Ou,Ru={fixed:"fixed",fullWidth:"full",edgeToEdge:"edge"},Lu=new Set([h.Gantt,h.PlanningBoard,h.Kanban,h.Bpmn,h.Workflow,h.Map]),Au={landing:"fixed",form:"fixed",process:"fixed"},Os=e=>e?Ru[e]:void 0,Yt=e=>e.type==W.ClientSide?e.metadata:void 0,Rs=e=>{const t=Yt(e);if(t?.type==h.Page){const a=Os(t.pageWidth);if(a)return a}for(const a of e.children??[]){const r=Rs(a);if(r)return r}},Ls=e=>{const t=e.pageType;if(t)return t;const a=r=>{const i=Yt(r);if(i?.type==h.Page&&i.pageType)return i.pageType;for(const s of r.children??[]){const n=a(s);if(n)return n}};return a(e)},Du=e=>{const t=Yt(e);if(t?.type!=h.Crud)return!1;const a=t;return a.compact?!0:(a.columns??[]).some(r=>r.metadata?.editable)},pr=(e,t)=>t(e)||(e.children??[]).some(a=>pr(a,t)),Fu=e=>!!e&&pr(e,t=>Yt(t)?.type==h.HeroSection),qu=e=>Yt(e)?.type==h.App?!0:(e.children??[]).some(t=>Yt(t)?.type==h.App),Mu=(e,t)=>{if(!e)return"fixed";const a=Os(e.pageWidth)??Rs(e);if(a)return a;if(t?.top&&qu(e))return"edge";const r=Au[Ls(e)??""];return r||(pr(e,i=>{const s=Yt(i)?.type;return s!=null&&Lu.has(s)})?"edge":pr(e,Du)?"full":"fixed")};var Nu=Object.defineProperty,Uu=Object.getOwnPropertyDescriptor,be=(e,t,a,r)=>{for(var i=r>1?void 0:r?Uu(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Nu(t,a,i),i};let Z=class extends mr{constructor(){super(...arguments),this.consumedRoute="",this.serverSideType=void 0,this.uriPrefix=void 0,this.overrides=void 0,this.homeRoute=void 0,this.route=void 0,this.top=void 0,this.appState={},this.appData={},this.preventNavigation=!1,this.overridesParsed={},this.fragment=void 0,this.actionRequestedListener=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.manageActionEvent(e))},this.historyPushed=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.preventNavigation=!0,this.route=e.detail.route)},this.routeChangedListener=e=>{if(e instanceof CustomEvent){e.preventDefault(),e.stopPropagation();let t=e.detail.route;typeof t=="string"&&(t===""||t.startsWith("/"))&&this.consumedRoute&&this.consumedRoute!=="_empty"&&this.consumedRoute.startsWith("/")&&!t.startsWith(this.consumedRoute)&&(t=this.consumedRoute+t),this.uriPrefix&&(t.startsWith("/")&&this.uriPrefix.endsWith("/")?t=this.uriPrefix+t.substring(1):!t.startsWith("/")&&!this.uriPrefix.endsWith("/")?t=this.uriPrefix+"/"+t:t=this.uriPrefix+t),this.dispatchEvent(new CustomEvent("url-update-requested",{detail:{route:t},bubbles:!0,composed:!0}))}},this.backendFailedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&e.detail.actionId==""&&(this.fragment={targetComponentId:this.id,data:{},state:{},component:{type:W.ClientSide,metadata:{type:h.Element,name:"div",content:"Not found"},id:"fieldId"},action:Ia.Replace,containerId:void 0})},this.detail1=void 0,this.manageActionEvent=e=>{e.preventDefault(),e.stopPropagation(),this.detail1=e.detail;const t=this.detail1;if(e.type=="server-side-action-requested"){let a=zu;t.sse&&(a=zs),a.runAction(Zt,this.baseUrl,t.route??"",t.consumedRoute,t.actionId,t.initiatorComponentId,this.getCustomisedAppState(),t.serverSideType,t.componentState,t.parameters,t.initiator,t.background,t.callback,t.callbackonly,t.callbackToken)}},this.getCustomisedAppState=()=>{let e={...G.value};if(this.overrides){const t=gi(this.overrides);e={...e,...t}}return e}}manageActionRequestedEvent(e){throw new Error("Method not implemented.")}createRenderRoot(){return N.mustUseShadowRoot()?super.createRenderRoot():this}connectedCallback(){super.connectedCallback(),this.overridesParsed=gi(this.overrides),this.addEventListener("server-side-action-requested",this.actionRequestedListener),this.addEventListener("backend-call-failed",this.backendFailedListener),this.addEventListener("history-pushed",this.historyPushed),this.addEventListener("route-changed",this.routeChangedListener)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("server-side-action-requested",this.actionRequestedListener),this.removeEventListener("backend-call-failed",this.backendFailedListener),this.removeEventListener("history-pushed",this.historyPushed),this.removeEventListener("route-changed",this.routeChangedListener)}shouldUpdate(e){if(this.fragment?.component&&[...e.keys()].every(a=>a==="appState"||a==="appData")){const a=this.renderRoot.querySelector("mateu-component");if(a)return e.has("appState")&&(a.appState=this.appState),e.has("appData")&&(a.appData=this.appData),!1}return!0}updated(e){(e.has("id")||e.has("baseurl")||e.has("route")||e.has("consumedRoute")||e.has("instant"))&&(this.preventNavigation||(this.callbackToken=this.instant||xe(),this.manageActionEvent(new CustomEvent("server-side-action-requested",{detail:{route:this.route,consumedRoute:this.consumedRoute,userData:void 0,actionId:"",serverSideType:this.serverSideType,initiatorComponentId:this.id,initiator:this,componentState:this.initialState,callbackToken:this.callbackToken},bubbles:!0,composed:!0})))),e.has("route")&&this.top&&(this.preventNavigation||this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:this.route},bubbles:!0,composed:!0}))),this.preventNavigation&&(this.preventNavigation=!1)}applyFragment(e){if(!e.component&&this.fragment?.component){this.fragment={...this.fragment,state:{...this.fragment.state??{},...e.state??{}},data:{...this.fragment.data??{},...e.data??{}}};return}this.fragment=e,e.component&&(this.dataset.pageWidth=Mu(e.component,{top:this.top}),this.dataset.pageType=Ls(e.component)??"",this.dataset.hasWelcomeBanner=String(Fu(e.component)))}render(){return o`
  ...
  `;pt([p()],De.prototype,"baseUrl",2);pt([p()],De.prototype,"route",2);pt([p()],De.prototype,"consumedRoute",2);pt([p()],De.prototype,"config",2);pt([p()],De.prototype,"top",2);pt([p()],De.prototype,"pathPrefix",2);pt([b()],De.prototype,"instant",2);pt([p({type:Boolean})],De.prototype,"debug",2);De=pt([k("mateu-ui")],De);var Ku=Object.defineProperty,Yu=Object.getOwnPropertyDescriptor,aa=(e,t,a,r)=>{for(var i=r>1?void 0:r?Yu(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Ku(t,a,i),i};let Fe=class extends C{constructor(){super(...arguments),this.baseUrl="",this.opened=!1,this.searchText=""}connectedCallback(){super.connectedCallback(),go()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick(),this.searchTimer&&clearTimeout(this.searchTimer)}currentValue(){return String(jr()[this.selector.fieldName]??"")}currentLabel(){const e=this.currentValue();if(!e)return"—";const t=(this.searchedOptions??this.selector.options)?.find(r=>String(r.value)===e);if(t)return t.label;const a=qi()[this.selector.fieldName];return a!==void 0?String(a):e}pick(e,t){bo(this.selector.fieldName,e,t),window.location.reload()}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}openPanel(){this.opened||(this.opened=!0,this.searchText="",this.searchedOptions=void 0,this.remoteSearch(),this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick),this.updateComplete.then(()=>this.renderRoot.querySelector("input.picker-search")?.focus()))}closePanel(){this.detachOutsideClick(),this.opened=!1}onSearchInput(e){this.searchText=e.target.value,this.searchTimer&&clearTimeout(this.searchTimer),this.searchTimer=setTimeout(()=>this.remoteSearch(),300)}async remoteSearch(){const e=this.app;if(e?.serverSideType)try{const t=await Zt.runAction(this.baseUrl??"",e.rootRoute??e.initialRoute??"","",`_appcontext-search-${this.selector.fieldName}`,`appcontext-${this.selector.fieldName}`,void 0,e.serverSideType,{},{searchText:this.searchText},this,!0);for(const a of t?.fragments??[]){const s=a.data?.[`_appcontext_${this.selector.fieldName}`]?.content;if(Array.isArray(s)){this.searchedOptions=s.map(n=>({value:n.value,label:n.label??String(n.value)}));return}}}catch{}}visibleOptions(){const e=this.searchedOptions??this.selector.options??[],t=this.searchText.trim().toLowerCase();return t?e.filter(a=>a.label.toLowerCase().includes(t)):e}renderPanel(){const e=this.currentValue(),t=this.visibleOptions(),a=this.searchText!==""||t.length>Fe.SEARCHABLE_THRESHOLD;return o`
    ...
    `;ja([p()],Jt.prototype,"app",2);ja([p()],Jt.prototype,"baseUrl",2);ja([b()],Jt.prototype,"opened",2);ja([b()],Jt.prototype,"notifications",2);Jt=ja([k("mateu-notification-bell")],Jt);const As=e=>{if(!e||!("querySelectorAll"in e))return null;for(const t of e.querySelectorAll("*")){if(t.tagName?.toLowerCase()==="mateu-component")return t;const a=As(t.shadowRoot);if(a)return a}return null},Qu=async(e,t,a)=>{const r=t.renderRoot??t,i=As(r);await zs.runAction(Zt,t.baseUrl??"",e.rootRoute||"_no_route","",a,i?.id??"app-header-action",{},e.serverSideType??"",{},{},i??t,!0,void 0,!1,"")},yi=async(e,t,a)=>{try{await Qu(e,t,a)}catch(r){Wt({text:"La acción falló: "+r,position:"bottomStart",duration:6e3,variant:"error"},t)}},ka=(e,t)=>{const a=e.contextSelectors??[],r=e.contextActions??[];return a.length===0&&r.length===0&&!e.notificationsEnabled?l:o`${e.notificationsEnabled?o`
        ...
        <details class="mateu-nav-group" style="margin-left: 0.5rem; flex-shrink: 0;">
            ...
            <div class="mateu-nav-panel" style="right: 0; left: auto;">
                ${i.children.map(s=>o`
                    <button class="mateu-nav-item" @click="${()=>s.actionId&&yi(e,t,s.actionId)}">${s.label}</button>`)}
            </div>
        </details>`:o`
        <button class="app-header-action-btn" style="margin-left: 0.5rem; flex-shrink: 0;"
            @click="${()=>i.actionId&&yi(e,t,i.actionId)}" title="${i.label}">${i.icon?j(i.icon):l}${i.label}</button>`)}`},$i=(e,t)=>o`
    <button class="mateu-nav-item ${e.selected?"mateu-nav-item--active":""}"
            ?disabled="${e.disabled}"
            @click="${()=>t(e)}">${e.text}</button>`,xi=(e,t,a="")=>o`
    <nav class="mateu-nav ${a}">
        ${e.map(r=>(r.children?.length??0)>0?o`<details class="mateu-nav-group">
                       ...
                       <div class="mateu-nav-panel">
                           ${r.children.map(i=>$i(i,t))}
                       </div>
                   </details>`:$i(r,t))}
    </nav>`,wi=(e,t)=>a=>t.call(e,{detail:{value:a}}),Ga=(e,t)=>e.themeToggle?o`
        <button class="app-chrome-icon-btn" @click="${t.toggleTheme}"
            ...
            ${j(t.isDark?"vaadin:sun-o":"vaadin:moon","color: var(--lumo-body-text-color);")}
        </button>
    `:l,Zu=(e,t)=>{t.filter!=e.detail.value&&(t.filter=e.detail.value)},ki=(e,t,a)=>{const r=it(e,t,a),i=ie(t,a);return r=="list"||r==i?"new":r},it=(e,t,a)=>{const r=e?._route;if(r!=null&&(r===""||r.startsWith("/"))){const i=a.homeRoute??"",s=i.indexOf("?"),n=s>=0?i.substring(s+1):"",d=ie(t,a)+r;if(!n)return d;const c=d.indexOf("?")>=0?"&":"?";return d+c+n}return t.selectedRoute?t.selectedRoute:a.homeRoute},ie=(e,t)=>e.selectedRoute?e.selectedConsumedRoute??t.route:t.homeConsumedRoute,Be=(e,t)=>e.selectedRoute?e.selectedBaseUrl??e.baseUrl:t.homeBaseUrl,Ve=(e,t)=>e.selectedRoute?e.selectedServerSideType??t.serverSideType:t.homeServerSideType,He=(e,t)=>e.selectedRoute?e.selectedUriPrefix:t.homeUriPrefix,ep=(e,t,a,r,i,s,n)=>{if(t.chromeless)return o`
        ...
        `;const d=e.mapItems(t.menu,e.filter?.toLowerCase()??""),c=ie(e,t),u=ki(r,e,t),m=u&&u!=="new"&&u.startsWith(c+"/")?u.substring(c.length+1).split("/")[0]:void 0;return o`
                    ${t.variant==st.MEDIATOR?o`
...
`:l}
            ${t.variant==st.HAMBURGUER_MENU?o`
                            ...
                            ${t.menu&&t.totalMenuOptions>10?o`
                                <div style="position: sticky; top: 0; z-index: 2; background: var(--lumo-base-color); padding: .25rem 0 .5rem;">
                                    <input class="drawer-search" placeholder="Search…" style="width: calc(100% - 20px); margin: 0 10px;"
                                           @input="${v=>Zu({detail:{value:v.target.value}},e)}">
                                </div>
                                `:l}
                            <nav class="side-nav">
            ...
            ${t.variant==st.MENU_ON_TOP?o`
                <div class="m-vl" style="width: 100%; height: 100vh; overflow: hidden;">
                    <div class="m-hl"
                        ...
                        ${(()=>{const v=wi(e,e.itemSelected);return N.get()?.renderTopNav?.(d,v,"menu-on-top")??xi(d,v,"menu-on-top")})()}
            ...
            ${t.variant==st.TILES?o`
                <div class="m-vl" style="width: 100%; height: 100vh; overflow: hidden;">
                    <div class="m-hl"
                        ...
                        ${xi(e.mapItemsForTiles(t.menu),wi(e,e.itemSelectedTiles),"menu-on-top")}
                        <div class="m-hl" style="flex-shrink: 0; align-items: center;">
                            <slot name="widgets"></slot>
                            ${ka(t,e)}${Ga(t,e)}
                        </div>
            ...
            <slot></slot>
       `},tp=(e,t)=>t!=null&&e!=null&&!e.has(t),ap=typeof HTMLElement<"u"?HTMLElement:class{};class rp extends ap{static get observedAttributes(){return["type","renderer"]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){const t=this.getAttribute("type")??"unknown",a=this.getAttribute("renderer")??"unknown";this.shadowRoot||this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host { display: block; }
                .mateu-unsupported {
                    box-sizing: border-box;
        ...
        `}}typeof customElements<"u"&&!customElements.get("mateu-unsupported")&&customElements.define("mateu-unsupported",rp);const Ci=new Set,ip=(e,t,a)=>{const r=`${a}/${t}`;return Ci.has(r)||(Ci.add(r),console.warn(`[mateu] Component type "${t}" is not supported by the "${a}" renderer — rendering <mateu-unsupported> placeholder.`)),o`<mateu-unsupported
            type="${t}"
            renderer="${a}"
            data-component-id="${e?.id??l}"
            slot="${e?.slot??l}"
    ></mateu-unsupported>`};class sp{renderFilterBar(t,a,r,i,s,n,d,c){const u=a?.metadata,m=f=>{const{fieldId:w,value:x}=f.detail;t.state={...t.state,[w]:x}},v=f=>{const{fieldIds:w}=f.detail,x={};w.forEach(y=>{x[y]=void 0}),x.searchText=void 0,t.state={...t.state,...x}};return o`
            <mateu-filter-bar
                .metadata="${u}"
        ...
        ></mateu-pagination>
        `}renderTableComponent(t,a,r,i,s,n,d){const c=t.data?.[t.id]?.page?.content??[];return Dr(a,c,i[a?.id]?.emptyStateMessage)}rendererName(){return this.constructor?.name??"unknown"}supportedClientSideTypes(){}renderClientSideComponent(t,a,r,i,s,n,d,c){const u=a?.metadata?.type??a?.type,m=Object.values(h).includes(u)?u:void 0;return tp(this.supportedClientSideTypes(),m)?ip(a,m,this.rendererName()):Zr(t,a,r,i,s,n,d,c)}renderAppComponent(t,a,r,i,s,n,d){return ep(t,a?.metadata,r,i,s,n,d)}}const op=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=u=>o`${g(e,u,a,r,i,s,n)}`;return o`
        <vaadin-virtual-list
                ...
                slot="${t.slot??l}"
        ></vaadin-virtual-list>
    `},np=e=>{const t=e.metadata;return o`
        <vaadin-notification
                .opened="${!0}"
                slot="${e.slot??l}"
                style="${e.style}"
                ...
                `,[])}
        ></vaadin-notification>
    `},lp=(e,t={})=>{const a=e.metadata,r=a.valueKey?t[a.valueKey]:a.value;return o`
        <div style="${e.style}">
        <vaadin-progress-bar
    ...
    `},dp=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
        <vaadin-details
                ?opened="${d.opened}"
                style="${t.style}"
                class="${t.cssClasses}"
        ...
        >
            ...
            `},cp=(e,t,a)=>{const r=e.metadata;return o`<vaadin-avatar
            img="${r.image}"
            name="${Oe(r.name,t,a)}"
            abbr="${r.abbreviation}"
            style="${e.style}" class="${e.cssClasses}"
            slot="${e.slot??l}"
    ></vaadin-avatar>`},up=e=>{const t=e.metadata;return o`<vaadin-avatar-group max-items-visible="${t.maxItemsVisible}"
                                     .items="${t.avatars}"
                                     style="${e.style}" class="${e.cssClasses}"
                                     slot="${e.slot??l}">
    </vaadin-avatar-group>`},pp=(e,t,a,r,i,s,n)=>{const d=t.metadata;if(!d)return o``;let c="";return d.variants?.map(u=>u=="stretchMedia"?"stretch-media":u=="coverMedia"?"cover-media":u).forEach(u=>c+=" "+u),c=c.trim(),o`
        <vaadin-card
                style="${t.style}"
                class="${t.cssClasses}"
                theme="${c}"
                slot="${t.slot??l}"
        >
            ${d.media?Ft(e,d.media,a,r,i,s,n,"media",!1):l}
            ${d.title?Ft(e,d.title,a,r,i,s,n,"title",!1):l}
            ${d.subtitle?Ft(e,d.subtitle,a,r,i,s,n,"subtitle",!1):l}
            ${d.header?Ft(e,d.header,a,r,i,s,n,"header",!1):l}
            ${d.headerPrefix?Ft(e,d.headerPrefix,a,r,i,s,n,"header-prefix",!1):l}
            ${d.headerSuffix?Ft(e,d.headerSuffix,a,r,i,s,n,"header-suffix",!1):l}
            ${d.footer?Ft(e,d.footer,a,r,i,s,n,"footer",!1):l}
            ${d.content?g(e,d.content,a,r,i,s,n,!1):l}
        </vaadin-card>
    `},hp=640,mp=e=>e>0&&e<hp?"accordion":"tabs";var vp=Object.defineProperty,fp=Object.getOwnPropertyDescriptor,Cr=(e,t,a,r)=>{for(var i=r>1?void 0:r?fp(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&vp(t,a,i),i};let pa=class extends C{constructor(){super(...arguments),this.tabLabels=[],this.mode="tabs",this.selected=0,this.selectedChangedListener=e=>{const t=e.detail?.value;typeof t=="number"&&t>=0&&(this.selected=t)}}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{for(const t of e)this.mode=mp(t.contentRect.width)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.resizeObserver=void 0,this.detachTabsListener()}detachTabsListener(){this.slottedTabs?.removeEventListener("selected-changed",this.selectedChangedListener),this.slottedTabs=void 0}tabsSlotChanged(e){this.detachTabsListener();const a=e.target.assignedElements().find(r=>"selected"in r);a&&(this.slottedTabs=a,a.addEventListener("selected-changed",this.selectedChangedListener),a.selected=this.selected)}select(e){this.selected=e,this.slottedTabs&&(this.slottedTabs.selected=e)}updated(){this.slottedTabs&&this.slottedTabs.selected!=this.selected&&(this.slottedTabs.selected=this.selected)}render(){return o`
    ...
    `;Cr([p({type:Array})],pa.prototype,"tabLabels",2);Cr([b()],pa.prototype,"mode",2);Cr([b()],pa.prototype,"selected",2);pa=Cr([k("mateu-adaptive-tabs")],pa);const bp=(e,t,a,r,i,s,n)=>{const d=t.metadata;let c=t.style;c==null&&(c=""),d.columnSpacing&&(c+="--vaadin-form-layout-column-spacing: "+d.columnSpacing+";");const u=d.itemRowSpacing&&d.itemRowSpacing!=="0"?d.itemRowSpacing:"var(--lumo-space-m)";return c+="--vaadin-form-layout-row-spacing: "+u+";",d.itemLabelSpacing&&(c+="--vaadin-form-layout-label-spacing: "+d.itemLabelSpacing+";"),d.labelsAside&&(c+="--vaadin-form-item-label-width: 10rem;"),d.fullWidth&&(c+="width: 100%;"),o`
               <vaadin-form-layout 
                       ...
                       slot="${t.slot||l}"
               >
                   ${t.children?.map(m=>Ds(d,e,m,a,r,i,s,n))}
               </vaadin-form-layout>
            `},Ds=(e,t,a,r,i,s,n,d)=>a.type==W.ClientSide&&a.metadata?.type==h.FormRow?yp(e,t,a,r,i,s,n,d):e.labelsAside?gp(t,a,r,i,s,n,d):g(t,a,r,i,s,n,d),gp=(e,t,a,r,i,s,n)=>{if(t.type==W.ClientSide&&t.metadata?.type==h.FormField&&t.metadata.label){const d=t.metadata,c=d.label?.includes("${")?e._evalTemplate(d.label):d.label;return o`
                       <vaadin-form-item data-colspan="${d.colspan}">
                           <label slot="label">${c}</label>
                           ${g(e,t,a,r,i,s,n,!0)}
                       </vaadin-form-item>
                   `}return g(e,t,a,r,i,s,n)},yp=(e,t,a,r,i,s,n,d)=>o`
        <vaadin-form-row>
            ${a.children?.map(c=>Ds(e,t,c,r,i,s,n,d))}
        </vaadin-form-row>
            `,$p=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=(d.padding?" padding":"")+(d.spacing?" spacing":"")+(d.spacingVariant?" spacing-"+d.spacingVariant:"")+(d.wrap?" wrap":"");let u=t.style;return d.fullWidth&&(u=u?"width: 100%;"+u:"width: 100%;"),d.justification&&(u=u?"justify-content: "+d.justification+";"+u:"justify-content: "+d.justification+";"),d.verticalAlignment&&(u=u?"align-items: "+d.verticalAlignment+";"+u:"align-items: "+d.verticalAlignment+";"),o`
               <vaadin-horizontal-layout 
                       style="${u}" 
                       class="${t.cssClasses}"
                       theme="${c}"
    ...
    `},wp=(e,t,a,r,i,s,n)=>{const d=t.metadata;let c=t.style;return d.fullWidth&&(c=c?"width: 100%;"+c:"width: 100%;"),o`
               <vaadin-split-layout 
                       style="${c}" 
                       class="${t.cssClasses}"
            ...
            `},kp=(e,t,a,r,i,s,n)=>{const d=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,u=!!i?.hasDetail||!!d,m=c??d;return o`
        ...
        >
            ...
            ${t.children?.map(f=>_p(e,f,a,r,i,s,n))}
        </vaadin-tabsheet>
            `},_p=(e,t,a,r,i,s,n)=>{const d=t.metadata.label,c=d?.includes("${")?e._evalTemplate(d):d;return o`
        <div tab="${c}" style="padding: var(--lumo-space-m) 0;">
                   ${t.children?.map(u=>g(e,u,a,r,i,s,n))}
               </div>
            `},Ip=(e,t,a,r,i,s,n)=>{const d=t.metadata;t.style,d.fullWidth;let c=0;if(t.children){for(let u=0;u<t.children.length;u++)if(t.children[u].metadata?.active){c=u;break}}return o`
               <vaadin-accordion
                       style="${t.style}"
                       class="${t.cssClasses}"
                       opened="${c}"
                       slot="${t.slot??l}"
               >
                   ${t.children?.map(u=>Sp(e,u,a,r,i,s,n,d.variant))}
               </vaadin-accordion>
            `},Sp=(e,t,a,r,i,s,n,d)=>{const c=t.metadata,u=c.label?.includes("${")?e._evalTemplate(c.label):c.label;return o`
        ...
        <vaadin-board-row style="${t.style}" class="${t.cssClasses}">
            ...
            `,zp=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
        <div style="${t.style}" 
             class="${t.cssClasses}"
    ...
    </vaadin-menu-bar>`,Rp=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
        <vaadin-context-menu .items=${ai(e,d.menu,a,r,i,s,n)} 
                             style="${t.style}" 
                             class="${t.cssClasses}"
            ...
            `},Lp=(e,t,a,r,i)=>{const s=t.metadata;return o`
        <vaadin-menu-bar .items=${ai(e,s.options,a,r,i,G,_a)}
                         style="${t.style}" class="${t.cssClasses}"
                         slot="${t.slot??l}">
        </vaadin-menu-bar>
            `},_i=(e,t,a,r,i,s,n)=>{const d=document.createElement("vaadin-context-menu-item");return Li(g(e,t,a,r,i,s,n),d),d},ai=(e,t,a,r,i,s,n)=>t.map(d=>d.submenus?{text:d.component?void 0:d.label,route:d.path,checked:d.selected,disabled:d.disabled,className:d.className,component:d.component?_i(e,d.component,a,r,i,s,n):void 0,children:ai(e,d.submenus,a,r,i,s,n)}:d.separator?{component:"hr"}:{text:d.component?void 0:d.label,route:d.path,checked:d.selected,disabled:d.disabled,className:d.className,component:d.component?_i(e,d.component,a,r,i,s,n):void 0});var Ap=Object.defineProperty,Dp=Object.getOwnPropertyDescriptor,Ba=(e,t,a,r)=>{for(var i=r>1?void 0:r?Dp(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Ap(t,a,i),i};let Xt=class extends C{constructor(){super(...arguments),this.fieldId="",this.signing=!1,this.hasStrokes=!1,this.drawing=!1,this.startStroke=e=>{const t=e.target;this.ensureCanvasSize(t),t.setPointerCapture(e.pointerId),this.drawing=!0;const a=t.getContext("2d");a.lineWidth=2,a.lineCap="round",a.lineJoin="round",a.strokeStyle=getComputedStyle(this).getPropertyValue("--lumo-body-text-color")||"#1a1a1a";const[r,i]=this.pointerPosition(e);a.beginPath(),a.moveTo(r,i),e.preventDefault()},this.stroke=e=>{if(!this.drawing)return;const a=e.target.getContext("2d"),[r,i]=this.pointerPosition(e);a.lineTo(r,i),a.stroke(),this.hasStrokes=!0,e.preventDefault()},this.endStroke=e=>{this.drawing=!1,e.target.releasePointerCapture(e.pointerId)}}emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e,fieldId:this.fieldId},bubbles:!0,composed:!0}))}canvas(){return this.renderRoot.querySelector("canvas")}pointerPosition(e){const a=e.target.getBoundingClientRect();return[e.clientX-a.left,e.clientY-a.top]}ensureCanvasSize(e){const t=e.getBoundingClientRect();(e.width!==Math.round(t.width)||e.height!==Math.round(t.height))&&(e.width=Math.round(t.width),e.height=Math.round(t.height))}clear(){const e=this.canvas();e&&e.getContext("2d").clearRect(0,0,e.width,e.height),this.hasStrokes=!1}accept(){const e=this.canvas();!e||!this.hasStrokes||(this.signing=!1,this.emit(e.toDataURL("image/png")))}renderPad(){return o`
            <canvas class="pad"
    ...
    `;Va([p()],Qt.prototype,"fieldId",2);Va([p()],Qt.prototype,"value",2);Va([b()],Qt.prototype,"cameraOpen",2);Va([b()],Qt.prototype,"cameraError",2);Qt=Va([k("mateu-camera-capture")],Qt);var Up=Object.defineProperty,jp=Object.getOwnPropertyDescriptor,Ha=(e,t,a,r)=>{for(var i=r>1?void 0:r?jp(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Up(t,a,i),i};const Bp=(e,t)=>{if(!e)return;if(Array.isArray(e)){const r=e.find(i=>i.key==t);return r?.value!=null?String(r.value):void 0}const a=e[t];return a!=null?String(a):void 0};let Ct=class extends C{constructor(){super(...arguments),this.fieldId="",this.editable=!0,this.filePicked=e=>{const t=e.target,a=t.files?.[0];if(!a)return;const r=new FileReader;r.onload=()=>{const i=r.result,s=i.indexOf(","),n=i.substring(0,s).replace(";base64",`;name=${encodeURIComponent(a.name)};base64`);this.emit(n+i.substring(s))},r.readAsDataURL(a),t.value=""}}static fileName(e){if(!e)return"";if(e.startsWith("data:")){const t=e.indexOf(","),r=e.substring(5,t<0?e.length:t).split(";").find(i=>i.startsWith("name="));if(r)try{return decodeURIComponent(r.substring(5))}catch{return r.substring(5)}return"Attached file"}return e.split("/").pop()||e}emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e,fieldId:this.fieldId},bubbles:!0,composed:!0}))}triggerPick(){this.renderRoot.querySelector("input[type=file]")?.click()}render(){const e=this.value!=null&&this.value!=="",t=Ct.fileName(this.value),a=e&&this.value.startsWith("data:"),r=e?o`<span class="file" title="${t}">📄 ${a?o`<a href="${this.value}" download="${t}">${t}</a>`:o`<a href="${this.value}" target="_blank">${t}</a>`}</span>`:l;return this.editable?o`
            ...
            </div>`:o`${e?r:o`<span class="empty">—</span>`}`}};Ct.styles=$`
        :host {
            display: block;
        }
        .row {
    ...
    `;Ha([p()],Ct.prototype,"fieldId",2);Ha([p()],Ct.prototype,"value",2);Ha([p()],Ct.prototype,"accept",2);Ha([p({type:Boolean})],Ct.prototype,"editable",2);Ct=Ha([k("mateu-file-upload")],Ct);const Ka=e=>!!e&&typeof e=="object"&&"__mateuGroup"in e,Tr=e=>String(e??""),Vp=(e,t,a)=>{const r=e??[];if(!t||!a||a.length===0)return r;const i=[];let s,n=!1;return r.forEach((d,c)=>{const u=Tr(d?.[t]);if(!n||u!==s){const m=a.find(v=>Tr(v.value)===u)??{value:u,count:r.filter(v=>Tr(v?.[t])===u).length,aggregates:{}};i.push({__mateuGroup:m,__mateuGroupBy:t,_rowNumber:`__mateuGroup:${c}:${u}`}),n=!0,s=u}i.push(d)}),i},Fs=(e,t)=>e==null?"":t.dataType==="money"||t.stereotype==="money"?new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(e):t.aggregate==="count"?new Intl.NumberFormat(void 0,{maximumFractionDigits:0}).format(Math.round(e)):new Intl.NumberFormat(void 0,{maximumFractionDigits:2}).format(e),Hp=(e,t)=>e&&t.includes(e)?e:t.find(a=>!!a),Wp=(e,t,a)=>{const r=e.__mateuGroup;return t.id===a?`${r.value} (${r.count})`:t.aggregate?Fs(r.aggregates?.[t.id],t):""},Gp=(e,t,a)=>{const r=t?.aggregates;if(!r||!e.some(n=>n.aggregate))return;const i={};e.forEach(n=>{n.aggregate&&r[n.id]!=null&&(i[n.id]=Fs(r[n.id],n))});const s=e[0];if(s&&i[s.id]===void 0){const n=t?.page?.totalElements;i[s.id]=a&&s.id===a&&n!=null?`Total (${n})`:"Total"}return i},Kp=(e,t,a)=>{const i=e[a.path]?"vaadin:check":"vaadin:minus";return j(i,"height: 16px; width: 16px; color: var(--lumo-body-text-color);")},Yp=(e,t,a,r,i)=>{const s=e[a.path];let n=s;return r=="money"&&s&&s.locale&&s.currency?n=new Intl.NumberFormat(s.locale,{style:"currency",currency:s.currency}).format(s.value):i=="money"&&(n=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(s)),o`${n}`},Ii=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},Jp=(e,t,a,r,i,s)=>{const n=a.xcolumn??s;if(n.text){if(n.actionId)return o`<a href="javascript: void(0);" @click="${u=>Ii(a,n,e)}">${n.text}</a>`;const c=e[a.path];return o`<a href="${c}">${n.text}</a>`}if(r=="string"){if(n.actionId){const u=e[a.path];return o`<a href="javascript: void(0);" @click="${m=>Ii(a,n,e)}">${u}</a>`}const c=e[a.path];return o`<a href="${c}">${c}</a>`}const d=e[a.path];return o`<a href="${d.href}">${d.text}</a>`},Xp=(e,t,a,r,i)=>{const s=e[a.path];return r=="string"?s.split(",").map(n=>j(n,"width: 16px;")):s.split(",").map(n=>j(n.icon,"width: 16px;"))},Qp=(e,t,a,r,i)=>{const s=e[a.path];return o`${ye(s)}`},Zp=(e,t,a,r,i,s)=>{if(r=="string"){const d=e[a.path],c="max-height: 40px; "+(s.style??"");return o`<img src="${d}" style="${c}">`}const n=e[a.path];return o`<img src="${n.src}" style="${s.style??""}">`},eh=e=>{const t={_clickedRow:e.target.row};e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-"+e.detail.value.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},Si=e=>{const t={_clickedRow:e.target.row},a=e.target.action;e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-"+a.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},th=e=>{const t=document.createElement("vaadin-context-menu-item"),a=document.createElement("vaadin-icon");return a.style.color="var(--lumo-secondary-text-color)",a.style.marginInlineEnd="var(--lumo-space-s)",a.style.padding="var(--lumo-space-xs)",a.setAttribute("icon",e.icon),t.appendChild(a),e.label&&t.appendChild(document.createTextNode(e.label)),t.disabled=e.disabled,t},Ei=(e,t,a)=>{const r=e[a.path]?.actions?.map(i=>i.icon?{component:th(i),methodNameInCrud:i.methodNameInCrud}:{...i,text:i.label});return!r||r.length==0?o``:o`
                                     <vaadin-menu-bar
                                         ...
                                         @item-selected="${eh}"
                                     ></vaadin-menu-bar>
                                   `},ah=(e,t,a)=>{if(a.path=="select"){const s={actionId:a.path,icon:"",label:"Select",disabled:!1,methodNameInCrud:"select"};return o`
         <vaadin-button theme="tertiary" title="Select" @click="${Si}" .row="${e}" .action="${s}">
             Select
         </vaadin-button>
    `}const r=a.path&&e[a.path]?.methodNameInCrud?e[a.path]:e.action;if(!r)return o``;const i=r.icon&&!r.label;return o`
         <vaadin-button theme="tertiary${i?" icon":""}" title="${r.label||l}" @click="${Si}" .row="${e}" .action="${r}">
             ${r.icon?o`<vaadin-icon icon="${r.icon}"></vaadin-icon>`:l}
             ${r.label?r.label:l}
         </vaadin-button>
    `},rh=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},ih=(e,t,a,r,i,s)=>{const n=a.xcolumn??s;if(n.actionId){const c=n.text||e[a.path];return o`
            <vaadin-button theme="tertiary" @click="${u=>rh(a,n,e)}" .row="${e}">
                ${c}
            </vaadin-button>
        `}const d=e[a.path];return o`<a href="${d}">${n.text||d}</a>`},sh=(e,t,a,r,i,s,n,d,c)=>{const u=e[a.path];return g(r,u,i,s,n,d,c)},Nr=new WeakMap,oh=(e,t)=>Nr.get(e)?.[t],nh=(e,t,a)=>{let r=Nr.get(e);r||(r={},Nr.set(e,r)),r[t]=a},Pi=e=>{if(e==null||e==="")return null;const t=Number(e);return Number.isNaN(t)?null:t},lh=(e,t,a,r)=>{const i=a?.field?.fieldId,s=c=>{if(e[t.id]===c||e[t.id]==null&&(c===""||c==null))return;if(e[t.id]=c,!i){a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"update-row",parameters:{_editedRow:{...e}}},bubbles:!0,composed:!0}));return}const m=(a?.state??r)[i];a.dispatchEvent(new CustomEvent("value-changed",{detail:{fieldId:i,value:Array.isArray(m)?[...m]:m},bubbles:!0,composed:!0}))},n=e[t.id],d=n==null?"":String(n);switch(t.editorType){case"boolean":return o`<vaadin-checkbox ?checked=${!!n} @checked-changed=${c=>s(c.detail.value)}></vaadin-checkbox>`;case"integer":return o`<vaadin-integer-field theme="small" style="width:100%;" .value=${d} @change=${c=>s(Pi(c.target.value))}></vaadin-integer-field>`;case"number":return o`<vaadin-number-field theme="small" style="width:100%;" .value=${d} @change=${c=>s(Pi(c.target.value))}></vaadin-number-field>`;case"date":return o`<vaadin-date-picker theme="small" style="width:100%;" .value=${d} @value-changed=${c=>s(c.detail.value)}></vaadin-date-picker>`;case"time":return o`<vaadin-time-picker theme="small" style="width:100%;" .value=${d} @value-changed=${c=>s(c.detail.value)}></vaadin-time-picker>`;case"datetime":return o`<vaadin-date-time-picker theme="small" style="width:100%;" .value=${d} @value-changed=${c=>s(c.detail.value)}></vaadin-date-time-picker>`;case"select":return o`<vaadin-combo-box
                ...
                .value=${d}
                @value-changed=${c=>s(c.detail.value)}></vaadin-combo-box>`;case"lookup":{const c=a?.field?.fieldId,u=`search-${c}-${t.id}`,m=`${c}-${t.id}`,f=(t.editorOptions??[]).find(x=>String(x.value)===d)??(d?{value:d,label:oh(e,t.id)??d}:void 0);return o`<vaadin-combo-box
                theme="small" style="width:100%;"
                ...
                .selectedItem=${f}
                @selected-item-changed=${x=>{const y=x.detail.value,S=y?y.value:null;String(S??"")!==d&&(y&&nh(e,t.id,y.label),s(S))}}></vaadin-combo-box>`}default:return o`<vaadin-text-field theme="small" style="width:100%;" .value=${d} @change=${c=>s(c.target.value)}></vaadin-text-field>`}},zr=e=>ao(()=>o`<span title="${e}" style="white-space:normal;overflow-wrap:break-word;">${e}</span>`,[e]),Or=e=>e!==void 0?ro(()=>o`<span style="font-weight: 600; white-space: nowrap;">${e}</span>`,[e]):l,dh=e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget?.dispatchEvent(new CustomEvent("sort-direction-changed",{detail:{grid:e.currentTarget.parentElement},bubbles:!0,composed:!0}))},ch=(e,t,a,r,i,s,n,d)=>{const c=$e(e.label,r,i);return o`
<vaadin-grid-column-group header="${c}">
    ${e.columns.map(u=>qs(u.metadata,t,a,r,i,s,n,d?.[u.metadata?.id]))}
</vaadin-grid-column-group>
`},ri=(e,t,a,r,i,s,n,d)=>h.GridGroupColumn==e.metadata?.type?ch(e.metadata,t,a,r,i,s,n,d):qs(e.metadata,t,a,r,i,s,n,d?.[e.metadata?.id]),qs=(e,t,a,r,i,s,n,d)=>{const c=$e(e.label,r,i);return e.sortable?o`
            ...
            <vaadin-grid
                    ...
                    ${E(this.field?.detailPath?Oi(a=>o`${g(this,a[this.field?.detailPath],this.baseUrl,this.state,this.data,this.appState,this.appData)}`):void 0)}
            ...
            >
                ...
                `}
                ${this.field?.columns?.map(a=>ri(a,this,this.baseUrl,this.state,this.data,this.appState,this.appData))}
    ...
    `;Rt([p()],Xe.prototype,"field",2);Rt([p()],Xe.prototype,"state",2);Rt([p()],Xe.prototype,"data",2);Rt([p()],Xe.prototype,"appState",2);Rt([p()],Xe.prototype,"appData",2);Rt([p()],Xe.prototype,"selectedItems",2);Rt([b()],Xe.prototype,"detailsOpenedItems",2);Xe=Rt([k("mateu-grid")],Xe);var vh=Object.defineProperty,fh=Object.getOwnPropertyDescriptor,xa=(e,t,a,r)=>{for(var i=r>1?void 0:r?fh(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&vh(t,a,i),i};let _t=class extends C{constructor(){super(...arguments),this.getNewValue=e=>{if(this.field?.dataType=="array"){if(!this.value)return[e];const t=this.value;return t.indexOf(e)>=0?t.filter(a=>a!==e):[...t,e]}return e}}render(){let e=this.field?.options;if(this.field?.remoteCoordinates){const a=this.field.remoteCoordinates;this.data?.[this.field.fieldId]&&this.data[this.field.fieldId].content&&this.data[this.field.fieldId].totalElements?e=this.data[this.field.fieldId].content:this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a.action,parameters:{searchText:"",fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0}))}const t=this.field?.attributes?.divStyle;return o`
...
`,this.comboRenderer=e=>o`
        ...
        `:l}
                            ...
                            `:e.label}
`,this.filteredIcons=[],this.navLinkOffset=null,this.iconFilterChanged=e=>{this.filteredIcons=Ti.filter(t=>!e.detail.value||t.indexOf(e.detail.value)>=0)}}loadUi5FieldComponents(){this.ui5FieldComponentsReady||xh().then(()=>{this.ui5FieldComponentsReady=!0})}remoteComboDataProvider(e){return(t,a)=>{const{filter:r,page:i,pageSize:s}=t,n=r??"";this._comboFilter=n,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e,parameters:{searchText:r,fieldId:this.field?.fieldId,size:s,page:i,sort:void 0},callback:d=>{if(n===this._comboFilter)if(d?.messages?.forEach(c=>{Ja.show(c.text,{position:c.position?this.mapPosition(c.position):void 0,theme:c.variant,duration:c.duration})}),!d.fragments||d.fragments.length==0)this.comboData=[],a([],0);else{const c=d.fragments[0].data?.[this.id];this.comboData=c?.content,a(c?.content,c?.totalElements)}},callbackonly:!0},bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.rendered=!1}renderNavLink(){const e=this.field?.link;if(!e?.href)return l;const t=$e(e.href,this.state,this.data)??e.href,a=$e(e.title,this.state,this.data)||t,r=e.icon||(t.startsWith("http")?"vaadin:external-link":"vaadin:link"),i=this.navLinkOffset??"calc(var(--lumo-font-size-s) * 1.6 + (var(--lumo-size-m) - var(--lumo-icon-size-s)) / 2)";return o`<a
                data-navlink
                href="${t}"
                title="${a}"
...
`}copyValue(e){navigator.clipboard.writeText(e).then(()=>Ja.show("Copied",{position:"bottom-end",theme:"success",duration:2e3})).catch(()=>{})}renderFileField(e,t,a,r){if(!this.field)return o``;const i=t?.map(s=>({id:s.id,name:s.name,type:"",uploadTarget:"",complete:!0}))??[];return o`
                <vaadin-custom-field
                        label="${a}"
                        .helperText="${this.helperText()}"
                        data-colspan="${this.field.colspan}"
            ...
            `}renderStringField(e,t,a,r){if(!this.field)return o``;if(this.field?.stereotype=="searchable"){const i=n=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"code-"+this.field?.fieldId,parameters:{code:n.currentTarget.value}},bubbles:!0,composed:!0}))},s=n=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"codesearch-"+this.field?.fieldId,parameters:{}},bubbles:!0,composed:!0}))};return o`
              ...
              ${i.description}
                ...
                `;if(this.field?.stereotype=="fileUpload"){const i=Bp(this.field.attributes,"accept");return o`
                    <vaadin-custom-field
                            id="${this.field.fieldId}"
                            label="${a}"
                            .helperText="${this.helperText()}"
  ...
  ${zi(this.renderColorPicker,[])}
  ${io(this.renderColorPickerFooter,[])}
></vaadin-dialog>
                `:o`
                <vaadin-text-field
                        id="${this.field.fieldId}"
...
`;if(this.field?.stereotype=="listBox"){if(this.field?.remoteCoordinates){const i=this.field.remoteCoordinates,s="";return this.data[this.id]&&(this.data[this.id].searchSignature||s)&&this.data[this.id].searchSignature!=s&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements||this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:i.action,parameters:{searchText:s,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0})),o`
            ...
            ></mateu-money-field>`}renderStatusField(e,t,a,r){if(!this.field)return o``;const i=t;return o`
                <vaadin-custom-field
                        ...
                        data-colspan="${this.field.colspan}"
                >
                    ${i?o`<span theme="badge pill ${$r(i.type)}">${i.message}</span>`:o``}                    
                </vaadin-custom-field>
  ...
  `;ce([b()],Y.prototype,"ui5FieldComponentsReady",2);ce([p()],Y.prototype,"component",2);ce([p()],Y.prototype,"field",2);ce([p()],Y.prototype,"baseUrl",2);ce([p()],Y.prototype,"state",2);ce([p()],Y.prototype,"data",2);ce([p()],Y.prototype,"appState",2);ce([p()],Y.prototype,"appData",2);ce([p()],Y.prototype,"labelAlreadyRendered",2);ce([b()],Y.prototype,"colorPickerOpened",2);ce([b()],Y.prototype,"colorPickerValue",2);ce([b()],Y.prototype,"filteredIcons",2);ce([b()],Y.prototype,"navLinkOffset",2);Y=ce([k("mateu-field")],Y);const wh=(e,t,a,r,i,s,n,d)=>{const c=t.metadata;return o`
    ...
    `},kh=(e,t,a,r,i,s,n)=>{const d=t.metadata;if(d.tree){const u=async(m,v)=>{const f=m.parentItem?m.parentItem.children:d.page.content;v(f,f.length)};return o`
        ...
        >
            ...
            <vaadin-grid-column path="${m.id}"
                                ...
                                width="${f?.width??l}"
                                .column="${m.metadata}"
                                ${ot((w,x,y)=>Ya(w,x,y,f,e,a,r,i,s,n),[])}></vaadin-grid-column>
`:o`
...
`})}
    ...
    `};var Ch=Object.defineProperty,_h=Object.getOwnPropertyDescriptor,qe=(e,t,a,r)=>{for(var i=r>1?void 0:r?_h(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Ch(t,a,i),i};let ve=class extends C{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.detailsOpenedItems=[],this.pagesRequested=[],this.emptyArray=e=>!e||e.length==0,this.dataProvider=(e,t)=>{const a=this.data[this.id]?.page;if(this.metadata?.infiniteScrolling&&e.page>0){let r=!1;a&&a.content&&(a.content.length>=(e.page+1)*e.pageSize||a.content.length==a.totalElements)&&(t(a.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),a.totalElements),r=!0,this.grid&&this.grid.recalculateColumnWidths()),r||this.pagesRequested.find(i=>i==e.page)||(this.pagesRequested.push(e.page),this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:e,callback:()=>{this.data[this.id]?.page?.content&&(t(this.data[this.id].page.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),this.data[this.id].page.totalElements),this.grid&&this.grid.recalculateColumnWidths())}},bubbles:!0,composed:!0})))}else{const r=this.metadata?.infiniteScrolling?a?.totalElements:a?.content?.length??0;t(a?.content??[],r),this.grid&&this.grid.recalculateColumnWidths()}},this._onActionRequested=e=>{const t=e.detail,a=this.identifierFieldName;if(!a||!t.parameters||t.actionId?.startsWith("action-on-row-"))return;const r=t.parameters[a];r!==void 0&&(this.state._selectedId=String(r),this._applyCellPartNameGenerator(),this.grid?.requestContentUpdate())},this.tooltipGenerator=e=>{let t="";const{column:a,item:r}=e,i=this.metadata?.columns?.find(s=>s.metadata.id==a?.path);if(i?.metadata){const s=(i?.metadata).tooltipPath;s&&a&&r&&(t=r[s])}return t}}get identifierFieldName(){const e=this.metadata?.columns?.find(a=>a.metadata?.identifier);if(e)return e.metadata?.id;if(this.metadata?.columns?.find(a=>a.metadata?.id==="id"))return"id"}_applyCellPartNameGenerator(){if(!this.grid)return;const e=this.identifierFieldName,t=this.state?._selectedId??this.appState?._splitDetailId,a=!!this.metadata?.groupBy;e&&t!==void 0||a?this.grid.cellPartNameGenerator=(r,i)=>{const s=i.item;return Ka(s)?"mateu-group-row":e&&t!==void 0&&String(s[e])===String(t)?"selected-row":""}:this.grid.cellPartNameGenerator=null}connectedCallback(){super.connectedCallback(),this.addEventListener("action-requested",this._onActionRequested)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("action-requested",this._onActionRequested)}updated(e){super.updated(e),this._applyCellPartNameGenerator(),this.grid?.clearCache(),this.grid?.requestContentUpdate(),this.grid?.recalculateColumnWidths(),this.pagesRequested=[]}render(){const e=this.data[this.id],t=e?.page,a=this.metadata?.groupBy,r=this.metadata?.infiniteScrolling?void 0:t?.content?Vp(t.content,a,e?.groups):t?.content,i=(this.metadata?.columns??[]).flatMap(c=>c.metadata?.type===h.GridGroupColumn?(c.metadata.columns??[]).map(u=>u.metadata):[c.metadata]),s=Gp(i,e,a);let n="";this.metadata?.wrapCellContent&&(n+=" wrap-cell-content"),this.metadata?.compact&&(n+=" compact"),this.metadata?.noBorder&&(n+=" no-border"),this.metadata?.noRowBorder&&(n+=" no-row-borders"),this.metadata?.columnBorders&&(n+=" column-borders"),this.metadata?.rowStripes&&(n+=" row-stripes");const d=this.state[this.id+"_selected_items"]||[];return o`
            <vaadin-grid
                    ...
                    .detailsOpenedItems="${this.detailsOpenedItems}"
                    ${E(this.metadata?.detailPath?Oi(c=>o`${g(this,c[this.metadata?.detailPath],this.baseUrl,this.state,this.data,this.appState,this.appData)}`):void 0)}
                    theme="${n}"
            ...
            >
                ...
                `:l}
                ${this.metadata?.columns?.map(c=>ri(c,this,this.baseUrl,this.state,this.data,this.appState,this.appData,s))}
                ${this.metadata?.useButtonForDetail?o`
                    <vaadin-grid-column
                            width="44px"
                            flex-grow="0"
                            ${ot((c,{detailsOpened:u})=>o`
              <vaadin-button
                theme="tertiary icon"
  ...
  `;qe([p()],ve.prototype,"id",2);qe([p()],ve.prototype,"metadata",2);qe([p()],ve.prototype,"baseUrl",2);qe([p()],ve.prototype,"state",2);qe([p()],ve.prototype,"data",2);qe([p()],ve.prototype,"appState",2);qe([p()],ve.prototype,"appData",2);qe([p()],ve.prototype,"emptyStateMessage",2);qe([b()],ve.prototype,"detailsOpenedItems",2);qe([ee("vaadin-grid")],ve.prototype,"grid",2);ve=qe([k("mateu-table")],ve);const Ih=(e,t,a,r,i,s,n)=>o`
    ...
    <mateu-table id="${e.id}"
                 ...
                 baseUrl="${a}"
    ></mateu-table>`,Eh=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
        ...
        <vaadin-popover
                ...
                content-width="300px"
                position="bottom"
                ${Ri(()=>o`${g(e,d.content,a,r,i,s,n)}`,[])}
                style="${t.style}" class="${t.cssClasses}"
        ></vaadin-popover>
    `},Ph=(e,t,a)=>{const r=e;return o`
        <vaadin-button
                data-action-id="${r.id}"
                theme="${ji(e)||l}"
                @click="${a}"
    ...
    <div style="display: flex; gap: var(--lumo-space-xs, .25rem); align-items: center;" class="peer-nav">
        ...
        <vaadin-button theme="tertiary icon" class="peer-nav-next" title="${e.nextLabel??"Next"}"
    ...
    </div>`,zh=(e,t,a)=>o`<vaadin-icon icon="${e}" style="${t??l}" class="${a??l}"></vaadin-icon>`,Oh=(e,t,a)=>{const r=e.metadata,i=$e(r.label,t,a);let s="";return r.buttonStyle&&(s+=" "+r.buttonStyle),r.color&&r.color!=="none"&&r.color!=="normal"&&(s+=" "+r.color),r.size&&r.size!=="none"&&r.size!=="normal"&&(s+=" "+r.size),o`<vaadin-button
            id="${e.id}"
            data-action-id="${r.actionId}"
            @click="${n=>ts(n,r)}"
            style="${e.style}"
            ...
            title="${r.shortcut?`${i} (${es(r.shortcut)})`:l}"
            slot="${e.slot??l}"
    >${r.iconOnLeft?o`<vaadin-icon icon="${r.iconOnLeft}"></vaadin-icon>`:l}${i}${r.iconOnRight?o`<vaadin-icon icon="${r.iconOnRight}"></vaadin-icon>`:l}</vaadin-button>`},Rh=e=>{const t=e.metadata,a=r=>{const i=r.detail?.value??"";!t.actionId||!i.trim()||r.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:{message:i}},bubbles:!0,composed:!0}))};return o`
        <vaadin-message-input
                style="${e.style}" class="${e.cssClasses}"
                slot="${e.slot??l}"
                @submit="${a}"
        ></vaadin-message-input>
    `},Lh=e=>{const a=(e.metadata.items??[]).map(r=>({text:r.text,time:r.time,userName:r.userName,userImg:r.userImg,userAbbr:r.userAbbr,userColorIndex:r.userColorIndex}));return o`
        <vaadin-message-list
                markdown
                style="${e.style}" class="${e.cssClasses}"
                slot="${e.slot??l}"
                .items="${a}"
        ></vaadin-message-list>
    `},Lr=(e,t)=>{e&&e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},Ah=(e,t,a,r,i,s,n)=>{const d=t.metadata;let c=!1;if(d.openedCondition)try{c=Br(d.openedCondition,r,i,s,n)}catch(u){console.error("when evaluating "+d.openedCondition+" :"+u+", where data is "+i+" and state is "+r)}return o`
    ...
    `;rt([p({type:Array})],Ie.prototype,"panels",2);rt([p({type:String})],Ie.prototype,"headerTitle",2);rt([p({type:Array})],Ie.prototype,"badges",2);rt([p({attribute:!1})],Ie.prototype,"navigation",2);rt([p({type:String})],Ie.prototype,"overviewEditActionId",2);rt([ee(".rail")],Ie.prototype,"_rail",2);rt([ee(".section--first")],Ie.prototype,"_first",2);rt([b()],Ie.prototype,"_less",2);rt([b()],Ie.prototype,"_more",2);Ie=rt([k("mateu-vaadin-foldout")],Ie);const qh=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
    ...
    `};var Mh=Object.defineProperty,Nh=Object.getOwnPropertyDescriptor,Lt=(e,t,a,r)=>{for(var i=r>1?void 0:r?Nh(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Mh(t,a,i),i};let Qe=class extends C{constructor(){super(...arguments),this.rows=[],this.columns=[],this.navigable=!1,this.expandedItems=[],this._normalized=[],this.dataProvider=(e,t)=>{const a=e.parentItem?e.parentItem.children??[]:this.normalized;t(a,a.length)}}get normalized(){return this._src!==this.rows&&(this._src=this.rows,this._normalized=this.normalizeRows(this.rows??[])),this._normalized}normalizeRows(e){return(e??[]).map(t=>{const a=Array.isArray(t.children)&&t.children.length?this.normalizeRows(t.children):void 0;return{...t,children:a}})}collectGroups(e,t=[]){return e.forEach(a=>{a.children&&a.children.length&&(t.push(a),this.collectGroups(a.children,t))}),t}willUpdate(){this._expandedSrc!==this.rows&&(this._expandedSrc=this.rows,this.expandedItems=this.collectGroups(this.normalized))}updated(e){e.has("rows")&&this._grid?.clearCache?.()}dispatch(e,t){this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e,parameters:t},bubbles:!0,composed:!0}))}render(){const e=this.columns??[],t=e[0],a=e.slice(1);return o`
            <vaadin-grid
                ...
                `:l}
                ${a.map(r=>r.id==="select"?o`<vaadin-grid-column header="${r.label??""}" auto-width flex-grow="0" text-align="end"
                              ${ot(i=>o`<vaadin-button theme="tertiary small"
                                          @click="${()=>this.dispatch("action-on-row-select",{_clickedRow:i})}">Select</vaadin-button>`,[])}></vaadin-grid-column>`:o`<vaadin-grid-column path="${r.id}" header="${r.label??""}"></vaadin-grid-column>`)}
                ${this.navigable?o`
                    <vaadin-grid-column auto-width flex-grow="0" text-align="end"
                          ${ot(r=>r?.viewable===!1?o``:o`<vaadin-button theme="tertiary small"
    ...
    `;Lt([p({attribute:!1})],Qe.prototype,"rows",2);Lt([p({attribute:!1})],Qe.prototype,"columns",2);Lt([p()],Qe.prototype,"idField",2);Lt([p({type:Boolean})],Qe.prototype,"navigable",2);Lt([p()],Qe.prototype,"selectedId",2);Lt([b()],Qe.prototype,"expandedItems",2);Lt([ee("vaadin-grid")],Qe.prototype,"_grid",2);Qe=Lt([k("mateu-vaadin-tree")],Qe);const Uh={[h.VirtualList]:(e,t,a,r,i,s,n)=>op(e,t,a,r,i,s,n),[h.Notification]:(e,t)=>np(t),[h.ProgressBar]:(e,t,a,r)=>lp(t,r),[h.Details]:(e,t,a,r,i,s,n)=>dp(e,t,a,r,i,s,n),[h.Avatar]:(e,t,a,r,i)=>cp(t,r,i),[h.AvatarGroup]:(e,t)=>up(t),[h.Card]:(e,t,a,r,i,s,n)=>pp(e,t,a,r,i,s,n),[h.Button]:(e,t,a,r,i)=>Oh(t,r,i),[h.MessageInput]:(e,t)=>Rh(t),[h.MessageList]:(e,t)=>Lh(t),[h.ConfirmDialog]:(e,t,a,r,i,s,n)=>Ah(e,t,a,r,i,s,n),[h.FormLayout]:(e,t,a,r,i,s,n)=>bp(e,t,a,r,i,s,n),[h.HorizontalLayout]:(e,t,a,r,i,s,n)=>$p(e,t,a,r,i,s,n),[h.VerticalLayout]:(e,t,a,r,i,s,n)=>xp(e,t,a,r,i,s,n),[h.SplitLayout]:(e,t,a,r,i,s,n)=>wp(e,t,a,r,i,s,n),[h.MasterDetailLayout]:(e,t,a,r,i,s,n)=>kp(e,t,a,r,i,s,n),[h.TabLayout]:(e,t,a,r,i,s,n)=>Cp(e,t,a,r,i,s,n),[h.AccordionLayout]:(e,t,a,r,i,s,n)=>Ip(e,t,a,r,i,s,n),[h.BoardLayout]:(e,t,a,r,i,s,n)=>Pp(e,t,a,r,i,s,n),[h.BoardLayoutRow]:(e,t,a,r,i,s,n)=>Tp(e,t,a,r,i,s,n),[h.BoardLayoutItem]:(e,t,a,r,i,s,n)=>zp(e,t,a,r,i,s,n),[h.Scroller]:(e,t,a,r,i,s,n)=>Ep(e,t,a,r,i,s,n),[h.MenuBar]:(e,t,a,r,i)=>Lp(e,t,a,r,i),[h.ContextMenu]:(e,t,a,r,i,s,n)=>Rp(e,t,a,r,i,s,n),[h.FormField]:(e,t,a,r,i,s,n,d)=>wh(e,t,a,r,i,s,n,d),[h.Grid]:(e,t,a,r,i,s,n)=>kh(e,t,a,r,i,s,n),[h.Table]:(e,t,a,r,i,s,n)=>Ih(e,t,a,r,i,s,n),[h.Popover]:(e,t,a,r,i,s,n)=>Eh(e,t,a,r,i,s,n),[h.FoldoutLayout]:(e,t,a,r,i,s,n)=>qh(e,t,a,r,i,s,n)};class jh extends sp{rendererName(){return"vaadin"}renderClientSideComponent(t,a,r,i,s,n,d,c){const u=a?.metadata?.type,m=u?Uh[u]:void 0;return m&&a?m(t,a,r,i,s,n,d,c):super.renderClientSideComponent(t,a,r,i,s,n,d,c)}renderTableComponent(t,a,r,i,s,n,d){return Sh(t,a,r,i,n,d)}renderTreeComponent(t,a){return o`
            <mateu-vaadin-tree
                    .rows="${a.rows}"
                    .columns="${a.columns}"
                    .idField="${a.idField}"
            ...
            ></mateu-vaadin-tree>`}renderToolbarButton(t,a,r){return Ph(t,a,r)}renderPeerNav(t){return Th(t)}renderIcon(t,a,r){return zh(t,a,r)}renderTopNav(t,a,r){return Op(t,a,r)}}function Ms(e){switch(e){case"topStretch":return"top-stretch";case"topStart":return"top-start";case"topCenter":return"top-center";case"topEnd":return"top-end";case"middle":return"middle";case"bottomStart":return"bottom-start";case"bottomEnd":return"bottom-end";case"bottomStretch":return"bottom-stretch";case"bottomCenter":return"bottom-center"}return"bottom-end"}function Bh(e,t){const a=new Ja;a.position=Ms(e.position),a.duration=e.duration??1e4,e.variant&&a.setAttribute("theme",e.variant),a.renderer=r=>{if(r.firstElementChild)return;const i=document.createElement("span");i.textContent=e.text;const s=document.createElement("button");s.textContent=e.undoLabel??"Undo",s.style.cssText="margin-left: 0.75rem; background: none; border: 1px solid currentColor; border-radius: var(--lumo-border-radius-s, 4px); color: inherit; cursor: pointer; padding: 0.15rem 0.6rem; font: inherit; font-weight: 600;",s.addEventListener("click",()=>{t.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.undoActionId,parameters:e.undoParameters??{}},bubbles:!0,composed:!0})),a.opened=!1}),r.append(i,s)},document.body.appendChild(a),a.opened=!0,a.addEventListener("opened-changed",r=>{r.detail.value||a.remove()})}const Vh={show(e,t){if(e.undoActionId){Bh(e,t);return}Ja.show(e.text,{position:e.position?Ms(e.position):"bottom-end",theme:e.variant,duration:e.duration})}};N.set(new jh);bs(Vh);
