...
`,za=new Intl.NumberFormat(`de-DE`,{minimumFractionDigits:2,maximumFractionDigits:2}),Ba=e=>Number.isFinite(e)?za.format(e):``,Va=(e,t)=>{let n=e<0?`-`:``,r=Ba(Math.abs(e));return t?`${n}${t} ${r}`:`${n}${r}`},Ha=(e,t)=>t?`${Ba(e)} ${t}`:Ba(e),Ua=class extends x{constructor(...e){super(...e),this.title=``,this.badges=[],this.facts=[]}static{this.styles=[Ra,g`
    ...
    `,$a=e=>{let t=e.metadata.attributes?.[`data-colspan`];return E`
        <hr style="border: none; border-top: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1)); width: 100%; margin: var(--lumo-space-s, .5rem) 0; ${e.style??``}"
            ...
            data-colspan="${C(t)}"
            slot="${e.slot??y}"/>
    `},eo={info:`ℹ`,success:`✓`,warning:`!`,danger:`!`},B=class extends x{constructor(...e){super(...e),this.text=``,this.theme=`info`,this.noIcon=!1,this.slim=!1,this.fullWidth=!1,this.hasContent=!1,this.inlineContent=!1}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
        .notice {
            display: flex;
            align-items: center;
    ...
    `}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId},bubbles:!0,composed:!0}))}render(){let e=!!this.text&&!!this.text.trim();if(!e&&!this.hasContent)return E``;let t=[`info`,`success`,`warning`,`danger`].includes(this.theme)?this.theme:`info`;return E`
            <div class="notice ${t} ${this.slim?`slim`:``}">
                ${this.noIcon?y:E`<span class="icon ${this.icon?`custom`:``}">${this.icon||eo[t]}</span>`}
        ...
        `}};k([b()],B.prototype,`text`,void 0),k([b()],B.prototype,`theme`,void 0),k([b()],B.prototype,`icon`,void 0),k([b({type:Boolean})],B.prototype,`noIcon`,void 0),k([b()],B.prototype,`actionLabel`,void 0),k([b()],B.prototype,`actionId`,void 0),k([b()],B.prototype,`status`,void 0),k([b({type:Boolean})],B.prototype,`slim`,void 0),k([b({type:Boolean})],B.prototype,`fullWidth`,void 0),k([b({type:Boolean})],B.prototype,`hasContent`,void 0),k([b({type:Boolean})],B.prototype,`inlineContent`,void 0),B=k([_(`mateu-notice`)],B);var to=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=Wt(s.text??``,r,i,a,o)??``,l=t.children??[];return E`
        <mateu-notice
                text="${c}"
                theme="${s.theme??`info`}"
    ...
    `},no=class extends x{constructor(...e){super(...e),this.groups=[]}static{this.styles=[Ra,R,g`
        :host { display: block; width: 100%; }
    ...
    `]}willUpdate(e){e.has(`groups`)&&(this.selectedId=this.groups.flatMap(e=>e.items??[]).find(e=>e.selected)?.id)}itemAction(e,t,n){e.stopPropagation(),t&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t,parameters:{_item:n}},bubbles:!0,composed:!0}))}select(e){this.selectedId=e,this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{_item:e}},bubbles:!0,composed:!0}))}render(){return E`
        ...
        `}};k([b()],no.prototype,`actionId`,void 0),k([b({type:Array})],no.prototype,`groups`,void 0),k([w()],no.prototype,`selectedId`,void 0),no=k([_(`mateu-task-queue`)],no);var ro=e=>{let t=e.metadata;return E`
        <mateu-task-queue
                .actionId="${t.actionId}"
                .groups="${t.groups??[]}"
                style="${e.style??y}"
                ...
                slot="${e.slot??y}"
        ></mateu-task-queue>
    `},io=class extends x{constructor(...e){super(...e),this.columns=0,this.items=[]}static{this.styles=[Ra,R,g`
    ...
    `]}willUpdate(e){e.has(`items`)&&(this.selectedId=this.items.find(e=>e.selected)?.id)}select(e){e.disabled||(this.selectedId=e.id,this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{_item:e.id}},bubbles:!0,composed:!0})))}render(){return E`
        ...
        `}};k([b()],io.prototype,`actionId`,void 0),k([b({type:Number})],io.prototype,`columns`,void 0),k([b()],io.prototype,`recommendedLabel`,void 0),k([b({type:Array})],io.prototype,`items`,void 0),k([w()],io.prototype,`selectedId`,void 0),io=k([_(`mateu-resource-grid`)],io);var ao=e=>{let t=e.metadata;return E`
        <mateu-resource-grid
                .actionId="${t.actionId}"
                .columns="${t.columns??0}"
    ...
    `}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return E`
        ...
        <mateu-offer-card
                ...
                slot="${e.slot??y}"
        ></mateu-offer-card>
    `},so=class extends x{constructor(...e){super(...e),this.items=[],this.added=new Set}static{this.styles=g`
        :host { display: block; width: 100%; }
    ...
    `}willUpdate(e){e.has(`items`)&&(this.added=new Set(this.items.filter(e=>e.added).map(e=>e.id)))}total(){return this.items.filter(e=>e.id!=null&&this.added.has(e.id)).reduce((e,t)=>e+(t.price??0),0)}toggle(e){if(e.id==null)return;let t=new Set(this.added),n=!t.has(e.id);n?t.add(e.id):t.delete(e.id),this.added=t,this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{_item:e.id,_added:n,_total:this.total()}},bubbles:!0,composed:!0}))}render(){return E`
        ...
        `}};k([b()],so.prototype,`totalLabel`,void 0),k([b()],so.prototype,`currency`,void 0),k([b()],so.prototype,`actionId`,void 0),k([b({type:Array})],so.prototype,`items`,void 0),k([w()],so.prototype,`added`,void 0),so=k([_(`mateu-addon-picker`)],so);var co=e=>{let t=e.metadata;return E`
        <mateu-addon-picker
                ...
                slot="${e.slot??y}"
        ></mateu-addon-picker>
    `},lo=class extends x{constructor(...e){super(...e),this.lines=[]}static{this.styles=g`
        :host {
    ...
    `}computedTotal(){return this.total==null?this.lines.filter(e=>!e.included).reduce((e,t)=>e+(t.amount??0),0):this.total}render(){return E`
        ...
        `}};k([b()],lo.prototype,`currency`,void 0),k([b()],lo.prototype,`totalLabel`,void 0),k([b({type:Array})],lo.prototype,`lines`,void 0),k([b({type:Number})],lo.prototype,`total`,void 0),lo=k([_(`mateu-ledger`)],lo);var uo=e=>{let t=e.metadata;return E`
        <mateu-ledger
                .currency="${t.currency}"
                .totalLabel="${t.totalLabel}"
                .lines="${t.lines??[]}"
                ...
                slot="${e.slot??y}"
        ></mateu-ledger>
    `},fo=class extends x{constructor(...e){super(...e),this.methods=[]}static{this.styles=g`
        :host { display: block; width: 100%; }
    ...
    `}willUpdate(e){e.has(`selected`)&&(this.selectedId=this.selected)}confirm(){this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{_method:this.selectedId}},bubbles:!0,composed:!0}))}pick(e){this.selectedId=e,this.methodActionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.methodActionId,parameters:{_method:e}},bubbles:!0,composed:!0}))}render(){return E`
        ...
        `}};k([b()],fo.prototype,`actionId`,void 0),k([b()],fo.prototype,`methodActionId`,void 0),k([b({type:Array})],fo.prototype,`methods`,void 0),k([b()],fo.prototype,`selected`,void 0),k([b()],fo.prototype,`contextLabel`,void 0),k([b()],fo.prototype,`contextValue`,void 0),k([b()],fo.prototype,`confirmLabel`,void 0),k([w()],fo.prototype,`selectedId`,void 0),fo=k([_(`mateu-payment-picker`)],fo);var po=e=>{let t=e.metadata;return E`
        <mateu-payment-picker
                ...
                slot="${e.slot??y}"
        ></mateu-payment-picker>
    `},mo=class extends x{constructor(...e){super(...e),this.items=[]}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
        .list {
            border: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1));
            border-radius: var(--lumo-border-radius-l, 12px);
    ...
    `}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return E`
        ...
        `}};k([b({type:Array})],mo.prototype,`items`,void 0),mo=k([_(`mateu-process-monitor`)],mo);var ho=e=>E`
...
`)}
            ...
            >
             ${t.children?.map(t=>P(e,t,n,r,i,a,o))}
         </mateu-app>`,[j.Element]:({container:e,component:t,state:n,data:r,appState:i,appData:a})=>Br(e,t.metadata,t,n,r,i,a),[j.FormField]:({component:e,state:t})=>Oi(e,t),[j.Text]:({component:e,state:t,data:n,appState:r,appData:i})=>Hr(e,t,n,r,i),[j.Avatar]:({component:e,state:t,data:n})=>Xt(e,t,n),[j.Chat]:({component:e,state:t,data:n})=>Ni(e,t,n),[j.AvatarGroup]:({component:e})=>Qt(e),[j.Badge]:({component:e,state:t,data:n})=>$t(e,t,n),[j.Breadcrumbs]:({component:e})=>yi(e),[j.Anchor]:({component:e})=>Ur(e),[j.Button]:({component:e,state:t,data:n})=>Zr(e,t,n),[j.Card]:H($r),[j.Chart]:({component:e})=>ei(e),[j.Icon]:({component:e})=>ti(e),[j.ConfirmDialog]:H(oi),[j.ContextMenu]:H(Mr),[j.CookieConsent]:({component:e})=>si(e),[j.Details]:H(ci),[j.Dialog]:({component:e,baseUrl:t,state:n,data:r,appState:i,appData:a})=>li(e,t,n,r,i,a),[j.Drawer]:({component:e,baseUrl:t,state:n,data:r,appState:i,appData:a})=>ui(e,t,n,r,i,a),[j.Image]:({component:e})=>vi(e),[j.Map]:({component:e})=>_i(e),[j.Markdown]:({component:e})=>pi(e),[j.MicroFrontend]:({component:e})=>fi(e),[j.Notification]:({component:e})=>mi(e),[j.ProgressBar]:({component:e,state:t})=>hi(e,t),[j.Popover]:H(gi),[j.CarouselLayout]:H(bi),[j.Tooltip]:H(Fr),[j.MessageInput]:({component:e})=>Pr(e),[j.MessageList]:({component:e})=>kr(e),[j.CustomField]:H(Nr),[j.MenuBar]:({container:e,component:t,baseUrl:n,state:r,data:i})=>jr(e,t,n,r,i),[j.Grid]:({component:e,state:t})=>Dr(e,Or(e,t)),[j.VirtualList]:H(wr),[j.FormSection]:H(wi),[j.FormSubSection]:H(Ti),[j.MetricCard]:({component:e})=>Bi(e),[j.Scoreboard]:H(Vi),[j.DashboardPanel]:H(Hi),[j.DashboardLayout]:H(Ui),[j.ResponsiveGrid]:H(Ki),[j.FoldoutLayout]:H(Gi),[j.ContentLayout]:H(qi),[j.HeroSection]:H(Ji),[j.EmptyState]:({component:e})=>gn(e),[j.Skeleton]:({component:e})=>_n(e),[j.Gantt]:({component:e})=>Zi(e),[j.PlanningBoard]:({component:e})=>$i(e),[j.Kanban]:({component:e})=>ta(e),[j.Timeline]:({component:e})=>ra(e),[j.ProgressSteps]:({component:e})=>aa(e),[j.Stat]:({component:e})=>sa(e),[j.Calendar]:({component:e})=>la(e),[j.PricingTable]:({component:e})=>da(e),[j.OrgChart]:({component:e})=>pa(e),[j.Heatmap]:({component:e})=>ga(e),[j.Funnel]:({component:e})=>va(e),[j.TrendChart]:({component:e})=>ba(e),[j.FeatureGrid]:({component:e})=>Sa(e),[j.Testimonials]:({component:e})=>wa(e),[j.Faq]:({component:e})=>Ea(e),[j.CalloutCard]:({component:e})=>Oa(e),[j.CommentThread]:({component:e})=>Aa(e),[j.FileList]:({component:e})=>Na(e),[j.Checklist]:({component:e})=>Fa(e),[j.ComparisonCard]:({component:e})=>La(e),[j.EntityHeader]:({component:e})=>Wa(e),[j.Meter]:({component:e})=>Ka(e),[j.TaskProgress]:({component:e})=>Ja(e),[j.StatusList]:({component:e})=>Xa(e),[j.BulletedList]:({component:e})=>Qa(e),[j.Separator]:({component:e})=>$a(e),[j.Notice]:H(to),[j.TaskQueue]:({component:e})=>ro(e),[j.ResourceGrid]:({component:e})=>ao(e),[j.OfferCard]:({component:e})=>oo(e),[j.AddOnPicker]:({component:e})=>co(e),[j.Ledger]:({component:e})=>uo(e),[j.PaymentPicker]:({component:e})=>po(e),[j.ProcessMonitor]:({component:e})=>ho(e)},yo=(e,t,n,r,i,a,o,s)=>{if(!t?.metadata)return t==null?(console.warn(`No metadata for component`,t),E`<p>No metadata for component</p>`):yo(e,{id:se(),metadata:t,type:A.ClientSide},n,r,i,a,o,s);let c=t.metadata.type,l={...t,style:go(t,i),metadata:_o(t,i)},u=vo[c];return u?u({container:e,component:l,baseUrl:n,state:r,data:i,appState:a,appData:o,labelAlreadyRendered:s}):E`<p ${l?.slot??y}>Unknown metadata type ${c} for component ${l?.id}</p>`},bo=function(e){return e.NONE=`NONE`,e.INFO=`INFO`,e.SUCCESS=`SUCCESS`,e.WARNING=`WARNING`,e.DANGER=`DANGER`,e}({}),xo=(e,t,n)=>{let r=e[n.path];return r?E`<span theme="badge pill ${So(r.type)}">${r.message}</span>`:E``},So=e=>{switch(e){case bo.SUCCESS:return`success`;case bo.WARNING:return`warning`;case bo.DANGER:return`error`;case bo.NONE:return`contrast`}return``},U=class extends x{constructor(...e){super(...e),this.id=``,this.baseUrl=``,this.state={},this.data={},this.appState={},this.appData={},this.respondToVisibility=(e,t)=>{var n={root:document.documentElement};new IntersectionObserver(e=>{e.forEach(e=>{t(e.intersectionRatio>0)})},n).observe(e)},this.keepAsking=!1,this.askToUpper=()=>{let e=this.data[this.id]?.page,t=e?.content?.length/e?.pageSize;this.dispatchEvent(new CustomEvent(`fetch-more-elements`,{detail:{params:{page:t,pageSize:this.metadata?.pageSize},callback:()=>{this.keepAsking&&this.askToUpper()}},bubbles:!0,composed:!0}))},this.renderItem=e=>e.card?yo(this,e.card,this.baseUrl,this.state,this.data,this.appState,this.appData,!1):e.title?E`<div class="neutral-card">
                ${e.image?E`<img class="card-media" src="${e.image}" alt="" />`:y}
                <div class="card-body">
                    <div class="card-head">
                        ${e.title?E`<span class="card-title">${e.title}</span>`:y}
                        ${e.status?E`<span theme="badge ${So(e.status.type)}">${e.status.message}</span>`:y}
                    </div>
        ...
        `}get cols(){return(this.effectiveComponent?.metadata)?.columns?.map(e=>e.metadata)??[]}get identifierFieldName(){let e=this.cols.find(e=>e.identifier);return e?e.id:this.cols.find(e=>e.id===`id`)?.id}get effectiveGridLayout(){let e=this.component?.metadata,t=e?.gridLayout??`auto`;return t===`auto`?e?.crudlType===`card`?`cards`:`table`:t}scheduleMeasure(){this.pendingMeasure=!0,this.corrections=0,this.requestUpdate()}measureFill(){if(!this.pendingMeasure)return;let e=this.renderRoot?.querySelector?.(`[data-crud-box]`);if(!e)return;if(this.closest?.(`mateu-dialog, mateu-drawer`)){this.pendingMeasure=!1;return}let t=e.style.height;t&&(e.style.height=``);let n=e.getBoundingClientRect().top,r=Math.round(window.innerHeight-n-this.measureBottomInset(e)-W.BOTTOM_GUTTER_PX);t&&(e.style.height=t);let i=this.lastMeasuredTop==null,a=!i&&Math.abs(n-this.lastMeasuredTop)>=2;if(r>=W.MIN_FILL_PX){if(a&&this.retryMeasure(n))return;this.pendingMeasure=!1,this.unsettledRefusals=0,this.lastMeasuredTop=n,this.fillHeightPx=r;return}!(!i&&!a)&&this.retryMeasure(n)||(this.lastMeasuredTop=n,this.pendingMeasure=!1,this.unsettledRefusals=0,this.fillHeightPx=void 0)}retryMeasure(e){return this.unsettledRefusals>=W.MAX_UNSETTLED_REFUSALS?!1:(this.lastMeasuredTop=e,this.unsettledRefusals++,this.requestUpdate(),!0)}trimOverflow(){if(this.fillHeightPx==null||this.pendingMeasure||this.corrections>=W.MAX_CORRECTIONS)return;let e=document.documentElement.scrollHeight-window.innerHeight;e<=1||e>W.MAX_SLIVER_PX||(this.corrections++,this.fillHeightPx=Math.max(W.MIN_FILL_PX,this.fillHeightPx-e))}measureBottomInset(e){let t=e,n=0,r=e.getBoundingClientRect().bottom;for(let e=0;t&&e<20;e++){n+=parseFloat(getComputedStyle(t).marginBottom)||0;let e=t.getRootNode(),i=t.assignedSlot??t.parentElement??e.host??null;if(!i||i===document.documentElement||i===document.body)break;let a=getComputedStyle(i);n+=(parseFloat(a.paddingBottom)||0)+(parseFloat(a.borderBottomWidth)||0);let o=parseFloat(a.rowGap)||0;for(let e=t.nextElementSibling;e;e=e.nextElementSibling){let t=e.getBoundingClientRect();if(t.top<r-1)continue;let i=getComputedStyle(e);n+=t.height+(parseFloat(i.marginTop)||0)+(parseFloat(i.marginBottom)||0)+o}t=i}return Math.round(n)}static{this.BOTTOM_GUTTER_PX=16}static{this.MAX_SLIVER_PX=64}static{this.MAX_CORRECTIONS=3}static{this.MAX_UNSETTLED_REFUSALS=4}static{this.MIN_FILL_PX=320}boxStyle(){let e=`border: var(--mateu-section-border, none); background: var(--mateu-section-bg, transparent); overflow: hidden; padding: var(--mateu-section-padding, 0); display: flex; flex-direction: column;`;return this.fillHeightPx==null?`${e} max-height: calc(100dvh - 12rem);`:`${e} height: ${this.fillHeightPx}px;`}connectedCallback(){super.connectedCallback(),window.addEventListener(`resize`,this.windowResizeListener),this.resizeObserver=new ResizeObserver(e=>{let t=e[0]?.contentRect.width;t&&Math.abs(t-this.availableWidthPx)>10&&(this.availableWidthPx=t)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.loadingTimer),window.removeEventListener(`resize`,this.windowResizeListener),this.resizeObserver?.disconnect()}static{this.LOADING_VALVE_MS=15e3}get awaitingRows(){return this.loadingSince!=null&&Date.now()-this.loadingSince<W.LOADING_VALVE_MS}beginLoading(){this.loadingSince=Date.now(),clearTimeout(this.loadingTimer),this.loadingTimer=setTimeout(()=>this.requestUpdate(),W.LOADING_VALVE_MS)}endLoading(){this.loadingSince=void 0,clearTimeout(this.loadingTimer)}_filterIds(e){return new Set([`searchText`,...(e.filters??[]).flatMap(e=>e.stereotype===`dateRange`||e.stereotype===`numberRange`?[`${e.fieldId}_from`,`${e.fieldId}_to`]:[e.fieldId])])}_syncStateToUrl(e){let t=this._filterIds(e),n=new URLSearchParams(window.location.search);t.forEach(e=>n.delete(e)),n.delete(`page`),n.delete(`sort`),t.forEach(e=>{let t=this.state[e];t!=null&&t!==``&&n.set(e,String(t))});let r=this.state.page;r&&r>0&&n.set(`page`,String(r));let i=this.state.sort;if(i&&i.length>0){let e=i.filter(e=>e.fieldId&&e.direction).map(e=>`${e.fieldId}:${e.direction}`).join(`,`);e&&n.set(`sort`,e)}let a=n.toString(),o=a?`${window.location.pathname}?${a}`:window.location.pathname;window.location.pathname+window.location.search!==o&&history.replaceState(null,``,o)}_initStateFromUrl(e,t){let n=new URLSearchParams(window.location.search),r=this._filterIds(e),i={...t};n.forEach((e,t)=>{r.has(t)&&(i[t]=e)});let a=n.get(`page`);if(a!==null){let e=parseInt(a,10);!isNaN(e)&&e>0&&(i.page=e)}let o=n.get(`sort`);if(o){let e=o.split(`,`).map(e=>{let[t,n]=e.split(`:`);return t&&n?{fieldId:t,direction:n}:null}).filter(Boolean);e.length>0&&(i.sort=e)}return i}pageChanged(e){this.state={...this.state,page:e.detail.page},this.handleSearchRequested(void 0)}static _initKeyOf(e){if(!e)return;let t=e.metadata?.rowsSource;return`${e.id}|${t?t.ref??t.url??``:``}`}willUpdate(e){if(super.willUpdate(e),!e.has(`data`)||this.data?.[this.id]!=null)return;let t=this._restRows;!t||t.key!==W._initKeyOf(this.component)||(this.data={...this.data,[this.id]:t.listing})}updated(e){if(super.updated(e),e.has(`component`)?this.scheduleMeasure():(this.measureFill(),this.trimOverflow()),this.data?.[this.id]==null?this.loadingSince==null&&this._initializedForKey!=null&&!this.awaitingRows&&this.beginLoading():this.endLoading(),e.has(`component`)){let e=W._initKeyOf(this.component),t=this.component?.metadata;if(e!==this._initializedForKey){this._initializedForKey=e;let n=t.initialPage&&t.initialPage>0?t.initialPage:0;this.state=this._initStateFromUrl(t,{...this.state,size:t.pageSize,page:n,sort:[]}),(this.state.page!==n||this.state.sort?.length>0||[...this._filterIds(t)].some(e=>this.state[e]!=null)||t.rowsSource)&&this.handleSearchRequested(void 0)}else{let e=this._restoreUrlFiltersIfMissing(t,this.state);e!==this.state&&(this.state=e)}}}_restoreUrlFiltersIfMissing(e,t){let n=new URLSearchParams(window.location.search),r=this._filterIds(e),i=t;return n.forEach((e,n)=>{if(!r.has(n))return;let a=i[n];(a==null||a===``)&&(i===t&&(i={...t}),i[n]=e)}),i}render(){let e=e=>N.get()?.renderToolbarButton?.(e,this.evalLabel(e.label),()=>this.handleToolbarButtonClick(e))||E`
            ...
            `;if(!this.component)return E`no component`;let t=this.effectiveComponent,n=t.metadata;n.serverSideOrdering=!0;let r=(()=>{let e=this;for(;e;){let t=e;if(t.tagName===`MATEU-PAGE`)return(t.component?.metadata?.toolbar?.length??0)>0;e=t.parentElement??(t.getRootNode?.()instanceof ShadowRoot?t.getRootNode().host:null)}return!1})()?[]:n?.toolbar??[],i=r.filter(e=>an(e.actionId)&&!nn(e.actionId)),a=r.filter(e=>nn(e.actionId)),o=r.filter(e=>!an(e.actionId)),s=i.length>0&&o.length>0,c=!!n?.title||!!n?.subtitle||r.length>0,l=this.effectiveGridLayout,u=this.cols,d=Eo(u),f=this.data[this.id]?.page?.content??[],p=this.state[this.component?.id]?.emptyStateMessage,m=(e,t)=>{let n=t[e.id];return n==null?E``:e.dataType===`status`?E`<span theme="badge pill ${So(n.type)}">${n.message}</span>`:e.dataType===`bool`?E`${n?`✓`:`✗`}`:typeof n==`object`?E`${n.label??n.name??n.message??``}`:E`${n}`},h=()=>{let e=this.identifierFieldName,t=this.state._selectedId??this.appState?._splitDetailId,n=d.find(e=>e.identifier)??d[0],r=e=>e.dataType===`action`||e.dataType===`actionGroup`||e.dataType===`menu`||e.stereotype===`button`,i=d.filter(e=>e!==n&&!r(e)),a=u.filter(e=>r(e)),o=(e,t,n)=>{e.stopPropagation(),e.currentTarget.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t,parameters:{_clickedRow:n}},bubbles:!0,composed:!0}))},s=e=>{let t=[];for(let n of a){let r=e[n.id];if(n.dataType===`action`){let i=r?.methodNameInCrud?r:e.action?.methodNameInCrud?e.action:{methodNameInCrud:n.id,label:n.label,icon:null,disabled:!1};t.push(E`
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: var(--lumo-space-m); padding: var(--lumo-space-s) 0;">
                    ...
                    `)}
                </div>`},g=()=>{let e=Do(u),t=e.find(e=>e.identifier)??e[0],n=e.filter(e=>e!==t);return E`
    ...
    `}};k([b()],G.prototype,`component`,void 0),k([b()],G.prototype,`baseUrl`,void 0),k([b({type:Boolean})],G.prototype,`standalone`,void 0),k([b()],G.prototype,`state`,void 0),k([b()],G.prototype,`data`,void 0),k([b()],G.prototype,`appState`,void 0),k([b()],G.prototype,`appData`,void 0),k([w()],G.prototype,`showImportDialog`,void 0),k([w()],G.prototype,`availableWidthPx`,void 0),k([w()],G.prototype,`selectedItem`,void 0),k([w()],G.prototype,`_columnPrefsRevision`,void 0),k([w()],G.prototype,`fillHeightPx`,void 0),k([w()],G.prototype,`loadingSince`,void 0),G=W=k([_(`mateu-table-crud`)],G);var ko=function(e){return e.OnLoad=`OnLoad`,e.OnSuccess=`OnSuccess`,e.OnError=`OnError`,e.OnValueChange=`OnValueChange`,e.OnCustomEvent=`OnCustomEvent`,e.AutoSave=`AutoSave`,e}({}),Ao=class extends Bt{constructor(...e){super(...e),this.state={},this.data={},this._locallyEdited=new Set,this.appData={},this.appState={},this.triggerOnLoad=()=>{let e=this.component;this.registerCustomEventListeners(),e.triggers?.filter(e=>e.type==ko.OnLoad).forEach(e=>{if((!e.condition||this._evalExpr(e.condition))&&!e.triggered){let n=e;n.triggered=!0;var t=n.times-1;n.timeoutMillis>0?this.scheduleOnload(n,t,this.id):this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:n.actionId,background:n.background},bubbles:!0,composed:!0}))}})},this.scheduleOnload=(e,t,n)=>{if(n!=this.component?.id)return;let r=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,background:e.background,callbackToken:r},bubbles:!0,composed:!0}))},e.timeoutMillis)},this._registeredCustomEventListeners=[],this.customEventManager=e=>{if(!(e instanceof CustomEvent))return;let t=e,n=(this.component.triggers??[]).filter(e=>e.type==ko.OnCustomEvent).filter(e=>e.eventName==t.type).filter(e=>e.source!==`COMPONENT`||t.detail?.__source===e.from);n.length!==0&&(n.some(e=>!e.source||e.source===`SELF`)&&(e.stopPropagation(),e.preventDefault()),n.forEach(e=>{(!e.condition||this._evalExpr(e.condition))&&this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:t.detail},bubbles:!0,composed:!0}))}))}}_interpolationExtra(){return{appState:this.appState??{},appData:this.appData??{},component:this.component}}_evalExpr(e){return Kt(e,this.state??{},this.data??{},this._interpolationExtra())}_evalTemplate(e){return qt(e,this.state??{},this.data??{},this._interpolationExtra())}isOverlayChild(e){let t=e?.metadata?.type;return t==j.Drawer||t==j.Dialog}removeSelfFromOwnerChildren(){let e=this.component;if(!e)return!1;let t=t=>{if(t===e)return!0;let n=t;return e.id!=null&&n?.id==e.id&&this.isOverlayChild(n)},n=this.parentNode;for(;n;){let e=n instanceof ShadowRoot?n.host:n,r=e.component?.children;if(Array.isArray(r)){let n=r.findIndex(t);if(n>=0)return r.splice(n,1),e.requestUpdate?.(),!0}n=n instanceof ShadowRoot?e:n.parentNode}return!1}applyFragment(e){if(this.id==e.targetComponentId){if(e.component)if(We.Add==e.action){if(this.component){let t=this.component.children??(this.component.children=[]),n=e.component.id?t.findIndex(t=>t.id==e.component.id&&this.isOverlayChild(t)):-1;n>=0?(t[n]=e.component,this.component={...this.component}):t.push(e.component)}}else{this.callbackToken=se();let t=!1;if(e.component?.type==A.ServerSide)if(this.component){let n=this.component,r=e.component;t=n.serverSideType==r.serverSideType;let i=t?(n.children??[]).filter(e=>this.isOverlayChild(e)):[];n.actions=r.actions,n.type=r.type,n.rules=r.rules,n.triggers=r.triggers,n.serverSideType=r.serverSideType,n.route=r.route,n.initialData=r.initialData,n.validations=r.validations,n.cssClasses=r.cssClasses,n.slot=r.slot,n.style=r.style,n.children=i.length?[...r.children??[],...i]:r.children,(n.serverSideType!=r.serverSideType||n.id!=r.id)&&setTimeout(()=>this.triggerOnLoad())}else this.component=e.component,setTimeout(()=>this.triggerOnLoad());else{let t=[e.component];this.component&&(this.component.children=t)}e.action!==We.ReplaceKeepData&&!t&&(this.state={},this.data={},this._locallyEdited.clear())}e.state&&(Object.keys(e.state).forEach(e=>this._locallyEdited.delete(e)),this.state={...this.state,...e.state});let t=this._lastOwnState,n=this.state;if(t&&this._locallyEdited.forEach(r=>{!(e.state!=null&&r in e.state)&&n[r]!==t[r]&&(n={...n,[r]:t[r]})}),this._lastOwnState=n,e.data){for(let t in e.data){let n=e.data[t]?.page;n?.pageNumber>0&&this.data[t]&&this.data[t].page.content&&(n.content?n.content=[...this.data[t].page.content,...n.content]:n.content=[...this.data[t].page.content])}this.data={...this.data,...e.data}}this._lastFragmentData=this.data,this.registerCustomEventListeners();let r=N.getAfterRenderHook();r&&setTimeout(()=>r(this)),this.requestUpdate()}}willUpdate(e){super.willUpdate(e);let t=this.component?.serverSideType,n=t!=null&&this._lastViewKey!=null&&t!==this._lastViewKey;if(t!=null&&(this._lastViewKey=t),n&&this._locallyEdited.clear(),this._keepEditedFieldValues(e,n),!e.has(`data`)||this.data===this._lastFragmentData||n)return;let r=this.data,i=e.get(`data`);r&&Object.keys(r).length===0&&i&&Object.keys(i).length>0&&(this.data=i)}_keepEditedFieldValues(e,t){if(t||!e.has(`state`)||this._locallyEdited.size===0||this.state===this._lastOwnState)return;let n=this._lastOwnState;if(!n)return;let r;this._locallyEdited.forEach(e=>{n[e]!==this.state?.[e]&&(r??={...this.state},r[e]=n[e])}),r&&(this.state=r)}adoptEditedState(e,t){this._locallyEdited.add(e),this.state=t,this._lastOwnState=t}registerCustomEventListeners(){this._registeredCustomEventListeners.forEach(({target:e,name:t})=>e.removeEventListener(t,this.customEventManager)),this._registeredCustomEventListeners=[],this.component?.triggers?.filter(e=>e.type==ko.OnCustomEvent).forEach(e=>{let t=e.source===`DOCUMENT`||e.source===`COMPONENT`?document:this;t.addEventListener(e.eventName,this.customEventManager),this._registeredCustomEventListeners.push({target:t,name:e.eventName})})}disconnectedCallback(){this._registeredCustomEventListeners.forEach(({target:e,name:t})=>e.removeEventListener(t,this.customEventManager)),this._registeredCustomEventListeners=[],super.disconnectedCallback()}connectedCallback(){super.connectedCallback(),this.component&&this.registerCustomEventListeners()}};k([b()],Ao.prototype,`state`,void 0),k([b()],Ao.prototype,`data`,void 0),k([b()],Ao.prototype,`appData`,void 0),k([b()],Ao.prototype,`appState`,void 0);var jo=new Set([`sse`,`app-data`,`rest-sources`,`command-center`,`global-search`,`notifications`,`context-selectors`,`header-actions`]);function Mo(e,t=jo){let n=(e??[]).filter(e=>e&&!t.has(e));return{ok:n.length===0,missing:n}}function No(e,t=document){let n=Mo(e);return n.ok||(console.warn(`[mateu] this renderer is missing capabilities the app requires: ${n.missing.join(`, `)}. The app may not render correctly. Load a renderer build that provides them.`),t.dispatchEvent(new CustomEvent(`mateu-capability-mismatch`,{detail:{missing:n.missing,required:[...e??[]]},bubbles:!0,composed:!0}))),n}var Po=`mateu-recent-routes`,Fo=8;function Io(){try{return JSON.parse(localStorage.getItem(Po)??`{}`)}catch{return{}}}function Lo(e){try{localStorage.setItem(Po,JSON.stringify(e))}catch{}}function Ro(e){return Io()[e||`_`]??[]}function zo(e,t){if(!t?.route||!t.label)return;let n=e||`_`,r=Io(),i=(r[n]??[]).filter(e=>e.route!==t.route);i.unshift({route:t.route,label:t.label}),r[n]=i.slice(0,Fo),Lo(r)}var Bo=class extends x{constructor(...e){super(...e),this.baseUrl=``,this.open=!1,this.queryText=``,this.dataHits=[],this.loading=!1,this.selectedIndex=0,this.fabOffset=0,this.keydownHandler=null}connectedCallback(){super.connectedCallback(),this.keydownHandler=e=>{(e.metaKey||e.ctrlKey)&&(e.key===`k`||e.key===`K`)?(e.preventDefault(),this.toggle()):e.key===`Escape`&&this.open&&this.close()},document.addEventListener(`keydown`,this.keydownHandler),this.setupFabObserver()}disconnectedCallback(){super.disconnectedCallback(),this.keydownHandler&&document.removeEventListener(`keydown`,this.keydownHandler),clearTimeout(this.searchTimer),this.fabObserver?.disconnect(),this.fabObserver=void 0}setupFabObserver(){let e=this.getRootNode(),t=e instanceof ShadowRoot?e:document.body;this.measureFabStack(),this.fabObserver?.disconnect(),this.fabObserver=new MutationObserver(()=>this.measureFabStack()),this.fabObserver.observe(t,{childList:!0,subtree:!0})}measureFabStack(){let e=(this.getRootNode().querySelectorAll?.(`.ai-fab, .app-fab, .page-fab`).length??0)*4;e!==this.fabOffset&&(this.fabOffset=e)}updated(e){e.has(`open`)&&this.open&&requestAnimationFrame(()=>this.inputEl?.focus())}toggle(){this.open?this.close():this.openCenter()}openCenter(){this.open=!0,this.queryText=``,this.dataHits=[],this.selectedIndex=0}close(){this.open=!1,this.queryText=``,this.dataHits=[],clearTimeout(this.searchTimer)}flattenMenu(e,t){let n=[];for(let r of e??[])if(!r.separator)if(r.submenus&&r.submenus.length>0){let e=t?`${t} › ${r.label}`:r.label;n.push(...this.flattenMenu(r.submenus,e))}else r.route!==void 0&&r.route!==null&&n.push({label:r.label,breadcrumb:t,route:r.route});return n}onInput(e){this.queryText=e,this.selectedIndex=0;let t=e.trim();if(clearTimeout(this.searchTimer),!t||!this.app?.globalSearchEnabled){this.dataHits=[],this.loading=!1;return}this.loading=!0,this.searchTimer=setTimeout(()=>this.fetchGlobalSearch(t),250)}async fetchGlobalSearch(e){let t=this.app;if(!t?.globalSearchEnabled){this.loading=!1;return}try{let n=(await Mt.runAction(this.baseUrl??``,t.rootRoute??``,``,`_globalsearch`,`command-center`,void 0,t.serverSideType,{},{searchText:e},this,!0))?.fragments?.map(e=>e.data).find(e=>e&&e._globalsearch);this.dataHits=n?._globalsearch??[]}catch{this.dataHits=[]}finally{this.loading=!1}}navigateTo(e,t){zo(this.app?.serverSideType??``,{route:e,label:t}),this.close();for(let t of[`route-changed`,`navigate-to-requested`])this.dispatchEvent(new CustomEvent(t,{detail:{route:e},bubbles:!0,composed:!0}))}askAi(){let e=this.queryText.trim();this.close(),this.dispatchEvent(new CustomEvent(`mateu-open-ai`,{detail:{query:e},bubbles:!0,composed:!0}))}visibleTargets(e){if(!this.queryText.trim()){let e=this.flattenMenu(this.app?.menu,``).map(e=>({route:e.route,label:e.label})),t=Ro(this.app?.serverSideType??``);return[...e,...t]}return[...e.map(e=>({route:e.route,label:e.label})),...this.dataHits.map(e=>({route:e.route,label:e.label}))]}onKeydown(e,t){if(e.key===`ArrowDown`)e.preventDefault(),this.selectedIndex=Math.min(this.selectedIndex+1,t.length-1);else if(e.key===`ArrowUp`)e.preventDefault(),this.selectedIndex=Math.max(this.selectedIndex-1,0);else if(e.key===`Enter`){let e=t[this.selectedIndex];e&&this.navigateTo(e.route,e.label)}}render(){return E`
        ...
        `}renderDefault(){let e=this.flattenMenu(this.app?.menu,``),t=Ro(this.app?.serverSideType??``),n=-1;return E`
    ...
    `}};k([b({attribute:!1})],Bo.prototype,`app`,void 0),k([b()],Bo.prototype,`baseUrl`,void 0),k([w()],Bo.prototype,`open`,void 0),k([w()],Bo.prototype,`queryText`,void 0),k([w()],Bo.prototype,`dataHits`,void 0),k([w()],Bo.prototype,`loading`,void 0),k([w()],Bo.prototype,`selectedIndex`,void 0),k([w()],Bo.prototype,`fabOffset`,void 0),k([S(`.cc-input`)],Bo.prototype,`inputEl`,void 0),Bo=k([_(`mateu-command-center`)],Bo);var Vo=null;function Ho(e){let t=e.component?.metadata;t&&(t.commandCenterEnabled||t.chromeless)&&t.variant!==`MEDIATOR`?((!Vo||!Vo.isConnected)&&(Vo=document.createElement(`mateu-command-center`),e.renderRoot.appendChild(Vo)),Vo.app=t,Vo.baseUrl=e.baseUrl??``):Vo&&e.renderRoot.contains(Vo)&&(Vo.remove(),Vo=null)}var Uo=class extends x{constructor(...e){super(...e),this.fetchStarted=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!0},this.fetchFinished=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1},this.fetchFailed=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1;let t=e.detail??{},n=t.failure??St(t.reason,{online:Ot.isOnline()});if(n.kind===`cancelled`)return;let r=t.retry;To({text:n.message,variant:`error`,duration:r?8e3:5e3,position:`bottomEnd`,...r?{actionLabel:`Retry`,onAction:r}:{}},this)}}connectedCallback(){super.connectedCallback(),this.addEventListener(`backend-called-event`,this.fetchStarted),this.addEventListener(`backend-succeeded-event`,this.fetchFinished),this.addEventListener(`backend-cancelled-event`,this.fetchFinished),this.addEventListener(`backend-failed-event`,this.fetchFailed)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`backend-called-event`,this.fetchStarted),this.removeEventListener(`backend-succeeded-event`,this.fetchFinished),this.removeEventListener(`backend-cancelled-event`,this.fetchFinished),this.removeEventListener(`backend-failed-event`,this.fetchFailed)}render(){return E`<div class="loader-container">
...
`,i=!0)}i&&this.updateMessage(a,o)}o||this.updateMessage(a,`⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).`)}catch(e){console.error(`Error en el flujo SSE:`,e);let t=e?.message??String(e);(t===`Failed to fetch`||t===`network error`||t===`Load failed`)&&!o?this.updateMessage(a,`⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible.`):this.updateMessage(a,`⚠️ Error: `+t)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value=``)},250),this.messageInputElement?.removeAttribute(`disabled`),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent(`close-requested`,{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{let e=this.messageInputElement?.value?.trim()??``;e&&this.send(new CustomEvent(`submit`,{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key===`Enter`&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback(),this.probeLocalAgent();let e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){let t=new e;this.recognition=t,t.lang=`es-ES`,t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=e=>{console.error(`Error de reconocimiento: `+e.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:`smooth`})},0)}addMessage(e,t){let n={text:e,time:new Date().toLocaleTimeString(),userName:t.includes(`agent`)?`Asistente`:`Tú`,userColorIndex:t.includes(`agent`)?2:1};return this.items=[...this.items,n],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((n,r)=>r===e?{...n,text:t}:n),this.scrollBottom()}tryParseCustomEvent(e){let t=e.trim();if(!t.startsWith(`{`))return null;try{let e=JSON.parse(t);if(typeof e.event==`string`)return{event:e.event,detail:e.detail??{}}}catch{}return null}tryParseTokenUsage(e){let t=e.trim();if(!t.startsWith(`{`))return null;try{let e=JSON.parse(t);if(`inputTokens`in e||`outputTokens`in e||`totalTokens`in e)return e}catch{}return null}buildMenuContext(e,t=[]){let n=[];for(let r of e){if(r.separator||r.remote)continue;let e=[...t,r.label];if(r.submenus&&r.submenus.length>0)n.push(...this.buildMenuContext(r.submenus,e));else{let t={path:e,navigation:{route:r.route,consumedRoute:r.consumedRoute,actionId:r.actionId??``,baseUrl:r.baseUrl,serverSideType:r.serverSideType,uriPrefix:r.uriPrefix}};r.description&&(t.description=r.description),n.push(t)}}return n}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return E`
                    ...
                    <div class="message-list" role="list">
                        ${this.items.map(e=>E`
                            <div class="message" role="listitem">
                                <div class="avatar" style="background: ${ps(e.userColorIndex)};">${ms(e.userName)}</div>
  ...
  `}};k([b()],hs.prototype,`type`,void 0),k([b()],hs.prototype,`data`,void 0),k([b()],hs.prototype,`options`,void 0),k([S(`#chart`)],hs.prototype,`chartElement`,void 0),hs=k([_(`mateu-chart`)],hs);var gs=class extends x{updated(e){super.updated(e),this.chart&&=(this.chart.destroy(),void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){let{default:t}=await D(async()=>{let{default:e}=await import(`./vendor-diagrams.js`).then(e=>e.t);return{default:e}},__vite__mapDeps([4,1,2]));if(e!==this.xml)return;this.chart&&this.chart.destroy();let n={container:this.divElement};this.chart=new t(n),this.chart.importXML(e)}handleSlotChange(){}render(){return E`
       ...
       `}static{this.styles=g`
  `}};k([b()],gs.prototype,`xml`,void 0),k([S(`#canvas`)],gs.prototype,`divElement`,void 0),gs=k([_(`mateu-bpmn`)],gs);var _s=160,vs=56,ys=220,bs=110,xs=60,Ss={ACTION:`#3B82F6`,JOIN:`#8B5CF6`,FORK:`#F59E0B`,END:`#EF4444`,USER_TASK:`#10B981`,PROCESS:`#6366F1`},Cs={ACTION:`▶`,JOIN:`⟨`,FORK:`⟩`,END:`◼`,USER_TASK:`👤`,PROCESS:`⚙`},ws=[`ACTION`,`JOIN`,`FORK`,`END`,`USER_TASK`,`PROCESS`];function Ts(){return`step-`+Math.random().toString(36).slice(2,8)}var Es=class extends x{constructor(...e){super(...e),this.value=`{"name":"New Workflow","steps":[]}`,this.wf={name:`New Workflow`,steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;let t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener(`mousemove`,this.onMouseMove),window.removeEventListener(`mouseup`,this.onMouseUp)}}updated(e){if(e.has(`value`)){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){let e=this.wf.steps??[],t={};e.forEach(e=>{t[e.id]=0});let n=!0;for(;n;)n=!1,e.forEach(e=>{if(e.preconditionStepId!=null&&t[e.preconditionStepId]!==void 0){let r=t[e.preconditionStepId]+1;r>t[e.id]&&(t[e.id]=r,n=!0)}});let r={};e.forEach(e=>{let n=t[e.id]??0;(r[n]??=[]).push(e.id)});let i={...this.positions},a=!1;Object.entries(r).forEach(([e,t])=>{let n=Number(e);t.forEach((e,t)=>{i[e]||(i[e]={x:xs+n*ys,y:xs+t*bs},a=!0)})}),a&&(this.positions=i)}emit(){let e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent(`value-changed`,{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(n=>n.id===e?{...n,...t}:n)},this.emit()}addStep(){let e=Ts(),t={id:e,type:`ACTION`,name:`New Step`};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};let n=Object.values(this.positions).map(e=>e.y),r=n.length?Math.max(...n)+bs:xs;this.positions={...this.positions,[e]:{x:xs,y:r}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(t=>t.id!==e).map(t=>t.preconditionStepId===e?{...t,preconditionStepId:void 0}:t)};let{[e]:t,...n}=this.positions;this.positions=n,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;let n=this.positions[t]??{x:0,y:0},r=this.toSvgPoint(e);this.dragOffset={x:r.x-n.x,y:r.y-n.y},this.svgEl=e.currentTarget.closest(`svg`),window.addEventListener(`mousemove`,this.onMouseMove),window.addEventListener(`mouseup`,this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};let t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){let e=Object.values(this.positions),t=e.length?Math.max(...e.map(e=>e.x))+_s+xs:600,n=e.length?Math.max(...e.map(e=>e.y))+vs+xs:400;return{w:Math.max(t,600),h:Math.max(n,400)}}render(){let{w:e,h:t}=this.canvasSize(),n=this.wf.steps??[];return E`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return T``;let t=this.positions[e.preconditionStepId],n=this.positions[e.id];if(!t||!n)return T``;let r=t.x+_s,i=t.y+vs/2,a=n.x,o=n.y+vs/2,s=(r+a)/2;return T`
            <path d="M${r},${i} C${s},${i} ${s},${o} ${a},${o}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){let t=this.positions[e.id]??{x:xs,y:xs},n=Ss[e.type]??`#64748b`,r=Cs[e.type]??`•`,i=this.selectedId===e.id;return T`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${t=>this.onNodeMouseDown(t,e.id)}"
               @click="${t=>{t.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${_s}" height="${vs}" rx="8"
                      fill="white"
                      stroke="${i?n:`#e2e8f0`}"
                      stroke-width="${i?2.5:1.5}"
                      filter="url(#shadow)"/>
                <!-- type badge -->
                <rect x="0" y="0" width="32" height="${vs}" rx="8" fill="${n}" clip-path="inset(0 -8px 0 0 round 8px)"/>
                <rect x="24" y="0" width="8" height="${vs}" fill="${n}"/>
                <text x="16" y="${33}" text-anchor="middle"
                      font-size="14" fill="white">${r}</text>
                <!-- name -->
                <text x="44" y="${vs/2-6}" font-size="11" fill="#1e293b" font-weight="600">
                ...
                <div class="prop-body">
                    ...
                    ${n(`Type`,E`
                        <select class="inp" @change="${t=>this.updateStep(e.id,{type:t.target.value})}">
                            ${ws.map(t=>E`<option value="${t}" ?selected="${e.type===t}">${t}</option>`)}
                        </select>`)}
        ...
        `}exportJson(){let e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:`application/json`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=(this.wf.name??`workflow`).replace(/\s+/g,`-`).toLowerCase()+`.json`,r.click(),URL.revokeObjectURL(n)}static{this.styles=[as,g`
    ...
    `]}};k([b()],Es.prototype,`value`,void 0),k([w()],Es.prototype,`wf`,void 0),k([w()],Es.prototype,`positions`,void 0),k([w()],Es.prototype,`selectedId`,void 0),k([w()],Es.prototype,`showMeta`,void 0),Es=k([_(`mateu-workflow`)],Es);var Ds=[`string`,`integer`,`number`,`bool`,`date`,`time`,`dateTime`,`dateRange`,`money`,`file`,`array`,`status`,`component`,`menu`,`range`,`action`,`actionGroup`],Os=[`regular`,`radio`,`checkbox`,`textarea`,`toggle`,`combobox`,`select`,`email`,`password`,`richText`,`listBox`,`html`,`markdown`,`image`,`icon`,`link`,`money`,`grid`,`color`,`choice`,`popover`,`slider`,`button`,`stars`],ks={string:`#3B82F6`,integer:`#8B5CF6`,number:`#6366F1`,bool:`#10B981`,date:`#F59E0B`,time:`#F59E0B`,dateTime:`#F59E0B`,dateRange:`#F59E0B`,money:`#EF4444`,file:`#64748B`,array:`#0EA5E9`,status:`#EC4899`,component:`#14B8A6`,menu:`#94A3B8`,range:`#A855F7`,action:`#F97316`,actionGroup:`#FB923C`};function As(){return`field-`+Math.random().toString(36).slice(2,8)}var js=class extends x{constructor(...e){super(...e),this.value=`{"name":"New Form","fields":[]}`,this.form={name:`New Form`,fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has(`value`))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){let e=this.shadowRoot?.querySelector(`.field-list`);!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=oe.create(e,{animation:150,handle:`.drag-handle`,ghostClass:`sortable-ghost`,onEnd:e=>{let{oldIndex:t,newIndex:n}=e;if(t===void 0||n===void 0||t===n)return;let r=[...this.form.fields],[i]=r.splice(t,1);r.splice(n,0,i),this.form={...this.form,fields:r},this.emit()}}))}emit(){let e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent(`value-changed`,{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(n=>n.id===e?{...n,...t}:n)},this.emit()}addField(){let e=As(),t={id:e,label:`New Field`,dataType:`string`};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){let t=this.form.fields.find(t=>t.id===e);if(!t)return;let n={...t,id:As(),label:t.label+` (copy)`},r=this.form.fields.findIndex(t=>t.id===e),i=[...this.form.fields];i.splice(r+1,0,n),this.form={...this.form,fields:i},this.selectedId=n.id,this.emit()}render(){return E`
        ...
        `}renderRow(e){let t=ks[e.dataType]??`#64748b`;return E`
        ...
        `}exportJson(){let e=JSON.stringify(this.form,null,2),t=new Blob([e],{type:`application/json`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=(this.form.name??`form`).replace(/\s+/g,`-`).toLowerCase()+`.json`,r.click(),URL.revokeObjectURL(n)}static{this.styles=[as,R,g`
        :host { display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif); }
        ...
        textarea.inp { resize: vertical; }
        input[readonly].inp { background: #f8fafc; color: #94a3b8; }
    `]}};k([b()],js.prototype,`value`,void 0),k([w()],js.prototype,`form`,void 0),k([w()],js.prototype,`selectedId`,void 0),k([w()],js.prototype,`showMeta`,void 0),js=k([_(`mateu-form-editor`)],js);var Ms=class extends x{constructor(...e){super(...e),this.appState={},this.appData={},this.open=!1,this.activeTab=`appstate`,this.hoveredTag=``,this.hoveredId=``,this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null,this._prevTarget=null,this._onMouseover=e=>{let t=e.target;for(;t&&!(t.tagName?.toLowerCase().startsWith(`mateu-`)&&t!==this);)t=t.parentElement;if(t===this||t===null){t===null&&this._prevTarget&&(this._prevTarget.style.outline=``,this._prevTarget.style.outlineOffset=``,this._prevTarget=null,this.hoveredTag=``,this.hoveredId=``,this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null);return}t!==this._prevTarget&&(this._prevTarget&&(this._prevTarget.style.outline=``,this._prevTarget.style.outlineOffset=``),this._prevTarget=t,t.style.outline=`2px solid #0070f3`,t.style.outlineOffset=`-2px`,this.hoveredTag=t.tagName.toLowerCase(),this.hoveredId=t.id||``,this.hoveredState=t.state,this.hoveredData=t.data,this.hoveredMeta=t.component?.metadata)}}connectedCallback(){super.connectedCallback(),document.addEventListener(`mouseover`,this._onMouseover,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`mouseover`,this._onMouseover,!0),this._prevTarget&&=(this._prevTarget.style.outline=``,null)}_fmt(e){try{return JSON.stringify(e,null,2)??`null`}catch{return String(e)}}_renderTab(e,t){return E`
    ...
    `}};k([b()],Ms.prototype,`appState`,void 0),k([b()],Ms.prototype,`appData`,void 0),k([w()],Ms.prototype,`open`,void 0),k([w()],Ms.prototype,`activeTab`,void 0),k([w()],Ms.prototype,`hoveredTag`,void 0),k([w()],Ms.prototype,`hoveredId`,void 0),k([w()],Ms.prototype,`hoveredState`,void 0),k([w()],Ms.prototype,`hoveredData`,void 0),k([w()],Ms.prototype,`hoveredMeta`,void 0),Ms=k([_(`mateu-debug-overlay`)],Ms);var Ns=(e,t)=>{let n=t?.initiatorState;return n&&typeof n==`object`?{...n}:{...e??{}}},Ps=e=>{if(e)try{return JSON.parse(e)}catch{return{value:e}}else return{}},Fs=function(e){return e.required=`required`,e.disabled=`disabled`,e.hidden=`hidden`,e.pattern=`pattern`,e.minValue=`minValue`,e.maxValue=`maxValue`,e.minLength=`minLength`,e.maxLength=`maxLength`,e.css=`css`,e.style=`style`,e.theme=`theme`,e.errorMessage=`errorMessage`,e.description=`description`,e.none=`none`,e}({}),Is=function(e){return e.Continue=`Continue`,e.Stop=`Stop`,e}({}),Ls=12e4,Rs=(e,t)=>`${e??`_`}::${t}`,zs=new class{constructor(){this.started=new Map,this.listeners=new Set}begin(e,t=Date.now()){let n=this.started.get(e);return n!==void 0&&t-n<Ls?!1:(this.started.set(e,t),this.emit(),!0)}end(e){this.started.delete(e)&&this.emit()}isPending(e,t=Date.now()){let n=this.started.get(e);return n!==void 0&&t-n<Ls}snapshot(){return new Set(this.started.keys())}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}reset(){this.started.clear(),this.emit()}emit(){let e=this.snapshot();this.listeners.forEach(t=>t(e))}},Bs=`data-mateu-pending-styles`,Vs=`
[data-mateu-pending] {
    pointer-events: none;
    cursor: progress;
...
`);e=a.pop()??``;for(let e of a){let t=e.trim();if(t)if(t.startsWith(`data:`)){let e=JSON.parse(t.substring(5).trim());f&&f(e),p||this.handleUIIncrement(e,u,m),e.messages&&e.messages.length==1&&e.messages[0].variant==`error`&&u.shadowRoot?.dispatchEvent(new CustomEvent(`backend-call-failed`,{detail:{actionId:i},bubbles:!0,composed:!0}))}else{let e=t;try{let n=JSON.parse(t);e=n.message,n._embedded?.errors?.length>0&&n._embedded.errors[0].message&&(e=n._embedded.errors[0].message)}catch{}throw Error(e)}}}}d||u.dispatchEvent(new CustomEvent(`backend-succeeded-event`,{bubbles:!0,composed:!0,detail:{actionId:i}})),u.shadowRoot?.dispatchEvent(new CustomEvent(`backend-call-succeeded`,{detail:{actionId:i},bubbles:!0,composed:!0}))}).catch(e=>{u.dispatchEvent(new CustomEvent(`backend-failed-event`,{bubbles:!0,composed:!0,detail:{actionId:i,reason:this.serialize(e),retry:ee}})),u.shadowRoot?.dispatchEvent(new CustomEvent(`backend-call-failed`,{detail:{actionId:i},bubbles:!0,composed:!0}))})}}serialize(e){return e?.message?e:JSON.stringify(e)}},ac={fixed:`fixed`,fullWidth:`full`,edgeToEdge:`edge`},oc=new Set([j.Gantt,j.PlanningBoard,j.Kanban,j.Bpmn,j.Workflow,j.Map]),sc={landing:`fixed`,form:`fixed`,process:`fixed`},cc=e=>e?ac[e]:void 0,lc=e=>e.type==A.ClientSide?e.metadata:void 0,uc=e=>{let t=lc(e);if(t?.type==j.Page){let e=cc(t.pageWidth);if(e)return e}for(let t of e.children??[]){let e=uc(t);if(e)return e}},dc=e=>{let t=e.pageType;if(t)return t;let n=e=>{let t=lc(e);if(t?.type==j.Page&&t.pageType)return t.pageType;for(let t of e.children??[]){let e=n(t);if(e)return e}};return n(e)},fc=e=>{let t=lc(e);if(t?.type!=j.Crud)return!1;let n=t;return n.compact?!0:(n.columns??[]).some(e=>e.metadata?.editable)},pc=(e,t)=>t(e)||(e.children??[]).some(e=>pc(e,t)),mc=e=>!!e&&pc(e,e=>lc(e)?.type==j.HeroSection),hc=e=>lc(e)?.type==j.App||(e.children??[]).some(e=>lc(e)?.type==j.App),gc=(e,t)=>e?(cc(e.pageWidth)??uc(e))||(t?.top&&hc(e)?`edge`:sc[dc(e)??``]||(pc(e,e=>{let t=lc(e)?.type;return t!=null&&oc.has(t)})?`edge`:pc(e,fc)?`full`:`fixed`)):`fixed`,_c=`mateu-route-structure-cache`,vc=1,yc=50,bc=(()=>{try{return localStorage.getItem(`mateu-route-structure-cache-off`)!==`1`}catch{return!0}})(),xc=()=>{try{return JSON.parse(localStorage.getItem(_c)??`{}`)}catch{return{}}},Sc=e=>{try{localStorage.setItem(_c,JSON.stringify(e))}catch{try{let t=Object.entries(e).sort((e,t)=>t[1].t-e[1].t).slice(0,Math.floor(yc/2));localStorage.setItem(_c,JSON.stringify(Object.fromEntries(t)))}catch{}}},Cc=e=>{let t=e.initialState&&Object.keys(e.initialState).length?`#`+Ec(JSON.stringify(e.initialState)):``;return[e.baseUrl,e.consumedRoute??``,e.route??``,e.serverSideType??``].join(`|`)+t},wc=e=>{if(!bc)return;let t=xc()[e];if(!(!t||t.v!==vc))return{component:t.component,hash:t.hash}},Tc=(e,t,n)=>{if(!bc)return;let r=xc();r[e]={v:vc,t:Date.now(),component:t,hash:n};let i=Object.keys(r);if(i.length>yc){let e=i.sort((e,t)=>r[e].t-r[t].t).slice(0,i.length-yc);for(let t of e)delete r[t]}Sc(r)},Ec=e=>{let t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return(t>>>0).toString(36)},Dc=30,Oc=new Map,kc=!0,Ac=e=>{if(kc)return Oc.get(e)},jc=(e,t)=>{if(kc&&(Oc.delete(e),Oc.set(e,t),Oc.size>Dc)){let e=Oc.keys().next().value;e!==void 0&&Oc.delete(e)}},Mc,X=class extends zt{static{Mc=this}constructor(...e){super(...e),this.consumedRoute=``,this.serverSideType=void 0,this.uriPrefix=void 0,this.overrides=void 0,this.homeRoute=void 0,this.route=void 0,this.top=void 0,this.appState={},this.appData={},this.preventNavigation=!1,this.overridesParsed={},this.fragment=void 0,this.showSkeleton=!1,this.pendingRouteFocus=!1,this.hasRenderedContent=!1,this.loadLifecycleListener=e=>{if(((typeof e.composedPath==`function`?e.composedPath():[])[0]??e.target)===this)if(clearTimeout(this.skeletonTimer),e.type===`backend-called-event`){if(this.fragment?.component)return;this.skeletonTimer=setTimeout(()=>{this.showSkeleton=!0},Mc.SKELETON_DELAY_MS)}else this.showSkeleton=!1},this.actionRequestedListener=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.manageActionEvent(e))},this.historyPushed=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.preventNavigation=!0,this.route=e.detail.route)},this.routeChangedListener=e=>{if(e instanceof CustomEvent){e.preventDefault(),e.stopPropagation();let t=e.detail.route;typeof t==`string`&&(t===``||t.startsWith(`/`))&&this.consumedRoute&&this.consumedRoute!==`_empty`&&this.consumedRoute.startsWith(`/`)&&!t.startsWith(this.consumedRoute)&&(t=this.consumedRoute+t),this.uriPrefix&&(t=t.startsWith(`/`)&&this.uriPrefix.endsWith(`/`)?this.uriPrefix+t.substring(1):!t.startsWith(`/`)&&!this.uriPrefix.endsWith(`/`)?this.uriPrefix+`/`+t:this.uriPrefix+t),this.dispatchEvent(new CustomEvent(`url-update-requested`,{detail:{route:t},bubbles:!0,composed:!0}))}},this.backendFailedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&e.detail.actionId==``&&(this.fragment={targetComponentId:this.id,data:{},state:{},component:{type:A.ClientSide,metadata:{type:j.Element,name:`div`,content:`Not found`},id:`fieldId`},action:We.Replace,containerId:void 0})},this.detail1=void 0,this.manageActionEvent=e=>{e.preventDefault(),e.stopPropagation(),this.detail1=e.detail;let t=this.detail1;if(e.type==`server-side-action-requested`){let e=rc;t.sse&&(e=ic),e.runAction(Mt,this.baseUrl,t.route??``,t.consumedRoute,t.actionId,t.initiatorComponentId,this.getCustomisedAppState(),t.serverSideType,t.componentState,t.parameters,t.initiator,t.background,t.callback,t.callbackonly,t.callbackToken,{timeoutMillis:t.timeoutMillis,idempotent:t.idempotent,knownStructureHash:t.knownStructureHash})}},this.getCustomisedAppState=()=>{let e={...O.value};if(this.overrides){let t=Ps(this.overrides);e={...e,...t}}return e}}manageActionRequestedEvent(e){throw Error(`Method not implemented.`)}createRenderRoot(){return N.mustUseShadowRoot()?super.createRenderRoot():this}structureCacheKey(){return Cc({baseUrl:this.baseUrl,consumedRoute:this.consumedRoute,route:this.route,serverSideType:this.serverSideType,initialState:this.initialState})}focusNewContent(){requestAnimationFrame(()=>{let e=this.renderRoot?.querySelector?.(`h1, h2, [role="heading"]`)??this;e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`-1`),e.focus?.({preventScroll:!0})})}static{this.SKELETON_DELAY_MS=400}connectedCallback(){super.connectedCallback(),this.overridesParsed=Ps(this.overrides),this.addEventListener(`server-side-action-requested`,this.actionRequestedListener),this.addEventListener(`backend-call-failed`,this.backendFailedListener),this.addEventListener(`history-pushed`,this.historyPushed),this.addEventListener(`route-changed`,this.routeChangedListener),this.addEventListener(`backend-called-event`,this.loadLifecycleListener),this.addEventListener(`backend-succeeded-event`,this.loadLifecycleListener),this.addEventListener(`backend-failed-event`,this.loadLifecycleListener),this.addEventListener(`backend-cancelled-event`,this.loadLifecycleListener)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`server-side-action-requested`,this.actionRequestedListener),this.removeEventListener(`backend-call-failed`,this.backendFailedListener),this.removeEventListener(`history-pushed`,this.historyPushed),this.removeEventListener(`route-changed`,this.routeChangedListener),this.removeEventListener(`backend-called-event`,this.loadLifecycleListener),this.removeEventListener(`backend-succeeded-event`,this.loadLifecycleListener),this.removeEventListener(`backend-failed-event`,this.loadLifecycleListener),this.removeEventListener(`backend-cancelled-event`,this.loadLifecycleListener),clearTimeout(this.skeletonTimer)}shouldUpdate(e){if(this.fragment?.component&&[...e.keys()].every(e=>e===`appState`||e===`appData`)){let t=this.renderRoot.querySelector(`mateu-component`);if(t)return e.has(`appState`)&&(t.appState=this.appState),e.has(`appData`)&&(t.appData=this.appData),!1}return!0}updated(e){if((e.has(`id`)||e.has(`baseurl`)||e.has(`route`)||e.has(`consumedRoute`)||e.has(`instant`))&&!this.preventNavigation){this.callbackToken=this.instant||se();let e=this.structureCacheKey(),t=e===this.lastAuthoritativeKey?void 0:Ac(e);if(t)queueMicrotask(()=>this.applyFragment(t));else{if(e!==this.lastAuthoritativeKey){let t=wc(e);this.currentStructureHash=t?.hash,t&&(this.fragment={targetComponentId:this.id,component:t.component,state:{},data:{},action:We.Replace,containerId:void 0},this.stampPageChrome())}this.manageActionEvent(new CustomEvent(`server-side-action-requested`,{detail:{route:this.route,consumedRoute:this.consumedRoute,userData:void 0,actionId:``,serverSideType:this.serverSideType,initiatorComponentId:this.id,initiator:this,componentState:this.initialState,knownStructureHash:this.currentStructureHash,callbackToken:this.callbackToken},bubbles:!0,composed:!0}))}}e.has(`route`)&&this.top&&(this.preventNavigation||(this.pendingRouteFocus=!0),this.preventNavigation||this.dispatchEvent(new CustomEvent(`route-changed`,{detail:{route:this.route},bubbles:!0,composed:!0}))),this.preventNavigation&&=!1}applyFragment(e){if(!e.component&&this.fragment?.component){this.fragment={...this.fragment,state:{...this.fragment.state??{},...e.state??{}},data:{...this.fragment.data??{},...e.data??{}}},this.stampPageChrome();return}if(this.fragment=e,e.component){if(e.action!==We.Add){let t=this.structureCacheKey(),n=e.component.structureHash;Tc(t,e.component,n),this.lastAuthoritativeKey=t,this.currentStructureHash=n,e.component.staticView&&jc(t,e)}this.pendingRouteFocus&&this.hasRenderedContent&&this.focusNewContent(),this.pendingRouteFocus=!1,this.hasRenderedContent=!0}this.stampPageChrome()}stampPageChrome(){let e=this.fragment?.component;!e||e===this.lastStampedComponent||(this.lastStampedComponent=e,this.dataset.pageWidth=gc(e,{top:this.top}),this.dataset.pageType=dc(e)??``,this.dataset.hasWelcomeBanner=String(mc(e)))}render(){return!this.fragment?.component&&this.showSkeleton?E`
  ...
  `}};k([b()],X.prototype,`consumedRoute`,void 0),k([b()],X.prototype,`serverSideType`,void 0),k([b()],X.prototype,`uriPrefix`,void 0),k([b()],X.prototype,`overrides`,void 0),k([b()],X.prototype,`homeRoute`,void 0),k([b()],X.prototype,`route`,void 0),k([b()],X.prototype,`top`,void 0),k([b()],X.prototype,`instant`,void 0),k([b()],X.prototype,`initialState`,void 0),k([b()],X.prototype,`appState`,void 0),k([b()],X.prototype,`appData`,void 0),k([w()],X.prototype,`fragment`,void 0),k([w()],X.prototype,`showSkeleton`,void 0),X=Mc=k([_(`mateu-ux`)],X);function Nc(e){let t=`var(--lumo-space-m, 1rem)`,n={left:`50%`,transform:`translateX(-50%)`};switch(e){case`topStart`:return{top:t,left:t};case`topCenter`:return{top:t,...n};case`topEnd`:return{top:t,right:t};case`topStretch`:return{top:t,left:t,right:t};case`middle`:return{top:`50%`,left:`50%`,transform:`translate(-50%, -50%)`};case`bottomStart`:return{bottom:t,left:t};case`bottomCenter`:return{bottom:t,...n};case`bottomStretch`:return{bottom:t,left:t,right:t};default:return{bottom:t,right:t}}}function Pc(e){switch(e){case`success`:return{bg:`var(--lumo-success-color, #2e7d32)`,fg:`#fff`};case`error`:return{bg:`var(--lumo-error-color, #c62828)`,fg:`#fff`};case`warning`:return{bg:`var(--lumo-warning-color, #f9a825)`,fg:`#1a1a1a`};case`contrast`:return{bg:`var(--lumo-contrast-90pct, #1a1a1a)`,fg:`#fff`};default:return{bg:`var(--lumo-base-color, #fff)`,fg:`var(--lumo-body-text-color, #1a1a1a)`}}}var Fc={show(e,t){let{bg:n,fg:r}=Pc(e.variant),i=Nc(e.position),a=document.createElement(`div`),o=e.variant===`error`;a.setAttribute(`role`,o?`alert`:`status`),a.setAttribute(`aria-live`,o?`assertive`:`polite`),a.setAttribute(`aria-atomic`,`true`),Object.assign(a.style,{position:`fixed`,zIndex:`2000`,display:`flex`,alignItems:`center`,gap:`0.75rem`,maxWidth:`min(90vw, 28rem)`,padding:`0.7rem 1rem`,borderRadius:`var(--lumo-border-radius-m, 8px)`,boxShadow:`var(--lumo-box-shadow-m, 0 4px 16px rgba(0,0,0,0.2))`,background:n,color:r,font:`inherit`,fontSize:`var(--lumo-font-size-s, 0.875rem)`,opacity:`0`,transition:`opacity 0.2s ease`,...i});let s=document.createElement(`span`);s.textContent=e.text,a.appendChild(s);let c=()=>{a.style.opacity=`0`,setTimeout(()=>a.remove(),200)},l=e.onAction?{label:e.actionLabel??`Retry`,run:e.onAction}:e.undoActionId?{label:e.undoLabel??`Undo`,run:()=>t.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.undoActionId,parameters:e.undoParameters??{}},bubbles:!0,composed:!0}))}:void 0;if(l){let e=document.createElement(`button`);e.textContent=l.label,e.style.cssText=`margin-left: 0.25rem; background: none; border: 1px solid currentColor; border-radius: var(--lumo-border-radius-s, 4px); color: inherit; cursor: pointer; padding: 0.15rem 0.6rem; font: inherit; font-weight: 600;`,e.addEventListener(`click`,()=>{l.run(),c()}),a.appendChild(e)}document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity=`1`});let u=e.duration??(l?1e4:5e3);u>0&&setTimeout(c,u)}};function Ic(){wo(Fc)}var Lc=class extends x{constructor(...e){super(...e),this.online=!0,this.recovered=!1}connectedCallback(){super.connectedCallback(),this.online=Ot.isOnline(),this.unsubscribe=Ot.subscribe(e=>{let t=!this.online;this.online=e,e&&t&&(this.recovered=!0,clearTimeout(this.recoveredTimer),this.recoveredTimer=setTimeout(()=>{this.recovered=!1},4e3))})}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.(),clearTimeout(this.recoveredTimer),this.releaseSpace()}updated(){let e=this.renderRoot.querySelector(`.bar`);if(!e){this.releaseSpace();return}document.body.style.setProperty(`padding-block-start`,`${e.offsetHeight}px`)}releaseSpace(){typeof document<`u`&&document.body?.style.removeProperty(`padding-block-start`)}render(){if(this.online&&!this.recovered)return y;let e=!this.online;return E`<div class="bar ${e?`offline`:`back`}" role="status" aria-live="polite">
    ...
    `}};k([w()],Lc.prototype,`online`,void 0),k([w()],Lc.prototype,`recovered`,void 0),Lc=k([_(`mateu-connectivity-banner`)],Lc);var Rc=null;function zc(){if(!(typeof document>`u`)&&!(Rc&&Rc.isConnected)){if(!document.body){document.addEventListener(`DOMContentLoaded`,()=>zc(),{once:!0});return}Rc=document.createElement(`mateu-connectivity-banner`),document.body.appendChild(Rc)}}var Bc,Vc=class extends x{static{Bc=this}constructor(...e){super(...e),this.skip=()=>{let e=this.findContent();e&&(e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`-1`),e.focus(),e.scrollIntoView({block:`start`}))}}static{this.TARGETS=[`.app-content`,`mateu-page`,`mateu-ux`,`mateu-component`]}findContent(){let e=new Set,t=n=>{if(e.has(n))return null;e.add(n);for(let e of Bc.TARGETS){let t=n.querySelector?.(e);if(t&&t!==this)return t}for(let e of Array.from(n.querySelectorAll?.(`*`)??[]))if(e.shadowRoot){let n=t(e.shadowRoot);if(n)return n}return null};return t(document)}render(){return E`<button class="skip" @click="${this.skip}">Skip to content</button>`}static{this.styles=g`
        :host {
            position: fixed;
            inset-block-start: 0;
  ...
  `}};k([b()],Kc.prototype,`baseUrl`,void 0),k([b()],Kc.prototype,`route`,void 0),k([b()],Kc.prototype,`consumedRoute`,void 0),k([b()],Kc.prototype,`config`,void 0),k([b()],Kc.prototype,`top`,void 0),k([b()],Kc.prototype,`pathPrefix`,void 0),k([b()],Kc.prototype,`bundleUrl`,void 0),k([w()],Kc.prototype,`instant`,void 0),k([b({type:Boolean})],Kc.prototype,`debug`,void 0),Kc=k([_(`mateu-ui`)],Kc);var qc,Jc=class extends x{static{qc=this}constructor(...e){super(...e),this.baseUrl=``,this.opened=!1,this.searchText=``}static{this.SEARCHABLE_THRESHOLD=7}connectedCallback(){super.connectedCallback(),Re()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick(),this.searchTimer&&clearTimeout(this.searchTimer)}currentValue(){return String(Pe()[this.selector.fieldName]??``)}currentLabel(){let e=this.currentValue();if(!e)return`—`;let t=(this.searchedOptions??this.selector.options)?.find(t=>String(t.value)===e);if(t)return t.label;let n=Fe()[this.selector.fieldName];return n===void 0?e:String(n)}pick(e,t){Ie(this.selector.fieldName,e,t),window.location.reload()}detachOutsideClick(){this.outsideClick&&=(document.removeEventListener(`mousedown`,this.outsideClick),void 0)}openPanel(){this.opened||(this.opened=!0,this.searchText=``,this.searchedOptions=void 0,this.remoteSearch(),this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener(`mousedown`,this.outsideClick),this.updateComplete.then(()=>this.renderRoot.querySelector(`input.picker-search`)?.focus()))}closePanel(){this.detachOutsideClick(),this.opened=!1}onSearchInput(e){this.searchText=e.target.value,this.searchTimer&&clearTimeout(this.searchTimer),this.searchTimer=setTimeout(()=>this.remoteSearch(),300)}async remoteSearch(){let e=this.app;if(e?.serverSideType)try{let t=await Mt.runAction(this.baseUrl??``,e.rootRoute??e.initialRoute??``,``,`_appcontext-search-${this.selector.fieldName}`,`appcontext-${this.selector.fieldName}`,void 0,e.serverSideType,{},{searchText:this.searchText},this,!0);for(let e of t?.fragments??[]){let t=e.data?.[`_appcontext_${this.selector.fieldName}`]?.content;if(Array.isArray(t)){this.searchedOptions=t.map(e=>({value:e.value,label:e.label??String(e.value)}));return}}}catch{}}visibleOptions(){let e=this.searchedOptions??this.selector.options??[],t=this.searchText.trim().toLowerCase();return t?e.filter(e=>e.label.toLowerCase().includes(t)):e}renderPanel(){let e=this.currentValue(),t=this.visibleOptions();return E`
    ...
    `}};k([b()],Jc.prototype,`selector`,void 0),k([b()],Jc.prototype,`app`,void 0),k([b()],Jc.prototype,`baseUrl`,void 0),k([w()],Jc.prototype,`opened`,void 0),k([w()],Jc.prototype,`searchText`,void 0),k([w()],Jc.prototype,`searchedOptions`,void 0),Jc=qc=k([_(`mateu-app-context-picker`)],Jc);var Yc=class extends x{constructor(...e){super(...e),this.baseUrl=``,this.opened=!1,this.notifications=[],this.fetched=!1}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}updated(){!this.fetched&&this.app?.serverSideType&&(this.fetched=!0,this.refresh())}unreadCount(){return this.notifications.filter(e=>e.unread).length}async runNotificationsAction(e,t){let n=this.app;if(n?.serverSideType)try{let r=await Mt.runAction(this.baseUrl??``,n.rootRoute??n.initialRoute??``,``,e,`notification-bell`,void 0,n.serverSideType,{},t,this,!0);for(let e of r?.fragments??[]){let t=e.data?._notifications;if(Array.isArray(t)){this.notifications=t;return}}}catch{}}refresh(){return this.runNotificationsAction(`_notifications-list`,{})}markRead(e){return this.runNotificationsAction(`_notifications-read`,{ids:e})}detachOutsideClick(){this.outsideClick&&=(document.removeEventListener(`mousedown`,this.outsideClick),void 0)}openPanel(){this.opened||(this.opened=!0,this.refresh(),this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener(`mousedown`,this.outsideClick))}closePanel(){this.detachOutsideClick(),this.opened=!1}async entryClicked(e){e.unread&&await this.markRead([e.id]);let t=e.route;if(t){if(!Wo.confirmLeave())return;this.closePanel(),this.dispatchEvent(new CustomEvent(`route-changed`,{detail:{route:t},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`navigate-to-requested`,{detail:{route:t},bubbles:!0,composed:!0}))}}renderEntry(e){return E`
        ...
        ${R}
    `}};k([b()],Yc.prototype,`app`,void 0),k([b()],Yc.prototype,`baseUrl`,void 0),k([w()],Yc.prototype,`opened`,void 0),k([w()],Yc.prototype,`notifications`,void 0),Yc=k([_(`mateu-notification-bell`)],Yc);var Xc=e=>{if(!e||!(`querySelectorAll`in e))return null;for(let t of e.querySelectorAll(`*`)){if(t.tagName?.toLowerCase()===`mateu-component`)return t;let e=Xc(t.shadowRoot);if(e)return e}return null},Zc=async(e,t,n)=>{let r=Xc(t.renderRoot??t);await ic.runAction(Mt,t.baseUrl??``,e.rootRoute||`_no_route`,``,n,r?.id??`app-header-action`,{},e.serverSideType??``,{},{},r??t,!0,void 0,!1,``)},Qc=async(e,t,n)=>{try{await Zc(e,t,n)}catch(e){To({text:`La acción falló: `+e,position:`bottomStart`,duration:6e3,variant:`error`},t)}},$c=(e,t)=>{let n=e.contextSelectors??[],r=e.contextActions??[];return n.length===0&&r.length===0&&!e.notificationsEnabled?y:E`${e.notificationsEnabled?E`
        ...
        <details class="mateu-nav-group" style="margin-left: 0.5rem; flex-shrink: 0;">
            ...
            <div class="mateu-nav-panel" style="right: 0; left: auto;">
                ${n.children.map(n=>E`
                    <button class="mateu-nav-item" @click="${()=>n.actionId&&Qc(e,t,n.actionId)}">${n.label}</button>`)}
            </div>
        </details>`:E`
        <button class="app-header-action-btn" style="margin-left: 0.5rem; flex-shrink: 0;"
            @click="${()=>n.actionId&&Qc(e,t,n.actionId)}" title="${n.label}">${n.icon?F(n.icon):y}${n.label}</button>`)}`},el=(e,t)=>E`
    <button class="mateu-nav-item ${e.selected?`mateu-nav-item--active`:``}"
            ?disabled="${e.disabled}"
            @click="${()=>t(e)}">${e.text}</button>`,tl=(e,t,n=``)=>E`
    <nav class="mateu-nav ${n}">
        ${e.map(e=>(e.children?.length??0)>0?E`<details class="mateu-nav-group">
                       ...
                       <div class="mateu-nav-panel">
                           ${e.children.map(e=>el(e,t))}
                       </div>
                   </details>`:el(e,t))}
    </nav>`,nl=(e,t)=>n=>t.call(e,{detail:{value:n}}),rl=(e,t)=>e.themeToggle?E`
    ...
    `:y,il=(e,t)=>{t.filter!=e.detail.value&&(t.filter=e.detail.value)},al=(e,t,n)=>{let r=ol(e,t,n),i=Z(t,n);return r==`list`||r==i?`new`:r},ol=(e,t,n)=>{let r=e?._route;if(r!=null&&(r===``||r.startsWith(`/`))){let e=n.homeRoute??``,i=e.indexOf(`?`),a=i>=0?e.substring(i+1):``,o=Z(t,n)+r;return a?o+(o.indexOf(`?`)>=0?`&`:`?`)+a:o}return t.selectedRoute?t.selectedRoute:n.homeRoute},Z=(e,t)=>e.selectedRoute?e.selectedConsumedRoute??t.route:t.homeConsumedRoute,sl=(e,t)=>e.selectedRoute?e.selectedBaseUrl??e.baseUrl:e.baseUrl||t.homeBaseUrl,cl=(e,t)=>e.selectedRoute?e.selectedServerSideType??t.serverSideType:t.homeServerSideType,ll=(e,t)=>e.selectedRoute?e.selectedUriPrefix:t.homeUriPrefix,ul=(e,t)=>`ux_`+((Z(e,t)||`root`)+`|`+(cl(e,t)??``)).replace(/[^a-zA-Z0-9]/g,`_`),dl=(e,t,n,r,i,a,o)=>{t.variant!==Nt.MENU_ON_TOP&&t.menu?.some(e=>e.remote)&&(t={...t,variant:Nt.MENU_ON_TOP});let s=ul(e,t);if(t.chromeless)return E`
        ...
        `;let c=e.mapItems(t.menu,e.filter?.toLowerCase()??``),l=Z(e,t),u=al(r,e,t),d=u&&u!==`new`&&u.startsWith(l+`/`)?u.substring(l.length+1).split(`/`)[0]:void 0;return E`
...
`:y}
                            ...
                            ${t.menu&&t.totalMenuOptions>10?E`
                                <div style="position: sticky; top: 0; z-index: 2; background: var(--lumo-base-color); padding: .25rem 0 .5rem;">
                                    <input class="drawer-search" placeholder="Search…" style="width: calc(100% - 20px); margin: 0 10px;"
                                           @input="${t=>il({detail:{value:t.target.value}},e)}">
                                </div>
                                `:y}
                            <nav class="side-nav">
            ...
            ${t.variant==Nt.MENU_ON_TOP?E`
                <div class="m-vl" style="width: 100%; height: 100vh; overflow: hidden;">
                    <div class="m-hl"
                        ...
                        ${(()=>{let t=nl(e,e.itemSelected);return N.get()?.renderTopNav?.(c,t,`menu-on-top`)??tl(c,t,`menu-on-top`)})()}
            ...
            ${t.variant==Nt.TILES?E`
                <div class="m-vl" style="width: 100%; height: 100vh; overflow: hidden;">
                    <div class="m-hl"
                        ...
                        ${tl(e.mapItemsForTiles(t.menu),nl(e,e.itemSelectedTiles),`menu-on-top`)}
                        <div class="m-hl" style="margin-left: auto; flex-shrink: 0; align-items: center;">
                            <slot name="widgets"></slot>
                            ${$c(t,e)}${rl(t,e)}
                        </div>
            ...
            <slot></slot>
       `},fl=(e,t)=>t!=null&&e!=null&&!e.has(t),pl=typeof HTMLElement<`u`?HTMLElement:class{},ml=class extends pl{static get observedAttributes(){return[`type`,`renderer`]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){let e=this.getAttribute(`type`)??`unknown`,t=this.getAttribute(`renderer`)??`unknown`;this.shadowRoot||this.attachShadow({mode:`open`}),this.shadowRoot.innerHTML=`
            <style>
                :host { display: block; }
                .mateu-unsupported {
                    box-sizing: border-box;
        ...
        `}};typeof customElements<`u`&&!customElements.get(`mateu-unsupported`)&&customElements.define(`mateu-unsupported`,ml);var hl=new Set,gl=(e,t,n)=>{let r=`${n}/${t}`;return hl.has(r)||(hl.add(r),console.warn(`[mateu] Component type "${t}" is not supported by the "${n}" renderer — rendering <mateu-unsupported> placeholder.`)),E`<mateu-unsupported
            type="${t}"
            renderer="${n}"
            data-component-id="${e?.id??y}"
            slot="${e?.slot??y}"
    ></mateu-unsupported>`},_l=class{renderFilterBar(e,t,n,r,i,a,o,s){let c=t?.metadata;return E`
            <mateu-filter-bar
                .metadata="${c}"
        ...
        ></mateu-pagination>
        `}renderTableComponent(e,t,n,r,i,a,o){return Dr(t,(e.data?.[e.id])?.page?.content??[],r[t?.id]?.emptyStateMessage)}rendererName(){return this.constructor?.name??`unknown`}supportedClientSideTypes(){}renderClientSideComponent(e,t,n,r,i,a,o,s){let c=t?.metadata?.type??t?.type,l=Object.values(j).includes(c)?c:void 0;return fl(this.supportedClientSideTypes(),l)?gl(t,l,this.rendererName()):yo(e,t,n,r,i,a,o,s)}renderAppComponent(e,t,n,r,i,a,o){return dl(e,t?.metadata,n,r,i,a,o)}},vl=(e,t,n,r,i,a,o)=>E`
        <vaadin-virtual-list
                ...
                slot="${t.slot??y}"
        ></vaadin-virtual-list>
    `,yl=e=>{let t=e.metadata;return E`
        <vaadin-notification
                .opened="${!0}"
                slot="${e.slot??y}"
                style="${e.style}"
                ...
                `,[])}
        ></vaadin-notification>
    `},bl=(e,t={})=>{let n=e.metadata,r=n.valueKey?t[n.valueKey]:n.value;return E`
        <div style="${e.style}">
        <vaadin-progress-bar
    ...
    `},xl=(e,t,n,r,i,a,o)=>{let s=t.metadata;return E`
        ...
        >
            ...
            `},Sl=(e,t,n)=>{let r=e.metadata;return E`<vaadin-avatar
            img="${r.image}"
            name="${Zt(r.name,t,n)}"
            abbr="${r.abbreviation}"
            style="${e.style}" class="${e.cssClasses}"
            slot="${e.slot??y}"
    ></vaadin-avatar>`},Cl=e=>{let t=e.metadata;return E`<vaadin-avatar-group max-items-visible="${t.maxItemsVisible}"
                                     .items="${t.avatars}"
                                     style="${e.style}" class="${e.cssClasses}"
                                     slot="${e.slot??y}">
    </vaadin-avatar-group>`},wl=(e,t,n,r,i,a,o)=>{let s=t.metadata;if(!s)return E``;let c=``;return s.variants?.map(e=>e==`stretchMedia`?`stretch-media`:e==`coverMedia`?`cover-media`:e).forEach(e=>c+=` `+e),c=c.trim(),E`
        <vaadin-card
                style="${t.style}"
                class="${t.cssClasses}"
                theme="${c}"
    ...
    `}render(){return E`
        ...
        `}};k([b({type:Array})],El.prototype,`tabLabels`,void 0),k([w()],El.prototype,`mode`,void 0),k([w()],El.prototype,`selected`,void 0),El=k([_(`mateu-adaptive-tabs`)],El);var Dl=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style;c??=``,s.columnSpacing&&(c+=`--vaadin-form-layout-column-spacing: `+s.columnSpacing+`;`);let l=s.itemRowSpacing&&s.itemRowSpacing!==`0`?s.itemRowSpacing:`var(--lumo-space-m)`;return c+=`--vaadin-form-layout-row-spacing: `+l+`;`,s.itemLabelSpacing&&(c+=`--vaadin-form-layout-label-spacing: `+s.itemLabelSpacing+`;`),s.labelsAside&&(c+=`--vaadin-form-item-label-width: 10rem;`),s.fullWidth&&(c+=`width: 100%;`),E`
               <vaadin-form-layout 
                       ...
                       slot="${t.slot||y}"
               >
                   ${t.children?.map(t=>Ol(s,e,t,n,r,i,a,o))}
               </vaadin-form-layout>
            `},Ol=(e,t,n,r,i,a,o,s)=>n.type==A.ClientSide&&n.metadata?.type==j.FormRow?Al(e,t,n,r,i,a,o,s):e.labelsAside?kl(t,n,r,i,a,o,s):P(t,n,r,i,a,o,s),kl=(e,t,n,r,i,a,o)=>{if(t.type==A.ClientSide&&t.metadata?.type==j.FormField&&t.metadata.label){let s=t.metadata,c=s.label?.includes("${")?e._evalTemplate(s.label):s.label;return E`
                       <vaadin-form-item data-colspan="${s.colspan}">
                           <label slot="label">${c}</label>
                           ${P(e,t,n,r,i,a,o,!0)}
                       </vaadin-form-item>
                   `}return P(e,t,n,r,i,a,o)},Al=(e,t,n,r,i,a,o,s)=>E`
        <vaadin-form-row>
            ${n.children?.map(n=>Ol(e,t,n,r,i,a,o,s))}
        </vaadin-form-row>
            `,jl=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=(s.padding?` padding`:``)+(s.spacing?` spacing`:``)+(s.spacingVariant?` spacing-`+s.spacingVariant:``)+(s.wrap?` wrap`:``),l=t.style;return s.fullWidth&&(l=l?`width: 100%;`+l:`width: 100%;`),s.justification&&(l=l?`justify-content: `+s.justification+`;`+l:`justify-content: `+s.justification+`;`),s.verticalAlignment&&(l=l?`align-items: `+s.verticalAlignment+`;`+l:`align-items: `+s.verticalAlignment+`;`),E`
               <vaadin-horizontal-layout 
                       style="${l}" 
                       class="${t.cssClasses}"
                       theme="${c}"
    ...
    `},Nl=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style;return s.fullWidth&&(c=c?`width: 100%;`+c:`width: 100%;`),E`
               <vaadin-split-layout 
                       style="${c}" 
                       class="${t.cssClasses}"
            ...
            `},Pl=(e,t,n,r,i,a,o)=>{let s=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,l=!!i?.hasDetail||!!s,u=c??s;return E`
            ...
            `},Fl=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style;c??=``,s.fullWidth&&(c+=`width: 100%;`);let l=s.variant;l==`equalWidth`&&(l=`equal-width-tabs`);let u=Math.max(0,(t.children??[]).findIndex(e=>e.metadata.active)),d=e=>{e.target.selected=u};if(s.adaptable){let u=(t.children??[]).map(t=>{let n=t.metadata.label;return n?.includes("${")?e._evalTemplate(n):n});return E`
            <mateu-adaptive-tabs
                    .tabLabels="${u}"
                    style="${c}"
                    class="${t.cssClasses}"
        ...
        >
            ...
            ${t.children?.map(t=>Il(e,t,n,r,i,a,o))}
        </vaadin-tabsheet>
            `},Il=(e,t,n,r,i,a,o)=>{let s=t.metadata.label;return E`
        <div tab="${s?.includes("${")?e._evalTemplate(s):s}" style="padding: var(--lumo-space-m) 0;">
                   ${t.children?.map(t=>P(e,t,n,r,i,a,o))}
               </div>
            `},Ll=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style;s.fullWidth&&(c=c?`width: 100%;`+c:`width: 100%;`);let l=0;if(t.children){for(let e=0;e<t.children.length;e++)if(t.children[e].metadata?.active){l=e;break}}return E`
               <vaadin-accordion
                       style="${t.style}"
                       class="${t.cssClasses}"
                       opened="${l}"
                       slot="${t.slot??y}"
               >
                   ${t.children?.map(t=>Rl(e,t,n,r,i,a,o,s.variant))}
               </vaadin-accordion>
            `},Rl=(e,t,n,r,i,a,o,s)=>{let c=t.metadata,l=c.label?.includes("${")?e._evalTemplate(c.label):c.label;return E`
    ...
    </vaadin-menu-bar>`,Wl=(e,t,n,r,i,a,o)=>{let s=t.metadata;return E`
        <vaadin-context-menu .items=${ql(e,s.menu,n,r,i,a,o)} 
                             style="${t.style}" 
                             class="${t.cssClasses}"
    ...
    `}};k([b()],$l.prototype,`fieldId`,void 0),k([b()],$l.prototype,`value`,void 0),k([b()],$l.prototype,`accept`,void 0),k([b({type:Boolean})],$l.prototype,`editable`,void 0),$l=Zl=k([_(`mateu-file-upload`)],$l);var eu=e=>e==null||typeof e==`string`&&e.trim()===``,tu=(e,t)=>{if(eu(e))return null;let n=t?parseInt(String(e),10):Number(e);return Number.isNaN(n)?null:n},nu=(e,t)=>eu(e)&&eu(t)?!0:e==t,ru=e=>!!e&&typeof e==`object`&&`__mateuGroup`in e,iu=e=>String(e??``),au=(e,t,n)=>{let r=e??[];if(!t||!n||n.length===0)return r;let i=[],a,o=!1;return r.forEach((e,s)=>{let c=iu(e?.[t]);if(!o||c!==a){let e=n.find(e=>iu(e.value)===c)??{value:c,count:r.filter(e=>iu(e?.[t])===c).length,aggregates:{}};i.push({__mateuGroup:e,__mateuGroupBy:t,_rowNumber:`__mateuGroup:${s}:${c}`}),o=!0,a=c}i.push(e)}),i},ou=(e,t)=>e==null?``:t.dataType===`money`||t.stereotype===`money`?new Intl.NumberFormat(`de-DE`,{minimumFractionDigits:2,maximumFractionDigits:2}).format(e):t.aggregate===`count`?new Intl.NumberFormat(void 0,{maximumFractionDigits:0}).format(Math.round(e)):new Intl.NumberFormat(void 0,{maximumFractionDigits:2}).format(e),su=(e,t)=>e&&t.includes(e)?e:t.find(e=>!!e),cu=(e,t,n)=>{let r=e.__mateuGroup;return t.id===n?`${r.value} (${r.count})`:t.aggregate?ou(r.aggregates?.[t.id],t):``},lu=(e,t,n)=>{let r=t?.aggregates;if(!r||!e.some(e=>e.aggregate))return;let i={};e.forEach(e=>{e.aggregate&&r[e.id]!=null&&(i[e.id]=ou(r[e.id],e))});let a=e[0];if(a&&i[a.id]===void 0){let e=t?.page?.totalElements;i[a.id]=n&&a.id===n&&e!=null?`Total (${e})`:`Total`}return i},uu=(e,t,n)=>{let r=e[n.path]??``,i=t.captionPath?e[t.captionPath]:void 0,a=t.leadingPath?e[t.leadingPath]:void 0;return E`
        ...
        </span>`},du=(e,t,n)=>F(e[n.path]?`vaadin:check`:`vaadin:minus`,`height: 16px; width: 16px; color: var(--lumo-body-text-color);`),fu=(e,t,n,r,i)=>{let a=e[n.path],o=a;return r==`money`&&a&&a.locale&&a.currency?o=new Intl.NumberFormat(a.locale,{style:`currency`,currency:a.currency}).format(a.value):i==`money`&&(o=new Intl.NumberFormat(`de-DE`,{minimumFractionDigits:2,maximumFractionDigits:2}).format(a)),E`${o}`},pu=(e,t,n)=>{e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId,parameters:n},bubbles:!0,composed:!0}))},mu=(e,t,n,r,i,a)=>{let o=n.xcolumn??a;if(o.text)return o.actionId?E`<a href="javascript: void(0);" @click="${t=>pu(n,o,e)}">${o.text}</a>`:E`<a href="${e[n.path]}">${o.text}</a>`;if(r==`string`){if(o.actionId)return E`<a href="javascript: void(0);" @click="${t=>pu(n,o,e)}">${e[n.path]}</a>`;let t=e[n.path];return E`<a href="${t}">${t}</a>`}let s=e[n.path];return E`<a href="${s.href}">${s.text}</a>`},hu=(e,t,n,r,i)=>{let a=e[n.path];return r==`string`?a.split(`,`).map(e=>F(e,`width: 16px;`)):a.split(`,`).map(e=>F(e.icon,`width: 16px;`))},gu=(e,t,n,r,i)=>{let a=e[n.path];return E`${v(a)}`},_u=(e,t,n,r,i,a)=>r==`string`?E`<img src="${e[n.path]}" style="${`max-height: 40px; `+(a.style??``)}">`:E`<img src="${e[n.path].src}" style="${a.style??``}">`,vu=e=>{let t={_clickedRow:e.target.row};e.target?.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:`action-on-row-`+e.detail.value.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},yu=e=>{let t={_clickedRow:e.target.row},n=e.target.action;e.target?.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:`action-on-row-`+n.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},bu=e=>{let t=document.createElement(`vaadin-context-menu-item`),n=document.createElement(`vaadin-icon`);return n.style.color=`var(--lumo-secondary-text-color)`,n.style.marginInlineEnd=`var(--lumo-space-s)`,n.style.padding=`var(--lumo-space-xs)`,n.setAttribute(`icon`,e.icon),t.appendChild(n),e.label&&t.appendChild(document.createTextNode(e.label)),t.disabled=e.disabled,t},xu=(e,t,n)=>{let r=e[n.path]?.actions?.map(e=>e.icon?{component:bu(e),methodNameInCrud:e.methodNameInCrud}:{...e,text:e.label});return!r||r.length==0?E``:E`
                                     <vaadin-menu-bar
                                         ...
                                         @item-selected="${vu}"
                                     ></vaadin-menu-bar>
                                   `},Su=(e,t,n)=>{if(n.path==`select`)return E`
         <vaadin-button theme="tertiary" title="Select" @click="${yu}" .row="${e}" .action="${{actionId:n.path,icon:``,label:`Select`,disabled:!1,methodNameInCrud:`select`}}">
             Select
         </vaadin-button>
    `;let r=n.path&&e[n.path]?.methodNameInCrud?e[n.path]:e.action;return r?E`
         <vaadin-button theme="tertiary${r.icon&&!r.label?` icon`:``}" title="${r.label||y}" @click="${yu}" .row="${e}" .action="${r}">
             ${r.icon?E`<vaadin-icon icon="${r.icon}"></vaadin-icon>`:y}
             ${r.label?r.label:y}
         </vaadin-button>
    `:E``},Cu=(e,t,n)=>{e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId,parameters:n},bubbles:!0,composed:!0}))},wu=(e,t,n,r,i,a)=>{let o=n.xcolumn??a;if(o.actionId)return E`
            <vaadin-button theme="tertiary" @click="${t=>Cu(n,o,e)}" .row="${e}">
                ${o.text||e[n.path]}
            </vaadin-button>
        `;let s=e[n.path];return E`<a href="${s}">${o.text||s}</a>`},Tu=(e,t,n,r,i,a,o,s,c)=>{let l=e[n.path];return P(r,l,i,a,o,s,c)},Eu=new WeakMap,Du=(e,t)=>Eu.get(e)?.[t],Ou=(e,t,n)=>{let r=Eu.get(e);r||(r={},Eu.set(e,r)),r[t]=n},ku=(e,t=!1)=>tu(e,t),Au=(e,t,n,r)=>{let i=n?.field?.fieldId,a=a=>{if(e[t.id]===a||e[t.id]==null&&(a===``||a==null))return;if(e[t.id]=a,!i){n.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:`update-row`,parameters:{_editedRow:{...e}}},bubbles:!0,composed:!0}));return}let o=(n?.state??r)[i];n.dispatchEvent(new CustomEvent(`value-changed`,{detail:{fieldId:i,value:Array.isArray(o)?[...o]:o},bubbles:!0,composed:!0}))},o=e[t.id],s=o==null?``:String(o);switch(t.editorType){case`boolean`:return E`<vaadin-checkbox ?checked=${!!o} @checked-changed=${e=>a(e.detail.value)}></vaadin-checkbox>`;case`integer`:return E`<vaadin-integer-field theme="small" style="width:100%;" .value=${s} @change=${e=>a(ku(e.target.value,!0))}></vaadin-integer-field>`;case`number`:return E`<vaadin-number-field theme="small" style="width:100%;" .value=${s} @change=${e=>a(ku(e.target.value))}></vaadin-number-field>`;case`date`:return E`<vaadin-date-picker theme="small" style="width:100%;" .value=${s} @value-changed=${e=>a(e.detail.value)}></vaadin-date-picker>`;case`time`:return E`<vaadin-time-picker theme="small" style="width:100%;" .value=${s} @value-changed=${e=>a(e.detail.value)}></vaadin-time-picker>`;case`datetime`:return E`<vaadin-date-time-picker theme="small" style="width:100%;" .value=${s} @value-changed=${e=>a(e.detail.value)}></vaadin-date-time-picker>`;case`select`:return E`<vaadin-combo-box
                ...
                .selectedItem=${(t.editorOptions??[]).find(e=>String(e.value)===s)??(s?{value:s,label:Du(e,t.id)??s}:void 0)}
                @selected-item-changed=${n=>{let r=n.detail.value,i=r?r.value:null;String(i??``)!==s&&(r&&Ou(e,t.id,r.label),a(i))}}></vaadin-combo-box>`}default:return E`<vaadin-text-field theme="small" style="width:100%;" .value=${s} @change=${e=>a(e.target.value)}></vaadin-text-field>`}},ju=e=>m(()=>E`<span title="${e}" style="white-space:normal;overflow-wrap:break-word;">${e}</span>`,[e]),Mu=e=>e===void 0?y:d(()=>E`<span style="font-weight: 600; white-space: nowrap;">${e}</span>`,[e]),Nu=e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget?.dispatchEvent(new CustomEvent(`sort-direction-changed`,{detail:{grid:e.currentTarget.parentElement},bubbles:!0,composed:!0}))},Pu=(e,t,n,r,i,a,o,s)=>E`
<vaadin-grid-column-group header="${M(e.label,r,i)}">
    ${e.columns.map(e=>Iu(e.metadata,t,n,r,i,a,o,s?.[e.metadata?.id]))}
</vaadin-grid-column-group>
`,Fu=(e,t,n,r,i,a,o,s)=>j.GridGroupColumn==e.metadata?.type?Pu(e.metadata,t,n,r,i,a,o,s):Iu(e.metadata,t,n,r,i,a,o,s?.[e.metadata?.id]),Iu=(e,n,r,i,a,o,s,c)=>{let l=M(e.label,i,a);return e.sortable?E`
                        <vaadin-grid-sort-column
                                ...
                                width="${e.width??y}"
                                @direction-changed="${Nu}"
                                data-data-type="${e.dataType}"
                                data-stereotype="${e.stereotype}"
                                ${ju(l)}
                                ${Mu(c)}
                                ${t((t,c,l)=>Lu(t,c,l,e,n,r,i,a,o,s),[e,i,a])}
                        ></vaadin-grid-sort-column>
                    `:e.filterable?E`
                    ...
                    `:E`
                        <vaadin-grid-column
                                ...
                                ${t((t,c,l)=>Lu(t,c,l,e,n,r,i,a,o,s),[e,i,a])}
                        ></vaadin-grid-column>
                    `},Lu=(e,t,n,r,i,a,o,s,c,l)=>{let u=n.dataset.dataType??``,d=n.dataset.stereotype??``;if(ru(e)){let t=i?.metadata,n=(t?.columns??[]).flatMap(e=>e?.metadata?.type===j.GridGroupColumn?(e.metadata.columns??[]).map(e=>e?.metadata?.id):[e?.metadata?.id]),a=cu(e,r,su(e.__mateuGroupBy,n)),o=e.__mateuGroup.hiddenActions??[],s=r.id===n[n.length-1]?(t?.groupActions??[]).filter(e=>!o.includes(e.actionId??e.id)):[];return s.length?E`<span style="display: flex; align-items: center; justify-content: flex-end; gap: var(--lumo-space-s); overflow: hidden;">
                ...
                `)}
            </span>`:E`<span title="${a}" style="font-weight: 600; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; display: block;">${a}</span>`}if(r.editable)return Au(e,r,i,o);if(u==`status`)return xo(e,t,n);if(d==`primary`)return uu(e,r,n);if(u==`bool`)return du(e,t,n);if(u==`money`||d==`money`)return fu(e,t,n,u,d);if(u==`link`||d==`link`)return mu(e,t,n,u,d,r);if(u==`icon`||d==`icon`)return hu(e,t,n,u,d);if(d==`html`)return gu(e,t,n,u,d);if(d==`image`)return _u(e,t,n,u,d,r);if(u==`menu`)return xu(e,t,n);if(u==`component`)return Tu(e,t,n,i,a,o,s,c,l);if(u==`action`)return Su(e,t,n);if(u==`actionGroup`)return xu(e,t,n);if(d==`button`||r.actionId)return wu(e,t,n,u,d,r);let f=e[n.path],p=i?.metadata?.rowRoute;if(r.identifier&&p){let t=on(p,e,o,s);if(t)return E`<a href="${`/`+t.replace(/^\/+/,``)}" title="${f}"
            ...
            >
                ...
                `}
                ${this.field?.columns?.map(e=>Fu(e,this,this.baseUrl,this.state,this.data,this.appState,this.appData))}
    ...
    `}};k([b()],Bu.prototype,`field`,void 0),k([b()],Bu.prototype,`state`,void 0),k([b()],Bu.prototype,`data`,void 0),k([b()],Bu.prototype,`appState`,void 0),k([b()],Bu.prototype,`appData`,void 0),k([b()],Bu.prototype,`selectedItems`,void 0),k([w()],Bu.prototype,`detailsOpenedItems`,void 0),Bu=k([_(`mateu-grid`)],Bu);var Vu=class extends x{constructor(...e){super(...e),this.getNewValue=e=>{if(this.field?.dataType==`array`){if(!this.value)return[e];let t=this.value;return t.indexOf(e)>=0?t.filter(t=>t!==e):[...t,e]}return e}}render(){let e=this.field?.options;if(this.field?.remoteCoordinates){let t=this.field.remoteCoordinates;this.data?.[this.field.fieldId]&&this.data[this.field.fieldId].content&&this.data[this.field.fieldId].totalElements?e=this.data[this.field.fieldId].content:this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.action,parameters:{searchText:``,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0}))}return E`
       ...
       `}static{this.styles=g`
        ...
        ${R}
    `}};k([b()],Vu.prototype,`field`,void 0),k([b()],Vu.prototype,`baseUrl`,void 0),k([b()],Vu.prototype,`state`,void 0),k([b()],Vu.prototype,`data`,void 0),k([b()],Vu.prototype,`value`,void 0),Vu=k([_(`mateu-choice`)],Vu);var Hu,Uu=class extends x{static{Hu=this}constructor(...e){super(...e),this.commit=e=>{this.value=e,this.dispatchEvent(new CustomEvent(`value-changed`,{detail:{value:{...e},fieldId:this.fieldId}}))},this.currencyChanged=e=>{let t=this.value??Hu.EMPTY;!e.detail.value||e.detail.value===t.currency||this.commit({...t,currency:e.detail.value})},this.valueChanged=e=>{let t=this.value??Hu.EMPTY,n=tu(e.detail.value,!1)??0;n!==t.value&&this.commit({...t,value:n})}}static{this.EMPTY={value:0,currency:`EUR`,locale:`es-ES`}}render(){return E`
            <vaadin-number-field
                    id="${this.fieldId}"
                    label="${this.label}"
...
`}copyValue(e){navigator.clipboard.writeText(e).then(()=>r.show(`Copied`,{position:`bottom-end`,theme:`success`,duration:2e3})).catch(()=>{})}renderFileField(e,t,n,r){if(!this.field)return E``;let i=t?.map(e=>({id:e.id,name:e.name,type:``,uploadTarget:``,complete:!0}))??[];return E`
            ...
            `}renderStringField(e,t,n,r){if(!this.field)return E``;if(this.field?.stereotype==`searchable`)return E`
              ...
              ${e.description}
                ...
                `;if(this.field?.stereotype==`fileUpload`){let e=Ql(this.field.attributes,`accept`);return E`
                    <vaadin-custom-field
                            id="${this.field.fieldId}"
                            label="${n}"
                            .helperText="${this.helperText()}"
...
`;if(this.field?.stereotype==`listBox`){if(this.field?.remoteCoordinates){let e=this.field.remoteCoordinates;return this.data[this.id]&&this.data[this.id].searchSignature&&this.data[this.id].searchSignature!=``&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements||this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.action,parameters:{searchText:``,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0})),E`
            ...
            ></mateu-money-field>`}renderStatusField(e,t,n,r){if(!this.field)return E``;let i=t;return E`
                <vaadin-custom-field
                        ...
                        data-colspan="${this.field.colspan}"
                >
                    ${i?E`<span theme="badge pill ${So(i.type)}">${i.message}</span>`:E``}                    
                </vaadin-custom-field>
    ...
    `},Ju=(e,n,r,i,a,o,s)=>{let c=n.metadata;if(c.tree)return E`
        ...
        >
            ...
            <vaadin-grid-column path="${n.id}"
                                ...
                                width="${l?.width??y}"
                                .column="${n.metadata}"
                                ${t((t,n,c)=>Lu(t,n,c,l,e,r,i,a,o,s),[])}></vaadin-grid-column>
`:E`
...
`})}
    ...
    `},$=class extends x{constructor(...e){super(...e),this.id=``,this.baseUrl=``,this.state={},this.data={},this.appState={},this.appData={},this.detailsOpenedItems=[],this.pagesRequested=[],this._lastGridHeight=0,this.emptyArray=e=>!e||e.length==0,this.dataProvider=(e,t)=>{let n=this.data[this.id]?.page;if(this.metadata?.infiniteScrolling&&e.page>0){let r=!1;n&&n.content&&(n.content.length>=(e.page+1)*e.pageSize||n.content.length==n.totalElements)&&(t(n.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),n.totalElements),r=!0,this.grid&&this.grid.recalculateColumnWidths()),r||this.pagesRequested.find(t=>t==e.page)||(this.pagesRequested.push(e.page),this.dispatchEvent(new CustomEvent(`fetch-more-elements`,{detail:{params:e,callback:()=>{this.data[this.id]?.page?.content&&(t(this.data[this.id].page.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),this.data[this.id].page.totalElements),this.grid&&this.grid.recalculateColumnWidths())}},bubbles:!0,composed:!0})))}else{let e=this.metadata?.infiniteScrolling?n?.totalElements:n?.content?.length??0;t(n?.content??[],e),this.grid&&this.grid.recalculateColumnWidths()}},this._onActionRequested=e=>{let t=e.detail,n=this.identifierFieldName;if(!n||!t.parameters||t.actionId?.startsWith(`action-on-row-`))return;let r=t.parameters[n];r!==void 0&&(this.state._selectedId=String(r),this._applyCellPartNameGenerator(),this.grid?.requestContentUpdate())},this.tooltipGenerator=e=>{let t=``,{column:n,item:r}=e,i=this.metadata?.columns?.find(e=>e.metadata.id==n?.path);if(i?.metadata){let e=(i?.metadata).tooltipPath;e&&n&&r&&(t=r[e])}return t}}get identifierFieldName(){let e=this.metadata?.columns?.find(e=>e.metadata?.identifier);if(e)return e.metadata?.id;if(this.metadata?.columns?.find(e=>e.metadata?.id===`id`))return`id`}_applyCellPartNameGenerator(){if(!this.grid)return;let e=this.identifierFieldName,t=this.state?._selectedId??this.appState?._splitDetailId,n=!!this.metadata?.groupBy;e&&t!==void 0||n?this.grid.cellPartNameGenerator=(n,r)=>{let i=r.item;return ru(i)?`mateu-group-row`:e&&t!==void 0&&String(i[e])===String(t)?`selected-row`:``}:this.grid.cellPartNameGenerator=null}connectedCallback(){super.connectedCallback(),this.addEventListener(`action-requested`,this._onActionRequested)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`action-requested`,this._onActionRequested),this._resizeObserver?.disconnect(),this._resizeObserver=void 0}firstUpdated(){let e=this.grid;!e||this._resizeObserver||(this._resizeObserver=new ResizeObserver(()=>{let t=e.offsetHeight;t>0&&this._lastGridHeight===0&&requestAnimationFrame(()=>{e.recalculateColumnWidths(),e.requestContentUpdate(),e.notifyResize?.()}),this._lastGridHeight=t}),this._resizeObserver.observe(e))}updated(e){super.updated(e),this._applyCellPartNameGenerator(),this.grid?.clearCache(),this.grid?.requestContentUpdate(),this.grid?.recalculateColumnWidths(),this.pagesRequested=[]}navigateToRowRoute(e){let t=(this.shadowRoot?.querySelector(`vaadin-grid`))?.getEventContext?.(e)?.item;if(!t||ru(t)||e.composedPath().some(e=>e?.tagName&&/^(A|BUTTON|INPUT|VAADIN-BUTTON|VAADIN-CHECKBOX)$/.test(e.tagName)))return;let n=on(this.metadata?.rowRoute,t,this.state,this.data);n&&sn(this,n)}render(){let e=this.data[this.id],r=e?.page,i=this.metadata?.groupBy,a=this.metadata?.infiniteScrolling?void 0:r?.content?au(r.content,i,e?.groups):r?.content,o=lu((this.metadata?.columns??[]).flatMap(e=>e.metadata?.type===j.GridGroupColumn?(e.metadata.columns??[]).map(e=>e.metadata):[e.metadata]),e,i),s=``;return this.metadata?.wrapCellContent&&(s+=` wrap-cell-content`),this.metadata?.compact&&(s+=` compact`),this.metadata?.noBorder&&(s+=` no-border`),this.metadata?.noRowBorder&&(s+=` no-row-borders`),this.metadata?.columnBorders&&(s+=` column-borders`),this.metadata?.rowStripes&&(s+=` row-stripes`),E`
            <vaadin-grid
                    ...
                    @selected-items-changed="${e=>{let t=(e.detail.value??[]).filter(e=>!ru(e));this.emptyArray(this.state[this.id+`_selected_items`])&&this.emptyArray(t)||(this.state[this.id+`_selected_items`]=t,this.metadata?.onRowSelectionChangedActionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.metadata?.onRowSelectionChangedActionId},bubbles:!0,composed:!0})))}}"
                    @active-item-changed="${C(this.metadata?.detailPath&&!this.metadata?.useButtonForDetail?e=>{let t=e.detail.value;t&&ru(t)||(this.detailsOpenedItems=t?[t]:[])}:void 0)}"
            ...
            >
                ...
                `:y}
                ${this.metadata?.columns?.map(e=>Fu(e,this,this.baseUrl,this.state,this.data,this.appState,this.appData,o))}
  ...
  `}};k([b()],$.prototype,`id`,void 0),k([b()],$.prototype,`metadata`,void 0),k([b()],$.prototype,`baseUrl`,void 0),k([b()],$.prototype,`state`,void 0),k([b()],$.prototype,`data`,void 0),k([b()],$.prototype,`appState`,void 0),k([b()],$.prototype,`appData`,void 0),k([b()],$.prototype,`emptyStateMessage`,void 0),k([w()],$.prototype,`detailsOpenedItems`,void 0),k([S(`vaadin-grid`)],$.prototype,`grid`,void 0),$=k([_(`mateu-table`)],$);var Yu=(e,t,n,r,i,a,o)=>E`
    ...
    <mateu-table id="${e.id}"
                 ...
                 @fetch-more-elements="${e.fetchMoreElements}"
                 baseUrl="${n}"
    ></mateu-table>`,Zu=(e,t,n,r,i,a,o)=>{let s=t.metadata;return E`
    ...
    <div style="display: flex; gap: var(--lumo-space-xs, .25rem); align-items: center;" class="peer-nav">
        ...
        <vaadin-button theme="tertiary icon" class="peer-nav-next" title="${e.nextLabel??`Next`}"
            ...
            title="${r.shortcut?`${i} (${Kr(r.shortcut)})`:y}"
            slot="${e.slot??y}"
    >${r.iconOnLeft?E`<vaadin-icon icon="${r.iconOnLeft}"></vaadin-icon>`:y}${i}${r.iconOnRight?E`<vaadin-icon icon="${r.iconOnRight}"></vaadin-icon>`:y}</vaadin-button>`},rd=e=>{let t=e.metadata;return E`
        ...
        ></vaadin-message-input>
    `},id=e=>{let t=(e.metadata.items??[]).map(e=>({text:e.text,time:e.time,userName:e.userName,userImg:e.userImg,userAbbr:e.userAbbr,userColorIndex:e.userColorIndex}));return E`
        <vaadin-message-list
                markdown
                style="${e.style}" class="${e.cssClasses}"
                slot="${e.slot??y}"
                .items="${t}"
        ></vaadin-message-list>
    `},ad=(e,t)=>{e&&e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t},bubbles:!0,composed:!0}))},od=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=!1;if(s.openedCondition)try{c=Gt(s.openedCondition,r,i,a,o)}catch(e){console.error(`when evaluating `+s.openedCondition+` :`+e+`, where data is `+i+` and state is `+r)}return E`
    ...
    `}render(){let e=this.navigation,t=!!(this.overviewEditActionId||e&&(e.parentActionId||e.previousActionId||e.nextActionId)),n=!!(this.headerTitle||t||this.badges.length);return E`
            ...
            `:y}
        `}};k([b({type:Array})],sd.prototype,`panels`,void 0),k([b({type:String})],sd.prototype,`headerTitle`,void 0),k([b({type:Array})],sd.prototype,`badges`,void 0),k([b({attribute:!1})],sd.prototype,`navigation`,void 0),k([b({type:String})],sd.prototype,`overviewEditActionId`,void 0),k([S(`.rail`)],sd.prototype,`_rail`,void 0),k([S(`.section--first`)],sd.prototype,`_first`,void 0),k([w()],sd.prototype,`_less`,void 0),k([w()],sd.prototype,`_more`,void 0),sd=k([_(`mateu-vaadin-foldout`)],sd);var cd=(e,t,n,r,i,a,o)=>{let s=t.metadata;return E`
    ...
    `}};k([b({attribute:!1})],ld.prototype,`rows`,void 0),k([b({attribute:!1})],ld.prototype,`columns`,void 0),k([b()],ld.prototype,`idField`,void 0),k([b({type:Boolean})],ld.prototype,`navigable`,void 0),k([b()],ld.prototype,`selectedId`,void 0),k([w()],ld.prototype,`expandedItems`,void 0),k([S(`vaadin-grid`)],ld.prototype,`_grid`,void 0),ld=k([_(`mateu-vaadin-tree`)],ld);var ud={[j.VirtualList]:(e,t,n,r,i,a,o)=>vl(e,t,n,r,i,a,o),[j.Notification]:(e,t)=>yl(t),[j.ProgressBar]:(e,t,n,r)=>bl(t,r),[j.Details]:(e,t,n,r,i,a,o)=>xl(e,t,n,r,i,a,o),[j.Avatar]:(e,t,n,r,i)=>Sl(t,r,i),[j.AvatarGroup]:(e,t)=>Cl(t),[j.Card]:(e,t,n,r,i,a,o)=>wl(e,t,n,r,i,a,o),[j.Button]:(e,t,n,r,i)=>nd(t,r,i),[j.MessageInput]:(e,t)=>rd(t),[j.MessageList]:(e,t)=>id(t),[j.ConfirmDialog]:(e,t,n,r,i,a,o)=>od(e,t,n,r,i,a,o),[j.FormLayout]:(e,t,n,r,i,a,o)=>Dl(e,t,n,r,i,a,o),[j.HorizontalLayout]:(e,t,n,r,i,a,o)=>jl(e,t,n,r,i,a,o),[j.VerticalLayout]:(e,t,n,r,i,a,o)=>Ml(e,t,n,r,i,a,o),[j.SplitLayout]:(e,t,n,r,i,a,o)=>Nl(e,t,n,r,i,a,o),[j.MasterDetailLayout]:(e,t,n,r,i,a,o)=>Pl(e,t,n,r,i,a,o),[j.TabLayout]:(e,t,n,r,i,a,o)=>Fl(e,t,n,r,i,a,o),[j.AccordionLayout]:(e,t,n,r,i,a,o)=>Ll(e,t,n,r,i,a,o),[j.BoardLayout]:(e,t,n,r,i,a,o)=>Bl(e,t,n,r,i,a,o),[j.BoardLayoutRow]:(e,t,n,r,i,a,o)=>Vl(e,t,n,r,i,a,o),[j.BoardLayoutItem]:(e,t,n,r,i,a,o)=>Hl(e,t,n,r,i,a,o),[j.Scroller]:(e,t,n,r,i,a,o)=>zl(e,t,n,r,i,a,o),[j.MenuBar]:(e,t,n,r,i)=>Gl(e,t,n,r,i),[j.ContextMenu]:(e,t,n,r,i,a,o)=>Wl(e,t,n,r,i,a,o),[j.FormField]:(e,t,n,r,i,a,o,s)=>qu(e,t,n,r,i,a,o,s),[j.Grid]:(e,t,n,r,i,a,o)=>Ju(e,t,n,r,i,a,o),[j.Table]:(e,t,n,r,i,a,o)=>Yu(e,t,n,r,i,a,o),[j.Popover]:(e,t,n,r,i,a,o)=>Zu(e,t,n,r,i,a,o),[j.FoldoutLayout]:(e,t,n,r,i,a,o)=>cd(e,t,n,r,i,a,o)},dd=class extends _l{rendererName(){return`vaadin`}renderClientSideComponent(e,t,n,r,i,a,o,s){let c=t?.metadata?.type,l=c?ud[c]:void 0;return l&&t?l(e,t,n,r,i,a,o,s):super.renderClientSideComponent(e,t,n,r,i,a,o,s)}renderTableComponent(e,t,n,r,i,a,o){return Xu(e,t,n,r,a,o)}renderTreeComponent(e,t){return E`
            <mateu-vaadin-tree
                    .rows="${t.rows}"
                    .columns="${t.columns}"
                    .idField="${t.idField}"
            ...
            ></mateu-vaadin-tree>`}renderToolbarButton(e,t,n){return Qu(e,t,n)}renderPeerNav(e){return $u(e)}renderIcon(e,t,n){return td(e,t,n)}renderTopNav(e,t,n){return Ul(e,t,n)}};function fd(e){switch(e){case`topStretch`:return`top-stretch`;case`topStart`:return`top-start`;case`topCenter`:return`top-center`;case`topEnd`:return`top-end`;case`middle`:return`middle`;case`bottomStart`:return`bottom-start`;case`bottomEnd`:return`bottom-end`;case`bottomStretch`:return`bottom-stretch`;case`bottomCenter`:return`bottom-center`}return`bottom-end`}function pd(e,t){if(e.onAction)return{label:e.actionLabel??`Retry`,run:e.onAction};if(e.undoActionId)return{label:e.undoLabel??`Undo`,run:()=>t.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.undoActionId,parameters:e.undoParameters??{}},bubbles:!0,composed:!0}))}}function md(e,t){let n=new r;n.position=fd(e.position),n.duration=e.duration??1e4,e.variant&&n.setAttribute(`theme`,e.variant),n.renderer=r=>{if(r.firstElementChild)return;let i=document.createElement(`span`);i.textContent=e.text;let a=pd(e,t),o=document.createElement(`button`);o.textContent=a.label,o.style.cssText=`margin-left: 0.75rem; background: none; border: 1px solid currentColor; border-radius: var(--lumo-border-radius-s, 4px); color: inherit; cursor: pointer; padding: 0.15rem 0.6rem; font: inherit; font-weight: 600;`,o.addEventListener(`click`,()=>{a.run(),n.opened=!1}),r.append(i,o)},document.body.appendChild(n),n.opened=!0,n.addEventListener(`opened-changed`,e=>{e.detail.value||n.remove()})}N.set(new dd),wo({show(e,t){if(Rt(e.text,{politeness:e.variant===`error`?`assertive`:`polite`}),e.undoActionId||e.onAction){md(e,t);return}r.show(e.text,{position:e.position?fd(e.position):`bottom-end`,theme:e.variant,duration:e.duration})}});