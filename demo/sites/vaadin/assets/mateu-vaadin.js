...
import{r as As,f as Fs,m as qs,o as Ms,a as Ns,b as Us,c as js,s as Bs,d as Vs,e as Hs,t as Ws,u as Gs,g as Ks,_ as he,v as Ys,n as Js,h as Rt,i as Xs,j as Qs,k as Ii,l as Si,N as Dr,p as $r,q as Ei,w as Zs}from"./vendor-vaadin.js";import{a as x,j as p,k as _e,i as C,x as o,m as k,A as l,p as ge,q as b,l as E,c as X,r as eo,D as Pi}from"./vendor-lit.js";import{S as to,a as ao,n as $e,b as ro}from"./vendor.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=a(i);fetch(i.href,s)}})();As("vaadin-card",x`
      :host(.mateu-section) {
    ...
    `);const Ti=document.createElement("style");Ti.innerHTML=`
${Fs.cssText}
${qs.cssText}
${Ms.cssText}
${Ns.cssText}
...
${Gs.cssText}
${Ks.cssText}
`;document.body.appendChild(Ti);{const e=window.Vaadin;e&&((e.featureFlags??={}).masterDetailLayoutComponent=!0)}const Lt=new to,G={value:{}},$a={value:{}},xt=x`
  [theme~='badge'] {
    display: inline-flex;
    align-items: center;
...
`,io={lon:0,lat:0},Zr=3,so=e=>{if(!e)return;const t=e.split(",").map(i=>i.trim());if(t.length!==2)return;const a=Number(t[0]),r=Number(t[1]);if(!(t[0]===""||t[1]===""||!Number.isFinite(a)||!Number.isFinite(r)))return{lon:r,lat:a}},oo=e=>{if(e==null||e.trim()==="")return Zr;const t=Number(e);return Number.isFinite(t)?t:Zr};var no=Object.defineProperty,lo=Object.getOwnPropertyDescriptor,nr=(e,t,a,r)=>{for(var i=r>1?void 0:r?lo(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&no(t,a,i),i};let aa=class extends C{constructor(){super(...arguments),this.renderSeq=0}updated(e){super.updated(e),this.createMap()}disconnectedCallback(){super.disconnectedCallback(),this.map?.setTarget(void 0),this.map=void 0}async createMap(){const e=++this.renderSeq,[{default:t},{default:a},{default:r},{default:i},{fromLonLat:s},{default:n}]=await Promise.all([he(()=>import("./vendor-ol.js").then(c=>c.M),[]),he(()=>import("./vendor-ol.js").then(c=>c.V),[]),he(()=>import("./vendor-ol.js").then(c=>c.T),[]),he(()=>import("./vendor-ol.js").then(c=>c.O),[]),he(()=>import("./vendor-ol.js").then(c=>c.p),[]),he(()=>import("./vendor-ol.js").then(c=>c.o),[])]);if(e!==this.renderSeq||!this.isConnected)return;if(!this.shadowRoot.querySelector("style[data-ol]")){const c=document.createElement("style");c.setAttribute("data-ol",""),c.textContent=n,this.shadowRoot.appendChild(c)}this.map&&(this.map.setTarget(void 0),this.map=void 0);const d=so(this.position)??io;this.map=new t({target:this.mapElement,layers:[new r({source:new i})],view:new a({center:s([d.lon,d.lat]),zoom:oo(this.zoom)})})}render(){return o`<div id="map"></div>`}};aa.styles=x`
        :host {
            display: block;
            width: 100%;
            height: 25rem;
    ...
    `;nr([p()],aa.prototype,"position",2);nr([p()],aa.prototype,"zoom",2);nr([_e("#map")],aa.prototype,"mapElement",2);aa=nr([k("mateu-map")],aa);const co=typeof HTMLElement<"u"?HTMLElement:class{};class uo extends co{static get observedAttributes(){return["content"]}#e;#t=0;get content(){return this.#e}set content(t){this.#e=t,this.#a()}attributeChangedCallback(t,a,r){this.content=r??void 0}connectedCallback(){this.style.display="block",this.#a()}async#a(){if(!this.isConnected)return;const t=this.#e??"",a=++this.#t,[{marked:r},{default:i}]=await Promise.all([he(()=>import("./vendor.js").then(s=>s.f),[]),he(()=>import("./vendor.js").then(s=>s.c),[])]);a===this.#t&&(this.innerHTML=i.sanitize(await r.parse(t),{USE_PROFILES:{html:!0,svg:!0,svgFilters:!0},CUSTOM_ELEMENT_HANDLING:{tagNameCheck:s=>!0}}))}}typeof customElements<"u"&&!customElements.get("mateu-markdown")&&customElements.define("mateu-markdown",uo);var W=(e=>(e.ServerSide="ServerSide",e.ClientSide="ClientSide",e))(W||{}),h=(e=>(e.Page="Page",e.Div="Div",e.Element="Element",e.MicroFrontend="MicroFrontend",e.Form="Form",e.Crud="Crud",e.Result="Result",e.Card="Card",e.Directory="Directory",e.Stepper="Stepper",e.HorizontalLayout="HorizontalLayout",e.VerticalLayout="VerticalLayout",e.SplitLayout="SplitLayout",e.MasterDetailLayout="MasterDetailLayout",e.TabLayout="TabLayout",e.AccordionLayout="AccordionLayout",e.FormLayout="FormLayout",e.FormRow="FormRow",e.FormItem="FormItem",e.BoardLayout="BoardLayout",e.BoardLayoutRow="BoardLayoutRow",e.BoardLayoutItem="BoardLayoutItem",e.Scroller="Scroller",e.FullWidth="FullWidth",e.Container="Container",e.FormField="FormField",e.Table="Table",e.App="App",e.Text="Text",e.Avatar="Avatar",e.Chat="Chat",e.AvatarGroup="AvatarGroup",e.Badge="Badge",e.Breadcrumbs="Breadcrumbs",e.Anchor="Anchor",e.Button="Button",e.Chart="Chart",e.Icon="Icon",e.ConfirmDialog="ConfirmDialog",e.ContextMenu="ContextMenu",e.CookieConsent="CookieConsent",e.Details="Details",e.Dialog="Dialog",e.Drawer="Drawer",e.Image="Image",e.Map="Map",e.Markdown="Markdown",e.Notification="Notification",e.ProgressBar="ProgressBar",e.Popover="Popover",e.CarouselLayout="CarouselLayout",e.Tooltip="Tooltip",e.MessageInput="MessageInput",e.MessageList="MessageList",e.CustomField="CustomField",e.MenuBar="MenuBar",e.Grid="Grid",e.GridColumn="GridColumn",e.GridGroupColumn="GridGroupColumn",e.VirtualList="VirtualList",e.FormSection="FormSection",e.FormSubSection="FormSubSection",e.Bpmn="Bpmn",e.Workflow="Workflow",e.FormEditor="FormEditor",e.MetricCard="MetricCard",e.Scoreboard="Scoreboard",e.DashboardPanel="DashboardPanel",e.DashboardLayout="DashboardLayout",e.FoldoutLayout="FoldoutLayout",e.HeroSection="HeroSection",e.EmptyState="EmptyState",e.Skeleton="Skeleton",e.Gantt="Gantt",e.PlanningBoard="PlanningBoard",e.Kanban="Kanban",e.Timeline="Timeline",e.ProgressSteps="ProgressSteps",e.Stat="Stat",e.Calendar="Calendar",e.PricingTable="PricingTable",e.OrgChart="OrgChart",e.Heatmap="Heatmap",e.Funnel="Funnel",e.TrendChart="TrendChart",e.FeatureGrid="FeatureGrid",e.Testimonials="Testimonials",e.Faq="Faq",e.CalloutCard="CalloutCard",e.CommentThread="CommentThread",e.FileList="FileList",e.Checklist="Checklist",e.ComparisonCard="ComparisonCard",e.EntityHeader="EntityHeader",e.Meter="Meter",e.TaskProgress="TaskProgress",e.StatusList="StatusList",e.BulletedList="BulletedList",e.Separator="Separator",e.Notice="Notice",e.TaskQueue="TaskQueue",e.ResourceGrid="ResourceGrid",e.OfferCard="OfferCard",e.AddOnPicker="AddOnPicker",e.Ledger="Ledger",e.PaymentPicker="PaymentPicker",e.ProcessMonitor="ProcessMonitor",e))(h||{});const Ar="mateu-app-context",Oi="mateu-app-context-labels",zi=e=>{try{return JSON.parse(localStorage.getItem(e)??"{}")}catch{return{}}},ei=(e,t)=>{try{localStorage.setItem(e,JSON.stringify(t))}catch{}},Fr=()=>zi(Ar),Ri=()=>zi(Oi),po=(e,t,a)=>{const r=Fr(),i=Ri();t==null||t===""?(delete r[e],delete i[e]):(r[e]=t,a!==void 0&&(i[e]=a)),ei(Ar,r),ei(Oi,i)};let ti=!1;const ho=()=>{ti||(ti=!0,window.addEventListener("storage",e=>{e.key===Ar&&e.newValue!==e.oldValue&&window.location.reload()}))},mo=(e,t)=>new Promise((a,r)=>{let i=!1;const s={retry:()=>{i||(i=!0,t().then(a,r))},giveUp:()=>{i||(i=!0,r(e))}},n=new CustomEvent("mateu-session-expired",{detail:s,cancelable:!0,bubbles:!1});typeof document<"u"&&!document.dispatchEvent(n)||s.giveUp()}),vo=(e,t)=>e.includes("json")?!0:t!==null&&typeof t=="object",fo=(e,t)=>{const a=e.finalUrl;if(!a)return;const r=typeof window<"u"?window.location.href:void 0;let i;try{i=new URL(e.requestedUrl,r).href}catch{return}if(i!==a&&!vo(e.contentType??"",e.data))return a};class bo{constructor(){this.windowMs=4e3,this.threshold=12,this.events=[],this.reported=new Set}check(t,a=Date.now()){this.events.push({sig:t,t:a});const r=a-this.windowMs;this.events=this.events.filter(s=>s.t>=r);let i=0;for(const s of this.events)s.sig===t&&i++;if(i>=this.threshold){const s=!this.reported.has(t);return this.reported.add(t),{blocked:!0,firstTrip:s}}return this.reported.delete(t),{blocked:!1,firstTrip:!1}}reset(){this.events=[],this.reported.clear()}configure(t){t.windowMs!==void 0&&(this.windowMs=t.windowMs),t.threshold!==void 0&&(this.threshold=t.threshold)}}const go=new bo;let ta=[];class yo{constructor(){this.axiosInstance=ao.create({timeout:6e4}),this.axiosInstance.interceptors.request.use(t=>(this.addAuthToken(t),this.addSessionId(t),t)),this.axiosInstance.interceptors.response.use(t=>{const a=fo({requestedUrl:this.axiosInstance.getUri(t.config),finalUrl:t.request?.responseURL,contentType:String(t.headers?.["content-type"]??""),data:t.data});if(a)throw window.location.assign(a),Object.assign(new Error("session lost — redirecting to "+a),{code:"ERR_CANCELED"});return t},t=>{const a=t;if(a?.response?.status===401&&a.config&&!a.config.__mateuRetried){const r=a.config;return r.__mateuRetried=!0,mo(t,()=>this.axiosInstance.request(r))}throw t})}addSessionId(t){let a=sessionStorage.getItem("__mateu_sesion_id");a||(a=$e(),sessionStorage.setItem("__mateu_sesion_id",a)),t.headers["X-Session-Id"]=a}addAuthToken(t){const a=localStorage.getItem("__mateu_auth_token");a&&(t.headers.Authorization="Bearer "+a)}async wrap(t,a,r,i){return r||a.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),t.then(s=>(a.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:i}})),s)).catch(s=>{throw s?.code=="ERR_CANCELED"?a.dispatchEvent(new CustomEvent("backend-cancelled-event",{bubbles:!0,composed:!0,detail:{}})):a.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:i,reason:this.serialize(s)}})),s})}serialize(t){return t?.message?t:JSON.stringify(t)}async get(t){const a=new AbortController;return ta=[...ta,a],this.axiosInstance.get(t,{signal:a.signal})}async post(t,a){const r=new AbortController;return ta=[...ta,r],this.axiosInstance.post(t,a,{signal:r.signal})}async abortAll(){ta.forEach(t=>t.abort()),ta=[]}async runAction(t,a,r,i,s,n,d,c,u,m,v){a&&a.startsWith("/")&&(a=a.substring(1));const f=[t,a,r,d??"",i,s].join(""),w=go.check(f);return w.blocked?(await this.abortAll(),w.firstTrip&&console.error("[mateu] request loop detected — aborting repeated request",f),{messages:w.firstTrip?[{title:"",text:"A repeating request was detected and stopped to protect the server. Reload the page or navigate elsewhere.",position:"bottom-end",variant:"error",duration:6e3}]:[],commands:[],fragments:[],banners:[],appendBanners:!1,appData:void 0,appState:void 0}):(n={...Fr(),...n},await this.wrap(this.post(t+"/mateu/v3/sync/"+(a&&a!=""?a:"_no_route"),{serverSideType:d,appState:n,componentState:c,parameters:u,initiatorComponentId:s,consumedRoute:r,route:a&&a!=""?"/"+a:"",actionId:i}).then($=>$.data),m,v,i))}}const Kt=new yo;var xa=(e=>(e.Add="Add",e.Replace="Replace",e.ReplaceKeepData="ReplaceKeepData",e))(xa||{}),at=(e=>(e.HAMBURGUER_MENU="HAMBURGUER_MENU",e.MENU_ON_LEFT="MENU_ON_LEFT",e.MENU_ON_TOP="MENU_ON_TOP",e.TABS="TABS",e.TILES="TILES",e.RAIL="RAIL",e.AUTO="AUTO",e.MEDIATOR="MEDIATOR",e))(at||{}),$o=Object.defineProperty,Li=(e,t,a,r)=>{for(var i=void 0,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=n(t,a,i)||i);return i&&$o(t,a,i),i};class lr extends C{constructor(){super(...arguments),this.id="",this.baseUrl="",this.callbackToken="",this.createElement=t=>{const a=t.data,r=document.createElement(a.name);for(let i in a.attributes)r.setAttribute(i,a.attributes[i]);for(let i in a.on)r.addEventListener(i,s=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.on[i],parameters:{event:s}},bubbles:!0,composed:!0}))});return r},this.closeModal=()=>{const t=(this.shadowRoot??this).querySelectorAll("mateu-dialog, mateu-drawer");if(t&&t.length>0){t[t.length-1].close(),this.removeTopOverlayChild();return}this.dispatchEvent(new CustomEvent("close-modal-requested",{bubbles:!0,composed:!0}))},this.changeFavicon=t=>{let a=document.querySelector('link[rel="icon"]');a!==null?a.setAttribute("href",t):(a=document.createElement("link"),a.setAttribute("rel","icon"),a.setAttribute("href",t),document.head.appendChild(a))}}connectedCallback(){super.connectedCallback(),this.upstreamSubscription=Lt.subscribe(t=>{if(t.command){const a=t.command;this.id==a.targetComponentId&&this.applyCommand(a)}if((!t.callbackToken||!this.callbackToken||t.callbackToken===this.callbackToken)&&t.fragment){const a=t.fragment;this.id==a.targetComponentId&&(this.applyFragment(a),this.completeMenu(a))}})}completeMenu(t){if(t.component&&t.component.type==W.ClientSide){const a=t.component,r=a.metadata;if(r?.type==h.App){const i=r,s=this.getRemoteMenus(i.menu);if(s.length>0){const n=s.map(d=>Kt.runAction(d.baseUrl,d.route,"_empty","",d.baseUrl+"#"+d.route,void 0,void 0,void 0,d.params,this,!0));Promise.all(n).then(d=>{i.menu=this.updateMenu(i.menu,d.map(c=>c.fragments).filter(c=>c).map(c=>c).flat()),i.variant=at.MENU_ON_TOP,Lt.next({fragment:{component:a,data:void 0,state:void 0,action:xa.Replace,targetComponentId:this.id,containerId:void 0},callbackToken:this.callbackToken})})}}}}updateMenu(t,a){const r=[];return t.forEach(i=>{if(i.remote){const s=a.find(n=>n.targetComponentId==i.baseUrl+"#"+i.route);if(s&&s.component?.type==W.ClientSide){const n=s.component;if(n.metadata?.type==h.App){const d=n.metadata,c=i.serverSideType&&i.serverSideType!=""?i.serverSideType:d.serverSideType;this.changeBaseUrl(d.menu,i.baseUrl,c,i.route,d.route),r.push(...d.menu)}}}else r.push(i)}),r}changeBaseUrl(t,a,r,i,s){t.forEach(n=>{n.baseUrl||(n.submenus&&n.submenus.length>0?this.changeBaseUrl(n.submenus,a,r,i,s):(n.consumedRoute=s??"",n.baseUrl=a,n.serverSideType=r,n.uriPrefix=i))})}getRemoteMenus(t){const a=[];return t.forEach(r=>{r.remote&&a.push(r)}),a}disconnectedCallback(){super.disconnectedCallback(),this.upstreamSubscription?.unsubscribe()}applyCommand(t){if(t.type=="SetWindowTitle"&&(document.title=t.data),t.type=="SetFavicon"&&this.changeFavicon(t.data),t.type=="DispatchEvent"&&this.dispatchNamedEvent(t.data),t.type=="NavigateTo"){const a=t.data;a&&(a.startsWith("http:")||a.startsWith("https:")?window.open(t.data,"_blank"):window.location.href=t.data)}if(t.type=="PushStateToHistory"){const a=t.data;a!==void 0&&this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:a},bubbles:!0,composed:!0}))}if(t.type=="RunAction"){const a=t.data;if(a&&a.actionId)if(a.targetComponentId){const r={command:{type:"RunAction",data:{actionId:a.actionId},targetComponentId:a.targetComponentId},fragment:void 0,ui:void 0,error:void 0,callbackToken:""};setTimeout(()=>Lt.next(r))}else this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.actionId,parameters:{}},bubbles:!0,composed:!0}))}if(t.type=="MarkAsDirty"&&this.dispatchEvent(new CustomEvent("dirty",{detail:{},bubbles:!0,composed:!0})),t.type=="MarkAsClean"&&this.dispatchEvent(new CustomEvent("clean",{detail:{},bubbles:!0,composed:!0})),t.type=="DownloadFile"){const a=t.data;if(a&&a.base64Content){const r=atob(a.base64Content),i=new Uint8Array(r.length);for(let c=0;c<r.length;c++)i[c]=r.charCodeAt(c);const s=new Blob([i],{type:a.mimeType}),n=URL.createObjectURL(s),d=document.createElement("a");d.href=n,d.download=a.filename??"export",d.click(),URL.revokeObjectURL(n)}}if(t.type=="CloseModal"&&(this.closeModal(),this.dispatchNamedEvent(t.data)),t.type=="AddContentToHead"){const a=t.data;if(a&&a.name){if(a.attributes&&a.attributes.id&&document.getElementById(a.attributes.id))return;document.head.appendChild(this.createElement(t))}}if(t.type=="AddContentToBody"){const a=t.data;if(a&&a.name){if(a.attributes&&a.attributes.id&&document.getElementById(a.attributes.id))return;document.body.appendChild(this.createElement(t))}}}dispatchNamedEvent(t){if(t&&t.eventName){const a=this.component,r=a?.emitsName??a?.serverSideType;let i=t.payload??t.detail;r&&i&&typeof i=="object"&&(i={...i,__source:r}),this.dispatchEvent(new CustomEvent(t.eventName,{detail:i,bubbles:!0,composed:!0}))}}removeTopOverlayChild(){const t=this.component?.children;if(t)for(let a=t.length-1;a>=0;a--){const r=t[a]?.metadata?.type;if(r==h.Drawer||r==h.Dialog){t.splice(a,1);return}}}}Li([p()],lr.prototype,"id");Li([p()],lr.prototype,"baseUrl");var xo=Object.defineProperty,wo=(e,t,a,r)=>{for(var i=void 0,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=n(t,a,i)||i);return i&&xo(t,a,i),i};class dr extends lr{applyFragment(t){}manageActionRequestedEvent(t){}}wo([p()],dr.prototype,"component");const ra=(e,t)=>new Function(...Object.keys(t),"return `"+e+"`")(...Object.values(t)),la=(e,t,a)=>({state:e??{},data:t??{},...a});function ye(e,t,a,r){if(!e?.includes("${"))return e;try{return ra(e,la(t,a,r))}catch(i){return console.warn(`Mateu: could not interpolate "${e}":`,i),e}}const ut=(e,t,a)=>{if(e&&e.indexOf("${")>=0)try{return ra(e,la(t,a))}catch(r){return r.message}return e},wa=(e,t,a,r,i)=>{if(!e)return e;const s=la(t,a,{appState:r??{},appData:i??{}});let n=e;try{if(n=ra(e,s),n.includes("${"))try{n=ra(n,s)}catch(d){n="when evaluating nested "+e+" :"+d+", where data is "+a+" and state is "+t+" and app state is "+r+" and app data is "+i,console.error(d,n,t,a,r,i)}}catch(d){n="when evaluating "+e+" :"+d+", where data is "+a+" and state is "+t+" and app state is "+r+" and app data is "+i,console.error(d,n,t,a,r,i)}return n},qr=(e,t,a,r,i,s)=>{const n=la(t,a,{appState:r??{},appData:i??{},...s}),d=ra(e,n);return new Function(...Object.keys(n),`return (${d})`)(...Object.values(n))},Di=(e,t,a,r)=>{const i=la(t,a,r);return new Function(...Object.keys(i),`return (${e})`)(...Object.values(i))},ko=(e,t,a,r)=>ra(e,la(t,a,r)),Pr="display:inline-flex; align-items:center; justify-content:center; width:2rem; height:2rem; border-radius:50%; background:var(--lumo-contrast-10pct,#e0e0e0); color:var(--lumo-secondary-text-color,#555); font-size:.8rem; font-weight:600; overflow:hidden; flex:none;",Ai=(e,t)=>t||(typeof e=="string"&&e?e.trim().split(/\s+/).map(a=>a[0]).slice(0,2).join("").toUpperCase():""),Co=(e,t,a)=>{const r=e.metadata,i=Oe(r.name,t,a);return o`<span style="${Pr}${e.style}" class="${e.cssClasses}"
                      title="${i||l}" slot="${e.slot??l}">
        ${r.image?o`<img src="${r.image}" alt="${i}" style="width:100%;height:100%;object-fit:cover;">`:Ai(i,r.abbreviation)}
    </span>`},Oe=(e,t,a)=>typeof e=="string"&&e.includes("${")?ye(e,t,a):e,_o=e=>{const t=e.metadata,a=t.avatars??[],r=t.maxItemsVisible&&t.maxItemsVisible>0?t.maxItemsVisible:a.length,i=a.slice(0,r),s=a.length-i.length,n="margin-left:-0.4rem; border:2px solid var(--lumo-base-color,#fff);";return o`<span style="display:inline-flex; ${e.style}" class="${e.cssClasses}" slot="${e.slot??l}">
        ${i.map(d=>o`<span style="${Pr}${n}" title="${d.name||l}">
            ${d.img?o`<img src="${d.img}" style="width:100%;height:100%;object-fit:cover;">`:Ai(d.name??"",d.abbr)}
        </span>`)}
        ${s>0?o`<span style="${Pr}${n}">+${s}</span>`:l}
    </span>`},Io=(e,t,a)=>{const r=e.metadata;return o`<span theme="badge ${r.color} ${r.pill?"pill":""} ${r.small?"small":""} ${r.primary?"primary":""}"
                      style="${e.style}" class="${e.cssClasses}"
                      slot="${e.slot??l}">${Oe(r.text,t,a)}</span>`},So=(e,t,a)=>{const r=Oe(e.text,t,a);if(!r)return l;let i=Oe(e.color,t,a);return i=="SUCCESS"&&(i="success"),i=="ERROR"&&(i="error"),i=="DANGER"&&(i="error"),i=="WARNING"&&(i="warning"),i=="INFO"&&(i="info"),i=="PRIMARY"&&(i="primary"),i=="SECONDARY"&&(i="secondary"),i=="TERTIARY"&&(i="tertiary"),i=="QUATERNARY"&&(i="quaternary"),i=="LIGHT"&&(i="light"),i=="DARK"&&(i="dark"),o`<span theme="badge ${i} ${e.pill?"pill":""} ${e.small?"small":""} ${e.primary?"primary":""}">${r}</span>`};class Eo{constructor(){this.afterRenderHook=void 0,this.useShadowRoot=!0,this.componentRenderer=void 0}set(t){if(this.componentRenderer=t,typeof window<"u"){const a=t.supportedClientSideTypes?.();window.__mateuRendererInfo={name:t.rendererName?.()??t.constructor?.name??"unknown",supportedTypes:a?[...a].sort():null}}}get(){return this.componentRenderer}setUseShadowRoot(t){this.useShadowRoot=t}mustUseShadowRoot(){return this.useShadowRoot}setAfterRenderHook(t){this.afterRenderHook=t}getAfterRenderHook(){return this.afterRenderHook}}const B=new Eo,Ot=(e,t,a,r,i,s,n,d,c)=>(t.slot=d,g(e,t,a,r,i,s,n,c)),g=(e,t,a,r,i,s,n,d)=>{if(!t)return o``;if(t.type==W.ClientSide)return B.get().renderClientSideComponent(e,t,a,r,i,s,n,d);const c=e.route,u=e.consumedRoute;return o`
        <mateu-component id="${t.id}"
                        ...
                        route="${c}"
                         ...
                         .appData="${n}"
        >
       </mateu-component>`};var Po=Object.defineProperty,To=Object.getOwnPropertyDescriptor,Yt=(e,t,a,r)=>{for(var i=r>1?void 0:r?To(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Po(t,a,i),i};const Fi=e=>{const t=[];return e.color&&e.color!=="normal"&&e.color!=="none"&&t.push(e.color),e.buttonStyle&&t.push(e.buttonStyle==="tertiaryInline"?"tertiary-inline":e.buttonStyle),e.size&&e.size!=="none"&&e.size!=="normal"&&t.push(e.size),t.length?t.join(" "):void 0},Oo=e=>{const t=Fi(e)??"",a=[];return t.includes("primary")&&a.push("primary"),t.includes("tertiary")&&a.push("tertiary"),(t.includes("error")||e.color==="error")&&a.push("danger"),a.join(" ")},ai=e=>e==="back"||e==="backToList"||!!e&&e.startsWith("cancel");let rt=class extends C{constructor(){super(...arguments),this.appState={},this.appData={},this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.evalLabel=e=>ye(e,this.state,this.data),this.renderBtn=e=>{if((this.data??{})[e.actionId+".hidden"])return l;const t=this.evalLabel(e.label),a=B.get()?.renderToolbarButton?.(e,t,()=>this.handleButtonClick(e.actionId));return a||o`
        <button class="mtb ${Oo(e)}"
                data-action-id="${e.id}"
    ...
    `},this.renderPeerNav=e=>{const t=B.get()?.renderPeerNav?.(e);return t||o`
        ...
        `}}render(){const e=this.metadata;if(!e)return o``;const t=e.peerNav&&(e.peerNav.prevRoute||e.peerNav.nextRoute)?e.peerNav:void 0,a=e.toolbar??[],r=a.filter(c=>ai(c.actionId)),i=a.filter(c=>!ai(c.actionId)),s=r.length>0&&i.length>0?o`<span class="toolbar-divider"></span>`:l,n=e.avatar||e.title||e.subtitle||e.kpis?.length>0||e.header?.length>0||a.length>0||!!t,d=e.level??0;return d>0?this.setAttribute("data-nested",""):this.removeAttribute("data-nested"),o`
            ...
            `:n?o`
                <div style="display: flex; gap: var(--lumo-space-m, 1rem); width: 100%; align-items: center;" class="form-header">
                    ...
                    <div style="flex: 1; min-width: 0; overflow: hidden;">
                        ${e?.title&&d==0?o`<h2 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ge(ut(e?.title,this.state??{},this.data??{}))}</h2>`:l}
                        ${e?.title&&d==1?o`<h3 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ge(ut(e?.title,this.state??{},this.data??{}))}</h3>`:l}
                        ${e?.title&&d==2?o`<h4 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ge(ut(e?.title,this.state??{},this.data??{}))}</h4>`:l}
                        ${e?.title&&d==3?o`<h5 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ge(ut(e?.title,this.state??{},this.data??{}))}</h5>`:l}
                        ${e?.title&&d>3?o`<h6 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${ge(ut(e?.title,this.state??{},this.data??{}))}</h6>`:l}

                        ${e?.subtitle?o`<span style="display: inline-block; margin-block-end: 0.83em;">${ge(ut(e?.subtitle,this.state??{},this.data??{}))}</span>`:l}
                        ${e?.timestamp?o`<span class="page-timestamp" style="display: block; color: var(--lumo-secondary-text-color, #6b7280); font-size: var(--lumo-font-size-s, .875rem);">${ge(ut(e.timestamp,this.state??{},this.data??{}))}</span>`:l}
                    </div>
                    <div style="display: flex; gap: var(--lumo-space-m, 1rem); align-items: center;">
                        ${e?.kpis?.map(c=>o`
                            <div style="display: flex; flex-direction: column; align-items: center;">
                                <div>${this.evalLabel(c.title)}</div>
                                <div>${ge(ut(c.text,this.state??{},this.data??{}))}</div>
                            </div>
                        `)}
                        ${e?.header?.map(c=>g(this,c,this.baseUrl,this.state??{},this.data??{},this.appState,this.appData))}
                        ${t?this.renderPeerNav(t):l}
            ...
            ${e.badges&&e.badges.length>0?o`
                <div style="display: flex; gap: var(--lumo-space-s, .5rem); padding-bottom: var(--lumo-space-s, .5rem);">
                    ${e.badges.map(c=>So(c,this.state??{},this.data??{}))}
                </div>
            `:l}
        `}};rt.styles=x`
        :host {
        ...
        ${xt}
    `;Yt([p()],rt.prototype,"metadata",2);Yt([p()],rt.prototype,"baseUrl",2);Yt([p()],rt.prototype,"state",2);Yt([p()],rt.prototype,"data",2);Yt([p()],rt.prototype,"appState",2);Yt([p()],rt.prototype,"appData",2);rt=Yt([k("mateu-content-header")],rt);var zo=Object.defineProperty,Ro=Object.getOwnPropertyDescriptor,Ta=(e,t,a,r)=>{for(var i=r>1?void 0:r?Ro(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&zo(t,a,i),i};let At=class extends dr{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={}}render(){const e=this.component?.metadata;return o`
    ...
    `;Ta([p()],At.prototype,"state",2);Ta([p()],At.prototype,"data",2);Ta([p()],At.prototype,"appState",2);Ta([p()],At.prototype,"appData",2);At=Ta([k("mateu-form")],At);var Lo=Object.defineProperty,Do=Object.getOwnPropertyDescriptor,Mr=(e,t,a,r)=>{for(var i=r>1?void 0:r?Do(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Lo(t,a,i),i};let ka=class extends C{constructor(){super(...arguments),this.variant="text",this.count=3}render(){const e=Array.from({length:Math.max(1,this.count)});return this.variant=="card"?o`${e.map(()=>o`<div class="bone card" style="margin: .5em 0;"></div>`)}`:this.variant=="grid"?o`${e.map(()=>o`<div class="bone row"></div>`)}`:this.variant=="form"?o`${e.map(()=>o`
                <div class="form-pair">
                    <div class="bone label"></div>
                    <div class="bone field"></div>
                </div>
            `)}`:o`${e.map(()=>o`<div class="bone line"></div>`)}`}};ka.styles=x`
        :host {
            display: block;
            flex: 1 1 0;
            min-width: 6rem;
    ...
    `;Mr([p()],ka.prototype,"variant",2);Mr([p({type:Number})],ka.prototype,"count",2);ka=Mr([k("mateu-skeleton")],ka);const Ao=(e,t)=>{t&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},zt=(e,t,a,r,i,s)=>o`
    ...
    `},U=(e,t,a,r)=>{if(!e)return o``;const i=B.get()?.renderIcon;if(i){const s=i.call(B.get(),e,t,a);return r?o`<span slot="${r}">${s}</span>`:s}return o`<span class="mateu-icon ${a??""}" data-icon="${e}" aria-hidden="true"
                      style="display:inline-block; width:1em; height:1em; ${t??""}" slot="${r??l}"></span>`},qi="mateu-saved-views",cr=()=>{try{return JSON.parse(localStorage.getItem(qi)??"{}")}catch{return{}}},Nr=e=>{try{localStorage.setItem(qi,JSON.stringify(e))}catch{}},Mi=e=>cr()[e]??[],Mo=(e,t)=>{const a=t.name?.trim();if(!a||Object.keys(t.values??{}).length===0)return;const r=cr(),i=(r[e]??[]).filter(s=>s.name!==a);i.push({...t,name:a}),r[e]=i,Nr(r)},No=(e,t)=>{const a=cr(),r=(a[e]??[]).filter(i=>i.name!==t);r.length===0?delete a[e]:a[e]=r,Nr(a)},Uo=(e,t)=>{const a=cr();a[e]=(a[e]??[]).map(r=>({...r,isDefault:r.name===t?!r.isDefault:!1})),Nr(a)},jo=e=>Mi(e).find(t=>t.isDefault);var Bo=Object.defineProperty,Vo=Object.getOwnPropertyDescriptor,Ie=(e,t,a,r)=>{for(var i=r>1?void 0:r?Vo(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Bo(t,a,i),i};let se=class extends C{constructor(){super(...arguments),this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.searchOnly=!1,this.panelOpened=!1,this.viewsOpened=!1,this.draftText="",this.openPanel=()=>{this.panelOpened||this.filters.length===0||(this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick))},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1,this.activeFilter=void 0},this.clearAllFilters=()=>{const e=this.filters.flatMap(a=>this.isRangeFilter(a)?[`${a.fieldId}_from`,`${a.fieldId}_to`]:[a.fieldId]),t={searchText:void 0};e.forEach(a=>{t[a]=void 0}),this.state={...this.state,...t},this.dispatchEvent(new CustomEvent("filter-reset-requested",{detail:{fieldIds:e},bubbles:!0,composed:!0})),this.requestSearch()},this.keepFocus=e=>e.preventDefault()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}get filters(){return this.metadata?.filters??[]}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}requestSearch(){this.closePanel(),this.dispatchEvent(new CustomEvent("search-requested",{detail:{},bubbles:!0,composed:!0}))}emitValueChanged(e,t){this.state={...this.state,[e]:t},this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t,fieldId:e},bubbles:!0,composed:!0}))}applyFilter(e,t){this.emitValueChanged(e,t),this.requestSearch()}removeChip(e){const t=this.filters.find(a=>a.fieldId===e);t&&this.isRangeFilter(t)?(this.emitValueChanged(`${e}_from`,void 0),this.emitValueChanged(`${e}_to`,void 0)):this.emitValueChanged(e,e==="searchText"?"":void 0),this.requestSearch()}commitText(e){this.emitValueChanged("searchText",e.value),this.draftText="",e.value="",this.requestSearch()}get viewsScope(){return window.location.pathname}allFilterKeys(){return["searchText",...this.filters.flatMap(e=>this.isRangeFilter(e)?[`${e.fieldId}_from`,`${e.fieldId}_to`]:[e.fieldId])]}snapshotValues(){const e={};return this.state.searchText&&(e.searchText=this.state.searchText),this.filters.forEach(t=>{if(this.isSet(t))if(this.isRangeFilter(t)){const a=this.rangeBound(t,"from"),r=this.rangeBound(t,"to");a&&(e[`${t.fieldId}_from`]=a),r&&(e[`${t.fieldId}_to`]=r)}else this.isMultiFilter(t)?e[t.fieldId]=this.multiValues(t):e[t.fieldId]=this.state[t.fieldId]}),e}applyView(e){const t=this.allFilterKeys(),a={};t.forEach(r=>{a[r]=void 0}),this.state={...this.state,...a},this.dispatchEvent(new CustomEvent("filter-reset-requested",{detail:{fieldIds:t},bubbles:!0,composed:!0})),Object.entries(e.values).forEach(([r,i])=>this.emitValueChanged(r,i)),this.viewsOpened=!1,this.detachOutsideClick(),this.requestSearch()}saveCurrentView(e){const t=e.value.trim();t&&(Mo(this.viewsScope,{name:t,values:this.snapshotValues()}),e.value="",this.requestUpdate())}firstUpdated(){if(window.location.search)return;const e=jo(this.viewsScope);e&&setTimeout(()=>{this.state.searchText||this.filters.some(a=>this.isSet(a))||this.applyView(e)},0)}isBooleanFilter(e){return e.dataType==="boolean"||e.dataType==="bool"||e.stereotype==="checkbox"||e.stereotype==="toggle"}isNumericFilter(e){return["integer","decimal","number","money"].includes(e.dataType??"")}isRangeFilter(e){return e.stereotype==="dateRange"||e.stereotype==="numberRange"}isMultiFilter(e){return e.stereotype==="multiSelect"}hasOptions(e){return(e.options?.length??0)>0}multiValues(e){const t=this.state[e.fieldId];return Array.isArray(t)?t.map(String):typeof t=="string"&&t!==""?t.split(",").map(a=>a.trim()).filter(a=>a):[]}rangeBound(e,t){const a=this.state[`${e.fieldId}_${t}`];return a==null?"":String(a)}isSet(e){if(this.isRangeFilter(e))return this.rangeBound(e,"from")!==""||this.rangeBound(e,"to")!=="";if(this.isMultiFilter(e))return this.multiValues(e).length>0;const t=this.state[e.fieldId];return t!=null&&t!==""&&!Number.isNaN(t)}getFilterDisplayValue(e,t){if(e.options?.length){const a=e.options.find(r=>r.value===String(t));if(a)return a.label??a.value}return typeof t=="boolean"?t?"Yes":"No":String(t)}conditionDisplay(e){if(this.isRangeFilter(e)){const t=this.rangeBound(e,"from"),a=this.rangeBound(e,"to");return t&&a?`${t} – ${a}`:t?`≥ ${t}`:`≤ ${a}`}return this.isMultiFilter(e)?this.multiValues(e).map(t=>this.getFilterDisplayValue(e,t)).join(", "):this.getFilterDisplayValue(e,this.state[e.fieldId])}labelOf(e){return ye(e.label,this.state,this.data)||e.fieldId}panelRow(e,t,a="panel-row"){return o`
        ...
        `,()=>a(r.value)))}`}renderActiveFilterWidget(e){if(this.isRangeFilter(e))return this.renderRangeWidget(e);if(this.isMultiFilter(e))return this.renderMultiWidget(e);if(this.hasOptions(e))return o`${e.options.map(r=>this.panelRow(r.label??r.value,()=>this.applyFilter(e.fieldId,r.value)))}`;if(this.isBooleanFilter(e))return o`
            ...
            </div>`}renderViewsPanel(){if(!this.viewsOpened)return l;const e=Mi(this.viewsScope),t=!!this.state.searchText||this.filters.some(a=>this.isSet(a));return o`
                ...
                ${e.map(a=>o`
                    <div class="panel-row view-row" @mousedown="${this.keepFocus}">
                        ...
                        <button class="view-star ${a.isDefault?"view-star--on":""}"
                                ...
                                @click="${()=>{Uo(this.viewsScope,a.name),this.requestUpdate()}}">★</button>
                        <button class="chip-remove" aria-label="Delete view ${a.name}"
                                @click="${()=>{No(this.viewsScope,a.name),this.requestUpdate()}}">✕</button>
                    </div>`)}
                ${t?o`
    ...
    `;Ie([p()],se.prototype,"metadata",2);Ie([p()],se.prototype,"baseUrl",2);Ie([b()],se.prototype,"state",2);Ie([b()],se.prototype,"data",2);Ie([p()],se.prototype,"appState",2);Ie([p()],se.prototype,"appData",2);Ie([p({type:Boolean})],se.prototype,"searchOnly",2);Ie([b()],se.prototype,"panelOpened",2);Ie([b()],se.prototype,"viewsOpened",2);Ie([b()],se.prototype,"activeFilter",2);Ie([b()],se.prototype,"draftText",2);se=Ie([k("mateu-filter-bar")],se);const Ni="mateu-column-prefs",Ur=()=>{try{const e=JSON.parse(localStorage.getItem(Ni)??"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}},Ui=e=>{try{localStorage.setItem(Ni,JSON.stringify(e))}catch{}},jr=e=>{if(!e||typeof e!="object")return;const t=a=>Array.isArray(a)?a.filter(r=>typeof r=="string"):[];return{hidden:t(e.hidden),order:t(e.order)}},ji=e=>jr(Ur()[e]),Ho=(e,t)=>{const a=Ur(),r=jr(t);r.hidden.length===0&&r.order.length===0?delete a[e]:a[e]=r,Ui(a)},Wo=e=>{const t=Ur();delete t[e],Ui(t)},Bi=e=>e?!!e.identifier||e.dataType==="action"||e.dataType==="actionGroup"||e.dataType==="menu"||e.id==="select"||e.id==="menu":!1,Vi=(e,t,a=r=>r)=>{const r=jr(t);if(!r||r.hidden.length===0&&r.order.length===0)return e;const i=v=>a(v)?.id??v.id,s=new Set(r.hidden),n=e.filter(v=>{const f=i(v);return!f||!s.has(f)||Bi(a(v))});if(r.order.length===0)return n.length===e.length?e:n;const d=new Map;n.forEach(v=>{const f=i(v);f&&!d.has(f)&&d.set(f,v)});const c=[],u=new Set;return r.order.forEach(v=>{const f=d.get(v);f&&!u.has(f)&&(c.push(f),u.add(f))}),n.forEach(v=>{u.has(v)||(c.push(v),u.add(v))}),c.length===e.length&&c.every((v,f)=>v===e[f])?e:c};var Go=Object.defineProperty,Ko=Object.getOwnPropertyDescriptor,Oa=(e,t,a,r)=>{for(var i=r>1?void 0:r?Ko(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Go(t,a,i),i};let Ft=class extends C{constructor(){super(...arguments),this.columns=[],this.scope="",this.panelOpened=!1,this.revision=0,this.togglePanel=()=>{if(this.panelOpened){this.closePanel();return}this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick)},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1},this.reset=()=>{Wo(this.scope),this.revision++,this.dispatchEvent(new CustomEvent("column-prefs-changed",{bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}get prefs(){return ji(this.scope)??{hidden:[],order:[]}}effectiveEntries(e){return Vi(this.columns,{hidden:[],order:e.order})}commit(e){Ho(this.scope,e),this.revision++,this.dispatchEvent(new CustomEvent("column-prefs-changed",{bubbles:!0,composed:!0}))}toggleVisibility(e){const t=this.prefs,a=t.hidden.includes(e)?t.hidden.filter(r=>r!==e):[...t.hidden,e];this.commit({...t,hidden:a})}move(e,t){const a=this.prefs,r=[...this.effectiveEntries(a)],i=r.findIndex(d=>d.id===e);if(i<0)return;let s=i+t;for(;s>=0&&s<r.length&&r[s].protected;)s+=t;if(s<0||s>=r.length)return;const n=r[i];r[i]=r[s],r[s]=n,this.commit({...a,order:r.map(d=>d.id)})}render(){this.revision;const e=this.prefs,t=this.effectiveEntries(e).filter(r=>!r.protected);if(t.length===0)return o``;const a=e.hidden.length>0||e.order.length>0;return o`
            <div class="chooser">
                <button
    ...
    `;Oa([p()],Ft.prototype,"columns",2);Oa([p()],Ft.prototype,"scope",2);Oa([b()],Ft.prototype,"panelOpened",2);Oa([b()],Ft.prototype,"revision",2);Ft=Oa([k("mateu-column-chooser")],Ft);var Yo=Object.defineProperty,Jo=Object.getOwnPropertyDescriptor,za=(e,t,a,r)=>{for(var i=r>1?void 0:r?Jo(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Yo(t,a,i),i};let qt=class extends C{constructor(){super(...arguments),this.totalElements=0,this.pageSize=100,this.pageNumber=0,this.totalPages=0}updated(e){super.updated(e),(e.has("totalElements")||e.has("pageSize"))&&(this.totalPages=Math.ceil(this.totalElements/this.pageSize))}dispatch(e){this.dispatchEvent(new CustomEvent("page-changed",{bubbles:!0,composed:!0,detail:{page:e}}))}render(){if(!this.totalElements)return l;const e=this.totalPages>1,t=this.pageNumber,a=t===0,r=t>=this.totalPages-1;return o`
            <div class="bar">
                ${e?o`
    ...
    `;za([p()],qt.prototype,"totalElements",2);za([p()],qt.prototype,"pageSize",2);za([p()],qt.prototype,"pageNumber",2);za([b()],qt.prototype,"totalPages",2);qt=za([k("mateu-pagination")],qt);const da="var(--lumo-space-m, 1rem)",Xo=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=d.columnWidth||"13rem";let m=`display: grid; grid-template-columns: ${d.maxColumns&&d.maxColumns>0?`repeat(${d.maxColumns}, minmax(0, 1fr))`:`repeat(auto-fill, minmax(min(100%, ${c}), 1fr))`}; gap: ${da} var(--lumo-space-l, 1.5rem); align-items: start;`;return d.labelsAside&&(m+=" --mateu-label-width: 10rem;"),d.fullWidth&&(m+=" width: 100%;"),m+=t.style??"",o`
        <div style="${m}" class="${t.cssClasses}" slot="${t.slot||l}">
            ${t.children?.map(v=>Hi(d,e,v,a,r,i,s,n))}
        </div>
    `},Hi=(e,t,a,r,i,s,n,d)=>{if(a.type==W.ClientSide&&a.metadata?.type==h.FormRow)return en(e,t,a,r,i,s,n,d);const c=Qo(a),u=e.labelsAside?Zo(t,a,r,i,s,n,d):g(t,a,r,i,s,n,d);return o`<div style="grid-column: span ${c}; min-width: 0;">${u}</div>`},Qo=e=>{if(e.type==W.ClientSide){const t=e.metadata;if(t?.type==h.FormField)return t.colspan||1}return 1},Zo=(e,t,a,r,i,s,n)=>{if(t.type==W.ClientSide&&t.metadata?.type==h.FormField&&t.metadata.label){const d=t.metadata,c=d.label?.includes("${")?e._evalTemplate(d.label):d.label;return o`
            <div style="display: flex; gap: ${da}; align-items: baseline;">
        ...
        `}return g(e,t,a,r,i,s,n)},en=(e,t,a,r,i,s,n,d)=>o`
        <div style="grid-column: 1 / -1; display: flex; gap: ${da}; flex-wrap: wrap;">
            ${a.children?.map(c=>o`<div style="flex: 1 1 ${100/Math.max(1,a.children.length)}%; min-width: min(100%, 13rem);">${Hi(e,t,c,r,i,s,n,d)}</div>`)}
        </div>
    `,Wi=(e,t,a,r,i,s,n,d)=>{const c=a.metadata;let u=`display: flex; flex-direction: ${e};`;c.spacing&&(u+=` gap: ${da};`),c.padding&&(u+=" padding: var(--lumo-space-m, 1rem);"),c.wrap&&(u+=" flex-wrap: wrap;"),c.fullWidth&&(u+=" width: 100%;"),c.justification&&(u+=` justify-content: ${c.justification};`);const m=e==="row"?c.verticalAlignment:c.horizontalAlignment;return m&&(u+=` align-items: ${m};`),u+=a.style??"",o`
        <div style="${u}" class="${a.cssClasses}" slot="${a.slot??l}">
            ${a.children?.map(v=>g(t,v,r,i,s,n,d))}
        </div>
    `},tn=(e,t,a,r,i,s,n)=>Wi("row",e,t,a,r,i,s,n),an=(e,t,a,r,i,s,n)=>Wi("column",e,t,a,r,i,s,n),rn=(e,t,a,r,i,s,n)=>{const d=t.metadata;let u=`display: flex; flex-direction: ${d.orientation==="vertical"?"column":"row"}; gap: var(--lumo-space-s, 0.5rem);`;return d.fullWidth&&(u+=" width: 100%;"),u+=t.style??"",o`
    ...
    `},sn=(e,t,a,r,i,s,n)=>{const d=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,u=!!i?.hasDetail||!!d,m=c??d;return o`
    ...
    `},on=(e,t,a,r,i,s,n)=>{let d=t.style??"";t.metadata.fullWidth&&(d+=" width: 100%;");const c=Math.max(0,(t.children??[]).findIndex(u=>u.metadata.active));return o`
            ...
            ${t.children?.map((u,m)=>{const v=u,f=v.metadata.label,w=f?.includes("${")?e._evalTemplate(f):f;return o`
                    <details ?open="${m===c}" style="border-bottom: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1));">
                        ...
                        <div style="padding: var(--lumo-space-m, 1rem) 0;">
                            ${v.children?.map($=>g(e,$,a,r,i,s,n))}
                        </div>
                    </details>
                `})}
        </div>
    `},nn=(e,t,a,r,i,s,n)=>{const d=t.metadata;let c=t.style??"";return d.fullWidth&&(c+=" width: 100%;"),o`
        <div style="${c}" class="${t.cssClasses}" slot="${t.slot??l}">
            ${t.children?.map(u=>ln(e,u,a,r,i,s,n,d.variant))}
        </div>
    `},ln=(e,t,a,r,i,s,n,d)=>{const c=t.metadata,u=c.label?.includes("${")?e._evalTemplate(c.label):c.label;return o`
    ...
    `,pn=(e,t,a,r,i,s,n)=>o`
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 16rem), 1fr)); gap: ${da}; ${t.style}" class="${t.cssClasses}" slot="${t.slot??l}">
            ${t.children?.map(d=>g(e,d,a,r,i,s,n))}
        </div>
    `,hn=(e,t,a,r,i,s,n)=>o`
        <div style="display: flex; gap: ${da}; flex-wrap: wrap; ${t.style}" class="${t.cssClasses}">
            ${t.children?.map(d=>g(e,d,a,r,i,s,n))}
        </div>
    ...
    `},fn=e=>{const t=e.metadata;return(t?.content??t?.columns??[]).filter(r=>r&&r.metadata).map(r=>{const i=r.metadata;return{id:r.id??"",label:i?.label??r.id??"",autoWidth:i?.autoWidth,width:i?.width}})},ri=(e,t)=>{const a=e?.[t];return a==null?"":typeof a=="object"?a.text??a.label??a.value??"":String(a)},Tr=(e,t,a)=>{const r=fn(e),i="text-align:left; padding:.45rem .6rem; border-bottom:2px solid var(--lumo-contrast-20pct,rgba(0,0,0,.2)); font-weight:600; white-space:nowrap; color: var(--lumo-secondary-text-color,#556);",s="padding:.4rem .6rem; border-bottom:1px solid var(--lumo-contrast-10pct,rgba(0,0,0,.08)); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:24rem;";return o`
        <div style="overflow:auto; width:100%; ${e.style}" class="${e.cssClasses}" slot="${e.slot??l}">
            <table style="border-collapse:collapse; width:100%; font-size: var(--lumo-font-size-s,.875rem);">
                ...
                <tbody>
                    ${(t??[]).length===0?o`<tr><td colspan="${Math.max(1,r.length)}" style="padding:1.5rem; text-align:center; color: var(--lumo-secondary-text-color,#888);">${a??"No data."}</td></tr>`:t.map(n=>o`<tr>${r.map(d=>o`<td style="${s}" title="${ri(n,d.id)}">${ri(n,d.id)}</td>`)}</tr>`)}
                </tbody>
            </table>
        </div>
    `},ii=(e,t)=>{const a=e.metadata;return e.id&&t&&t[e.id]?t[e.id]:a?.page?.content??[]},bn=e=>{const a=e.metadata.items??[];return o`
    ...
    `},Gi=(e,t,a,r,i,s,n)=>t.separator?o`<span style="align-self: stretch; width: 1px; background: var(--lumo-contrast-20pct, rgba(0,0,0,.2));"></span>`:t.submenus?o`
            <details style="position: relative;">
                ...
                <div style="display: flex; flex-direction: column; gap: .1rem; padding: .3rem; min-width: 10rem;
                    ...
                    ${t.submenus.map(d=>Gi(e,d,a,r,i,s,n))}
                </div>
            </details>
        `:o`
    ...
    `,gn=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
        <div style="display: flex; flex-wrap: wrap; gap: .25rem; align-items: center; ${t.style}"
            ...
            ${d.options?.map(c=>Gi(e,c,a,r,i,{},{}))}
        </div>
    `},yn=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
        <div style="${t.style}" class="${t.cssClasses}" slot="${t.slot??l}">
            ${g(e,d.wrapped,a,r,i,s,n)}
        </div>
    `},$n=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=d.content?.metadata,u=c?.type==h.Notice&&c.fullWidth===!0;return o`
        ...
        >
            ...
            `},xn=e=>{const t=e.metadata,a=r=>{const i=r.closest(".mateu-message-input")?.querySelector("input"),s=i?.value??"";!t.actionId||!s.trim()||(r.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:{message:s}},bubbles:!0,composed:!0})),i&&(i.value=""))};return o`
    ...
    `},wn=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`<span title="${d.text}" style="${t.style}" class="${t.cssClasses}" slot="${t.slot??l}"
        >${g(e,d.wrapped,a,r,i,s,n)}</span>`},kn=e=>{if(e instanceof CustomEvent)return e.detail;const t={};for(const a in e){const r=e[a];["number","string","boolean"].indexOf(typeof r)>=0&&(t[a]=e[a])}return t},si=(e,t,a)=>{for(let r in t.attributes)e.setAttribute(r,t.attributes[r]);a.style&&e.setAttribute("style",a.style),a.cssClasses&&e.setAttribute("class",a.cssClasses),a.slot&&e.setAttribute("slot",a.slot),t.content&&(t.html?e.innerHTML=t.content:e.append(t.content))},Cn=e=>{const t=e.name,a=e.attributes?e.attributes.import:void 0;a&&t.includes("-")&&!customElements.get(t)&&import(a)},_n=(e,t,a)=>{Cn(t);let r=t.name;return t.attributes&&t.attributes.id&&(r="#"+t.attributes.id),setTimeout(()=>{const i=e.shadowRoot?.querySelector(".element-container")?.querySelector(r);if(i){for(;i.firstChild;)i.removeChild(i.lastChild);si(i,t,a)}else{const s=document.createElement(t.name);si(s,t,a);for(let n in t.on)s.addEventListener(n,d=>{const c=kn(d);e.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.on[n],parameters:{event:c}},bubbles:!0,composed:!0}))});e.shadowRoot?.querySelector(".element-container")?.appendChild(s)}}),o`<div class="element-container"></div>`};var He=(e=>(e.div="div",e.p="p",e.h1="h1",e.h2="h2",e.h3="h3",e.h4="h4",e.h5="h5",e.h6="h6",e.span="span",e))(He||{});const In=(e,t,a,r,i)=>{const s=e.metadata,n=s.attributes?.["data-colspan"],d=wa(s.text,t,a,r,i),c={xl:"var(--lumo-font-size-xl, 1.375rem)",l:"var(--lumo-font-size-l, 1.125rem)",s:"var(--lumo-font-size-s, .875rem)",xs:"var(--lumo-font-size-xs, .8125rem)"},u=(s.size&&c[s.size]?`font-size: ${c[s.size]}; `:"")+(s.noMargins?"margin-block-start: 0; margin-block-end: 0; ":"");return He.h1==s.container?o`
        ...
        `:He.p==s.container?o`
            ...
            `},Sn=e=>{const t=e.metadata;return o`<a href="${t.url}" target="${t.target??l}"
                   rel="${t.target==="_blank"?"noopener":l}"
                   style="${e.style}" class="${e.cssClasses}"
                   slot="${e.slot??l}">${t.text}</a>`},Ki=(e,t)=>{const a=e.toLowerCase().split("+");return t.ctrlKey===a.includes("ctrl")&&t.altKey===a.includes("alt")&&t.shiftKey===a.includes("shift")&&t.metaKey===a.includes("meta")},En=(e,t)=>{if(!Ki(e,t))return!1;const a=e.toLowerCase().split("+"),r=a[a.length-1];return!!(t.key.toLowerCase()===r||/^[a-z]$/.test(r)&&t.code==="Key"+r.toUpperCase()||/^[0-9]$/.test(r)&&(t.code==="Digit"+r||t.code==="Numpad"+r))},Yi=e=>e?e.split("+").map(t=>t.length<=1?t.toUpperCase():t.charAt(0).toUpperCase()+t.slice(1)).join("+"):void 0,Ji=(e,t)=>{const a=e.currentTarget.dataset.actionId;e.currentTarget?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a,parameters:t.parameters},bubbles:!0,composed:!0}))},Pn="display:inline-flex; align-items:center; justify-content:center; gap:.4em; box-sizing:border-box; font:inherit; font-weight:500; cursor:pointer; border-radius:var(--lumo-border-radius-m,6px); border:1px solid transparent; line-height:1; white-space:nowrap;",Tn=e=>{const t=e.buttonStyle??"",a=e.color&&e.color!=="none"&&e.color!=="normal"?e.color:"",r=e.size,i=a==="success"?"var(--lumo-success-color,#1a7f37)":a==="error"?"var(--lumo-error-color,#c5221f)":a==="contrast"?"var(--lumo-contrast,#161513)":"var(--lumo-primary-color,#3b5bdb)",s=a==="success"?"var(--lumo-success-contrast-color,#fff)":a==="error"?"var(--lumo-error-contrast-color,#fff)":a==="contrast"?"var(--lumo-base-color,#fff)":"var(--lumo-primary-contrast-color,#fff)",n=a==="success"?"var(--lumo-success-text-color,#1a7f37)":a==="error"?"var(--lumo-error-text-color,#c5221f)":a==="contrast"?"var(--lumo-body-text-color,#161513)":"var(--lumo-primary-text-color,#3b5bdb)";let d;return t==="primary"?d=`background:${i}; color:${s};`:t==="tertiary"||t==="tertiaryInline"?d=`background:transparent; color:${n};`:d=`background:var(--lumo-contrast-5pct,rgba(0,0,0,.04)); color:${n}; border-color:var(--lumo-contrast-20pct,rgba(0,0,0,.16));`,`${Pn}${d}${r==="small"?"padding:.25rem .6rem; font-size:var(--lumo-font-size-s,.875rem);":r==="large"?"padding:.65rem 1.4rem; font-size:var(--lumo-font-size-l,1.125rem);":"padding:.45rem 1rem; font-size:var(--lumo-font-size-m,1rem);"}`},On=(e,t,a)=>{const r=e.metadata,i=ye(r.label,t,a);return o`<button
            id="${e.id}"
            ...
            class="${e.cssClasses}"
            ?disabled="${r.disabled}"
            title="${r.shortcut?`${i} (${Yi(r.shortcut)})`:l}"
            slot="${e.slot??l}"
    >${r.iconOnLeft?U(r.iconOnLeft):l}${i}${r.iconOnRight?U(r.iconOnRight):l}</button>`},zn="display:block; box-sizing:border-box; background:var(--lumo-base-color,#fff); border:1px solid var(--lumo-contrast-10pct,rgba(0,0,0,.1)); border-radius:var(--lumo-border-radius-l,12px); box-shadow:var(--lumo-box-shadow-xs,0 1px 3px rgba(0,0,0,.08)); overflow:hidden;",Rn=(e,t,a,r,i,s,n)=>{const d=t.metadata;if(!d)return o``;const c=m=>m?g(e,m,a,r,i,s,n,!1):l,u=d.header||d.headerPrefix||d.headerSuffix||d.title||d.subtitle;return o`
        <div style="${zn}${t.style}" class="${t.cssClasses}" slot="${t.slot??l}">
            ${d.media?c(d.media):l}
    ...
    `},Dn=e=>{const t=e.metadata;return U(t.icon,e.style,e.cssClasses,e.slot)},xr=(e,t)=>{e&&e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},Xi="font:inherit; font-weight:500; cursor:pointer; padding:.45rem 1rem; border-radius:var(--lumo-border-radius-m,6px);",oi=`${Xi} background:var(--lumo-contrast-5pct,rgba(0,0,0,.04)); color:var(--lumo-body-text-color,#161513); border:1px solid var(--lumo-contrast-20pct,rgba(0,0,0,.16));`,An=`${Xi} background:var(--lumo-primary-color,#3b5bdb); color:var(--lumo-primary-contrast-color,#fff); border:1px solid transparent;`,Fn=(e,t,a,r,i,s,n)=>{const d=t.metadata;let c=!1;if(d.openedCondition)try{c=qr(d.openedCondition,r,i,s,n)}catch(u){console.error("when evaluating "+d.openedCondition+" :"+u+", where data is "+i+" and state is "+r)}return c?o`
        <div class="mateu-confirm-dialog ${t.cssClasses??""}"
            ...
            <div style="background:var(--lumo-base-color,#fff); color:var(--lumo-body-text-color,#161513); border-radius:var(--lumo-border-radius-l,12px); box-shadow:var(--lumo-box-shadow-l,0 8px 24px rgba(0,0,0,.2)); width:100%; max-width:min(90vw,32rem); padding:1.5rem; box-sizing:border-box;">
                ...
                <div style="display:flex; gap:.5rem; justify-content:flex-end; margin-top:1.25rem;">
                    ${d.canCancel?o`<button style="${oi}" @click="${u=>xr(u.currentTarget,d.cancelActionId)}">${d.rejectText&&!d.canReject?d.rejectText:"Cancel"}</button>`:l}
                    ${d.canReject?o`<button style="${oi}" @click="${u=>xr(u.currentTarget,d.rejectActionId)}">${d.rejectText||"No"}</button>`:l}
                    <button style="${An}" @click="${u=>xr(u.currentTarget,d.confirmActionId)}">${d.confirmText||"OK"}</button>
                </div>
            </div>
        </div>
    `:o``},qn=e=>{const t=e.metadata;let a;return t.position&&(a={Top:"top",Bottom:"bottom",TopLeft:"top-left",TopRight:"top-right",BottomLeft:"bottom-left",BottomRight:"bottom-right"}[t.position]),o`
    ...
    `},Hn=(e,t={})=>{const a=e.metadata,r=a.valueKey?t[a.valueKey]:a.value,i=a.max&&a.max!=0?a.max:1,s=!a.indeterminate&&r!=null;return o`
    ...
    `},Wn=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
    ...
    `},Gn=e=>{const t=e.metadata;return o`
        ...
        <img src="${t.src}" style="${e.style}" class="${e.cssClasses}"
             slot="${e.slot??l}">
            `},Yn=e=>{const t=e.metadata;return o`<div style="display:flex; align-items:center; gap:0.5rem;" slot="${e.slot??l}">
        ${t.breadcrumbs.map(a=>o`
            <a href="${a.link}">${a.text}</a>
            <span>/</span>
        `)}
        <span style="${e.style}" class="${e.cssClasses}">${t.currentItemText}</span>
    </div>`},Jn=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
        <skeleton-carousel 
                id="${t.id}"
                ?dots = "${d.dots}" 
                ?nav = "${d.nav}" 
    ...
    `},Xn=(e,t,a,r)=>{const i=e.metadata;return o`
        ...
        ${e.submenus?o`
                <details open>
                    ...
                    <div style="display:flex; flex-direction:column; gap:0.25rem; padding-left:0.5rem;">
                        ${e.submenus.map(t=>Qi(t))}
                    </div>
                </details>
            `:o`
                <a href="${e.path}">${e.label}</a>
        `}
        `,Qn=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`<div
                slot="${t.slot??l}"
                style="${t.style}" class="${t.cssClasses}"
        >${d.content?ge(d.content):l}${t.children?.map(c=>g(e,c,a,r,i,s,n))}</div>
    `},Zn=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=d.title?.includes("${")?e._evalTemplate(d.title):d.title;return o`<div
                slot="${t.slot??l}"
    ...
    `},el=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=d.title?.includes("${")?e._evalTemplate(d.title):d.title;return o`
        <div
                slot="${t.slot??l}"
                style="${t.style}" class="${t.cssClasses}"
        >
    ...
    `},tl=(e,t,a)=>{a.dispatchEvent(new CustomEvent("value-changed",{detail:{fieldId:e,value:t},bubbles:!0,composed:!0}))},Ua=e=>t=>{const a=t.target,r=a.type==="checkbox"?a.checked:a.value;tl(e.fieldId,r,a)},al=(e,t)=>{const a=e.metadata,r=t?.[a.fieldId]??"",i=a,s=i.dataType,n=i.stereotype,d=!!i.readOnly,c=!!i.disabled,u=i.options,m=a.label?o`<label style="display:block; font-size: var(--lumo-font-size-s,.875rem); color: var(--lumo-secondary-text-color,#667); margin-bottom:.15rem;">${a.label}</label>`:l,v="width:100%; box-sizing:border-box; padding:.4rem .6rem; border:1px solid var(--lumo-contrast-30pct,rgba(0,0,0,.3)); border-radius: var(--lumo-border-radius-m,6px); font:inherit; background: var(--lumo-base-color,#fff); color: var(--lumo-body-text-color,#1a1a1a);";let f;return d||n==="plainText"?f=o`<div style="padding:.4rem 0;">${String(r??"")}</div>`:s==="boolean"||n==="checkbox"||n==="badge"?f=o`<input type="checkbox" ?checked="${!!r}" ?disabled="${c}" @change="${Ua(a)}">`:u&&u.length?f=o`
            <select style="${v}" ?disabled="${c}" @change="${Ua(a)}">
                <option value="">—</option>
                ${u.map(w=>o`<option value="${w.value}" ?selected="${w.value===r}">${w.label}</option>`)}
            </select>`:n==="textarea"||n==="richText"||n==="html"?f=o`<textarea style="${v}" rows="3" ?disabled="${c}" @input="${Ua(a)}">${String(r??"")}</textarea>`:f=o`<input type="${s==="integer"||s==="number"||s==="double"||s==="money"?"number":s==="date"?"date":s==="datetime"?"datetime-local":s==="time"?"time":n==="password"?"password":s==="email"?"email":"text"}" style="${v}" .value="${String(r??"")}"
                              placeholder="${i.placeholder??l}" ?disabled="${c}" @input="${Ua(a)}">`,o`
        <div style="${e.style}" class="${e.cssClasses}" slot="${e.slot??l}">
            ${m}
            ${f}
        </div>
    `},Or=(e,t,a,r,i,s,n,d)=>{const c=t.metadata,u=c?.fabs??[];return o`<mateu-page
            .component="${t}"
            baseUrl="${a}"
            .state="${r}"
            .data="${i}"
...
`)}
    ...
    `},zr=(e,t,a,r,i,s,n,d)=>o`<mateu-table-crud
            id="${t.id}"
            baseUrl="${a}"
            .component="${t}"
            .metadata="${t.metadata}"
    ...
    `},il=(e,t,a)=>{const r=e.metadata;return o`<mateu-chat sseUrl="${r.sseUrl}"
                            style="${e.style}" 
                            class="${e.cssClasses}" 
                            slot="${e.slot??l}"></mateu-chat>`},sl=e=>{const t=e.metadata;return o`
        <mateu-workflow
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
    ...
    box-sizing: border-box;
`,nl=e=>e=="up"?"var(--lumo-success-text-color, #1a7f37)":e=="down"?"var(--lumo-error-text-color, #c5221f)":"var(--lumo-secondary-text-color, #666)",ll=e=>e=="up"?"▲":e=="down"?"▼":"",dl=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},cl=e=>{const t=e.metadata,a=!!t.actionId;return o`
        <div class="mateu-metric-card ${e.cssClasses??""}"
             style="${Zi} display: flex; flex-direction: column; gap: .25rem; min-width: 11rem; flex: 1; ${a?"cursor: pointer;":""} ${e.style??""}"
             slot="${e.slot??l}"
             role="${a?"button":l}"
             @click="${r=>dl(r,t)}"
        >
            ...
            ${t.trend||t.trendLabel?o`
                <span style="font-size: var(--lumo-font-size-s, .875rem); color: ${nl(t.trend)};">
                    ${ll(t.trend)} ${t.trendLabel??l}
                </span>
            `:l}
    ...
    `,pl=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=d.colSpan&&d.colSpan>1?`grid-column: span ${d.colSpan};`:"",u=d.rowSpan&&d.rowSpan>1?`grid-row: span ${d.rowSpan};`:"";return o`
        <div class="mateu-dashboard-panel ${t.cssClasses??""}"
             style="${Zi} display: flex; flex-direction: column; gap: .5rem; min-width: 0; ${c} ${u} ${t.style??""}"
             slot="${t.slot??l}"
        >
            ${d.title?o`
                <div>
    ...
    `},hl=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=d.columns&&d.columns>0?`repeat(${d.columns}, minmax(0, 1fr))`:"repeat(auto-fit, minmax(20rem, 1fr))";return o`
    ...
    `};var ml=Object.defineProperty,vl=Object.getOwnPropertyDescriptor,ot=(e,t,a,r)=>{for(var i=r>1?void 0:r?vl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&ml(t,a,i),i};let Re=class extends C{constructor(){super(...arguments),this.panels=[],this.headerTitle="",this.badges=[],this.orientation="vertical",this.navigation=null,this.overviewEditActionId="",this.openPanels=new Set,this.expandedPanel=null,this._onPopState=()=>{const e=decodeURIComponent((location.hash||"").replace(/^#/,""));if(e.startsWith("expand=")){const t=e.slice(7),a=this.panels.findIndex((r,i)=>this.panelAnchor(r,i)===t);this.expandedPanel=a>=0?a:null}else this.expandedPanel=null},this.initialized=!1}navAction(e){e&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e,parameters:{}},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._onPopState)}disconnectedCallback(){window.removeEventListener("popstate",this._onPopState),super.disconnectedCallback()}willUpdate(){if(!this.initialized&&this.panels.length){this.openPanels=new Set(this.panels.map((t,a)=>t.open?a:-1).filter(t=>t>=0));const e=decodeURIComponent((location.hash||"").replace(/^#/,""));if(e.startsWith("expand=")){const t=e.slice(7),a=this.panels.findIndex((r,i)=>this.panelAnchor(r,i)===t);a>=0&&(this.expandedPanel=a)}else if(e){const t=this.panels.findIndex((a,r)=>this.panelAnchor(a,r)===e);t>=0&&this.openPanels.add(t)}this.initialized=!0}}firstUpdated(){const e=decodeURIComponent((location.hash||"").replace(/^#/,""));if(!e)return;const t=this.renderRoot.querySelector(`[data-anchor="${CSS.escape(e)}"]`);t&&t.scrollIntoView({block:"nearest"})}panelAnchor(e,t){return(e.title??"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")||`panel-${t}`}bookmarkPanel(e){const t=this.panelAnchor(this.panels[e],e);try{history.replaceState(history.state,"","#"+t)}catch{}}clearBookmark(e){const t=this.panelAnchor(this.panels[e],e);if(decodeURIComponent((location.hash||"").replace(/^#/,""))===t)try{history.replaceState(history.state,"",location.pathname+location.search)}catch{}}expandPanel(e,t){t?.stopPropagation(),this.expandedPanel=e;const a=this.panelAnchor(this.panels[e],e);try{history.pushState(history.state,"","#expand="+a)}catch{}}collapsePanel(){try{history.back()}catch{this.expandedPanel=null}}toggle(e){const t=new Set(this.openPanels);t.has(e)?(t.delete(e),this.clearBookmark(e)):(t.add(e),this.bookmarkPanel(e)),this.openPanels=t}render(){if(this.expandedPanel!=null&&this.panels[this.expandedPanel]){const t=this.panels[this.expandedPanel];return o`
    ...
    `;ot([p({type:Array})],Re.prototype,"panels",2);ot([p({type:String})],Re.prototype,"headerTitle",2);ot([p({type:Array})],Re.prototype,"badges",2);ot([p({type:String,reflect:!0})],Re.prototype,"orientation",2);ot([p({attribute:!1})],Re.prototype,"navigation",2);ot([p({type:String})],Re.prototype,"overviewEditActionId",2);ot([b()],Re.prototype,"openPanels",2);ot([b()],Re.prototype,"expandedPanel",2);Re=ot([k("mateu-foldout")],Re);const fl=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
        <mateu-foldout
                .panels="${d.panels??[]}"
    ...
    `},bl=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=!!d.image,u=c?`background-image: linear-gradient(rgba(0,0,0,.35), rgba(0,0,0,.35)), url('${d.image}'); background-size: cover; background-position: center; color: #fff;`:"",m=d.centered===!1?"flex-start":"center",v=d.centered===!1?"left":"center";return o`
    ...
    `};var gl=Object.defineProperty,yl=Object.getOwnPropertyDescriptor,Br=(e,t,a,r)=>{for(var i=r>1?void 0:r?yl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&gl(t,a,i),i};const wr=1440*60*1e3;let Ca=class extends C{constructor(){super(...arguments),this.tasks=[],this.onTaskSelectionActionId=""}selectTask(e){this.onTaskSelectionActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.onTaskSelectionActionId,parameters:{_clickedTaskId:e.id}},bubbles:!0,composed:!0}))}range(){const e=this.tasks.flatMap(t=>[t.start,t.end]).filter(t=>!!t).map(t=>new Date(t+"T00:00:00").getTime());return e.length?{min:Math.min(...e)-wr,max:Math.max(...e)+2*wr}:null}months(e,t){const a=[],r=new Date(e);for(r.setDate(1);r.getTime()<=t;){const i=Math.max(r.getTime(),e),s=new Date(r.getFullYear(),r.getMonth()+1,1),n=Math.min(s.getTime(),t);a.push({label:r.toLocaleDateString(void 0,{month:"short",year:"2-digit"}),from:i,to:n}),r.setMonth(r.getMonth()+1)}return a}render(){const e=this.range();if(!e)return o``;const t=e.max-e.min,a=i=>(i-e.min)/t*100,r=Date.now();return o`
            <div class="frame">
                ...
                ${this.tasks.map(i=>{const s=new Date(i.start+"T00:00:00").getTime(),n=new Date(i.end+"T00:00:00").getTime()+wr;return o`
    ...
    `;Br([p({type:Array})],Ca.prototype,"tasks",2);Br([p()],Ca.prototype,"onTaskSelectionActionId",2);Ca=Br([k("mateu-gantt")],Ca);const $l=e=>{const t=e.metadata;return o`
        <mateu-gantt
                .tasks="${t.tasks??[]}"
    ...
    `;wt([p({type:Array})],L.prototype,"resources",2);wt([p({type:Array})],L.prototype,"blocks",2);wt([p()],L.prototype,"from",2);wt([p()],L.prototype,"to",2);wt([p()],L.prototype,"moveActionId",2);wt([p()],L.prototype,"selectActionId",2);wt([b()],L.prototype,"drag",2);L=wt([k("mateu-planning-board")],L);const kl=e=>{const t=e.metadata;return o`
        <mateu-planning-board
                ...
                slot="${e.slot??l}"
        ></mateu-planning-board>
    `};var Cl=Object.defineProperty,_l=Object.getOwnPropertyDescriptor,es=(e,t,a,r)=>{for(var i=r>1?void 0:r?_l(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Cl(t,a,i),i};let Ha=class extends C{constructor(){super(...arguments),this.columns=[]}clickCard(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedCard:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="board">
    ...
    `;es([p({type:Array})],Ha.prototype,"columns",2);Ha=es([k("mateu-kanban")],Ha);const Il=e=>{const t=e.metadata;return o`
        <mateu-kanban
                .columns="${t.columns??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-kanban>
    `};var Sl=Object.defineProperty,El=Object.getOwnPropertyDescriptor,ts=(e,t,a,r)=>{for(var i=r>1?void 0:r?El(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Sl(t,a,i),i};let Wa=class extends C{constructor(){super(...arguments),this.items=[]}clickItem(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedItem:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="feed">
                ${this.items.map(e=>o`
    ...
    `;ts([p({type:Array})],Wa.prototype,"items",2);Wa=ts([k("mateu-timeline")],Wa);const Pl=e=>{const t=e.metadata;return o`
        <mateu-timeline
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-timeline>
    `};var Tl=Object.defineProperty,Ol=Object.getOwnPropertyDescriptor,Vr=(e,t,a,r)=>{for(var i=r>1?void 0:r?Ol(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Tl(t,a,i),i};let _a=class extends C{constructor(){super(...arguments),this.steps=[],this.vertical=!1}render(){return o`
            <div class="steps">
    ...
    `;Vr([p({type:Array})],_a.prototype,"steps",2);Vr([p({type:Boolean,reflect:!0})],_a.prototype,"vertical",2);_a=Vr([k("mateu-progress-steps")],_a);const zl=e=>{const t=e.metadata;return o`
        <mateu-progress-steps
                ...
                slot="${e.slot??l}"
        ></mateu-progress-steps>
    `};var Rl=Object.defineProperty,Ll=Object.getOwnPropertyDescriptor,kt=(e,t,a,r)=>{for(var i=r>1?void 0:r?Ll(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Rl(t,a,i),i};let We=class extends C{constructor(){super(...arguments),this.spark=[]}sparkline(){const e=this.spark;if(!e||e.length<2)return l;const t=84,a=30,r=2,i=Math.min(...e),n=Math.max(...e)-i||1,d=(t-r*2)/(e.length-1),c=e.map((f,w)=>{const $=r+w*d,y=r+(a-r*2)*(1-(f-i)/n);return[$,y]}),u=c.map(([f,w],$)=>`${$===0?"M":"L"}${f.toFixed(1)} ${w.toFixed(1)}`).join(" "),m=`${u} L${c[c.length-1][0].toFixed(1)} ${a} L${c[0][0].toFixed(1)} ${a} Z`,v=this.trend==="down"?"var(--lumo-error-color, #e11d48)":this.trend==="flat"?"var(--lumo-secondary-text-color, #888)":"var(--lumo-success-color, #12b76a)";return X`
    ...
    `;kt([p()],We.prototype,"label",2);kt([p()],We.prototype,"value",2);kt([p()],We.prototype,"unit",2);kt([p()],We.prototype,"delta",2);kt([p()],We.prototype,"trend",2);kt([p({type:Array})],We.prototype,"spark",2);kt([p()],We.prototype,"actionId",2);We=kt([k("mateu-stat")],We);const Dl=e=>{const t=e.metadata;return o`
        <mateu-stat
                label="${t.label??l}"
                value="${t.value??l}"
                unit="${t.unit??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-stat>
    `};var Al=Object.defineProperty,Fl=Object.getOwnPropertyDescriptor,Hr=(e,t,a,r)=>{for(var i=r>1?void 0:r?Fl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Al(t,a,i),i};let Ia=class extends C{constructor(){super(...arguments),this.events=[]}clickEvent(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedEvent:e}},bubbles:!0,composed:!0}))}render(){const e=this.month?new Date(this.month+"T00:00:00"):new Date,t=e.getFullYear(),a=e.getMonth(),r=new Date(t,a,1),i=(r.getDay()+6)%7,s=new Date(t,a+1,0).getDate(),n=new Date,d=f=>n.getFullYear()===t&&n.getMonth()===a&&n.getDate()===f,c={};for(const f of this.events){if(!f.date)continue;const w=new Date(f.date+"T00:00:00");w.getFullYear()===t&&w.getMonth()===a&&(c[w.getDate()]??=[]).push(f)}const u=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],m=[];for(let f=0;f<i;f++)m.push(o`<div class="cell blank"></div>`);for(let f=1;f<=s;f++)m.push(o`
    ...
    `;Hr([p()],Ia.prototype,"month",2);Hr([p({type:Array})],Ia.prototype,"events",2);Ia=Hr([k("mateu-calendar")],Ia);const ql=e=>{const t=e.metadata;return o`
        <mateu-calendar
                month="${t.month??l}"
                .events="${t.events??[]}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-calendar>
    `};var Ml=Object.defineProperty,Nl=Object.getOwnPropertyDescriptor,as=(e,t,a,r)=>{for(var i=r>1?void 0:r?Nl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Ml(t,a,i),i};let Ga=class extends C{constructor(){super(...arguments),this.plans=[]}cta(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){return o`
            <div class="plans">
                ${this.plans.map(e=>o`
    ...
    `;as([p({type:Array})],Ga.prototype,"plans",2);Ga=as([k("mateu-pricing-table")],Ga);const Ul=e=>{const t=e.metadata;return o`
        <mateu-pricing-table
                .plans="${t.plans??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-pricing-table>
    `};var jl=Object.defineProperty,Bl=Object.getOwnPropertyDescriptor,rs=(e,t,a,r)=>{for(var i=r>1?void 0:r?Bl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&jl(t,a,i),i};let Ka=class extends C{clickNode(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedNode:e}},bubbles:!0,composed:!0}))}renderNode(e){const t=e.avatar,a=t&&(t.startsWith("http")||t.startsWith("data:"));return o`
            <li>
        ...
        `}render(){return this.root?o`<div class="tree"><ul>${this.renderNode(this.root)}</ul></div>`:o``}};Ka.styles=x`
        :host {
            display: block;
            width: 100%;
            overflow-x: auto;
    ...
    `;rs([p({attribute:!1})],Ka.prototype,"root",2);Ka=rs([k("mateu-org-chart")],Ka);const Vl=e=>{const t=e.metadata;return o`
        <mateu-org-chart
                .root="${t.root}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-org-chart>
    `};var Hl=Object.defineProperty,Wl=Object.getOwnPropertyDescriptor,is=(e,t,a,r)=>{for(var i=r>1?void 0:r?Wl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Hl(t,a,i),i};const Gl=1440*60*1e3;let Ya=class extends C{constructor(){super(...arguments),this.cells=[]}color(e,t){if(e<=0||t<=0)return"var(--lumo-contrast-10pct, #ebedf0)";const a=e/t,r=a>.75?1:a>.5?.75:a>.25?.5:.3;return`color-mix(in srgb, var(--lumo-primary-color, #1a73e8) ${Math.round(r*100)}%, transparent)`}render(){const e=this.cells.filter(c=>!!c.date);if(!e.length)return o``;const t=e.map(c=>new Date(c.date+"T00:00:00").getTime()),a=Math.min(...t),r=Math.max(...t),i=new Date(a);i.setDate(i.getDate()-(i.getDay()+6)%7);const s={};for(const c of e)s[c.date]=c;const n=Math.max(...e.map(c=>c.value??0),1),d=[];for(let c=i.getTime();c<=r;c+=Gl){const u=new Date(c),m=u.toISOString().slice(0,10),v=s[m],f=v?.value??0,w=(u.getDay()+6)%7+1,$=v?.label??`${m}: ${f}`;d.push(o`
    ...
    `;is([p({type:Array})],Ya.prototype,"cells",2);Ya=is([k("mateu-heatmap")],Ya);const Kl=e=>{const t=e.metadata;return o`
        <mateu-heatmap
                .cells="${t.cells??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-heatmap>
    `};var Yl=Object.defineProperty,Jl=Object.getOwnPropertyDescriptor,ss=(e,t,a,r)=>{for(var i=r>1?void 0:r?Jl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Yl(t,a,i),i};let Ja=class extends C{constructor(){super(...arguments),this.stages=[]}render(){const e=this.stages;if(!e.length)return o``;const t=e[0].value??0,a=Math.max(...e.map(r=>r.value??0),1);return o`
            <div class="funnel">
    ...
    `;ss([p({type:Array})],Ja.prototype,"stages",2);Ja=ss([k("mateu-funnel")],Ja);const Xl=e=>{const t=e.metadata;return o`
        <mateu-funnel
                .stages="${t.stages??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-funnel>
    `};var Ql=Object.defineProperty,Zl=Object.getOwnPropertyDescriptor,ca=(e,t,a,r)=>{for(var i=r>1?void 0:r?Zl(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Ql(t,a,i),i};let mt=class extends C{constructor(){super(...arguments),this.values=[],this.labels=[],this.area=!1}render(){const e=this.values;if(!e||e.length<2)return o``;const t=600,a=160,r=8,i=Math.min(...e),s=Math.max(...e),n=s-i||1,d=(t-r*2)/(e.length-1),c=e.map(($,y)=>{const S=r+y*d,H=r+(a-r*2)*(1-($-i)/n);return[S,H]}),u=c.map(([$,y],S)=>`${S===0?"M":"L"}${$.toFixed(1)} ${y.toFixed(1)}`).join(" "),m=`${u} L${c[c.length-1][0].toFixed(1)} ${a-r} L${c[0][0].toFixed(1)} ${a-r} Z`,v=this.color||"var(--lumo-primary-color, #1a73e8)",f=e.indexOf(s),w=e.indexOf(i);return o`
            ...
            <svg viewBox="0 0 ${t} ${a}" preserveAspectRatio="none">
                ...
                ${c.map(($,y)=>y===f||y===w?X`<circle cx="${$[0]}" cy="${$[1]}" r="3.2" fill="${v}"><title>${this.labels[y]??""}: ${e[y]}</title></circle>`:X`<circle cx="${$[0]}" cy="${$[1]}" r="6" fill="transparent"><title>${this.labels[y]??""}: ${e[y]}</title></circle>`)}
            </svg>
    ...
    `;ca([p()],mt.prototype,"heading",2);ca([p({type:Array})],mt.prototype,"values",2);ca([p({type:Array})],mt.prototype,"labels",2);ca([p()],mt.prototype,"color",2);ca([p({type:Boolean})],mt.prototype,"area",2);mt=ca([k("mateu-trend-chart")],mt);const ed=e=>{const t=e.metadata;return o`
        <mateu-trend-chart
                heading="${t.title??l}"
                color="${t.color??l}"
                ?area="${t.area??!1}"
                ...
                slot="${e.slot??l}"
        ></mateu-trend-chart>
    `};var td=Object.defineProperty,ad=Object.getOwnPropertyDescriptor,Wr=(e,t,a,r)=>{for(var i=r>1?void 0:r?ad(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&td(t,a,i),i};let Sa=class extends C{constructor(){super(...arguments),this.features=[],this.columns=0}clickFeature(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){const e=this.columns&&this.columns>0?`repeat(${this.columns}, minmax(0, 1fr))`:"repeat(auto-fit, minmax(15rem, 1fr))";return o`
    ...
    `;Wr([p({type:Array})],Sa.prototype,"features",2);Wr([p({type:Number})],Sa.prototype,"columns",2);Sa=Wr([k("mateu-feature-grid")],Sa);const rd=e=>{const t=e.metadata;return o`
        <mateu-feature-grid
                .features="${t.features??[]}"
                .columns="${t.columns??0}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-feature-grid>
    `};var id=Object.defineProperty,sd=Object.getOwnPropertyDescriptor,os=(e,t,a,r)=>{for(var i=r>1?void 0:r?sd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&id(t,a,i),i};let Xa=class extends C{constructor(){super(...arguments),this.items=[]}stars(e){const t=Math.max(0,Math.min(5,e||0));return"★".repeat(t)+"☆".repeat(5-t)}render(){return o`
            <div class="grid">
    ...
    `;os([p({type:Array})],Xa.prototype,"items",2);Xa=os([k("mateu-testimonials")],Xa);const od=e=>{const t=e.metadata;return o`
        <mateu-testimonials
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-testimonials>
    `};var nd=Object.defineProperty,ld=Object.getOwnPropertyDescriptor,Gr=(e,t,a,r)=>{for(var i=r>1?void 0:r?ld(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&nd(t,a,i),i};let Ea=class extends C{constructor(){super(...arguments),this.items=[],this.openSet=new Set,this.seeded=!1}seed(){this.seeded||(this.seeded=!0,this.items.forEach((e,t)=>{e.open&&this.openSet.add(t)}))}toggle(e){this.openSet.has(e)?this.openSet.delete(e):this.openSet.add(e),this.requestUpdate()}render(){return this.seed(),o`
            <div class="list">
    ...
    `;Gr([p({type:Array})],Ea.prototype,"items",2);Gr([b()],Ea.prototype,"openSet",2);Ea=Gr([k("mateu-faq")],Ea);const dd=e=>{const t=e.metadata;return o`
        <mateu-faq
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;Jt([p()],it.prototype,"heading",2);Jt([p()],it.prototype,"description",2);Jt([p()],it.prototype,"icon",2);Jt([p()],it.prototype,"ctaLabel",2);Jt([p()],it.prototype,"actionId",2);Jt([p()],it.prototype,"theme",2);it=Jt([k("mateu-callout-card")],it);const pd=e=>{const t=e.metadata;return o`
        <mateu-callout-card
                heading="${t.title??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-callout-card>
    `};var hd=Object.defineProperty,md=Object.getOwnPropertyDescriptor,ns=(e,t,a,r)=>{for(var i=r>1?void 0:r?md(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&hd(t,a,i),i};let Qa=class extends C{constructor(){super(...arguments),this.comments=[]}renderComment(e){const t=e.avatar&&(e.avatar.startsWith("http")||e.avatar.startsWith("data:"));return o`
            <div class="comment">
        ...
        `}render(){return o`<div class="thread">${this.comments.map(e=>this.renderComment(e))}</div>`}};Qa.styles=x`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
    ...
    `;ns([p({type:Array})],Qa.prototype,"comments",2);Qa=ns([k("mateu-comment-thread")],Qa);const vd=e=>{const t=e.metadata;return o`
        <mateu-comment-thread
                ...
                slot="${e.slot??l}"
        ></mateu-comment-thread>
    `};var fd=Object.defineProperty,bd=Object.getOwnPropertyDescriptor,ls=(e,t,a,r)=>{for(var i=r>1?void 0:r?bd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&fd(t,a,i),i};const gd={pdf:"📕",image:"🖼️",img:"🖼️",doc:"📘",docx:"📘",word:"📘",xls:"📗",xlsx:"📗",excel:"📗",sheet:"📗",zip:"🗜️",archive:"🗜️",video:"🎬",audio:"🎵",code:"💻",csv:"📄",txt:"📄"};let Za=class extends C{constructor(){super(...arguments),this.files=[]}icon(e){return e&&gd[e.toLowerCase()]||"📄"}clickFile(e,t){e.url||e.actionId&&(t.preventDefault(),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_file:e}},bubbles:!0,composed:!0})))}render(){return o`
            <div class="list">
    ...
    `;ls([p({type:Array})],Za.prototype,"files",2);Za=ls([k("mateu-file-list")],Za);const yd=e=>{const t=e.metadata;return o`
        <mateu-file-list
                .files="${t.files??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-file-list>
    `};var $d=Object.defineProperty,xd=Object.getOwnPropertyDescriptor,ur=(e,t,a,r)=>{for(var i=r>1?void 0:r?xd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&$d(t,a,i),i};let ia=class extends C{constructor(){super(...arguments),this.items=[],this.localDone=new Map}isDone(e,t){return this.localDone.has(t)?!!this.localDone.get(t):!!e.done}toggle(e,t){const a=!this.isDone(e,t);this.localDone.set(t,a),this.requestUpdate(),e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_item:e,_done:a}},bubbles:!0,composed:!0}))}render(){const e=this.items.length,t=this.items.filter((r,i)=>this.isDone(r,i)).length,a=e>0?Math.round(t/e*100):0;return o`
            <div class="head">
    ...
    `;ur([p()],ia.prototype,"heading",2);ur([p({type:Array})],ia.prototype,"items",2);ur([b()],ia.prototype,"localDone",2);ia=ur([k("mateu-checklist")],ia);const wd=e=>{const t=e.metadata;return o`
        <mateu-checklist
                heading="${t.title??l}"
                .items="${t.items??[]}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-checklist>
    `};var kd=Object.defineProperty,Cd=Object.getOwnPropertyDescriptor,Ct=(e,t,a,r)=>{for(var i=r>1?void 0:r?Cd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&kd(t,a,i),i};let Ge=class extends C{render(){const e=this.trend??"flat";return o`
            <div class="card">
                ${this.heading?o`<div class="title">${this.heading}</div>`:l}
                <div class="row">
                    <div class="side">
        ...
        @media (prefers-color-scheme: dark) { .card { background: var(--lumo-contrast-5pct, #2a2a2a); } }
    `;Ct([p()],Ge.prototype,"heading",2);Ct([p()],Ge.prototype,"leftLabel",2);Ct([p()],Ge.prototype,"leftValue",2);Ct([p()],Ge.prototype,"rightLabel",2);Ct([p()],Ge.prototype,"rightValue",2);Ct([p()],Ge.prototype,"delta",2);Ct([p()],Ge.prototype,"trend",2);Ge=Ct([k("mateu-comparison-card")],Ge);const _d=e=>{const t=e.metadata;return o`
...
`,Id=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}),Rr=e=>Id.format(e),er=(e,t)=>{const a=e<0?"-":"",r=Rr(Math.abs(e));return t?`${a}${t} ${r}`:`${a}${r}`},Sd=(e,t)=>t?`${Rr(e)} ${t}`:Rr(e);var Ed=Object.defineProperty,Pd=Object.getOwnPropertyDescriptor,_t=(e,t,a,r)=>{for(var i=r>1?void 0:r?Pd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Ed(t,a,i),i};let Ke=class extends C{constructor(){super(...arguments),this.title="",this.badges=[],this.facts=[]}render(){const e=!!(this.metricLabel||this.metricValue||this.metricCaption);return o`
            <div class="card">
                <div class="main">
                    <div class="title-row">
    ...
    `];_t([p()],Ke.prototype,"title",2);_t([p({type:Array})],Ke.prototype,"badges",2);_t([p()],Ke.prototype,"subtitle",2);_t([p({type:Array})],Ke.prototype,"facts",2);_t([p()],Ke.prototype,"metricLabel",2);_t([p()],Ke.prototype,"metricValue",2);_t([p()],Ke.prototype,"metricCaption",2);Ke=_t([k("mateu-entity-header")],Ke);const Td=e=>{const t=e.metadata;return o`
        <mateu-entity-header
                .title="${t.title??""}"
                .badges="${t.badges??[]}"
                .subtitle="${t.subtitle}"
                ...
                slot="${e.slot??l}"
        ></mateu-entity-header>
    `};var Od=Object.defineProperty,zd=Object.getOwnPropertyDescriptor,It=(e,t,a,r)=>{for(var i=r>1?void 0:r?zd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Od(t,a,i),i};let Ye=class extends C{constructor(){super(...arguments),this.value=0,this.max=0}fillColor(){return this.dangerAt!=null&&this.value>=this.dangerAt?"error":this.warnAt!=null&&this.value>=this.warnAt?"warning":this.warnAt!=null||this.dangerAt!=null?"success":"primary"}render(){const e=this.max>0?Math.min(Math.max(this.value/this.max,0),1):0,t=Math.round(e*100);return o`
            <div class="meter">
                ${this.label?o`<span class="label">${this.label}</span>`:l}
                <span class="value">${Sd(this.value,this.unit)}</span>
                <div class="track">
    ...
    `;It([p()],Ye.prototype,"label",2);It([p({type:Number})],Ye.prototype,"value",2);It([p({type:Number})],Ye.prototype,"max",2);It([p()],Ye.prototype,"unit",2);It([p()],Ye.prototype,"caption",2);It([p({type:Number})],Ye.prototype,"warnAt",2);It([p({type:Number})],Ye.prototype,"dangerAt",2);Ye=It([k("mateu-meter")],Ye);const Rd=e=>{const t=e.metadata;return o`
        <mateu-meter
                .label="${t.label}"
                .value="${t.value??0}"
                .max="${t.max??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-meter>
    `};var Ld=Object.defineProperty,Dd=Object.getOwnPropertyDescriptor,ua=(e,t,a,r)=>{for(var i=r>1?void 0:r?Dd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Ld(t,a,i),i};let vt=class extends C{constructor(){super(...arguments),this.total=0,this.done=0}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){const e=this.total>0&&this.done>=this.total,t=!e&&!!this.actionLabel&&!!this.actionId;return o`
    ...
    `;ua([p()],vt.prototype,"label",2);ua([p({type:Number})],vt.prototype,"total",2);ua([p({type:Number})],vt.prototype,"done",2);ua([p()],vt.prototype,"actionLabel",2);ua([p()],vt.prototype,"actionId",2);vt=ua([k("mateu-task-progress")],vt);const Ad=e=>{const t=e.metadata;return o`
        <mateu-task-progress
                .label="${t.label}"
                .total="${t.total??0}"
                .done="${t.done??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-task-progress>
    `};var Fd=Object.defineProperty,qd=Object.getOwnPropertyDescriptor,Ra=(e,t,a,r)=>{for(var i=r>1?void 0:r?qd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Fd(t,a,i),i};let Mt=class extends C{constructor(){super(...arguments),this.items=[],this.compact=!1,this.frameless=!1}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}rowClicked(e){this.rowActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.rowActionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}render(){return o`
    ...
    `];Ra([p({type:Array})],Mt.prototype,"items",2);Ra([p({type:Boolean})],Mt.prototype,"compact",2);Ra([p({type:Boolean})],Mt.prototype,"frameless",2);Ra([p()],Mt.prototype,"rowActionId",2);Mt=Ra([k("mateu-status-list")],Mt);const Md=e=>{const t=e.metadata;return o`
        <mateu-status-list
                .items="${t.items??[]}"
                ?compact="${t.compact??!1}"
                ...
                slot="${e.slot??l}"
        ></mateu-status-list>
    `};var Nd=Object.defineProperty,Ud=Object.getOwnPropertyDescriptor,ds=(e,t,a,r)=>{for(var i=r>1?void 0:r?Ud(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Nd(t,a,i),i};let tr=class extends C{constructor(){super(...arguments),this.items=[]}render(){return o`
            <ul>
    ...
    `;ds([p({type:Array})],tr.prototype,"items",2);tr=ds([k("mateu-bulleted-list")],tr);const jd=e=>{const t=e.metadata;return o`
        <mateu-bulleted-list
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-bulleted-list>
    `},Bd=e=>{const a=e.metadata.attributes?.["data-colspan"];return o`
    ...
    `;Se([p()],oe.prototype,"text",2);Se([p()],oe.prototype,"theme",2);Se([p()],oe.prototype,"icon",2);Se([p({type:Boolean})],oe.prototype,"noIcon",2);Se([p()],oe.prototype,"actionLabel",2);Se([p()],oe.prototype,"actionId",2);Se([p()],oe.prototype,"status",2);Se([p({type:Boolean})],oe.prototype,"slim",2);Se([p({type:Boolean})],oe.prototype,"fullWidth",2);Se([p({type:Boolean})],oe.prototype,"hasContent",2);Se([p({type:Boolean})],oe.prototype,"inlineContent",2);oe=Se([k("mateu-notice")],oe);const Gd=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=wa(d.text??"",r,i,s,n)??"",u=t.children??[];return o`
        <mateu-notice
                text="${c}"
                theme="${d.theme??"info"}"
    ...
    `};var Kd=Object.defineProperty,Yd=Object.getOwnPropertyDescriptor,hr=(e,t,a,r)=>{for(var i=r>1?void 0:r?Yd(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Kd(t,a,i),i};let sa=class extends C{constructor(){super(...arguments),this.groups=[]}willUpdate(e){e.has("groups")&&(this.selectedId=this.groups.flatMap(t=>t.items??[]).find(t=>t.selected)?.id)}select(e){this.selectedId=e,this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{_item:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="rail">
                ${this.groups.map(e=>o`
                    <div class="group">
    ...
    `];hr([p()],sa.prototype,"actionId",2);hr([p({type:Array})],sa.prototype,"groups",2);hr([b()],sa.prototype,"selectedId",2);sa=hr([k("mateu-task-queue")],sa);const Jd=e=>{const t=e.metadata;return o`
        <mateu-task-queue
                .actionId="${t.actionId}"
                .groups="${t.groups??[]}"
                style="${e.style??l}"
    ...
    `];pa([p()],ft.prototype,"actionId",2);pa([p({type:Number})],ft.prototype,"columns",2);pa([p()],ft.prototype,"recommendedLabel",2);pa([p({type:Array})],ft.prototype,"items",2);pa([b()],ft.prototype,"selectedId",2);ft=pa([k("mateu-resource-grid")],ft);const Zd=e=>{const t=e.metadata;return o`
        <mateu-resource-grid
                .actionId="${t.actionId}"
                .columns="${t.columns??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-resource-grid>
    `};var ec=Object.defineProperty,tc=Object.getOwnPropertyDescriptor,ve=(e,t,a,r)=>{for(var i=r>1?void 0:r?tc(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&ec(t,a,i),i};let Q=class extends C{constructor(){super(...arguments),this.title="",this.features=[],this.current=!1,this.added=!1}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return o`
                ...
                ${this.items.map(e=>{const t=e.id!=null&&this.added.has(e.id);return o`
                        <div class="card ${t?"added":""}">
                            ...
                            ${e.includedLabel?o`<span class="included">${e.includedLabel}</span>`:o`
                                    ${e.price!=null?o`
                                        <span class="price">${er(e.price,this.currency)}${e.unit?` / ${e.unit}`:""}</span>
                                    `:l}
    ...
    `;ha([p()],bt.prototype,"totalLabel",2);ha([p()],bt.prototype,"currency",2);ha([p()],bt.prototype,"actionId",2);ha([p({type:Array})],bt.prototype,"items",2);ha([b()],bt.prototype,"added",2);bt=ha([k("mateu-addon-picker")],bt);const sc=e=>{const t=e.metadata;return o`
        <mateu-addon-picker
                ...
                slot="${e.slot??l}"
        ></mateu-addon-picker>
    `};var oc=Object.defineProperty,nc=Object.getOwnPropertyDescriptor,La=(e,t,a,r)=>{for(var i=r>1?void 0:r?nc(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&oc(t,a,i),i};let Nt=class extends C{constructor(){super(...arguments),this.lines=[]}computedTotal(){return this.total!=null?this.total:this.lines.filter(e=>!e.included).reduce((e,t)=>e+(t.amount??0),0)}render(){return o`
            ${this.lines.map(e=>o`
                <div class="row">
                    <span class="dot"></span>
                    <span class="concept">${e.concept}</span>
                    ${e.included?o`<span class="included-label">${e.includedLabel||"Included"}</span>`:o`<span class="amount ${(e.amount??0)<0?"negative":""}">${er(e.amount??0,this.currency)}</span>`}
                </div>
            `)}
            <div class="total-row">
                <span class="total-label">${this.totalLabel||"Total"}</span>
                <span class="total">${er(this.computedTotal(),this.currency)}</span>
            </div>
        `}};Nt.styles=x`
        :host {
    ...
    `;La([p()],Nt.prototype,"currency",2);La([p()],Nt.prototype,"totalLabel",2);La([p({type:Array})],Nt.prototype,"lines",2);La([p({type:Number})],Nt.prototype,"total",2);Nt=La([k("mateu-ledger")],Nt);const lc=e=>{const t=e.metadata;return o`
        <mateu-ledger
                .currency="${t.currency}"
                .totalLabel="${t.totalLabel}"
                .lines="${t.lines??[]}"
    ...
    `;nt([p()],Le.prototype,"actionId",2);nt([p()],Le.prototype,"methodActionId",2);nt([p({type:Array})],Le.prototype,"methods",2);nt([p()],Le.prototype,"selected",2);nt([p()],Le.prototype,"contextLabel",2);nt([p()],Le.prototype,"contextValue",2);nt([p()],Le.prototype,"confirmLabel",2);nt([b()],Le.prototype,"selectedId",2);Le=nt([k("mateu-payment-picker")],Le);const uc=e=>{const t=e.metadata;return o`
        <mateu-payment-picker
                ...
                slot="${e.slot??l}"
        ></mateu-payment-picker>
    `};var pc=Object.defineProperty,hc=Object.getOwnPropertyDescriptor,cs=(e,t,a,r)=>{for(var i=r>1?void 0:r?hc(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&pc(t,a,i),i};let ar=class extends C{constructor(){super(...arguments),this.items=[]}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="list">
                ${this.items.map(e=>o`
                    <div class="row">
    ...
    `;cs([p({type:Array})],ar.prototype,"items",2);ar=cs([k("mateu-process-monitor")],ar);const mc=e=>{const t=e.metadata;return o`
        <mateu-process-monitor
                ...
                slot="${e.slot??l}"
        ></mateu-process-monitor>
    `},vc=(e,t)=>{let a=e.style;return e.id&&(a&&!a.endsWith(";")&&(a+=";"),a==null&&(a=""),t[e.id+".hidden"]==!0&&(a+="display: none;")),a},fc=(e,t)=>{let a={...e.metadata};if(e.id&&a){if(a.type==h.Button){const r=a;t[e.id+".disabled"]==!0&&(r.disabled=!0)}if(a.type==h.FormField){const r=a;t[e.id+".disabled"]==!0&&(r.disabled=!0)}}return a},O=e=>t=>e(t.container,t.component,t.baseUrl,t.state,t.data,t.appState,t.appData),bc={[h.Bpmn]:({component:e})=>rl(e),[h.Workflow]:({component:e})=>sl(e),[h.FormEditor]:({component:e})=>ol(e),[h.Page]:O(Or),[h.Div]:O(Qn),[h.Directory]:({component:e,baseUrl:t,state:a,data:r})=>Xn(e),[h.FormLayout]:O(Xo),[h.HorizontalLayout]:O(tn),[h.VerticalLayout]:O(an),[h.SplitLayout]:O(rn),[h.MasterDetailLayout]:O(sn),[h.TabLayout]:O(on),[h.AccordionLayout]:O(nn),[h.BoardLayout]:O(pn),[h.BoardLayoutRow]:O(hn),[h.BoardLayoutItem]:O(mn),[h.Scroller]:O(dn),[h.FullWidth]:O(cn),[h.Container]:O(un),[h.Form]:({container:e,component:t,baseUrl:a,state:r,data:i,appState:s,appData:n})=>{const d=t.metadata;return o`<mateu-form
            id="${t.id}"
        baseUrl="${a}"
            .component="${t}"
            .values="${r}"
...
`)}
            ...
            </mateu-form>`},[h.Table]:({component:e,state:t,data:a})=>Tr(e,(e.id?a?.[e.id]:void 0)?.page?.content??ii(e,t)),[h.Crud]:O(zr),[h.App]:({container:e,component:t,baseUrl:a,state:r,data:i,appState:s,appData:n})=>o`
            <mateu-app
                        id="${t.id}"
                        baseUrl="${a}"
                        .component="${t}"
            ...
            >
             ${t.children?.map(d=>g(e,d,a,r,i,s,n))}
         </mateu-app>`,[h.Element]:({container:e,component:t})=>_n(e,t.metadata,t),[h.FormField]:({component:e,state:t})=>al(e,t),[h.Text]:({component:e,state:t,data:a,appState:r,appData:i})=>In(e,t,a,r,i),[h.Avatar]:({component:e,state:t,data:a})=>Co(e,t,a),[h.Chat]:({component:e,state:t,data:a})=>il(e),[h.AvatarGroup]:({component:e})=>_o(e),[h.Badge]:({component:e,state:t,data:a})=>Io(e,t,a),[h.Breadcrumbs]:({component:e})=>Yn(e),[h.Anchor]:({component:e})=>Sn(e),[h.Button]:({component:e,state:t,data:a})=>On(e,t,a),[h.Card]:O(Rn),[h.Chart]:({component:e})=>Ln(e),[h.Icon]:({component:e})=>Dn(e),[h.ConfirmDialog]:O(Fn),[h.ContextMenu]:O(yn),[h.CookieConsent]:({component:e})=>qn(e),[h.Details]:O(Mn),[h.Dialog]:({component:e,baseUrl:t,state:a,data:r,appState:i,appData:s})=>Nn(e,t,a,r,i,s),[h.Drawer]:({component:e,baseUrl:t,state:a,data:r,appState:i,appData:s})=>Un(e,t,a,r,i,s),[h.Image]:({component:e})=>Kn(e),[h.Map]:({component:e})=>Gn(e),[h.Markdown]:({component:e})=>Bn(e),[h.MicroFrontend]:({component:e})=>jn(e),[h.Notification]:({component:e})=>Vn(e),[h.ProgressBar]:({component:e,state:t})=>Hn(e,t),[h.Popover]:O(Wn),[h.CarouselLayout]:O(Jn),[h.Tooltip]:O(wn),[h.MessageInput]:({component:e})=>xn(e),[h.MessageList]:({component:e})=>bn(e),[h.CustomField]:O($n),[h.MenuBar]:({container:e,component:t,baseUrl:a,state:r,data:i})=>gn(e,t,a,r,i),[h.Grid]:({component:e,state:t})=>Tr(e,ii(e,t)),[h.VirtualList]:O(vn),[h.FormSection]:O(Zn),[h.FormSubSection]:O(el),[h.MetricCard]:({component:e})=>cl(e),[h.Scoreboard]:O(ul),[h.DashboardPanel]:O(pl),[h.DashboardLayout]:O(hl),[h.FoldoutLayout]:O(fl),[h.HeroSection]:O(bl),[h.EmptyState]:({component:e})=>Fo(e),[h.Skeleton]:({component:e})=>qo(e),[h.Gantt]:({component:e})=>$l(e),[h.PlanningBoard]:({component:e})=>kl(e),[h.Kanban]:({component:e})=>Il(e),[h.Timeline]:({component:e})=>Pl(e),[h.ProgressSteps]:({component:e})=>zl(e),[h.Stat]:({component:e})=>Dl(e),[h.Calendar]:({component:e})=>ql(e),[h.PricingTable]:({component:e})=>Ul(e),[h.OrgChart]:({component:e})=>Vl(e),[h.Heatmap]:({component:e})=>Kl(e),[h.Funnel]:({component:e})=>Xl(e),[h.TrendChart]:({component:e})=>ed(e),[h.FeatureGrid]:({component:e})=>rd(e),[h.Testimonials]:({component:e})=>od(e),[h.Faq]:({component:e})=>dd(e),[h.CalloutCard]:({component:e})=>pd(e),[h.CommentThread]:({component:e})=>vd(e),[h.FileList]:({component:e})=>yd(e),[h.Checklist]:({component:e})=>wd(e),[h.ComparisonCard]:({component:e})=>_d(e),[h.EntityHeader]:({component:e})=>Td(e),[h.Meter]:({component:e})=>Rd(e),[h.TaskProgress]:({component:e})=>Ad(e),[h.StatusList]:({component:e})=>Md(e),[h.BulletedList]:({component:e})=>jd(e),[h.Separator]:({component:e})=>Bd(e),[h.Notice]:O(Gd),[h.TaskQueue]:({component:e})=>Jd(e),[h.ResourceGrid]:({component:e})=>Zd(e),[h.OfferCard]:({component:e})=>ac(e),[h.AddOnPicker]:({component:e})=>sc(e),[h.Ledger]:({component:e})=>lc(e),[h.PaymentPicker]:({component:e})=>uc(e),[h.ProcessMonitor]:({component:e})=>mc(e)},Kr=(e,t,a,r,i,s,n,d)=>{if(!t?.metadata)return t==null?(console.warn("No metadata for component",t),o`<p>No metadata for component</p>`):Kr(e,{id:$e(),metadata:t,type:W.ClientSide},a,r,i,s,n,d);const c=t.metadata.type,u={...t,style:vc(t,i),metadata:fc(t,i)},m=bc[c];return m?m({container:e,component:u,baseUrl:a,state:r,data:i,appState:s,appData:n,labelAlreadyRendered:d}):o`<p ${u?.slot??l}>Unknown metadata type ${c} for component ${u?.id}</p>`};var ya=(e=>(e.NONE="NONE",e.INFO="INFO",e.SUCCESS="SUCCESS",e.WARNING="WARNING",e.DANGER="DANGER",e))(ya||{});const gc=(e,t,a)=>{const r=e[a.path];return r?o`<span theme="badge pill ${mr(r.type)}">${r.message}</span>`:o``},mr=e=>{switch(e){case ya.SUCCESS:return"success";case ya.WARNING:return"warning";case ya.DANGER:return"error";case ya.NONE:return"contrast"}return""};var yc=Object.defineProperty,$c=Object.getOwnPropertyDescriptor,Ee=(e,t,a,r)=>{for(var i=r>1?void 0:r?$c(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&yc(t,a,i),i};let ne=class extends C{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.respondToVisibility=(e,t)=>{var a={root:document.documentElement},r=new IntersectionObserver(i=>{i.forEach(s=>{t(s.intersectionRatio>0)})},a);r.observe(e)},this.keepAsking=!1,this.askToUpper=()=>{const e=this.data[this.id]?.page,t=e?.content?.length/e?.pageSize;this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:{page:t,pageSize:this.metadata?.pageSize},callback:()=>{this.keepAsking&&this.askToUpper()}},bubbles:!0,composed:!0}))},this.renderItem=e=>e.card?Kr(this,e.card,this.baseUrl,this.state,this.data,this.appState,this.appData,!1):e.title?o`<div class="neutral-card">
                ${e.image?o`<img class="card-media" src="${e.image}" alt="" />`:l}
                <div class="card-body">
                    <div class="card-head">
                        ${e.title?o`<span class="card-title">${e.title}</span>`:l}
                        ${e.status?o`<span theme="badge ${mr(e.status.type)}">${e.status.message}</span>`:l}
                    </div>
    ...
    `;Ee([p()],ne.prototype,"id",2);Ee([p()],ne.prototype,"metadata",2);Ee([p()],ne.prototype,"baseUrl",2);Ee([p()],ne.prototype,"state",2);Ee([p()],ne.prototype,"data",2);Ee([p()],ne.prototype,"appState",2);Ee([p()],ne.prototype,"appData",2);Ee([p()],ne.prototype,"emptyStateMessage",2);Ee([b()],ne.prototype,"keepAsking",2);Ee([_e("#ask-for-more")],ne.prototype,"askForMore",2);Ee([b()],ne.prototype,"hasMore",2);ne=Ee([k("mateu-card-list")],ne);const xc={show:e=>console.debug("[mateu] no notifier registered, dropping toast:",e.text)};let us=xc;function ps(e){us=e}function Ut(e,t){us.show(e,t)}var hs=(e=>(e.none="none",e.success="success",e.error="error",e.warning="warning",e.contrast="contrast",e.normal="normal",e))(hs||{}),ms=(e=>(e.primary="primary",e.secondary="secondary",e.tertiary="tertiary",e.tertiaryInline="tertiaryInline",e))(ms||{});const wc=76;function ni(e){if(e.weight!=null)return e.weight;const t=e.stereotype??"";if(t==="icon")return 1;if(t==="image")return 4;if(t==="html"||t==="richText"||t==="markdown"||t==="textarea")return 5;if(t==="link")return 2.5;if(t==="combobox"||t==="select")return 2;const a=e.dataType??"";return a==="bool"?1:a==="status"||a==="integer"?1.5:a==="number"||a==="date"||a==="money"?2:a==="dateTime"||a==="dateRange"?2.5:3}function kc(e,t){if(e.length===0)return"table";const a=e.reduce((c,u)=>c+ni(u),0),r=t/wc,i=a/r;if(e.length>10)return"masterDetail";if(i<=1.7)return"table";const s=e.filter(c=>c.identifier||(c.priority??Number.MAX_SAFE_INTEGER)<=2),n=s.reduce((c,u)=>c+ni(u),0);return i>2.4?"masterDetail":s.length>0&&n<=8?"list":e.some(c=>c.stereotype==="image"||c.stereotype==="html")||s.length===0&&e.length>=4&&e.length<=8?"cards":"masterDetail"}function vs(e){return e.filter(t=>t.identifier||(t.priority??Number.MAX_SAFE_INTEGER)<=2).sort((t,a)=>(t.priority??Number.MAX_SAFE_INTEGER)-(a.priority??Number.MAX_SAFE_INTEGER))}function Cc(e){const t=vs(e);return t.length>0?t:e.slice(0,3)}var _c=Object.defineProperty,Ic=Object.getOwnPropertyDescriptor,Pe=(e,t,a,r)=>{for(var i=r>1?void 0:r?Ic(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&_c(t,a,i),i};const Sc={asc:"ascending",desc:"descending"};let le=class extends C{constructor(){super(...arguments),this.component=void 0,this.standalone=!1,this.state={},this.data={},this.appState={},this.appData={},this.showImportDialog=!1,this.availableWidthPx=1024,this.selectedItem=null,this._columnPrefsRevision=0,this._prefsRevisionApplied=-1,this.search=()=>{const e=this.component.metadata;this.state={...this.state,size:e.pageSize,page:0,crud_selected_items:[]},this._syncStateToUrl(e),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}}},bubbles:!0,composed:!0}))},this.notify=e=>{Ut({text:e,position:"bottomEnd",variant:"error",duration:3e3},this)},this.handleSearchRequested=e=>{this.state={...this.state,crud_selected_items:[]};const t=this.component.metadata;this._syncStateToUrl(t),!t.infiniteScrolling&&this.data?.[this.id]?.page&&(this.data[this.id].page.content=[]),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}},callback:e},bubbles:!0,composed:!0}))},this.fetchMoreElements=e=>{const{params:t,callback:a}=e.detail;this.state={...this.state,size:t.pageSize,page:t.page},this.handleSearchRequested(a)},this.directionChanged=e=>{const t=e.detail.grid._sorters;this.state={...this.state,sort:t.map(a=>({fieldId:a.__data.path,direction:a.__data.direction?Sc[a.__data.direction]:void 0}))},this.handleSearchRequested(void 0)},this._initializedForComponentId=void 0,this.evalLabel=e=>ye(e,this.state,this.data),this.handleToolbarButtonClick=e=>{if(e==="import"){this.showImportDialog=!0;return}this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.handleImportUploadSuccess=e=>{const t=e.detail.xhr.responseText;this.showImportDialog=!1,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"process-import",parameters:{fileId:t}},bubbles:!0,composed:!0}))}}get columnPrefsScope(){return window.location.pathname}get effectiveComponent(){const e=this.component,t=e?.metadata;if(!e||!t?.columns)return e;if(this._prefsSource===e&&this._prefsRevisionApplied===this._columnPrefsRevision)return this._prefsApplied;const a=ji(this.columnPrefsScope),r=Vi(t.columns,a,i=>i.metadata??{});return this._prefsApplied=r===t.columns?e:{...e,metadata:{...t,columns:r}},this._prefsSource=e,this._prefsRevisionApplied=this._columnPrefsRevision,this._prefsApplied}get columnChooserEntries(){return(this.component?.metadata?.columns??[]).map(t=>{const a=t.metadata??{},r=a.id??t.id;return r?{id:r,label:a.label??r,protected:Bi(a)}:void 0}).filter(t=>!!t)}renderColumnChooser(){const e=this.columnChooserEntries;return e.filter(t=>!t.protected).length===0?l:o`
            <mateu-column-chooser
                .columns="${e}"
                .scope="${this.columnPrefsScope}"
                @column-prefs-changed="${t=>{t.stopPropagation(),this._columnPrefsRevision++}}"
            ></mateu-column-chooser>
        `}get cols(){return this.effectiveComponent?.metadata?.columns?.map(t=>t.metadata)??[]}get identifierFieldName(){const e=this.cols.find(t=>t.identifier);return e?e.id:this.cols.find(t=>t.id==="id")?.id}get effectiveGridLayout(){const e=this.component?.metadata,t=e?.gridLayout??"auto";return t==="auto"?e?.crudlType==="card"?"cards":kc(this.cols,this.availableWidthPx):t}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{const t=e[0]?.contentRect.width;t&&Math.abs(t-this.availableWidthPx)>10&&(this.availableWidthPx=t)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}_filterIds(e){return new Set(["searchText",...(e.filters??[]).flatMap(t=>t.stereotype==="dateRange"||t.stereotype==="numberRange"?[`${t.fieldId}_from`,`${t.fieldId}_to`]:[t.fieldId])])}_syncStateToUrl(e){const t=this._filterIds(e),a=new URLSearchParams(window.location.search);t.forEach(d=>a.delete(d)),a.delete("page"),a.delete("sort"),t.forEach(d=>{const c=this.state[d];c!=null&&c!==""&&a.set(d,String(c))});const r=this.state.page;r&&r>0&&a.set("page",String(r));const i=this.state.sort;if(i&&i.length>0){const d=i.filter(c=>c.fieldId&&c.direction).map(c=>`${c.fieldId}:${c.direction}`).join(",");d&&a.set("sort",d)}const s=a.toString(),n=s?`${window.location.pathname}?${s}`:window.location.pathname;window.location.pathname+window.location.search!==n&&history.replaceState(null,"",n)}_initStateFromUrl(e,t){const a=new URLSearchParams(window.location.search),r=this._filterIds(e),i={...t};a.forEach((d,c)=>{r.has(c)&&(i[c]=d)});const s=a.get("page");if(s!==null){const d=parseInt(s,10);!isNaN(d)&&d>0&&(i.page=d)}const n=a.get("sort");if(n){const d=n.split(",").map(c=>{const[u,m]=c.split(":");return u&&m?{fieldId:u,direction:m}:null}).filter(Boolean);d.length>0&&(i.sort=d)}return i}pageChanged(e){this.state={...this.state,page:e.detail.page},this.handleSearchRequested(void 0)}updated(e){if(super.updated(e),e.has("component")){const t=this.component?.id;if(t!==this._initializedForComponentId){this._initializedForComponentId=t;const a=this.component?.metadata,r=a.initialPage&&a.initialPage>0?a.initialPage:0;this.state=this._initStateFromUrl(a,{...this.state,size:a.pageSize,page:r,sort:[]}),(this.state.page!==r||this.state.sort?.length>0||[...this._filterIds(a)].some(s=>this.state[s]!=null))&&this.handleSearchRequested(void 0)}}}render(){const e=_=>{const D=[];return _.color&&_.color!==hs.normal&&D.push(_.color),_.buttonStyle&&D.push(_.buttonStyle===ms.tertiaryInline?"tertiary-inline":_.buttonStyle),D.length?D.join(" "):void 0},t=_=>_==="back"||_==="backToList"||!!_&&_.startsWith("cancel"),a=_=>{const D=B.get()?.renderToolbarButton?.(_,this.evalLabel(_.label),()=>this.handleToolbarButtonClick(_.actionId));return D||o`
                <button class="crud-btn"
                        data-action-id="${_.id}"
                        theme="${e(_)||l}"
                        @click="${()=>this.handleToolbarButtonClick(_.actionId)}"
                >${this.evalLabel(_.label)}</button>
            `};if(!this.component)return o`no component`;const r=this.effectiveComponent,i=r.metadata;i.serverSideOrdering=!0;const s=i?.toolbar??[],n=s.filter(_=>t(_.actionId)),d=s.filter(_=>!t(_.actionId)),c=n.length>0&&d.length>0,u=!!i?.title||!!i?.subtitle||s.length>0,m=this.effectiveGridLayout,v=this.cols,f=vs(v),$=this.data[this.id]?.page?.content??[],y=this.state[this.component?.id]?.emptyStateMessage,S=(_,D)=>{const P=D[_.id];if(P==null)return o``;if(_.dataType==="status"){const z=mr(P.type);return o`<span theme="badge pill ${z}">${P.message}</span>`}return _.dataType==="bool"?o`${P?"✓":"✗"}`:typeof P=="object"?o`${P.label??P.name??P.message??""}`:o`${P}`},H=()=>{const _=this.identifierFieldName,D=this.state._selectedId??this.appState?._splitDetailId,P=f.find(T=>T.identifier)??f[0],z=T=>T.dataType==="action"||T.dataType==="actionGroup"||T.dataType==="menu"||T.stereotype==="button",qe=f.filter(T=>T!==P&&!z(T)),Zt=v.filter(T=>z(T)),dt=(T,R,M)=>{T.stopPropagation(),T.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:R,parameters:{_clickedRow:M}},bubbles:!0,composed:!0}))},Pt=T=>{const R=[];for(const M of Zt){const N=T[M.id];if(M.dataType==="action"){const Me=N?.methodNameInCrud?N:T.action?.methodNameInCrud?T.action:{methodNameInCrud:M.id,label:M.label,icon:null};R.push(o`
                            <button class="crud-btn" theme="tertiary small" title="${Me.label||l}"
                                @click="${I=>dt(I,"action-on-row-"+Me.methodNameInCrud,T)}">
                                ${Me.icon?U(Me.icon):l}
                                ${Me.label??l}
                            ...
                            <button class="crud-btn" theme="tertiary small" title="${I.label||l}"
                                @click="${re=>dt(re,"action-on-row-"+I.methodNameInCrud,T)}">
                                ${I.icon?U(I.icon):l}
                                ${I.label??l}
                ...
                <div class="m-listbox" style="width: 100%;">
                    ${$.length===0?o`<div class="m-item" disabled>${zt(y)}</div>`:l}
                    ${$.map(T=>o`
                        <div class="m-item"
                            ?selected="${_&&D!==void 0&&String(T[_])===String(D)}"
                        ...
                        >
                            ...
                            <div style="font-size: var(--lumo-font-size-s); color: var(--lumo-secondary-text-color); display: flex; flex-wrap: wrap; gap: var(--lumo-space-xs); align-items: center;">
                                ${qe.map(R=>o`<span>${R.label}: ${S(R,T)}</span>`)}
                            </div>
                            ${Pt(T)}
                        </div>
                    `)}
                </div>`},ue=(_,D,P)=>{const z=this.identifierFieldName;z&&P[z]!==void 0&&(this.state={...this.state,_selectedId:String(P[z])}),_.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:D,parameters:P},bubbles:!0,composed:!0}))},F=()=>{const _=this.identifierFieldName,D=this.state._selectedId??this.appState?._splitDetailId,P=v.slice(0,6),z=P.filter(I=>I.stereotype==="image"),qe=P.find(I=>I.identifier)??P[0],Zt=I=>!!I.actionId,dt=I=>I.dataType==="action"||I.dataType==="actionGroup"||I.dataType==="menu"||I.stereotype==="button",Pt=P.find(I=>I.id==="select"&&I.dataType==="action"),T=!!Pt,R=P.filter(I=>I!==qe&&!z.includes(I)&&!Zt(I)&&!dt(I)),M=P.filter(I=>dt(I)&&!(T&&I===Pt)),N=(I,re,ct)=>{I.stopPropagation(),I.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:re,parameters:{_clickedRow:ct}},bubbles:!0,composed:!0}))},Me=I=>{const re=[];for(const ct of M){const yr=I[ct.id];if(ct.dataType==="action"){const ea=yr?.methodNameInCrud?yr:I.action?.methodNameInCrud?I.action:{methodNameInCrud:ct.id,label:ct.label,icon:null};re.push(o`
                            <button class="crud-btn" theme="tertiary" title="${ea.label||l}"
                                @click="${Tt=>N(Tt,"action-on-row-"+ea.methodNameInCrud,I)}">
                                ${ea.icon?U(ea.icon):l}
                                ${ea.label??l}
                            </button>`)}else(ct.dataType==="actionGroup"||ct.dataType==="menu")&&(yr?.actions??[]).forEach(Tt=>re.push(o`
                            <button class="crud-btn" theme="tertiary" title="${Tt.label||l}"
                                @click="${Ds=>N(Ds,"action-on-row-"+Tt.methodNameInCrud,I)}">
                                ${Tt.icon?U(Tt.icon):l}
                                ${Tt.label??l}
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: var(--lumo-space-m); padding: var(--lumo-space-s) 0;">
                    ${$.length===0?o`<div style="grid-column: 1 / -1;">${zt(y)}</div>`:l}
                    ${$.map(I=>o`
                        <div class="crud-card"
                            ?data-selected="${_&&D!==void 0&&String(I[_])===String(D)}"
                            style="cursor: pointer;"
                            @click="${re=>T?N(re,"action-on-row-select",I):ue(re.target,"view",I)}"
                        >
                    ...
                    `)}
                </div>`},ee=()=>{const _=Cc(v),D=_.find(z=>z.identifier)??_[0],P=_.filter(z=>z!==D);return o`
                ...
                </div>`},pe=()=>{const _=this.identifierFieldName,D=this.state._selectedId??this.appState?._splitDetailId,P=v[0],z=v.slice(1),qe=!!P?.actionId,Zt=R=>(R??[]).map(M=>{const N=Array.isArray(M.children)?M.children:[];return N.length>0?{...M,children:Zt(N)}:{...M,children:void 0}}),dt=Zt($),Pt=(R,M,N)=>{R.stopPropagation(),_&&M[_]!==void 0&&(this.state={...this.state,_selectedId:String(M[_])}),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:N,parameters:M},bubbles:!0,composed:!0}))},T=(R,M)=>o`
                <tr class="${_&&D!==void 0&&String(R[_])===String(D)?"selected":""}"
                    style="cursor: pointer;" @click="${N=>Pt(N,R,"view")}">
                    ...
                    ${qe?o`<td style="text-align: end;">${R?.viewable===!1?l:o`<button class="crud-btn small" @click="${N=>Pt(N,R,"view")}">View</button>`}</td>`:l}
                </tr>
            ...
            `;return o`
                <table class="crud-table">
                    ...
                    <tbody>
                        ${dt.length===0?o`<tr><td colspan="99" style="padding: 1.5rem; text-align: center; color: var(--lumo-secondary-text-color, #888);">${zt(y)}</td></tr>`:l}
                        ${dt.map(R=>T(R,0))}
                    </tbody>
            ...
            `:F():!J&&m==="masterDetail"?ee():!J&&m==="tree"?pe():B.get()?.renderTableComponent(this,r,this.baseUrl,this.state,this.data,this.appState,this.appData)}
            <slot></slot>
        `,ae=i.infiniteScrolling?l:B.get()?.renderPagination(this,this.component),be=this.showImportDialog?o`
            <div class="crud-modal-backdrop" @click="${_=>{_.target===_.currentTarget&&(this.showImportDialog=!1)}}">
                <div class="crud-modal">
                    ...
                    <input type="file" @change="${_=>{const D=_.target.files?.[0];if(D){const P=new FormData;P.append("file",D),fetch("/upload",{method:"POST",body:P}).then(z=>z.json()).then(z=>this.handleImportUploadSuccess({detail:z})).catch(()=>this.notify("Import failed"))}}}">
        ...
        `}createRenderRoot(){return B.mustUseShadowRoot()?super.createRenderRoot():this}};le.styles=x`
        ${xt}
    ...
    `;Pe([p()],le.prototype,"component",2);Pe([p()],le.prototype,"baseUrl",2);Pe([p({type:Boolean})],le.prototype,"standalone",2);Pe([p()],le.prototype,"state",2);Pe([p()],le.prototype,"data",2);Pe([p()],le.prototype,"appState",2);Pe([p()],le.prototype,"appData",2);Pe([b()],le.prototype,"showImportDialog",2);Pe([b()],le.prototype,"availableWidthPx",2);Pe([b()],le.prototype,"selectedItem",2);Pe([b()],le.prototype,"_columnPrefsRevision",2);le=Pe([k("mateu-table-crud")],le);var ht=(e=>(e.OnLoad="OnLoad",e.OnSuccess="OnSuccess",e.OnError="OnError",e.OnValueChange="OnValueChange",e.OnCustomEvent="OnCustomEvent",e.AutoSave="AutoSave",e))(ht||{}),Ec=Object.defineProperty,vr=(e,t,a,r)=>{for(var i=void 0,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=n(t,a,i)||i);return i&&Ec(t,a,i),i};class St extends dr{constructor(){super(...arguments),this.state={},this.data={},this.appData={},this.appState={},this.triggerOnLoad=()=>{const t=this.component;this.registerCustomEventListeners(),t.triggers?.filter(a=>a.type==ht.OnLoad).forEach(a=>{if((!a.condition||this._evalExpr(a.condition))&&!a.triggered){const i=a;i.triggered=!0;var r=i.times-1;i.timeoutMillis>0?this.scheduleOnload(i,r,this.id):this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:i.actionId},bubbles:!0,composed:!0}))}})},this.scheduleOnload=(t,a,r)=>{if(r!=this.component?.id)return;const i=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,callbackToken:i},bubbles:!0,composed:!0}))},t.timeoutMillis)},this._registeredCustomEventListeners=[],this.customEventManager=t=>{if(!(t instanceof CustomEvent))return;const a=t,i=(this.component.triggers??[]).filter(s=>s.type==ht.OnCustomEvent).filter(s=>s.eventName==a.type).filter(s=>s.source!=="COMPONENT"||a.detail?.__source===s.from);i.length!==0&&(i.some(s=>!s.source||s.source==="SELF")&&(t.stopPropagation(),t.preventDefault()),i.forEach(s=>{(!s.condition||this._evalExpr(s.condition))&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:s.actionId,parameters:a.detail},bubbles:!0,composed:!0}))}))}}_interpolationExtra(){return{appState:this.appState??{},appData:this.appData??{},component:this.component}}_evalExpr(t){return Di(t,this.state??{},this.data??{},this._interpolationExtra())}_evalTemplate(t){return ko(t,this.state??{},this.data??{},this._interpolationExtra())}applyFragment(t){if(this.id==t.targetComponentId){if(t.component)if(xa.Add==t.action)this.component&&this.component.children?.push(t.component);else{if(this.callbackToken=$e(),t.component?.type==W.ServerSide)if(this.component){const r=this.component,i=t.component;r.actions=i.actions,r.type=i.type,r.rules=i.rules,r.triggers=i.triggers,r.serverSideType=i.serverSideType,r.route=i.route,r.initialData=i.initialData,r.validations=i.validations,r.cssClasses=i.cssClasses,r.slot=i.slot,r.style=i.style,r.children=i.children,(r.serverSideType!=i.serverSideType||r.id!=i.id)&&setTimeout(()=>this.triggerOnLoad())}else this.component=t.component,setTimeout(()=>this.triggerOnLoad());else{const r=[t.component];this.component&&(this.component.children=r)}t.action!==xa.ReplaceKeepData&&(this.state={},this.data={})}if(t.state&&(this.state={...this.state,...t.state}),t.data){for(const r in t.data){const i=t.data[r]?.page;i?.pageNumber>0&&this.data[r]&&this.data[r].page.content&&(i.content?i.content=[...this.data[r].page.content,...i.content]:i.content=[...this.data[r].page.content])}this.data={...this.data,...t.data}}this.registerCustomEventListeners();const a=B.getAfterRenderHook();a&&setTimeout(()=>a(this)),this.requestUpdate()}}registerCustomEventListeners(){this._registeredCustomEventListeners.forEach(({target:a,name:r})=>a.removeEventListener(r,this.customEventManager)),this._registeredCustomEventListeners=[],this.component?.triggers?.filter(a=>a.type==ht.OnCustomEvent).forEach(a=>{const r=a.source==="DOCUMENT"||a.source==="COMPONENT"?document:this;r.addEventListener(a.eventName,this.customEventManager),this._registeredCustomEventListeners.push({target:r,name:a.eventName})})}disconnectedCallback(){this._registeredCustomEventListeners.forEach(({target:t,name:a})=>t.removeEventListener(a,this.customEventManager)),this._registeredCustomEventListeners=[],super.disconnectedCallback()}connectedCallback(){super.connectedCallback(),this.component&&this.registerCustomEventListeners()}}vr([p()],St.prototype,"state");vr([p()],St.prototype,"data");vr([p()],St.prototype,"appData");vr([p()],St.prototype,"appState");const fs="mateu-recent-routes",Pc=8;function bs(){try{return JSON.parse(localStorage.getItem(fs)??"{}")}catch{return{}}}function Tc(e){try{localStorage.setItem(fs,JSON.stringify(e))}catch{}}function li(e){return bs()[e||"_"]??[]}function Oc(e,t){if(!t?.route||!t.label)return;const a=e||"_",r=bs(),s=(r[a]??[]).filter(n=>n.route!==t.route);s.unshift({route:t.route,label:t.label}),r[a]=s.slice(0,Pc),Tc(r)}var zc=Object.defineProperty,Rc=Object.getOwnPropertyDescriptor,Xe=(e,t,a,r)=>{for(var i=r>1?void 0:r?Rc(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&zc(t,a,i),i};let xe=class extends C{constructor(){super(...arguments),this.baseUrl="",this.open=!1,this.queryText="",this.dataHits=[],this.loading=!1,this.selectedIndex=0,this.fabOffset=0,this.keydownHandler=null}connectedCallback(){super.connectedCallback(),this.keydownHandler=e=>{(e.metaKey||e.ctrlKey)&&(e.key==="k"||e.key==="K")?(e.preventDefault(),this.toggle()):e.key==="Escape"&&this.open&&this.close()},document.addEventListener("keydown",this.keydownHandler),this.setupFabObserver()}disconnectedCallback(){super.disconnectedCallback(),this.keydownHandler&&document.removeEventListener("keydown",this.keydownHandler),clearTimeout(this.searchTimer),this.fabObserver?.disconnect(),this.fabObserver=void 0}setupFabObserver(){const e=this.getRootNode(),t=e instanceof ShadowRoot?e:document.body;this.measureFabStack(),this.fabObserver?.disconnect(),this.fabObserver=new MutationObserver(()=>this.measureFabStack()),this.fabObserver.observe(t,{childList:!0,subtree:!0})}measureFabStack(){const a=(this.getRootNode().querySelectorAll?.(".ai-fab, .app-fab, .page-fab").length??0)*4;a!==this.fabOffset&&(this.fabOffset=a)}updated(e){e.has("open")&&this.open&&requestAnimationFrame(()=>this.inputEl?.focus())}toggle(){this.open?this.close():this.openCenter()}openCenter(){this.open=!0,this.queryText="",this.dataHits=[],this.selectedIndex=0}close(){this.open=!1,this.queryText="",this.dataHits=[],clearTimeout(this.searchTimer)}flattenMenu(e,t){const a=[];for(const r of e??[])if(!r.separator)if(r.submenus&&r.submenus.length>0){const i=t?`${t} › ${r.label}`:r.label;a.push(...this.flattenMenu(r.submenus,i))}else r.route!==void 0&&r.route!==null&&a.push({label:r.label,breadcrumb:t,route:r.route});return a}onInput(e){this.queryText=e,this.selectedIndex=0;const t=e.trim();if(clearTimeout(this.searchTimer),!t||!this.app?.globalSearchEnabled){this.dataHits=[],this.loading=!1;return}this.loading=!0,this.searchTimer=setTimeout(()=>this.fetchGlobalSearch(t),250)}async fetchGlobalSearch(e){const t=this.app;if(!t?.globalSearchEnabled){this.loading=!1;return}try{const r=(await Kt.runAction(this.baseUrl??"",t.rootRoute??"","","_globalsearch","command-center",void 0,t.serverSideType,{},{searchText:e},this,!0))?.fragments?.map(i=>i.data).find(i=>i&&i._globalsearch);this.dataHits=r?._globalsearch??[]}catch{this.dataHits=[]}finally{this.loading=!1}}navigateTo(e,t){Oc(this.app?.serverSideType??"",{route:e,label:t}),this.close();for(const a of["route-changed","navigate-to-requested"])this.dispatchEvent(new CustomEvent(a,{detail:{route:e},bubbles:!0,composed:!0}))}askAi(){const e=this.queryText.trim();this.close(),this.dispatchEvent(new CustomEvent("mateu-open-ai",{detail:{query:e},bubbles:!0,composed:!0}))}visibleTargets(e){if(!this.queryText.trim()){const t=this.flattenMenu(this.app?.menu,"").map(r=>({route:r.route,label:r.label})),a=li(this.app?.serverSideType??"");return[...t,...a]}return[...e.map(t=>({route:t.route,label:t.label})),...this.dataHits.map(t=>({route:t.route,label:t.label}))]}onKeydown(e,t){if(e.key==="ArrowDown")e.preventDefault(),this.selectedIndex=Math.min(this.selectedIndex+1,t.length-1);else if(e.key==="ArrowUp")e.preventDefault(),this.selectedIndex=Math.max(this.selectedIndex-1,0);else if(e.key==="Enter"){const a=t[this.selectedIndex];a&&this.navigateTo(a.route,a.label)}}render(){return o`
        ...
        `}renderDefault(){const e=this.flattenMenu(this.app?.menu,""),t=li(this.app?.serverSideType??"");let a=-1;return o`
    ...
    `;Xe([p({attribute:!1})],xe.prototype,"app",2);Xe([p()],xe.prototype,"baseUrl",2);Xe([b()],xe.prototype,"open",2);Xe([b()],xe.prototype,"queryText",2);Xe([b()],xe.prototype,"dataHits",2);Xe([b()],xe.prototype,"loading",2);Xe([b()],xe.prototype,"selectedIndex",2);Xe([b()],xe.prototype,"fabOffset",2);Xe([_e(".cc-input")],xe.prototype,"inputEl",2);xe=Xe([k("mateu-command-center")],xe);let Ne=null;function Lc(e){const t=e.component?.metadata;!!(t&&(t.commandCenterEnabled||t.chromeless)&&t.variant!=="MEDIATOR")?((!Ne||!Ne.isConnected)&&(Ne=document.createElement("mateu-command-center"),e.renderRoot.appendChild(Ne)),Ne.app=t,Ne.baseUrl=e.baseUrl??""):Ne&&e.renderRoot.contains(Ne)&&(Ne.remove(),Ne=null)}var Dc=Object.defineProperty,Ac=Object.getOwnPropertyDescriptor,gs=(e,t,a,r)=>{for(var i=r>1?void 0:r?Ac(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Dc(t,a,i),i};let rr=class extends C{constructor(){super(...arguments),this.fetchStarted=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!0},this.fetchFinished=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1},this.fetchFailed=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1;const t=e.detail.reason,a=t?.message??String(t);Ut({text:a,variant:"error",duration:3e3,position:"bottomEnd"},this)}}connectedCallback(){super.connectedCallback(),this.addEventListener("backend-called-event",this.fetchStarted),this.addEventListener("backend-succeeded-event",this.fetchFinished),this.addEventListener("backend-cancelled-event",this.fetchFailed),this.addEventListener("backend-failed-event",this.fetchFailed)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("backend-succeeded-event",this.fetchStarted),this.removeEventListener("backend-succeeded-event",this.fetchFinished),this.removeEventListener("backend-cancelled-event",this.fetchFailed),this.removeEventListener("backend-failed-event",this.fetchFailed)}render(){return o`<div class="loader-container">
...
`):e?.cssText??"";if(!t)return;const a=document.createElement("style");a.id="mateu-app-light-styles",a.textContent=t,document.head.appendChild(a)}fetchGlobalSearch(e){const t=this.component?.metadata;if(t?.globalSearchEnabled){if(clearTimeout(this._globalSearchTimer),!e){this.commandPaletteDataHits=[];return}this._globalSearchTimer=setTimeout(async()=>{try{const r=(await Kt.runAction(this.baseUrl??"",t.rootRoute??"","","_globalsearch","cmd-palette",void 0,t.serverSideType,{},{searchText:e},this,!0))?.fragments?.map(i=>i.data).find(i=>i&&i._globalsearch);this.commandPaletteDataHits=r?._globalsearch??[]}catch{this.commandPaletteDataHits=[]}},250)}}connectedCallback(){super.connectedCallback(),this.isDark=document.documentElement.getAttribute("theme")==="dark",this._commandPaletteHandler=e=>{this.component?.metadata?.commandCenterEnabled||((e.metaKey||e.ctrlKey)&&e.key==="k"&&(e.preventDefault(),this.commandPaletteOpen=!this.commandPaletteOpen,this.commandPaletteQuery="",this.commandPaletteSelectedIndex=0),e.key==="Escape"&&this.commandPaletteOpen&&(this.commandPaletteOpen=!1,this.commandPaletteQuery=""))},document.addEventListener("keydown",this._commandPaletteHandler),Dt.install(),this.addEventListener("compact-changed",this._compactHandler),this.addEventListener("mateu-open-ai",this._openAiHandler)}disconnectedCallback(){super.disconnectedCallback(),this._commandPaletteHandler&&document.removeEventListener("keydown",this._commandPaletteHandler),this.removeEventListener("compact-changed",this._compactHandler),this.removeEventListener("mateu-open-ai",this._openAiHandler)}updated(e){if(super.updated(e),Lc(this),this.component){const a=this.component.metadata;if(a){const r=a;if(r.favicon){let i=document.querySelector("link[rel~='icon']");i||(i=document.createElement("link"),i.rel="icon",document.head.appendChild(i)),i.href=r.favicon}e.has("component")&&(this.selectedRoute=r.homeRoute,this.selectedConsumedRoute=r.homeConsumedRoute,this.selectedServerSideType=r.homeServerSideType,this.selectedBaseUrl=r.homeBaseUrl,this.selectedUriPrefix=r.homeUriPrefix)}}e.has("commandPaletteOpen")&&this.commandPaletteOpen&&setTimeout(()=>{this.renderRoot.querySelector(".cmd-input")?.focus()},0)}render(){return B.get()?.renderAppComponent(this,this.component,this.baseUrl,this.state,this.data,this.appState,this.appData)}};A.lightDomStylesInjected=!1;A.styles=x`
  ...
  `;ys([p()],ir.prototype,"target",2);ir=ys([k("mateu-event-interceptor")],ir);var Vc=Object.defineProperty,Hc=Object.getOwnPropertyDescriptor,$s=(e,t,a,r)=>{for(var i=r>1?void 0:r?Hc(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Vc(t,a,i),i};let sr=class extends St{constructor(){super(...arguments),this.opened=!0,this.close=()=>{this.opened=!1,setTimeout(()=>this.parentElement?.removeChild(this),500)},this.onKeydown=e=>{e.key==="Escape"&&this.opened&&(e.stopPropagation(),this.close())}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeydown)}applyFragment(e){super.applyFragment(e);const t=e.state?._closeAfterMillis;t&&setTimeout(()=>this.close(),t)}updated(e){if(super.updated(e),e.has("component")&&this.component){const t=this.component.metadata;this.state=t.initialData}}render(){if(!this.opened)return o``;const e=this.component.metadata,t=wa(e.headerTitle,this.state,this.data,this.appState,this.appData),a=!!(t||e.header||e.closeButtonOnHeader),r=[e.width?`width:${e.width};`:"min-width:min(90vw,28rem);",e.height?`height:${e.height};`:"",e.top?`margin-top:${e.top};`:""].join("");return o`
    ...
    `;$s([b()],sr.prototype,"opened",2);sr=$s([k("mateu-dialog")],sr);var Wc=Object.defineProperty,Gc=Object.getOwnPropertyDescriptor,fr=(e,t,a,r)=>{for(var i=r>1?void 0:r?Gc(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Wc(t,a,i),i};let ze=class extends St{constructor(){super(...arguments),this.opened=!1,this.maximizeSteps=0,this.collapsed=!1,this.close=()=>{this.opened=!1,setTimeout(()=>this.parentElement?.removeChild(this),300)},this._escListener=e=>{if(e.key!=="Escape")return;const a=this.getRootNode().querySelectorAll("mateu-drawer, mateu-dialog");a[a.length-1]===this&&(e.stopPropagation(),this.close())}}effectiveWidth(e){if(e.width)return e.width;if(!e.size)return;const t=ze.SIZE_LADDER,a=Math.max(0,t.indexOf(e.size)),r=Math.min(t.length-1,a+this.maximizeSteps);return ze.SIZE_WIDTHS[t[r]]}canMaximize(e){if(!e.maximizable)return!1;const t=ze.SIZE_LADDER;return Math.max(0,t.indexOf(e.size??"m"))+this.maximizeSteps<t.length-1}firstUpdated(){requestAnimationFrame(()=>this.opened=!0)}applyFragment(e){super.applyFragment(e);const t=e.state?._closeAfterMillis;t&&setTimeout(()=>this.close(),t)}updated(e){if(super.updated(e),e.has("component")&&this.component){const t=this.component.metadata;this.state=t.initialData}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._escListener)}disconnectedCallback(){document.removeEventListener("keydown",this._escListener),super.disconnectedCallback()}render(){const e=this.component.metadata,t=e.position??"end",a=wa(e.headerTitle,this.state,this.data,this.appState,this.appData),r=wa(e.subtitle,this.state,this.data,this.appState,this.appData),i=this.effectiveWidth(e),s=e.peerNav&&(e.peerNav.prevRoute||e.peerNav.nextRoute)?e.peerNav:void 0;return o`
        ${e.modeless?l:o`
       ...
       `}};ze.SIZE_LADDER=["s","m","l","xl"];ze.SIZE_WIDTHS={s:"464px",m:"648px",l:"968px",xl:"90vw"};ze.styles=x`
        .drawer-close {
            border: none;
            background: transparent;
            cursor: pointer;
  ...
  `;fr([b()],ze.prototype,"opened",2);fr([b()],ze.prototype,"maximizeSteps",2);fr([b()],ze.prototype,"collapsed",2);ze=fr([k("mateu-drawer")],ze);var Kc=Object.defineProperty,Yc=Object.getOwnPropertyDescriptor,de=(e,t,a,r)=>{for(var i=r>1?void 0:r?Yc(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Kc(t,a,i),i};function di(e){if(e.parentElement)return e.parentElement;const t=e.getRootNode();return t instanceof ShadowRoot?t.host:null}let K=class extends C{constructor(){super(...arguments),this.appState={},this.appData={},this.standalone=!1,this.actionBanners=[],this.dismissedStaticBannerIndices=new Set,this._tocEntries=[],this._activeToc=0,this._tocVisible=!1,this._tocRebuildScheduled=!1,this._headerH=0,this._onResize=()=>this._layoutStickyTops(),this._tocLocked=!1,this._unlockToc=e=>{if(e&&e.type==="keydown"){const t=e;if(t.ctrlKey&&t.altKey&&!t.shiftKey&&!t.metaKey&&/^(?:Digit|Numpad)[1-9]$/.test(t.code))return}this._tocLocked=!1},this._actionBannerTimers=[],this._staticBannerTimers=[],this._bannersHandler=e=>{const t=e.detail,a=t.banners??[],r=t.append??!1;r?this.actionBanners=[...this.actionBanners,...a]:(this._clearActionBannerTimers(),this.actionBanners=a);const i=r?this.actionBanners.length-a.length:0;a.forEach((s,n)=>{if(s.timeoutSeconds&&s.timeoutSeconds>0){const d=i+n;this._actionBannerTimers.push(setTimeout(()=>{this.actionBanners=this.actionBanners.filter((c,u)=>u!==d)},s.timeoutSeconds*1e3))}})},this._onTocKey=e=>{if(!this._tocVisible||!e.ctrlKey||!e.altKey||e.shiftKey||e.metaKey)return;const t=/^(?:Digit|Numpad)([1-9])$/.exec(e.code);if(!t)return;const a=parseInt(t[1],10)-1;a>=this._tocEntries.length||(e.preventDefault(),this._scrollToSection(a))},this._onScrollSpy=()=>{if(this._tocLocked)return;const e=this._sectionCards();if(!e.length)return;const t=12,a=this.shadowRoot?.querySelector("mateu-content-header");let r=a?a.getBoundingClientRect().bottom:0;for(const n of e){if(!n.classList.contains("mateu-section--sticky"))continue;const d=n.getBoundingClientRect();d.top<=r+t+2&&(r=Math.max(r,d.bottom))}const i=r+t+4;let s=0;this._tocEntries.forEach((n,d)=>{n.el.getBoundingClientRect().top<=i&&(s=d)}),this._activeToc=s}}connectedCallback(){super.connectedCallback(),document.addEventListener("page-banners-received",this._bannersHandler),window.addEventListener("resize",this._onResize),document.addEventListener("keydown",this._onTocKey)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("page-banners-received",this._bannersHandler),window.removeEventListener("resize",this._onResize),document.removeEventListener("keydown",this._onTocKey),this._clearAllTimers(),this._teardownScrollSpy()}updated(e){if(super.updated(e),e.has("component")&&e.get("component")!==void 0&&(this._clearAllTimers(),this.actionBanners=[],this.dismissedStaticBannerIndices=new Set),e.has("component")){const t=this.component?.metadata?.level??0;this.toggleAttribute("data-nested",t>0),this._scheduleStaticBannerTimeouts(),this.dispatchEvent(new CustomEvent("compact-changed",{detail:{compact:!!this.component?.style?.includes("--mateu-compact:1")},bubbles:!0,composed:!0})),this._scheduleTocRebuild()}}_scheduleStaticBannerTimeouts(){this._staticBannerTimers.forEach(a=>clearTimeout(a)),this._staticBannerTimers=[],(this.component?.metadata?.banners??[]).forEach((a,r)=>{a.timeoutSeconds&&a.timeoutSeconds>0&&this._staticBannerTimers.push(setTimeout(()=>{this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,r])},a.timeoutSeconds*1e3))})}_clearActionBannerTimers(){this._actionBannerTimers.forEach(e=>clearTimeout(e)),this._actionBannerTimers=[]}_clearAllTimers(){this._clearActionBannerTimers(),this._staticBannerTimers.forEach(e=>clearTimeout(e)),this._staticBannerTimers=[]}_dismissActionBanner(e){this.actionBanners=this.actionBanners.filter((t,a)=>a!==e)}_dismissStaticBanner(e){this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,e])}bannerThemeClass(e){const t=e.theme?.toLowerCase()??"info";return t==="none"?"":t}_evalBannerText(e){return ye(e,this.state,this.data)}_renderBanner(e,t){const a=this._evalBannerText(e.title),r=this._evalBannerText(e.description);return o`
        ...
        `;return o`<div style="display: flex; flex-direction: column; width: 100%;">${i}</div>`}};K.styles=x`
    ...
    `;de([p()],K.prototype,"component",2);de([p()],K.prototype,"baseUrl",2);de([p()],K.prototype,"state",2);de([p()],K.prototype,"data",2);de([p()],K.prototype,"appState",2);de([p()],K.prototype,"appData",2);de([p()],K.prototype,"value",2);de([p({type:Boolean})],K.prototype,"standalone",2);de([b()],K.prototype,"actionBanners",2);de([b()],K.prototype,"dismissedStaticBannerIndices",2);de([b()],K.prototype,"_tocEntries",2);de([b()],K.prototype,"_activeToc",2);de([b()],K.prototype,"_tocVisible",2);K=de([k("mateu-page")],K);const Yr=x`
    .nbtn {
        display: inline-flex;
        align-items: center;
        gap: .35em;
...
`,ee=!0)}ee&&this.updateMessage(s,n)}n||this.updateMessage(s,"⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).")}catch(d){console.error("Error en el flujo SSE:",d);const c=d?.message??String(d);(c==="Failed to fetch"||c==="network error"||c==="Load failed")&&!n?this.updateMessage(s,"⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible."):this.updateMessage(s,"⚠️ Error: "+c)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value="")},250),this.messageInputElement?.removeAttribute("disabled"),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent("close-requested",{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{const e=this.messageInputElement?.value?.trim()??"";e&&this.send(new CustomEvent("submit",{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key==="Enter"&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback(),this.probeLocalAgent();const e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){const t=new e;this.recognition=t,t.lang="es-ES",t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=a=>{console.error("Error de reconocimiento: "+a.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:"smooth"})},0)}addMessage(e,t){const a={text:e,time:new Date().toLocaleTimeString(),userName:t.includes("agent")?"Asistente":"Tú",userColorIndex:t.includes("agent")?2:1};return this.items=[...this.items,a],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((a,r)=>r===e?{...a,text:t}:a),this.scrollBottom()}tryParseCustomEvent(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if(typeof a.event=="string")return{event:a.event,detail:a.detail??{}}}catch{}return null}tryParseTokenUsage(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if("inputTokens"in a||"outputTokens"in a||"totalTokens"in a)return a}catch{}return null}buildMenuContext(e,t=[]){const a=[];for(const r of e){if(r.separator||r.remote)continue;const i=[...t,r.label];if(r.submenus&&r.submenus.length>0)a.push(...this.buildMenuContext(r.submenus,i));else{const s={path:i,navigation:{route:r.route,consumedRoute:r.consumedRoute,actionId:r.actionId??"",baseUrl:r.baseUrl,serverSideType:r.serverSideType,uriPrefix:r.uriPrefix}};r.description&&(s.description=r.description),a.push(s)}}return a}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return o`
    ...
    `];j([p({attribute:!1})],q.prototype,"contextProvider",2);j([p()],q.prototype,"localAgentUrl",2);j([p({attribute:!1})],q.prototype,"mcpUrl",2);j([b()],q.prototype,"localAgentAlive",2);j([p()],q.prototype,"sseUrl",2);j([p()],q.prototype,"uploadUrl",2);j([p({attribute:!1})],q.prototype,"menu",2);j([b()],q.prototype,"attachments",2);j([b()],q.prototype,"uploading",2);j([_e(".file-input")],q.prototype,"fileInputElement",2);j([p({type:Boolean,reflect:!0})],q.prototype,"expanded",2);j([p()],q.prototype,"items",2);j([_e(".scroll-container")],q.prototype,"scrollContainer",2);j([_e(".msg-input")],q.prototype,"messageInputElement",2);j([b()],q.prototype,"recognition",2);j([b()],q.prototype,"listening",2);j([b()],q.prototype,"recognitionAvailable",2);j([b()],q.prototype,"loading",2);j([b()],q.prototype,"elapsedSeconds",2);j([b()],q.prototype,"tokenUsage",2);q=j([k("mateu-chat")],q);var au=Object.defineProperty,ru=Object.getOwnPropertyDescriptor,Da=(e,t,a,r)=>{for(var i=r>1?void 0:r?ru(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&au(t,a,i),i};let jt=class extends C{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.data&&this.createChart(this.data)}async createChart(e){const[{default:t}]=await Promise.all([he(()=>import("./vendor-chartjs.js").then(r=>r.a),[]),he(()=>import("./vendor-chartjs.js").then(r=>r.c),[])]);if(e!==this.data)return;this.chart&&this.chart.destroy();const a={type:this.type,data:this.data,options:this.options};this.chart=new t(this.chartElement,a)}handleSlotChange(){}render(){return o`
            <div class="container">
       ...
       `}};jt.styles=x`
  `;Da([p()],jt.prototype,"type",2);Da([p()],jt.prototype,"data",2);Da([p()],jt.prototype,"options",2);Da([_e("#chart")],jt.prototype,"chartElement",2);jt=Da([k("mateu-chart")],jt);var iu=Object.defineProperty,su=Object.getOwnPropertyDescriptor,Jr=(e,t,a,r)=>{for(var i=r>1?void 0:r?su(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&iu(t,a,i),i};let Pa=class extends C{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){const{default:t}=await he(async()=>{const{default:r}=await import("./vendor-diagrams.js");return{default:r}},__vite__mapDeps([0,1]));if(e!==this.xml)return;this.chart&&this.chart.destroy();const a={container:this.divElement};this.chart=new t(a),this.chart.importXML(e)}handleSlotChange(){}render(){return o`
       ...
       `}};Pa.styles=x`
  `;Jr([p()],Pa.prototype,"xml",2);Jr([_e("#canvas")],Pa.prototype,"divElement",2);Pa=Jr([k("mateu-bpmn")],Pa);var ou=Object.defineProperty,nu=Object.getOwnPropertyDescriptor,va=(e,t,a,r)=>{for(var i=r>1?void 0:r?nu(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&ou(t,a,i),i};const kr=160,Ue=56,lu=220,ui=110,pt=60,du={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},cu={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},uu=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];function pu(){return"step-"+Math.random().toString(36).slice(2,8)}let gt=class extends C{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.wf={name:"New Workflow",steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value")){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){const e=this.wf.steps??[],t={};e.forEach(n=>{t[n.id]=0});let a=!0;for(;a;)a=!1,e.forEach(n=>{if(n.preconditionStepId!=null&&t[n.preconditionStepId]!==void 0){const d=t[n.preconditionStepId]+1;d>t[n.id]&&(t[n.id]=d,a=!0)}});const r={};e.forEach(n=>{const d=t[n.id]??0;(r[d]??=[]).push(n.id)});const i={...this.positions};let s=!1;Object.entries(r).forEach(([n,d])=>{const c=Number(n);d.forEach((u,m)=>{i[u]||(i[u]={x:pt+c*lu,y:pt+m*ui},s=!0)})}),s&&(this.positions=i)}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addStep(){const e=pu(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(i=>i.y),r=a.length?Math.max(...a)+ui:pt;this.positions={...this.positions,[e]:{x:pt,y:r}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(r=>r.id!==e).map(r=>r.preconditionStepId===e?{...r,preconditionStepId:void 0}:r)};const{[e]:t,...a}=this.positions;this.positions=a,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},r=this.toSvgPoint(e);this.dragOffset={x:r.x-a.x,y:r.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(r=>r.x))+kr+pt:600,a=e.length?Math.max(...e.map(r=>r.y))+Ue+pt:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return X``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return X``;const r=t.x+kr,i=t.y+Ue/2,s=a.x,n=a.y+Ue/2,d=(r+s)/2;return X`
            <path d="M${r},${i} C${d},${i} ${d},${n} ${s},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:pt,y:pt},a=du[e.type]??"#64748b",r=cu[e.type]??"•",i=this.selectedId===e.id;return X`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${s=>this.onNodeMouseDown(s,e.id)}"
               @click="${s=>{s.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${kr}" height="${Ue}" rx="8"
                      fill="white"
                      stroke="${i?a:"#e2e8f0"}"
                ...
                <div class="prop-body">
                    ...
                    ${a("Type",o`
                        <select class="inp" @change="${r=>this.updateStep(e.id,{type:r.target.value})}">
                            ${uu.map(r=>o`<option value="${r}" ?selected="${e.type===r}">${r}</option>`)}
                        </select>`)}
        ...
        `}exportJson(){const e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),r=document.createElement("a");r.href=a,r.download=(this.wf.name??"workflow").replace(/\s+/g,"-").toLowerCase()+".json",r.click(),URL.revokeObjectURL(a)}};gt.styles=[Yr,x`
    ...
    `];va([p()],gt.prototype,"value",2);va([b()],gt.prototype,"wf",2);va([b()],gt.prototype,"positions",2);va([b()],gt.prototype,"selectedId",2);va([b()],gt.prototype,"showMeta",2);gt=va([k("mateu-workflow")],gt);var hu=Object.defineProperty,mu=Object.getOwnPropertyDescriptor,Aa=(e,t,a,r)=>{for(var i=r>1?void 0:r?mu(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&hu(t,a,i),i};const vu=["string","integer","number","bool","date","time","dateTime","dateRange","money","file","array","status","component","menu","range","action","actionGroup"],fu=["regular","radio","checkbox","textarea","toggle","combobox","select","email","password","richText","listBox","html","markdown","image","icon","link","money","grid","color","choice","popover","slider","button","stars"],bu={string:"#3B82F6",integer:"#8B5CF6",number:"#6366F1",bool:"#10B981",date:"#F59E0B",time:"#F59E0B",dateTime:"#F59E0B",dateRange:"#F59E0B",money:"#EF4444",file:"#64748B",array:"#0EA5E9",status:"#EC4899",component:"#14B8A6",menu:"#94A3B8",range:"#A855F7",action:"#F97316",actionGroup:"#FB923C"};function pi(){return"field-"+Math.random().toString(36).slice(2,8)}let Bt=class extends C{constructor(){super(...arguments),this.value='{"name":"New Form","fields":[]}',this.form={name:"New Form",fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has("value"))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){const e=this.shadowRoot?.querySelector(".field-list");!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=ro.create(e,{animation:150,handle:".drag-handle",ghostClass:"sortable-ghost",onEnd:t=>{const{oldIndex:a,newIndex:r}=t;if(a===void 0||r===void 0||a===r)return;const i=[...this.form.fields],[s]=i.splice(a,1);i.splice(r,0,s),this.form={...this.form,fields:i},this.emit()}}))}emit(){const e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addField(){const e=pi(),t={id:e,label:"New Field",dataType:"string"};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){const t=this.form.fields.find(s=>s.id===e);if(!t)return;const a={...t,id:pi(),label:t.label+" (copy)"},r=this.form.fields.findIndex(s=>s.id===e),i=[...this.form.fields];i.splice(r+1,0,a),this.form={...this.form,fields:i},this.selectedId=a.id,this.emit()}render(){return o`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderRow(e){const t=bu[e.dataType]??"#64748b",a=this.selectedId===e.id;return o`
        ...
        `}exportJson(){const e=JSON.stringify(this.form,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),r=document.createElement("a");r.href=a,r.download=(this.form.name??"form").replace(/\s+/g,"-").toLowerCase()+".json",r.click(),URL.revokeObjectURL(a)}};Bt.styles=[Yr,x`
        :host { display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif); }
    ...
    `;Ze([p()],ke.prototype,"appState",2);Ze([p()],ke.prototype,"appData",2);Ze([b()],ke.prototype,"open",2);Ze([b()],ke.prototype,"activeTab",2);Ze([b()],ke.prototype,"hoveredTag",2);Ze([b()],ke.prototype,"hoveredId",2);Ze([b()],ke.prototype,"hoveredState",2);Ze([b()],ke.prototype,"hoveredData",2);Ze([b()],ke.prototype,"hoveredMeta",2);ke=Ze([k("mateu-debug-overlay")],ke);var Te=(e=>(e.SetAppDataValue="SetAppDataValue",e.SetAppStateValue="SetAppStateValue",e.SetDataValue="SetDataValue",e.RunAction="RunAction",e.RunJS="RunJS",e.SetAttributeValue="SetAttributeValue",e.SetStateValue="SetStateValue",e.SetCssClass="SetCssClass",e.SetStyle="SetStyle",e))(Te||{}),Cs=(e=>(e.required="required",e.disabled="disabled",e.hidden="hidden",e.pattern="pattern",e.minValue="minValue",e.maxValue="maxValue",e.minLength="minLength",e.maxLength="maxLength",e.css="css",e.style="style",e.theme="theme",e.errorMessage="errorMessage",e.description="description",e.none="none",e))(Cs||{}),_s=(e=>(e.Continue="Continue",e.Stop="Stop",e))(_s||{}),$u=Object.defineProperty,xu=Object.getOwnPropertyDescriptor,br=(e,t,a,r)=>{for(var i=r>1?void 0:r?xu(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&$u(t,a,i),i};let ba=null,oa=class extends St{constructor(){super(...arguments),this.baseUrl="",this.route="",this.consumedRoute="",this.formerState={},this.applyRules=()=>{const e=this.component.rules;if(e&&e.length>0){const t=this.state,a=this.data,r=this.appState,i=this.appData,s=this.component,n=$=>Di($,t,a,{appState:r,appData:i,component:s}),d=$=>qr($,t,a,r,i,{component:s}),c=["state","data","appState","appData","component"],u=[t,a,r,i,s],m={...this.state},v={...this.data};let f=!1,w=!1;for(let $=0;$<e.length;$++){const y=e[$];try{if(n(y.filter)){if(Te.SetStateValue==y.action||Te.SetDataValue==y.action){const S=Te.SetStateValue==y.action?m:v,H=y.fieldName.split(",");for(let ue=0;ue<H.length;ue++){const F=H[ue];if(!S[F]||S[F]!=y.value){const ee=y.expression?d(y.expression):y.value,pe=Cs.none==y.fieldAttribute?F:F+"."+y.fieldAttribute;ee!=S[pe]&&(S[pe]=ee,Te.SetStateValue==y.action&&(f=!0),Te.SetDataValue==y.action&&(w=!0))}}}if(Te.RunAction==y.action&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:y.actionId},bubbles:!0,composed:!0})),Te.RunJS==y.action&&new Function(...c,y.value)(...u),Te.SetAttributeValue==y.action){const S=y.expression?n(y.expression):y.value;if(y.fieldAttribute=="disabled"){S?this.shadowRoot?.getElementById(y.fieldName)?.setAttribute(y.fieldAttribute,"disabled"):this.shadowRoot?.getElementById(y.fieldName)?.removeAttribute(y.fieldAttribute);continue}this.shadowRoot?.getElementById(y.fieldName)?.setAttribute(y.fieldAttribute,S)}if(Te.SetCssClass==y.action&&this.shadowRoot?.getElementById(y.fieldName)?.setAttribute("class",y.value),Te.SetStyle==y.action&&this.shadowRoot?.getElementById(y.fieldName)?.style.setProperty(y.expression,y.value),_s.Stop==y.result)break}}catch(S){console.error("rule failed",y,S)}}f&&(this.state=m),w&&(this.data=v),f&&this.checkValidations()}},this.skipValidation=(e,t)=>e&&t.fieldId&&!e.includes(t.fieldId)||!e&&t.fieldId&&t.fieldId.includes("-"),this.checkValidations=e=>{const t=e?e.split(","):void 0,a=this.component.validations;let r=!0,i=!1;const s=this.data??{},n={...this.data??{},errors:{}};if(a){for(let d=0;d<a.length;d++){const c=a[d];if(this.skipValidation(t,c))continue;const u=(c.fieldId??"_component").split(",");for(let m=0;m<u.length;m++){const v=u[m];n.errors[v]=[]}}for(let d=0;d<a.length;d++){const c=a[d];if(!this.skipValidation(t,c))try{const u=c.condition&&c.condition.includes("${")?this._evalTemplate(c.condition):this._evalExpr(c.condition);if(c.condition&&!u){r=!1;const v=(c.fieldId??"_component").split(",");for(let f=0;f<v.length;f++){const w=v[f];let $=n.errors[w];if($||(n.errors[w]=[]),$=n.errors[w],!s[w]){let y=c.message;try{y=this._evalTemplate(c.message)}catch{}$.push(y)}}}}catch(u){console.error("validation failed",c,u)}}for(let d=0;d<a.length;d++){const c=a[d];if(this.skipValidation(t,c))continue;const u=(c.fieldId??"_component").split(",");for(let m=0;m<u.length;m++){const v=u[m];if(s.errors?[v].join(","):n.errors==""&&[v].join(",")){i=!0;break}}}(s.errors?["_component"].join(","):n.errors==""&&["_component"].join(","))&&(i=!0)}n._valid=r,n._valid!=s._valid&&(i=!0),i&&(this.data=n)},this._autoSaveTimers=new Map,this.onChange=()=>{this.applyRules()},this.closeModalRequestedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&this.closeModal()},this.resetFilters=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail,a={};t.fieldIds.forEach(r=>{a[r]=void 0}),a.searchText=void 0,this.state={...this.state,...a}}},this.dataChangedListener=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail,a={};a[t.key]=t.value,e.type=="data-changed"&&(this.data={...this.data,...a})}},this.valueChangedListener=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail;if(e.type=="value-changed"){const a={...this.state};a[t.fieldId]=t.value,this.state=a,(this.state[t.fieldId]||this.formerState[t.fieldId])&&this.state[t.fieldId]!=this.formerState[t.fieldId]&&this.component?.confirmOnNavigationIfDirty&&this.dispatchEvent(new CustomEvent("dirty",{detail:e.detail,bubbles:!0,composed:!0}));const r=this.component;r.triggers?.filter(i=>i.type==ht.OnValueChange).filter(i=>!i.propertyName||t.fieldId==i.propertyName).forEach(i=>{(!i.condition||this._evalExpr(i.condition))&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:i.actionId},bubbles:!0,composed:!0}))}),r.triggers?.filter(i=>i.type==ht.AutoSave).forEach(i=>{const s=i.actionId,n=this._autoSaveTimers.get(s);n!==void 0&&clearTimeout(n),this._autoSaveTimers.set(s,setTimeout(()=>{this._autoSaveTimers.delete(s),this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:i.actionId},bubbles:!0,composed:!0}))},i.debounceMillis??800))})}}},this.actionRequestedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&this.manageActionRequestedEvent(e)},this.manageActionRequestedEvent=e=>{const t=e.detail;if(e.type=="action-requested"){e.preventDefault(),e.stopPropagation();const a=this.component,r=a.actions?.find(i=>i.id==t.actionId||i.id.endsWith("*")&&t.actionId.startsWith(i.id.replace("*","")));if(r){if(r&&r.rowsSelectedRequired&&(!this.state.crud_selected_items||this.state.crud_selected_items.length==0)){this.notify("You first need to select some rows");return}if(r&&r.validationRequired){const s=ba??this;if(ba=null,s.checkValidations(r.fieldsToValidate),!s.data._valid){s.notifyValidationErrors();return}}ba=null;const i={...t,initiatorComponentId:this.id};r&&r.confirmationRequired?this.callAfterConfirmation(r,()=>this.requestActionCallToServerOrBubble(i,a,r)):this.requestActionCallToServerOrBubble(i,a,r)}else{const i={...t.parameters};i.initiatorState||(i.initiatorState=this.state),ba||(ba=this),this.dispatchEvent(new CustomEvent(e.type,{detail:{...e.detail,parameters:i},bubbles:!0,composed:!0}))}}},this.buildFieldLabelMap=()=>{const e={},t=a=>{if(a)for(const r of a){const i=r.metadata;if(i?.type===h.FormField){const s=i;s.fieldId&&s.label&&(e[s.fieldId]=s.label)}t(r.children)}};return t(this.component?.children),e},this.notifyValidationErrors=()=>{const e=this.data?.errors??{},t=this.buildFieldLabelMap(),a=[];if(Object.entries(e).forEach(([i,s])=>{if(!Array.isArray(s))return;const n=i==="_component"?void 0:t[i]??i;s.forEach(d=>{d&&!a.some(c=>c.label===n&&c.msg===d)&&a.push({label:n,msg:d})})}),a.length===0){this.notify("There are validation errors");return}const r=`There are validation errors
`+a.map(({label:i,msg:s})=>i?`• ${i}: ${s}`:`• ${s}`).join(`
`);Ut({text:r,variant:"error",position:"bottomEnd",duration:Math.max(3e3,1500+a.length*1e3)},this)},this.notify=e=>{Ut({text:e,variant:"error",position:"bottomEnd",duration:3e3},this)},this.callAfterConfirmation=(e,t)=>{let a="One moment, please",r="Are you sure?",i="Yes",s="No";e.confirmationTexts&&(a=e.confirmationTexts.title,r=e.confirmationTexts.message,i=e.confirmationTexts.confirmationText,s=e.confirmationTexts.denialText);const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;z-index:1100;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.35);padding:1rem;";const d=document.createElement("div");d.style.cssText="background:var(--lumo-base-color,#fff);color:var(--lumo-body-text-color,#1a1a1a);border-radius:var(--lumo-border-radius-l,12px);box-shadow:var(--lumo-box-shadow-xl,0 12px 40px rgba(0,0,0,.3));padding:1.2rem;max-width:min(90vw,26rem);";const c=()=>{n.parentElement&&document.body.removeChild(n)},u="font:inherit;font-weight:600;padding:.45rem 1rem;border-radius:var(--lumo-border-radius-m,6px);cursor:pointer;";Pi(o`
        ...
        `,d),n.appendChild(d),n.addEventListener("click",m=>{m.target===n&&c()}),document.body.appendChild(n)},this.requestActionCallToServerOrBubble=(e,t,a)=>{if(a&&a.bubble){const r={...e.parameters};r.initiatorState||(r.initiatorState=this.state),this.dispatchEvent(new CustomEvent("action-requested",{detail:{...e,parameters:r},bubbles:!0,composed:!0}))}else this.requestActionCallToServer(e,t,a)},this.requestActionCallToServer=(e,t,a)=>{if(a&&a.href){window.location.href=a.href;return}if(a&&a.js)try{new Function("state","data","appState","appData","component",a.js).call(this,this.state??{},this.data??{},this.appState??{},this.appData??{},this.component),this.state={...this.state},this.data={...this.data}}catch(r){console.error("when evaluating "+a.js,r,this.component,this.state,this.data)}if(a&&a.customEvent&&this.dispatchEvent(new CustomEvent(a.customEvent.name,{detail:a.customEvent.detail,bubbles:!0,composed:!0})),!(a&&(a.js||a.customEvent))){if(e.actionId=="search"){const r=e.parameters?._searchState;r?this.state={...this.state,...r}:this.state.size||(this.state={...this.state,size:10,page:0,sort:[]})}this.dispatchEvent(new CustomEvent("server-side-action-requested",{detail:{route:this.route,consumedRoute:this.consumedRoute,componentState:{...this.state},parameters:e.parameters??{},actionId:e.actionId,serverSideType:t.serverSideType,serverSideComponentRoute:t.route,initiatorComponentId:e.initiatorComponentId??t.id,initiator:this,background:a?.background,sse:a?.sse,callback:e.callback,callbackonly:e.callbackonly,callbackToken:e.callbackToken??this.callbackToken},bubbles:!0,composed:!0}))}},this.handleBackendSucceeded=e=>{e.detail.actionId&&this.component.triggers?.filter(r=>r.type==ht.OnSuccess).filter(r=>e.detail.actionId==r.calledActionId).forEach(r=>{if(!r.condition||this._evalExpr(r.condition))if(e.preventDefault(),e.stopPropagation(),r.timeoutMillis>0){const i=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.actionId,callbackToken:i},bubbles:!0,composed:!0}))},r.timeoutMillis)}else this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.actionId},bubbles:!0,composed:!0}))})},this.handleBackendFailed=e=>{e.detail.actionId&&this.component.triggers?.filter(r=>r.type==ht.OnError).filter(r=>e.detail.actionId==r.calledActionId).forEach(r=>{(!r.condition||this._evalExpr(r.condition))&&(e.preventDefault(),e.stopPropagation(),this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.actionId},bubbles:!0,composed:!0})))})},this._keydownListener=e=>{if(this._handleTabShortcut(e))return;const t=this.component;if(t)for(const a of t.actions??[]){const r=a.shortcut||(a.runOnEnter?"enter":null);if(r&&this._shortcutMatchesEvent(r,e)){e.preventDefault(),this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.id},bubbles:!0,composed:!0}));return}}}}createRenderRoot(){return B.mustUseShadowRoot()?super.createRenderRoot():this}updated(e){super.updated(e),e.has("state")&&this.state&&JSON.stringify(this.state)!=JSON.stringify({})&&this.onChange(),e.has("component")&&(this.formerState={...this.state},this.component?.confirmOnNavigationIfDirty&&this.dispatchEvent(new CustomEvent("clean",{detail:{},bubbles:!0,composed:!0})),setTimeout(()=>this.triggerOnLoad()))}_shortcutMatchesEvent(e,t){return En(e,t)}_collectShortcutTabs(){const e=this.renderRoot;if(!e)return[];const t=Array.from(e.querySelectorAll("vaadin-tab[data-shortcut]"));return e.querySelectorAll("mateu-drawer, mateu-dialog").forEach(a=>{const r=a.shadowRoot;r&&t.push(...Array.from(r.querySelectorAll("vaadin-tab[data-shortcut]")))}),t}_handleTabShortcut(e){const t=this._collectShortcutTabs();if(t.length===0)return!1;for(const a of Array.from(t)){const r=a.dataset.shortcut;if(!r||!this._shortcutMatchesEvent(r,e))continue;const i=a.closest("vaadin-tabs");if(!i)continue;const s=Array.from(i.querySelectorAll("vaadin-tab")).indexOf(a);if(!(s<0))return e.preventDefault(),i.selected=s,!0}return!1}connectedCallback(){super.connectedCallback(),this.addEventListener("backend-call-succeeded",this.handleBackendSucceeded),this.addEventListener("backend-call-failed",this.handleBackendFailed),document.addEventListener("keydown",this._keydownListener)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("backend-call-succeeded",this.handleBackendSucceeded),this.removeEventListener("backend-call-failed",this.handleBackendFailed),document.removeEventListener("keydown",this._keydownListener)}render(){return o`<div>
            ...
            `:l}</div>`}_render(){if(this.component?.type==W.ClientSide){const e=this.component;return e.metadata?.type==h.Page?Or(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):e.metadata?.type==h.Crud?zr(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):B.get()?.renderClientSideComponent(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!1)}return o`
            <mateu-api-caller 
            ...
            ${this.component?.children?.map(e=>{if(e.type==W.ClientSide){const t=e;if(t.metadata?.type==h.Page)return Or(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0);if(t.metadata?.type==h.Crud)return zr(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0)}return g(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData)})}
            </mateu-api-caller>
        `}};oa.styles=x`
        :host {
        }
  ...
  `;br([p()],oa.prototype,"baseUrl",2);br([p()],oa.prototype,"route",2);br([p()],oa.prototype,"consumedRoute",2);oa=br([k("mateu-component")],oa);const hi=e=>{if(e)try{return JSON.parse(e)}catch{return{value:e}}else return{}};class wu{async handle(t,a){return await t.runAction(a.baseUrl,a.route,a.consumedRoute,a.actionId,a.initiatorComponentId,a.appState,a.serverSideType,a.componentState,a.parameters,a.initiator,a.background)}}const ku=new wu;class Cu{constructor(){this.handleUIIncrement=(t,a,r)=>{if(t?.fragments?.forEach(i=>{Lt.next({command:void 0,fragment:i,ui:void 0,error:void 0,callbackToken:r})}),t?.appState&&(G.value={...t.appState},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))),t?.appData){const i=t?.appData;$a.value={...t.appData,...i},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))}t?.messages?.forEach(i=>{Ut({text:i.text,position:i.position,variant:i.variant,duration:i.duration,undoLabel:i.undoLabel,undoActionId:i.undoActionId,undoParameters:i.undoParameters},a)}),t?.banners&&t.banners.length>0&&document.dispatchEvent(new CustomEvent("page-banners-received",{detail:{banners:t.banners,append:t.appendBanners??!1},bubbles:!1,composed:!1})),t?.commands?.forEach(i=>{Lt.next({command:i,fragment:void 0,ui:void 0,error:void 0,callbackToken:r})})}}async runAction(t,a,r,i,s,n,d,c,u,m,v,f,w,$,y){try{const S=await ku.handle(t,{baseUrl:a,route:r,consumedRoute:i,actionId:s,appState:G.value,initiatorComponentId:n,componentState:u,parameters:m,serverSideType:c,initiator:v,background:f});w&&w(S),$||this.handleUIIncrement(S,v,y),S.messages&&S.messages.length==1&&S.messages[0].variant=="error"&&v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:s},bubbles:!0,composed:!0})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:s,evevntId:$e()},bubbles:!0,composed:!0}))}catch(S){console.warn("Action request failed",S),v.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:s,reason:this.serialize(S)}})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:s},bubbles:!0,composed:!0}))}}serialize(t){return t?.message?t:JSON.stringify(t)}}const _u=new Cu,Iu=_u;class Su{constructor(){this.handleUIIncrement=(t,a,r)=>{if(t?.messages?.forEach(i=>{Ut({text:i.text,position:i.position,variant:i.variant,duration:i.duration,undoLabel:i.undoLabel,undoActionId:i.undoActionId,undoParameters:i.undoParameters},a)}),t?.banners&&t.banners.length>0&&document.dispatchEvent(new CustomEvent("page-banners-received",{detail:{banners:t.banners,append:t.appendBanners??!1},bubbles:!1,composed:!1})),t?.commands?.forEach(i=>{Lt.next({command:i,fragment:void 0,ui:void 0,error:void 0,callbackToken:r})}),t?.fragments?.forEach(i=>{Lt.next({command:void 0,fragment:i,ui:void 0,error:void 0,callbackToken:r})}),t?.appState&&(G.value={...t.appState},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))),t?.appData){const i=t?.appData;$a.value={...t.appData,...i},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))}}}async runAction(t,a,r,i,s,n,d,c,u,m,v,f,w,$,y){if(r){r=r||"_no_route",r&&r.startsWith("/")&&(r=r.substring(1));const S={serverSideType:c,appState:G.value,componentState:u,parameters:m,initiatorComponentId:n,consumedRoute:i,route:"/"+r,actionId:s};f||v.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),fetch(a+"/mateu/v3/sse/"+r,{method:"POST",headers:{Accept:"text/event-stream","Content-Type":"application/json"},body:JSON.stringify(S)}).then(async H=>{const ue=H.body?.pipeThrough(new TextDecoderStream).getReader();if(ue){let F="";for(;;){const{value:ee,done:pe}=await ue.read();if(pe)break;F+=ee;const J=F.split(`

`);F=J.pop()??"";for(const te of J){const ae=te.trim();if(ae)if(ae.startsWith("data:")){const be=JSON.parse(ae.substring(5).trim());w&&w(be),$||this.handleUIIncrement(be,v,y),be.messages&&be.messages.length==1&&be.messages[0].variant=="error"&&v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:s},bubbles:!0,composed:!0}))}else{let be=ae;try{const _=JSON.parse(ae);be=_.message,_._embedded?.errors?.length>0&&_._embedded.errors[0].message&&(be=_._embedded.errors[0].message)}catch{}throw new Error(be)}}}}f||v.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:s}})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:s},bubbles:!0,composed:!0}))}).catch(H=>{v.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:s,reason:this.serialize(H)}})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:s},bubbles:!0,composed:!0}))})}}serialize(t){return t?.message?t:JSON.stringify(t)}}const Is=new Su,Eu={fixed:"fixed",fullWidth:"full",edgeToEdge:"edge"},Pu=new Set([h.Gantt,h.PlanningBoard,h.Kanban,h.Bpmn,h.Workflow,h.Map]),Tu={landing:"fixed",form:"fixed",process:"fixed"},Ss=e=>e?Eu[e]:void 0,Vt=e=>e.type==W.ClientSide?e.metadata:void 0,Es=e=>{const t=Vt(e);if(t?.type==h.Page){const a=Ss(t.pageWidth);if(a)return a}for(const a of e.children??[]){const r=Es(a);if(r)return r}},Ps=e=>{const t=e.pageType;if(t)return t;const a=r=>{const i=Vt(r);if(i?.type==h.Page&&i.pageType)return i.pageType;for(const s of r.children??[]){const n=a(s);if(n)return n}};return a(e)},Ou=e=>{const t=Vt(e);if(t?.type!=h.Crud)return!1;const a=t;return a.compact?!0:(a.columns??[]).some(r=>r.metadata?.editable)},or=(e,t)=>t(e)||(e.children??[]).some(a=>or(a,t)),zu=e=>!!e&&or(e,t=>Vt(t)?.type==h.HeroSection),Ru=e=>Vt(e)?.type==h.App?!0:(e.children??[]).some(t=>Vt(t)?.type==h.App),Lu=(e,t)=>{if(!e)return"fixed";const a=Ss(e.pageWidth)??Es(e);if(a)return a;if(t?.top&&Ru(e))return"edge";const r=Tu[Ps(e)??""];return r||(or(e,i=>{const s=Vt(i)?.type;return s!=null&&Pu.has(s)})?"edge":or(e,Ou)?"full":"fixed")};var Du=Object.defineProperty,Au=Object.getOwnPropertyDescriptor,fe=(e,t,a,r)=>{for(var i=r>1?void 0:r?Au(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Du(t,a,i),i};let Z=class extends lr{constructor(){super(...arguments),this.consumedRoute="",this.serverSideType=void 0,this.uriPrefix=void 0,this.overrides=void 0,this.homeRoute=void 0,this.route=void 0,this.top=void 0,this.appState={},this.appData={},this.preventNavigation=!1,this.overridesParsed={},this.fragment=void 0,this.actionRequestedListener=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.manageActionEvent(e))},this.historyPushed=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.preventNavigation=!0,this.route=e.detail.route)},this.routeChangedListener=e=>{if(e instanceof CustomEvent){e.preventDefault(),e.stopPropagation();let t=e.detail.route;typeof t=="string"&&(t===""||t.startsWith("/"))&&this.consumedRoute&&this.consumedRoute!=="_empty"&&this.consumedRoute.startsWith("/")&&!t.startsWith(this.consumedRoute)&&(t=this.consumedRoute+t),this.uriPrefix&&(t.startsWith("/")&&this.uriPrefix.endsWith("/")?t=this.uriPrefix+t.substring(1):!t.startsWith("/")&&!this.uriPrefix.endsWith("/")?t=this.uriPrefix+"/"+t:t=this.uriPrefix+t),this.dispatchEvent(new CustomEvent("url-update-requested",{detail:{route:t},bubbles:!0,composed:!0}))}},this.backendFailedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&e.detail.actionId==""&&(this.fragment={targetComponentId:this.id,data:{},state:{},component:{type:W.ClientSide,metadata:{type:h.Element,name:"div",content:"Not found"},id:"fieldId"},action:xa.Replace,containerId:void 0})},this.detail1=void 0,this.manageActionEvent=e=>{e.preventDefault(),e.stopPropagation(),this.detail1=e.detail;const t=this.detail1;if(e.type=="server-side-action-requested"){let a=Iu;t.sse&&(a=Is),a.runAction(Kt,this.baseUrl,t.route??"",t.consumedRoute,t.actionId,t.initiatorComponentId,this.getCustomisedAppState(),t.serverSideType,t.componentState,t.parameters,t.initiator,t.background,t.callback,t.callbackonly,t.callbackToken)}},this.getCustomisedAppState=()=>{let e={...G.value};if(this.overrides){const t=hi(this.overrides);e={...e,...t}}return e}}manageActionRequestedEvent(e){throw new Error("Method not implemented.")}createRenderRoot(){return B.mustUseShadowRoot()?super.createRenderRoot():this}connectedCallback(){super.connectedCallback(),this.overridesParsed=hi(this.overrides),this.addEventListener("server-side-action-requested",this.actionRequestedListener),this.addEventListener("backend-call-failed",this.backendFailedListener),this.addEventListener("history-pushed",this.historyPushed),this.addEventListener("route-changed",this.routeChangedListener)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("server-side-action-requested",this.actionRequestedListener),this.removeEventListener("backend-call-failed",this.backendFailedListener),this.removeEventListener("history-pushed",this.historyPushed),this.removeEventListener("route-changed",this.routeChangedListener)}shouldUpdate(e){if(this.fragment?.component&&[...e.keys()].every(a=>a==="appState"||a==="appData")){const a=this.renderRoot.querySelector("mateu-component");if(a)return e.has("appState")&&(a.appState=this.appState),e.has("appData")&&(a.appData=this.appData),!1}return!0}updated(e){(e.has("id")||e.has("baseurl")||e.has("route")||e.has("consumedRoute")||e.has("instant"))&&(this.preventNavigation||(this.callbackToken=this.instant||$e(),this.manageActionEvent(new CustomEvent("server-side-action-requested",{detail:{route:this.route,consumedRoute:this.consumedRoute,userData:void 0,actionId:"",serverSideType:this.serverSideType,initiatorComponentId:this.id,initiator:this,componentState:this.initialState,callbackToken:this.callbackToken},bubbles:!0,composed:!0})))),e.has("route")&&this.top&&(this.preventNavigation||this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:this.route},bubbles:!0,composed:!0}))),this.preventNavigation&&(this.preventNavigation=!1)}applyFragment(e){if(!e.component&&this.fragment?.component){this.fragment={...this.fragment,state:{...this.fragment.state??{},...e.state??{}},data:{...this.fragment.data??{},...e.data??{}}};return}this.fragment=e,e.component&&(this.dataset.pageWidth=Lu(e.component,{top:this.top}),this.dataset.pageType=Ps(e.component)??"",this.dataset.hasWelcomeBanner=String(zu(e.component)))}render(){return o`
  ...
  `;lt([p()],De.prototype,"baseUrl",2);lt([p()],De.prototype,"route",2);lt([p()],De.prototype,"consumedRoute",2);lt([p()],De.prototype,"config",2);lt([p()],De.prototype,"top",2);lt([p()],De.prototype,"pathPrefix",2);lt([b()],De.prototype,"instant",2);lt([p({type:Boolean})],De.prototype,"debug",2);De=lt([k("mateu-ui")],De);var Bu=Object.defineProperty,Vu=Object.getOwnPropertyDescriptor,Xt=(e,t,a,r)=>{for(var i=r>1?void 0:r?Vu(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Bu(t,a,i),i};let Ae=class extends C{constructor(){super(...arguments),this.baseUrl="",this.opened=!1,this.searchText=""}connectedCallback(){super.connectedCallback(),ho()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick(),this.searchTimer&&clearTimeout(this.searchTimer)}currentValue(){return String(Fr()[this.selector.fieldName]??"")}currentLabel(){const e=this.currentValue();if(!e)return"—";const t=(this.searchedOptions??this.selector.options)?.find(r=>String(r.value)===e);if(t)return t.label;const a=Ri()[this.selector.fieldName];return a!==void 0?String(a):e}pick(e,t){po(this.selector.fieldName,e,t),window.location.reload()}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}openPanel(){this.opened||(this.opened=!0,this.searchText="",this.searchedOptions=void 0,this.remoteSearch(),this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick),this.updateComplete.then(()=>this.renderRoot.querySelector("input.picker-search")?.focus()))}closePanel(){this.detachOutsideClick(),this.opened=!1}onSearchInput(e){this.searchText=e.target.value,this.searchTimer&&clearTimeout(this.searchTimer),this.searchTimer=setTimeout(()=>this.remoteSearch(),300)}async remoteSearch(){const e=this.app;if(e?.serverSideType)try{const t=await Kt.runAction(this.baseUrl??"",e.rootRoute??e.initialRoute??"","",`_appcontext-search-${this.selector.fieldName}`,`appcontext-${this.selector.fieldName}`,void 0,e.serverSideType,{},{searchText:this.searchText},this,!0);for(const a of t?.fragments??[]){const s=a.data?.[`_appcontext_${this.selector.fieldName}`]?.content;if(Array.isArray(s)){this.searchedOptions=s.map(n=>({value:n.value,label:n.label??String(n.value)}));return}}}catch{}}visibleOptions(){const e=this.searchedOptions??this.selector.options??[],t=this.searchText.trim().toLowerCase();return t?e.filter(a=>a.label.toLowerCase().includes(t)):e}renderPanel(){const e=this.currentValue(),t=this.visibleOptions(),a=this.searchText!==""||t.length>Ae.SEARCHABLE_THRESHOLD;return o`
            ...
            </label>`:o``}};Ae.SEARCHABLE_THRESHOLD=7;Ae.styles=x`
        :host {
            display: inline-flex;
            position: relative;
            flex-shrink: 0;
    ...
    `;Fa([p()],Ht.prototype,"app",2);Fa([p()],Ht.prototype,"baseUrl",2);Fa([b()],Ht.prototype,"opened",2);Fa([b()],Ht.prototype,"notifications",2);Ht=Fa([k("mateu-notification-bell")],Ht);const Ts=e=>{if(!e||!("querySelectorAll"in e))return null;for(const t of e.querySelectorAll("*")){if(t.tagName?.toLowerCase()==="mateu-component")return t;const a=Ts(t.shadowRoot);if(a)return a}return null},Gu=async(e,t,a)=>{const r=t.renderRoot??t,i=Ts(r);await Is.runAction(Kt,t.baseUrl??"",e.rootRoute||"_no_route","",a,i?.id??"app-header-action",{},e.serverSideType??"",{},{},i??t,!0,void 0,!1,"")},mi=async(e,t,a)=>{try{await Gu(e,t,a)}catch(r){Ut({text:"La acción falló: "+r,position:"bottomStart",duration:6e3,variant:"error"},t)}},ga=(e,t)=>{const a=e.contextSelectors??[],r=e.contextActions??[];return a.length===0&&r.length===0&&!e.notificationsEnabled?l:o`${e.notificationsEnabled?o`
        ...
        <details class="mateu-nav-group" style="margin-left: 0.5rem; flex-shrink: 0;">
            ...
            <div class="mateu-nav-panel" style="right: 0; left: auto;">
                ${i.children.map(s=>o`
                    <button class="mateu-nav-item" @click="${()=>s.actionId&&mi(e,t,s.actionId)}">${s.label}</button>`)}
            </div>
        </details>`:o`
        <button class="app-header-action-btn" style="margin-left: 0.5rem; flex-shrink: 0;"
            @click="${()=>i.actionId&&mi(e,t,i.actionId)}" title="${i.label}">${i.icon?U(i.icon):l}${i.label}</button>`)}`},vi=(e,t)=>o`
    <button class="mateu-nav-item ${e.selected?"mateu-nav-item--active":""}"
            ?disabled="${e.disabled}"
            @click="${()=>t(e)}">${e.text}</button>`,fi=(e,t,a="")=>o`
    <nav class="mateu-nav ${a}">
        ${e.map(r=>(r.children?.length??0)>0?o`<details class="mateu-nav-group">
                       ...
                       <div class="mateu-nav-panel">
                           ${r.children.map(i=>vi(i,t))}
                       </div>
                   </details>`:vi(r,t))}
    </nav>`,bi=(e,t)=>a=>t.call(e,{detail:{value:a}}),ja=(e,t)=>e.themeToggle?o`
    ...
    `:l,Ku=(e,t)=>{t.filter!=e.detail.value&&(t.filter=e.detail.value)},gi=(e,t,a)=>{const r=tt(e,t,a),i=ie(t,a);return r=="list"||r==i?"new":r},tt=(e,t,a)=>{const r=e?._route;if(r!=null&&(r===""||r.startsWith("/"))){const i=a.homeRoute??"",s=i.indexOf("?"),n=s>=0?i.substring(s+1):"",d=ie(t,a)+r;if(!n)return d;const c=d.indexOf("?")>=0?"&":"?";return d+c+n}return t.selectedRoute?t.selectedRoute:a.homeRoute},ie=(e,t)=>e.selectedRoute?e.selectedConsumedRoute??t.route:t.homeConsumedRoute,je=(e,t)=>e.selectedRoute?e.selectedBaseUrl??e.baseUrl:t.homeBaseUrl,Be=(e,t)=>e.selectedRoute?e.selectedServerSideType??t.serverSideType:t.homeServerSideType,Ve=(e,t)=>e.selectedRoute?e.selectedUriPrefix:t.homeUriPrefix,Yu=(e,t,a,r,i,s,n)=>{if(t.chromeless)return o`
        ...
        `;const d=e.mapItems(t.menu,e.filter?.toLowerCase()??""),c=ie(e,t),u=gi(r,e,t),m=u&&u!=="new"&&u.startsWith(c+"/")?u.substring(c.length+1).split("/")[0]:void 0;return o`
...
`:l}
                            ...
                            ${t.menu&&t.totalMenuOptions>10?o`
                                <div style="position: sticky; top: 0; z-index: 2; background: var(--lumo-base-color); padding: .25rem 0 .5rem;">
                                    <input class="drawer-search" placeholder="Search…" style="width: calc(100% - 20px); margin: 0 10px;"
                                           @input="${v=>Ku({detail:{value:v.target.value}},e)}">
                                </div>
                                `:l}
                            <nav class="side-nav">
            ...
            ${t.variant==at.MENU_ON_TOP?o`
                <div class="m-vl" style="width: 100%; height: 100vh; overflow: hidden;">
                    <div class="m-hl"
                        ...
                        ${fi(d,bi(e,e.itemSelected),"menu-on-top")}
            ...
            ${t.variant==at.TILES?o`
                <div class="m-vl" style="width: 100%; height: 100vh; overflow: hidden;">
                    <div class="m-hl"
                        ...
                        ${fi(e.mapItemsForTiles(t.menu),bi(e,e.itemSelectedTiles),"menu-on-top")}
                        <div class="m-hl" style="flex-shrink: 0; align-items: center;">
                            <slot name="widgets"></slot>
                            ${ga(t,e)}${ja(t,e)}
                        </div>
            ...
            <slot></slot>
       `},Ju=(e,t)=>t!=null&&e!=null&&!e.has(t),Xu=typeof HTMLElement<"u"?HTMLElement:class{};class Qu extends Xu{static get observedAttributes(){return["type","renderer"]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){const t=this.getAttribute("type")??"unknown",a=this.getAttribute("renderer")??"unknown";this.shadowRoot||this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host { display: block; }
                .mateu-unsupported {
                    box-sizing: border-box;
        ...
        `}}typeof customElements<"u"&&!customElements.get("mateu-unsupported")&&customElements.define("mateu-unsupported",Qu);const yi=new Set,Zu=(e,t,a)=>{const r=`${a}/${t}`;return yi.has(r)||(yi.add(r),console.warn(`[mateu] Component type "${t}" is not supported by the "${a}" renderer — rendering <mateu-unsupported> placeholder.`)),o`<mateu-unsupported
            type="${t}"
            renderer="${a}"
            data-component-id="${e?.id??l}"
            slot="${e?.slot??l}"
    ></mateu-unsupported>`};class ep{renderFilterBar(t,a,r,i,s,n,d,c){const u=a?.metadata,m=f=>{const{fieldId:w,value:$}=f.detail;t.state={...t.state,[w]:$}},v=f=>{const{fieldIds:w}=f.detail,$={};w.forEach(y=>{$[y]=void 0}),$.searchText=void 0,t.state={...t.state,...$}};return o`
            <mateu-filter-bar
                .metadata="${u}"
        ...
        ></mateu-pagination>
        `}renderTableComponent(t,a,r,i,s,n,d){const c=t.data?.[t.id]?.page?.content??[];return Tr(a,c,i[a?.id]?.emptyStateMessage)}rendererName(){return this.constructor?.name??"unknown"}supportedClientSideTypes(){}renderClientSideComponent(t,a,r,i,s,n,d,c){const u=a?.metadata?.type??a?.type,m=Object.values(h).includes(u)?u:void 0;return Ju(this.supportedClientSideTypes(),m)?Zu(a,m,this.rendererName()):Kr(t,a,r,i,s,n,d,c)}renderAppComponent(t,a,r,i,s,n,d){return Yu(t,a?.metadata,r,i,s,n,d)}}const tp=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=u=>o`${g(e,u,a,r,i,s,n)}`;return o`
        <vaadin-virtual-list
                ...
                slot="${t.slot??l}"
        ></vaadin-virtual-list>
    `},ap=e=>{const t=e.metadata;return o`
        <vaadin-notification
                .opened="${!0}"
                slot="${e.slot??l}"
                style="${e.style}"
                ...
                `,[])}
        ></vaadin-notification>
    `},rp=(e,t={})=>{const a=e.metadata,r=a.valueKey?t[a.valueKey]:a.value;return o`
        <div style="${e.style}">
        <vaadin-progress-bar
    ...
    `},ip=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
        <vaadin-details
                ?opened="${d.opened}"
                style="${t.style}"
                class="${t.cssClasses}"
        ...
        >
            ...
            `},sp=(e,t,a)=>{const r=e.metadata;return o`<vaadin-avatar
            img="${r.image}"
            name="${Oe(r.name,t,a)}"
            abbr="${r.abbreviation}"
            style="${e.style}" class="${e.cssClasses}"
            slot="${e.slot??l}"
    ></vaadin-avatar>`},op=e=>{const t=e.metadata;return o`<vaadin-avatar-group max-items-visible="${t.maxItemsVisible}"
                                     .items="${t.avatars}"
                                     style="${e.style}" class="${e.cssClasses}"
                                     slot="${e.slot??l}">
    </vaadin-avatar-group>`},np=(e,t,a,r,i,s,n)=>{const d=t.metadata;if(!d)return o``;let c="";return d.variants?.map(u=>u=="stretchMedia"?"stretch-media":u=="coverMedia"?"cover-media":u).forEach(u=>c+=" "+u),c=c.trim(),o`
        <vaadin-card
                style="${t.style}"
                class="${t.cssClasses}"
                theme="${c}"
                slot="${t.slot??l}"
        >
            ${d.media?Ot(e,d.media,a,r,i,s,n,"media",!1):l}
            ${d.title?Ot(e,d.title,a,r,i,s,n,"title",!1):l}
            ${d.subtitle?Ot(e,d.subtitle,a,r,i,s,n,"subtitle",!1):l}
            ${d.header?Ot(e,d.header,a,r,i,s,n,"header",!1):l}
            ${d.headerPrefix?Ot(e,d.headerPrefix,a,r,i,s,n,"header-prefix",!1):l}
            ${d.headerSuffix?Ot(e,d.headerSuffix,a,r,i,s,n,"header-suffix",!1):l}
            ${d.footer?Ot(e,d.footer,a,r,i,s,n,"footer",!1):l}
            ${d.content?g(e,d.content,a,r,i,s,n,!1):l}
        </vaadin-card>
    `},lp=640,dp=e=>e>0&&e<lp?"accordion":"tabs";var cp=Object.defineProperty,up=Object.getOwnPropertyDescriptor,gr=(e,t,a,r)=>{for(var i=r>1?void 0:r?up(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&cp(t,a,i),i};let na=class extends C{constructor(){super(...arguments),this.tabLabels=[],this.mode="tabs",this.selected=0,this.selectedChangedListener=e=>{const t=e.detail?.value;typeof t=="number"&&t>=0&&(this.selected=t)}}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{for(const t of e)this.mode=dp(t.contentRect.width)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.resizeObserver=void 0,this.detachTabsListener()}detachTabsListener(){this.slottedTabs?.removeEventListener("selected-changed",this.selectedChangedListener),this.slottedTabs=void 0}tabsSlotChanged(e){this.detachTabsListener();const a=e.target.assignedElements().find(r=>"selected"in r);a&&(this.slottedTabs=a,a.addEventListener("selected-changed",this.selectedChangedListener),a.selected=this.selected)}select(e){this.selected=e,this.slottedTabs&&(this.slottedTabs.selected=e)}updated(){this.slottedTabs&&this.slottedTabs.selected!=this.selected&&(this.slottedTabs.selected=this.selected)}render(){return o`
    ...
    `;gr([p({type:Array})],na.prototype,"tabLabels",2);gr([b()],na.prototype,"mode",2);gr([b()],na.prototype,"selected",2);na=gr([k("mateu-adaptive-tabs")],na);const pp=(e,t,a,r,i,s,n)=>{const d=t.metadata;let c=t.style;c==null&&(c=""),d.columnSpacing&&(c+="--vaadin-form-layout-column-spacing: "+d.columnSpacing+";");const u=d.itemRowSpacing&&d.itemRowSpacing!=="0"?d.itemRowSpacing:"var(--lumo-space-m)";return c+="--vaadin-form-layout-row-spacing: "+u+";",d.itemLabelSpacing&&(c+="--vaadin-form-layout-label-spacing: "+d.itemLabelSpacing+";"),d.labelsAside&&(c+="--vaadin-form-item-label-width: 10rem;"),d.fullWidth&&(c+="width: 100%;"),o`
               <vaadin-form-layout 
                       ...
                       slot="${t.slot||l}"
               >
                   ${t.children?.map(m=>Os(d,e,m,a,r,i,s,n))}
               </vaadin-form-layout>
            `},Os=(e,t,a,r,i,s,n,d)=>a.type==W.ClientSide&&a.metadata?.type==h.FormRow?mp(e,t,a,r,i,s,n,d):e.labelsAside?hp(t,a,r,i,s,n,d):g(t,a,r,i,s,n,d),hp=(e,t,a,r,i,s,n)=>{if(t.type==W.ClientSide&&t.metadata?.type==h.FormField&&t.metadata.label){const d=t.metadata,c=d.label?.includes("${")?e._evalTemplate(d.label):d.label;return o`
                       <vaadin-form-item data-colspan="${d.colspan}">
                           <label slot="label">${c}</label>
                           ${g(e,t,a,r,i,s,n,!0)}
                       </vaadin-form-item>
                   `}return g(e,t,a,r,i,s,n)},mp=(e,t,a,r,i,s,n,d)=>o`
        <vaadin-form-row>
            ${a.children?.map(c=>Os(e,t,c,r,i,s,n,d))}
        </vaadin-form-row>
            `,vp=(e,t,a,r,i,s,n)=>{const d=t.metadata,c=(d.padding?" padding":"")+(d.spacing?" spacing":"")+(d.spacingVariant?" spacing-"+d.spacingVariant:"")+(d.wrap?" wrap":"");let u=t.style;return d.fullWidth&&(u=u?"width: 100%;"+u:"width: 100%;"),d.justification&&(u=u?"justify-content: "+d.justification+";"+u:"justify-content: "+d.justification+";"),d.verticalAlignment&&(u=u?"align-items: "+d.verticalAlignment+";"+u:"align-items: "+d.verticalAlignment+";"),o`
               <vaadin-horizontal-layout 
                       style="${u}" 
                       class="${t.cssClasses}"
                       theme="${c}"
    ...
    `},bp=(e,t,a,r,i,s,n)=>{const d=t.metadata;let c=t.style;return d.fullWidth&&(c=c?"width: 100%;"+c:"width: 100%;"),o`
               <vaadin-split-layout 
                       style="${c}" 
                       class="${t.cssClasses}"
            ...
            `},gp=(e,t,a,r,i,s,n)=>{const d=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,u=!!i?.hasDetail||!!d,m=c??d;return o`
            ...
            `},yp=(e,t,a,r,i,s,n)=>{const d=t.metadata;let c=t.style;c==null&&(c=""),d.fullWidth&&(c+="width: 100%;");let u=d.variant;u=="equalWidth"&&(u="equal-width-tabs");const m=Math.max(0,(t.children??[]).findIndex(f=>f.metadata.active)),v=f=>{f.target.selected=m};if(d.adaptable){const f=(t.children??[]).map(w=>{const $=w.metadata.label;return $?.includes("${")?e._evalTemplate($):$});return o`
            <mateu-adaptive-tabs
                    .tabLabels="${f}"
                    style="${c}"
                    class="${t.cssClasses}"
            ...
            >
                <vaadin-tabs slot="tabs"
                             ...
                             @items-changed=${v}
                >
                    ${t.children?.map(w=>w).map((w,$)=>{const y=w.metadata.shortcut;return o`
                        <vaadin-tab id="${f[$]}"
                                    style="${w.style}"
                                    class="${w.cssClasses}"
                                    data-shortcut="${y??l}"
        ...
        >
            <vaadin-tabs slot="tabs"
                         ...
                         @items-changed=${v}
            >
                ${t.children?.map(f=>f).map(f=>{const w=f.metadata.label,$=w?.includes("${")?e._evalTemplate(w):w,y=f.metadata.shortcut;return o`
                    <vaadin-tab id="${$}"
                                style="${f.style}"
                                class="${f.cssClasses}"
                                data-shortcut="${y??l}"
            ...
            ${t.children?.map(f=>$p(e,f,a,r,i,s,n))}
        </vaadin-tabsheet>
            `},$p=(e,t,a,r,i,s,n)=>{const d=t.metadata.label,c=d?.includes("${")?e._evalTemplate(d):d;return o`
        <div tab="${c}" style="padding: var(--lumo-space-m) 0;">
                   ${t.children?.map(u=>g(e,u,a,r,i,s,n))}
               </div>
            `},xp=(e,t,a,r,i,s,n)=>{const d=t.metadata;t.style,d.fullWidth;let c=0;if(t.children){for(let u=0;u<t.children.length;u++)if(t.children[u].metadata?.active){c=u;break}}return o`
               <vaadin-accordion
                       style="${t.style}"
                       class="${t.cssClasses}"
                       opened="${c}"
                       slot="${t.slot??l}"
               >
                   ${t.children?.map(u=>wp(e,u,a,r,i,s,n,d.variant))}
               </vaadin-accordion>
            `},wp=(e,t,a,r,i,s,n,d)=>{const c=t.metadata,u=c.label?.includes("${")?e._evalTemplate(c.label):c.label;return o`
        ...
        <vaadin-context-menu .items=${Xr(e,d.menu,a,r,i,s,n)} 
                             style="${t.style}" 
                             class="${t.cssClasses}"
            ...
            `},Ep=(e,t,a,r,i)=>{const s=t.metadata;return o`
        <vaadin-menu-bar .items=${Xr(e,s.options,a,r,i,G,$a)}
                         style="${t.style}" class="${t.cssClasses}"
                         slot="${t.slot??l}">
        </vaadin-menu-bar>
            `},$i=(e,t,a,r,i,s,n)=>{const d=document.createElement("vaadin-context-menu-item");return Pi(g(e,t,a,r,i,s,n),d),d},Xr=(e,t,a,r,i,s,n)=>t.map(d=>d.submenus?{text:d.component?void 0:d.label,route:d.path,checked:d.selected,disabled:d.disabled,className:d.className,component:d.component?$i(e,d.component,a,r,i,s,n):void 0,children:Xr(e,d.submenus,a,r,i,s,n)}:d.separator?{component:"hr"}:{text:d.component?void 0:d.label,route:d.path,checked:d.selected,disabled:d.disabled,className:d.className,component:d.component?$i(e,d.component,a,r,i,s,n):void 0});var Pp=Object.defineProperty,Tp=Object.getOwnPropertyDescriptor,qa=(e,t,a,r)=>{for(var i=r>1?void 0:r?Tp(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Pp(t,a,i),i};let Wt=class extends C{constructor(){super(...arguments),this.fieldId="",this.signing=!1,this.hasStrokes=!1,this.drawing=!1,this.startStroke=e=>{const t=e.target;this.ensureCanvasSize(t),t.setPointerCapture(e.pointerId),this.drawing=!0;const a=t.getContext("2d");a.lineWidth=2,a.lineCap="round",a.lineJoin="round",a.strokeStyle=getComputedStyle(this).getPropertyValue("--lumo-body-text-color")||"#1a1a1a";const[r,i]=this.pointerPosition(e);a.beginPath(),a.moveTo(r,i),e.preventDefault()},this.stroke=e=>{if(!this.drawing)return;const a=e.target.getContext("2d"),[r,i]=this.pointerPosition(e);a.lineTo(r,i),a.stroke(),this.hasStrokes=!0,e.preventDefault()},this.endStroke=e=>{this.drawing=!1,e.target.releasePointerCapture(e.pointerId)}}emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e,fieldId:this.fieldId},bubbles:!0,composed:!0}))}canvas(){return this.renderRoot.querySelector("canvas")}pointerPosition(e){const a=e.target.getBoundingClientRect();return[e.clientX-a.left,e.clientY-a.top]}ensureCanvasSize(e){const t=e.getBoundingClientRect();(e.width!==Math.round(t.width)||e.height!==Math.round(t.height))&&(e.width=Math.round(t.width),e.height=Math.round(t.height))}clear(){const e=this.canvas();e&&e.getContext("2d").clearRect(0,0,e.width,e.height),this.hasStrokes=!1}accept(){const e=this.canvas();!e||!this.hasStrokes||(this.signing=!1,this.emit(e.toDataURL("image/png")))}renderPad(){return o`
            <canvas class="pad"
    ...
    `;Ma([p()],Gt.prototype,"fieldId",2);Ma([p()],Gt.prototype,"value",2);Ma([b()],Gt.prototype,"cameraOpen",2);Ma([b()],Gt.prototype,"cameraError",2);Gt=Ma([k("mateu-camera-capture")],Gt);var Dp=Object.defineProperty,Ap=Object.getOwnPropertyDescriptor,Na=(e,t,a,r)=>{for(var i=r>1?void 0:r?Ap(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&Dp(t,a,i),i};const Fp=(e,t)=>{if(!e)return;if(Array.isArray(e)){const r=e.find(i=>i.key==t);return r?.value!=null?String(r.value):void 0}const a=e[t];return a!=null?String(a):void 0};let yt=class extends C{constructor(){super(...arguments),this.fieldId="",this.editable=!0,this.filePicked=e=>{const t=e.target,a=t.files?.[0];if(!a)return;const r=new FileReader;r.onload=()=>{const i=r.result,s=i.indexOf(","),n=i.substring(0,s).replace(";base64",`;name=${encodeURIComponent(a.name)};base64`);this.emit(n+i.substring(s))},r.readAsDataURL(a),t.value=""}}static fileName(e){if(!e)return"";if(e.startsWith("data:")){const t=e.indexOf(","),r=e.substring(5,t<0?e.length:t).split(";").find(i=>i.startsWith("name="));if(r)try{return decodeURIComponent(r.substring(5))}catch{return r.substring(5)}return"Attached file"}return e.split("/").pop()||e}emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e,fieldId:this.fieldId},bubbles:!0,composed:!0}))}triggerPick(){this.renderRoot.querySelector("input[type=file]")?.click()}render(){const e=this.value!=null&&this.value!=="",t=yt.fileName(this.value),a=e&&this.value.startsWith("data:"),r=e?o`<span class="file" title="${t}">📄 ${a?o`<a href="${this.value}" download="${t}">${t}</a>`:o`<a href="${this.value}" target="_blank">${t}</a>`}</span>`:l;return this.editable?o`
            ...
            </div>`:o`${e?r:o`<span class="empty">—</span>`}`}};yt.styles=x`
        :host {
            display: block;
        }
        .row {
    ...
    `;Na([p()],yt.prototype,"fieldId",2);Na([p()],yt.prototype,"value",2);Na([p()],yt.prototype,"accept",2);Na([p({type:Boolean})],yt.prototype,"editable",2);yt=Na([k("mateu-file-upload")],yt);const Ba=e=>!!e&&typeof e=="object"&&"__mateuGroup"in e,Cr=e=>String(e??""),qp=(e,t,a)=>{const r=e??[];if(!t||!a||a.length===0)return r;const i=[];let s,n=!1;return r.forEach((d,c)=>{const u=Cr(d?.[t]);if(!n||u!==s){const m=a.find(v=>Cr(v.value)===u)??{value:u,count:r.filter(v=>Cr(v?.[t])===u).length,aggregates:{}};i.push({__mateuGroup:m,__mateuGroupBy:t,_rowNumber:`__mateuGroup:${c}:${u}`}),n=!0,s=u}i.push(d)}),i},zs=(e,t)=>e==null?"":t.dataType==="money"||t.stereotype==="money"?new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(e):t.aggregate==="count"?new Intl.NumberFormat(void 0,{maximumFractionDigits:0}).format(Math.round(e)):new Intl.NumberFormat(void 0,{maximumFractionDigits:2}).format(e),Mp=(e,t)=>e&&t.includes(e)?e:t.find(a=>!!a),Np=(e,t,a)=>{const r=e.__mateuGroup;return t.id===a?`${r.value} (${r.count})`:t.aggregate?zs(r.aggregates?.[t.id],t):""},Up=(e,t,a)=>{const r=t?.aggregates;if(!r||!e.some(n=>n.aggregate))return;const i={};e.forEach(n=>{n.aggregate&&r[n.id]!=null&&(i[n.id]=zs(r[n.id],n))});const s=e[0];if(s&&i[s.id]===void 0){const n=t?.page?.totalElements;i[s.id]=a&&s.id===a&&n!=null?`Total (${n})`:"Total"}return i},jp=(e,t,a)=>{const i=e[a.path]?"vaadin:check":"vaadin:minus";return U(i,"height: 16px; width: 16px; color: var(--lumo-body-text-color);")},Bp=(e,t,a,r,i)=>{const s=e[a.path];let n=s;return r=="money"&&s&&s.locale&&s.currency?n=new Intl.NumberFormat(s.locale,{style:"currency",currency:s.currency}).format(s.value):i=="money"&&(n=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(s)),o`${n}`},xi=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},Vp=(e,t,a,r,i,s)=>{const n=a.xcolumn??s;if(n.text){if(n.actionId)return o`<a href="javascript: void(0);" @click="${u=>xi(a,n,e)}">${n.text}</a>`;const c=e[a.path];return o`<a href="${c}">${n.text}</a>`}if(r=="string"){if(n.actionId){const u=e[a.path];return o`<a href="javascript: void(0);" @click="${m=>xi(a,n,e)}">${u}</a>`}const c=e[a.path];return o`<a href="${c}">${c}</a>`}const d=e[a.path];return o`<a href="${d.href}">${d.text}</a>`},Hp=(e,t,a,r,i)=>{const s=e[a.path];return r=="string"?s.split(",").map(n=>U(n,"width: 16px;")):s.split(",").map(n=>U(n.icon,"width: 16px;"))},Wp=(e,t,a,r,i)=>{const s=e[a.path];return o`${ge(s)}`},Gp=(e,t,a,r,i,s)=>{if(r=="string"){const d=e[a.path],c="max-height: 40px; "+(s.style??"");return o`<img src="${d}" style="${c}">`}const n=e[a.path];return o`<img src="${n.src}" style="${s.style??""}">`},Kp=e=>{const t={_clickedRow:e.target.row};e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-"+e.detail.value.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},wi=e=>{const t={_clickedRow:e.target.row},a=e.target.action;e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-"+a.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},Yp=e=>{const t=document.createElement("vaadin-context-menu-item"),a=document.createElement("vaadin-icon");return a.style.color="var(--lumo-secondary-text-color)",a.style.marginInlineEnd="var(--lumo-space-s)",a.style.padding="var(--lumo-space-xs)",a.setAttribute("icon",e.icon),t.appendChild(a),e.label&&t.appendChild(document.createTextNode(e.label)),t.disabled=e.disabled,t},ki=(e,t,a)=>{const r=e[a.path]?.actions?.map(i=>i.icon?{component:Yp(i),methodNameInCrud:i.methodNameInCrud}:{...i,text:i.label});return!r||r.length==0?o``:o`
                                     <vaadin-menu-bar
                                         ...
                                         @item-selected="${Kp}"
                                     ></vaadin-menu-bar>
                                   `},Jp=(e,t,a)=>{if(a.path=="select"){const s={actionId:a.path,icon:"",label:"Select",disabled:!1,methodNameInCrud:"select"};return o`
         <vaadin-button theme="tertiary" title="Select" @click="${wi}" .row="${e}" .action="${s}">
             Select
         </vaadin-button>
    `}const r=a.path&&e[a.path]?.methodNameInCrud?e[a.path]:e.action;if(!r)return o``;const i=r.icon&&!r.label;return o`
         <vaadin-button theme="tertiary${i?" icon":""}" title="${r.label||l}" @click="${wi}" .row="${e}" .action="${r}">
             ${r.icon?o`<vaadin-icon icon="${r.icon}"></vaadin-icon>`:l}
             ${r.label?r.label:l}
         </vaadin-button>
    `},Xp=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},Qp=(e,t,a,r,i,s)=>{const n=a.xcolumn??s;if(n.actionId){const c=n.text||e[a.path];return o`
            <vaadin-button theme="tertiary" @click="${u=>Xp(a,n,e)}" .row="${e}">
                ${c}
            </vaadin-button>
        `}const d=e[a.path];return o`<a href="${d}">${n.text||d}</a>`},Zp=(e,t,a,r,i,s,n,d,c)=>{const u=e[a.path];return g(r,u,i,s,n,d,c)},Lr=new WeakMap,eh=(e,t)=>Lr.get(e)?.[t],th=(e,t,a)=>{let r=Lr.get(e);r||(r={},Lr.set(e,r)),r[t]=a},Ci=e=>{if(e==null||e==="")return null;const t=Number(e);return Number.isNaN(t)?null:t},ah=(e,t,a,r)=>{const i=a?.field?.fieldId,s=c=>{if(e[t.id]===c||e[t.id]==null&&(c===""||c==null))return;if(e[t.id]=c,!i){a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"update-row",parameters:{_editedRow:{...e}}},bubbles:!0,composed:!0}));return}const m=(a?.state??r)[i];a.dispatchEvent(new CustomEvent("value-changed",{detail:{fieldId:i,value:Array.isArray(m)?[...m]:m},bubbles:!0,composed:!0}))},n=e[t.id],d=n==null?"":String(n);switch(t.editorType){case"boolean":return o`<vaadin-checkbox ?checked=${!!n} @checked-changed=${c=>s(c.detail.value)}></vaadin-checkbox>`;case"integer":return o`<vaadin-integer-field theme="small" style="width:100%;" .value=${d} @change=${c=>s(Ci(c.target.value))}></vaadin-integer-field>`;case"number":return o`<vaadin-number-field theme="small" style="width:100%;" .value=${d} @change=${c=>s(Ci(c.target.value))}></vaadin-number-field>`;case"date":return o`<vaadin-date-picker theme="small" style="width:100%;" .value=${d} @value-changed=${c=>s(c.detail.value)}></vaadin-date-picker>`;case"time":return o`<vaadin-time-picker theme="small" style="width:100%;" .value=${d} @value-changed=${c=>s(c.detail.value)}></vaadin-time-picker>`;case"datetime":return o`<vaadin-date-time-picker theme="small" style="width:100%;" .value=${d} @value-changed=${c=>s(c.detail.value)}></vaadin-date-time-picker>`;case"select":return o`<vaadin-combo-box
                ...
                .value=${d}
                @value-changed=${c=>s(c.detail.value)}></vaadin-combo-box>`;case"lookup":{const c=a?.field?.fieldId,u=`search-${c}-${t.id}`,m=`${c}-${t.id}`,f=(t.editorOptions??[]).find($=>String($.value)===d)??(d?{value:d,label:eh(e,t.id)??d}:void 0);return o`<vaadin-combo-box
                theme="small" style="width:100%;"
                item-label-path="label" item-id-path="value"
                .dataProvider=${($,y)=>{a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:u,parameters:{searchText:$.filter,size:$.pageSize,page:$.page},callback:S=>{const H=S?.fragments?.[0]?.data?.[m];y(H?.content??[],H?.totalElements??0)},callbackonly:!0},bubbles:!0,composed:!0}))}}
                .selectedItem=${f}
                @selected-item-changed=${$=>{const y=$.detail.value,S=y?y.value:null;String(S??"")!==d&&(y&&th(e,t.id,y.label),s(S))}}></vaadin-combo-box>`}default:return o`<vaadin-text-field theme="small" style="width:100%;" .value=${d} @change=${c=>s(c.target.value)}></vaadin-text-field>`}},_r=e=>Xs(()=>o`<span title="${e}" style="white-space:normal;overflow-wrap:break-word;">${e}</span>`,[e]),Ir=e=>e!==void 0?Qs(()=>o`<span style="font-weight: 600; white-space: nowrap;">${e}</span>`,[e]):l,rh=e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget?.dispatchEvent(new CustomEvent("sort-direction-changed",{detail:{grid:e.currentTarget.parentElement},bubbles:!0,composed:!0}))},ih=(e,t,a,r,i,s,n,d)=>{const c=ye(e.label,r,i);return o`
<vaadin-grid-column-group header="${c}">
    ${e.columns.map(u=>Rs(u.metadata,t,a,r,i,s,n,d?.[u.metadata?.id]))}
</vaadin-grid-column-group>
`},Qr=(e,t,a,r,i,s,n,d)=>h.GridGroupColumn==e.metadata?.type?ih(e.metadata,t,a,r,i,s,n,d):Rs(e.metadata,t,a,r,i,s,n,d?.[e.metadata?.id]),Rs=(e,t,a,r,i,s,n,d)=>{const c=ye(e.label,r,i);return e.sortable?o`
                    ...
                    `:o`
                        <vaadin-grid-column
                                ...
                                ${Rt((u,m,v)=>Va(u,m,v,e,t,a,r,i,s,n),[])}
                        ></vaadin-grid-column>
                    `},Va=(e,t,a,r,i,s,n,d,c,u)=>{const m=a.dataset.dataType??"",v=a.dataset.stereotype??"";if(Ba(e)){const w=i?.metadata,$=(w?.columns??[]).flatMap(F=>F?.metadata?.type===h.GridGroupColumn?(F.metadata.columns??[]).map(ee=>ee?.metadata?.id):[F?.metadata?.id]),y=Mp(e.__mateuGroupBy,$),S=Np(e,r,y),H=e.__mateuGroup.hiddenActions??[],ue=r.id===$[$.length-1]?(w?.groupActions??[]).filter(F=>!H.includes(F.actionId??F.id)):[];return ue.length?o`<span style="display: flex; align-items: center; justify-content: flex-end; gap: var(--lumo-space-s); overflow: hidden;">
            ...
            <vaadin-grid
                    ...
                    ${E(this.field?.detailPath?Si(a=>o`${g(this,a[this.field?.detailPath],this.baseUrl,this.state,this.data,this.appState,this.appData)}`):void 0)}
            ...
            >
                ...
                `}
                ${this.field?.columns?.map(a=>Qr(a,this,this.baseUrl,this.state,this.data,this.appState,this.appData))}
            ...
            ${this.field?.readOnly?l:this.field?.inlineEditing?o`
                ...
                `}
        </vaadin-vertical-layout>`}};Je.styles=x`
        ${xt}
    ...
    `;Et([p()],Je.prototype,"field",2);Et([p()],Je.prototype,"state",2);Et([p()],Je.prototype,"data",2);Et([p()],Je.prototype,"appState",2);Et([p()],Je.prototype,"appData",2);Et([p()],Je.prototype,"selectedItems",2);Et([b()],Je.prototype,"detailsOpenedItems",2);Je=Et([k("mateu-grid")],Je);var dh=Object.defineProperty,ch=Object.getOwnPropertyDescriptor,fa=(e,t,a,r)=>{for(var i=r>1?void 0:r?ch(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&dh(t,a,i),i};let $t=class extends C{constructor(){super(...arguments),this.getNewValue=e=>{if(this.field?.dataType=="array"){if(!this.value)return[e];const t=this.value;return t.indexOf(e)>=0?t.filter(a=>a!==e):[...t,e]}return e}}render(){let e=this.field?.options;if(this.field?.remoteCoordinates){const a=this.field.remoteCoordinates;this.data?.[this.field.fieldId]&&this.data[this.field.fieldId].content&&this.data[this.field.fieldId].totalElements?e=this.data[this.field.fieldId].content:this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a.action,parameters:{searchText:"",fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0}))}const t=this.field?.attributes?.divStyle;return o`
  ...
  `;fa([p()],$t.prototype,"field",2);fa([p()],$t.prototype,"baseUrl",2);fa([p()],$t.prototype,"state",2);fa([p()],$t.prototype,"data",2);fa([p()],$t.prototype,"value",2);$t=fa([k("mateu-choice")],$t);var uh=Object.defineProperty,ph=Object.getOwnPropertyDescriptor,et=(e,t,a,r)=>{for(var i=r>1?void 0:r?ph(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&uh(t,a,i),i};let Ce=class extends C{constructor(){super(...arguments),this.currencyChanged=e=>{this.value||(this.value={value:0,currency:"EUR",locale:"es-ES"}),this.value.currency=e.detail.value,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:{...this.value},fieldId:this.fieldId}}))},this.valueChanged=e=>{this.value||(this.value={value:0,currency:"EUR",locale:"es-ES"}),e.detail.value&&(this.value.value=e.detail.value?parseFloat(e.detail.value):0,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:{...this.value},fieldId:this.fieldId}})))}}render(){return o`
            <vaadin-number-field
                    id="${this.fieldId}"
                    label="${this.label}"
...
`,this.comboRenderer=e=>o`
        ...
        `:l}
                            ...
                            `:e.label}
`,this.filteredIcons=[],this.navLinkOffset=null,this.iconFilterChanged=e=>{this.filteredIcons=_i.filter(t=>!e.detail.value||t.indexOf(e.detail.value)>=0)}}loadUi5FieldComponents(){this.ui5FieldComponentsReady||vh().then(()=>{this.ui5FieldComponentsReady=!0})}remoteComboDataProvider(e){return(t,a)=>{const{filter:r,page:i,pageSize:s}=t,n=r??"";this._comboFilter=n,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e,parameters:{searchText:r,fieldId:this.field?.fieldId,size:s,page:i,sort:void 0},callback:d=>{if(n===this._comboFilter)if(d?.messages?.forEach(c=>{Dr.show(c.text,{position:c.position?this.mapPosition(c.position):void 0,theme:c.variant,duration:c.duration})}),!d.fragments||d.fragments.length==0)this.comboData=[],a([],0);else{const c=d.fragments[0].data?.[this.id];this.comboData=c?.content,a(c?.content,c?.totalElements)}},callbackonly:!0},bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.rendered=!1}renderNavLink(){const e=this.field?.link;if(!e?.href)return l;const t=ye(e.href,this.state,this.data)??e.href,a=ye(e.title,this.state,this.data)||t,r=e.icon||(t.startsWith("http")?"vaadin:external-link":"vaadin:link"),i=this.navLinkOffset??"calc(var(--lumo-font-size-s) * 1.6 + (var(--lumo-size-m) - var(--lumo-icon-size-s)) / 2)";return o`<a
                data-navlink
                href="${t}"
                title="${a}"
...
`}renderFileField(e,t,a,r){if(!this.field)return o``;const i=t?.map(s=>({id:s.id,name:s.name,type:"",uploadTarget:"",complete:!0}))??[];return o`
            ...
            `}renderStringField(e,t,a,r){if(!this.field)return o``;if(this.field?.stereotype=="searchable"){const i=n=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"code-"+this.field?.fieldId,parameters:{code:n.currentTarget.value}},bubbles:!0,composed:!0}))},s=n=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"codesearch-"+this.field?.fieldId,parameters:{}},bubbles:!0,composed:!0}))};return o`
              ...
              ${i.description}
                ...
                `;if(this.field?.stereotype=="fileUpload"){const i=Fp(this.field.attributes,"accept");return o`
                    <vaadin-custom-field
                            id="${this.field.fieldId}"
                            label="${a}"
                            .helperText="${this.helperText()}"
...
`;if(this.field?.stereotype=="listBox"){if(this.field?.remoteCoordinates){const i=this.field.remoteCoordinates,s="";return this.data[this.id]&&(this.data[this.id].searchSignature||s)&&this.data[this.id].searchSignature!=s&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements||this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:i.action,parameters:{searchText:s,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0})),o`
            ...
            ></mateu-money-field>`}renderStatusField(e,t,a,r){if(!this.field)return o``;const i=t;return o`
                <vaadin-custom-field
                        ...
                        data-colspan="${this.field.colspan}"
                >
                    ${i?o`<span theme="badge pill ${mr(i.type)}">${i.message}</span>`:o``}                    
                </vaadin-custom-field>
  ...
  `;ce([b()],Y.prototype,"ui5FieldComponentsReady",2);ce([p()],Y.prototype,"component",2);ce([p()],Y.prototype,"field",2);ce([p()],Y.prototype,"baseUrl",2);ce([p()],Y.prototype,"state",2);ce([p()],Y.prototype,"data",2);ce([p()],Y.prototype,"appState",2);ce([p()],Y.prototype,"appData",2);ce([p()],Y.prototype,"labelAlreadyRendered",2);ce([b()],Y.prototype,"colorPickerOpened",2);ce([b()],Y.prototype,"colorPickerValue",2);ce([b()],Y.prototype,"filteredIcons",2);ce([b()],Y.prototype,"navLinkOffset",2);Y=ce([k("mateu-field")],Y);const fh=(e,t,a,r,i,s,n,d)=>{const c=t.metadata;return o`
        <mateu-field
                id="${t.id}"
                .component="${t}"
                .field="${t.metadata}"
    ...
    `},bh=(e,t,a,r,i,s,n)=>{const d=t.metadata;if(d.tree){const u=async(m,v)=>{const f=m.parentItem?m.parentItem.children:d.page.content;v(f,f.length)};return o`
        ...
        >
            ...
            <vaadin-grid-column path="${m.id}"
                                ...
                                width="${f?.width??l}"
                                .column="${m.metadata}"
                                ${Rt((w,$,y)=>Va(w,$,y,f,e,a,r,i,s,n),[])}></vaadin-grid-column>
`:o`
...
`})}
    ...
    `};var gh=Object.defineProperty,yh=Object.getOwnPropertyDescriptor,Fe=(e,t,a,r)=>{for(var i=r>1?void 0:r?yh(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(r?n(t,a,i):n(i))||i);return r&&i&&gh(t,a,i),i};let me=class extends C{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.detailsOpenedItems=[],this.pagesRequested=[],this.emptyArray=e=>!e||e.length==0,this.dataProvider=(e,t)=>{const a=this.data[this.id]?.page;if(this.metadata?.infiniteScrolling&&e.page>0){let r=!1;a&&a.content&&(a.content.length>=(e.page+1)*e.pageSize||a.content.length==a.totalElements)&&(t(a.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),a.totalElements),r=!0,this.grid&&this.grid.recalculateColumnWidths()),r||this.pagesRequested.find(i=>i==e.page)||(this.pagesRequested.push(e.page),this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:e,callback:()=>{this.data[this.id]?.page?.content&&(t(this.data[this.id].page.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),this.data[this.id].page.totalElements),this.grid&&this.grid.recalculateColumnWidths())}},bubbles:!0,composed:!0})))}else{const r=this.metadata?.infiniteScrolling?a?.totalElements:a?.content?.length??0;t(a?.content??[],r),this.grid&&this.grid.recalculateColumnWidths()}},this._onActionRequested=e=>{const t=e.detail,a=this.identifierFieldName;if(!a||!t.parameters||t.actionId?.startsWith("action-on-row-"))return;const r=t.parameters[a];r!==void 0&&(this.state._selectedId=String(r),this._applyCellPartNameGenerator(),this.grid?.requestContentUpdate())},this.tooltipGenerator=e=>{let t="";const{column:a,item:r}=e,i=this.metadata?.columns?.find(s=>s.metadata.id==a?.path);if(i?.metadata){const s=(i?.metadata).tooltipPath;s&&a&&r&&(t=r[s])}return t}}get identifierFieldName(){const e=this.metadata?.columns?.find(a=>a.metadata?.identifier);if(e)return e.metadata?.id;if(this.metadata?.columns?.find(a=>a.metadata?.id==="id"))return"id"}_applyCellPartNameGenerator(){if(!this.grid)return;const e=this.identifierFieldName,t=this.state?._selectedId??this.appState?._splitDetailId,a=!!this.metadata?.groupBy;e&&t!==void 0||a?this.grid.cellPartNameGenerator=(r,i)=>{const s=i.item;return Ba(s)?"mateu-group-row":e&&t!==void 0&&String(s[e])===String(t)?"selected-row":""}:this.grid.cellPartNameGenerator=null}connectedCallback(){super.connectedCallback(),this.addEventListener("action-requested",this._onActionRequested)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("action-requested",this._onActionRequested)}updated(e){super.updated(e),this._applyCellPartNameGenerator(),this.grid?.clearCache(),this.grid?.requestContentUpdate(),this.grid?.recalculateColumnWidths(),this.pagesRequested=[]}render(){const e=this.data[this.id],t=e?.page,a=this.metadata?.groupBy,r=this.metadata?.infiniteScrolling?void 0:t?.content?qp(t.content,a,e?.groups):t?.content,i=(this.metadata?.columns??[]).flatMap(c=>c.metadata?.type===h.GridGroupColumn?(c.metadata.columns??[]).map(u=>u.metadata):[c.metadata]),s=Up(i,e,a);let n="";this.metadata?.wrapCellContent&&(n+=" wrap-cell-content"),this.metadata?.compact&&(n+=" compact"),this.metadata?.noBorder&&(n+=" no-border"),this.metadata?.noRowBorder&&(n+=" no-row-borders"),this.metadata?.columnBorders&&(n+=" column-borders"),this.metadata?.rowStripes&&(n+=" row-stripes");const d=this.state[this.id+"_selected_items"]||[];return o`
            <vaadin-grid
                    ...
                    @selected-items-changed="${c=>{const u=(c.detail.value??[]).filter(m=>!Ba(m));this.emptyArray(this.state[this.id+"_selected_items"])&&this.emptyArray(u)||(this.state[this.id+"_selected_items"]=u,this.metadata?.onRowSelectionChangedActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.metadata?.onRowSelectionChangedActionId},bubbles:!0,composed:!0})))}}"
                    @active-item-changed="${E(this.metadata?.detailPath&&!this.metadata?.useButtonForDetail?c=>{if(this.metadata?.detailPath){const u=c.detail.value;if(u&&Ba(u))return;u?this.detailsOpenedItems=[u]:this.detailsOpenedItems=[]}}:void 0)}"
                    .detailsOpenedItems="${this.detailsOpenedItems}"
                    ${E(this.metadata?.detailPath?Si(c=>o`${g(this,c[this.metadata?.detailPath],this.baseUrl,this.state,this.data,this.appState,this.appData)}`):void 0)}
                    theme="${n}"
            ...
            >
                ...
                `:l}
                ${this.metadata?.columns?.map(c=>Qr(c,this,this.baseUrl,this.state,this.data,this.appState,this.appData,s))}
                ${this.metadata?.useButtonForDetail?o`
                    <vaadin-grid-column
                            width="44px"
                            flex-grow="0"
                            ${Rt((c,{detailsOpened:u})=>o`
              <vaadin-button
                theme="tertiary icon"
  ...
  `;Fe([p()],me.prototype,"id",2);Fe([p()],me.prototype,"metadata",2);Fe([p()],me.prototype,"baseUrl",2);Fe([p()],me.prototype,"state",2);Fe([p()],me.prototype,"data",2);Fe([p()],me.prototype,"appState",2);Fe([p()],me.prototype,"appData",2);Fe([p()],me.prototype,"emptyStateMessage",2);Fe([b()],me.prototype,"detailsOpenedItems",2);Fe([_e("vaadin-grid")],me.prototype,"grid",2);me=Fe([k("mateu-table")],me);const $h=(e,t,a,r,i,s,n)=>o`
    <mateu-table
            id="${t.id}"
            baseUrl="${a}"
            .metadata="${t.metadata}"
    ...
    <mateu-table id="${e.id}"
                 ...
                 baseUrl="${a}"
    ></mateu-table>`,wh=(e,t,a,r,i,s,n)=>{const d=t.metadata;return o`
        ...
        <vaadin-popover
                ...
                content-width="300px"
                position="bottom"
                ${Ei(()=>o`${g(e,d.content,a,r,i,s,n)}`,[])}
                style="${t.style}" class="${t.cssClasses}"
        ></vaadin-popover>
    `},kh=(e,t,a)=>{const r=e;return o`
        <vaadin-button
                data-action-id="${r.id}"
                theme="${Fi(e)||l}"
                @click="${a}"
    ...
    <div style="display: flex; gap: var(--lumo-space-xs, .25rem); align-items: center;" class="peer-nav">
        ...
        <vaadin-button theme="tertiary icon" class="peer-nav-next" title="${e.nextLabel??"Next"}"
    ...
    </div>`,_h=(e,t,a)=>o`<vaadin-icon icon="${e}" style="${t??l}" class="${a??l}"></vaadin-icon>`,Ih=(e,t,a)=>{const r=e.metadata,i=ye(r.label,t,a);let s="";return r.buttonStyle&&(s+=" "+r.buttonStyle),r.color&&r.color!=="none"&&r.color!=="normal"&&(s+=" "+r.color),r.size&&r.size!=="none"&&r.size!=="normal"&&(s+=" "+r.size),o`<vaadin-button
            id="${e.id}"
            data-action-id="${r.actionId}"
            @click="${n=>Ji(n,r)}"
            style="${e.style}"
            ...
            title="${r.shortcut?`${i} (${Yi(r.shortcut)})`:l}"
            slot="${e.slot??l}"
    >${r.iconOnLeft?o`<vaadin-icon icon="${r.iconOnLeft}"></vaadin-icon>`:l}${i}${r.iconOnRight?o`<vaadin-icon icon="${r.iconOnRight}"></vaadin-icon>`:l}</vaadin-button>`},Sh=e=>{const t=e.metadata,a=r=>{const i=r.detail?.value??"";!t.actionId||!i.trim()||r.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:{message:i}},bubbles:!0,composed:!0}))};return o`
        <vaadin-message-input
                style="${e.style}" class="${e.cssClasses}"
                slot="${e.slot??l}"
                @submit="${a}"
        ></vaadin-message-input>
    `},Eh=e=>{const a=(e.metadata.items??[]).map(r=>({text:r.text,time:r.time,userName:r.userName,userImg:r.userImg,userAbbr:r.userAbbr,userColorIndex:r.userColorIndex}));return o`
        <vaadin-message-list
                markdown
                style="${e.style}" class="${e.cssClasses}"
                slot="${e.slot??l}"
                .items="${a}"
        ></vaadin-message-list>
    `},Er=(e,t)=>{e&&e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},Ph=(e,t,a,r,i,s,n)=>{const d=t.metadata;let c=!1;if(d.openedCondition)try{c=qr(d.openedCondition,r,i,s,n)}catch(u){console.error("when evaluating "+d.openedCondition+" :"+u+", where data is "+i+" and state is "+r)}return o`
        <vaadin-confirm-dialog
                ...
                .opened="${c}"
                @confirm="${u=>Er(u.currentTarget,d.confirmActionId)}"
                @reject="${u=>Er(u.currentTarget,d.rejectActionId)}"
                @cancel="${u=>Er(u.currentTarget,d.cancelActionId)}"
                style="${t.style}" class="${t.cssClasses}"
                slot="${t.slot??l}"
        >
            ${t.children?.map(u=>g(e,u,a,r,i,s,n))}
        </vaadin-confirm-dialog>
    `},Th={[h.VirtualList]:(e,t,a,r,i,s,n)=>tp(e,t,a,r,i,s,n),[h.Notification]:(e,t)=>ap(t),[h.ProgressBar]:(e,t,a,r)=>rp(t,r),[h.Details]:(e,t,a,r,i,s,n)=>ip(e,t,a,r,i,s,n),[h.Avatar]:(e,t,a,r,i)=>sp(t,r,i),[h.AvatarGroup]:(e,t)=>op(t),[h.Card]:(e,t,a,r,i,s,n)=>np(e,t,a,r,i,s,n),[h.Button]:(e,t,a,r,i)=>Ih(t,r,i),[h.MessageInput]:(e,t)=>Sh(t),[h.MessageList]:(e,t)=>Eh(t),[h.ConfirmDialog]:(e,t,a,r,i,s,n)=>Ph(e,t,a,r,i,s,n),[h.FormLayout]:(e,t,a,r,i,s,n)=>pp(e,t,a,r,i,s,n),[h.HorizontalLayout]:(e,t,a,r,i,s,n)=>vp(e,t,a,r,i,s,n),[h.VerticalLayout]:(e,t,a,r,i,s,n)=>fp(e,t,a,r,i,s,n),[h.SplitLayout]:(e,t,a,r,i,s,n)=>bp(e,t,a,r,i,s,n),[h.MasterDetailLayout]:(e,t,a,r,i,s,n)=>gp(e,t,a,r,i,s,n),[h.TabLayout]:(e,t,a,r,i,s,n)=>yp(e,t,a,r,i,s,n),[h.AccordionLayout]:(e,t,a,r,i,s,n)=>xp(e,t,a,r,i,s,n),[h.BoardLayout]:(e,t,a,r,i,s,n)=>Cp(e,t,a,r,i,s,n),[h.BoardLayoutRow]:(e,t,a,r,i,s,n)=>_p(e,t,a,r,i,s,n),[h.BoardLayoutItem]:(e,t,a,r,i,s,n)=>Ip(e,t,a,r,i,s,n),[h.Scroller]:(e,t,a,r,i,s,n)=>kp(e,t,a,r,i,s,n),[h.MenuBar]:(e,t,a,r,i)=>Ep(e,t,a,r,i),[h.ContextMenu]:(e,t,a,r,i,s,n)=>Sp(e,t,a,r,i,s,n),[h.FormField]:(e,t,a,r,i,s,n,d)=>fh(e,t,a,r,i,s,n,d),[h.Grid]:(e,t,a,r,i,s,n)=>bh(e,t,a,r,i,s,n),[h.Table]:(e,t,a,r,i,s,n)=>$h(e,t,a,r,i,s,n),[h.Popover]:(e,t,a,r,i,s,n)=>wh(e,t,a,r,i,s,n)};class Oh extends ep{rendererName(){return"vaadin"}renderClientSideComponent(t,a,r,i,s,n,d,c){const u=a?.metadata?.type,m=u?Th[u]:void 0;return m&&a?m(t,a,r,i,s,n,d,c):super.renderClientSideComponent(t,a,r,i,s,n,d,c)}renderTableComponent(t,a,r,i,s,n,d){return xh(t,a,r,i,n,d)}renderToolbarButton(t,a,r){return kh(t,a,r)}renderPeerNav(t){return Ch(t)}renderIcon(t,a,r){return _h(t,a,r)}}function Ls(e){switch(e){case"topStretch":return"top-stretch";case"topStart":return"top-start";case"topCenter":return"top-center";case"topEnd":return"top-end";case"middle":return"middle";case"bottomStart":return"bottom-start";case"bottomEnd":return"bottom-end";case"bottomStretch":return"bottom-stretch";case"bottomCenter":return"bottom-center"}return"bottom-end"}function zh(e,t){const a=new Dr;a.position=Ls(e.position),a.duration=e.duration??1e4,e.variant&&a.setAttribute("theme",e.variant),a.renderer=r=>{if(r.firstElementChild)return;const i=document.createElement("span");i.textContent=e.text;const s=document.createElement("button");s.textContent=e.undoLabel??"Undo",s.style.cssText="margin-left: 0.75rem; background: none; border: 1px solid currentColor; border-radius: var(--lumo-border-radius-s, 4px); color: inherit; cursor: pointer; padding: 0.15rem 0.6rem; font: inherit; font-weight: 600;",s.addEventListener("click",()=>{t.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.undoActionId,parameters:e.undoParameters??{}},bubbles:!0,composed:!0})),a.opened=!1}),r.append(i,s)},document.body.appendChild(a),a.opened=!0,a.addEventListener("opened-changed",r=>{r.detail.value||a.remove()})}const Rh={show(e,t){if(e.undoActionId){zh(e,t);return}Dr.show(e.text,{position:e.position?Ls(e.position):"bottom-end",theme:e.variant,duration:e.duration})}};B.set(new Oh);ps(Rh);
