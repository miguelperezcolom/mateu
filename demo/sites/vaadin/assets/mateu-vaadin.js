...
`)}
    ...
    `}};O([y({attribute:!1})],G.prototype,`app`,void 0),O([y()],G.prototype,`baseUrl`,void 0),O([C()],G.prototype,`open`,void 0),O([C()],G.prototype,`queryText`,void 0),O([C()],G.prototype,`dataHits`,void 0),O([C()],G.prototype,`loading`,void 0),O([C()],G.prototype,`selectedIndex`,void 0),O([C()],G.prototype,`fabOffset`,void 0),O([x(`.cc-input`)],G.prototype,`inputEl`,void 0),G=O([g(`mateu-command-center`)],G);var Co=null;function wo(e){let t=e.component?.metadata;t&&(t.commandCenterEnabled||t.chromeless)&&t.variant!==`MEDIATOR`?((!Co||!Co.isConnected)&&(Co=document.createElement(`mateu-command-center`),e.renderRoot.appendChild(Co)),Co.app=t,Co.baseUrl=e.baseUrl??``):Co&&e.renderRoot.contains(Co)&&(Co.remove(),Co=null)}var To=class extends b{constructor(...e){super(...e),this.fetchStarted=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!0},this.fetchFinished=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1},this.fetchFailed=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1;let t=e.detail??{},n=t.failure??ot(t.reason,{online:ft.isOnline()});if(n.kind===`cancelled`)return;let r=t.retry;oo({text:n.message,variant:`error`,duration:r?8e3:5e3,position:`bottomEnd`,...r?{actionLabel:`Retry`,onAction:r}:{}},this)}}connectedCallback(){super.connectedCallback(),this.addEventListener(`backend-called-event`,this.fetchStarted),this.addEventListener(`backend-succeeded-event`,this.fetchFinished),this.addEventListener(`backend-cancelled-event`,this.fetchFinished),this.addEventListener(`backend-failed-event`,this.fetchFailed)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`backend-called-event`,this.fetchStarted),this.removeEventListener(`backend-succeeded-event`,this.fetchFinished),this.removeEventListener(`backend-cancelled-event`,this.fetchFinished),this.removeEventListener(`backend-failed-event`,this.fetchFailed)}render(){return w`<div class="loader-container">
...
`):e?.cssText??``;if(!t)return;let n=document.createElement(`style`);n.id=`mateu-app-light-styles`,n.textContent=t,document.head.appendChild(n)}fetchGlobalSearch(e){let t=this.component?.metadata;if(t?.globalSearchEnabled){if(clearTimeout(this._globalSearchTimer),!e){this.commandPaletteDataHits=[];return}this._globalSearchTimer=setTimeout(async()=>{try{let n=(await gt.runAction(this.baseUrl??``,t.rootRoute??``,``,`_globalsearch`,`cmd-palette`,void 0,t.serverSideType,{},{searchText:e},this,!0))?.fragments?.map(e=>e.data).find(e=>e&&e._globalsearch);this.commandPaletteDataHits=n?._globalsearch??[]}catch{this.commandPaletteDataHits=[]}},250)}}connectedCallback(){super.connectedCallback(),this.isDark=document.documentElement.getAttribute(`theme`)===`dark`,this._commandPaletteHandler=e=>{this.component?.metadata?.commandCenterEnabled||((e.metaKey||e.ctrlKey)&&e.key===`k`&&(e.preventDefault(),this.commandPaletteOpen=!this.commandPaletteOpen,this.commandPaletteQuery=``,this.commandPaletteSelectedIndex=0),e.key===`Escape`&&this.commandPaletteOpen&&(this.commandPaletteOpen=!1,this.commandPaletteQuery=``))},document.addEventListener(`keydown`,this._commandPaletteHandler),Eo.install(),this.addEventListener(`compact-changed`,this._compactHandler),this.addEventListener(`mateu-open-ai`,this._openAiHandler)}disconnectedCallback(){super.disconnectedCallback(),this._commandPaletteHandler&&document.removeEventListener(`keydown`,this._commandPaletteHandler),this.removeEventListener(`compact-changed`,this._compactHandler),this.removeEventListener(`mateu-open-ai`,this._openAiHandler)}updated(e){if(super.updated(e),wo(this),this.component){let t=this.component.metadata;if(t){let n=t;if(ve(n.restSources),n.appDataSource){let e=n.appDataSource.ref||n.appDataSource.url;e&&e!==this._fetchedAppDataRef&&(this._fetchedAppDataRef=e,Tn(n.appDataSource).then(e=>{e&&typeof e==`object`&&(pe.value={...pe.value,...e},this.dispatchEvent(new CustomEvent(`app-data-updated`,{bubbles:!0,composed:!0})))}).catch(e=>console.error(`app-scope data source fetch failed`,e)))}if(n.favicon){let e=document.querySelector(`link[rel~='icon']`);e||(e=document.createElement(`link`),e.rel=`icon`,document.head.appendChild(e)),e.href=n.favicon}e.has(`component`)&&(go(n.requiredCapabilities,this),this.selectedRoute=n.homeRoute,this.selectedConsumedRoute=n.homeConsumedRoute,this.selectedServerSideType=n.homeServerSideType,this.selectedBaseUrl=Oo(n,this.baseUrl),this.selectedUriPrefix=n.homeUriPrefix)}}e.has(`commandPaletteOpen`)&&this.commandPaletteOpen&&setTimeout(()=>{this.renderRoot.querySelector(`.cmd-input`)?.focus()},0)}render(){return M.get()?.renderAppComponent(this,this.component,this.baseUrl,this.state,this.data,this.appState,this.appData)}static{this.styles=h`
  ...
  `}};O([C()],zo.prototype,`opened`,void 0),O([C()],zo.prototype,`maximizeSteps`,void 0),O([C()],zo.prototype,`collapsed`,void 0),O([C()],zo.prototype,`guidedProgress`,void 0),O([C()],zo.prototype,`pagerMenuOpen`,void 0),zo=Ro=O([g(`mateu-drawer`)],zo);function Bo(e){if(e.parentElement)return e.parentElement;let t=e.getRootNode();return t instanceof ShadowRoot?t.host:null}var J=class extends b{constructor(...e){super(...e),this.appState={},this.appData={},this.standalone=!1,this.actionBanners=[],this.dismissedStaticBannerIndices=new Set,this._tocEntries=[],this._activeToc=0,this._tocVisible=!1,this._tocRebuildScheduled=!1,this._headerH=0,this._onResize=()=>this._layoutStickyTops(),this._tocLocked=!1,this._unlockToc=e=>{if(e&&e.type===`keydown`){let t=e;if(t.ctrlKey&&t.altKey&&!t.shiftKey&&!t.metaKey&&/^(?:Digit|Numpad)[1-9]$/.test(t.code))return}this._tocLocked=!1},this._actionBannerTimers=[],this._staticBannerTimers=[],this._bannersHandler=e=>{let t=e.detail,n=t.banners??[],r=t.append??!1;r?this.actionBanners=[...this.actionBanners,...n]:(this._clearActionBannerTimers(),this.actionBanners=n);let i=r?this.actionBanners.length-n.length:0;n.forEach((e,t)=>{if(e.timeoutSeconds&&e.timeoutSeconds>0){let n=i+t;this._actionBannerTimers.push(setTimeout(()=>{this.actionBanners=this.actionBanners.filter((e,t)=>t!==n)},e.timeoutSeconds*1e3))}})},this._onTocKey=e=>{if(!this._tocVisible||!e.ctrlKey||!e.altKey||e.shiftKey||e.metaKey)return;let t=/^(?:Digit|Numpad)([1-9])$/.exec(e.code);if(!t)return;let n=parseInt(t[1],10)-1;n>=this._tocEntries.length||(e.preventDefault(),this._scrollToSection(n))},this._onScrollSpy=()=>{if(this._tocLocked)return;let e=this._sectionCards();if(!e.length)return;let t=this.shadowRoot?.querySelector(`mateu-content-header`),n=t?t.getBoundingClientRect().bottom:0;for(let t of e){if(!t.classList.contains(`mateu-section--sticky`))continue;let e=t.getBoundingClientRect();e.top<=n+12+2&&(n=Math.max(n,e.bottom))}let r=n+12+4,i=0;this._tocEntries.forEach((e,t)=>{e.el.getBoundingClientRect().top<=r&&(i=t)}),this._activeToc=i}}connectedCallback(){super.connectedCallback(),document.addEventListener(`page-banners-received`,this._bannersHandler),window.addEventListener(`resize`,this._onResize),document.addEventListener(`keydown`,this._onTocKey)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`page-banners-received`,this._bannersHandler),window.removeEventListener(`resize`,this._onResize),document.removeEventListener(`keydown`,this._onTocKey),this._clearAllTimers(),this._teardownScrollSpy()}updated(e){if(super.updated(e),e.has(`component`)&&e.get(`component`)!==void 0&&(this._clearAllTimers(),this.actionBanners=[],this.dismissedStaticBannerIndices=new Set),e.has(`component`)){let e=this.component?.metadata?.level??0;this.toggleAttribute(`data-nested`,e>0),this._scheduleStaticBannerTimeouts();let t=this.component?.metadata?.pageWidth===`edgeToEdge`;this.toggleAttribute(`data-edge`,t),this.dispatchEvent(new CustomEvent(`compact-changed`,{detail:{compact:!!this.component?.style?.includes(`--mateu-compact:1`)||t},bubbles:!0,composed:!0})),this._scheduleTocRebuild()}}_scheduleStaticBannerTimeouts(){this._staticBannerTimers.forEach(e=>clearTimeout(e)),this._staticBannerTimers=[],(this.component?.metadata?.banners??[]).forEach((e,t)=>{e.timeoutSeconds&&e.timeoutSeconds>0&&this._staticBannerTimers.push(setTimeout(()=>{this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,t])},e.timeoutSeconds*1e3))})}_clearActionBannerTimers(){this._actionBannerTimers.forEach(e=>clearTimeout(e)),this._actionBannerTimers=[]}_clearAllTimers(){this._clearActionBannerTimers(),this._staticBannerTimers.forEach(e=>clearTimeout(e)),this._staticBannerTimers=[]}_dismissActionBanner(e){this.actionBanners=this.actionBanners.filter((t,n)=>n!==e)}_dismissStaticBanner(e){this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,e])}bannerThemeClass(e){let t=e.theme?.toLowerCase()??`info`;return t===`none`?``:t}_evalBannerText(e){return j(e,this.state,this.data)}_renderBanner(e,t){let n=this._evalBannerText(e.title),r=this._evalBannerText(e.description);return w`
    ...
    `}};O([y()],J.prototype,`component`,void 0),O([y()],J.prototype,`baseUrl`,void 0),O([y()],J.prototype,`state`,void 0),O([y()],J.prototype,`data`,void 0),O([y()],J.prototype,`appState`,void 0),O([y()],J.prototype,`appData`,void 0),O([y()],J.prototype,`value`,void 0),O([y({type:Boolean})],J.prototype,`standalone`,void 0),O([C()],J.prototype,`actionBanners`,void 0),O([C()],J.prototype,`dismissedStaticBannerIndices`,void 0),O([C()],J.prototype,`_tocEntries`,void 0),O([C()],J.prototype,`_activeToc`,void 0),O([C()],J.prototype,`_tocVisible`,void 0),J=O([g(`mateu-page`)],J);var Vo=h`
    .nbtn {
        display: inline-flex;
        align-items: center;
        gap: .35em;
...
`,i=!0)}i&&this.updateMessage(a,o)}o||this.updateMessage(a,`⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).`)}catch(e){console.error(`Error en el flujo SSE:`,e);let t=e?.message??String(e);(t===`Failed to fetch`||t===`network error`||t===`Load failed`)&&!o?this.updateMessage(a,`⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible.`):this.updateMessage(a,`⚠️ Error: `+t)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value=``)},250),this.messageInputElement?.removeAttribute(`disabled`),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent(`close-requested`,{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{let e=this.messageInputElement?.value?.trim()??``;e&&this.send(new CustomEvent(`submit`,{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key===`Enter`&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback(),this.probeLocalAgent();let e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){let t=new e;this.recognition=t,t.lang=`es-ES`,t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=e=>{console.error(`Error de reconocimiento: `+e.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:`smooth`})},0)}addMessage(e,t){let n={text:e,time:new Date().toLocaleTimeString(),userName:t.includes(`agent`)?`Asistente`:`Tú`,userColorIndex:t.includes(`agent`)?2:1};return this.items=[...this.items,n],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((n,r)=>r===e?{...n,text:t}:n),this.scrollBottom()}tryParseCustomEvent(e){let t=e.trim();if(!t.startsWith(`{`))return null;try{let e=JSON.parse(t);if(typeof e.event==`string`)return{event:e.event,detail:e.detail??{}}}catch{}return null}tryParseTokenUsage(e){let t=e.trim();if(!t.startsWith(`{`))return null;try{let e=JSON.parse(t);if(`inputTokens`in e||`outputTokens`in e||`totalTokens`in e)return e}catch{}return null}buildMenuContext(e,t=[]){let n=[];for(let r of e){if(r.separator||r.remote)continue;let e=[...t,r.label];if(r.submenus&&r.submenus.length>0)n.push(...this.buildMenuContext(r.submenus,e));else{let t={path:e,navigation:{route:r.route,consumedRoute:r.consumedRoute,actionId:r.actionId??``,baseUrl:r.baseUrl,serverSideType:r.serverSideType,uriPrefix:r.uriPrefix}};r.description&&(t.description=r.description),n.push(t)}}return n}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return w`
                    ...
                    <div class="message-list" role="list">
                        ${this.items.map(e=>w`
                            <div class="message" role="listitem">
                                <div class="avatar" style="background: ${Yo(e.userColorIndex)};">${Xo(e.userName)}</div>
    ...
    `]}};O([y({attribute:!1})],Y.prototype,`contextProvider`,void 0),O([y()],Y.prototype,`localAgentUrl`,void 0),O([y({attribute:!1})],Y.prototype,`mcpUrl`,void 0),O([C()],Y.prototype,`localAgentAlive`,void 0),O([y()],Y.prototype,`sseUrl`,void 0),O([y()],Y.prototype,`uploadUrl`,void 0),O([y({attribute:!1})],Y.prototype,`menu`,void 0),O([C()],Y.prototype,`attachments`,void 0),O([C()],Y.prototype,`uploading`,void 0),O([x(`.file-input`)],Y.prototype,`fileInputElement`,void 0),O([y({type:Boolean,reflect:!0})],Y.prototype,`expanded`,void 0),O([y()],Y.prototype,`items`,void 0),O([x(`.scroll-container`)],Y.prototype,`scrollContainer`,void 0),O([x(`.msg-input`)],Y.prototype,`messageInputElement`,void 0),O([C()],Y.prototype,`recognition`,void 0),O([C()],Y.prototype,`listening`,void 0),O([C()],Y.prototype,`recognitionAvailable`,void 0),O([C()],Y.prototype,`loading`,void 0),O([C()],Y.prototype,`elapsedSeconds`,void 0),O([C()],Y.prototype,`tokenUsage`,void 0),Y=O([g(`mateu-chat`)],Y);var Zo=class extends b{updated(e){super.updated(e),this.chart&&=(this.chart.destroy(),void 0),this.data&&this.createChart(this.data)}async createChart(e){let[{default:t}]=await Promise.all([E(()=>import(`./vendor-chartjs.js`).then(e=>e.n),__vite__mapDeps([3,1])),E(()=>import(`./vendor-chartjs.js`).then(e=>e.t),__vite__mapDeps([3,1]))]);if(e!==this.data)return;this.chart&&this.chart.destroy();let n={type:this.type,data:this.data,options:this.options};this.chart=new t(this.chartElement,n)}handleSlotChange(){}render(){return w`
            <div class="container">
  ...
  `}};O([y()],Zo.prototype,`type`,void 0),O([y()],Zo.prototype,`data`,void 0),O([y()],Zo.prototype,`options`,void 0),O([x(`#chart`)],Zo.prototype,`chartElement`,void 0),Zo=O([g(`mateu-chart`)],Zo);var Qo=class extends b{updated(e){super.updated(e),this.chart&&=(this.chart.destroy(),void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){let{default:t}=await E(async()=>{let{default:e}=await import(`./vendor-diagrams.js`).then(e=>e.t);return{default:e}},__vite__mapDeps([4,1,2]));if(e!==this.xml)return;this.chart&&this.chart.destroy();let n={container:this.divElement};this.chart=new t(n),this.chart.importXML(e)}handleSlotChange(){}render(){return w`
       ...
       `}static{this.styles=h`
  `}};O([y()],Qo.prototype,`xml`,void 0),O([x(`#canvas`)],Qo.prototype,`divElement`,void 0),Qo=O([g(`mateu-bpmn`)],Qo);var $o=160,es=56,ts=220,ns=110,rs=60,is={ACTION:`#3B82F6`,JOIN:`#8B5CF6`,FORK:`#F59E0B`,END:`#EF4444`,USER_TASK:`#10B981`,PROCESS:`#6366F1`},as={ACTION:`▶`,JOIN:`⟨`,FORK:`⟩`,END:`◼`,USER_TASK:`👤`,PROCESS:`⚙`},os=[`ACTION`,`JOIN`,`FORK`,`END`,`USER_TASK`,`PROCESS`];function ss(){return`step-`+Math.random().toString(36).slice(2,8)}var cs=class extends b{constructor(...e){super(...e),this.value=`{"name":"New Workflow","steps":[]}`,this.wf={name:`New Workflow`,steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;let t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener(`mousemove`,this.onMouseMove),window.removeEventListener(`mouseup`,this.onMouseUp)}}updated(e){if(e.has(`value`)){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){let e=this.wf.steps??[],t={};e.forEach(e=>{t[e.id]=0});let n=!0;for(;n;)n=!1,e.forEach(e=>{if(e.preconditionStepId!=null&&t[e.preconditionStepId]!==void 0){let r=t[e.preconditionStepId]+1;r>t[e.id]&&(t[e.id]=r,n=!0)}});let r={};e.forEach(e=>{let n=t[e.id]??0;(r[n]??=[]).push(e.id)});let i={...this.positions},a=!1;Object.entries(r).forEach(([e,t])=>{let n=Number(e);t.forEach((e,t)=>{i[e]||(i[e]={x:rs+n*ts,y:rs+t*ns},a=!0)})}),a&&(this.positions=i)}emit(){let e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent(`value-changed`,{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(n=>n.id===e?{...n,...t}:n)},this.emit()}addStep(){let e=ss(),t={id:e,type:`ACTION`,name:`New Step`};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};let n=Object.values(this.positions).map(e=>e.y),r=n.length?Math.max(...n)+ns:rs;this.positions={...this.positions,[e]:{x:rs,y:r}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(t=>t.id!==e).map(t=>t.preconditionStepId===e?{...t,preconditionStepId:void 0}:t)};let{[e]:t,...n}=this.positions;this.positions=n,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;let n=this.positions[t]??{x:0,y:0},r=this.toSvgPoint(e);this.dragOffset={x:r.x-n.x,y:r.y-n.y},this.svgEl=e.currentTarget.closest(`svg`),window.addEventListener(`mousemove`,this.onMouseMove),window.addEventListener(`mouseup`,this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};let t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){let e=Object.values(this.positions),t=e.length?Math.max(...e.map(e=>e.x))+$o+rs:600,n=e.length?Math.max(...e.map(e=>e.y))+es+rs:400;return{w:Math.max(t,600),h:Math.max(n,400)}}render(){let{w:e,h:t}=this.canvasSize(),n=this.wf.steps??[];return w`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return T``;let t=this.positions[e.preconditionStepId],n=this.positions[e.id];if(!t||!n)return T``;let r=t.x+$o,i=t.y+es/2,a=n.x,o=n.y+es/2,s=(r+a)/2;return T`
            <path d="M${r},${i} C${s},${i} ${s},${o} ${a},${o}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){let t=this.positions[e.id]??{x:rs,y:rs},n=is[e.type]??`#64748b`,r=as[e.type]??`•`,i=this.selectedId===e.id;return T`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${t=>this.onNodeMouseDown(t,e.id)}"
               @click="${t=>{t.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${$o}" height="${es}" rx="8"
                      fill="white"
                      stroke="${i?n:`#e2e8f0`}"
                      stroke-width="${i?2.5:1.5}"
                      filter="url(#shadow)"/>
                <!-- type badge -->
                <rect x="0" y="0" width="32" height="${es}" rx="8" fill="${n}" clip-path="inset(0 -8px 0 0 round 8px)"/>
                <rect x="24" y="0" width="8" height="${es}" fill="${n}"/>
                <text x="16" y="${33}" text-anchor="middle"
                      font-size="14" fill="white">${r}</text>
                <!-- name -->
                <text x="44" y="${es/2-6}" font-size="11" fill="#1e293b" font-weight="600">
                ...
                <div class="prop-body">
                    ...
                    ${n(`Type`,w`
                        <select class="inp" @change="${t=>this.updateStep(e.id,{type:t.target.value})}">
                            ${os.map(t=>w`<option value="${t}" ?selected="${e.type===t}">${t}</option>`)}
                        </select>`)}
        ...
        `}exportJson(){let e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:`application/json`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=(this.wf.name??`workflow`).replace(/\s+/g,`-`).toLowerCase()+`.json`,r.click(),URL.revokeObjectURL(n)}static{this.styles=[Vo,h`
    ...
    `]}};O([y()],cs.prototype,`value`,void 0),O([C()],cs.prototype,`wf`,void 0),O([C()],cs.prototype,`positions`,void 0),O([C()],cs.prototype,`selectedId`,void 0),O([C()],cs.prototype,`showMeta`,void 0),cs=O([g(`mateu-workflow`)],cs);var ls=[`string`,`integer`,`number`,`bool`,`date`,`time`,`dateTime`,`dateRange`,`money`,`file`,`array`,`status`,`component`,`menu`,`range`,`action`,`actionGroup`],us=[`regular`,`radio`,`checkbox`,`textarea`,`toggle`,`combobox`,`select`,`email`,`password`,`richText`,`listBox`,`html`,`markdown`,`image`,`icon`,`link`,`money`,`grid`,`color`,`choice`,`popover`,`slider`,`button`,`stars`],ds={string:`#3B82F6`,integer:`#8B5CF6`,number:`#6366F1`,bool:`#10B981`,date:`#F59E0B`,time:`#F59E0B`,dateTime:`#F59E0B`,dateRange:`#F59E0B`,money:`#EF4444`,file:`#64748B`,array:`#0EA5E9`,status:`#EC4899`,component:`#14B8A6`,menu:`#94A3B8`,range:`#A855F7`,action:`#F97316`,actionGroup:`#FB923C`};function fs(){return`field-`+Math.random().toString(36).slice(2,8)}var ps=class extends b{constructor(...e){super(...e),this.value=`{"name":"New Form","fields":[]}`,this.form={name:`New Form`,fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has(`value`))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){let e=this.shadowRoot?.querySelector(`.field-list`);!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=se.create(e,{animation:150,handle:`.drag-handle`,ghostClass:`sortable-ghost`,onEnd:e=>{let{oldIndex:t,newIndex:n}=e;if(t===void 0||n===void 0||t===n)return;let r=[...this.form.fields],[i]=r.splice(t,1);r.splice(n,0,i),this.form={...this.form,fields:r},this.emit()}}))}emit(){let e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent(`value-changed`,{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(n=>n.id===e?{...n,...t}:n)},this.emit()}addField(){let e=fs(),t={id:e,label:`New Field`,dataType:`string`};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){let t=this.form.fields.find(t=>t.id===e);if(!t)return;let n={...t,id:fs(),label:t.label+` (copy)`},r=this.form.fields.findIndex(t=>t.id===e),i=[...this.form.fields];i.splice(r+1,0,n),this.form={...this.form,fields:i},this.selectedId=n.id,this.emit()}render(){return w`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderRow(e){let t=ds[e.dataType]??`#64748b`;return w`
        ...
        `}exportJson(){let e=JSON.stringify(this.form,null,2),t=new Blob([e],{type:`application/json`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=(this.form.name??`form`).replace(/\s+/g,`-`).toLowerCase()+`.json`,r.click(),URL.revokeObjectURL(n)}static{this.styles=[Vo,L,h`
        :host { display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif); }
        ...
        textarea.inp { resize: vertical; }
        input[readonly].inp { background: #f8fafc; color: #94a3b8; }
    `]}};O([y()],ps.prototype,`value`,void 0),O([C()],ps.prototype,`form`,void 0),O([C()],ps.prototype,`selectedId`,void 0),O([C()],ps.prototype,`showMeta`,void 0),ps=O([g(`mateu-form-editor`)],ps);var ms=class extends b{constructor(...e){super(...e),this.appState={},this.appData={},this.open=!1,this.activeTab=`appstate`,this.hoveredTag=``,this.hoveredId=``,this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null,this._prevTarget=null,this._onMouseover=e=>{let t=e.target;for(;t&&!(t.tagName?.toLowerCase().startsWith(`mateu-`)&&t!==this);)t=t.parentElement;if(t===this||t===null){t===null&&this._prevTarget&&(this._prevTarget.style.outline=``,this._prevTarget.style.outlineOffset=``,this._prevTarget=null,this.hoveredTag=``,this.hoveredId=``,this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null);return}t!==this._prevTarget&&(this._prevTarget&&(this._prevTarget.style.outline=``,this._prevTarget.style.outlineOffset=``),this._prevTarget=t,t.style.outline=`2px solid #0070f3`,t.style.outlineOffset=`-2px`,this.hoveredTag=t.tagName.toLowerCase(),this.hoveredId=t.id||``,this.hoveredState=t.state,this.hoveredData=t.data,this.hoveredMeta=t.component?.metadata)}}connectedCallback(){super.connectedCallback(),document.addEventListener(`mouseover`,this._onMouseover,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`mouseover`,this._onMouseover,!0),this._prevTarget&&=(this._prevTarget.style.outline=``,null)}_fmt(e){try{return JSON.stringify(e,null,2)??`null`}catch{return String(e)}}_renderTab(e,t){return w`
    ...
    `}};O([y()],ms.prototype,`appState`,void 0),O([y()],ms.prototype,`appData`,void 0),O([C()],ms.prototype,`open`,void 0),O([C()],ms.prototype,`activeTab`,void 0),O([C()],ms.prototype,`hoveredTag`,void 0),O([C()],ms.prototype,`hoveredId`,void 0),O([C()],ms.prototype,`hoveredState`,void 0),O([C()],ms.prototype,`hoveredData`,void 0),O([C()],ms.prototype,`hoveredMeta`,void 0),ms=O([g(`mateu-debug-overlay`)],ms);var hs=(e,t)=>{let n=t?.initiatorState;return n&&typeof n==`object`?{...n}:{...e??{}}},gs=e=>{if(e)try{return JSON.parse(e)}catch{return{value:e}}else return{}},_s=function(e){return e.required=`required`,e.disabled=`disabled`,e.hidden=`hidden`,e.pattern=`pattern`,e.minValue=`minValue`,e.maxValue=`maxValue`,e.minLength=`minLength`,e.maxLength=`maxLength`,e.css=`css`,e.style=`style`,e.theme=`theme`,e.errorMessage=`errorMessage`,e.description=`description`,e.none=`none`,e}({}),vs=function(e){return e.Continue=`Continue`,e.Stop=`Stop`,e}({}),ys=12e4,bs=(e,t)=>`${e??`_`}::${t}`,xs=new class{constructor(){this.started=new Map,this.listeners=new Set}begin(e,t=Date.now()){let n=this.started.get(e);return n!==void 0&&t-n<ys?!1:(this.started.set(e,t),this.emit(),!0)}end(e){this.started.delete(e)&&this.emit()}isPending(e,t=Date.now()){let n=this.started.get(e);return n!==void 0&&t-n<ys}snapshot(){return new Set(this.started.keys())}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}reset(){this.started.clear(),this.emit()}emit(){let e=this.snapshot();this.listeners.forEach(t=>t(e))}},Ss=`data-mateu-pending-styles`,Cs=`
[data-mateu-pending] {
    pointer-events: none;
    cursor: progress;
...
`);e=a.pop()??``;for(let e of a){let t=e.trim();if(t)if(t.startsWith(`data:`)){let e=JSON.parse(t.substring(5).trim());f&&f(e),p||this.handleUIIncrement(e,u,ee),e.messages&&e.messages.length==1&&e.messages[0].variant==`error`&&u.shadowRoot?.dispatchEvent(new CustomEvent(`backend-call-failed`,{detail:{actionId:i},bubbles:!0,composed:!0}))}else{let e=t;try{let n=JSON.parse(t);e=n.message,n._embedded?.errors?.length>0&&n._embedded.errors[0].message&&(e=n._embedded.errors[0].message)}catch{}throw Error(e)}}}}d||u.dispatchEvent(new CustomEvent(`backend-succeeded-event`,{bubbles:!0,composed:!0,detail:{actionId:i}})),u.shadowRoot?.dispatchEvent(new CustomEvent(`backend-call-succeeded`,{detail:{actionId:i},bubbles:!0,composed:!0}))}).catch(e=>{u.dispatchEvent(new CustomEvent(`backend-failed-event`,{bubbles:!0,composed:!0,detail:{actionId:i,reason:this.serialize(e),retry:te}})),u.shadowRoot?.dispatchEvent(new CustomEvent(`backend-call-failed`,{detail:{actionId:i},bubbles:!0,composed:!0}))})}}serialize(e){return e?.message?e:JSON.stringify(e)}},Bs={fixed:`fixed`,fullWidth:`full`,edgeToEdge:`edge`},Vs=new Set([A.Gantt,A.PlanningBoard,A.Kanban,A.Bpmn,A.Workflow,A.Map]),Hs={landing:`fixed`,form:`fixed`,process:`fixed`},Us=e=>e?Bs[e]:void 0,Ws=e=>e.type==k.ClientSide?e.metadata:void 0,Gs=e=>{let t=Ws(e);if(t?.type==A.Page){let e=Us(t.pageWidth);if(e)return e}for(let t of e.children??[]){let e=Gs(t);if(e)return e}},Ks=e=>{let t=e.pageType;if(t)return t;let n=e=>{let t=Ws(e);if(t?.type==A.Page&&t.pageType)return t.pageType;for(let t of e.children??[]){let e=n(t);if(e)return e}};return n(e)},qs=e=>{let t=Ws(e);if(t?.type!=A.Crud)return!1;let n=t;return n.compact?!0:(n.columns??[]).some(e=>e.metadata?.editable)},Js=(e,t)=>t(e)||(e.children??[]).some(e=>Js(e,t)),Ys=e=>!!e&&Js(e,e=>Ws(e)?.type==A.HeroSection),Xs=e=>Ws(e)?.type==A.App||(e.children??[]).some(e=>Ws(e)?.type==A.App),Zs=(e,t)=>e?(Us(e.pageWidth)??Gs(e))||(t?.top&&Xs(e)?`edge`:Hs[Ks(e)??``]||(Js(e,e=>{let t=Ws(e)?.type;return t!=null&&Vs.has(t)})?`edge`:Js(e,qs)?`full`:`fixed`)):`fixed`,Qs=`mateu-route-structure-cache`,$s=1,ec=50,tc=(()=>{try{return localStorage.getItem(`mateu-route-structure-cache-off`)!==`1`}catch{return!0}})(),nc=()=>{try{return JSON.parse(localStorage.getItem(Qs)??`{}`)}catch{return{}}},rc=e=>{try{localStorage.setItem(Qs,JSON.stringify(e))}catch{try{let t=Object.entries(e).sort((e,t)=>t[1].t-e[1].t).slice(0,Math.floor(ec/2));localStorage.setItem(Qs,JSON.stringify(Object.fromEntries(t)))}catch{}}},ic=e=>{let t=e.initialState&&Object.keys(e.initialState).length?`#`+sc(JSON.stringify(e.initialState)):``;return[e.baseUrl,e.consumedRoute??``,e.route??``,e.serverSideType??``].join(`|`)+t},ac=e=>{if(!tc)return;let t=nc()[e];if(!(!t||t.v!==$s))return{component:t.component,hash:t.hash}},oc=(e,t,n)=>{if(!tc)return;let r=nc();r[e]={v:$s,t:Date.now(),component:t,hash:n};let i=Object.keys(r);if(i.length>ec){let e=i.sort((e,t)=>r[e].t-r[t].t).slice(0,i.length-ec);for(let t of e)delete r[t]}rc(r)},sc=e=>{let t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return(t>>>0).toString(36)},cc=30,lc=new Map,uc=!0,dc=e=>{if(uc)return lc.get(e)},fc=(e,t)=>{if(uc&&(lc.delete(e),lc.set(e,t),lc.size>cc)){let e=lc.keys().next().value;e!==void 0&&lc.delete(e)}},pc,X=class extends Ct{static{pc=this}constructor(...e){super(...e),this.consumedRoute=``,this.serverSideType=void 0,this.uriPrefix=void 0,this.overrides=void 0,this.homeRoute=void 0,this.route=void 0,this.top=void 0,this.appState={},this.appData={},this.preventNavigation=!1,this.overridesParsed={},this.fragment=void 0,this.showSkeleton=!1,this.pendingRouteFocus=!1,this.hasRenderedContent=!1,this.loadLifecycleListener=e=>{if(((typeof e.composedPath==`function`?e.composedPath():[])[0]??e.target)===this)if(clearTimeout(this.skeletonTimer),e.type===`backend-called-event`){if(this.fragment?.component)return;this.skeletonTimer=setTimeout(()=>{this.showSkeleton=!0},pc.SKELETON_DELAY_MS)}else this.showSkeleton=!1},this.actionRequestedListener=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.manageActionEvent(e))},this.historyPushed=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.preventNavigation=!0,this.route=e.detail.route)},this.routeChangedListener=e=>{if(e instanceof CustomEvent){e.preventDefault(),e.stopPropagation();let t=e.detail.route;typeof t==`string`&&(t===``||t.startsWith(`/`))&&this.consumedRoute&&this.consumedRoute!==`_empty`&&this.consumedRoute.startsWith(`/`)&&!t.startsWith(this.consumedRoute)&&(t=this.consumedRoute+t),this.uriPrefix&&(t=t.startsWith(`/`)&&this.uriPrefix.endsWith(`/`)?this.uriPrefix+t.substring(1):!t.startsWith(`/`)&&!this.uriPrefix.endsWith(`/`)?this.uriPrefix+`/`+t:this.uriPrefix+t),this.dispatchEvent(new CustomEvent(`url-update-requested`,{detail:{route:t},bubbles:!0,composed:!0}))}},this.backendFailedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&e.detail.actionId==``&&(this.fragment={targetComponentId:this.id,data:{},state:{},component:{type:k.ClientSide,metadata:{type:A.Element,name:`div`,content:`Not found`},id:`fieldId`},action:uo.Replace,containerId:void 0})},this.detail1=void 0,this.manageActionEvent=e=>{e.preventDefault(),e.stopPropagation(),this.detail1=e.detail;let t=this.detail1;if(e.type==`server-side-action-requested`){let e=Rs;t.sse&&(e=zs),e.runAction(gt,this.baseUrl,t.route??``,t.consumedRoute,t.actionId,t.initiatorComponentId,this.getCustomisedAppState(),t.serverSideType,t.componentState,t.parameters,t.initiator,t.background,t.callback,t.callbackonly,t.callbackToken,{timeoutMillis:t.timeoutMillis,idempotent:t.idempotent,knownStructureHash:t.knownStructureHash})}},this.getCustomisedAppState=()=>{let e={...D.value};if(this.overrides){let t=gs(this.overrides);e={...e,...t}}return e}}manageActionRequestedEvent(e){throw Error(`Method not implemented.`)}createRenderRoot(){return M.mustUseShadowRoot()?super.createRenderRoot():this}structureCacheKey(){return ic({baseUrl:this.baseUrl,consumedRoute:this.consumedRoute,route:this.route,serverSideType:this.serverSideType,initialState:this.initialState})}focusNewContent(){requestAnimationFrame(()=>{let e=this.renderRoot?.querySelector?.(`h1, h2, [role="heading"]`)??this;e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`-1`),e.focus?.({preventScroll:!0})})}static{this.SKELETON_DELAY_MS=400}connectedCallback(){super.connectedCallback(),this.overridesParsed=gs(this.overrides),this.addEventListener(`server-side-action-requested`,this.actionRequestedListener),this.addEventListener(`backend-call-failed`,this.backendFailedListener),this.addEventListener(`history-pushed`,this.historyPushed),this.addEventListener(`route-changed`,this.routeChangedListener),this.addEventListener(`backend-called-event`,this.loadLifecycleListener),this.addEventListener(`backend-succeeded-event`,this.loadLifecycleListener),this.addEventListener(`backend-failed-event`,this.loadLifecycleListener),this.addEventListener(`backend-cancelled-event`,this.loadLifecycleListener)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`server-side-action-requested`,this.actionRequestedListener),this.removeEventListener(`backend-call-failed`,this.backendFailedListener),this.removeEventListener(`history-pushed`,this.historyPushed),this.removeEventListener(`route-changed`,this.routeChangedListener),this.removeEventListener(`backend-called-event`,this.loadLifecycleListener),this.removeEventListener(`backend-succeeded-event`,this.loadLifecycleListener),this.removeEventListener(`backend-failed-event`,this.loadLifecycleListener),this.removeEventListener(`backend-cancelled-event`,this.loadLifecycleListener),clearTimeout(this.skeletonTimer)}shouldUpdate(e){if(this.fragment?.component&&[...e.keys()].every(e=>e===`appState`||e===`appData`)){let t=this.renderRoot.querySelector(`mateu-component`);if(t)return e.has(`appState`)&&(t.appState=this.appState),e.has(`appData`)&&(t.appData=this.appData),!1}return!0}updated(e){if((e.has(`id`)||e.has(`baseurl`)||e.has(`route`)||e.has(`consumedRoute`)||e.has(`instant`))&&!this.preventNavigation){this.callbackToken=this.instant||ce();let e=this.structureCacheKey(),t=e===this.lastAuthoritativeKey?void 0:dc(e);if(t)queueMicrotask(()=>this.applyFragment(t));else{if(e!==this.lastAuthoritativeKey){let t=ac(e);this.currentStructureHash=t?.hash,t&&(this.fragment={targetComponentId:this.id,component:t.component,state:{},data:{},action:uo.Replace,containerId:void 0},this.stampPageChrome())}this.manageActionEvent(new CustomEvent(`server-side-action-requested`,{detail:{route:this.route,consumedRoute:this.consumedRoute,userData:void 0,actionId:``,serverSideType:this.serverSideType,initiatorComponentId:this.id,initiator:this,componentState:this.initialState,knownStructureHash:this.currentStructureHash,callbackToken:this.callbackToken},bubbles:!0,composed:!0}))}}e.has(`route`)&&this.top&&(this.preventNavigation||(this.pendingRouteFocus=!0),this.preventNavigation||this.dispatchEvent(new CustomEvent(`route-changed`,{detail:{route:this.route},bubbles:!0,composed:!0}))),this.preventNavigation&&=!1}applyFragment(e){if(!e.component&&this.fragment?.component){this.fragment={...this.fragment,state:{...this.fragment.state??{},...e.state??{}},data:{...this.fragment.data??{},...e.data??{}}},this.stampPageChrome();return}if(this.fragment=e,e.component){if(e.action!==uo.Add){let t=this.structureCacheKey(),n=e.component.structureHash;oc(t,e.component,n),this.lastAuthoritativeKey=t,this.currentStructureHash=n,e.component.staticView&&fc(t,e)}this.pendingRouteFocus&&this.hasRenderedContent&&this.focusNewContent(),this.pendingRouteFocus=!1,this.hasRenderedContent=!0}this.stampPageChrome()}stampPageChrome(){let e=this.fragment?.component;!e||e===this.lastStampedComponent||(this.lastStampedComponent=e,this.dataset.pageWidth=Zs(e,{top:this.top}),this.dataset.pageType=Ks(e)??``,this.dataset.hasWelcomeBanner=String(Ys(e)))}render(){return!this.fragment?.component&&this.showSkeleton?w`
  ...
  `}};O([y()],Dc.prototype,`baseUrl`,void 0),O([y()],Dc.prototype,`route`,void 0),O([y()],Dc.prototype,`consumedRoute`,void 0),O([y()],Dc.prototype,`config`,void 0),O([y()],Dc.prototype,`top`,void 0),O([y()],Dc.prototype,`pathPrefix`,void 0),O([y()],Dc.prototype,`bundleUrl`,void 0),O([C()],Dc.prototype,`instant`,void 0),O([y({type:Boolean})],Dc.prototype,`debug`,void 0),Dc=O([g(`mateu-ui`)],Dc);var Oc,kc=class extends b{static{Oc=this}constructor(...e){super(...e),this.baseUrl=``,this.opened=!1,this.searchText=``}static{this.SEARCHABLE_THRESHOLD=7}connectedCallback(){super.connectedCallback(),ze()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick(),this.searchTimer&&clearTimeout(this.searchTimer)}currentValue(){return String(Fe()[this.selector.fieldName]??``)}currentLabel(){let e=this.currentValue();if(!e)return`—`;let t=(this.searchedOptions??this.selector.options)?.find(t=>String(t.value)===e);if(t)return t.label;let n=Ie()[this.selector.fieldName];return n===void 0?e:String(n)}pick(e,t){Le(this.selector.fieldName,e,t),window.location.reload()}detachOutsideClick(){this.outsideClick&&=(document.removeEventListener(`mousedown`,this.outsideClick),void 0)}openPanel(){this.opened||(this.opened=!0,this.searchText=``,this.searchedOptions=void 0,this.remoteSearch(),this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener(`mousedown`,this.outsideClick),this.updateComplete.then(()=>this.renderRoot.querySelector(`input.picker-search`)?.focus()))}closePanel(){this.detachOutsideClick(),this.opened=!1}onSearchInput(e){this.searchText=e.target.value,this.searchTimer&&clearTimeout(this.searchTimer),this.searchTimer=setTimeout(()=>this.remoteSearch(),300)}async remoteSearch(){let e=this.app;if(e?.serverSideType)try{let t=await gt.runAction(this.baseUrl??``,e.rootRoute??e.initialRoute??``,``,`_appcontext-search-${this.selector.fieldName}`,`appcontext-${this.selector.fieldName}`,void 0,e.serverSideType,{},{searchText:this.searchText},this,!0);for(let e of t?.fragments??[]){let t=e.data?.[`_appcontext_${this.selector.fieldName}`]?.content;if(Array.isArray(t)){this.searchedOptions=t.map(e=>({value:e.value,label:e.label??String(e.value)}));return}}}catch{}}visibleOptions(){let e=this.searchedOptions??this.selector.options??[],t=this.searchText.trim().toLowerCase();return t?e.filter(e=>e.label.toLowerCase().includes(t)):e}renderPanel(){let e=this.currentValue(),t=this.visibleOptions();return w`
    ...
    `:v,zc=(e,t)=>{t.filter!=e.detail.value&&(t.filter=e.detail.value)},Bc=(e,t,n)=>{let r=Vc(e,t,n),i=Z(t,n);return r==`list`||r==i?`new`:r},Vc=(e,t,n)=>{let r=e?._route;if(r!=null&&(r===``||r.startsWith(`/`))){let e=n.homeRoute??``,i=e.indexOf(`?`),a=i>=0?e.substring(i+1):``,o=Z(t,n)+r;return a?o+(o.indexOf(`?`)>=0?`&`:`?`)+a:o}return t.selectedRoute?t.selectedRoute:n.homeRoute},Z=(e,t)=>e.selectedRoute?e.selectedConsumedRoute??t.route:t.homeConsumedRoute,Hc=(e,t)=>e.selectedRoute?e.selectedBaseUrl??e.baseUrl:e.baseUrl||t.homeBaseUrl,Uc=(e,t)=>e.selectedRoute?e.selectedServerSideType??t.serverSideType:t.homeServerSideType,Wc=(e,t)=>e.selectedRoute?e.selectedUriPrefix:t.homeUriPrefix,Gc=(e,t)=>`ux_`+((Z(e,t)||`root`)+`|`+(Uc(e,t)??``)).replace(/[^a-zA-Z0-9]/g,`_`),Kc=(e,t,n,r,i,a,o)=>{t.variant!==_t.MENU_ON_TOP&&t.menu?.some(e=>e.remote)&&(t={...t,variant:_t.MENU_ON_TOP});let s=Gc(e,t);if(t.chromeless)return w`
        ...
        `;let c=e.mapItems(t.menu,e.filter?.toLowerCase()??``),l=Z(e,t),u=Bc(r,e,t),d=u&&u!==`new`&&u.startsWith(l+`/`)?u.substring(l.length+1).split(`/`)[0]:void 0;return w`
...
`:v}
            ...
            <slot></slot>
       `},qc=(e,t)=>t!=null&&e!=null&&!e.has(t),Jc=typeof HTMLElement<`u`?HTMLElement:class{},Yc=class extends Jc{static get observedAttributes(){return[`type`,`renderer`]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){let e=this.getAttribute(`type`)??`unknown`,t=this.getAttribute(`renderer`)??`unknown`;this.shadowRoot||this.attachShadow({mode:`open`}),this.shadowRoot.innerHTML=`
            <style>
                :host { display: block; }
                .mateu-unsupported {
                    box-sizing: border-box;
        ...
        `}};typeof customElements<`u`&&!customElements.get(`mateu-unsupported`)&&customElements.define(`mateu-unsupported`,Yc);var Xc=new Set,Zc=(e,t,n)=>{let r=`${n}/${t}`;return Xc.has(r)||(Xc.add(r),console.warn(`[mateu] Component type "${t}" is not supported by the "${n}" renderer — rendering <mateu-unsupported> placeholder.`)),w`<mateu-unsupported
            type="${t}"
            renderer="${n}"
            data-component-id="${e?.id??v}"
            slot="${e?.slot??v}"
    ></mateu-unsupported>`},Qc=class{renderFilterBar(e,t,n,r,i,a,o,s){let c=t?.metadata;return w`
            <mateu-filter-bar
                .metadata="${c}"
        ...
        <vaadin-virtual-list
                ...
                slot="${t.slot??v}"
        ></vaadin-virtual-list>
    `,el=e=>{let t=e.metadata;return w`
        <vaadin-notification
                .opened="${!0}"
                slot="${e.slot??v}"
                style="${e.style}"
                ...
                `,[])}
        ></vaadin-notification>
    `},tl=(e,t={})=>{let n=e.metadata,r=n.valueKey?t[n.valueKey]:n.value;return w`
        <div style="${e.style}">
        <vaadin-progress-bar
    ...
    `},nl=(e,t,n,r,i,a,o)=>{let s=t.metadata;return w`
        <vaadin-details
                ?opened="${s.opened}"
                style="${t.style}"
                class="${t.cssClasses}"
        ...
        >
            ...
            `},rl=(e,t,n)=>{let r=e.metadata;return w`<vaadin-avatar
            img="${r.image}"
            name="${Ft(r.name,t,n)}"
            abbr="${r.abbreviation}"
            style="${e.style}" class="${e.cssClasses}"
            slot="${e.slot??v}"
    ></vaadin-avatar>`},il=e=>{let t=e.metadata;return w`<vaadin-avatar-group max-items-visible="${t.maxItemsVisible}"
                                     .items="${t.avatars}"
                                     style="${e.style}" class="${e.cssClasses}"
                                     slot="${e.slot??v}">
    </vaadin-avatar-group>`},al=(e,t,n,r,i,a,o)=>{let s=t.metadata;if(!s)return w``;let c=``;return s.variants?.map(e=>e==`stretchMedia`?`stretch-media`:e==`coverMedia`?`cover-media`:e).forEach(e=>c+=` `+e),c=c.trim(),w`
        <vaadin-card
                style="${t.style}"
                class="${t.cssClasses}"
                theme="${c}"
    ...
    `}render(){return w`
        ...
        `}};O([y({type:Array})],sl.prototype,`tabLabels`,void 0),O([C()],sl.prototype,`mode`,void 0),O([C()],sl.prototype,`selected`,void 0),sl=O([g(`mateu-adaptive-tabs`)],sl);var cl=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style;c??=``,s.columnSpacing&&(c+=`--vaadin-form-layout-column-spacing: `+s.columnSpacing+`;`);let l=s.itemRowSpacing&&s.itemRowSpacing!==`0`?s.itemRowSpacing:`var(--lumo-space-m)`;return c+=`--vaadin-form-layout-row-spacing: `+l+`;`,s.itemLabelSpacing&&(c+=`--vaadin-form-layout-label-spacing: `+s.itemLabelSpacing+`;`),s.labelsAside&&(c+=`--vaadin-form-item-label-width: 10rem;`),s.fullWidth&&(c+=`width: 100%;`),w`
               <vaadin-form-layout 
                       ...
                       slot="${t.slot||v}"
               >
                   ${t.children?.map(t=>ll(s,e,t,n,r,i,a,o))}
               </vaadin-form-layout>
            `},ll=(e,t,n,r,i,a,o,s)=>n.type==k.ClientSide&&n.metadata?.type==A.FormRow?dl(e,t,n,r,i,a,o,s):e.labelsAside?ul(t,n,r,i,a,o,s):N(t,n,r,i,a,o,s),ul=(e,t,n,r,i,a,o)=>{if(t.type==k.ClientSide&&t.metadata?.type==A.FormField&&t.metadata.label){let s=t.metadata,c=s.label?.includes("${")?e._evalTemplate(s.label):s.label;return w`
                       <vaadin-form-item data-colspan="${s.colspan}">
                           <label slot="label">${c}</label>
                           ${N(e,t,n,r,i,a,o,!0)}
                       </vaadin-form-item>
                   `}return N(e,t,n,r,i,a,o)},dl=(e,t,n,r,i,a,o,s)=>w`
        <vaadin-form-row>
            ${n.children?.map(n=>ll(e,t,n,r,i,a,o,s))}
        </vaadin-form-row>
    ...
    `},ml=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style;return s.fullWidth&&(c=c?`width: 100%;`+c:`width: 100%;`),w`
               <vaadin-split-layout 
                       style="${c}" 
                       class="${t.cssClasses}"
            ...
            `},hl=(e,t,n,r,i,a,o)=>{let s=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,l=!!i?.hasDetail||!!s,u=c??s;return w`
            ...
            `},gl=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style;c??=``,s.fullWidth&&(c+=`width: 100%;`);let l=s.variant;l==`equalWidth`&&(l=`equal-width-tabs`);let u=Math.max(0,(t.children??[]).findIndex(e=>e.metadata.active)),d=e=>{e.target.selected=u};if(s.adaptable){let u=(t.children??[]).map(t=>{let n=t.metadata.label;return n?.includes("${")?e._evalTemplate(n):n});return w`
            <mateu-adaptive-tabs
                    .tabLabels="${u}"
                    style="${c}"
                    class="${t.cssClasses}"
        ...
        >
            ...
            ${t.children?.map(t=>_l(e,t,n,r,i,a,o))}
        </vaadin-tabsheet>
            `},_l=(e,t,n,r,i,a,o)=>{let s=t.metadata.label;return w`
        <div tab="${s?.includes("${")?e._evalTemplate(s):s}" style="padding: var(--lumo-space-m) 0;">
                   ${t.children?.map(t=>N(e,t,n,r,i,a,o))}
               </div>
            `},vl=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style;s.fullWidth&&(c=c?`width: 100%;`+c:`width: 100%;`);let l=0;if(t.children){for(let e=0;e<t.children.length;e++)if(t.children[e].metadata?.active){l=e;break}}return w`
               <vaadin-accordion
                       style="${t.style}"
                       class="${t.cssClasses}"
                       opened="${l}"
                       slot="${t.slot??v}"
               >
                   ${t.children?.map(t=>yl(e,t,n,r,i,a,o,s.variant))}
               </vaadin-accordion>
            `},yl=(e,t,n,r,i,a,o,s)=>{let c=t.metadata,l=c.label?.includes("${")?e._evalTemplate(c.label):c.label;return w`
        ...
        <vaadin-board-row style="${t.style}" class="${t.cssClasses}">
            ...
            `,Cl=(e,t,n,r,i,a,o)=>{let s=t.metadata;return w`
        <div style="${t.style}" 
             class="${t.cssClasses}"
    ...
    </vaadin-menu-bar>`,Tl=(e,t,n,r,i,a,o)=>{let s=t.metadata;return w`
        <vaadin-context-menu .items=${Ol(e,s.menu,n,r,i,a,o)} 
                             style="${t.style}" 
                             class="${t.cssClasses}"
    ...
    `}};O([y()],Pl.prototype,`fieldId`,void 0),O([y()],Pl.prototype,`value`,void 0),O([y()],Pl.prototype,`accept`,void 0),O([y({type:Boolean})],Pl.prototype,`editable`,void 0),Pl=Ml=O([g(`mateu-file-upload`)],Pl);var Fl=e=>e==null||typeof e==`string`&&e.trim()===``,Il=(e,t)=>{if(Fl(e))return null;let n=t?parseInt(String(e),10):Number(e);return Number.isNaN(n)?null:n},Ll=(e,t)=>Fl(e)&&Fl(t)?!0:e==t,Rl=e=>!!e&&typeof e==`object`&&`__mateuGroup`in e,zl=e=>String(e??``),Bl=(e,t,n)=>{let r=e??[];if(!t||!n||n.length===0)return r;let i=[],a,o=!1;return r.forEach((e,s)=>{let c=zl(e?.[t]);if(!o||c!==a){let e=n.find(e=>zl(e.value)===c)??{value:c,count:r.filter(e=>zl(e?.[t])===c).length,aggregates:{}};i.push({__mateuGroup:e,__mateuGroupBy:t,_rowNumber:`__mateuGroup:${s}:${c}`}),o=!0,a=c}i.push(e)}),i},Vl=(e,t)=>e==null?``:t.dataType===`money`||t.stereotype===`money`?new Intl.NumberFormat(`de-DE`,{minimumFractionDigits:2,maximumFractionDigits:2}).format(e):t.aggregate===`count`?new Intl.NumberFormat(void 0,{maximumFractionDigits:0}).format(Math.round(e)):new Intl.NumberFormat(void 0,{maximumFractionDigits:2}).format(e),Hl=(e,t)=>e&&t.includes(e)?e:t.find(e=>!!e),Ul=(e,t,n)=>{let r=e.__mateuGroup;return t.id===n?`${r.value} (${r.count})`:t.aggregate?Vl(r.aggregates?.[t.id],t):``},Wl=(e,t,n)=>{let r=t?.aggregates;if(!r||!e.some(e=>e.aggregate))return;let i={};e.forEach(e=>{e.aggregate&&r[e.id]!=null&&(i[e.id]=Vl(r[e.id],e))});let a=e[0];if(a&&i[a.id]===void 0){let e=t?.page?.totalElements;i[a.id]=n&&a.id===n&&e!=null?`Total (${e})`:`Total`}return i},Gl=(e,t,n)=>P(e[n.path]?`vaadin:check`:`vaadin:minus`,`height: 16px; width: 16px; color: var(--lumo-body-text-color);`),Kl=(e,t,n,r,i)=>{let a=e[n.path],o=a;return r==`money`&&a&&a.locale&&a.currency?o=new Intl.NumberFormat(a.locale,{style:`currency`,currency:a.currency}).format(a.value):i==`money`&&(o=new Intl.NumberFormat(`de-DE`,{minimumFractionDigits:2,maximumFractionDigits:2}).format(a)),w`${o}`},ql=(e,t,n)=>{e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId,parameters:n},bubbles:!0,composed:!0}))},Jl=(e,t,n,r,i,a)=>{let o=n.xcolumn??a;if(o.text)return o.actionId?w`<a href="javascript: void(0);" @click="${t=>ql(n,o,e)}">${o.text}</a>`:w`<a href="${e[n.path]}">${o.text}</a>`;if(r==`string`){if(o.actionId)return w`<a href="javascript: void(0);" @click="${t=>ql(n,o,e)}">${e[n.path]}</a>`;let t=e[n.path];return w`<a href="${t}">${t}</a>`}let s=e[n.path];return w`<a href="${s.href}">${s.text}</a>`},Yl=(e,t,n,r,i)=>{let a=e[n.path];return r==`string`?a.split(`,`).map(e=>P(e,`width: 16px;`)):a.split(`,`).map(e=>P(e.icon,`width: 16px;`))},Xl=(e,t,n,r,i)=>{let a=e[n.path];return w`${_(a)}`},Zl=(e,t,n,r,i,a)=>r==`string`?w`<img src="${e[n.path]}" style="${`max-height: 40px; `+(a.style??``)}">`:w`<img src="${e[n.path].src}" style="${a.style??``}">`,Ql=e=>{let t={_clickedRow:e.target.row};e.target?.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:`action-on-row-`+e.detail.value.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},$l=e=>{let t={_clickedRow:e.target.row},n=e.target.action;e.target?.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:`action-on-row-`+n.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},eu=e=>{let t=document.createElement(`vaadin-context-menu-item`),n=document.createElement(`vaadin-icon`);return n.style.color=`var(--lumo-secondary-text-color)`,n.style.marginInlineEnd=`var(--lumo-space-s)`,n.style.padding=`var(--lumo-space-xs)`,n.setAttribute(`icon`,e.icon),t.appendChild(n),e.label&&t.appendChild(document.createTextNode(e.label)),t.disabled=e.disabled,t},tu=(e,t,n)=>{let r=e[n.path]?.actions?.map(e=>e.icon?{component:eu(e),methodNameInCrud:e.methodNameInCrud}:{...e,text:e.label});return!r||r.length==0?w``:w`
                                     <vaadin-menu-bar
                                         ...
                                         @item-selected="${Ql}"
                                     ></vaadin-menu-bar>
                                   `},nu=(e,t,n)=>{if(n.path==`select`)return w`
         <vaadin-button theme="tertiary" title="Select" @click="${$l}" .row="${e}" .action="${{actionId:n.path,icon:``,label:`Select`,disabled:!1,methodNameInCrud:`select`}}">
             Select
         </vaadin-button>
    `;let r=n.path&&e[n.path]?.methodNameInCrud?e[n.path]:e.action;return r?w`
         <vaadin-button theme="tertiary${r.icon&&!r.label?` icon`:``}" title="${r.label||v}" @click="${$l}" .row="${e}" .action="${r}">
             ${r.icon?w`<vaadin-icon icon="${r.icon}"></vaadin-icon>`:v}
             ${r.label?r.label:v}
         </vaadin-button>
    `:w``},ru=(e,t,n)=>{e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId,parameters:n},bubbles:!0,composed:!0}))},iu=(e,t,n,r,i,a)=>{let o=n.xcolumn??a;if(o.actionId)return w`
            <vaadin-button theme="tertiary" @click="${t=>ru(n,o,e)}" .row="${e}">
                ${o.text||e[n.path]}
            </vaadin-button>
        `;let s=e[n.path];return w`<a href="${s}">${o.text||s}</a>`},au=(e,t,n,r,i,a,o,s,c)=>{let l=e[n.path];return N(r,l,i,a,o,s,c)},ou=new WeakMap,su=(e,t)=>ou.get(e)?.[t],cu=(e,t,n)=>{let r=ou.get(e);r||(r={},ou.set(e,r)),r[t]=n},lu=(e,t=!1)=>Il(e,t),uu=(e,t,n,r)=>{let i=n?.field?.fieldId,a=a=>{if(e[t.id]===a||e[t.id]==null&&(a===``||a==null))return;if(e[t.id]=a,!i){n.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:`update-row`,parameters:{_editedRow:{...e}}},bubbles:!0,composed:!0}));return}let o=(n?.state??r)[i];n.dispatchEvent(new CustomEvent(`value-changed`,{detail:{fieldId:i,value:Array.isArray(o)?[...o]:o},bubbles:!0,composed:!0}))},o=e[t.id],s=o==null?``:String(o);switch(t.editorType){case`boolean`:return w`<vaadin-checkbox ?checked=${!!o} @checked-changed=${e=>a(e.detail.value)}></vaadin-checkbox>`;case`integer`:return w`<vaadin-integer-field theme="small" style="width:100%;" .value=${s} @change=${e=>a(lu(e.target.value,!0))}></vaadin-integer-field>`;case`number`:return w`<vaadin-number-field theme="small" style="width:100%;" .value=${s} @change=${e=>a(lu(e.target.value))}></vaadin-number-field>`;case`date`:return w`<vaadin-date-picker theme="small" style="width:100%;" .value=${s} @value-changed=${e=>a(e.detail.value)}></vaadin-date-picker>`;case`time`:return w`<vaadin-time-picker theme="small" style="width:100%;" .value=${s} @value-changed=${e=>a(e.detail.value)}></vaadin-time-picker>`;case`datetime`:return w`<vaadin-date-time-picker theme="small" style="width:100%;" .value=${s} @value-changed=${e=>a(e.detail.value)}></vaadin-date-time-picker>`;case`select`:return w`<vaadin-combo-box
                ...
                .selectedItem=${(t.editorOptions??[]).find(e=>String(e.value)===s)??(s?{value:s,label:su(e,t.id)??s}:void 0)}
                @selected-item-changed=${n=>{let r=n.detail.value,i=r?r.value:null;String(i??``)!==s&&(r&&cu(e,t.id,r.label),a(i))}}></vaadin-combo-box>`}default:return w`<vaadin-text-field theme="small" style="width:100%;" .value=${s} @change=${e=>a(e.target.value)}></vaadin-text-field>`}},du=e=>ee(()=>w`<span title="${e}" style="white-space:normal;overflow-wrap:break-word;">${e}</span>`,[e]),fu=e=>e===void 0?v:d(()=>w`<span style="font-weight: 600; white-space: nowrap;">${e}</span>`,[e]),pu=e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget?.dispatchEvent(new CustomEvent(`sort-direction-changed`,{detail:{grid:e.currentTarget.parentElement},bubbles:!0,composed:!0}))},mu=(e,t,n,r,i,a,o,s)=>w`
<vaadin-grid-column-group header="${j(e.label,r,i)}">
    ${e.columns.map(e=>gu(e.metadata,t,n,r,i,a,o,s?.[e.metadata?.id]))}
</vaadin-grid-column-group>
`,hu=(e,t,n,r,i,a,o,s)=>A.GridGroupColumn==e.metadata?.type?mu(e.metadata,t,n,r,i,a,o,s):gu(e.metadata,t,n,r,i,a,o,s?.[e.metadata?.id]),gu=(e,n,r,i,a,o,s,c)=>{let l=j(e.label,i,a);return e.sortable?w`
                        <vaadin-grid-sort-column
                                ...
                                width="${e.width??v}"
                                @direction-changed="${pu}"
                                data-data-type="${e.dataType}"
                                data-stereotype="${e.stereotype}"
                                ${du(l)}
                                ${fu(c)}
                                ${t((t,c,l)=>_u(t,c,l,e,n,r,i,a,o,s),[e,i,a])}
                        ></vaadin-grid-sort-column>
                    `:e.filterable?w`
                    ...
                    `:w`
                        <vaadin-grid-column
                                ...
                                ${t((t,c,l)=>_u(t,c,l,e,n,r,i,a,o,s),[e,i,a])}
                        ></vaadin-grid-column>
                    `},_u=(e,t,n,r,i,a,o,s,c,l)=>{let u=n.dataset.dataType??``,d=n.dataset.stereotype??``;if(Rl(e)){let t=i?.metadata,n=(t?.columns??[]).flatMap(e=>e?.metadata?.type===A.GridGroupColumn?(e.metadata.columns??[]).map(e=>e?.metadata?.id):[e?.metadata?.id]),a=Ul(e,r,Hl(e.__mateuGroupBy,n)),o=e.__mateuGroup.hiddenActions??[],s=r.id===n[n.length-1]?(t?.groupActions??[]).filter(e=>!o.includes(e.actionId??e.id)):[];return s.length?w`<span style="display: flex; align-items: center; justify-content: flex-end; gap: var(--lumo-space-s); overflow: hidden;">
                ...
                `)}
            </span>`:w`<span title="${a}" style="font-weight: 600; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; display: block;">${a}</span>`}if(r.editable)return uu(e,r,i,o);if(u==`status`)return no(e,t,n);if(u==`bool`)return Gl(e,t,n);if(u==`money`||d==`money`)return Kl(e,t,n,u,d);if(u==`link`||d==`link`)return Jl(e,t,n,u,d,r);if(u==`icon`||d==`icon`)return Yl(e,t,n,u,d);if(d==`html`)return Xl(e,t,n,u,d);if(d==`image`)return Zl(e,t,n,u,d,r);if(u==`menu`)return tu(e,t,n);if(u==`component`)return au(e,t,n,i,a,o,s,c,l);if(u==`action`)return nu(e,t,n);if(u==`actionGroup`)return tu(e,t,n);if(d==`button`||r.actionId)return iu(e,t,n,u,d,r);let f=e[n.path],p=i?.metadata?.rowRoute;if(r.identifier&&p){let t=Ut(p,e,o,s);if(t)return w`<a href="${`/`+t.replace(/^\/+/,``)}" title="${f}"
            ...
            >
                ...
                `}
                ${this.field?.columns?.map(e=>hu(e,this,this.baseUrl,this.state,this.data,this.appState,this.appData))}
    ...
    `}};O([y()],bu.prototype,`field`,void 0),O([y()],bu.prototype,`state`,void 0),O([y()],bu.prototype,`data`,void 0),O([y()],bu.prototype,`appState`,void 0),O([y()],bu.prototype,`appData`,void 0),O([y()],bu.prototype,`selectedItems`,void 0),O([C()],bu.prototype,`detailsOpenedItems`,void 0),bu=O([g(`mateu-grid`)],bu);var xu=class extends b{constructor(...e){super(...e),this.getNewValue=e=>{if(this.field?.dataType==`array`){if(!this.value)return[e];let t=this.value;return t.indexOf(e)>=0?t.filter(t=>t!==e):[...t,e]}return e}}render(){let e=this.field?.options;if(this.field?.remoteCoordinates){let t=this.field.remoteCoordinates;this.data?.[this.field.fieldId]&&this.data[this.field.fieldId].content&&this.data[this.field.fieldId].totalElements?e=this.data[this.field.fieldId].content:this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.action,parameters:{searchText:``,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0}))}return w`
       ...
       `}static{this.styles=h`
        ...
        ${L}
    `}};O([y()],xu.prototype,`field`,void 0),O([y()],xu.prototype,`baseUrl`,void 0),O([y()],xu.prototype,`state`,void 0),O([y()],xu.prototype,`data`,void 0),O([y()],xu.prototype,`value`,void 0),xu=O([g(`mateu-choice`)],xu);var Su,Cu=class extends b{static{Su=this}constructor(...e){super(...e),this.commit=e=>{this.value=e,this.dispatchEvent(new CustomEvent(`value-changed`,{detail:{value:{...e},fieldId:this.fieldId}}))},this.currencyChanged=e=>{let t=this.value??Su.EMPTY;!e.detail.value||e.detail.value===t.currency||this.commit({...t,currency:e.detail.value})},this.valueChanged=e=>{let t=this.value??Su.EMPTY,n=Il(e.detail.value,!1)??0;n!==t.value&&this.commit({...t,value:n})}}static{this.EMPTY={value:0,currency:`EUR`,locale:`es-ES`}}render(){return w`
            <vaadin-number-field
                    id="${this.fieldId}"
                    label="${this.label}"
...
`}copyValue(e){navigator.clipboard.writeText(e).then(()=>r.show(`Copied`,{position:`bottom-end`,theme:`success`,duration:2e3})).catch(()=>{})}renderFileField(e,t,n,r){if(!this.field)return w``;let i=t?.map(e=>({id:e.id,name:e.name,type:``,uploadTarget:``,complete:!0}))??[];return w`
            ...
            `}renderStringField(e,t,n,r){if(!this.field)return w``;if(this.field?.stereotype==`searchable`)return w`
              ...
              ${e.description}
                ...
                `;if(this.field?.stereotype==`fileUpload`){let e=Nl(this.field.attributes,`accept`);return w`
                    <vaadin-custom-field
                            id="${this.field.fieldId}"
                            label="${n}"
                            .helperText="${this.helperText()}"
...
`;if(this.field?.stereotype==`listBox`){if(this.field?.remoteCoordinates){let e=this.field.remoteCoordinates;return this.data[this.id]&&this.data[this.id].searchSignature&&this.data[this.id].searchSignature!=``&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements||this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.action,parameters:{searchText:``,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0})),w`
  ...
  `}};O([C()],Q.prototype,`ui5FieldComponentsReady`,void 0),O([y()],Q.prototype,`component`,void 0),O([y()],Q.prototype,`field`,void 0),O([y()],Q.prototype,`baseUrl`,void 0),O([y()],Q.prototype,`state`,void 0),O([y()],Q.prototype,`data`,void 0),O([y()],Q.prototype,`appState`,void 0),O([y()],Q.prototype,`appData`,void 0),O([y()],Q.prototype,`labelAlreadyRendered`,void 0),O([C()],Q.prototype,`colorPickerOpened`,void 0),O([C()],Q.prototype,`colorPickerValue`,void 0),O([C()],Q.prototype,`controlOwnsValidity`,void 0),O([C()],Q.prototype,`filteredIcons`,void 0),O([C()],Q.prototype,`navLinkOffset`,void 0),Q=O([g(`mateu-field`)],Q);var Du=(e,t,n,r,i,a,o,s)=>{let c=t.metadata;return w`
    ...
    `},Ou=(e,n,r,i,a,o,s)=>{let c=n.metadata;if(c.tree)return w`
        ...
        >
            ...
            <vaadin-grid-column path="${n.id}"
                                ...
                                width="${l?.width??v}"
                                .column="${n.metadata}"
                                ${t((t,n,c)=>_u(t,n,c,l,e,r,i,a,o,s),[])}></vaadin-grid-column>
`:w`
...
`})}
    ...
    `},$=class extends b{constructor(...e){super(...e),this.id=``,this.baseUrl=``,this.state={},this.data={},this.appState={},this.appData={},this.detailsOpenedItems=[],this.pagesRequested=[],this._lastGridHeight=0,this.emptyArray=e=>!e||e.length==0,this.dataProvider=(e,t)=>{let n=this.data[this.id]?.page;if(this.metadata?.infiniteScrolling&&e.page>0){let r=!1;n&&n.content&&(n.content.length>=(e.page+1)*e.pageSize||n.content.length==n.totalElements)&&(t(n.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),n.totalElements),r=!0,this.grid&&this.grid.recalculateColumnWidths()),r||this.pagesRequested.find(t=>t==e.page)||(this.pagesRequested.push(e.page),this.dispatchEvent(new CustomEvent(`fetch-more-elements`,{detail:{params:e,callback:()=>{this.data[this.id]?.page?.content&&(t(this.data[this.id].page.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),this.data[this.id].page.totalElements),this.grid&&this.grid.recalculateColumnWidths())}},bubbles:!0,composed:!0})))}else{let e=this.metadata?.infiniteScrolling?n?.totalElements:n?.content?.length??0;t(n?.content??[],e),this.grid&&this.grid.recalculateColumnWidths()}},this._onActionRequested=e=>{let t=e.detail,n=this.identifierFieldName;if(!n||!t.parameters||t.actionId?.startsWith(`action-on-row-`))return;let r=t.parameters[n];r!==void 0&&(this.state._selectedId=String(r),this._applyCellPartNameGenerator(),this.grid?.requestContentUpdate())},this.tooltipGenerator=e=>{let t=``,{column:n,item:r}=e,i=this.metadata?.columns?.find(e=>e.metadata.id==n?.path);if(i?.metadata){let e=(i?.metadata).tooltipPath;e&&n&&r&&(t=r[e])}return t}}get identifierFieldName(){let e=this.metadata?.columns?.find(e=>e.metadata?.identifier);if(e)return e.metadata?.id;if(this.metadata?.columns?.find(e=>e.metadata?.id===`id`))return`id`}_applyCellPartNameGenerator(){if(!this.grid)return;let e=this.identifierFieldName,t=this.state?._selectedId??this.appState?._splitDetailId,n=!!this.metadata?.groupBy;e&&t!==void 0||n?this.grid.cellPartNameGenerator=(n,r)=>{let i=r.item;return Rl(i)?`mateu-group-row`:e&&t!==void 0&&String(i[e])===String(t)?`selected-row`:``}:this.grid.cellPartNameGenerator=null}connectedCallback(){super.connectedCallback(),this.addEventListener(`action-requested`,this._onActionRequested)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`action-requested`,this._onActionRequested),this._resizeObserver?.disconnect(),this._resizeObserver=void 0}firstUpdated(){let e=this.grid;!e||this._resizeObserver||(this._resizeObserver=new ResizeObserver(()=>{let t=e.offsetHeight;t>0&&this._lastGridHeight===0&&requestAnimationFrame(()=>{e.recalculateColumnWidths(),e.requestContentUpdate(),e.notifyResize?.()}),this._lastGridHeight=t}),this._resizeObserver.observe(e))}updated(e){super.updated(e),this._applyCellPartNameGenerator(),this.grid?.clearCache(),this.grid?.requestContentUpdate(),this.grid?.recalculateColumnWidths(),this.pagesRequested=[]}navigateToRowRoute(e){let t=(this.shadowRoot?.querySelector(`vaadin-grid`))?.getEventContext?.(e)?.item;if(!t||Rl(t)||e.composedPath().some(e=>e?.tagName&&/^(A|BUTTON|INPUT|VAADIN-BUTTON|VAADIN-CHECKBOX)$/.test(e.tagName)))return;let n=Ut(this.metadata?.rowRoute,t,this.state,this.data);n&&Wt(this,n)}render(){let e=this.data[this.id],r=e?.page,i=this.metadata?.groupBy,a=this.metadata?.infiniteScrolling?void 0:r?.content?Bl(r.content,i,e?.groups):r?.content,o=Wl((this.metadata?.columns??[]).flatMap(e=>e.metadata?.type===A.GridGroupColumn?(e.metadata.columns??[]).map(e=>e.metadata):[e.metadata]),e,i),s=``;return this.metadata?.wrapCellContent&&(s+=` wrap-cell-content`),this.metadata?.compact&&(s+=` compact`),this.metadata?.noBorder&&(s+=` no-border`),this.metadata?.noRowBorder&&(s+=` no-row-borders`),this.metadata?.columnBorders&&(s+=` column-borders`),this.metadata?.rowStripes&&(s+=` row-stripes`),w`
            <vaadin-grid
                    ...
                    @active-item-changed="${S(this.metadata?.detailPath&&!this.metadata?.useButtonForDetail?e=>{let t=e.detail.value;t&&Rl(t)||(this.detailsOpenedItems=t?[t]:[])}:void 0)}"
            ...
            >
                ...
                `:v}
                ${this.metadata?.columns?.map(e=>hu(e,this,this.baseUrl,this.state,this.data,this.appState,this.appData,o))}
  ...
  `}};O([y()],$.prototype,`id`,void 0),O([y()],$.prototype,`metadata`,void 0),O([y()],$.prototype,`baseUrl`,void 0),O([y()],$.prototype,`state`,void 0),O([y()],$.prototype,`data`,void 0),O([y()],$.prototype,`appState`,void 0),O([y()],$.prototype,`appData`,void 0),O([y()],$.prototype,`emptyStateMessage`,void 0),O([C()],$.prototype,`detailsOpenedItems`,void 0),O([x(`vaadin-grid`)],$.prototype,`grid`,void 0),$=O([g(`mateu-table`)],$);var ku=(e,t,n,r,i,a,o)=>w`
    ...
    <mateu-table id="${e.id}"
                 ...
                 @fetch-more-elements="${e.fetchMoreElements}"
                 baseUrl="${n}"
    ></mateu-table>`,ju=(e,t,n,r,i,a,o)=>{let s=t.metadata;return w`
    ...
    <div style="display: flex; gap: var(--lumo-space-xs, .25rem); align-items: center;" class="peer-nav">
        ...
        <vaadin-button theme="tertiary icon" class="peer-nav-next" title="${e.nextLabel??`Next`}"
    ...
    </div>`,Pu={"vaadin:wifi":`vaadin:connect`,"vaadin:pen":`vaadin:pencil`,"vaadin:automation":`vaadin:cogs`},Fu=(e,t,n)=>w`<vaadin-icon icon="${Pu[e]??e}" style="${t??v}" class="${n??v}"></vaadin-icon>`,Iu=(e,t,n)=>{let r=e.metadata,i=j(r.label,t,n),a=``;return r.buttonStyle&&(a+=` `+r.buttonStyle),r.color&&r.color!==`none`&&r.color!==`normal`&&(a+=` `+r.color),r.size&&r.size!==`none`&&r.size!==`normal`&&(a+=` `+r.size),w`<vaadin-button
            id="${e.id}"
            data-action-id="${r.actionId}"
            data-route="${jr(r,t,n)??v}"
            @click="${e=>Ar(e,r)}"
            ...
            title="${r.shortcut?`${i} (${kr(r.shortcut)})`:v}"
            slot="${e.slot??v}"
    >${r.iconOnLeft?w`<vaadin-icon icon="${r.iconOnLeft}"></vaadin-icon>`:v}${i}${r.iconOnRight?w`<vaadin-icon icon="${r.iconOnRight}"></vaadin-icon>`:v}</vaadin-button>`},Lu=e=>{let t=e.metadata;return w`
        ...
        ></vaadin-message-input>
    `},Ru=e=>{let t=(e.metadata.items??[]).map(e=>({text:e.text,time:e.time,userName:e.userName,userImg:e.userImg,userAbbr:e.userAbbr,userColorIndex:e.userColorIndex}));return w`
        <vaadin-message-list
                markdown
                style="${e.style}" class="${e.cssClasses}"
                slot="${e.slot??v}"
                .items="${t}"
        ></vaadin-message-list>
    `},zu=(e,t)=>{e&&e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t},bubbles:!0,composed:!0}))},Bu=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=!1;if(s.openedCondition)try{c=kt(s.openedCondition,r,i,a,o)}catch(e){console.error(`when evaluating `+s.openedCondition+` :`+e+`, where data is `+i+` and state is `+r)}return w`
    ...
    `}render(){let e=this.navigation,t=!!(this.overviewEditActionId||e&&(e.parentActionId||e.previousActionId||e.nextActionId)),n=!!(this.headerTitle||t||this.badges.length);return w`
            ...
            `:v}
        `}};O([y({type:Array})],Vu.prototype,`panels`,void 0),O([y({type:String})],Vu.prototype,`headerTitle`,void 0),O([y({type:Array})],Vu.prototype,`badges`,void 0),O([y({attribute:!1})],Vu.prototype,`navigation`,void 0),O([y({type:String})],Vu.prototype,`overviewEditActionId`,void 0),O([x(`.rail`)],Vu.prototype,`_rail`,void 0),O([x(`.section--first`)],Vu.prototype,`_first`,void 0),O([C()],Vu.prototype,`_less`,void 0),O([C()],Vu.prototype,`_more`,void 0),Vu=O([g(`mateu-vaadin-foldout`)],Vu);var Hu=(e,t,n,r,i,a,o)=>{let s=t.metadata;return w`
    ...
    `}};O([y({attribute:!1})],Uu.prototype,`rows`,void 0),O([y({attribute:!1})],Uu.prototype,`columns`,void 0),O([y()],Uu.prototype,`idField`,void 0),O([y({type:Boolean})],Uu.prototype,`navigable`,void 0),O([y()],Uu.prototype,`selectedId`,void 0),O([C()],Uu.prototype,`expandedItems`,void 0),O([x(`vaadin-grid`)],Uu.prototype,`_grid`,void 0),Uu=O([g(`mateu-vaadin-tree`)],Uu);var Wu={[A.VirtualList]:(e,t,n,r,i,a,o)=>$c(e,t,n,r,i,a,o),[A.Notification]:(e,t)=>el(t),[A.ProgressBar]:(e,t,n,r)=>tl(t,r),[A.Details]:(e,t,n,r,i,a,o)=>nl(e,t,n,r,i,a,o),[A.Avatar]:(e,t,n,r,i)=>rl(t,r,i),[A.AvatarGroup]:(e,t)=>il(t),[A.Card]:(e,t,n,r,i,a,o)=>al(e,t,n,r,i,a,o),[A.Button]:(e,t,n,r,i)=>Iu(t,r,i),[A.MessageInput]:(e,t)=>Lu(t),[A.MessageList]:(e,t)=>Ru(t),[A.ConfirmDialog]:(e,t,n,r,i,a,o)=>Bu(e,t,n,r,i,a,o),[A.FormLayout]:(e,t,n,r,i,a,o)=>cl(e,t,n,r,i,a,o),[A.HorizontalLayout]:(e,t,n,r,i,a,o)=>fl(e,t,n,r,i,a,o),[A.VerticalLayout]:(e,t,n,r,i,a,o)=>pl(e,t,n,r,i,a,o),[A.SplitLayout]:(e,t,n,r,i,a,o)=>ml(e,t,n,r,i,a,o),[A.MasterDetailLayout]:(e,t,n,r,i,a,o)=>hl(e,t,n,r,i,a,o),[A.TabLayout]:(e,t,n,r,i,a,o)=>gl(e,t,n,r,i,a,o),[A.AccordionLayout]:(e,t,n,r,i,a,o)=>vl(e,t,n,r,i,a,o),[A.BoardLayout]:(e,t,n,r,i,a,o)=>xl(e,t,n,r,i,a,o),[A.BoardLayoutRow]:(e,t,n,r,i,a,o)=>Sl(e,t,n,r,i,a,o),[A.BoardLayoutItem]:(e,t,n,r,i,a,o)=>Cl(e,t,n,r,i,a,o),[A.Scroller]:(e,t,n,r,i,a,o)=>bl(e,t,n,r,i,a,o),[A.MenuBar]:(e,t,n,r,i)=>El(e,t,n,r,i),[A.ContextMenu]:(e,t,n,r,i,a,o)=>Tl(e,t,n,r,i,a,o),[A.FormField]:(e,t,n,r,i,a,o,s)=>Du(e,t,n,r,i,a,o,s),[A.Grid]:(e,t,n,r,i,a,o)=>Ou(e,t,n,r,i,a,o),[A.Table]:(e,t,n,r,i,a,o)=>ku(e,t,n,r,i,a,o),[A.Popover]:(e,t,n,r,i,a,o)=>ju(e,t,n,r,i,a,o),[A.FoldoutLayout]:(e,t,n,r,i,a,o)=>Hu(e,t,n,r,i,a,o)},Gu=class extends Qc{rendererName(){return`vaadin`}renderClientSideComponent(e,t,n,r,i,a,o,s){let c=t?.metadata?.type,l=c?Wu[c]:void 0;return l&&t?l(e,t,n,r,i,a,o,s):super.renderClientSideComponent(e,t,n,r,i,a,o,s)}renderTableComponent(e,t,n,r,i,a,o){return Au(e,t,n,r,a,o)}renderTreeComponent(e,t){return w`
            <mateu-vaadin-tree
                    .rows="${t.rows}"
                    .columns="${t.columns}"
                    .idField="${t.idField}"
            ...
            ></mateu-vaadin-tree>`}renderToolbarButton(e,t,n){return Mu(e,t,n)}renderPeerNav(e){return Nu(e)}renderIcon(e,t,n){return Fu(e,t,n)}renderTopNav(e,t,n){return wl(e,t,n)}};function Ku(e){switch(e){case`topStretch`:return`top-stretch`;case`topStart`:return`top-start`;case`topCenter`:return`top-center`;case`topEnd`:return`top-end`;case`middle`:return`middle`;case`bottomStart`:return`bottom-start`;case`bottomEnd`:return`bottom-end`;case`bottomStretch`:return`bottom-stretch`;case`bottomCenter`:return`bottom-center`}return`bottom-end`}function qu(e,t){if(e.onAction)return{label:e.actionLabel??`Retry`,run:e.onAction};if(e.undoActionId)return{label:e.undoLabel??`Undo`,run:()=>t.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.undoActionId,parameters:e.undoParameters??{}},bubbles:!0,composed:!0}))}}function Ju(e,t){let n=new r;n.position=Ku(e.position),n.duration=e.duration??1e4,e.variant&&n.setAttribute(`theme`,e.variant),n.renderer=r=>{if(r.firstElementChild)return;let i=document.createElement(`span`);i.textContent=e.text;let a=qu(e,t),o=document.createElement(`button`);o.textContent=a.label,o.style.cssText=`margin-left: 0.75rem; background: none; border: 1px solid currentColor; border-radius: var(--lumo-border-radius-s, 4px); color: inherit; cursor: pointer; padding: 0.15rem 0.6rem; font: inherit; font-weight: 600;`,o.addEventListener(`click`,()=>{a.run(),n.opened=!1}),r.append(i,o)},document.body.appendChild(n),n.opened=!0,n.addEventListener(`opened-changed`,e=>{e.detail.value||n.remove()})}M.set(new Gu),ao({show(e,t){if(St(e.text,{politeness:e.variant===`error`?`assertive`:`polite`}),e.undoActionId||e.onAction){Ju(e,t);return}r.show(e.text,{position:e.position?Ku(e.position):`bottom-end`,theme:e.variant,duration:e.duration})}});