...
import{d as o,A as l,a as w,j as p,r as b,i as _,k as x,m as ye,D as Ms,c as T,w as V,p as Fe,q as Br}from"./vendor-lit.js";import{v as Vr,b as it,e as Hr,f as Wr,_ as ue,n as qs,p as Us,N as jt,i as Pt,j as yi,k as js,l as Fi,m as Yi,o as Gr}from"./vendor-vaadin.js";import{S as Kr,n as Q,a as Yr,b as Jr}from"./vendor.js";import"./vendor-ui5.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=a(i);fetch(i.href,r)}})();class Xr{constructor(){this.afterRenderHook=void 0,this.useShadowRoot=!0,this.componentRenderer=void 0}set(t){if(this.componentRenderer=t,typeof window<"u"){const a=t.supportedClientSideTypes?.();window.__mateuRendererInfo={name:t.rendererName?.()??t.constructor?.name??"unknown",supportedTypes:a?[...a].sort():null}}}get(){return this.componentRenderer}setUseShadowRoot(t){this.useShadowRoot=t}mustUseShadowRoot(){return this.useShadowRoot}setAfterRenderHook(t){this.afterRenderHook=t}getAfterRenderHook(){return this.afterRenderHook}}const H=new Xr;var h=(e=>(e.Page="Page",e.Div="Div",e.Element="Element",e.MicroFrontend="MicroFrontend",e.Form="Form",e.Crud="Crud",e.Result="Result",e.Card="Card",e.Directory="Directory",e.Stepper="Stepper",e.HorizontalLayout="HorizontalLayout",e.VerticalLayout="VerticalLayout",e.SplitLayout="SplitLayout",e.MasterDetailLayout="MasterDetailLayout",e.TabLayout="TabLayout",e.AccordionLayout="AccordionLayout",e.FormLayout="FormLayout",e.FormRow="FormRow",e.FormItem="FormItem",e.BoardLayout="BoardLayout",e.BoardLayoutRow="BoardLayoutRow",e.BoardLayoutItem="BoardLayoutItem",e.Scroller="Scroller",e.FullWidth="FullWidth",e.Container="Container",e.FormField="FormField",e.Table="Table",e.App="App",e.Text="Text",e.Avatar="Avatar",e.Chat="Chat",e.AvatarGroup="AvatarGroup",e.Badge="Badge",e.Breadcrumbs="Breadcrumbs",e.Anchor="Anchor",e.Button="Button",e.Chart="Chart",e.Icon="Icon",e.ConfirmDialog="ConfirmDialog",e.ContextMenu="ContextMenu",e.CookieConsent="CookieConsent",e.Details="Details",e.Dialog="Dialog",e.Drawer="Drawer",e.Image="Image",e.Map="Map",e.Markdown="Markdown",e.Notification="Notification",e.ProgressBar="ProgressBar",e.Popover="Popover",e.CarouselLayout="CarouselLayout",e.Tooltip="Tooltip",e.MessageInput="MessageInput",e.MessageList="MessageList",e.CustomField="CustomField",e.MenuBar="MenuBar",e.Grid="Grid",e.GridColumn="GridColumn",e.GridGroupColumn="GridGroupColumn",e.VirtualList="VirtualList",e.FormSection="FormSection",e.FormSubSection="FormSubSection",e.Bpmn="Bpmn",e.Workflow="Workflow",e.WorkflowElk="WorkflowElk",e.FormEditor="FormEditor",e.MetricCard="MetricCard",e.Scoreboard="Scoreboard",e.DashboardPanel="DashboardPanel",e.DashboardLayout="DashboardLayout",e.FoldoutLayout="FoldoutLayout",e.HeroSection="HeroSection",e.EmptyState="EmptyState",e.Skeleton="Skeleton",e.Gantt="Gantt",e.PlanningBoard="PlanningBoard",e.Kanban="Kanban",e.Timeline="Timeline",e.ProgressSteps="ProgressSteps",e.Stat="Stat",e.Calendar="Calendar",e.PricingTable="PricingTable",e.OrgChart="OrgChart",e.Heatmap="Heatmap",e.Funnel="Funnel",e.TrendChart="TrendChart",e.FeatureGrid="FeatureGrid",e.Testimonials="Testimonials",e.Faq="Faq",e.CalloutCard="CalloutCard",e.CommentThread="CommentThread",e.FileList="FileList",e.Checklist="Checklist",e.ComparisonCard="ComparisonCard",e.EntityHeader="EntityHeader",e.Meter="Meter",e.TaskProgress="TaskProgress",e.StatusList="StatusList",e.BulletedList="BulletedList",e.Separator="Separator",e.Notice="Notice",e.TaskQueue="TaskQueue",e.ResourceGrid="ResourceGrid",e.OfferCard="OfferCard",e.AddOnPicker="AddOnPicker",e.Ledger="Ledger",e.PaymentPicker="PaymentPicker",e.ProcessMonitor="ProcessMonitor",e))(h||{}),pe=(e=>(e.ServerSide="ServerSide",e.ClientSide="ClientSide",e))(pe||{});const Mt=(e,t,a,s,i,r,n,d,c)=>(t.slot=d,k(e,t,a,s,i,r,n,c)),k=(e,t,a,s,i,r,n,d)=>{if(!t)return o``;if(t.type==pe.ClientSide)return H.get().renderClientSideComponent(e,t,a,s,i,r,n,d);const c=e.route,u=e.consumedRoute;return o`
    ...
    `;xi([p({type:Array})],da.prototype,"tabLabels",2);xi([b()],da.prototype,"mode",2);xi([b()],da.prototype,"selected",2);da=xi([x("mateu-adaptive-tabs")],da);const ao=(e,t,a,s,i,r,n)=>{const d=t.metadata;let c=t.style;return c==null&&(c=""),d.columnSpacing&&(c+="--vaadin-form-layout-column-spacing: "+d.columnSpacing+";"),d.itemRowSpacing&&(c+="--vaadin-form-layout-row-spacing: "+d.itemRowSpacing+";"),d.itemLabelSpacing&&(c+="--vaadin-form-layout-label-spacing: "+d.itemLabelSpacing+";"),d.labelsAside&&(c+="--vaadin-form-item-label-width: 92px;"),d.fullWidth&&(c+="width: 100%;"),o`
            ...
            `},Bs=(e,t,a,s,i,r,n,d)=>a.type==pe.ClientSide&&a.metadata?.type==h.FormRow?so(e,t,a,s,i,r,n,d):e.labelsAside?io(t,a,s,i,r,n,d):k(t,a,s,i,r,n,d),io=(e,t,a,s,i,r,n)=>{if(t.type==pe.ClientSide&&t.metadata?.type==h.FormField&&t.metadata.label){const d=t.metadata,c=d.label?.includes("${")?e._evalTemplate(d.label):d.label;return o`
...
`;return o`
    ...
    `},Mo=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},qo=(e,t,a,s,i,r)=>{const n=a.xcolumn??r;if(n.actionId){const c=n.text||e[a.path];return o`
        ...
        `}const d=e[a.path];return o`<a href="${d}">${n.text||d}</a>`},Uo=(e,t,a,s,i,r,n,d,c)=>{const u=e[a.path];return k(s,u,i,r,n,d,c)},Vi=new WeakMap,jo=(e,t)=>Vi.get(e)?.[t],Bo=(e,t,a)=>{let s=Vi.get(e);s||(s={},Vi.set(e,s)),s[t]=a},$s=e=>{if(e==null||e==="")return null;const t=Number(e);return Number.isNaN(t)?null:t},Vo=(e,t,a,s)=>{const i=a?.field?.fieldId,r=c=>{if(e[t.id]===c||e[t.id]==null&&(c===""||c==null))return;if(e[t.id]=c,!i){a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"update-row",parameters:{_editedRow:{...e}}},bubbles:!0,composed:!0}));return}const m=(a?.state??s)[i];a.dispatchEvent(new CustomEvent("value-changed",{detail:{fieldId:i,value:Array.isArray(m)?[...m]:m},bubbles:!0,composed:!0}))},n=e[t.id],d=n==null?"":String(n);switch(t.editorType){case"boolean":return o`<vaadin-checkbox ?checked=${!!n} @checked-changed=${c=>r(c.detail.value)}></vaadin-checkbox>`;case"integer":return o`<vaadin-integer-field theme="small" style="width:100%;" .value=${d} @change=${c=>r($s(c.target.value))}></vaadin-integer-field>`;case"number":return o`<vaadin-number-field theme="small" style="width:100%;" .value=${d} @change=${c=>r($s(c.target.value))}></vaadin-number-field>`;case"date":return o`<vaadin-date-picker theme="small" style="width:100%;" .value=${d} @value-changed=${c=>r(c.detail.value)}></vaadin-date-picker>`;case"time":return o`<vaadin-time-picker theme="small" style="width:100%;" .value=${d} @value-changed=${c=>r(c.detail.value)}></vaadin-time-picker>`;case"datetime":return o`<vaadin-date-time-picker theme="small" style="width:100%;" .value=${d} @value-changed=${c=>r(c.detail.value)}></vaadin-date-time-picker>`;case"select":return o`<vaadin-combo-box
                ...
                .dataProvider=${(y,$)=>{a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:u,parameters:{searchText:y.filter,size:y.pageSize,page:y.page},callback:E=>{const N=E?.fragments?.[0]?.data?.[m];$(N?.content??[],N?.totalElements??0)},callbackonly:!0},bubbles:!0,composed:!0}))}}
                .selectedItem=${f}
                @selected-item-changed=${y=>{const $=y.detail.value,E=$?$.value:null;String(E??"")!==d&&($&&Bo(e,t.id,$.label),r(E))}}></vaadin-combo-box>`}default:return o`<vaadin-text-field theme="small" style="width:100%;" .value=${d} @change=${c=>r(c.target.value)}></vaadin-text-field>`}},Mi=e=>Hr(()=>o`<span title="${e}" style="white-space:normal;overflow-wrap:break-word;">${e}</span>`,[e]),qi=e=>e!==void 0?Wr(()=>o`<span style="font-weight: 600; white-space: nowrap;">${e}</span>`,[e]):l,Ho=e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget?.dispatchEvent(new CustomEvent("sort-direction-changed",{detail:{grid:e.currentTarget.parentElement},bubbles:!0,composed:!0}))},Wo=(e,t,a,s,i,r,n,d)=>{const c=Re(e.label,s,i);return o`
<vaadin-grid-column-group header="${c}">
    ${e.columns.map(u=>Xs(u.metadata,t,a,s,i,r,n,d?.[u.metadata?.id]))}
</vaadin-grid-column-group>
`},Xi=(e,t,a,s,i,r,n,d)=>h.GridGroupColumn==e.metadata?.type?Wo(e.metadata,t,a,s,i,r,n,d):Xs(e.metadata,t,a,s,i,r,n,d?.[e.metadata?.id]),Xs=(e,t,a,s,i,r,n,d)=>{const c=Re(e.label,s,i);return e.sortable?o`
                        <vaadin-grid-sort-column
                                ...
                                ${Mi(c)}
                                ${qi(d)}
                                ${it((u,m,v)=>ti(u,m,v,e,t,a,s,i,r,n),[])}
                        ></vaadin-grid-sort-column>
                    `:e.filterable?o`
                    ...
                    `:o`
                        <vaadin-grid-column
                                ...
                                ${it((u,m,v)=>ti(u,m,v,e,t,a,s,i,r,n),[])}
                        ></vaadin-grid-column>
                    `},ti=(e,t,a,s,i,r,n,d,c,u)=>{const m=a.dataset.dataType??"",v=a.dataset.stereotype??"";if(Oa(e)){const g=i?.metadata,y=(g?.columns??[]).flatMap(C=>C?.metadata?.type===h.GridGroupColumn?(C.metadata.columns??[]).map(D=>D?.metadata?.id):[C?.metadata?.id]),$=Ks(e.__mateuGroupBy,y),E=Ys(e,s,$),N=e.__mateuGroup.hiddenActions??[],B=s.id===y[y.length-1]?(g?.groupActions??[]).filter(C=>!N.includes(C.actionId??C.id)):[];return B.length?o`<span style="display: flex; align-items: center; justify-content: flex-end; gap: var(--lumo-space-s); overflow: hidden;">
                ${E?o`<span style="font-weight: 600;">${E}</span>`:l}
                ${B.map(C=>o`
                    <vaadin-button theme="tertiary small" style="flex-shrink: 0;"
                        @click="${D=>{D.stopPropagation(),D.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-"+(C.actionId??C.id),parameters:{_groupValue:e.__mateuGroup.value}},bubbles:!0,composed:!0}))}}">${C.label??C.caption??""}</vaadin-button>
                `)}
        ...
        >
            ...
            <vaadin-grid-column path="${m.id}"
                                ...
                                width="${f?.width??l}"
                                .column="${m.metadata}"
                                ${it((g,y,$)=>ti(g,y,$,f,e,a,s,i,r,n),[])}></vaadin-grid-column>
`:o`
...
`})}
    ...
    `},Ko=e=>{const a=(e.metadata.items??[]).map(s=>({text:s.text,time:s.time,userName:s.userName,userImg:s.userImg,userAbbr:s.userAbbr,userColorIndex:s.userColorIndex}));return o`
        <vaadin-message-list
                ...
                .items="${a}"
        ></vaadin-message-list>
    `},bt=new Kr,Y={value:{}},za={value:{}},Yo=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
...
`,Fn=e=>e=="up"?"var(--lumo-success-text-color, #1a7f37)":e=="down"?"var(--lumo-error-text-color, #c5221f)":"var(--lumo-secondary-text-color, #666)",Nn=e=>e=="up"?"▲":e=="down"?"▼":"",Mn=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},qn=e=>{const t=e.metadata,a=!!t.actionId;return o`
    ...
    `;ar([p({type:Array})],ai.prototype,"tasks",2);ai=ar([x("mateu-gantt")],ai);const Jn=e=>{const t=e.metadata;return o`
        <mateu-gantt
                .tasks="${t.tasks??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;Tt([p({type:Array})],z.prototype,"resources",2);Tt([p({type:Array})],z.prototype,"blocks",2);Tt([p()],z.prototype,"from",2);Tt([p()],z.prototype,"to",2);Tt([p()],z.prototype,"moveActionId",2);Tt([p()],z.prototype,"selectActionId",2);Tt([b()],z.prototype,"drag",2);z=Tt([x("mateu-planning-board")],z);const Zn=e=>{const t=e.metadata;return o`
        <mateu-planning-board
                ...
                slot="${e.slot??l}"
        ></mateu-planning-board>
    `};var el=Object.defineProperty,tl=Object.getOwnPropertyDescriptor,ir=(e,t,a,s)=>{for(var i=s>1?void 0:s?tl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&el(t,a,i),i};let ii=class extends _{constructor(){super(...arguments),this.columns=[]}clickCard(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedCard:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="board">
    ...
    `;ir([p({type:Array})],ii.prototype,"columns",2);ii=ir([x("mateu-kanban")],ii);const al=e=>{const t=e.metadata;return o`
        <mateu-kanban
                .columns="${t.columns??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-kanban>
    `};var il=Object.defineProperty,sl=Object.getOwnPropertyDescriptor,sr=(e,t,a,s)=>{for(var i=s>1?void 0:s?sl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&il(t,a,i),i};let si=class extends _{constructor(){super(...arguments),this.items=[]}clickItem(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedItem:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="feed">
                ${this.items.map(e=>o`
    ...
    `;sr([p({type:Array})],si.prototype,"items",2);si=sr([x("mateu-timeline")],si);const rl=e=>{const t=e.metadata;return o`
        <mateu-timeline
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-timeline>
    `};var ol=Object.defineProperty,nl=Object.getOwnPropertyDescriptor,rr=(e,t,a,s)=>{for(var i=s>1?void 0:s?nl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ol(t,a,i),i};let ri=class extends _{constructor(){super(...arguments),this.steps=[]}render(){return o`
            <div class="steps">
    ...
    `;rr([p({type:Array})],ri.prototype,"steps",2);ri=rr([x("mateu-progress-steps")],ri);const ll=e=>{const t=e.metadata;return o`
        <mateu-progress-steps
                ...
                slot="${e.slot??l}"
        ></mateu-progress-steps>
    `};var dl=Object.defineProperty,cl=Object.getOwnPropertyDescriptor,Ot=(e,t,a,s)=>{for(var i=s>1?void 0:s?cl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&dl(t,a,i),i};let He=class extends _{constructor(){super(...arguments),this.spark=[]}sparkline(){const e=this.spark;if(!e||e.length<2)return l;const t=84,a=30,s=2,i=Math.min(...e),n=Math.max(...e)-i||1,d=(t-s*2)/(e.length-1),c=e.map((f,g)=>{const y=s+g*d,$=s+(a-s*2)*(1-(f-i)/n);return[y,$]}),u=c.map(([f,g],y)=>`${y===0?"M":"L"}${f.toFixed(1)} ${g.toFixed(1)}`).join(" "),m=`${u} L${c[c.length-1][0].toFixed(1)} ${a} L${c[0][0].toFixed(1)} ${a} Z`,v=this.trend==="down"?"var(--lumo-error-color, #e11d48)":this.trend==="flat"?"var(--lumo-secondary-text-color, #888)":"var(--lumo-success-color, #12b76a)";return V`
    ...
    `;Ot([p()],He.prototype,"label",2);Ot([p()],He.prototype,"value",2);Ot([p()],He.prototype,"unit",2);Ot([p()],He.prototype,"delta",2);Ot([p()],He.prototype,"trend",2);Ot([p({type:Array})],He.prototype,"spark",2);Ot([p()],He.prototype,"actionId",2);He=Ot([x("mateu-stat")],He);const ul=e=>{const t=e.metadata;return o`
        <mateu-stat
                label="${t.label??l}"
                value="${t.value??l}"
                unit="${t.unit??l}"
    ...
    `;dr([p({type:Array})],di.prototype,"stages",2);di=dr([x("mateu-funnel")],di);const Il=e=>{const t=e.metadata;return o`
        <mateu-funnel
                ...
                slot="${e.slot??l}"
        ></mateu-funnel>
    `};var El=Object.defineProperty,Pl=Object.getOwnPropertyDescriptor,ga=(e,t,a,s)=>{for(var i=s>1?void 0:s?Pl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&El(t,a,i),i};let $t=class extends _{constructor(){super(...arguments),this.values=[],this.labels=[],this.area=!1}render(){const e=this.values;if(!e||e.length<2)return o``;const t=600,a=160,s=8,i=Math.min(...e),r=Math.max(...e),n=r-i||1,d=(t-s*2)/(e.length-1),c=e.map((y,$)=>{const E=s+$*d,N=s+(a-s*2)*(1-(y-i)/n);return[E,N]}),u=c.map(([y,$],E)=>`${E===0?"M":"L"}${y.toFixed(1)} ${$.toFixed(1)}`).join(" "),m=`${u} L${c[c.length-1][0].toFixed(1)} ${a-s} L${c[0][0].toFixed(1)} ${a-s} Z`,v=this.color||"var(--lumo-primary-color, #1a73e8)",f=e.indexOf(r),g=e.indexOf(i);return o`
            ${this.heading?o`<div class="title">${this.heading}</div>`:l}
            <svg viewBox="0 0 ${t} ${a}" preserveAspectRatio="none">
                ${this.area?V`<path d="${m}" fill="${v}" opacity="0.12"></path>`:l}
                <path d="${u}" fill="none" stroke="${v}" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"></path>
                ${c.map((y,$)=>$===f||$===g?V`<circle cx="${y[0]}" cy="${y[1]}" r="3.2" fill="${v}"><title>${this.labels[$]??""}: ${e[$]}</title></circle>`:V`<circle cx="${y[0]}" cy="${y[1]}" r="6" fill="transparent"><title>${this.labels[$]??""}: ${e[$]}</title></circle>`)}
            </svg>
    ...
    `;ga([p()],$t.prototype,"heading",2);ga([p({type:Array})],$t.prototype,"values",2);ga([p({type:Array})],$t.prototype,"labels",2);ga([p()],$t.prototype,"color",2);ga([p({type:Boolean})],$t.prototype,"area",2);$t=ga([x("mateu-trend-chart")],$t);const Tl=e=>{const t=e.metadata;return o`
        <mateu-trend-chart
                heading="${t.title??l}"
                color="${t.color??l}"
                ?area="${t.area??!1}"
    ...
    `;Zt([p()],st.prototype,"heading",2);Zt([p()],st.prototype,"description",2);Zt([p()],st.prototype,"icon",2);Zt([p()],st.prototype,"ctaLabel",2);Zt([p()],st.prototype,"actionId",2);Zt([p()],st.prototype,"theme",2);st=Zt([x("mateu-callout-card")],st);const jl=e=>{const t=e.metadata;return o`
        <mateu-callout-card
                heading="${t.title??l}"
    ...
    `;_i([p()],ua.prototype,"heading",2);_i([p({type:Array})],ua.prototype,"items",2);_i([b()],ua.prototype,"localDone",2);ua=_i([x("mateu-checklist")],ua);const Ql=e=>{const t=e.metadata;return o`
        <mateu-checklist
                ...
                slot="${e.slot??l}"
        ></mateu-checklist>
    `};var Zl=Object.defineProperty,ed=Object.getOwnPropertyDescriptor,Rt=(e,t,a,s)=>{for(var i=s>1?void 0:s?ed(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Zl(t,a,i),i};let We=class extends _{render(){const e=this.trend??"flat";return o`
            <div class="card">
                ${this.heading?o`<div class="title">${this.heading}</div>`:l}
                <div class="row">
                    <div class="side">
        ...
        @media (prefers-color-scheme: dark) { .card { background: var(--lumo-contrast-5pct, #2a2a2a); } }
    `;Rt([p()],We.prototype,"heading",2);Rt([p()],We.prototype,"leftLabel",2);Rt([p()],We.prototype,"leftValue",2);Rt([p()],We.prototype,"rightLabel",2);Rt([p()],We.prototype,"rightValue",2);Rt([p()],We.prototype,"delta",2);Rt([p()],We.prototype,"trend",2);We=Rt([x("mateu-comparison-card")],We);const td=e=>{const t=e.metadata;return o`
...
`,ad=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}),Gi=e=>ad.format(e),hi=(e,t)=>{const a=e<0?"-":"",s=Gi(Math.abs(e));return t?`${a}${t} ${s}`:`${a}${s}`},id=(e,t)=>t?`${Gi(e)} ${t}`:Gi(e);var sd=Object.defineProperty,rd=Object.getOwnPropertyDescriptor,zt=(e,t,a,s)=>{for(var i=s>1?void 0:s?rd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&sd(t,a,i),i};let Ge=class extends _{constructor(){super(...arguments),this.title="",this.badges=[],this.facts=[]}render(){const e=!!(this.metricLabel||this.metricValue||this.metricCaption);return o`
            <div class="card">
                <div class="main">
                    <div class="title-row">
    ...
    `];zt([p()],Ge.prototype,"title",2);zt([p({type:Array})],Ge.prototype,"badges",2);zt([p()],Ge.prototype,"subtitle",2);zt([p({type:Array})],Ge.prototype,"facts",2);zt([p()],Ge.prototype,"metricLabel",2);zt([p()],Ge.prototype,"metricValue",2);zt([p()],Ge.prototype,"metricCaption",2);Ge=zt([x("mateu-entity-header")],Ge);const od=e=>{const t=e.metadata;return o`
        <mateu-entity-header
                .title="${t.title??""}"
                .badges="${t.badges??[]}"
                .subtitle="${t.subtitle}"
    ...
    `;Lt([p()],Ke.prototype,"label",2);Lt([p({type:Number})],Ke.prototype,"value",2);Lt([p({type:Number})],Ke.prototype,"max",2);Lt([p()],Ke.prototype,"unit",2);Lt([p()],Ke.prototype,"caption",2);Lt([p({type:Number})],Ke.prototype,"warnAt",2);Lt([p({type:Number})],Ke.prototype,"dangerAt",2);Ke=Lt([x("mateu-meter")],Ke);const dd=e=>{const t=e.metadata;return o`
        <mateu-meter
                .label="${t.label}"
                .value="${t.value??0}"
                .max="${t.max??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-meter>
    `};var cd=Object.defineProperty,ud=Object.getOwnPropertyDescriptor,$a=(e,t,a,s)=>{for(var i=s>1?void 0:s?ud(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&cd(t,a,i),i};let yt=class extends _{constructor(){super(...arguments),this.total=0,this.done=0}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){const e=this.total>0&&this.done>=this.total,t=!e&&!!this.actionLabel&&!!this.actionId;return o`
    ...
    `;$a([p()],yt.prototype,"label",2);$a([p({type:Number})],yt.prototype,"total",2);$a([p({type:Number})],yt.prototype,"done",2);$a([p()],yt.prototype,"actionLabel",2);$a([p()],yt.prototype,"actionId",2);yt=$a([x("mateu-task-progress")],yt);const pd=e=>{const t=e.metadata;return o`
        <mateu-task-progress
                .label="${t.label}"
                .total="${t.total??0}"
                .done="${t.done??0}"
    ...
    `];Ua([p({type:Array})],Bt.prototype,"items",2);Ua([p({type:Boolean})],Bt.prototype,"compact",2);Ua([p({type:Boolean})],Bt.prototype,"frameless",2);Ua([p()],Bt.prototype,"rowActionId",2);Bt=Ua([x("mateu-status-list")],Bt);const vd=e=>{const t=e.metadata;return o`
        <mateu-status-list
                .items="${t.items??[]}"
                ?compact="${t.compact??!1}"
    ...
    `];ya([p()],xt.prototype,"actionId",2);ya([p({type:Number})],xt.prototype,"columns",2);ya([p()],xt.prototype,"recommendedLabel",2);ya([p({type:Array})],xt.prototype,"items",2);ya([b()],xt.prototype,"selectedId",2);xt=ya([x("mateu-resource-grid")],xt);const Pd=e=>{const t=e.metadata;return o`
        <mateu-resource-grid
                .actionId="${t.actionId}"
                .columns="${t.columns??0}"
    ...
    `;xa([p()],wt.prototype,"totalLabel",2);xa([p()],wt.prototype,"currency",2);xa([p()],wt.prototype,"actionId",2);xa([p({type:Array})],wt.prototype,"items",2);xa([b()],wt.prototype,"added",2);wt=xa([x("mateu-addon-picker")],wt);const Dd=e=>{const t=e.metadata;return o`
        <mateu-addon-picker
    ...
    `;ja([p()],Vt.prototype,"currency",2);ja([p()],Vt.prototype,"totalLabel",2);ja([p({type:Array})],Vt.prototype,"lines",2);ja([p({type:Number})],Vt.prototype,"total",2);Vt=ja([x("mateu-ledger")],Vt);const Nd=e=>{const t=e.metadata;return o`
        <mateu-ledger
                .currency="${t.currency}"
                .totalLabel="${t.totalLabel}"
                .lines="${t.lines??[]}"
    ...
    `;nt([p()],ze.prototype,"actionId",2);nt([p()],ze.prototype,"methodActionId",2);nt([p({type:Array})],ze.prototype,"methods",2);nt([p()],ze.prototype,"selected",2);nt([p()],ze.prototype,"contextLabel",2);nt([p()],ze.prototype,"contextValue",2);nt([p()],ze.prototype,"confirmLabel",2);nt([b()],ze.prototype,"selectedId",2);ze=nt([x("mateu-payment-picker")],ze);const Ud=e=>{const t=e.metadata;return o`
...
`)}
    ...
    <mateu-field
        ...
        `},[h.Text]:({component:e,state:t,data:a,appState:s,appData:i})=>sn(e,t,a,s,i),[h.Avatar]:({component:e,state:t,data:a})=>xo(e,t,a),[h.Chat]:({component:e,state:t,data:a})=>zn(e),[h.AvatarGroup]:({component:e})=>wo(e),[h.Badge]:({component:e,state:t,data:a})=>rn(e,t,a),[h.Breadcrumbs]:({component:e})=>Sn(e),[h.Anchor]:({component:e})=>nn(e),[h.Button]:({component:e,state:t,data:a})=>cn(e,t,a),[h.Card]:R(un),[h.Chart]:({component:e})=>pn(e),[h.Icon]:({component:e})=>hn(e),[h.ConfirmDialog]:R(mn),[h.ContextMenu]:R(Yo),[h.CookieConsent]:({component:e})=>vn(e),[h.Details]:R(fn),[h.Dialog]:({component:e,baseUrl:t,state:a,data:s,appState:i,appData:r})=>bn(e,t,a,s,i,r),[h.Drawer]:({component:e,baseUrl:t,state:a,data:s,appState:i,appData:r})=>gn(e,t,a,s,i,r),[h.Image]:({component:e})=>Cn(e),[h.Map]:({component:e})=>_n(e),[h.Markdown]:({component:e})=>yn(e),[h.MicroFrontend]:({component:e})=>$n(e),[h.Notification]:({component:e})=>xn(e),[h.ProgressBar]:({component:e,state:t})=>wn(e,t),[h.Popover]:R(kn),[h.CarouselLayout]:R(In),[h.Tooltip]:R(Zo),[h.MessageInput]:({component:e})=>Qo(e),[h.MessageList]:({component:e})=>Ko(e),[h.CustomField]:R(Xo),[h.MenuBar]:({container:e,component:t,baseUrl:a,state:s,data:i})=>Jo(e,t,a,s,i),[h.Grid]:R(Go),[h.VirtualList]:R(ko),[h.FormSection]:R(Tn),[h.FormSubSection]:R(On),[h.MetricCard]:({component:e})=>qn(e),[h.Scoreboard]:R(Un),[h.DashboardPanel]:R(jn),[h.DashboardLayout]:R(Bn),[h.FoldoutLayout]:R(Wn),[h.HeroSection]:R(Gn),[h.EmptyState]:({component:e})=>Io(e),[h.Skeleton]:({component:e})=>Eo(e),[h.Gantt]:({component:e})=>Jn(e),[h.PlanningBoard]:({component:e})=>Zn(e),[h.Kanban]:({component:e})=>al(e),[h.Timeline]:({component:e})=>rl(e),[h.ProgressSteps]:({component:e})=>ll(e),[h.Stat]:({component:e})=>ul(e),[h.Calendar]:({component:e})=>ml(e),[h.PricingTable]:({component:e})=>bl(e),[h.OrgChart]:({component:e})=>yl(e),[h.Heatmap]:({component:e})=>_l(e),[h.Funnel]:({component:e})=>Il(e),[h.TrendChart]:({component:e})=>Tl(e),[h.FeatureGrid]:({component:e})=>zl(e),[h.Testimonials]:({component:e})=>Al(e),[h.Faq]:({component:e})=>Ml(e),[h.CalloutCard]:({component:e})=>jl(e),[h.CommentThread]:({component:e})=>Hl(e),[h.FileList]:({component:e})=>Yl(e),[h.Checklist]:({component:e})=>Ql(e),[h.ComparisonCard]:({component:e})=>td(e),[h.EntityHeader]:({component:e})=>od(e),[h.Meter]:({component:e})=>dd(e),[h.TaskProgress]:({component:e})=>pd(e),[h.StatusList]:({component:e})=>vd(e),[h.BulletedList]:({component:e})=>gd(e),[h.Separator]:({component:e})=>$d(e),[h.Notice]:R(kd),[h.TaskQueue]:({component:e})=>Sd(e),[h.ResourceGrid]:({component:e})=>Pd(e),[h.OfferCard]:({component:e})=>Rd(e),[h.AddOnPicker]:({component:e})=>Dd(e),[h.Ledger]:({component:e})=>Nd(e),[h.PaymentPicker]:({component:e})=>Ud(e),[h.ProcessMonitor]:({component:e})=>Vd(e)},is=(e,t,a,s,i,r,n,d)=>{if(!t?.metadata)return t==null?(console.warn("No metadata for component",t),o`<p>No metadata for component</p>`):is(e,{id:Q(),metadata:t,type:pe.ClientSide},a,s,i,r,n,d);const c=t.metadata.type,u={...t,style:Hd(t,i),metadata:Wd(t,i)},m=Gd[c];return m?m({container:e,component:u,baseUrl:a,state:s,data:i,appState:r,appData:n,labelAlreadyRendered:d}):o`<p ${u?.slot??l}>Unknown metadata type ${c} for component ${u?.id}</p>`};var xe=(e=>(e.HAMBURGUER_MENU="HAMBURGUER_MENU",e.MENU_ON_LEFT="MENU_ON_LEFT",e.MENU_ON_TOP="MENU_ON_TOP",e.TABS="TABS",e.TILES="TILES",e.RAIL="RAIL",e.AUTO="AUTO",e.MEDIATOR="MEDIATOR",e))(xe||{});const ss="mateu-app-context",vr="mateu-app-context-labels",fr=e=>{try{return JSON.parse(localStorage.getItem(e)??"{}")}catch{return{}}},ws=(e,t)=>{try{localStorage.setItem(e,JSON.stringify(t))}catch{}},Ii=()=>fr(ss),rs=()=>fr(vr),br=(e,t,a)=>{const s=Ii(),i=rs();t==null||t===""?(delete s[e],delete i[e]):(s[e]=t,a!==void 0&&(i[e]=a)),ws(ss,s),ws(vr,i)};let ks=!1;const gr=()=>{ks||(ks=!0,window.addEventListener("storage",e=>{e.key===ss&&e.newValue!==e.oldValue&&window.location.reload()}))},Kd=(e,t)=>new Promise((a,s)=>{let i=!1;const r={retry:()=>{i||(i=!0,t().then(a,s))},giveUp:()=>{i||(i=!0,s(e))}},n=new CustomEvent("mateu-session-expired",{detail:r,cancelable:!0,bubbles:!1});typeof document<"u"&&!document.dispatchEvent(n)||r.giveUp()}),Yd=(e,t)=>e.includes("json")?!0:t!==null&&typeof t=="object",Jd=(e,t)=>{const a=e.finalUrl;if(!a)return;const s=typeof window<"u"?window.location.href:void 0;let i;try{i=new URL(e.requestedUrl,s).href}catch{return}if(i!==a&&!Yd(e.contentType??"",e.data))return a};let la=[];class Xd{constructor(){this.axiosInstance=Yr.create({timeout:6e4}),this.axiosInstance.interceptors.request.use(t=>(this.addAuthToken(t),this.addSessionId(t),t)),this.axiosInstance.interceptors.response.use(t=>{const a=Jd({requestedUrl:this.axiosInstance.getUri(t.config),finalUrl:t.request?.responseURL,contentType:String(t.headers?.["content-type"]??""),data:t.data});if(a)throw window.location.assign(a),Object.assign(new Error("session lost — redirecting to "+a),{code:"ERR_CANCELED"});return t},t=>{const a=t;if(a?.response?.status===401&&a.config&&!a.config.__mateuRetried){const s=a.config;return s.__mateuRetried=!0,Kd(t,()=>this.axiosInstance.request(s))}throw t})}addSessionId(t){let a=sessionStorage.getItem("__mateu_sesion_id");a||(a=Q(),sessionStorage.setItem("__mateu_sesion_id",a)),t.headers["X-Session-Id"]=a}addAuthToken(t){const a=localStorage.getItem("__mateu_auth_token");a&&(t.headers.Authorization="Bearer "+a)}async wrap(t,a,s,i){return s||a.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),t.then(r=>(a.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:i}})),r)).catch(r=>{throw r?.code=="ERR_CANCELED"?a.dispatchEvent(new CustomEvent("backend-cancelled-event",{bubbles:!0,composed:!0,detail:{}})):a.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:i,reason:this.serialize(r)}})),r})}serialize(t){return t?.message?t:JSON.stringify(t)}async get(t){const a=new AbortController;return la=[...la,a],this.axiosInstance.get(t,{signal:a.signal})}async post(t,a){const s=new AbortController;return la=[...la,s],this.axiosInstance.post(t,a,{signal:s.signal})}async abortAll(){la.forEach(t=>t.abort()),la=[]}async runAction(t,a,s,i,r,n,d,c,u,m,v){return a&&a.startsWith("/")&&(a=a.substring(1)),n={...Ii(),...n},await this.wrap(this.post(t+"/mateu/v3/sync/"+(a&&a!=""?a:"_no_route"),{serverSideType:d,appState:n,componentState:c,parameters:u,initiatorComponentId:r,consumedRoute:s,route:a&&a!=""?"/"+a:"",actionId:i}).then(f=>f.data),m,v,i)}}const ea=new Xd;var Qd=Object.defineProperty,Zd=Object.getOwnPropertyDescriptor,Ei=(e,t,a,s)=>{for(var i=s>1?void 0:s?Zd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Qd(t,a,i),i};let kt=class extends _{constructor(){super(...arguments),this.baseUrl="",this.dataProvider=async(e,t)=>{const a=e.filter??"",i=await this.remoteSearch(a)??(this.selector.options??[]).filter(r=>r.label.toLowerCase().includes(a.toLowerCase()));t(i,i.length)}}connectedCallback(){super.connectedCallback(),gr()}currentValue(){return String(Ii()[this.selector.fieldName]??"")}currentLabel(){const e=this.currentValue();if(!e)return"";const t=(this.selector.options??[]).find(s=>String(s.value)===e);if(t)return t.label;const a=rs()[this.selector.fieldName];return a!==void 0?String(a):e}pick(e,t){String(e??"")!==this.currentValue()&&(br(this.selector.fieldName,e,t),window.location.reload())}async remoteSearch(e){const t=this.app;if(t?.serverSideType)try{const a=await ea.runAction(this.baseUrl??"",t.rootRoute??t.initialRoute??"","",`_appcontext-search-${this.selector.fieldName}`,`appcontext-${this.selector.fieldName}`,void 0,t.serverSideType,{},{searchText:e},this,!0);for(const s of a?.fragments??[]){const n=s.data?.[`_appcontext_${this.selector.fieldName}`]?.content;if(Array.isArray(n))return n.map(d=>({value:d.value,label:d.label??String(d.value)}))}}catch{}}renderSelect(){const e=[{label:"—",value:""},...(this.selector.options??[]).map(t=>({label:t.label,value:String(t.value)}))];return o`
            ...
            </label>`}};kt.SEARCHABLE_THRESHOLD=7;kt.styles=w`
        :host {
            display: inline-flex;
            flex-shrink: 0;
        }
...
`);C=X.pop()??"";for(const ae of X){const ie=ae.trim();if(ie)if(ie.startsWith("data:")){const ge=JSON.parse(ie.substring(5).trim());g&&g(ge),y||this.handleUIIncrement(ge,v,$),ge.messages&&ge.messages.length==1&&ge.messages[0].variant=="error"&&v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))}else{let ge=ie;try{const S=JSON.parse(ie);ge=S.message,S._embedded?.errors?.length>0&&S._embedded.errors[0].message&&(ge=S._embedded.errors[0].message)}catch{}throw new Error(ge)}}}}f||v.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:r}})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:r},bubbles:!0,composed:!0}))}).catch(N=>{v.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:r,reason:this.serialize(N)}})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))})}}serialize(t){return t?.message?t:JSON.stringify(t)}showUndoableMessage(t,a){const s=new jt;s.position=t.position?this.mapPosition(t.position):"bottom-end",s.duration=t.duration??1e4,t.variant&&s.setAttribute("theme",t.variant),s.renderer=i=>{if(i.firstElementChild)return;const r=document.createElement("span");r.textContent=t.text;const n=document.createElement("button");n.textContent=t.undoLabel??"Undo",n.style.cssText="margin-left: 0.75rem; background: none; border: 1px solid currentColor; border-radius: var(--lumo-border-radius-s, 4px); color: inherit; cursor: pointer; padding: 0.15rem 0.6rem; font: inherit; font-weight: 600;",n.addEventListener("click",()=>{a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.undoActionId,parameters:t.undoParameters??{}},bubbles:!0,composed:!0})),s.opened=!1}),i.append(r,n)},document.body.appendChild(s),s.opened=!0,s.addEventListener("opened-changed",i=>{i.detail.value||s.remove()})}}const $r=new nc,yr=e=>{if(!e||!("querySelectorAll"in e))return null;for(const t of e.querySelectorAll("*")){if(t.tagName?.toLowerCase()==="mateu-component")return t;const a=yr(t.shadowRoot);if(a)return a}return null},xr=async(e,t,a)=>{const s=t.renderRoot??t,i=yr(s);await $r.runAction(ea,t.baseUrl??"",e.rootRoute||"_no_route","",a,i?.id??"app-header-action",{},e.serverSideType??"",{},{},i??t,!0,void 0,!1,"")},_s=async(e,t,a)=>{try{await xr(e,t,a)}catch(s){jt.show("La acción falló: "+s,{position:"bottom-start",duration:6e3,theme:"error"})}},Ia=(e,t)=>{const a=e.contextSelectors??[],s=e.contextActions??[];return a.length===0&&s.length===0&&!e.notificationsEnabled?l:o`${e.notificationsEnabled?o`
        ...
        </vaadin-button>`)}`},ei=(e,t)=>e.themeToggle?o`
...
`:l}
       ...
       `},cc=(e,t)=>t!=null&&e!=null&&!e.has(t),uc=typeof HTMLElement<"u"?HTMLElement:class{};class pc extends uc{static get observedAttributes(){return["type","renderer"]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){const t=this.getAttribute("type")??"unknown",a=this.getAttribute("renderer")??"unknown";this.shadowRoot||this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
        ...
        `}}typeof customElements<"u"&&!customElements.get("mateu-unsupported")&&customElements.define("mateu-unsupported",pc);const Ss=new Set,hc=(e,t,a)=>{const s=`${a}/${t}`;return Ss.has(s)||(Ss.add(s),console.warn(`[mateu] Component type "${t}" is not supported by the "${a}" renderer — rendering <mateu-unsupported> placeholder.`)),o`<mateu-unsupported
            type="${t}"
            renderer="${a}"
    ...
    `;Wa([p()],Gt.prototype,"fieldId",2);Wa([p()],Gt.prototype,"value",2);Wa([b()],Gt.prototype,"cameraOpen",2);Wa([b()],Gt.prototype,"cameraError",2);Gt=Wa([x("mateu-camera-capture")],Gt);var Oc=Object.defineProperty,Rc=Object.getOwnPropertyDescriptor,Ga=(e,t,a,s)=>{for(var i=s>1?void 0:s?Rc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Oc(t,a,i),i};const kr=(e,t)=>{if(!e)return;if(Array.isArray(e)){const s=e.find(i=>i.key==t);return s?.value!=null?String(s.value):void 0}const a=e[t];return a!=null?String(a):void 0};let _t=class extends _{constructor(){super(...arguments),this.fieldId="",this.editable=!0,this.filePicked=e=>{const t=e.target,a=t.files?.[0];if(!a)return;const s=new FileReader;s.onload=()=>{const i=s.result,r=i.indexOf(","),n=i.substring(0,r).replace(";base64",`;name=${encodeURIComponent(a.name)};base64`);this.emit(n+i.substring(r))},s.readAsDataURL(a),t.value=""}}static fileName(e){if(!e)return"";if(e.startsWith("data:")){const t=e.indexOf(","),s=e.substring(5,t<0?e.length:t).split(";").find(i=>i.startsWith("name="));if(s)try{return decodeURIComponent(s.substring(5))}catch{return s.substring(5)}return"Attached file"}return e.split("/").pop()||e}emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e,fieldId:this.fieldId},bubbles:!0,composed:!0}))}triggerPick(){this.renderRoot.querySelector("input[type=file]")?.click()}render(){const e=this.value!=null&&this.value!=="",t=_t.fileName(this.value),a=e&&this.value.startsWith("data:"),s=e?o`<span class="file" title="${t}">📄 ${a?o`<a href="${this.value}" download="${t}">${t}</a>`:o`<a href="${this.value}" target="_blank">${t}</a>`}</span>`:l;return this.editable?o`
            ...
            </div>`:o`${e?s:o`<span class="empty">—</span>`}`}};_t.styles=w`
        :host {
            display: block;
        }
        .row {
...
`;if(this.field?.stereotype=="listBox"){if(this.field?.remoteCoordinates){const i=this.field.remoteCoordinates,r="";return this.data[this.id]&&(this.data[this.id].searchSignature||r)&&this.data[this.id].searchSignature!=r&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements||this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:i.action,parameters:{searchText:r,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0})),o`
  ...
  `;ve([p()],ee.prototype,"component",2);ve([p()],ee.prototype,"field",2);ve([p()],ee.prototype,"baseUrl",2);ve([p()],ee.prototype,"state",2);ve([p()],ee.prototype,"data",2);ve([p()],ee.prototype,"appState",2);ve([p()],ee.prototype,"appData",2);ve([p()],ee.prototype,"labelAlreadyRendered",2);ve([b()],ee.prototype,"colorPickerOpened",2);ve([b()],ee.prototype,"colorPickerValue",2);ve([b()],ee.prototype,"filteredIcons",2);ve([b()],ee.prototype,"navLinkOffset",2);ee=ve([x("mateu-field")],ee);var Bc=Object.defineProperty,Vc=Object.getOwnPropertyDescriptor,aa=(e,t,a,s)=>{for(var i=s>1?void 0:s?Vc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Bc(t,a,i),i};const Hc=e=>{const t=[];return e.color&&e.color!=="normal"&&e.color!=="none"&&t.push(e.color),e.buttonStyle&&t.push(e.buttonStyle==="tertiaryInline"?"tertiary-inline":e.buttonStyle),e.size&&e.size!=="none"&&e.size!=="normal"&&t.push(e.size),t.length?t.join(" "):void 0},Ps=e=>e==="back"||e==="backToList"||!!e&&e.startsWith("cancel");let ot=class extends _{constructor(){super(...arguments),this.appState={},this.appData={},this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.evalLabel=e=>Re(e,this.state,this.data),this.renderBtn=e=>{if((this.data??{})[e.actionId+".hidden"])return l;const t=this.evalLabel(e.label),a=H.get()?.renderToolbarButton?.(e,t,()=>this.handleButtonClick(e.actionId));return a||o`
        <vaadin-button
                data-action-id="${e.id}"
                theme="${Hc(e)||l}"
    ...
    `}}render(){const e=this.metadata;if(!e)return o``;const t=e.toolbar??[],a=t.filter(d=>Ps(d.actionId)),s=t.filter(d=>!Ps(d.actionId)),i=a.length>0&&s.length>0?o`<span class="toolbar-divider"></span>`:l,r=e.avatar||e.title||e.subtitle||e.kpis?.length>0||e.header?.length>0||t.length>0,n=e.level??0;return n>0?this.setAttribute("data-nested",""):this.removeAttribute("data-nested"),o`
        ...
        ${Pt}
    `;aa([p()],ot.prototype,"metadata",2);aa([p()],ot.prototype,"baseUrl",2);aa([p()],ot.prototype,"state",2);aa([p()],ot.prototype,"data",2);aa([p()],ot.prototype,"appState",2);aa([p()],ot.prototype,"appData",2);ot=aa([x("mateu-content-header")],ot);var Wc=Object.defineProperty,Gc=Object.getOwnPropertyDescriptor,Ka=(e,t,a,s)=>{for(var i=s>1?void 0:s?Gc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Wc(t,a,i),i};let Kt=class extends Va{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={}}render(){const e=this.component?.metadata;return o`
  ...
  `;Ne([p()],he.prototype,"id",2);Ne([p()],he.prototype,"metadata",2);Ne([p()],he.prototype,"baseUrl",2);Ne([p()],he.prototype,"state",2);Ne([p()],he.prototype,"data",2);Ne([p()],he.prototype,"appState",2);Ne([p()],he.prototype,"appData",2);Ne([p()],he.prototype,"emptyStateMessage",2);Ne([b()],he.prototype,"detailsOpenedItems",2);Ne([Fe("vaadin-grid")],he.prototype,"grid",2);he=Ne([x("mateu-table")],he);const _r="mateu-saved-views",Oi=()=>{try{return JSON.parse(localStorage.getItem(_r)??"{}")}catch{return{}}},os=e=>{try{localStorage.setItem(_r,JSON.stringify(e))}catch{}},Cr=e=>Oi()[e]??[],Jc=(e,t)=>{const a=t.name?.trim();if(!a||Object.keys(t.values??{}).length===0)return;const s=Oi(),i=(s[e]??[]).filter(r=>r.name!==a);i.push({...t,name:a}),s[e]=i,os(s)},Xc=(e,t)=>{const a=Oi(),s=(a[e]??[]).filter(i=>i.name!==t);s.length===0?delete a[e]:a[e]=s,os(a)},Qc=(e,t)=>{const a=Oi();a[e]=(a[e]??[]).map(s=>({...s,isDefault:s.name===t?!s.isDefault:!1})),os(a)},Zc=e=>Cr(e).find(t=>t.isDefault);var eu=Object.defineProperty,tu=Object.getOwnPropertyDescriptor,Se=(e,t,a,s)=>{for(var i=s>1?void 0:s?tu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&eu(t,a,i),i};let ne=class extends _{constructor(){super(...arguments),this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.searchOnly=!1,this.panelOpened=!1,this.viewsOpened=!1,this.draftText="",this.openPanel=()=>{this.panelOpened||this.filters.length===0||(this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick))},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1,this.activeFilter=void 0},this.clearAllFilters=()=>{const e=this.filters.flatMap(a=>this.isRangeFilter(a)?[`${a.fieldId}_from`,`${a.fieldId}_to`]:[a.fieldId]),t={searchText:void 0};e.forEach(a=>{t[a]=void 0}),this.state={...this.state,...t},this.dispatchEvent(new CustomEvent("filter-reset-requested",{detail:{fieldIds:e},bubbles:!0,composed:!0})),this.requestSearch()},this.keepFocus=e=>e.preventDefault()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}get filters(){return this.metadata?.filters??[]}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}requestSearch(){this.closePanel(),this.dispatchEvent(new CustomEvent("search-requested",{detail:{},bubbles:!0,composed:!0}))}emitValueChanged(e,t){this.state={...this.state,[e]:t},this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t,fieldId:e},bubbles:!0,composed:!0}))}applyFilter(e,t){this.emitValueChanged(e,t),this.requestSearch()}removeChip(e){const t=this.filters.find(a=>a.fieldId===e);t&&this.isRangeFilter(t)?(this.emitValueChanged(`${e}_from`,void 0),this.emitValueChanged(`${e}_to`,void 0)):this.emitValueChanged(e,e==="searchText"?"":void 0),this.requestSearch()}commitText(e){this.emitValueChanged("searchText",e.value),this.draftText="",e.value="",this.requestSearch()}get viewsScope(){return window.location.pathname}allFilterKeys(){return["searchText",...this.filters.flatMap(e=>this.isRangeFilter(e)?[`${e.fieldId}_from`,`${e.fieldId}_to`]:[e.fieldId])]}snapshotValues(){const e={};return this.state.searchText&&(e.searchText=this.state.searchText),this.filters.forEach(t=>{if(this.isSet(t))if(this.isRangeFilter(t)){const a=this.rangeBound(t,"from"),s=this.rangeBound(t,"to");a&&(e[`${t.fieldId}_from`]=a),s&&(e[`${t.fieldId}_to`]=s)}else this.isMultiFilter(t)?e[t.fieldId]=this.multiValues(t):e[t.fieldId]=this.state[t.fieldId]}),e}applyView(e){const t=this.allFilterKeys(),a={};t.forEach(s=>{a[s]=void 0}),this.state={...this.state,...a},this.dispatchEvent(new CustomEvent("filter-reset-requested",{detail:{fieldIds:t},bubbles:!0,composed:!0})),Object.entries(e.values).forEach(([s,i])=>this.emitValueChanged(s,i)),this.viewsOpened=!1,this.detachOutsideClick(),this.requestSearch()}saveCurrentView(e){const t=e.value.trim();t&&(Jc(this.viewsScope,{name:t,values:this.snapshotValues()}),e.value="",this.requestUpdate())}firstUpdated(){if(window.location.search)return;const e=Zc(this.viewsScope);e&&setTimeout(()=>{this.state.searchText||this.filters.some(a=>this.isSet(a))||this.applyView(e)},0)}isBooleanFilter(e){return e.dataType==="boolean"||e.dataType==="bool"||e.stereotype==="checkbox"||e.stereotype==="toggle"}isNumericFilter(e){return["integer","decimal","number","money"].includes(e.dataType??"")}isRangeFilter(e){return e.stereotype==="dateRange"||e.stereotype==="numberRange"}isMultiFilter(e){return e.stereotype==="multiSelect"}hasOptions(e){return(e.options?.length??0)>0}multiValues(e){const t=this.state[e.fieldId];return Array.isArray(t)?t.map(String):typeof t=="string"&&t!==""?t.split(",").map(a=>a.trim()).filter(a=>a):[]}rangeBound(e,t){const a=this.state[`${e.fieldId}_${t}`];return a==null?"":String(a)}isSet(e){if(this.isRangeFilter(e))return this.rangeBound(e,"from")!==""||this.rangeBound(e,"to")!=="";if(this.isMultiFilter(e))return this.multiValues(e).length>0;const t=this.state[e.fieldId];return t!=null&&t!==""&&!Number.isNaN(t)}getFilterDisplayValue(e,t){if(e.options?.length){const a=e.options.find(s=>s.value===String(t));if(a)return a.label??a.value}return typeof t=="boolean"?t?"Yes":"No":String(t)}conditionDisplay(e){if(this.isRangeFilter(e)){const t=this.rangeBound(e,"from"),a=this.rangeBound(e,"to");return t&&a?`${t} – ${a}`:t?`≥ ${t}`:`≤ ${a}`}return this.isMultiFilter(e)?this.multiValues(e).map(t=>this.getFilterDisplayValue(e,t)).join(", "):this.getFilterDisplayValue(e,this.state[e.fieldId])}labelOf(e){return Re(e.label,this.state,this.data)||e.fieldId}panelRow(e,t,a="panel-row"){return o`
    ...
    `;Ie([p()],le.prototype,"id",2);Ie([p()],le.prototype,"metadata",2);Ie([p()],le.prototype,"baseUrl",2);Ie([p()],le.prototype,"state",2);Ie([p()],le.prototype,"data",2);Ie([p()],le.prototype,"appState",2);Ie([p()],le.prototype,"appData",2);Ie([p()],le.prototype,"emptyStateMessage",2);Ie([b()],le.prototype,"keepAsking",2);Ie([Fe("#ask-for-more")],le.prototype,"askForMore",2);Ie([b()],le.prototype,"hasMore",2);le=Ie([x("mateu-card-list")],le);var Or=(e=>(e.none="none",e.success="success",e.error="error",e.warning="warning",e.contrast="contrast",e.normal="normal",e))(Or||{}),Rr=(e=>(e.primary="primary",e.secondary="secondary",e.tertiary="tertiary",e.tertiaryInline="tertiaryInline",e))(Rr||{});const cu=76;function Ts(e){if(e.weight!=null)return e.weight;const t=e.stereotype??"";if(t==="icon")return 1;if(t==="image")return 4;if(t==="html"||t==="richText"||t==="markdown"||t==="textarea")return 5;if(t==="link")return 2.5;if(t==="combobox"||t==="select")return 2;const a=e.dataType??"";return a==="bool"?1:a==="status"||a==="integer"?1.5:a==="number"||a==="date"||a==="money"?2:a==="dateTime"||a==="dateRange"?2.5:3}function uu(e,t){if(e.length===0)return"table";const a=e.reduce((c,u)=>c+Ts(u),0),s=t/cu,i=a/s;if(i<=1)return"table";const r=e.filter(c=>c.identifier||(c.priority??Number.MAX_SAFE_INTEGER)<=2),n=r.reduce((c,u)=>c+Ts(u),0);return i>1.6||e.length>10?"masterDetail":r.length>0&&n<=8?"list":e.some(c=>c.stereotype==="image"||c.stereotype==="html")||r.length===0&&e.length>=4&&e.length<=8?"cards":"masterDetail"}function ds(e){return e.filter(t=>t.identifier||(t.priority??Number.MAX_SAFE_INTEGER)<=2).sort((t,a)=>(t.priority??Number.MAX_SAFE_INTEGER)-(a.priority??Number.MAX_SAFE_INTEGER))}var pu=Object.defineProperty,hu=Object.getOwnPropertyDescriptor,Ee=(e,t,a,s)=>{for(var i=s>1?void 0:s?hu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&pu(t,a,i),i};const mu={asc:"ascending",desc:"descending"};let de=class extends _{constructor(){super(...arguments),this.component=void 0,this.standalone=!1,this.state={},this.data={},this.appState={},this.appData={},this.showImportDialog=!1,this.availableWidthPx=1024,this.selectedItem=null,this._columnPrefsRevision=0,this._prefsRevisionApplied=-1,this.search=()=>{const e=this.component.metadata;this.state={...this.state,size:e.pageSize,page:0,crud_selected_items:[]},this._syncStateToUrl(e),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}}},bubbles:!0,composed:!0}))},this.notify=e=>{jt.show(e,{position:"bottom-end",theme:"error",duration:3e3})},this.handleSearchRequested=e=>{this.state={...this.state,crud_selected_items:[]};const t=this.component.metadata;this._syncStateToUrl(t),!t.infiniteScrolling&&this.data?.[this.id]?.page&&(this.data[this.id].page.content=[]),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}},callback:e},bubbles:!0,composed:!0}))},this.fetchMoreElements=e=>{const{params:t,callback:a}=e.detail;this.state={...this.state,size:t.pageSize,page:t.page},this.handleSearchRequested(a)},this.directionChanged=e=>{const t=e.detail.grid._sorters;this.state={...this.state,sort:t.map(a=>({fieldId:a.__data.path,direction:a.__data.direction?mu[a.__data.direction]:void 0}))},this.handleSearchRequested(void 0)},this._initializedForComponentId=void 0,this.evalLabel=e=>Re(e,this.state,this.data),this.handleToolbarButtonClick=e=>{if(e==="import"){this.showImportDialog=!0;return}this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.handleImportUploadSuccess=e=>{const t=e.detail.xhr.responseText;this.showImportDialog=!1,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"process-import",parameters:{fileId:t}},bubbles:!0,composed:!0}))}}get columnPrefsScope(){return window.location.pathname}get effectiveComponent(){const e=this.component,t=e?.metadata;if(!e||!t?.columns)return e;if(this._prefsSource===e&&this._prefsRevisionApplied===this._columnPrefsRevision)return this._prefsApplied;const a=Er(this.columnPrefsScope),s=Tr(t.columns,a,i=>i.metadata??{});return this._prefsApplied=s===t.columns?e:{...e,metadata:{...t,columns:s}},this._prefsSource=e,this._prefsRevisionApplied=this._columnPrefsRevision,this._prefsApplied}get columnChooserEntries(){return(this.component?.metadata?.columns??[]).map(t=>{const a=t.metadata??{},s=a.id??t.id;return s?{id:s,label:a.label??s,protected:Pr(a)}:void 0}).filter(t=>!!t)}renderColumnChooser(){const e=this.columnChooserEntries;return e.filter(t=>!t.protected).length===0?l:o`
        ...
        `}get cols(){return this.effectiveComponent?.metadata?.columns?.map(t=>t.metadata)??[]}get identifierFieldName(){const e=this.cols.find(t=>t.identifier);return e?e.id:this.cols.find(t=>t.id==="id")?.id}get effectiveGridLayout(){const e=this.component?.metadata,t=e?.gridLayout??"auto";return t==="auto"?e?.crudlType==="card"?"cards":uu(this.cols,this.availableWidthPx):t}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{const t=e[0]?.contentRect.width;t&&Math.abs(t-this.availableWidthPx)>10&&(this.availableWidthPx=t)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}_filterIds(e){return new Set(["searchText",...(e.filters??[]).flatMap(t=>t.stereotype==="dateRange"||t.stereotype==="numberRange"?[`${t.fieldId}_from`,`${t.fieldId}_to`]:[t.fieldId])])}_syncStateToUrl(e){const t=this._filterIds(e),a=new URLSearchParams(window.location.search);t.forEach(d=>a.delete(d)),a.delete("page"),a.delete("sort"),t.forEach(d=>{const c=this.state[d];c!=null&&c!==""&&a.set(d,String(c))});const s=this.state.page;s&&s>0&&a.set("page",String(s));const i=this.state.sort;if(i&&i.length>0){const d=i.filter(c=>c.fieldId&&c.direction).map(c=>`${c.fieldId}:${c.direction}`).join(",");d&&a.set("sort",d)}const r=a.toString(),n=r?`${window.location.pathname}?${r}`:window.location.pathname;window.location.pathname+window.location.search!==n&&history.replaceState(null,"",n)}_initStateFromUrl(e,t){const a=new URLSearchParams(window.location.search),s=this._filterIds(e),i={...t};a.forEach((d,c)=>{s.has(c)&&(i[c]=d)});const r=a.get("page");if(r!==null){const d=parseInt(r,10);!isNaN(d)&&d>0&&(i.page=d)}const n=a.get("sort");if(n){const d=n.split(",").map(c=>{const[u,m]=c.split(":");return u&&m?{fieldId:u,direction:m}:null}).filter(Boolean);d.length>0&&(i.sort=d)}return i}pageChanged(e){this.state={...this.state,page:e.detail.page},this.handleSearchRequested(void 0)}updated(e){if(super.updated(e),e.has("component")){const t=this.component?.id;if(t!==this._initializedForComponentId){this._initializedForComponentId=t;const a=this.component?.metadata,s=a.initialPage&&a.initialPage>0?a.initialPage:0;this.state=this._initStateFromUrl(a,{...this.state,size:a.pageSize,page:s,sort:[]}),(this.state.page!==s||this.state.sort?.length>0||[...this._filterIds(a)].some(r=>this.state[r]!=null))&&this.handleSearchRequested(void 0)}}}render(){const e=S=>{const M=[];return S.color&&S.color!==Or.normal&&M.push(S.color),S.buttonStyle&&M.push(S.buttonStyle===Rr.tertiaryInline?"tertiary-inline":S.buttonStyle),M.length?M.join(" "):void 0},t=S=>S==="back"||S==="backToList"||!!S&&S.startsWith("cancel"),a=S=>{const M=H.get()?.renderToolbarButton?.(S,this.evalLabel(S.label),()=>this.handleToolbarButtonClick(S.actionId));return M||o`
            ...
            `};if(!this.component)return o`no component`;const s=this.effectiveComponent,i=s.metadata;i.serverSideOrdering=!0;const r=i?.toolbar??[],n=r.filter(S=>t(S.actionId)),d=r.filter(S=>!t(S.actionId)),c=n.length>0&&d.length>0,u=!!i?.title||!!i?.subtitle||r.length>0,m=this.effectiveGridLayout,v=this.cols,f=ds(v),y=this.data[this.id]?.page?.content??[],$=this.state[this.component?.id]?.emptyStateMessage,E=(S,M)=>{const P=M[S.id];if(P==null)return o``;if(S.dataType==="status"){const K=ki(P.type);return o`<span theme="badge pill ${K}">${P.message}</span>`}return S.dataType==="bool"?o`${P?"✓":"✗"}`:typeof P=="object"?o`${P.label??P.name??P.message??""}`:o`${P}`},N=()=>{const S=this.identifierFieldName,M=this.state._selectedId??this.appState?._splitDetailId,P=f.find(O=>O.identifier)??f[0],K=O=>O.dataType==="action"||O.dataType==="actionGroup"||O.dataType==="menu"||O.stereotype==="button",Ft=f.filter(O=>O!==P&&!K(O)),ra=v.filter(O=>K(O)),pt=(O,se,$e)=>{O.stopPropagation(),O.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:se,parameters:{_clickedRow:$e}},bubbles:!0,composed:!0}))},oa=O=>{const se=[];for(const $e of ra){const A=O[$e.id];if($e.dataType==="action"){const L=A?.methodNameInCrud?A:O.action?.methodNameInCrud?O.action:{methodNameInCrud:$e.id,label:$e.label,icon:null};se.push(o`
                ...
                <vaadin-list-box style="width: 100%;">
                    ...
                    `)}
                </vaadin-list-box>`},B=(S,M,P)=>{const K=this.identifierFieldName;K&&P[K]!==void 0&&(this.state={...this.state,_selectedId:String(P[K])}),S.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:M,parameters:P},bubbles:!0,composed:!0}))},C=()=>{const S=this.identifierFieldName,M=this.state._selectedId??this.appState?._splitDetailId,P=v.slice(0,6),K=P.filter(I=>I.stereotype==="image"),Ft=P.find(I=>I.identifier)??P[0],ra=I=>!!I.actionId,pt=I=>I.dataType==="action"||I.dataType==="actionGroup"||I.dataType==="menu"||I.stereotype==="button",oa=P.find(I=>I.id==="select"&&I.dataType==="action"),O=!!oa,se=P.filter(I=>I!==Ft&&!K.includes(I)&&!ra(I)&&!pt(I)),$e=P.filter(I=>pt(I)&&!(O&&I===oa)),A=(I,G,ht)=>{I.stopPropagation(),I.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:G,parameters:{_clickedRow:ht}},bubbles:!0,composed:!0}))},L=I=>{const G=[];for(const ht of $e){const Ai=I[ht.id];if(ht.dataType==="action"){const na=Ai?.methodNameInCrud?Ai:I.action?.methodNameInCrud?I.action:{methodNameInCrud:ht.id,label:ht.label,icon:null};G.push(o`
                            <vaadin-button theme="tertiary" title="${na.label||l}"
                                @click="${Nt=>A(Nt,"action-on-row-"+na.methodNameInCrud,I)}">
                                ${na.icon?o`<vaadin-icon icon="${na.icon}"></vaadin-icon>`:l}
                                ${na.label??l}
                            </vaadin-button>`)}else(ht.dataType==="actionGroup"||ht.dataType==="menu")&&(Ai?.actions??[]).forEach(Nt=>G.push(o`
                            <vaadin-button theme="tertiary" title="${Nt.label||l}"
                                @click="${jr=>A(jr,"action-on-row-"+Nt.methodNameInCrud,I)}">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: var(--lumo-space-m); padding: var(--lumo-space-s) 0;">
                    ...
                    ${y.map(I=>o`
                        <vaadin-card
                            ...
                            style="cursor: pointer;"
                            @click="${G=>O?A(G,"action-on-row-select",I):B(G.target,"view",I)}"
                        >
                            ${K.length?o`<img slot="media" src="${I[K[0].id]??""}" alt="" style="width: 100%; max-height: 160px; object-fit: cover;" />`:l}
                            ${Ft?o`<div slot="title">${I[Ft.id]??""}</div>`:l}
                    ...
                    `)}
                </div>`},D=()=>{const S=f.find(P=>P.identifier)??f[0],M=f.filter(P=>P!==S);return o`
                ...
                </div>`},W=()=>{const S=this.identifierFieldName,M=this.state._selectedId??this.appState?._splitDetailId,P=v[0],K=v.slice(1),Ft=!!P?.actionId,ra=A=>(A??[]).map(L=>{const I=Array.isArray(L.children)?L.children:[];return I.length>0?{...L,children:ra(I)}:{...L,children:void 0}}),pt=ra(y),oa=(A,L)=>{const I=A.parentItem?A.parentItem.children??[]:pt;L(I,I.length)},O=(A,L)=>{for(const I of A??[]){if(S&&String(I[S])===L)return I;const G=O(I.children,L);if(G)return G}},se=S&&M!==void 0?O(pt,String(M)):void 0,$e=(A,L,I)=>{A.stopPropagation(),S&&L[S]!==void 0&&(this.state={...this.state,_selectedId:String(L[S])}),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:I,parameters:L},bubbles:!0,composed:!0}))};return o`
                <vaadin-grid
                    style="width: 100%;"
                    all-rows-visible
                ...
                >
                    ...
                    ${K.map(A=>A.id==="select"?o`<vaadin-grid-column width="7rem" flex-grow="0" text-align="end" header="${A.label??l}" ${it(L=>o`
                            <vaadin-button theme="tertiary small" @click="${I=>{I.stopPropagation(),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-select",parameters:{_clickedRow:L}},bubbles:!0,composed:!0}))}}">Select</vaadin-button>
            ...
            `:l}
            ${!X&&m==="list"?N():!X&&m==="cards"?i.contentHeight?o`
                <vaadin-scroller style="width: 100%; height: ${i.contentHeight};">
                    ${C()}
                </vaadin-scroller>
            `:C():!X&&m==="masterDetail"?D():!X&&m==="tree"?W():H.get()?.renderTableComponent(this,s,this.baseUrl,this.state,this.data,this.appState,this.appData)}
            <slot></slot>
        ...
        `}createRenderRoot(){return H.mustUseShadowRoot()?super.createRenderRoot():this}};de.styles=w`
        ${Pt}
...
`,D=!0)}D&&this.updateMessage(r,n)}n||this.updateMessage(r,"⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).")}catch(d){console.error("Error en el flujo SSE:",d);const c=d?.message??String(d);(c==="Failed to fetch"||c==="network error"||c==="Load failed")&&!n?this.updateMessage(r,"⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible."):this.updateMessage(r,"⚠️ Error: "+c)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value="")},250),this.messageInputElement?.removeAttribute("disabled"),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent("close-requested",{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{const e=this.messageInputElement?.value?.trim()??"";e&&this.send(new CustomEvent("submit",{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key==="Enter"&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback(),this.probeLocalAgent();const e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){const t=new e;this.recognition=t,t.lang="es-ES",t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=a=>{console.error("Error de reconocimiento: "+a.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:"smooth"})},0)}addMessage(e,t){const a={text:e,time:new Date().toLocaleTimeString(),userName:t.includes("agent")?"Asistente":"Tú",userColorIndex:t.includes("agent")?2:1};return this.items=[...this.items,a],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((a,s)=>s===e?{...a,text:t}:a),this.scrollBottom()}tryParseCustomEvent(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if(typeof a.event=="string")return{event:a.event,detail:a.detail??{}}}catch{}return null}tryParseTokenUsage(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if("inputTokens"in a||"outputTokens"in a||"totalTokens"in a)return a}catch{}return null}buildMenuContext(e,t=[]){const a=[];for(const s of e){if(s.separator||s.remote)continue;const i=[...t,s.label];if(s.submenus&&s.submenus.length>0)a.push(...this.buildMenuContext(s.submenus,i));else{const r={path:i,navigation:{route:s.route,consumedRoute:s.consumedRoute,actionId:s.actionId??"",baseUrl:s.baseUrl,serverSideType:s.serverSideType,uriPrefix:s.uriPrefix}};s.description&&(r.description=s.description),a.push(r)}}return a}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return o`
                    ...
                    <div class="message-list" role="list">
                        ${this.items.map(e=>o`
                            <div class="message" role="listitem">
                                <div class="avatar" style="background: ${Du(e.userColorIndex)};">${Au(e.userName)}</div>
    ...
    `];U([p({attribute:!1})],F.prototype,"contextProvider",2);U([p()],F.prototype,"localAgentUrl",2);U([p({attribute:!1})],F.prototype,"mcpUrl",2);U([b()],F.prototype,"localAgentAlive",2);U([p()],F.prototype,"sseUrl",2);U([p()],F.prototype,"uploadUrl",2);U([p({attribute:!1})],F.prototype,"menu",2);U([b()],F.prototype,"attachments",2);U([b()],F.prototype,"uploading",2);U([Fe(".file-input")],F.prototype,"fileInputElement",2);U([p({type:Boolean,reflect:!0})],F.prototype,"expanded",2);U([p()],F.prototype,"items",2);U([Fe(".scroll-container")],F.prototype,"scrollContainer",2);U([Fe(".msg-input")],F.prototype,"messageInputElement",2);U([b()],F.prototype,"recognition",2);U([b()],F.prototype,"listening",2);U([b()],F.prototype,"recognitionAvailable",2);U([b()],F.prototype,"loading",2);U([b()],F.prototype,"elapsedSeconds",2);U([b()],F.prototype,"tokenUsage",2);F=U([x("mateu-chat")],F);var Fu=Object.defineProperty,Nu=Object.getOwnPropertyDescriptor,Xa=(e,t,a,s)=>{for(var i=s>1?void 0:s?Nu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Fu(t,a,i),i};let Xt=class extends _{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.data&&this.createChart(this.data)}async createChart(e){const[{default:t}]=await Promise.all([ue(()=>import("./vendor-chartjs.js").then(s=>s.a),[]),ue(()=>import("./vendor-chartjs.js").then(s=>s.c),[])]);if(e!==this.data)return;this.chart&&this.chart.destroy();const a={type:this.type,data:this.data,options:this.options};this.chart=new t(this.chartElement,a)}handleSlotChange(){}render(){return o`
            <div class="container">
       ...
       `}};Xt.styles=w`
  `;Xa([p()],Xt.prototype,"type",2);Xa([p()],Xt.prototype,"data",2);Xa([p()],Xt.prototype,"options",2);Xa([Fe("#chart")],Xt.prototype,"chartElement",2);Xt=Xa([x("mateu-chart")],Xt);var Mu=Object.defineProperty,qu=Object.getOwnPropertyDescriptor,hs=(e,t,a,s)=>{for(var i=s>1?void 0:s?qu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Mu(t,a,i),i};let Ma=class extends _{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){const{default:t}=await ue(async()=>{const{default:s}=await import("./vendor-diagrams.js").then(i=>i.i);return{default:s}},__vite__mapDeps([4,3,1,2]));if(e!==this.xml)return;this.chart&&this.chart.destroy();const a={container:this.divElement};this.chart=new t(a),this.chart.importXML(e)}handleSlotChange(){}render(){return o`
       ...
       `}};Ma.styles=w`
  `;hs([p()],Ma.prototype,"xml",2);hs([Fe("#canvas")],Ma.prototype,"divElement",2);Ma=hs([x("mateu-bpmn")],Ma);var Uu=Object.defineProperty,ju=Object.getOwnPropertyDescriptor,_a=(e,t,a,s)=>{for(var i=s>1?void 0:s?ju(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Uu(t,a,i),i};const ji=160,Me=56,Bu=220,zs=110,mt=60,Vu={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},Hu={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},Wu=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];function Gu(){return"step-"+Math.random().toString(36).slice(2,8)}let St=class extends _{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.wf={name:"New Workflow",steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value")){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){const e=this.wf.steps??[],t={};e.forEach(n=>{t[n.id]=0});let a=!0;for(;a;)a=!1,e.forEach(n=>{if(n.preconditionStepId!=null&&t[n.preconditionStepId]!==void 0){const d=t[n.preconditionStepId]+1;d>t[n.id]&&(t[n.id]=d,a=!0)}});const s={};e.forEach(n=>{const d=t[n.id]??0;(s[d]??=[]).push(n.id)});const i={...this.positions};let r=!1;Object.entries(s).forEach(([n,d])=>{const c=Number(n);d.forEach((u,m)=>{i[u]||(i[u]={x:mt+c*Bu,y:mt+m*zs},r=!0)})}),r&&(this.positions=i)}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addStep(){const e=Gu(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(i=>i.y),s=a.length?Math.max(...a)+zs:mt;this.positions={...this.positions,[e]:{x:mt,y:s}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(s=>s.id!==e).map(s=>s.preconditionStepId===e?{...s,preconditionStepId:void 0}:s)};const{[e]:t,...a}=this.positions;this.positions=a,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},s=this.toSvgPoint(e);this.dragOffset={x:s.x-a.x,y:s.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(s=>s.x))+ji+mt:600,a=e.length?Math.max(...e.map(s=>s.y))+Me+mt:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return V``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return V``;const s=t.x+ji,i=t.y+Me/2,r=a.x,n=a.y+Me/2,d=(s+r)/2;return V`
            <path d="M${s},${i} C${d},${i} ${d},${n} ${r},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:mt,y:mt},a=Vu[e.type]??"#64748b",s=Hu[e.type]??"•",i=this.selectedId===e.id;return V`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${r=>this.onNodeMouseDown(r,e.id)}"
               @click="${r=>{r.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${ji}" height="${Me}" rx="8"
                      fill="white"
                      stroke="${i?a:"#e2e8f0"}"
                ...
                <div class="prop-body">
                    ...
                    ${a("Type",o`
                        <select class="inp" @change="${s=>this.updateStep(e.id,{type:s.target.value})}">
                            ${Wu.map(s=>o`<option value="${s}" ?selected="${e.type===s}">${s}</option>`)}
                        </select>`)}
        ...
        `}exportJson(){const e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),s=document.createElement("a");s.href=a,s.download=(this.wf.name??"workflow").replace(/\s+/g,"-").toLowerCase()+".json",s.click(),URL.revokeObjectURL(a)}};St.styles=[Li,w`
    ...
    `];_a([p()],St.prototype,"value",2);_a([b()],St.prototype,"wf",2);_a([b()],St.prototype,"positions",2);_a([b()],St.prototype,"selectedId",2);_a([b()],St.prototype,"showMeta",2);St=_a([x("mateu-workflow")],St);var Ku=Object.defineProperty,Yu=Object.getOwnPropertyDescriptor,lt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Yu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ku(t,a,i),i};const Ea=160,Te=56,vt=60,Ju={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},Xu={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},Qu=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];let Bi;const Zu=()=>(Bi||(Bi=ue(()=>import("./vendor-diagrams.js").then(e=>e.e),__vite__mapDeps([4,3,1,2])).then(e=>new e.default)),Bi);function ep(){return"step-"+Math.random().toString(36).slice(2,8)}let Le=class extends _{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.readOnly=!1,this.wf={name:"New Workflow",steps:[]},this.positions={},this.layoutReady=!1,this.selectedId=null,this.showMeta=!1,this.layoutError=null,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.elkPositioned=new Set,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.elkPositioned.add(this.draggingId),this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value"))try{const t=JSON.parse(this.value),a=new Set((this.wf.steps??[]).map(r=>r.id)),s=new Set((t.steps??[]).map(r=>r.id)),i=a.size!==s.size||[...s].some(r=>!a.has(r))||[...s].some(r=>{const n=(this.wf.steps??[]).find(c=>c.id===r),d=(t.steps??[]).find(c=>c.id===r);return n?.preconditionStepId!==d?.preconditionStepId});this.wf=t,(i||!this.layoutReady)&&this.runElkLayout()}catch{}}async runElkLayout(){const e=this.wf.steps??[];if(e.length===0){this.positions={},this.layoutReady=!0;return}const t={id:"root",layoutOptions:{"elk.algorithm":"layered","elk.direction":"RIGHT","elk.spacing.nodeNode":"40","elk.layered.spacing.nodeNodeBetweenLayers":"80","elk.edgeRouting":"ORTHOGONAL","elk.layered.nodePlacement.strategy":"BRANDES_KOEPF"},children:e.map(a=>({id:a.id,width:Ea,height:Te})),edges:e.filter(a=>a.preconditionStepId).map(a=>({id:`${a.preconditionStepId}->${a.id}`,sources:[a.preconditionStepId],targets:[a.id]}))};try{const s=await(await Zu()).layout(t),i={...this.positions};for(const r of s.children??[])(!this.elkPositioned.has(r.id)||!i[r.id])&&(i[r.id]={x:(r.x??0)+vt,y:(r.y??0)+vt},this.elkPositioned.add(r.id));this.positions=i,this.layoutReady=!0,this.layoutError=null}catch(a){this.layoutError=a?.message??"ELK layout failed",this.layoutReady=!0}}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){const a=this.wf.steps.map(r=>r.id===e?{...r,...t}:r),s=this.wf.steps.find(r=>r.id===e),i=t.preconditionStepId!==void 0&&t.preconditionStepId!==s?.preconditionStepId;this.wf={...this.wf,steps:a},i&&(this.elkPositioned.clear(),this.runElkLayout()),this.emit()}addStep(){const e=ep(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(s=>s.x);this.positions={...this.positions,[e]:{x:a.length?Math.max(...a)+Ea+80:vt,y:vt}},this.selectedId=e,this.elkPositioned.clear(),this.runElkLayout(),this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(s=>s.id!==e).map(s=>s.preconditionStepId===e?{...s,preconditionStepId:void 0}:s)};const{[e]:t,...a}=this.positions;this.positions=a,this.elkPositioned.delete(e),this.selectedId===e&&(this.selectedId=null),this.runElkLayout(),this.emit()}onNodeMouseDown(e,t){if(this.readOnly)return;e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},s=this.toSvgPoint(e);this.dragOffset={x:s.x-a.x,y:s.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}relayout(){this.elkPositioned.clear(),this.runElkLayout()}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(s=>s.x))+Ea+vt:600,a=e.length?Math.max(...e.map(s=>s.y))+Te+vt:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){if(!this.layoutReady)return o`<div class="loading">Computing layout…</div>`;const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return V``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return V``;const s=t.x+Ea,i=t.y+Te/2,r=a.x,n=a.y+Te/2,d=(s+r)/2;return V`
            <path d="M${s},${i} C${d},${i} ${d},${n} ${r},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:vt,y:vt},a=Ju[e.type]??"#64748b",s=Xu[e.type]??"•",i=this.selectedId===e.id,r=e.name.length>16?e.name.slice(0,15)+"…":e.name;return V`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
        ...
        `}exportJson(){const e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),s=document.createElement("a");s.href=a,s.download=(this.wf.name??"workflow").replace(/\s+/g,"-").toLowerCase()+".json",s.click(),URL.revokeObjectURL(a)}};Le.styles=[Li,w`
        :host {display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif);}
        ...
        textarea.inp {resize: vertical;}
        input[readonly].inp {background: #f8fafc; color: #94a3b8;}
    `];lt([p()],Le.prototype,"value",2);lt([p({type:Boolean})],Le.prototype,"readOnly",2);lt([b()],Le.prototype,"wf",2);lt([b()],Le.prototype,"positions",2);lt([b()],Le.prototype,"layoutReady",2);lt([b()],Le.prototype,"selectedId",2);lt([b()],Le.prototype,"showMeta",2);lt([b()],Le.prototype,"layoutError",2);Le=lt([x("mateu-workflow-elk")],Le);var tp=Object.defineProperty,ap=Object.getOwnPropertyDescriptor,Qa=(e,t,a,s)=>{for(var i=s>1?void 0:s?ap(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&tp(t,a,i),i};const ip=["string","integer","number","bool","date","time","dateTime","dateRange","money","file","array","status","component","menu","range","action","actionGroup"],sp=["regular","radio","checkbox","textarea","toggle","combobox","select","email","password","richText","listBox","html","markdown","image","icon","link","money","grid","color","choice","popover","slider","button","stars"],rp={string:"#3B82F6",integer:"#8B5CF6",number:"#6366F1",bool:"#10B981",date:"#F59E0B",time:"#F59E0B",dateTime:"#F59E0B",dateRange:"#F59E0B",money:"#EF4444",file:"#64748B",array:"#0EA5E9",status:"#EC4899",component:"#14B8A6",menu:"#94A3B8",range:"#A855F7",action:"#F97316",actionGroup:"#FB923C"};function Ls(){return"field-"+Math.random().toString(36).slice(2,8)}let Qt=class extends _{constructor(){super(...arguments),this.value='{"name":"New Form","fields":[]}',this.form={name:"New Form",fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has("value"))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){const e=this.shadowRoot?.querySelector(".field-list");!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=Jr.create(e,{animation:150,handle:".drag-handle",ghostClass:"sortable-ghost",onEnd:t=>{const{oldIndex:a,newIndex:s}=t;if(a===void 0||s===void 0||a===s)return;const i=[...this.form.fields],[r]=i.splice(a,1);i.splice(s,0,r),this.form={...this.form,fields:i},this.emit()}}))}emit(){const e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addField(){const e=Ls(),t={id:e,label:"New Field",dataType:"string"};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){const t=this.form.fields.find(r=>r.id===e);if(!t)return;const a={...t,id:Ls(),label:t.label+" (copy)"},s=this.form.fields.findIndex(r=>r.id===e),i=[...this.form.fields];i.splice(s+1,0,a),this.form={...this.form,fields:i},this.selectedId=a.id,this.emit()}render(){return o`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderRow(e){const t=rp[e.dataType]??"#64748b",a=this.selectedId===e.id;return o`
        ...
        `}exportJson(){const e=JSON.stringify(this.form,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),s=document.createElement("a");s.href=a,s.download=(this.form.name??"form").replace(/\s+/g,"-").toLowerCase()+".json",s.click(),URL.revokeObjectURL(a)}};Qt.styles=[Li,w`
        :host { display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif); }
  ...
  `;fe([p()],te.prototype,"consumedRoute",2);fe([p()],te.prototype,"serverSideType",2);fe([p()],te.prototype,"uriPrefix",2);fe([p()],te.prototype,"overrides",2);fe([p()],te.prototype,"homeRoute",2);fe([p()],te.prototype,"route",2);fe([p()],te.prototype,"top",2);fe([p()],te.prototype,"instant",2);fe([p()],te.prototype,"initialState",2);fe([p()],te.prototype,"appState",2);fe([p()],te.prototype,"appData",2);fe([b()],te.prototype,"fragment",2);te=fe([x("mateu-ux")],te);var hp=Object.defineProperty,Pe=(e,t,a,s)=>{for(var i=void 0,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(t,a,i)||i);return i&&hp(t,a,i),i};class be extends Va{constructor(){super(...arguments),this.baseUrl="",this.route="",this.consumedRoute="",this.state={},this.appState={},this.appData={},this.selectedRoute=void 0,this.selectedConsumedRoute=void 0,this.selectedBaseUrl=void 0,this.selectedServerSideType=void 0,this.selectedUriPrefix=void 0,this.instant=void 0,this.lastActionServerSideType=void 0,this.lastActionInitiatorComponentId=void 0,this.captureActionSST=t=>{const a=t.detail;typeof a?.serverSideComponentRoute=="string"&&a.serverSideComponentRoute.indexOf("_embeddedMediator=1")>=0||a?.serverSideType&&(this.lastActionServerSideType=a.serverSideType,this.lastActionInitiatorComponentId=a.initiatorComponentId)},this.handleUnhandledAction=t=>{if(this.appMetadata()?.variant==xe.MEDIATOR)return;const a=t.detail;t.preventDefault(),t.stopPropagation();const s=this.renderRoot?.querySelector("#"+this.contentUxId);!s||typeof s.manageActionEvent!="function"||(this.lastActionServerSideType=this.selectedServerSideType,this.lastActionInitiatorComponentId=s.id,s.manageActionEvent(new CustomEvent("server-side-action-requested",{detail:{route:s.route??this.selectedRoute??"",consumedRoute:s.consumedRoute??this.selectedConsumedRoute??"",componentState:a.parameters?.initiatorState??{},parameters:a.parameters,actionId:a.actionId,serverSideType:this.selectedServerSideType??"",initiatorComponentId:s.id,initiator:s}})))},this.updateRoute=t=>{t.preventDefault(),t.stopPropagation();const a=t.detail;this.selectedConsumedRoute=a.consumedRoute,this.selectedBaseUrl=a.baseUrl,this.selectedRoute=a.route,this.selectedServerSideType=a.serverSideType,this.selectedUriPrefix=a.uriPrefix,this.instant=Q()}}appMetadata(){return this.component?.metadata}isActive(t){const a=this.appMetadata();return this.selectedRoute===t.path?!0:!this.selectedRoute&&this.route===this.consumedRoute&&t.path===a?.homeRoute}get contentUxId(){return this._contentUxId||(this._contentUxId="ux_"+(this.route||"root").replace(/[^a-zA-Z0-9]/g,"_")+"_app"),this._contentUxId}connectedCallback(){super.connectedCallback(),this.addEventListener("server-side-action-requested",this.captureActionSST,!0),this.addEventListener("action-requested",this.handleUnhandledAction),this.innerFragmentSubscription=bt.subscribe(t=>{const a=t.fragment;if(a&&this.lastActionInitiatorComponentId&&a.targetComponentId===this.lastActionInitiatorComponentId&&a.state?._route!==void 0){const s=a.state._route;if(s!==""&&!s.startsWith("/")){this.lastActionInitiatorComponentId=void 0,this.lastActionServerSideType=void 0;return}const i=a.state._componentRoute||"",r=this.appMetadata(),n=this.renderRoot?.querySelector("#"+this.contentUxId),d=n?.consumedRoute&&n.consumedRoute!=="_empty"?n.consumedRoute:"",c=i||this.selectedConsumedRoute||d||r?.homeConsumedRoute||"",u=c+s;this.lastActionInitiatorComponentId=void 0,u!==this.selectedRoute&&(this.selectedConsumedRoute=c,this.selectedRoute=u,this.lastActionServerSideType&&(this.selectedServerSideType=this.lastActionServerSideType),this.state&&this.state._route!=null&&(this.state._route=void 0),this.instant=Q()),this.lastActionServerSideType=void 0}})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("server-side-action-requested",this.captureActionSST,!0),this.removeEventListener("action-requested",this.handleUnhandledAction),this.innerFragmentSubscription?.unsubscribe()}navigate(t){const a=this.appMetadata();if(a?.variant!=xe.MEDIATOR&&!t.actionId&&(!t.baseUrl||t.baseUrl===this.baseUrl)&&(!t.serverSideType||t.serverSideType===a?.serverSideType)&&t.path!=null){if(!gt.confirmLeave())return;this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:t.path},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("navigate-to-requested",{detail:{route:t.path},bubbles:!0,composed:!0}));return}this.selectedConsumedRoute=t.consumedRoute,this.selectedBaseUrl=t.baseUrl,this.selectedRoute=t.path,this.selectedServerSideType=t.serverSideType,this.selectedUriPrefix=t.uriPrefix,this.instant=Q(),this.route=t.path??this.route,this.dispatchEvent(new CustomEvent("update-route",{detail:{route:t.path},bubbles:!0,composed:!0}))}renderContent(){const t=this.appMetadata();if(!t)return o`${l}`;const a=this;return o`
    ...
    `,this.renderItem=e=>e.submenus&&e.submenus.length>0?o`
            ...
            </div>`}};Nr([b()],Ki.prototype,"openHeaderMenu",2);Ki=Nr([x("mateu-redhat-app")],Ki);const gp=(e,t,a,s,i)=>{const r=t.metadata;return o`
        <mateu-redhat-app
                id="${e.id}_ux"
                route="${r.homeRoute}"
                ...
                style="width: 100%;"
        ></mateu-redhat-app>
    `},It=(e,t,a)=>e?e.includes("${")?new Function("state","data","return `"+e+"`")(t??{},a??{}):e:"",Ca=(e,t,a,s,i,r,n)=>(t.children??[]).map(d=>k(e,d,a,s,i,r,n)),$p=e=>{const t=e.color;return t==="primary"?"pf-m-primary":t==="error"||t==="danger"?"pf-m-danger":t==="success"?"pf-m-primary":"pf-m-secondary"},yp=(e,t,a)=>{const s=e.metadata,i=It(s.label,t,a);return o`
        <button id="${e.id}" type="button"
                class="pf-v6-c-button ${$p(s)}"
                data-action-id="${s.actionId}"
                ?disabled="${s.disabled}"
                slot="${e.slot??l}"
                @click="${r=>Zs(r,s)}">
            <span class="pf-v6-c-button__text">${i}</span>
        </button>`},xp=e=>{switch(e){case"h1":return"pf-m-2xl";case"h2":return"pf-m-xl";case"h3":return"pf-m-lg";case"h4":case"h5":case"h6":return"pf-m-md";default:return null}},wp=(e,t,a)=>{const s=e.metadata,i=It(s.text,t,a),r=xp(s.container);return r?o`<h2 class="pf-v6-c-title ${r}" style="${e.style??""}">${i}</h2>`:o`<div class="pf-v6-c-content" style="${e.style??""}"><p>${i}</p></div>`},Mr=e=>{const t=e?.metadata?.type;return t==="FormRow"||t==="FormItem"?(e.children??[]).flatMap(Mr):[e]},kp=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=(t.children??[]).flatMap(Mr),u=Math.max(1,Math.min(d.maxColumns??1,c.length)),m=v=>{const f=v?.metadata;if(f?.type!=="FormField")return"min-width:0;";const g=f?.colspan??1;return f?.stereotype==="grid"&&g<=1?"min-width:0; grid-column: 1 / -1;":g>1?`min-width:0; grid-column: span ${Math.min(g,u)};`:"min-width:0;"};return o`
        ...
        </div>`},_p=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=t.children??[],u=c.filter($=>$.slot!=="buttons"&&$.slot!=="toolbar"),m=c.filter($=>$.slot==="toolbar"),v=c.filter($=>$.slot==="buttons"),f=It(d.title,s,i),g=It(d.subtitle,s,i),y=$=>k(e,$,a,s,i,r,n);return o`
        <div>
            ${d.noHeader?l:o`
        ...
        </div>`},Cp=(e,t,a,s,i,r,n)=>{const d=It(t.metadata.title,s,i);return o`
        ...
        </div>`},Sp=(e,t,a,s,i,r,n)=>{const d=It(t.metadata.title,s,i);return o`
        <div style="margin:.5rem 0;" slot="${t.slot??l}">
            ${d?o`<h3 class="pf-v6-c-title pf-m-md" style="margin-bottom:.5rem;">${d}</h3>`:l}
            ${Ca(e,t,a,s,i,r,n)}
        </div>`},Ip=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=m=>m?k(e,m,a,s,i,r,n):l,u=typeof d.title=="string"?d.title:"";return o`
    ...
    <div class="pf-v6-c-backdrop" style="position:fixed; inset:0; display:flex; align-items:center; justify-content:center; z-index:1000;">
    ...
    </div>`,zp=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=u=>u?k(e,u,a,s,i,r,n):l;return qr(It(d.headerTitle,s,i),o`${c(d.content)}${Ca(e,t,a,s,i,r,n)}`,c(d.footer))},Lp=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.content?k(e,d.content,a,s,i,r,n):l,u=(m,v,f)=>o`<button class="pf-v6-c-button ${f}" type="button" @click="${g=>As(g.target,v)}"><span class="pf-v6-c-button__text">${m}</span></button>`;return qr(It(d.header,s,i),c,o`
        ...
        ${d.canCancel?u(d.cancelText??"Cancel",d.cancelActionId,"pf-m-link"):l}`)},Dp=(e,t)=>{const a=e?.data?.[t?.id??""]?.page??{},s=a.totalElements??0,i=a.pageSize??10,r=a.pageNumber??0,n=Math.max(1,Math.ceil(s/(i||1))),d=c=>e.pageChanged?.({detail:{page:c}});return s===0?o``:o`
    ...
    <div class="pf-v6-c-empty-state pf-m-sm">
        ...
        <table class="pf-v6-c-table pf-m-grid-md" role="grid">
            ...
            <tbody class="pf-v6-c-table__tbody" role="rowgroup">
                ${a.length===0?o`<tr class="pf-v6-c-table__tr" role="row"><td class="pf-v6-c-table__td" role="cell" colspan="${t.length+(i?1:0)}">${Za(s)}</td></tr>`:l}
                ${u.map(C=>Oa(C)?o`<tr class="pf-v6-c-table__tr" role="row"
                    ...
                    ${t.map(D=>o`<td class="pf-v6-c-table__td" role="cell" style="font-weight: 600;">${Ys(C,D,v)}</td>`)}
                </tr>`:o`<tr class="pf-v6-c-table__tr" role="row">
                    ${B(C)}
                    ${t.map(D=>o`<td class="pf-v6-c-table__td" role="cell" data-label="${D.label??""}">${fa(C,D,n)}</td>`)}
                </tr>`)}
            </tbody>
            ${m?o`
        ...
        </table>`},jp=(e,t,a,s)=>{const i=Sa(e),r=ds(t),n=r.find(u=>u.identifier)??r[0],d=r.filter(u=>u!==n&&!qa(u)),c=t.filter(u=>qa(u));return o`
        <ul class="pf-v6-c-data-list pf-m-compact" role="list" style="width: 100%;">
            ${a.length===0?o`<li class="pf-v6-c-data-list__item">${Za(s)}</li>`:l}
            ${a.map(u=>o`
            ...
            `)}
        </ul>`},Bp=(e,t,a,s)=>{const i=Sa(e),r=t.slice(0,6),n=r.filter(g=>g.stereotype==="image"),d=r.find(g=>g.identifier)??r[0],c=g=>!!g.actionId,u=r.find(g=>g.id==="select"&&g.dataType==="action"),m=!!u,v=r.filter(g=>g!==d&&!n.includes(g)&&!c(g)&&!qa(g)),f=r.filter(g=>qa(g)&&!(m&&g===u));return o`
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 1rem; padding: .5rem 0;">
            ${a.length===0?o`<div style="grid-column: 1 / -1;">${Za(s)}</div>`:l}
            ${a.map(g=>o`
                <div class="pf-v6-c-card pf-m-clickable ${$i(e,t,g)?"pf-m-selected":""}"
                     style="cursor: pointer;"
                     @click="${()=>m?i("action-on-row-select",{_clickedRow:g}):vs(e,t,g)}">
            ...
            `)}
        </div>`},Vp=(e,t,a,s)=>{const i=Sa(e),r=ds(t),n=r.find(u=>u.identifier)??r[0],d=r.filter(u=>u!==n),c=e.selectedItem;return o`
        ...
        </div>`},Fs=new WeakMap,Hp=(e,t,a,s)=>{const i=Sa(e),r=ms(t),n=t[0],d=t.slice(1),c=!!n?.actionId,u=Fs.get(e)??new Set;Fs.set(e,u);const m=y=>r&&y[r]!==void 0?String(y[r]):y,v=(y,$)=>{y.stopPropagation();const E=m($);u.has(E)?u.delete(E):u.add(E),e.requestUpdate()},f=(y,$)=>{y.stopPropagation(),vs(e,t,$)},g=(y,$)=>{const E=Array.isArray(y.children)?y.children:[],N=E.length>0,B=u.has(m(y));return o`
            <div>
        ...
        <div role="tree" style="width: 100%;">
            ...
            </div>`}};sa([p({attribute:!1})],Et.prototype,"field",2);sa([p({attribute:!1})],Et.prototype,"state",2);sa([p({attribute:!1})],Et.prototype,"data",2);sa([p({attribute:!1})],Et.prototype,"appState",2);sa([p({attribute:!1})],Et.prototype,"appData",2);sa([p({attribute:!1})],Et.prototype,"labelAlreadyRendered",2);Et=sa([x("mateu-redhat-field")],Et);function Ns(e){const t=typeof e=="number"?e:parseFloat(String(e??""));if(isNaN(t))return String(e??"");try{return new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(t)}catch{return t.toFixed(2)}}var Yp=Object.defineProperty,Jp=Object.getOwnPropertyDescriptor,dt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Jp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Yp(t,a,i),i};let Je=class extends _{constructor(){super(...arguments),this.selected=0}createRenderRoot(){return this}label(e){const t=e?.metadata?.label;return t&&typeof t=="string"&&t.includes("${")&&this.container?._evalTemplate?this.container._evalTemplate(t):t??""}render(){const e=this.component?.children??[],t=e[this.selected];return o`
            <div>
            ...
            </div>`}};dt([p({attribute:!1})],Je.prototype,"component",2);dt([p({attribute:!1})],Je.prototype,"container",2);dt([p()],Je.prototype,"baseUrl",2);dt([p({attribute:!1})],Je.prototype,"compState",2);dt([p({attribute:!1})],Je.prototype,"compData",2);dt([p({attribute:!1})],Je.prototype,"appState",2);dt([p({attribute:!1})],Je.prototype,"appData",2);dt([b()],Je.prototype,"selected",2);Je=dt([x("mateu-redhat-tabs")],Je);var Xp=Object.defineProperty,Qp=Object.getOwnPropertyDescriptor,ct=(e,t,a,s)=>{for(var i=s>1?void 0:s?Qp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Xp(t,a,i),i};let Xe=class extends _{constructor(){super(...arguments),this.open={},this.initialized=!1}createRenderRoot(){return this}label(e){const t=e?.metadata?.label;return t&&typeof t=="string"&&t.includes("${")&&this.container?._evalTemplate?this.container._evalTemplate(t):t??""}render(){const e=this.component?.children??[];return this.initialized||(e.forEach((t,a)=>{t?.metadata?.active&&(this.open[a]=!0)}),this.initialized=!0),o`
            ...
            </div>`}};ct([p({attribute:!1})],Xe.prototype,"component",2);ct([p({attribute:!1})],Xe.prototype,"container",2);ct([p()],Xe.prototype,"baseUrl",2);ct([p({attribute:!1})],Xe.prototype,"compState",2);ct([p({attribute:!1})],Xe.prototype,"compData",2);ct([p({attribute:!1})],Xe.prototype,"appState",2);ct([p({attribute:!1})],Xe.prototype,"appData",2);ct([b()],Xe.prototype,"open",2);Xe=ct([x("mateu-redhat-accordion")],Xe);const Zp=new Set([h.App,h.Form,h.FormField,h.FormLayout,h.FormSection,h.FormSubSection,h.Card,h.Button,h.Text,h.HorizontalLayout,h.VerticalLayout,h.SplitLayout,h.Badge,h.Anchor,h.Dialog,h.Drawer,h.ConfirmDialog,h.TabLayout,h.AccordionLayout,h.Page,h.Crud,h.Element,h.Div,h.Image,h.MicroFrontend,h.Markdown,h.Chart,h.ProgressBar,h.CustomField,h.MessageList,h.MessageInput,h.MetricCard,h.Scoreboard,h.DashboardPanel,h.DashboardLayout,h.FoldoutLayout,h.HeroSection,h.EmptyState,h.Skeleton,h.Gantt,h.PlanningBoard,h.Kanban,h.Timeline,h.ProgressSteps,h.Stat,h.Calendar,h.PricingTable,h.OrgChart,h.Heatmap,h.Funnel,h.TrendChart,h.FeatureGrid,h.Testimonials,h.Faq,h.CalloutCard,h.CommentThread,h.FileList,h.Checklist,h.ComparisonCard,h.EntityHeader,h.Meter,h.TaskProgress,h.StatusList,h.BulletedList,h.Separator,h.Notice,h.TaskQueue,h.ResourceGrid,h.OfferCard,h.AddOnPicker,h.Ledger,h.PaymentPicker,h.ProcessMonitor]);class eh extends mc{rendererName(){return"redhat"}supportedClientSideTypes(){return Zp}renderClientSideComponent(t,a,s,i,r,n,d,c){const u=a?.metadata?.type,m=a;return h.App==u?gp(t,m,s):h.Form==u?_p(t,m,s,i,r,n,d):h.FormField==u?o`<mateu-redhat-field id="${m.id}" .component="${m}" .field="${m.metadata}" .state="${i}" .data="${r}" .appState="${n}" .appData="${d}" .labelAlreadyRendered="${c}"></mateu-redhat-field>`:h.FormLayout==u?kp(t,m,s,i,r,n,d):h.FormSection==u?Cp(t,m,s,i,r,n,d):h.FormSubSection==u?Sp(t,m,s,i,r,n,d):h.Card==u?Ip(t,m,s,i,r,n,d):h.Button==u?yp(m,i,r):h.Text==u?wp(m,i,r):h.HorizontalLayout==u?Ep(t,m,s,i,r,n,d):h.VerticalLayout==u?Pp(t,m,s,i,r,n,d):h.SplitLayout==u?Tp(t,m,s,i,r,n,d):h.Badge==u?Op(m):h.Anchor==u?Rp(m):h.Dialog==u?zp(t,m,s,i,r,n,d):h.ConfirmDialog==u?Lp(t,m,s,i,r,n,d):h.TabLayout==u?o`<mateu-redhat-tabs .component="${m}" .container="${t}" baseUrl="${s}" .compState="${i}" .compData="${r}" .appState="${n}" .appData="${d}"></mateu-redhat-tabs>`:h.AccordionLayout==u?o`<mateu-redhat-accordion .component="${m}" .container="${t}" baseUrl="${s}" .compState="${i}" .compData="${r}" .appState="${n}" .appData="${d}"></mateu-redhat-accordion>`:super.renderClientSideComponent(t,a,s,i,r,n,d,c)}rendersCrudLayouts(){return!0}renderTableComponent(t,a){return Wp(t,a)}renderToolbarButton(t,a,s){const i=t,r=i.color==="error"||i.color==="danger"||i.variant==="error"||i.variant==="danger"?"danger":i.buttonStyle==="primary"||i.color==="primary"?"primary":"secondary";return o`
            <button type="button"
  ...
  `;ut([p()],Ae.prototype,"baseUrl",2);ut([p()],Ae.prototype,"route",2);ut([p()],Ae.prototype,"consumedRoute",2);ut([p()],Ae.prototype,"config",2);ut([p()],Ae.prototype,"top",2);ut([p()],Ae.prototype,"pathPrefix",2);ut([b()],Ae.prototype,"instant",2);ut([p({type:Boolean})],Ae.prototype,"debug",2);Ae=ut([x("mateu-ui")],Ae);
