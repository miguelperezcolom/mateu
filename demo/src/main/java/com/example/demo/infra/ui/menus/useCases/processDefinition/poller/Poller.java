...
import com.example.demo.infra.ui.menus.useCases.processDefinition.main.Updater;
import com.example.demo.infra.ui.menus.useCases.processDefinition.main.insprod.*;
...
/**
 * the mission of the poller is to retrieve the products from insprod using their api and create the
 * entities in our model
 */
@Service
public class Poller {

  @Autowired InsProdClient insProdClient;
