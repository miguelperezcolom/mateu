...
@MateuUI("/cardscrudwithactiononrows")
@Component@Scope("prototype")
public class SimpleCardsCrudWithActionOnSelectedRows extends SimpleCardsCrud {

    public SimpleCardsCrudWithActionOnSelectedRows(SimpleCrudService service) {
        super(service);
    }
