        ...
        add(ReservationLine.builder()
                ...
                .guests(new ArrayList<>(List.of(
                        GuestData.builder().lastName("García Romero").firstName("Miguel")
                                ...
                                .roomState(RoomState.PENDIENTE).hasCardex(true).internal(false).aviso(true)
                                .hotelObservations("Cliente VIP — bienvenida especial").build(),
                        GuestData.builder().lastName("García Romero").firstName("Laura")
                                .paxType(PaxType.AD).mealPlan(MealPlan.HB).nationality("ES")
                                .roomState(RoomState.PENDIENTE).hasCardex(true).internal(false).aviso(false)
                                .hotelObservations("").build(),
                        GuestData.builder().lastName("García Soto").firstName("Daniela")
                                .paxType(PaxType.CH).mealPlan(MealPlan.HB).nationality("ES")
                                .roomState(RoomState.PENDIENTE).hasCardex(false).internal(false).aviso(false)
                                .hotelObservations("Cama extra solicitada").build()
                )))
                .build());
        ...
        add(ReservationLine.builder()
                ...
                .guests(new ArrayList<>(List.of(
                        GuestData.builder().lastName("Smith").firstName("John").paxType(PaxType.AD)
                                .mealPlan(MealPlan.BB).nationality("GB").roomState(RoomState.LIMPIA)
                                .hasCardex(true).build()
                )))
                .build());
        ...
        add(ReservationLine.builder()
                ...
                .guests(new ArrayList<>(List.of(
                        GuestData.builder().lastName("García López").firstName("Pedro").paxType(PaxType.AD)
                                .mealPlan(MealPlan.AI).nationality("ES").roomState(RoomState.PENDIENTE).build(),
