 ...
 *
 * <p>On Helidon MP (Weld), a plain {@code @ApplicationScoped} bean is enough: Weld does not prune
 * unused beans the way Quarkus Arc does, so no {@code @Unremovable} equivalent is needed. The
 * adapter is discovered reflectively via the {@code BeanManager} and resolved as the parameterized
 * {@code ComponentAdapter<AdapterDemo>} bean.
 */
@ApplicationScoped
