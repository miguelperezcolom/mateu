describe('basic fields', () => {
    beforeEach(() => {
        ...
        cy.get('.v-menubar-menuitem').contains('Runnable field form').should('be.visible')

        cy.get('.v-menubar-menuitem').contains('Runnable field form').click();

        cy.get('.viewTitle').contains('Runnable field form').should('be.visible')
    })
    ...
    it('fields and actions should work as expected', () => {
        ...
        cy.get('.test-runnable').contains('Runnable').should('exist')
        cy.get('.test-runnable').focus();
        cy.get('.test-runnable').click();
