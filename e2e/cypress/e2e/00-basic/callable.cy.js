describe('basic fields', () => {
    beforeEach(() => {
        ...
        cy.get('.v-menubar-menuitem').contains('Callable form').should('be.visible')

        cy.get('.v-menubar-menuitem').contains('Callable form').click();

        cy.get('.viewTitle').contains('Callable form').should('be.visible')
    })
    ...
    it('fields and actions should work as expected', () => {
        ...
        cy.get('.v-button').contains('Back to Callable form').should('exist')
        cy.get('.v-button').contains('Back to Callable form').click({force: true})
