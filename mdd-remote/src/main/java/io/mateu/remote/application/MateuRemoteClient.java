...
public class MateuRemoteClient {
    ...
    public Mono<Journey> getJourney(String remoteBaseUrl, String remoteJourneyTypeId, String journeyId,
                                    ServerHttpRequest serverHttpRequest) {
        String uri = "/journeys/" + remoteJourneyTypeId + "/" + journeyId;
        return buildClient(remoteBaseUrl).get().uri(uri)
                .headers(headers -> serverHttpRequest.getHeaders())
    ...
    public Flux<Object> getListRows(String remoteBaseUrl, String remoteJourneyTypeId, String journeyId, String stepId,
                                    String listId, Object filters, List<SortCriteria> ordering, int page, int pageSize, ServerHttpRequest serverHttpRequest) throws ExecutionException, InterruptedException {
    ...
    public Mono<Long> getListCount(String remoteBaseUrl, String remoteJourneyTypeId, String journeyId, String stepId,
                             String listId, Object filters, ServerHttpRequest serverHttpRequest) throws ExecutionException, InterruptedException {
