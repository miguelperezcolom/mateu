...
public class QAPopulator implements CommandLineRunner {
  ...
  @Autowired TestProjectRepository testProjectRepository;

  @Autowired TestRepository testRepository;

  @Autowired TestStepRepository testStepRepository;

  @Autowired EnvironmentRepository environmentRepository;

  @Autowired TestExecutionRepository testExecutionRepository;
