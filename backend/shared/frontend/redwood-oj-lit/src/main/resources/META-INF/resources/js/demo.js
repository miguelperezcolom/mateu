require([
        ...
        function (require, exports, ko, ojbootstrap_1) {
            ...
            (0, ojbootstrap_1.whenDocumentReady)().then(() => {
                ...
                // Served from a backend, the generated controller injects the routed
                // <mateu-ui baseUrl="/route"> inside the inert #mateu-ui-holder template —
                // adopt it. Without injection (vite dev, static site) fall back to the
                // root-mounted default.
                const holder = document.getElementById("mateu-ui-holder");
                const injected = holder && holder.content ? holder.content.querySelector("mateu-ui") : null;
                let ui;
                if (injected) {
                    ui = document.importNode(injected, true);
                    ui.setAttribute("style", "display: block; width: 100%; height: calc(100vh - 100px);");
                } else {
                    ui = document.createElement('mateu-ui');
