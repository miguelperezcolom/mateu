...
import{d as o,A as d,a as C,j as m,r as $,i as S,k,m as ge,D as $r,c as P,w as X,p as Do,q as tt,s as Fo}from"./vendor-lit.js";import{v as No,b as wt,e as Mo,f as qo,n as yr,p as xr,N as ia,i as Ht,j as qi,k as wr,l as rs,m as Cs,o as Uo}from"./vendor-vaadin.js";import{S as Bo,n as ye,a as Vo,b as Wo}from"./vendor.js";import{_ as Pe,N as gi}from"./vendor-ui5.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=a(i);fetch(i.href,r)}})();var v=(e=>(e.Page="Page",e.Div="Div",e.Element="Element",e.MicroFrontend="MicroFrontend",e.Form="Form",e.Crud="Crud",e.Result="Result",e.Card="Card",e.Directory="Directory",e.Stepper="Stepper",e.HorizontalLayout="HorizontalLayout",e.VerticalLayout="VerticalLayout",e.SplitLayout="SplitLayout",e.MasterDetailLayout="MasterDetailLayout",e.TabLayout="TabLayout",e.AccordionLayout="AccordionLayout",e.FormLayout="FormLayout",e.FormRow="FormRow",e.FormItem="FormItem",e.BoardLayout="BoardLayout",e.BoardLayoutRow="BoardLayoutRow",e.BoardLayoutItem="BoardLayoutItem",e.Scroller="Scroller",e.FullWidth="FullWidth",e.Container="Container",e.FormField="FormField",e.Table="Table",e.App="App",e.Text="Text",e.Avatar="Avatar",e.Chat="Chat",e.AvatarGroup="AvatarGroup",e.Badge="Badge",e.Breadcrumbs="Breadcrumbs",e.Anchor="Anchor",e.Button="Button",e.Chart="Chart",e.Icon="Icon",e.ConfirmDialog="ConfirmDialog",e.ContextMenu="ContextMenu",e.CookieConsent="CookieConsent",e.Details="Details",e.Dialog="Dialog",e.Drawer="Drawer",e.Image="Image",e.Map="Map",e.Markdown="Markdown",e.Notification="Notification",e.ProgressBar="ProgressBar",e.Popover="Popover",e.CarouselLayout="CarouselLayout",e.Tooltip="Tooltip",e.MessageInput="MessageInput",e.MessageList="MessageList",e.CustomField="CustomField",e.MenuBar="MenuBar",e.Grid="Grid",e.GridColumn="GridColumn",e.GridGroupColumn="GridGroupColumn",e.VirtualList="VirtualList",e.FormSection="FormSection",e.FormSubSection="FormSubSection",e.Bpmn="Bpmn",e.Workflow="Workflow",e.WorkflowElk="WorkflowElk",e.FormEditor="FormEditor",e.MetricCard="MetricCard",e.Scoreboard="Scoreboard",e.DashboardPanel="DashboardPanel",e.DashboardLayout="DashboardLayout",e.FoldoutLayout="FoldoutLayout",e.HeroSection="HeroSection",e.EmptyState="EmptyState",e.Skeleton="Skeleton",e.Gantt="Gantt",e.PlanningBoard="PlanningBoard",e.Kanban="Kanban",e.Timeline="Timeline",e.ProgressSteps="ProgressSteps",e.Stat="Stat",e.Calendar="Calendar",e.PricingTable="PricingTable",e.OrgChart="OrgChart",e.Heatmap="Heatmap",e.Funnel="Funnel",e.TrendChart="TrendChart",e.FeatureGrid="FeatureGrid",e.Testimonials="Testimonials",e.Faq="Faq",e.CalloutCard="CalloutCard",e.CommentThread="CommentThread",e.FileList="FileList",e.Checklist="Checklist",e.ComparisonCard="ComparisonCard",e.EntityHeader="EntityHeader",e.Meter="Meter",e.TaskProgress="TaskProgress",e.StatusList="StatusList",e.BulletedList="BulletedList",e.Separator="Separator",e.Notice="Notice",e.TaskQueue="TaskQueue",e.ResourceGrid="ResourceGrid",e.OfferCard="OfferCard",e.AddOnPicker="AddOnPicker",e.Ledger="Ledger",e.PaymentPicker="PaymentPicker",e.ProcessMonitor="ProcessMonitor",e))(v||{}),oe=(e=>(e.ServerSide="ServerSide",e.ClientSide="ClientSide",e))(oe||{});class Ho{constructor(){this.afterRenderHook=void 0,this.useShadowRoot=!0,this.componentRenderer=void 0}set(t){if(this.componentRenderer=t,typeof window<"u"){const a=t.supportedClientSideTypes?.();window.__mateuRendererInfo={name:t.rendererName?.()??t.constructor?.name??"unknown",supportedTypes:a?[...a].sort():null}}}get(){return this.componentRenderer}setUseShadowRoot(t){this.useShadowRoot=t}mustUseShadowRoot(){return this.useShadowRoot}setAfterRenderHook(t){this.afterRenderHook=t}getAfterRenderHook(){return this.afterRenderHook}}const te=new Ho,ta=(e,t,a,s,i,r,n,l,c)=>(t.slot=l,w(e,t,a,s,i,r,n,c)),w=(e,t,a,s,i,r,n,l)=>{if(!t)return o``;if(t.type==oe.ClientSide)return te.get().renderClientSideComponent(e,t,a,s,i,r,n,l);const c=e.route,u=e.consumedRoute;return o`
    ...
    `;Ui([m({type:Array})],Ca.prototype,"tabLabels",2);Ui([$()],Ca.prototype,"mode",2);Ui([$()],Ca.prototype,"selected",2);Ca=Ui([k("mateu-adaptive-tabs")],Ca);const Xo=(e,t,a,s,i,r,n)=>{const l=t.metadata;let c=t.style;return c==null&&(c=""),l.columnSpacing&&(c+="--vaadin-form-layout-column-spacing: "+l.columnSpacing+";"),l.itemRowSpacing&&(c+="--vaadin-form-layout-row-spacing: "+l.itemRowSpacing+";"),l.itemLabelSpacing&&(c+="--vaadin-form-layout-label-spacing: "+l.itemLabelSpacing+";"),l.labelsAside&&(c+="--vaadin-form-item-label-width: 92px;"),l.fullWidth&&(c+="width: 100%;"),o`
            ...
            `},kr=(e,t,a,s,i,r,n,l)=>a.type==oe.ClientSide&&a.metadata?.type==v.FormRow?Zo(e,t,a,s,i,r,n,l):e.labelsAside?Qo(t,a,s,i,r,n,l):w(t,a,s,i,r,n,l),Qo=(e,t,a,s,i,r,n)=>{if(t.type==oe.ClientSide&&t.metadata?.type==v.FormField&&t.metadata.label){const l=t.metadata,c=l.label?.includes("${")?e._evalTemplate(l.label):l.label;return o`
...
`})}
    ...
    `},Bn=e=>{const a=(e.metadata.items??[]).map(s=>({text:s.text,time:s.time,userName:s.userName,userImg:s.userImg,userAbbr:s.userAbbr,userColorIndex:s.userColorIndex}));return o`
        <vaadin-message-list
                ...
                .items="${a}"
        ></vaadin-message-list>
    `},Lt=new Bo,le={value:{}},Ya={value:{}},Vn=(e,t,a,s,i,r,n)=>{const l=t.metadata;return o`
        ...
        <vaadin-menu-bar .items=${_s(e,r.options,a,s,i,le,Ya)}
                         style="${t.style}" class="${t.cssClasses}"
                         slot="${t.slot??d}">
        </vaadin-menu-bar>
        ...
        `}get cols(){return this.effectiveComponent?.metadata?.columns?.map(t=>t.metadata)??[]}get identifierFieldName(){const e=this.cols.find(t=>t.identifier);return e?e.id:this.cols.find(t=>t.id==="id")?.id}get effectiveGridLayout(){const e=this.component?.metadata,t=e?.gridLayout??"auto";return t==="auto"?e?.crudlType==="card"?"cards":to(this.cols,this.availableWidthPx):t}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{const t=e[0]?.contentRect.width;t&&Math.abs(t-this.availableWidthPx)>10&&(this.availableWidthPx=t)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}_filterIds(e){return new Set(["searchText",...(e.filters??[]).flatMap(t=>t.stereotype==="dateRange"||t.stereotype==="numberRange"?[`${t.fieldId}_from`,`${t.fieldId}_to`]:[t.fieldId])])}_syncStateToUrl(e){const t=this._filterIds(e),a=new URLSearchParams(window.location.search);t.forEach(l=>a.delete(l)),a.delete("page"),a.delete("sort"),t.forEach(l=>{const c=this.state[l];c!=null&&c!==""&&a.set(l,String(c))});const s=this.state.page;s&&s>0&&a.set("page",String(s));const i=this.state.sort;if(i&&i.length>0){const l=i.filter(c=>c.fieldId&&c.direction).map(c=>`${c.fieldId}:${c.direction}`).join(",");l&&a.set("sort",l)}const r=a.toString(),n=r?`${window.location.pathname}?${r}`:window.location.pathname;window.location.pathname+window.location.search!==n&&history.replaceState(null,"",n)}_initStateFromUrl(e,t){const a=new URLSearchParams(window.location.search),s=this._filterIds(e),i={...t};a.forEach((l,c)=>{s.has(c)&&(i[c]=l)});const r=a.get("page");if(r!==null){const l=parseInt(r,10);!isNaN(l)&&l>0&&(i.page=l)}const n=a.get("sort");if(n){const l=n.split(",").map(c=>{const[u,h]=c.split(":");return u&&h?{fieldId:u,direction:h}:null}).filter(Boolean);l.length>0&&(i.sort=l)}return i}pageChanged(e){this.state={...this.state,page:e.detail.page},this.handleSearchRequested(void 0)}updated(e){if(super.updated(e),e.has("component")){const t=this.component?.id;if(t!==this._initializedForComponentId){this._initializedForComponentId=t;const a=this.component?.metadata,s=a.initialPage&&a.initialPage>0?a.initialPage:0;this.state=this._initStateFromUrl(a,{...this.state,size:a.pageSize,page:s,sort:[]}),(this.state.page!==s||this.state.sort?.length>0||[...this._filterIds(a)].some(r=>this.state[r]!=null))&&this.handleSearchRequested(void 0)}}}render(){const e=I=>{const L=[];return I.color&&I.color!==Co.normal&&L.push(I.color),I.buttonStyle&&L.push(I.buttonStyle===So.tertiaryInline?"tertiary-inline":I.buttonStyle),L.length?L.join(" "):void 0},t=I=>I==="back"||I==="backToList"||!!I&&I.startsWith("cancel"),a=I=>{const L=te.get()?.renderToolbarButton?.(I,this.evalLabel(I.label),()=>this.handleToolbarButtonClick(I.actionId));return L||o`
            ...
            `};if(!this.component)return o`no component`;const s=this.effectiveComponent,i=s.metadata;i.serverSideOrdering=!0;const r=i?.toolbar??[],n=r.filter(I=>t(I.actionId)),l=r.filter(I=>!t(I.actionId)),c=n.length>0&&l.length>0,u=!!i?.title||!!i?.subtitle||r.length>0,h=this.effectiveGridLayout,p=this.cols,f=Ai(p),y=this.data[this.id]?.page?.content??[],x=this.state[this.component?.id]?.emptyStateMessage,T=(I,L)=>{const O=L[I.id];if(O==null)return o``;if(I.dataType==="status"){const D=Vi(O.type);return o`<span theme="badge pill ${D}">${O.message}</span>`}return I.dataType==="bool"?o`${O?"✓":"✗"}`:typeof O=="object"?o`${O.label??O.name??O.message??""}`:o`${O}`},U=()=>{const I=this.identifierFieldName,L=this.state._selectedId??this.appState?._splitDetailId,O=f.find(R=>R.identifier)??f[0],D=R=>R.dataType==="action"||R.dataType==="actionGroup"||R.dataType==="menu"||R.stereotype==="button",De=f.filter(R=>R!==O&&!D(R)),Ie=p.filter(R=>D(R)),it=(R,se,pe)=>{R.stopPropagation(),R.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:se,parameters:{_clickedRow:pe}},bubbles:!0,composed:!0}))},ft=R=>{const se=[];for(const pe of Ie){const F=R[pe.id];if(pe.dataType==="action"){const j=F?.methodNameInCrud?F:R.action?.methodNameInCrud?R.action:{methodNameInCrud:pe.id,label:pe.label,icon:null};se.push(o`
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: var(--lumo-space-m); padding: var(--lumo-space-s) 0;">
                    ...
                    `)}
                </div>`},ne=()=>{const I=yu(p),L=I.find(D=>D.identifier)??I[0],O=I.filter(D=>D!==L);return o`
...
`)}
    ...
    `},em=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=l.title||l.subtitle||l.toolbar?.length||l.header?.length||l.avatar;return o`
    ...
    `},bi=(e,t)=>e?e.includes("${")&&t._evalTemplate?t._evalTemplate(e):e:"",ze=(e,t,a,s,i,r,n)=>(t.children??[]).map(l=>w(e,l,a,s,i,r,n)),Oo=e=>{const t=e?.metadata?.type;return t==="FormRow"||t==="FormItem"?(e.children??[]).flatMap(Oo):[e]},tm=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=Math.max(1,l.maxColumns??1),u=(t.children??[]).flatMap(Oo),h=p=>{const f=p?.metadata?.colspan,g=typeof f=="number"?f:parseInt(f??"1",10);return Math.min(Math.max(isNaN(g)?1:g,1),c)};return o`
        ...
        </div>`},am=(e,t,a,s,i,r,n)=>o`<div style="display:flex; flex-direction:row; gap:1rem; flex-wrap:wrap;">${ze(e,t,a,s,i,r,n)}</div>`,im=(e,t,a,s,i,r,n)=>{const l=bi(t.metadata.title,e);return o`
        ...
        </div>`},sm=(e,t,a,s,i,r,n)=>{const l=bi(t.metadata.title,e);return o`
        ...
        </div>`},rm=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=l?.spacing===!1?"0":"1rem";return o`<div style="display:flex; flex-direction:row; gap:${c}; ${l?.wrap?"flex-wrap:wrap;":""} ${l?.fullWidth?"width:100%;":""} ${t.style??""}"
                     slot="${t.slot??d}">${ze(e,t,a,s,i,r,n)}</div>`},om=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=l?.spacing===!1?"0":".75rem";return o`<div style="display:flex; flex-direction:column; gap:${c}; ${l?.fullWidth?"width:100%;":""} ${t.style??""}"
                     slot="${t.slot??d}">${ze(e,t,a,s,i,r,n)}</div>`},nm=(e,t,a,s,i,r,n)=>{const l=t.metadata?.orientation==="vertical"?"column":"row";return o`<div style="display:flex; flex-direction:${l}; gap:1rem; width:100%; ${t.style??""}" slot="${t.slot??d}">
        ${(t.children??[]).map(c=>o`<div style="flex:1; min-width:0;">${w(e,c,a,s,i,r,n)}</div>`)}
    </div>`},lm=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=h=>h?w(e,h,a,s,i,r,n):d,u=typeof l.title=="string"?l.title:"";if(t.cssClasses?.includes("mateu-section")){const h=u?o`<h2 class="oj-typography-heading-sm" style="margin: 0;">${u}</h2>`:typeof l.title=="object"&&l.title?c(l.title):d;return o`
        ...
        </div>`},dm=e=>{switch(e){case"h1":return"oj-typography-heading-xl";case"h2":return"oj-typography-heading-lg";case"h3":return"oj-typography-heading-md";case"h4":return"oj-typography-heading-sm";case"h5":case"h6":return"oj-typography-subheading-sm";default:return"oj-typography-body-md"}},cm=(e,t,a)=>{const s=t.metadata,i=bi(s.text,e);return o`<div class="${dm(s.container)}" style="${t.style??""}">${i}</div>`},um=e=>{const t=e.metadata,a=t.color;return o`<oj-c-badge variant="${a==="success"?"success":a==="error"||a==="danger"?"danger":a==="warning"?"warning":a==="info"?"info":"neutral"}" slot="${e.slot??d}">${t.text??""}</oj-c-badge>`},pm=e=>{const t=e.metadata;return o`<a class="oj-link-standalone" href="${t.url??"#"}" slot="${e.slot??d}">${t.text??t.url??""}</a>`},vs=(e,t)=>{t&&e?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t,parameters:{}},bubbles:!0,composed:!0}))},Ro=(e,t,a)=>o`
    <div style="position:fixed; inset:0; background:rgba(0,0,0,.4); display:flex; align-items:center; justify-content:center; z-index:1000;">
    ...
    </div>`,hm=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=bi(l.headerTitle,e),u=p=>p?w(e,p,a,s,i,r,n):d,h=o`${u(l.content)}${ze(e,t,a,s,i,r,n)}`;return Ro(c,h,u(l.footer))},mm=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=bi(l.header,e),u=l.content?w(e,l.content,a,s,i,r,n):d,h=o`
        ...
        <oj-c-button chroming="callToAction" label="${l.confirmText??"OK"}" @ojAction="${p=>vs(p.target,l.confirmActionId)}"></oj-c-button>`;return Ro(c,u,h)},vm=(e,t,a,s,i,r,n)=>o`<div style="overflow: auto; ${t.style??""}" class="${t.cssClasses??d}"
              slot="${t.slot??d}">${ze(e,t,a,s,i,r,n)}</div>`,fm=(e,t,a,s,i,r,n)=>o`<div style="width: 100%; ${t.style??""}" class="${t.cssClasses??d}"
              slot="${t.slot??d}">${ze(e,t,a,s,i,r,n)}</div>`,bm=(e,t,a,s,i,r,n)=>o`<div style="max-width: min(100%, 1200px); margin: auto; ${t.style??""}" class="${t.cssClasses??d}"
              slot="${t.slot??d}">${ze(e,t,a,s,i,r,n)}</div>`,gm=(e,t,a,s,i,r,n)=>o`<div style="display: flex; flex-direction: column; gap: 1rem; width: 100%; ${t.style??""}"
              class="${t.cssClasses??d}" slot="${t.slot??d}">
        ${ze(e,t,a,s,i,r,n)}</div>`,$m=(e,t,a,s,i,r,n)=>{const l=c=>c?.metadata?.type==="BoardLayoutItem"?c.metadata.boardCols??1:1;return o`<div style="display: flex; flex-direction: row; gap: 1rem; width: 100%; ${t.style??""}"
                     class="${t.cssClasses??d}" slot="${t.slot??d}">
        ${(t.children??[]).map(c=>o`
            <div style="flex: ${l(c)} 1 0; min-width: 0;">${w(e,c,a,s,i,r,n)}</div>`)}
    </div>`},ym=(e,t,a,s,i,r,n)=>o`<div style="${t.style??""}" class="${t.cssClasses??d}">
        ${ze(e,t,a,s,i,r,n)}</div>`,xm=(e,t,a,s,i,r,n)=>{const l=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,u=!!i?.hasDetail||!!l,h=c??l;return o`
        ...
        </div>`},wm=(e,t,a,s,i,r,n)=>{const l=t.metadata,c=h=>p=>{const g=p.target.closest(".rw-carousel-wrap")?.querySelector(":scope > .rw-carousel");g?.scrollBy({left:h*g.clientWidth,behavior:"smooth"})},u=l?.nav!==!1;return o`
        <div class="rw-carousel-wrap ${t.cssClasses??""}" style="position: relative; width: 100%; ${t.style??""}"
            ...
            `:d}
        </div>`};var km=Object.defineProperty,Cm=Object.getOwnPropertyDescriptor,Tt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Cm(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&km(t,a,i),i};let ut=class extends S{constructor(){super(...arguments),this.selected=0}createRenderRoot(){return this}label(e){const t=e?.metadata?.label;return t&&typeof t=="string"&&t.includes("${")&&this.container?._evalTemplate?this.container._evalTemplate(t):t??""}render(){const e=this.component?.children??[],t=e.map((s,i)=>({itemKey:String(i),label:this.label(s)})),a=e[this.selected];return o`
            <div>
            ...
            </div>`}};Tt([m({attribute:!1})],ut.prototype,"component",2);Tt([m({attribute:!1})],ut.prototype,"container",2);Tt([m()],ut.prototype,"baseUrl",2);Tt([m({attribute:!1})],ut.prototype,"compState",2);Tt([m({attribute:!1})],ut.prototype,"compData",2);Tt([m({attribute:!1})],ut.prototype,"appState",2);Tt([m({attribute:!1})],ut.prototype,"appData",2);Tt([$()],ut.prototype,"selected",2);ut=Tt([k("mateu-redwood-tabs")],ut);var Sm=Object.defineProperty,Im=Object.getOwnPropertyDescriptor,Pt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Im(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Sm(t,a,i),i};let pt=class extends S{constructor(){super(...arguments),this.open={},this.initialized=!1}createRenderRoot(){return this}label(e){const t=e?.metadata?.label;return t&&typeof t=="string"&&t.includes("${")&&this.container?._evalTemplate?this.container._evalTemplate(t):t??""}render(){const e=this.component?.children??[];return this.initialized||(e.forEach((t,a)=>{t?.metadata?.active&&(this.open[a]=!0)}),this.initialized=!0),o`
            <div style="display:flex; flex-direction:column; gap:.5rem;">
        ...
        <mateu-redwood-table id="${t.id}"
                     ...
                     baseUrl="${s}"
        ></mateu-redwood-table>
        `}renderClientSideComponent(t,a,s,i,r,n,l,c){return v.Page==a?.metadata?.type?em(t,a,s,i,r,n,l):v.Form==a?.metadata?.type?Zh(t,a,s,i,r,n,l):v.Button==a?.metadata?.type?cu(a):v.FormField==a?.metadata?.type?lp(t,a,s,i,r):v.FormLayout==a?.metadata?.type?tm(t,a,s,i,r,n,l):v.FormRow==a?.metadata?.type?am(t,a,s,i,r,n,l):v.FormSection==a?.metadata?.type?im(t,a,s,i,r,n,l):v.FormSubSection==a?.metadata?.type?sm(t,a,s,i,r,n,l):v.HorizontalLayout==a?.metadata?.type?rm(t,a,s,i,r,n,l):v.VerticalLayout==a?.metadata?.type?om(t,a,s,i,r,n,l):v.SplitLayout==a?.metadata?.type?nm(t,a,s,i,r,n,l):v.MasterDetailLayout==a?.metadata?.type?xm(t,a,s,i,r,n,l):v.Scroller==a?.metadata?.type?vm(t,a,s,i,r,n,l):v.FullWidth==a?.metadata?.type?fm(t,a,s,i,r,n,l):v.Container==a?.metadata?.type?bm(t,a,s,i,r,n,l):v.BoardLayout==a?.metadata?.type?gm(t,a,s,i,r,n,l):v.BoardLayoutRow==a?.metadata?.type?$m(t,a,s,i,r,n,l):v.BoardLayoutItem==a?.metadata?.type?ym(t,a,s,i,r,n,l):v.CarouselLayout==a?.metadata?.type?wm(t,a,s,i,r,n,l):v.Card==a?.metadata?.type?lm(t,a,s,i,r,n,l):v.Text==a?.metadata?.type?cm(t,a):v.Badge==a?.metadata?.type?um(a):v.Anchor==a?.metadata?.type?pm(a):v.Icon==a?.metadata?.type?Lu(a):v.Breadcrumbs==a?.metadata?.type?Du(a):v.Notification==a?.metadata?.type?Fu(a):v.ProgressBar==a?.metadata?.type?Nu(a,i):v.Details==a?.metadata?.type?Mu(t,a,s,i,r,n,l):v.Avatar==a?.metadata?.type?qu(a,i,r):v.AvatarGroup==a?.metadata?.type?Uu(a):v.Tooltip==a?.metadata?.type?Bu(t,a,s,i,r,n,l):v.Popover==a?.metadata?.type?Vu(t,a,s,i,r,n,l):v.MenuBar==a?.metadata?.type?Wu(t,a):v.ContextMenu==a?.metadata?.type?Hu(t,a,s,i,r,n,l):v.Grid==a?.metadata?.type?Tu(a,i):v.Table==a?.metadata?.type?Pu(t,a,s,i,r,n,l):v.VirtualList==a?.metadata?.type?Ou(t,a,s,i,r,n,l):v.Directory==a?.metadata?.type?Ru(a):v.CustomField==a?.metadata?.type?zu(t,a,s,i,r,n,l):v.MessageList==a?.metadata?.type?ju(a):v.MessageInput==a?.metadata?.type?Au(a):v.TabLayout==a?.metadata?.type?o`<mateu-redwood-tabs
  ...
  `;Ot([m()],et.prototype,"baseUrl",2);Ot([m()],et.prototype,"route",2);Ot([m()],et.prototype,"consumedRoute",2);Ot([m()],et.prototype,"config",2);Ot([m()],et.prototype,"top",2);Ot([m()],et.prototype,"pathPrefix",2);Ot([$()],et.prototype,"instant",2);Ot([m({type:Boolean})],et.prototype,"debug",2);et=Ot([k("mateu-ui")],et);var jm=Object.getOwnPropertyDescriptor,Am=(e,t,a,s)=>{for(var i=s>1?void 0:s?jm(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(i)||i);return i};let ks=class extends ui{constructor(){super(...arguments),this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))}}render(){const e=this.component?.metadata;return o`
