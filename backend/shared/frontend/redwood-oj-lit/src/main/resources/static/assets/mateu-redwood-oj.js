...
`},zs=(e,t,a,s,i,r,n,d)=>v.GridGroupColumn==e.metadata?.type?Qn(e.metadata,t,a,s,i,r,n,d):Fr(e.metadata,t,a,s,i,r,n,d?.[e.metadata?.id]),Fr=(e,t,a,s,i,r,n,d)=>{const c=Re(e.label,s,i);return e.sortable?o`
        ...
        >
            ...
            <vaadin-grid-column path="${m.id}"
                                ...
                                width="${f?.width??l}"
                                .column="${m.metadata}"
                                ${_t((g,y,x)=>Ti(g,y,x,f,e,a,s,i,r,n),[])}></vaadin-grid-column>
`:o`
...
`,Bl=e=>e=="up"?"var(--lumo-success-text-color, #1a7f37)":e=="down"?"var(--lumo-error-text-color, #c5221f)":"var(--lumo-secondary-text-color, #666)",Vl=e=>e=="up"?"▲":e=="down"?"▼":"",Hl=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},Wl=e=>{const t=e.metadata,a=!!t.actionId;return o`
    ...
    `;Zt([h({type:Array})],M.prototype,"resources",2);Zt([h({type:Array})],M.prototype,"blocks",2);Zt([h()],M.prototype,"from",2);Zt([h()],M.prototype,"to",2);Zt([h()],M.prototype,"moveActionId",2);Zt([h()],M.prototype,"selectActionId",2);Zt([$()],M.prototype,"drag",2);M=Zt([k("mateu-planning-board")],M);const rd=e=>{const t=e.metadata;return o`
    ...
    `;Fs([h({type:Array})],li.prototype,"items",2);Fs([$()],li.prototype,"openSet",2);li=Fs([k("mateu-faq")],li);const Hd=e=>{const t=e.metadata;return o`
        <mateu-faq
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;Xi([h()],za.prototype,"heading",2);Xi([h({type:Array})],za.prototype,"items",2);Xi([$()],za.prototype,"localDone",2);za=Xi([k("mateu-checklist")],za);const sc=e=>{const t=e.metadata;return o`
        <mateu-checklist
                heading="${t.title??l}"
                .items="${t.items??[]}"
                style="${e.style??l}"
...
`,lc=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}),Is=e=>lc.format(e),Fi=(e,t)=>{const a=e<0?"-":"",s=Is(Math.abs(e));return t?`${a}${t} ${s}`:`${a}${s}`},dc=(e,t)=>t?`${Is(e)} ${t}`:Is(e);var cc=Object.defineProperty,uc=Object.getOwnPropertyDescriptor,aa=(e,t,a,s)=>{for(var i=s>1?void 0:s?uc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&cc(t,a,i),i};let ht=class extends S{constructor(){super(...arguments),this.title="",this.badges=[],this.facts=[]}render(){const e=!!(this.metricLabel||this.metricValue||this.metricCaption);return o`
    ...
    `];Zi([h()],Aa.prototype,"actionId",2);Zi([h({type:Array})],Aa.prototype,"groups",2);Zi([$()],Aa.prototype,"selectedId",2);Aa=Zi([k("mateu-task-queue")],Aa);const Rc=e=>{const t=e.metadata;return o`
        <mateu-task-queue
                .actionId="${t.actionId}"
                .groups="${t.groups??[]}"
                style="${e.style??l}"
    ...
    `];qa([h()],Wt.prototype,"actionId",2);qa([h({type:Number})],Wt.prototype,"columns",2);qa([h()],Wt.prototype,"recommendedLabel",2);qa([h({type:Array})],Wt.prototype,"items",2);qa([$()],Wt.prototype,"selectedId",2);Wt=qa([k("mateu-resource-grid")],Wt);const Lc=e=>{const t=e.metadata;return o`
        <mateu-resource-grid
                .actionId="${t.actionId}"
                .columns="${t.columns??0}"
    ...
    `;Ua([h()],Gt.prototype,"totalLabel",2);Ua([h()],Gt.prototype,"currency",2);Ua([h()],Gt.prototype,"actionId",2);Ua([h({type:Array})],Gt.prototype,"items",2);Ua([$()],Gt.prototype,"added",2);Gt=Ua([k("mateu-addon-picker")],Gt);const qc=e=>{const t=e.metadata;return o`
        <mateu-addon-picker
...
`:l}
                ...
                <vaadin-app-layout style="${t?.style}" class="${t?.cssClasses}" .drawerOpened=${!t.drawerClosed}>
                    ...
                    <vaadin-scroller slot="drawer" class="p-s"
                        ...
                        ${t.menu&&t.totalMenuOptions>10?o`
                            <vaadin-text-field style="width: calc(100% - 20px); padding-left: 10px; padding-right: 10px;" @value-changed="${p=>fu(p,e)}">
            ...
            <slot></slot>
       `},gu=(e,t)=>t!=null&&e!=null&&!e.has(t),$u=typeof HTMLElement<"u"?HTMLElement:class{};class yu extends $u{static get observedAttributes(){return["type","renderer"]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){const t=this.getAttribute("type")??"unknown",a=this.getAttribute("renderer")??"unknown";this.shadowRoot||this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host { display: block; }
                .mateu-unsupported {
                    box-sizing: border-box;
        ...
        `}}typeof customElements<"u"&&!customElements.get("mateu-unsupported")&&customElements.define("mateu-unsupported",yu);const cr=new Set,xu=(e,t,a)=>{const s=`${a}/${t}`;return cr.has(s)||(cr.add(s),console.warn(`[mateu] Component type "${t}" is not supported by the "${a}" renderer — rendering <mateu-unsupported> placeholder.`)),o`<mateu-unsupported
            type="${t}"
            renderer="${a}"
            data-component-id="${e?.id??l}"
            slot="${e?.slot??l}"
    ></mateu-unsupported>`};class wu{renderFilterBar(t,a,s,i,r,n,d,c){const u=a?.metadata,m=f=>{const{fieldId:g,value:y}=f.detail;t.state={...t.state,[g]:y}},p=f=>{const{fieldIds:g}=f.detail,y={};g.forEach(x=>{y[x]=void 0}),y.searchText=void 0,t.state={...t.state,...y}};return o`
            <mateu-filter-bar
                .metadata="${u}"
        ...
        <mateu-table id="${t.id}"
                     ...
                     baseUrl="${s}"
        ></mateu-table>
        `}rendererName(){return this.constructor?.name??"unknown"}supportedClientSideTypes(){}renderClientSideComponent(t,a,s,i,r,n,d,c){const u=a?.metadata?.type??a?.type,m=Object.values(v).includes(u)?u:void 0;return gu(this.supportedClientSideTypes(),m)?xu(a,m,this.rendererName()):Ms(t,a,s,i,r,n,d,c)}renderAppComponent(t,a,s,i,r,n,d){return bu(t,a?.metadata,s,i,r,n,d)}}const ur="border-left: 1px solid var(--oj-core-text-color-secondary, #888); height: 1.5rem; display: inline-block; align-self: center;",ku=(e,t,a,s)=>{const i=e.metadata,r=e.slot??l;if(i.children&&i.children.length>0){const d=i.children.map(c=>({key:c.actionId,label:c.label,disabled:c.disabled??!1}));return o`
    ...
    `;bi([h()],Yt.prototype,"fieldId",2);bi([h()],Yt.prototype,"value",2);bi([h()],Yt.prototype,"accept",2);bi([h({type:Boolean})],Yt.prototype,"editable",2);Yt=bi([k("mateu-file-upload")],Yt);const Ru=76;function pr(e){if(e.weight!=null)return e.weight;const t=e.stereotype??"";if(t==="icon")return 1;if(t==="image")return 4;if(t==="html"||t==="richText"||t==="markdown"||t==="textarea")return 5;if(t==="link")return 2.5;if(t==="combobox"||t==="select")return 2;const a=e.dataType??"";return a==="bool"?1:a==="status"||a==="integer"?1.5:a==="number"||a==="date"||a==="money"?2:a==="dateTime"||a==="dateRange"?2.5:3}function lo(e,t){if(e.length===0)return"table";const a=e.reduce((c,u)=>c+pr(u),0),s=t/Ru,i=a/s;if(i<=1)return"table";const r=e.filter(c=>c.identifier||(c.priority??Number.MAX_SAFE_INTEGER)<=2),n=r.reduce((c,u)=>c+pr(u),0);return i>1.6||e.length>10?"masterDetail":r.length>0&&n<=8?"list":e.some(c=>c.stereotype==="image"||c.stereotype==="html")||r.length===0&&e.length>=4&&e.length<=8?"cards":"masterDetail"}function Ui(e){return e.filter(t=>t.identifier||(t.priority??Number.MAX_SAFE_INTEGER)<=2).sort((t,a)=>(t.priority??Number.MAX_SAFE_INTEGER)-(a.priority??Number.MAX_SAFE_INTEGER))}function zu(e){const t=Ui(e);return t.length>0?t:e.slice(0,3)}var Au=Object.defineProperty,Lu=Object.getOwnPropertyDescriptor,Bs=(e,t,a,s)=>{for(var i=s>1?void 0:s?Lu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Au(t,a,i),i};let Bi=class extends S{constructor(){super(...arguments),this.actions=[],this.rowdata={}}createRenderRoot(){return this}handleMenuAction(e){e.stopPropagation();const t=e.detail?.key;t&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t,parameters:{_clickedRow:this.rowdata}},bubbles:!0,composed:!0}))}render(){const e=this.actions??[];if(!e.length)return o`${l}`;const t=e.map(a=>({label:a.label??a.text??"",key:a.methodNameInCrud??a.actionId??a.id??a.key??a.label,disabled:a.disabled??!1}));return o`
            <oj-c-menu-button
                data-oj-binding-provider="preact"
                label="···"
                chroming="borderless"
...
data-oj-binding-provider="preact" label="[[cell.data == null ? '' : '' + cell.data]]" chroming="borderless"></oj-c-button>`,e+="</span>",e+="</template>"}else if(a.dataType==="status")e+=`<template slot="${a.id}Template" data-oj-as="cell">`,e+="<oj-c-badge",e+=` label="[[cell.data ? (cell.data.message || String(cell.data)) : '']]"`,e+=` variant="[[cell.data ? (cell.data.type === 'SUCCESS' ? 'successSubtle' : cell.data.type === 'DANGER' ? 'dangerSubtle' : cell.data.type === 'WARNING' ? 'warningSubtle' : cell.data.type === 'INFO' ? 'infoSubtle' : 'neutral') : 'neutral']]"`,e+="></oj-c-badge>",e+="</template>";else if(a.dataType==="actionGroup"||a.dataType==="menu")e+=`<template slot="${a.id}Template" data-oj-as="cell">`,e+="<oj-c-menu-button",e+=' data-oj-binding-provider="preact"',e+=' label="···"',e+=' chroming="borderless"',e+=` :items="[[cell.data && cell.data.actions ? cell.data.actions.map(function(a){return {label:a.label||a.text||'',key:(cell.item.key+'')+'|'+(a.methodNameInCrud||a.actionId||a.id||a.key||(a.label||'')),disabled:!!a.disabled};}) : []]]"`,e+="></oj-c-menu-button>",e+="</template>";else if(a.dataType==="action"){const s=a.actionId||a.id;e+=`<template slot="${a.id}Template" data-oj-as="cell">`,e+="<oj-c-menu-button",e+=' data-oj-binding-provider="preact"',e+=' label="···"',e+=' chroming="borderless"',e+=` :items="[[cell.data ? [{label:cell.data.label||cell.data.text||'${s}',key:(cell.item.key+'')+'|'+(cell.data.methodNameInCrud||'${s}'),disabled:!!cell.data.disabled}] : []]]"`,e+="></oj-c-menu-button>",e+="</template>"}}),e}refreshDataProvider(){const e=()=>{const t=this.data[this.id]?.page?.content??[];this.dataProvider=new W._ADP(t,{keyAttributes:"@index"}),this.scheduleMount()};W._ADP?e():require(["ojs/ojarraydataprovider"],t=>{W._ADP=t.default??t,this.isConnected&&e()})}scheduleMount(){this.mountTimer&&clearTimeout(this.mountTimer),this.mountTimer=setTimeout(()=>{this.mountTimer=null,this.mountTable()},60)}mountTable(){const e=this.querySelector(".rwt-table-host");if(!e)return;const t=document.createElement("oj-c-table");t.setAttribute("data-oj-binding-provider","preact"),t.setAttribute("aria-label","Data table"),t.setAttribute("layout","contents"),t.style.width="100%";const a=this.getTemplateSlots();if(a){const s=document.createElement("div");s.innerHTML=a,Array.from(s.childNodes).forEach(i=>t.appendChild(i))}t.columns=this.getOjColumns(),t.selectionMode=this.metadata?.rowsSelectionEnabled?{row:"multiple"}:{row:"none"},t.addEventListener("ojRowAction",s=>this.handleRowAction(s)),t.addEventListener("ojAction",s=>this.handleCellButtonAction(s)),t.addEventListener("selectedChanged",s=>this.handleSelectedChanged(s)),t.addEventListener("ojMenuAction",s=>this.handleMenuAction(s)),t.data=this.dataProvider,e.replaceChildren(t)}updated(e){super.updated(e),e.has("metadata")&&(this.lastContentRef=!1);const t=this.data?.[this.id]?.page?.content,a=Array.isArray(t)?t.length:0,s=t!==this.lastContentRef||a!==this.lastContentLen;if(s&&(this.lastContentRef=t,this.lastContentLen=a),this.effectiveGridLayout==="table"&&!this.groupedTableActive){const i=this.querySelector(".rwt-table-host");(s||i&&i.childElementCount===0)&&this.refreshDataProvider()}else s&&(this.collapsedNodes.clear(),this.requestUpdate())}handleRowAction(e){const t=e.detail?.context?.item?.data;if(!t)return;const a=this.metadata?.columns?.find(s=>{const i=s.metadata;return i.stereotype==="button"&&i.actionId});if(a){const s=a.metadata;this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:s.actionId,parameters:t},bubbles:!0,composed:!0}))}}handleCellButtonAction(e){const t=e.composedPath();let a=null,s=null;for(const n of t){const d=n;if(d.getAttribute("data-mateu-row-key")){const c=d.getAttribute("data-mateu-row-key");if(c!==null){a=c,s=d.getAttribute("data-mateu-action-id");break}}}if(a===null)return;const r=(this.data[this.id]?.page?.content??[]).find((n,d)=>n._rowNumber==a)??{};this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:s??"",parameters:r},bubbles:!0,composed:!0}))}handleMenuAction(e){const t=e.detail?.key;if(!t)return;const a=t.indexOf("|");if(a<0)return;const s=parseInt(t.substring(0,a)),i=t.substring(a+1),n=(this.data[this.id]?.page?.content??[])[s]??{};this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:i,parameters:n},bubbles:!0,composed:!0}))}handleSelectedChanged(e){const t=e.detail.value?.row;if(!t)return;const a=this.data[this.id]?.page?.content??[],s=t.isAddAll()?a:a.filter((i,r)=>t.has(r));this.state.crud_selected_items=s}dispatchAction(e,t){this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e,parameters:t},bubbles:!0,composed:!0}))}openRow(e){const t=this.identifierFieldName;t&&e[t]!==void 0&&(this.state._selectedId=String(e[t])),this.dispatchAction("view",e),this.requestUpdate()}isSelectedRow(e){const t=this.identifierFieldName,a=this.state?._selectedId??this.appState?._splitDetailId;return!!t&&a!==void 0&&String(e[t])===String(a)}static isActionButtonCol(e){return e.dataType==="action"||e.dataType==="actionGroup"||e.dataType==="menu"||e.stereotype==="button"}statusBadge(e){const t=(e?.type??"").toUpperCase();return o`<span style="${t==="SUCCESS"?"background: rgba(104, 150, 90, 0.18); color: rgb(49, 93, 36);":t==="DANGER"||t==="ERROR"?"background: rgba(179, 49, 31, 0.14); color: rgb(150, 40, 27);":t==="WARNING"?"background: rgba(190, 120, 0, 0.16); color: rgb(124, 79, 4);":t==="INFO"?"background: rgba(28, 101, 154, 0.14); color: rgb(28, 90, 131);":"background: rgba(22, 21, 19, 0.08); color: rgb(70, 68, 66);"} border-radius: 1rem; padding: 0.1rem 0.6rem; font-size: 0.75rem; font-weight: 600; white-space: nowrap;">${e?.message??String(e??"")}</span>`}formatValue(e,t){const a=t[e.id];return a==null?o``:e.dataType==="status"?this.statusBadge(a):e.dataType==="bool"||e.dataType==="boolean"?o`${a?"✓":"✗"}`:typeof a=="object"?o`${a.label??a.name??a.message??""}`:o`${a}`}linkButton(e,t,a){return o`
            ...
            <slot></slot>
        `}};W._ADP=null;He([h()],W.prototype,"id",2);He([h()],W.prototype,"metadata",2);He([h()],W.prototype,"baseUrl",2);He([h()],W.prototype,"state",2);He([h()],W.prototype,"data",2);He([h()],W.prototype,"appState",2);He([h()],W.prototype,"appData",2);He([h()],W.prototype,"emptyStateMessage",2);He([$()],W.prototype,"_connected",2);He([$()],W.prototype,"availableWidthPx",2);He([$()],W.prototype,"selectedItem",2);W=He([k("mateu-redwood-table")],W);const as="var(--oj-core-text-color-secondary, #666)",co="var(--oj-core-divider-color, rgba(22,21,19,.12))",Nu=`text-align: left; padding: 0.5rem 0.75rem; border-bottom: 2px solid ${co}; color: ${as}; font-size: 0.8125rem; font-weight: 600; white-space: nowrap;`,mr=`padding: 0.5rem 0.75rem; border-bottom: 1px solid ${co};`,Fu=e=>{const t=(e??"").toUpperCase();return t==="SUCCESS"?"successSubtle":t==="DANGER"||t==="ERROR"?"dangerSubtle":t==="WARNING"?"warningSubtle":t==="INFO"?"infoSubtle":"neutral"},Mu=(e,t,a)=>{e?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t,parameters:a},bubbles:!0,composed:!0}))},qu=(e,t)=>{const a=e[t.id];if(t.stereotype==="button"||t.dataType==="action"){const s=a?.label??a?.text??t.text??t.label??"View",i=a?.methodNameInCrud??t.actionId??t.id;return o`<oj-c-button
            data-oj-binding-provider="preact"
            label="${s}"
            chroming="borderless"
            @ojAction="${r=>Mu(r.target,i,e)}"
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <thead>
                <tr>${e.map(r=>o`<th style="${Nu} ${r.align?`text-align: ${r.align};`:""}" width="${r.width??l}">${r.label??""}</th>`)}</tr>
            </thead>
            <tbody>
                ${t.length===0?o`<tr><td colspan="${e.length}" style="${mr} color: ${as}; text-align: center;">No data.</td></tr>`:t.flatMap(r=>i(r,0))}
            </tbody>
        </table>`},Uu=(e,t)=>{const a=e.metadata,s=uo(a.content);let i=a.page?.content??[];return e.id&&t&&Array.isArray(t[e.id])&&(i=t[e.id]),o`
        <div style="width: 100%; overflow-x: auto; ${e.style??""}" class="${e.cssClasses??l}"
             slot="${e.slot??l}">
            ${po(s,i,a.tree)}
        </div>`},Bu=(e,t,a,s,i,r,n)=>o`
    <mateu-redwood-table
        id="${t.id}"
        .metadata="${t.metadata}"
        .data="${i}"
    ...
    >
        ${t.children?.map(d=>w(e,d,a,s,i,r,n))}
    </mateu-redwood-table>`,Vu=(e,t,a,s,i,r,n)=>{const c=t.metadata.page?.content??[];return o`
        <div style="overflow-y: auto; ${t.style??""}" class="${t.cssClasses??l}"
             slot="${t.slot??l}">
            ${c.map(u=>w(e,u,a,s,i,r,n))}
        </div>`},Hu=e=>{const t=s=>s.submenus?o`
        ...
        <div style="display: flex; gap: 3rem; align-items: flex-start; flex-wrap: wrap; ${e.style??""}"
            ...
            ${a.menu.map(s=>t(s))}
        </div>`},Wu=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        ...
        </div>`},Gu=e=>{const t=e.state?.items??e.metadata?.items??[];return o`
        <div style="display: flex; flex-direction: column; gap: 0.75rem; padding: 0.5rem; ${e.style??""}"
            ...
            `)}
        </div>`},Ku=e=>{const t=a=>{const i=a.target.closest(".rw-message-input")?.querySelector("oj-c-input-text"),r=i?.rawValue??i?.value??"";r&&(a.target.dispatchEvent(new CustomEvent("submit",{detail:{value:r},bubbles:!0,composed:!0})),i&&(i.value=""))};return o`
        ...
        </div>`},Pa="var(--oj-core-text-color-secondary, #666)",Vs="var(--oj-core-divider-color, rgba(22,21,19,.12))",Hs="var(--oj-core-bg-color-content, #fff)",ho="var(--oj-core-border-radius-md, 6px)",Ba=e=>"oj-ux-ico-"+(e??"").replace(/^vaadin:/,"").replace(/^lumo:/,""),Yu=e=>{const t=e.metadata;return o`<span class="${Ba(t?.icon)} ${e.cssClasses??""}"
                      style="font-size: 1.25rem; ${e.style??""}"
                      slot="${e.slot??l}"
                      aria-label="${t?.icon??l}"></span>`},Ju=e=>{const t=e.metadata,a=t?.breadcrumbs??[];return o`
        <nav aria-label="Breadcrumb"
            ...
            `:l}
        </nav>`},Xu=e=>{const t=e.metadata;return o`
        <div role="status"
        ...
        </div>`},Qu=(e,t={})=>{const a=e.metadata,s=a.valueKey?t[a.valueKey]:a.value;return o`
        ...
        </div>`},Zu=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        <oj-c-collapsible data-oj-binding-provider="preact"
        ...
        </oj-c-collapsible>`},mo=e=>e.abbreviation||(e.name?e.name.split(/\s+/).map(t=>t[0]).slice(0,2).join(""):""),ep=(e,t,a)=>{const s=e.metadata;return o`<oj-c-avatar
            data-oj-binding-provider="preact"
            initials="${mo(s)||l}"
            src="${s.image??l}"
            role="img"
            ...
            slot="${e.slot??l}"
    ></oj-c-avatar>`},tp=e=>{const t=e.metadata,a=t.avatars??[],s=t.maxItemsVisible||a.length,i=a.slice(0,s),r=a.length-i.length;return o`
        ...
        </div>`},ap=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        <span title="${d.text??""}" style="${t.style??l}"
              class="${t.cssClasses??l}" slot="${t.slot??l}">
            ${d.wrapped?w(e,d.wrapped,a,s,i,r,n):l}
        </span>`},_s=e=>{const a=e?.closest(".rw-pop-wrap")?.querySelector(":scope > .rw-pop-panel");a&&(a.hidden=!a.hidden)},vo=`position: absolute; top: 100%; left: 0; margin-top: 4px; z-index: 1000; background: ${Hs}; border: 1px solid ${Vs}; border-radius: ${ho}; box-shadow: 0 4px 12px rgba(0,0,0,.15); min-width: 10rem;`,ip=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        ...
        </span>`},Es=(e,t)=>{t&&e?.dispatchEvent(new CustomEvent("update-route",{detail:{route:t},bubbles:!0,composed:!0}))},sp=(e,t)=>{const s=t.metadata.options??[],i=r=>{if(r.submenus&&r.submenus.length>0){const n=r.submenus.map(d=>({key:d.path??d.label,label:d.label,disabled:d.disabled??!1}));return o`
                <oj-c-menu-button
                    data-oj-binding-provider="preact"
                    label="${r.label}"
                    chroming="borderless"
        ...
        <div style="display: flex; flex-direction: row; gap: 0.25rem; align-items: center; ${t.style??""}"
             class="${t.cssClasses??l}" slot="${t.slot??l}">
            ${s.map(i)}
        </div>`},rp=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=p=>{p.preventDefault(),_s(p.currentTarget)},u=(p,f)=>{_s(p.currentTarget),Es(p.target,f.path)},m=(p,f=0)=>o`
        ${p.map(g=>g.separator?o`<div style="border-top: 1px solid ${Vs}; margin: 0.25rem 0;"></div>`:o`
                <div role="menuitem"
                     style="padding: 0.4rem 1rem 0.4rem ${1+f*1.25}rem; cursor: ${g.disabled?"default":"pointer"}; ${g.disabled?`color: ${Pa}; opacity: 0.6;`:""} white-space: nowrap;"
                     @click="${g.disabled?l:y=>u(y,g)}">
                    ${g.icon?o`<span class="${Ba(g.icon)}" style="margin-right: 0.4rem;"></span>`:l}
                    ${g.label}
                </div>
    ...
    ></oj-c-select-single>`},op=(e,t,a,s,i)=>{const r=fo(i.map(n=>({value:n.value,label:n.label??""})));return o`<oj-c-select-multiple
        data-oj-binding-provider="preact"
        id="${t}"
        label-hint="${a}"
        label-edge="top"
    ...
    </div>`,np=(e,t,a)=>{let s=typeof e=="number"?e:parseInt(""+e,10);return isNaN(s)&&(s=0),o`<oj-c-rating-gauge
        data-oj-binding-provider="preact"
        .value="${s}"
        max="5"
        step="1"
    ...
    ></oj-c-rating-gauge>`},lp=e=>t=>{const a=t.target,s=a.files?.[0];if(!s)return;const i=new FileReader;i.onload=()=>gi(a,e,i.result),i.readAsDataURL(s),a.value=""},dp=e=>t=>{t.target.getRootNode().querySelector(`#${CSS.escape(e)}`)?.click()},cp=(e,t,a)=>{const s=a!=null&&a!=="",i=`${t}_file`;return o`
        <div style="display: flex; flex-direction: column; align-items: stretch; gap: 0.5rem; max-width: 320px;">
            ...
            `}
            <input type="file" id="${i}" accept="image/*" style="display: none;" @change="${lp(e.fieldId)}">
            <div style="display: flex; gap: 0.5rem;">
                <oj-c-button data-oj-binding-provider="preact" label="${s?"Replace":"Upload"}" chroming="outlined"
                             @ojAction="${dp(i)}"></oj-c-button>
                ${s?o`
        ...
        </div>`},up=(e,t,a)=>{const s=t===!0||t==="true";return o`
        <div style="${e.style??l}">
            <oj-c-badge data-oj-binding-provider="preact"
                        variant="${s?"success":"neutral"}"
                        style="${s?"":"opacity: 0.4;"}">${a}</oj-c-badge>
        </div>`},pp=(e,t,a,s,i)=>{let r=de(t,s,i);const n=r&&typeof r=="object"&&"value"in r?r:null;r&&r.value&&(r=r.value);const d=e.dataType=="bool"||r===!0||r===!1,c=e.dataType=="money",u=r!=null&&r!=="";let m=u?""+r:"—";c&&u&&(m=bo(r,n));const p=d?o`<span>${r===!0||r==="true"?"✓":"—"}</span>`:e.multiline?o`<span style="font-weight: 500; white-space: pre-wrap; word-break: break-word;">${m}</span>`:o`<span style="display: block; font-weight: 500; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;${c?" font-variant-numeric: tabular-nums;":""}">${m}</span>`;return H(a,p,c?"text-align: right; ":"")},hp=(e,t,a,s,i)=>{let r=de(t,s,i);const n=r&&typeof r=="object"&&"value"in r?r:null;r&&r.value&&(r=r.value);const d=e.dataType=="bool"||r===!0||r===!1,c=e.dataType=="money",u=r!=null&&r!=="";let m=u?""+r:"—";c&&u&&(m=bo(r,n));const p=d?o`<span style="margin-left: auto;">${r===!0||r==="true"?"✓":"—"}</span>`:o`<span style="font-weight: 500; text-align: right; word-break: break-word; margin-left: auto;${c?" font-variant-numeric: tabular-nums;":""}">${m}</span>`,f=a!=null&&a!==""&&a!=="null"?""+a:"";return o`<div style="display: flex; justify-content: space-between; align-items: baseline; gap: 1rem; width: 100%; padding: 0.4rem 0; border-bottom: 1px solid rgba(0,0,0,.08); ${e.style??""}"
    >${f?o`<span style="color: ${Sa}; white-space: nowrap;">${f}</span>`:l}${p}</div>`},mp=(e,t,a,s,i)=>{const r=de(t,s,i),n=Array.isArray(r)?r.map(d=>""+d):r!=null&&r!==""?[""+r]:[];return H(a,o`<mateu-bulleted-list .items="${n}" style="${e.style??l}"></mateu-bulleted-list>`)},vp=(e,t,a,s,i)=>{let r=de(t,s,i)||i?.[e.fieldId];if(r&&r.value&&(r=r.value),e.stereotype=="image"||e.stereotype=="uploadableImage"||e.stereotype=="signature"||e.stereotype=="camera")return H(a,o`<img src="${r}" style="${e.style??l}">`);if(e.stereotype=="fileUpload")return H(a,o`<mateu-file-upload .fieldId="${e.fieldId}" .value="${r}" .editable="${!1}"></mateu-file-upload>`);if(e.dataType=="bool")return H(a,o`<span>${r?"✓":"—"}</span>`);if(e.stereotype=="link")return H(a,o`<a class="oj-link-standalone" href="${r??""}" target="_blank">${r??""}</a>`);if(e.stereotype=="color")return H(a,o`<span style="background-color: ${r}; display: block; height: 20px; width: 40px; border: 1px solid ${Sa}; border-radius: 4px;"></span>`);const n=r!=null&&r!=="";return H(a,o`<span style="display: block; font-weight: 500; overflow: hidden; text-overflow: ellipsis;">${n?r:"—"}</span>`)},fp=X`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>`,bp=X`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>`,$o=(e,t,a)=>{const s=e.link,i=Re(s.href,t,a)??s.href,r=Re(s.title,t,a)||i;return{href:i,title:r}},gp=e=>{const t=e;if(!t||t.__navlinkPositioned)return;t.__navlinkPositioned=!0;const a=()=>{const r=t.parentElement,n=r?.firstElementChild?.querySelector("input, textarea, select");if(!r||!n)return;const d=n.getBoundingClientRect();d.height!==0&&(t.style.marginTop=`${Math.max(0,Math.round(d.top+d.height/2-t.offsetHeight/2-r.getBoundingClientRect().top))}px`)};let s=0;const i=()=>{a(),s++<32&&setTimeout(i,250)};setTimeout(i),document.fonts?.ready.then(()=>setTimeout(a))},$p=(e,t,a)=>{const s=e.link,{href:i,title:r}=$o(e,t,a),n=s.icon?o`<span class="${Ba(s.icon)}" style="font-size: 1.125rem;"></span>`:i.startsWith("http")?fp:bp;return o`<a data-navlink
        href="${i}"
        title="${r}"
        target="${s.target||l}"
        ${Ko(gp)}
        style="display: flex; align-items: center; color: ${Sa}; align-self: flex-start; margin-top: 1.9rem;"
    >${n}</a>`},yp=(e,t,a)=>s=>{const i=s.composedPath()[0]?.value;if(i==null)return;const n=s.currentTarget.querySelector("a[data-navlink]");if(!n)return;const{href:d,title:c}=$o(e,{...t,[e.fieldId]:i},a);n.setAttribute("href",d),n.setAttribute("title",c)},xp=(e,t,a,s,i)=>{const r=t.metadata,n=wp(e,t,a,s,i);return r?.link?.href?o`<div style="display: flex; gap: 0.5rem;" @input="${yp(r,s,i)}">
        <div style="flex: 1; min-width: 0;">${n}</div>
        ${$p(r,s,i)}
    </div>`:n},wp=(e,t,a,s,i)=>{const r=t.metadata,n=r?.fieldId??"",d=s&&n in s?s[n]:r?.initialValue,c=r.label??"",u=t.id??n,m=r.stereotype;if(r.propertyRow)return hp(r,d,c,s,i);if(m==="badge")return up(t,d,c||n);if(m==="plainText")return pp(r,d,c,s,i);if(m==="bulletedList")return mp(r,d,c,s,i);if(r.readOnly&&m!="grid"&&r.dataType!="status"&&r.dataType!="money")return vp(r,d,c,s,i);if(m==="grid"&&r.columns&&r.columns.length>0){const p=Array.isArray(d)?d:[],f=r.columns.map(x=>({...x.metadata,id:x.metadata.id??x.id})),g=r.onItemSelectionActionId;return H(c,o`<div style="overflow-x: auto;">${po(f,p,!1,g?(x,T)=>x.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:g,parameters:{_clickedRow:T}},bubbles:!0,composed:!0})):void 0)}</div>`)}if(r.dataType==="string"){if(m==="searchable"){const p=g=>Ts(g.target,"code-"+n,{code:g.detail?.value??g.target?.value??""}),f=g=>Ts(g.target,"codesearch-"+n,{});return H(c,o`
            ...
            </figure>`:m==="uploadableImage"?H(c,cp(r,u,d)):m==="treeSelect"?H(c,o`<mateu-tree-select
                .fieldId="${u}" .value="${d}"
                .options="${r.options??[]}"
        ...
        ></oj-c-input-text>`}if(r.dataType==="number")return o`<oj-c-input-number
            ...
            ?disabled="${r.disabled}"
            @valueChanged="${p=>V(p,u,p.detail.value)}"
        ></oj-c-input-number>`;if(r.dataType==="integer")return m==="stars"?H(c,np(d,n,r.disabled)):m==="slider"?o`<div>
                <label for="${u}" style="${It}">${c}</label>
        ...
        >${c}</oj-c-checkbox>`;if(r.dataType==="date")return o`<oj-c-input-date-picker
            ...
            ?disabled="${r.disabled}"
            @valueChanged="${p=>V(p,u,p.detail.value)}"
        ></oj-c-input-date-picker>`;if(r.dataType==="dateTime"){const p=d,f=p?p.split("T")[0]:null,g=p?p.split("T")[1]?.substring(0,5):null;return o`<div style="display:flex;gap:0.5rem;align-items:flex-end;">
        ...
        ></oj-c-input-time-mask>`;if(r.dataType==="dateRange"){const p=d;return o`<div style="display:flex;gap:0.5rem;align-items:flex-end;">
            ...
            ></oj-c-input-date-picker>
        </div>`}if(r.dataType==="array"){if(m==="choice")return H(c,$s(r,d,St(e,r,u,n,i),!0));if(m==="listBox")return H(c,fr(r,d,St(e,r,u,n,i),!0));if(m==="combobox"||m==="select")return op(r,u,c,d,St(e,r,u,n,i));const p=St(e,r,u,n,i).map(f=>({value:f.value,label:f.label??""}));return o`<oj-c-checkboxset
            data-oj-binding-provider="preact"
            id="${u}"
            label-hint="${c}"
            label-edge="top"
            ...
            ?disabled="${r.disabled}"
            @valueChanged="${f=>V(f,u,f.detail.value)}"
        ></oj-c-checkboxset>`}if(r.dataType==="status"){const p=d,g={danger:"error",success:"success",warning:"warning",info:"info"}[(p?.type??"").toLowerCase()]??"info";return o`<div id="${u}">
            <div style="${It}">${c}</div>
            ${p?o`<oj-c-badge
                data-oj-binding-provider="preact"
                .value="${p.message}"
    ...
    `;ra([h()],vt.prototype,"field",2);ra([h()],vt.prototype,"state",2);ra([h()],vt.prototype,"data",2);ra([h()],vt.prototype,"appState",2);ra([h()],vt.prototype,"appData",2);ra([h()],vt.prototype,"selectedItems",2);ra([$()],vt.prototype,"detailsOpenedItems",2);vt=ra([k("mateu-grid")],vt);var Rp=Object.defineProperty,zp=Object.getOwnPropertyDescriptor,Va=(e,t,a,s)=>{for(var i=s>1?void 0:s?zp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Rp(t,a,i),i};let Jt=class extends S{constructor(){super(...arguments),this.getNewValue=e=>{if(this.field?.dataType=="array"){if(!this.value)return[e];const t=this.value;return t.indexOf(e)>=0?t.filter(a=>a!==e):[...t,e]}return e}}render(){let e=this.field?.options;if(this.field?.remoteCoordinates){const a=this.field.remoteCoordinates;this.data?.[this.field.fieldId]&&this.data[this.field.fieldId].content&&this.data[this.field.fieldId].totalElements?e=this.data[this.field.fieldId].content:this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a.action,parameters:{searchText:"",fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0}))}const t=this.field?.attributes?.divStyle;return o`
  ...
  `;Va([h()],Jt.prototype,"field",2);Va([h()],Jt.prototype,"baseUrl",2);Va([h()],Jt.prototype,"state",2);Va([h()],Jt.prototype,"data",2);Va([h()],Jt.prototype,"value",2);Jt=Va([k("mateu-choice")],Jt);var Ap=Object.defineProperty,Lp=Object.getOwnPropertyDescriptor,gt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Lp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ap(t,a,i),i};let Fe=class extends S{constructor(){super(...arguments),this.currencyChanged=e=>{this.value||(this.value={value:0,currency:"EUR",locale:"es-ES"}),this.value.currency=e.detail.value,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:{...this.value},fieldId:this.fieldId}}))},this.valueChanged=e=>{this.value||(this.value={value:0,currency:"EUR",locale:"es-ES"}),e.detail.value&&(this.value.value=e.detail.value?parseFloat(e.detail.value):0,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:{...this.value},fieldId:this.fieldId}})))}}render(){return o`
            <vaadin-number-field
                    id="${this.fieldId}"
                    label="${this.label}"
...
`;if(this.field?.stereotype=="listBox"){if(this.field?.remoteCoordinates){const i=this.field.remoteCoordinates,r="";return this.data[this.id]&&(this.data[this.id].searchSignature||r)&&this.data[this.id].searchSignature!=r&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements||this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:i.action,parameters:{searchText:r,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0})),o`
  ...
  `;je([h()],ve.prototype,"component",2);je([h()],ve.prototype,"field",2);je([h()],ve.prototype,"baseUrl",2);je([h()],ve.prototype,"state",2);je([h()],ve.prototype,"data",2);je([h()],ve.prototype,"appState",2);je([h()],ve.prototype,"appData",2);je([h()],ve.prototype,"labelAlreadyRendered",2);je([$()],ve.prototype,"colorPickerOpened",2);je([$()],ve.prototype,"colorPickerValue",2);je([$()],ve.prototype,"filteredIcons",2);je([$()],ve.prototype,"navLinkOffset",2);ve=je([k("mateu-field")],ve);var qt=(e=>(e.OnLoad="OnLoad",e.OnSuccess="OnSuccess",e.OnError="OnError",e.OnValueChange="OnValueChange",e.OnCustomEvent="OnCustomEvent",e.AutoSave="AutoSave",e))(qt||{}),Np=Object.defineProperty,ss=(e,t,a,s)=>{for(var i=void 0,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(t,a,i)||i);return i&&Np(t,a,i),i};class oa extends $i{constructor(){super(...arguments),this.state={},this.data={},this.appData={},this.appState={},this.triggerOnLoad=()=>{const t=this.component;this.registerCustomEventListeners(),t.triggers?.filter(a=>a.type==qt.OnLoad).forEach(a=>{if((!a.condition||this._evalExpr(a.condition))&&!a.triggered){const i=a;i.triggered=!0;var s=i.times-1;i.timeoutMillis>0?this.scheduleOnload(i,s,this.id):this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:i.actionId},bubbles:!0,composed:!0}))}})},this.scheduleOnload=(t,a,s)=>{if(s!=this.component?.id)return;const i=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,callbackToken:i},bubbles:!0,composed:!0}))},t.timeoutMillis)},this._registeredCustomEventListeners=[],this.customEventManager=t=>{if(!(t instanceof CustomEvent))return;const a=t,i=(this.component.triggers??[]).filter(r=>r.type==qt.OnCustomEvent).filter(r=>r.eventName==a.type).filter(r=>r.source!=="COMPONENT"||a.detail?.__source===r.from);i.length!==0&&(i.some(r=>!r.source||r.source==="SELF")&&(t.stopPropagation(),t.preventDefault()),i.forEach(r=>{(!r.condition||this._evalExpr(r.condition))&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.actionId,parameters:a.detail},bubbles:!0,composed:!0}))}))}}_interpolationExtra(){return{appState:this.appState??{},appData:this.appData??{},component:this.component}}_evalExpr(t){return zr(t,this.state??{},this.data??{},this._interpolationExtra())}_evalTemplate(t){return In(t,this.state??{},this.data??{},this._interpolationExtra())}applyFragment(t){if(this.id==t.targetComponentId){if(t.component)if(ci.Add==t.action)this.component&&this.component.children?.push(t.component);else{if(this.callbackToken=ke(),t.component?.type==oe.ServerSide)if(this.component){const s=this.component,i=t.component;s.actions=i.actions,s.type=i.type,s.rules=i.rules,s.triggers=i.triggers,s.serverSideType=i.serverSideType,s.route=i.route,s.initialData=i.initialData,s.validations=i.validations,s.cssClasses=i.cssClasses,s.slot=i.slot,s.style=i.style,s.children=i.children,(s.serverSideType!=i.serverSideType||s.id!=i.id)&&setTimeout(()=>this.triggerOnLoad())}else this.component=t.component,setTimeout(()=>this.triggerOnLoad());else{const s=[t.component];this.component&&(this.component.children=s)}t.action!==ci.ReplaceKeepData&&(this.state={},this.data={})}if(t.state&&(this.state={...this.state,...t.state}),t.data){for(const s in t.data){const i=t.data[s]?.page;i?.pageNumber>0&&this.data[s]&&this.data[s].page.content&&(i.content?i.content=[...this.data[s].page.content,...i.content]:i.content=[...this.data[s].page.content])}this.data={...this.data,...t.data}}this.registerCustomEventListeners();const a=Z.getAfterRenderHook();a&&setTimeout(()=>a(this)),this.requestUpdate()}}registerCustomEventListeners(){this._registeredCustomEventListeners.forEach(({target:a,name:s})=>a.removeEventListener(s,this.customEventManager)),this._registeredCustomEventListeners=[],this.component?.triggers?.filter(a=>a.type==qt.OnCustomEvent).forEach(a=>{const s=a.source==="DOCUMENT"||a.source==="COMPONENT"?document:this;s.addEventListener(a.eventName,this.customEventManager),this._registeredCustomEventListeners.push({target:s,name:a.eventName})})}disconnectedCallback(){this._registeredCustomEventListeners.forEach(({target:t,name:a})=>t.removeEventListener(a,this.customEventManager)),this._registeredCustomEventListeners=[],super.disconnectedCallback()}connectedCallback(){super.connectedCallback(),this.component&&this.registerCustomEventListeners()}}ss([h()],oa.prototype,"state");ss([h()],oa.prototype,"data");ss([h()],oa.prototype,"appData");ss([h()],oa.prototype,"appState");const xo="mateu-recent-routes",Fp=8;function wo(){try{return JSON.parse(localStorage.getItem(xo)??"{}")}catch{return{}}}function Mp(e){try{localStorage.setItem(xo,JSON.stringify(e))}catch{}}function gr(e){return wo()[e||"_"]??[]}function qp(e,t){if(!t?.route||!t.label)return;const a=e||"_",s=wo(),r=(s[a]??[]).filter(n=>n.route!==t.route);r.unshift({route:t.route,label:t.label}),s[a]=r.slice(0,Fp),Mp(s)}var Up=Object.defineProperty,Bp=Object.getOwnPropertyDescriptor,$t=(e,t,a,s)=>{for(var i=s>1?void 0:s?Bp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Up(t,a,i),i};let Me=class extends S{constructor(){super(...arguments),this.baseUrl="",this.open=!1,this.queryText="",this.dataHits=[],this.loading=!1,this.selectedIndex=0,this.fabOffset=0,this.keydownHandler=null}connectedCallback(){super.connectedCallback(),this.keydownHandler=e=>{(e.metaKey||e.ctrlKey)&&(e.key==="k"||e.key==="K")?(e.preventDefault(),this.toggle()):e.key==="Escape"&&this.open&&this.close()},document.addEventListener("keydown",this.keydownHandler),this.setupFabObserver()}disconnectedCallback(){super.disconnectedCallback(),this.keydownHandler&&document.removeEventListener("keydown",this.keydownHandler),clearTimeout(this.searchTimer),this.fabObserver?.disconnect(),this.fabObserver=void 0}setupFabObserver(){const e=this.getRootNode(),t=e instanceof ShadowRoot?e:document.body;this.measureFabStack(),this.fabObserver?.disconnect(),this.fabObserver=new MutationObserver(()=>this.measureFabStack()),this.fabObserver.observe(t,{childList:!0,subtree:!0})}measureFabStack(){const a=(this.getRootNode().querySelectorAll?.(".ai-fab, .app-fab, .page-fab").length??0)*4;a!==this.fabOffset&&(this.fabOffset=a)}updated(e){e.has("open")&&this.open&&requestAnimationFrame(()=>this.inputEl?.focus())}toggle(){this.open?this.close():this.openCenter()}openCenter(){this.open=!0,this.queryText="",this.dataHits=[],this.selectedIndex=0}close(){this.open=!1,this.queryText="",this.dataHits=[],clearTimeout(this.searchTimer)}flattenMenu(e,t){const a=[];for(const s of e??[])if(!s.separator)if(s.submenus&&s.submenus.length>0){const i=t?`${t} › ${s.label}`:s.label;a.push(...this.flattenMenu(s.submenus,i))}else s.route!==void 0&&s.route!==null&&a.push({label:s.label,breadcrumb:t,route:s.route});return a}onInput(e){this.queryText=e,this.selectedIndex=0;const t=e.trim();if(clearTimeout(this.searchTimer),!t||!this.app?.globalSearchEnabled){this.dataHits=[],this.loading=!1;return}this.loading=!0,this.searchTimer=setTimeout(()=>this.fetchGlobalSearch(t),250)}async fetchGlobalSearch(e){const t=this.app;if(!t?.globalSearchEnabled){this.loading=!1;return}try{const s=(await sa.runAction(this.baseUrl??"",t.rootRoute??"","","_globalsearch","command-center",void 0,t.serverSideType,{},{searchText:e},this,!0))?.fragments?.map(i=>i.data).find(i=>i&&i._globalsearch);this.dataHits=s?._globalsearch??[]}catch{this.dataHits=[]}finally{this.loading=!1}}navigateTo(e,t){qp(this.app?.serverSideType??"",{route:e,label:t}),this.close();for(const a of["route-changed","navigate-to-requested"])this.dispatchEvent(new CustomEvent(a,{detail:{route:e},bubbles:!0,composed:!0}))}askAi(){const e=this.queryText.trim();this.close(),this.dispatchEvent(new CustomEvent("mateu-open-ai",{detail:{query:e},bubbles:!0,composed:!0}))}visibleTargets(e){if(!this.queryText.trim()){const t=this.flattenMenu(this.app?.menu,"").map(s=>({route:s.route,label:s.label})),a=gr(this.app?.serverSideType??"");return[...t,...a]}return[...e.map(t=>({route:t.route,label:t.label})),...this.dataHits.map(t=>({route:t.route,label:t.label}))]}onKeydown(e,t){if(e.key==="ArrowDown")e.preventDefault(),this.selectedIndex=Math.min(this.selectedIndex+1,t.length-1);else if(e.key==="ArrowUp")e.preventDefault(),this.selectedIndex=Math.max(this.selectedIndex-1,0);else if(e.key==="Enter"){const a=t[this.selectedIndex];a&&this.navigateTo(a.route,a.label)}}render(){return o`
    ...
    `;$t([h({attribute:!1})],Me.prototype,"app",2);$t([h()],Me.prototype,"baseUrl",2);$t([$()],Me.prototype,"open",2);$t([$()],Me.prototype,"queryText",2);$t([$()],Me.prototype,"dataHits",2);$t([$()],Me.prototype,"loading",2);$t([$()],Me.prototype,"selectedIndex",2);$t([$()],Me.prototype,"fabOffset",2);$t([Be(".cc-input")],Me.prototype,"inputEl",2);Me=$t([k("mateu-command-center")],Me);let nt=null;function Vp(e){const t=e.component?.metadata;!!(t&&(t.commandCenterEnabled||t.chromeless)&&t.variant!=="MEDIATOR")?((!nt||!nt.isConnected)&&(nt=document.createElement("mateu-command-center"),e.renderRoot.appendChild(nt)),nt.app=t,nt.baseUrl=e.baseUrl??""):nt&&e.renderRoot.contains(nt)&&(nt.remove(),nt=null)}const Hp={lon:0,lat:0},$r=3,Wp=e=>{if(!e)return;const t=e.split(",").map(i=>i.trim());if(t.length!==2)return;const a=Number(t[0]),s=Number(t[1]);if(!(t[0]===""||t[1]===""||!Number.isFinite(a)||!Number.isFinite(s)))return{lon:s,lat:a}},Gp=e=>{if(e==null||e.trim()==="")return $r;const t=Number(e);return Number.isFinite(t)?t:$r};var Kp=Object.defineProperty,Yp=Object.getOwnPropertyDescriptor,rs=(e,t,a,s)=>{for(var i=s>1?void 0:s?Yp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Kp(t,a,i),i};let La=class extends S{constructor(){super(...arguments),this.renderSeq=0}updated(e){super.updated(e),this.createMap()}disconnectedCallback(){super.disconnectedCallback(),this.map?.setTarget(void 0),this.map=void 0}async createMap(){const e=++this.renderSeq,[{default:t},{default:a},{default:s},{default:i},{fromLonLat:r},{default:n}]=await Promise.all([Oe(()=>import("./vendor-ol.js").then(c=>c.M),[]),Oe(()=>import("./vendor-ol.js").then(c=>c.V),[]),Oe(()=>import("./vendor-ol.js").then(c=>c.T),[]),Oe(()=>import("./vendor-ol.js").then(c=>c.O),[]),Oe(()=>import("./vendor-ol.js").then(c=>c.p),[]),Oe(()=>import("./vendor-ol.js").then(c=>c.o),[])]);if(e!==this.renderSeq||!this.isConnected)return;if(!this.shadowRoot.querySelector("style[data-ol]")){const c=document.createElement("style");c.setAttribute("data-ol",""),c.textContent=n,this.shadowRoot.appendChild(c)}this.map&&(this.map.setTarget(void 0),this.map=void 0);const d=Wp(this.position)??Hp;this.map=new t({target:this.mapElement,layers:[new s({source:new i})],view:new a({center:r([d.lon,d.lat]),zoom:Gp(this.zoom)})})}render(){return o`<div id="map"></div>`}};La.styles=C`
        :host {
            display: block;
            width: 100%;
            height: 25rem;
    ...
    `;rs([h()],La.prototype,"position",2);rs([h()],La.prototype,"zoom",2);rs([Be("#map")],La.prototype,"mapElement",2);La=rs([k("mateu-map")],La);const Jp=typeof HTMLElement<"u"?HTMLElement:class{};class Xp extends Jp{static get observedAttributes(){return["content"]}#e;#t=0;get content(){return this.#e}set content(t){this.#e=t,this.#a()}attributeChangedCallback(t,a,s){this.content=s??void 0}connectedCallback(){this.style.display="block",this.#a()}async#a(){if(!this.isConnected)return;const t=this.#e??"",a=++this.#t,[{marked:s},{default:i}]=await Promise.all([Oe(()=>import("./vendor.js").then(r=>r.f),[]),Oe(()=>import("./vendor.js").then(r=>r.c),[])]);a===this.#t&&(this.innerHTML=i.sanitize(await s.parse(t),{USE_PROFILES:{html:!0,svg:!0,svgFilters:!0},CUSTOM_ELEMENT_HANDLING:{tagNameCheck:r=>!0}}))}}typeof customElements<"u"&&!customElements.get("mateu-markdown")&&customElements.define("mateu-markdown",Xp);var Qp=Object.defineProperty,Zp=Object.getOwnPropertyDescriptor,_a=(e,t,a,s)=>{for(var i=s>1?void 0:s?Zp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Qp(t,a,i),i};const eh=e=>{const t=[];return e.color&&e.color!=="normal"&&e.color!=="none"&&t.push(e.color),e.buttonStyle&&t.push(e.buttonStyle==="tertiaryInline"?"tertiary-inline":e.buttonStyle),e.size&&e.size!=="none"&&e.size!=="normal"&&t.push(e.size),t.length?t.join(" "):void 0},yr=e=>e==="back"||e==="backToList"||!!e&&e.startsWith("cancel");let Pt=class extends S{constructor(){super(...arguments),this.appState={},this.appData={},this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.evalLabel=e=>Re(e,this.state,this.data),this.renderBtn=e=>{if((this.data??{})[e.actionId+".hidden"])return l;const t=this.evalLabel(e.label),a=Z.get()?.renderToolbarButton?.(e,t,()=>this.handleButtonClick(e.actionId));return a||o`
        <vaadin-button
                data-action-id="${e.id}"
                theme="${eh(e)||l}"
    ...
    `},this.renderPeerNav=e=>{const t=Z.get()?.renderPeerNav?.(e);return t||o`
        ...
        ${Qt}
    `;_a([h()],Pt.prototype,"metadata",2);_a([h()],Pt.prototype,"baseUrl",2);_a([h()],Pt.prototype,"state",2);_a([h()],Pt.prototype,"data",2);_a([h()],Pt.prototype,"appState",2);_a([h()],Pt.prototype,"appData",2);Pt=_a([k("mateu-content-header")],Pt);var th=Object.defineProperty,ah=Object.getOwnPropertyDescriptor,yi=(e,t,a,s)=>{for(var i=s>1?void 0:s?ah(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&th(t,a,i),i};let fa=class extends $i{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={}}render(){const e=this.component?.metadata;return o`
  ...
  `;rt([h()],ze.prototype,"id",2);rt([h()],ze.prototype,"metadata",2);rt([h()],ze.prototype,"baseUrl",2);rt([h()],ze.prototype,"state",2);rt([h()],ze.prototype,"data",2);rt([h()],ze.prototype,"appState",2);rt([h()],ze.prototype,"appData",2);rt([h()],ze.prototype,"emptyStateMessage",2);rt([$()],ze.prototype,"detailsOpenedItems",2);rt([Be("vaadin-grid")],ze.prototype,"grid",2);ze=rt([k("mateu-table")],ze);const ko="mateu-saved-views",os=()=>{try{return JSON.parse(localStorage.getItem(ko)??"{}")}catch{return{}}},Ws=e=>{try{localStorage.setItem(ko,JSON.stringify(e))}catch{}},Vi=e=>os()[e]??[],Co=(e,t)=>{const a=t.name?.trim();if(!a||Object.keys(t.values??{}).length===0)return;const s=os(),i=(s[e]??[]).filter(r=>r.name!==a);i.push({...t,name:a}),s[e]=i,Ws(s)},So=(e,t)=>{const a=os(),s=(a[e]??[]).filter(i=>i.name!==t);s.length===0?delete a[e]:a[e]=s,Ws(a)},Io=(e,t)=>{const a=os();a[e]=(a[e]??[]).map(s=>({...s,isDefault:s.name===t?!s.isDefault:!1})),Ws(a)},_o=e=>Vi(e).find(t=>t.isDefault);var rh=Object.defineProperty,oh=Object.getOwnPropertyDescriptor,We=(e,t,a,s)=>{for(var i=s>1?void 0:s?oh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&rh(t,a,i),i};let Se=class extends S{constructor(){super(...arguments),this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.searchOnly=!1,this.panelOpened=!1,this.viewsOpened=!1,this.draftText="",this.openPanel=()=>{this.panelOpened||this.filters.length===0||(this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick))},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1,this.activeFilter=void 0},this.clearAllFilters=()=>{const e=this.filters.flatMap(a=>this.isRangeFilter(a)?[`${a.fieldId}_from`,`${a.fieldId}_to`]:[a.fieldId]),t={searchText:void 0};e.forEach(a=>{t[a]=void 0}),this.state={...this.state,...t},this.dispatchEvent(new CustomEvent("filter-reset-requested",{detail:{fieldIds:e},bubbles:!0,composed:!0})),this.requestSearch()},this.keepFocus=e=>e.preventDefault()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}get filters(){return this.metadata?.filters??[]}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}requestSearch(){this.closePanel(),this.dispatchEvent(new CustomEvent("search-requested",{detail:{},bubbles:!0,composed:!0}))}emitValueChanged(e,t){this.state={...this.state,[e]:t},this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t,fieldId:e},bubbles:!0,composed:!0}))}applyFilter(e,t){this.emitValueChanged(e,t),this.requestSearch()}removeChip(e){const t=this.filters.find(a=>a.fieldId===e);t&&this.isRangeFilter(t)?(this.emitValueChanged(`${e}_from`,void 0),this.emitValueChanged(`${e}_to`,void 0)):this.emitValueChanged(e,e==="searchText"?"":void 0),this.requestSearch()}commitText(e){this.emitValueChanged("searchText",e.value),this.draftText="",e.value="",this.requestSearch()}get viewsScope(){return window.location.pathname}allFilterKeys(){return["searchText",...this.filters.flatMap(e=>this.isRangeFilter(e)?[`${e.fieldId}_from`,`${e.fieldId}_to`]:[e.fieldId])]}snapshotValues(){const e={};return this.state.searchText&&(e.searchText=this.state.searchText),this.filters.forEach(t=>{if(this.isSet(t))if(this.isRangeFilter(t)){const a=this.rangeBound(t,"from"),s=this.rangeBound(t,"to");a&&(e[`${t.fieldId}_from`]=a),s&&(e[`${t.fieldId}_to`]=s)}else this.isMultiFilter(t)?e[t.fieldId]=this.multiValues(t):e[t.fieldId]=this.state[t.fieldId]}),e}applyView(e){const t=this.allFilterKeys(),a={};t.forEach(s=>{a[s]=void 0}),this.state={...this.state,...a},this.dispatchEvent(new CustomEvent("filter-reset-requested",{detail:{fieldIds:t},bubbles:!0,composed:!0})),Object.entries(e.values).forEach(([s,i])=>this.emitValueChanged(s,i)),this.viewsOpened=!1,this.detachOutsideClick(),this.requestSearch()}saveCurrentView(e){const t=e.value.trim();t&&(Co(this.viewsScope,{name:t,values:this.snapshotValues()}),e.value="",this.requestUpdate())}firstUpdated(){if(window.location.search)return;const e=_o(this.viewsScope);e&&setTimeout(()=>{this.state.searchText||this.filters.some(a=>this.isSet(a))||this.applyView(e)},0)}isBooleanFilter(e){return e.dataType==="boolean"||e.dataType==="bool"||e.stereotype==="checkbox"||e.stereotype==="toggle"}isNumericFilter(e){return["integer","decimal","number","money"].includes(e.dataType??"")}isRangeFilter(e){return e.stereotype==="dateRange"||e.stereotype==="numberRange"}isMultiFilter(e){return e.stereotype==="multiSelect"}hasOptions(e){return(e.options?.length??0)>0}multiValues(e){const t=this.state[e.fieldId];return Array.isArray(t)?t.map(String):typeof t=="string"&&t!==""?t.split(",").map(a=>a.trim()).filter(a=>a):[]}rangeBound(e,t){const a=this.state[`${e.fieldId}_${t}`];return a==null?"":String(a)}isSet(e){if(this.isRangeFilter(e))return this.rangeBound(e,"from")!==""||this.rangeBound(e,"to")!=="";if(this.isMultiFilter(e))return this.multiValues(e).length>0;const t=this.state[e.fieldId];return t!=null&&t!==""&&!Number.isNaN(t)}getFilterDisplayValue(e,t){if(e.options?.length){const a=e.options.find(s=>s.value===String(t));if(a)return a.label??a.value}return typeof t=="boolean"?t?"Yes":"No":String(t)}conditionDisplay(e){if(this.isRangeFilter(e)){const t=this.rangeBound(e,"from"),a=this.rangeBound(e,"to");return t&&a?`${t} – ${a}`:t?`≥ ${t}`:`≤ ${a}`}return this.isMultiFilter(e)?this.multiValues(e).map(t=>this.getFilterDisplayValue(e,t)).join(", "):this.getFilterDisplayValue(e,this.state[e.fieldId])}labelOf(e){return Re(e.label,this.state,this.data)||e.fieldId}panelRow(e,t,a="panel-row"){return o`
    ...
    `;We([h()],Se.prototype,"metadata",2);We([h()],Se.prototype,"baseUrl",2);We([$()],Se.prototype,"state",2);We([$()],Se.prototype,"data",2);We([h()],Se.prototype,"appState",2);We([h()],Se.prototype,"appData",2);We([h({type:Boolean})],Se.prototype,"searchOnly",2);We([$()],Se.prototype,"panelOpened",2);We([$()],Se.prototype,"viewsOpened",2);We([$()],Se.prototype,"activeFilter",2);We([$()],Se.prototype,"draftText",2);Se=We([k("mateu-filter-bar")],Se);const Eo="mateu-column-prefs",Gs=()=>{try{const e=JSON.parse(localStorage.getItem(Eo)??"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}},To=e=>{try{localStorage.setItem(Eo,JSON.stringify(e))}catch{}},Ks=e=>{if(!e||typeof e!="object")return;const t=a=>Array.isArray(a)?a.filter(s=>typeof s=="string"):[];return{hidden:t(e.hidden),order:t(e.order)}},Po=e=>Ks(Gs()[e]),nh=(e,t)=>{const a=Gs(),s=Ks(t);s.hidden.length===0&&s.order.length===0?delete a[e]:a[e]=s,To(a)},lh=e=>{const t=Gs();delete t[e],To(t)},Oo=e=>e?!!e.identifier||e.dataType==="action"||e.dataType==="actionGroup"||e.dataType==="menu"||e.id==="select"||e.id==="menu":!1,Ro=(e,t,a=s=>s)=>{const s=Ks(t);if(!s||s.hidden.length===0&&s.order.length===0)return e;const i=p=>a(p)?.id??p.id,r=new Set(s.hidden),n=e.filter(p=>{const f=i(p);return!f||!r.has(f)||Oo(a(p))});if(s.order.length===0)return n.length===e.length?e:n;const d=new Map;n.forEach(p=>{const f=i(p);f&&!d.has(f)&&d.set(f,p)});const c=[],u=new Set;return s.order.forEach(p=>{const f=d.get(p);f&&!u.has(f)&&(c.push(f),u.add(f))}),n.forEach(p=>{u.has(p)||(c.push(p),u.add(p))}),c.length===e.length&&c.every((p,f)=>p===e[f])?e:c};var dh=Object.defineProperty,ch=Object.getOwnPropertyDescriptor,xi=(e,t,a,s)=>{for(var i=s>1?void 0:s?ch(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&dh(t,a,i),i};let ba=class extends S{constructor(){super(...arguments),this.columns=[],this.scope="",this.panelOpened=!1,this.revision=0,this.togglePanel=()=>{if(this.panelOpened){this.closePanel();return}this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick)},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1},this.reset=()=>{lh(this.scope),this.revision++,this.dispatchEvent(new CustomEvent("column-prefs-changed",{bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}get prefs(){return Po(this.scope)??{hidden:[],order:[]}}effectiveEntries(e){return Ro(this.columns,{hidden:[],order:e.order})}commit(e){nh(this.scope,e),this.revision++,this.dispatchEvent(new CustomEvent("column-prefs-changed",{bubbles:!0,composed:!0}))}toggleVisibility(e){const t=this.prefs,a=t.hidden.includes(e)?t.hidden.filter(s=>s!==e):[...t.hidden,e];this.commit({...t,hidden:a})}move(e,t){const a=this.prefs,s=[...this.effectiveEntries(a)],i=s.findIndex(d=>d.id===e);if(i<0)return;let r=i+t;for(;r>=0&&r<s.length&&s[r].protected;)r+=t;if(r<0||r>=s.length)return;const n=s[i];s[i]=s[r],s[r]=n,this.commit({...a,order:s.map(d=>d.id)})}render(){this.revision;const e=this.prefs,t=this.effectiveEntries(e).filter(s=>!s.protected);if(t.length===0)return o``;const a=e.hidden.length>0||e.order.length>0;return o`
            <div class="chooser">
                <button
    ...
    `;xi([h()],ba.prototype,"columns",2);xi([h()],ba.prototype,"scope",2);xi([$()],ba.prototype,"panelOpened",2);xi([$()],ba.prototype,"revision",2);ba=xi([k("mateu-column-chooser")],ba);var uh=Object.defineProperty,ph=Object.getOwnPropertyDescriptor,wi=(e,t,a,s)=>{for(var i=s>1?void 0:s?ph(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&uh(t,a,i),i};let ga=class extends S{constructor(){super(...arguments),this.totalElements=0,this.pageSize=100,this.pageNumber=0,this.totalPages=0}updated(e){super.updated(e),(e.has("totalElements")||e.has("pageSize"))&&(this.totalPages=Math.ceil(this.totalElements/this.pageSize))}dispatch(e){this.dispatchEvent(new CustomEvent("page-changed",{bubbles:!0,composed:!0,detail:{page:e}}))}render(){if(!this.totalElements)return l;const e=this.totalPages>1,t=this.pageNumber,a=t===0,s=t>=this.totalPages-1;return o`
        ...
        `}get cols(){return this.effectiveComponent?.metadata?.columns?.map(t=>t.metadata)??[]}get identifierFieldName(){const e=this.cols.find(t=>t.identifier);return e?e.id:this.cols.find(t=>t.id==="id")?.id}get effectiveGridLayout(){const e=this.component?.metadata,t=e?.gridLayout??"auto";return t==="auto"?e?.crudlType==="card"?"cards":lo(this.cols,this.availableWidthPx):t}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{const t=e[0]?.contentRect.width;t&&Math.abs(t-this.availableWidthPx)>10&&(this.availableWidthPx=t)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}_filterIds(e){return new Set(["searchText",...(e.filters??[]).flatMap(t=>t.stereotype==="dateRange"||t.stereotype==="numberRange"?[`${t.fieldId}_from`,`${t.fieldId}_to`]:[t.fieldId])])}_syncStateToUrl(e){const t=this._filterIds(e),a=new URLSearchParams(window.location.search);t.forEach(d=>a.delete(d)),a.delete("page"),a.delete("sort"),t.forEach(d=>{const c=this.state[d];c!=null&&c!==""&&a.set(d,String(c))});const s=this.state.page;s&&s>0&&a.set("page",String(s));const i=this.state.sort;if(i&&i.length>0){const d=i.filter(c=>c.fieldId&&c.direction).map(c=>`${c.fieldId}:${c.direction}`).join(",");d&&a.set("sort",d)}const r=a.toString(),n=r?`${window.location.pathname}?${r}`:window.location.pathname;window.location.pathname+window.location.search!==n&&history.replaceState(null,"",n)}_initStateFromUrl(e,t){const a=new URLSearchParams(window.location.search),s=this._filterIds(e),i={...t};a.forEach((d,c)=>{s.has(c)&&(i[c]=d)});const r=a.get("page");if(r!==null){const d=parseInt(r,10);!isNaN(d)&&d>0&&(i.page=d)}const n=a.get("sort");if(n){const d=n.split(",").map(c=>{const[u,m]=c.split(":");return u&&m?{fieldId:u,direction:m}:null}).filter(Boolean);d.length>0&&(i.sort=d)}return i}pageChanged(e){this.state={...this.state,page:e.detail.page},this.handleSearchRequested(void 0)}updated(e){if(super.updated(e),e.has("component")){const t=this.component?.id;if(t!==this._initializedForComponentId){this._initializedForComponentId=t;const a=this.component?.metadata,s=a.initialPage&&a.initialPage>0?a.initialPage:0;this.state=this._initStateFromUrl(a,{...this.state,size:a.pageSize,page:s,sort:[]}),(this.state.page!==s||this.state.sort?.length>0||[...this._filterIds(a)].some(r=>this.state[r]!=null))&&this.handleSearchRequested(void 0)}}}render(){const e=I=>{const j=[];return I.color&&I.color!==zo.normal&&j.push(I.color),I.buttonStyle&&j.push(I.buttonStyle===Ao.tertiaryInline?"tertiary-inline":I.buttonStyle),j.length?j.join(" "):void 0},t=I=>I==="back"||I==="backToList"||!!I&&I.startsWith("cancel"),a=I=>{const j=Z.get()?.renderToolbarButton?.(I,this.evalLabel(I.label),()=>this.handleToolbarButtonClick(I.actionId));return j||o`
            ...
            `};if(!this.component)return o`no component`;const s=this.effectiveComponent,i=s.metadata;i.serverSideOrdering=!0;const r=i?.toolbar??[],n=r.filter(I=>t(I.actionId)),d=r.filter(I=>!t(I.actionId)),c=n.length>0&&d.length>0,u=!!i?.title||!!i?.subtitle||r.length>0,m=this.effectiveGridLayout,p=this.cols,f=Ui(p),y=this.data[this.id]?.page?.content??[],x=this.state[this.component?.id]?.emptyStateMessage,T=(I,j)=>{const O=j[I.id];if(O==null)return o``;if(I.dataType==="status"){const D=Ji(O.type);return o`<span theme="badge pill ${D}">${O.message}</span>`}return I.dataType==="bool"?o`${O?"✓":"✗"}`:typeof O=="object"?o`${O.label??O.name??O.message??""}`:o`${O}`},U=()=>{const I=this.identifierFieldName,j=this.state._selectedId??this.appState?._splitDetailId,O=f.find(R=>R.identifier)??f[0],D=R=>R.dataType==="action"||R.dataType==="actionGroup"||R.dataType==="menu"||R.stereotype==="button",Ne=f.filter(R=>R!==O&&!D(R)),Te=p.filter(R=>D(R)),ot=(R,re,pe)=>{R.stopPropagation(),R.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:re,parameters:{_clickedRow:pe}},bubbles:!0,composed:!0}))},wt=R=>{const re=[];for(const pe of Te){const N=R[pe.id];if(pe.dataType==="action"){const A=N?.methodNameInCrud?N:R.action?.methodNameInCrud?R.action:{methodNameInCrud:pe.id,label:pe.label,icon:null};re.push(o`
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: var(--lumo-space-m); padding: var(--lumo-space-s) 0;">
                    ...
                    `)}
                </div>`},ne=()=>{const I=zu(p),j=I.find(D=>D.identifier)??I[0],O=I.filter(D=>D!==j);return o`
    ...
    `;Ke([h()],_e.prototype,"component",2);Ke([h()],_e.prototype,"baseUrl",2);Ke([h({type:Boolean})],_e.prototype,"standalone",2);Ke([h()],_e.prototype,"state",2);Ke([h()],_e.prototype,"data",2);Ke([h()],_e.prototype,"appState",2);Ke([h()],_e.prototype,"appData",2);Ke([$()],_e.prototype,"showImportDialog",2);Ke([$()],_e.prototype,"availableWidthPx",2);Ke([$()],_e.prototype,"selectedItem",2);Ke([$()],_e.prototype,"_columnPrefsRevision",2);_e=Ke([k("mateu-table-crud")],_e);var gh=Object.defineProperty,$h=Object.getOwnPropertyDescriptor,ns=(e,t,a,s)=>{for(var i=s>1?void 0:s?$h(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&gh(t,a,i),i};let ja=class extends S{constructor(){super(...arguments),this.notificationOpened=!1,this.fetchStarted=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!0},this.fetchFinished=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1},this.fetchFailed=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1,this.error=e.detail.reason,this.openNotification()},this.openNotification=()=>{this.notificationOpened=!0},this.closeNotification=()=>{this.notificationOpened=!1},this.notificationRenderer=()=>o`
    <vaadin-horizontal-layout theme="spacing" style="align-items: center;">
  ...
  `;ls([$()],Qe.prototype,"opened",2);ls([$()],Qe.prototype,"maximizeSteps",2);ls([$()],Qe.prototype,"collapsed",2);Qe=ls([k("mateu-drawer")],Qe);var Eh=Object.defineProperty,Th=Object.getOwnPropertyDescriptor,Ee=(e,t,a,s)=>{for(var i=s>1?void 0:s?Th(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Eh(t,a,i),i};function xr(e){if(e.parentElement)return e.parentElement;const t=e.getRootNode();return t instanceof ShadowRoot?t.host:null}let ce=class extends S{constructor(){super(...arguments),this.appState={},this.appData={},this.standalone=!1,this.actionBanners=[],this.dismissedStaticBannerIndices=new Set,this._tocEntries=[],this._activeToc=0,this._tocVisible=!1,this._tocRebuildScheduled=!1,this._headerH=0,this._onResize=()=>this._layoutStickyTops(),this._tocLocked=!1,this._unlockToc=e=>{if(e&&e.type==="keydown"){const t=e;if(t.ctrlKey&&t.altKey&&!t.shiftKey&&!t.metaKey&&/^(?:Digit|Numpad)[1-9]$/.test(t.code))return}this._tocLocked=!1},this._actionBannerTimers=[],this._staticBannerTimers=[],this._bannersHandler=e=>{const t=e.detail,a=t.banners??[],s=t.append??!1;s?this.actionBanners=[...this.actionBanners,...a]:(this._clearActionBannerTimers(),this.actionBanners=a);const i=s?this.actionBanners.length-a.length:0;a.forEach((r,n)=>{if(r.timeoutSeconds&&r.timeoutSeconds>0){const d=i+n;this._actionBannerTimers.push(setTimeout(()=>{this.actionBanners=this.actionBanners.filter((c,u)=>u!==d)},r.timeoutSeconds*1e3))}})},this._onTocKey=e=>{if(!this._tocVisible||!e.ctrlKey||!e.altKey||e.shiftKey||e.metaKey)return;const t=/^(?:Digit|Numpad)([1-9])$/.exec(e.code);if(!t)return;const a=parseInt(t[1],10)-1;a>=this._tocEntries.length||(e.preventDefault(),this._scrollToSection(a))},this._onScrollSpy=()=>{if(this._tocLocked)return;const e=this._sectionCards();if(!e.length)return;const t=12,a=this.shadowRoot?.querySelector("mateu-content-header");let s=a?a.getBoundingClientRect().bottom:0;for(const n of e){if(!n.classList.contains("mateu-section--sticky"))continue;const d=n.getBoundingClientRect();d.top<=s+t+2&&(s=Math.max(s,d.bottom))}const i=s+t+4;let r=0;this._tocEntries.forEach((n,d)=>{n.el.getBoundingClientRect().top<=i&&(r=d)}),this._activeToc=r}}connectedCallback(){super.connectedCallback(),document.addEventListener("page-banners-received",this._bannersHandler),window.addEventListener("resize",this._onResize),document.addEventListener("keydown",this._onTocKey)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("page-banners-received",this._bannersHandler),window.removeEventListener("resize",this._onResize),document.removeEventListener("keydown",this._onTocKey),this._clearAllTimers(),this._teardownScrollSpy()}updated(e){super.updated(e),e.has("component")&&e.get("component")!==void 0&&(this._clearAllTimers(),this.actionBanners=[],this.dismissedStaticBannerIndices=new Set),e.has("component")&&(this._scheduleStaticBannerTimeouts(),this.dispatchEvent(new CustomEvent("compact-changed",{detail:{compact:!!this.component?.style?.includes("--mateu-compact:1")},bubbles:!0,composed:!0})),this._scheduleTocRebuild())}_scheduleStaticBannerTimeouts(){this._staticBannerTimers.forEach(a=>clearTimeout(a)),this._staticBannerTimers=[],(this.component?.metadata?.banners??[]).forEach((a,s)=>{a.timeoutSeconds&&a.timeoutSeconds>0&&this._staticBannerTimers.push(setTimeout(()=>{this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,s])},a.timeoutSeconds*1e3))})}_clearActionBannerTimers(){this._actionBannerTimers.forEach(e=>clearTimeout(e)),this._actionBannerTimers=[]}_clearAllTimers(){this._clearActionBannerTimers(),this._staticBannerTimers.forEach(e=>clearTimeout(e)),this._staticBannerTimers=[]}_dismissActionBanner(e){this.actionBanners=this.actionBanners.filter((t,a)=>a!==e)}_dismissStaticBanner(e){this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,e])}bannerThemeClass(e){const t=e.theme?.toLowerCase()??"info";return t==="none"?"":t}_evalBannerText(e){return Re(e,this.state,this.data)}_renderBanner(e,t){const a=this._evalBannerText(e.title),s=this._evalBannerText(e.description);return o`
    ...
    `;Ee([h()],ce.prototype,"component",2);Ee([h()],ce.prototype,"baseUrl",2);Ee([h()],ce.prototype,"state",2);Ee([h()],ce.prototype,"data",2);Ee([h()],ce.prototype,"appState",2);Ee([h()],ce.prototype,"appData",2);Ee([h()],ce.prototype,"value",2);Ee([h({type:Boolean})],ce.prototype,"standalone",2);Ee([$()],ce.prototype,"actionBanners",2);Ee([$()],ce.prototype,"dismissedStaticBannerIndices",2);Ee([$()],ce.prototype,"_tocEntries",2);Ee([$()],ce.prototype,"_activeToc",2);Ee([$()],ce.prototype,"_tocVisible",2);ce=Ee([k("mateu-page")],ce);const ds=C`
    .nbtn {
        display: inline-flex;
        align-items: center;
        gap: .35em;
...
`,ne=!0)}ne&&this.updateMessage(r,n)}n||this.updateMessage(r,"⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).")}catch(d){console.error("Error en el flujo SSE:",d);const c=d?.message??String(d);(c==="Failed to fetch"||c==="network error"||c==="Load failed")&&!n?this.updateMessage(r,"⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible."):this.updateMessage(r,"⚠️ Error: "+c)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value="")},250),this.messageInputElement?.removeAttribute("disabled"),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent("close-requested",{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{const e=this.messageInputElement?.value?.trim()??"";e&&this.send(new CustomEvent("submit",{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key==="Enter"&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback(),this.probeLocalAgent();const e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){const t=new e;this.recognition=t,t.lang="es-ES",t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=a=>{console.error("Error de reconocimiento: "+a.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:"smooth"})},0)}addMessage(e,t){const a={text:e,time:new Date().toLocaleTimeString(),userName:t.includes("agent")?"Asistente":"Tú",userColorIndex:t.includes("agent")?2:1};return this.items=[...this.items,a],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((a,s)=>s===e?{...a,text:t}:a),this.scrollBottom()}tryParseCustomEvent(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if(typeof a.event=="string")return{event:a.event,detail:a.detail??{}}}catch{}return null}tryParseTokenUsage(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if("inputTokens"in a||"outputTokens"in a||"totalTokens"in a)return a}catch{}return null}buildMenuContext(e,t=[]){const a=[];for(const s of e){if(s.separator||s.remote)continue;const i=[...t,s.label];if(s.submenus&&s.submenus.length>0)a.push(...this.buildMenuContext(s.submenus,i));else{const r={path:i,navigation:{route:s.route,consumedRoute:s.consumedRoute,actionId:s.actionId??"",baseUrl:s.baseUrl,serverSideType:s.serverSideType,uriPrefix:s.uriPrefix}};s.description&&(r.description=s.description),a.push(r)}}return a}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return o`
                    ...
                    <div class="message-list" role="list">
                        ${this.items.map(e=>o`
                            <div class="message" role="listitem">
                                <div class="avatar" style="background: ${Lh(e.userColorIndex)};">${jh(e.userName)}</div>
    ...
    `];Q([h({attribute:!1})],G.prototype,"contextProvider",2);Q([h()],G.prototype,"localAgentUrl",2);Q([h({attribute:!1})],G.prototype,"mcpUrl",2);Q([$()],G.prototype,"localAgentAlive",2);Q([h()],G.prototype,"sseUrl",2);Q([h()],G.prototype,"uploadUrl",2);Q([h({attribute:!1})],G.prototype,"menu",2);Q([$()],G.prototype,"attachments",2);Q([$()],G.prototype,"uploading",2);Q([Be(".file-input")],G.prototype,"fileInputElement",2);Q([h({type:Boolean,reflect:!0})],G.prototype,"expanded",2);Q([h()],G.prototype,"items",2);Q([Be(".scroll-container")],G.prototype,"scrollContainer",2);Q([Be(".msg-input")],G.prototype,"messageInputElement",2);Q([$()],G.prototype,"recognition",2);Q([$()],G.prototype,"listening",2);Q([$()],G.prototype,"recognitionAvailable",2);Q([$()],G.prototype,"loading",2);Q([$()],G.prototype,"elapsedSeconds",2);Q([$()],G.prototype,"tokenUsage",2);G=Q([k("mateu-chat")],G);var Dh=Object.defineProperty,Nh=Object.getOwnPropertyDescriptor,ki=(e,t,a,s)=>{for(var i=s>1?void 0:s?Nh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Dh(t,a,i),i};let $a=class extends S{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.data&&this.createChart(this.data)}async createChart(e){const[{default:t}]=await Promise.all([Oe(()=>import("./vendor-chartjs.js").then(s=>s.a),[]),Oe(()=>import("./vendor-chartjs.js").then(s=>s.c),[])]);if(e!==this.data)return;this.chart&&this.chart.destroy();const a={type:this.type,data:this.data,options:this.options};this.chart=new t(this.chartElement,a)}handleSlotChange(){}render(){return o`
            <div class="container">
       ...
       `}};$a.styles=C`
  `;ki([h()],$a.prototype,"type",2);ki([h()],$a.prototype,"data",2);ki([h()],$a.prototype,"options",2);ki([Be("#chart")],$a.prototype,"chartElement",2);$a=ki([k("mateu-chart")],$a);var Fh=Object.defineProperty,Mh=Object.getOwnPropertyDescriptor,Qs=(e,t,a,s)=>{for(var i=s>1?void 0:s?Mh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Fh(t,a,i),i};let ui=class extends S{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){const{default:t}=await Oe(async()=>{const{default:s}=await import("./vendor-diagrams.js").then(i=>i.i);return{default:s}},__vite__mapDeps([5,3,1,2,4]));if(e!==this.xml)return;this.chart&&this.chart.destroy();const a={container:this.divElement};this.chart=new t(a),this.chart.importXML(e)}handleSlotChange(){}render(){return o`
  ...
  `;Qs([h()],ui.prototype,"xml",2);Qs([Be("#canvas")],ui.prototype,"divElement",2);ui=Qs([k("mateu-bpmn")],ui);var qh=Object.defineProperty,Uh=Object.getOwnPropertyDescriptor,Wa=(e,t,a,s)=>{for(var i=s>1?void 0:s?Uh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&qh(t,a,i),i};const ys=160,lt=56,Bh=220,kr=110,Ft=60,Vh={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},Hh={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},Wh=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];function Gh(){return"step-"+Math.random().toString(36).slice(2,8)}let Xt=class extends S{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.wf={name:"New Workflow",steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value")){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){const e=this.wf.steps??[],t={};e.forEach(n=>{t[n.id]=0});let a=!0;for(;a;)a=!1,e.forEach(n=>{if(n.preconditionStepId!=null&&t[n.preconditionStepId]!==void 0){const d=t[n.preconditionStepId]+1;d>t[n.id]&&(t[n.id]=d,a=!0)}});const s={};e.forEach(n=>{const d=t[n.id]??0;(s[d]??=[]).push(n.id)});const i={...this.positions};let r=!1;Object.entries(s).forEach(([n,d])=>{const c=Number(n);d.forEach((u,m)=>{i[u]||(i[u]={x:Ft+c*Bh,y:Ft+m*kr},r=!0)})}),r&&(this.positions=i)}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addStep(){const e=Gh(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(i=>i.y),s=a.length?Math.max(...a)+kr:Ft;this.positions={...this.positions,[e]:{x:Ft,y:s}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(s=>s.id!==e).map(s=>s.preconditionStepId===e?{...s,preconditionStepId:void 0}:s)};const{[e]:t,...a}=this.positions;this.positions=a,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},s=this.toSvgPoint(e);this.dragOffset={x:s.x-a.x,y:s.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(s=>s.x))+ys+Ft:600,a=e.length?Math.max(...e.map(s=>s.y))+lt+Ft:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
        ...
        `}renderNode(e){const t=this.positions[e.id]??{x:Ft,y:Ft},a=Vh[e.type]??"#64748b",s=Hh[e.type]??"•",i=this.selectedId===e.id;return X`
                ...
                <div class="prop-body">
                    ...
                    ${a("Type",o`
                        <select class="inp" @change="${s=>this.updateStep(e.id,{type:s.target.value})}">
                            ${Wh.map(s=>o`<option value="${s}" ?selected="${e.type===s}">${s}</option>`)}
                        </select>`)}
    ...
    `];Wa([h()],Xt.prototype,"value",2);Wa([$()],Xt.prototype,"wf",2);Wa([$()],Xt.prototype,"positions",2);Wa([$()],Xt.prototype,"selectedId",2);Wa([$()],Xt.prototype,"showMeta",2);Xt=Wa([k("mateu-workflow")],Xt);var Kh=Object.defineProperty,Yh=Object.getOwnPropertyDescriptor,zt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Yh(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Kh(t,a,i),i};const Xa=160,Je=56,Mt=60,Jh={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},Xh={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},Qh=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];let xs;const Zh=()=>(xs||(xs=Oe(()=>import("./vendor-diagrams.js").then(e=>e.e),__vite__mapDeps([5,3,1,2,4])).then(e=>new e.default)),xs);function em(){return"step-"+Math.random().toString(36).slice(2,8)}let at=class extends S{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.readOnly=!1,this.wf={name:"New Workflow",steps:[]},this.positions={},this.layoutReady=!1,this.selectedId=null,this.showMeta=!1,this.layoutError=null,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.elkPositioned=new Set,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.elkPositioned.add(this.draggingId),this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value"))try{const t=JSON.parse(this.value),a=new Set((this.wf.steps??[]).map(r=>r.id)),s=new Set((t.steps??[]).map(r=>r.id)),i=a.size!==s.size||[...s].some(r=>!a.has(r))||[...s].some(r=>{const n=(this.wf.steps??[]).find(c=>c.id===r),d=(t.steps??[]).find(c=>c.id===r);return n?.preconditionStepId!==d?.preconditionStepId});this.wf=t,(i||!this.layoutReady)&&this.runElkLayout()}catch{}}async runElkLayout(){const e=this.wf.steps??[];if(e.length===0){this.positions={},this.layoutReady=!0;return}const t={id:"root",layoutOptions:{"elk.algorithm":"layered","elk.direction":"RIGHT","elk.spacing.nodeNode":"40","elk.layered.spacing.nodeNodeBetweenLayers":"80","elk.edgeRouting":"ORTHOGONAL","elk.layered.nodePlacement.strategy":"BRANDES_KOEPF"},children:e.map(a=>({id:a.id,width:Xa,height:Je})),edges:e.filter(a=>a.preconditionStepId).map(a=>({id:`${a.preconditionStepId}->${a.id}`,sources:[a.preconditionStepId],targets:[a.id]}))};try{const s=await(await Zh()).layout(t),i={...this.positions};for(const r of s.children??[])(!this.elkPositioned.has(r.id)||!i[r.id])&&(i[r.id]={x:(r.x??0)+Mt,y:(r.y??0)+Mt},this.elkPositioned.add(r.id));this.positions=i,this.layoutReady=!0,this.layoutError=null}catch(a){this.layoutError=a?.message??"ELK layout failed",this.layoutReady=!0}}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){const a=this.wf.steps.map(r=>r.id===e?{...r,...t}:r),s=this.wf.steps.find(r=>r.id===e),i=t.preconditionStepId!==void 0&&t.preconditionStepId!==s?.preconditionStepId;this.wf={...this.wf,steps:a},i&&(this.elkPositioned.clear(),this.runElkLayout()),this.emit()}addStep(){const e=em(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(s=>s.x);this.positions={...this.positions,[e]:{x:a.length?Math.max(...a)+Xa+80:Mt,y:Mt}},this.selectedId=e,this.elkPositioned.clear(),this.runElkLayout(),this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(s=>s.id!==e).map(s=>s.preconditionStepId===e?{...s,preconditionStepId:void 0}:s)};const{[e]:t,...a}=this.positions;this.positions=a,this.elkPositioned.delete(e),this.selectedId===e&&(this.selectedId=null),this.runElkLayout(),this.emit()}onNodeMouseDown(e,t){if(this.readOnly)return;e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},s=this.toSvgPoint(e);this.dragOffset={x:s.x-a.x,y:s.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}relayout(){this.elkPositioned.clear(),this.runElkLayout()}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(s=>s.x))+Xa+Mt:600,a=e.length?Math.max(...e.map(s=>s.y))+Je+Mt:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){if(!this.layoutReady)return o`<div class="loading">Computing layout…</div>`;const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return X``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return X``;const s=t.x+Xa,i=t.y+Je/2,r=a.x,n=a.y+Je/2,d=(s+r)/2;return X`
            <path d="M${s},${i} C${d},${i} ${d},${n} ${r},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:Mt,y:Mt},a=Jh[e.type]??"#64748b",s=Xh[e.type]??"•",i=this.selectedId===e.id,r=e.name.length>16?e.name.slice(0,15)+"…":e.name;return X`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
    ...
    `];zt([h()],at.prototype,"value",2);zt([h({type:Boolean})],at.prototype,"readOnly",2);zt([$()],at.prototype,"wf",2);zt([$()],at.prototype,"positions",2);zt([$()],at.prototype,"layoutReady",2);zt([$()],at.prototype,"selectedId",2);zt([$()],at.prototype,"showMeta",2);zt([$()],at.prototype,"layoutError",2);at=zt([k("mateu-workflow-elk")],at);var tm=Object.defineProperty,am=Object.getOwnPropertyDescriptor,Ci=(e,t,a,s)=>{for(var i=s>1?void 0:s?am(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&tm(t,a,i),i};const im=["string","integer","number","bool","date","time","dateTime","dateRange","money","file","array","status","component","menu","range","action","actionGroup"],sm=["regular","radio","checkbox","textarea","toggle","combobox","select","email","password","richText","listBox","html","markdown","image","icon","link","money","grid","color","choice","popover","slider","button","stars"],rm={string:"#3B82F6",integer:"#8B5CF6",number:"#6366F1",bool:"#10B981",date:"#F59E0B",time:"#F59E0B",dateTime:"#F59E0B",dateRange:"#F59E0B",money:"#EF4444",file:"#64748B",array:"#0EA5E9",status:"#EC4899",component:"#14B8A6",menu:"#94A3B8",range:"#A855F7",action:"#F97316",actionGroup:"#FB923C"};function Cr(){return"field-"+Math.random().toString(36).slice(2,8)}let ya=class extends S{constructor(){super(...arguments),this.value='{"name":"New Form","fields":[]}',this.form={name:"New Form",fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has("value"))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){const e=this.shadowRoot?.querySelector(".field-list");!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=an.create(e,{animation:150,handle:".drag-handle",ghostClass:"sortable-ghost",onEnd:t=>{const{oldIndex:a,newIndex:s}=t;if(a===void 0||s===void 0||a===s)return;const i=[...this.form.fields],[r]=i.splice(a,1);i.splice(s,0,r),this.form={...this.form,fields:i},this.emit()}}))}emit(){const e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addField(){const e=Cr(),t={id:e,label:"New Field",dataType:"string"};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){const t=this.form.fields.find(r=>r.id===e);if(!t)return;const a={...t,id:Cr(),label:t.label+" (copy)"},s=this.form.fields.findIndex(r=>r.id===e),i=[...this.form.fields];i.splice(s+1,0,a),this.form={...this.form,fields:i},this.selectedId=a.id,this.emit()}render(){return o`
        ...
        `}renderRow(e){const t=rm[e.dataType]??"#64748b",a=this.selectedId===e.id;return o`
        ...
        textarea.inp { resize: vertical; }
        input[readonly].inp { background: #f8fafc; color: #94a3b8; }
    `];Ci([h()],ya.prototype,"value",2);Ci([$()],ya.prototype,"form",2);Ci([$()],ya.prototype,"selectedId",2);Ci([$()],ya.prototype,"showMeta",2);ya=Ci([k("mateu-form-editor")],ya);var om=Object.defineProperty,nm=Object.getOwnPropertyDescriptor,xt=(e,t,a,s)=>{for(var i=s>1?void 0:s?nm(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&om(t,a,i),i};let Ue=class extends S{constructor(){super(...arguments),this.appState={},this.appData={},this.open=!1,this.activeTab="appstate",this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null,this._prevTarget=null,this._onMouseover=e=>{let t=e.target;for(;t&&!(t.tagName?.toLowerCase().startsWith("mateu-")&&t!==this);)t=t.parentElement;if(t===this||t===null){t===null&&this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset="",this._prevTarget=null,this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null);return}t!==this._prevTarget&&(this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset=""),this._prevTarget=t,t.style.outline="2px solid #0070f3",t.style.outlineOffset="-2px",this.hoveredTag=t.tagName.toLowerCase(),this.hoveredId=t.id||"",this.hoveredState=t.state,this.hoveredData=t.data,this.hoveredMeta=t.component?.metadata)}}connectedCallback(){super.connectedCallback(),document.addEventListener("mouseover",this._onMouseover,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mouseover",this._onMouseover,!0),this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget=null)}_fmt(e){try{return JSON.stringify(e,null,2)??"null"}catch{return String(e)}}_renderTab(e,t){return o`
...
>
  ...
  `;At([$()],it.prototype,"filter",2);At([$()],it.prototype,"instant",2);At([$()],it.prototype,"selectedConsumedRoute",2);At([$()],it.prototype,"selectedRoute",2);At([$()],it.prototype,"selectedUriPrefix",2);At([$()],it.prototype,"selectedBaseUrl",2);At([$()],it.prototype,"selectedServerSideType",2);At([$()],it.prototype,"selectedParams",2);it=At([k("mateu-redwood-app")],it);const Cm=(e,t,a,s,i,r,n)=>o`
        <mateu-redwood-app
                id="${t.id}"
                baseUrl="${a}"
                .component="${t}"
                ...
                style="width: 100%;"
        ></mateu-redwood-app>
    `,Sm=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
...
`)}
    ...
    `},Im=e=>{const t=e.color==="error"||e.variant==="danger"?"danger":e.buttonStyle==="primary"?"callToAction":"outlined",a=t==="danger"?"background: var(--mateu-redwood-danger-bg, rgb(179, 49, 31)); color: #fff; border: 1px solid transparent;":t==="callToAction"?"background: var(--mateu-redwood-cta-bg, rgb(49, 45, 42)); color: #fff; border: 1px solid transparent;":"background: transparent; color: var(--mateu-redwood-text, rgb(22, 21, 19)); border: 1px solid rgba(22, 21, 19, 0.5);",s=i=>i.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId},bubbles:!0,composed:!0}));return o`
        <button
            ...
            ?disabled="${e.disabled}"
            @click="${s}"
        >${e.label}</button>`},_m=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.title||d.subtitle||d.toolbar?.length||d.header?.length||d.avatar;return o`
    ...
    `},Si=(e,t)=>e?e.includes("${")&&t._evalTemplate?t._evalTemplate(e):e:"",Ae=(e,t,a,s,i,r,n)=>(t.children??[]).map(d=>w(e,d,a,s,i,r,n)),Uo=e=>{const t=e?.metadata?.type;return t==="FormRow"||t==="FormItem"?(e.children??[]).flatMap(Uo):[e]},Em=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=Math.max(1,d.maxColumns??1),u=(t.children??[]).flatMap(Uo),m=p=>{const f=p?.metadata?.colspan,g=typeof f=="number"?f:parseInt(f??"1",10);return Math.min(Math.max(isNaN(g)?1:g,1),c)};return o`
        ...
        </div>`},Tm=(e,t,a,s,i,r,n)=>o`<div style="display:flex; flex-direction:row; gap:1rem; flex-wrap:wrap;">${Ae(e,t,a,s,i,r,n)}</div>`,Pm=(e,t,a,s,i,r,n)=>{const d=Si(t.metadata.title,e);return o`
        ...
        </div>`},Om=(e,t,a,s,i,r,n)=>{const d=Si(t.metadata.title,e);return o`
        ...
        </div>`},Rm=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d?.spacing===!1?"0":"1rem";return o`<div style="display:flex; flex-direction:row; gap:${c}; ${d?.wrap?"flex-wrap:wrap;":""} ${d?.fullWidth?"width:100%;":""} ${t.style??""}"
                     slot="${t.slot??l}">${Ae(e,t,a,s,i,r,n)}</div>`},zm=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d?.spacing===!1?"0":".75rem";return o`<div style="display:flex; flex-direction:column; gap:${c}; ${d?.fullWidth?"width:100%;":""} ${t.style??""}"
                     slot="${t.slot??l}">${Ae(e,t,a,s,i,r,n)}</div>`},Am=(e,t,a,s,i,r,n)=>{const d=t.metadata?.orientation==="vertical"?"column":"row";return o`<div style="display:flex; flex-direction:${d}; gap:1rem; width:100%; ${t.style??""}" slot="${t.slot??l}">
        ${(t.children??[]).map(c=>o`<div style="flex:1; min-width:0;">${w(e,c,a,s,i,r,n)}</div>`)}
    </div>`},Lm=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=m=>m?w(e,m,a,s,i,r,n):l,u=typeof d.title=="string"?d.title:"";if(t.cssClasses?.includes("mateu-section")){const m=u?o`<h2 class="oj-typography-heading-sm" style="margin: 0;">${u}</h2>`:typeof d.title=="object"&&d.title?c(d.title):l;return o`
        ...
        </div>`},jm=e=>{switch(e){case"h1":return"oj-typography-heading-xl";case"h2":return"oj-typography-heading-lg";case"h3":return"oj-typography-heading-md";case"h4":return"oj-typography-heading-sm";case"h5":case"h6":return"oj-typography-subheading-sm";default:return"oj-typography-body-md"}},Dm=(e,t,a)=>{const s=t.metadata,i=Si(s.text,e);return o`<div class="${jm(s.container)}" style="${t.style??""}">${i}</div>`},Nm=e=>{const t=e.metadata,a=t.color;return o`<oj-c-badge variant="${a==="success"?"success":a==="error"||a==="danger"?"danger":a==="warning"?"warning":a==="info"?"info":"neutral"}" slot="${e.slot??l}">${t.text??""}</oj-c-badge>`},Fm=e=>{const t=e.metadata;return o`<a class="oj-link-standalone" href="${t.url??"#"}" slot="${e.slot??l}">${t.text??t.url??""}</a>`},ws=(e,t)=>{t&&e?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t,parameters:{}},bubbles:!0,composed:!0}))},Bo=(e,t,a)=>o`
    <div style="position:fixed; inset:0; background:rgba(0,0,0,.4); display:flex; align-items:center; justify-content:center; z-index:1000;">
    ...
    </div>`,Mm=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=Si(d.headerTitle,e),u=p=>p?w(e,p,a,s,i,r,n):l,m=o`${u(d.content)}${Ae(e,t,a,s,i,r,n)}`;return Bo(c,m,u(d.footer))},qm=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=Si(d.header,e),u=d.content?w(e,d.content,a,s,i,r,n):l,m=o`
        ...
        <oj-c-button chroming="callToAction" label="${d.confirmText??"OK"}" @ojAction="${p=>ws(p.target,d.confirmActionId)}"></oj-c-button>`;return Bo(c,u,m)},Um=(e,t,a,s,i,r,n)=>o`<div style="overflow: auto; ${t.style??""}" class="${t.cssClasses??l}"
              slot="${t.slot??l}">${Ae(e,t,a,s,i,r,n)}</div>`,Bm=(e,t,a,s,i,r,n)=>o`<div style="width: 100%; ${t.style??""}" class="${t.cssClasses??l}"
              slot="${t.slot??l}">${Ae(e,t,a,s,i,r,n)}</div>`,Vm=(e,t,a,s,i,r,n)=>o`<div style="max-width: min(100%, 1200px); margin: auto; ${t.style??""}" class="${t.cssClasses??l}"
              slot="${t.slot??l}">${Ae(e,t,a,s,i,r,n)}</div>`,Hm=(e,t,a,s,i,r,n)=>o`<div style="display: flex; flex-direction: column; gap: 1rem; width: 100%; ${t.style??""}"
              class="${t.cssClasses??l}" slot="${t.slot??l}">
        ${Ae(e,t,a,s,i,r,n)}</div>`,Wm=(e,t,a,s,i,r,n)=>{const d=c=>c?.metadata?.type==="BoardLayoutItem"?c.metadata.boardCols??1:1;return o`<div style="display: flex; flex-direction: row; gap: 1rem; width: 100%; ${t.style??""}"
                     class="${t.cssClasses??l}" slot="${t.slot??l}">
        ${(t.children??[]).map(c=>o`
            <div style="flex: ${d(c)} 1 0; min-width: 0;">${w(e,c,a,s,i,r,n)}</div>`)}
    </div>`},Gm=(e,t,a,s,i,r,n)=>o`<div style="${t.style??""}" class="${t.cssClasses??l}">
        ${Ae(e,t,a,s,i,r,n)}</div>`,Km=(e,t,a,s,i,r,n)=>{const d=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,u=!!i?.hasDetail||!!d,m=c??d;return o`
        ...
        </div>`},Ym=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=m=>p=>{const g=p.target.closest(".rw-carousel-wrap")?.querySelector(":scope > .rw-carousel");g?.scrollBy({left:m*g.clientWidth,behavior:"smooth"})},u=d?.nav!==!1;return o`
        <div class="rw-carousel-wrap ${t.cssClasses??""}" style="position: relative; width: 100%; ${t.style??""}"
            ...
            </div>`}};Lt([h({attribute:!1})],ft.prototype,"component",2);Lt([h({attribute:!1})],ft.prototype,"container",2);Lt([h()],ft.prototype,"baseUrl",2);Lt([h({attribute:!1})],ft.prototype,"compState",2);Lt([h({attribute:!1})],ft.prototype,"compData",2);Lt([h({attribute:!1})],ft.prototype,"appState",2);Lt([h({attribute:!1})],ft.prototype,"appData",2);Lt([$()],ft.prototype,"selected",2);ft=Lt([k("mateu-redwood-tabs")],ft);var Qm=Object.defineProperty,Zm=Object.getOwnPropertyDescriptor,jt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Zm(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Qm(t,a,i),i};let bt=class extends S{constructor(){super(...arguments),this.open={},this.initialized=!1}createRenderRoot(){return this}label(e){const t=e?.metadata?.label;return t&&typeof t=="string"&&t.includes("${")&&this.container?._evalTemplate?this.container._evalTemplate(t):t??""}render(){const e=this.component?.children??[];return this.initialized||(e.forEach((t,a)=>{t?.metadata?.active&&(this.open[a]=!0)}),this.initialized=!0),o`
            <div style="display:flex; flex-direction:column; gap:.5rem;">
        ...
        `:o`${l}`}};Ga([h({type:Number})],wa.prototype,"totalElements",2);Ga([h({type:Number})],wa.prototype,"pageSize",2);Ga([h({type:Number})],wa.prototype,"pageNumber",2);Ga([$()],wa.prototype,"pages",2);Ga([$()],wa.prototype,"summary",2);wa=Ga([k("mateu-redwood-pagination")],wa);const av=e=>{let t=e;for(;t;){if(t.tagName?.toLowerCase()==="mateu-ux")return t;t=t.parentElement??t.getRootNode?.()?.host??null}return null},Ir=new WeakMap,iv=e=>{const t=e.target.dataset.actionId;e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},sv=new Set([v.App,v.Page,v.Form,v.Button,v.FormField,v.FormLayout,v.FormRow,v.FormSection,v.FormSubSection,v.HorizontalLayout,v.VerticalLayout,v.SplitLayout,v.MasterDetailLayout,v.Scroller,v.FullWidth,v.Container,v.BoardLayout,v.BoardLayoutRow,v.BoardLayoutItem,v.CarouselLayout,v.Card,v.Text,v.Badge,v.Anchor,v.Icon,v.Breadcrumbs,v.Notification,v.ProgressBar,v.Details,v.Avatar,v.AvatarGroup,v.Tooltip,v.Popover,v.MenuBar,v.ContextMenu,v.TabLayout,v.AccordionLayout,v.Dialog,v.Drawer,v.ConfirmDialog,v.Grid,v.Table,v.VirtualList,v.Directory,v.CustomField,v.MessageList,v.MessageInput,v.Crud,v.Element,v.Div,v.Image,v.MicroFrontend,v.Markdown,v.Chart,v.Bpmn,v.Map,v.Chat,v.CookieConsent,v.Workflow,v.WorkflowElk,v.FormEditor,v.MetricCard,v.Scoreboard,v.DashboardPanel,v.DashboardLayout,v.FoldoutLayout,v.HeroSection,v.EmptyState,v.Skeleton,v.Gantt,v.PlanningBoard,v.Kanban,v.Timeline,v.ProgressSteps,v.Stat,v.Calendar,v.PricingTable,v.OrgChart,v.Heatmap,v.Funnel,v.TrendChart,v.FeatureGrid,v.Testimonials,v.Faq,v.CalloutCard,v.CommentThread,v.FileList,v.Checklist,v.ComparisonCard,v.EntityHeader,v.Meter,v.TaskProgress,v.StatusList,v.BulletedList,v.Separator,v.Notice,v.TaskQueue,v.ResourceGrid,v.OfferCard,v.AddOnPicker,v.Ledger,v.PaymentPicker,v.ProcessMonitor]);class rv extends wu{rendererName(){return"redwood-oj"}supportedClientSideTypes(){return sv}rendersCrudLayouts(){return!0}renderFilterBar(t,a,s,i,r,n,d){const c=a?.metadata,u=c?.filters??[],m=Ir.get(t)??{open:!1,text:"",viewsOpen:!1};Ir.set(t,m);const p=()=>t.requestUpdate(),f=()=>{m.outsideClick&&(document.removeEventListener("mousedown",m.outsideClick),m.outsideClick=void 0)},g=()=>{f(),m.open=!1,m.viewsOpen=!1,m.activeFilter=void 0,p()},y=()=>{f(),m.outsideClick=b=>{b.composedPath().some(z=>z instanceof HTMLElement&&z.classList?.contains("mateu-smart-search"))||g()},document.addEventListener("mousedown",m.outsideClick)},x=()=>{m.open||(m.open=!0,m.viewsOpen=!1,y(),p())},T=()=>{const b=!m.viewsOpen;m.open=!1,m.activeFilter=void 0,m.viewsOpen=b,b?y():f(),p()},U=()=>{f(),m.open=!1,m.viewsOpen=!1,m.activeFilter=void 0,t.search()},ae=(b,E)=>{i[b]=E,U()},F=b=>{const E=u.find(z=>z.fieldId===b);E&&Y(E)?(i[`${b}_from`]=void 0,i[`${b}_to`]=void 0):i[b]=b==="searchText"?"":void 0,U()},ne=b=>{i.searchText=b.value,m.text="",b.value="",U()},ue=b=>b.dataType==="boolean"||b.dataType==="bool"||b.stereotype==="checkbox"||b.stereotype==="toggle",se=b=>["integer","decimal","number","money"].includes(b.dataType),Y=b=>b.stereotype==="dateRange"||b.stereotype==="numberRange",te=b=>b.stereotype==="multiSelect",be=b=>(b.options?.length??0)>0,I=b=>{const E=i[b.fieldId];return Array.isArray(E)?E.map(String):typeof E=="string"&&E!==""?E.split(",").map(z=>z.trim()).filter(z=>z):[]},j=(b,E)=>{const z=i[`${b.fieldId}_${E}`];return z==null?"":String(z)},O=b=>{if(Y(b))return j(b,"from")!==""||j(b,"to")!=="";if(te(b))return I(b).length>0;const E=i[b.fieldId];return E!=null&&E!==""},D=(b,E)=>{const z=b?.options?.find(B=>B.value===String(E));return z?z.label??z.value:typeof E=="boolean"?E?"Yes":"No":String(E)},Ne=b=>{if(Y(b)){const E=j(b,"from"),z=j(b,"to");return E&&z?`${E} – ${z}`:E?`≥ ${E}`:`≤ ${z}`}return te(b)?I(b).map(E=>D(b,E)).join(", "):D(b,i[b.fieldId])},Te=window.location.pathname,ot=()=>["searchText",...u.flatMap(b=>Y(b)?[`${b.fieldId}_from`,`${b.fieldId}_to`]:[b.fieldId])],wt=()=>!!i.searchText||u.some(b=>O(b)),R=()=>{const b={};return i.searchText&&(b.searchText=i.searchText),u.forEach(E=>{if(O(E))if(Y(E)){const z=j(E,"from"),B=j(E,"to");z&&(b[`${E.fieldId}_from`]=z),B&&(b[`${E.fieldId}_to`]=B)}else te(E)?b[E.fieldId]=I(E):b[E.fieldId]=i[E.fieldId]}),b},re=b=>{ot().forEach(E=>{i[E]=void 0}),Object.entries(b.values).forEach(([E,z])=>{i[E]=z}),U()},pe=b=>{const E=b.value.trim();E&&(Co(Te,{name:E,values:R()}),b.value="",p())};if(!m.defaultViewChecked&&(m.defaultViewChecked=!0,!window.location.search)){const b=_o(Te);b&&setTimeout(()=>{wt()||re(b)},0)}const N=[];i.searchText&&N.push({fieldId:"searchText",label:"Text",display:String(i.searchText)}),u.forEach(b=>{O(b)&&N.push({fieldId:b.fieldId,label:b.label||b.fieldId,display:Ne(b)})});const A="var(--mateu-redwood-text, rgb(22, 21, 19))",_=`display: flex; align-items: center; gap: 0.5rem; padding: 0.45rem 0.75rem; cursor: pointer; color: ${A}; font-size: 0.875rem;`,q=b=>b.preventDefault(),ge=(b,E,z=!1)=>o`
            ...
            ${av(t)?.getAttribute("data-has-welcome-banner")==="true"?l:o`
        ...
        <mateu-redwood-table id="${t.id}"
                     ...
                     baseUrl="${s}"
        ></mateu-redwood-table>
        `}renderClientSideComponent(t,a,s,i,r,n,d,c){return v.Page==a?.metadata?.type?_m(t,a,s,i,r,n,d):v.Form==a?.metadata?.type?Sm(t,a,s,i,r,n,d):v.Button==a?.metadata?.type?ku(a):v.FormField==a?.metadata?.type?xp(t,a,s,i,r):v.FormLayout==a?.metadata?.type?Em(t,a,s,i,r,n,d):v.FormRow==a?.metadata?.type?Tm(t,a,s,i,r,n,d):v.FormSection==a?.metadata?.type?Pm(t,a,s,i,r,n,d):v.FormSubSection==a?.metadata?.type?Om(t,a,s,i,r,n,d):v.HorizontalLayout==a?.metadata?.type?Rm(t,a,s,i,r,n,d):v.VerticalLayout==a?.metadata?.type?zm(t,a,s,i,r,n,d):v.SplitLayout==a?.metadata?.type?Am(t,a,s,i,r,n,d):v.MasterDetailLayout==a?.metadata?.type?Km(t,a,s,i,r,n,d):v.Scroller==a?.metadata?.type?Um(t,a,s,i,r,n,d):v.FullWidth==a?.metadata?.type?Bm(t,a,s,i,r,n,d):v.Container==a?.metadata?.type?Vm(t,a,s,i,r,n,d):v.BoardLayout==a?.metadata?.type?Hm(t,a,s,i,r,n,d):v.BoardLayoutRow==a?.metadata?.type?Wm(t,a,s,i,r,n,d):v.BoardLayoutItem==a?.metadata?.type?Gm(t,a,s,i,r,n,d):v.CarouselLayout==a?.metadata?.type?Ym(t,a,s,i,r,n,d):v.Card==a?.metadata?.type?Lm(t,a,s,i,r,n,d):v.Text==a?.metadata?.type?Dm(t,a):v.Badge==a?.metadata?.type?Nm(a):v.Anchor==a?.metadata?.type?Fm(a):v.Icon==a?.metadata?.type?Yu(a):v.Breadcrumbs==a?.metadata?.type?Ju(a):v.Notification==a?.metadata?.type?Xu(a):v.ProgressBar==a?.metadata?.type?Qu(a,i):v.Details==a?.metadata?.type?Zu(t,a,s,i,r,n,d):v.Avatar==a?.metadata?.type?ep(a,i,r):v.AvatarGroup==a?.metadata?.type?tp(a):v.Tooltip==a?.metadata?.type?ap(t,a,s,i,r,n,d):v.Popover==a?.metadata?.type?ip(t,a,s,i,r,n,d):v.MenuBar==a?.metadata?.type?sp(t,a):v.ContextMenu==a?.metadata?.type?rp(t,a,s,i,r,n,d):v.Grid==a?.metadata?.type?Uu(a,i):v.Table==a?.metadata?.type?Bu(t,a,s,i,r,n,d):v.VirtualList==a?.metadata?.type?Vu(t,a,s,i,r,n,d):v.Directory==a?.metadata?.type?Hu(a):v.CustomField==a?.metadata?.type?Wu(t,a,s,i,r,n,d):v.MessageList==a?.metadata?.type?Gu(a):v.MessageInput==a?.metadata?.type?Ku(a):v.TabLayout==a?.metadata?.type?o`<mateu-redwood-tabs
  ...
  `;Dt([h()],st.prototype,"baseUrl",2);Dt([h()],st.prototype,"route",2);Dt([h()],st.prototype,"consumedRoute",2);Dt([h()],st.prototype,"config",2);Dt([h()],st.prototype,"top",2);Dt([h()],st.prototype,"pathPrefix",2);Dt([$()],st.prototype,"instant",2);Dt([h({type:Boolean})],st.prototype,"debug",2);st=Dt([k("mateu-ui")],st);var lv=Object.getOwnPropertyDescriptor,dv=(e,t,a,s)=>{for(var i=s>1?void 0:s?lv(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(i)||i);return i};let Ps=class extends $i{constructor(){super(...arguments),this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))}}render(){const e=this.component?.metadata;return o`
