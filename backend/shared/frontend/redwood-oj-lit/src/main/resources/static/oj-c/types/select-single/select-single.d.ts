...
export type CollectionTemplateContext<K extends string | number, D extends Record<string, any>> = {
    ...
    /**
     * A callback function to be called to let the select component know when a user performs an action gesture on an item/row.
     * @param detail The detail containing information about the current row's data.
     */
    onRowAction: (detail: {
        item: Item<K, D>;
    }) => void;
...
/**
 * The properties of the SelectSingle component
 */
type Props<V extends string | number, D extends Record<string, any>> = ObservedGlobalProps<'aria-describedby' | 'id'> & {
     ...
     * </p>
     *
     * @ojmetadata description "Specifies whether the advanced search link is shown in the dropdown when the user filters."
     * @ojmetadata displayName "Advanced Search"
     * @ojmetadata help "#advancedSearch"
     */
     ...
     * @ojmetadata preferredContent ["CTableElement", "CListViewElement"]
     */
     ...
     *
     * @ojmetadata description "The data source for SelectSingle."
     ...
     * @ojmetadata displayName "Value Item"
     * @ojmetadata help "#valueItem"
     */
    ...
    /**
     * @ojmetadata description Writeback support for the valueItem property
     * @ojmetadata displayName "ValueItem"
     * @ojmetadata help "#valueItem"
     */
     ...
     *
     * @ojmetadata description Event triggered when the user clicks or presses Enter on the advanced
     * search link in the dropdown.
     * @ojmetadata displayName "onOjAdvancedSearchAction"
     * @ojmetadata help "#event:advancedSearchAction"
     */
    onOjAdvancedSearchAction?: Action<AdvancedSearchActionPayload>;
    /**
     * @ojmetadata description Event triggered when a value is submitted by the user, even if the value is the same as the previous value.
     * @ojmetadata displayName "onOjValueAction"
     * @ojmetadata help "#event:valueAction"
     */
    onOjValueAction?: Action<ValueActionPayload<V, D>>;
};
type SelectSingleHandle<V> = {
    /**
    ...
    /**
     * @ojmetadata description "This method imitates triggering the advanced search link in the dropdown.
     * This is used by the WebElement implementation of oj-c-select-single."
     * @param {string} searchText The search text to include in the event
     * @ignore
     */
    _doAdvancedSearchAction: (searchText: string) => void;
    /**
     * @ojmetadata description "This method imitates an option selection from the dropdown by using
     * the key of an item. This is used by the WebElement implementation of oj-c-select-single."
     * @param {V | null} value The value to be selected
...
/**
 * This export corresponds to the SelectSingle Preact component. For the oj-c-select-single custom element, import CSelectSingleElement instead.
 */
export declare const SelectSingle: <V extends string | number = string | number, D extends Record<string, any> = Record<string, any>>(props: ExtendGlobalProps<Props<V, D>> & {
    ref?: Ref<SelectSingleHandle<V>>;
}) => ComponentChildren;
...
/**
 * This export corresponds to the oj-c-select-single custom element. For the SelectSingle Preact component, import SelectSingle instead.
 */
...
declare namespace _CSelectSingleElementTypes {
    type _CollectionTemplateContext<V extends string | number, D extends Record<string, any>> = CollectionTemplateContext<V, D>;
    type _ItemTemplateContext<V extends string | number, D extends Record<string, any>> = ItemTemplateContext<V, D>;
}
export namespace CSelectSingleElement {
    ...
    type maxWidthChanged<V extends string | number, D extends Record<string, any>> = JetElementCustomEventStrict<CSelectSingleElement<V, D>['maxWidth']>;
    ...
    type readonlyUserAssistanceShownChanged<V extends string | number, D extends Record<string, any>> = JetElementCustomEventStrict<CSelectSingleElement<V, D>['readonlyUserAssistanceShown']>;
    ...
    type widthChanged<V extends string | number, D extends Record<string, any>> = JetElementCustomEventStrict<CSelectSingleElement<V, D>['width']>;
    type CollectionTemplateContext<V extends string | number, D extends Record<string, any>> = _CSelectSingleElementTypes._CollectionTemplateContext<V, D>;
    ...
    type ItemTemplateContext<V extends string | number, D extends Record<string, any>> = _CSelectSingleElementTypes._ItemTemplateContext<V, D>;
...
export interface CSelectSingleElementEventMap<V extends string | number, D extends Record<string, any>> extends HTMLElementEventMap {
    ...
    'maxWidthChanged': JetElementCustomEventStrict<CSelectSingleElement<V, D>['maxWidth']>;
    ...
    'readonlyUserAssistanceShownChanged': JetElementCustomEventStrict<CSelectSingleElement<V, D>['readonlyUserAssistanceShown']>;
    ...
    'widthChanged': JetElementCustomEventStrict<CSelectSingleElement<V, D>['width']>;
}
export interface CSelectSingleElementSettableProperties<V extends string | number, D extends Record<string, any>> extends JetSettableProperties {
     ...
     * </p>
     */
    readonlyUserAssistanceShown?: Props<V, D>['readonlyUserAssistanceShown'];
    /**
     * <p>
     * This property set to <code class="prettyprint">false</code> implies that a value is not required to be provided by the user.
     * This is the default.
...
export interface SelectSingleIntrinsicProps extends Partial<Readonly<CSelectSingleElementSettableProperties<any, any>>>, GlobalProps, Pick<preact.JSX.HTMLAttributes, 'ref' | 'key'> {
    ...
    /** @deprecated since 18.0.0 */ onlabelWrappingChanged?: (value: CSelectSingleElementEventMap<any, any>['labelWrappingChanged']) => void;
    onmatchByChanged?: (value: CSelectSingleElementEventMap<any, any>['matchByChanged']) => void;
    onmaxWidthChanged?: (value: CSelectSingleElementEventMap<any, any>['maxWidthChanged']) => void;
    ...
    onreadonlyUserAssistanceShownChanged?: (value: CSelectSingleElementEventMap<any, any>['readonlyUserAssistanceShownChanged']) => void;
    ...
    onwidthChanged?: (value: CSelectSingleElementEventMap<any, any>['widthChanged']) => void;
}
declare global {
