...
import{f as Ls,m as Rs,o as Ds,b as As,e as Qe,i as Fs,s as Ns,j as qs,k as Ms,t as Us,u as js,l as Bs,_ as ie,n as Ge,p as Vs,q as ja,v as Ji,N as Kt,w as oi,x as Yi,y as vi,z as Ws,A as Qi,B as Hs}from"./vendor-vaadin.js";import{a as $,j as u,k as Ce,i as _,x as o,m as x,r as b,A as l,p as xe,l as E,D as Xi,b as N,q as Gs}from"./vendor-lit.js";import{S as Ks,a as Js,n as me,b as Ys}from"./vendor.js";import"./vendor-ui5.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=a(i);fetch(i.href,r)}})();const Zi=document.createElement("style");Zi.innerHTML=`
${Ls.cssText}
${Rs.cssText}
${Ds.cssText}
${As.cssText}
...
${js.cssText}
${Bs.cssText}
`;document.body.appendChild(Zi);const Ct=new Ks,V={value:{}},la={value:{}},Qs={lon:0,lat:0},Oi=3,Xs=e=>{if(!e)return;const t=e.split(",").map(i=>i.trim());if(t.length!==2)return;const a=Number(t[0]),s=Number(t[1]);if(!(t[0]===""||t[1]===""||!Number.isFinite(a)||!Number.isFinite(s)))return{lon:s,lat:a}},Zs=e=>{if(e==null||e.trim()==="")return Oi;const t=Number(e);return Number.isFinite(t)?t:Oi};var er=Object.defineProperty,tr=Object.getOwnPropertyDescriptor,Ba=(e,t,a,s)=>{for(var i=s>1?void 0:s?tr(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&er(t,a,i),i};let Mt=class extends _{constructor(){super(...arguments),this.renderSeq=0}updated(e){super.updated(e),this.createMap()}disconnectedCallback(){super.disconnectedCallback(),this.map?.setTarget(void 0),this.map=void 0}async createMap(){const e=++this.renderSeq,[{default:t},{default:a},{default:s},{default:i},{fromLonLat:r},{default:n}]=await Promise.all([ie(()=>import("./vendor-ol.js").then(c=>c.M),[]),ie(()=>import("./vendor-ol.js").then(c=>c.V),[]),ie(()=>import("./vendor-ol.js").then(c=>c.T),[]),ie(()=>import("./vendor-ol.js").then(c=>c.O),[]),ie(()=>import("./vendor-ol.js").then(c=>c.p),[]),ie(()=>import("./vendor-ol.js").then(c=>c.o),[])]);if(e!==this.renderSeq||!this.isConnected)return;if(!this.shadowRoot.querySelector("style[data-ol]")){const c=document.createElement("style");c.setAttribute("data-ol",""),c.textContent=n,this.shadowRoot.appendChild(c)}this.map&&(this.map.setTarget(void 0),this.map=void 0);const d=Xs(this.position)??Qs;this.map=new t({target:this.mapElement,layers:[new s({source:new i})],view:new a({center:r([d.lon,d.lat]),zoom:Zs(this.zoom)})})}render(){return o`<div id="map"></div>`}};Mt.styles=$`
        :host {
            display: block;
            width: 100%;
            height: 25rem;
    ...
    `;Ba([u()],Mt.prototype,"position",2);Ba([u()],Mt.prototype,"zoom",2);Ba([Ce("#map")],Mt.prototype,"mapElement",2);Mt=Ba([x("mateu-map")],Mt);const ar=typeof HTMLElement<"u"?HTMLElement:class{};class ir extends ar{static get observedAttributes(){return["content"]}#e;#t=0;get content(){return this.#e}set content(t){this.#e=t,this.#a()}attributeChangedCallback(t,a,s){this.content=s??void 0}connectedCallback(){this.style.display="block",this.#a()}async#a(){if(!this.isConnected)return;const t=this.#e??"",a=++this.#t,[{marked:s},{default:i}]=await Promise.all([ie(()=>import("./vendor.js").then(r=>r.f),[]),ie(()=>import("./vendor.js").then(r=>r.c),[])]);a===this.#t&&(this.innerHTML=i.sanitize(await s.parse(t),{USE_PROFILES:{html:!0,svg:!0,svgFilters:!0},CUSTOM_ELEMENT_HANDLING:{tagNameCheck:r=>!0}}))}}typeof customElements<"u"&&!customElements.get("mateu-markdown")&&customElements.define("mateu-markdown",ir);var sr=Object.defineProperty,rr=Object.getOwnPropertyDescriptor,fa=(e,t,a,s)=>{for(var i=s>1?void 0:s?rr(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&sr(t,a,i),i};let St=class extends _{constructor(){super(...arguments),this.fieldId="",this.signing=!1,this.hasStrokes=!1,this.drawing=!1,this.startStroke=e=>{const t=e.target;this.ensureCanvasSize(t),t.setPointerCapture(e.pointerId),this.drawing=!0;const a=t.getContext("2d");a.lineWidth=2,a.lineCap="round",a.lineJoin="round",a.strokeStyle=getComputedStyle(this).getPropertyValue("--lumo-body-text-color")||"#1a1a1a";const[s,i]=this.pointerPosition(e);a.beginPath(),a.moveTo(s,i),e.preventDefault()},this.stroke=e=>{if(!this.drawing)return;const a=e.target.getContext("2d"),[s,i]=this.pointerPosition(e);a.lineTo(s,i),a.stroke(),this.hasStrokes=!0,e.preventDefault()},this.endStroke=e=>{this.drawing=!1,e.target.releasePointerCapture(e.pointerId)}}emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e,fieldId:this.fieldId},bubbles:!0,composed:!0}))}canvas(){return this.renderRoot.querySelector("canvas")}pointerPosition(e){const a=e.target.getBoundingClientRect();return[e.clientX-a.left,e.clientY-a.top]}ensureCanvasSize(e){const t=e.getBoundingClientRect();(e.width!==Math.round(t.width)||e.height!==Math.round(t.height))&&(e.width=Math.round(t.width),e.height=Math.round(t.height))}clear(){const e=this.canvas();e&&e.getContext("2d").clearRect(0,0,e.width,e.height),this.hasStrokes=!1}accept(){const e=this.canvas();!e||!this.hasStrokes||(this.signing=!1,this.emit(e.toDataURL("image/png")))}renderPad(){return o`
            <canvas class="pad"
    ...
    `;ba([u()],It.prototype,"fieldId",2);ba([u()],It.prototype,"value",2);ba([b()],It.prototype,"cameraOpen",2);ba([b()],It.prototype,"cameraError",2);It=ba([x("mateu-camera-capture")],It);var cr=Object.defineProperty,ur=Object.getOwnPropertyDescriptor,es=(e,t,a,s)=>{for(var i=s>1?void 0:s?ur(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&cr(t,a,i),i};let Ca=class extends _{constructor(){super(...arguments),this.items=[]}render(){return o`
            <ul>
    ...
    `;es([u({type:Array})],Ca.prototype,"items",2);Ca=es([x("mateu-bulleted-list")],Ca);const Ut=(e,t)=>new Function(...Object.keys(t),"return `"+e+"`")(...Object.values(t)),Jt=(e,t,a)=>({state:e??{},data:t??{},...a});function we(e,t,a,s){if(!e?.includes("${"))return e;try{return Ut(e,Jt(t,a,s))}catch(i){return console.warn(`Mateu: could not interpolate "${e}":`,i),e}}const wt=(e,t,a)=>{if(e&&e.indexOf("${")>=0)try{return Ut(e,Jt(t,a))}catch(s){return s.message}return e},Va=(e,t,a,s,i)=>{if(!e)return e;const r=Jt(t,a,{appState:s??{},appData:i??{}});let n=e;try{if(n=Ut(e,r),n.includes("${"))try{n=Ut(n,r)}catch(d){n="when evaluating nested "+e+" :"+d+", where data is "+a+" and state is "+t+" and app state is "+s+" and app data is "+i,console.error(d,n,t,a,s,i)}}catch(d){n="when evaluating "+e+" :"+d+", where data is "+a+" and state is "+t+" and app state is "+s+" and app data is "+i,console.error(d,n,t,a,s,i)}return n},ts=(e,t,a,s,i,r)=>{const n=Jt(t,a,{appState:s??{},appData:i??{},...r}),d=Ut(e,n);return new Function(...Object.keys(n),`return (${d})`)(...Object.values(n))},as=(e,t,a,s)=>{const i=Jt(t,a,s);return new Function(...Object.keys(i),`return (${e})`)(...Object.values(i))},hr=(e,t,a,s)=>Ut(e,Jt(t,a,s)),is=(e,t)=>{const a=e.toLowerCase().split("+");return t.ctrlKey===a.includes("ctrl")&&t.altKey===a.includes("alt")&&t.shiftKey===a.includes("shift")&&t.metaKey===a.includes("meta")},pr=(e,t)=>{if(!is(e,t))return!1;const a=e.toLowerCase().split("+"),s=a[a.length-1];return!!(t.key.toLowerCase()===s||/^[a-z]$/.test(s)&&t.code==="Key"+s.toUpperCase()||/^[0-9]$/.test(s)&&(t.code==="Digit"+s||t.code==="Numpad"+s))},mr=e=>e?e.split("+").map(t=>t.length<=1?t.toUpperCase():t.charAt(0).toUpperCase()+t.slice(1)).join("+"):void 0;var se=(e=>(e.ServerSide="ServerSide",e.ClientSide="ClientSide",e))(se||{}),m=(e=>(e.Page="Page",e.Div="Div",e.Element="Element",e.MicroFrontend="MicroFrontend",e.Form="Form",e.Crud="Crud",e.Result="Result",e.Card="Card",e.Directory="Directory",e.Stepper="Stepper",e.HorizontalLayout="HorizontalLayout",e.VerticalLayout="VerticalLayout",e.SplitLayout="SplitLayout",e.MasterDetailLayout="MasterDetailLayout",e.TabLayout="TabLayout",e.AccordionLayout="AccordionLayout",e.FormLayout="FormLayout",e.FormRow="FormRow",e.FormItem="FormItem",e.BoardLayout="BoardLayout",e.BoardLayoutRow="BoardLayoutRow",e.BoardLayoutItem="BoardLayoutItem",e.Scroller="Scroller",e.FullWidth="FullWidth",e.Container="Container",e.FormField="FormField",e.Table="Table",e.App="App",e.Text="Text",e.Avatar="Avatar",e.Chat="Chat",e.AvatarGroup="AvatarGroup",e.Badge="Badge",e.Breadcrumbs="Breadcrumbs",e.Anchor="Anchor",e.Button="Button",e.Chart="Chart",e.Icon="Icon",e.ConfirmDialog="ConfirmDialog",e.ContextMenu="ContextMenu",e.CookieConsent="CookieConsent",e.Details="Details",e.Dialog="Dialog",e.Drawer="Drawer",e.Image="Image",e.Map="Map",e.Markdown="Markdown",e.Notification="Notification",e.ProgressBar="ProgressBar",e.Popover="Popover",e.CarouselLayout="CarouselLayout",e.Tooltip="Tooltip",e.MessageInput="MessageInput",e.MessageList="MessageList",e.CustomField="CustomField",e.MenuBar="MenuBar",e.Grid="Grid",e.GridColumn="GridColumn",e.GridGroupColumn="GridGroupColumn",e.VirtualList="VirtualList",e.FormSection="FormSection",e.FormSubSection="FormSubSection",e.Bpmn="Bpmn",e.Workflow="Workflow",e.WorkflowElk="WorkflowElk",e.FormEditor="FormEditor",e.MetricCard="MetricCard",e.Scoreboard="Scoreboard",e.DashboardPanel="DashboardPanel",e.DashboardLayout="DashboardLayout",e.FoldoutLayout="FoldoutLayout",e.HeroSection="HeroSection",e.EmptyState="EmptyState",e.Skeleton="Skeleton",e.Gantt="Gantt",e.Kanban="Kanban",e.Timeline="Timeline",e.ProgressSteps="ProgressSteps",e.Stat="Stat",e.Calendar="Calendar",e.PricingTable="PricingTable",e.OrgChart="OrgChart",e.Heatmap="Heatmap",e.Funnel="Funnel",e.TrendChart="TrendChart",e.FeatureGrid="FeatureGrid",e.Testimonials="Testimonials",e.Faq="Faq",e.CalloutCard="CalloutCard",e.CommentThread="CommentThread",e.FileList="FileList",e.Checklist="Checklist",e.ComparisonCard="ComparisonCard",e.EntityHeader="EntityHeader",e.Meter="Meter",e.TaskProgress="TaskProgress",e.StatusList="StatusList",e.BulletedList="BulletedList",e.Separator="Separator",e.Notice="Notice",e.TaskQueue="TaskQueue",e.ResourceGrid="ResourceGrid",e.OfferCard="OfferCard",e.AddOnPicker="AddOnPicker",e.Ledger="Ledger",e.PaymentPicker="PaymentPicker",e.ProcessMonitor="ProcessMonitor",e))(m||{});const fi="mateu-app-context",ss="mateu-app-context-labels",rs=e=>{try{return JSON.parse(localStorage.getItem(e)??"{}")}catch{return{}}},Ti=(e,t)=>{try{localStorage.setItem(e,JSON.stringify(t))}catch{}},bi=()=>rs(fi),os=()=>rs(ss),vr=(e,t,a)=>{const s=bi(),i=os();t==null||t===""?(delete s[e],delete i[e]):(s[e]=t,a!==void 0&&(i[e]=a)),Ti(fi,s),Ti(ss,i)};let zi=!1;const fr=()=>{zi||(zi=!0,window.addEventListener("storage",e=>{e.key===fi&&e.newValue!==e.oldValue&&window.location.reload()}))};let qt=[];class br{constructor(){this.axiosInstance=Js.create({timeout:6e4}),this.axiosInstance.interceptors.request.use(t=>(this.addAuthToken(t),this.addSessionId(t),t))}addSessionId(t){let a=sessionStorage.getItem("__mateu_sesion_id");a||(a=me(),sessionStorage.setItem("__mateu_sesion_id",a)),t.headers["X-Session-Id"]=a}addAuthToken(t){const a=localStorage.getItem("__mateu_auth_token");a&&(t.headers.Authorization="Bearer "+a)}async wrap(t,a,s,i){return s||a.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),t.then(r=>(a.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:i}})),r)).catch(r=>{throw r?.code=="ERR_CANCELED"?a.dispatchEvent(new CustomEvent("backend-cancelled-event",{bubbles:!0,composed:!0,detail:{}})):a.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:i,reason:this.serialize(r)}})),r})}serialize(t){return t?.message?t:JSON.stringify(t)}async get(t){const a=new AbortController;return qt=[...qt,a],this.axiosInstance.get(t,{signal:a.signal})}async post(t,a){const s=new AbortController;return qt=[...qt,s],this.axiosInstance.post(t,a,{signal:s.signal})}async abortAll(){qt.forEach(t=>t.abort()),qt=[]}async runAction(t,a,s,i,r,n,d,c,h,p,f){return a&&a.startsWith("/")&&(a=a.substring(1)),n={...bi(),...n},await this.wrap(this.post(t+"/mateu/v3/sync/"+(a&&a!=""?a:"_no_route"),{serverSideType:d,appState:n,componentState:c,parameters:h,initiatorComponentId:r,consumedRoute:s,route:a&&a!=""?"/"+a:"",actionId:i}).then(v=>v.data),p,f,i)}}const Wa=new br;var da=(e=>(e.Add="Add",e.Replace="Replace",e.ReplaceKeepData="ReplaceKeepData",e))(da||{}),He=(e=>(e.HAMBURGUER_MENU="HAMBURGUER_MENU",e.MENU_ON_LEFT="MENU_ON_LEFT",e.MENU_ON_TOP="MENU_ON_TOP",e.TABS="TABS",e.TILES="TILES",e.RAIL="RAIL",e.AUTO="AUTO",e.MEDIATOR="MEDIATOR",e))(He||{}),gr=Object.defineProperty,ns=(e,t,a,s)=>{for(var i=void 0,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(t,a,i)||i);return i&&gr(t,a,i),i};class Ha extends _{constructor(){super(...arguments),this.id="",this.baseUrl="",this.callbackToken="",this.createElement=t=>{const a=t.data,s=document.createElement(a.name);for(let i in a.attributes)s.setAttribute(i,a.attributes[i]);for(let i in a.on)s.addEventListener(i,r=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.on[i],parameters:{event:r}},bubbles:!0,composed:!0}))});return s},this.closeModal=()=>{const t=this.shadowRoot?.querySelectorAll("mateu-dialog, mateu-drawer");if(t&&t.length>0){t[t.length-1].close();return}this.dispatchEvent(new CustomEvent("close-modal-requested",{bubbles:!0,composed:!0}))},this.changeFavicon=t=>{let a=document.querySelector('link[rel="icon"]');a!==null?a.setAttribute("href",t):(a=document.createElement("link"),a.setAttribute("rel","icon"),a.setAttribute("href",t),document.head.appendChild(a))}}connectedCallback(){super.connectedCallback(),this.upstreamSubscription=Ct.subscribe(t=>{if(t.command){const a=t.command;this.id==a.targetComponentId&&this.applyCommand(a)}if((!t.callbackToken||!this.callbackToken||t.callbackToken===this.callbackToken)&&t.fragment){const a=t.fragment;this.id==a.targetComponentId&&(this.applyFragment(a),this.completeMenu(a))}})}completeMenu(t){if(t.component&&t.component.type==se.ClientSide){const a=t.component,s=a.metadata;if(s?.type==m.App){const i=s,r=this.getRemoteMenus(i.menu);if(r.length>0){const n=r.map(d=>Wa.runAction(d.baseUrl,d.route,"_empty","",d.baseUrl+"#"+d.route,void 0,void 0,void 0,d.params,this,!0));Promise.all(n).then(d=>{i.menu=this.updateMenu(i.menu,d.map(c=>c.fragments).filter(c=>c).map(c=>c).flat()),i.variant=He.MENU_ON_TOP,Ct.next({fragment:{component:a,data:void 0,state:void 0,action:da.Replace,targetComponentId:this.id,containerId:void 0},callbackToken:this.callbackToken})})}}}}updateMenu(t,a){const s=[];return t.forEach(i=>{if(i.remote){const r=a.find(n=>n.targetComponentId==i.baseUrl+"#"+i.route);if(r&&r.component?.type==se.ClientSide){const n=r.component;if(n.metadata?.type==m.App){const d=n.metadata,c=i.serverSideType&&i.serverSideType!=""?i.serverSideType:d.serverSideType;this.changeBaseUrl(d.menu,i.baseUrl,c,i.route,d.route),s.push(...d.menu)}}}else s.push(i)}),s}changeBaseUrl(t,a,s,i,r){t.forEach(n=>{n.baseUrl||(n.submenus&&n.submenus.length>0?this.changeBaseUrl(n.submenus,a,s,i,r):(n.consumedRoute=r??"",n.baseUrl=a,n.serverSideType=s,n.uriPrefix=i))})}getRemoteMenus(t){const a=[];return t.forEach(s=>{s.remote&&a.push(s)}),a}disconnectedCallback(){super.disconnectedCallback(),this.upstreamSubscription?.unsubscribe()}applyCommand(t){if(t.type=="SetWindowTitle"&&(document.title=t.data),t.type=="SetFavicon"&&this.changeFavicon(t.data),t.type=="DispatchEvent"&&this.dispatchNamedEvent(t.data),t.type=="NavigateTo"){const a=t.data;a&&(a.startsWith("http:")||a.startsWith("https:")?window.open(t.data,"_blank"):window.location.href=t.data)}if(t.type=="PushStateToHistory"){const a=t.data;a!==void 0&&this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:a},bubbles:!0,composed:!0}))}if(t.type=="RunAction"){const a=t.data;if(a&&a.actionId)if(a.targetComponentId){const s={command:{type:"RunAction",data:{actionId:a.actionId},targetComponentId:a.targetComponentId},fragment:void 0,ui:void 0,error:void 0,callbackToken:""};setTimeout(()=>Ct.next(s))}else this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.actionId,parameters:{}},bubbles:!0,composed:!0}))}if(t.type=="MarkAsDirty"&&this.dispatchEvent(new CustomEvent("dirty",{detail:{},bubbles:!0,composed:!0})),t.type=="MarkAsClean"&&this.dispatchEvent(new CustomEvent("clean",{detail:{},bubbles:!0,composed:!0})),t.type=="DownloadFile"){const a=t.data;if(a&&a.base64Content){const s=atob(a.base64Content),i=new Uint8Array(s.length);for(let c=0;c<s.length;c++)i[c]=s.charCodeAt(c);const r=new Blob([i],{type:a.mimeType}),n=URL.createObjectURL(r),d=document.createElement("a");d.href=n,d.download=a.filename??"export",d.click(),URL.revokeObjectURL(n)}}if(t.type=="CloseModal"&&(this.closeModal(),this.dispatchNamedEvent(t.data)),t.type=="AddContentToHead"){const a=t.data;if(a&&a.name){if(a.attributes&&a.attributes.id&&document.getElementById(a.attributes.id))return;document.head.appendChild(this.createElement(t))}}if(t.type=="AddContentToBody"){const a=t.data;if(a&&a.name){if(a.attributes&&a.attributes.id&&document.getElementById(a.attributes.id))return;document.body.appendChild(this.createElement(t))}}}dispatchNamedEvent(t){if(t&&t.eventName){const a=this.component,s=a?.emitsName??a?.serverSideType;let i=t.payload??t.detail;s&&i&&typeof i=="object"&&(i={...i,__source:s}),this.dispatchEvent(new CustomEvent(t.eventName,{detail:i,bubbles:!0,composed:!0}))}}}ns([u()],Ha.prototype,"id");ns([u()],Ha.prototype,"baseUrl");var $r=Object.defineProperty,yr=(e,t,a,s)=>{for(var i=void 0,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(t,a,i)||i);return i&&$r(t,a,i),i};class Ga extends Ha{applyFragment(t){}manageActionRequestedEvent(t){}}yr([u()],Ga.prototype,"component");var oa=(e=>(e.NONE="NONE",e.INFO="INFO",e.SUCCESS="SUCCESS",e.WARNING="WARNING",e.DANGER="DANGER",e))(oa||{});const xr=(e,t,a)=>{const s=e[a.path];return s?o`<span theme="badge pill ${Ka(s.type)}">${s.message}</span>`:o``},Ka=e=>{switch(e){case oa.SUCCESS:return"success";case oa.WARNING:return"warning";case oa.DANGER:return"error";case oa.NONE:return"contrast"}return""},wr=(e,t,a)=>{const i=e[a.path]?"vaadin:check":"vaadin:minus";return o`<vaadin-icon 
            ...
            ></vaadin-icon>`},kr=(e,t,a,s,i)=>{const r=e[a.path];let n=r;return s=="money"&&r&&r.locale&&r.currency?n=new Intl.NumberFormat(r.locale,{style:"currency",currency:r.currency}).format(r.value):i=="money"&&(n=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(r)),o`${n}`},Li=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},_r=(e,t,a,s,i,r)=>{const n=a.xcolumn??r;if(n.text){if(n.actionId)return o`<a href="javascript: void(0);" @click="${h=>Li(a,n,e)}">${n.text}</a>`;const c=e[a.path];return o`<a href="${c}">${n.text}</a>`}if(s=="string"){if(n.actionId){const h=e[a.path];return o`<a href="javascript: void(0);" @click="${p=>Li(a,n,e)}">${h}</a>`}const c=e[a.path];return o`<a href="${c}">${c}</a>`}const d=e[a.path];return o`<a href="${d.href}">${d.text}</a>`},Cr=(e,t,a,s,i)=>s=="string"?e[a.path].split(",").map(d=>o`<vaadin-icon icon="${d}" style="width: 16px;"></vaadin-icon>`):e[a.path].split(",").map(n=>o`<vaadin-icon icon="${n.icon}" style="width: 16px;"></vaadin-icon>`),Sr=(e,t,a,s,i)=>{const r=e[a.path];return o`${xe(r)}`},Ir=(e,t,a,s,i,r)=>{if(s=="string"){const d=e[a.path],c="max-height: 40px; "+(r.style??"");return o`<img src="${d}" style="${c}">`}const n=e[a.path];return o`<img src="${n.src}" style="${r.style??""}">`},Er=e=>{const t={_clickedRow:e.target.row};e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-"+e.detail.value.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},Ri=e=>{const t={_clickedRow:e.target.row},a=e.target.action;e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-"+a.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},Pr=e=>{const t=document.createElement("vaadin-context-menu-item"),a=document.createElement("vaadin-icon");return a.style.color="var(--lumo-secondary-text-color)",a.style.marginInlineEnd="var(--lumo-space-s)",a.style.padding="var(--lumo-space-xs)",a.setAttribute("icon",e.icon),t.appendChild(a),e.label&&t.appendChild(document.createTextNode(e.label)),t.disabled=e.disabled,t},Di=(e,t,a)=>{const s=e[a.path]?.actions?.map(i=>i.icon?{component:Pr(i),methodNameInCrud:i.methodNameInCrud}:{...i,text:i.label});return!s||s.length==0?o``:o`
                                     <vaadin-menu-bar
                                         ...
                                         @item-selected="${Er}"
                                     ></vaadin-menu-bar>
                                   `},Or=(e,t,a)=>{if(a.path=="select"){const r={actionId:a.path,icon:"",label:"Select",disabled:!1,methodNameInCrud:"select"};return o`
    ...
    `},Tr=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},zr=(e,t,a,s,i,r)=>{const n=a.xcolumn??r;if(n.actionId){const c=n.text||e[a.path];return o`
        ...
        >
                ...
                .value=${d}
                @value-changed=${c=>r(c.detail.value)}></vaadin-combo-box>`;case"lookup":{const c=a?.field?.fieldId,h=`search-${c}-${t.id}`,p=`${c}-${t.id}`,v=(t.editorOptions??[]).find(w=>String(w.value)===d)??(d?{value:d,label:Dr(e,t.id)??d}:void 0);return o`<vaadin-combo-box
                theme="small" style="width:100%;"
                ...
                .selectedItem=${v}
                @selected-item-changed=${w=>{const g=w.detail.value,P=g?g.value:null;String(P??"")!==d&&(g&&Ar(e,t.id,g.label),r(P))}}></vaadin-combo-box>`}default:return o`<vaadin-text-field theme="small" style="width:100%;" .value=${d} @change=${c=>r(c.target.value)}></vaadin-text-field>`}},ni=e=>Vs(()=>o`<span title="${e}" style="white-space:normal;overflow-wrap:break-word;">${e}</span>`,[e]),Nr=e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget?.dispatchEvent(new CustomEvent("sort-direction-changed",{detail:{grid:e.currentTarget.parentElement},bubbles:!0,composed:!0}))},qr=(e,t,a,s,i,r,n)=>{const d=we(e.label,s,i);return o`
<vaadin-grid-column-group header="${d}">
    ${e.columns.map(c=>ls(c.metadata,t,a,s,i,r,n))}
</vaadin-grid-column-group>
`},gi=(e,t,a,s,i,r,n)=>m.GridGroupColumn==e.metadata?.type?qr(e.metadata,t,a,s,i,r,n):ls(e.metadata,t,a,s,i,r,n),ls=(e,t,a,s,i,r,n)=>{const d=we(e.label,s,i);return e.sortable?o`
            ...
            <vaadin-grid
                    ...
                    ${E(this.field?.detailPath?Ji(a=>o`${k(this,a[this.field?.detailPath],this.baseUrl,this.state,this.data,this.appState,this.appData)}`):void 0)}
  ...
  `;Yt([u()],ot.prototype,"field",2);Yt([u()],ot.prototype,"baseUrl",2);Yt([u()],ot.prototype,"state",2);Yt([u()],ot.prototype,"data",2);Yt([u()],ot.prototype,"value",2);ot=Yt([x("mateu-choice")],ot);var Hr=Object.defineProperty,Gr=Object.getOwnPropertyDescriptor,Me=(e,t,a,s)=>{for(var i=s>1?void 0:s?Gr(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Hr(t,a,i),i};let ve=class extends _{constructor(){super(...arguments),this.currencyChanged=e=>{this.value||(this.value={value:0,currency:"EUR",locale:"es-ES"}),this.value.currency=e.detail.value,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:{...this.value},fieldId:this.fieldId}}))},this.valueChanged=e=>{this.value||(this.value={value:0,currency:"EUR",locale:"es-ES"}),e.detail.value&&(this.value.value=e.detail.value?parseFloat(e.detail.value):0,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:{...this.value},fieldId:this.fieldId}})))}}render(){return o`
            <vaadin-number-field
                    id="${this.fieldId}"
                    label="${this.label}"
...
`;if(this.field?.stereotype=="listBox"){if(this.field?.remoteCoordinates){const i=this.field.remoteCoordinates,r="";return this.data[this.id]&&(this.data[this.id].searchSignature||r)&&this.data[this.id].searchSignature!=r&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements||this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:i.action,parameters:{searchText:r,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0})),o`
  ...
  `;de([u()],H.prototype,"component",2);de([u()],H.prototype,"field",2);de([u()],H.prototype,"baseUrl",2);de([u()],H.prototype,"state",2);de([u()],H.prototype,"data",2);de([u()],H.prototype,"appState",2);de([u()],H.prototype,"appData",2);de([u()],H.prototype,"labelAlreadyRendered",2);de([b()],H.prototype,"colorPickerOpened",2);de([b()],H.prototype,"colorPickerValue",2);de([b()],H.prototype,"filteredIcons",2);de([b()],H.prototype,"navLinkOffset",2);H=de([x("mateu-field")],H);const Xr=(e,t,a)=>{const s=e.metadata;return o`<span theme="badge ${s.color} ${s.pill?"pill":""} ${s.small?"small":""} ${s.primary?"primary":""}"
                      style="${e.style}" class="${e.cssClasses}"
                      slot="${e.slot??l}">${Le(s.text,t,a)}</span>`},Zr=(e,t,a)=>{const s=Le(e.text,t,a);if(!s)return l;let i=Le(e.color,t,a);return i=="SUCCESS"&&(i="success"),i=="ERROR"&&(i="error"),i=="DANGER"&&(i="error"),i=="WARNING"&&(i="warning"),i=="INFO"&&(i="info"),i=="PRIMARY"&&(i="primary"),i=="SECONDARY"&&(i="secondary"),i=="TERTIARY"&&(i="tertiary"),i=="QUATERNARY"&&(i="quaternary"),i=="LIGHT"&&(i="light"),i=="DARK"&&(i="dark"),o`<span theme="badge ${i} ${e.pill?"pill":""} ${e.small?"small":""} ${e.primary?"primary":""}">${s}</span>`};var eo=Object.defineProperty,to=Object.getOwnPropertyDescriptor,Rt=(e,t,a,s)=>{for(var i=s>1?void 0:s?to(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&eo(t,a,i),i};const ao=e=>{const t=[];return e.color&&e.color!=="normal"&&e.color!=="none"&&t.push(e.color),e.buttonStyle&&t.push(e.buttonStyle==="tertiaryInline"?"tertiary-inline":e.buttonStyle),e.size&&e.size!=="none"&&e.size!=="normal"&&t.push(e.size),t.length?t.join(" "):void 0},Ni=e=>e==="back"||e==="backToList"||!!e&&e.startsWith("cancel");let Je=class extends _{constructor(){super(...arguments),this.appState={},this.appData={},this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.evalLabel=e=>we(e,this.state,this.data),this.renderBtn=e=>{if((this.data??{})[e.actionId+".hidden"])return l;const t=this.evalLabel(e.label),a=U.get()?.renderToolbarButton?.(e,t,()=>this.handleButtonClick(e.actionId));return a||o`
        <vaadin-button
                data-action-id="${e.id}"
                theme="${ao(e)||l}"
    ...
    `}}render(){const e=this.metadata;if(!e)return o``;const t=e.toolbar??[],a=t.filter(d=>Ni(d.actionId)),s=t.filter(d=>!Ni(d.actionId)),i=a.length>0&&s.length>0?o`<span class="toolbar-divider"></span>`:l,r=e.avatar||e.title||e.subtitle||e.kpis?.length>0||e.header?.length>0||t.length>0,n=e.level??0;return n>0?this.setAttribute("data-nested",""):this.removeAttribute("data-nested"),o`
            ...
            ${e.badges&&e.badges.length>0?o`
                <div style="display: flex; gap: var(--lumo-space-s, .5rem); padding-bottom: var(--lumo-space-s, .5rem);">
                    ${e.badges.map(d=>Zr(d,this.state??{},this.data??{}))}
                </div>
            `:l}
        `}};Je.styles=$`
        :host {
        ...
        ${Qe}
    `;Rt([u()],Je.prototype,"metadata",2);Rt([u()],Je.prototype,"baseUrl",2);Rt([u()],Je.prototype,"state",2);Rt([u()],Je.prototype,"data",2);Rt([u()],Je.prototype,"appState",2);Rt([u()],Je.prototype,"appData",2);Je=Rt([x("mateu-content-header")],Je);var io=Object.defineProperty,so=Object.getOwnPropertyDescriptor,ga=(e,t,a,s)=>{for(var i=s>1?void 0:s?so(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&io(t,a,i),i};let Et=class extends Ga{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={}}render(){const e=this.component?.metadata;return o`
    ...
    `;$i([u()],ca.prototype,"variant",2);$i([u({type:Number})],ca.prototype,"count",2);ca=$i([x("mateu-skeleton")],ca);const no=(e,t)=>{t&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},_t=(e,t,a,s,i,r)=>o`
        <div class="mateu-empty-state"
            ...
            ${i&&r?o`
                <vaadin-button theme="tertiary" style="margin-top: .25rem;" @click="${n=>no(n,i)}">${r}</vaadin-button>
            `:l}
        </div>
    ...
    `};var uo=Object.defineProperty,ho=Object.getOwnPropertyDescriptor,Se=(e,t,a,s)=>{for(var i=s>1?void 0:s?ho(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&uo(t,a,i),i};let re=class extends _{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.detailsOpenedItems=[],this.pagesRequested=[],this.emptyArray=e=>!e||e.length==0,this.dataProvider=(e,t)=>{const a=this.data[this.id]?.page;if(this.metadata?.infiniteScrolling&&e.page>0){let s=!1;a&&a.content&&(a.content.length>=(e.page+1)*e.pageSize||a.content.length==a.totalElements)&&(t(a.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),a.totalElements),s=!0,this.grid&&this.grid.recalculateColumnWidths()),s||this.pagesRequested.find(i=>i==e.page)||(this.pagesRequested.push(e.page),this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:e,callback:()=>{this.data[this.id]?.page?.content&&(t(this.data[this.id].page.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),this.data[this.id].page.totalElements),this.grid&&this.grid.recalculateColumnWidths())}},bubbles:!0,composed:!0})))}else{const s=this.metadata?.infiniteScrolling?a?.totalElements:a?.content?.length??0;t(a?.content??[],s),this.grid&&this.grid.recalculateColumnWidths()}},this._onActionRequested=e=>{const t=e.detail,a=this.identifierFieldName;if(!a||!t.parameters||t.actionId?.startsWith("action-on-row-"))return;const s=t.parameters[a];s!==void 0&&(this.state._selectedId=String(s),this._applyCellPartNameGenerator(),this.grid?.requestContentUpdate())},this.tooltipGenerator=e=>{let t="";const{column:a,item:s}=e,i=this.metadata?.columns?.find(r=>r.metadata.id==a?.path);if(i?.metadata){const r=(i?.metadata).tooltipPath;r&&a&&s&&(t=s[r])}return t}}get identifierFieldName(){const e=this.metadata?.columns?.find(a=>a.metadata?.identifier);if(e)return e.metadata?.id;if(this.metadata?.columns?.find(a=>a.metadata?.id==="id"))return"id"}_applyCellPartNameGenerator(){if(!this.grid)return;const e=this.identifierFieldName,t=this.state?._selectedId??this.appState?._splitDetailId;e&&t!==void 0?this.grid.cellPartNameGenerator=(a,s)=>String(s.item[e])===String(t)?"selected-row":"":this.grid.cellPartNameGenerator=null}connectedCallback(){super.connectedCallback(),this.addEventListener("action-requested",this._onActionRequested)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("action-requested",this._onActionRequested)}updated(e){super.updated(e),this._applyCellPartNameGenerator(),this.grid?.clearCache(),this.grid?.recalculateColumnWidths(),this.pagesRequested=[]}render(){const e=this.data[this.id]?.page;let t="";this.metadata?.wrapCellContent&&(t+=" wrap-cell-content"),this.metadata?.compact&&(t+=" compact"),this.metadata?.noBorder&&(t+=" no-border"),this.metadata?.noRowBorder&&(t+=" no-row-borders"),this.metadata?.columnBorders&&(t+=" column-borders"),this.metadata?.rowStripes&&(t+=" row-stripes");const a=this.state[this.id+"_selected_items"]||[];return o`
            <vaadin-grid
                    ...
                    .detailsOpenedItems="${this.detailsOpenedItems}"
                    ${E(this.metadata?.detailPath?Ji(s=>o`${k(this,s[this.metadata?.detailPath],this.baseUrl,this.state,this.data,this.appState,this.appData)}`):void 0)}
                    theme="${t}"
  ...
  `;Se([u()],re.prototype,"id",2);Se([u()],re.prototype,"metadata",2);Se([u()],re.prototype,"baseUrl",2);Se([u()],re.prototype,"state",2);Se([u()],re.prototype,"data",2);Se([u()],re.prototype,"appState",2);Se([u()],re.prototype,"appData",2);Se([u()],re.prototype,"emptyStateMessage",2);Se([b()],re.prototype,"detailsOpenedItems",2);Se([Ce("vaadin-grid")],re.prototype,"grid",2);re=Se([x("mateu-table")],re);var po=Object.defineProperty,mo=Object.getOwnPropertyDescriptor,Ie=(e,t,a,s)=>{for(var i=s>1?void 0:s?mo(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&po(t,a,i),i};let oe=class extends _{constructor(){super(...arguments),this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.searchOnly=!1,this.panelOpened=!1,this.draftText="",this.openPanel=()=>{this.panelOpened||this.filters.length===0||(this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick))},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1,this.activeFilter=void 0},this.clearAllFilters=()=>{const e=this.filters.flatMap(a=>this.isRangeFilter(a)?[`${a.fieldId}_from`,`${a.fieldId}_to`]:[a.fieldId]),t={searchText:void 0};e.forEach(a=>{t[a]=void 0}),this.state={...this.state,...t},this.dispatchEvent(new CustomEvent("filter-reset-requested",{detail:{fieldIds:e},bubbles:!0,composed:!0})),this.requestSearch()},this.keepFocus=e=>e.preventDefault()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}get filters(){return this.metadata?.filters??[]}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}requestSearch(){this.closePanel(),this.dispatchEvent(new CustomEvent("search-requested",{detail:{},bubbles:!0,composed:!0}))}emitValueChanged(e,t){this.state={...this.state,[e]:t},this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t,fieldId:e},bubbles:!0,composed:!0}))}applyFilter(e,t){this.emitValueChanged(e,t),this.requestSearch()}removeChip(e){const t=this.filters.find(a=>a.fieldId===e);t&&this.isRangeFilter(t)?(this.emitValueChanged(`${e}_from`,void 0),this.emitValueChanged(`${e}_to`,void 0)):this.emitValueChanged(e,e==="searchText"?"":void 0),this.requestSearch()}commitText(e){this.emitValueChanged("searchText",e.value),this.draftText="",e.value="",this.requestSearch()}isBooleanFilter(e){return e.dataType==="boolean"||e.dataType==="bool"||e.stereotype==="checkbox"||e.stereotype==="toggle"}isNumericFilter(e){return["integer","decimal","number","money"].includes(e.dataType??"")}isRangeFilter(e){return e.stereotype==="dateRange"||e.stereotype==="numberRange"}isMultiFilter(e){return e.stereotype==="multiSelect"}hasOptions(e){return(e.options?.length??0)>0}multiValues(e){const t=this.state[e.fieldId];return Array.isArray(t)?t.map(String):typeof t=="string"&&t!==""?t.split(",").map(a=>a.trim()).filter(a=>a):[]}rangeBound(e,t){const a=this.state[`${e.fieldId}_${t}`];return a==null?"":String(a)}isSet(e){if(this.isRangeFilter(e))return this.rangeBound(e,"from")!==""||this.rangeBound(e,"to")!=="";if(this.isMultiFilter(e))return this.multiValues(e).length>0;const t=this.state[e.fieldId];return t!=null&&t!==""&&!Number.isNaN(t)}getFilterDisplayValue(e,t){if(e.options?.length){const a=e.options.find(s=>s.value===String(t));if(a)return a.label??a.value}return typeof t=="boolean"?t?"Yes":"No":String(t)}conditionDisplay(e){if(this.isRangeFilter(e)){const t=this.rangeBound(e,"from"),a=this.rangeBound(e,"to");return t&&a?`${t} – ${a}`:t?`≥ ${t}`:`≤ ${a}`}return this.isMultiFilter(e)?this.multiValues(e).map(t=>this.getFilterDisplayValue(e,t)).join(", "):this.getFilterDisplayValue(e,this.state[e.fieldId])}labelOf(e){return we(e.label,this.state,this.data)||e.fieldId}panelRow(e,t,a="panel-row"){return o`
    ...
    `;Ie([u()],oe.prototype,"metadata",2);Ie([u()],oe.prototype,"baseUrl",2);Ie([b()],oe.prototype,"state",2);Ie([b()],oe.prototype,"data",2);Ie([u()],oe.prototype,"appState",2);Ie([u()],oe.prototype,"appData",2);Ie([u({type:Boolean})],oe.prototype,"searchOnly",2);Ie([b()],oe.prototype,"panelOpened",2);Ie([b()],oe.prototype,"activeFilter",2);Ie([b()],oe.prototype,"draftText",2);oe=Ie([x("mateu-filter-bar")],oe);var vo=Object.defineProperty,fo=Object.getOwnPropertyDescriptor,$a=(e,t,a,s)=>{for(var i=s>1?void 0:s?fo(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&vo(t,a,i),i};let Pt=class extends _{constructor(){super(...arguments),this.totalElements=0,this.pageSize=100,this.pageNumber=0,this.totalPages=0}updated(e){super.updated(e),(e.has("totalElements")||e.has("pageSize"))&&(this.totalPages=Math.ceil(this.totalElements/this.pageSize))}dispatch(e){this.dispatchEvent(new CustomEvent("page-changed",{bubbles:!0,composed:!0,detail:{page:e}}))}render(){if(!this.totalElements)return l;const e=this.totalPages>1,t=this.pageNumber,a=t===0,s=t>=this.totalPages-1;return o`
    ...
    `;$a([u()],Pt.prototype,"totalElements",2);$a([u()],Pt.prototype,"pageSize",2);$a([u()],Pt.prototype,"pageNumber",2);$a([b()],Pt.prototype,"totalPages",2);Pt=$a([x("mateu-pagination")],Pt);const bo=640,go=e=>e>0&&e<bo?"accordion":"tabs";var $o=Object.defineProperty,yo=Object.getOwnPropertyDescriptor,Ja=(e,t,a,s)=>{for(var i=s>1?void 0:s?yo(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&$o(t,a,i),i};let jt=class extends _{constructor(){super(...arguments),this.tabLabels=[],this.mode="tabs",this.selected=0,this.selectedChangedListener=e=>{const t=e.detail?.value;typeof t=="number"&&t>=0&&(this.selected=t)}}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{for(const t of e)this.mode=go(t.contentRect.width)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.resizeObserver=void 0,this.detachTabsListener()}detachTabsListener(){this.slottedTabs?.removeEventListener("selected-changed",this.selectedChangedListener),this.slottedTabs=void 0}tabsSlotChanged(e){this.detachTabsListener();const a=e.target.assignedElements().find(s=>"selected"in s);a&&(this.slottedTabs=a,a.addEventListener("selected-changed",this.selectedChangedListener),a.selected=this.selected)}select(e){this.selected=e,this.slottedTabs&&(this.slottedTabs.selected=e)}updated(){this.slottedTabs&&this.slottedTabs.selected!=this.selected&&(this.slottedTabs.selected=this.selected)}render(){return o`
    ...
    `},So=(e,t,a,s,i,r,n)=>{const d=t.metadata;let c=t.style;return d.fullWidth&&(c=c?"width: 100%;"+c:"width: 100%;"),o`
               <vaadin-split-layout 
                       style="${c}" 
                       class="${t.cssClasses}"
            ...
            `},Io=(e,t,a,s,i,r,n)=>{const d=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,h=!!i?.hasDetail||!!d,p=c??d;return o`
        ...
        >
            ...
            ${t.children?.map(v=>Po(e,v,a,s,i,r,n))}
        </vaadin-tabsheet>
            `},Po=(e,t,a,s,i,r,n)=>{const d=t.metadata.label,c=d?.includes("${")?e._evalTemplate(d):d;return o`
        <div tab="${c}" style="padding: var(--lumo-space-m) 0;">
                   ${t.children?.map(h=>k(e,h,a,s,i,r,n))}
               </div>
            `},Oo=(e,t,a,s,i,r,n)=>{const d=t.metadata;t.style,d.fullWidth;let c=0;if(t.children){for(let h=0;h<t.children.length;h++)if(t.children[h].metadata?.active){c=h;break}}return o`
               <vaadin-accordion
                       style="${t.style}"
                       class="${t.cssClasses}"
                       opened="${c}"
                       slot="${t.slot??l}"
               >
                   ${t.children?.map(h=>To(e,h,a,s,i,r,n,d.variant))}
               </vaadin-accordion>
            `},To=(e,t,a,s,i,r,n,d)=>{const c=t.metadata,h=c.label?.includes("${")?e._evalTemplate(c.label):c.label;return o`
        ...
        <vaadin-board-row style="${t.style}" class="${t.cssClasses}">
            ...
            `,Fo=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        <div style="${t.style}" 
             class="${t.cssClasses}"
        ...
        >
            ...
            `},No=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=h=>o`
            ${k(e,h,a,s,i,r,n)}
`;return o`
        <vaadin-virtual-list
                ...
                slot="${t.slot??l}"
        ></vaadin-virtual-list>
    `},qo=(e,t,a,s,i,r,n)=>{const d=t.metadata;if(d.tree){const h=async(p,f)=>{const v=p.parentItem?p.parentItem.children:d.page.content;f(v,v.length)};return o`
...
`})}
    ...
    `},Mo=e=>{const a=(e.metadata.items??[]).map(s=>({text:s.text,time:s.time,userName:s.userName,userImg:s.userImg,userAbbr:s.userAbbr,userColorIndex:s.userColorIndex}));return o`
        <vaadin-message-list
                markdown
                style="${e.style}" class="${e.cssClasses}"
                slot="${e.slot??l}"
                .items="${a}"
        ></vaadin-message-list>
    `},Uo=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        ...
        <vaadin-menu-bar .items=${yi(e,r.options,a,s,i,V,la)}
            ...
            `},qi=(e,t,a,s,i,r,n)=>{const d=document.createElement("vaadin-context-menu-item");return Xi(k(e,t,a,s,i,r,n),d),d},yi=(e,t,a,s,i,r,n)=>t.map(d=>d.submenus?{text:d.component?void 0:d.label,route:d.path,checked:d.selected,disabled:d.disabled,className:d.className,component:d.component?qi(e,d.component,a,s,i,r,n):void 0,children:yi(e,d.submenus,a,s,i,r,n)}:d.separator?{component:"hr"}:{text:d.component?void 0:d.label,route:d.path,checked:d.selected,disabled:d.disabled,className:d.className,component:d.component?qi(e,d.component,a,s,i,r,n):void 0}),Bo=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.content?.metadata,h=c?.type==m.Notice&&c.fullWidth===!0;return o`
        ...
        >
            ...
            `},Vo=e=>{const t=e.metadata,a=s=>{const i=s.detail?.value??"";!t.actionId||!i.trim()||s.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:{message:i}},bubbles:!0,composed:!0}))};return o`
    ...
    `},Ho=e=>{if(e instanceof CustomEvent)return e.detail;const t={};for(const a in e){const s=e[a];["number","string","boolean"].indexOf(typeof s)>=0&&(t[a]=e[a])}return t},Mi=(e,t,a)=>{for(let s in t.attributes)e.setAttribute(s,t.attributes[s]);a.style&&e.setAttribute("style",a.style),a.cssClasses&&e.setAttribute("class",a.cssClasses),a.slot&&e.setAttribute("slot",a.slot),t.content&&(t.html?e.innerHTML=t.content:e.append(t.content))},Go=e=>{const t=e.name;t.startsWith("vaadin-chart")&&!customElements.get(t)&&ie(()=>import("./vendor-highcharts.js"),__vite__mapDeps([0,1,2,3]));const a=e.attributes?e.attributes.import:void 0;a&&t.includes("-")&&!customElements.get(t)&&import(a)},Ko=(e,t,a)=>{Go(t);let s=t.name;return t.attributes&&t.attributes.id&&(s="#"+t.attributes.id),setTimeout(()=>{const i=e.shadowRoot?.querySelector(".element-container")?.querySelector(s);if(i){for(;i.firstChild;)i.removeChild(i.lastChild);Mi(i,t,a)}else{const r=document.createElement(t.name);Mi(r,t,a);for(let n in t.on)r.addEventListener(n,d=>{const c=Ho(d);e.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.on[n],parameters:{event:c}},bubbles:!0,composed:!0}))});e.shadowRoot?.querySelector(".element-container")?.appendChild(r)}}),o`<div class="element-container"></div>`};var ze=(e=>(e.div="div",e.p="p",e.h1="h1",e.h2="h2",e.h3="h3",e.h4="h4",e.h5="h5",e.h6="h6",e.span="span",e))(ze||{});const Jo=(e,t,a,s,i)=>{const r=e.metadata,n=r.attributes?.["data-colspan"],d=Va(r.text,t,a,s,i),c={xl:"var(--lumo-font-size-xl, 1.375rem)",l:"var(--lumo-font-size-l, 1.125rem)",s:"var(--lumo-font-size-s, .875rem)",xs:"var(--lumo-font-size-xs, .8125rem)"},h=(r.size&&c[r.size]?`font-size: ${c[r.size]}; `:"")+(r.noMargins?"margin-block-start: 0; margin-block-end: 0; ":"");return ze.h1==r.container?o`
        ...
        `:ze.p==r.container?o`
            ...
            `},Yo=e=>{const t=e.metadata;return o`<a href="${t.url}" style="${e.style}" class="${e.cssClasses}"
                   slot="${e.slot??l}">${t.text}</a>`},Qo=(e,t)=>{const a=e.target.dataset.actionId;e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a,parameters:t.parameters},bubbles:!0,composed:!0}))},Xo=(e,t,a)=>{const s=e.metadata,i=we(s.label,t,a);let r="";return s.buttonStyle&&(r+=" "+s.buttonStyle),s.color&&s.color!=="none"&&s.color!=="normal"&&(r+=" "+s.color),s.size&&s.size!=="none"&&s.size!=="normal"&&(r+=" "+s.size),o`<vaadin-button
id="${e.id}"
            ...
            theme="${r}"
            ?disabled="${s.disabled}"
            title="${s.shortcut?`${i} (${mr(s.shortcut)})`:l}"
            slot="${e.slot??l}"
    >${s.iconOnLeft?o`<vaadin-icon icon="${s.iconOnLeft}"></vaadin-icon>`:l}${i}${s.iconOnRight?o`<vaadin-icon icon="${s.iconOnRight}"></vaadin-icon>`:l}</vaadin-button>`},Zo=(e,t,a,s,i,r,n)=>{const d=t.metadata;if(!d)return o``;let c="";return d.variants?.map(h=>h=="stretchMedia"?"stretch-media":h=="coverMedia"?"cover-media":h).forEach(h=>c+=" "+h),c=c.trim(),o`
        <vaadin-card
                style="${t.style}" 
                class="${t.cssClasses}" 
                theme="${c}"
    ...
    `},an=(e,t,a,s,i,r,n)=>{const d=t.metadata;let c=!1;if(d.openedCondition)try{c=ts(d.openedCondition,s,i,r,n)}catch(h){console.error("when evaluating "+d.openedCondition+" :"+h+", where data is "+i+" and state is "+s)}return o`
...
>
  ${t.children?.map(h=>k(e,h,a,s,i,r,n))}
    ...
    </vaadin-horizontal-layout>`},fn=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        <skeleton-carousel 
                id="${t.id}"
                ?dots = "${d.dots}" 
                ?nav = "${d.nav}" 
        ...
        ${e.submenus?o`
                <vaadin-details summary="${e.label}" opened>
                    <vaadin-vertical-layout theme="spacing">
                        ${e.submenus.map(t=>cs(t))}
                    </vaadin-vertical-layout>
                </vaadin-details>
            `:o`
                <a href="${e.path}">${e.label}</a>
        `}
        `,gn=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`<div
                slot="${t.slot??l}"
                style="${t.style}" class="${t.cssClasses}"
        >${d.content?xe(d.content):l}${t.children?.map(c=>k(e,c,a,s,i,r,n))}</div>
    `},$n=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.title?.includes("${")?e._evalTemplate(d.title):d.title;return o`<vaadin-card
                slot="${t.slot??l}"
    ...
    `},yn=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.title?.includes("${")?e._evalTemplate(d.title):d.title;return o`
        <div
                slot="${t.slot??l}"
                style="${t.style}" class="${t.cssClasses}"
        >
...
`)}
    ...
    `},wn=(e,t,a)=>{const s=e.metadata;return o`<mateu-chat sseUrl="${s.sseUrl}"
                            style="${e.style}" 
                            class="${e.cssClasses}" 
                            slot="${e.slot??l}"></mateu-chat>`},kn=e=>{const t=e.metadata;return o`
        <mateu-workflow
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
...
`,Sn=e=>e=="up"?"var(--lumo-success-text-color, #1a7f37)":e=="down"?"var(--lumo-error-text-color, #c5221f)":"var(--lumo-secondary-text-color, #666)",In=e=>e=="up"?"▲":e=="down"?"▼":"",En=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},Pn=e=>{const t=e.metadata,a=!!t.actionId;return o`
        <div class="mateu-metric-card ${e.cssClasses??""}"
             style="${us} display: flex; flex-direction: column; gap: .25rem; min-width: 11rem; flex: 1; ${a?"cursor: pointer;":""} ${e.style??""}"
             slot="${e.slot??l}"
             role="${a?"button":l}"
             @click="${s=>En(s,t)}"
        >
            ...
            ${t.trend||t.trendLabel?o`
                <span style="font-size: var(--lumo-font-size-s, .875rem); color: ${Sn(t.trend)};">
                    ${In(t.trend)} ${t.trendLabel??l}
                </span>
            `:l}
    ...
    `,Tn=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.colSpan&&d.colSpan>1?`grid-column: span ${d.colSpan};`:"",h=d.rowSpan&&d.rowSpan>1?`grid-row: span ${d.rowSpan};`:"";return o`
        <div class="mateu-dashboard-panel ${t.cssClasses??""}"
             style="${us} display: flex; flex-direction: column; gap: .5rem; min-width: 0; ${c} ${h} ${t.style??""}"
             slot="${t.slot??l}"
        >
            ${d.title?o`
                <div>
    ...
    `},zn=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.columns&&d.columns>0?`repeat(${d.columns}, minmax(0, 1fr))`:"repeat(auto-fit, minmax(20rem, 1fr))";return o`
    ...
    `};var Ln=Object.defineProperty,Rn=Object.getOwnPropertyDescriptor,xi=(e,t,a,s)=>{for(var i=s>1?void 0:s?Rn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ln(t,a,i),i};let ua=class extends _{constructor(){super(...arguments),this.panels=[],this.openPanels=new Set,this.initialized=!1}willUpdate(){!this.initialized&&this.panels.length&&(this.openPanels=new Set(this.panels.map((e,t)=>e.open?t:-1).filter(e=>e>=0)),this.initialized=!0)}toggle(e){const t=new Set(this.openPanels);t.has(e)?t.delete(e):t.add(e),this.openPanels=t}render(){return o`
    ...
    `;xi([u({type:Array})],ua.prototype,"panels",2);xi([b()],ua.prototype,"openPanels",2);ua=xi([x("mateu-foldout")],ua);const Dn=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        <mateu-foldout
                .panels="${d.panels??[]}"
                style="${t.style}"
                class="${t.cssClasses}"
    ...
    `},An=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=!!d.image,h=c?`background-image: linear-gradient(rgba(0,0,0,.35), rgba(0,0,0,.35)), url('${d.image}'); background-size: cover; background-position: center; color: #fff;`:"",p=d.centered===!1?"flex-start":"center",f=d.centered===!1?"left":"center";return o`
    ...
    `};var Fn=Object.defineProperty,Nn=Object.getOwnPropertyDescriptor,hs=(e,t,a,s)=>{for(var i=s>1?void 0:s?Nn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Fn(t,a,i),i};const li=1440*60*1e3;let Sa=class extends _{constructor(){super(...arguments),this.tasks=[]}range(){const e=this.tasks.flatMap(t=>[t.start,t.end]).filter(t=>!!t).map(t=>new Date(t+"T00:00:00").getTime());return e.length?{min:Math.min(...e)-li,max:Math.max(...e)+2*li}:null}months(e,t){const a=[],s=new Date(e);for(s.setDate(1);s.getTime()<=t;){const i=Math.max(s.getTime(),e),r=new Date(s.getFullYear(),s.getMonth()+1,1),n=Math.min(r.getTime(),t);a.push({label:s.toLocaleDateString(void 0,{month:"short",year:"2-digit"}),from:i,to:n}),s.setMonth(s.getMonth()+1)}return a}render(){const e=this.range();if(!e)return o``;const t=e.max-e.min,a=i=>(i-e.min)/t*100,s=Date.now();return o`
            <div class="frame">
    ...
    `;hs([u({type:Array})],Sa.prototype,"tasks",2);Sa=hs([x("mateu-gantt")],Sa);const qn=e=>{const t=e.metadata;return o`
        <mateu-gantt
                .tasks="${t.tasks??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;ps([u({type:Array})],Ia.prototype,"columns",2);Ia=ps([x("mateu-kanban")],Ia);const jn=e=>{const t=e.metadata;return o`
        <mateu-kanban
                .columns="${t.columns??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-kanban>
    `};var Bn=Object.defineProperty,Vn=Object.getOwnPropertyDescriptor,ms=(e,t,a,s)=>{for(var i=s>1?void 0:s?Vn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Bn(t,a,i),i};let Ea=class extends _{constructor(){super(...arguments),this.items=[]}clickItem(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedItem:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="feed">
                ${this.items.map(e=>o`
    ...
    `;ms([u({type:Array})],Ea.prototype,"items",2);Ea=ms([x("mateu-timeline")],Ea);const Wn=e=>{const t=e.metadata;return o`
        <mateu-timeline
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-timeline>
    `};var Hn=Object.defineProperty,Gn=Object.getOwnPropertyDescriptor,vs=(e,t,a,s)=>{for(var i=s>1?void 0:s?Gn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Hn(t,a,i),i};let Pa=class extends _{constructor(){super(...arguments),this.steps=[]}render(){return o`
            <div class="steps">
    ...
    `;vs([u({type:Array})],Pa.prototype,"steps",2);Pa=vs([x("mateu-progress-steps")],Pa);const Kn=e=>{const t=e.metadata;return o`
        <mateu-progress-steps
                ...
                slot="${e.slot??l}"
        ></mateu-progress-steps>
    `};var Jn=Object.defineProperty,Yn=Object.getOwnPropertyDescriptor,mt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Yn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Jn(t,a,i),i};let De=class extends _{constructor(){super(...arguments),this.spark=[]}sparkline(){const e=this.spark;if(!e||e.length<2)return l;const t=84,a=30,s=2,i=Math.min(...e),n=Math.max(...e)-i||1,d=(t-s*2)/(e.length-1),c=e.map((v,C)=>{const w=s+C*d,g=s+(a-s*2)*(1-(v-i)/n);return[w,g]}),h=c.map(([v,C],w)=>`${w===0?"M":"L"}${v.toFixed(1)} ${C.toFixed(1)}`).join(" "),p=`${h} L${c[c.length-1][0].toFixed(1)} ${a} L${c[0][0].toFixed(1)} ${a} Z`,f=this.trend==="down"?"var(--lumo-error-color, #e11d48)":this.trend==="flat"?"var(--lumo-secondary-text-color, #888)":"var(--lumo-success-color, #12b76a)";return N`
    ...
    `;mt([u()],De.prototype,"label",2);mt([u()],De.prototype,"value",2);mt([u()],De.prototype,"unit",2);mt([u()],De.prototype,"delta",2);mt([u()],De.prototype,"trend",2);mt([u({type:Array})],De.prototype,"spark",2);mt([u()],De.prototype,"actionId",2);De=mt([x("mateu-stat")],De);const Qn=e=>{const t=e.metadata;return o`
        <mateu-stat
                label="${t.label??l}"
                value="${t.value??l}"
                unit="${t.unit??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-stat>
    `};var Xn=Object.defineProperty,Zn=Object.getOwnPropertyDescriptor,wi=(e,t,a,s)=>{for(var i=s>1?void 0:s?Zn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Xn(t,a,i),i};let ha=class extends _{constructor(){super(...arguments),this.events=[]}clickEvent(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedEvent:e}},bubbles:!0,composed:!0}))}render(){const e=this.month?new Date(this.month+"T00:00:00"):new Date,t=e.getFullYear(),a=e.getMonth(),s=new Date(t,a,1),i=(s.getDay()+6)%7,r=new Date(t,a+1,0).getDate(),n=new Date,d=v=>n.getFullYear()===t&&n.getMonth()===a&&n.getDate()===v,c={};for(const v of this.events){if(!v.date)continue;const C=new Date(v.date+"T00:00:00");C.getFullYear()===t&&C.getMonth()===a&&(c[C.getDate()]??=[]).push(v)}const h=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],p=[];for(let v=0;v<i;v++)p.push(o`<div class="cell blank"></div>`);for(let v=1;v<=r;v++)p.push(o`
    ...
    `;wi([u()],ha.prototype,"month",2);wi([u({type:Array})],ha.prototype,"events",2);ha=wi([x("mateu-calendar")],ha);const el=e=>{const t=e.metadata;return o`
        <mateu-calendar
                month="${t.month??l}"
                .events="${t.events??[]}"
                style="${e.style??l}"
    ...
    `;fs([u({type:Array})],Oa.prototype,"plans",2);Oa=fs([x("mateu-pricing-table")],Oa);const il=e=>{const t=e.metadata;return o`
        <mateu-pricing-table
                .plans="${t.plans??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-pricing-table>
    `};var sl=Object.defineProperty,rl=Object.getOwnPropertyDescriptor,bs=(e,t,a,s)=>{for(var i=s>1?void 0:s?rl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&sl(t,a,i),i};let Ta=class extends _{clickNode(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedNode:e}},bubbles:!0,composed:!0}))}renderNode(e){const t=e.avatar,a=t&&(t.startsWith("http")||t.startsWith("data:"));return o`
            <li>
    ...
    `;bs([u({attribute:!1})],Ta.prototype,"root",2);Ta=bs([x("mateu-org-chart")],Ta);const ol=e=>{const t=e.metadata;return o`
        <mateu-org-chart
                .root="${t.root}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-org-chart>
    `};var nl=Object.defineProperty,ll=Object.getOwnPropertyDescriptor,gs=(e,t,a,s)=>{for(var i=s>1?void 0:s?ll(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&nl(t,a,i),i};const dl=1440*60*1e3;let za=class extends _{constructor(){super(...arguments),this.cells=[]}color(e,t){if(e<=0||t<=0)return"var(--lumo-contrast-10pct, #ebedf0)";const a=e/t,s=a>.75?1:a>.5?.75:a>.25?.5:.3;return`color-mix(in srgb, var(--lumo-primary-color, #1a73e8) ${Math.round(s*100)}%, transparent)`}render(){const e=this.cells.filter(c=>!!c.date);if(!e.length)return o``;const t=e.map(c=>new Date(c.date+"T00:00:00").getTime()),a=Math.min(...t),s=Math.max(...t),i=new Date(a);i.setDate(i.getDate()-(i.getDay()+6)%7);const r={};for(const c of e)r[c.date]=c;const n=Math.max(...e.map(c=>c.value??0),1),d=[];for(let c=i.getTime();c<=s;c+=dl){const h=new Date(c),p=h.toISOString().slice(0,10),f=r[p],v=f?.value??0,C=(h.getDay()+6)%7+1,w=f?.label??`${p}: ${v}`;d.push(o`
    ...
    `;gs([u({type:Array})],za.prototype,"cells",2);za=gs([x("mateu-heatmap")],za);const cl=e=>{const t=e.metadata;return o`
        <mateu-heatmap
                .cells="${t.cells??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-heatmap>
    `};var ul=Object.defineProperty,hl=Object.getOwnPropertyDescriptor,$s=(e,t,a,s)=>{for(var i=s>1?void 0:s?hl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ul(t,a,i),i};let La=class extends _{constructor(){super(...arguments),this.stages=[]}render(){const e=this.stages;if(!e.length)return o``;const t=e[0].value??0,a=Math.max(...e.map(s=>s.value??0),1);return o`
            <div class="funnel">
    ...
    `;$s([u({type:Array})],La.prototype,"stages",2);La=$s([x("mateu-funnel")],La);const pl=e=>{const t=e.metadata;return o`
        <mateu-funnel
                .stages="${t.stages??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;Qt([u()],nt.prototype,"heading",2);Qt([u({type:Array})],nt.prototype,"values",2);Qt([u({type:Array})],nt.prototype,"labels",2);Qt([u()],nt.prototype,"color",2);Qt([u({type:Boolean})],nt.prototype,"area",2);nt=Qt([x("mateu-trend-chart")],nt);const fl=e=>{const t=e.metadata;return o`
        <mateu-trend-chart
                heading="${t.title??l}"
                color="${t.color??l}"
                ?area="${t.area??!1}"
    ...
    `;ki([u({type:Array})],pa.prototype,"features",2);ki([u({type:Number})],pa.prototype,"columns",2);pa=ki([x("mateu-feature-grid")],pa);const $l=e=>{const t=e.metadata;return o`
        <mateu-feature-grid
                .features="${t.features??[]}"
                .columns="${t.columns??0}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-feature-grid>
    `};var yl=Object.defineProperty,xl=Object.getOwnPropertyDescriptor,ys=(e,t,a,s)=>{for(var i=s>1?void 0:s?xl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&yl(t,a,i),i};let Ra=class extends _{constructor(){super(...arguments),this.items=[]}stars(e){const t=Math.max(0,Math.min(5,e||0));return"★".repeat(t)+"☆".repeat(5-t)}render(){return o`
            <div class="grid">
    ...
    `;ys([u({type:Array})],Ra.prototype,"items",2);Ra=ys([x("mateu-testimonials")],Ra);const wl=e=>{const t=e.metadata;return o`
        <mateu-testimonials
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-testimonials>
    `};var kl=Object.defineProperty,_l=Object.getOwnPropertyDescriptor,_i=(e,t,a,s)=>{for(var i=s>1?void 0:s?_l(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&kl(t,a,i),i};let ma=class extends _{constructor(){super(...arguments),this.items=[],this.openSet=new Set,this.seeded=!1}seed(){this.seeded||(this.seeded=!0,this.items.forEach((e,t)=>{e.open&&this.openSet.add(t)}))}toggle(e){this.openSet.has(e)?this.openSet.delete(e):this.openSet.add(e),this.requestUpdate()}render(){return this.seed(),o`
            <div class="list">
    ...
    `;_i([u({type:Array})],ma.prototype,"items",2);_i([b()],ma.prototype,"openSet",2);ma=_i([x("mateu-faq")],ma);const Cl=e=>{const t=e.metadata;return o`
        <mateu-faq
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;Dt([u()],Ye.prototype,"heading",2);Dt([u()],Ye.prototype,"description",2);Dt([u()],Ye.prototype,"icon",2);Dt([u()],Ye.prototype,"ctaLabel",2);Dt([u()],Ye.prototype,"actionId",2);Dt([u()],Ye.prototype,"theme",2);Ye=Dt([x("mateu-callout-card")],Ye);const El=e=>{const t=e.metadata;return o`
        <mateu-callout-card
                heading="${t.title??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-callout-card>
    `};var Pl=Object.defineProperty,Ol=Object.getOwnPropertyDescriptor,xs=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ol(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Pl(t,a,i),i};let Da=class extends _{constructor(){super(...arguments),this.comments=[]}renderComment(e){const t=e.avatar&&(e.avatar.startsWith("http")||e.avatar.startsWith("data:"));return o`
            <div class="comment">
    ...
    `;xs([u({type:Array})],Da.prototype,"comments",2);Da=xs([x("mateu-comment-thread")],Da);const Tl=e=>{const t=e.metadata;return o`
        <mateu-comment-thread
                ...
                slot="${e.slot??l}"
        ></mateu-comment-thread>
    `};var zl=Object.defineProperty,Ll=Object.getOwnPropertyDescriptor,ws=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ll(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&zl(t,a,i),i};const Rl={pdf:"📕",image:"🖼️",img:"🖼️",doc:"📘",docx:"📘",word:"📘",xls:"📗",xlsx:"📗",excel:"📗",sheet:"📗",zip:"🗜️",archive:"🗜️",video:"🎬",audio:"🎵",code:"💻",csv:"📄",txt:"📄"};let Aa=class extends _{constructor(){super(...arguments),this.files=[]}icon(e){return e&&Rl[e.toLowerCase()]||"📄"}clickFile(e,t){e.url||e.actionId&&(t.preventDefault(),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_file:e}},bubbles:!0,composed:!0})))}render(){return o`
            <div class="list">
    ...
    `;ws([u({type:Array})],Aa.prototype,"files",2);Aa=ws([x("mateu-file-list")],Aa);const Dl=e=>{const t=e.metadata;return o`
        <mateu-file-list
                .files="${t.files??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;Ya([u()],Bt.prototype,"heading",2);Ya([u({type:Array})],Bt.prototype,"items",2);Ya([b()],Bt.prototype,"localDone",2);Bt=Ya([x("mateu-checklist")],Bt);const Nl=e=>{const t=e.metadata;return o`
        <mateu-checklist
                heading="${t.title??l}"
                .items="${t.items??[]}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-checklist>
    `};var ql=Object.defineProperty,Ml=Object.getOwnPropertyDescriptor,vt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ml(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ql(t,a,i),i};let Ae=class extends _{render(){const e=this.trend??"flat";return o`
            <div class="card">
                ${this.heading?o`<div class="title">${this.heading}</div>`:l}
                <div class="row">
                    <div class="side">
        ...
        @media (prefers-color-scheme: dark) { .card { background: var(--lumo-contrast-5pct, #2a2a2a); } }
    `;vt([u()],Ae.prototype,"heading",2);vt([u()],Ae.prototype,"leftLabel",2);vt([u()],Ae.prototype,"leftValue",2);vt([u()],Ae.prototype,"rightLabel",2);vt([u()],Ae.prototype,"rightValue",2);vt([u()],Ae.prototype,"delta",2);vt([u()],Ae.prototype,"trend",2);Ae=vt([x("mateu-comparison-card")],Ae);const Ul=e=>{const t=e.metadata;return o`
...
`,jl=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}),mi=e=>jl.format(e),Fa=(e,t)=>{const a=e<0?"-":"",s=mi(Math.abs(e));return t?`${a}${t} ${s}`:`${a}${s}`},Bl=(e,t)=>t?`${mi(e)} ${t}`:mi(e);var Vl=Object.defineProperty,Wl=Object.getOwnPropertyDescriptor,ft=(e,t,a,s)=>{for(var i=s>1?void 0:s?Wl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Vl(t,a,i),i};let Fe=class extends _{constructor(){super(...arguments),this.title="",this.badges=[],this.facts=[]}render(){const e=!!(this.metricLabel||this.metricValue||this.metricCaption);return o`
            <div class="card">
                <div class="main">
                    <div class="title-row">
    ...
    `];ft([u()],Fe.prototype,"title",2);ft([u({type:Array})],Fe.prototype,"badges",2);ft([u()],Fe.prototype,"subtitle",2);ft([u({type:Array})],Fe.prototype,"facts",2);ft([u()],Fe.prototype,"metricLabel",2);ft([u()],Fe.prototype,"metricValue",2);ft([u()],Fe.prototype,"metricCaption",2);Fe=ft([x("mateu-entity-header")],Fe);const Hl=e=>{const t=e.metadata;return o`
        <mateu-entity-header
                .title="${t.title??""}"
                .badges="${t.badges??[]}"
                .subtitle="${t.subtitle}"
                ...
                slot="${e.slot??l}"
        ></mateu-entity-header>
    `};var Gl=Object.defineProperty,Kl=Object.getOwnPropertyDescriptor,bt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Kl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Gl(t,a,i),i};let Ne=class extends _{constructor(){super(...arguments),this.value=0,this.max=0}fillColor(){return this.dangerAt!=null&&this.value>=this.dangerAt?"error":this.warnAt!=null&&this.value>=this.warnAt?"warning":this.warnAt!=null||this.dangerAt!=null?"success":"primary"}render(){const e=this.max>0?Math.min(Math.max(this.value/this.max,0),1):0,t=Math.round(e*100);return o`
            <div class="meter">
                ${this.label?o`<span class="label">${this.label}</span>`:l}
    ...
    `;bt([u()],Ne.prototype,"label",2);bt([u({type:Number})],Ne.prototype,"value",2);bt([u({type:Number})],Ne.prototype,"max",2);bt([u()],Ne.prototype,"unit",2);bt([u()],Ne.prototype,"caption",2);bt([u({type:Number})],Ne.prototype,"warnAt",2);bt([u({type:Number})],Ne.prototype,"dangerAt",2);Ne=bt([x("mateu-meter")],Ne);const Jl=e=>{const t=e.metadata;return o`
        <mateu-meter
                .label="${t.label}"
                .value="${t.value??0}"
                .max="${t.max??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-meter>
    `};var Yl=Object.defineProperty,Ql=Object.getOwnPropertyDescriptor,Xt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ql(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Yl(t,a,i),i};let lt=class extends _{constructor(){super(...arguments),this.total=0,this.done=0}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){const e=this.total>0&&this.done>=this.total,t=!e&&!!this.actionLabel&&!!this.actionId;return o`
    ...
    `;Xt([u()],lt.prototype,"label",2);Xt([u({type:Number})],lt.prototype,"total",2);Xt([u({type:Number})],lt.prototype,"done",2);Xt([u()],lt.prototype,"actionLabel",2);Xt([u()],lt.prototype,"actionId",2);lt=Xt([x("mateu-task-progress")],lt);const Xl=e=>{const t=e.metadata;return o`
        <mateu-task-progress
                .label="${t.label}"
                .total="${t.total??0}"
                .done="${t.done??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-task-progress>
    `};var Zl=Object.defineProperty,ed=Object.getOwnPropertyDescriptor,Xa=(e,t,a,s)=>{for(var i=s>1?void 0:s?ed(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Zl(t,a,i),i};let Vt=class extends _{constructor(){super(...arguments),this.items=[],this.compact=!1,this.frameless=!1}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}render(){return o`
    ...
    `];Xa([u({type:Array})],Vt.prototype,"items",2);Xa([u({type:Boolean})],Vt.prototype,"compact",2);Xa([u({type:Boolean})],Vt.prototype,"frameless",2);Vt=Xa([x("mateu-status-list")],Vt);const td=e=>{const t=e.metadata;return o`
        <mateu-status-list
                .items="${t.items??[]}"
                ?compact="${t.compact??!1}"
                ...
                slot="${e.slot??l}"
        ></mateu-status-list>
    `},ad=e=>{const t=e.metadata;return o`
        <mateu-bulleted-list
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `};var ld=Object.defineProperty,dd=Object.getOwnPropertyDescriptor,Za=(e,t,a,s)=>{for(var i=s>1?void 0:s?dd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ld(t,a,i),i};let Wt=class extends _{constructor(){super(...arguments),this.groups=[]}willUpdate(e){e.has("groups")&&(this.selectedId=this.groups.flatMap(t=>t.items??[]).find(t=>t.selected)?.id)}select(e){this.selectedId=e,this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{_item:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="rail">
                ${this.groups.map(e=>o`
                    <div class="group">
    ...
    `];Za([u()],Wt.prototype,"actionId",2);Za([u({type:Array})],Wt.prototype,"groups",2);Za([b()],Wt.prototype,"selectedId",2);Wt=Za([x("mateu-task-queue")],Wt);const cd=e=>{const t=e.metadata;return o`
        <mateu-task-queue
                .actionId="${t.actionId}"
                .groups="${t.groups??[]}"
                style="${e.style??l}"
    ...
    `];Zt([u()],dt.prototype,"actionId",2);Zt([u({type:Number})],dt.prototype,"columns",2);Zt([u()],dt.prototype,"recommendedLabel",2);Zt([u({type:Array})],dt.prototype,"items",2);Zt([b()],dt.prototype,"selectedId",2);dt=Zt([x("mateu-resource-grid")],dt);const pd=e=>{const t=e.metadata;return o`
        <mateu-resource-grid
                .actionId="${t.actionId}"
                .columns="${t.columns??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-resource-grid>
    `};var md=Object.defineProperty,vd=Object.getOwnPropertyDescriptor,ce=(e,t,a,s)=>{for(var i=s>1?void 0:s?vd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&md(t,a,i),i};let G=class extends _{constructor(){super(...arguments),this.title="",this.features=[],this.current=!1,this.added=!1}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return o`
    ...
    `;ea([u()],ct.prototype,"totalLabel",2);ea([u()],ct.prototype,"currency",2);ea([u()],ct.prototype,"actionId",2);ea([u({type:Array})],ct.prototype,"items",2);ea([b()],ct.prototype,"added",2);ct=ea([x("mateu-addon-picker")],ct);const $d=e=>{const t=e.metadata;return o`
        <mateu-addon-picker
                ...
                slot="${e.slot??l}"
        ></mateu-addon-picker>
    `};var yd=Object.defineProperty,xd=Object.getOwnPropertyDescriptor,ya=(e,t,a,s)=>{for(var i=s>1?void 0:s?xd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&yd(t,a,i),i};let Ot=class extends _{constructor(){super(...arguments),this.lines=[]}computedTotal(){return this.total!=null?this.total:this.lines.filter(e=>!e.included).reduce((e,t)=>e+(t.amount??0),0)}render(){return o`
            ${this.lines.map(e=>o`
                <div class="row">
                    <span class="dot"></span>
    ...
    `;ya([u()],Ot.prototype,"currency",2);ya([u()],Ot.prototype,"totalLabel",2);ya([u({type:Array})],Ot.prototype,"lines",2);ya([u({type:Number})],Ot.prototype,"total",2);Ot=ya([x("mateu-ledger")],Ot);const wd=e=>{const t=e.metadata;return o`
        <mateu-ledger
                .currency="${t.currency}"
                .totalLabel="${t.totalLabel}"
                .lines="${t.lines??[]}"
                ...
                slot="${e.slot??l}"
        ></mateu-ledger>
    `};var kd=Object.defineProperty,_d=Object.getOwnPropertyDescriptor,gt=(e,t,a,s)=>{for(var i=s>1?void 0:s?_d(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&kd(t,a,i),i};let qe=class extends _{constructor(){super(...arguments),this.methods=[]}willUpdate(e){e.has("selected")&&(this.selectedId=this.selected)}confirm(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{_method:this.selectedId}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="bar">
                <div class="methods">
    ...
    `;gt([u()],qe.prototype,"actionId",2);gt([u({type:Array})],qe.prototype,"methods",2);gt([u()],qe.prototype,"selected",2);gt([u()],qe.prototype,"contextLabel",2);gt([u()],qe.prototype,"contextValue",2);gt([u()],qe.prototype,"confirmLabel",2);gt([b()],qe.prototype,"selectedId",2);qe=gt([x("mateu-payment-picker")],qe);const Cd=e=>{const t=e.metadata;return o`
        <mateu-payment-picker
                ...
                slot="${e.slot??l}"
        ></mateu-payment-picker>
    `};var Sd=Object.defineProperty,Id=Object.getOwnPropertyDescriptor,ks=(e,t,a,s)=>{for(var i=s>1?void 0:s?Id(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Sd(t,a,i),i};let Na=class extends _{constructor(){super(...arguments),this.items=[]}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="list">
                ${this.items.map(e=>o`
                    <div class="row">
    ...
    `;ks([u({type:Array})],Na.prototype,"items",2);Na=ks([x("mateu-process-monitor")],Na);const Ed=e=>{const t=e.metadata;return o`
        <mateu-process-monitor
                ...
                slot="${e.slot??l}"
        ></mateu-process-monitor>
    `},Pd=(e,t)=>{let a=e.style;return e.id&&(a&&!a.endsWith(";")&&(a+=";"),a==null&&(a=""),t[e.id+".hidden"]==!0&&(a+="display: none;")),a},Od=(e,t)=>{let a={...e.metadata};if(e.id&&a){if(a.type==m.Button){const s=a;t[e.id+".disabled"]==!0&&(s.disabled=!0)}if(a.type==m.FormField){const s=a;t[e.id+".disabled"]==!0&&(s.disabled=!0)}}return a},T=e=>t=>e(t.container,t.component,t.baseUrl,t.state,t.data,t.appState,t.appData),Td={[m.Bpmn]:({component:e})=>xn(e),[m.Workflow]:({component:e})=>kn(e),[m.WorkflowElk]:({component:e})=>_n(e),[m.FormEditor]:({component:e})=>Cn(e),[m.Page]:T(hi),[m.Div]:T(gn),[m.Directory]:({component:e,baseUrl:t,state:a,data:s})=>bn(e),[m.FormLayout]:T(xo),[m.HorizontalLayout]:T(_o),[m.VerticalLayout]:T(Co),[m.SplitLayout]:T(So),[m.MasterDetailLayout]:T(Io),[m.TabLayout]:T(Eo),[m.AccordionLayout]:T(Oo),[m.BoardLayout]:T(Do),[m.BoardLayoutRow]:T(Ao),[m.BoardLayoutItem]:T(Fo),[m.Scroller]:T(zo),[m.FullWidth]:T(Lo),[m.Container]:T(Ro),[m.Form]:({container:e,component:t,baseUrl:a,state:s,data:i,appState:r,appData:n})=>{const d=t.metadata;return o`<mateu-form
            id="${t.id}"
        baseUrl="${a}"
            .component="${t}"
            .values="${s}"
...
`)}
        ...
        baseUrl="${a}"
            ...
            >
             ${t.children?.map(d=>k(e,d,a,s,i,r,n))}
         </mateu-app>`,[m.Element]:({container:e,component:t})=>Ko(e,t.metadata,t),[m.FormField]:({container:e,component:t,baseUrl:a,state:s,data:i,appState:r,appData:n,labelAlreadyRendered:d})=>{const c=t.metadata;return o`
    <mateu-field
                   id="${t.id}"
                   .component="${t}"
            .field="${t.metadata}"
        ...
        `},[m.Text]:({component:e,state:t,data:a,appState:s,appData:i})=>Jo(e,t,a,s,i),[m.Avatar]:({component:e,state:t,data:a})=>Kr(e,t,a),[m.Chat]:({component:e,state:t,data:a})=>wn(e),[m.AvatarGroup]:({component:e})=>Jr(e),[m.Badge]:({component:e,state:t,data:a})=>Xr(e,t,a),[m.Breadcrumbs]:({component:e})=>vn(e),[m.Anchor]:({component:e})=>Yo(e),[m.Button]:({component:e,state:t,data:a})=>Xo(e,t,a),[m.Card]:T(Zo),[m.Chart]:({component:e})=>en(e),[m.Icon]:({component:e})=>tn(e),[m.ConfirmDialog]:T(an),[m.ContextMenu]:T(Uo),[m.CookieConsent]:({component:e})=>sn(e),[m.Details]:T(rn),[m.Dialog]:({component:e,baseUrl:t,state:a,data:s,appState:i,appData:r})=>on(e,t,a,s,i,r),[m.Drawer]:({component:e,baseUrl:t,state:a,data:s,appState:i,appData:r})=>nn(e,t,a,s,i,r),[m.Image]:({component:e})=>mn(e),[m.Map]:({component:e})=>pn(e),[m.Markdown]:({component:e})=>dn(e),[m.MicroFrontend]:({component:e})=>ln(e),[m.Notification]:({component:e})=>cn(e),[m.ProgressBar]:({component:e,state:t})=>un(e,t),[m.Popover]:T(hn),[m.CarouselLayout]:T(fn),[m.Tooltip]:T(Wo),[m.MessageInput]:({component:e})=>Vo(e),[m.MessageList]:({component:e})=>Mo(e),[m.CustomField]:T(Bo),[m.MenuBar]:({container:e,component:t,baseUrl:a,state:s,data:i})=>jo(e,t,a,s,i),[m.Grid]:T(qo),[m.VirtualList]:T(No),[m.FormSection]:T($n),[m.FormSubSection]:T(yn),[m.MetricCard]:({component:e})=>Pn(e),[m.Scoreboard]:T(On),[m.DashboardPanel]:T(Tn),[m.DashboardLayout]:T(zn),[m.FoldoutLayout]:T(Dn),[m.HeroSection]:T(An),[m.EmptyState]:({component:e})=>lo(e),[m.Skeleton]:({component:e})=>co(e),[m.Gantt]:({component:e})=>qn(e),[m.Kanban]:({component:e})=>jn(e),[m.Timeline]:({component:e})=>Wn(e),[m.ProgressSteps]:({component:e})=>Kn(e),[m.Stat]:({component:e})=>Qn(e),[m.Calendar]:({component:e})=>el(e),[m.PricingTable]:({component:e})=>il(e),[m.OrgChart]:({component:e})=>ol(e),[m.Heatmap]:({component:e})=>cl(e),[m.Funnel]:({component:e})=>pl(e),[m.TrendChart]:({component:e})=>fl(e),[m.FeatureGrid]:({component:e})=>$l(e),[m.Testimonials]:({component:e})=>wl(e),[m.Faq]:({component:e})=>Cl(e),[m.CalloutCard]:({component:e})=>El(e),[m.CommentThread]:({component:e})=>Tl(e),[m.FileList]:({component:e})=>Dl(e),[m.Checklist]:({component:e})=>Nl(e),[m.ComparisonCard]:({component:e})=>Ul(e),[m.EntityHeader]:({component:e})=>Hl(e),[m.Meter]:({component:e})=>Jl(e),[m.TaskProgress]:({component:e})=>Xl(e),[m.StatusList]:({component:e})=>td(e),[m.BulletedList]:({component:e})=>ad(e),[m.Separator]:({component:e})=>id(e),[m.Notice]:T(nd),[m.TaskQueue]:({component:e})=>cd(e),[m.ResourceGrid]:({component:e})=>pd(e),[m.OfferCard]:({component:e})=>fd(e),[m.AddOnPicker]:({component:e})=>$d(e),[m.Ledger]:({component:e})=>wd(e),[m.PaymentPicker]:({component:e})=>Cd(e),[m.ProcessMonitor]:({component:e})=>Ed(e)},Ci=(e,t,a,s,i,r,n,d)=>{if(!t?.metadata)return t==null?(console.warn("No metadata for component",t),o`<p>No metadata for component</p>`):Ci(e,{id:me(),metadata:t,type:se.ClientSide},a,s,i,r,n,d);const c=t.metadata.type,h={...t,style:Pd(t,i),metadata:Od(t,i)},p=Td[c];return p?p({container:e,component:h,baseUrl:a,state:s,data:i,appState:r,appData:n,labelAlreadyRendered:d}):o`<p ${h?.slot??l}>Unknown metadata type ${c} for component ${h?.id}</p>`};var zd=Object.defineProperty,Ld=Object.getOwnPropertyDescriptor,ge=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ld(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&zd(t,a,i),i};let X=class extends _{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.dataProvider=(e,t)=>{const a=this.data[this.id]?.page;t(a?.content??[],a?.content?.length??0)},this.respondToVisibility=(e,t)=>{var a={root:document.documentElement},s=new IntersectionObserver(i=>{i.forEach(r=>{t(r.intersectionRatio>0)})},a);s.observe(e)},this.keepAsking=!1,this.askToUpper=()=>{const e=this.data[this.id]?.page,t=e?.content?.length/e?.pageSize;this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:{page:t,pageSize:this.metadata?.pageSize},callback:()=>{this.keepAsking&&this.askToUpper()}},bubbles:!0,composed:!0}))},this.renderItem=e=>e.card?Ci(this,e.card,this.baseUrl,this.state,this.data,this.appState,this.appData,!1):e.title?o`<vaadin-card
        >
                ${e.title?o`
                ...
                <vaadin-list-box style="width: 100%;">
                    ...
                    `)}
                            ...
                            <vaadin-button theme="tertiary" title="${xt.label||l}"
                                @click="${zs=>R(zs,"action-on-row-"+xt.methodNameInCrud,S)}">
...
`:o`<vaadin-button theme="tertiary" 
  ...
  `;Ss([u()],qa.prototype,"target",2);qa=Ss([x("mateu-event-interceptor")],qa);var Yd=Object.defineProperty,Qd=Object.getOwnPropertyDescriptor,Is=(e,t,a,s)=>{for(var i=s>1?void 0:s?Qd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Yd(t,a,i),i};let Ma=class extends $t{constructor(){super(...arguments),this.opened=!0,this.close=()=>{this.opened=!1,setTimeout(()=>this.parentElement?.removeChild(this),500)}}applyFragment(e){super.applyFragment(e);const t=e.state?._closeAfterMillis;t&&setTimeout(()=>this.close(),t)}updated(e){if(super.updated(e),e.has("component")&&this.component){const t=this.component.metadata;this.state=t.initialData}}render(){const e=this.component.metadata;let t="";e.noPadding&&(t+=" no-padding");const a=Va(e.headerTitle,this.state,this.data,this.appState,this.appData);return o`
        <vaadin-dialog
                ...
                width="${e.width??l}"
                height="${e.height??l}"
                ${e.header||e.closeButtonOnHeader?Hs(()=>o`<mateu-event-interceptor .target="${this}" style="width: 100%;">${e.header?k(this,e.header,this.baseUrl,this.state,this.data,this.appState,this.appData):l}${e.closeButtonOnHeader?o`
...
`,he=!0)}he&&this.updateMessage(r,n)}n||this.updateMessage(r,"⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).")}catch(d){console.error("Error en el flujo SSE:",d);const c=d?.message??String(d);(c==="Failed to fetch"||c==="network error"||c==="Load failed")&&!n?this.updateMessage(r,"⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible."):this.updateMessage(r,"⚠️ Error: "+c)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value="")},250),this.messageInputElement?.removeAttribute("disabled"),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent("close-requested",{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{const e=this.messageInputElement?.value?.trim()??"";e&&this.send(new CustomEvent("submit",{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key==="Enter"&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback(),this.probeLocalAgent();const e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){const t=new e;this.recognition=t,t.lang="es-ES",t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=a=>{console.error("Error de reconocimiento: "+a.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:"smooth"})},0)}addMessage(e,t){const a={text:e,time:new Date().toLocaleTimeString(),userName:t.includes("agent")?"Asistente":"Tú",userColorIndex:t.includes("agent")?2:1};return this.items=[...this.items,a],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((a,s)=>s===e?{...a,text:t}:a),this.scrollBottom()}tryParseCustomEvent(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if(typeof a.event=="string")return{event:a.event,detail:a.detail??{}}}catch{}return null}tryParseTokenUsage(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if("inputTokens"in a||"outputTokens"in a||"totalTokens"in a)return a}catch{}return null}buildMenuContext(e,t=[]){const a=[];for(const s of e){if(s.separator||s.remote)continue;const i=[...t,s.label];if(s.submenus&&s.submenus.length>0)a.push(...this.buildMenuContext(s.submenus,i));else{const r={path:i,navigation:{route:s.route,consumedRoute:s.consumedRoute,actionId:s.actionId??"",baseUrl:s.baseUrl,serverSideType:s.serverSideType,uriPrefix:s.uriPrefix}};s.description&&(r.description=s.description),a.push(r)}}return a}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return o`
                    ...
                    <div class="message-list" role="list">
                        ${this.items.map(e=>o`
                            <div class="message" role="listitem">
                                <div class="avatar" style="background: ${nc(e.userColorIndex)};">${lc(e.userName)}</div>
    ...
    `];F([u({attribute:!1})],D.prototype,"contextProvider",2);F([u()],D.prototype,"localAgentUrl",2);F([u({attribute:!1})],D.prototype,"mcpUrl",2);F([b()],D.prototype,"localAgentAlive",2);F([u()],D.prototype,"sseUrl",2);F([u()],D.prototype,"uploadUrl",2);F([u({attribute:!1})],D.prototype,"menu",2);F([b()],D.prototype,"attachments",2);F([b()],D.prototype,"uploading",2);F([Ce(".file-input")],D.prototype,"fileInputElement",2);F([u({type:Boolean,reflect:!0})],D.prototype,"expanded",2);F([u()],D.prototype,"items",2);F([Ce(".scroll-container")],D.prototype,"scrollContainer",2);F([Ce(".msg-input")],D.prototype,"messageInputElement",2);F([b()],D.prototype,"recognition",2);F([b()],D.prototype,"listening",2);F([b()],D.prototype,"recognitionAvailable",2);F([b()],D.prototype,"loading",2);F([b()],D.prototype,"elapsedSeconds",2);F([b()],D.prototype,"tokenUsage",2);D=F([x("mateu-chat")],D);var dc=Object.defineProperty,cc=Object.getOwnPropertyDescriptor,xa=(e,t,a,s)=>{for(var i=s>1?void 0:s?cc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&dc(t,a,i),i};let Tt=class extends _{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.data&&this.createChart(this.data)}async createChart(e){const[{default:t}]=await Promise.all([ie(()=>import("./vendor-chartjs.js").then(s=>s.a),[]),ie(()=>import("./vendor-chartjs.js").then(s=>s.c),[])]);if(e!==this.data)return;this.chart&&this.chart.destroy();const a={type:this.type,data:this.data,options:this.options};this.chart=new t(this.chartElement,a)}handleSlotChange(){}render(){return o`
       ...
       `}};Tt.styles=$`
  `;xa([u()],Tt.prototype,"type",2);xa([u()],Tt.prototype,"data",2);xa([u()],Tt.prototype,"options",2);xa([Ce("#chart")],Tt.prototype,"chartElement",2);Tt=xa([x("mateu-chart")],Tt);var uc=Object.defineProperty,hc=Object.getOwnPropertyDescriptor,Pi=(e,t,a,s)=>{for(var i=s>1?void 0:s?hc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&uc(t,a,i),i};let va=class extends _{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){const{default:t}=await ie(async()=>{const{default:s}=await import("./vendor-diagrams.js").then(i=>i.i);return{default:s}},__vite__mapDeps([4,3,1,2]));if(e!==this.xml)return;this.chart&&this.chart.destroy();const a={container:this.divElement};this.chart=new t(a),this.chart.importXML(e)}handleSlotChange(){}render(){return o`
  ...
  `;Pi([u()],va.prototype,"xml",2);Pi([Ce("#canvas")],va.prototype,"divElement",2);va=Pi([x("mateu-bpmn")],va);var pc=Object.defineProperty,mc=Object.getOwnPropertyDescriptor,aa=(e,t,a,s)=>{for(var i=s>1?void 0:s?mc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&pc(t,a,i),i};const di=160,Te=56,vc=220,Vi=110,at=60,fc={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},bc={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},gc=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];function $c(){return"step-"+Math.random().toString(36).slice(2,8)}let ut=class extends _{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.wf={name:"New Workflow",steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value")){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){const e=this.wf.steps??[],t={};e.forEach(n=>{t[n.id]=0});let a=!0;for(;a;)a=!1,e.forEach(n=>{if(n.preconditionStepId!=null&&t[n.preconditionStepId]!==void 0){const d=t[n.preconditionStepId]+1;d>t[n.id]&&(t[n.id]=d,a=!0)}});const s={};e.forEach(n=>{const d=t[n.id]??0;(s[d]??=[]).push(n.id)});const i={...this.positions};let r=!1;Object.entries(s).forEach(([n,d])=>{const c=Number(n);d.forEach((h,p)=>{i[h]||(i[h]={x:at+c*vc,y:at+p*Vi},r=!0)})}),r&&(this.positions=i)}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addStep(){const e=$c(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(i=>i.y),s=a.length?Math.max(...a)+Vi:at;this.positions={...this.positions,[e]:{x:at,y:s}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(s=>s.id!==e).map(s=>s.preconditionStepId===e?{...s,preconditionStepId:void 0}:s)};const{[e]:t,...a}=this.positions;this.positions=a,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},s=this.toSvgPoint(e);this.dragOffset={x:s.x-a.x,y:s.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(s=>s.x))+di+at:600,a=e.length?Math.max(...e.map(s=>s.y))+Te+at:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
        ...
        `}renderNode(e){const t=this.positions[e.id]??{x:at,y:at},a=fc[e.type]??"#64748b",s=bc[e.type]??"•",i=this.selectedId===e.id;return N`
                ...
                <div class="prop-body">
                    ...
                    ${a("Type",o`
                        <select class="inp" @change="${s=>this.updateStep(e.id,{type:s.target.value})}">
                            ${gc.map(s=>o`<option value="${s}" ?selected="${e.type===s}">${s}</option>`)}
                        </select>`)}
    ...
    `];aa([u()],ut.prototype,"value",2);aa([b()],ut.prototype,"wf",2);aa([b()],ut.prototype,"positions",2);aa([b()],ut.prototype,"selectedId",2);aa([b()],ut.prototype,"showMeta",2);ut=aa([x("mateu-workflow")],ut);var yc=Object.defineProperty,xc=Object.getOwnPropertyDescriptor,Xe=(e,t,a,s)=>{for(var i=s>1?void 0:s?xc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&yc(t,a,i),i};const ia=160,$e=56,it=60,wc={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},kc={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},_c=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];let ci;const Cc=()=>(ci||(ci=ie(()=>import("./vendor-diagrams.js").then(e=>e.e),__vite__mapDeps([4,3,1,2])).then(e=>new e.default)),ci);function Sc(){return"step-"+Math.random().toString(36).slice(2,8)}let ke=class extends _{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.readOnly=!1,this.wf={name:"New Workflow",steps:[]},this.positions={},this.layoutReady=!1,this.selectedId=null,this.showMeta=!1,this.layoutError=null,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.elkPositioned=new Set,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.elkPositioned.add(this.draggingId),this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value"))try{const t=JSON.parse(this.value),a=new Set((this.wf.steps??[]).map(r=>r.id)),s=new Set((t.steps??[]).map(r=>r.id)),i=a.size!==s.size||[...s].some(r=>!a.has(r))||[...s].some(r=>{const n=(this.wf.steps??[]).find(c=>c.id===r),d=(t.steps??[]).find(c=>c.id===r);return n?.preconditionStepId!==d?.preconditionStepId});this.wf=t,(i||!this.layoutReady)&&this.runElkLayout()}catch{}}async runElkLayout(){const e=this.wf.steps??[];if(e.length===0){this.positions={},this.layoutReady=!0;return}const t={id:"root",layoutOptions:{"elk.algorithm":"layered","elk.direction":"RIGHT","elk.spacing.nodeNode":"40","elk.layered.spacing.nodeNodeBetweenLayers":"80","elk.edgeRouting":"ORTHOGONAL","elk.layered.nodePlacement.strategy":"BRANDES_KOEPF"},children:e.map(a=>({id:a.id,width:ia,height:$e})),edges:e.filter(a=>a.preconditionStepId).map(a=>({id:`${a.preconditionStepId}->${a.id}`,sources:[a.preconditionStepId],targets:[a.id]}))};try{const s=await(await Cc()).layout(t),i={...this.positions};for(const r of s.children??[])(!this.elkPositioned.has(r.id)||!i[r.id])&&(i[r.id]={x:(r.x??0)+it,y:(r.y??0)+it},this.elkPositioned.add(r.id));this.positions=i,this.layoutReady=!0,this.layoutError=null}catch(a){this.layoutError=a?.message??"ELK layout failed",this.layoutReady=!0}}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){const a=this.wf.steps.map(r=>r.id===e?{...r,...t}:r),s=this.wf.steps.find(r=>r.id===e),i=t.preconditionStepId!==void 0&&t.preconditionStepId!==s?.preconditionStepId;this.wf={...this.wf,steps:a},i&&(this.elkPositioned.clear(),this.runElkLayout()),this.emit()}addStep(){const e=Sc(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(s=>s.x);this.positions={...this.positions,[e]:{x:a.length?Math.max(...a)+ia+80:it,y:it}},this.selectedId=e,this.elkPositioned.clear(),this.runElkLayout(),this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(s=>s.id!==e).map(s=>s.preconditionStepId===e?{...s,preconditionStepId:void 0}:s)};const{[e]:t,...a}=this.positions;this.positions=a,this.elkPositioned.delete(e),this.selectedId===e&&(this.selectedId=null),this.runElkLayout(),this.emit()}onNodeMouseDown(e,t){if(this.readOnly)return;e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},s=this.toSvgPoint(e);this.dragOffset={x:s.x-a.x,y:s.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}relayout(){this.elkPositioned.clear(),this.runElkLayout()}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(s=>s.x))+ia+it:600,a=e.length?Math.max(...e.map(s=>s.y))+$e+it:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){if(!this.layoutReady)return o`<div class="loading">Computing layout…</div>`;const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return N``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return N``;const s=t.x+ia,i=t.y+$e/2,r=a.x,n=a.y+$e/2,d=(s+r)/2;return N`
            <path d="M${s},${i} C${d},${i} ${d},${n} ${r},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:it,y:it},a=wc[e.type]??"#64748b",s=kc[e.type]??"•",i=this.selectedId===e.id,r=e.name.length>16?e.name.slice(0,15)+"…":e.name;return N`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
    ...
    `];Xe([u()],ke.prototype,"value",2);Xe([u({type:Boolean})],ke.prototype,"readOnly",2);Xe([b()],ke.prototype,"wf",2);Xe([b()],ke.prototype,"positions",2);Xe([b()],ke.prototype,"layoutReady",2);Xe([b()],ke.prototype,"selectedId",2);Xe([b()],ke.prototype,"showMeta",2);Xe([b()],ke.prototype,"layoutError",2);ke=Xe([x("mateu-workflow-elk")],ke);var Ic=Object.defineProperty,Ec=Object.getOwnPropertyDescriptor,wa=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ec(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ic(t,a,i),i};const Pc=["string","integer","number","bool","date","time","dateTime","dateRange","money","file","array","status","component","menu","range","action","actionGroup"],Oc=["regular","radio","checkbox","textarea","toggle","combobox","select","email","password","richText","listBox","html","markdown","image","icon","link","money","grid","color","choice","popover","slider","button","stars"],Tc={string:"#3B82F6",integer:"#8B5CF6",number:"#6366F1",bool:"#10B981",date:"#F59E0B",time:"#F59E0B",dateTime:"#F59E0B",dateRange:"#F59E0B",money:"#EF4444",file:"#64748B",array:"#0EA5E9",status:"#EC4899",component:"#14B8A6",menu:"#94A3B8",range:"#A855F7",action:"#F97316",actionGroup:"#FB923C"};function Wi(){return"field-"+Math.random().toString(36).slice(2,8)}let zt=class extends _{constructor(){super(...arguments),this.value='{"name":"New Form","fields":[]}',this.form={name:"New Form",fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has("value"))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){const e=this.shadowRoot?.querySelector(".field-list");!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=Ys.create(e,{animation:150,handle:".drag-handle",ghostClass:"sortable-ghost",onEnd:t=>{const{oldIndex:a,newIndex:s}=t;if(a===void 0||s===void 0||a===s)return;const i=[...this.form.fields],[r]=i.splice(a,1);i.splice(s,0,r),this.form={...this.form,fields:i},this.emit()}}))}emit(){const e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addField(){const e=Wi(),t={id:e,label:"New Field",dataType:"string"};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){const t=this.form.fields.find(r=>r.id===e);if(!t)return;const a={...t,id:Wi(),label:t.label+" (copy)"},s=this.form.fields.findIndex(r=>r.id===e),i=[...this.form.fields];i.splice(s+1,0,a),this.form={...this.form,fields:i},this.selectedId=a.id,this.emit()}render(){return o`
        ...
        `}renderRow(e){const t=Tc[e.dataType]??"#64748b",a=this.selectedId===e.id;return o`
        ...
        textarea.inp { resize: vertical; }
        input[readonly].inp { background: #f8fafc; color: #94a3b8; }
    `];wa([u()],zt.prototype,"value",2);wa([b()],zt.prototype,"form",2);wa([b()],zt.prototype,"selectedId",2);wa([b()],zt.prototype,"showMeta",2);zt=wa([x("mateu-form-editor")],zt);var zc=Object.defineProperty,Lc=Object.getOwnPropertyDescriptor,je=(e,t,a,s)=>{for(var i=s>1?void 0:s?Lc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&zc(t,a,i),i};let be=class extends _{constructor(){super(...arguments),this.appState={},this.appData={},this.open=!1,this.activeTab="appstate",this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null,this._prevTarget=null,this._onMouseover=e=>{let t=e.target;for(;t&&!(t.tagName?.toLowerCase().startsWith("mateu-")&&t!==this);)t=t.parentElement;if(t===this||t===null){t===null&&this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset="",this._prevTarget=null,this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null);return}t!==this._prevTarget&&(this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset=""),this._prevTarget=t,t.style.outline="2px solid #0070f3",t.style.outlineOffset="-2px",this.hoveredTag=t.tagName.toLowerCase(),this.hoveredId=t.id||"",this.hoveredState=t.state,this.hoveredData=t.data,this.hoveredMeta=t.component?.metadata)}}connectedCallback(){super.connectedCallback(),document.addEventListener("mouseover",this._onMouseover,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mouseover",this._onMouseover,!0),this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget=null)}_fmt(e){try{return JSON.stringify(e,null,2)??"null"}catch{return String(e)}}_renderTab(e,t){return o`
...
`);ee=te.pop()??"";for(const Y of te){const y=Y.trim();if(y)if(y.startsWith("data:")){const z=JSON.parse(y.substring(5).trim());C&&C(z),w||this.handleUIIncrement(z,f,g),z.messages&&z.messages.length==1&&z.messages[0].variant=="error"&&f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))}else{let z=y;try{const I=JSON.parse(y);z=I.message,I._embedded?.errors?.length>0&&I._embedded.errors[0].message&&(z=I._embedded.errors[0].message)}catch{}throw new Error(z)}}}}v||f.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:r}})),f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:r},bubbles:!0,composed:!0}))}).catch(j=>{f.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:r,reason:this.serialize(j)}})),f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))})}}serialize(t){return t?.message?t:JSON.stringify(t)}}const Ts=new Uc;var jc=Object.defineProperty,Bc=Object.getOwnPropertyDescriptor,ue=(e,t,a,s)=>{for(var i=s>1?void 0:s?Bc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&jc(t,a,i),i};let K=class extends Ha{constructor(){super(...arguments),this.consumedRoute="",this.serverSideType=void 0,this.uriPrefix=void 0,this.overrides=void 0,this.homeRoute=void 0,this.route=void 0,this.top=void 0,this.appState={},this.appData={},this.preventNavigation=!1,this.overridesParsed={},this.fragment=void 0,this.actionRequestedListener=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.manageActionEvent(e))},this.historyPushed=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.preventNavigation=!0,this.route=e.detail.route)},this.routeChangedListener=e=>{if(e instanceof CustomEvent){e.preventDefault(),e.stopPropagation();let t=e.detail.route;typeof t=="string"&&(t===""||t.startsWith("/"))&&this.consumedRoute&&this.consumedRoute!=="_empty"&&this.consumedRoute.startsWith("/")&&!t.startsWith(this.consumedRoute)&&(t=this.consumedRoute+t),this.uriPrefix&&(t.startsWith("/")&&this.uriPrefix.endsWith("/")?t=this.uriPrefix+t.substring(1):!t.startsWith("/")&&!this.uriPrefix.endsWith("/")?t=this.uriPrefix+"/"+t:t=this.uriPrefix+t),this.dispatchEvent(new CustomEvent("url-update-requested",{detail:{route:t},bubbles:!0,composed:!0}))}},this.backendFailedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&e.detail.actionId==""&&(this.fragment={targetComponentId:this.id,data:{},state:{},component:{type:se.ClientSide,metadata:{type:m.Element,name:"div",content:"Not found"},id:"fieldId"},action:da.Replace,containerId:void 0})},this.detail1=void 0,this.manageActionEvent=e=>{e.preventDefault(),e.stopPropagation(),this.detail1=e.detail;const t=this.detail1;if(e.type=="server-side-action-requested"){let a=Mc;t.sse&&(a=Ts),a.runAction(Wa,this.baseUrl,t.route??"",t.consumedRoute,t.actionId,t.initiatorComponentId,this.getCustomisedAppState(),t.serverSideType,t.componentState,t.parameters,t.initiator,t.background,t.callback,t.callbackonly,t.callbackToken)}},this.getCustomisedAppState=()=>{let e={...V.value};if(this.overrides){const t=Hi(this.overrides);e={...e,...t}}return e}}manageActionRequestedEvent(e){throw new Error("Method not implemented.")}createRenderRoot(){return U.mustUseShadowRoot()?super.createRenderRoot():this}connectedCallback(){super.connectedCallback(),this.overridesParsed=Hi(this.overrides),this.addEventListener("server-side-action-requested",this.actionRequestedListener),this.addEventListener("backend-call-failed",this.backendFailedListener),this.addEventListener("history-pushed",this.historyPushed),this.addEventListener("route-changed",this.routeChangedListener),window.Vaadin.featureFlags.masterDetailLayoutComponent=!0}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("server-side-action-requested",this.actionRequestedListener),this.removeEventListener("backend-call-failed",this.backendFailedListener),this.removeEventListener("history-pushed",this.historyPushed),this.removeEventListener("route-changed",this.routeChangedListener)}shouldUpdate(e){if(this.fragment?.component&&[...e.keys()].every(a=>a==="appState"||a==="appData")){const a=this.renderRoot.querySelector("mateu-component");if(a)return e.has("appState")&&(a.appState=this.appState),e.has("appData")&&(a.appData=this.appData),!1}return!0}updated(e){(e.has("id")||e.has("baseurl")||e.has("route")||e.has("consumedRoute")||e.has("instant"))&&(this.preventNavigation||(this.callbackToken=this.instant||me(),this.manageActionEvent(new CustomEvent("server-side-action-requested",{detail:{route:this.route,consumedRoute:this.consumedRoute,userData:void 0,actionId:"",serverSideType:this.serverSideType,initiatorComponentId:this.id,initiator:this,componentState:this.initialState,callbackToken:this.callbackToken},bubbles:!0,composed:!0})))),e.has("route")&&this.top&&(this.preventNavigation||this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:this.route},bubbles:!0,composed:!0}))),this.preventNavigation&&(this.preventNavigation=!1)}applyFragment(e){if(!e.component&&this.fragment?.component){this.fragment={...this.fragment,state:{...this.fragment.state??{},...e.state??{}},data:{...this.fragment.data??{},...e.data??{}}};return}this.fragment=e}render(){return o`
  ...
  `;Ze([u()],_e.prototype,"baseUrl",2);Ze([u()],_e.prototype,"route",2);Ze([u()],_e.prototype,"consumedRoute",2);Ze([u()],_e.prototype,"config",2);Ze([u()],_e.prototype,"top",2);Ze([u()],_e.prototype,"pathPrefix",2);Ze([b()],_e.prototype,"instant",2);Ze([u({type:Boolean})],_e.prototype,"debug",2);_e=Ze([x("mateu-ui")],_e);var Hc=Object.defineProperty,Gc=Object.getOwnPropertyDescriptor,si=(e,t,a,s)=>{for(var i=s>1?void 0:s?Gc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Hc(t,a,i),i};let ht=class extends _{constructor(){super(...arguments),this.baseUrl="",this.dataProvider=async(e,t)=>{const a=e.filter??"",i=await this.remoteSearch(a)??(this.selector.options??[]).filter(r=>r.label.toLowerCase().includes(a.toLowerCase()));t(i,i.length)}}connectedCallback(){super.connectedCallback(),fr()}currentValue(){return String(bi()[this.selector.fieldName]??"")}currentLabel(){const e=this.currentValue();if(!e)return"";const t=(this.selector.options??[]).find(s=>String(s.value)===e);if(t)return t.label;const a=os()[this.selector.fieldName];return a!==void 0?String(a):e}pick(e,t){String(e??"")!==this.currentValue()&&(vr(this.selector.fieldName,e,t),window.location.reload())}async remoteSearch(e){const t=this.app;if(t?.serverSideType)try{const a=await Wa.runAction(this.baseUrl??"",t.rootRoute??t.initialRoute??"","",`_appcontext-search-${this.selector.fieldName}`,`appcontext-${this.selector.fieldName}`,void 0,t.serverSideType,{},{searchText:e},this,!0);for(const s of a?.fragments??[]){const n=s.data?.[`_appcontext_${this.selector.fieldName}`]?.content;if(Array.isArray(n))return n.map(d=>({value:d.value,label:d.label??String(d.value)}))}}catch{}}renderSelect(){const e=[{label:"—",value:""},...(this.selector.options??[]).map(t=>({label:t.label,value:String(t.value)}))];return o`
    ...
    `;si([u()],ht.prototype,"selector",2);si([u()],ht.prototype,"app",2);si([u()],ht.prototype,"baseUrl",2);ht=si([x("mateu-vaadin-app-context-picker")],ht);const Kc=async(e,t,a)=>{try{const s=r=>{if(!r||!("querySelectorAll"in r))return null;for(const n of r.querySelectorAll("*")){if(n.tagName?.toLowerCase()==="mateu-component")return n;const d=s(n.shadowRoot);if(d)return d}return null},i=s(t.renderRoot);await Ts.runAction(Wa,t.baseUrl??"",e.rootRoute||"_no_route","",a,i?.id??"app-header-action",{},e.serverSideType??"",{},{},i??t,!0,void 0,!1,"")}catch(s){Kt.show("La acción falló: "+s,{position:"bottom-start",duration:6e3,theme:"error"})}},ra=(e,t)=>{const a=e.contextSelectors??[],s=e.contextActions??[];return a.length===0&&s.length===0?l:o`${a.map(i=>o`
...
`:l}
                ...
                <vaadin-app-layout style="${t?.style}" class="${t?.cssClasses}" .drawerOpened=${!t.drawerClosed}>
                    ...
                    <vaadin-scroller slot="drawer" class="p-s"
                        ...
                        ${t.menu&&t.totalMenuOptions>10?o`
                            <vaadin-text-field style="width: calc(100% - 20px); padding-left: 10px; padding-right: 10px;" @value-changed="${f=>Jc(f,e)}">
            ...
            <slot></slot>
       `},Qc=(e,t)=>t!=null&&e!=null&&!e.has(t),Xc=typeof HTMLElement<"u"?HTMLElement:class{};class Zc extends Xc{static get observedAttributes(){return["type","renderer"]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){const t=this.getAttribute("type")??"unknown",a=this.getAttribute("renderer")??"unknown";this.shadowRoot||this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host { display: block; }
                .mateu-unsupported {
                    box-sizing: border-box;
        ...
        `}}typeof customElements<"u"&&!customElements.get("mateu-unsupported")&&customElements.define("mateu-unsupported",Zc);const Ki=new Set,eu=(e,t,a)=>{const s=`${a}/${t}`;return Ki.has(s)||(Ki.add(s),console.warn(`[mateu] Component type "${t}" is not supported by the "${a}" renderer — rendering <mateu-unsupported> placeholder.`)),o`<mateu-unsupported
            type="${t}"
            renderer="${a}"
            data-component-id="${e?.id??l}"
            slot="${e?.slot??l}"
    ></mateu-unsupported>`};class tu{renderFilterBar(t,a,s,i,r,n,d,c){const h=a?.metadata,p=v=>{const{fieldId:C,value:w}=v.detail;t.state={...t.state,[C]:w}},f=v=>{const{fieldIds:C}=v.detail,w={};C.forEach(g=>{w[g]=void 0}),w.searchText=void 0,t.state={...t.state,...w}};return o`
            <mateu-filter-bar
                .metadata="${h}"
        ...
        <mateu-table id="${t.id}"
                     ...
                     baseUrl="${s}"
        ></mateu-table>
        `}rendererName(){return this.constructor?.name??"unknown"}supportedClientSideTypes(){}renderClientSideComponent(t,a,s,i,r,n,d,c){const h=a?.metadata?.type??a?.type,p=Object.values(m).includes(h)?h:void 0;return Qc(this.supportedClientSideTypes(),p)?eu(a,p,this.rendererName()):Ci(t,a,s,i,r,n,d,c)}renderAppComponent(t,a,s,i,r,n,d){return Yc(t,a?.metadata,s,i,r,n,d)}}class au extends tu{rendererName(){return"vaadin"}renderClientSideComponent(t,a,s,i,r,n,d,c){return super.renderClientSideComponent(t,a,s,i,r,n,d,c)}}U.set(new au);
