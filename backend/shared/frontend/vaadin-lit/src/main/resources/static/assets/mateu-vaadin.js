...
import{f as nr,m as lr,o as dr,b as cr,e as tt,i as ur,s as hr,j as pr,k as mr,t as vr,u as fr,l as br,_ as ce,n as Xe,p as gr,q as $r,v as ti,w as ms,N as zt,x as gi,y as vs,z as Pi,A as yr,B as fs,C as xr}from"./vendor-vaadin.js";import{a as $,j as u,k as Re,i as w,x as o,m as x,p as b,A as l,q as Ee,l as E,D as bs,c as B,r as wr}from"./vendor-lit.js";import{S as kr,a as Cr,n as ge,b as _r}from"./vendor.js";import"./vendor-ui5.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=a(i);fetch(i.href,r)}})();const gs=document.createElement("style");gs.innerHTML=`
${nr.cssText}
${lr.cssText}
${dr.cssText}
${cr.cssText}
...
${fr.cssText}
${br.cssText}
`;document.body.appendChild(gs);const Ot=new kr,H={value:{}},fa={value:{}},Sr={lon:0,lat:0},Ki=3,Ir=e=>{if(!e)return;const t=e.split(",").map(i=>i.trim());if(t.length!==2)return;const a=Number(t[0]),s=Number(t[1]);if(!(t[0]===""||t[1]===""||!Number.isFinite(a)||!Number.isFinite(s)))return{lon:s,lat:a}},Er=e=>{if(e==null||e.trim()==="")return Ki;const t=Number(e);return Number.isFinite(t)?t:Ki};var Pr=Object.defineProperty,Or=Object.getOwnPropertyDescriptor,ai=(e,t,a,s)=>{for(var i=s>1?void 0:s?Or(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Pr(t,a,i),i};let Jt=class extends w{constructor(){super(...arguments),this.renderSeq=0}updated(e){super.updated(e),this.createMap()}disconnectedCallback(){super.disconnectedCallback(),this.map?.setTarget(void 0),this.map=void 0}async createMap(){const e=++this.renderSeq,[{default:t},{default:a},{default:s},{default:i},{fromLonLat:r},{default:n}]=await Promise.all([ce(()=>import("./vendor-ol.js").then(c=>c.M),[]),ce(()=>import("./vendor-ol.js").then(c=>c.V),[]),ce(()=>import("./vendor-ol.js").then(c=>c.T),[]),ce(()=>import("./vendor-ol.js").then(c=>c.O),[]),ce(()=>import("./vendor-ol.js").then(c=>c.p),[]),ce(()=>import("./vendor-ol.js").then(c=>c.o),[])]);if(e!==this.renderSeq||!this.isConnected)return;if(!this.shadowRoot.querySelector("style[data-ol]")){const c=document.createElement("style");c.setAttribute("data-ol",""),c.textContent=n,this.shadowRoot.appendChild(c)}this.map&&(this.map.setTarget(void 0),this.map=void 0);const d=Ir(this.position)??Sr;this.map=new t({target:this.mapElement,layers:[new s({source:new i})],view:new a({center:r([d.lon,d.lat]),zoom:Er(this.zoom)})})}render(){return o`<div id="map"></div>`}};Jt.styles=$`
        :host {
            display: block;
            width: 100%;
            height: 25rem;
    ...
    `;ai([u()],Jt.prototype,"position",2);ai([u()],Jt.prototype,"zoom",2);ai([Re("#map")],Jt.prototype,"mapElement",2);Jt=ai([x("mateu-map")],Jt);const Tr=typeof HTMLElement<"u"?HTMLElement:class{};class zr extends Tr{static get observedAttributes(){return["content"]}#e;#t=0;get content(){return this.#e}set content(t){this.#e=t,this.#a()}attributeChangedCallback(t,a,s){this.content=s??void 0}connectedCallback(){this.style.display="block",this.#a()}async#a(){if(!this.isConnected)return;const t=this.#e??"",a=++this.#t,[{marked:s},{default:i}]=await Promise.all([ce(()=>import("./vendor.js").then(r=>r.f),[]),ce(()=>import("./vendor.js").then(r=>r.c),[])]);a===this.#t&&(this.innerHTML=i.sanitize(await s.parse(t),{USE_PROFILES:{html:!0,svg:!0,svgFilters:!0},CUSTOM_ELEMENT_HANDLING:{tagNameCheck:r=>!0}}))}}typeof customElements<"u"&&!customElements.get("mateu-markdown")&&customElements.define("mateu-markdown",zr);var Rr=Object.defineProperty,Dr=Object.getOwnPropertyDescriptor,_a=(e,t,a,s)=>{for(var i=s>1?void 0:s?Dr(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Rr(t,a,i),i};let Rt=class extends w{constructor(){super(...arguments),this.fieldId="",this.signing=!1,this.hasStrokes=!1,this.drawing=!1,this.startStroke=e=>{const t=e.target;this.ensureCanvasSize(t),t.setPointerCapture(e.pointerId),this.drawing=!0;const a=t.getContext("2d");a.lineWidth=2,a.lineCap="round",a.lineJoin="round",a.strokeStyle=getComputedStyle(this).getPropertyValue("--lumo-body-text-color")||"#1a1a1a";const[s,i]=this.pointerPosition(e);a.beginPath(),a.moveTo(s,i),e.preventDefault()},this.stroke=e=>{if(!this.drawing)return;const a=e.target.getContext("2d"),[s,i]=this.pointerPosition(e);a.lineTo(s,i),a.stroke(),this.hasStrokes=!0,e.preventDefault()},this.endStroke=e=>{this.drawing=!1,e.target.releasePointerCapture(e.pointerId)}}emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e,fieldId:this.fieldId},bubbles:!0,composed:!0}))}canvas(){return this.renderRoot.querySelector("canvas")}pointerPosition(e){const a=e.target.getBoundingClientRect();return[e.clientX-a.left,e.clientY-a.top]}ensureCanvasSize(e){const t=e.getBoundingClientRect();(e.width!==Math.round(t.width)||e.height!==Math.round(t.height))&&(e.width=Math.round(t.width),e.height=Math.round(t.height))}clear(){const e=this.canvas();e&&e.getContext("2d").clearRect(0,0,e.width,e.height),this.hasStrokes=!1}accept(){const e=this.canvas();!e||!this.hasStrokes||(this.signing=!1,this.emit(e.toDataURL("image/png")))}renderPad(){return o`
            <canvas class="pad"
    ...
    `;Sa([u()],Dt.prototype,"fieldId",2);Sa([u()],Dt.prototype,"value",2);Sa([b()],Dt.prototype,"cameraOpen",2);Sa([b()],Dt.prototype,"cameraError",2);Dt=Sa([x("mateu-camera-capture")],Dt);var qr=Object.defineProperty,Mr=Object.getOwnPropertyDescriptor,Ia=(e,t,a,s)=>{for(var i=s>1?void 0:s?Mr(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&qr(t,a,i),i};const Ur=(e,t)=>{if(!e)return;if(Array.isArray(e)){const s=e.find(i=>i.key==t);return s?.value!=null?String(s.value):void 0}const a=e[t];return a!=null?String(a):void 0};let ut=class extends w{constructor(){super(...arguments),this.fieldId="",this.editable=!0,this.filePicked=e=>{const t=e.target,a=t.files?.[0];if(!a)return;const s=new FileReader;s.onload=()=>{const i=s.result,r=i.indexOf(","),n=i.substring(0,r).replace(";base64",`;name=${encodeURIComponent(a.name)};base64`);this.emit(n+i.substring(r))},s.readAsDataURL(a),t.value=""}}static fileName(e){if(!e)return"";if(e.startsWith("data:")){const t=e.indexOf(","),s=e.substring(5,t<0?e.length:t).split(";").find(i=>i.startsWith("name="));if(s)try{return decodeURIComponent(s.substring(5))}catch{return s.substring(5)}return"Attached file"}return e.split("/").pop()||e}emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e,fieldId:this.fieldId},bubbles:!0,composed:!0}))}triggerPick(){this.renderRoot.querySelector("input[type=file]")?.click()}render(){const e=this.value!=null&&this.value!=="",t=ut.fileName(this.value),a=e&&this.value.startsWith("data:"),s=e?o`<span class="file" title="${t}">📄 ${a?o`<a href="${this.value}" download="${t}">${t}</a>`:o`<a href="${this.value}" target="_blank">${t}</a>`}</span>`:l;return this.editable?o`
            ...
            </div>`:o`${e?s:o`<span class="empty">—</span>`}`}};ut.styles=$`
        :host {
            display: block;
        }
        .row {
    ...
    `;Ia([u()],ut.prototype,"fieldId",2);Ia([u()],ut.prototype,"value",2);Ia([u()],ut.prototype,"accept",2);Ia([u({type:Boolean})],ut.prototype,"editable",2);ut=Ia([x("mateu-file-upload")],ut);var Br=Object.defineProperty,jr=Object.getOwnPropertyDescriptor,$s=(e,t,a,s)=>{for(var i=s>1?void 0:s?jr(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Br(t,a,i),i};let qa=class extends w{constructor(){super(...arguments),this.items=[]}render(){return o`
            <ul>
    ...
    `;$s([u({type:Array})],qa.prototype,"items",2);qa=$s([x("mateu-bulleted-list")],qa);const Xt=(e,t)=>new Function(...Object.keys(t),"return `"+e+"`")(...Object.values(t)),ia=(e,t,a)=>({state:e??{},data:t??{},...a});function Pe(e,t,a,s){if(!e?.includes("${"))return e;try{return Xt(e,ia(t,a,s))}catch(i){return console.warn(`Mateu: could not interpolate "${e}":`,i),e}}const It=(e,t,a)=>{if(e&&e.indexOf("${")>=0)try{return Xt(e,ia(t,a))}catch(s){return s.message}return e},ii=(e,t,a,s,i)=>{if(!e)return e;const r=ia(t,a,{appState:s??{},appData:i??{}});let n=e;try{if(n=Xt(e,r),n.includes("${"))try{n=Xt(n,r)}catch(d){n="when evaluating nested "+e+" :"+d+", where data is "+a+" and state is "+t+" and app state is "+s+" and app data is "+i,console.error(d,n,t,a,s,i)}}catch(d){n="when evaluating "+e+" :"+d+", where data is "+a+" and state is "+t+" and app state is "+s+" and app data is "+i,console.error(d,n,t,a,s,i)}return n},ys=(e,t,a,s,i,r)=>{const n=ia(t,a,{appState:s??{},appData:i??{},...r}),d=Xt(e,n);return new Function(...Object.keys(n),`return (${d})`)(...Object.values(n))},xs=(e,t,a,s)=>{const i=ia(t,a,s);return new Function(...Object.keys(i),`return (${e})`)(...Object.values(i))},Vr=(e,t,a,s)=>Xt(e,ia(t,a,s)),ws=(e,t)=>{const a=e.toLowerCase().split("+");return t.ctrlKey===a.includes("ctrl")&&t.altKey===a.includes("alt")&&t.shiftKey===a.includes("shift")&&t.metaKey===a.includes("meta")},Wr=(e,t)=>{if(!ws(e,t))return!1;const a=e.toLowerCase().split("+"),s=a[a.length-1];return!!(t.key.toLowerCase()===s||/^[a-z]$/.test(s)&&t.code==="Key"+s.toUpperCase()||/^[0-9]$/.test(s)&&(t.code==="Digit"+s||t.code==="Numpad"+s))},Hr=e=>e?e.split("+").map(t=>t.length<=1?t.toUpperCase():t.charAt(0).toUpperCase()+t.slice(1)).join("+"):void 0;var ue=(e=>(e.ServerSide="ServerSide",e.ClientSide="ClientSide",e))(ue||{}),v=(e=>(e.Page="Page",e.Div="Div",e.Element="Element",e.MicroFrontend="MicroFrontend",e.Form="Form",e.Crud="Crud",e.Result="Result",e.Card="Card",e.Directory="Directory",e.Stepper="Stepper",e.HorizontalLayout="HorizontalLayout",e.VerticalLayout="VerticalLayout",e.SplitLayout="SplitLayout",e.MasterDetailLayout="MasterDetailLayout",e.TabLayout="TabLayout",e.AccordionLayout="AccordionLayout",e.FormLayout="FormLayout",e.FormRow="FormRow",e.FormItem="FormItem",e.BoardLayout="BoardLayout",e.BoardLayoutRow="BoardLayoutRow",e.BoardLayoutItem="BoardLayoutItem",e.Scroller="Scroller",e.FullWidth="FullWidth",e.Container="Container",e.FormField="FormField",e.Table="Table",e.App="App",e.Text="Text",e.Avatar="Avatar",e.Chat="Chat",e.AvatarGroup="AvatarGroup",e.Badge="Badge",e.Breadcrumbs="Breadcrumbs",e.Anchor="Anchor",e.Button="Button",e.Chart="Chart",e.Icon="Icon",e.ConfirmDialog="ConfirmDialog",e.ContextMenu="ContextMenu",e.CookieConsent="CookieConsent",e.Details="Details",e.Dialog="Dialog",e.Drawer="Drawer",e.Image="Image",e.Map="Map",e.Markdown="Markdown",e.Notification="Notification",e.ProgressBar="ProgressBar",e.Popover="Popover",e.CarouselLayout="CarouselLayout",e.Tooltip="Tooltip",e.MessageInput="MessageInput",e.MessageList="MessageList",e.CustomField="CustomField",e.MenuBar="MenuBar",e.Grid="Grid",e.GridColumn="GridColumn",e.GridGroupColumn="GridGroupColumn",e.VirtualList="VirtualList",e.FormSection="FormSection",e.FormSubSection="FormSubSection",e.Bpmn="Bpmn",e.Workflow="Workflow",e.WorkflowElk="WorkflowElk",e.FormEditor="FormEditor",e.MetricCard="MetricCard",e.Scoreboard="Scoreboard",e.DashboardPanel="DashboardPanel",e.DashboardLayout="DashboardLayout",e.FoldoutLayout="FoldoutLayout",e.HeroSection="HeroSection",e.EmptyState="EmptyState",e.Skeleton="Skeleton",e.Gantt="Gantt",e.PlanningBoard="PlanningBoard",e.Kanban="Kanban",e.Timeline="Timeline",e.ProgressSteps="ProgressSteps",e.Stat="Stat",e.Calendar="Calendar",e.PricingTable="PricingTable",e.OrgChart="OrgChart",e.Heatmap="Heatmap",e.Funnel="Funnel",e.TrendChart="TrendChart",e.FeatureGrid="FeatureGrid",e.Testimonials="Testimonials",e.Faq="Faq",e.CalloutCard="CalloutCard",e.CommentThread="CommentThread",e.FileList="FileList",e.Checklist="Checklist",e.ComparisonCard="ComparisonCard",e.EntityHeader="EntityHeader",e.Meter="Meter",e.TaskProgress="TaskProgress",e.StatusList="StatusList",e.BulletedList="BulletedList",e.Separator="Separator",e.Notice="Notice",e.TaskQueue="TaskQueue",e.ResourceGrid="ResourceGrid",e.OfferCard="OfferCard",e.AddOnPicker="AddOnPicker",e.Ledger="Ledger",e.PaymentPicker="PaymentPicker",e.ProcessMonitor="ProcessMonitor",e))(v||{});const Oi="mateu-app-context",ks="mateu-app-context-labels",Cs=e=>{try{return JSON.parse(localStorage.getItem(e)??"{}")}catch{return{}}},Yi=(e,t)=>{try{localStorage.setItem(e,JSON.stringify(t))}catch{}},Ti=()=>Cs(Oi),_s=()=>Cs(ks),Gr=(e,t,a)=>{const s=Ti(),i=_s();t==null||t===""?(delete s[e],delete i[e]):(s[e]=t,a!==void 0&&(i[e]=a)),Yi(Oi,s),Yi(ks,i)};let Ji=!1;const Kr=()=>{Ji||(Ji=!0,window.addEventListener("storage",e=>{e.key===Oi&&e.newValue!==e.oldValue&&window.location.reload()}))},Yr=(e,t)=>new Promise((a,s)=>{let i=!1;const r={retry:()=>{i||(i=!0,t().then(a,s))},giveUp:()=>{i||(i=!0,s(e))}},n=new CustomEvent("mateu-session-expired",{detail:r,cancelable:!0,bubbles:!1});typeof document<"u"&&!document.dispatchEvent(n)||r.giveUp()}),Jr=(e,t)=>e.includes("json")?!0:t!==null&&typeof t=="object",Xr=(e,t)=>{const a=e.finalUrl;if(!a)return;const s=typeof window<"u"?window.location.href:void 0;let i;try{i=new URL(e.requestedUrl,s).href}catch{return}if(i!==a&&!Jr(e.contentType??"",e.data))return a};let Yt=[];class Qr{constructor(){this.axiosInstance=Cr.create({timeout:6e4}),this.axiosInstance.interceptors.request.use(t=>(this.addAuthToken(t),this.addSessionId(t),t)),this.axiosInstance.interceptors.response.use(t=>{const a=Xr({requestedUrl:this.axiosInstance.getUri(t.config),finalUrl:t.request?.responseURL,contentType:String(t.headers?.["content-type"]??""),data:t.data});if(a)throw window.location.assign(a),Object.assign(new Error("session lost — redirecting to "+a),{code:"ERR_CANCELED"});return t},t=>{const a=t;if(a?.response?.status===401&&a.config&&!a.config.__mateuRetried){const s=a.config;return s.__mateuRetried=!0,Yr(t,()=>this.axiosInstance.request(s))}throw t})}addSessionId(t){let a=sessionStorage.getItem("__mateu_sesion_id");a||(a=ge(),sessionStorage.setItem("__mateu_sesion_id",a)),t.headers["X-Session-Id"]=a}addAuthToken(t){const a=localStorage.getItem("__mateu_auth_token");a&&(t.headers.Authorization="Bearer "+a)}async wrap(t,a,s,i){return s||a.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),t.then(r=>(a.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:i}})),r)).catch(r=>{throw r?.code=="ERR_CANCELED"?a.dispatchEvent(new CustomEvent("backend-cancelled-event",{bubbles:!0,composed:!0,detail:{}})):a.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:i,reason:this.serialize(r)}})),r})}serialize(t){return t?.message?t:JSON.stringify(t)}async get(t){const a=new AbortController;return Yt=[...Yt,a],this.axiosInstance.get(t,{signal:a.signal})}async post(t,a){const s=new AbortController;return Yt=[...Yt,s],this.axiosInstance.post(t,a,{signal:s.signal})}async abortAll(){Yt.forEach(t=>t.abort()),Yt=[]}async runAction(t,a,s,i,r,n,d,c,h,p,m){return a&&a.startsWith("/")&&(a=a.substring(1)),n={...Ti(),...n},await this.wrap(this.post(t+"/mateu/v3/sync/"+(a&&a!=""?a:"_no_route"),{serverSideType:d,appState:n,componentState:c,parameters:h,initiatorComponentId:r,consumedRoute:s,route:a&&a!=""?"/"+a:"",actionId:i}).then(f=>f.data),p,m,i)}}const sa=new Qr;var ba=(e=>(e.Add="Add",e.Replace="Replace",e.ReplaceKeepData="ReplaceKeepData",e))(ba||{}),Je=(e=>(e.HAMBURGUER_MENU="HAMBURGUER_MENU",e.MENU_ON_LEFT="MENU_ON_LEFT",e.MENU_ON_TOP="MENU_ON_TOP",e.TABS="TABS",e.TILES="TILES",e.RAIL="RAIL",e.AUTO="AUTO",e.MEDIATOR="MEDIATOR",e))(Je||{}),Zr=Object.defineProperty,Ss=(e,t,a,s)=>{for(var i=void 0,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(t,a,i)||i);return i&&Zr(t,a,i),i};class si extends w{constructor(){super(...arguments),this.id="",this.baseUrl="",this.callbackToken="",this.createElement=t=>{const a=t.data,s=document.createElement(a.name);for(let i in a.attributes)s.setAttribute(i,a.attributes[i]);for(let i in a.on)s.addEventListener(i,r=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.on[i],parameters:{event:r}},bubbles:!0,composed:!0}))});return s},this.closeModal=()=>{const t=(this.shadowRoot??this).querySelectorAll("mateu-dialog, mateu-drawer");if(t&&t.length>0){t[t.length-1].close(),this.removeTopOverlayChild();return}this.dispatchEvent(new CustomEvent("close-modal-requested",{bubbles:!0,composed:!0}))},this.changeFavicon=t=>{let a=document.querySelector('link[rel="icon"]');a!==null?a.setAttribute("href",t):(a=document.createElement("link"),a.setAttribute("rel","icon"),a.setAttribute("href",t),document.head.appendChild(a))}}connectedCallback(){super.connectedCallback(),this.upstreamSubscription=Ot.subscribe(t=>{if(t.command){const a=t.command;this.id==a.targetComponentId&&this.applyCommand(a)}if((!t.callbackToken||!this.callbackToken||t.callbackToken===this.callbackToken)&&t.fragment){const a=t.fragment;this.id==a.targetComponentId&&(this.applyFragment(a),this.completeMenu(a))}})}completeMenu(t){if(t.component&&t.component.type==ue.ClientSide){const a=t.component,s=a.metadata;if(s?.type==v.App){const i=s,r=this.getRemoteMenus(i.menu);if(r.length>0){const n=r.map(d=>sa.runAction(d.baseUrl,d.route,"_empty","",d.baseUrl+"#"+d.route,void 0,void 0,void 0,d.params,this,!0));Promise.all(n).then(d=>{i.menu=this.updateMenu(i.menu,d.map(c=>c.fragments).filter(c=>c).map(c=>c).flat()),i.variant=Je.MENU_ON_TOP,Ot.next({fragment:{component:a,data:void 0,state:void 0,action:ba.Replace,targetComponentId:this.id,containerId:void 0},callbackToken:this.callbackToken})})}}}}updateMenu(t,a){const s=[];return t.forEach(i=>{if(i.remote){const r=a.find(n=>n.targetComponentId==i.baseUrl+"#"+i.route);if(r&&r.component?.type==ue.ClientSide){const n=r.component;if(n.metadata?.type==v.App){const d=n.metadata,c=i.serverSideType&&i.serverSideType!=""?i.serverSideType:d.serverSideType;this.changeBaseUrl(d.menu,i.baseUrl,c,i.route,d.route),s.push(...d.menu)}}}else s.push(i)}),s}changeBaseUrl(t,a,s,i,r){t.forEach(n=>{n.baseUrl||(n.submenus&&n.submenus.length>0?this.changeBaseUrl(n.submenus,a,s,i,r):(n.consumedRoute=r??"",n.baseUrl=a,n.serverSideType=s,n.uriPrefix=i))})}getRemoteMenus(t){const a=[];return t.forEach(s=>{s.remote&&a.push(s)}),a}disconnectedCallback(){super.disconnectedCallback(),this.upstreamSubscription?.unsubscribe()}applyCommand(t){if(t.type=="SetWindowTitle"&&(document.title=t.data),t.type=="SetFavicon"&&this.changeFavicon(t.data),t.type=="DispatchEvent"&&this.dispatchNamedEvent(t.data),t.type=="NavigateTo"){const a=t.data;a&&(a.startsWith("http:")||a.startsWith("https:")?window.open(t.data,"_blank"):window.location.href=t.data)}if(t.type=="PushStateToHistory"){const a=t.data;a!==void 0&&this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:a},bubbles:!0,composed:!0}))}if(t.type=="RunAction"){const a=t.data;if(a&&a.actionId)if(a.targetComponentId){const s={command:{type:"RunAction",data:{actionId:a.actionId},targetComponentId:a.targetComponentId},fragment:void 0,ui:void 0,error:void 0,callbackToken:""};setTimeout(()=>Ot.next(s))}else this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.actionId,parameters:{}},bubbles:!0,composed:!0}))}if(t.type=="MarkAsDirty"&&this.dispatchEvent(new CustomEvent("dirty",{detail:{},bubbles:!0,composed:!0})),t.type=="MarkAsClean"&&this.dispatchEvent(new CustomEvent("clean",{detail:{},bubbles:!0,composed:!0})),t.type=="DownloadFile"){const a=t.data;if(a&&a.base64Content){const s=atob(a.base64Content),i=new Uint8Array(s.length);for(let c=0;c<s.length;c++)i[c]=s.charCodeAt(c);const r=new Blob([i],{type:a.mimeType}),n=URL.createObjectURL(r),d=document.createElement("a");d.href=n,d.download=a.filename??"export",d.click(),URL.revokeObjectURL(n)}}if(t.type=="CloseModal"&&(this.closeModal(),this.dispatchNamedEvent(t.data)),t.type=="AddContentToHead"){const a=t.data;if(a&&a.name){if(a.attributes&&a.attributes.id&&document.getElementById(a.attributes.id))return;document.head.appendChild(this.createElement(t))}}if(t.type=="AddContentToBody"){const a=t.data;if(a&&a.name){if(a.attributes&&a.attributes.id&&document.getElementById(a.attributes.id))return;document.body.appendChild(this.createElement(t))}}}dispatchNamedEvent(t){if(t&&t.eventName){const a=this.component,s=a?.emitsName??a?.serverSideType;let i=t.payload??t.detail;s&&i&&typeof i=="object"&&(i={...i,__source:s}),this.dispatchEvent(new CustomEvent(t.eventName,{detail:i,bubbles:!0,composed:!0}))}}removeTopOverlayChild(){const t=this.component?.children;if(t)for(let a=t.length-1;a>=0;a--){const s=t[a]?.metadata?.type;if(s==v.Drawer||s==v.Dialog){t.splice(a,1);return}}}}Ss([u()],si.prototype,"id");Ss([u()],si.prototype,"baseUrl");var eo=Object.defineProperty,to=(e,t,a,s)=>{for(var i=void 0,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(t,a,i)||i);return i&&eo(t,a,i),i};class ri extends si{applyFragment(t){}manageActionRequestedEvent(t){}}to([u()],ri.prototype,"component");const Fa=e=>!!e&&typeof e=="object"&&"__mateuGroup"in e,$i=e=>String(e??""),ao=(e,t,a)=>{const s=e??[];if(!t||!a||a.length===0)return s;const i=[];let r,n=!1;return s.forEach((d,c)=>{const h=$i(d?.[t]);if(!n||h!==r){const p=a.find(m=>$i(m.value)===h)??{value:h,count:s.filter(m=>$i(m?.[t])===h).length,aggregates:{}};i.push({__mateuGroup:p,__mateuGroupBy:t,_rowNumber:`__mateuGroup:${c}:${h}`}),n=!0,r=h}i.push(d)}),i},Is=(e,t)=>e==null?"":t.dataType==="money"||t.stereotype==="money"?new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(e):t.aggregate==="count"?new Intl.NumberFormat(void 0,{maximumFractionDigits:0}).format(Math.round(e)):new Intl.NumberFormat(void 0,{maximumFractionDigits:2}).format(e),io=(e,t)=>e&&t.includes(e)?e:t.find(a=>!!a),so=(e,t,a)=>{const s=e.__mateuGroup;return t.id===a?`${s.value} (${s.count})`:t.aggregate?Is(s.aggregates?.[t.id],t):""},ro=(e,t,a)=>{const s=t?.aggregates;if(!s||!e.some(n=>n.aggregate))return;const i={};e.forEach(n=>{n.aggregate&&s[n.id]!=null&&(i[n.id]=Is(s[n.id],n))});const r=e[0];if(r&&i[r.id]===void 0){const n=t?.page?.totalElements;i[r.id]=a&&r.id===a&&n!=null?`Total (${n})`:"Total"}return i};var va=(e=>(e.NONE="NONE",e.INFO="INFO",e.SUCCESS="SUCCESS",e.WARNING="WARNING",e.DANGER="DANGER",e))(va||{});const oo=(e,t,a)=>{const s=e[a.path];return s?o`<span theme="badge pill ${oi(s.type)}">${s.message}</span>`:o``},oi=e=>{switch(e){case va.SUCCESS:return"success";case va.WARNING:return"warning";case va.DANGER:return"error";case va.NONE:return"contrast"}return""},no=(e,t,a)=>{const i=e[a.path]?"vaadin:check":"vaadin:minus";return o`<vaadin-icon 
            ...
            ></vaadin-icon>`},lo=(e,t,a,s,i)=>{const r=e[a.path];let n=r;return s=="money"&&r&&r.locale&&r.currency?n=new Intl.NumberFormat(r.locale,{style:"currency",currency:r.currency}).format(r.value):i=="money"&&(n=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(r)),o`${n}`},Xi=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},co=(e,t,a,s,i,r)=>{const n=a.xcolumn??r;if(n.text){if(n.actionId)return o`<a href="javascript: void(0);" @click="${h=>Xi(a,n,e)}">${n.text}</a>`;const c=e[a.path];return o`<a href="${c}">${n.text}</a>`}if(s=="string"){if(n.actionId){const h=e[a.path];return o`<a href="javascript: void(0);" @click="${p=>Xi(a,n,e)}">${h}</a>`}const c=e[a.path];return o`<a href="${c}">${c}</a>`}const d=e[a.path];return o`<a href="${d.href}">${d.text}</a>`},uo=(e,t,a,s,i)=>s=="string"?e[a.path].split(",").map(d=>o`<vaadin-icon icon="${d}" style="width: 16px;"></vaadin-icon>`):e[a.path].split(",").map(n=>o`<vaadin-icon icon="${n.icon}" style="width: 16px;"></vaadin-icon>`),ho=(e,t,a,s,i)=>{const r=e[a.path];return o`${Ee(r)}`},po=(e,t,a,s,i,r)=>{if(s=="string"){const d=e[a.path],c="max-height: 40px; "+(r.style??"");return o`<img src="${d}" style="${c}">`}const n=e[a.path];return o`<img src="${n.src}" style="${r.style??""}">`},mo=e=>{const t={_clickedRow:e.target.row};e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-"+e.detail.value.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},Qi=e=>{const t={_clickedRow:e.target.row},a=e.target.action;e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-"+a.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},vo=e=>{const t=document.createElement("vaadin-context-menu-item"),a=document.createElement("vaadin-icon");return a.style.color="var(--lumo-secondary-text-color)",a.style.marginInlineEnd="var(--lumo-space-s)",a.style.padding="var(--lumo-space-xs)",a.setAttribute("icon",e.icon),t.appendChild(a),e.label&&t.appendChild(document.createTextNode(e.label)),t.disabled=e.disabled,t},Zi=(e,t,a)=>{const s=e[a.path]?.actions?.map(i=>i.icon?{component:vo(i),methodNameInCrud:i.methodNameInCrud}:{...i,text:i.label});return!s||s.length==0?o``:o`
                                     <vaadin-menu-bar
                                         ...
                                         @item-selected="${mo}"
                                     ></vaadin-menu-bar>
                                   `},fo=(e,t,a)=>{if(a.path=="select"){const r={actionId:a.path,icon:"",label:"Select",disabled:!1,methodNameInCrud:"select"};return o`
         <vaadin-button theme="tertiary" title="Select" @click="${Qi}" .row="${e}" .action="${r}">
             Select
         </vaadin-button>
    `}const s=a.path&&e[a.path]?.methodNameInCrud?e[a.path]:e.action;if(!s)return o``;const i=s.icon&&!s.label;return o`
         <vaadin-button theme="tertiary${i?" icon":""}" title="${s.label||l}" @click="${Qi}" .row="${e}" .action="${s}">
             ${s.icon?o`<vaadin-icon icon="${s.icon}"></vaadin-icon>`:l}
             ${s.label?s.label:l}
         </vaadin-button>
    `},bo=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},go=(e,t,a,s,i,r)=>{const n=a.xcolumn??r;if(n.actionId){const c=n.text||e[a.path];return o`
            <vaadin-button theme="tertiary" @click="${h=>bo(a,n,e)}" .row="${e}">
                ${c}
            </vaadin-button>
        `}const d=e[a.path];return o`<a href="${d}">${n.text||d}</a>`};class $o{constructor(){this.afterRenderHook=void 0,this.useShadowRoot=!0,this.componentRenderer=void 0}set(t){if(this.componentRenderer=t,typeof window<"u"){const a=t.supportedClientSideTypes?.();window.__mateuRendererInfo={name:t.rendererName?.()??t.constructor?.name??"unknown",supportedTypes:a?[...a].sort():null}}}get(){return this.componentRenderer}setUseShadowRoot(t){this.useShadowRoot=t}mustUseShadowRoot(){return this.useShadowRoot}setAfterRenderHook(t){this.afterRenderHook=t}getAfterRenderHook(){return this.afterRenderHook}}const W=new $o,Et=(e,t,a,s,i,r,n,d,c)=>(t.slot=d,C(e,t,a,s,i,r,n,c)),C=(e,t,a,s,i,r,n,d)=>{if(!t)return o``;if(t.type==ue.ClientSide)return W.get().renderClientSideComponent(e,t,a,s,i,r,n,d);const c=e.route,h=e.consumedRoute;return o`
        ...
        >
                ...
                .selectedItem=${f}
                @selected-item-changed=${y=>{const g=y.detail.value,I=g?g.value:null;String(I??"")!==d&&(g&&wo(e,t.id,g.label),r(I))}}></vaadin-combo-box>`}default:return o`<vaadin-text-field theme="small" style="width:100%;" .value=${d} @change=${c=>r(c.target.value)}></vaadin-text-field>`}},yi=e=>gr(()=>o`<span title="${e}" style="white-space:normal;overflow-wrap:break-word;">${e}</span>`,[e]),xi=e=>e!==void 0?$r(()=>o`<span style="font-weight: 600; white-space: nowrap;">${e}</span>`,[e]):l,Co=e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget?.dispatchEvent(new CustomEvent("sort-direction-changed",{detail:{grid:e.currentTarget.parentElement},bubbles:!0,composed:!0}))},_o=(e,t,a,s,i,r,n,d)=>{const c=Pe(e.label,s,i);return o`
<vaadin-grid-column-group header="${c}">
    ${e.columns.map(h=>Es(h.metadata,t,a,s,i,r,n,d?.[h.metadata?.id]))}
</vaadin-grid-column-group>
`},zi=(e,t,a,s,i,r,n,d)=>v.GridGroupColumn==e.metadata?.type?_o(e.metadata,t,a,s,i,r,n,d):Es(e.metadata,t,a,s,i,r,n,d?.[e.metadata?.id]),Es=(e,t,a,s,i,r,n,d)=>{const c=Pe(e.label,s,i);return e.sortable?o`
                        <vaadin-grid-sort-column
                                ...
                                ${yi(c)}
                                ${xi(d)}
                                ${Xe((h,p,m)=>Na(h,p,m,e,t,a,s,i,r,n),[])}
                        ></vaadin-grid-sort-column>
                    `:e.filterable?o`
                    ...
                    `:o`
                        <vaadin-grid-column
                                ...
                                ${Xe((h,p,m)=>Na(h,p,m,e,t,a,s,i,r,n),[])}
                        ></vaadin-grid-column>
                    `},Na=(e,t,a,s,i,r,n,d,c,h)=>{const p=a.dataset.dataType??"",m=a.dataset.stereotype??"";if(Fa(e)){const k=i?.metadata,y=(k?.columns??[]).flatMap(R=>R?.metadata?.type===v.GridGroupColumn?(R.metadata.columns??[]).map(Q=>Q?.metadata?.id):[R?.metadata?.id]),g=io(e.__mateuGroupBy,y),I=so(e,s,g),j=e.__mateuGroup.hiddenActions??[],ne=s.id===y[y.length-1]?(k?.groupActions??[]).filter(R=>!j.includes(R.actionId??R.id)):[];return ne.length?o`<span style="display: flex; align-items: center; justify-content: flex-end; gap: var(--lumo-space-s); overflow: hidden;">
            ...
            <vaadin-grid
                    ...
                    ${E(this.field?.detailPath?ms(a=>o`${C(this,a[this.field?.detailPath],this.baseUrl,this.state,this.data,this.appState,this.appData)}`):void 0)}
            ...
            >
                ...
                `}
                ${this.field?.columns?.map(a=>zi(a,this,this.baseUrl,this.state,this.data,this.appState,this.appData))}
            ...
            ${this.field?.readOnly?l:this.field?.inlineEditing?o`
                ...
                `}
        </vaadin-vertical-layout>`}};Ne.styles=$`
        ${tt}
    ...
    `;$t([u()],Ne.prototype,"field",2);$t([u()],Ne.prototype,"state",2);$t([u()],Ne.prototype,"data",2);$t([u()],Ne.prototype,"appState",2);$t([u()],Ne.prototype,"appData",2);$t([u()],Ne.prototype,"selectedItems",2);$t([b()],Ne.prototype,"detailsOpenedItems",2);Ne=$t([x("mateu-grid")],Ne);var Oo=Object.defineProperty,To=Object.getOwnPropertyDescriptor,ra=(e,t,a,s)=>{for(var i=s>1?void 0:s?To(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Oo(t,a,i),i};let ht=class extends w{constructor(){super(...arguments),this.getNewValue=e=>{if(this.field?.dataType=="array"){if(!this.value)return[e];const t=this.value;return t.indexOf(e)>=0?t.filter(a=>a!==e):[...t,e]}return e}}render(){let e=this.field?.options;if(this.field?.remoteCoordinates){const a=this.field.remoteCoordinates;this.data?.[this.field.fieldId]&&this.data[this.field.fieldId].content&&this.data[this.field.fieldId].totalElements?e=this.data[this.field.fieldId].content:this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a.action,parameters:{searchText:"",fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0}))}const t=this.field?.attributes?.divStyle;return o`
  ...
  `;ra([u()],ht.prototype,"field",2);ra([u()],ht.prototype,"baseUrl",2);ra([u()],ht.prototype,"state",2);ra([u()],ht.prototype,"data",2);ra([u()],ht.prototype,"value",2);ht=ra([x("mateu-choice")],ht);var zo=Object.defineProperty,Ro=Object.getOwnPropertyDescriptor,je=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ro(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&zo(t,a,i),i};let $e=class extends w{constructor(){super(...arguments),this.currencyChanged=e=>{this.value||(this.value={value:0,currency:"EUR",locale:"es-ES"}),this.value.currency=e.detail.value,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:{...this.value},fieldId:this.fieldId}}))},this.valueChanged=e=>{this.value||(this.value={value:0,currency:"EUR",locale:"es-ES"}),e.detail.value&&(this.value.value=e.detail.value?parseFloat(e.detail.value):0,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:{...this.value},fieldId:this.fieldId}})))}}render(){return o`
            <vaadin-number-field
                    id="${this.fieldId}"
                    label="${this.label}"
...
`,this.comboRenderer=e=>o`
        ...
        `:l}
                            ...
                            `:e.label}
`,this.filteredIcons=[],this.navLinkOffset=null,this.iconFilterChanged=e=>{this.filteredIcons=ts.filter(t=>!e.detail.value||t.indexOf(e.detail.value)>=0)}}remoteComboDataProvider(e){return(t,a)=>{const{filter:s,page:i,pageSize:r}=t,n=s??"";this._comboFilter=n,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e,parameters:{searchText:s,fieldId:this.field?.fieldId,size:r,page:i,sort:void 0},callback:d=>{if(n===this._comboFilter)if(d?.messages?.forEach(c=>{zt.show(c.text,{position:c.position?this.mapPosition(c.position):void 0,theme:c.variant,duration:c.duration})}),!d.fragments||d.fragments.length==0)this.comboData=[],a([],0);else{const c=d.fragments[0].data?.[this.id];this.comboData=c?.content,a(c?.content,c?.totalElements)}},callbackonly:!0},bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.rendered=!1}renderNavLink(){const e=this.field?.link;if(!e?.href)return l;const t=Pe(e.href,this.state,this.data)??e.href,a=Pe(e.title,this.state,this.data)||t,s=e.icon||(t.startsWith("http")?"vaadin:external-link":"vaadin:link"),i=this.navLinkOffset??"calc(var(--lumo-font-size-s) * 1.6 + (var(--lumo-size-m) - var(--lumo-icon-size-s)) / 2)";return o`<a
                data-navlink
                href="${t}"
                title="${a}"
        ...
        ><vaadin-icon icon="${s}" style="width: var(--lumo-icon-size-s); height: var(--lumo-icon-size-s);"></vaadin-icon></a>`}positionNavLink(){const e=this.renderRoot?.querySelector("a[data-navlink]");e&&setTimeout(()=>{const t=e.parentElement,a=t?.firstElementChild?.firstElementChild;if(!t||!a)return;const i=(a.shadowRoot?.querySelector('[part="input-field"]')??a).getBoundingClientRect();if(i.height===0)return;const r=Math.max(0,i.top+i.height/2-e.offsetHeight/2-t.getBoundingClientRect().top),n=`${Math.round(r)}px`;this.navLinkOffset!==n&&(this.navLinkOffset=n)})}helperText(){return this.helperShownInControl=!0,Fe(this.field?.description??"",this.state,this.data)??""}render(){const e=this.field?.fieldId??"";this.rendered=!0;const t=this.renderNavLink();this.helperShownInControl=!1;const a=this.renderField(),s=this.field?.description&&!this.helperShownInControl?Fe(this.field.description,this.state,this.data):void 0;return o`<div style="display: block;">
            ...
            `:l}
        </div>`}async firstUpdated(){this.filteredIcons=ts}update(e){e.has("component")&&(this.rendered=!1),super.update(e)}updated(e){super.updated(e),this.positionNavLink()}renderField(){const e=this.field?.fieldId??"",t=this.state&&e in this.state?this.state[e]:this.field?.initialValue,a=this.field?.label+"",s=Pe(a,this.state,this.data),i=this.labelAlreadyRendered||!s||s=="null"?l:s;return this.field?.propertyRow?this.renderPropertyRowField(e,t,i,s):this.field?.stereotype=="badge"?this.renderBadgeField(e,t,i,s):this.field?.stereotype=="plainText"?this.renderPlainTextField(e,t,i,s):this.field?.stereotype=="bulletedList"?this.renderBulletedListField(e,t,i,s):this.field?.readOnly&&this.field.stereotype!="grid"&&this.field.dataType!="status"&&this.field?.dataType!="money"?this.renderReadOnlyField(e,t,i,s):this.field?.dataType=="file"?this.renderFileField(e,t,i,s):this.field?.dataType=="string"?this.renderStringField(e,t,i,s):this.field?.dataType=="number"?this.renderNumberField(e,t,i,s):this.field?.dataType=="integer"?this.renderIntegerField(e,t,i,s):this.field?.dataType=="bool"?this.renderBoolField(e,t,i,s):this.field?.dataType=="dateRange"?this.renderDateRangeField(e,t,i,s):this.field?.dataType=="date"?this.renderDateField(e,t,i,s):this.field?.dataType=="dateTime"?this.renderDateTimeField(e,t,i,s):this.field?.dataType=="time"?this.renderTimeField(e,t,i,s):this.field?.dataType=="array"?this.renderArrayField(e,t,i,s):this.field?.dataType=="money"?this.renderMoneyField(e,t,i,s):this.field?.dataType=="status"?this.renderStatusField(e,t,i,s):this.field?.dataType=="range"?this.renderRangeField(e,t,i,s):o`<p>Unknown field type ${this.field?.dataType} / ${this.field?.stereotype}</p>`}renderBadgeField(e,t,a,s){if(!this.field)return o``;const i=t===!0||t==="true";return o`<vaadin-custom-field
                    id="${this.field.fieldId}"
                    .helperText="${this.helperText()}"
                    data-colspan="${this.field?.colspan}"
                    style="${this.field?.style}"
            ><span theme="badge ${i?"success":""} pill" style="${i?"":"opacity: 0.4;"}">${s}</span>
            </vaadin-custom-field>`}renderPropertyRowField(e,t,a,s){if(!this.field)return o``;let i=Fe(t,this.state,this.data);const r=i&&typeof i=="object"&&"value"in i?i:null;i&&i.value&&(i=i.value);const n=this.field?.dataType=="bool"||i===!0||i===!1,d=this.field?.dataType=="money",c=i!=null&&i!=="";let h=c?String(i):"—";if(d&&c){const f=typeof i=="number"?i:parseFloat(String(i));isNaN(f)||(h=r&&r.locale&&r.currency?new Intl.NumberFormat(r.locale,{style:"currency",currency:r.currency}).format(f):new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(f))}const p=n?o`<vaadin-icon icon="${i===!0||i==="true"?"vaadin:check":"vaadin:minus"}" style="height: 16px; width: 16px;"></vaadin-icon>`:o`<span style="font-weight: 500; text-align: right; word-break: break-word; margin-left: auto;${d?" font-variant-numeric: tabular-nums;":""}">${h}</span>`,m=s&&s!="null";return o`<div
                    id="${this.field.fieldId}"
                    data-colspan="${this.field?.colspan}"
            ...
            >${m?o`<span style="color: var(--lumo-secondary-text-color, #888); white-space: nowrap;">${s}</span>`:l}${p}</div>`}renderBulletedListField(e,t,a,s){if(!this.field)return o``;const i=Fe(t,this.state,this.data),r=Array.isArray(i)?i.map(n=>String(n)):i!=null&&i!==""?[String(i)]:[];return o`<vaadin-custom-field
                    id="${this.field.fieldId}"
                    label="${a}"
                    .helperText="${this.helperText()}"
                    data-colspan="${this.field?.colspan}"
            ...
            </vaadin-custom-field>`}renderPlainTextField(e,t,a,s){if(!this.field)return o``;let i=Fe(t,this.state,this.data);const r=i&&typeof i=="object"&&"value"in i?i:null;i&&i.value&&(i=i.value);const n=this.field?.dataType=="bool"||i===!0||i===!1,d=this.field?.dataType=="money",c=i!=null&&i!=="";let h=c?String(i):"—";if(d&&c){const m=typeof i=="number"?i:parseFloat(String(i));isNaN(m)||(h=r&&r.locale&&r.currency?new Intl.NumberFormat(r.locale,{style:"currency",currency:r.currency}).format(m):new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(m))}const p=n?o`<vaadin-icon icon="${i===!0||i==="true"?"vaadin:check":"vaadin:minus"}" style="height: 16px; width: 16px;"></vaadin-icon>`:this.field?.multiline?o`<span style="font-weight: 500; white-space: pre-wrap; word-break: break-word;">${h}</span>`:o`<span style="font-weight: 500; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;${d?" font-variant-numeric: tabular-nums;":""}">${h}</span>`;return o`<vaadin-custom-field
                    id="${this.field.fieldId}"
                    label="${a}"
                    data-colspan="${this.field?.colspan}"
                    style="${d?"text-align: right; ":""}${this.field?.style}"
            >${p}</vaadin-custom-field>`}renderReadOnlyField(e,t,a,s){if(!this.field)return o``;let i=Fe(t,this.state,this.data)||this.data[e];if(i&&i.value&&(i=i.value),this.field.stereotype=="fileUpload")return o`<vaadin-custom-field
                        id="${this.field.fieldId}"
                        label="${a}"
                        .helperText="${this.helperText()}"
                        data-colspan="${this.field.colspan}"
...
`}renderFileField(e,t,a,s){if(!this.field)return o``;const i=t?.map(r=>({id:r.id,name:r.name,type:"",uploadTarget:"",complete:!0}))??[];return o`
            ...
            `}renderStringField(e,t,a,s){if(!this.field)return o``;if(this.field?.stereotype=="searchable"){const i=n=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"code-"+this.field?.fieldId,parameters:{code:n.currentTarget.value}},bubbles:!0,composed:!0}))},r=n=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"codesearch-"+this.field?.fieldId,parameters:{}},bubbles:!0,composed:!0}))};return o`
              ...
              ${i.description}
                ...
                `;if(this.field?.stereotype=="fileUpload"){const i=Ur(this.field.attributes,"accept");return o`
                    <vaadin-custom-field
                            id="${this.field.fieldId}"
                            label="${a}"
                            .helperText="${this.helperText()}"
  ...
  ${ti(this.renderColorPicker,[])}
  ${Pi(this.renderColorPickerFooter,[])}
></vaadin-dialog>
                `:o`
                <vaadin-text-field
                        id="${this.field.fieldId}"
...
`;if(this.field?.stereotype=="listBox"){if(this.field?.remoteCoordinates){const i=this.field.remoteCoordinates,r="";return this.data[this.id]&&(this.data[this.id].searchSignature||r)&&this.data[this.id].searchSignature!=r&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements||this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:i.action,parameters:{searchText:r,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0})),o`
            ...
            ></mateu-money-field>`}renderStatusField(e,t,a,s){if(!this.field)return o``;const i=t;return o`
                <vaadin-custom-field
                        ...
                        data-colspan="${this.field.colspan}"
                >
                    ${i?o`<span theme="badge pill ${oi(i.type)}">${i.message}</span>`:o``}                    
                </vaadin-custom-field>
  ...
  `;pe([u()],Y.prototype,"component",2);pe([u()],Y.prototype,"field",2);pe([u()],Y.prototype,"baseUrl",2);pe([u()],Y.prototype,"state",2);pe([u()],Y.prototype,"data",2);pe([u()],Y.prototype,"appState",2);pe([u()],Y.prototype,"appData",2);pe([u()],Y.prototype,"labelAlreadyRendered",2);pe([b()],Y.prototype,"colorPickerOpened",2);pe([b()],Y.prototype,"colorPickerValue",2);pe([b()],Y.prototype,"filteredIcons",2);pe([b()],Y.prototype,"navLinkOffset",2);Y=pe([x("mateu-field")],Y);const No=(e,t,a)=>{const s=e.metadata;return o`<span theme="badge ${s.color} ${s.pill?"pill":""} ${s.small?"small":""} ${s.primary?"primary":""}"
                      style="${e.style}" class="${e.cssClasses}"
                      slot="${e.slot??l}">${Fe(s.text,t,a)}</span>`},qo=(e,t,a)=>{const s=Fe(e.text,t,a);if(!s)return l;let i=Fe(e.color,t,a);return i=="SUCCESS"&&(i="success"),i=="ERROR"&&(i="error"),i=="DANGER"&&(i="error"),i=="WARNING"&&(i="warning"),i=="INFO"&&(i="info"),i=="PRIMARY"&&(i="primary"),i=="SECONDARY"&&(i="secondary"),i=="TERTIARY"&&(i="tertiary"),i=="QUATERNARY"&&(i="quaternary"),i=="LIGHT"&&(i="light"),i=="DARK"&&(i="dark"),o`<span theme="badge ${i} ${e.pill?"pill":""} ${e.small?"small":""} ${e.primary?"primary":""}">${s}</span>`};var Mo=Object.defineProperty,Uo=Object.getOwnPropertyDescriptor,Vt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Uo(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Mo(t,a,i),i};const Bo=e=>{const t=[];return e.color&&e.color!=="normal"&&e.color!=="none"&&t.push(e.color),e.buttonStyle&&t.push(e.buttonStyle==="tertiaryInline"?"tertiary-inline":e.buttonStyle),e.size&&e.size!=="none"&&e.size!=="normal"&&t.push(e.size),t.length?t.join(" "):void 0},as=e=>e==="back"||e==="backToList"||!!e&&e.startsWith("cancel");let Ze=class extends w{constructor(){super(...arguments),this.appState={},this.appData={},this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.evalLabel=e=>Pe(e,this.state,this.data),this.renderBtn=e=>{if((this.data??{})[e.actionId+".hidden"])return l;const t=this.evalLabel(e.label),a=W.get()?.renderToolbarButton?.(e,t,()=>this.handleButtonClick(e.actionId));return a||o`
        <vaadin-button
                data-action-id="${e.id}"
                theme="${Bo(e)||l}"
    ...
    `}}render(){const e=this.metadata;if(!e)return o``;const t=e.toolbar??[],a=t.filter(d=>as(d.actionId)),s=t.filter(d=>!as(d.actionId)),i=a.length>0&&s.length>0?o`<span class="toolbar-divider"></span>`:l,r=e.avatar||e.title||e.subtitle||e.kpis?.length>0||e.header?.length>0||t.length>0,n=e.level??0;return n>0?this.setAttribute("data-nested",""):this.removeAttribute("data-nested"),o`
            ...
            `:r?o`
                <div style="display: flex; gap: var(--lumo-space-m, 1rem); width: 100%; align-items: center;" class="form-header">
                    ...
                    <div style="flex: 1; min-width: 0; overflow: hidden;">
                        ${e?.title&&n==0?o`<h2 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${Ee(It(e?.title,this.state??{},this.data??{}))}</h2>`:l}
                        ${e?.title&&n==1?o`<h3 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${Ee(It(e?.title,this.state??{},this.data??{}))}</h3>`:l}
                        ${e?.title&&n==2?o`<h4 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${Ee(It(e?.title,this.state??{},this.data??{}))}</h4>`:l}
                        ${e?.title&&n==3?o`<h5 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${Ee(It(e?.title,this.state??{},this.data??{}))}</h5>`:l}
                        ${e?.title&&n>3?o`<h6 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${Ee(It(e?.title,this.state??{},this.data??{}))}</h6>`:l}

                        ${e?.subtitle?o`<span style="display: inline-block; margin-block-end: 0.83em;">${Ee(It(e?.subtitle,this.state??{},this.data??{}))}</span>`:l}
                    </div>
                    <div style="display: flex; gap: var(--lumo-space-m, 1rem); align-items: center;">
                        ${e?.kpis?.map(d=>o`
                            <div style="display: flex; flex-direction: column; align-items: center;">
                                <div>${this.evalLabel(d.title)}</div>
                                <div>${Ee(It(d.text,this.state??{},this.data??{}))}</div>
                            </div>
                        `)}
                        ${e?.header?.map(d=>C(this,d,this.baseUrl,this.state??{},this.data??{},this.appState,this.appData))}
                        ${a.map(this.renderBtn)}
            ...
            ${e.badges&&e.badges.length>0?o`
                <div style="display: flex; gap: var(--lumo-space-s, .5rem); padding-bottom: var(--lumo-space-s, .5rem);">
                    ${e.badges.map(d=>qo(d,this.state??{},this.data??{}))}
                </div>
            `:l}
        `}};Ze.styles=$`
        :host {
        ...
        ${tt}
    `;Vt([u()],Ze.prototype,"metadata",2);Vt([u()],Ze.prototype,"baseUrl",2);Vt([u()],Ze.prototype,"state",2);Vt([u()],Ze.prototype,"data",2);Vt([u()],Ze.prototype,"appState",2);Vt([u()],Ze.prototype,"appData",2);Ze=Vt([x("mateu-content-header")],Ze);var jo=Object.defineProperty,Vo=Object.getOwnPropertyDescriptor,Ea=(e,t,a,s)=>{for(var i=s>1?void 0:s?Vo(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&jo(t,a,i),i};let Lt=class extends ri{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={}}render(){const e=this.component?.metadata;return o`
    ...
    `;Ea([u()],Lt.prototype,"state",2);Ea([u()],Lt.prototype,"data",2);Ea([u()],Lt.prototype,"appState",2);Ea([u()],Lt.prototype,"appData",2);Lt=Ea([x("mateu-form")],Lt);var Wo=Object.defineProperty,Ho=Object.getOwnPropertyDescriptor,Ri=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ho(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Wo(t,a,i),i};let ga=class extends w{constructor(){super(...arguments),this.variant="text",this.count=3}render(){const e=Array.from({length:Math.max(1,this.count)});return this.variant=="card"?o`${e.map(()=>o`<div class="bone card" style="margin: .5em 0;"></div>`)}`:this.variant=="grid"?o`${e.map(()=>o`<div class="bone row"></div>`)}`:this.variant=="form"?o`${e.map(()=>o`
                <div class="form-pair">
                    <div class="bone label"></div>
                    <div class="bone field"></div>
                </div>
            `)}`:o`${e.map(()=>o`<div class="bone line"></div>`)}`}};ga.styles=$`
        :host {
            display: block;
            flex: 1 1 0;
            min-width: 6rem;
    ...
    `;Ri([u()],ga.prototype,"variant",2);Ri([u({type:Number})],ga.prototype,"count",2);ga=Ri([x("mateu-skeleton")],ga);const Go=(e,t)=>{t&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},Pt=(e,t,a,s,i,r)=>o`
        <div class="mateu-empty-state"
            ...
            ${i&&r?o`
                <vaadin-button theme="tertiary" style="margin-top: .25rem;" @click="${n=>Go(n,i)}">${r}</vaadin-button>
            `:l}
        </div>
    ...
    `};var Jo=Object.defineProperty,Xo=Object.getOwnPropertyDescriptor,De=(e,t,a,s)=>{for(var i=s>1?void 0:s?Xo(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Jo(t,a,i),i};let he=class extends w{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.detailsOpenedItems=[],this.pagesRequested=[],this.emptyArray=e=>!e||e.length==0,this.dataProvider=(e,t)=>{const a=this.data[this.id]?.page;if(this.metadata?.infiniteScrolling&&e.page>0){let s=!1;a&&a.content&&(a.content.length>=(e.page+1)*e.pageSize||a.content.length==a.totalElements)&&(t(a.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),a.totalElements),s=!0,this.grid&&this.grid.recalculateColumnWidths()),s||this.pagesRequested.find(i=>i==e.page)||(this.pagesRequested.push(e.page),this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:e,callback:()=>{this.data[this.id]?.page?.content&&(t(this.data[this.id].page.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),this.data[this.id].page.totalElements),this.grid&&this.grid.recalculateColumnWidths())}},bubbles:!0,composed:!0})))}else{const s=this.metadata?.infiniteScrolling?a?.totalElements:a?.content?.length??0;t(a?.content??[],s),this.grid&&this.grid.recalculateColumnWidths()}},this._onActionRequested=e=>{const t=e.detail,a=this.identifierFieldName;if(!a||!t.parameters||t.actionId?.startsWith("action-on-row-"))return;const s=t.parameters[a];s!==void 0&&(this.state._selectedId=String(s),this._applyCellPartNameGenerator(),this.grid?.requestContentUpdate())},this.tooltipGenerator=e=>{let t="";const{column:a,item:s}=e,i=this.metadata?.columns?.find(r=>r.metadata.id==a?.path);if(i?.metadata){const r=(i?.metadata).tooltipPath;r&&a&&s&&(t=s[r])}return t}}get identifierFieldName(){const e=this.metadata?.columns?.find(a=>a.metadata?.identifier);if(e)return e.metadata?.id;if(this.metadata?.columns?.find(a=>a.metadata?.id==="id"))return"id"}_applyCellPartNameGenerator(){if(!this.grid)return;const e=this.identifierFieldName,t=this.state?._selectedId??this.appState?._splitDetailId,a=!!this.metadata?.groupBy;e&&t!==void 0||a?this.grid.cellPartNameGenerator=(s,i)=>{const r=i.item;return Fa(r)?"mateu-group-row":e&&t!==void 0&&String(r[e])===String(t)?"selected-row":""}:this.grid.cellPartNameGenerator=null}connectedCallback(){super.connectedCallback(),this.addEventListener("action-requested",this._onActionRequested)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("action-requested",this._onActionRequested)}updated(e){super.updated(e),this._applyCellPartNameGenerator(),this.grid?.clearCache(),this.grid?.requestContentUpdate(),this.grid?.recalculateColumnWidths(),this.pagesRequested=[]}render(){const e=this.data[this.id],t=e?.page,a=this.metadata?.groupBy,s=this.metadata?.infiniteScrolling?void 0:t?.content?ao(t.content,a,e?.groups):t?.content,i=(this.metadata?.columns??[]).flatMap(c=>c.metadata?.type===v.GridGroupColumn?(c.metadata.columns??[]).map(h=>h.metadata):[c.metadata]),r=ro(i,e,a);let n="";this.metadata?.wrapCellContent&&(n+=" wrap-cell-content"),this.metadata?.compact&&(n+=" compact"),this.metadata?.noBorder&&(n+=" no-border"),this.metadata?.noRowBorder&&(n+=" no-row-borders"),this.metadata?.columnBorders&&(n+=" column-borders"),this.metadata?.rowStripes&&(n+=" row-stripes");const d=this.state[this.id+"_selected_items"]||[];return o`
            <vaadin-grid
                    ...
                    @selected-items-changed="${c=>{const h=(c.detail.value??[]).filter(p=>!Fa(p));this.emptyArray(this.state[this.id+"_selected_items"])&&this.emptyArray(h)||(this.state[this.id+"_selected_items"]=h,this.metadata?.onRowSelectionChangedActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.metadata?.onRowSelectionChangedActionId},bubbles:!0,composed:!0})))}}"
                    @active-item-changed="${E(this.metadata?.detailPath&&!this.metadata?.useButtonForDetail?c=>{if(this.metadata?.detailPath){const h=c.detail.value;if(h&&Fa(h))return;h?this.detailsOpenedItems=[h]:this.detailsOpenedItems=[]}}:void 0)}"
                    .detailsOpenedItems="${this.detailsOpenedItems}"
                    ${E(this.metadata?.detailPath?ms(c=>o`${C(this,c[this.metadata?.detailPath],this.baseUrl,this.state,this.data,this.appState,this.appData)}`):void 0)}
                    theme="${n}"
            ...
            >
                ...
                `:l}
                ${this.metadata?.columns?.map(c=>zi(c,this,this.baseUrl,this.state,this.data,this.appState,this.appData,r))}
                ${this.metadata?.useButtonForDetail?o`
                    <vaadin-grid-column
                            width="44px"
                            flex-grow="0"
                            ${Xe((c,{detailsOpened:h})=>o`
              <vaadin-button
                theme="tertiary icon"
  ...
  `;De([u()],he.prototype,"id",2);De([u()],he.prototype,"metadata",2);De([u()],he.prototype,"baseUrl",2);De([u()],he.prototype,"state",2);De([u()],he.prototype,"data",2);De([u()],he.prototype,"appState",2);De([u()],he.prototype,"appData",2);De([u()],he.prototype,"emptyStateMessage",2);De([b()],he.prototype,"detailsOpenedItems",2);De([Re("vaadin-grid")],he.prototype,"grid",2);he=De([x("mateu-table")],he);const Ps="mateu-saved-views",ni=()=>{try{return JSON.parse(localStorage.getItem(Ps)??"{}")}catch{return{}}},Di=e=>{try{localStorage.setItem(Ps,JSON.stringify(e))}catch{}},Os=e=>ni()[e]??[],Qo=(e,t)=>{const a=t.name?.trim();if(!a||Object.keys(t.values??{}).length===0)return;const s=ni(),i=(s[e]??[]).filter(r=>r.name!==a);i.push({...t,name:a}),s[e]=i,Di(s)},Zo=(e,t)=>{const a=ni(),s=(a[e]??[]).filter(i=>i.name!==t);s.length===0?delete a[e]:a[e]=s,Di(a)},en=(e,t)=>{const a=ni();a[e]=(a[e]??[]).map(s=>({...s,isDefault:s.name===t?!s.isDefault:!1})),Di(a)},tn=e=>Os(e).find(t=>t.isDefault);var an=Object.defineProperty,sn=Object.getOwnPropertyDescriptor,we=(e,t,a,s)=>{for(var i=s>1?void 0:s?sn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&an(t,a,i),i};let ae=class extends w{constructor(){super(...arguments),this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.searchOnly=!1,this.panelOpened=!1,this.viewsOpened=!1,this.draftText="",this.openPanel=()=>{this.panelOpened||this.filters.length===0||(this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick))},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1,this.activeFilter=void 0},this.clearAllFilters=()=>{const e=this.filters.flatMap(a=>this.isRangeFilter(a)?[`${a.fieldId}_from`,`${a.fieldId}_to`]:[a.fieldId]),t={searchText:void 0};e.forEach(a=>{t[a]=void 0}),this.state={...this.state,...t},this.dispatchEvent(new CustomEvent("filter-reset-requested",{detail:{fieldIds:e},bubbles:!0,composed:!0})),this.requestSearch()},this.keepFocus=e=>e.preventDefault()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}get filters(){return this.metadata?.filters??[]}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}requestSearch(){this.closePanel(),this.dispatchEvent(new CustomEvent("search-requested",{detail:{},bubbles:!0,composed:!0}))}emitValueChanged(e,t){this.state={...this.state,[e]:t},this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t,fieldId:e},bubbles:!0,composed:!0}))}applyFilter(e,t){this.emitValueChanged(e,t),this.requestSearch()}removeChip(e){const t=this.filters.find(a=>a.fieldId===e);t&&this.isRangeFilter(t)?(this.emitValueChanged(`${e}_from`,void 0),this.emitValueChanged(`${e}_to`,void 0)):this.emitValueChanged(e,e==="searchText"?"":void 0),this.requestSearch()}commitText(e){this.emitValueChanged("searchText",e.value),this.draftText="",e.value="",this.requestSearch()}get viewsScope(){return window.location.pathname}allFilterKeys(){return["searchText",...this.filters.flatMap(e=>this.isRangeFilter(e)?[`${e.fieldId}_from`,`${e.fieldId}_to`]:[e.fieldId])]}snapshotValues(){const e={};return this.state.searchText&&(e.searchText=this.state.searchText),this.filters.forEach(t=>{if(this.isSet(t))if(this.isRangeFilter(t)){const a=this.rangeBound(t,"from"),s=this.rangeBound(t,"to");a&&(e[`${t.fieldId}_from`]=a),s&&(e[`${t.fieldId}_to`]=s)}else this.isMultiFilter(t)?e[t.fieldId]=this.multiValues(t):e[t.fieldId]=this.state[t.fieldId]}),e}applyView(e){const t=this.allFilterKeys(),a={};t.forEach(s=>{a[s]=void 0}),this.state={...this.state,...a},this.dispatchEvent(new CustomEvent("filter-reset-requested",{detail:{fieldIds:t},bubbles:!0,composed:!0})),Object.entries(e.values).forEach(([s,i])=>this.emitValueChanged(s,i)),this.viewsOpened=!1,this.detachOutsideClick(),this.requestSearch()}saveCurrentView(e){const t=e.value.trim();t&&(Qo(this.viewsScope,{name:t,values:this.snapshotValues()}),e.value="",this.requestUpdate())}firstUpdated(){if(window.location.search)return;const e=tn(this.viewsScope);e&&setTimeout(()=>{this.state.searchText||this.filters.some(a=>this.isSet(a))||this.applyView(e)},0)}isBooleanFilter(e){return e.dataType==="boolean"||e.dataType==="bool"||e.stereotype==="checkbox"||e.stereotype==="toggle"}isNumericFilter(e){return["integer","decimal","number","money"].includes(e.dataType??"")}isRangeFilter(e){return e.stereotype==="dateRange"||e.stereotype==="numberRange"}isMultiFilter(e){return e.stereotype==="multiSelect"}hasOptions(e){return(e.options?.length??0)>0}multiValues(e){const t=this.state[e.fieldId];return Array.isArray(t)?t.map(String):typeof t=="string"&&t!==""?t.split(",").map(a=>a.trim()).filter(a=>a):[]}rangeBound(e,t){const a=this.state[`${e.fieldId}_${t}`];return a==null?"":String(a)}isSet(e){if(this.isRangeFilter(e))return this.rangeBound(e,"from")!==""||this.rangeBound(e,"to")!=="";if(this.isMultiFilter(e))return this.multiValues(e).length>0;const t=this.state[e.fieldId];return t!=null&&t!==""&&!Number.isNaN(t)}getFilterDisplayValue(e,t){if(e.options?.length){const a=e.options.find(s=>s.value===String(t));if(a)return a.label??a.value}return typeof t=="boolean"?t?"Yes":"No":String(t)}conditionDisplay(e){if(this.isRangeFilter(e)){const t=this.rangeBound(e,"from"),a=this.rangeBound(e,"to");return t&&a?`${t} – ${a}`:t?`≥ ${t}`:`≤ ${a}`}return this.isMultiFilter(e)?this.multiValues(e).map(t=>this.getFilterDisplayValue(e,t)).join(", "):this.getFilterDisplayValue(e,this.state[e.fieldId])}labelOf(e){return Pe(e.label,this.state,this.data)||e.fieldId}panelRow(e,t,a="panel-row"){return o`
        ...
        `,()=>a(s.value)))}`}renderActiveFilterWidget(e){if(this.isRangeFilter(e))return this.renderRangeWidget(e);if(this.isMultiFilter(e))return this.renderMultiWidget(e);if(this.hasOptions(e))return o`${e.options.map(s=>this.panelRow(s.label??s.value,()=>this.applyFilter(e.fieldId,s.value)))}`;if(this.isBooleanFilter(e))return o`
            ...
            </div>`}renderViewsPanel(){if(!this.viewsOpened)return l;const e=Os(this.viewsScope),t=!!this.state.searchText||this.filters.some(a=>this.isSet(a));return o`
                ...
                ${e.map(a=>o`
                    <div class="panel-row view-row" @mousedown="${this.keepFocus}">
                        ...
                        <button class="view-star ${a.isDefault?"view-star--on":""}"
                                ...
                                @click="${()=>{en(this.viewsScope,a.name),this.requestUpdate()}}">★</button>
                        <button class="chip-remove" aria-label="Delete view ${a.name}"
                                @click="${()=>{Zo(this.viewsScope,a.name),this.requestUpdate()}}">✕</button>
                    </div>`)}
                ${t?o`
    ...
    `;we([u()],ae.prototype,"metadata",2);we([u()],ae.prototype,"baseUrl",2);we([b()],ae.prototype,"state",2);we([b()],ae.prototype,"data",2);we([u()],ae.prototype,"appState",2);we([u()],ae.prototype,"appData",2);we([u({type:Boolean})],ae.prototype,"searchOnly",2);we([b()],ae.prototype,"panelOpened",2);we([b()],ae.prototype,"viewsOpened",2);we([b()],ae.prototype,"activeFilter",2);we([b()],ae.prototype,"draftText",2);ae=we([x("mateu-filter-bar")],ae);const Ts="mateu-column-prefs",Li=()=>{try{const e=JSON.parse(localStorage.getItem(Ts)??"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}},zs=e=>{try{localStorage.setItem(Ts,JSON.stringify(e))}catch{}},Ai=e=>{if(!e||typeof e!="object")return;const t=a=>Array.isArray(a)?a.filter(s=>typeof s=="string"):[];return{hidden:t(e.hidden),order:t(e.order)}},Rs=e=>Ai(Li()[e]),rn=(e,t)=>{const a=Li(),s=Ai(t);s.hidden.length===0&&s.order.length===0?delete a[e]:a[e]=s,zs(a)},on=e=>{const t=Li();delete t[e],zs(t)},Ds=e=>e?!!e.identifier||e.dataType==="action"||e.dataType==="actionGroup"||e.dataType==="menu"||e.id==="select"||e.id==="menu":!1,Ls=(e,t,a=s=>s)=>{const s=Ai(t);if(!s||s.hidden.length===0&&s.order.length===0)return e;const i=m=>a(m)?.id??m.id,r=new Set(s.hidden),n=e.filter(m=>{const f=i(m);return!f||!r.has(f)||Ds(a(m))});if(s.order.length===0)return n.length===e.length?e:n;const d=new Map;n.forEach(m=>{const f=i(m);f&&!d.has(f)&&d.set(f,m)});const c=[],h=new Set;return s.order.forEach(m=>{const f=d.get(m);f&&!h.has(f)&&(c.push(f),h.add(f))}),n.forEach(m=>{h.has(m)||(c.push(m),h.add(m))}),c.length===e.length&&c.every((m,f)=>m===e[f])?e:c};var nn=Object.defineProperty,ln=Object.getOwnPropertyDescriptor,Pa=(e,t,a,s)=>{for(var i=s>1?void 0:s?ln(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&nn(t,a,i),i};let At=class extends w{constructor(){super(...arguments),this.columns=[],this.scope="",this.panelOpened=!1,this.revision=0,this.togglePanel=()=>{if(this.panelOpened){this.closePanel();return}this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick)},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1},this.reset=()=>{on(this.scope),this.revision++,this.dispatchEvent(new CustomEvent("column-prefs-changed",{bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}get prefs(){return Rs(this.scope)??{hidden:[],order:[]}}effectiveEntries(e){return Ls(this.columns,{hidden:[],order:e.order})}commit(e){rn(this.scope,e),this.revision++,this.dispatchEvent(new CustomEvent("column-prefs-changed",{bubbles:!0,composed:!0}))}toggleVisibility(e){const t=this.prefs,a=t.hidden.includes(e)?t.hidden.filter(s=>s!==e):[...t.hidden,e];this.commit({...t,hidden:a})}move(e,t){const a=this.prefs,s=[...this.effectiveEntries(a)],i=s.findIndex(d=>d.id===e);if(i<0)return;let r=i+t;for(;r>=0&&r<s.length&&s[r].protected;)r+=t;if(r<0||r>=s.length)return;const n=s[i];s[i]=s[r],s[r]=n,this.commit({...a,order:s.map(d=>d.id)})}render(){this.revision;const e=this.prefs,t=this.effectiveEntries(e).filter(s=>!s.protected);if(t.length===0)return o``;const a=e.hidden.length>0||e.order.length>0;return o`
            <div class="chooser">
                <button
    ...
    `;Pa([u()],At.prototype,"columns",2);Pa([u()],At.prototype,"scope",2);Pa([b()],At.prototype,"panelOpened",2);Pa([b()],At.prototype,"revision",2);At=Pa([x("mateu-column-chooser")],At);var dn=Object.defineProperty,cn=Object.getOwnPropertyDescriptor,Oa=(e,t,a,s)=>{for(var i=s>1?void 0:s?cn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&dn(t,a,i),i};let Ft=class extends w{constructor(){super(...arguments),this.totalElements=0,this.pageSize=100,this.pageNumber=0,this.totalPages=0}updated(e){super.updated(e),(e.has("totalElements")||e.has("pageSize"))&&(this.totalPages=Math.ceil(this.totalElements/this.pageSize))}dispatch(e){this.dispatchEvent(new CustomEvent("page-changed",{bubbles:!0,composed:!0,detail:{page:e}}))}render(){if(!this.totalElements)return l;const e=this.totalPages>1,t=this.pageNumber,a=t===0,s=t>=this.totalPages-1;return o`
    ...
    `;Oa([u()],Ft.prototype,"totalElements",2);Oa([u()],Ft.prototype,"pageSize",2);Oa([u()],Ft.prototype,"pageNumber",2);Oa([b()],Ft.prototype,"totalPages",2);Ft=Oa([x("mateu-pagination")],Ft);const un=640,hn=e=>e>0&&e<un?"accordion":"tabs";var pn=Object.defineProperty,mn=Object.getOwnPropertyDescriptor,li=(e,t,a,s)=>{for(var i=s>1?void 0:s?mn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&pn(t,a,i),i};let Qt=class extends w{constructor(){super(...arguments),this.tabLabels=[],this.mode="tabs",this.selected=0,this.selectedChangedListener=e=>{const t=e.detail?.value;typeof t=="number"&&t>=0&&(this.selected=t)}}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{for(const t of e)this.mode=hn(t.contentRect.width)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.resizeObserver=void 0,this.detachTabsListener()}detachTabsListener(){this.slottedTabs?.removeEventListener("selected-changed",this.selectedChangedListener),this.slottedTabs=void 0}tabsSlotChanged(e){this.detachTabsListener();const a=e.target.assignedElements().find(s=>"selected"in s);a&&(this.slottedTabs=a,a.addEventListener("selected-changed",this.selectedChangedListener),a.selected=this.selected)}select(e){this.selected=e,this.slottedTabs&&(this.slottedTabs.selected=e)}updated(){this.slottedTabs&&this.slottedTabs.selected!=this.selected&&(this.slottedTabs.selected=this.selected)}render(){return o`
    ...
    `;li([u({type:Array})],Qt.prototype,"tabLabels",2);li([b()],Qt.prototype,"mode",2);li([b()],Qt.prototype,"selected",2);Qt=li([x("mateu-adaptive-tabs")],Qt);const vn=(e,t,a,s,i,r,n)=>{const d=t.metadata;let c=t.style;return c==null&&(c=""),d.columnSpacing&&(c+="--vaadin-form-layout-column-spacing: "+d.columnSpacing+";"),d.itemRowSpacing&&(c+="--vaadin-form-layout-row-spacing: "+d.itemRowSpacing+";"),d.itemLabelSpacing&&(c+="--vaadin-form-layout-label-spacing: "+d.itemLabelSpacing+";"),d.labelsAside&&(c+="--vaadin-form-item-label-width: 92px;"),d.fullWidth&&(c+="width: 100%;"),o`
               <vaadin-form-layout 
                       ...
                       slot="${t.slot||l}"
               >
                   ${t.children?.map(h=>As(d,e,h,a,s,i,r,n))}
               </vaadin-form-layout>
            `},As=(e,t,a,s,i,r,n,d)=>a.type==ue.ClientSide&&a.metadata?.type==v.FormRow?bn(e,t,a,s,i,r,n,d):e.labelsAside?fn(t,a,s,i,r,n,d):C(t,a,s,i,r,n,d),fn=(e,t,a,s,i,r,n)=>{if(t.type==ue.ClientSide&&t.metadata?.type==v.FormField&&t.metadata.label){const d=t.metadata,c=d.label?.includes("${")?e._evalTemplate(d.label):d.label;return o`
                       <vaadin-form-item data-colspan="${d.colspan}">
                           <label slot="label">${c}</label>
                           ${C(e,t,a,s,i,r,n,!0)}
                       </vaadin-form-item>
                   `}return C(e,t,a,s,i,r,n)},bn=(e,t,a,s,i,r,n,d)=>o`
        <vaadin-form-row>
            ${a.children?.map(c=>As(e,t,c,s,i,r,n,d))}
        </vaadin-form-row>
            `,gn=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=(d.padding?" padding":"")+(d.spacing?" spacing":"")+(d.spacingVariant?" spacing-"+d.spacingVariant:"")+(d.wrap?" wrap":"");let h=t.style;return d.fullWidth&&(h=h?"width: 100%;"+h:"width: 100%;"),d.justification&&(h=h?"justify-content: "+d.justification+";"+h:"justify-content: "+d.justification+";"),d.verticalAlignment&&(h=h?"align-items: "+d.verticalAlignment+";"+h:"align-items: "+d.verticalAlignment+";"),o`
               <vaadin-horizontal-layout 
                       style="${h}" 
                       class="${t.cssClasses}"
                       theme="${c}"
    ...
    `},yn=(e,t,a,s,i,r,n)=>{const d=t.metadata;let c=t.style;return d.fullWidth&&(c=c?"width: 100%;"+c:"width: 100%;"),o`
               <vaadin-split-layout 
                       style="${c}" 
                       class="${t.cssClasses}"
            ...
            `},xn=(e,t,a,s,i,r,n)=>{const d=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,h=!!i?.hasDetail||!!d,p=c??d;return o`
            ...
            `},wn=(e,t,a,s,i,r,n)=>{const d=t.metadata;let c=t.style;c==null&&(c=""),d.fullWidth&&(c+="width: 100%;");let h=d.variant;h=="equalWidth"&&(h="equal-width-tabs");const p=Math.max(0,(t.children??[]).findIndex(f=>f.metadata.active)),m=f=>{f.target.selected=p};if(d.adaptable){const f=(t.children??[]).map(k=>{const y=k.metadata.label;return y?.includes("${")?e._evalTemplate(y):y});return o`
            <mateu-adaptive-tabs
                    .tabLabels="${f}"
                    style="${c}"
                    class="${t.cssClasses}"
        ...
        >
            ...
            ${t.children?.map(f=>kn(e,f,a,s,i,r,n))}
        </vaadin-tabsheet>
            `},kn=(e,t,a,s,i,r,n)=>{const d=t.metadata.label,c=d?.includes("${")?e._evalTemplate(d):d;return o`
        <div tab="${c}" style="padding: var(--lumo-space-m) 0;">
                   ${t.children?.map(h=>C(e,h,a,s,i,r,n))}
               </div>
            `},Cn=(e,t,a,s,i,r,n)=>{const d=t.metadata;t.style,d.fullWidth;let c=0;if(t.children){for(let h=0;h<t.children.length;h++)if(t.children[h].metadata?.active){c=h;break}}return o`
               <vaadin-accordion
                       style="${t.style}"
                       class="${t.cssClasses}"
                       opened="${c}"
                       slot="${t.slot??l}"
               >
                   ${t.children?.map(h=>_n(e,h,a,s,i,r,n,d.variant))}
               </vaadin-accordion>
            `},_n=(e,t,a,s,i,r,n,d)=>{const c=t.metadata,h=c.label?.includes("${")?e._evalTemplate(c.label):c.label;return o`
        ...
        >
            ...
            `},zn=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=h=>o`
            ${C(e,h,a,s,i,r,n)}
`;return o`
        <vaadin-virtual-list
                ...
                slot="${t.slot??l}"
        ></vaadin-virtual-list>
    `},Rn=(e,t,a,s,i,r,n)=>{const d=t.metadata;if(d.tree){const h=async(p,m)=>{const f=p.parentItem?p.parentItem.children:d.page.content;m(f,f.length)};return o`
        <vaadin-grid style="${t.style}" class="${t.cssClasses}"
                     .itemHasChildrenPath="${"children"}" .dataProvider="${h}"
                     slot="${t.slot??l}"
                     all-rows-visible
        >
            ${d.content.map((p,m)=>{const f=p.metadata;return m>0?o`
            <vaadin-grid-column path="${p.id}"
                                ...
                                width="${f?.width??l}"
                                .column="${p.metadata}"
                                ${Xe((k,y,g)=>Na(k,y,g,f,e,a,s,i,r,n),[])}></vaadin-grid-column>
`:o`
...
`})}
    ...
    `}let c=d.page?.content;return t.id&&s&&s[t.id]&&(c=s[t.id]),c||(c=[]),o`
        <vaadin-grid 
                ...
                all-rows-visible
        >
            ${d?.content?.map(h=>zi(h,e,a,s,i,r,n))}
        </vaadin-grid>
    `},Dn=e=>{const a=(e.metadata.items??[]).map(s=>({text:s.text,time:s.time,userName:s.userName,userImg:s.userImg,userAbbr:s.userAbbr,userColorIndex:s.userColorIndex}));return o`
        <vaadin-message-list
                markdown
                style="${e.style}" class="${e.cssClasses}"
                slot="${e.slot??l}"
    ...
    `},Ln=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        <vaadin-context-menu .items=${Fi(e,d.menu,a,s,i,r,n)} 
                             style="${t.style}" 
                             class="${t.cssClasses}"
            ...
            `},An=(e,t,a,s,i)=>{const r=t.metadata;return o`
        <vaadin-menu-bar .items=${Fi(e,r.options,a,s,i,H,fa)}
                         style="${t.style}" class="${t.cssClasses}"
                         slot="${t.slot??l}">
        </vaadin-menu-bar>
            `},is=(e,t,a,s,i,r,n)=>{const d=document.createElement("vaadin-context-menu-item");return bs(C(e,t,a,s,i,r,n),d),d},Fi=(e,t,a,s,i,r,n)=>t.map(d=>d.submenus?{text:d.component?void 0:d.label,route:d.path,checked:d.selected,disabled:d.disabled,className:d.className,component:d.component?is(e,d.component,a,s,i,r,n):void 0,children:Fi(e,d.submenus,a,s,i,r,n)}:d.separator?{component:"hr"}:{text:d.component?void 0:d.label,route:d.path,checked:d.selected,disabled:d.disabled,className:d.className,component:d.component?is(e,d.component,a,s,i,r,n):void 0}),Fn=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.content?.metadata,h=c?.type==v.Notice&&c.fullWidth===!0;return o`
        ...
        >
            ...
            `},Nn=e=>{const t=e.metadata,a=s=>{const i=s.detail?.value??"";!t.actionId||!i.trim()||s.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:{message:i}},bubbles:!0,composed:!0}))};return o`
    ...
    `},Mn=e=>{if(e instanceof CustomEvent)return e.detail;const t={};for(const a in e){const s=e[a];["number","string","boolean"].indexOf(typeof s)>=0&&(t[a]=e[a])}return t},ss=(e,t,a)=>{for(let s in t.attributes)e.setAttribute(s,t.attributes[s]);a.style&&e.setAttribute("style",a.style),a.cssClasses&&e.setAttribute("class",a.cssClasses),a.slot&&e.setAttribute("slot",a.slot),t.content&&(t.html?e.innerHTML=t.content:e.append(t.content))},Un=e=>{const t=e.name;t.startsWith("vaadin-chart")&&!customElements.get(t)&&ce(()=>import("./vendor-highcharts.js"),__vite__mapDeps([0,1,2,3]));const a=e.attributes?e.attributes.import:void 0;a&&t.includes("-")&&!customElements.get(t)&&import(a)},Bn=(e,t,a)=>{Un(t);let s=t.name;return t.attributes&&t.attributes.id&&(s="#"+t.attributes.id),setTimeout(()=>{const i=e.shadowRoot?.querySelector(".element-container")?.querySelector(s);if(i){for(;i.firstChild;)i.removeChild(i.lastChild);ss(i,t,a)}else{const r=document.createElement(t.name);ss(r,t,a);for(let n in t.on)r.addEventListener(n,d=>{const c=Mn(d);e.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.on[n],parameters:{event:c}},bubbles:!0,composed:!0}))});e.shadowRoot?.querySelector(".element-container")?.appendChild(r)}}),o`<div class="element-container"></div>`};var Ae=(e=>(e.div="div",e.p="p",e.h1="h1",e.h2="h2",e.h3="h3",e.h4="h4",e.h5="h5",e.h6="h6",e.span="span",e))(Ae||{});const jn=(e,t,a,s,i)=>{const r=e.metadata,n=r.attributes?.["data-colspan"],d=ii(r.text,t,a,s,i),c={xl:"var(--lumo-font-size-xl, 1.375rem)",l:"var(--lumo-font-size-l, 1.125rem)",s:"var(--lumo-font-size-s, .875rem)",xs:"var(--lumo-font-size-xs, .8125rem)"},h=(r.size&&c[r.size]?`font-size: ${c[r.size]}; `:"")+(r.noMargins?"margin-block-start: 0; margin-block-end: 0; ":"");return Ae.h1==r.container?o`
        ...
        `:Ae.p==r.container?o`
            ...
            `},Vn=e=>{const t=e.metadata;return o`<a href="${t.url}" target="${t.target??l}"
                   rel="${t.target==="_blank"?"noopener":l}"
                   style="${e.style}" class="${e.cssClasses}"
                   slot="${e.slot??l}">${t.text}</a>`},Wn=(e,t)=>{const a=e.target.dataset.actionId;e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a,parameters:t.parameters},bubbles:!0,composed:!0}))},Hn=(e,t,a)=>{const s=e.metadata,i=Pe(s.label,t,a);let r="";return s.buttonStyle&&(r+=" "+s.buttonStyle),s.color&&s.color!=="none"&&s.color!=="normal"&&(r+=" "+s.color),s.size&&s.size!=="none"&&s.size!=="normal"&&(r+=" "+s.size),o`<vaadin-button
id="${e.id}"
            ...
            theme="${r}"
            ?disabled="${s.disabled}"
            title="${s.shortcut?`${i} (${Hr(s.shortcut)})`:l}"
            slot="${e.slot??l}"
    >${s.iconOnLeft?o`<vaadin-icon icon="${s.iconOnLeft}"></vaadin-icon>`:l}${i}${s.iconOnRight?o`<vaadin-icon icon="${s.iconOnRight}"></vaadin-icon>`:l}</vaadin-button>`},Gn=(e,t,a,s,i,r,n)=>{const d=t.metadata;if(!d)return o``;let c="";return d.variants?.map(h=>h=="stretchMedia"?"stretch-media":h=="coverMedia"?"cover-media":h).forEach(h=>c+=" "+h),c=c.trim(),o`
        <vaadin-card
                style="${t.style}" 
                class="${t.cssClasses}" 
                theme="${c}"
                slot="${t.slot??l}"
        >
            ${d.media?Et(e,d.media,a,s,i,r,n,"media",!1):l}
            ${d.title?Et(e,d.title,a,s,i,r,n,"title",!1):l}
            ${d.subtitle?Et(e,d.subtitle,a,s,i,r,n,"subtitle",!1):l}
            ${d.header?Et(e,d.header,a,s,i,r,n,"header",!1):l}
            ${d.headerPrefix?Et(e,d.headerPrefix,a,s,i,r,n,"header-prefix",!1):l}
            ${d.headerSuffix?Et(e,d.headerSuffix,a,s,i,r,n,"header-suffix",!1):l}
            ${d.footer?Et(e,d.footer,a,s,i,r,n,"footer",!1):l}
    ...
    `},Jn=(e,t,a,s,i,r,n)=>{const d=t.metadata;let c=!1;if(d.openedCondition)try{c=ys(d.openedCondition,s,i,r,n)}catch(h){console.error("when evaluating "+d.openedCondition+" :"+h+", where data is "+i+" and state is "+s)}return o`
  ...
  ${t.children?.map(h=>C(e,h,a,s,i,r,n))}
    ...
    `},Qn=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        ...
        <vaadin-notification
                ...
                `,[])}
        ></vaadin-notification>
            `},sl=(e,t={})=>{const a=e.metadata,s=a.valueKey?t[a.valueKey]:a.value;return o`
        <div style="${e.style}">
        <vaadin-progress-bar
    ...
    `},ol=e=>{const t=e.metadata;return o`
        ...
        <img src="${t.src}" style="${e.style}" class="${e.cssClasses}"
             slot="${e.slot??l}">
            `},ll=e=>{const t=e.metadata;return o`<vaadin-horizontal-layout theme="spacing"
                                          slot="${e.slot??l}">
    ...
    </vaadin-horizontal-layout>`},dl=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        <skeleton-carousel 
                id="${t.id}"
                ?dots = "${d.dots}" 
                ?nav = "${d.nav}" 
        ...
        ${e.submenus?o`
                <vaadin-details summary="${e.label}" opened>
                    <vaadin-vertical-layout theme="spacing">
                        ${e.submenus.map(t=>Fs(t))}
                    </vaadin-vertical-layout>
                </vaadin-details>
            `:o`
                <a href="${e.path}">${e.label}</a>
        `}
        `,ul=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`<div
                slot="${t.slot??l}"
                style="${t.style}" class="${t.cssClasses}"
        >${d.content?Ee(d.content):l}${t.children?.map(c=>C(e,c,a,s,i,r,n))}</div>
    `},hl=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.title?.includes("${")?e._evalTemplate(d.title):d.title;return o`<vaadin-card
                slot="${t.slot??l}"
    ...
    `},pl=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.title?.includes("${")?e._evalTemplate(d.title):d.title;return o`
        <div
                slot="${t.slot??l}"
                style="${t.style}" class="${t.cssClasses}"
        >
    ...
    `},Si=(e,t,a,s,i,r,n,d)=>{const c=t.metadata,h=c?.fabs??[];return o`<mateu-page
            .component="${t}"
            baseUrl="${a}"
            .state="${s}"
            .data="${i}"
    ...
    >
        ${t.children?.map(p=>C(e,p,a,s,i,r,n))}
        ${c?.buttons?.map(p=>o`
                   ${C(e,{id:p.actionId,metadata:p,type:ue.ClientSide,slot:"buttons"},void 0,s,i,r,n)}
`)}
        ${h.map((p,m)=>o`
    ...
    `},Ii=(e,t,a,s,i,r,n,d)=>o`<mateu-table-crud
            id="${t.id}"
            baseUrl="${a}"
            .component="${t}"
            .metadata="${t.metadata}"
    ...
    `},vl=(e,t,a)=>{const s=e.metadata;return o`<mateu-chat sseUrl="${s.sseUrl}"
                            style="${e.style}" 
                            class="${e.cssClasses}" 
                            slot="${e.slot??l}"></mateu-chat>`},fl=e=>{const t=e.metadata;return o`
        <mateu-workflow
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
...
`,$l=e=>e=="up"?"var(--lumo-success-text-color, #1a7f37)":e=="down"?"var(--lumo-error-text-color, #c5221f)":"var(--lumo-secondary-text-color, #666)",yl=e=>e=="up"?"▲":e=="down"?"▼":"",xl=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},wl=e=>{const t=e.metadata,a=!!t.actionId;return o`
        <div class="mateu-metric-card ${e.cssClasses??""}"
             style="${Ns} display: flex; flex-direction: column; gap: .25rem; min-width: 11rem; flex: 1; ${a?"cursor: pointer;":""} ${e.style??""}"
             slot="${e.slot??l}"
             role="${a?"button":l}"
             @click="${s=>xl(s,t)}"
        >
            ...
            ${t.trend||t.trendLabel?o`
                <span style="font-size: var(--lumo-font-size-s, .875rem); color: ${$l(t.trend)};">
                    ${yl(t.trend)} ${t.trendLabel??l}
                </span>
            `:l}
    ...
    `,Cl=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.colSpan&&d.colSpan>1?`grid-column: span ${d.colSpan};`:"",h=d.rowSpan&&d.rowSpan>1?`grid-row: span ${d.rowSpan};`:"";return o`
        <div class="mateu-dashboard-panel ${t.cssClasses??""}"
             style="${Ns} display: flex; flex-direction: column; gap: .5rem; min-width: 0; ${c} ${h} ${t.style??""}"
             slot="${t.slot??l}"
        >
            ${d.title?o`
                <div>
    ...
    `},_l=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.columns&&d.columns>0?`repeat(${d.columns}, minmax(0, 1fr))`:"repeat(auto-fit, minmax(20rem, 1fr))";return o`
    ...
    `};var Sl=Object.defineProperty,Il=Object.getOwnPropertyDescriptor,Ni=(e,t,a,s)=>{for(var i=s>1?void 0:s?Il(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Sl(t,a,i),i};let $a=class extends w{constructor(){super(...arguments),this.panels=[],this.openPanels=new Set,this.initialized=!1}willUpdate(){!this.initialized&&this.panels.length&&(this.openPanels=new Set(this.panels.map((e,t)=>e.open?t:-1).filter(e=>e>=0)),this.initialized=!0)}toggle(e){const t=new Set(this.openPanels);t.has(e)?t.delete(e):t.add(e),this.openPanels=t}render(){return o`
    ...
    `;Ni([u({type:Array})],$a.prototype,"panels",2);Ni([b()],$a.prototype,"openPanels",2);$a=Ni([x("mateu-foldout")],$a);const El=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        <mateu-foldout
                .panels="${d.panels??[]}"
                style="${t.style}"
                class="${t.cssClasses}"
    ...
    `},Pl=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=!!d.image,h=c?`background-image: linear-gradient(rgba(0,0,0,.35), rgba(0,0,0,.35)), url('${d.image}'); background-size: cover; background-position: center; color: #fff;`:"",p=d.centered===!1?"flex-start":"center",m=d.centered===!1?"left":"center";return o`
        <div class="mateu-hero ${t.cssClasses??""}"
             style="display: flex; flex-direction: column; align-items: ${p}; justify-content: center; gap: var(--lumo-space-m, 1rem); text-align: ${m}; padding: var(--lumo-space-xl, 2.5rem) var(--lumo-space-l, 1.5rem); border-radius: var(--lumo-border-radius-l, 12px); min-height: ${d.height??"12rem"}; box-sizing: border-box; ${h} ${t.style??""}"
             slot="${t.slot??l}"
        >
    ...
    `};var Ol=Object.defineProperty,Tl=Object.getOwnPropertyDescriptor,qs=(e,t,a,s)=>{for(var i=s>1?void 0:s?Tl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ol(t,a,i),i};const wi=1440*60*1e3;let Ma=class extends w{constructor(){super(...arguments),this.tasks=[]}range(){const e=this.tasks.flatMap(t=>[t.start,t.end]).filter(t=>!!t).map(t=>new Date(t+"T00:00:00").getTime());return e.length?{min:Math.min(...e)-wi,max:Math.max(...e)+2*wi}:null}months(e,t){const a=[],s=new Date(e);for(s.setDate(1);s.getTime()<=t;){const i=Math.max(s.getTime(),e),r=new Date(s.getFullYear(),s.getMonth()+1,1),n=Math.min(r.getTime(),t);a.push({label:s.toLocaleDateString(void 0,{month:"short",year:"2-digit"}),from:i,to:n}),s.setMonth(s.getMonth()+1)}return a}render(){const e=this.range();if(!e)return o``;const t=e.max-e.min,a=i=>(i-e.min)/t*100,s=Date.now();return o`
            <div class="frame">
                ...
                ${this.tasks.map(i=>{const r=new Date(i.start+"T00:00:00").getTime(),n=new Date(i.end+"T00:00:00").getTime()+wi;return o`
    ...
    `;qs([u({type:Array})],Ma.prototype,"tasks",2);Ma=qs([x("mateu-gantt")],Ma);const zl=e=>{const t=e.metadata;return o`
        <mateu-gantt
                .tasks="${t.tasks??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `};var Rl=Object.defineProperty,Dl=Object.getOwnPropertyDescriptor,yt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Dl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Rl(t,a,i),i};let z=class extends w{constructor(){super(...arguments),this.resources=[],this.blocks=[],this.drag=null,this.dragStartX=0,this.dragStartY=0,this.laneRects=[],this.onDragKeydown=e=>{e.key==="Escape"&&this.drag&&(e.stopPropagation(),this.endDrag())}}static parse(e){return new Date(e+"T00:00:00")}static iso(e){const t=a=>String(a).padStart(2,"0");return`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}`}static addDays(e,t){return new Date(e.getFullYear(),e.getMonth(),e.getDate()+t)}static daysBetween(e,t){return Math.round((t.getTime()-e.getTime())/864e5)}window(){if(this.from&&this.to){const s=z.parse(this.from),i=z.daysBetween(s,z.parse(this.to))+1;return i>0?{from:s,days:i}:null}const e=this.blocks.flatMap(s=>[s.start,s.end]).filter(s=>!!s).map(s=>z.parse(s));if(!e.length)return null;const t=new Date(Math.min(...e.map(s=>s.getTime()))),a=new Date(Math.max(...e.map(s=>s.getTime())));return{from:t,days:z.daysBetween(t,a)+1}}onBlockPointerDown(e,t,a){if(!this.moveActionId&&!this.selectActionId||(e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),this.dragStartX=e.clientX,this.dragStartY=e.clientY,!this.window()))return;const r=z.parse(t.start),n=z.parse(t.end),d=Math.max(1,z.daysBetween(r,n)+1);this.laneRects=[...this.renderRoot.querySelectorAll(".lane[data-resource-id]")].map(h=>({resourceId:h.dataset.resourceId,rect:h.getBoundingClientRect()}));const c=this.dayAt(t.resourceId,e.clientX)??a;this.drag={blockId:t.id,duration:d,grabOffsetDays:c-a,originResourceId:t.resourceId,originStartIdx:a,targetResourceId:t.resourceId,targetStartIdx:a,moved:!1},window.addEventListener("keydown",this.onDragKeydown)}dayAt(e,t){const a=this.laneRects.find(r=>r.resourceId===e),s=this.window();if(!a||!s||a.rect.width===0)return null;const i=Math.floor((t-a.rect.left)/a.rect.width*s.days);return Math.max(0,Math.min(s.days-1,i))}onBlockPointerMove(e){if(!this.drag||!this.drag.moved&&Math.abs(e.clientX-this.dragStartX)<4&&Math.abs(e.clientY-this.dragStartY)<4||!this.moveActionId)return;const t=this.window();if(!t)return;const a=this.laneRects.find(r=>e.clientY>=r.rect.top&&e.clientY<=r.rect.bottom)??this.laneRects.find(r=>r.resourceId===this.drag.targetResourceId);if(!a)return;const s=this.dayAt(a.resourceId,e.clientX);if(s==null)return;const i=Math.max(0,Math.min(t.days-this.drag.duration,s-this.drag.grabOffsetDays));this.drag={...this.drag,moved:!0,targetResourceId:a.resourceId,targetStartIdx:i}}onBlockPointerUp(e){const t=this.drag;if(this.endDrag(),!t)return;if(!t.moved){this.selectActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.selectActionId,parameters:{_blockId:e.id}},bubbles:!0,composed:!0}));return}if(!this.moveActionId||t.targetResourceId===t.originResourceId&&t.targetStartIdx===t.originStartIdx)return;const a=this.window();if(!a)return;const s=z.addDays(a.from,t.targetStartIdx),i=z.addDays(s,t.duration-1);this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.moveActionId,parameters:{_blockId:t.blockId,_resourceId:t.targetResourceId,_start:z.iso(s),_end:z.iso(i)}},bubbles:!0,composed:!0}))}endDrag(){this.drag=null,window.removeEventListener("keydown",this.onDragKeydown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onDragKeydown)}render(){const e=this.window();if(!e||!this.resources.length)return o``;const t=[...Array(e.days).keys()].map(d=>z.addDays(e.from,d)),a=new Date,s=z.daysBetween(e.from,new Date(a.getFullYear(),a.getMonth(),a.getDate())),i=s>=0&&s<e.days,r=[];let n;return this.resources.forEach(d=>{d.group&&d.group!==n&&r.push(o`<div class="group">${d.group}</div>`),n=d.group,r.push(this.renderRow(d,e,t,i?s:null))}),o`
        ...
        `}isWeekend(e){return e.getDay()===0||e.getDay()===6}renderRow(e,t,a,s){const i=100/t.days,r=this.blocks.filter(d=>d.resourceId===e.id&&d.start&&d.end),n=this.drag?.moved&&this.drag.targetResourceId===e.id?this.drag:null;return o`
            ...
            <div class="lane" data-resource-id="${e.id}">
                ...
                ${r.map(d=>{const c=z.daysBetween(t.from,z.parse(d.start)),h=z.daysBetween(t.from,z.parse(d.end));if(h<0||c>=t.days)return l;const p=Math.max(0,c),m=Math.min(t.days-1,h),f=this.drag?.moved&&this.drag.blockId===d.id;return o`
                        <div class="block ${this.selectActionId?"clickable":""} ${this.moveActionId?"draggable":""} ${f?"dragging":""}"
                             ...
                             style="left: ${p*i}%; width: ${(m-p+1)*i}%; ${d.color?`--mateu-planning-block: ${d.color};`:""}"
    ...
    `;yt([u({type:Array})],z.prototype,"resources",2);yt([u({type:Array})],z.prototype,"blocks",2);yt([u()],z.prototype,"from",2);yt([u()],z.prototype,"to",2);yt([u()],z.prototype,"moveActionId",2);yt([u()],z.prototype,"selectActionId",2);yt([b()],z.prototype,"drag",2);z=yt([x("mateu-planning-board")],z);const Ll=e=>{const t=e.metadata;return o`
        <mateu-planning-board
                ...
                slot="${e.slot??l}"
        ></mateu-planning-board>
    `};var Al=Object.defineProperty,Fl=Object.getOwnPropertyDescriptor,Ms=(e,t,a,s)=>{for(var i=s>1?void 0:s?Fl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Al(t,a,i),i};let Ua=class extends w{constructor(){super(...arguments),this.columns=[]}clickCard(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedCard:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="board">
    ...
    `;Ms([u({type:Array})],Ua.prototype,"columns",2);Ua=Ms([x("mateu-kanban")],Ua);const Nl=e=>{const t=e.metadata;return o`
        <mateu-kanban
                .columns="${t.columns??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-kanban>
    `};var ql=Object.defineProperty,Ml=Object.getOwnPropertyDescriptor,Us=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ml(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ql(t,a,i),i};let Ba=class extends w{constructor(){super(...arguments),this.items=[]}clickItem(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedItem:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="feed">
                ${this.items.map(e=>o`
    ...
    `;Us([u({type:Array})],Ba.prototype,"items",2);Ba=Us([x("mateu-timeline")],Ba);const Ul=e=>{const t=e.metadata;return o`
        <mateu-timeline
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-timeline>
    `};var Bl=Object.defineProperty,jl=Object.getOwnPropertyDescriptor,qi=(e,t,a,s)=>{for(var i=s>1?void 0:s?jl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Bl(t,a,i),i};let ya=class extends w{constructor(){super(...arguments),this.steps=[],this.vertical=!1}render(){return o`
            <div class="steps">
    ...
    `;qi([u({type:Array})],ya.prototype,"steps",2);qi([u({type:Boolean,reflect:!0})],ya.prototype,"vertical",2);ya=qi([x("mateu-progress-steps")],ya);const Vl=e=>{const t=e.metadata;return o`
        <mateu-progress-steps
                ...
                slot="${e.slot??l}"
        ></mateu-progress-steps>
    `};var Wl=Object.defineProperty,Hl=Object.getOwnPropertyDescriptor,xt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Hl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Wl(t,a,i),i};let qe=class extends w{constructor(){super(...arguments),this.spark=[]}sparkline(){const e=this.spark;if(!e||e.length<2)return l;const t=84,a=30,s=2,i=Math.min(...e),n=Math.max(...e)-i||1,d=(t-s*2)/(e.length-1),c=e.map((f,k)=>{const y=s+k*d,g=s+(a-s*2)*(1-(f-i)/n);return[y,g]}),h=c.map(([f,k],y)=>`${y===0?"M":"L"}${f.toFixed(1)} ${k.toFixed(1)}`).join(" "),p=`${h} L${c[c.length-1][0].toFixed(1)} ${a} L${c[0][0].toFixed(1)} ${a} Z`,m=this.trend==="down"?"var(--lumo-error-color, #e11d48)":this.trend==="flat"?"var(--lumo-secondary-text-color, #888)":"var(--lumo-success-color, #12b76a)";return B`
            <svg width="${t}" height="${a}" viewBox="0 0 ${t} ${a}">
                <path d="${p}" fill="${m}" opacity="0.12"></path>
                <path d="${h}" fill="none" stroke="${m}" stroke-width="1.6"
    ...
    `;xt([u()],qe.prototype,"label",2);xt([u()],qe.prototype,"value",2);xt([u()],qe.prototype,"unit",2);xt([u()],qe.prototype,"delta",2);xt([u()],qe.prototype,"trend",2);xt([u({type:Array})],qe.prototype,"spark",2);xt([u()],qe.prototype,"actionId",2);qe=xt([x("mateu-stat")],qe);const Gl=e=>{const t=e.metadata;return o`
        <mateu-stat
                label="${t.label??l}"
                value="${t.value??l}"
                unit="${t.unit??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-stat>
    `};var Kl=Object.defineProperty,Yl=Object.getOwnPropertyDescriptor,Mi=(e,t,a,s)=>{for(var i=s>1?void 0:s?Yl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Kl(t,a,i),i};let xa=class extends w{constructor(){super(...arguments),this.events=[]}clickEvent(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedEvent:e}},bubbles:!0,composed:!0}))}render(){const e=this.month?new Date(this.month+"T00:00:00"):new Date,t=e.getFullYear(),a=e.getMonth(),s=new Date(t,a,1),i=(s.getDay()+6)%7,r=new Date(t,a+1,0).getDate(),n=new Date,d=f=>n.getFullYear()===t&&n.getMonth()===a&&n.getDate()===f,c={};for(const f of this.events){if(!f.date)continue;const k=new Date(f.date+"T00:00:00");k.getFullYear()===t&&k.getMonth()===a&&(c[k.getDate()]??=[]).push(f)}const h=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],p=[];for(let f=0;f<i;f++)p.push(o`<div class="cell blank"></div>`);for(let f=1;f<=r;f++)p.push(o`
    ...
    `;Mi([u()],xa.prototype,"month",2);Mi([u({type:Array})],xa.prototype,"events",2);xa=Mi([x("mateu-calendar")],xa);const Jl=e=>{const t=e.metadata;return o`
        <mateu-calendar
                month="${t.month??l}"
                .events="${t.events??[]}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-calendar>
    `};var Xl=Object.defineProperty,Ql=Object.getOwnPropertyDescriptor,Bs=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ql(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Xl(t,a,i),i};let ja=class extends w{constructor(){super(...arguments),this.plans=[]}cta(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){return o`
            <div class="plans">
                ${this.plans.map(e=>o`
    ...
    `;Bs([u({type:Array})],ja.prototype,"plans",2);ja=Bs([x("mateu-pricing-table")],ja);const Zl=e=>{const t=e.metadata;return o`
        <mateu-pricing-table
                .plans="${t.plans??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-pricing-table>
    `};var ed=Object.defineProperty,td=Object.getOwnPropertyDescriptor,js=(e,t,a,s)=>{for(var i=s>1?void 0:s?td(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ed(t,a,i),i};let Va=class extends w{clickNode(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedNode:e}},bubbles:!0,composed:!0}))}renderNode(e){const t=e.avatar,a=t&&(t.startsWith("http")||t.startsWith("data:"));return o`
            <li>
        ...
        `}render(){return this.root?o`<div class="tree"><ul>${this.renderNode(this.root)}</ul></div>`:o``}};Va.styles=$`
        :host {
            display: block;
            width: 100%;
            overflow-x: auto;
    ...
    `;js([u({attribute:!1})],Va.prototype,"root",2);Va=js([x("mateu-org-chart")],Va);const ad=e=>{const t=e.metadata;return o`
        <mateu-org-chart
                .root="${t.root}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-org-chart>
    `};var id=Object.defineProperty,sd=Object.getOwnPropertyDescriptor,Vs=(e,t,a,s)=>{for(var i=s>1?void 0:s?sd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&id(t,a,i),i};const rd=1440*60*1e3;let Wa=class extends w{constructor(){super(...arguments),this.cells=[]}color(e,t){if(e<=0||t<=0)return"var(--lumo-contrast-10pct, #ebedf0)";const a=e/t,s=a>.75?1:a>.5?.75:a>.25?.5:.3;return`color-mix(in srgb, var(--lumo-primary-color, #1a73e8) ${Math.round(s*100)}%, transparent)`}render(){const e=this.cells.filter(c=>!!c.date);if(!e.length)return o``;const t=e.map(c=>new Date(c.date+"T00:00:00").getTime()),a=Math.min(...t),s=Math.max(...t),i=new Date(a);i.setDate(i.getDate()-(i.getDay()+6)%7);const r={};for(const c of e)r[c.date]=c;const n=Math.max(...e.map(c=>c.value??0),1),d=[];for(let c=i.getTime();c<=s;c+=rd){const h=new Date(c),p=h.toISOString().slice(0,10),m=r[p],f=m?.value??0,k=(h.getDay()+6)%7+1,y=m?.label??`${p}: ${f}`;d.push(o`
    ...
    `;Vs([u({type:Array})],Wa.prototype,"cells",2);Wa=Vs([x("mateu-heatmap")],Wa);const od=e=>{const t=e.metadata;return o`
        <mateu-heatmap
                .cells="${t.cells??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-heatmap>
    `};var nd=Object.defineProperty,ld=Object.getOwnPropertyDescriptor,Ws=(e,t,a,s)=>{for(var i=s>1?void 0:s?ld(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&nd(t,a,i),i};let Ha=class extends w{constructor(){super(...arguments),this.stages=[]}render(){const e=this.stages;if(!e.length)return o``;const t=e[0].value??0,a=Math.max(...e.map(s=>s.value??0),1);return o`
            <div class="funnel">
    ...
    `;Ws([u({type:Array})],Ha.prototype,"stages",2);Ha=Ws([x("mateu-funnel")],Ha);const dd=e=>{const t=e.metadata;return o`
        <mateu-funnel
                .stages="${t.stages??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-funnel>
    `};var cd=Object.defineProperty,ud=Object.getOwnPropertyDescriptor,oa=(e,t,a,s)=>{for(var i=s>1?void 0:s?ud(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&cd(t,a,i),i};let pt=class extends w{constructor(){super(...arguments),this.values=[],this.labels=[],this.area=!1}render(){const e=this.values;if(!e||e.length<2)return o``;const t=600,a=160,s=8,i=Math.min(...e),r=Math.max(...e),n=r-i||1,d=(t-s*2)/(e.length-1),c=e.map((y,g)=>{const I=s+g*d,j=s+(a-s*2)*(1-(y-i)/n);return[I,j]}),h=c.map(([y,g],I)=>`${I===0?"M":"L"}${y.toFixed(1)} ${g.toFixed(1)}`).join(" "),p=`${h} L${c[c.length-1][0].toFixed(1)} ${a-s} L${c[0][0].toFixed(1)} ${a-s} Z`,m=this.color||"var(--lumo-primary-color, #1a73e8)",f=e.indexOf(r),k=e.indexOf(i);return o`
            ${this.heading?o`<div class="title">${this.heading}</div>`:l}
            <svg viewBox="0 0 ${t} ${a}" preserveAspectRatio="none">
                ${this.area?B`<path d="${p}" fill="${m}" opacity="0.12"></path>`:l}
                <path d="${h}" fill="none" stroke="${m}" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"></path>
                ${c.map((y,g)=>g===f||g===k?B`<circle cx="${y[0]}" cy="${y[1]}" r="3.2" fill="${m}"><title>${this.labels[g]??""}: ${e[g]}</title></circle>`:B`<circle cx="${y[0]}" cy="${y[1]}" r="6" fill="transparent"><title>${this.labels[g]??""}: ${e[g]}</title></circle>`)}
            </svg>
    ...
    `;oa([u()],pt.prototype,"heading",2);oa([u({type:Array})],pt.prototype,"values",2);oa([u({type:Array})],pt.prototype,"labels",2);oa([u()],pt.prototype,"color",2);oa([u({type:Boolean})],pt.prototype,"area",2);pt=oa([x("mateu-trend-chart")],pt);const hd=e=>{const t=e.metadata;return o`
        <mateu-trend-chart
                heading="${t.title??l}"
                color="${t.color??l}"
                ?area="${t.area??!1}"
                ...
                slot="${e.slot??l}"
        ></mateu-trend-chart>
    `};var pd=Object.defineProperty,md=Object.getOwnPropertyDescriptor,Ui=(e,t,a,s)=>{for(var i=s>1?void 0:s?md(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&pd(t,a,i),i};let wa=class extends w{constructor(){super(...arguments),this.features=[],this.columns=0}clickFeature(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){const e=this.columns&&this.columns>0?`repeat(${this.columns}, minmax(0, 1fr))`:"repeat(auto-fit, minmax(15rem, 1fr))";return o`
    ...
    `;Ui([u({type:Array})],wa.prototype,"features",2);Ui([u({type:Number})],wa.prototype,"columns",2);wa=Ui([x("mateu-feature-grid")],wa);const vd=e=>{const t=e.metadata;return o`
        <mateu-feature-grid
                .features="${t.features??[]}"
                .columns="${t.columns??0}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-feature-grid>
    `};var fd=Object.defineProperty,bd=Object.getOwnPropertyDescriptor,Hs=(e,t,a,s)=>{for(var i=s>1?void 0:s?bd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&fd(t,a,i),i};let Ga=class extends w{constructor(){super(...arguments),this.items=[]}stars(e){const t=Math.max(0,Math.min(5,e||0));return"★".repeat(t)+"☆".repeat(5-t)}render(){return o`
            <div class="grid">
    ...
    `;Hs([u({type:Array})],Ga.prototype,"items",2);Ga=Hs([x("mateu-testimonials")],Ga);const gd=e=>{const t=e.metadata;return o`
        <mateu-testimonials
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-testimonials>
    `};var $d=Object.defineProperty,yd=Object.getOwnPropertyDescriptor,Bi=(e,t,a,s)=>{for(var i=s>1?void 0:s?yd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&$d(t,a,i),i};let ka=class extends w{constructor(){super(...arguments),this.items=[],this.openSet=new Set,this.seeded=!1}seed(){this.seeded||(this.seeded=!0,this.items.forEach((e,t)=>{e.open&&this.openSet.add(t)}))}toggle(e){this.openSet.has(e)?this.openSet.delete(e):this.openSet.add(e),this.requestUpdate()}render(){return this.seed(),o`
            <div class="list">
    ...
    `;Bi([u({type:Array})],ka.prototype,"items",2);Bi([b()],ka.prototype,"openSet",2);ka=Bi([x("mateu-faq")],ka);const xd=e=>{const t=e.metadata;return o`
        <mateu-faq
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;Wt([u()],et.prototype,"heading",2);Wt([u()],et.prototype,"description",2);Wt([u()],et.prototype,"icon",2);Wt([u()],et.prototype,"ctaLabel",2);Wt([u()],et.prototype,"actionId",2);Wt([u()],et.prototype,"theme",2);et=Wt([x("mateu-callout-card")],et);const Cd=e=>{const t=e.metadata;return o`
        <mateu-callout-card
                heading="${t.title??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-callout-card>
    `};var _d=Object.defineProperty,Sd=Object.getOwnPropertyDescriptor,Gs=(e,t,a,s)=>{for(var i=s>1?void 0:s?Sd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&_d(t,a,i),i};let Ka=class extends w{constructor(){super(...arguments),this.comments=[]}renderComment(e){const t=e.avatar&&(e.avatar.startsWith("http")||e.avatar.startsWith("data:"));return o`
            <div class="comment">
        ...
        `}render(){return o`<div class="thread">${this.comments.map(e=>this.renderComment(e))}</div>`}};Ka.styles=$`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
    ...
    `;Gs([u({type:Array})],Ka.prototype,"comments",2);Ka=Gs([x("mateu-comment-thread")],Ka);const Id=e=>{const t=e.metadata;return o`
        <mateu-comment-thread
                ...
                slot="${e.slot??l}"
        ></mateu-comment-thread>
    `};var Ed=Object.defineProperty,Pd=Object.getOwnPropertyDescriptor,Ks=(e,t,a,s)=>{for(var i=s>1?void 0:s?Pd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ed(t,a,i),i};const Od={pdf:"📕",image:"🖼️",img:"🖼️",doc:"📘",docx:"📘",word:"📘",xls:"📗",xlsx:"📗",excel:"📗",sheet:"📗",zip:"🗜️",archive:"🗜️",video:"🎬",audio:"🎵",code:"💻",csv:"📄",txt:"📄"};let Ya=class extends w{constructor(){super(...arguments),this.files=[]}icon(e){return e&&Od[e.toLowerCase()]||"📄"}clickFile(e,t){e.url||e.actionId&&(t.preventDefault(),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_file:e}},bubbles:!0,composed:!0})))}render(){return o`
            <div class="list">
    ...
    `;Ks([u({type:Array})],Ya.prototype,"files",2);Ya=Ks([x("mateu-file-list")],Ya);const Td=e=>{const t=e.metadata;return o`
        <mateu-file-list
                .files="${t.files??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-file-list>
    `};var zd=Object.defineProperty,Rd=Object.getOwnPropertyDescriptor,di=(e,t,a,s)=>{for(var i=s>1?void 0:s?Rd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&zd(t,a,i),i};let Zt=class extends w{constructor(){super(...arguments),this.items=[],this.localDone=new Map}isDone(e,t){return this.localDone.has(t)?!!this.localDone.get(t):!!e.done}toggle(e,t){const a=!this.isDone(e,t);this.localDone.set(t,a),this.requestUpdate(),e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_item:e,_done:a}},bubbles:!0,composed:!0}))}render(){const e=this.items.length,t=this.items.filter((s,i)=>this.isDone(s,i)).length,a=e>0?Math.round(t/e*100):0;return o`
            <div class="head">
    ...
    `;di([u()],Zt.prototype,"heading",2);di([u({type:Array})],Zt.prototype,"items",2);di([b()],Zt.prototype,"localDone",2);Zt=di([x("mateu-checklist")],Zt);const Dd=e=>{const t=e.metadata;return o`
        <mateu-checklist
                heading="${t.title??l}"
                .items="${t.items??[]}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-checklist>
    `};var Ld=Object.defineProperty,Ad=Object.getOwnPropertyDescriptor,wt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ad(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ld(t,a,i),i};let Me=class extends w{render(){const e=this.trend??"flat";return o`
            <div class="card">
                ${this.heading?o`<div class="title">${this.heading}</div>`:l}
                <div class="row">
                    <div class="side">
        ...
        @media (prefers-color-scheme: dark) { .card { background: var(--lumo-contrast-5pct, #2a2a2a); } }
    `;wt([u()],Me.prototype,"heading",2);wt([u()],Me.prototype,"leftLabel",2);wt([u()],Me.prototype,"leftValue",2);wt([u()],Me.prototype,"rightLabel",2);wt([u()],Me.prototype,"rightValue",2);wt([u()],Me.prototype,"delta",2);wt([u()],Me.prototype,"trend",2);Me=wt([x("mateu-comparison-card")],Me);const Fd=e=>{const t=e.metadata;return o`
...
`,Nd=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}),Ei=e=>Nd.format(e),Ja=(e,t)=>{const a=e<0?"-":"",s=Ei(Math.abs(e));return t?`${a}${t} ${s}`:`${a}${s}`},qd=(e,t)=>t?`${Ei(e)} ${t}`:Ei(e);var Md=Object.defineProperty,Ud=Object.getOwnPropertyDescriptor,kt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ud(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Md(t,a,i),i};let Ue=class extends w{constructor(){super(...arguments),this.title="",this.badges=[],this.facts=[]}render(){const e=!!(this.metricLabel||this.metricValue||this.metricCaption);return o`
            <div class="card">
                <div class="main">
                    <div class="title-row">
    ...
    `];kt([u()],Ue.prototype,"title",2);kt([u({type:Array})],Ue.prototype,"badges",2);kt([u()],Ue.prototype,"subtitle",2);kt([u({type:Array})],Ue.prototype,"facts",2);kt([u()],Ue.prototype,"metricLabel",2);kt([u()],Ue.prototype,"metricValue",2);kt([u()],Ue.prototype,"metricCaption",2);Ue=kt([x("mateu-entity-header")],Ue);const Bd=e=>{const t=e.metadata;return o`
        <mateu-entity-header
                .title="${t.title??""}"
                .badges="${t.badges??[]}"
                .subtitle="${t.subtitle}"
                ...
                slot="${e.slot??l}"
        ></mateu-entity-header>
    `};var jd=Object.defineProperty,Vd=Object.getOwnPropertyDescriptor,Ct=(e,t,a,s)=>{for(var i=s>1?void 0:s?Vd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&jd(t,a,i),i};let Be=class extends w{constructor(){super(...arguments),this.value=0,this.max=0}fillColor(){return this.dangerAt!=null&&this.value>=this.dangerAt?"error":this.warnAt!=null&&this.value>=this.warnAt?"warning":this.warnAt!=null||this.dangerAt!=null?"success":"primary"}render(){const e=this.max>0?Math.min(Math.max(this.value/this.max,0),1):0,t=Math.round(e*100);return o`
            <div class="meter">
                ${this.label?o`<span class="label">${this.label}</span>`:l}
    ...
    `;Ct([u()],Be.prototype,"label",2);Ct([u({type:Number})],Be.prototype,"value",2);Ct([u({type:Number})],Be.prototype,"max",2);Ct([u()],Be.prototype,"unit",2);Ct([u()],Be.prototype,"caption",2);Ct([u({type:Number})],Be.prototype,"warnAt",2);Ct([u({type:Number})],Be.prototype,"dangerAt",2);Be=Ct([x("mateu-meter")],Be);const Wd=e=>{const t=e.metadata;return o`
        <mateu-meter
                .label="${t.label}"
                .value="${t.value??0}"
                .max="${t.max??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-meter>
    `};var Hd=Object.defineProperty,Gd=Object.getOwnPropertyDescriptor,na=(e,t,a,s)=>{for(var i=s>1?void 0:s?Gd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Hd(t,a,i),i};let mt=class extends w{constructor(){super(...arguments),this.total=0,this.done=0}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){const e=this.total>0&&this.done>=this.total,t=!e&&!!this.actionLabel&&!!this.actionId;return o`
    ...
    `;na([u()],mt.prototype,"label",2);na([u({type:Number})],mt.prototype,"total",2);na([u({type:Number})],mt.prototype,"done",2);na([u()],mt.prototype,"actionLabel",2);na([u()],mt.prototype,"actionId",2);mt=na([x("mateu-task-progress")],mt);const Kd=e=>{const t=e.metadata;return o`
        <mateu-task-progress
                .label="${t.label}"
                .total="${t.total??0}"
                .done="${t.done??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-task-progress>
    `};var Yd=Object.defineProperty,Jd=Object.getOwnPropertyDescriptor,Ta=(e,t,a,s)=>{for(var i=s>1?void 0:s?Jd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Yd(t,a,i),i};let Nt=class extends w{constructor(){super(...arguments),this.items=[],this.compact=!1,this.frameless=!1}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}rowClicked(e){this.rowActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.rowActionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}render(){return o`
    ...
    `];Ta([u({type:Array})],Nt.prototype,"items",2);Ta([u({type:Boolean})],Nt.prototype,"compact",2);Ta([u({type:Boolean})],Nt.prototype,"frameless",2);Ta([u()],Nt.prototype,"rowActionId",2);Nt=Ta([x("mateu-status-list")],Nt);const Xd=e=>{const t=e.metadata;return o`
        <mateu-status-list
                .items="${t.items??[]}"
                ?compact="${t.compact??!1}"
                ...
                slot="${e.slot??l}"
        ></mateu-status-list>
    `},Qd=e=>{const t=e.metadata;return o`
        <mateu-bulleted-list
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-bulleted-list>
    `},Zd=e=>{const a=e.metadata.attributes?.["data-colspan"];return o`
        <hr style="border: none; border-top: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1)); width: 100%; margin: var(--lumo-space-s, .5rem) 0; ${e.style??""}"
            ...
            data-colspan="${E(a)}"
            slot="${e.slot??l}"/>
    `};var ec=Object.defineProperty,tc=Object.getOwnPropertyDescriptor,ke=(e,t,a,s)=>{for(var i=s>1?void 0:s?tc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ec(t,a,i),i};const ac={info:"ℹ",success:"✓",warning:"!",danger:"!"};let ie=class extends w{constructor(){super(...arguments),this.text="",this.theme="info",this.noIcon=!1,this.slim=!1,this.fullWidth=!1,this.hasContent=!1,this.inlineContent=!1}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId},bubbles:!0,composed:!0}))}render(){const e=!!this.text&&!!this.text.trim();if(!e&&!this.hasContent)return o``;const t=["info","success","warning","danger"].includes(this.theme)?this.theme:"info";return o`
            <div class="notice ${t} ${this.slim?"slim":""}">
                ${this.noIcon?l:o`<span class="icon ${this.icon?"custom":""}">${this.icon||ac[t]}</span>`}
    ...
    `;ke([u()],ie.prototype,"text",2);ke([u()],ie.prototype,"theme",2);ke([u()],ie.prototype,"icon",2);ke([u({type:Boolean})],ie.prototype,"noIcon",2);ke([u()],ie.prototype,"actionLabel",2);ke([u()],ie.prototype,"actionId",2);ke([u()],ie.prototype,"status",2);ke([u({type:Boolean})],ie.prototype,"slim",2);ke([u({type:Boolean})],ie.prototype,"fullWidth",2);ke([u({type:Boolean})],ie.prototype,"hasContent",2);ke([u({type:Boolean})],ie.prototype,"inlineContent",2);ie=ke([x("mateu-notice")],ie);const ic=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=ii(d.text??"",s,i,r,n)??"",h=t.children??[];return o`
        <mateu-notice
                text="${c}"
                theme="${d.theme??"info"}"
    ...
    `};var sc=Object.defineProperty,rc=Object.getOwnPropertyDescriptor,ui=(e,t,a,s)=>{for(var i=s>1?void 0:s?rc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&sc(t,a,i),i};let ea=class extends w{constructor(){super(...arguments),this.groups=[]}willUpdate(e){e.has("groups")&&(this.selectedId=this.groups.flatMap(t=>t.items??[]).find(t=>t.selected)?.id)}select(e){this.selectedId=e,this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{_item:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="rail">
                ${this.groups.map(e=>o`
                    <div class="group">
    ...
    `];ui([u()],ea.prototype,"actionId",2);ui([u({type:Array})],ea.prototype,"groups",2);ui([b()],ea.prototype,"selectedId",2);ea=ui([x("mateu-task-queue")],ea);const oc=e=>{const t=e.metadata;return o`
        <mateu-task-queue
                .actionId="${t.actionId}"
                .groups="${t.groups??[]}"
                style="${e.style??l}"
    ...
    `];la([u()],vt.prototype,"actionId",2);la([u({type:Number})],vt.prototype,"columns",2);la([u()],vt.prototype,"recommendedLabel",2);la([u({type:Array})],vt.prototype,"items",2);la([b()],vt.prototype,"selectedId",2);vt=la([x("mateu-resource-grid")],vt);const dc=e=>{const t=e.metadata;return o`
        <mateu-resource-grid
                .actionId="${t.actionId}"
                .columns="${t.columns??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-resource-grid>
    `};var cc=Object.defineProperty,uc=Object.getOwnPropertyDescriptor,me=(e,t,a,s)=>{for(var i=s>1?void 0:s?uc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&cc(t,a,i),i};let J=class extends w{constructor(){super(...arguments),this.title="",this.features=[],this.current=!1,this.added=!1}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return o`
                ...
                ${this.items.map(e=>{const t=e.id!=null&&this.added.has(e.id);return o`
                        <div class="card ${t?"added":""}">
                            ...
                            ${e.includedLabel?o`<span class="included">${e.includedLabel}</span>`:o`
                                    ${e.price!=null?o`
                                        <span class="price">${Ja(e.price,this.currency)}${e.unit?` / ${e.unit}`:""}</span>
                                    `:l}
    ...
    `;da([u()],ft.prototype,"totalLabel",2);da([u()],ft.prototype,"currency",2);da([u()],ft.prototype,"actionId",2);da([u({type:Array})],ft.prototype,"items",2);da([b()],ft.prototype,"added",2);ft=da([x("mateu-addon-picker")],ft);const vc=e=>{const t=e.metadata;return o`
        <mateu-addon-picker
                ...
                slot="${e.slot??l}"
        ></mateu-addon-picker>
    `};var fc=Object.defineProperty,bc=Object.getOwnPropertyDescriptor,za=(e,t,a,s)=>{for(var i=s>1?void 0:s?bc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&fc(t,a,i),i};let qt=class extends w{constructor(){super(...arguments),this.lines=[]}computedTotal(){return this.total!=null?this.total:this.lines.filter(e=>!e.included).reduce((e,t)=>e+(t.amount??0),0)}render(){return o`
            ${this.lines.map(e=>o`
                <div class="row">
                    <span class="dot"></span>
                    <span class="concept">${e.concept}</span>
                    ${e.included?o`<span class="included-label">${e.includedLabel||"Included"}</span>`:o`<span class="amount ${(e.amount??0)<0?"negative":""}">${Ja(e.amount??0,this.currency)}</span>`}
                </div>
            `)}
            <div class="total-row">
                <span class="total-label">${this.totalLabel||"Total"}</span>
                <span class="total">${Ja(this.computedTotal(),this.currency)}</span>
            </div>
        `}};qt.styles=$`
        :host {
    ...
    `;za([u()],qt.prototype,"currency",2);za([u()],qt.prototype,"totalLabel",2);za([u({type:Array})],qt.prototype,"lines",2);za([u({type:Number})],qt.prototype,"total",2);qt=za([x("mateu-ledger")],qt);const gc=e=>{const t=e.metadata;return o`
        <mateu-ledger
                .currency="${t.currency}"
                .totalLabel="${t.totalLabel}"
                .lines="${t.lines??[]}"
    ...
    `;at([u()],Oe.prototype,"actionId",2);at([u()],Oe.prototype,"methodActionId",2);at([u({type:Array})],Oe.prototype,"methods",2);at([u()],Oe.prototype,"selected",2);at([u()],Oe.prototype,"contextLabel",2);at([u()],Oe.prototype,"contextValue",2);at([u()],Oe.prototype,"confirmLabel",2);at([b()],Oe.prototype,"selectedId",2);Oe=at([x("mateu-payment-picker")],Oe);const xc=e=>{const t=e.metadata;return o`
        <mateu-payment-picker
                ...
                slot="${e.slot??l}"
        ></mateu-payment-picker>
    `};var wc=Object.defineProperty,kc=Object.getOwnPropertyDescriptor,Ys=(e,t,a,s)=>{for(var i=s>1?void 0:s?kc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&wc(t,a,i),i};let Xa=class extends w{constructor(){super(...arguments),this.items=[]}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="list">
                ${this.items.map(e=>o`
                    <div class="row">
    ...
    `;Ys([u({type:Array})],Xa.prototype,"items",2);Xa=Ys([x("mateu-process-monitor")],Xa);const Cc=e=>{const t=e.metadata;return o`
        <mateu-process-monitor
                ...
                slot="${e.slot??l}"
        ></mateu-process-monitor>
    `},_c=(e,t)=>{let a=e.style;return e.id&&(a&&!a.endsWith(";")&&(a+=";"),a==null&&(a=""),t[e.id+".hidden"]==!0&&(a+="display: none;")),a},Sc=(e,t)=>{let a={...e.metadata};if(e.id&&a){if(a.type==v.Button){const s=a;t[e.id+".disabled"]==!0&&(s.disabled=!0)}if(a.type==v.FormField){const s=a;t[e.id+".disabled"]==!0&&(s.disabled=!0)}}return a},O=e=>t=>e(t.container,t.component,t.baseUrl,t.state,t.data,t.appState,t.appData),Ic={[v.Bpmn]:({component:e})=>ml(e),[v.Workflow]:({component:e})=>fl(e),[v.WorkflowElk]:({component:e})=>bl(e),[v.FormEditor]:({component:e})=>gl(e),[v.Page]:O(Si),[v.Div]:O(ul),[v.Directory]:({component:e,baseUrl:t,state:a,data:s})=>cl(e),[v.FormLayout]:O(vn),[v.HorizontalLayout]:O(gn),[v.VerticalLayout]:O($n),[v.SplitLayout]:O(yn),[v.MasterDetailLayout]:O(xn),[v.TabLayout]:O(wn),[v.AccordionLayout]:O(Cn),[v.BoardLayout]:O(Pn),[v.BoardLayoutRow]:O(On),[v.BoardLayoutItem]:O(Tn),[v.Scroller]:O(Sn),[v.FullWidth]:O(In),[v.Container]:O(En),[v.Form]:({container:e,component:t,baseUrl:a,state:s,data:i,appState:r,appData:n})=>{const d=t.metadata;return o`<mateu-form
            id="${t.id}"
        baseUrl="${a}"
            .component="${t}"
            .values="${s}"
            ...
            >
                ${t.children?.map(c=>C(e,c,a,s,i,r,n))}
            ${d?.buttons?.map(c=>o`
               ${C(e,{id:c.actionId,metadata:c,type:ue.ClientSide,slot:"buttons"},void 0,s,i,r,n)}
`)}
        ...
        baseUrl="${a}"
            ...
            >
             ${t.children?.map(d=>C(e,d,a,s,i,r,n))}
            </mateu-table>`,[v.Crud]:O(Ii),[v.App]:({container:e,component:t,baseUrl:a,state:s,data:i,appState:r,appData:n})=>o`
            <mateu-app
                        id="${t.id}"
                        baseUrl="${a}"
                        .component="${t}"
            ...
            >
             ${t.children?.map(d=>C(e,d,a,s,i,r,n))}
         </mateu-app>`,[v.Element]:({container:e,component:t})=>Bn(e,t.metadata,t),[v.FormField]:({container:e,component:t,baseUrl:a,state:s,data:i,appState:r,appData:n,labelAlreadyRendered:d})=>{const c=t.metadata;return o`
    <mateu-field
                   id="${t.id}"
                   .component="${t}"
            .field="${t.metadata}"
        ...
        `},[v.Text]:({component:e,state:t,data:a,appState:s,appData:i})=>jn(e,t,a,s,i),[v.Avatar]:({component:e,state:t,data:a})=>Do(e,t,a),[v.Chat]:({component:e,state:t,data:a})=>vl(e),[v.AvatarGroup]:({component:e})=>Lo(e),[v.Badge]:({component:e,state:t,data:a})=>No(e,t,a),[v.Breadcrumbs]:({component:e})=>ll(e),[v.Anchor]:({component:e})=>Vn(e),[v.Button]:({component:e,state:t,data:a})=>Hn(e,t,a),[v.Card]:O(Gn),[v.Chart]:({component:e})=>Kn(e),[v.Icon]:({component:e})=>Yn(e),[v.ConfirmDialog]:O(Jn),[v.ContextMenu]:O(Ln),[v.CookieConsent]:({component:e})=>Xn(e),[v.Details]:O(Qn),[v.Dialog]:({component:e,baseUrl:t,state:a,data:s,appState:i,appData:r})=>Zn(e,t,a,s,i,r),[v.Drawer]:({component:e,baseUrl:t,state:a,data:s,appState:i,appData:r})=>el(e,t,a,s,i,r),[v.Image]:({component:e})=>nl(e),[v.Map]:({component:e})=>ol(e),[v.Markdown]:({component:e})=>al(e),[v.MicroFrontend]:({component:e})=>tl(e),[v.Notification]:({component:e})=>il(e),[v.ProgressBar]:({component:e,state:t})=>sl(e,t),[v.Popover]:O(rl),[v.CarouselLayout]:O(dl),[v.Tooltip]:O(qn),[v.MessageInput]:({component:e})=>Nn(e),[v.MessageList]:({component:e})=>Dn(e),[v.CustomField]:O(Fn),[v.MenuBar]:({container:e,component:t,baseUrl:a,state:s,data:i})=>An(e,t,a,s,i),[v.Grid]:O(Rn),[v.VirtualList]:O(zn),[v.FormSection]:O(hl),[v.FormSubSection]:O(pl),[v.MetricCard]:({component:e})=>wl(e),[v.Scoreboard]:O(kl),[v.DashboardPanel]:O(Cl),[v.DashboardLayout]:O(_l),[v.FoldoutLayout]:O(El),[v.HeroSection]:O(Pl),[v.EmptyState]:({component:e})=>Ko(e),[v.Skeleton]:({component:e})=>Yo(e),[v.Gantt]:({component:e})=>zl(e),[v.PlanningBoard]:({component:e})=>Ll(e),[v.Kanban]:({component:e})=>Nl(e),[v.Timeline]:({component:e})=>Ul(e),[v.ProgressSteps]:({component:e})=>Vl(e),[v.Stat]:({component:e})=>Gl(e),[v.Calendar]:({component:e})=>Jl(e),[v.PricingTable]:({component:e})=>Zl(e),[v.OrgChart]:({component:e})=>ad(e),[v.Heatmap]:({component:e})=>od(e),[v.Funnel]:({component:e})=>dd(e),[v.TrendChart]:({component:e})=>hd(e),[v.FeatureGrid]:({component:e})=>vd(e),[v.Testimonials]:({component:e})=>gd(e),[v.Faq]:({component:e})=>xd(e),[v.CalloutCard]:({component:e})=>Cd(e),[v.CommentThread]:({component:e})=>Id(e),[v.FileList]:({component:e})=>Td(e),[v.Checklist]:({component:e})=>Dd(e),[v.ComparisonCard]:({component:e})=>Fd(e),[v.EntityHeader]:({component:e})=>Bd(e),[v.Meter]:({component:e})=>Wd(e),[v.TaskProgress]:({component:e})=>Kd(e),[v.StatusList]:({component:e})=>Xd(e),[v.BulletedList]:({component:e})=>Qd(e),[v.Separator]:({component:e})=>Zd(e),[v.Notice]:O(ic),[v.TaskQueue]:({component:e})=>oc(e),[v.ResourceGrid]:({component:e})=>dc(e),[v.OfferCard]:({component:e})=>hc(e),[v.AddOnPicker]:({component:e})=>vc(e),[v.Ledger]:({component:e})=>gc(e),[v.PaymentPicker]:({component:e})=>xc(e),[v.ProcessMonitor]:({component:e})=>Cc(e)},ji=(e,t,a,s,i,r,n,d)=>{if(!t?.metadata)return t==null?(console.warn("No metadata for component",t),o`<p>No metadata for component</p>`):ji(e,{id:ge(),metadata:t,type:ue.ClientSide},a,s,i,r,n,d);const c=t.metadata.type,h={...t,style:_c(t,i),metadata:Sc(t,i)},p=Ic[c];return p?p({container:e,component:h,baseUrl:a,state:s,data:i,appState:r,appData:n,labelAlreadyRendered:d}):o`<p ${h?.slot??l}>Unknown metadata type ${c} for component ${h?.id}</p>`};var Ec=Object.defineProperty,Pc=Object.getOwnPropertyDescriptor,Ce=(e,t,a,s)=>{for(var i=s>1?void 0:s?Pc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ec(t,a,i),i};let se=class extends w{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.dataProvider=(e,t)=>{const a=this.data[this.id]?.page;t(a?.content??[],a?.content?.length??0)},this.respondToVisibility=(e,t)=>{var a={root:document.documentElement},s=new IntersectionObserver(i=>{i.forEach(r=>{t(r.intersectionRatio>0)})},a);s.observe(e)},this.keepAsking=!1,this.askToUpper=()=>{const e=this.data[this.id]?.page,t=e?.content?.length/e?.pageSize;this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:{page:t,pageSize:this.metadata?.pageSize},callback:()=>{this.keepAsking&&this.askToUpper()}},bubbles:!0,composed:!0}))},this.renderItem=e=>e.card?ji(this,e.card,this.baseUrl,this.state,this.data,this.appState,this.appData,!1):e.title?o`<vaadin-card
        >
                ${e.title?o`
                ...
                `:l}
                ${e.status?o`
                    <span slot="header-suffix" theme="badge ${oi(e.status.type)}">${e.status.message}</span>
                `:l}
                ${e.image?o`
    ...
    `;Ce([u()],se.prototype,"id",2);Ce([u()],se.prototype,"metadata",2);Ce([u()],se.prototype,"baseUrl",2);Ce([u()],se.prototype,"state",2);Ce([u()],se.prototype,"data",2);Ce([u()],se.prototype,"appState",2);Ce([u()],se.prototype,"appData",2);Ce([u()],se.prototype,"emptyStateMessage",2);Ce([b()],se.prototype,"keepAsking",2);Ce([Re("#ask-for-more")],se.prototype,"askForMore",2);Ce([b()],se.prototype,"hasMore",2);se=Ce([x("mateu-card-list")],se);var Js=(e=>(e.none="none",e.success="success",e.error="error",e.warning="warning",e.contrast="contrast",e.normal="normal",e))(Js||{}),Xs=(e=>(e.primary="primary",e.secondary="secondary",e.tertiary="tertiary",e.tertiaryInline="tertiaryInline",e))(Xs||{});const Oc=76;function rs(e){if(e.weight!=null)return e.weight;const t=e.stereotype??"";if(t==="icon")return 1;if(t==="image")return 4;if(t==="html"||t==="richText"||t==="markdown"||t==="textarea")return 5;if(t==="link")return 2.5;if(t==="combobox"||t==="select")return 2;const a=e.dataType??"";return a==="bool"?1:a==="status"||a==="integer"?1.5:a==="number"||a==="date"||a==="money"?2:a==="dateTime"||a==="dateRange"?2.5:3}function Tc(e,t){if(e.length===0)return"table";const a=e.reduce((c,h)=>c+rs(h),0),s=t/Oc,i=a/s;if(i<=1)return"table";const r=e.filter(c=>c.identifier||(c.priority??Number.MAX_SAFE_INTEGER)<=2),n=r.reduce((c,h)=>c+rs(h),0);return i>1.6||e.length>10?"masterDetail":r.length>0&&n<=8?"list":e.some(c=>c.stereotype==="image"||c.stereotype==="html")||r.length===0&&e.length>=4&&e.length<=8?"cards":"masterDetail"}function Qs(e){return e.filter(t=>t.identifier||(t.priority??Number.MAX_SAFE_INTEGER)<=2).sort((t,a)=>(t.priority??Number.MAX_SAFE_INTEGER)-(a.priority??Number.MAX_SAFE_INTEGER))}function zc(e){const t=Qs(e);return t.length>0?t:e.slice(0,3)}var Rc=Object.defineProperty,Dc=Object.getOwnPropertyDescriptor,_e=(e,t,a,s)=>{for(var i=s>1?void 0:s?Dc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Rc(t,a,i),i};const Lc={asc:"ascending",desc:"descending"};let re=class extends w{constructor(){super(...arguments),this.component=void 0,this.standalone=!1,this.state={},this.data={},this.appState={},this.appData={},this.showImportDialog=!1,this.availableWidthPx=1024,this.selectedItem=null,this._columnPrefsRevision=0,this._prefsRevisionApplied=-1,this.search=()=>{const e=this.component.metadata;this.state={...this.state,size:e.pageSize,page:0,crud_selected_items:[]},this._syncStateToUrl(e),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}}},bubbles:!0,composed:!0}))},this.notify=e=>{zt.show(e,{position:"bottom-end",theme:"error",duration:3e3})},this.handleSearchRequested=e=>{this.state={...this.state,crud_selected_items:[]};const t=this.component.metadata;this._syncStateToUrl(t),!t.infiniteScrolling&&this.data?.[this.id]?.page&&(this.data[this.id].page.content=[]),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}},callback:e},bubbles:!0,composed:!0}))},this.fetchMoreElements=e=>{const{params:t,callback:a}=e.detail;this.state={...this.state,size:t.pageSize,page:t.page},this.handleSearchRequested(a)},this.directionChanged=e=>{const t=e.detail.grid._sorters;this.state={...this.state,sort:t.map(a=>({fieldId:a.__data.path,direction:a.__data.direction?Lc[a.__data.direction]:void 0}))},this.handleSearchRequested(void 0)},this._initializedForComponentId=void 0,this.evalLabel=e=>Pe(e,this.state,this.data),this.handleToolbarButtonClick=e=>{if(e==="import"){this.showImportDialog=!0;return}this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.handleImportUploadSuccess=e=>{const t=e.detail.xhr.responseText;this.showImportDialog=!1,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"process-import",parameters:{fileId:t}},bubbles:!0,composed:!0}))}}get columnPrefsScope(){return window.location.pathname}get effectiveComponent(){const e=this.component,t=e?.metadata;if(!e||!t?.columns)return e;if(this._prefsSource===e&&this._prefsRevisionApplied===this._columnPrefsRevision)return this._prefsApplied;const a=Rs(this.columnPrefsScope),s=Ls(t.columns,a,i=>i.metadata??{});return this._prefsApplied=s===t.columns?e:{...e,metadata:{...t,columns:s}},this._prefsSource=e,this._prefsRevisionApplied=this._columnPrefsRevision,this._prefsApplied}get columnChooserEntries(){return(this.component?.metadata?.columns??[]).map(t=>{const a=t.metadata??{},s=a.id??t.id;return s?{id:s,label:a.label??s,protected:Ds(a)}:void 0}).filter(t=>!!t)}renderColumnChooser(){const e=this.columnChooserEntries;return e.filter(t=>!t.protected).length===0?l:o`
            <mateu-column-chooser
                .columns="${e}"
                .scope="${this.columnPrefsScope}"
                @column-prefs-changed="${t=>{t.stopPropagation(),this._columnPrefsRevision++}}"
            ></mateu-column-chooser>
        `}get cols(){return this.effectiveComponent?.metadata?.columns?.map(t=>t.metadata)??[]}get identifierFieldName(){const e=this.cols.find(t=>t.identifier);return e?e.id:this.cols.find(t=>t.id==="id")?.id}get effectiveGridLayout(){const e=this.component?.metadata,t=e?.gridLayout??"auto";return t==="auto"?e?.crudlType==="card"?"cards":Tc(this.cols,this.availableWidthPx):t}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{const t=e[0]?.contentRect.width;t&&Math.abs(t-this.availableWidthPx)>10&&(this.availableWidthPx=t)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}_filterIds(e){return new Set(["searchText",...(e.filters??[]).flatMap(t=>t.stereotype==="dateRange"||t.stereotype==="numberRange"?[`${t.fieldId}_from`,`${t.fieldId}_to`]:[t.fieldId])])}_syncStateToUrl(e){const t=this._filterIds(e),a=new URLSearchParams(window.location.search);t.forEach(d=>a.delete(d)),a.delete("page"),a.delete("sort"),t.forEach(d=>{const c=this.state[d];c!=null&&c!==""&&a.set(d,String(c))});const s=this.state.page;s&&s>0&&a.set("page",String(s));const i=this.state.sort;if(i&&i.length>0){const d=i.filter(c=>c.fieldId&&c.direction).map(c=>`${c.fieldId}:${c.direction}`).join(",");d&&a.set("sort",d)}const r=a.toString(),n=r?`${window.location.pathname}?${r}`:window.location.pathname;window.location.pathname+window.location.search!==n&&history.replaceState(null,"",n)}_initStateFromUrl(e,t){const a=new URLSearchParams(window.location.search),s=this._filterIds(e),i={...t};a.forEach((d,c)=>{s.has(c)&&(i[c]=d)});const r=a.get("page");if(r!==null){const d=parseInt(r,10);!isNaN(d)&&d>0&&(i.page=d)}const n=a.get("sort");if(n){const d=n.split(",").map(c=>{const[h,p]=c.split(":");return h&&p?{fieldId:h,direction:p}:null}).filter(Boolean);d.length>0&&(i.sort=d)}return i}pageChanged(e){this.state={...this.state,page:e.detail.page},this.handleSearchRequested(void 0)}updated(e){if(super.updated(e),e.has("component")){const t=this.component?.id;if(t!==this._initializedForComponentId){this._initializedForComponentId=t;const a=this.component?.metadata,s=a.initialPage&&a.initialPage>0?a.initialPage:0;this.state=this._initStateFromUrl(a,{...this.state,size:a.pageSize,page:s,sort:[]}),(this.state.page!==s||this.state.sort?.length>0||[...this._filterIds(a)].some(r=>this.state[r]!=null))&&this.handleSearchRequested(void 0)}}}render(){const e=_=>{const A=[];return _.color&&_.color!==Js.normal&&A.push(_.color),_.buttonStyle&&A.push(_.buttonStyle===Xs.tertiaryInline?"tertiary-inline":_.buttonStyle),A.length?A.join(" "):void 0},t=_=>_==="back"||_==="backToList"||!!_&&_.startsWith("cancel"),a=_=>{const A=W.get()?.renderToolbarButton?.(_,this.evalLabel(_.label),()=>this.handleToolbarButtonClick(_.actionId));return A||o`
                <vaadin-button
                        data-action-id="${_.id}"
                        theme="${e(_)||l}"
                        @click="${()=>this.handleToolbarButtonClick(_.actionId)}"
                >${this.evalLabel(_.label)}</vaadin-button>
            `};if(!this.component)return o`no component`;const s=this.effectiveComponent,i=s.metadata;i.serverSideOrdering=!0;const r=i?.toolbar??[],n=r.filter(_=>t(_.actionId)),d=r.filter(_=>!t(_.actionId)),c=n.length>0&&d.length>0,h=!!i?.title||!!i?.subtitle||r.length>0,p=this.effectiveGridLayout,m=this.cols,f=Qs(m),y=this.data[this.id]?.page?.content??[],g=this.state[this.component?.id]?.emptyStateMessage,I=(_,A)=>{const T=A[_.id];if(T==null)return o``;if(_.dataType==="status"){const D=oi(T.type);return o`<span theme="badge pill ${D}">${T.message}</span>`}return _.dataType==="bool"?o`${T?"✓":"✗"}`:typeof T=="object"?o`${T.label??T.name??T.message??""}`:o`${T}`},j=()=>{const _=this.identifierFieldName,A=this.state._selectedId??this.appState?._splitDetailId,T=f.find(P=>P.identifier)??f[0],D=P=>P.dataType==="action"||P.dataType==="actionGroup"||P.dataType==="menu"||P.stereotype==="button",He=f.filter(P=>P!==T&&!D(P)),Ht=m.filter(P=>D(P)),rt=(P,te,be)=>{P.stopPropagation(),P.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:te,parameters:{_clickedRow:be}},bubbles:!0,composed:!0}))},Gt=P=>{const te=[];for(const be of Ht){const F=P[be.id];if(be.dataType==="action"){const L=F?.methodNameInCrud?F:P.action?.methodNameInCrud?P.action:{methodNameInCrud:be.id,label:be.label,icon:null};te.push(o`
                            <vaadin-button theme="tertiary small" title="${L.label||l}"
                                @click="${S=>rt(S,"action-on-row-"+L.methodNameInCrud,P)}">
                            ...
                            <vaadin-button theme="tertiary small" title="${S.label||l}"
                                @click="${V=>rt(V,"action-on-row-"+S.methodNameInCrud,P)}">
                                ${S.icon?o`<vaadin-icon icon="${S.icon}"></vaadin-icon>`:l}
                                ${S.label??l}
                ...
                <vaadin-list-box style="width: 100%;">
                    ${y.length===0?o`<vaadin-item disabled>${Pt(g)}</vaadin-item>`:l}
                    ${y.map(P=>o`
                        <vaadin-item
                        ...
                        >
                            ...
                            <div style="font-size: var(--lumo-font-size-s); color: var(--lumo-secondary-text-color); display: flex; flex-wrap: wrap; gap: var(--lumo-space-xs); align-items: center;">
                                ${He.map(te=>o`<span>${te.label}: ${I(te,P)}</span>`)}
                            </div>
                            ${Gt(P)}
                        </vaadin-item>
                    `)}
                </vaadin-list-box>`},ne=(_,A,T)=>{const D=this.identifierFieldName;D&&T[D]!==void 0&&(this.state={...this.state,_selectedId:String(T[D])}),_.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:A,parameters:T},bubbles:!0,composed:!0}))},R=()=>{const _=this.identifierFieldName,A=this.state._selectedId??this.appState?._splitDetailId,T=m.slice(0,6),D=T.filter(S=>S.stereotype==="image"),He=T.find(S=>S.identifier)??T[0],Ht=S=>!!S.actionId,rt=S=>S.dataType==="action"||S.dataType==="actionGroup"||S.dataType==="menu"||S.stereotype==="button",Gt=T.find(S=>S.id==="select"&&S.dataType==="action"),P=!!Gt,te=T.filter(S=>S!==He&&!D.includes(S)&&!Ht(S)&&!rt(S)),be=T.filter(S=>rt(S)&&!(P&&S===Gt)),F=(S,V,ot)=>{S.stopPropagation(),S.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:V,parameters:{_clickedRow:ot}},bubbles:!0,composed:!0}))},L=S=>{const V=[];for(const ot of be){const bi=S[ot.id];if(ot.dataType==="action"){const Kt=bi?.methodNameInCrud?bi:S.action?.methodNameInCrud?S.action:{methodNameInCrud:ot.id,label:ot.label,icon:null};V.push(o`
                            <vaadin-button theme="tertiary" title="${Kt.label||l}"
                                @click="${St=>F(St,"action-on-row-"+Kt.methodNameInCrud,S)}">
                                ${Kt.icon?o`<vaadin-icon icon="${Kt.icon}"></vaadin-icon>`:l}
                                ${Kt.label??l}
                            </vaadin-button>`)}else(ot.dataType==="actionGroup"||ot.dataType==="menu")&&(bi?.actions??[]).forEach(St=>V.push(o`
                            <vaadin-button theme="tertiary" title="${St.label||l}"
                                @click="${or=>F(or,"action-on-row-"+St.methodNameInCrud,S)}">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: var(--lumo-space-m); padding: var(--lumo-space-s) 0;">
                    ...
                    `)}
                </div>`},Q=()=>{const _=zc(m),A=_.find(D=>D.identifier)??_[0],T=_.filter(D=>D!==A);return o`
                ...
                </div>`},le=()=>{const _=this.identifierFieldName,A=this.state._selectedId??this.appState?._splitDetailId,T=m[0],D=m.slice(1),He=!!T?.actionId,Ht=F=>(F??[]).map(L=>{const S=Array.isArray(L.children)?L.children:[];return S.length>0?{...L,children:Ht(S)}:{...L,children:void 0}}),rt=Ht(y),Gt=(F,L)=>{const S=F.parentItem?F.parentItem.children??[]:rt;L(S,S.length)},P=(F,L)=>{for(const S of F??[]){if(_&&String(S[_])===L)return S;const V=P(S.children,L);if(V)return V}},te=_&&A!==void 0?P(rt,String(A)):void 0,be=(F,L,S)=>{F.stopPropagation(),_&&L[_]!==void 0&&(this.state={...this.state,_selectedId:String(L[_])}),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:S,parameters:L},bubbles:!0,composed:!0}))};return o`
                <vaadin-grid
                    style="width: 100%;"
                    all-rows-visible
                ...
                >
                    ...
                    ${He?o`
                    <vaadin-grid-column width="6rem" flex-grow="0" text-align="end" ${Xe(F=>F?.viewable===!1?l:o`
                        <vaadin-button theme="tertiary small" @click="${L=>be(L,F,"view")}">View</vaadin-button>
                    `,[])}></vaadin-grid-column>`:l}
                    ${D.map(F=>F.id==="select"?o`<vaadin-grid-column width="7rem" flex-grow="0" text-align="end" header="${F.label??l}" ${Xe(L=>o`
                    ...
                    <span slot="empty-state">${Pt(g)}</span>
            ...
            `:R():!K&&p==="masterDetail"?Q():!K&&p==="tree"?le():W.get()?.renderTableComponent(this,s,this.baseUrl,this.state,this.data,this.appState,this.appData)}
            <slot></slot>
        ...
        `}createRenderRoot(){return W.mustUseShadowRoot()?super.createRenderRoot():this}};re.styles=$`
        ${tt}
    ...
    `;_e([u()],re.prototype,"component",2);_e([u()],re.prototype,"baseUrl",2);_e([u({type:Boolean})],re.prototype,"standalone",2);_e([u()],re.prototype,"state",2);_e([u()],re.prototype,"data",2);_e([u()],re.prototype,"appState",2);_e([u()],re.prototype,"appData",2);_e([b()],re.prototype,"showImportDialog",2);_e([b()],re.prototype,"availableWidthPx",2);_e([b()],re.prototype,"selectedItem",2);_e([b()],re.prototype,"_columnPrefsRevision",2);re=_e([x("mateu-table-crud")],re);var ct=(e=>(e.OnLoad="OnLoad",e.OnSuccess="OnSuccess",e.OnError="OnError",e.OnValueChange="OnValueChange",e.OnCustomEvent="OnCustomEvent",e.AutoSave="AutoSave",e))(ct||{}),Ac=Object.defineProperty,hi=(e,t,a,s)=>{for(var i=void 0,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(t,a,i)||i);return i&&Ac(t,a,i),i};class _t extends ri{constructor(){super(...arguments),this.state={},this.data={},this.appData={},this.appState={},this.triggerOnLoad=()=>{const t=this.component;this.registerCustomEventListeners(),t.triggers?.filter(a=>a.type==ct.OnLoad).forEach(a=>{if((!a.condition||this._evalExpr(a.condition))&&!a.triggered){const i=a;i.triggered=!0;var s=i.times-1;i.timeoutMillis>0?this.scheduleOnload(i,s,this.id):this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:i.actionId},bubbles:!0,composed:!0}))}})},this.scheduleOnload=(t,a,s)=>{if(s!=this.component?.id)return;const i=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,callbackToken:i},bubbles:!0,composed:!0}))},t.timeoutMillis)},this._registeredCustomEventListeners=[],this.customEventManager=t=>{if(!(t instanceof CustomEvent))return;const a=t,i=(this.component.triggers??[]).filter(r=>r.type==ct.OnCustomEvent).filter(r=>r.eventName==a.type).filter(r=>r.source!=="COMPONENT"||a.detail?.__source===r.from);i.length!==0&&(i.some(r=>!r.source||r.source==="SELF")&&(t.stopPropagation(),t.preventDefault()),i.forEach(r=>{(!r.condition||this._evalExpr(r.condition))&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.actionId,parameters:a.detail},bubbles:!0,composed:!0}))}))}}_interpolationExtra(){return{appState:this.appState??{},appData:this.appData??{},component:this.component}}_evalExpr(t){return xs(t,this.state??{},this.data??{},this._interpolationExtra())}_evalTemplate(t){return Vr(t,this.state??{},this.data??{},this._interpolationExtra())}applyFragment(t){if(this.id==t.targetComponentId){if(t.component)if(ba.Add==t.action)this.component&&this.component.children?.push(t.component);else{if(this.callbackToken=ge(),t.component?.type==ue.ServerSide)if(this.component){const s=this.component,i=t.component;s.actions=i.actions,s.type=i.type,s.rules=i.rules,s.triggers=i.triggers,s.serverSideType=i.serverSideType,s.route=i.route,s.initialData=i.initialData,s.validations=i.validations,s.cssClasses=i.cssClasses,s.slot=i.slot,s.style=i.style,s.children=i.children,(s.serverSideType!=i.serverSideType||s.id!=i.id)&&setTimeout(()=>this.triggerOnLoad())}else this.component=t.component,setTimeout(()=>this.triggerOnLoad());else{const s=[t.component];this.component&&(this.component.children=s)}t.action!==ba.ReplaceKeepData&&(this.state={},this.data={})}if(t.state&&(this.state={...this.state,...t.state}),t.data){for(const s in t.data){const i=t.data[s]?.page;i?.pageNumber>0&&this.data[s]&&this.data[s].page.content&&(i.content?i.content=[...this.data[s].page.content,...i.content]:i.content=[...this.data[s].page.content])}this.data={...this.data,...t.data}}this.registerCustomEventListeners();const a=W.getAfterRenderHook();a&&setTimeout(()=>a(this)),this.requestUpdate()}}registerCustomEventListeners(){this._registeredCustomEventListeners.forEach(({target:a,name:s})=>a.removeEventListener(s,this.customEventManager)),this._registeredCustomEventListeners=[],this.component?.triggers?.filter(a=>a.type==ct.OnCustomEvent).forEach(a=>{const s=a.source==="DOCUMENT"||a.source==="COMPONENT"?document:this;s.addEventListener(a.eventName,this.customEventManager),this._registeredCustomEventListeners.push({target:s,name:a.eventName})})}disconnectedCallback(){this._registeredCustomEventListeners.forEach(({target:t,name:a})=>t.removeEventListener(a,this.customEventManager)),this._registeredCustomEventListeners=[],super.disconnectedCallback()}connectedCallback(){super.connectedCallback(),this.component&&this.registerCustomEventListeners()}}hi([u()],_t.prototype,"state");hi([u()],_t.prototype,"data");hi([u()],_t.prototype,"appData");hi([u()],_t.prototype,"appState");var Fc=Object.defineProperty,Nc=Object.getOwnPropertyDescriptor,pi=(e,t,a,s)=>{for(var i=s>1?void 0:s?Nc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Fc(t,a,i),i};let ta=class extends w{constructor(){super(...arguments),this.notificationOpened=!1,this.fetchStarted=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!0},this.fetchFinished=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1},this.fetchFailed=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1,this.error=e.detail.reason,this.openNotification()},this.openNotification=()=>{this.notificationOpened=!0},this.closeNotification=()=>{this.notificationOpened=!1},this.notificationRenderer=()=>o`
    <vaadin-horizontal-layout theme="spacing" style="align-items: center;">
...
`:o`<vaadin-button theme="tertiary" 
  ...
  `;Zs([u()],Qa.prototype,"target",2);Qa=Zs([x("mateu-event-interceptor")],Qa);var Hc=Object.defineProperty,Gc=Object.getOwnPropertyDescriptor,er=(e,t,a,s)=>{for(var i=s>1?void 0:s?Gc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Hc(t,a,i),i};let Za=class extends _t{constructor(){super(...arguments),this.opened=!0,this.close=()=>{this.opened=!1,setTimeout(()=>this.parentElement?.removeChild(this),500)}}applyFragment(e){super.applyFragment(e);const t=e.state?._closeAfterMillis;t&&setTimeout(()=>this.close(),t)}updated(e){if(super.updated(e),e.has("component")&&this.component){const t=this.component.metadata;this.state=t.initialData}}render(){const e=this.component.metadata;let t="";e.noPadding&&(t+=" no-padding");const a=ii(e.headerTitle,this.state,this.data,this.appState,this.appData);return o`
        <vaadin-dialog
                ...
                width="${e.width??l}"
                height="${e.height??l}"
                ${e.header||e.closeButtonOnHeader?xr(()=>o`<mateu-event-interceptor .target="${this}" style="width: 100%;">${e.header?C(this,e.header,this.baseUrl,this.state,this.data,this.appState,this.appData):l}${e.closeButtonOnHeader?o`
                            <vaadin-button theme="tertiary" @click="${this.close}">
                                <vaadin-icon icon="lumo:cross"></vaadin-icon>
                            </vaadin-button>
                        `:l}</mateu-event-interceptor>`,[this.state,this.data]):l}
                ${e.footer?Pi(()=>o`<mateu-event-interceptor .target="${this}" style="width: 100%;">${C(this,e.footer,this.baseUrl,this.state,this.data,this.appState,this.appData)}</mateu-event-interceptor>`,[this.state,this.data]):l}
                ${e.content?ti(()=>o`<mateu-event-interceptor .target="${this}" style="--mateu-section-border: none; width: 100%;">${C(this,e.content,this.baseUrl,this.state,this.data,this.appState,this.appData)}</mateu-event-interceptor>`,[this.state,this.data]):l}
       ...
       `}};Za.styles=$`
  `;er([b()],Za.prototype,"opened",2);Za=er([x("mateu-dialog")],Za);var Kc=Object.defineProperty,Yc=Object.getOwnPropertyDescriptor,tr=(e,t,a,s)=>{for(var i=s>1?void 0:s?Yc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Kc(t,a,i),i};let ei=class extends _t{constructor(){super(...arguments),this.opened=!1,this.close=()=>{this.opened=!1,setTimeout(()=>this.parentElement?.removeChild(this),300)},this._escListener=e=>{if(e.key!=="Escape")return;const a=this.getRootNode().querySelectorAll("mateu-drawer, mateu-dialog");a[a.length-1]===this&&(e.stopPropagation(),this.close())}}firstUpdated(){requestAnimationFrame(()=>this.opened=!0)}applyFragment(e){super.applyFragment(e);const t=e.state?._closeAfterMillis;t&&setTimeout(()=>this.close(),t)}updated(e){if(super.updated(e),e.has("component")&&this.component){const t=this.component.metadata;this.state=t.initialData}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._escListener)}disconnectedCallback(){document.removeEventListener("keydown",this._escListener),super.disconnectedCallback()}render(){const e=this.component.metadata,t=e.position??"end",a=ii(e.headerTitle,this.state,this.data,this.appState,this.appData);return o`
        ${e.modeless?l:o`
  ...
  `;tr([b()],ei.prototype,"opened",2);ei=tr([x("mateu-drawer")],ei);var Jc=Object.defineProperty,Xc=Object.getOwnPropertyDescriptor,oe=(e,t,a,s)=>{for(var i=s>1?void 0:s?Xc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Jc(t,a,i),i};function os(e){if(e.parentElement)return e.parentElement;const t=e.getRootNode();return t instanceof ShadowRoot?t.host:null}let G=class extends w{constructor(){super(...arguments),this.appState={},this.appData={},this.standalone=!1,this.actionBanners=[],this.dismissedStaticBannerIndices=new Set,this._tocEntries=[],this._activeToc=0,this._tocVisible=!1,this._tocRebuildScheduled=!1,this._headerH=0,this._onResize=()=>this._layoutStickyTops(),this._tocLocked=!1,this._unlockToc=e=>{if(e&&e.type==="keydown"){const t=e;if(t.ctrlKey&&t.altKey&&!t.shiftKey&&!t.metaKey&&/^(?:Digit|Numpad)[1-9]$/.test(t.code))return}this._tocLocked=!1},this._actionBannerTimers=[],this._staticBannerTimers=[],this._bannersHandler=e=>{const t=e.detail,a=t.banners??[],s=t.append??!1;s?this.actionBanners=[...this.actionBanners,...a]:(this._clearActionBannerTimers(),this.actionBanners=a);const i=s?this.actionBanners.length-a.length:0;a.forEach((r,n)=>{if(r.timeoutSeconds&&r.timeoutSeconds>0){const d=i+n;this._actionBannerTimers.push(setTimeout(()=>{this.actionBanners=this.actionBanners.filter((c,h)=>h!==d)},r.timeoutSeconds*1e3))}})},this._onTocKey=e=>{if(!this._tocVisible||!e.ctrlKey||!e.altKey||e.shiftKey||e.metaKey)return;const t=/^(?:Digit|Numpad)([1-9])$/.exec(e.code);if(!t)return;const a=parseInt(t[1],10)-1;a>=this._tocEntries.length||(e.preventDefault(),this._scrollToSection(a))},this._onScrollSpy=()=>{if(this._tocLocked)return;const e=this._sectionCards();if(!e.length)return;const t=12,a=this.shadowRoot?.querySelector("mateu-content-header");let s=a?a.getBoundingClientRect().bottom:0;for(const n of e){if(!n.classList.contains("mateu-section--sticky"))continue;const d=n.getBoundingClientRect();d.top<=s+t+2&&(s=Math.max(s,d.bottom))}const i=s+t+4;let r=0;this._tocEntries.forEach((n,d)=>{n.el.getBoundingClientRect().top<=i&&(r=d)}),this._activeToc=r}}connectedCallback(){super.connectedCallback(),document.addEventListener("page-banners-received",this._bannersHandler),window.addEventListener("resize",this._onResize),document.addEventListener("keydown",this._onTocKey)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("page-banners-received",this._bannersHandler),window.removeEventListener("resize",this._onResize),document.removeEventListener("keydown",this._onTocKey),this._clearAllTimers(),this._teardownScrollSpy()}updated(e){super.updated(e),e.has("component")&&e.get("component")!==void 0&&(this._clearAllTimers(),this.actionBanners=[],this.dismissedStaticBannerIndices=new Set),e.has("component")&&(this._scheduleStaticBannerTimeouts(),this.dispatchEvent(new CustomEvent("compact-changed",{detail:{compact:!!this.component?.style?.includes("--mateu-compact:1")},bubbles:!0,composed:!0})),this._scheduleTocRebuild())}_scheduleStaticBannerTimeouts(){this._staticBannerTimers.forEach(a=>clearTimeout(a)),this._staticBannerTimers=[],(this.component?.metadata?.banners??[]).forEach((a,s)=>{a.timeoutSeconds&&a.timeoutSeconds>0&&this._staticBannerTimers.push(setTimeout(()=>{this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,s])},a.timeoutSeconds*1e3))})}_clearActionBannerTimers(){this._actionBannerTimers.forEach(e=>clearTimeout(e)),this._actionBannerTimers=[]}_clearAllTimers(){this._clearActionBannerTimers(),this._staticBannerTimers.forEach(e=>clearTimeout(e)),this._staticBannerTimers=[]}_dismissActionBanner(e){this.actionBanners=this.actionBanners.filter((t,a)=>a!==e)}_dismissStaticBanner(e){this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,e])}bannerThemeClass(e){const t=e.theme?.toLowerCase()??"info";return t==="none"?"":t}_evalBannerText(e){return Pe(e,this.state,this.data)}_renderBanner(e,t){const a=this._evalBannerText(e.title),s=this._evalBannerText(e.description);return o`
    ...
    `;oe([u()],G.prototype,"component",2);oe([u()],G.prototype,"baseUrl",2);oe([u()],G.prototype,"state",2);oe([u()],G.prototype,"data",2);oe([u()],G.prototype,"appState",2);oe([u()],G.prototype,"appData",2);oe([u()],G.prototype,"value",2);oe([u({type:Boolean})],G.prototype,"standalone",2);oe([b()],G.prototype,"actionBanners",2);oe([b()],G.prototype,"dismissedStaticBannerIndices",2);oe([b()],G.prototype,"_tocEntries",2);oe([b()],G.prototype,"_activeToc",2);oe([b()],G.prototype,"_tocVisible",2);G=oe([x("mateu-page")],G);const mi=$`
    .nbtn {
        display: inline-flex;
        align-items: center;
        gap: .35em;
...
`,Q=!0)}Q&&this.updateMessage(r,n)}n||this.updateMessage(r,"⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).")}catch(d){console.error("Error en el flujo SSE:",d);const c=d?.message??String(d);(c==="Failed to fetch"||c==="network error"||c==="Load failed")&&!n?this.updateMessage(r,"⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible."):this.updateMessage(r,"⚠️ Error: "+c)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value="")},250),this.messageInputElement?.removeAttribute("disabled"),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent("close-requested",{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{const e=this.messageInputElement?.value?.trim()??"";e&&this.send(new CustomEvent("submit",{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key==="Enter"&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback(),this.probeLocalAgent();const e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){const t=new e;this.recognition=t,t.lang="es-ES",t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=a=>{console.error("Error de reconocimiento: "+a.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:"smooth"})},0)}addMessage(e,t){const a={text:e,time:new Date().toLocaleTimeString(),userName:t.includes("agent")?"Asistente":"Tú",userColorIndex:t.includes("agent")?2:1};return this.items=[...this.items,a],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((a,s)=>s===e?{...a,text:t}:a),this.scrollBottom()}tryParseCustomEvent(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if(typeof a.event=="string")return{event:a.event,detail:a.detail??{}}}catch{}return null}tryParseTokenUsage(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if("inputTokens"in a||"outputTokens"in a||"totalTokens"in a)return a}catch{}return null}buildMenuContext(e,t=[]){const a=[];for(const s of e){if(s.separator||s.remote)continue;const i=[...t,s.label];if(s.submenus&&s.submenus.length>0)a.push(...this.buildMenuContext(s.submenus,i));else{const r={path:i,navigation:{route:s.route,consumedRoute:s.consumedRoute,actionId:s.actionId??"",baseUrl:s.baseUrl,serverSideType:s.serverSideType,uriPrefix:s.uriPrefix}};s.description&&(r.description=s.description),a.push(r)}}return a}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return o`
                    ...
                    <div class="message-list" role="list">
                        ${this.items.map(e=>o`
                            <div class="message" role="listitem">
                                <div class="avatar" style="background: ${iu(e.userColorIndex)};">${su(e.userName)}</div>
    ...
    `];M([u({attribute:!1})],N.prototype,"contextProvider",2);M([u()],N.prototype,"localAgentUrl",2);M([u({attribute:!1})],N.prototype,"mcpUrl",2);M([b()],N.prototype,"localAgentAlive",2);M([u()],N.prototype,"sseUrl",2);M([u()],N.prototype,"uploadUrl",2);M([u({attribute:!1})],N.prototype,"menu",2);M([b()],N.prototype,"attachments",2);M([b()],N.prototype,"uploading",2);M([Re(".file-input")],N.prototype,"fileInputElement",2);M([u({type:Boolean,reflect:!0})],N.prototype,"expanded",2);M([u()],N.prototype,"items",2);M([Re(".scroll-container")],N.prototype,"scrollContainer",2);M([Re(".msg-input")],N.prototype,"messageInputElement",2);M([b()],N.prototype,"recognition",2);M([b()],N.prototype,"listening",2);M([b()],N.prototype,"recognitionAvailable",2);M([b()],N.prototype,"loading",2);M([b()],N.prototype,"elapsedSeconds",2);M([b()],N.prototype,"tokenUsage",2);N=M([x("mateu-chat")],N);var ru=Object.defineProperty,ou=Object.getOwnPropertyDescriptor,Ra=(e,t,a,s)=>{for(var i=s>1?void 0:s?ou(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ru(t,a,i),i};let Mt=class extends w{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.data&&this.createChart(this.data)}async createChart(e){const[{default:t}]=await Promise.all([ce(()=>import("./vendor-chartjs.js").then(s=>s.a),[]),ce(()=>import("./vendor-chartjs.js").then(s=>s.c),[])]);if(e!==this.data)return;this.chart&&this.chart.destroy();const a={type:this.type,data:this.data,options:this.options};this.chart=new t(this.chartElement,a)}handleSlotChange(){}render(){return o`
            <div class="container">
       ...
       `}};Mt.styles=$`
  `;Ra([u()],Mt.prototype,"type",2);Ra([u()],Mt.prototype,"data",2);Ra([u()],Mt.prototype,"options",2);Ra([Re("#chart")],Mt.prototype,"chartElement",2);Mt=Ra([x("mateu-chart")],Mt);var nu=Object.defineProperty,lu=Object.getOwnPropertyDescriptor,Gi=(e,t,a,s)=>{for(var i=s>1?void 0:s?lu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&nu(t,a,i),i};let Ca=class extends w{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){const{default:t}=await ce(async()=>{const{default:s}=await import("./vendor-diagrams.js").then(i=>i.i);return{default:s}},__vite__mapDeps([4,3,1,2]));if(e!==this.xml)return;this.chart&&this.chart.destroy();const a={container:this.divElement};this.chart=new t(a),this.chart.importXML(e)}handleSlotChange(){}render(){return o`
       ...
       `}};Ca.styles=$`
  `;Gi([u()],Ca.prototype,"xml",2);Gi([Re("#canvas")],Ca.prototype,"divElement",2);Ca=Gi([x("mateu-bpmn")],Ca);var du=Object.defineProperty,cu=Object.getOwnPropertyDescriptor,ua=(e,t,a,s)=>{for(var i=s>1?void 0:s?cu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&du(t,a,i),i};const ki=160,Le=56,uu=220,ls=110,nt=60,hu={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},pu={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},mu=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];function vu(){return"step-"+Math.random().toString(36).slice(2,8)}let bt=class extends w{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.wf={name:"New Workflow",steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value")){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){const e=this.wf.steps??[],t={};e.forEach(n=>{t[n.id]=0});let a=!0;for(;a;)a=!1,e.forEach(n=>{if(n.preconditionStepId!=null&&t[n.preconditionStepId]!==void 0){const d=t[n.preconditionStepId]+1;d>t[n.id]&&(t[n.id]=d,a=!0)}});const s={};e.forEach(n=>{const d=t[n.id]??0;(s[d]??=[]).push(n.id)});const i={...this.positions};let r=!1;Object.entries(s).forEach(([n,d])=>{const c=Number(n);d.forEach((h,p)=>{i[h]||(i[h]={x:nt+c*uu,y:nt+p*ls},r=!0)})}),r&&(this.positions=i)}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addStep(){const e=vu(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(i=>i.y),s=a.length?Math.max(...a)+ls:nt;this.positions={...this.positions,[e]:{x:nt,y:s}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(s=>s.id!==e).map(s=>s.preconditionStepId===e?{...s,preconditionStepId:void 0}:s)};const{[e]:t,...a}=this.positions;this.positions=a,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},s=this.toSvgPoint(e);this.dragOffset={x:s.x-a.x,y:s.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(s=>s.x))+ki+nt:600,a=e.length?Math.max(...e.map(s=>s.y))+Le+nt:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return B``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return B``;const s=t.x+ki,i=t.y+Le/2,r=a.x,n=a.y+Le/2,d=(s+r)/2;return B`
            <path d="M${s},${i} C${d},${i} ${d},${n} ${r},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:nt,y:nt},a=hu[e.type]??"#64748b",s=pu[e.type]??"•",i=this.selectedId===e.id;return B`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${r=>this.onNodeMouseDown(r,e.id)}"
               @click="${r=>{r.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${ki}" height="${Le}" rx="8"
                      fill="white"
                      stroke="${i?a:"#e2e8f0"}"
                      stroke-width="${i?2.5:1.5}"
                      filter="url(#shadow)"/>
                <!-- type badge -->
                <rect x="0" y="0" width="32" height="${Le}" rx="8" fill="${a}" clip-path="inset(0 -8px 0 0 round 8px)"/>
                ...
                <text x="44" y="${Le/2+20}" font-size="9" fill="${a}">${e.type}</text>
            </g>
                ...
                <div class="prop-body">
                    ...
                    ${a("Type",o`
                        <select class="inp" @change="${s=>this.updateStep(e.id,{type:s.target.value})}">
                            ${mu.map(s=>o`<option value="${s}" ?selected="${e.type===s}">${s}</option>`)}
                        </select>`)}
        ...
        `}exportJson(){const e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),s=document.createElement("a");s.href=a,s.download=(this.wf.name??"workflow").replace(/\s+/g,"-").toLowerCase()+".json",s.click(),URL.revokeObjectURL(a)}};bt.styles=[mi,$`
    ...
    `];ua([u()],bt.prototype,"value",2);ua([b()],bt.prototype,"wf",2);ua([b()],bt.prototype,"positions",2);ua([b()],bt.prototype,"selectedId",2);ua([b()],bt.prototype,"showMeta",2);bt=ua([x("mateu-workflow")],bt);var fu=Object.defineProperty,bu=Object.getOwnPropertyDescriptor,it=(e,t,a,s)=>{for(var i=s>1?void 0:s?bu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&fu(t,a,i),i};const ha=160,Se=56,lt=60,gu={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},$u={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},yu=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];let Ci;const xu=()=>(Ci||(Ci=ce(()=>import("./vendor-diagrams.js").then(e=>e.e),__vite__mapDeps([4,3,1,2])).then(e=>new e.default)),Ci);function wu(){return"step-"+Math.random().toString(36).slice(2,8)}let Te=class extends w{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.readOnly=!1,this.wf={name:"New Workflow",steps:[]},this.positions={},this.layoutReady=!1,this.selectedId=null,this.showMeta=!1,this.layoutError=null,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.elkPositioned=new Set,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.elkPositioned.add(this.draggingId),this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value"))try{const t=JSON.parse(this.value),a=new Set((this.wf.steps??[]).map(r=>r.id)),s=new Set((t.steps??[]).map(r=>r.id)),i=a.size!==s.size||[...s].some(r=>!a.has(r))||[...s].some(r=>{const n=(this.wf.steps??[]).find(c=>c.id===r),d=(t.steps??[]).find(c=>c.id===r);return n?.preconditionStepId!==d?.preconditionStepId});this.wf=t,(i||!this.layoutReady)&&this.runElkLayout()}catch{}}async runElkLayout(){const e=this.wf.steps??[];if(e.length===0){this.positions={},this.layoutReady=!0;return}const t={id:"root",layoutOptions:{"elk.algorithm":"layered","elk.direction":"RIGHT","elk.spacing.nodeNode":"40","elk.layered.spacing.nodeNodeBetweenLayers":"80","elk.edgeRouting":"ORTHOGONAL","elk.layered.nodePlacement.strategy":"BRANDES_KOEPF"},children:e.map(a=>({id:a.id,width:ha,height:Se})),edges:e.filter(a=>a.preconditionStepId).map(a=>({id:`${a.preconditionStepId}->${a.id}`,sources:[a.preconditionStepId],targets:[a.id]}))};try{const s=await(await xu()).layout(t),i={...this.positions};for(const r of s.children??[])(!this.elkPositioned.has(r.id)||!i[r.id])&&(i[r.id]={x:(r.x??0)+lt,y:(r.y??0)+lt},this.elkPositioned.add(r.id));this.positions=i,this.layoutReady=!0,this.layoutError=null}catch(a){this.layoutError=a?.message??"ELK layout failed",this.layoutReady=!0}}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){const a=this.wf.steps.map(r=>r.id===e?{...r,...t}:r),s=this.wf.steps.find(r=>r.id===e),i=t.preconditionStepId!==void 0&&t.preconditionStepId!==s?.preconditionStepId;this.wf={...this.wf,steps:a},i&&(this.elkPositioned.clear(),this.runElkLayout()),this.emit()}addStep(){const e=wu(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(s=>s.x);this.positions={...this.positions,[e]:{x:a.length?Math.max(...a)+ha+80:lt,y:lt}},this.selectedId=e,this.elkPositioned.clear(),this.runElkLayout(),this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(s=>s.id!==e).map(s=>s.preconditionStepId===e?{...s,preconditionStepId:void 0}:s)};const{[e]:t,...a}=this.positions;this.positions=a,this.elkPositioned.delete(e),this.selectedId===e&&(this.selectedId=null),this.runElkLayout(),this.emit()}onNodeMouseDown(e,t){if(this.readOnly)return;e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},s=this.toSvgPoint(e);this.dragOffset={x:s.x-a.x,y:s.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}relayout(){this.elkPositioned.clear(),this.runElkLayout()}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(s=>s.x))+ha+lt:600,a=e.length?Math.max(...e.map(s=>s.y))+Se+lt:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){if(!this.layoutReady)return o`<div class="loading">Computing layout…</div>`;const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return B``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return B``;const s=t.x+ha,i=t.y+Se/2,r=a.x,n=a.y+Se/2,d=(s+r)/2;return B`
            <path d="M${s},${i} C${d},${i} ${d},${n} ${r},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:lt,y:lt},a=gu[e.type]??"#64748b",s=$u[e.type]??"•",i=this.selectedId===e.id,r=e.name.length>16?e.name.slice(0,15)+"…":e.name;return B`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
        ...
        `}exportJson(){const e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),s=document.createElement("a");s.href=a,s.download=(this.wf.name??"workflow").replace(/\s+/g,"-").toLowerCase()+".json",s.click(),URL.revokeObjectURL(a)}};Te.styles=[mi,$`
        :host {display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif);}
        ...
        textarea.inp {resize: vertical;}
        input[readonly].inp {background: #f8fafc; color: #94a3b8;}
    `];it([u()],Te.prototype,"value",2);it([u({type:Boolean})],Te.prototype,"readOnly",2);it([b()],Te.prototype,"wf",2);it([b()],Te.prototype,"positions",2);it([b()],Te.prototype,"layoutReady",2);it([b()],Te.prototype,"selectedId",2);it([b()],Te.prototype,"showMeta",2);it([b()],Te.prototype,"layoutError",2);Te=it([x("mateu-workflow-elk")],Te);var ku=Object.defineProperty,Cu=Object.getOwnPropertyDescriptor,Da=(e,t,a,s)=>{for(var i=s>1?void 0:s?Cu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ku(t,a,i),i};const _u=["string","integer","number","bool","date","time","dateTime","dateRange","money","file","array","status","component","menu","range","action","actionGroup"],Su=["regular","radio","checkbox","textarea","toggle","combobox","select","email","password","richText","listBox","html","markdown","image","icon","link","money","grid","color","choice","popover","slider","button","stars"],Iu={string:"#3B82F6",integer:"#8B5CF6",number:"#6366F1",bool:"#10B981",date:"#F59E0B",time:"#F59E0B",dateTime:"#F59E0B",dateRange:"#F59E0B",money:"#EF4444",file:"#64748B",array:"#0EA5E9",status:"#EC4899",component:"#14B8A6",menu:"#94A3B8",range:"#A855F7",action:"#F97316",actionGroup:"#FB923C"};function ds(){return"field-"+Math.random().toString(36).slice(2,8)}let Ut=class extends w{constructor(){super(...arguments),this.value='{"name":"New Form","fields":[]}',this.form={name:"New Form",fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has("value"))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){const e=this.shadowRoot?.querySelector(".field-list");!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=_r.create(e,{animation:150,handle:".drag-handle",ghostClass:"sortable-ghost",onEnd:t=>{const{oldIndex:a,newIndex:s}=t;if(a===void 0||s===void 0||a===s)return;const i=[...this.form.fields],[r]=i.splice(a,1);i.splice(s,0,r),this.form={...this.form,fields:i},this.emit()}}))}emit(){const e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addField(){const e=ds(),t={id:e,label:"New Field",dataType:"string"};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){const t=this.form.fields.find(r=>r.id===e);if(!t)return;const a={...t,id:ds(),label:t.label+" (copy)"},s=this.form.fields.findIndex(r=>r.id===e),i=[...this.form.fields];i.splice(s+1,0,a),this.form={...this.form,fields:i},this.selectedId=a.id,this.emit()}render(){return o`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderRow(e){const t=Iu[e.dataType]??"#64748b",a=this.selectedId===e.id;return o`
        ...
        `}exportJson(){const e=JSON.stringify(this.form,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),s=document.createElement("a");s.href=a,s.download=(this.form.name??"form").replace(/\s+/g,"-").toLowerCase()+".json",s.click(),URL.revokeObjectURL(a)}};Ut.styles=[mi,$`
        :host { display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif); }
        ...
        textarea.inp { resize: vertical; }
        input[readonly].inp { background: #f8fafc; color: #94a3b8; }
    `];Da([u()],Ut.prototype,"value",2);Da([b()],Ut.prototype,"form",2);Da([b()],Ut.prototype,"selectedId",2);Da([b()],Ut.prototype,"showMeta",2);Ut=Da([x("mateu-form-editor")],Ut);var Eu=Object.defineProperty,Pu=Object.getOwnPropertyDescriptor,We=(e,t,a,s)=>{for(var i=s>1?void 0:s?Pu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Eu(t,a,i),i};let xe=class extends w{constructor(){super(...arguments),this.appState={},this.appData={},this.open=!1,this.activeTab="appstate",this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null,this._prevTarget=null,this._onMouseover=e=>{let t=e.target;for(;t&&!(t.tagName?.toLowerCase().startsWith("mateu-")&&t!==this);)t=t.parentElement;if(t===this||t===null){t===null&&this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset="",this._prevTarget=null,this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null);return}t!==this._prevTarget&&(this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset=""),this._prevTarget=t,t.style.outline="2px solid #0070f3",t.style.outlineOffset="-2px",this.hoveredTag=t.tagName.toLowerCase(),this.hoveredId=t.id||"",this.hoveredState=t.state,this.hoveredData=t.data,this.hoveredMeta=t.component?.metadata)}}connectedCallback(){super.connectedCallback(),document.addEventListener("mouseover",this._onMouseover,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mouseover",this._onMouseover,!0),this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget=null)}_fmt(e){try{return JSON.stringify(e,null,2)??"null"}catch{return String(e)}}_renderTab(e,t){return o`
    ...
    `;We([u()],xe.prototype,"appState",2);We([u()],xe.prototype,"appData",2);We([b()],xe.prototype,"open",2);We([b()],xe.prototype,"activeTab",2);We([b()],xe.prototype,"hoveredTag",2);We([b()],xe.prototype,"hoveredId",2);We([b()],xe.prototype,"hoveredState",2);We([b()],xe.prototype,"hoveredData",2);We([b()],xe.prototype,"hoveredMeta",2);xe=We([x("mateu-debug-overlay")],xe);var Ie=(e=>(e.SetAppDataValue="SetAppDataValue",e.SetAppStateValue="SetAppStateValue",e.SetDataValue="SetDataValue",e.RunAction="RunAction",e.RunJS="RunJS",e.SetAttributeValue="SetAttributeValue",e.SetStateValue="SetStateValue",e.SetCssClass="SetCssClass",e.SetStyle="SetStyle",e))(Ie||{}),ar=(e=>(e.required="required",e.disabled="disabled",e.hidden="hidden",e.pattern="pattern",e.minValue="minValue",e.maxValue="maxValue",e.minLength="minLength",e.maxLength="maxLength",e.css="css",e.style="style",e.theme="theme",e.errorMessage="errorMessage",e.description="description",e.none="none",e))(ar||{}),ir=(e=>(e.Continue="Continue",e.Stop="Stop",e))(ir||{}),Ou=Object.defineProperty,Tu=Object.getOwnPropertyDescriptor,vi=(e,t,a,s)=>{for(var i=s>1?void 0:s?Tu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ou(t,a,i),i};let pa=null,aa=class extends _t{constructor(){super(...arguments),this.baseUrl="",this.route="",this.consumedRoute="",this.formerState={},this.applyRules=()=>{const e=this.component.rules;if(e&&e.length>0){const t=this.state,a=this.data,s=this.appState,i=this.appData,r=this.component,n=y=>xs(y,t,a,{appState:s,appData:i,component:r}),d=y=>ys(y,t,a,s,i,{component:r}),c=["state","data","appState","appData","component"],h=[t,a,s,i,r],p={...this.state},m={...this.data};let f=!1,k=!1;for(let y=0;y<e.length;y++){const g=e[y];try{if(n(g.filter)){if(Ie.SetStateValue==g.action||Ie.SetDataValue==g.action){const I=Ie.SetStateValue==g.action?p:m,j=g.fieldName.split(",");for(let ne=0;ne<j.length;ne++){const R=j[ne];if(!I[R]||I[R]!=g.value){const Q=g.expression?d(g.expression):g.value,le=ar.none==g.fieldAttribute?R:R+"."+g.fieldAttribute;Q!=I[le]&&(I[le]=Q,Ie.SetStateValue==g.action&&(f=!0),Ie.SetDataValue==g.action&&(k=!0))}}}if(Ie.RunAction==g.action&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:g.actionId},bubbles:!0,composed:!0})),Ie.RunJS==g.action&&new Function(...c,g.value)(...h),Ie.SetAttributeValue==g.action){const I=g.expression?n(g.expression):g.value;if(g.fieldAttribute=="disabled"){I?this.shadowRoot?.getElementById(g.fieldName)?.setAttribute(g.fieldAttribute,"disabled"):this.shadowRoot?.getElementById(g.fieldName)?.removeAttribute(g.fieldAttribute);continue}this.shadowRoot?.getElementById(g.fieldName)?.setAttribute(g.fieldAttribute,I)}if(Ie.SetCssClass==g.action&&this.shadowRoot?.getElementById(g.fieldName)?.setAttribute("class",g.value),Ie.SetStyle==g.action&&this.shadowRoot?.getElementById(g.fieldName)?.style.setProperty(g.expression,g.value),ir.Stop==g.result)break}}catch(I){console.error("rule failed",g,I)}}f&&(this.state=p),k&&(this.data=m),f&&this.checkValidations()}},this.skipValidation=(e,t)=>e&&t.fieldId&&!e.includes(t.fieldId)||!e&&t.fieldId&&t.fieldId.includes("-"),this.checkValidations=e=>{const t=e?e.split(","):void 0,a=this.component.validations;let s=!0,i=!1;const r=this.data??{},n={...this.data??{},errors:{}};if(a){for(let d=0;d<a.length;d++){const c=a[d];if(this.skipValidation(t,c))continue;const h=(c.fieldId??"_component").split(",");for(let p=0;p<h.length;p++){const m=h[p];n.errors[m]=[]}}for(let d=0;d<a.length;d++){const c=a[d];if(!this.skipValidation(t,c))try{const h=c.condition&&c.condition.includes("${")?this._evalTemplate(c.condition):this._evalExpr(c.condition);if(c.condition&&!h){s=!1;const m=(c.fieldId??"_component").split(",");for(let f=0;f<m.length;f++){const k=m[f];let y=n.errors[k];if(y||(n.errors[k]=[]),y=n.errors[k],!r[k]){let g=c.message;try{g=this._evalTemplate(c.message)}catch{}y.push(g)}}}}catch(h){console.error("validation failed",c,h)}}for(let d=0;d<a.length;d++){const c=a[d];if(this.skipValidation(t,c))continue;const h=(c.fieldId??"_component").split(",");for(let p=0;p<h.length;p++){const m=h[p];if(r.errors?[m].join(","):n.errors==""&&[m].join(",")){i=!0;break}}}(r.errors?["_component"].join(","):n.errors==""&&["_component"].join(","))&&(i=!0)}n._valid=s,n._valid!=r._valid&&(i=!0),i&&(this.data=n)},this._autoSaveTimers=new Map,this.onChange=()=>{this.applyRules()},this.closeModalRequestedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&this.closeModal()},this.resetFilters=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail,a={};t.fieldIds.forEach(s=>{a[s]=void 0}),a.searchText=void 0,this.state={...this.state,...a}}},this.dataChangedListener=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail,a={};a[t.key]=t.value,e.type=="data-changed"&&(this.data={...this.data,...a})}},this.valueChangedListener=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail;if(e.type=="value-changed"){const a={...this.state};a[t.fieldId]=t.value,this.state=a,(this.state[t.fieldId]||this.formerState[t.fieldId])&&this.state[t.fieldId]!=this.formerState[t.fieldId]&&this.component?.confirmOnNavigationIfDirty&&this.dispatchEvent(new CustomEvent("dirty",{detail:e.detail,bubbles:!0,composed:!0}));const s=this.component;s.triggers?.filter(i=>i.type==ct.OnValueChange).filter(i=>!i.propertyName||t.fieldId==i.propertyName).forEach(i=>{(!i.condition||this._evalExpr(i.condition))&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:i.actionId},bubbles:!0,composed:!0}))}),s.triggers?.filter(i=>i.type==ct.AutoSave).forEach(i=>{const r=i.actionId,n=this._autoSaveTimers.get(r);n!==void 0&&clearTimeout(n),this._autoSaveTimers.set(r,setTimeout(()=>{this._autoSaveTimers.delete(r),this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:i.actionId},bubbles:!0,composed:!0}))},i.debounceMillis??800))})}}},this.actionRequestedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&this.manageActionRequestedEvent(e)},this.manageActionRequestedEvent=e=>{const t=e.detail;if(e.type=="action-requested"){e.preventDefault(),e.stopPropagation();const a=this.component,s=a.actions?.find(i=>i.id==t.actionId||i.id.endsWith("*")&&t.actionId.startsWith(i.id.replace("*","")));if(s){if(s&&s.rowsSelectedRequired&&(!this.state.crud_selected_items||this.state.crud_selected_items.length==0)){this.notify("You first need to select some rows");return}if(s&&s.validationRequired){const r=pa??this;if(pa=null,r.checkValidations(s.fieldsToValidate),!r.data._valid){r.notifyValidationErrors();return}}pa=null;const i={...t,initiatorComponentId:this.id};s&&s.confirmationRequired?this.callAfterConfirmation(s,()=>this.requestActionCallToServerOrBubble(i,a,s)):this.requestActionCallToServerOrBubble(i,a,s)}else{const i={...t.parameters};i.initiatorState||(i.initiatorState=this.state),pa||(pa=this),this.dispatchEvent(new CustomEvent(e.type,{detail:{...e.detail,parameters:i},bubbles:!0,composed:!0}))}}},this.buildFieldLabelMap=()=>{const e={},t=a=>{if(a)for(const s of a){const i=s.metadata;if(i?.type===v.FormField){const r=i;r.fieldId&&r.label&&(e[r.fieldId]=r.label)}t(s.children)}};return t(this.component?.children),e},this.notifyValidationErrors=()=>{const e=this.data?.errors??{},t=this.buildFieldLabelMap(),a=[];if(Object.entries(e).forEach(([i,r])=>{if(!Array.isArray(r))return;const n=i==="_component"?void 0:t[i]??i;r.forEach(d=>{d&&!a.some(c=>c.label===n&&c.msg===d)&&a.push({label:n,msg:d})})}),a.length===0){this.notify("There are validation errors");return}const s=document.createElement("vaadin-notification");s.position="bottom-end",s.setAttribute("theme","error"),s.duration=Math.max(3e3,1500+a.length*1e3),s.renderer=i=>{bs(o`
            ...
            `:l}</div>`}_render(){if(this.component?.type==ue.ClientSide){const e=this.component;return e.metadata?.type==v.Page?Si(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):e.metadata?.type==v.Crud?Ii(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):W.get()?.renderClientSideComponent(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!1)}return o`
            <mateu-api-caller 
            ...
            ${this.component?.children?.map(e=>{if(e.type==ue.ClientSide){const t=e;if(t.metadata?.type==v.Page)return Si(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0);if(t.metadata?.type==v.Crud)return Ii(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0)}return C(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData)})}
            </mateu-api-caller>
        `}};aa.styles=$`
        :host {
        }
  ...
  `;vi([u()],aa.prototype,"baseUrl",2);vi([u()],aa.prototype,"route",2);vi([u()],aa.prototype,"consumedRoute",2);aa=vi([x("mateu-component")],aa);const cs=e=>{if(e)try{return JSON.parse(e)}catch{return{value:e}}else return{}};class zu{async handle(t,a){return await t.runAction(a.baseUrl,a.route,a.consumedRoute,a.actionId,a.initiatorComponentId,a.appState,a.serverSideType,a.componentState,a.parameters,a.initiator,a.background)}}const Ru=new zu;class Du{constructor(){this.mapPosition=t=>{switch(t){case"topStretch":return"top-stretch";case"topStart":return"top-start";case"topCenter":return"top-center";case"topEnd":return"top-end";case"middle":return"middle";case"bottomStart":return"bottom-start";case"bottomEnd":return"bottom-end";case"bottomStretch":return"bottom-stretch";case"bottomCenter":return"bottom-center"}return"bottom-end"},this.handleUIIncrement=(t,a,s)=>{if(t?.fragments?.forEach(i=>{Ot.next({command:void 0,fragment:i,ui:void 0,error:void 0,callbackToken:s})}),t?.appState&&(H.value={...t.appState},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))),t?.appData){const i=t?.appData;fa.value={...t.appData,...i},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))}t?.messages?.forEach(i=>{zt.show(i.text,{position:i.position?this.mapPosition(i.position):void 0,theme:i.variant,duration:i.duration})}),t?.banners&&t.banners.length>0&&document.dispatchEvent(new CustomEvent("page-banners-received",{detail:{banners:t.banners,append:t.appendBanners??!1},bubbles:!1,composed:!1})),t?.commands?.forEach(i=>{Ot.next({command:i,fragment:void 0,ui:void 0,error:void 0,callbackToken:s})})}}async runAction(t,a,s,i,r,n,d,c,h,p,m,f,k,y,g){try{const I=await Ru.handle(t,{baseUrl:a,route:s,consumedRoute:i,actionId:r,appState:H.value,initiatorComponentId:n,componentState:h,parameters:p,serverSideType:c,initiator:m,background:f});k&&k(I),y||this.handleUIIncrement(I,m,g),I.messages&&I.messages.length==1&&I.messages[0].variant=="error"&&m.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0})),m.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:r,evevntId:ge()},bubbles:!0,composed:!0}))}catch(I){console.warn("Action request failed",I),m.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:r,reason:this.serialize(I)}})),m.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))}}serialize(t){return t?.message?t:JSON.stringify(t)}}const Lu=new Du,Au=Lu;class Fu{constructor(){this.mapPosition=t=>{switch(t){case"topStretch":return"top-stretch";case"topStart":return"top-start";case"topCenter":return"top-center";case"topEnd":return"top-end";case"middle":return"middle";case"bottomStart":return"bottom-start";case"bottomEnd":return"bottom-end";case"bottomStretch":return"bottom-stretch";case"bottomCenter":return"bottom-center"}return"bottom-end"},this.handleUIIncrement=(t,a,s)=>{if(t?.messages?.forEach(i=>{if(i.undoActionId){this.showUndoableMessage(i,a);return}zt.show(i.text,{position:i.position?this.mapPosition(i.position):"bottom-end",theme:i.variant,duration:i.duration})}),t?.banners&&t.banners.length>0&&document.dispatchEvent(new CustomEvent("page-banners-received",{detail:{banners:t.banners,append:t.appendBanners??!1},bubbles:!1,composed:!1})),t?.commands?.forEach(i=>{Ot.next({command:i,fragment:void 0,ui:void 0,error:void 0,callbackToken:s})}),t?.fragments?.forEach(i=>{Ot.next({command:void 0,fragment:i,ui:void 0,error:void 0,callbackToken:s})}),t?.appState&&(H.value={...t.appState},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))),t?.appData){const i=t?.appData;fa.value={...t.appData,...i},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))}}}async runAction(t,a,s,i,r,n,d,c,h,p,m,f,k,y,g){if(s){s=s||"_no_route",s&&s.startsWith("/")&&(s=s.substring(1));const I={serverSideType:c,appState:H.value,componentState:h,parameters:p,initiatorComponentId:n,consumedRoute:i,route:"/"+s,actionId:r};f||m.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),fetch(a+"/mateu/v3/sse/"+s,{method:"POST",headers:{Accept:"text/event-stream","Content-Type":"application/json"},body:JSON.stringify(I)}).then(async j=>{const ne=j.body?.pipeThrough(new TextDecoderStream).getReader();if(ne){let R="";for(;;){const{value:Q,done:le}=await ne.read();if(le)break;R+=Q;const K=R.split(`

`);R=K.pop()??"";for(const Z of K){const ee=Z.trim();if(ee)if(ee.startsWith("data:")){const fe=JSON.parse(ee.substring(5).trim());k&&k(fe),y||this.handleUIIncrement(fe,m,g),fe.messages&&fe.messages.length==1&&fe.messages[0].variant=="error"&&m.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))}else{let fe=ee;try{const _=JSON.parse(ee);fe=_.message,_._embedded?.errors?.length>0&&_._embedded.errors[0].message&&(fe=_._embedded.errors[0].message)}catch{}throw new Error(fe)}}}}f||m.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:r}})),m.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:r},bubbles:!0,composed:!0}))}).catch(j=>{m.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:r,reason:this.serialize(j)}})),m.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))})}}serialize(t){return t?.message?t:JSON.stringify(t)}showUndoableMessage(t,a){const s=new zt;s.position=t.position?this.mapPosition(t.position):"bottom-end",s.duration=t.duration??1e4,t.variant&&s.setAttribute("theme",t.variant),s.renderer=i=>{if(i.firstElementChild)return;const r=document.createElement("span");r.textContent=t.text;const n=document.createElement("button");n.textContent=t.undoLabel??"Undo",n.style.cssText="margin-left: 0.75rem; background: none; border: 1px solid currentColor; border-radius: var(--lumo-border-radius-s, 4px); color: inherit; cursor: pointer; padding: 0.15rem 0.6rem; font: inherit; font-weight: 600;",n.addEventListener("click",()=>{a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.undoActionId,parameters:t.undoParameters??{}},bubbles:!0,composed:!0})),s.opened=!1}),i.append(r,n)},document.body.appendChild(s),s.opened=!0,s.addEventListener("opened-changed",i=>{i.detail.value||s.remove()})}}const sr=new Fu;var Nu=Object.defineProperty,qu=Object.getOwnPropertyDescriptor,ve=(e,t,a,s)=>{for(var i=s>1?void 0:s?qu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Nu(t,a,i),i};let X=class extends si{constructor(){super(...arguments),this.consumedRoute="",this.serverSideType=void 0,this.uriPrefix=void 0,this.overrides=void 0,this.homeRoute=void 0,this.route=void 0,this.top=void 0,this.appState={},this.appData={},this.preventNavigation=!1,this.overridesParsed={},this.fragment=void 0,this.actionRequestedListener=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.manageActionEvent(e))},this.historyPushed=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.preventNavigation=!0,this.route=e.detail.route)},this.routeChangedListener=e=>{if(e instanceof CustomEvent){e.preventDefault(),e.stopPropagation();let t=e.detail.route;typeof t=="string"&&(t===""||t.startsWith("/"))&&this.consumedRoute&&this.consumedRoute!=="_empty"&&this.consumedRoute.startsWith("/")&&!t.startsWith(this.consumedRoute)&&(t=this.consumedRoute+t),this.uriPrefix&&(t.startsWith("/")&&this.uriPrefix.endsWith("/")?t=this.uriPrefix+t.substring(1):!t.startsWith("/")&&!this.uriPrefix.endsWith("/")?t=this.uriPrefix+"/"+t:t=this.uriPrefix+t),this.dispatchEvent(new CustomEvent("url-update-requested",{detail:{route:t},bubbles:!0,composed:!0}))}},this.backendFailedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&e.detail.actionId==""&&(this.fragment={targetComponentId:this.id,data:{},state:{},component:{type:ue.ClientSide,metadata:{type:v.Element,name:"div",content:"Not found"},id:"fieldId"},action:ba.Replace,containerId:void 0})},this.detail1=void 0,this.manageActionEvent=e=>{e.preventDefault(),e.stopPropagation(),this.detail1=e.detail;const t=this.detail1;if(e.type=="server-side-action-requested"){let a=Au;t.sse&&(a=sr),a.runAction(sa,this.baseUrl,t.route??"",t.consumedRoute,t.actionId,t.initiatorComponentId,this.getCustomisedAppState(),t.serverSideType,t.componentState,t.parameters,t.initiator,t.background,t.callback,t.callbackonly,t.callbackToken)}},this.getCustomisedAppState=()=>{let e={...H.value};if(this.overrides){const t=cs(this.overrides);e={...e,...t}}return e}}manageActionRequestedEvent(e){throw new Error("Method not implemented.")}createRenderRoot(){return W.mustUseShadowRoot()?super.createRenderRoot():this}connectedCallback(){super.connectedCallback(),this.overridesParsed=cs(this.overrides),this.addEventListener("server-side-action-requested",this.actionRequestedListener),this.addEventListener("backend-call-failed",this.backendFailedListener),this.addEventListener("history-pushed",this.historyPushed),this.addEventListener("route-changed",this.routeChangedListener),window.Vaadin.featureFlags.masterDetailLayoutComponent=!0}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("server-side-action-requested",this.actionRequestedListener),this.removeEventListener("backend-call-failed",this.backendFailedListener),this.removeEventListener("history-pushed",this.historyPushed),this.removeEventListener("route-changed",this.routeChangedListener)}shouldUpdate(e){if(this.fragment?.component&&[...e.keys()].every(a=>a==="appState"||a==="appData")){const a=this.renderRoot.querySelector("mateu-component");if(a)return e.has("appState")&&(a.appState=this.appState),e.has("appData")&&(a.appData=this.appData),!1}return!0}updated(e){(e.has("id")||e.has("baseurl")||e.has("route")||e.has("consumedRoute")||e.has("instant"))&&(this.preventNavigation||(this.callbackToken=this.instant||ge(),this.manageActionEvent(new CustomEvent("server-side-action-requested",{detail:{route:this.route,consumedRoute:this.consumedRoute,userData:void 0,actionId:"",serverSideType:this.serverSideType,initiatorComponentId:this.id,initiator:this,componentState:this.initialState,callbackToken:this.callbackToken},bubbles:!0,composed:!0})))),e.has("route")&&this.top&&(this.preventNavigation||this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:this.route},bubbles:!0,composed:!0}))),this.preventNavigation&&(this.preventNavigation=!1)}applyFragment(e){if(!e.component&&this.fragment?.component){this.fragment={...this.fragment,state:{...this.fragment.state??{},...e.state??{}},data:{...this.fragment.data??{},...e.data??{}}};return}this.fragment=e}render(){return o`
  ...
  `;st([u()],ze.prototype,"baseUrl",2);st([u()],ze.prototype,"route",2);st([u()],ze.prototype,"consumedRoute",2);st([u()],ze.prototype,"config",2);st([u()],ze.prototype,"top",2);st([u()],ze.prototype,"pathPrefix",2);st([b()],ze.prototype,"instant",2);st([u({type:Boolean})],ze.prototype,"debug",2);ze=st([x("mateu-ui")],ze);var Bu=Object.defineProperty,ju=Object.getOwnPropertyDescriptor,fi=(e,t,a,s)=>{for(var i=s>1?void 0:s?ju(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Bu(t,a,i),i};let gt=class extends w{constructor(){super(...arguments),this.baseUrl="",this.dataProvider=async(e,t)=>{const a=e.filter??"",i=await this.remoteSearch(a)??(this.selector.options??[]).filter(r=>r.label.toLowerCase().includes(a.toLowerCase()));t(i,i.length)}}connectedCallback(){super.connectedCallback(),Kr()}currentValue(){return String(Ti()[this.selector.fieldName]??"")}currentLabel(){const e=this.currentValue();if(!e)return"";const t=(this.selector.options??[]).find(s=>String(s.value)===e);if(t)return t.label;const a=_s()[this.selector.fieldName];return a!==void 0?String(a):e}pick(e,t){String(e??"")!==this.currentValue()&&(Gr(this.selector.fieldName,e,t),window.location.reload())}async remoteSearch(e){const t=this.app;if(t?.serverSideType)try{const a=await sa.runAction(this.baseUrl??"",t.rootRoute??t.initialRoute??"","",`_appcontext-search-${this.selector.fieldName}`,`appcontext-${this.selector.fieldName}`,void 0,t.serverSideType,{},{searchText:e},this,!0);for(const s of a?.fragments??[]){const n=s.data?.[`_appcontext_${this.selector.fieldName}`]?.content;if(Array.isArray(n))return n.map(d=>({value:d.value,label:d.label??String(d.value)}))}}catch{}}renderSelect(){const e=[{label:"—",value:""},...(this.selector.options??[]).map(t=>({label:t.label,value:String(t.value)}))];return o`
            ...
            </label>`}};gt.SEARCHABLE_THRESHOLD=7;gt.styles=$`
        :host {
            display: inline-flex;
            flex-shrink: 0;
        }
    ...
    `;La([u()],Bt.prototype,"app",2);La([u()],Bt.prototype,"baseUrl",2);La([b()],Bt.prototype,"opened",2);La([b()],Bt.prototype,"notifications",2);Bt=La([x("mateu-notification-bell")],Bt);const rr=e=>{if(!e||!("querySelectorAll"in e))return null;for(const t of e.querySelectorAll("*")){if(t.tagName?.toLowerCase()==="mateu-component")return t;const a=rr(t.shadowRoot);if(a)return a}return null},Hu=async(e,t,a)=>{const s=t.renderRoot??t,i=rr(s);await sr.runAction(sa,t.baseUrl??"",e.rootRoute||"_no_route","",a,i?.id??"app-header-action",{},e.serverSideType??"",{},{},i??t,!0,void 0,!1,"")},us=async(e,t,a)=>{try{await Hu(e,t,a)}catch(s){zt.show("La acción falló: "+s,{position:"bottom-start",duration:6e3,theme:"error"})}},ma=(e,t)=>{const a=e.contextSelectors??[],s=e.contextActions??[];return a.length===0&&s.length===0&&!e.notificationsEnabled?l:o`${e.notificationsEnabled?o`
        ...
        <vaadin-menu-bar theme="primary small" style="margin-left: 0.5rem; flex-shrink: 0;"
            ...
            @item-selected="${r=>{const n=r.detail?.value?.actionId;n&&us(e,t,n)}}"></vaadin-menu-bar>`:o`
        <vaadin-button theme="primary small" style="margin-left: 0.5rem; flex-shrink: 0;"
            @click="${()=>i.actionId&&us(e,t,i.actionId)}" title="${i.label}">
            ${i.icon?o`<vaadin-icon icon="${i.icon}" slot="prefix"></vaadin-icon>`:l}${i.label}
        </vaadin-button>`)}`},Aa=(e,t)=>e.themeToggle?o`
    ...
    `:l,Gu=(e,t)=>{t.filter!=e.detail.value&&(t.filter=e.detail.value)},hs=(e,t,a)=>{const s=dt(e,t,a),i=de(t,a);return s=="list"||s==i?"new":s},dt=(e,t,a)=>{const s=e?._route;if(s!=null&&(s===""||s.startsWith("/"))){const i=a.homeRoute??"",r=i.indexOf("?"),n=r>=0?i.substring(r+1):"",d=de(t,a)+s;if(!n)return d;const c=d.indexOf("?")>=0?"&":"?";return d+c+n}return t.selectedRoute?t.selectedRoute:a.homeRoute},de=(e,t)=>e.selectedRoute?e.selectedConsumedRoute??t.route:t.homeConsumedRoute,Ge=(e,t)=>e.selectedRoute?e.selectedBaseUrl??e.baseUrl:t.homeBaseUrl,Ke=(e,t)=>e.selectedRoute?e.selectedServerSideType??t.serverSideType:t.homeServerSideType,Ye=(e,t)=>e.selectedRoute?e.selectedUriPrefix:t.homeUriPrefix,Ku=(e,t,a,s,i,r,n)=>{const d=e.mapItems(t.menu,e.filter?.toLowerCase()??""),c=de(e,t),h=hs(s,e,t),p=h&&h!=="new"&&h.startsWith(c+"/")?h.substring(c.length+1).split("/")[0]:void 0;return o`
                    ${t.variant==Je.MEDIATOR?o`
...
`:l}
            ${t.variant==Je.HAMBURGUER_MENU?o`
                <vaadin-app-layout style="${t?.style}" class="${t?.cssClasses}" .drawerOpened=${!t.drawerClosed}>
                    ...
                    <vaadin-scroller slot="drawer" class="p-s"
                        ...
                        ${t.menu&&t.totalMenuOptions>10?o`
                            <vaadin-text-field style="width: calc(100% - 20px); padding-left: 10px; padding-right: 10px;" @value-changed="${m=>Gu(m,e)}">
            ...
            <slot></slot>
       `},Yu=(e,t)=>t!=null&&e!=null&&!e.has(t),Ju=typeof HTMLElement<"u"?HTMLElement:class{};class Xu extends Ju{static get observedAttributes(){return["type","renderer"]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){const t=this.getAttribute("type")??"unknown",a=this.getAttribute("renderer")??"unknown";this.shadowRoot||this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host { display: block; }
                .mateu-unsupported {
                    box-sizing: border-box;
        ...
        `}}typeof customElements<"u"&&!customElements.get("mateu-unsupported")&&customElements.define("mateu-unsupported",Xu);const ps=new Set,Qu=(e,t,a)=>{const s=`${a}/${t}`;return ps.has(s)||(ps.add(s),console.warn(`[mateu] Component type "${t}" is not supported by the "${a}" renderer — rendering <mateu-unsupported> placeholder.`)),o`<mateu-unsupported
            type="${t}"
            renderer="${a}"
            data-component-id="${e?.id??l}"
            slot="${e?.slot??l}"
    ></mateu-unsupported>`};class Zu{renderFilterBar(t,a,s,i,r,n,d,c){const h=a?.metadata,p=f=>{const{fieldId:k,value:y}=f.detail;t.state={...t.state,[k]:y}},m=f=>{const{fieldIds:k}=f.detail,y={};k.forEach(g=>{y[g]=void 0}),y.searchText=void 0,t.state={...t.state,...y}};return o`
            <mateu-filter-bar
                .metadata="${h}"
        ...
        <mateu-table id="${t.id}"
                     ...
                     baseUrl="${s}"
        ></mateu-table>
        `}rendererName(){return this.constructor?.name??"unknown"}supportedClientSideTypes(){}renderClientSideComponent(t,a,s,i,r,n,d,c){const h=a?.metadata?.type??a?.type,p=Object.values(v).includes(h)?h:void 0;return Yu(this.supportedClientSideTypes(),p)?Qu(a,p,this.rendererName()):ji(t,a,s,i,r,n,d,c)}renderAppComponent(t,a,s,i,r,n,d){return Ku(t,a?.metadata,s,i,r,n,d)}}class eh extends Zu{rendererName(){return"vaadin"}renderClientSideComponent(t,a,s,i,r,n,d,c){return super.renderClientSideComponent(t,a,s,i,r,n,d,c)}}W.set(new eh);
