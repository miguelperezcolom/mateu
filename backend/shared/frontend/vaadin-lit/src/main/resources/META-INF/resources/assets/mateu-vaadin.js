...
`;document.body.appendChild(Oa);const et=new di,B={value:{}},St={value:{}},ui={lon:0,lat:0},ca=3,pi=e=>{if(!e)return;const t=e.split(",").map(s=>s.trim());if(t.length!==2)return;const a=Number(t[0]),i=Number(t[1]);if(!(t[0]===""||t[1]===""||!Number.isFinite(a)||!Number.isFinite(i)))return{lon:i,lat:a}},vi=e=>{if(e==null||e.trim()==="")return ca;const t=Number(e);return Number.isFinite(t)?t:ca};var mi=Object.defineProperty,fi=Object.getOwnPropertyDescriptor,qt=(e,t,a,i)=>{for(var s=i>1?void 0:i?fi(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&mi(t,a,s),s};let ct=class extends L{constructor(){super(...arguments),this.renderSeq=0}updated(e){super.updated(e),this.createMap()}disconnectedCallback(){super.disconnectedCallback(),this.map?.setTarget(void 0),this.map=void 0}async createMap(){const e=++this.renderSeq,[{default:t},{default:a},{default:i},{default:s},{fromLonLat:r},{default:o}]=await Promise.all([te(()=>import("./vendor-ol.js").then(c=>c.M),[]),te(()=>import("./vendor-ol.js").then(c=>c.V),[]),te(()=>import("./vendor-ol.js").then(c=>c.T),[]),te(()=>import("./vendor-ol.js").then(c=>c.O),[]),te(()=>import("./vendor-ol.js").then(c=>c.p),[]),te(()=>import("./vendor-ol.js").then(c=>c.o),[])]);if(e!==this.renderSeq||!this.isConnected)return;if(!this.shadowRoot.querySelector("style[data-ol]")){const c=document.createElement("style");c.setAttribute("data-ol",""),c.textContent=o,this.shadowRoot.appendChild(c)}this.map&&(this.map.setTarget(void 0),this.map=void 0);const l=pi(this.position)??ui;this.map=new t({target:this.mapElement,layers:[new i({source:new s})],view:new a({center:r([l.lon,l.lat]),zoom:vi(this.zoom)})})}render(){return n`<div id="map"></div>`}};ct.styles=_`
    ...
    `},Fi=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},Ai=(e,t,a,i,s,r)=>{const o=a.xcolumn??r;if(o.actionId){const c=o.text||e[a.path];return n`
        ...
        >
                ...
                .value=${l}
                @value-changed=${c=>r(c.detail.value)}></vaadin-combo-box>`;case"lookup":{const c=a?.field?.fieldId,h=`search-${c}-${t.id}`,p=`${c}-${t.id}`,$=(t.editorOptions??[]).find(k=>String(k.value)===l)??(l?{value:l,label:Ui(e,t.id)??l}:void 0);return n`<vaadin-combo-box
                theme="small" style="width:100%;"
                item-label-path="label" item-id-path="value"
                .dataProvider=${(k,g)=>{a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:h,parameters:{searchText:k.filter,size:k.pageSize,page:k.page},callback:C=>{const q=C?.fragments?.[0]?.data?.[p];g(q?.content??[],q?.totalElements??0)},callbackonly:!0},bubbles:!0,composed:!0}))}}
                .selectedItem=${$}
                @selected-item-changed=${k=>{const g=k.detail.value,C=g?g.value:null;String(C??"")!==l&&(g&&Mi(e,t.id,g.label),r(C))}}></vaadin-combo-box>`}default:return n`<vaadin-text-field theme="small" style="width:100%;" .value=${l} @change=${c=>r(c.target.value)}></vaadin-text-field>`}},Jt=e=>ri(()=>n`<span title="${e}" style="white-space:normal;overflow-wrap:break-word;">${e}</span>`,[e]),ji=e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget?.dispatchEvent(new CustomEvent("sort-direction-changed",{detail:{grid:e.currentTarget.parentElement},bubbles:!0,composed:!0}))},Wi=(e,t,a,i,s,r,o)=>{const l=De(e.label,i,s);return n`
    ...
    `},Cs=(e,t,a,i,s,r,o)=>{const l=t.metadata;let c=t.style;return l.fullWidth&&(c=c?"width: 100%;"+c:"width: 100%;"),n`
        ...
        >
            <vaadin-tabs slot="tabs"
                         ...
                         @items-changed=${p}
            >
                ${t.children?.map(v=>v).map(v=>{const $=v.metadata.label,T=$?.includes("${")?e._evalTemplate($):$,k=v.metadata.shortcut;return n`
                    <vaadin-tab id="${T}"
                                style="${v.style}"
                                class="${v.cssClasses}"
                                data-shortcut="${k??d}"
...
`;return n`
        <vaadin-virtual-list
                ...
                slot="${t.slot??d}"
        ></vaadin-virtual-list>
    `},qs=(e,t,a,i,s,r,o)=>{const l=t.metadata;if(l.tree){const h=async(p,v)=>{const $=p.parentItem?p.parentItem.children:l.page.content;v($,$.length)};return n`
        ...
        >
            ...
            <vaadin-grid-column path="${p.id}"
                                ...
                                width="${$?.width??d}"
                                .column="${p.metadata}"
                                ${We((T,k,g)=>zt(T,k,g,$,e,a,i,s,r,o),[])}></vaadin-grid-column>
`:n`
...
`,Sr=e=>e=="up"?"var(--lumo-success-text-color, #1a7f37)":e=="down"?"var(--lumo-error-text-color, #c5221f)":"var(--lumo-secondary-text-color, #666)",Er=e=>e=="up"?"▲":e=="down"?"▼":"",Cr=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},Ir=e=>{const t=e.metadata,a=!!t.actionId;return n`
    ...
    `},Dr=(e,t,a,i,s,r,o)=>{const l=t.metadata,c=!!l.image,h=c?`background-image: linear-gradient(rgba(0,0,0,.35), rgba(0,0,0,.35)), url('${l.image}'); background-size: cover; background-position: center; color: #fff;`:"",p=l.centered===!1?"flex-start":"center",v=l.centered===!1?"left":"center";return n`
    ...
    `},zr=(e,t)=>{let a=e.style;return e.id&&(a&&!a.endsWith(";")&&(a+=";"),a==null&&(a=""),t[e.id+".hidden"]==!0&&(a+="display: none;")),a},Fr=(e,t)=>{let a={...e.metadata};if(e.id&&a){if(a.type==m.Button){const i=a;t[e.id+".disabled"]==!0&&(i.disabled=!0)}if(a.type==m.FormField){const i=a;t[e.id+".disabled"]==!0&&(i.disabled=!0)}}return a},E=e=>t=>e(t.container,t.component,t.baseUrl,t.state,t.data,t.appState,t.appData),Ar={[m.Bpmn]:({component:e})=>$r(e),[m.Workflow]:({component:e})=>wr(e),[m.WorkflowElk]:({component:e})=>xr(e),[m.FormEditor]:({component:e})=>kr(e),[m.Page]:E(Zt),[m.Div]:E(fr),[m.Directory]:({component:e,baseUrl:t,state:a,data:i})=>mr(e),[m.FormLayout]:E(ws),[m.HorizontalLayout]:E(Ss),[m.VerticalLayout]:E(Es),[m.SplitLayout]:E(Cs),[m.MasterDetailLayout]:E(Is),[m.TabLayout]:E(_s),[m.AccordionLayout]:E(Os),[m.BoardLayout]:E(zs),[m.BoardLayoutRow]:E(Fs),[m.BoardLayoutItem]:E(As),[m.Scroller]:E(Rs),[m.FullWidth]:E(Ls),[m.Container]:E(Ds),[m.Form]:({container:e,component:t,baseUrl:a,state:i,data:s,appState:r,appData:o})=>{const l=t.metadata;return n`<mateu-form
            id="${t.id}"
        baseUrl="${a}"
            .component="${t}"
            .values="${i}"
...
`)}
        ...
        baseUrl="${a}"
            ...
            >
             ${t.children?.map(l=>b(e,l,a,i,s,r,o))}
            </mateu-table>`,[m.Crud]:E(ea),[m.App]:({container:e,component:t,baseUrl:a,state:i,data:s,appState:r,appData:o})=>n`
            <mateu-app
                        id="${t.id}"
                        baseUrl="${a}"
                        .component="${t}"
    ...
    <mateu-field
        ...
        `},[m.Text]:({component:e,state:t,data:a,appState:i,appData:s})=>Js(e,t,a,i,s),[m.Avatar]:({component:e,state:t,data:a})=>Zi(e,t,a),[m.Chat]:({component:e,state:t,data:a})=>yr(e),[m.AvatarGroup]:({component:e})=>es(e),[m.Badge]:({component:e,state:t,data:a})=>is(e,t,a),[m.Breadcrumbs]:({component:e})=>pr(e),[m.Anchor]:({component:e})=>Ys(e),[m.Button]:({component:e,state:t,data:a})=>Qs(e,t,a),[m.Card]:E(Zs),[m.Chart]:({component:e})=>er(e),[m.Icon]:({component:e})=>tr(e),[m.ConfirmDialog]:E(ar),[m.ContextMenu]:E(Ms),[m.CookieConsent]:({component:e})=>ir(e),[m.Details]:E(sr),[m.Dialog]:({component:e,baseUrl:t,state:a,data:i,appState:s,appData:r})=>rr(e,t,a,i,s,r),[m.Image]:({component:e})=>ur(e),[m.Map]:({component:e})=>hr(e),[m.Markdown]:({component:e})=>or(e),[m.MicroFrontend]:({component:e})=>nr(e),[m.Notification]:({component:e})=>lr(e),[m.ProgressBar]:({component:e,state:t})=>dr(e,t),[m.Popover]:E(cr),[m.CarouselLayout]:E(vr),[m.Tooltip]:E(Vs),[m.MessageInput]:({component:e})=>Ws(e),[m.MessageList]:({component:e})=>Us(e),[m.CustomField]:E(js),[m.MenuBar]:({container:e,component:t,baseUrl:a,state:i,data:s})=>Bs(e,t,a,i,s),[m.Grid]:E(qs),[m.VirtualList]:E(Ns),[m.FormSection]:E(br),[m.FormSubSection]:E(gr),[m.MetricCard]:({component:e})=>Ir(e),[m.Scoreboard]:E(_r),[m.DashboardPanel]:E(Tr),[m.DashboardLayout]:E(Or),[m.FoldoutLayout]:E(Lr),[m.HeroSection]:E(Dr)},ra=(e,t,a,i,s,r,o,l)=>{if(!t?.metadata)return t==null?(console.warn("No metadata for component",t),n`<p>No metadata for component</p>`):ra(e,{id:se(),metadata:t,type:G.ClientSide},a,i,s,r,o,l);const c=t.metadata.type,h={...t,style:zr(t,s),metadata:Fr(t,s)},p=Ar[c];return p?p({container:e,component:h,baseUrl:a,state:i,data:s,appState:r,appData:o,labelAlreadyRendered:l}):n`<p ${h?.slot??d}>Unknown metadata type ${c} for component ${h?.id}</p>`};var Nr=Object.defineProperty,qr=Object.getOwnPropertyDescriptor,de=(e,t,a,i)=>{for(var s=i>1?void 0:i?qr(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&Nr(t,a,s),s};let J=class extends L{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.dataProvider=(e,t)=>{const a=this.data[this.id]?.page;t(a?.content??[],a?.content?.length??0)},this.respondToVisibility=(e,t)=>{var a={root:document.documentElement},i=new IntersectionObserver(s=>{s.forEach(r=>{t(r.intersectionRatio>0)})},a);i.observe(e)},this.keepAsking=!1,this.askToUpper=()=>{const e=this.data[this.id]?.page,t=e?.content?.length/e?.pageSize;this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:{page:t,pageSize:this.metadata?.pageSize},callback:()=>{this.keepAsking&&this.askToUpper()}},bubbles:!0,composed:!0}))},this.renderItem=e=>e.card?ra(this,e.card,this.baseUrl,this.state,this.data,this.appState,this.appData,!1):e.title?n`<vaadin-card
        >
                ${e.title?n`
    ...
    `;de([u()],J.prototype,"id",2);de([u()],J.prototype,"metadata",2);de([u()],J.prototype,"baseUrl",2);de([u()],J.prototype,"state",2);de([u()],J.prototype,"data",2);de([u()],J.prototype,"appState",2);de([u()],J.prototype,"appData",2);de([u()],J.prototype,"emptyStateMessage",2);de([f()],J.prototype,"keepAsking",2);de([Se("#ask-for-more")],J.prototype,"askForMore",2);de([f()],J.prototype,"hasMore",2);J=de([O("mateu-card-list")],J);var Ma=(e=>(e.none="none",e.success="success",e.error="error",e.warning="warning",e.contrast="contrast",e.normal="normal",e))(Ma||{}),Ba=(e=>(e.primary="primary",e.secondary="secondary",e.tertiary="tertiary",e.tertiaryInline="tertiaryInline",e))(Ba||{}),Ur=Object.defineProperty,Mr=Object.getOwnPropertyDescriptor,ye=(e,t,a,i)=>{for(var s=i>1?void 0:i?Mr(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&Ur(t,a,s),s};const Br={asc:"ascending",desc:"descending"};let ie=class extends L{constructor(){super(...arguments),this.component=void 0,this.standalone=!1,this.state={},this.data={},this.appState={},this.appData={},this.showImportDialog=!1,this.availableWidthPx=1024,this.selectedItem=null,this.search=()=>{const e=this.component.metadata;this.state={...this.state,size:e.pageSize,page:0,crud_selected_items:[]},this._syncStateToUrl(e),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}}},bubbles:!0,composed:!0}))},this.notify=e=>{Tt.show(e,{position:"bottom-end",theme:"error",duration:3e3})},this.handleSearchRequested=e=>{this.state={...this.state,crud_selected_items:[]};const t=this.component.metadata;this._syncStateToUrl(t),!t.infiniteScrolling&&this.data?.[this.id]?.page&&(this.data[this.id].page.content=[]),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}},callback:e},bubbles:!0,composed:!0}))},this.fetchMoreElements=e=>{const{params:t,callback:a}=e.detail;this.state={...this.state,size:t.pageSize,page:t.page},this.handleSearchRequested(a)},this.directionChanged=e=>{const t=e.detail.grid._sorters;this.state={...this.state,sort:t.map(a=>({fieldId:a.__data.path,direction:a.__data.direction?Br[a.__data.direction]:void 0}))},this.handleSearchRequested(void 0)},this._initializedForComponentId=void 0,this.evalLabel=e=>De(e,this.state,this.data),this.handleToolbarButtonClick=e=>{if(e==="import"){this.showImportDialog=!0;return}this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.handleImportUploadSuccess=e=>{const t=e.detail.xhr.responseText;this.showImportDialog=!1,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"process-import",parameters:{fileId:t}},bubbles:!0,composed:!0}))}}get cols(){return this.component?.metadata?.columns?.map(t=>t.metadata)??[]}get identifierFieldName(){const e=this.cols.find(t=>t.identifier);return e?e.id:this.cols.find(t=>t.id==="id")?.id}get effectiveGridLayout(){const e=this.component?.metadata,t=e?.gridLayout??"auto";return t==="auto"?e?.crudlType==="card"?"cards":ps(this.cols,this.availableWidthPx):t}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{const t=e[0]?.contentRect.width;t&&Math.abs(t-this.availableWidthPx)>10&&(this.availableWidthPx=t)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}_filterIds(e){return new Set(["searchText",...(e.filters??[]).map(t=>t.fieldId)])}_syncStateToUrl(e){const t=this._filterIds(e),a=new URLSearchParams(window.location.search);t.forEach(l=>a.delete(l)),a.delete("page"),a.delete("sort"),t.forEach(l=>{const c=this.state[l];c!=null&&c!==""&&a.set(l,String(c))});const i=this.state.page;i&&i>0&&a.set("page",String(i));const s=this.state.sort;if(s&&s.length>0){const l=s.filter(c=>c.fieldId&&c.direction).map(c=>`${c.fieldId}:${c.direction}`).join(",");l&&a.set("sort",l)}const r=a.toString(),o=r?`${window.location.pathname}?${r}`:window.location.pathname;window.location.pathname+window.location.search!==o&&history.replaceState(null,"",o)}_initStateFromUrl(e,t){const a=new URLSearchParams(window.location.search),i=this._filterIds(e),s={...t};a.forEach((l,c)=>{i.has(c)&&(s[c]=l)});const r=a.get("page");if(r!==null){const l=parseInt(r,10);!isNaN(l)&&l>0&&(s.page=l)}const o=a.get("sort");if(o){const l=o.split(",").map(c=>{const[h,p]=c.split(":");return h&&p?{fieldId:h,direction:p}:null}).filter(Boolean);l.length>0&&(s.sort=l)}return s}pageChanged(e){this.state={...this.state,page:e.detail.page},this.handleSearchRequested(void 0)}updated(e){if(super.updated(e),e.has("component")){const t=this.component?.id;if(t!==this._initializedForComponentId){this._initializedForComponentId=t;const a=this.component?.metadata,i=a.initialPage&&a.initialPage>0?a.initialPage:0;this.state=this._initStateFromUrl(a,{...this.state,size:a.pageSize,page:i,sort:[]}),(this.state.page!==i||this.state.sort?.length>0||[...this._filterIds(a)].some(r=>this.state[r]!=null))&&this.handleSearchRequested(void 0)}}}render(){const e=y=>{const P=[];return y.color&&y.color!==Ma.normal&&P.push(y.color),y.buttonStyle&&P.push(y.buttonStyle===Ba.tertiaryInline?"tertiary-inline":y.buttonStyle),P.length?P.join(" "):void 0},t=y=>y==="back"||y==="backToList"||!!y&&y.startsWith("cancel");if(!this.component)return n`no component`;const a=this.component.metadata;a.serverSideOrdering=!0;const i=a?.toolbar??[],s=i.filter(y=>t(y.actionId)),r=i.filter(y=>!t(y.actionId)),o=s.length>0&&r.length>0,l=!!a?.title||!!a?.subtitle||i.length>0,c=this.effectiveGridLayout,h=this.cols,p=vs(h),v=this.data[this.id]?.page?.content??[],$=this.state[this.component?.id]?.emptyStateMessage,T=(y,P)=>{const w=P[y.id];if(w==null)return n``;if(y.dataType==="status"){const z=Bt(w.type);return n`<span theme="badge pill ${z}">${w.message}</span>`}return y.dataType==="bool"?n`${w?"✓":"✗"}`:typeof w=="object"?n`${w.label??w.name??w.message??""}`:n`${w}`},k=()=>{const y=this.identifierFieldName,P=this.state._selectedId??this.appState?._splitDetailId,w=p.find(S=>S.identifier)??p[0],z=S=>S.dataType==="action"||S.dataType==="actionGroup"||S.dataType==="menu"||S.stereotype==="button",Je=p.filter(S=>S!==w&&!z(S)),$t=h.filter(S=>z(S)),Ne=(S,R,F)=>{S.stopPropagation(),S.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:R,parameters:{_clickedRow:F}},bubbles:!0,composed:!0}))},Ye=S=>{const R=[];for(const F of $t){const M=S[F.id];if(F.dataType==="action"){const ue=M?.methodNameInCrud?M:S.action?.methodNameInCrud?S.action:{methodNameInCrud:F.id,label:F.label,icon:null};R.push(n`
                ...
                <vaadin-list-box style="width: 100%;">
                    ${v.length===0?n`<vaadin-item disabled>${$??"No data."}</vaadin-item>`:d}
                    ${v.map(S=>n`
                        <vaadin-item
                            ?selected="${y&&P!==void 0&&String(S[y])===String(P)}"
                            @click="${()=>{y&&S[y]!==void 0&&(this.state={...this.state,_selectedId:String(S[y])}),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"view",parameters:S},bubbles:!0,composed:!0}))}}"
                            style="cursor: pointer;"
                        >
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: var(--lumo-space-m); padding: var(--lumo-space-s) 0;">
                    ...
                    `)}
                </div>`},q=()=>{const y=p.find(w=>w.identifier)??p[0],P=p.filter(w=>w!==y);return n`
                ...
                </div>`},U=()=>{const y=this.identifierFieldName,P=this.state._selectedId??this.appState?._splitDetailId,w=h[0],z=h.slice(1),Je=!!w?.actionId,$t=(R,F)=>{const M=R.parentItem?R.parentItem.children??[]:v;F(M,M.length)},Ne=(R,F)=>{for(const M of R??[]){if(y&&String(M[y])===F)return M;const ue=Ne(M.children,F);if(ue)return ue}},Ye=y&&P!==void 0?Ne(v,String(P)):void 0,S=(R,F,M)=>{R.stopPropagation(),y&&F[y]!==void 0&&(this.state={...this.state,_selectedId:String(F[y])}),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:M,parameters:F},bubbles:!0,composed:!0}))};return n`
                <vaadin-grid
                    style="width: 100%;"
                    all-rows-visible
            ...
            `:C():!D&&c==="masterDetail"?q():!D&&c==="tree"?U():W.get()?.renderTableComponent(this,this.component,this.baseUrl,this.state,this.data,this.appState,this.appData)}
            <slot></slot>
...
`,C=!0)}C&&this.updateMessage(a,i)}i||this.updateMessage(a,"⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).")}catch(s){console.error("Error en el flujo SSE:",s);const r=s?.message??String(s);(r==="Failed to fetch"||r==="network error"||r==="Load failed")&&!i?this.updateMessage(a,"⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible."):this.updateMessage(a,"⚠️ Error: "+r)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value="")},250),this.messageInputElement?.removeAttribute("disabled"),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent("close-requested",{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{const e=this.messageInputElement?.value?.trim()??"";e&&this.send(new CustomEvent("submit",{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key==="Enter"&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback();const e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){const t=new e;this.recognition=t,t.lang="es-ES",t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=a=>{console.error("Error de reconocimiento: "+a.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:"smooth"})},0)}addMessage(e,t){const a={text:e,time:new Date().toLocaleTimeString(),userName:t.includes("agent")?"Asistente":"Tú",userColorIndex:t.includes("agent")?2:1};return this.items=[...this.items,a],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((a,i)=>i===e?{...a,text:t}:a),this.scrollBottom()}tryParseCustomEvent(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if(typeof a.event=="string")return{event:a.event,detail:a.detail??{}}}catch{}return null}tryParseTokenUsage(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if("inputTokens"in a||"outputTokens"in a||"totalTokens"in a)return a}catch{}return null}buildMenuContext(e,t=[]){const a=[];for(const i of e){if(i.separator||i.remote)continue;const s=[...t,i.label];if(i.submenus&&i.submenus.length>0)a.push(...this.buildMenuContext(i.submenus,s));else{const r={path:s,navigation:{route:i.route,consumedRoute:i.consumedRoute,actionId:i.actionId??"",baseUrl:i.baseUrl,serverSideType:i.serverSideType,uriPrefix:i.uriPrefix}};i.description&&(r.description=i.description),a.push(r)}}return a}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return n`
    ...
    `];ce([u()],Y.prototype,"sseUrl",2);ce([u({attribute:!1})],Y.prototype,"menu",2);ce([u()],Y.prototype,"items",2);ce([Se(".scroll-container")],Y.prototype,"scrollContainer",2);ce([Se(".msg-input")],Y.prototype,"messageInputElement",2);ce([f()],Y.prototype,"recognition",2);ce([f()],Y.prototype,"listening",2);ce([f()],Y.prototype,"recognitionAvailable",2);ce([f()],Y.prototype,"loading",2);ce([f()],Y.prototype,"elapsedSeconds",2);ce([f()],Y.prototype,"tokenUsage",2);Y=ce([O("mateu-chat")],Y);var hn=Object.defineProperty,un=Object.getOwnPropertyDescriptor,Rt=(e,t,a,i)=>{for(var s=i>1?void 0:i?un(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&hn(t,a,s),s};let st=class extends L{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.data&&this.createChart(this.data)}async createChart(e){const[{default:t}]=await Promise.all([te(()=>import("./vendor-chartjs.js").then(i=>i.a),[]),te(()=>import("./vendor-chartjs.js").then(i=>i.c),[])]);if(e!==this.data)return;this.chart&&this.chart.destroy();const a={type:this.type,data:this.data,options:this.options};this.chart=new t(this.chartElement,a)}handleSlotChange(){}render(){return n`
            <div class="container">
  ...
  `;da([u()],It.prototype,"xml",2);da([Se("#canvas")],It.prototype,"divElement",2);It=da([O("mateu-bpmn")],It);var mn=Object.defineProperty,fn=Object.getOwnPropertyDescriptor,bt=(e,t,a,i)=>{for(var s=i>1?void 0:i?fn(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&mn(t,a,s),s};const Yt=160,we=56,bn=220,xa=110,Ue=60,gn={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},$n={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},yn=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];function wn(){return"step-"+Math.random().toString(36).slice(2,8)}let He=class extends L{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.wf={name:"New Workflow",steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value")){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){const e=this.wf.steps??[],t={};e.forEach(o=>{t[o.id]=0});let a=!0;for(;a;)a=!1,e.forEach(o=>{if(o.preconditionStepId!=null&&t[o.preconditionStepId]!==void 0){const l=t[o.preconditionStepId]+1;l>t[o.id]&&(t[o.id]=l,a=!0)}});const i={};e.forEach(o=>{const l=t[o.id]??0;(i[l]??=[]).push(o.id)});const s={...this.positions};let r=!1;Object.entries(i).forEach(([o,l])=>{const c=Number(o);l.forEach((h,p)=>{s[h]||(s[h]={x:Ue+c*bn,y:Ue+p*xa},r=!0)})}),r&&(this.positions=s)}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addStep(){const e=wn(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(s=>s.y),i=a.length?Math.max(...a)+xa:Ue;this.positions={...this.positions,[e]:{x:Ue,y:i}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(i=>i.id!==e).map(i=>i.preconditionStepId===e?{...i,preconditionStepId:void 0}:i)};const{[e]:t,...a}=this.positions;this.positions=a,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},i=this.toSvgPoint(e);this.dragOffset={x:i.x-a.x,y:i.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(i=>i.x))+Yt+Ue:600,a=e.length?Math.max(...e.map(i=>i.y))+we+Ue:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return n`
        ...
        `}renderNode(e){const t=this.positions[e.id]??{x:Ue,y:Ue},a=gn[e.type]??"#64748b",i=$n[e.type]??"•",s=this.selectedId===e.id;return V`
                ...
                <div class="prop-body">
                    ...
                    ${a("Type",n`
                        <select class="inp" @change="${i=>this.updateStep(e.id,{type:i.target.value})}">
                            ${yn.map(i=>n`<option value="${i}" ?selected="${e.type===i}">${i}</option>`)}
                        </select>`)}
    ...
    `];bt([u()],He.prototype,"value",2);bt([f()],He.prototype,"wf",2);bt([f()],He.prototype,"positions",2);bt([f()],He.prototype,"selectedId",2);bt([f()],He.prototype,"showMeta",2);He=bt([O("mateu-workflow")],He);var xn=Object.defineProperty,kn=Object.getOwnPropertyDescriptor,Fe=(e,t,a,i)=>{for(var s=i>1?void 0:i?kn(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&xn(t,a,s),s};const yt=160,pe=56,Me=60,Sn={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},En={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},Cn=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];let Xt;const In=()=>(Xt||(Xt=te(()=>import("./vendor-diagrams.js").then(e=>e.e),__vite__mapDeps([4,3,1,2])).then(e=>new e.default)),Xt);function _n(){return"step-"+Math.random().toString(36).slice(2,8)}let be=class extends L{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.readOnly=!1,this.wf={name:"New Workflow",steps:[]},this.positions={},this.layoutReady=!1,this.selectedId=null,this.showMeta=!1,this.layoutError=null,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.elkPositioned=new Set,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.elkPositioned.add(this.draggingId),this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value"))try{const t=JSON.parse(this.value),a=new Set((this.wf.steps??[]).map(r=>r.id)),i=new Set((t.steps??[]).map(r=>r.id)),s=a.size!==i.size||[...i].some(r=>!a.has(r))||[...i].some(r=>{const o=(this.wf.steps??[]).find(c=>c.id===r),l=(t.steps??[]).find(c=>c.id===r);return o?.preconditionStepId!==l?.preconditionStepId});this.wf=t,(s||!this.layoutReady)&&this.runElkLayout()}catch{}}async runElkLayout(){const e=this.wf.steps??[];if(e.length===0){this.positions={},this.layoutReady=!0;return}const t={id:"root",layoutOptions:{"elk.algorithm":"layered","elk.direction":"RIGHT","elk.spacing.nodeNode":"40","elk.layered.spacing.nodeNodeBetweenLayers":"80","elk.edgeRouting":"ORTHOGONAL","elk.layered.nodePlacement.strategy":"BRANDES_KOEPF"},children:e.map(a=>({id:a.id,width:yt,height:pe})),edges:e.filter(a=>a.preconditionStepId).map(a=>({id:`${a.preconditionStepId}->${a.id}`,sources:[a.preconditionStepId],targets:[a.id]}))};try{const i=await(await In()).layout(t),s={...this.positions};for(const r of i.children??[])(!this.elkPositioned.has(r.id)||!s[r.id])&&(s[r.id]={x:(r.x??0)+Me,y:(r.y??0)+Me},this.elkPositioned.add(r.id));this.positions=s,this.layoutReady=!0,this.layoutError=null}catch(a){this.layoutError=a?.message??"ELK layout failed",this.layoutReady=!0}}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){const a=this.wf.steps.map(r=>r.id===e?{...r,...t}:r),i=this.wf.steps.find(r=>r.id===e),s=t.preconditionStepId!==void 0&&t.preconditionStepId!==i?.preconditionStepId;this.wf={...this.wf,steps:a},s&&(this.elkPositioned.clear(),this.runElkLayout()),this.emit()}addStep(){const e=_n(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(i=>i.x);this.positions={...this.positions,[e]:{x:a.length?Math.max(...a)+yt+80:Me,y:Me}},this.selectedId=e,this.elkPositioned.clear(),this.runElkLayout(),this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(i=>i.id!==e).map(i=>i.preconditionStepId===e?{...i,preconditionStepId:void 0}:i)};const{[e]:t,...a}=this.positions;this.positions=a,this.elkPositioned.delete(e),this.selectedId===e&&(this.selectedId=null),this.runElkLayout(),this.emit()}onNodeMouseDown(e,t){if(this.readOnly)return;e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},i=this.toSvgPoint(e);this.dragOffset={x:i.x-a.x,y:i.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}relayout(){this.elkPositioned.clear(),this.runElkLayout()}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(i=>i.x))+yt+Me:600,a=e.length?Math.max(...e.map(i=>i.y))+pe+Me:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){if(!this.layoutReady)return n`<div class="loading">Computing layout…</div>`;const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return n`
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return V``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return V``;const i=t.x+yt,s=t.y+pe/2,r=a.x,o=a.y+pe/2,l=(i+r)/2;return V`
            <path d="M${i},${s} C${l},${s} ${l},${o} ${r},${o}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:Me,y:Me},a=Sn[e.type]??"#64748b",i=En[e.type]??"•",s=this.selectedId===e.id,r=e.name.length>16?e.name.slice(0,15)+"…":e.name;return V`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
    ...
    `];Fe([u()],be.prototype,"value",2);Fe([u({type:Boolean})],be.prototype,"readOnly",2);Fe([f()],be.prototype,"wf",2);Fe([f()],be.prototype,"positions",2);Fe([f()],be.prototype,"layoutReady",2);Fe([f()],be.prototype,"selectedId",2);Fe([f()],be.prototype,"showMeta",2);Fe([f()],be.prototype,"layoutError",2);be=Fe([O("mateu-workflow-elk")],be);var Tn=Object.defineProperty,On=Object.getOwnPropertyDescriptor,Lt=(e,t,a,i)=>{for(var s=i>1?void 0:i?On(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&Tn(t,a,s),s};const Pn=["string","integer","number","bool","date","time","dateTime","dateRange","money","file","array","status","component","menu","range","action","actionGroup"],Rn=["regular","radio","checkbox","textarea","toggle","combobox","select","email","password","richText","listBox","html","markdown","image","icon","link","money","grid","color","choice","popover","slider","button","stars"],Ln={string:"#3B82F6",integer:"#8B5CF6",number:"#6366F1",bool:"#10B981",date:"#F59E0B",time:"#F59E0B",dateTime:"#F59E0B",dateRange:"#F59E0B",money:"#EF4444",file:"#64748B",array:"#0EA5E9",status:"#EC4899",component:"#14B8A6",menu:"#94A3B8",range:"#A855F7",action:"#F97316",actionGroup:"#FB923C"};function ka(){return"field-"+Math.random().toString(36).slice(2,8)}let rt=class extends L{constructor(){super(...arguments),this.value='{"name":"New Form","fields":[]}',this.form={name:"New Form",fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has("value"))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){const e=this.shadowRoot?.querySelector(".field-list");!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=hi.create(e,{animation:150,handle:".drag-handle",ghostClass:"sortable-ghost",onEnd:t=>{const{oldIndex:a,newIndex:i}=t;if(a===void 0||i===void 0||a===i)return;const s=[...this.form.fields],[r]=s.splice(a,1);s.splice(i,0,r),this.form={...this.form,fields:s},this.emit()}}))}emit(){const e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addField(){const e=ka(),t={id:e,label:"New Field",dataType:"string"};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){const t=this.form.fields.find(r=>r.id===e);if(!t)return;const a={...t,id:ka(),label:t.label+" (copy)"},i=this.form.fields.findIndex(r=>r.id===e),s=[...this.form.fields];s.splice(i+1,0,a),this.form={...this.form,fields:s},this.selectedId=a.id,this.emit()}render(){return n`
        ...
        `}renderRow(e){const t=Ln[e.dataType]??"#64748b",a=this.selectedId===e.id;return n`
        ...
        textarea.inp { resize: vertical; }
        input[readonly].inp { background: #f8fafc; color: #94a3b8; }
    `];Lt([u()],rt.prototype,"value",2);Lt([f()],rt.prototype,"form",2);Lt([f()],rt.prototype,"selectedId",2);Lt([f()],rt.prototype,"showMeta",2);rt=Lt([O("mateu-form-editor")],rt);var Dn=Object.defineProperty,zn=Object.getOwnPropertyDescriptor,Ie=(e,t,a,i)=>{for(var s=i>1?void 0:i?zn(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&Dn(t,a,s),s};let oe=class extends L{constructor(){super(...arguments),this.appState={},this.appData={},this.open=!1,this.activeTab="appstate",this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null,this._prevTarget=null,this._onMouseover=e=>{let t=e.target;for(;t&&!(t.tagName?.toLowerCase().startsWith("mateu-")&&t!==this);)t=t.parentElement;if(t===this||t===null){t===null&&this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset="",this._prevTarget=null,this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null);return}t!==this._prevTarget&&(this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset=""),this._prevTarget=t,t.style.outline="2px solid #0070f3",t.style.outlineOffset="-2px",this.hoveredTag=t.tagName.toLowerCase(),this.hoveredId=t.id||"",this.hoveredState=t.state,this.hoveredData=t.data,this.hoveredMeta=t.component?.metadata)}}connectedCallback(){super.connectedCallback(),document.addEventListener("mouseover",this._onMouseover,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mouseover",this._onMouseover,!0),this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget=null)}_fmt(e){try{return JSON.stringify(e,null,2)??"null"}catch{return String(e)}}_renderTab(e,t){return n`
...
`);D=gt.pop()??"";for(const y of gt){const P=y.trim();if(P)if(P.startsWith("data:")){const w=JSON.parse(P.substring(5).trim());T&&T(w),k||this.handleUIIncrement(w,v,g),w.messages&&w.messages.length==1&&w.messages[0].variant=="error"&&v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))}else{let w=P;try{const z=JSON.parse(P);w=z.message,z._embedded?.errors?.length>0&&z._embedded.errors[0].message&&(w=z._embedded.errors[0].message)}catch{}throw new Error(w)}}}}$||v.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:r}})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:r},bubbles:!0,composed:!0}))}).catch(q=>{v.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:r,reason:this.serialize(q)}})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))})}}serialize(t){return t?.message?t:JSON.stringify(t)}}const Wn=new jn;var Vn=Object.defineProperty,Hn=Object.getOwnPropertyDescriptor,he=(e,t,a,i)=>{for(var s=i>1?void 0:i?Hn(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&Vn(t,a,s),s};let X=class extends Ut{constructor(){super(...arguments),this.consumedRoute="",this.serverSideType=void 0,this.uriPrefix=void 0,this.overrides=void 0,this.homeRoute=void 0,this.route=void 0,this.top=void 0,this.appState={},this.appData={},this.preventNavigation=!1,this.overridesParsed={},this.fragment=void 0,this.actionRequestedListener=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.manageActionEvent(e))},this.historyPushed=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.preventNavigation=!0,this.route=e.detail.route)},this.routeChangedListener=e=>{if(e instanceof CustomEvent){e.preventDefault(),e.stopPropagation();let t=e.detail.route;this.uriPrefix&&(t.startsWith("/")&&this.uriPrefix.endsWith("/")?t=this.uriPrefix+t.substring(1):!t.startsWith("/")&&!this.uriPrefix.endsWith("/")?t=this.uriPrefix+"/"+t:t=this.uriPrefix+t),this.dispatchEvent(new CustomEvent("url-update-requested",{detail:{route:t},bubbles:!0,composed:!0}))}},this.backendFailedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&e.detail.actionId==""&&(this.fragment={targetComponentId:this.id,data:{},state:{},component:{type:G.ClientSide,metadata:{type:m.Element,name:"div",content:"Not found"},id:"fieldId"},action:Et.Replace,containerId:void 0})},this.detail1=void 0,this.manageActionEvent=e=>{e.preventDefault(),e.stopPropagation(),this.detail1=e.detail;const t=this.detail1;if(e.type=="server-side-action-requested"){let a=Bn;t.sse&&(a=Wn),a.runAction(za,this.baseUrl,t.route??"",t.consumedRoute,t.actionId,t.initiatorComponentId,this.getCustomisedAppState(),t.serverSideType,t.componentState,t.parameters,t.initiator,t.background,t.callback,t.callbackonly,t.callbackToken)}},this.getCustomisedAppState=()=>{let e={...B.value};if(this.overrides){const t=Sa(this.overrides);e={...e,...t}}return e}}manageActionRequestedEvent(e){throw new Error("Method not implemented.")}createRenderRoot(){return W.mustUseShadowRoot()?super.createRenderRoot():this}connectedCallback(){super.connectedCallback(),this.overridesParsed=Sa(this.overrides),this.addEventListener("server-side-action-requested",this.actionRequestedListener),this.addEventListener("backend-call-failed",this.backendFailedListener),this.addEventListener("history-pushed",this.historyPushed),this.addEventListener("route-changed",this.routeChangedListener),window.Vaadin.featureFlags.masterDetailLayoutComponent=!0}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("server-side-action-requested",this.actionRequestedListener),this.removeEventListener("backend-call-failed",this.backendFailedListener),this.removeEventListener("history-pushed",this.historyPushed),this.removeEventListener("route-changed",this.routeChangedListener)}shouldUpdate(e){if(this.fragment?.component&&[...e.keys()].every(a=>a==="appState"||a==="appData")){const a=this.renderRoot.querySelector("mateu-component");if(a)return e.has("appState")&&(a.appState=this.appState),e.has("appData")&&(a.appData=this.appData),!1}return!0}updated(e){(e.has("id")||e.has("baseurl")||e.has("route")||e.has("consumedRoute")||e.has("instant"))&&(this.preventNavigation||(this.callbackToken=this.instant||se(),this.manageActionEvent(new CustomEvent("server-side-action-requested",{detail:{route:this.route,consumedRoute:this.consumedRoute,userData:void 0,actionId:"",serverSideType:this.serverSideType,initiatorComponentId:this.id,initiator:this,callbackToken:this.callbackToken},bubbles:!0,composed:!0})))),e.has("route")&&this.top&&(this.preventNavigation||this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:this.route},bubbles:!0,composed:!0}))),this.preventNavigation&&(this.preventNavigation=!1)}applyFragment(e){this.fragment=e}render(){return n`
  ...
  `;Ae([u()],ge.prototype,"baseUrl",2);Ae([u()],ge.prototype,"route",2);Ae([u()],ge.prototype,"consumedRoute",2);Ae([u()],ge.prototype,"config",2);Ae([u()],ge.prototype,"top",2);Ae([u()],ge.prototype,"pathPrefix",2);Ae([f()],ge.prototype,"instant",2);Ae([u({type:Boolean})],ge.prototype,"debug",2);ge=Ae([O("mateu-ui")],ge);const Dt=(e,t)=>e.themeToggle?n`
    ...
    `:d,Jn=(e,t)=>{t.filter!=e.detail.value&&(t.filter=e.detail.value)},Ea=(e,t,a)=>{const i=Be(e,t,a),s=ee(t,a);return i=="list"||i==s?"new":i},Be=(e,t,a)=>{const i=e?._route;if(i!=null&&(i===""||i.startsWith("/"))){const s=a.homeRoute??"",r=s.indexOf("?"),o=r>=0?s.substring(r+1):"",l=ee(t,a)+i;if(!o)return l;const c=l.indexOf("?")>=0?"&":"?";return l+c+o}return t.selectedRoute?t.selectedRoute:a.homeRoute},ee=(e,t)=>e.selectedRoute?e.selectedConsumedRoute??t.route:t.homeConsumedRoute,_e=(e,t)=>e.selectedRoute?e.selectedBaseUrl??e.baseUrl:t.homeBaseUrl,Te=(e,t)=>e.selectedRoute?e.selectedServerSideType??t.serverSideType:t.homeServerSideType,Oe=(e,t)=>e.selectedRoute?e.selectedUriPrefix:t.homeUriPrefix,Yn=(e,t,a,i,s,r,o)=>{const l=e.mapItems(t.menu,e.filter?.toLowerCase()??""),c=ee(e,t),h=Ea(i,e,t),p=h&&h!=="new"&&h.startsWith(c+"/")?h.substring(c.length+1).split("/")[0]:void 0;return n`
...
`:d}
                ...
                <vaadin-app-layout style="${t?.style}" class="${t?.cssClasses}" .drawerOpened=${!t.drawerClosed}>
                    ...
                    <vaadin-scroller slot="drawer" class="p-s"
                        ...
                        ${t.menu&&t.totalMenuOptions>10?n`
                            <vaadin-text-field style="width: calc(100% - 20px); padding-left: 10px; padding-right: 10px;" @value-changed="${v=>Jn(v,e)}">
            ...
            <slot></slot>
       `},Xn=(e,t)=>t!=null&&e!=null&&!e.has(t),Qn=typeof HTMLElement<"u"?HTMLElement:class{};class Zn extends Qn{static get observedAttributes(){return["type","renderer"]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){const t=this.getAttribute("type")??"unknown",a=this.getAttribute("renderer")??"unknown";this.shadowRoot||this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host { display: block; }
                .mateu-unsupported {
                    box-sizing: border-box;
        ...
        `}}typeof customElements<"u"&&!customElements.get("mateu-unsupported")&&customElements.define("mateu-unsupported",Zn);const Ca=new Set,eo=(e,t,a)=>{const i=`${a}/${t}`;return Ca.has(i)||(Ca.add(i),console.warn(`[mateu] Component type "${t}" is not supported by the "${a}" renderer — rendering <mateu-unsupported> placeholder.`)),n`<mateu-unsupported
            type="${t}"
            renderer="${a}"
            data-component-id="${e?.id??d}"
            slot="${e?.slot??d}"
    ></mateu-unsupported>`};class to{renderFilterBar(t,a,i,s,r,o,l,c){const h=a?.metadata,p=$=>{const{fieldId:T,value:k}=$.detail;t.state={...t.state,[T]:k}},v=$=>{const{fieldIds:T}=$.detail,k={};T.forEach(g=>{k[g]=void 0}),k.searchText=void 0,t.state={...t.state,...k}};return n`
            <mateu-filter-bar
                .metadata="${h}"
        ...
        <mateu-table id="${t.id}"
                     ...
                     baseUrl="${i}"
        ></mateu-table>
        `}rendererName(){return this.constructor?.name??"unknown"}supportedClientSideTypes(){}renderClientSideComponent(t,a,i,s,r,o,l,c){const h=a?.metadata?.type??a?.type,p=Object.values(m).includes(h)?h:void 0;return Xn(this.supportedClientSideTypes(),p)?eo(a,p,this.rendererName()):ra(t,a,i,s,r,o,l,c)}renderAppComponent(t,a,i,s,r,o,l){return Yn(t,a?.metadata,i,s,r,o,l)}}class ao extends to{rendererName(){return"vaadin"}renderClientSideComponent(t,a,i,s,r,o,l,c){return super.renderClientSideComponent(t,a,i,s,r,o,l,c)}}W.set(new ao);
