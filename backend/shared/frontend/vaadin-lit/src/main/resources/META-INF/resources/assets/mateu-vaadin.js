...
`,we={lon:0,lat:0},Te=e=>{if(!e)return;let t=e.split(`,`).map(e=>e.trim());if(t.length!==2)return;let n=Number(t[0]),r=Number(t[1]);if(!(t[0]===``||t[1]===``||!Number.isFinite(n)||!Number.isFinite(r)))return{lon:r,lat:n}},Ee=e=>{if(e==null||e.trim()===``)return 3;let t=Number(e);return Number.isFinite(t)?t:3};function k(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var De=class extends x{constructor(...e){super(...e),this.renderSeq=0}updated(e){super.updated(e),this.createMap()}disconnectedCallback(){super.disconnectedCallback(),this.map?.setTarget(void 0),this.map=void 0}async createMap(){let e=++this.renderSeq,[{default:t},{default:n},{default:r},{default:i},{fromLonLat:a},{default:o}]=await Promise.all([D(()=>import(`./vendor-ol.js`).then(e=>e.i),__vite__mapDeps([0,1])),D(()=>import(`./vendor-ol.js`).then(e=>e.a),__vite__mapDeps([0,1])),D(()=>import(`./vendor-ol.js`).then(e=>e.r),__vite__mapDeps([0,1])),D(()=>import(`./vendor-ol.js`).then(e=>e.t),__vite__mapDeps([0,1])),D(()=>import(`./vendor-ol.js`).then(e=>e.o),__vite__mapDeps([0,1])),D(()=>import(`./vendor-ol.js`).then(e=>e.n),__vite__mapDeps([0,1]))]);if(e!==this.renderSeq||!this.isConnected)return;if(!this.shadowRoot.querySelector(`style[data-ol]`)){let e=document.createElement(`style`);e.setAttribute(`data-ol`,``),e.textContent=o,this.shadowRoot.appendChild(e)}this.map&&=(this.map.setTarget(void 0),void 0);let s=Te(this.position)??we;this.map=new t({target:this.mapElement,layers:[new r({source:new i})],view:new n({center:a([s.lon,s.lat]),zoom:Ee(this.zoom)})})}render(){return T`<div id="map"></div>`}static{this.styles=g`
    ...
    `}};k([b()],De.prototype,`position`,void 0),k([b()],De.prototype,`zoom`,void 0),k([S(`#map`)],De.prototype,`mapElement`,void 0),De=k([_(`mateu-map`)],De);var Oe=typeof HTMLElement<`u`?HTMLElement:class{},ke=class extends Oe{static get observedAttributes(){return[`content`]}#e;#t=0;get content(){return this.#e}set content(e){this.#e=e,this.#n()}attributeChangedCallback(e,t,n){this.content=n??void 0}connectedCallback(){this.style.display=`block`,this.#n()}async#n(){if(!this.isConnected)return;let e=this.#e??``,t=++this.#t,[{marked:n},{default:r}]=await Promise.all([D(()=>import(`./vendor.js`).then(e=>e.t),__vite__mapDeps([2,1])),D(()=>import(`./vendor.js`).then(e=>e.a),__vite__mapDeps([2,1]))]);t===this.#t&&(this.innerHTML=r.sanitize(await n.parse(e),{USE_PROFILES:{html:!0,svg:!0,svgFilters:!0},CUSTOM_ELEMENT_HANDLING:{tagNameCheck:e=>!0}}))}};typeof customElements<`u`&&!customElements.get(`mateu-markdown`)&&customElements.define(`mateu-markdown`,ke);var A=function(e){return e.ServerSide=`ServerSide`,e.ClientSide=`ClientSide`,e}({}),j=function(e){return e.Page=`Page`,e.Div=`Div`,e.Element=`Element`,e.MicroFrontend=`MicroFrontend`,e.Form=`Form`,e.Crud=`Crud`,e.Result=`Result`,e.Card=`Card`,e.Directory=`Directory`,e.Stepper=`Stepper`,e.HorizontalLayout=`HorizontalLayout`,e.VerticalLayout=`VerticalLayout`,e.SplitLayout=`SplitLayout`,e.MasterDetailLayout=`MasterDetailLayout`,e.TabLayout=`TabLayout`,e.AccordionLayout=`AccordionLayout`,e.FormLayout=`FormLayout`,e.FormRow=`FormRow`,e.FormItem=`FormItem`,e.BoardLayout=`BoardLayout`,e.BoardLayoutRow=`BoardLayoutRow`,e.BoardLayoutItem=`BoardLayoutItem`,e.Scroller=`Scroller`,e.FullWidth=`FullWidth`,e.Container=`Container`,e.FormField=`FormField`,e.Table=`Table`,e.App=`App`,e.Text=`Text`,e.Avatar=`Avatar`,e.Chat=`Chat`,e.AvatarGroup=`AvatarGroup`,e.Badge=`Badge`,e.Breadcrumbs=`Breadcrumbs`,e.Anchor=`Anchor`,e.Button=`Button`,e.Chart=`Chart`,e.Icon=`Icon`,e.ConfirmDialog=`ConfirmDialog`,e.ContextMenu=`ContextMenu`,e.CookieConsent=`CookieConsent`,e.Details=`Details`,e.Dialog=`Dialog`,e.Drawer=`Drawer`,e.Image=`Image`,e.Map=`Map`,e.Markdown=`Markdown`,e.Notification=`Notification`,e.ProgressBar=`ProgressBar`,e.Popover=`Popover`,e.CarouselLayout=`CarouselLayout`,e.Tooltip=`Tooltip`,e.MessageInput=`MessageInput`,e.MessageList=`MessageList`,e.CustomField=`CustomField`,e.MenuBar=`MenuBar`,e.Grid=`Grid`,e.GridColumn=`GridColumn`,e.GridGroupColumn=`GridGroupColumn`,e.VirtualList=`VirtualList`,e.FormSection=`FormSection`,e.FormSubSection=`FormSubSection`,e.Bpmn=`Bpmn`,e.Workflow=`Workflow`,e.FormEditor=`FormEditor`,e.MetricCard=`MetricCard`,e.Scoreboard=`Scoreboard`,e.DashboardPanel=`DashboardPanel`,e.DashboardLayout=`DashboardLayout`,e.ResponsiveGrid=`ResponsiveGrid`,e.FoldoutLayout=`FoldoutLayout`,e.ContentLayout=`ContentLayout`,e.HeroSection=`HeroSection`,e.EmptyState=`EmptyState`,e.Skeleton=`Skeleton`,e.Gantt=`Gantt`,e.PlanningBoard=`PlanningBoard`,e.Kanban=`Kanban`,e.Timeline=`Timeline`,e.ProgressSteps=`ProgressSteps`,e.Stat=`Stat`,e.Calendar=`Calendar`,e.PricingTable=`PricingTable`,e.OrgChart=`OrgChart`,e.Heatmap=`Heatmap`,e.Funnel=`Funnel`,e.TrendChart=`TrendChart`,e.FeatureGrid=`FeatureGrid`,e.Testimonials=`Testimonials`,e.Faq=`Faq`,e.CalloutCard=`CalloutCard`,e.CommentThread=`CommentThread`,e.FileList=`FileList`,e.Checklist=`Checklist`,e.ComparisonCard=`ComparisonCard`,e.EntityHeader=`EntityHeader`,e.Meter=`Meter`,e.TaskProgress=`TaskProgress`,e.StatusList=`StatusList`,e.BulletedList=`BulletedList`,e.Separator=`Separator`,e.CustomComponent=`CustomComponent`,e.Notice=`Notice`,e.TaskQueue=`TaskQueue`,e.ResourceGrid=`ResourceGrid`,e.OfferCard=`OfferCard`,e.AddOnPicker=`AddOnPicker`,e.Ledger=`Ledger`,e.PaymentPicker=`PaymentPicker`,e.ProcessMonitor=`ProcessMonitor`,e}({}),Ae=`mateu-app-context`,je=`mateu-app-context-labels`,Me=e=>{try{return JSON.parse(localStorage.getItem(e)??`{}`)}catch{return{}}},Ne=(e,t)=>{try{localStorage.setItem(e,JSON.stringify(t))}catch{}},Pe=()=>Me(Ae),Fe=()=>Me(je),Ie=(e,t,n)=>{let r=Pe(),i=Fe();t==null||t===``?(delete r[e],delete i[e]):(r[e]=t,n!==void 0&&(i[e]=n)),Ne(Ae,r),Ne(je,i)},Le=!1,Re=()=>{Le||(Le=!0,window.addEventListener(`storage`,e=>{e.key===Ae&&e.newValue!==e.oldValue&&window.location.reload()}))},ze,Be=(e,t)=>new Promise((n,r)=>{let i=!1,a={retry:()=>{i||(i=!0,t().then(n,r))},giveUp:()=>{i||(i=!0,r(e))}};if(ze){ze(a);return}let o=new CustomEvent(`mateu-session-expired`,{detail:a,cancelable:!0,bubbles:!1});typeof document<`u`&&!document.dispatchEvent(o)||a.giveUp()}),Ve=(e,t)=>e.includes(`json`)?!0:typeof t==`object`&&!!t,He=(e,t)=>{let n=e.finalUrl;if(!n)return;let r=t??(typeof window<`u`?window.location.href:void 0),i;try{i=new URL(e.requestedUrl,r).href}catch{return}if(i!==n&&!Ve(e.contentType??``,e.data))return n},Ue=new class{constructor(){this.windowMs=4e3,this.threshold=12,this.events=[],this.reported=new Set}check(e,t=Date.now()){this.events.push({sig:e,t});let n=t-this.windowMs;this.events=this.events.filter(e=>e.t>=n);let r=0;for(let t of this.events)t.sig===e&&r++;if(r>=this.threshold){let t=!this.reported.has(e);return this.reported.add(e),{blocked:!0,firstTrip:t}}return this.reported.delete(e),{blocked:!1,firstTrip:!1}}reset(){this.events=[],this.reported.clear()}configure(e){e.windowMs!==void 0&&(this.windowMs=e.windowMs),e.threshold!==void 0&&(this.threshold=e.threshold)}},We=function(e){return e.Add=`Add`,e.Replace=`Replace`,e.ReplaceKeepData=`ReplaceKeepData`,e}({}),Ge=[],Ke=e=>{Ge=Array.isArray(e)?e:[]},qe=e=>e?Ge.find(t=>t.name===e)?.component:void 0,Je=new Set([`id`,`style`,`cssClasses`,`slot`,`initialData`,`confirmOnNavigationIfDirty`,`sizing`]),Ye=new Set([`VerticalLayout`,`HorizontalLayout`,`Div`,`FlexLayout`,`CustomComponent`]),Xe=new Set([`Card`]),Ze=new Set([`Listing`,`Crudl`,`Crud`]);function Qe(e){if(Ze.has(e.type))return $e(e);if(e.type===`ComponentRef`)return qe(e.ref)||{type:A.ClientSide,metadata:{type:`Text`,text:`Unknown business component: ${e.ref}`},children:[]};let{type:t,content:n,children:r,...i}=e,a={},o={type:t};for(let[e,t]of Object.entries(i))Je.has(e)?a[e]=t:o[e]=t;let s=[];if(Ye.has(t)){let e=n??r??[];s=Array.isArray(e)?e:[e]}else Xe.has(t)&&n&&typeof n==`object`&&!Array.isArray(n)&&(o.content=Qe(n));return{...a,type:A.ClientSide,metadata:o,children:s.map(Qe)}}function $e(e){let{type:t,content:n,children:r,...i}=e,a={id:`crud`,sizing:`fill`},o={type:`Crud`,crudlType:i.crudlType??i.listingType??`table`};for(let[e,t]of Object.entries(i))e===`crudlType`||e===`listingType`||(Je.has(e)?a[e]=t:e===`columns`&&Array.isArray(t)?o[e]=t.map(et):o[e]=t);return{...a,type:A.ClientSide,metadata:o,children:[]}}function et(e){let t=Qe(e);return e.id!==void 0&&t.metadata&&(t.metadata.id=e.id),t}var tt=`ux_main`;function nt(e){return!(e.viewModel??e.modelView)&&!!rt(e)}function rt(e){if(e.layout&&typeof e.layout==`object`)return e.layout;if(typeof e.type==`string`)return e}function it(e,t,n){let r=rt(e);if(!r)throw Error(`Definition for route "${t}" has no layout to expand`);return{commands:[{targetComponentId:tt,type:`SetWindowTitle`,data:n??t}],messages:[],fragments:[{targetComponentId:tt,component:Qe(r),data:void 0,state:void 0,action:We.Replace,containerId:void 0}],banners:[],appendBanners:!1,appData:void 0,appState:void 0}}var at,ot=[],st,ct=[],lt={},ut=e=>e.split(`/`).filter(e=>e.startsWith(`:`)&&e.length>1).map(e=>e.substring(1)),dt=e=>{let t=e=>e.replace(/^\/+/,``).replace(/\/+$/,``),n=t(e===`_no_route`?``:e),r=n===``?[]:n.split(`/`),i;for(let e of ct){let n=t(e.route??``),a=n===``?[]:n.split(`/`);if(a.length!==r.length)continue;let o={},s=!0;for(let e=0;e<a.length;e++){let t=a[e];if(t.startsWith(`:`)&&t.length>1)o[t.substring(1)]=r[e];else if(t!==r[e]){s=!1;break}}if(!s)continue;let c={entry:e,pathParams:o};(!i||ut(n).length<ut(t(i.entry.route??``)).length)&&(i=c)}return i},ft=(e,t)=>{let n=dt(e);if(!n)return t;let{entry:r,pathParams:i}=n,a=r.defaultParams??{},o=r.fixedParams??{};return!Object.keys(a).length&&!Object.keys(o).length&&!Object.keys(i).length?t:{...t,fragments:(t.fragments??[]).map(e=>({...e,state:{...a,...e.state??{},...i,...o},data:{...a,...e.data??{},...i,...o}}))}},pt=e=>{let t=e&&e.startsWith(`/`)?e.substring(1):e??``;return t===``?`_no_route`:t};function mt(e,t=fetch){return st=(async()=>{try{let n=await t(e);if(!n.ok)return;let r=await n.json(),i=new Map,a=[];for(let e of r.entries??[])if(!(!e.ok||!e.json))try{let t=JSON.parse(e.json);e.routePattern?a.push({regex:new RegExp(e.routePattern),paramNames:e.paramNames??[],increment:t}):i.set(e.syncPath,t)}catch(t){console.warn(`mateu: bundle entry parse failed for`,e.syncPath,t)}at=i,ot=a,ct=r.routes?.routes??[],lt=r.definitions??{},_e(r.sources?.sources)}catch(e){console.warn(`mateu: bundle manifest load failed`,e)}})(),st}var ht=()=>st??Promise.resolve(),gt=()=>at!==void 0&&at.size>0||ot.length>0||Object.keys(lt).length>0,_t=e=>{let t=at?.get(e);return t===void 0?void 0:ft(e,t)},vt=e=>{for(let t of ot){let n=t.regex.exec(e);if(!n)continue;let r={};return t.paramNames.forEach((e,t)=>{r[e]=n[t+1]}),ft(e,{...t.increment,fragments:(t.increment.fragments??[]).map(e=>({...e,state:{...e.state??{},...r},data:{...e.data??{},...r}}))})}},yt=e=>{let t=dt(e),n=t?.entry.definition;if(!n)return;let r=lt[n];if(!(!r||!nt(r)))return ft(e,it(r,t.entry.route))},bt={offline:()=>`No connection. Your changes have not been sent — check your network and try again.`,timeout:()=>`The server is taking too long to answer. Your changes may not have been saved.`,server:e=>`The server could not complete the request${e?` (error ${e})`:``}. Please try again.`,unauthorized:()=>`Your session is no longer valid. Please sign in again.`,notFound:()=>`This is no longer available. It may have been moved or deleted.`,client:e=>`The request was rejected${e?` (error ${e})`:``}.`,cancelled:()=>``,unknown:()=>`Something went wrong. Please try again.`},xt=new Set([`offline`,`timeout`,`server`]),St=(e,t={})=>{let n=e??{},r=n.response?.status,i=n.code,a=t.online??(typeof navigator<`u`&&typeof navigator.onLine==`boolean`?navigator.onLine:!0),o=e=>({kind:e,message:bt[e](r),retryable:xt.has(e),status:r});return i===`ERR_CANCELED`?o(`cancelled`):i===`ECONNABORTED`||i===`ETIMEDOUT`||/timeout/i.test(n.message??``)?o(`timeout`):r===void 0?!a||i===`ERR_NETWORK`||/network error/i.test(n.message??``)?o(`offline`):o(`unknown`):o(r===401||r===403?`unauthorized`:r===404||r===410?`notFound`:r===408||r===429?`timeout`:r>=500?`server`:r>=400?`client`:`unknown`)},Ct=new Set([``,`__load__`,`search`,`_globalsearch`,`_notifications-list`]),wt=[`_appcontext-search-`,`search-`],Tt=(e,t)=>t===!0?!0:e==null?!1:Ct.has(e)?!0:wt.some(t=>e.startsWith(t)),Et=(e,t=Math.random)=>{let n=300*3**Math.max(0,e-1);return Math.round(n*(.75+t()*.5))},Dt=(e,t,n)=>!n.idempotent||t>2||!e.retryable?!1:e.kind===`timeout`||e.kind===`server`,Ot=new class{constructor(){this.linkUp=!0,this.listeners=new Set,this.waiters=new Set,this.started=!1}start(){this.started||typeof window>`u`||(this.started=!0,this.linkUp=typeof navigator<`u`&&typeof navigator.onLine==`boolean`?navigator.onLine:!0,window.addEventListener(`online`,()=>{this.linkUp=!0,this.reachable=void 0,this.changed(),this.releaseWaiters()}),window.addEventListener(`offline`,()=>{this.linkUp=!1,this.changed()}))}isOnline(){return this.linkUp?this.reachable!==!1:!1}noteReachable(){let e=this.isOnline();this.reachable=!0,e||(this.changed(),this.releaseWaiters())}noteUnreachable(){let e=this.isOnline();this.reachable=!1,e&&this.changed()}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}whenBack(e){return this.isOnline()?(e(),()=>{}):(this.waiters.add(e),()=>this.waiters.delete(e))}reset(){this.linkUp=!0,this.reachable=void 0,this.waiters.clear()}changed(){let e=this.isOnline();this.listeners.forEach(t=>t(e))}releaseWaiters(){let e=Array.from(this.waiters);this.waiters.clear(),e.forEach(e=>e())}};Ot.start();var kt=[],At=6e4,jt=e=>new Promise(t=>setTimeout(t,e)),Mt=new class{constructor(){this.axiosInstance=ie.create({timeout:At}),this.axiosInstance.interceptors.request.use(e=>(this.addAuthToken(e),this.addSessionId(e),e)),this.axiosInstance.interceptors.response.use(e=>{let t=He({requestedUrl:this.axiosInstance.getUri(e.config),finalUrl:e.request?.responseURL,contentType:String(e.headers?.[`content-type`]??``),data:e.data});if(t)throw window.location.assign(t),Object.assign(Error(`session lost — redirecting to `+t),{code:`ERR_CANCELED`});return e},e=>{let t=e;if(t?.response?.status===401&&t.config&&!t.config.__mateuRetried){let n=t.config;return n.__mateuRetried=!0,Be(e,()=>this.axiosInstance.request(n))}throw e})}addSessionId(e){let t=sessionStorage.getItem(`__mateu_sesion_id`);t||(t=se(),sessionStorage.setItem(`__mateu_sesion_id`,t)),e.headers[`X-Session-Id`]=t}addAuthToken(e){let t=localStorage.getItem(`__mateu_auth_token`);t&&(e.headers.Authorization=`Bearer `+t)}async wrap(e,t,n,r,i){return n||t.dispatchEvent(new CustomEvent(`backend-called-event`,{bubbles:!0,composed:!0,detail:{}})),e().then(e=>(t.dispatchEvent(new CustomEvent(`backend-succeeded-event`,{bubbles:!0,composed:!0,detail:{actionId:r}})),e)).catch(e=>{let n=St(e,{online:Ot.isOnline()});throw n.kind==`cancelled`?t.dispatchEvent(new CustomEvent(`backend-cancelled-event`,{bubbles:!0,composed:!0,detail:{actionId:r}})):(e&&typeof e==`object`&&(e.__mateuReported=!0),t.dispatchEvent(new CustomEvent(`backend-failed-event`,{bubbles:!0,composed:!0,detail:{actionId:r,reason:this.serialize(e),failure:n,retry:i}}))),e})}async sendWithRetry(e,t){let n=0;for(;;)try{let t=await e();return Ot.noteReachable(),t}catch(e){let r=St(e,{online:Ot.isOnline()});if(r.kind==`offline`&&Ot.noteUnreachable(),n++,!Dt(r,n,{idempotent:t}))throw e;await jt(Et(n))}}serialize(e){return e?.message?e:JSON.stringify(e)}release(e){kt=kt.filter(t=>t!==e)}async get(e){let t=new AbortController;return kt=[...kt,t],this.axiosInstance.get(e,{signal:t.signal}).finally(()=>this.release(t))}async post(e,t,n){let r=new AbortController;return kt=[...kt,r],this.axiosInstance.post(e,t,{signal:r.signal,...n&&n>0?{timeout:n}:{}}).finally(()=>this.release(r))}async abortAll(){kt.forEach(e=>e.abort()),kt=[]}async runAction(e,t,n,r,i,a,o,s,c,l,u,d={}){if(t&&t.startsWith(`/`)&&(t=t.substring(1)),r===``&&(await ht(),gt())){let e=_t(pt(t))??vt(pt(t))??yt(pt(t));if(e){let t={...e,fragments:(e.fragments??[]).map(e=>e.targetComponentId?e:{...e,targetComponentId:i})};return await this.wrap(()=>Promise.resolve(t),l,u,r,d.retry)}}let f=[e,t,n,o??``,r,i].join(``),p=Ue.check(f);if(p.blocked)return await this.abortAll(),p.firstTrip&&console.error(`[mateu] request loop detected — aborting repeated request`,f),{messages:p.firstTrip?[{title:``,text:`A repeating request was detected and stopped to protect the server. Reload the page or navigate elsewhere.`,position:`bottom-end`,variant:`error`,duration:6e3}]:[],commands:[],fragments:[],banners:[],appendBanners:!1,appData:void 0,appState:void 0};a={...Pe(),...a};let m=e+`/mateu/v3/sync/`+(t&&t!=``?t:`_no_route`),h={serverSideType:o,appState:a,componentState:s,parameters:c,initiatorComponentId:i,consumedRoute:n,route:t&&t!=``?`/`+t:``,actionId:r,knownStructureHash:d.knownStructureHash},ee=Tt(r,d.idempotent),te=()=>this.post(m,h,d.timeoutMillis).then(e=>e.data);return await this.wrap(()=>this.sendWithRetry(te,ee),l,u,r,d.retry)}},Nt=function(e){return e.HAMBURGUER_MENU=`HAMBURGUER_MENU`,e.MENU_ON_LEFT=`MENU_ON_LEFT`,e.MENU_ON_TOP=`MENU_ON_TOP`,e.TABS=`TABS`,e.TILES=`TILES`,e.RAIL=`RAIL`,e.AUTO=`AUTO`,e.MEDIATOR=`MEDIATOR`,e}({}),Pt=new Map,Ft=[`position:absolute`,`width:1px`,`height:1px`,`margin:-1px`,`padding:0`,`overflow:hidden`,`clip:rect(0 0 0 0)`,`clip-path:inset(50%)`,`white-space:nowrap`,`border:0`].join(`;`),It=e=>{if(typeof document>`u`||!document.body)return;let t=Pt.get(e);return t?.isConnected?t:(t=document.createElement(`div`),t.setAttribute(`aria-live`,e),t.setAttribute(`aria-atomic`,`true`),t.setAttribute(`role`,e===`assertive`?`alert`:`status`),t.setAttribute(`data-mateu-live-region`,e),t.style.cssText=Ft,document.body.appendChild(t),Pt.set(e,t),t)},Lt=()=>{if(!(typeof document>`u`)){if(!document.body){document.addEventListener(`DOMContentLoaded`,()=>Lt(),{once:!0});return}It(`polite`),It(`assertive`)}},Rt=(e,t={})=>{let n=(e??``).trim();if(!n)return;let r=It(t.politeness??`polite`);if(r){if(r.textContent===n){r.textContent=``,setTimeout(()=>{r.textContent=n},60);return}r.textContent=n}},zt=class extends x{constructor(...e){super(...e),this.id=``,this.baseUrl=``,this.callbackToken=``,this.createElement=e=>{let t=e.data,n=document.createElement(t.name);for(let e in t.attributes)n.setAttribute(e,t.attributes[e]);for(let e in t.on)n.addEventListener(e,n=>{this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.on[e],parameters:{event:n}},bubbles:!0,composed:!0}))});return n},this.closeModal=()=>{let e=(this.shadowRoot??this).querySelectorAll(`mateu-dialog, mateu-drawer`);if(e&&e.length>0){e[e.length-1].close();return}this.dispatchEvent(new CustomEvent(`close-modal-requested`,{bubbles:!0,composed:!0}))},this.changeFavicon=e=>{let t=document.querySelector(`link[rel="icon"]`);t===null?(t=document.createElement(`link`),t.setAttribute(`rel`,`icon`),t.setAttribute(`href`,e),document.head.appendChild(t)):t.setAttribute(`href`,e)}}connectedCallback(){super.connectedCallback(),this.upstreamSubscription=de.subscribe(e=>{if(e.command){let t=e.command;this.id==t.targetComponentId&&this.applyCommand(t)}if((!e.callbackToken||!this.callbackToken||e.callbackToken===this.callbackToken)&&e.fragment){let t=e.fragment;this.id==t.targetComponentId&&(this.applyFragment(t),this.completeMenu(t))}})}completeMenu(e){if(e.component&&e.component.type==A.ClientSide){let t=e.component,n=t.metadata;if(n?.type==j.App){let e=n,r=this.getRemoteMenus(e.menu);if(r.length>0){let n=r.map(e=>Mt.runAction(e.baseUrl,e.route,`_empty`,``,e.baseUrl+`#`+e.route,void 0,void 0,void 0,e.params,this,!0));Promise.all(n).then(n=>{let r=this.updateMenu(e.menu,n.map(e=>e.fragments).filter(e=>e).map(e=>e).flat());t.metadata={...e,menu:r,variant:Nt.MENU_ON_TOP},this.requestUpdate()})}}}}updateMenu(e,t){let n=[];return e.forEach(e=>{if(e.remote){let r=t.find(t=>t.targetComponentId==e.baseUrl+`#`+e.route);if(r&&r.component?.type==A.ClientSide){let t=r.component;if(t.metadata?.type==j.App){let r=t.metadata,i=e.serverSideType&&e.serverSideType!=``?e.serverSideType:r.serverSideType;this.changeBaseUrl(r.menu,e.baseUrl,i,e.route,r.route),n.push(...r.menu)}}}else e.submenus&&e.submenus.length>0?n.push({...e,submenus:this.updateMenu(e.submenus,t)}):n.push(e)}),n}changeBaseUrl(e,t,n,r,i){e.forEach(e=>{e.baseUrl||(e.submenus&&e.submenus.length>0?this.changeBaseUrl(e.submenus,t,n,r,i):(e.consumedRoute=i??``,e.baseUrl=t,e.serverSideType=n,e.uriPrefix=r))})}getRemoteMenus(e){let t=[];return e.forEach(e=>{e.remote?t.push(e):e.submenus&&e.submenus.length>0&&t.push(...this.getRemoteMenus(e.submenus))}),t}disconnectedCallback(){super.disconnectedCallback(),this.upstreamSubscription?.unsubscribe()}applyCommand(e){if(e.type==`SetWindowTitle`&&(document.title=e.data,Rt(document.title)),e.type==`SetFavicon`&&this.changeFavicon(e.data),e.type==`DispatchEvent`&&this.dispatchNamedEvent(e.data),e.type==`NavigateTo`){let t=e.data;t&&(t.startsWith(`http:`)||t.startsWith(`https:`)?window.open(e.data,`_blank`):window.location.href=e.data)}if(e.type==`PushStateToHistory`){let t=e.data;t!==void 0&&this.dispatchEvent(new CustomEvent(`route-changed`,{detail:{route:t},bubbles:!0,composed:!0}))}if(e.type==`RunAction`){let t=e.data;if(t&&t.actionId)if(t.targetComponentId){let e={command:{type:`RunAction`,data:{actionId:t.actionId},targetComponentId:t.targetComponentId},fragment:void 0,ui:void 0,error:void 0,callbackToken:``};setTimeout(()=>de.next(e))}else this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId,parameters:{}},bubbles:!0,composed:!0}))}if(e.type==`MarkAsDirty`&&this.dispatchEvent(new CustomEvent(`dirty`,{detail:{},bubbles:!0,composed:!0})),e.type==`MarkAsClean`&&this.dispatchEvent(new CustomEvent(`clean`,{detail:{},bubbles:!0,composed:!0})),e.type==`DownloadFile`){let t=e.data;if(t&&t.base64Content){let e=atob(t.base64Content),n=new Uint8Array(e.length);for(let t=0;t<e.length;t++)n[t]=e.charCodeAt(t);let r=new Blob([n],{type:t.mimeType}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=t.filename??`export`,a.click(),URL.revokeObjectURL(i)}}if(e.type==`CloseModal`&&(this.closeModal(),this.dispatchNamedEvent(e.data)),e.type==`AddContentToHead`){let t=e.data;if(t&&t.name){if(t.attributes&&t.attributes.id&&document.getElementById(t.attributes.id))return;document.head.appendChild(this.createElement(e))}}if(e.type==`AddContentToBody`){let t=e.data;if(t&&t.name){if(t.attributes&&t.attributes.id&&document.getElementById(t.attributes.id))return;document.body.appendChild(this.createElement(e))}}}dispatchNamedEvent(e){if(e&&e.eventName){let t=this.component,n=t?.emitsName??t?.serverSideType,r=e.payload??e.detail;n&&r&&typeof r==`object`&&(r={...r,__source:n}),this.dispatchEvent(new CustomEvent(e.eventName,{detail:r,bubbles:!0,composed:!0}))}}};k([b()],zt.prototype,`id`,void 0),k([b()],zt.prototype,`baseUrl`,void 0);var Bt=class extends zt{applyFragment(e){}manageActionRequestedEvent(e){}};k([b()],Bt.prototype,`component`,void 0);var Vt=(e,t)=>Function(...Object.keys(t),"return `"+e+"`")(...Object.values(t)),Ht=(e,t,n)=>({state:e??{},data:t??{},...n});function M(e,t,n,r){if(!e?.includes("${"))return e;try{return Vt(e,Ht(t,n,r))}catch(t){return console.warn(`Mateu: could not interpolate "${e}":`,t),e}}var Ut=(e,t,n)=>{if(e&&e.indexOf("${")>=0)try{return Vt(e,Ht(t,n))}catch(e){return e.message}return e},Wt=(e,t,n,r,i)=>{if(!e)return e;let a=Ht(t,n,{appState:r??{},appData:i??{}}),o=e;try{if(o=Vt(e,a),o.includes("${"))try{o=Vt(o,a)}catch(a){o=`when evaluating nested `+e+` :`+a+`, where data is `+n+` and state is `+t+` and app state is `+r+` and app data is `+i,console.error(a,o,t,n,r,i)}}catch(a){o=`when evaluating `+e+` :`+a+`, where data is `+n+` and state is `+t+` and app state is `+r+` and app data is `+i,console.error(a,o,t,n,r,i)}return o},Gt=(e,t,n,r,i,a)=>{let o=Ht(t,n,{appState:r??{},appData:i??{},...a}),s=Vt(e,o);return Function(...Object.keys(o),`return (${s})`)(...Object.values(o))},Kt=(e,t,n,r)=>{let i=Ht(t,n,r);return Function(...Object.keys(i),`return (${e})`)(...Object.values(i))},qt=(e,t,n,r)=>Vt(e,Ht(t,n,r)),Jt=`display:inline-flex; align-items:center; justify-content:center; width:2rem; height:2rem; border-radius:50%; background:var(--lumo-contrast-10pct,#e0e0e0); color:var(--lumo-secondary-text-color,#555); font-size:.8rem; font-weight:600; overflow:hidden; flex:none;`,Yt=(e,t)=>t||(typeof e==`string`&&e?e.trim().split(/\s+/).map(e=>e[0]).slice(0,2).join(``).toUpperCase():``),Xt=(e,t,n)=>{let r=e.metadata,i=Zt(r.name,t,n);return T`<span style="${Jt}${e.style}" class="${e.cssClasses}"
        ...
        ${i.map(e=>T`<span style="${Jt}${o}" title="${e.name||y}">
            ${e.img?T`<img src="${e.img}" style="width:100%;height:100%;object-fit:cover;">`:Yt(e.name??``,e.abbr)}
        </span>`)}
        ${a>0?T`<span style="${Jt}${o}">+${a}</span>`:y}
    </span>`},$t=(e,t,n)=>{let r=e.metadata;return T`<span theme="badge ${r.color} ${r.pill?`pill`:``} ${r.small?`small`:``} ${r.primary?`primary`:``}"
                      style="${e.style}" class="${e.cssClasses}"
                      slot="${e.slot??y}">${Zt(r.text,t,n)}</span>`},en=(e,t,n)=>{let r=Zt(e.text,t,n);if(!r)return y;let i=Zt(e.color,t,n);return i==`SUCCESS`&&(i=`success`),i==`ERROR`&&(i=`error`),i==`DANGER`&&(i=`error`),i==`WARNING`&&(i=`warning`),i==`INFO`&&(i=`info`),i==`PRIMARY`&&(i=`primary`),i==`SECONDARY`&&(i=`secondary`),i==`TERTIARY`&&(i=`tertiary`),i==`QUATERNARY`&&(i=`quaternary`),i==`LIGHT`&&(i=`light`),i==`DARK`&&(i=`dark`),T`<span theme="badge ${i} ${e.pill?`pill`:``} ${e.small?`small`:``} ${e.primary?`primary`:``}">${r}</span>`},N=new class{constructor(){this.afterRenderHook=void 0,this.useShadowRoot=!0,this.componentRenderer=void 0}set(e){if(this.componentRenderer=e,typeof window<`u`){let t=e.supportedClientSideTypes?.();window.__mateuRendererInfo={name:e.rendererName?.()??e.constructor?.name??`unknown`,supportedTypes:t?[...t].sort():null}}}get(){return this.componentRenderer}setUseShadowRoot(e){this.useShadowRoot=e}mustUseShadowRoot(){return this.useShadowRoot}setAfterRenderHook(e){this.afterRenderHook=e}getAfterRenderHook(){return this.afterRenderHook}},tn=(e,t,n,r,i,a,o,s,c)=>(t.slot=s,P(e,t,n,r,i,a,o,c)),P=(e,t,n,r,i,a,o,s)=>{if(!t)return T``;if(t.type==A.ClientSide)return N.get().renderClientSideComponent(e,t,n,r,i,a,o,s);let c=e.route,l=e.consumedRoute;return T`
            ...
            `:u?T`
                <div style="display: flex; gap: var(--lumo-space-m, 1rem); width: 100%; align-items: center; flex-wrap: wrap;" class="form-header">
                    ...
                    <div style="flex: 1; min-width: min(22rem, 100%); overflow: hidden;">
                        ${c?T`<div class="page-overline">${v(Ut(c,this.state??{},this.data??{}))}</div>`:y}
                        ${(e?.title||l)&&d==0?T`
                            <div style="display: flex; align-items: center; gap: var(--lumo-space-s, .5rem); min-width: 0;">
                                <h2 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${e?.title?v(Ut(e?.title,this.state??{},this.data??{})):T`<span class="page-title-placeholder">${v(Ut(l,this.state??{},this.data??{}))}</span>`}</h2>
                                ${e.kpisBelow&&e.badges?.length?e.badges.map(e=>en(e,this.state??{},this.data??{})):y}
                            </div>`:y}
                        ${e?.title&&d==1?T`<h3 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${v(Ut(e?.title,this.state??{},this.data??{}))}</h3>`:y}
                        ${e?.title&&d==2?T`<h4 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${v(Ut(e?.title,this.state??{},this.data??{}))}</h4>`:y}
                        ${e?.title&&d==3?T`<h5 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${v(Ut(e?.title,this.state??{},this.data??{}))}</h5>`:y}
                        ${e?.title&&d>3?T`<h6 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${v(Ut(e?.title,this.state??{},this.data??{}))}</h6>`:y}

                        ${e?.subtitle?T`<span style="display: inline-block; margin-block-end: 0.83em;">${v(Ut(e?.subtitle,this.state??{},this.data??{}))}</span>`:y}
                        ${e?.timestamp?T`<span class="page-timestamp" style="display: block; color: var(--lumo-secondary-text-color, #6b7280); font-size: var(--lumo-font-size-s, .875rem);">${v(Ut(e.timestamp,this.state??{},this.data??{}))}</span>`:y}
                    </div>
    ...
    `}render(){let e=Array.from({length:Math.max(1,this.count)});return this.variant==`card`?T`${e.map(()=>T`<div class="bone card" style="margin: .5em 0;"></div>`)}`:this.variant==`grid`?T`${e.map(()=>T`<div class="bone row"></div>`)}`:this.variant==`form`?T`${e.map(()=>T`
            ...
            `)}`:T`${e.map(()=>T`<div class="bone line"></div>`)}`}};k([b()],pn.prototype,`variant`,void 0),k([b({type:Number})],pn.prototype,`count`,void 0),pn=k([_(`mateu-skeleton`)],pn);var mn=(e,t)=>{t&&e.target?.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t},bubbles:!0,composed:!0}))},hn=(e,t,n,r,i,a)=>T`
        <div class="mateu-empty-state"
            ...
            ${i&&a?T`
                <button style="margin-top: .25rem; font: inherit; font-weight: 500; cursor: pointer; padding: .4rem .9rem; border: none; border-radius: var(--lumo-border-radius-m, 6px); background: transparent; color: var(--lumo-primary-text-color, #3b5bdb);"
                        @click="${e=>mn(e,i)}">${a}</button>
            `:y}
        </div>
    `,gn=e=>{let t=e.metadata;return T`
        <div style="${e.style??y}" class="${e.cssClasses??y}" slot="${e.slot??y}">
            ${hn(void 0,t.icon,t.title,t.description,t.actionId,t.actionLabel)}
        </div>
    `},_n=e=>{let t=e.metadata;return T`
        <mateu-skeleton
    ...
    `},F=(e,t,n,r)=>{if(!e)return T``;let i=N.get()?.renderIcon;if(i){let a=i.call(N.get(),e,t,n);return r?T`<span slot="${r}">${a}</span>`:a}return T`<span class="mateu-icon ${n??``}" data-icon="${e}" aria-hidden="true"
        ...
        `,()=>n(e.value)))}`}renderActiveFilterWidget(e){if(this.isRangeFilter(e))return this.renderRangeWidget(e);if(this.isMultiFilter(e))return this.renderMultiWidget(e);if(this.hasOptions(e))return T`${e.options.map(t=>this.panelRow(t.label??t.value,()=>this.applyFilter(e.fieldId,t.value)))}`;if(this.isBooleanFilter(e))return T`
            ...
            </div>`}renderViewsPanel(){if(!this.viewsOpened)return y;let e=xn(this.viewsScope),t=!!this.state.searchText||this.filters.some(e=>this.isSet(e));return T`
                ...
                ${e.map(e=>T`
                    <div class="panel-row view-row" @mousedown="${this.keepFocus}">
                        ...
                        <button class="view-star ${e.isDefault?`view-star--on`:``}"
                                ...
                                @click="${()=>{wn(this.viewsScope,e.name),this.requestUpdate()}}">★</button>
    ...
    `}};k([b()],I.prototype,`metadata`,void 0),k([b()],I.prototype,`baseUrl`,void 0),k([w()],I.prototype,`state`,void 0),k([w()],I.prototype,`data`,void 0),k([b()],I.prototype,`appState`,void 0),k([b()],I.prototype,`appData`,void 0),k([b({type:Boolean})],I.prototype,`searchOnly`,void 0),k([w()],I.prototype,`panelOpened`,void 0),k([w()],I.prototype,`viewsOpened`,void 0),k([w()],I.prototype,`activeFilter`,void 0),k([w()],I.prototype,`draftText`,void 0),I=k([_(`mateu-filter-bar`)],I);var En=`mateu-column-prefs`,Dn=()=>{try{let e=JSON.parse(localStorage.getItem(En)??`{}`);return e&&typeof e==`object`&&!Array.isArray(e)?e:{}}catch{return{}}},On=e=>{try{localStorage.setItem(En,JSON.stringify(e))}catch{}},kn=e=>{if(!e||typeof e!=`object`)return;let t=e=>Array.isArray(e)?e.filter(e=>typeof e==`string`):[];return{hidden:t(e.hidden),order:t(e.order)}},An=e=>kn(Dn()[e]),jn=(e,t)=>{let n=Dn(),r=kn(t);r.hidden.length===0&&r.order.length===0?delete n[e]:n[e]=r,On(n)},Mn=e=>{let t=Dn();delete t[e],On(t)},Nn=e=>e?!!e.identifier||e.dataType===`action`||e.dataType===`actionGroup`||e.dataType===`menu`||e.id===`select`||e.id===`menu`:!1,Pn=(e,t,n=e=>e)=>{let r=kn(t);if(!r||r.hidden.length===0&&r.order.length===0)return e;let i=e=>n(e)?.id??e.id,a=new Set(r.hidden),o=e.filter(e=>{let t=i(e);return!t||!a.has(t)||Nn(n(e))});if(r.order.length===0)return o.length===e.length?e:o;let s=new Map;o.forEach(e=>{let t=i(e);t&&!s.has(t)&&s.set(t,e)});let c=[],l=new Set;return r.order.forEach(e=>{let t=s.get(e);t&&!l.has(t)&&(c.push(t),l.add(t))}),o.forEach(e=>{l.has(e)||(c.push(e),l.add(e))}),c.length===e.length&&c.every((t,n)=>t===e[n])?e:c},Fn=class extends x{constructor(...e){super(...e),this.columns=[],this.scope=``,this.panelOpened=!1,this.revision=0,this.togglePanel=()=>{if(this.panelOpened){this.closePanel();return}this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener(`mousedown`,this.outsideClick)},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1},this.reset=()=>{Mn(this.scope),this.revision++,this.dispatchEvent(new CustomEvent(`column-prefs-changed`,{bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}detachOutsideClick(){this.outsideClick&&=(document.removeEventListener(`mousedown`,this.outsideClick),void 0)}get prefs(){return An(this.scope)??{hidden:[],order:[]}}effectiveEntries(e){return Pn(this.columns,{hidden:[],order:e.order})}commit(e){jn(this.scope,e),this.revision++,this.dispatchEvent(new CustomEvent(`column-prefs-changed`,{bubbles:!0,composed:!0}))}toggleVisibility(e){let t=this.prefs,n=t.hidden.includes(e)?t.hidden.filter(t=>t!==e):[...t.hidden,e];this.commit({...t,hidden:n})}move(e,t){let n=this.prefs,r=[...this.effectiveEntries(n)],i=r.findIndex(t=>t.id===e);if(i<0)return;let a=i+t;for(;a>=0&&a<r.length&&r[a].protected;)a+=t;if(a<0||a>=r.length)return;let o=r[i];r[i]=r[a],r[a]=o,this.commit({...n,order:r.map(e=>e.id)})}render(){this.revision;let e=this.prefs,t=this.effectiveEntries(e).filter(e=>!e.protected);if(t.length===0)return T``;let n=e.hidden.length>0||e.order.length>0;return T`
            <div class="chooser">
                <button
    ...
    `}};k([b()],Fn.prototype,`columns`,void 0),k([b()],Fn.prototype,`scope`,void 0),k([w()],Fn.prototype,`panelOpened`,void 0),k([w()],Fn.prototype,`revision`,void 0),Fn=k([_(`mateu-column-chooser`)],Fn);var In;async function Ln(e){if(!In)return{};try{return await In(e)??{}}catch(e){return console.warn(`mateu: external auth provider failed`,e),{}}}function Rn(e,t){return t?t.split(`.`).reduce((e,t)=>typeof e==`object`&&e?e[t]:void 0,e):e}function zn(e,t,n=`value`,r=`label`){let i=Rn(e,t);return Array.isArray(i)?i.map(e=>{if(typeof e==`object`&&e){let t=Rn(e,n),i=Rn(e,r);return{value:t??i,label:String(i??t??``)}}return{value:e,label:String(e)}}):[]}function Bn(e,t,n,r=e=>e){let i=Rn(e,t);return Array.isArray(i)?i.map(e=>{let t={};for(let i of n)t[i]=Rn(e,r(i));return t}):[]}async function Vn(e,t=e=>e,n=fetch,r){let i=be(e),a=(i.method||`GET`).toUpperCase();if(!i.url)throw Error(`External REST fetch has no url${e.ref?` (unknown source "${e.ref}")`:``}`);let o=t(i.url)??i.url,s={};for(let[e,n]of Object.entries(i.headers??{}))s[e]=t(n)??n;Object.assign(s,await Ln({url:o,method:a}));let c={method:a,headers:s};a!==`GET`&&a!==`HEAD`&&i.body&&(c.body=(r&&he(s)?r:t)(i.body)??i.body);let l=await n(o,c);if(!l.ok)throw Error(`External REST fetch failed: ${l.status}`);return l.json()}async function Hn(e,t=e=>e,n=fetch){let r=await Vn(e,t,n),i=be(e);return zn(r,i.itemsPath,i.valuePath,i.labelPath)}async function Un(e,t,n=e=>e,r=fetch){return Bn(await Vn(e,n,r),be(e).itemsPath,t,t=>xe(e,t))}async function Wn(e,t,n=e=>e,r=fetch){return Gn(await Vn(e,n,r),e,t)}function Gn(e,t,n){let r=Bn(e,be(t).itemsPath,n,e=>xe(t,e)),i=Rn(e,Se(t)),a=typeof i==`number`?i:Number(i);return{rows:r,total:Number.isFinite(a)?a:null}}var Kn=e=>e==null||e===``||typeof e==`number`&&Number.isNaN(e),qn=e=>e.stereotype===`dateRange`||e.stereotype===`numberRange`,Jn=e=>e.stereotype===`multiSelect`,Yn=e=>e.dataType===`boolean`||e.dataType===`bool`||e.stereotype===`checkbox`||e.stereotype===`toggle`,Xn=e=>Array.isArray(e)?e.map(String):typeof e==`string`&&e!==``?e.split(`,`).map(e=>e.trim()).filter(e=>e):[],Zn=(e,t,n,r)=>{if(r){let r=Number(e);return!(e===``||e==null||Number.isNaN(r)||!Kn(t)&&r<Number(t)||!Kn(n)&&r>Number(n))}let i=e==null?``:String(e);return!(i===``||!Kn(t)&&i<String(t)||!Kn(n)&&i>String(n))},Qn=(e,t,n)=>{let r=t.fieldId;if(!r)return!0;let i=e[r];if(qn(t)){let e=n[`${r}_from`],a=n[`${r}_to`];return Kn(e)&&Kn(a)?!0:Zn(i,e,a,t.stereotype===`numberRange`)}if(Jn(t)){let e=Xn(n[r]);return e.length===0||e.includes(String(i??``))}let a=n[r];return Kn(a)?!0:Yn(t)?(typeof a==`boolean`?a:String(a).toLowerCase()===`true`)===(typeof i==`boolean`?i:String(i??``).toLowerCase()===`true`):(t.options?.length??0)>0?String(i??``)===String(a):String(i??``).toLowerCase().includes(String(a).toLowerCase())};function $n(e,t,n,r){let i=String(r?.searchText??``).trim().toLowerCase(),a=(n??[]).filter(e=>e?.fieldId);return i===``&&a.length===0?e:e.filter(e=>i!==``&&!t.some(t=>String(e[t]??``).toLowerCase().includes(i))?!1:a.every(t=>Qn(e,t,r??{})))}var er=e=>{let t=Number(e);return Number.isFinite(t)&&t>0?Math.floor(t):0},tr=(e,t,n)=>{let r=er(e),i=er(t),a=er(n);if(i===0)return{totalPages:void 0,currentPage:a,multiPage:a>0,isFirst:a===0,isLast:!0};let o=Math.max(1,Math.ceil(r/i)),s=Math.min(a,o-1);return{totalPages:o,currentPage:s,multiPage:o>1,isFirst:s===0,isLast:s>=o-1}},nr=class extends x{constructor(...e){super(...e),this.totalElements=0,this.pageSize=100,this.pageNumber=0}dispatch(e){this.dispatchEvent(new CustomEvent(`page-changed`,{bubbles:!0,composed:!0,detail:{page:e}}))}render(){if(!this.totalElements)return y;let{totalPages:e,currentPage:t,multiPage:n,isFirst:r,isLast:i}=tr(this.totalElements,this.pageSize,this.pageNumber);return T`
            <div class="bar">
                ${n?T`
    ...
    `}};k([b()],nr.prototype,`totalElements`,void 0),k([b()],nr.prototype,`pageSize`,void 0),k([b()],nr.prototype,`pageNumber`,void 0),nr=k([_(`mateu-pagination`)],nr);var rr=(e,t,n=!1)=>e&&e>1||n?T`<div style="grid-column: span ${e&&e>1?e:1}; min-width: 0;">${t}</div>`:t,ir=`var(--lumo-space-m, 1rem)`,ar=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=s.columnWidth||`13rem`,l=`display: grid; grid-template-columns: ${s.maxColumns&&s.maxColumns>0?`repeat(${s.maxColumns}, minmax(0, 1fr))`:`repeat(auto-fill, minmax(min(100%, ${c}), 1fr))`}; gap: ${ir} var(--lumo-space-l, 1.5rem); align-items: start;`;return s.labelsAside&&(l+=` --mateu-label-width: 10rem;`),s.fullWidth&&(l+=` width: 100%;`),l+=t.style??``,T`
        <div id="${t.id??y}" style="${l}" class="${t.cssClasses}" slot="${t.slot||y}">
            ${t.children?.map(t=>or(s,e,t,n,r,i,a,o))}
        </div>
    `},or=(e,t,n,r,i,a,o,s)=>n.type==A.ClientSide&&n.metadata?.type==j.FormRow?lr(e,t,n,r,i,a,o,s):rr(sr(n),e.labelsAside?cr(t,n,r,i,a,o,s):P(t,n,r,i,a,o,s),!0),sr=e=>{if(e.type==A.ClientSide){let t=e.metadata;if(t?.type==j.FormField)return t.colspan||1}return 1},cr=(e,t,n,r,i,a,o)=>{if(t.type==A.ClientSide&&t.metadata?.type==j.FormField&&t.metadata.label){let s=t.metadata;return T`
            <div style="display: flex; gap: ${ir}; align-items: baseline;">
        ...
        `}return P(e,t,n,r,i,a,o)},lr=(e,t,n,r,i,a,o,s)=>T`
        <div style="grid-column: 1 / -1; display: flex; gap: ${ir}; flex-wrap: wrap;">
            ${n.children?.map(c=>T`<div style="flex: 1 1 ${100/Math.max(1,n.children.length)}%; min-width: min(100%, 13rem);">${or(e,t,c,r,i,a,o,s)}</div>`)}
        </div>
    `,ur=(e,t,n,r,i,a,o,s)=>{let c=n.metadata,l=`display: flex; flex-direction: ${e};`;c.spacing&&(l+=` gap: ${ir};`),c.padding&&(l+=` padding: var(--lumo-space-m, 1rem);`),c.wrap&&(l+=` flex-wrap: wrap;`),c.fullWidth&&(l+=` width: 100%;`),c.justification&&(l+=` justify-content: ${c.justification};`);let u=e===`row`?c.verticalAlignment:c.horizontalAlignment;return u&&(l+=` align-items: ${u};`),l+=n.style??``,T`
        <div id="${n.id??y}" style="${l}" class="${n.cssClasses}" slot="${n.slot??y}">
            ${n.children?.map(e=>P(t,e,r,i,a,o,s))}
        </div>
    `},dr=(e,t,n,r,i,a,o)=>ur(`row`,e,t,n,r,i,a,o),fr=(e,t,n,r,i,a,o)=>ur(`column`,e,t,n,r,i,a,o),pr=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=`display: flex; flex-direction: ${s.orientation===`vertical`?`column`:`row`}; gap: var(--lumo-space-s, 0.5rem);`;return s.fullWidth&&(c+=` width: 100%;`),c+=t.style??``,T`
    ...
    `},mr=(e,t,n,r,i,a,o)=>{let s=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,l=!!i?.hasDetail||!!s,u=c??s;return T`
    ...
    `},hr=(e,t,n,r,i,a,o)=>{let s=t.style??``;t.metadata.fullWidth&&(s+=` width: 100%;`);let c=Math.max(0,(t.children??[]).findIndex(e=>e.metadata.active));return T`
    ...
    `},gr=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style??``;return s.fullWidth&&(c+=` width: 100%;`),T`
        <div style="${c}" class="${t.cssClasses}" slot="${t.slot??y}">
            ${t.children?.map(t=>_r(e,t,n,r,i,a,o,s.variant))}
        </div>
    `},_r=(e,t,n,r,i,a,o,s)=>{let c=t.metadata,l=c.label?.includes("${")?e._evalTemplate(c.label):c.label;return T`
    ...
    `,xr=(e,t,n,r,i,a,o)=>T`
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 16rem), 1fr)); gap: ${ir}; ${t.style}" class="${t.cssClasses}" slot="${t.slot??y}">
            ${t.children?.map(t=>P(e,t,n,r,i,a,o))}
        </div>
    `,Sr=(e,t,n,r,i,a,o)=>T`
        <div style="display: flex; gap: ${ir}; flex-wrap: wrap; ${t.style}" class="${t.cssClasses}">
            ${t.children?.map(t=>P(e,t,n,r,i,a,o))}
        </div>
    `,Cr=(e,t,n,r,i,a,o)=>T`
    ...
    `},Tr=e=>{let t=e.metadata;return(t?.content??t?.columns??[]).filter(e=>e&&e.metadata).map(e=>{let t=e.metadata;return{id:e.id??``,label:t?.label??e.id??``,autoWidth:t?.autoWidth,width:t?.width}})},Er=(e,t)=>{let n=e?.[t];return n==null?``:typeof n==`object`?n.text??n.label??n.value??``:String(n)},Dr=(e,t,n)=>{let r=Tr(e);return T`
    ...
    `},Ar=(e,t,n,r,i,a,o)=>t.separator?T`<span style="align-self: stretch; width: 1px; background: var(--lumo-contrast-20pct, rgba(0,0,0,.2));"></span>`:t.submenus?T`
            <details style="position: relative;">
                ...
                <div style="display: flex; flex-direction: column; gap: .1rem; padding: .3rem; min-width: 10rem;
                    ...
                    ${t.submenus.map(t=>Ar(e,t,n,r,i,a,o))}
                </div>
            </details>
        `:T`
    ...
    `,jr=(e,t,n,r,i,a,o)=>{let s=t.metadata;return T`
        <div style="display: flex; flex-wrap: wrap; gap: .25rem; align-items: center; ${t.style}"
            ...
            ${s.options?.map(t=>Ar(e,t,n,r,i,a??{},o??{}))}
        </div>
    `},Mr=(e,t,n,r,i,a,o)=>{let s=t.metadata;return T`
        <div style="${t.style}" class="${t.cssClasses}" slot="${t.slot??y}">
            ${P(e,s.wrapped,n,r,i,a,o)}
        </div>
    `},Nr=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=s.content?.metadata,l=c?.type==j.Notice&&c.fullWidth===!0;return T`
    ...
    `},Fr=(e,t,n,r,i,a,o)=>{let s=t.metadata;return T`<span title="${s.text}" style="${t.style}" class="${t.cssClasses}" slot="${t.slot??y}"
        >${P(e,s.wrapped,n,r,i,a,o)}</span>`},Ir=e=>{if(e instanceof CustomEvent)return e.detail;let t={};for(let n in e){let r=e[n];[`number`,`string`,`boolean`].indexOf(typeof r)>=0&&(t[n]=e[n])}return t},Lr=(e,t,n,r,i)=>{let a={appState:r??{},appData:i??{}},o={};for(let r in e.attributes)o[r]=M(e.attributes[r],t,n,a);return{attributes:o,content:M(e.content,t,n,a)}},Rr=(e,t,n,r)=>{for(let t in r.attributes)e.setAttribute(t,r.attributes[t]);n.style&&e.setAttribute(`style`,n.style),n.cssClasses&&e.setAttribute(`class`,n.cssClasses),n.slot&&e.setAttribute(`slot`,n.slot),r.content&&(t.html?e.innerHTML=r.content:e.append(r.content))},zr=e=>{let t=e.name,n=e.attributes?e.attributes.import:void 0;n&&t.includes(`-`)&&!customElements.get(t)&&D(()=>import(n),[])},Br=(e,t,n,r,i,a,o)=>{zr(t);let s=Lr(t,r,i,a,o),c=t.name;s.attributes.id&&(c=`#`+s.attributes.id);let l=n.id?`.element-container[data-element-id="${n.id}"]`:`.element-container`;return setTimeout(()=>{let r=e.shadowRoot?.querySelector(l),i=r?.querySelector(c);if(i){for(;i.firstChild;)i.removeChild(i.lastChild);Rr(i,t,n,s)}else{let i=document.createElement(t.name);Rr(i,t,n,s);for(let n in t.on)i.addEventListener(n,r=>{let i=Ir(r);e.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.on[n],parameters:{event:i}},bubbles:!0,composed:!0}))});r?.appendChild(i)}}),T`<div class="element-container" data-element-id="${C(n.id)}"></div>`},Vr=function(e){return e.div=`div`,e.p=`p`,e.h1=`h1`,e.h2=`h2`,e.h3=`h3`,e.h4=`h4`,e.h5=`h5`,e.h6=`h6`,e.span=`span`,e}({}),Hr=(e,t,n,r,i)=>{let a=e.metadata,o=a.attributes?.[`data-colspan`],s=Wt(a.text,t,n,r,i),c={xl:`var(--lumo-font-size-xl, 1.375rem)`,l:`var(--lumo-font-size-l, 1.125rem)`,s:`var(--lumo-font-size-s, .875rem)`,xs:`var(--lumo-font-size-xs, .8125rem)`},l=(a.size&&c[a.size]?`font-size: ${c[a.size]}; `:``)+(a.noMargins?`margin-block-start: 0; margin-block-end: 0; `:``);return Vr.h1==a.container?T`
        ...
        `:Vr.p==a.container?T`
            ...
            slot="${e.slot??y}"
    >${r.iconOnLeft?F(r.iconOnLeft):y}${i}${r.iconOnRight?F(r.iconOnRight):y}</button>`},Qr=`display:block; box-sizing:border-box; background:var(--lumo-base-color,#fff); border:1px solid var(--lumo-contrast-10pct,rgba(0,0,0,.1)); border-radius:var(--lumo-border-radius-l,12px); box-shadow:var(--lumo-box-shadow-xs,0 1px 3px rgba(0,0,0,.08)); overflow:hidden;`,$r=(e,t,n,r,i,a,o)=>{let s=t.metadata;if(!s)return T``;let c=t=>t?P(e,t,n,r,i,a,o,!1):y,l=s.header||s.headerPrefix||s.headerSuffix||s.title||s.subtitle;return T`
        <div id="${t.id??y}" style="${Qr}${t.style}" class="${t.cssClasses}" slot="${t.slot??y}">
            ${s.media?c(s.media):y}
    ...
    `},ti=e=>{let t=e.metadata;return F(t.icon,e.style,e.cssClasses,e.slot)},ni=(e,t)=>{e&&e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t},bubbles:!0,composed:!0}))},ri=`font:inherit; font-weight:500; cursor:pointer; padding:.45rem 1rem; border-radius:var(--lumo-border-radius-m,6px);`,ii=`${ri} background:var(--lumo-contrast-5pct,rgba(0,0,0,.04)); color:var(--lumo-body-text-color,#161513); border:1px solid var(--lumo-contrast-20pct,rgba(0,0,0,.16));`,ai=`${ri} background:var(--lumo-primary-color,#3b5bdb); color:var(--lumo-primary-contrast-color,#fff); border:1px solid transparent;`,oi=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=!1;if(s.openedCondition)try{c=Gt(s.openedCondition,r,i,a,o)}catch(e){console.error(`when evaluating `+s.openedCondition+` :`+e+`, where data is `+i+` and state is `+r)}return c?T`
        <div class="mateu-confirm-dialog ${t.cssClasses??``}"
            ...
            <div style="background:var(--lumo-base-color,#fff); color:var(--lumo-body-text-color,#161513); border-radius:var(--lumo-border-radius-l,12px); box-shadow:var(--lumo-box-shadow-l,0 8px 24px rgba(0,0,0,.2)); width:100%; max-width:min(90vw,32rem); padding:1.5rem; box-sizing:border-box;">
                ...
                <div style="display:flex; gap:.5rem; justify-content:flex-end; margin-top:1.25rem;">
                    ${s.canCancel?T`<button style="${ii}" @click="${e=>ni(e.currentTarget,s.cancelActionId)}">${s.rejectText&&!s.canReject?s.rejectText:`Cancel`}</button>`:y}
                    ${s.canReject?T`<button style="${ii}" @click="${e=>ni(e.currentTarget,s.rejectActionId)}">${s.rejectText||`No`}</button>`:y}
                    <button style="${ai}" @click="${e=>ni(e.currentTarget,s.confirmActionId)}">${s.confirmText||`OK`}</button>
                </div>
            </div>
        </div>
    `:T``},si=e=>{let t=e.metadata,n;return t.position&&(n={Top:`top`,Bottom:`bottom`,TopLeft:`top-left`,TopRight:`top-right`,BottomLeft:`bottom-left`,BottomRight:`bottom-right`}[t.position]),T`
    ...
    `},ci=(e,t,n,r,i,a,o)=>{let s=t.metadata;return T`
        <details
                ?open="${s.opened}"
                style="${t.style}"
                class="${t.cssClasses}"
        ...
        <mateu-drawer
            ...
            .appdata="${a}"
        ></mateu-drawer>
            `,di=e=>`mfe_`+[e.baseUrl,e.route,e.consumedRoute,e.serverSideType].map(e=>e??``).join(`|`).replace(/[^a-zA-Z0-9]/g,`_`),fi=e=>{let t=e.metadata;return T`
        <mateu-api-caller>
        ...
        <mateu-markdown .content=${e.metadata.markdown}
            ...
            `,mi=e=>{let t=e.metadata;return T`
        <div
            role="status"
            slot="${e.slot??y}"
            class="${e.cssClasses}"
    ...
    `},hi=(e,t={})=>{let n=e.metadata,r=n.valueKey?t[n.valueKey]:n.value,i=n.max&&n.max!=0?n.max:1,a=!n.indeterminate&&r!=null;return T`
    ...
    `},gi=(e,t,n,r,i,a,o)=>{let s=t.metadata;return T`
    ...
    `},_i=e=>{let t=e.metadata;return T`
        ...
        <img src="${e.metadata.src}" style="${e.style}" class="${e.cssClasses}"
             slot="${e.slot??y}">
            `,yi=e=>{let t=e.metadata;return T`<div style="display:flex; align-items:center; gap:0.5rem;" slot="${e.slot??y}">
        ${t.breadcrumbs.map(e=>T`
            <a href="${e.link}">${e.text}</a>
            <span>/</span>
        `)}
        <span style="${e.style}" class="${e.cssClasses}">${t.currentItemText}</span>
    </div>`},bi=(e,t,n,r,i,a,o)=>{let s=t.metadata;return T`
        <skeleton-carousel 
                id="${t.id}"
                ?dots = "${s.dots}" 
                ?nav = "${s.nav}" 
    ...
    `},xi=(e,t,n,r)=>{let i=e.metadata;return T`
        ...
        ${e.submenus?T`
                <details open>
                    ...
                    <div style="display:flex; flex-direction:column; gap:0.25rem; padding-left:0.5rem;">
                        ${e.submenus.map(e=>Si(e))}
                    </div>
                </details>
            `:T`
                <a href="${e.path}">${e.label}</a>
        `}
        `,Ci=(e,t,n,r,i,a,o)=>{let s=t.metadata;return T`<div
                slot="${t.slot??y}"
                style="${t.style}" class="${t.cssClasses}"
        >${s.content?v(s.content):y}${t.children?.map(t=>P(e,t,n,r,i,a,o))}</div>
    `},wi=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=s.title?.includes("${")?e._evalTemplate(s.title):s.title;return T`<div
                id="${t.id??y}"
                slot="${t.slot??y}"
    ...
    `},Ti=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=s.title?.includes("${")?e._evalTemplate(s.title):s.title;return T`
        <div
                slot="${t.slot??y}"
                style="${t.style}" class="${t.cssClasses}"
        >
    ...
    `},Ei=(e,t,n)=>{n.dispatchEvent(new CustomEvent(`value-changed`,{detail:{fieldId:e,value:t},bubbles:!0,composed:!0}))},Di=e=>t=>{let n=t.target,r=n.type===`checkbox`?n.checked:n.value;Ei(e.fieldId,r,n)},Oi=(e,t)=>{let n=e.metadata,r=t?.[n.fieldId]??``,i=n,a=i.dataType,o=i.stereotype,s=!!i.readOnly,c=!!i.disabled,l=i.options,u=n.label?T`<label style="display:block; font-size: var(--lumo-font-size-s,.875rem); color: var(--lumo-secondary-text-color,#667); margin-bottom:.15rem;">${n.label}</label>`:y,d=`width:100%; box-sizing:border-box; padding:.4rem .6rem; border:1px solid var(--lumo-contrast-30pct,rgba(0,0,0,.3)); border-radius: var(--lumo-border-radius-m,6px); font:inherit; background: var(--lumo-base-color,#fff); color: var(--lumo-body-text-color,#1a1a1a);`,f;return f=s||o===`plainText`?T`<div style="padding:.4rem 0;">${String(r??``)}</div>`:a===`boolean`||a===`bool`||o===`checkbox`||o===`badge`?T`<input type="checkbox" ?checked="${!!r}" ?disabled="${c}" @change="${Di(n)}">`:l&&l.length?T`
            <select style="${d}" ?disabled="${c}" @change="${Di(n)}">
                <option value="">—</option>
                ${l.map(e=>T`<option value="${e.value}" ?selected="${e.value===r}">${e.label}</option>`)}
            </select>`:o===`textarea`||o===`richText`||o===`html`?T`<textarea style="${d}" rows="3" ?disabled="${c}" @input="${Di(n)}">${String(r??``)}</textarea>`:T`<input type="${a===`integer`||a===`number`||a===`double`||a===`money`?`number`:a===`date`?`date`:a===`datetime`?`datetime-local`:a===`time`?`time`:o===`password`?`password`:a===`email`?`email`:`text`}" style="${d}" .value="${String(r??``)}"
                              placeholder="${i.placeholder??y}" ?disabled="${c}" @input="${Di(n)}">`,T`
        <div id="${e.id??y}" style="${e.style}" class="${e.cssClasses}" slot="${e.slot??y}">
            ${u}
            ${f}
        </div>
    `},ki=e=>{let t=e.metadata;if((t?.level??0)>0)return e;let n=e=>{if(e?.metadata?.type===j.EntityHeader)return e;let t=e?.metadata?.content,r=[...e?.children??[],...Array.isArray(t)?t:t?[t]:[]];for(let e of r){let t=n(e);if(t)return t}},r;for(let t of e.children??[])if(r=n(t),r)break;if(!r)return e;let i=r.metadata;r.__hoistedToPageHeader=!0;let a=[...(i.facts??[]).filter(e=>e.label||e.value).map(e=>({title:e.label??``,text:e.value??``})),...i.metricLabel?[{title:i.metricLabel,text:i.metricValue??``}]:[]],o=(i.badges??[]).filter(e=>e.label).map(e=>({text:e.label,color:e.color})),s={...t,title:i.title||t.title,subtitle:i.subtitle??t.subtitle,kpis:[...t.kpis??[],...a],kpisBelow:!0,badges:[...t.badges??[],...o]};return{...e,metadata:s}},Ai=(e,t,n,r,i,a,o,s)=>{let c=ki(t),l=c.metadata,u=l?.fabs??[];return T`<mateu-page
            .component="${c}"
            baseUrl="${n}"
            .state="${r}"
            .data="${i}"
...
`)}
    ...
    `},ji=(e,t,n,r,i,a,o,s)=>T`<mateu-table-crud
            id="${t.id}"
            baseUrl="${n}"
            .component="${t}"
            .metadata="${t.metadata}"
    ...
    >
        ${t.children?.map(t=>P(e,t,n,r,i,a,o))}
    </mateu-table-crud>`,Mi=e=>{let t=e.metadata;return T`
        <mateu-bpmn
                style="${e.style}"
                class="${e.cssClasses}"
                slot="${e.slot??y}"
    ...
    `},Ni=(e,t,n)=>T`<mateu-chat sseUrl="${e.metadata.sseUrl}"
                            style="${e.style}" 
                            class="${e.cssClasses}" 
                            slot="${e.slot??y}"></mateu-chat>`,Pi=e=>{let t=e.metadata;return T`
        <mateu-workflow
                style="${e.style??y}"
                class="${e.cssClasses??y}"
                slot="${e.slot??y}"
    ...
    box-sizing: border-box;
`,Li=e=>e==`up`?`var(--lumo-success-text-color, #1a7f37)`:e==`down`?`var(--lumo-error-text-color, #c5221f)`:`var(--lumo-secondary-text-color, #666)`,Ri=e=>e==`up`?`▲`:e==`down`?`▼`:``,zi=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},Bi=e=>{let t=e.metadata,n=!!t.actionId;return T`
        <div class="mateu-metric-card ${e.cssClasses??``}"
             style="${Ii} display: flex; flex-direction: column; gap: .25rem; min-width: 11rem; flex: 1; ${n?`cursor: pointer;`:``} ${e.style??``}"
             slot="${e.slot??y}"
             role="${n?`button`:y}"
             @click="${e=>zi(e,t)}"
        >
            ...
            ${t.trend||t.trendLabel?T`
                <span style="font-size: var(--lumo-font-size-s, .875rem); color: ${Li(t.trend)};">
                    ${Ri(t.trend)} ${t.trendLabel??y}
                </span>
            `:y}
    ...
    `,Hi=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=s.colSpan&&s.colSpan>1?`grid-column: span ${s.colSpan};`:``,l=s.rowSpan&&s.rowSpan>1?`grid-row: span ${s.rowSpan};`:``,u=t.children??[];return u.length===1&&u[0].metadata?.type===`MetricCard`?T`
            <div style="min-width: 0; ${c} ${l} ${t.style??``}" slot="${t.slot??y}">
                ${P(e,u[0],n,r,i,a,o)}
            </div>`:T`
        <div class="mateu-dashboard-panel ${t.cssClasses??``}"
             style="${Ii} display: flex; flex-direction: column; gap: .5rem; min-width: 0; ${c} ${l} ${t.style??``}"
             slot="${t.slot??y}"
        >
            ${s.title?T`
                <div>
    ...
    `},Ui=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=s.columns&&s.columns>0?`repeat(${s.columns}, minmax(0, 1fr))`:`repeat(auto-fit, minmax(20rem, 1fr))`;return T`
    ...
    `}render(){if(this.expandedPanel!=null&&this.panels[this.expandedPanel]){let e=this.panels[this.expandedPanel];return T`
        ...
        `}};k([b({type:Array})],Wi.prototype,`panels`,void 0),k([b({type:String})],Wi.prototype,`headerTitle`,void 0),k([b({type:Array})],Wi.prototype,`badges`,void 0),k([b({type:String,reflect:!0})],Wi.prototype,`orientation`,void 0),k([b({attribute:!1})],Wi.prototype,`navigation`,void 0),k([b({type:String})],Wi.prototype,`overviewEditActionId`,void 0),k([w()],Wi.prototype,`openPanels`,void 0),k([w()],Wi.prototype,`expandedPanel`,void 0),Wi=k([_(`mateu-foldout`)],Wi);var Gi=(e,t,n,r,i,a,o)=>{let s=t.metadata;return T`
        <mateu-foldout
                .panels="${s.panels??[]}"
    ...
    `},qi=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.children??[],l=e=>c.filter(t=>(t.slot??``).startsWith(e)),u=l(`main-`),d=l(`aside-`),f=l(`footer-`),p=s.asideWidth&&s.asideWidth.trim()?s.asideWidth:`32%`,m=s.asidePosition===`start`,h=s.asideSticky!==!1,ee=t=>t.map(t=>P(e,t,n,r,i,a,o)),te=T`
...
`,Yi=1440*60*1e3,Xi=class extends x{constructor(...e){super(...e),this.tasks=[],this.onTaskSelectionActionId=``}selectTask(e){this.onTaskSelectionActionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.onTaskSelectionActionId,parameters:{_clickedTaskId:e.id}},bubbles:!0,composed:!0}))}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            font-size: var(--lumo-font-size-s, .875rem);
    ...
    `}range(){let e=this.tasks.flatMap(e=>[e.start,e.end]).filter(e=>!!e).map(e=>new Date(e+`T00:00:00`).getTime());return e.length?{min:Math.min(...e)-Yi,max:Math.max(...e)+2*Yi}:null}months(e,t){let n=[],r=new Date(e);for(r.setDate(1);r.getTime()<=t;){let i=Math.max(r.getTime(),e),a=new Date(r.getFullYear(),r.getMonth()+1,1),o=Math.min(a.getTime(),t);n.push({label:r.toLocaleDateString(void 0,{month:`short`,year:`2-digit`}),from:i,to:o}),r.setMonth(r.getMonth()+1)}return n}render(){let e=this.range();if(!e)return T``;let t=e.max-e.min,n=n=>(n-e.min)/t*100,r=Date.now();return T`
        ...
        `}};k([b({type:Array})],Xi.prototype,`tasks`,void 0),k([b()],Xi.prototype,`onTaskSelectionActionId`,void 0),Xi=k([_(`mateu-gantt`)],Xi);var Zi=e=>{let t=e.metadata;return T`
        <mateu-gantt
                .tasks="${t.tasks??[]}"
                ...
                slot="${e.slot??y}"
        ></mateu-gantt>
    `},z,Qi=class extends x{static{z=this}constructor(...e){super(...e),this.resources=[],this.blocks=[],this.drag=null,this.dragStartX=0,this.dragStartY=0,this.laneRects=[],this.onDragKeydown=e=>{e.key===`Escape`&&this.drag&&(e.stopPropagation(),this.endDrag())}}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            font-size: var(--lumo-font-size-s, .875rem);
    ...
    `}static parse(e){return new Date(e+`T00:00:00`)}static iso(e){let t=e=>String(e).padStart(2,`0`);return`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}`}static addDays(e,t){return new Date(e.getFullYear(),e.getMonth(),e.getDate()+t)}static daysBetween(e,t){return Math.round((t.getTime()-e.getTime())/864e5)}window(){if(this.from&&this.to){let e=z.parse(this.from),t=z.daysBetween(e,z.parse(this.to))+1;return t>0?{from:e,days:t}:null}let e=this.blocks.flatMap(e=>[e.start,e.end]).filter(e=>!!e).map(e=>z.parse(e));if(!e.length)return null;let t=new Date(Math.min(...e.map(e=>e.getTime()))),n=new Date(Math.max(...e.map(e=>e.getTime())));return{from:t,days:z.daysBetween(t,n)+1}}onBlockPointerDown(e,t,n){if(!this.moveActionId&&!this.selectActionId||(e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),this.dragStartX=e.clientX,this.dragStartY=e.clientY,!this.window()))return;let r=z.parse(t.start),i=z.parse(t.end),a=Math.max(1,z.daysBetween(r,i)+1);this.laneRects=[...this.renderRoot.querySelectorAll(`.lane[data-resource-id]`)].map(e=>({resourceId:e.dataset.resourceId,rect:e.getBoundingClientRect()}));let o=this.dayAt(t.resourceId,e.clientX)??n;this.drag={blockId:t.id,duration:a,grabOffsetDays:o-n,originResourceId:t.resourceId,originStartIdx:n,targetResourceId:t.resourceId,targetStartIdx:n,moved:!1},window.addEventListener(`keydown`,this.onDragKeydown)}dayAt(e,t){let n=this.laneRects.find(t=>t.resourceId===e),r=this.window();if(!n||!r||n.rect.width===0)return null;let i=Math.floor((t-n.rect.left)/n.rect.width*r.days);return Math.max(0,Math.min(r.days-1,i))}onBlockPointerMove(e){if(!this.drag||!this.drag.moved&&Math.abs(e.clientX-this.dragStartX)<4&&Math.abs(e.clientY-this.dragStartY)<4||!this.moveActionId)return;let t=this.window();if(!t)return;let n=this.laneRects.find(t=>e.clientY>=t.rect.top&&e.clientY<=t.rect.bottom)??this.laneRects.find(e=>e.resourceId===this.drag.targetResourceId);if(!n)return;let r=this.dayAt(n.resourceId,e.clientX);if(r==null)return;let i=Math.max(0,Math.min(t.days-this.drag.duration,r-this.drag.grabOffsetDays));this.drag={...this.drag,moved:!0,targetResourceId:n.resourceId,targetStartIdx:i}}onBlockPointerUp(e){let t=this.drag;if(this.endDrag(),!t)return;if(!t.moved){this.selectActionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.selectActionId,parameters:{_blockId:e.id}},bubbles:!0,composed:!0}));return}if(!this.moveActionId||t.targetResourceId===t.originResourceId&&t.targetStartIdx===t.originStartIdx)return;let n=this.window();if(!n)return;let r=z.addDays(n.from,t.targetStartIdx),i=z.addDays(r,t.duration-1);this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.moveActionId,parameters:{_blockId:t.blockId,_resourceId:t.targetResourceId,_start:z.iso(r),_end:z.iso(i)}},bubbles:!0,composed:!0}))}endDrag(){this.drag=null,window.removeEventListener(`keydown`,this.onDragKeydown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`keydown`,this.onDragKeydown)}render(){let e=this.window();if(!e||!this.resources.length)return T``;let t=[...Array(e.days).keys()].map(t=>z.addDays(e.from,t)),n=new Date,r=z.daysBetween(e.from,new Date(n.getFullYear(),n.getMonth(),n.getDate())),i=r>=0&&r<e.days,a=[],o;return this.resources.forEach(n=>{n.group&&n.group!==o&&a.push(T`<div class="group">${n.group}</div>`),o=n.group,a.push(this.renderRow(n,e,t,i?r:null))}),T`
        ...
        `}};k([b({type:Array})],Qi.prototype,`resources`,void 0),k([b({type:Array})],Qi.prototype,`blocks`,void 0),k([b()],Qi.prototype,`from`,void 0),k([b()],Qi.prototype,`to`,void 0),k([b()],Qi.prototype,`moveActionId`,void 0),k([b()],Qi.prototype,`selectActionId`,void 0),k([w()],Qi.prototype,`drag`,void 0),Qi=z=k([_(`mateu-planning-board`)],Qi);var $i=e=>{let t=e.metadata;return T`
        <mateu-planning-board
                ...
                slot="${e.slot??y}"
        ></mateu-planning-board>
    `},ea=class extends x{constructor(...e){super(...e),this.columns=[]}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            font-size: var(--lumo-font-size-s, .875rem);
    ...
    `}clickCard(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{_clickedCard:e}},bubbles:!0,composed:!0}))}render(){return T`
        ...
        `}};k([b({type:Array})],ea.prototype,`columns`,void 0),ea=k([_(`mateu-kanban`)],ea);var ta=e=>T`
        <mateu-kanban
                ...
                slot="${e.slot??y}"
        ></mateu-kanban>
    `,na=class extends x{constructor(...e){super(...e),this.items=[]}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            font-size: var(--lumo-font-size-s, .875rem);
    ...
    `}clickItem(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{_clickedItem:e}},bubbles:!0,composed:!0}))}render(){return T`
        ...
        `}};k([b({type:Array})],na.prototype,`items`,void 0),na=k([_(`mateu-timeline`)],na);var ra=e=>T`
        <mateu-timeline
                ...
                slot="${e.slot??y}"
        ></mateu-timeline>
    `,ia=class extends x{constructor(...e){super(...e),this.steps=[],this.vertical=!1}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            font-size: var(--lumo-font-size-s, .875rem);
    ...
    `}updated(){let e=this.steps.length;if(e===0)return;let t=this.steps.findIndex(e=>e.status===`current`),n=this.steps.every(e=>e.status===`done`),r=t>=0?t+1:n?e:0;this.dispatchEvent(new CustomEvent(`mateu-guided-progress`,{detail:{current:r,total:e,steps:this.steps.map(e=>({id:e.id,title:e.title,status:e.status??`upcoming`}))},bubbles:!0,composed:!0}))}render(){return T`
        ...
        `}};k([b({type:Array})],ia.prototype,`steps`,void 0),k([b({type:Boolean,reflect:!0})],ia.prototype,`vertical`,void 0),ia=k([_(`mateu-progress-steps`)],ia);var aa=e=>{let t=e.metadata;return T`
        <mateu-progress-steps
                ...
                slot="${e.slot??y}"
        ></mateu-progress-steps>
    `},oa=class extends x{constructor(...e){super(...e),this.spark=[]}static{this.styles=g`
        :host {
            display: block;
        }
        .tile {
    ...
    `}sparkline(){let e=this.spark;if(!e||e.length<2)return y;let t=Math.min(...e),n=Math.max(...e)-t||1,r=80/(e.length-1),i=e.map((e,i)=>[2+i*r,2+26*(1-(e-t)/n)]),a=i.map(([e,t],n)=>`${n===0?`M`:`L`}${e.toFixed(1)} ${t.toFixed(1)}`).join(` `),o=`${a} L${i[i.length-1][0].toFixed(1)} 30 L${i[0][0].toFixed(1)} 30 Z`,s=this.trend===`down`?`var(--lumo-error-color, #e11d48)`:this.trend===`flat`?`var(--lumo-secondary-text-color, #888)`:`var(--lumo-success-color, #12b76a)`;return E`
        ...
        `}};k([b()],oa.prototype,`label`,void 0),k([b()],oa.prototype,`value`,void 0),k([b()],oa.prototype,`unit`,void 0),k([b()],oa.prototype,`delta`,void 0),k([b()],oa.prototype,`trend`,void 0),k([b({type:Array})],oa.prototype,`spark`,void 0),k([b()],oa.prototype,`actionId`,void 0),oa=k([_(`mateu-stat`)],oa);var sa=e=>{let t=e.metadata;return T`
        <mateu-stat
                label="${t.label??y}"
                value="${t.value??y}"
                unit="${t.unit??y}"
                ...
                slot="${e.slot??y}"
        ></mateu-stat>
    `},ca=class extends x{constructor(...e){super(...e),this.events=[]}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            font-size: var(--lumo-font-size-s, .875rem);
    ...
    `}clickEvent(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{_clickedEvent:e}},bubbles:!0,composed:!0}))}render(){let e=this.month?new Date(this.month+`T00:00:00`):new Date,t=e.getFullYear(),n=e.getMonth(),r=new Date(t,n,1),i=(r.getDay()+6)%7,a=new Date(t,n+1,0).getDate(),o=new Date,s=e=>o.getFullYear()===t&&o.getMonth()===n&&o.getDate()===e,c={};for(let e of this.events){if(!e.date)continue;let r=new Date(e.date+`T00:00:00`);r.getFullYear()===t&&r.getMonth()===n&&(c[r.getDate()]??=[]).push(e)}let l=[`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`,`Sun`],u=[];for(let e=0;e<i;e++)u.push(T`<div class="cell blank"></div>`);for(let e=1;e<=a;e++)u.push(T`
        ...
        `}};k([b()],ca.prototype,`month`,void 0),k([b({type:Array})],ca.prototype,`events`,void 0),ca=k([_(`mateu-calendar`)],ca);var la=e=>{let t=e.metadata;return T`
        <mateu-calendar
                month="${t.month??y}"
                .events="${t.events??[]}"
                style="${e.style??y}"
                ...
                slot="${e.slot??y}"
        ></mateu-calendar>
    `},ua=class extends x{constructor(...e){super(...e),this.plans=[]}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
        }
    ...
    `}cta(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){return T`
        ...
        `}};k([b({type:Array})],ua.prototype,`plans`,void 0),ua=k([_(`mateu-pricing-table`)],ua);var da=e=>T`
        <mateu-pricing-table
                ...
                slot="${e.slot??y}"
        ></mateu-pricing-table>
    `,fa=class extends x{static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            overflow-x: auto;
    ...
    `}clickNode(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{_clickedNode:e}},bubbles:!0,composed:!0}))}renderNode(e){let t=e.avatar,n=t&&(t.startsWith(`http`)||t.startsWith(`data:`));return T`
        ...
        `}render(){return this.root?T`<div class="tree"><ul>${this.renderNode(this.root)}</ul></div>`:T``}};k([b({attribute:!1})],fa.prototype,`root`,void 0),fa=k([_(`mateu-org-chart`)],fa);var pa=e=>T`
        <mateu-org-chart
                ...
                slot="${e.slot??y}"
        ></mateu-org-chart>
    `,ma=1440*60*1e3,ha=class extends x{constructor(...e){super(...e),this.cells=[]}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            overflow-x: auto;
    ...
    `}color(e,t){if(e<=0||t<=0)return`var(--lumo-contrast-10pct, #ebedf0)`;let n=e/t;return`color-mix(in srgb, var(--lumo-primary-color, #1a73e8) ${Math.round((n>.75?1:n>.5?.75:n>.25?.5:.3)*100)}%, transparent)`}render(){let e=this.cells.filter(e=>!!e.date);if(!e.length)return T``;let t=e.map(e=>new Date(e.date+`T00:00:00`).getTime()),n=Math.min(...t),r=Math.max(...t),i=new Date(n);i.setDate(i.getDate()-(i.getDay()+6)%7);let a={};for(let t of e)a[t.date]=t;let o=Math.max(...e.map(e=>e.value??0),1),s=[];for(let e=i.getTime();e<=r;e+=ma){let t=new Date(e),n=t.toISOString().slice(0,10),r=a[n],i=r?.value??0,c=(t.getDay()+6)%7+1,l=r?.label??`${n}: ${i}`;s.push(T`
        ...
        `}};k([b({type:Array})],ha.prototype,`cells`,void 0),ha=k([_(`mateu-heatmap`)],ha);var ga=e=>T`
        <mateu-heatmap
                ...
                slot="${e.slot??y}"
        ></mateu-heatmap>
    `,_a=class extends x{constructor(...e){super(...e),this.stages=[]}static{this.styles=g`
    ...
    `}render(){let e=this.stages;if(!e.length)return T``;let t=e[0].value??0,n=Math.max(...e.map(e=>e.value??0),1);return T`
        ...
        `}};k([b({type:Array})],_a.prototype,`stages`,void 0),_a=k([_(`mateu-funnel`)],_a);var va=e=>T`
        <mateu-funnel
                ...
                slot="${e.slot??y}"
        ></mateu-funnel>
    `,ya=class extends x{constructor(...e){super(...e),this.values=[],this.labels=[],this.area=!1}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
    ...
    `}render(){let e=this.values;if(!e||e.length<2)return T``;let t=Math.min(...e),n=Math.max(...e),r=n-t||1,i=584/(e.length-1),a=e.map((e,n)=>[8+n*i,8+144*(1-(e-t)/r)]),o=a.map(([e,t],n)=>`${n===0?`M`:`L`}${e.toFixed(1)} ${t.toFixed(1)}`).join(` `),s=`${o} L${a[a.length-1][0].toFixed(1)} 152 L${a[0][0].toFixed(1)} 152 Z`,c=this.color||`var(--lumo-primary-color, #1a73e8)`,l=e.indexOf(n),u=e.indexOf(t);return T`
        ...
        `}};k([b()],ya.prototype,`heading`,void 0),k([b({type:Array})],ya.prototype,`values`,void 0),k([b({type:Array})],ya.prototype,`labels`,void 0),k([b()],ya.prototype,`color`,void 0),k([b({type:Boolean})],ya.prototype,`area`,void 0),ya=k([_(`mateu-trend-chart`)],ya);var ba=e=>{let t=e.metadata;return T`
        <mateu-trend-chart
                heading="${t.title??y}"
                color="${t.color??y}"
                ?area="${t.area??!1}"
                ...
                slot="${e.slot??y}"
        ></mateu-trend-chart>
    `},xa=class extends x{constructor(...e){super(...e),this.features=[],this.columns=0}static{this.styles=g`
    ...
    `}clickFeature(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){return T`
        ...
        `}};k([b({type:Array})],xa.prototype,`features`,void 0),k([b({type:Number})],xa.prototype,`columns`,void 0),xa=k([_(`mateu-feature-grid`)],xa);var Sa=e=>{let t=e.metadata;return T`
        <mateu-feature-grid
                .features="${t.features??[]}"
                .columns="${t.columns??0}"
                style="${e.style??y}"
    ...
    `}stars(e){let t=Math.max(0,Math.min(5,e||0));return`★`.repeat(t)+`☆`.repeat(5-t)}render(){return T`
        ...
        `}};k([b({type:Array})],Ca.prototype,`items`,void 0),Ca=k([_(`mateu-testimonials`)],Ca);var wa=e=>T`
        <mateu-testimonials
                .items="${e.metadata.items??[]}"
                style="${e.style??y}"
                class="${e.cssClasses??y}"
                slot="${e.slot??y}"
        ></mateu-testimonials>
    `,Ta=class extends x{constructor(...e){super(...e),this.items=[],this.openSet=new Set,this.seeded=!1}static{this.styles=g`
    ...
    `}seed(){this.seeded||(this.seeded=!0,this.items.forEach((e,t)=>{e.open&&this.openSet.add(t)}))}toggle(e){this.openSet.has(e)?this.openSet.delete(e):this.openSet.add(e),this.requestUpdate()}render(){return this.seed(),T`
        ...
        `}};k([b({type:Array})],Ta.prototype,`items`,void 0),k([w()],Ta.prototype,`openSet`,void 0),Ta=k([_(`mateu-faq`)],Ta);var Ea=e=>T`
        <mateu-faq
                .items="${e.metadata.items??[]}"
                style="${e.style??y}"
                class="${e.cssClasses??y}"
                slot="${e.slot??y}"
        ></mateu-faq>
    `,Da=class extends x{static{this.styles=g`
        :host { display: block; width: 100%; }
        .callout {
    ...
    `}themeVars(){switch(this.theme){case`success`:return`--accent: var(--lumo-success-color, #12b76a); --bg: var(--lumo-success-color-10pct, rgba(18,183,106,.1));`;case`warning`:return`--accent: #f59e0b; --bg: rgba(245,158,11,.12);`;case`danger`:return`--accent: var(--lumo-error-color, #e11d48); --bg: var(--lumo-error-color-10pct, rgba(225,29,72,.1));`;default:return`--accent: var(--lumo-primary-color, #1a73e8); --bg: var(--lumo-primary-color-10pct, rgba(26,115,232,.1));`}}cta(){this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId},bubbles:!0,composed:!0}))}render(){return T`
        ...
        `}};k([b()],Da.prototype,`heading`,void 0),k([b()],Da.prototype,`description`,void 0),k([b()],Da.prototype,`icon`,void 0),k([b()],Da.prototype,`ctaLabel`,void 0),k([b()],Da.prototype,`actionId`,void 0),k([b()],Da.prototype,`theme`,void 0),Da=k([_(`mateu-callout-card`)],Da);var Oa=e=>{let t=e.metadata;return T`
        <mateu-callout-card
                heading="${t.title??y}"
                ...
                slot="${e.slot??y}"
        ></mateu-callout-card>
    `},ka=class extends x{constructor(...e){super(...e),this.comments=[]}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
    ...
    `}renderComment(e){let t=e.avatar&&(e.avatar.startsWith(`http`)||e.avatar.startsWith(`data:`));return T`
        ...
        `}render(){return T`<div class="thread">${this.comments.map(e=>this.renderComment(e))}</div>`}};k([b({type:Array})],ka.prototype,`comments`,void 0),ka=k([_(`mateu-comment-thread`)],ka);var Aa=e=>T`
        <mateu-comment-thread
                ...
                slot="${e.slot??y}"
        ></mateu-comment-thread>
    `,ja={pdf:`📕`,image:`🖼️`,img:`🖼️`,doc:`📘`,docx:`📘`,word:`📘`,xls:`📗`,xlsx:`📗`,excel:`📗`,sheet:`📗`,zip:`🗜️`,archive:`🗜️`,video:`🎬`,audio:`🎵`,code:`💻`,csv:`📄`,txt:`📄`},Ma=class extends x{constructor(...e){super(...e),this.files=[]}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
        .list {
            border: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1));
            border-radius: var(--lumo-border-radius-l, 12px);
        ...
        ${R}
    `}icon(e){return e&&ja[e.toLowerCase()]||`📄`}clickFile(e,t){e.url||e.actionId&&(t.preventDefault(),this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{_file:e}},bubbles:!0,composed:!0})))}render(){return T`
            <div class="list">
        ...
        `}};k([b({type:Array})],Ma.prototype,`files`,void 0),Ma=k([_(`mateu-file-list`)],Ma);var Na=e=>T`
        <mateu-file-list
                ...
                slot="${e.slot??y}"
        ></mateu-file-list>
    `,Pa=class extends x{constructor(...e){super(...e),this.items=[],this.localDone=new Map}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
    ...
    `}isDone(e,t){return this.localDone.has(t)?!!this.localDone.get(t):!!e.done}toggle(e,t){let n=!this.isDone(e,t);this.localDone.set(t,n),this.requestUpdate(),e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{_item:e,_done:n}},bubbles:!0,composed:!0}))}render(){let e=this.items.length,t=this.items.filter((e,t)=>this.isDone(e,t)).length,n=e>0?Math.round(t/e*100):0;return T`
            ...
            ${this.items.map((e,t)=>{let n=this.isDone(e,t);return T`
                ...
                `})}
        `}};k([b()],Pa.prototype,`heading`,void 0),k([b({type:Array})],Pa.prototype,`items`,void 0),k([w()],Pa.prototype,`localDone`,void 0),Pa=k([_(`mateu-checklist`)],Pa);var Fa=e=>{let t=e.metadata;return T`
        <mateu-checklist
                heading="${t.title??y}"
                .items="${t.items??[]}"
                style="${e.style??y}"
                ...
                slot="${e.slot??y}"
        ></mateu-checklist>
    `},Ia=class extends x{static{this.styles=g`
        :host { display: block; width: 100%; }
        .card {
            border: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1));
            border-radius: var(--lumo-border-radius-l, 14px);
    ...
    `}render(){let e=this.trend??`flat`;return T`
        ...
        `}};k([b()],Ia.prototype,`heading`,void 0),k([b()],Ia.prototype,`leftLabel`,void 0),k([b()],Ia.prototype,`leftValue`,void 0),k([b()],Ia.prototype,`rightLabel`,void 0),k([b()],Ia.prototype,`rightValue`,void 0),k([b()],Ia.prototype,`delta`,void 0),k([b()],Ia.prototype,`trend`,void 0),Ia=k([_(`mateu-comparison-card`)],Ia);var La=e=>{let t=e.metadata;return T`
...
`,za=new Intl.NumberFormat(`de-DE`,{minimumFractionDigits:2,maximumFractionDigits:2}),Ba=e=>Number.isFinite(e)?za.format(e):``,Va=(e,t)=>{let n=e<0?`-`:``,r=Ba(Math.abs(e));return t?`${n}${t} ${r}`:`${n}${r}`},Ha=(e,t)=>t?`${Ba(e)} ${t}`:Ba(e),Ua=class extends x{constructor(...e){super(...e),this.title=``,this.badges=[],this.facts=[]}static{this.styles=[Ra,g`
        :host { display: block; width: 100%; }
        .card {
            display: flex;
            align-items: stretch;
    ...
    `]}render(){let e=!!(this.metricLabel||this.metricValue||this.metricCaption);return T`
        ...
        `}};k([b()],Ua.prototype,`title`,void 0),k([b({type:Array})],Ua.prototype,`badges`,void 0),k([b()],Ua.prototype,`subtitle`,void 0),k([b({type:Array})],Ua.prototype,`facts`,void 0),k([b()],Ua.prototype,`metricLabel`,void 0),k([b()],Ua.prototype,`metricValue`,void 0),k([b()],Ua.prototype,`metricCaption`,void 0),Ua=k([_(`mateu-entity-header`)],Ua);var Wa=e=>{if(e.__hoistedToPageHeader)return T``;let t=e.metadata;return T`
        <mateu-entity-header
                .title="${t.title??``}"
                .badges="${t.badges??[]}"
                .subtitle="${t.subtitle}"
                ...
                slot="${e.slot??y}"
        ></mateu-entity-header>
    `},Ga=class extends x{constructor(...e){super(...e),this.value=0,this.max=0}static{this.styles=g`
        :host { display: block; width: 100%; }
    ...
    `}fillColor(){return this.dangerAt!=null&&this.value>=this.dangerAt?`error`:this.warnAt!=null&&this.value>=this.warnAt?`warning`:this.warnAt!=null||this.dangerAt!=null?`success`:`primary`}render(){let e=this.max>0?Math.min(Math.max(this.value/this.max,0),1):0,t=Math.round(e*100);return T`
            <div class="meter">
                ${this.label?T`<span class="label">${this.label}</span>`:y}
                <span class="value">${Ha(this.value,this.unit)}</span>
                <div class="track">
                    <div class="fill ${this.fillColor()}" style="width: ${t}%"></div>
                </div>
                <span class="caption">${this.caption?this.caption:`${t}%`}</span>
            </div>
        `}};k([b()],Ga.prototype,`label`,void 0),k([b({type:Number})],Ga.prototype,`value`,void 0),k([b({type:Number})],Ga.prototype,`max`,void 0),k([b()],Ga.prototype,`unit`,void 0),k([b()],Ga.prototype,`caption`,void 0),k([b({type:Number})],Ga.prototype,`warnAt`,void 0),k([b({type:Number})],Ga.prototype,`dangerAt`,void 0),Ga=k([_(`mateu-meter`)],Ga);var Ka=e=>{let t=e.metadata;return T`
        <mateu-meter
                .label="${t.label}"
                .value="${t.value??0}"
                .max="${t.max??0}"
                ...
                slot="${e.slot??y}"
        ></mateu-meter>
    `},qa=class extends x{constructor(...e){super(...e),this.total=0,this.done=0}static{this.styles=g`
        :host { display: block; width: 100%; }
        .banner {
    ...
    `}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){let e=this.total>0&&this.done>=this.total,t=!e&&!!this.actionLabel&&!!this.actionId;return T`
        ...
        `}};k([b()],qa.prototype,`label`,void 0),k([b({type:Number})],qa.prototype,`total`,void 0),k([b({type:Number})],qa.prototype,`done`,void 0),k([b()],qa.prototype,`actionLabel`,void 0),k([b()],qa.prototype,`actionId`,void 0),qa=k([_(`mateu-task-progress`)],qa);var Ja=e=>{let t=e.metadata;return T`
        <mateu-task-progress
                .label="${t.label}"
                .total="${t.total??0}"
                .done="${t.done??0}"
                ...
                slot="${e.slot??y}"
        ></mateu-task-progress>
    `},Ya=class extends x{constructor(...e){super(...e),this.items=[],this.compact=!1,this.frameless=!1,this.columns=0,this.itemHeadingLevel=3}static{this.styles=[Ra,R,g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
        .list {
            border: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1));
            border-radius: var(--lumo-border-radius-l, 12px);
    ...
    `]}runAction(e,t){t&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}rowClicked(e){this.rowActionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.rowActionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}renderItemAction(e,t,n,r){return!t||!n?y:r?T`
        ...
        `}};k([b({type:Array})],Ya.prototype,`items`,void 0),k([b({type:Boolean})],Ya.prototype,`compact`,void 0),k([b({type:Boolean})],Ya.prototype,`frameless`,void 0),k([b()],Ya.prototype,`rowActionId`,void 0),k([b({type:Number})],Ya.prototype,`columns`,void 0),k([b({type:Number})],Ya.prototype,`itemHeadingLevel`,void 0),Ya=k([_(`mateu-status-list`)],Ya);var Xa=e=>{let t=e.metadata;return T`
        <mateu-status-list
                .items="${t.items??[]}"
                ?compact="${t.compact??!1}"
                ...
                slot="${e.slot??y}"
        ></mateu-status-list>
    `},Za=class extends x{constructor(...e){super(...e),this.items=[]}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
        ul {
    ...
    `}render(){return T`
        ...
        `}};k([b({type:Array})],Za.prototype,`items`,void 0),Za=k([_(`mateu-bulleted-list`)],Za);var Qa=e=>T`
        <mateu-bulleted-list
                .items="${e.metadata.items??[]}"
                style="${e.style??y}"
                class="${e.cssClasses??y}"
                slot="${e.slot??y}"
        ></mateu-bulleted-list>
    `,$a=e=>{let t=e.metadata.attributes?.[`data-colspan`];return T`
        <hr style="border: none; border-top: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1)); width: 100%; margin: var(--lumo-space-s, .5rem) 0; ${e.style??``}"
            ...
            data-colspan="${C(t)}"
            slot="${e.slot??y}"/>
    `},eo=new Map,to=e=>eo.get(e),no=(e,t)=>t!=null&&e!=null&&!e.has(t),ro=typeof HTMLElement<`u`?HTMLElement:class{},io=class extends ro{static get observedAttributes(){return[`type`,`renderer`]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){let e=this.getAttribute(`type`)??`unknown`,t=this.getAttribute(`renderer`)??`unknown`;this.shadowRoot||this.attachShadow({mode:`open`}),this.shadowRoot.innerHTML=`
            <style>
                :host { display: block; }
                .mateu-unsupported {
                    box-sizing: border-box;
        ...
        `}};typeof customElements<`u`&&!customElements.get(`mateu-unsupported`)&&customElements.define(`mateu-unsupported`,io);var ao=new Set,oo=(e,t,n)=>{let r=`${n}/${t}`;return ao.has(r)||(ao.add(r),console.warn(`[mateu] Component type "${t}" is not supported by the "${n}" renderer — rendering <mateu-unsupported> placeholder.`)),T`<mateu-unsupported
            type="${t}"
            renderer="${n}"
            data-component-id="${e?.id??y}"
            slot="${e?.slot??y}"
    ></mateu-unsupported>`},so=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.children?.map(t=>P(e,t,n,r,i,a,o,!1))??[],l=to(s.name);return l?l(s.props??{},c):oo(t,`${j.CustomComponent}:${s.name}`,`custom-component-registry`)},co={info:`ℹ`,success:`✓`,warning:`!`,danger:`!`},B=class extends x{constructor(...e){super(...e),this.text=``,this.theme=`info`,this.noIcon=!1,this.slim=!1,this.fullWidth=!1,this.hasContent=!1,this.inlineContent=!1}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
        .notice {
            display: flex;
            align-items: center;
    ...
    `}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId},bubbles:!0,composed:!0}))}render(){let e=!!this.text&&!!this.text.trim();if(!e&&!this.hasContent)return T``;let t=[`info`,`success`,`warning`,`danger`].includes(this.theme)?this.theme:`info`;return T`
            <div class="notice ${t} ${this.slim?`slim`:``}">
                ${this.noIcon?y:T`<span class="icon ${this.icon?`custom`:``}">${this.icon||co[t]}</span>`}
        ...
        `}};k([b()],B.prototype,`text`,void 0),k([b()],B.prototype,`theme`,void 0),k([b()],B.prototype,`icon`,void 0),k([b({type:Boolean})],B.prototype,`noIcon`,void 0),k([b()],B.prototype,`actionLabel`,void 0),k([b()],B.prototype,`actionId`,void 0),k([b()],B.prototype,`status`,void 0),k([b({type:Boolean})],B.prototype,`slim`,void 0),k([b({type:Boolean})],B.prototype,`fullWidth`,void 0),k([b({type:Boolean})],B.prototype,`hasContent`,void 0),k([b({type:Boolean})],B.prototype,`inlineContent`,void 0),B=k([_(`mateu-notice`)],B);var lo=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=Wt(s.text??``,r,i,a,o)??``,l=t.children??[];return T`
        <mateu-notice
                text="${c}"
                theme="${s.theme??`info`}"
    ...
    `},uo=class extends x{constructor(...e){super(...e),this.groups=[]}static{this.styles=[Ra,R,g`
        :host { display: block; width: 100%; }
    ...
    `]}willUpdate(e){e.has(`groups`)&&(this.selectedId=this.groups.flatMap(e=>e.items??[]).find(e=>e.selected)?.id)}itemAction(e,t,n){e.stopPropagation(),t&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t,parameters:{_item:n}},bubbles:!0,composed:!0}))}select(e){this.selectedId=e,this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{_item:e}},bubbles:!0,composed:!0}))}render(){return T`
        ...
        `}};k([b()],uo.prototype,`actionId`,void 0),k([b({type:Array})],uo.prototype,`groups`,void 0),k([w()],uo.prototype,`selectedId`,void 0),uo=k([_(`mateu-task-queue`)],uo);var fo=e=>{let t=e.metadata;return T`
        <mateu-task-queue
                .actionId="${t.actionId}"
                .groups="${t.groups??[]}"
                style="${e.style??y}"
                ...
                slot="${e.slot??y}"
        ></mateu-task-queue>
    `},po=class extends x{constructor(...e){super(...e),this.columns=0,this.items=[]}static{this.styles=[Ra,R,g`
    ...
    `]}willUpdate(e){e.has(`items`)&&(this.selectedId=this.items.find(e=>e.selected)?.id)}select(e){e.disabled||(this.selectedId=e.id,this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{_item:e.id}},bubbles:!0,composed:!0})))}render(){return T`
        ...
        `}};k([b()],po.prototype,`actionId`,void 0),k([b({type:Number})],po.prototype,`columns`,void 0),k([b()],po.prototype,`recommendedLabel`,void 0),k([b({type:Array})],po.prototype,`items`,void 0),k([w()],po.prototype,`selectedId`,void 0),po=k([_(`mateu-resource-grid`)],po);var mo=e=>{let t=e.metadata;return T`
        <mateu-resource-grid
                .actionId="${t.actionId}"
                .columns="${t.columns??0}"
    ...
    `}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return T`
        ...
        <mateu-offer-card
                ...
                slot="${e.slot??y}"
        ></mateu-offer-card>
    `},go=class extends x{constructor(...e){super(...e),this.items=[],this.added=new Set}static{this.styles=g`
        :host { display: block; width: 100%; }
    ...
    `}willUpdate(e){e.has(`items`)&&(this.added=new Set(this.items.filter(e=>e.added).map(e=>e.id)))}total(){return this.items.filter(e=>e.id!=null&&this.added.has(e.id)).reduce((e,t)=>e+(t.price??0),0)}toggle(e){if(e.id==null)return;let t=new Set(this.added),n=!t.has(e.id);n?t.add(e.id):t.delete(e.id),this.added=t,this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{_item:e.id,_added:n,_total:this.total()}},bubbles:!0,composed:!0}))}render(){return T`
        ...
        `}};k([b()],go.prototype,`totalLabel`,void 0),k([b()],go.prototype,`currency`,void 0),k([b()],go.prototype,`actionId`,void 0),k([b({type:Array})],go.prototype,`items`,void 0),k([w()],go.prototype,`added`,void 0),go=k([_(`mateu-addon-picker`)],go);var _o=e=>{let t=e.metadata;return T`
        <mateu-addon-picker
                ...
                slot="${e.slot??y}"
        ></mateu-addon-picker>
    `},vo=class extends x{constructor(...e){super(...e),this.lines=[]}static{this.styles=g`
        :host {
    ...
    `}computedTotal(){return this.total==null?this.lines.filter(e=>!e.included).reduce((e,t)=>e+(t.amount??0),0):this.total}render(){return T`
        ...
        `}};k([b()],vo.prototype,`currency`,void 0),k([b()],vo.prototype,`totalLabel`,void 0),k([b({type:Array})],vo.prototype,`lines`,void 0),k([b({type:Number})],vo.prototype,`total`,void 0),vo=k([_(`mateu-ledger`)],vo);var yo=e=>{let t=e.metadata;return T`
        <mateu-ledger
                .currency="${t.currency}"
                .totalLabel="${t.totalLabel}"
                .lines="${t.lines??[]}"
                ...
                slot="${e.slot??y}"
        ></mateu-ledger>
    `},bo=class extends x{constructor(...e){super(...e),this.methods=[]}static{this.styles=g`
        :host { display: block; width: 100%; }
    ...
    `}willUpdate(e){e.has(`selected`)&&(this.selectedId=this.selected)}confirm(){this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{_method:this.selectedId}},bubbles:!0,composed:!0}))}pick(e){this.selectedId=e,this.methodActionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.methodActionId,parameters:{_method:e}},bubbles:!0,composed:!0}))}render(){return T`
        ...
        `}};k([b()],bo.prototype,`actionId`,void 0),k([b()],bo.prototype,`methodActionId`,void 0),k([b({type:Array})],bo.prototype,`methods`,void 0),k([b()],bo.prototype,`selected`,void 0),k([b()],bo.prototype,`contextLabel`,void 0),k([b()],bo.prototype,`contextValue`,void 0),k([b()],bo.prototype,`confirmLabel`,void 0),k([w()],bo.prototype,`selectedId`,void 0),bo=k([_(`mateu-payment-picker`)],bo);var xo=e=>{let t=e.metadata;return T`
    ...
    `}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return T`
        ...
        `}};k([b({type:Array})],So.prototype,`items`,void 0),So=k([_(`mateu-process-monitor`)],So);var Co=e=>T`
        <mateu-process-monitor
                ...
                slot="${e.slot??y}"
        ></mateu-process-monitor>
    `,wo=(e,t)=>{let n=e.style;return e.id&&(n&&!n.endsWith(`;`)&&(n+=`;`),n??=``,t[e.id+`.hidden`]==1&&(n+=`display: none;`)),n},To=(e,t)=>{let n={...e.metadata};if(e.id&&n){if(n.type==j.Button){let r=n;t[e.id+`.disabled`]==1&&(r.disabled=!0)}if(n.type==j.FormField){let r=n;t[e.id+`.disabled`]==1&&(r.disabled=!0)}}return n},H=e=>t=>e(t.container,t.component,t.baseUrl,t.state,t.data,t.appState,t.appData),Eo={[j.Bpmn]:({component:e})=>Mi(e),[j.Workflow]:({component:e})=>Pi(e),[j.FormEditor]:({component:e})=>Fi(e),[j.Page]:H(Ai),[j.Div]:H(Ci),[j.Directory]:({component:e,baseUrl:t,state:n,data:r})=>xi(e,t,n,r),[j.FormLayout]:H(ar),[j.HorizontalLayout]:H(dr),[j.VerticalLayout]:H(fr),[j.SplitLayout]:H(pr),[j.MasterDetailLayout]:H(mr),[j.TabLayout]:H(hr),[j.AccordionLayout]:H(gr),[j.BoardLayout]:H(xr),[j.BoardLayoutRow]:H(Sr),[j.BoardLayoutItem]:H(Cr),[j.Scroller]:H(vr),[j.FullWidth]:H(yr),[j.Container]:H(br),[j.Form]:({container:e,component:t,baseUrl:n,state:r,data:i,appState:a,appData:o})=>{let s=t.metadata;return T`<mateu-form
            id="${t.id}"
        baseUrl="${n}"
            .component="${t}"
            .values="${r}"
...
`)}
            ...
            </mateu-form>`},[j.Table]:({component:e,state:t,data:n})=>Dr(e,(e.id?n?.[e.id]:void 0)?.page?.content??Or(e,t)),[j.Crud]:H(ji),[j.App]:({container:e,component:t,baseUrl:n,state:r,data:i,appState:a,appData:o})=>T`
            <mateu-app
                        id="${t.id}"
                        baseUrl="${n}"
                        .component="${t}"
            ...
            >
             ${t.children?.map(t=>P(e,t,n,r,i,a,o))}
         </mateu-app>`,[j.Element]:({container:e,component:t,state:n,data:r,appState:i,appData:a})=>Br(e,t.metadata,t,n,r,i,a),[j.FormField]:({component:e,state:t})=>Oi(e,t),[j.Text]:({component:e,state:t,data:n,appState:r,appData:i})=>Hr(e,t,n,r,i),[j.Avatar]:({component:e,state:t,data:n})=>Xt(e,t,n),[j.Chat]:({component:e,state:t,data:n})=>Ni(e,t,n),[j.AvatarGroup]:({component:e})=>Qt(e),[j.Badge]:({component:e,state:t,data:n})=>$t(e,t,n),[j.Breadcrumbs]:({component:e})=>yi(e),[j.Anchor]:({component:e})=>Ur(e),[j.Button]:({component:e,state:t,data:n})=>Zr(e,t,n),[j.Card]:H($r),[j.Chart]:({component:e})=>ei(e),[j.Icon]:({component:e})=>ti(e),[j.ConfirmDialog]:H(oi),[j.ContextMenu]:H(Mr),[j.CookieConsent]:({component:e})=>si(e),[j.Details]:H(ci),[j.Dialog]:({component:e,baseUrl:t,state:n,data:r,appState:i,appData:a})=>li(e,t,n,r,i,a),[j.Drawer]:({component:e,baseUrl:t,state:n,data:r,appState:i,appData:a})=>ui(e,t,n,r,i,a),[j.Image]:({component:e})=>vi(e),[j.Map]:({component:e})=>_i(e),[j.Markdown]:({component:e})=>pi(e),[j.MicroFrontend]:({component:e})=>fi(e),[j.Notification]:({component:e})=>mi(e),[j.ProgressBar]:({component:e,state:t})=>hi(e,t),[j.Popover]:H(gi),[j.CarouselLayout]:H(bi),[j.Tooltip]:H(Fr),[j.MessageInput]:({component:e})=>Pr(e),[j.MessageList]:({component:e})=>kr(e),[j.CustomField]:H(Nr),[j.MenuBar]:({container:e,component:t,baseUrl:n,state:r,data:i})=>jr(e,t,n,r,i),[j.Grid]:({component:e,state:t})=>Dr(e,Or(e,t)),[j.VirtualList]:H(wr),[j.FormSection]:H(wi),[j.FormSubSection]:H(Ti),[j.MetricCard]:({component:e})=>Bi(e),[j.Scoreboard]:H(Vi),[j.DashboardPanel]:H(Hi),[j.DashboardLayout]:H(Ui),[j.ResponsiveGrid]:H(Ki),[j.FoldoutLayout]:H(Gi),[j.ContentLayout]:H(qi),[j.HeroSection]:H(Ji),[j.EmptyState]:({component:e})=>gn(e),[j.Skeleton]:({component:e})=>_n(e),[j.Gantt]:({component:e})=>Zi(e),[j.PlanningBoard]:({component:e})=>$i(e),[j.Kanban]:({component:e})=>ta(e),[j.Timeline]:({component:e})=>ra(e),[j.ProgressSteps]:({component:e})=>aa(e),[j.Stat]:({component:e})=>sa(e),[j.Calendar]:({component:e})=>la(e),[j.PricingTable]:({component:e})=>da(e),[j.OrgChart]:({component:e})=>pa(e),[j.Heatmap]:({component:e})=>ga(e),[j.Funnel]:({component:e})=>va(e),[j.TrendChart]:({component:e})=>ba(e),[j.FeatureGrid]:({component:e})=>Sa(e),[j.Testimonials]:({component:e})=>wa(e),[j.Faq]:({component:e})=>Ea(e),[j.CalloutCard]:({component:e})=>Oa(e),[j.CommentThread]:({component:e})=>Aa(e),[j.FileList]:({component:e})=>Na(e),[j.Checklist]:({component:e})=>Fa(e),[j.ComparisonCard]:({component:e})=>La(e),[j.EntityHeader]:({component:e})=>Wa(e),[j.Meter]:({component:e})=>Ka(e),[j.TaskProgress]:({component:e})=>Ja(e),[j.StatusList]:({component:e})=>Xa(e),[j.BulletedList]:({component:e})=>Qa(e),[j.Separator]:({component:e})=>$a(e),[j.CustomComponent]:H(so),[j.Notice]:H(lo),[j.TaskQueue]:({component:e})=>fo(e),[j.ResourceGrid]:({component:e})=>mo(e),[j.OfferCard]:({component:e})=>ho(e),[j.AddOnPicker]:({component:e})=>_o(e),[j.Ledger]:({component:e})=>yo(e),[j.PaymentPicker]:({component:e})=>xo(e),[j.ProcessMonitor]:({component:e})=>Co(e)},Do=(e,t,n,r,i,a,o,s)=>{if(!t?.metadata)return t==null?(console.warn(`No metadata for component`,t),T`<p>No metadata for component</p>`):Do(e,{id:se(),metadata:t,type:A.ClientSide},n,r,i,a,o,s);let c=t.metadata.type,l={...t,style:wo(t,i),metadata:To(t,i)},u=Eo[c];return u?u({container:e,component:l,baseUrl:n,state:r,data:i,appState:a,appData:o,labelAlreadyRendered:s}):T`<p ${l?.slot??y}>Unknown metadata type ${c} for component ${l?.id}</p>`},Oo=function(e){return e.NONE=`NONE`,e.INFO=`INFO`,e.SUCCESS=`SUCCESS`,e.WARNING=`WARNING`,e.DANGER=`DANGER`,e}({}),ko=(e,t,n)=>{let r=e[n.path];return r?T`<span theme="badge pill ${Ao(r.type)}">${r.message}</span>`:T``},Ao=e=>{switch(e){case Oo.SUCCESS:return`success`;case Oo.WARNING:return`warning`;case Oo.DANGER:return`error`;case Oo.NONE:return`contrast`}return``},U=class extends x{constructor(...e){super(...e),this.id=``,this.baseUrl=``,this.state={},this.data={},this.appState={},this.appData={},this.respondToVisibility=(e,t)=>{var n={root:document.documentElement};new IntersectionObserver(e=>{e.forEach(e=>{t(e.intersectionRatio>0)})},n).observe(e)},this.keepAsking=!1,this.askToUpper=()=>{let e=this.data[this.id]?.page,t=e?.content?.length/e?.pageSize;this.dispatchEvent(new CustomEvent(`fetch-more-elements`,{detail:{params:{page:t,pageSize:this.metadata?.pageSize},callback:()=>{this.keepAsking&&this.askToUpper()}},bubbles:!0,composed:!0}))},this.renderItem=e=>e.card?Do(this,e.card,this.baseUrl,this.state,this.data,this.appState,this.appData,!1):e.title?T`<div class="neutral-card">
                ${e.image?T`<img class="card-media" src="${e.image}" alt="" />`:y}
                <div class="card-body">
                    <div class="card-head">
                        ${e.title?T`<span class="card-title">${e.title}</span>`:y}
                        ${e.status?T`<span theme="badge ${Ao(e.status.type)}">${e.status.message}</span>`:y}
                    </div>
        ...
        `}get cols(){return(this.effectiveComponent?.metadata)?.columns?.map(e=>e.metadata)??[]}get identifierFieldName(){let e=this.cols.find(e=>e.identifier);return e?e.id:this.cols.find(e=>e.id===`id`)?.id}get effectiveGridLayout(){let e=this.component?.metadata,t=e?.gridLayout??`auto`;return t===`auto`?e?.crudlType===`card`?`cards`:`table`:t}scheduleMeasure(){this.pendingMeasure=!0,this.corrections=0,this.requestUpdate()}measureFill(){if(!this.pendingMeasure)return;let e=this.renderRoot?.querySelector?.(`[data-crud-box]`);if(!e)return;if(this.closest?.(`mateu-dialog, mateu-drawer`)){this.pendingMeasure=!1;return}let t=e.style.height;t&&(e.style.height=``);let n=e.getBoundingClientRect().top,r=Math.round(window.innerHeight-n-this.measureBottomInset(e)-W.BOTTOM_GUTTER_PX);t&&(e.style.height=t);let i=this.lastMeasuredTop==null,a=!i&&Math.abs(n-this.lastMeasuredTop)>=2;if(r>=W.MIN_FILL_PX){if(a&&this.retryMeasure(n))return;this.pendingMeasure=!1,this.unsettledRefusals=0,this.lastMeasuredTop=n,this.fillHeightPx=r;return}!(!i&&!a)&&this.retryMeasure(n)||(this.lastMeasuredTop=n,this.pendingMeasure=!1,this.unsettledRefusals=0,this.fillHeightPx=void 0)}retryMeasure(e){return this.unsettledRefusals>=W.MAX_UNSETTLED_REFUSALS?!1:(this.lastMeasuredTop=e,this.unsettledRefusals++,this.requestUpdate(),!0)}trimOverflow(){if(this.fillHeightPx==null||this.pendingMeasure||this.corrections>=W.MAX_CORRECTIONS)return;let e=document.documentElement.scrollHeight-window.innerHeight;e<=1||e>W.MAX_SLIVER_PX||(this.corrections++,this.fillHeightPx=Math.max(W.MIN_FILL_PX,this.fillHeightPx-e))}measureBottomInset(e){let t=e,n=0,r=e.getBoundingClientRect().bottom;for(let e=0;t&&e<20;e++){n+=parseFloat(getComputedStyle(t).marginBottom)||0;let e=t.getRootNode(),i=t.assignedSlot??t.parentElement??e.host??null;if(!i||i===document.documentElement||i===document.body)break;let a=getComputedStyle(i);n+=(parseFloat(a.paddingBottom)||0)+(parseFloat(a.borderBottomWidth)||0);let o=parseFloat(a.rowGap)||0;for(let e=t.nextElementSibling;e;e=e.nextElementSibling){let t=e.getBoundingClientRect();if(t.top<r-1)continue;let i=getComputedStyle(e);n+=t.height+(parseFloat(i.marginTop)||0)+(parseFloat(i.marginBottom)||0)+o}t=i}return Math.round(n)}static{this.BOTTOM_GUTTER_PX=16}static{this.MAX_SLIVER_PX=64}static{this.MAX_CORRECTIONS=3}static{this.MAX_UNSETTLED_REFUSALS=4}static{this.MIN_FILL_PX=320}boxStyle(){let e=`border: var(--mateu-section-border, none); background: var(--mateu-section-bg, transparent); overflow: hidden; padding: var(--mateu-section-padding, 0); display: flex; flex-direction: column;`;return this.fillHeightPx==null?`${e} max-height: calc(100dvh - 12rem);`:`${e} height: ${this.fillHeightPx}px;`}connectedCallback(){super.connectedCallback(),window.addEventListener(`resize`,this.windowResizeListener),this.resizeObserver=new ResizeObserver(e=>{let t=e[0]?.contentRect.width;t&&Math.abs(t-this.availableWidthPx)>10&&(this.availableWidthPx=t)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.loadingTimer),window.removeEventListener(`resize`,this.windowResizeListener),this.resizeObserver?.disconnect()}static{this.LOADING_VALVE_MS=15e3}get awaitingRows(){return this.loadingSince!=null&&Date.now()-this.loadingSince<W.LOADING_VALVE_MS}beginLoading(){this.loadingSince=Date.now(),clearTimeout(this.loadingTimer),this.loadingTimer=setTimeout(()=>this.requestUpdate(),W.LOADING_VALVE_MS)}endLoading(){this.loadingSince=void 0,clearTimeout(this.loadingTimer)}_filterIds(e){return new Set([`searchText`,...(e.filters??[]).flatMap(e=>e.stereotype===`dateRange`||e.stereotype===`numberRange`?[`${e.fieldId}_from`,`${e.fieldId}_to`]:[e.fieldId])])}_syncStateToUrl(e){let t=this._filterIds(e),n=new URLSearchParams(window.location.search);t.forEach(e=>n.delete(e)),n.delete(`page`),n.delete(`sort`),t.forEach(e=>{let t=this.state[e];t!=null&&t!==``&&n.set(e,String(t))});let r=this.state.page;r&&r>0&&n.set(`page`,String(r));let i=this.state.sort;if(i&&i.length>0){let e=i.filter(e=>e.fieldId&&e.direction).map(e=>`${e.fieldId}:${e.direction}`).join(`,`);e&&n.set(`sort`,e)}let a=n.toString(),o=a?`${window.location.pathname}?${a}`:window.location.pathname;window.location.pathname+window.location.search!==o&&history.replaceState(null,``,o)}_initStateFromUrl(e,t){let n=new URLSearchParams(window.location.search),r=this._filterIds(e),i={...t};n.forEach((e,t)=>{r.has(t)&&(i[t]=e)});let a=n.get(`page`);if(a!==null){let e=parseInt(a,10);!isNaN(e)&&e>0&&(i.page=e)}let o=n.get(`sort`);if(o){let e=o.split(`,`).map(e=>{let[t,n]=e.split(`:`);return t&&n?{fieldId:t,direction:n}:null}).filter(Boolean);e.length>0&&(i.sort=e)}return i}pageChanged(e){this.state={...this.state,page:e.detail.page},this.handleSearchRequested(void 0)}static _initKeyOf(e){if(!e)return;let t=e.metadata?.rowsSource;return`${e.id}|${t?t.ref??t.url??``:``}`}willUpdate(e){if(super.willUpdate(e),!e.has(`data`)||this.data?.[this.id]!=null)return;let t=this._restRows;!t||t.key!==W._initKeyOf(this.component)||(this.data={...this.data,[this.id]:t.listing})}updated(e){if(super.updated(e),e.has(`component`)?this.scheduleMeasure():(this.measureFill(),this.trimOverflow()),this.data?.[this.id]==null?this.loadingSince==null&&this._initializedForKey!=null&&!this.awaitingRows&&this.beginLoading():this.endLoading(),e.has(`component`)){let e=W._initKeyOf(this.component),t=this.component?.metadata;if(e!==this._initializedForKey){this._initializedForKey=e;let n=t.initialPage&&t.initialPage>0?t.initialPage:0;this.state=this._initStateFromUrl(t,{...this.state,size:t.pageSize,page:n,sort:[]}),(this.state.page!==n||this.state.sort?.length>0||[...this._filterIds(t)].some(e=>this.state[e]!=null)||t.rowsSource)&&this.handleSearchRequested(void 0)}else{let e=this._restoreUrlFiltersIfMissing(t,this.state);e!==this.state&&(this.state=e)}}}_restoreUrlFiltersIfMissing(e,t){let n=new URLSearchParams(window.location.search),r=this._filterIds(e),i=t;return n.forEach((e,n)=>{if(!r.has(n))return;let a=i[n];(a==null||a===``)&&(i===t&&(i={...t}),i[n]=e)}),i}render(){let e=e=>N.get()?.renderToolbarButton?.(e,this.evalLabel(e.label),()=>this.handleToolbarButtonClick(e))||T`
            ...
            `;if(!this.component)return T`no component`;let t=this.effectiveComponent,n=t.metadata;n.serverSideOrdering=!0;let r=(()=>{let e=this;for(;e;){let t=e;if(t.tagName===`MATEU-PAGE`)return(t.component?.metadata?.toolbar?.length??0)>0;e=t.parentElement??(t.getRootNode?.()instanceof ShadowRoot?t.getRootNode().host:null)}return!1})()?[]:n?.toolbar??[],i=r.filter(e=>an(e.actionId)&&!nn(e.actionId)),a=r.filter(e=>nn(e.actionId)),o=r.filter(e=>!an(e.actionId)),s=i.length>0&&o.length>0,c=!!n?.title||!!n?.subtitle||r.length>0,l=this.effectiveGridLayout,u=this.cols,d=Po(u),f=this.data[this.id]?.page?.content??[],p=this.state[this.component?.id]?.emptyStateMessage,m=(e,t)=>{let n=t[e.id];return n==null?T``:e.dataType===`status`?T`<span theme="badge pill ${Ao(n.type)}">${n.message}</span>`:e.dataType===`bool`?T`${n?`✓`:`✗`}`:typeof n==`object`?T`${n.label??n.name??n.message??``}`:T`${n}`},h=()=>{let e=this.identifierFieldName,t=this.state._selectedId??this.appState?._splitDetailId,n=d.find(e=>e.identifier)??d[0],r=e=>e.dataType===`action`||e.dataType===`actionGroup`||e.dataType===`menu`||e.stereotype===`button`,i=d.filter(e=>e!==n&&!r(e)),a=u.filter(e=>r(e)),o=(e,t,n)=>{e.stopPropagation(),e.currentTarget.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t,parameters:{_clickedRow:n}},bubbles:!0,composed:!0}))},s=e=>{let t=[];for(let n of a){let r=e[n.id];if(n.dataType===`action`){let i=r?.methodNameInCrud?r:e.action?.methodNameInCrud?e.action:{methodNameInCrud:n.id,label:n.label,icon:null,disabled:!1};t.push(T`
                ...
                <div class="m-listbox" style="width: 100%;">
                    ${f.length===0?T`<div class="m-item" disabled>${hn(p)}</div>`:y}
                    ${f.map(r=>T`
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: var(--lumo-space-m); padding: var(--lumo-space-s) 0;">
                    ${f.length===0?T`<div style="grid-column: 1 / -1;">${hn(p)}</div>`:y}
                    ${f.map(n=>T`
                    ...
                    `)}
                </div>`},g=()=>{let e=Fo(u),t=e.find(e=>e.identifier)??e[0],n=e.filter(e=>e!==t);return T`
            ...
            `;return T`
                <table class="crud-table">
                    ...
                    <tbody>
                        ${o.length===0?T`<tr><td colspan="99" style="padding: 1.5rem; text-align: center; color: var(--lumo-secondary-text-color, #888);">${hn(p)}</td></tr>`:y}
                        ${o.map(e=>c(e,0))}
                    </tbody>
    ...
    `}};k([b()],G.prototype,`component`,void 0),k([b()],G.prototype,`baseUrl`,void 0),k([b({type:Boolean})],G.prototype,`standalone`,void 0),k([b()],G.prototype,`state`,void 0),k([b()],G.prototype,`data`,void 0),k([b()],G.prototype,`appState`,void 0),k([b()],G.prototype,`appData`,void 0),k([w()],G.prototype,`showImportDialog`,void 0),k([w()],G.prototype,`availableWidthPx`,void 0),k([w()],G.prototype,`selectedItem`,void 0),k([w()],G.prototype,`_columnPrefsRevision`,void 0),k([w()],G.prototype,`fillHeightPx`,void 0),k([w()],G.prototype,`loadingSince`,void 0),G=W=k([_(`mateu-table-crud`)],G);var Lo=function(e){return e.OnLoad=`OnLoad`,e.OnSuccess=`OnSuccess`,e.OnError=`OnError`,e.OnValueChange=`OnValueChange`,e.OnCustomEvent=`OnCustomEvent`,e.AutoSave=`AutoSave`,e}({}),Ro=class extends Bt{constructor(...e){super(...e),this.state={},this.data={},this._locallyEdited=new Set,this.appData={},this.appState={},this.triggerOnLoad=()=>{let e=this.component;this.registerCustomEventListeners(),e.triggers?.filter(e=>e.type==Lo.OnLoad).forEach(e=>{if((!e.condition||this._evalExpr(e.condition))&&!e.triggered){let n=e;n.triggered=!0;var t=n.times-1;n.timeoutMillis>0?this.scheduleOnload(n,t,this.id):this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:n.actionId,background:n.background},bubbles:!0,composed:!0}))}})},this.scheduleOnload=(e,t,n)=>{if(n!=this.component?.id)return;let r=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,background:e.background,callbackToken:r},bubbles:!0,composed:!0}))},e.timeoutMillis)},this._registeredCustomEventListeners=[],this.customEventManager=e=>{if(!(e instanceof CustomEvent))return;let t=e,n=(this.component.triggers??[]).filter(e=>e.type==Lo.OnCustomEvent).filter(e=>e.eventName==t.type).filter(e=>e.source!==`COMPONENT`||t.detail?.__source===e.from);n.length!==0&&(n.some(e=>!e.source||e.source===`SELF`)&&(e.stopPropagation(),e.preventDefault()),n.forEach(e=>{(!e.condition||this._evalExpr(e.condition))&&this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:t.detail},bubbles:!0,composed:!0}))}))}}_interpolationExtra(){return{appState:this.appState??{},appData:this.appData??{},component:this.component}}_evalExpr(e){return Kt(e,this.state??{},this.data??{},this._interpolationExtra())}_evalTemplate(e){return qt(e,this.state??{},this.data??{},this._interpolationExtra())}isOverlayChild(e){let t=e?.metadata?.type;return t==j.Drawer||t==j.Dialog}removeSelfFromOwnerChildren(){let e=this.component;if(!e)return!1;let t=t=>{if(t===e)return!0;let n=t;return e.id!=null&&n?.id==e.id&&this.isOverlayChild(n)},n=this.parentNode;for(;n;){let e=n instanceof ShadowRoot?n.host:n,r=e.component?.children;if(Array.isArray(r)){let n=r.findIndex(t);if(n>=0)return r.splice(n,1),e.requestUpdate?.(),!0}n=n instanceof ShadowRoot?e:n.parentNode}return!1}applyFragment(e){if(this.id==e.targetComponentId){if(e.component)if(We.Add==e.action){if(this.component){let t=this.component.children??(this.component.children=[]),n=e.component.id?t.findIndex(t=>t.id==e.component.id&&this.isOverlayChild(t)):-1;n>=0?(t[n]=e.component,this.component={...this.component}):t.push(e.component)}}else{this.callbackToken=se();let t=!1;if(e.component?.type==A.ServerSide)if(this.component){let n=this.component,r=e.component;t=n.serverSideType==r.serverSideType;let i=t?(n.children??[]).filter(e=>this.isOverlayChild(e)):[];n.actions=r.actions,n.type=r.type,n.rules=r.rules,n.triggers=r.triggers,n.serverSideType=r.serverSideType,n.route=r.route,n.initialData=r.initialData,n.validations=r.validations,n.cssClasses=r.cssClasses,n.slot=r.slot,n.style=r.style,n.children=i.length?[...r.children??[],...i]:r.children,(n.serverSideType!=r.serverSideType||n.id!=r.id)&&setTimeout(()=>this.triggerOnLoad())}else this.component=e.component,setTimeout(()=>this.triggerOnLoad());else{let t=[e.component];this.component&&(this.component.children=t)}e.action!==We.ReplaceKeepData&&!t&&(this.state={},this.data={},this._locallyEdited.clear())}e.state&&(Object.keys(e.state).forEach(e=>this._locallyEdited.delete(e)),this.state={...this.state,...e.state});let t=this._lastOwnState,n=this.state;if(t&&this._locallyEdited.forEach(r=>{!(e.state!=null&&r in e.state)&&n[r]!==t[r]&&(n={...n,[r]:t[r]})}),this._lastOwnState=n,e.data){for(let t in e.data){let n=e.data[t]?.page;n?.pageNumber>0&&this.data[t]&&this.data[t].page.content&&(n.content?n.content=[...this.data[t].page.content,...n.content]:n.content=[...this.data[t].page.content])}this.data={...this.data,...e.data}}this._lastFragmentData=this.data,this.registerCustomEventListeners();let r=N.getAfterRenderHook();r&&setTimeout(()=>r(this)),this.requestUpdate()}}willUpdate(e){super.willUpdate(e);let t=this.component?.serverSideType,n=t!=null&&this._lastViewKey!=null&&t!==this._lastViewKey;if(t!=null&&(this._lastViewKey=t),n&&this._locallyEdited.clear(),this._keepEditedFieldValues(e,n),!e.has(`data`)||this.data===this._lastFragmentData||n)return;let r=this.data,i=e.get(`data`);r&&Object.keys(r).length===0&&i&&Object.keys(i).length>0&&(this.data=i)}_keepEditedFieldValues(e,t){if(t||!e.has(`state`)||this._locallyEdited.size===0||this.state===this._lastOwnState)return;let n=this._lastOwnState;if(!n)return;let r;this._locallyEdited.forEach(e=>{n[e]!==this.state?.[e]&&(r??={...this.state},r[e]=n[e])}),r&&(this.state=r)}adoptEditedState(e,t){this._locallyEdited.add(e),this.state=t,this._lastOwnState=t}registerCustomEventListeners(){this._registeredCustomEventListeners.forEach(({target:e,name:t})=>e.removeEventListener(t,this.customEventManager)),this._registeredCustomEventListeners=[],this.component?.triggers?.filter(e=>e.type==Lo.OnCustomEvent).forEach(e=>{let t=e.source===`DOCUMENT`||e.source===`COMPONENT`?document:this;t.addEventListener(e.eventName,this.customEventManager),this._registeredCustomEventListeners.push({target:t,name:e.eventName})})}disconnectedCallback(){this._registeredCustomEventListeners.forEach(({target:e,name:t})=>e.removeEventListener(t,this.customEventManager)),this._registeredCustomEventListeners=[],super.disconnectedCallback()}connectedCallback(){super.connectedCallback(),this.component&&this.registerCustomEventListeners()}};k([b()],Ro.prototype,`state`,void 0),k([b()],Ro.prototype,`data`,void 0),k([b()],Ro.prototype,`appData`,void 0),k([b()],Ro.prototype,`appState`,void 0);var zo=new Set([`sse`,`app-data`,`rest-sources`,`command-center`,`global-search`,`notifications`,`context-selectors`,`header-actions`]);function Bo(e,t=zo){let n=(e??[]).filter(e=>e&&!t.has(e));return{ok:n.length===0,missing:n}}function Vo(e,t=document){let n=Bo(e);return n.ok||(console.warn(`[mateu] this renderer is missing capabilities the app requires: ${n.missing.join(`, `)}. The app may not render correctly. Load a renderer build that provides them.`),t.dispatchEvent(new CustomEvent(`mateu-capability-mismatch`,{detail:{missing:n.missing,required:[...e??[]]},bubbles:!0,composed:!0}))),n}var Ho=`mateu-recent-routes`,Uo=8;function Wo(){try{return JSON.parse(localStorage.getItem(Ho)??`{}`)}catch{return{}}}function Go(e){try{localStorage.setItem(Ho,JSON.stringify(e))}catch{}}function Ko(e){return Wo()[e||`_`]??[]}function qo(e,t){if(!t?.route||!t.label)return;let n=e||`_`,r=Wo(),i=(r[n]??[]).filter(e=>e.route!==t.route);i.unshift({route:t.route,label:t.label}),r[n]=i.slice(0,Uo),Go(r)}var Jo=class extends x{constructor(...e){super(...e),this.baseUrl=``,this.open=!1,this.queryText=``,this.dataHits=[],this.loading=!1,this.selectedIndex=0,this.fabOffset=0,this.keydownHandler=null}connectedCallback(){super.connectedCallback(),this.keydownHandler=e=>{(e.metaKey||e.ctrlKey)&&(e.key===`k`||e.key===`K`)?(e.preventDefault(),this.toggle()):e.key===`Escape`&&this.open&&this.close()},document.addEventListener(`keydown`,this.keydownHandler),this.setupFabObserver()}disconnectedCallback(){super.disconnectedCallback(),this.keydownHandler&&document.removeEventListener(`keydown`,this.keydownHandler),clearTimeout(this.searchTimer),this.fabObserver?.disconnect(),this.fabObserver=void 0}setupFabObserver(){let e=this.getRootNode(),t=e instanceof ShadowRoot?e:document.body;this.measureFabStack(),this.fabObserver?.disconnect(),this.fabObserver=new MutationObserver(()=>this.measureFabStack()),this.fabObserver.observe(t,{childList:!0,subtree:!0})}measureFabStack(){let e=(this.getRootNode().querySelectorAll?.(`.ai-fab, .app-fab, .page-fab`).length??0)*4;e!==this.fabOffset&&(this.fabOffset=e)}updated(e){e.has(`open`)&&this.open&&requestAnimationFrame(()=>this.inputEl?.focus())}toggle(){this.open?this.close():this.openCenter()}openCenter(){this.open=!0,this.queryText=``,this.dataHits=[],this.selectedIndex=0}close(){this.open=!1,this.queryText=``,this.dataHits=[],clearTimeout(this.searchTimer)}flattenMenu(e,t){let n=[];for(let r of e??[])if(!r.separator)if(r.submenus&&r.submenus.length>0){let e=t?`${t} › ${r.label}`:r.label;n.push(...this.flattenMenu(r.submenus,e))}else r.route!==void 0&&r.route!==null&&n.push({label:r.label,breadcrumb:t,route:r.route});return n}onInput(e){this.queryText=e,this.selectedIndex=0;let t=e.trim();if(clearTimeout(this.searchTimer),!t||!this.app?.globalSearchEnabled){this.dataHits=[],this.loading=!1;return}this.loading=!0,this.searchTimer=setTimeout(()=>this.fetchGlobalSearch(t),250)}async fetchGlobalSearch(e){let t=this.app;if(!t?.globalSearchEnabled){this.loading=!1;return}try{let n=(await Mt.runAction(this.baseUrl??``,t.rootRoute??``,``,`_globalsearch`,`command-center`,void 0,t.serverSideType,{},{searchText:e},this,!0))?.fragments?.map(e=>e.data).find(e=>e&&e._globalsearch);this.dataHits=n?._globalsearch??[]}catch{this.dataHits=[]}finally{this.loading=!1}}navigateTo(e,t){qo(this.app?.serverSideType??``,{route:e,label:t}),this.close();for(let t of[`route-changed`,`navigate-to-requested`])this.dispatchEvent(new CustomEvent(t,{detail:{route:e},bubbles:!0,composed:!0}))}askAi(){let e=this.queryText.trim();this.close(),this.dispatchEvent(new CustomEvent(`mateu-open-ai`,{detail:{query:e},bubbles:!0,composed:!0}))}visibleTargets(e){if(!this.queryText.trim()){let e=this.flattenMenu(this.app?.menu,``).map(e=>({route:e.route,label:e.label})),t=Ko(this.app?.serverSideType??``);return[...e,...t]}return[...e.map(e=>({route:e.route,label:e.label})),...this.dataHits.map(e=>({route:e.route,label:e.label}))]}onKeydown(e,t){if(e.key===`ArrowDown`)e.preventDefault(),this.selectedIndex=Math.min(this.selectedIndex+1,t.length-1);else if(e.key===`ArrowUp`)e.preventDefault(),this.selectedIndex=Math.max(this.selectedIndex-1,0);else if(e.key===`Enter`){let e=t[this.selectedIndex];e&&this.navigateTo(e.route,e.label)}}render(){return T`
        ...
        `}renderDefault(){let e=this.flattenMenu(this.app?.menu,``),t=Ko(this.app?.serverSideType??``),n=-1;return T`
    ...
    `}};k([b({attribute:!1})],Jo.prototype,`app`,void 0),k([b()],Jo.prototype,`baseUrl`,void 0),k([w()],Jo.prototype,`open`,void 0),k([w()],Jo.prototype,`queryText`,void 0),k([w()],Jo.prototype,`dataHits`,void 0),k([w()],Jo.prototype,`loading`,void 0),k([w()],Jo.prototype,`selectedIndex`,void 0),k([w()],Jo.prototype,`fabOffset`,void 0),k([S(`.cc-input`)],Jo.prototype,`inputEl`,void 0),Jo=k([_(`mateu-command-center`)],Jo);var Yo=null;function Xo(e){let t=e.component?.metadata;t&&(t.commandCenterEnabled||t.chromeless)&&t.variant!==`MEDIATOR`?((!Yo||!Yo.isConnected)&&(Yo=document.createElement(`mateu-command-center`),e.renderRoot.appendChild(Yo)),Yo.app=t,Yo.baseUrl=e.baseUrl??``):Yo&&e.renderRoot.contains(Yo)&&(Yo.remove(),Yo=null)}var Zo=class extends x{constructor(...e){super(...e),this.fetchStarted=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!0},this.fetchFinished=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1},this.fetchFailed=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1;let t=e.detail??{},n=t.failure??St(t.reason,{online:Ot.isOnline()});if(n.kind===`cancelled`)return;let r=t.retry;No({text:n.message,variant:`error`,duration:r?8e3:5e3,position:`bottomEnd`,...r?{actionLabel:`Retry`,onAction:r}:{}},this)}}connectedCallback(){super.connectedCallback(),this.addEventListener(`backend-called-event`,this.fetchStarted),this.addEventListener(`backend-succeeded-event`,this.fetchFinished),this.addEventListener(`backend-cancelled-event`,this.fetchFinished),this.addEventListener(`backend-failed-event`,this.fetchFailed)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`backend-called-event`,this.fetchStarted),this.removeEventListener(`backend-succeeded-event`,this.fetchFinished),this.removeEventListener(`backend-cancelled-event`,this.fetchFinished),this.removeEventListener(`backend-failed-event`,this.fetchFailed)}render(){return T`<div class="loader-container">
...
`,i=!0)}i&&this.updateMessage(a,o)}o||this.updateMessage(a,`⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).`)}catch(e){console.error(`Error en el flujo SSE:`,e);let t=e?.message??String(e);(t===`Failed to fetch`||t===`network error`||t===`Load failed`)&&!o?this.updateMessage(a,`⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible.`):this.updateMessage(a,`⚠️ Error: `+t)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value=``)},250),this.messageInputElement?.removeAttribute(`disabled`),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent(`close-requested`,{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{let e=this.messageInputElement?.value?.trim()??``;e&&this.send(new CustomEvent(`submit`,{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key===`Enter`&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback(),this.probeLocalAgent();let e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){let t=new e;this.recognition=t,t.lang=`es-ES`,t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=e=>{console.error(`Error de reconocimiento: `+e.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:`smooth`})},0)}addMessage(e,t){let n={text:e,time:new Date().toLocaleTimeString(),userName:t.includes(`agent`)?`Asistente`:`Tú`,userColorIndex:t.includes(`agent`)?2:1};return this.items=[...this.items,n],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((n,r)=>r===e?{...n,text:t}:n),this.scrollBottom()}tryParseCustomEvent(e){let t=e.trim();if(!t.startsWith(`{`))return null;try{let e=JSON.parse(t);if(typeof e.event==`string`)return{event:e.event,detail:e.detail??{}}}catch{}return null}tryParseTokenUsage(e){let t=e.trim();if(!t.startsWith(`{`))return null;try{let e=JSON.parse(t);if(`inputTokens`in e||`outputTokens`in e||`totalTokens`in e)return e}catch{}return null}buildMenuContext(e,t=[]){let n=[];for(let r of e){if(r.separator||r.remote)continue;let e=[...t,r.label];if(r.submenus&&r.submenus.length>0)n.push(...this.buildMenuContext(r.submenus,e));else{let t={path:e,navigation:{route:r.route,consumedRoute:r.consumedRoute,actionId:r.actionId??``,baseUrl:r.baseUrl,serverSideType:r.serverSideType,uriPrefix:r.uriPrefix}};r.description&&(t.description=r.description),n.push(t)}}return n}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return T`
                    ...
                    <div class="message-list" role="list">
                        ${this.items.map(e=>T`
                            <div class="message" role="listitem">
                                <div class="avatar" style="background: ${Es(e.userColorIndex)};">${Ds(e.userName)}</div>
  ...
  `}};k([b()],Os.prototype,`type`,void 0),k([b()],Os.prototype,`data`,void 0),k([b()],Os.prototype,`options`,void 0),k([S(`#chart`)],Os.prototype,`chartElement`,void 0),Os=k([_(`mateu-chart`)],Os);var ks=class extends x{updated(e){super.updated(e),this.chart&&=(this.chart.destroy(),void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){let{default:t}=await D(async()=>{let{default:e}=await import(`./vendor-diagrams.js`).then(e=>e.t);return{default:e}},__vite__mapDeps([4,1,2]));if(e!==this.xml)return;this.chart&&this.chart.destroy();let n={container:this.divElement};this.chart=new t(n),this.chart.importXML(e)}handleSlotChange(){}render(){return T`
       ...
       `}static{this.styles=g`
  `}};k([b()],ks.prototype,`xml`,void 0),k([S(`#canvas`)],ks.prototype,`divElement`,void 0),ks=k([_(`mateu-bpmn`)],ks);var As=160,js=56,Ms=220,Ns=110,Ps=60,Fs={ACTION:`#3B82F6`,JOIN:`#8B5CF6`,FORK:`#F59E0B`,END:`#EF4444`,USER_TASK:`#10B981`,PROCESS:`#6366F1`},Is={ACTION:`▶`,JOIN:`⟨`,FORK:`⟩`,END:`◼`,USER_TASK:`👤`,PROCESS:`⚙`},Ls=[`ACTION`,`JOIN`,`FORK`,`END`,`USER_TASK`,`PROCESS`];function Rs(){return`step-`+Math.random().toString(36).slice(2,8)}var zs=class extends x{constructor(...e){super(...e),this.value=`{"name":"New Workflow","steps":[]}`,this.wf={name:`New Workflow`,steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;let t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener(`mousemove`,this.onMouseMove),window.removeEventListener(`mouseup`,this.onMouseUp)}}updated(e){if(e.has(`value`)){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){let e=this.wf.steps??[],t={};e.forEach(e=>{t[e.id]=0});let n=!0;for(;n;)n=!1,e.forEach(e=>{if(e.preconditionStepId!=null&&t[e.preconditionStepId]!==void 0){let r=t[e.preconditionStepId]+1;r>t[e.id]&&(t[e.id]=r,n=!0)}});let r={};e.forEach(e=>{let n=t[e.id]??0;(r[n]??=[]).push(e.id)});let i={...this.positions},a=!1;Object.entries(r).forEach(([e,t])=>{let n=Number(e);t.forEach((e,t)=>{i[e]||(i[e]={x:Ps+n*Ms,y:Ps+t*Ns},a=!0)})}),a&&(this.positions=i)}emit(){let e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent(`value-changed`,{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(n=>n.id===e?{...n,...t}:n)},this.emit()}addStep(){let e=Rs(),t={id:e,type:`ACTION`,name:`New Step`};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};let n=Object.values(this.positions).map(e=>e.y),r=n.length?Math.max(...n)+Ns:Ps;this.positions={...this.positions,[e]:{x:Ps,y:r}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(t=>t.id!==e).map(t=>t.preconditionStepId===e?{...t,preconditionStepId:void 0}:t)};let{[e]:t,...n}=this.positions;this.positions=n,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;let n=this.positions[t]??{x:0,y:0},r=this.toSvgPoint(e);this.dragOffset={x:r.x-n.x,y:r.y-n.y},this.svgEl=e.currentTarget.closest(`svg`),window.addEventListener(`mousemove`,this.onMouseMove),window.addEventListener(`mouseup`,this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};let t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){let e=Object.values(this.positions),t=e.length?Math.max(...e.map(e=>e.x))+As+Ps:600,n=e.length?Math.max(...e.map(e=>e.y))+js+Ps:400;return{w:Math.max(t,600),h:Math.max(n,400)}}render(){let{w:e,h:t}=this.canvasSize(),n=this.wf.steps??[];return T`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return E``;let t=this.positions[e.preconditionStepId],n=this.positions[e.id];if(!t||!n)return E``;let r=t.x+As,i=t.y+js/2,a=n.x,o=n.y+js/2,s=(r+a)/2;return E`
            <path d="M${r},${i} C${s},${i} ${s},${o} ${a},${o}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){let t=this.positions[e.id]??{x:Ps,y:Ps},n=Fs[e.type]??`#64748b`,r=Is[e.type]??`•`,i=this.selectedId===e.id;return E`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${t=>this.onNodeMouseDown(t,e.id)}"
               @click="${t=>{t.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${As}" height="${js}" rx="8"
                      fill="white"
                      stroke="${i?n:`#e2e8f0`}"
                      stroke-width="${i?2.5:1.5}"
                      filter="url(#shadow)"/>
                <!-- type badge -->
                <rect x="0" y="0" width="32" height="${js}" rx="8" fill="${n}" clip-path="inset(0 -8px 0 0 round 8px)"/>
                <rect x="24" y="0" width="8" height="${js}" fill="${n}"/>
                <text x="16" y="${33}" text-anchor="middle"
                      font-size="14" fill="white">${r}</text>
                <!-- name -->
                <text x="44" y="${js/2-6}" font-size="11" fill="#1e293b" font-weight="600">
                ...
                <div class="prop-body">
                    ...
                    ${n(`Type`,T`
                        <select class="inp" @change="${t=>this.updateStep(e.id,{type:t.target.value})}">
                            ${Ls.map(t=>T`<option value="${t}" ?selected="${e.type===t}">${t}</option>`)}
                        </select>`)}
    ...
    `]}};k([b()],zs.prototype,`value`,void 0),k([w()],zs.prototype,`wf`,void 0),k([w()],zs.prototype,`positions`,void 0),k([w()],zs.prototype,`selectedId`,void 0),k([w()],zs.prototype,`showMeta`,void 0),zs=k([_(`mateu-workflow`)],zs);var Bs=[`string`,`integer`,`number`,`bool`,`date`,`time`,`dateTime`,`dateRange`,`money`,`file`,`array`,`status`,`component`,`menu`,`range`,`action`,`actionGroup`],Vs=[`regular`,`radio`,`checkbox`,`textarea`,`toggle`,`combobox`,`select`,`email`,`password`,`richText`,`listBox`,`html`,`markdown`,`image`,`icon`,`link`,`money`,`grid`,`color`,`choice`,`popover`,`slider`,`button`,`stars`],Hs={string:`#3B82F6`,integer:`#8B5CF6`,number:`#6366F1`,bool:`#10B981`,date:`#F59E0B`,time:`#F59E0B`,dateTime:`#F59E0B`,dateRange:`#F59E0B`,money:`#EF4444`,file:`#64748B`,array:`#0EA5E9`,status:`#EC4899`,component:`#14B8A6`,menu:`#94A3B8`,range:`#A855F7`,action:`#F97316`,actionGroup:`#FB923C`};function Us(){return`field-`+Math.random().toString(36).slice(2,8)}var Ws=class extends x{constructor(...e){super(...e),this.value=`{"name":"New Form","fields":[]}`,this.form={name:`New Form`,fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has(`value`))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){let e=this.shadowRoot?.querySelector(`.field-list`);!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=oe.create(e,{animation:150,handle:`.drag-handle`,ghostClass:`sortable-ghost`,onEnd:e=>{let{oldIndex:t,newIndex:n}=e;if(t===void 0||n===void 0||t===n)return;let r=[...this.form.fields],[i]=r.splice(t,1);r.splice(n,0,i),this.form={...this.form,fields:r},this.emit()}}))}emit(){let e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent(`value-changed`,{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(n=>n.id===e?{...n,...t}:n)},this.emit()}addField(){let e=Us(),t={id:e,label:`New Field`,dataType:`string`};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){let t=this.form.fields.find(t=>t.id===e);if(!t)return;let n={...t,id:Us(),label:t.label+` (copy)`},r=this.form.fields.findIndex(t=>t.id===e),i=[...this.form.fields];i.splice(r+1,0,n),this.form={...this.form,fields:i},this.selectedId=n.id,this.emit()}render(){return T`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderRow(e){let t=Hs[e.dataType]??`#64748b`;return T`
        ...
        textarea.inp { resize: vertical; }
        input[readonly].inp { background: #f8fafc; color: #94a3b8; }
    `]}};k([b()],Ws.prototype,`value`,void 0),k([w()],Ws.prototype,`form`,void 0),k([w()],Ws.prototype,`selectedId`,void 0),k([w()],Ws.prototype,`showMeta`,void 0),Ws=k([_(`mateu-form-editor`)],Ws);var Gs=class extends x{constructor(...e){super(...e),this.appState={},this.appData={},this.open=!1,this.activeTab=`appstate`,this.hoveredTag=``,this.hoveredId=``,this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null,this._prevTarget=null,this._onMouseover=e=>{let t=e.target;for(;t&&!(t.tagName?.toLowerCase().startsWith(`mateu-`)&&t!==this);)t=t.parentElement;if(t===this||t===null){t===null&&this._prevTarget&&(this._prevTarget.style.outline=``,this._prevTarget.style.outlineOffset=``,this._prevTarget=null,this.hoveredTag=``,this.hoveredId=``,this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null);return}t!==this._prevTarget&&(this._prevTarget&&(this._prevTarget.style.outline=``,this._prevTarget.style.outlineOffset=``),this._prevTarget=t,t.style.outline=`2px solid #0070f3`,t.style.outlineOffset=`-2px`,this.hoveredTag=t.tagName.toLowerCase(),this.hoveredId=t.id||``,this.hoveredState=t.state,this.hoveredData=t.data,this.hoveredMeta=t.component?.metadata)}}connectedCallback(){super.connectedCallback(),document.addEventListener(`mouseover`,this._onMouseover,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`mouseover`,this._onMouseover,!0),this._prevTarget&&=(this._prevTarget.style.outline=``,null)}_fmt(e){try{return JSON.stringify(e,null,2)??`null`}catch{return String(e)}}_renderTab(e,t){return T`
    ...
    `}};k([b()],Gs.prototype,`appState`,void 0),k([b()],Gs.prototype,`appData`,void 0),k([w()],Gs.prototype,`open`,void 0),k([w()],Gs.prototype,`activeTab`,void 0),k([w()],Gs.prototype,`hoveredTag`,void 0),k([w()],Gs.prototype,`hoveredId`,void 0),k([w()],Gs.prototype,`hoveredState`,void 0),k([w()],Gs.prototype,`hoveredData`,void 0),k([w()],Gs.prototype,`hoveredMeta`,void 0),Gs=k([_(`mateu-debug-overlay`)],Gs);var Ks=(e,t)=>{let n=t?.initiatorState;return n&&typeof n==`object`?{...n}:{...e??{}}},qs=e=>{if(e)try{return JSON.parse(e)}catch{return{value:e}}else return{}},Js=function(e){return e.required=`required`,e.disabled=`disabled`,e.hidden=`hidden`,e.pattern=`pattern`,e.minValue=`minValue`,e.maxValue=`maxValue`,e.minLength=`minLength`,e.maxLength=`maxLength`,e.css=`css`,e.style=`style`,e.theme=`theme`,e.errorMessage=`errorMessage`,e.description=`description`,e.none=`none`,e}({}),Ys=function(e){return e.Continue=`Continue`,e.Stop=`Stop`,e}({}),Xs=12e4,Zs=(e,t)=>`${e??`_`}::${t}`,Qs=new class{constructor(){this.started=new Map,this.listeners=new Set}begin(e,t=Date.now()){let n=this.started.get(e);return n!==void 0&&t-n<Xs?!1:(this.started.set(e,t),this.emit(),!0)}end(e){this.started.delete(e)&&this.emit()}isPending(e,t=Date.now()){let n=this.started.get(e);return n!==void 0&&t-n<Xs}snapshot(){return new Set(this.started.keys())}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}reset(){this.started.clear(),this.emit()}emit(){let e=this.snapshot();this.listeners.forEach(t=>t(e))}},$s=`data-mateu-pending-styles`,ec=`
[data-mateu-pending] {
    pointer-events: none;
    cursor: progress;
...
`),variant:`error`,position:`bottomEnd`,duration:Math.max(3e3,1500+n.length*1e3)},this),this.focusFirstInvalidField()},this.notify=e=>{No({text:e,variant:`error`,position:`bottomEnd`,duration:3e3},this)},this.handleRestAction=(e,t)=>{let n=()=>{let t=M(e.successMessage,this.state,this.data);t&&No({text:t,variant:`success`,position:`bottomEnd`,duration:3e3},this);let n=M(e.successRoute,this.state,this.data);if(!(!n||n.includes("${"))){if(this.sameRoute(n)){this.refreshListing();return}sn(this,n)}},r=t=>{if(e.resultPath!=null){let n=Rn(t,e.resultPath);n&&typeof n==`object`&&(this.state={...this.state,...n})}n()},i=e=>{console.warn(`mateu: rest action failed`,e),No({text:`Request failed`,variant:`error`,position:`bottomEnd`,duration:3e3},this)},a=(e,t)=>{let n=e?.appData?._restfetchError;if(n){No({text:`Request failed${typeof n?.status==`number`&&n.status>0?` (HTTP ${n.status})`:``}`,variant:`error`,position:`bottomEnd`,duration:3e3},this);return}t(e?.appData?._restfetch)},o=!!be(e.source)?.proxy,s=t===`__restdata__`?`data`:`action`;if(e.forEachSelectedRow){let r=this.state.crud_selected_items??[];if(!r.length){this.notify(`You first need to select some rows`);return}if(o){this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:`__restfetch__`,parameters:{_sourceKind:s,_sourceId:t,_forEachSelectedRow:!0},callback:e=>a(e,()=>n()),callbackonly:!0},bubbles:!0,composed:!0}));return}Promise.all(r.map(t=>Vn(e.source,e=>M(e,{...this.state,...t},this.data)))).then(()=>n()).catch(i);return}if(o){this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:`__restfetch__`,parameters:{_sourceKind:s,_sourceId:t},callback:e=>a(e,r),callbackonly:!0},bubbles:!0,composed:!0}));return}Vn(e.source,e=>M(e,this.state,this.data),void 0,e=>M(e,me(this.state),me(this.data))).then(r).catch(i)},this.callAfterConfirmation=(e,t)=>{let{header:n,message:r,confirmationText:i,denialText:a}=fc(e),o=document.createElement(`div`);o.style.cssText=`position:fixed;inset:0;z-index:1100;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.35);padding:1rem;`;let s=document.createElement(`div`);s.style.cssText=`background:var(--lumo-base-color,#fff);color:var(--lumo-body-text-color,#1a1a1a);border-radius:var(--lumo-border-radius-l,12px);box-shadow:var(--lumo-box-shadow-xl,0 12px 40px rgba(0,0,0,.3));padding:1.2rem;max-width:min(90vw,26rem);`;let c=()=>{o.parentElement&&document.body.removeChild(o)},l=`font:inherit;font-weight:600;padding:.45rem 1rem;border-radius:var(--lumo-border-radius-m,6px);cursor:pointer;`;ne(T`
        ...
        `,s),o.appendChild(s),o.addEventListener(`click`,e=>{e.target===o&&c()}),document.body.appendChild(o)},this.requestActionCallToServerOrBubble=(e,t,n,r)=>{if(n&&n.bubble){let t={...e.parameters};t.initiatorState||=this.state,this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{...e,_originElement:r,parameters:t},bubbles:!0,composed:!0}))}else this.requestActionCallToServer(e,t,n,r)},this.requestActionCallToServer=(e,t,n,r)=>{if(n&&n.href){window.location.href=n.href;return}if(n&&n.js)try{Function(`state`,`data`,`appState`,`appData`,`component`,n.js).call(this,this.state??{},this.data??{},this.appState??{},this.appData??{},this.component),this.state={...this.state},this.data={...this.data}}catch(e){console.error(`when evaluating `+n.js,e,this.component,this.state,this.data)}if(n&&n.customEvent&&this.dispatchEvent(new CustomEvent(n.customEvent.name,{detail:n.customEvent.detail,bubbles:!0,composed:!0})),n&&(n.js||n.customEvent)||lc(n,e=>this.applyCommand(e)))return;if(n&&n.restAction){this.handleRestAction(n.restAction,n.id);return}if(e.actionId==`search`){let t=e.parameters?._searchState;t?this.state={...this.state,...t}:this.state.size||(this.state={...this.state,size:10,page:0,sort:[]})}let i=e.background??n?.background;if(!i){if(!Tt(e.actionId,n?.idempotent)&&!Qs.begin(Zs(this.id,e.actionId)))return;let t=cc(r);this._pendingOrigins.set(e.actionId,t),ic(t)}let a=Ks(this.state,e.parameters);this.dispatchEvent(new CustomEvent(`server-side-action-requested`,{detail:{route:this.route,consumedRoute:this.consumedRoute,componentState:a,parameters:e.parameters??{},actionId:e.actionId,serverSideType:t.serverSideType,serverSideComponentRoute:t.route,initiatorComponentId:e.initiatorComponentId??t.id,initiator:this,background:i,sse:n?.sse,timeoutMillis:n?.timeoutMillis,idempotent:n?.idempotent,callback:e.callback,callbackonly:e.callbackonly,callbackToken:e.callbackToken??this.callbackToken},bubbles:!0,composed:!0}))},this.handleBackendSucceeded=e=>{e.detail.actionId&&this.component.triggers?.filter(e=>e.type==Lo.OnSuccess).filter(t=>e.detail.actionId==t.calledActionId).forEach(t=>{if(!t.condition||this._evalExpr(t.condition))if(e.preventDefault(),e.stopPropagation(),t.timeoutMillis>0){let e=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId,background:t.background,callbackToken:e},bubbles:!0,composed:!0}))},t.timeoutMillis)}else this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId,background:t.background},bubbles:!0,composed:!0}))})},this.handleBackendFailed=e=>{e.detail.actionId&&this.component.triggers?.filter(e=>e.type==Lo.OnError).filter(t=>e.detail.actionId==t.calledActionId).forEach(t=>{(!t.condition||this._evalExpr(t.condition))&&(e.preventDefault(),e.stopPropagation(),this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId},bubbles:!0,composed:!0})))})},this._pendingOrigins=new Map,this._backendSettledListener=e=>{((typeof e.composedPath==`function`?e.composedPath():[])[0]??e.target)===this&&this._releasePending(e.detail?.actionId)},this._keydownListener=e=>{if(this._handleTabShortcut(e))return;let t=this.component;if(t)for(let n of t.actions??[]){let t=n.shortcut||(n.runOnEnter?`enter`:null);if(t&&this._shortcutMatchesEvent(t,e)){e.preventDefault(),this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:n.id},bubbles:!0,composed:!0}));return}}}}createRenderRoot(){return N.mustUseShadowRoot()?super.createRenderRoot():this}updated(e){super.updated(e),e.has(`state`)&&this.state&&JSON.stringify(this.state)!=JSON.stringify({})&&this.onChange(),e.has(`component`)&&(uc(this,this.component?.sizing),this.formerState={...this.state},this.component?.confirmOnNavigationIfDirty&&this.dispatchEvent(new CustomEvent(`clean`,{detail:{},bubbles:!0,composed:!0})),setTimeout(()=>this.triggerOnLoad()))}sameRoute(e){let t=e=>e.replace(/^\/+/,``).replace(/\/+$/,``).split(`?`)[0];return t(e)===t(window.location.pathname)}refreshListing(){let e=null,t=n=>{let r=n.querySelector?.(`mateu-table-crud`);r&&(e=r),n.querySelectorAll?.(`*`).forEach(e=>{e.shadowRoot&&t(e.shadowRoot)})};t(this.renderRoot),e?.search?.()}focusFirstInvalidField(){let e=t=>requestAnimationFrame(()=>{let n=this.findFirstInvalid(this.renderRoot);if(n){n.focus?.(),n.scrollIntoView?.({block:`center`,behavior:`smooth`});return}t>0&&e(t-1)});e(3)}findFirstInvalid(e){if(!e?.querySelectorAll)return null;for(let t of Array.from(e.querySelectorAll(`*`))){if(t.invalid===!0)return t;if(t.shadowRoot){let e=this.findFirstInvalid(t.shadowRoot);if(e)return e}}return null}_releasePending(e){(e===void 0?Array.from(this._pendingOrigins.keys()):[e]).forEach(e=>{Qs.end(Zs(this.id,e)),ac(this._pendingOrigins.get(e)),this._pendingOrigins.delete(e)})}_shortcutMatchesEvent(e,t){return Gr(e,t)}_collectShortcutTabs(){let e=this.renderRoot;if(!e)return[];let t=Array.from(e.querySelectorAll(`vaadin-tab[data-shortcut]`));return e.querySelectorAll(`mateu-drawer, mateu-dialog`).forEach(e=>{let n=e.shadowRoot;n&&t.push(...Array.from(n.querySelectorAll(`vaadin-tab[data-shortcut]`)))}),t}_handleTabShortcut(e){let t=this._collectShortcutTabs();if(t.length===0)return!1;for(let n of Array.from(t)){let t=n.dataset.shortcut;if(!t||!this._shortcutMatchesEvent(t,e))continue;let r=n.closest(`vaadin-tabs`);if(!r)continue;let i=Array.from(r.querySelectorAll(`vaadin-tab`)).indexOf(n);if(!(i<0))return e.preventDefault(),r.selected=i,!0}return!1}connectedCallback(){super.connectedCallback(),this.addEventListener(`backend-call-succeeded`,this.handleBackendSucceeded),this.addEventListener(`backend-call-failed`,this.handleBackendFailed),this.addEventListener(`backend-succeeded-event`,this._backendSettledListener),this.addEventListener(`backend-failed-event`,this._backendSettledListener),this.addEventListener(`backend-cancelled-event`,this._backendSettledListener),document.addEventListener(`keydown`,this._keydownListener)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`backend-call-succeeded`,this.handleBackendSucceeded),this.removeEventListener(`backend-call-failed`,this.handleBackendFailed),this.removeEventListener(`backend-succeeded-event`,this._backendSettledListener),this.removeEventListener(`backend-failed-event`,this._backendSettledListener),this.removeEventListener(`backend-cancelled-event`,this._backendSettledListener),document.removeEventListener(`keydown`,this._keydownListener),this._releasePending()}render(){return T`<div>
            ...
            `:y}</div>`}_render(){if(this.component?.type==A.ClientSide){let e=this.component;return e.metadata?.type==j.Page?Ai(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):e.metadata?.type==j.Crud?ji(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):N.get()?.renderClientSideComponent(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!1)}return T`
            <mateu-api-caller 
            ...
            ${this.component?.children?.map(e=>{if(e.type==A.ClientSide){let t=e;if(t.metadata?.type==j.Page)return Ai(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0);if(t.metadata?.type==j.Crud)return ji(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0)}return P(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData)})}
            </mateu-api-caller>
        `}static{this.styles=g`
        :host {
        }
...
`);e=a.pop()??``;for(let e of a){let t=e.trim();if(t)if(t.startsWith(`data:`)){let e=JSON.parse(t.substring(5).trim());f&&f(e),p||this.handleUIIncrement(e,u,m),e.messages&&e.messages.length==1&&e.messages[0].variant==`error`&&u.shadowRoot?.dispatchEvent(new CustomEvent(`backend-call-failed`,{detail:{actionId:i},bubbles:!0,composed:!0}))}else{let e=t;try{let n=JSON.parse(t);e=n.message,n._embedded?.errors?.length>0&&n._embedded.errors[0].message&&(e=n._embedded.errors[0].message)}catch{}throw Error(e)}}}}d||u.dispatchEvent(new CustomEvent(`backend-succeeded-event`,{bubbles:!0,composed:!0,detail:{actionId:i}})),u.shadowRoot?.dispatchEvent(new CustomEvent(`backend-call-succeeded`,{detail:{actionId:i},bubbles:!0,composed:!0}))}).catch(e=>{u.dispatchEvent(new CustomEvent(`backend-failed-event`,{bubbles:!0,composed:!0,detail:{actionId:i,reason:this.serialize(e),retry:ee}})),u.shadowRoot?.dispatchEvent(new CustomEvent(`backend-call-failed`,{detail:{actionId:i},bubbles:!0,composed:!0}))})}}serialize(e){return e?.message?e:JSON.stringify(e)}},vc={fixed:`fixed`,fullWidth:`full`,edgeToEdge:`edge`},yc=new Set([j.Gantt,j.PlanningBoard,j.Kanban,j.Bpmn,j.Workflow,j.Map]),bc={landing:`fixed`,form:`fixed`,process:`fixed`},xc=e=>e?vc[e]:void 0,Sc=e=>e.type==A.ClientSide?e.metadata:void 0,Cc=e=>{let t=Sc(e);if(t?.type==j.Page){let e=xc(t.pageWidth);if(e)return e}for(let t of e.children??[]){let e=Cc(t);if(e)return e}},wc=e=>{let t=e.pageType;if(t)return t;let n=e=>{let t=Sc(e);if(t?.type==j.Page&&t.pageType)return t.pageType;for(let t of e.children??[]){let e=n(t);if(e)return e}};return n(e)},Tc=e=>{let t=Sc(e);if(t?.type!=j.Crud)return!1;let n=t;return n.compact?!0:(n.columns??[]).some(e=>e.metadata?.editable)},Ec=(e,t)=>t(e)||(e.children??[]).some(e=>Ec(e,t)),Dc=e=>!!e&&Ec(e,e=>Sc(e)?.type==j.HeroSection),Oc=e=>Sc(e)?.type==j.App||(e.children??[]).some(e=>Sc(e)?.type==j.App),kc=(e,t)=>e?(xc(e.pageWidth)??Cc(e))||(t?.top&&Oc(e)?`edge`:bc[wc(e)??``]||(Ec(e,e=>{let t=Sc(e)?.type;return t!=null&&yc.has(t)})?`edge`:Ec(e,Tc)?`full`:`fixed`)):`fixed`,Ac=`mateu-route-structure-cache`,jc=1,Mc=50,Nc=(()=>{try{return localStorage.getItem(`mateu-route-structure-cache-off`)!==`1`}catch{return!0}})(),Pc=()=>{try{return JSON.parse(localStorage.getItem(Ac)??`{}`)}catch{return{}}},Fc=e=>{try{localStorage.setItem(Ac,JSON.stringify(e))}catch{try{let t=Object.entries(e).sort((e,t)=>t[1].t-e[1].t).slice(0,Math.floor(Mc/2));localStorage.setItem(Ac,JSON.stringify(Object.fromEntries(t)))}catch{}}},Ic=e=>{let t=e.initialState&&Object.keys(e.initialState).length?`#`+zc(JSON.stringify(e.initialState)):``;return[e.baseUrl,e.consumedRoute??``,e.route??``,e.serverSideType??``].join(`|`)+t},Lc=e=>{if(!Nc)return;let t=Pc()[e];if(!(!t||t.v!==jc))return{component:t.component,hash:t.hash}},Rc=(e,t,n)=>{if(!Nc)return;let r=Pc();r[e]={v:jc,t:Date.now(),component:t,hash:n};let i=Object.keys(r);if(i.length>Mc){let e=i.sort((e,t)=>r[e].t-r[t].t).slice(0,i.length-Mc);for(let t of e)delete r[t]}Fc(r)},zc=e=>{let t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return(t>>>0).toString(36)},Bc=30,Vc=new Map,Hc=!0,Uc=e=>{if(Hc)return Vc.get(e)},Wc=(e,t)=>{if(Hc&&(Vc.delete(e),Vc.set(e,t),Vc.size>Bc)){let e=Vc.keys().next().value;e!==void 0&&Vc.delete(e)}},Gc,X=class extends zt{static{Gc=this}constructor(...e){super(...e),this.consumedRoute=``,this.serverSideType=void 0,this.uriPrefix=void 0,this.overrides=void 0,this.homeRoute=void 0,this.route=void 0,this.top=void 0,this.appState={},this.appData={},this.preventNavigation=!1,this.overridesParsed={},this.fragment=void 0,this.showSkeleton=!1,this.pendingRouteFocus=!1,this.hasRenderedContent=!1,this.loadLifecycleListener=e=>{if(((typeof e.composedPath==`function`?e.composedPath():[])[0]??e.target)===this)if(clearTimeout(this.skeletonTimer),e.type===`backend-called-event`){if(this.fragment?.component)return;this.skeletonTimer=setTimeout(()=>{this.showSkeleton=!0},Gc.SKELETON_DELAY_MS)}else this.showSkeleton=!1},this.actionRequestedListener=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.manageActionEvent(e))},this.historyPushed=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.preventNavigation=!0,this.route=e.detail.route)},this.routeChangedListener=e=>{if(e instanceof CustomEvent){e.preventDefault(),e.stopPropagation();let t=e.detail.route;typeof t==`string`&&(t===``||t.startsWith(`/`))&&this.consumedRoute&&this.consumedRoute!==`_empty`&&this.consumedRoute.startsWith(`/`)&&!t.startsWith(this.consumedRoute)&&(t=this.consumedRoute+t),this.uriPrefix&&(t=t.startsWith(`/`)&&this.uriPrefix.endsWith(`/`)?this.uriPrefix+t.substring(1):!t.startsWith(`/`)&&!this.uriPrefix.endsWith(`/`)?this.uriPrefix+`/`+t:this.uriPrefix+t),this.dispatchEvent(new CustomEvent(`url-update-requested`,{detail:{route:t},bubbles:!0,composed:!0}))}},this.backendFailedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&e.detail.actionId==``&&(this.fragment={targetComponentId:this.id,data:{},state:{},component:{type:A.ClientSide,metadata:{type:j.Element,name:`div`,content:`Not found`},id:`fieldId`},action:We.Replace,containerId:void 0})},this.detail1=void 0,this.manageActionEvent=e=>{e.preventDefault(),e.stopPropagation(),this.detail1=e.detail;let t=this.detail1;if(e.type==`server-side-action-requested`){let e=gc;t.sse&&(e=_c),e.runAction(Mt,this.baseUrl,t.route??``,t.consumedRoute,t.actionId,t.initiatorComponentId,this.getCustomisedAppState(),t.serverSideType,t.componentState,t.parameters,t.initiator,t.background,t.callback,t.callbackonly,t.callbackToken,{timeoutMillis:t.timeoutMillis,idempotent:t.idempotent,knownStructureHash:t.knownStructureHash})}},this.getCustomisedAppState=()=>{let e={...O.value};if(this.overrides){let t=qs(this.overrides);e={...e,...t}}return e}}manageActionRequestedEvent(e){throw Error(`Method not implemented.`)}createRenderRoot(){return N.mustUseShadowRoot()?super.createRenderRoot():this}structureCacheKey(){return Ic({baseUrl:this.baseUrl,consumedRoute:this.consumedRoute,route:this.route,serverSideType:this.serverSideType,initialState:this.initialState})}focusNewContent(){requestAnimationFrame(()=>{let e=this.renderRoot?.querySelector?.(`h1, h2, [role="heading"]`)??this;e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`-1`),e.focus?.({preventScroll:!0})})}static{this.SKELETON_DELAY_MS=400}connectedCallback(){super.connectedCallback(),this.overridesParsed=qs(this.overrides),this.addEventListener(`server-side-action-requested`,this.actionRequestedListener),this.addEventListener(`backend-call-failed`,this.backendFailedListener),this.addEventListener(`history-pushed`,this.historyPushed),this.addEventListener(`route-changed`,this.routeChangedListener),this.addEventListener(`backend-called-event`,this.loadLifecycleListener),this.addEventListener(`backend-succeeded-event`,this.loadLifecycleListener),this.addEventListener(`backend-failed-event`,this.loadLifecycleListener),this.addEventListener(`backend-cancelled-event`,this.loadLifecycleListener)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`server-side-action-requested`,this.actionRequestedListener),this.removeEventListener(`backend-call-failed`,this.backendFailedListener),this.removeEventListener(`history-pushed`,this.historyPushed),this.removeEventListener(`route-changed`,this.routeChangedListener),this.removeEventListener(`backend-called-event`,this.loadLifecycleListener),this.removeEventListener(`backend-succeeded-event`,this.loadLifecycleListener),this.removeEventListener(`backend-failed-event`,this.loadLifecycleListener),this.removeEventListener(`backend-cancelled-event`,this.loadLifecycleListener),clearTimeout(this.skeletonTimer)}shouldUpdate(e){if(this.fragment?.component&&[...e.keys()].every(e=>e===`appState`||e===`appData`)){let t=this.renderRoot.querySelector(`mateu-component`);if(t)return e.has(`appState`)&&(t.appState=this.appState),e.has(`appData`)&&(t.appData=this.appData),!1}return!0}updated(e){if((e.has(`id`)||e.has(`baseurl`)||e.has(`route`)||e.has(`consumedRoute`)||e.has(`instant`))&&!this.preventNavigation){this.callbackToken=this.instant||se();let e=this.structureCacheKey(),t=e===this.lastAuthoritativeKey?void 0:Uc(e);if(t)queueMicrotask(()=>this.applyFragment(t));else{if(e!==this.lastAuthoritativeKey){let t=Lc(e);this.currentStructureHash=t?.hash,t&&(this.fragment={targetComponentId:this.id,component:t.component,state:{},data:{},action:We.Replace,containerId:void 0},this.stampPageChrome())}this.manageActionEvent(new CustomEvent(`server-side-action-requested`,{detail:{route:this.route,consumedRoute:this.consumedRoute,userData:void 0,actionId:``,serverSideType:this.serverSideType,initiatorComponentId:this.id,initiator:this,componentState:this.initialState,knownStructureHash:this.currentStructureHash,callbackToken:this.callbackToken},bubbles:!0,composed:!0}))}}e.has(`route`)&&this.top&&(this.preventNavigation||(this.pendingRouteFocus=!0),this.preventNavigation||this.dispatchEvent(new CustomEvent(`route-changed`,{detail:{route:this.route},bubbles:!0,composed:!0}))),this.preventNavigation&&=!1}applyFragment(e){if(!e.component&&this.fragment?.component){this.fragment={...this.fragment,state:{...this.fragment.state??{},...e.state??{}},data:{...this.fragment.data??{},...e.data??{}}},this.stampPageChrome();return}if(this.fragment=e,e.component){if(e.action!==We.Add){let t=this.structureCacheKey(),n=e.component.structureHash;Rc(t,e.component,n),this.lastAuthoritativeKey=t,this.currentStructureHash=n,e.component.staticView&&Wc(t,e)}this.pendingRouteFocus&&this.hasRenderedContent&&this.focusNewContent(),this.pendingRouteFocus=!1,this.hasRenderedContent=!0}this.stampPageChrome()}stampPageChrome(){let e=this.fragment?.component;!e||e===this.lastStampedComponent||(this.lastStampedComponent=e,this.dataset.pageWidth=kc(e,{top:this.top}),this.dataset.pageType=wc(e)??``,this.dataset.hasWelcomeBanner=String(Dc(e)))}render(){return!this.fragment?.component&&this.showSkeleton?T`
  ...
  `}};k([b()],X.prototype,`consumedRoute`,void 0),k([b()],X.prototype,`serverSideType`,void 0),k([b()],X.prototype,`uriPrefix`,void 0),k([b()],X.prototype,`overrides`,void 0),k([b()],X.prototype,`homeRoute`,void 0),k([b()],X.prototype,`route`,void 0),k([b()],X.prototype,`top`,void 0),k([b()],X.prototype,`instant`,void 0),k([b()],X.prototype,`initialState`,void 0),k([b()],X.prototype,`appState`,void 0),k([b()],X.prototype,`appData`,void 0),k([w()],X.prototype,`fragment`,void 0),k([w()],X.prototype,`showSkeleton`,void 0),X=Gc=k([_(`mateu-ux`)],X);function Kc(e){let t=`var(--lumo-space-m, 1rem)`,n={left:`50%`,transform:`translateX(-50%)`};switch(e){case`topStart`:return{top:t,left:t};case`topCenter`:return{top:t,...n};case`topEnd`:return{top:t,right:t};case`topStretch`:return{top:t,left:t,right:t};case`middle`:return{top:`50%`,left:`50%`,transform:`translate(-50%, -50%)`};case`bottomStart`:return{bottom:t,left:t};case`bottomCenter`:return{bottom:t,...n};case`bottomStretch`:return{bottom:t,left:t,right:t};default:return{bottom:t,right:t}}}function qc(e){switch(e){case`success`:return{bg:`var(--lumo-success-color, #2e7d32)`,fg:`#fff`};case`error`:return{bg:`var(--lumo-error-color, #c62828)`,fg:`#fff`};case`warning`:return{bg:`var(--lumo-warning-color, #f9a825)`,fg:`#1a1a1a`};case`contrast`:return{bg:`var(--lumo-contrast-90pct, #1a1a1a)`,fg:`#fff`};default:return{bg:`var(--lumo-base-color, #fff)`,fg:`var(--lumo-body-text-color, #1a1a1a)`}}}var Jc={show(e,t){let{bg:n,fg:r}=qc(e.variant),i=Kc(e.position),a=document.createElement(`div`),o=e.variant===`error`;a.setAttribute(`role`,o?`alert`:`status`),a.setAttribute(`aria-live`,o?`assertive`:`polite`),a.setAttribute(`aria-atomic`,`true`),Object.assign(a.style,{position:`fixed`,zIndex:`2000`,display:`flex`,alignItems:`center`,gap:`0.75rem`,maxWidth:`min(90vw, 28rem)`,padding:`0.7rem 1rem`,borderRadius:`var(--lumo-border-radius-m, 8px)`,boxShadow:`var(--lumo-box-shadow-m, 0 4px 16px rgba(0,0,0,0.2))`,background:n,color:r,font:`inherit`,fontSize:`var(--lumo-font-size-s, 0.875rem)`,opacity:`0`,transition:`opacity 0.2s ease`,...i});let s=document.createElement(`span`);s.textContent=e.text,a.appendChild(s);let c=()=>{a.style.opacity=`0`,setTimeout(()=>a.remove(),200)},l=e.onAction?{label:e.actionLabel??`Retry`,run:e.onAction}:e.undoActionId?{label:e.undoLabel??`Undo`,run:()=>t.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.undoActionId,parameters:e.undoParameters??{}},bubbles:!0,composed:!0}))}:void 0;if(l){let e=document.createElement(`button`);e.textContent=l.label,e.style.cssText=`margin-left: 0.25rem; background: none; border: 1px solid currentColor; border-radius: var(--lumo-border-radius-s, 4px); color: inherit; cursor: pointer; padding: 0.15rem 0.6rem; font: inherit; font-weight: 600;`,e.addEventListener(`click`,()=>{l.run(),c()}),a.appendChild(e)}document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity=`1`});let u=e.duration??(l?1e4:5e3);u>0&&setTimeout(c,u)}};function Yc(){Mo(Jc)}var Xc=class extends x{constructor(...e){super(...e),this.online=!0,this.recovered=!1}connectedCallback(){super.connectedCallback(),this.online=Ot.isOnline(),this.unsubscribe=Ot.subscribe(e=>{let t=!this.online;this.online=e,e&&t&&(this.recovered=!0,clearTimeout(this.recoveredTimer),this.recoveredTimer=setTimeout(()=>{this.recovered=!1},4e3))})}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.(),clearTimeout(this.recoveredTimer),this.releaseSpace()}updated(){let e=this.renderRoot.querySelector(`.bar`);if(!e){this.releaseSpace();return}document.body.style.setProperty(`padding-block-start`,`${e.offsetHeight}px`)}releaseSpace(){typeof document<`u`&&document.body?.style.removeProperty(`padding-block-start`)}render(){if(this.online&&!this.recovered)return y;let e=!this.online;return T`<div class="bar ${e?`offline`:`back`}" role="status" aria-live="polite">
    ...
    `}};k([w()],Xc.prototype,`online`,void 0),k([w()],Xc.prototype,`recovered`,void 0),Xc=k([_(`mateu-connectivity-banner`)],Xc);var Zc=null;function Qc(){if(!(typeof document>`u`)&&!(Zc&&Zc.isConnected)){if(!document.body){document.addEventListener(`DOMContentLoaded`,()=>Qc(),{once:!0});return}Zc=document.createElement(`mateu-connectivity-banner`),document.body.appendChild(Zc)}}var $c,el=class extends x{static{$c=this}constructor(...e){super(...e),this.skip=()=>{let e=this.findContent();e&&(e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`-1`),e.focus(),e.scrollIntoView({block:`start`}))}}static{this.TARGETS=[`.app-content`,`mateu-page`,`mateu-ux`,`mateu-component`]}findContent(){let e=new Set,t=n=>{if(e.has(n))return null;e.add(n);for(let e of $c.TARGETS){let t=n.querySelector?.(e);if(t&&t!==this)return t}for(let e of Array.from(n.querySelectorAll?.(`*`)??[]))if(e.shadowRoot){let n=t(e.shadowRoot);if(n)return n}return null};return t(document)}render(){return T`<button class="skip" @click="${this.skip}">Skip to content</button>`}static{this.styles=g`
        :host {
            position: fixed;
            inset-block-start: 0;
  ...
  `}};k([b()],al.prototype,`baseUrl`,void 0),k([b()],al.prototype,`route`,void 0),k([b()],al.prototype,`consumedRoute`,void 0),k([b()],al.prototype,`config`,void 0),k([b()],al.prototype,`top`,void 0),k([b()],al.prototype,`pathPrefix`,void 0),k([b()],al.prototype,`bundleUrl`,void 0),k([w()],al.prototype,`instant`,void 0),k([b({type:Boolean})],al.prototype,`debug`,void 0),al=k([_(`mateu-ui`)],al);var ol,sl=class extends x{static{ol=this}constructor(...e){super(...e),this.baseUrl=``,this.opened=!1,this.searchText=``}static{this.SEARCHABLE_THRESHOLD=7}connectedCallback(){super.connectedCallback(),Re()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick(),this.searchTimer&&clearTimeout(this.searchTimer)}currentValue(){return String(Pe()[this.selector.fieldName]??``)}currentLabel(){let e=this.currentValue();if(!e)return`—`;let t=(this.searchedOptions??this.selector.options)?.find(t=>String(t.value)===e);if(t)return t.label;let n=Fe()[this.selector.fieldName];return n===void 0?e:String(n)}pick(e,t){Ie(this.selector.fieldName,e,t),window.location.reload()}detachOutsideClick(){this.outsideClick&&=(document.removeEventListener(`mousedown`,this.outsideClick),void 0)}openPanel(){this.opened||(this.opened=!0,this.searchText=``,this.searchedOptions=void 0,this.remoteSearch(),this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener(`mousedown`,this.outsideClick),this.updateComplete.then(()=>this.renderRoot.querySelector(`input.picker-search`)?.focus()))}closePanel(){this.detachOutsideClick(),this.opened=!1}onSearchInput(e){this.searchText=e.target.value,this.searchTimer&&clearTimeout(this.searchTimer),this.searchTimer=setTimeout(()=>this.remoteSearch(),300)}async remoteSearch(){let e=this.app;if(e?.serverSideType)try{let t=await Mt.runAction(this.baseUrl??``,e.rootRoute??e.initialRoute??``,``,`_appcontext-search-${this.selector.fieldName}`,`appcontext-${this.selector.fieldName}`,void 0,e.serverSideType,{},{searchText:this.searchText},this,!0);for(let e of t?.fragments??[]){let t=e.data?.[`_appcontext_${this.selector.fieldName}`]?.content;if(Array.isArray(t)){this.searchedOptions=t.map(e=>({value:e.value,label:e.label??String(e.value)}));return}}}catch{}}visibleOptions(){let e=this.searchedOptions??this.selector.options??[],t=this.searchText.trim().toLowerCase();return t?e.filter(e=>e.label.toLowerCase().includes(t)):e}renderPanel(){let e=this.currentValue(),t=this.visibleOptions();return T`
    ...
    `}};k([b()],sl.prototype,`selector`,void 0),k([b()],sl.prototype,`app`,void 0),k([b()],sl.prototype,`baseUrl`,void 0),k([w()],sl.prototype,`opened`,void 0),k([w()],sl.prototype,`searchText`,void 0),k([w()],sl.prototype,`searchedOptions`,void 0),sl=ol=k([_(`mateu-app-context-picker`)],sl);var cl=class extends x{constructor(...e){super(...e),this.baseUrl=``,this.opened=!1,this.notifications=[],this.fetched=!1}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}updated(){!this.fetched&&this.app?.serverSideType&&(this.fetched=!0,this.refresh())}unreadCount(){return this.notifications.filter(e=>e.unread).length}async runNotificationsAction(e,t){let n=this.app;if(n?.serverSideType)try{let r=await Mt.runAction(this.baseUrl??``,n.rootRoute??n.initialRoute??``,``,e,`notification-bell`,void 0,n.serverSideType,{},t,this,!0);for(let e of r?.fragments??[]){let t=e.data?._notifications;if(Array.isArray(t)){this.notifications=t;return}}}catch{}}refresh(){return this.runNotificationsAction(`_notifications-list`,{})}markRead(e){return this.runNotificationsAction(`_notifications-read`,{ids:e})}detachOutsideClick(){this.outsideClick&&=(document.removeEventListener(`mousedown`,this.outsideClick),void 0)}openPanel(){this.opened||(this.opened=!0,this.refresh(),this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener(`mousedown`,this.outsideClick))}closePanel(){this.detachOutsideClick(),this.opened=!1}async entryClicked(e){e.unread&&await this.markRead([e.id]);let t=e.route;if(t){if(!Qo.confirmLeave())return;this.closePanel(),this.dispatchEvent(new CustomEvent(`route-changed`,{detail:{route:t},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`navigate-to-requested`,{detail:{route:t},bubbles:!0,composed:!0}))}}renderEntry(e){return T`
        ...
        ${R}
    `}};k([b()],cl.prototype,`app`,void 0),k([b()],cl.prototype,`baseUrl`,void 0),k([w()],cl.prototype,`opened`,void 0),k([w()],cl.prototype,`notifications`,void 0),cl=k([_(`mateu-notification-bell`)],cl);var ll=e=>{if(!e||!(`querySelectorAll`in e))return null;for(let t of e.querySelectorAll(`*`)){if(t.tagName?.toLowerCase()===`mateu-component`)return t;let e=ll(t.shadowRoot);if(e)return e}return null},ul=async(e,t,n)=>{let r=ll(t.renderRoot??t);await _c.runAction(Mt,t.baseUrl??``,e.rootRoute||`_no_route`,``,n,r?.id??`app-header-action`,{},e.serverSideType??``,{},{},r??t,!0,void 0,!1,``)},dl=async(e,t,n)=>{try{await ul(e,t,n)}catch(e){No({text:`La acción falló: `+e,position:`bottomStart`,duration:6e3,variant:`error`},t)}},fl=(e,t)=>{let n=e.contextSelectors??[],r=e.contextActions??[];return n.length===0&&r.length===0&&!e.notificationsEnabled?y:T`${e.notificationsEnabled?T`
        ...
        <details class="mateu-nav-group" style="margin-left: 0.5rem; flex-shrink: 0;">
            ...
            <div class="mateu-nav-panel" style="right: 0; left: auto;">
                ${n.children.map(n=>T`
                    <button class="mateu-nav-item" @click="${()=>n.actionId&&dl(e,t,n.actionId)}">${n.label}</button>`)}
            </div>
        </details>`:T`
        <button class="app-header-action-btn" style="margin-left: 0.5rem; flex-shrink: 0;"
            @click="${()=>n.actionId&&dl(e,t,n.actionId)}" title="${n.label}">${n.icon?F(n.icon):y}${n.label}</button>`)}`},pl=(e,t)=>T`
    <button class="mateu-nav-item ${e.selected?`mateu-nav-item--active`:``}"
            ?disabled="${e.disabled}"
            @click="${()=>t(e)}">${e.text}</button>`,ml=(e,t,n=``)=>T`
    ...
    </nav>`,hl=(e,t)=>n=>t.call(e,{detail:{value:n}}),gl=(e,t)=>e.themeToggle?T`
    ...
    `:y,_l=(e,t)=>{t.filter!=e.detail.value&&(t.filter=e.detail.value)},vl=(e,t,n)=>{let r=yl(e,t,n),i=Z(t,n);return r==`list`||r==i?`new`:r},yl=(e,t,n)=>{let r=e?._route;if(r!=null&&(r===``||r.startsWith(`/`))){let e=n.homeRoute??``,i=e.indexOf(`?`),a=i>=0?e.substring(i+1):``,o=Z(t,n)+r;return a?o+(o.indexOf(`?`)>=0?`&`:`?`)+a:o}return t.selectedRoute?t.selectedRoute:n.homeRoute},Z=(e,t)=>e.selectedRoute?e.selectedConsumedRoute??t.route:t.homeConsumedRoute,bl=(e,t)=>e.selectedRoute?e.selectedBaseUrl??e.baseUrl:e.baseUrl||t.homeBaseUrl,xl=(e,t)=>e.selectedRoute?e.selectedServerSideType??t.serverSideType:t.homeServerSideType,Sl=(e,t)=>e.selectedRoute?e.selectedUriPrefix:t.homeUriPrefix,Cl=(e,t)=>`ux_`+((Z(e,t)||`root`)+`|`+(xl(e,t)??``)).replace(/[^a-zA-Z0-9]/g,`_`),wl=(e,t,n,r,i,a,o)=>{t.variant!==Nt.MENU_ON_TOP&&t.menu?.some(e=>e.remote)&&(t={...t,variant:Nt.MENU_ON_TOP});let s=Cl(e,t);if(t.chromeless)return T`
        ...
        `;let c=e.mapItems(t.menu,e.filter?.toLowerCase()??``),l=Z(e,t),u=vl(r,e,t),d=u&&u!==`new`&&u.startsWith(l+`/`)?u.substring(l.length+1).split(`/`)[0]:void 0;return T`
                    ${t.variant==Nt.MEDIATOR?T`
...
`:y}
            ${t.variant==Nt.HAMBURGUER_MENU?T`
                            ...
                            ${t.menu&&t.totalMenuOptions>10?T`
                                <div style="position: sticky; top: 0; z-index: 2; background: var(--lumo-base-color); padding: .25rem 0 .5rem;">
                                    <input class="drawer-search" placeholder="Search…" style="width: calc(100% - 20px); margin: 0 10px;"
                                           @input="${t=>_l({detail:{value:t.target.value}},e)}">
                                </div>
                                `:y}
                            <nav class="side-nav">
            ...
            ${t.variant==Nt.MENU_ON_TOP?T`
                <div class="m-vl" style="width: 100%; height: 100vh; overflow: hidden;">
                    <div class="m-hl"
                        ...
                        ${(()=>{let t=hl(e,e.itemSelected);return N.get()?.renderTopNav?.(c,t,`menu-on-top`)??ml(c,t,`menu-on-top`)})()}
            ...
            ${t.variant==Nt.TILES?T`
                <div class="m-vl" style="width: 100%; height: 100vh; overflow: hidden;">
                    <div class="m-hl"
                        ...
                        ${ml(e.mapItemsForTiles(t.menu),hl(e,e.itemSelectedTiles),`menu-on-top`)}
                        <div class="m-hl" style="margin-left: auto; flex-shrink: 0; align-items: center;">
                            <slot name="widgets"></slot>
                            ${fl(t,e)}${gl(t,e)}
                        </div>
            ...
            <slot></slot>
       `},Tl=class{renderFilterBar(e,t,n,r,i,a,o,s){let c=t?.metadata;return T`
            <mateu-filter-bar
                .metadata="${c}"
        ...
        ></mateu-pagination>
        `}renderTableComponent(e,t,n,r,i,a,o){return Dr(t,(e.data?.[e.id])?.page?.content??[],r[t?.id]?.emptyStateMessage)}rendererName(){return this.constructor?.name??`unknown`}supportedClientSideTypes(){}renderClientSideComponent(e,t,n,r,i,a,o,s){let c=t?.metadata?.type??t?.type,l=Object.values(j).includes(c)?c:void 0;return no(this.supportedClientSideTypes(),l)?oo(t,l,this.rendererName()):Do(e,t,n,r,i,a,o,s)}renderAppComponent(e,t,n,r,i,a,o){return wl(e,t?.metadata,n,r,i,a,o)}},El=(e,t,n,r,i,a,o)=>T`
        <vaadin-virtual-list
                ...
                slot="${t.slot??y}"
        ></vaadin-virtual-list>
    `,Dl=e=>{let t=e.metadata;return T`
        <vaadin-notification
                .opened="${!0}"
                slot="${e.slot??y}"
                style="${e.style}"
                ...
                `,[])}
        ></vaadin-notification>
    `},Ol=(e,t={})=>{let n=e.metadata,r=n.valueKey?t[n.valueKey]:n.value;return T`
        <div style="${e.style}">
        <vaadin-progress-bar
    ...
    `},kl=(e,t,n,r,i,a,o)=>{let s=t.metadata;return T`
        <vaadin-details
                ?opened="${s.opened}"
                style="${t.style}"
                class="${t.cssClasses}"
        ...
        >
            ...
            `},Al=(e,t,n)=>{let r=e.metadata;return T`<vaadin-avatar
            img="${r.image}"
            name="${Zt(r.name,t,n)}"
            abbr="${r.abbreviation}"
            style="${e.style}" class="${e.cssClasses}"
            slot="${e.slot??y}"
    ></vaadin-avatar>`},jl=e=>{let t=e.metadata;return T`<vaadin-avatar-group max-items-visible="${t.maxItemsVisible}"
                                     .items="${t.avatars}"
                                     style="${e.style}" class="${e.cssClasses}"
                                     slot="${e.slot??y}">
    </vaadin-avatar-group>`},Ml=(e,t,n,r,i,a,o)=>{let s=t.metadata;if(!s)return T``;let c=``;return s.variants?.map(e=>e==`stretchMedia`?`stretch-media`:e==`coverMedia`?`cover-media`:e).forEach(e=>c+=` `+e),c=c.trim(),T`
        <vaadin-card
                style="${t.style}"
                class="${t.cssClasses}"
                theme="${c}"
    ...
    `}render(){return T`
        ...
        `}};k([b({type:Array})],Pl.prototype,`tabLabels`,void 0),k([w()],Pl.prototype,`mode`,void 0),k([w()],Pl.prototype,`selected`,void 0),Pl=k([_(`mateu-adaptive-tabs`)],Pl);var Fl=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style;c??=``,s.columnSpacing&&(c+=`--vaadin-form-layout-column-spacing: `+s.columnSpacing+`;`);let l=s.itemRowSpacing&&s.itemRowSpacing!==`0`?s.itemRowSpacing:`var(--lumo-space-m)`;return c+=`--vaadin-form-layout-row-spacing: `+l+`;`,s.itemLabelSpacing&&(c+=`--vaadin-form-layout-label-spacing: `+s.itemLabelSpacing+`;`),s.labelsAside&&(c+=`--vaadin-form-item-label-width: 10rem;`),s.fullWidth&&(c+=`width: 100%;`),T`
            ...
            `},Il=(e,t,n,r,i,a,o,s)=>n.type==A.ClientSide&&n.metadata?.type==j.FormRow?Rl(e,t,n,r,i,a,o,s):e.labelsAside?Ll(t,n,r,i,a,o,s):P(t,n,r,i,a,o,s),Ll=(e,t,n,r,i,a,o)=>{if(t.type==A.ClientSide&&t.metadata?.type==j.FormField&&t.metadata.label){let s=t.metadata,c=s.label?.includes("${")?e._evalTemplate(s.label):s.label;return T`
                       <vaadin-form-item data-colspan="${s.colspan}">
                           <label slot="label">${c}</label>
                           ${P(e,t,n,r,i,a,o,!0)}
                       </vaadin-form-item>
                   `}return P(e,t,n,r,i,a,o)},Rl=(e,t,n,r,i,a,o,s)=>T`
        <vaadin-form-row>
            ${n.children?.map(n=>Il(e,t,n,r,i,a,o,s))}
        </vaadin-form-row>
            `,zl=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=(s.padding?` padding`:``)+(s.spacing?` spacing`:``)+(s.spacingVariant?` spacing-`+s.spacingVariant:``)+(s.wrap?` wrap`:``),l=t.style;return s.fullWidth&&(l=l?`width: 100%;`+l:`width: 100%;`),s.justification&&(l=l?`justify-content: `+s.justification+`;`+l:`justify-content: `+s.justification+`;`),s.verticalAlignment&&(l=l?`align-items: `+s.verticalAlignment+`;`+l:`align-items: `+s.verticalAlignment+`;`),T`
               <vaadin-horizontal-layout 
                       style="${l}" 
                       class="${t.cssClasses}"
                       theme="${c}"
    ...
    `},Vl=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style;return s.fullWidth&&(c=c?`width: 100%;`+c:`width: 100%;`),T`
               <vaadin-split-layout 
                       style="${c}" 
                       class="${t.cssClasses}"
            ...
            `},Hl=(e,t,n,r,i,a,o)=>{let s=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,l=!!i?.hasDetail||!!s,u=c??s;return T`
        ...
        >
            ...
            ${t.children?.map(t=>Wl(e,t,n,r,i,a,o))}
        </vaadin-tabsheet>
            `},Wl=(e,t,n,r,i,a,o)=>{let s=t.metadata.label;return T`
        <div tab="${s?.includes("${")?e._evalTemplate(s):s}" style="padding: var(--lumo-space-m) 0;">
            ...
            `},Gl=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style;s.fullWidth&&(c=c?`width: 100%;`+c:`width: 100%;`);let l=0;if(t.children){for(let e=0;e<t.children.length;e++)if(t.children[e].metadata?.active){l=e;break}}return T`
               <vaadin-accordion
                       ...
                       slot="${t.slot??y}"
               >
                   ${t.children?.map(t=>Kl(e,t,n,r,i,a,o,s.variant))}
               </vaadin-accordion>
            `},Kl=(e,t,n,r,i,a,o,s)=>{let c=t.metadata,l=c.label?.includes("${")?e._evalTemplate(c.label):c.label;return T`
    ...
    </vaadin-menu-bar>`,Ql=(e,t,n,r,i,a,o)=>{let s=t.metadata;return T`
        <vaadin-context-menu .items=${tu(e,s.menu,n,r,i,a,o)} 
                             style="${t.style}" 
                             class="${t.cssClasses}"
    ...
    `}};k([b()],su.prototype,`fieldId`,void 0),k([b()],su.prototype,`value`,void 0),k([b()],su.prototype,`accept`,void 0),k([b({type:Boolean})],su.prototype,`editable`,void 0),su=au=k([_(`mateu-file-upload`)],su);var cu=e=>e==null||typeof e==`string`&&e.trim()===``,lu=(e,t)=>{if(cu(e))return null;let n=t?parseInt(String(e),10):Number(e);return Number.isNaN(n)?null:n},uu=(e,t)=>cu(e)&&cu(t)?!0:e==t,du=e=>!!e&&typeof e==`object`&&`__mateuGroup`in e,fu=e=>String(e??``),pu=(e,t,n)=>{let r=e??[];if(!t||!n||n.length===0)return r;let i=[],a,o=!1;return r.forEach((e,s)=>{let c=fu(e?.[t]);if(!o||c!==a){let e=n.find(e=>fu(e.value)===c)??{value:c,count:r.filter(e=>fu(e?.[t])===c).length,aggregates:{}};i.push({__mateuGroup:e,__mateuGroupBy:t,_rowNumber:`__mateuGroup:${s}:${c}`}),o=!0,a=c}i.push(e)}),i},mu=(e,t)=>e==null?``:t.dataType===`money`||t.stereotype===`money`?new Intl.NumberFormat(`de-DE`,{minimumFractionDigits:2,maximumFractionDigits:2}).format(e):t.aggregate===`count`?new Intl.NumberFormat(void 0,{maximumFractionDigits:0}).format(Math.round(e)):new Intl.NumberFormat(void 0,{maximumFractionDigits:2}).format(e),hu=(e,t)=>e&&t.includes(e)?e:t.find(e=>!!e),gu=(e,t,n)=>{let r=e.__mateuGroup;return t.id===n?`${r.value} (${r.count})`:t.aggregate?mu(r.aggregates?.[t.id],t):``},_u=(e,t,n)=>{let r=t?.aggregates;if(!r||!e.some(e=>e.aggregate))return;let i={};e.forEach(e=>{e.aggregate&&r[e.id]!=null&&(i[e.id]=mu(r[e.id],e))});let a=e[0];if(a&&i[a.id]===void 0){let e=t?.page?.totalElements;i[a.id]=n&&a.id===n&&e!=null?`Total (${e})`:`Total`}return i},vu=(e,t,n)=>{let r=e[n.path]??``,i=t.captionPath?e[t.captionPath]:void 0,a=t.leadingPath?e[t.leadingPath]:void 0;return T`
        <span style="display: flex; align-items: center; gap: var(--lumo-space-s); overflow: hidden;">
            ${a?T`<img src="${a}" alt="" loading="lazy"
            ...
            <span style="display: flex; flex-direction: column; overflow: hidden;">
                ...
                ${i?T`<span style="color: var(--lumo-secondary-text-color); font-size: var(--lumo-font-size-s); overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${i}</span>`:y}
            </span>
        </span>`},yu=(e,t,n)=>F(e[n.path]?`vaadin:check`:`vaadin:minus`,`height: 16px; width: 16px; color: var(--lumo-body-text-color);`),bu=(e,t,n,r,i)=>{let a=e[n.path],o=a;return r==`money`&&a&&a.locale&&a.currency?o=new Intl.NumberFormat(a.locale,{style:`currency`,currency:a.currency}).format(a.value):i==`money`&&(o=new Intl.NumberFormat(`de-DE`,{minimumFractionDigits:2,maximumFractionDigits:2}).format(a)),T`${o}`},xu=(e,t,n)=>{e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId,parameters:n},bubbles:!0,composed:!0}))},Su=(e,t,n,r,i,a)=>{let o=n.xcolumn??a;if(o.text)return o.actionId?T`<a href="javascript: void(0);" @click="${t=>xu(n,o,e)}">${o.text}</a>`:T`<a href="${e[n.path]}">${o.text}</a>`;if(r==`string`){if(o.actionId)return T`<a href="javascript: void(0);" @click="${t=>xu(n,o,e)}">${e[n.path]}</a>`;let t=e[n.path];return T`<a href="${t}">${t}</a>`}let s=e[n.path];return T`<a href="${s.href}">${s.text}</a>`},Cu=(e,t,n,r,i)=>{let a=e[n.path];return r==`string`?a.split(`,`).map(e=>F(e,`width: 16px;`)):a.split(`,`).map(e=>F(e.icon,`width: 16px;`))},wu=(e,t,n,r,i)=>{let a=e[n.path];return T`${v(a)}`},Tu=(e,t,n,r,i,a)=>r==`string`?T`<img src="${e[n.path]}" style="${`max-height: 40px; `+(a.style??``)}">`:T`<img src="${e[n.path].src}" style="${a.style??``}">`,Eu=e=>{let t={_clickedRow:e.target.row};e.target?.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:`action-on-row-`+e.detail.value.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},Du=e=>{let t={_clickedRow:e.target.row},n=e.target.action;e.target?.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:`action-on-row-`+n.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},Ou=e=>{let t=document.createElement(`vaadin-context-menu-item`),n=document.createElement(`vaadin-icon`);return n.style.color=`var(--lumo-secondary-text-color)`,n.style.marginInlineEnd=`var(--lumo-space-s)`,n.style.padding=`var(--lumo-space-xs)`,n.setAttribute(`icon`,e.icon),t.appendChild(n),e.label&&t.appendChild(document.createTextNode(e.label)),t.disabled=e.disabled,t},ku=(e,t,n)=>{let r=e[n.path]?.actions?.map(e=>e.icon?{component:Ou(e),methodNameInCrud:e.methodNameInCrud}:{...e,text:e.label});return!r||r.length==0?T``:T`
                                     <vaadin-menu-bar
    ...
    `:T``},ju=(e,t,n)=>{e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId,parameters:n},bubbles:!0,composed:!0}))},Mu=(e,t,n,r,i,a)=>{let o=n.xcolumn??a;if(o.actionId)return T`
            <vaadin-button theme="tertiary" @click="${t=>ju(n,o,e)}" .row="${e}">
                ${o.text||e[n.path]}
            </vaadin-button>
        `;let s=e[n.path];return T`<a href="${s}">${o.text||s}</a>`},Nu=(e,t,n,r,i,a,o,s,c)=>{let l=e[n.path];return P(r,l,i,a,o,s,c)},Pu=new WeakMap,Fu=(e,t)=>Pu.get(e)?.[t],Iu=(e,t,n)=>{let r=Pu.get(e);r||(r={},Pu.set(e,r)),r[t]=n},Lu=(e,t=!1)=>lu(e,t),Ru=(e,t,n,r)=>{let i=n?.field?.fieldId,a=a=>{if(e[t.id]===a||e[t.id]==null&&(a===``||a==null))return;if(e[t.id]=a,!i){n.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:`update-row`,parameters:{_editedRow:{...e}}},bubbles:!0,composed:!0}));return}let o=(n?.state??r)[i];n.dispatchEvent(new CustomEvent(`value-changed`,{detail:{fieldId:i,value:Array.isArray(o)?[...o]:o},bubbles:!0,composed:!0}))},o=e[t.id],s=o==null?``:String(o);switch(t.editorType){case`boolean`:return T`<vaadin-checkbox ?checked=${!!o} @checked-changed=${e=>a(e.detail.value)}></vaadin-checkbox>`;case`integer`:return T`<vaadin-integer-field theme="small" style="width:100%;" .value=${s} @change=${e=>a(Lu(e.target.value,!0))}></vaadin-integer-field>`;case`number`:return T`<vaadin-number-field theme="small" style="width:100%;" .value=${s} @change=${e=>a(Lu(e.target.value))}></vaadin-number-field>`;case`date`:return T`<vaadin-date-picker theme="small" style="width:100%;" .value=${s} @value-changed=${e=>a(e.detail.value)}></vaadin-date-picker>`;case`time`:return T`<vaadin-time-picker theme="small" style="width:100%;" .value=${s} @value-changed=${e=>a(e.detail.value)}></vaadin-time-picker>`;case`datetime`:return T`<vaadin-date-time-picker theme="small" style="width:100%;" .value=${s} @value-changed=${e=>a(e.detail.value)}></vaadin-date-time-picker>`;case`select`:return T`<vaadin-combo-box
                ...
                .selectedItem=${(t.editorOptions??[]).find(e=>String(e.value)===s)??(s?{value:s,label:Fu(e,t.id)??s}:void 0)}
                @selected-item-changed=${n=>{let r=n.detail.value,i=r?r.value:null;String(i??``)!==s&&(r&&Iu(e,t.id,r.label),a(i))}}></vaadin-combo-box>`}default:return T`<vaadin-text-field theme="small" style="width:100%;" .value=${s} @change=${e=>a(e.target.value)}></vaadin-text-field>`}},zu=e=>m(()=>T`<span title="${e}" style="white-space:normal;overflow-wrap:break-word;">${e}</span>`,[e]),Bu=e=>e===void 0?y:d(()=>T`<span style="font-weight: 600; white-space: nowrap;">${e}</span>`,[e]),Vu=e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget?.dispatchEvent(new CustomEvent(`sort-direction-changed`,{detail:{grid:e.currentTarget.parentElement},bubbles:!0,composed:!0}))},Hu=(e,t,n,r,i,a,o,s)=>T`
<vaadin-grid-column-group header="${M(e.label,r,i)}">
    ${e.columns.map(e=>Wu(e.metadata,t,n,r,i,a,o,s?.[e.metadata?.id]))}
</vaadin-grid-column-group>
`,Uu=(e,t,n,r,i,a,o,s)=>j.GridGroupColumn==e.metadata?.type?Hu(e.metadata,t,n,r,i,a,o,s):Wu(e.metadata,t,n,r,i,a,o,s?.[e.metadata?.id]),Wu=(e,n,r,i,a,o,s,c)=>{let l=M(e.label,i,a);return e.sortable?T`
                    ...
                    `:T`
                        <vaadin-grid-column
                                ...
                                ${t((t,c,l)=>Gu(t,c,l,e,n,r,i,a,o,s),[e,i,a])}
                        ></vaadin-grid-column>
                    `},Gu=(e,t,n,r,i,a,o,s,c,l)=>{let u=n.dataset.dataType??``,d=n.dataset.stereotype??``;if(du(e)){let t=i?.metadata,n=(t?.columns??[]).flatMap(e=>e?.metadata?.type===j.GridGroupColumn?(e.metadata.columns??[]).map(e=>e?.metadata?.id):[e?.metadata?.id]),a=gu(e,r,hu(e.__mateuGroupBy,n)),o=e.__mateuGroup.hiddenActions??[],s=r.id===n[n.length-1]?(t?.groupActions??[]).filter(e=>!o.includes(e.actionId??e.id)):[];return s.length?T`<span style="display: flex; align-items: center; justify-content: flex-end; gap: var(--lumo-space-s); overflow: hidden;">
                ...
                `)}
            </span>`:T`<span title="${a}" style="font-weight: 600; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; display: block;">${a}</span>`}if(r.editable)return Ru(e,r,i,o);if(u==`status`)return ko(e,t,n);if(d==`primary`)return vu(e,r,n);if(u==`bool`)return yu(e,t,n);if(u==`money`||d==`money`)return bu(e,t,n,u,d);if(u==`link`||d==`link`)return Su(e,t,n,u,d,r);if(u==`icon`||d==`icon`)return Cu(e,t,n,u,d);if(d==`html`)return wu(e,t,n,u,d);if(d==`image`)return Tu(e,t,n,u,d,r);if(u==`menu`)return ku(e,t,n);if(u==`component`)return Nu(e,t,n,i,a,o,s,c,l);if(u==`action`)return Au(e,t,n);if(u==`actionGroup`)return ku(e,t,n);if(d==`button`||r.actionId)return Mu(e,t,n,u,d,r);let f=e[n.path],p=i?.metadata?.rowRoute;if(r.identifier&&p){let t=on(p,e,o,s);if(t)return T`<a href="${`/`+t.replace(/^\/+/,``)}" title="${f}"
    ...
    `}};k([b()],Ju.prototype,`field`,void 0),k([b()],Ju.prototype,`state`,void 0),k([b()],Ju.prototype,`data`,void 0),k([b()],Ju.prototype,`appState`,void 0),k([b()],Ju.prototype,`appData`,void 0),k([b()],Ju.prototype,`selectedItems`,void 0),k([w()],Ju.prototype,`detailsOpenedItems`,void 0),Ju=k([_(`mateu-grid`)],Ju);var Yu=class extends x{constructor(...e){super(...e),this.getNewValue=e=>{if(this.field?.dataType==`array`){if(!this.value)return[e];let t=this.value;return t.indexOf(e)>=0?t.filter(t=>t!==e):[...t,e]}return e}}render(){let e=this.field?.options;if(this.field?.remoteCoordinates){let t=this.field.remoteCoordinates;this.data?.[this.field.fieldId]&&this.data[this.field.fieldId].content&&this.data[this.field.fieldId].totalElements?e=this.data[this.field.fieldId].content:this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.action,parameters:{searchText:``,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0}))}return T`
       ...
       `}static{this.styles=g`
        ...
        ${R}
    `}};k([b()],Yu.prototype,`field`,void 0),k([b()],Yu.prototype,`baseUrl`,void 0),k([b()],Yu.prototype,`state`,void 0),k([b()],Yu.prototype,`data`,void 0),k([b()],Yu.prototype,`value`,void 0),Yu=k([_(`mateu-choice`)],Yu);var Xu,Zu=class extends x{static{Xu=this}constructor(...e){super(...e),this.commit=e=>{this.value=e,this.dispatchEvent(new CustomEvent(`value-changed`,{detail:{value:{...e},fieldId:this.fieldId}}))},this.currencyChanged=e=>{let t=this.value??Xu.EMPTY;!e.detail.value||e.detail.value===t.currency||this.commit({...t,currency:e.detail.value})},this.valueChanged=e=>{let t=this.value??Xu.EMPTY,n=lu(e.detail.value,!1)??0;n!==t.value&&this.commit({...t,value:n})}}static{this.EMPTY={value:0,currency:`EUR`,locale:`es-ES`}}render(){return T`
            <vaadin-number-field
                    id="${this.fieldId}"
                    label="${this.label}"
...
`,this.filteredIcons=[],this.navLinkOffset=null,this.iconFilterChanged=e=>{this.filteredIcons=Qu.filter(t=>!e.detail.value||t.indexOf(e.detail.value)>=0)}}loadUi5FieldComponents(){this.ui5FieldComponentsReady||ed().then(()=>{this.ui5FieldComponentsReady=!0})}remoteComboDataProvider(e){return(t,n)=>{let{filter:i,page:a,pageSize:o}=t,s=i??``;this._comboFilter=s,this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e,parameters:{searchText:i,fieldId:this.field?.fieldId,size:o,page:a,sort:void 0},callback:e=>{if(s===this._comboFilter)if(e?.messages?.forEach(e=>{r.show(e.text,{position:e.position?this.mapPosition(e.position):void 0,theme:e.variant,duration:e.duration})}),!e.fragments||e.fragments.length==0)this.comboData=[],n([],0);else{let t=e.fragments[0].data?.[this.id];this.comboData=t?.content,n(t?.content,t?.totalElements)}},callbackonly:!0},bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.rendered=!1}renderNavLink(){let e=this.field?.link;if(!e?.href)return y;let t=M(e.href,this.state,this.data)??e.href,n=M(e.title,this.state,this.data)||t,r=e.icon||(t.startsWith(`http`)?`vaadin:external-link`:`vaadin:link`),i=this.navLinkOffset??`calc(var(--lumo-font-size-s) * 1.6 + (var(--lumo-size-m) - var(--lumo-icon-size-s)) / 2)`;return T`<a
        ...
        ><vaadin-icon icon="${r}" style="width: var(--lumo-icon-size-s); height: var(--lumo-icon-size-s);"></vaadin-icon></a>`}positionNavLink(){let e=this.renderRoot?.querySelector(`a[data-navlink]`);e&&setTimeout(()=>{let t=e.parentElement,n=t?.firstElementChild?.firstElementChild;if(!t||!n)return;let r=(n.shadowRoot?.querySelector(`[part="input-field"]`)??n).getBoundingClientRect();if(r.height===0)return;let i=Math.max(0,r.top+r.height/2-e.offsetHeight/2-t.getBoundingClientRect().top),a=`${Math.round(i)}px`;this.navLinkOffset!==a&&(this.navLinkOffset=a)})}helperText(){return this.helperShownInControl=!0,Zt(this.field?.description??``,this.state,this.data)??``}fieldErrors(){let e=this.field?.fieldId??``,t=this.data?.errors?.[e];return Array.isArray(t)?t.filter(e=>!!e):[]}validatableControl(){let e=this.renderRoot.querySelectorAll(`*`);for(let t of e)if(`invalid`in t&&`errorMessage`in t)return t;return null}applyValidationState(){let e=this.fieldErrors(),t=this.validatableControl();if(!t){this.lastAnnouncedError=e.join(`. `);return}let n=e.join(`. `);if(t.errorMessage=n,t.invalid=e.length>0,n&&n!==this.lastAnnouncedError){let e=(this.field?.label??``).toString().trim();Rt(e?`${e}: ${n}`:n,{politeness:`assertive`})}this.lastAnnouncedError=n}render(){this.rendered=!0;let e=this.renderNavLink();this.helperShownInControl=!1;let t=this.renderField(),n=this.field?.description&&!this.helperShownInControl?Zt(this.field.description,this.state,this.data):void 0,r=this.fieldErrors(),i=r.length>0&&!this.controlOwnsValidity;return T`<div style="display: block;">
            ...
            >${d?T`<span style="color: var(--lumo-secondary-text-color, #888); white-space: nowrap;">${r}</span>`:y}${u}</div>`}renderBulletedListField(e,t,n,r){if(!this.field)return T``;let i=Zt(t,this.state,this.data),a=Array.isArray(i)?i.map(e=>String(e)):i!=null&&i!==``?[String(i)]:[];return T`<vaadin-custom-field
                    id="${this.field.fieldId}"
                    label="${n}"
                    .helperText="${this.helperText()}"
                    data-colspan="${this.field?.colspan}"
            ...
            </vaadin-custom-field>`}renderPlainTextField(e,t,n,r){if(!this.field)return T``;let i=Zt(t,this.state,this.data),a=i&&typeof i==`object`&&`value`in i?i:null;i&&i.value&&(i=i.value);let o=this.field?.dataType==`bool`||i===!0||i===!1,s=this.field?.dataType==`money`,c=i!=null&&i!==``,l=c?String(i):`—`;if(s&&c){let e=typeof i==`number`?i:parseFloat(String(i));isNaN(e)||(l=a&&a.locale&&a.currency?new Intl.NumberFormat(a.locale,{style:`currency`,currency:a.currency}).format(e):new Intl.NumberFormat(`de-DE`,{minimumFractionDigits:2,maximumFractionDigits:2}).format(e))}let u=o?T`<vaadin-icon icon="${i===!0||i===`true`?`vaadin:check`:`vaadin:minus`}" style="height: 16px; width: 16px;"></vaadin-icon>`:this.field?.multiline?T`<span style="font-weight: 500; white-space: pre-wrap; word-break: break-word;">${l}</span>`:T`<span style="font-weight: 500; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;${s?` font-variant-numeric: tabular-nums;`:``}">${l}</span>`;return T`<vaadin-custom-field
                    id="${this.field.fieldId}"
                    label="${n}"
                    data-colspan="${this.field?.colspan}"
                    style="${s?`text-align: right; `:``}${this.field?.style}"
            >${u}</vaadin-custom-field>`}renderReadOnlyField(e,t,n,r){if(!this.field)return T``;let i=Zt(t,this.state,this.data)||this.data[e];if(i&&i.value&&(i=i.value),this.field.stereotype==`fileUpload`)return T`<vaadin-custom-field
                        id="${this.field.fieldId}"
                        label="${n}"
                        .helperText="${this.helperText()}"
                        data-colspan="${this.field.colspan}"
...
`}copyValue(e){navigator.clipboard.writeText(e).then(()=>r.show(`Copied`,{position:`bottom-end`,theme:`success`,duration:2e3})).catch(()=>{})}renderFileField(e,t,n,r){if(!this.field)return T``;let i=t?.map(e=>({id:e.id,name:e.name,type:``,uploadTarget:``,complete:!0}))??[];return T`
            ...
            `}renderStringField(e,t,n,r){if(!this.field)return T``;if(this.field?.stereotype==`searchable`)return T`
              ...
              ${e.description}
                ...
                `;if(this.field?.stereotype==`fileUpload`){let e=ou(this.field.attributes,`accept`);return T`
                    <vaadin-custom-field
                            id="${this.field.fieldId}"
                            label="${n}"
                            .helperText="${this.helperText()}"
...
`;if(this.field?.stereotype==`listBox`){if(this.field?.remoteCoordinates){let e=this.field.remoteCoordinates;return this.data[this.id]&&this.data[this.id].searchSignature&&this.data[this.id].searchSignature!=``&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements||this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.action,parameters:{searchText:``,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0})),T`
            ...
            ></mateu-money-field>`}renderStatusField(e,t,n,r){if(!this.field)return T``;let i=t;return T`
                <vaadin-custom-field
                        ...
                        data-colspan="${this.field.colspan}"
                >
                    ${i?T`<span theme="badge pill ${Ao(i.type)}">${i.message}</span>`:T``}                    
                </vaadin-custom-field>
  ...
  `}};k([w()],Q.prototype,`ui5FieldComponentsReady`,void 0),k([b()],Q.prototype,`component`,void 0),k([b()],Q.prototype,`field`,void 0),k([b()],Q.prototype,`baseUrl`,void 0),k([b()],Q.prototype,`state`,void 0),k([b()],Q.prototype,`data`,void 0),k([b()],Q.prototype,`appState`,void 0),k([b()],Q.prototype,`appData`,void 0),k([b()],Q.prototype,`labelAlreadyRendered`,void 0),k([w()],Q.prototype,`colorPickerOpened`,void 0),k([w()],Q.prototype,`colorPickerValue`,void 0),k([w()],Q.prototype,`controlOwnsValidity`,void 0),k([w()],Q.prototype,`filteredIcons`,void 0),k([w()],Q.prototype,`navLinkOffset`,void 0),Q=k([_(`mateu-field`)],Q);var td=(e,t,n,r,i,a,o,s)=>{let c=t.metadata;return T`
        <mateu-field
                ...
                .appState="${a}"
                .appdata="${o}"
                style="${wo(t,i)}" class="${t.cssClasses}"
                slot="${t.slot??y}"
    ...
    `},nd=(e,n,r,i,a,o,s)=>{let c=n.metadata;if(c.tree)return T`
...
`})}
    ...
    `},$=class extends x{constructor(...e){super(...e),this.id=``,this.baseUrl=``,this.state={},this.data={},this.appState={},this.appData={},this.detailsOpenedItems=[],this.pagesRequested=[],this._lastGridHeight=0,this.emptyArray=e=>!e||e.length==0,this.dataProvider=(e,t)=>{let n=this.data[this.id]?.page;if(this.metadata?.infiniteScrolling&&e.page>0){let r=!1;n&&n.content&&(n.content.length>=(e.page+1)*e.pageSize||n.content.length==n.totalElements)&&(t(n.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),n.totalElements),r=!0,this.grid&&this.grid.recalculateColumnWidths()),r||this.pagesRequested.find(t=>t==e.page)||(this.pagesRequested.push(e.page),this.dispatchEvent(new CustomEvent(`fetch-more-elements`,{detail:{params:e,callback:()=>{this.data[this.id]?.page?.content&&(t(this.data[this.id].page.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),this.data[this.id].page.totalElements),this.grid&&this.grid.recalculateColumnWidths())}},bubbles:!0,composed:!0})))}else{let e=this.metadata?.infiniteScrolling?n?.totalElements:n?.content?.length??0;t(n?.content??[],e),this.grid&&this.grid.recalculateColumnWidths()}},this._onActionRequested=e=>{let t=e.detail,n=this.identifierFieldName;if(!n||!t.parameters||t.actionId?.startsWith(`action-on-row-`))return;let r=t.parameters[n];r!==void 0&&(this.state._selectedId=String(r),this._applyCellPartNameGenerator(),this.grid?.requestContentUpdate())},this.tooltipGenerator=e=>{let t=``,{column:n,item:r}=e,i=this.metadata?.columns?.find(e=>e.metadata.id==n?.path);if(i?.metadata){let e=(i?.metadata).tooltipPath;e&&n&&r&&(t=r[e])}return t}}get identifierFieldName(){let e=this.metadata?.columns?.find(e=>e.metadata?.identifier);if(e)return e.metadata?.id;if(this.metadata?.columns?.find(e=>e.metadata?.id===`id`))return`id`}_applyCellPartNameGenerator(){if(!this.grid)return;let e=this.identifierFieldName,t=this.state?._selectedId??this.appState?._splitDetailId,n=!!this.metadata?.groupBy;e&&t!==void 0||n?this.grid.cellPartNameGenerator=(n,r)=>{let i=r.item;return du(i)?`mateu-group-row`:e&&t!==void 0&&String(i[e])===String(t)?`selected-row`:``}:this.grid.cellPartNameGenerator=null}connectedCallback(){super.connectedCallback(),this.addEventListener(`action-requested`,this._onActionRequested)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`action-requested`,this._onActionRequested),this._resizeObserver?.disconnect(),this._resizeObserver=void 0}firstUpdated(){let e=this.grid;!e||this._resizeObserver||(this._resizeObserver=new ResizeObserver(()=>{let t=e.offsetHeight;t>0&&this._lastGridHeight===0&&requestAnimationFrame(()=>{e.recalculateColumnWidths(),e.requestContentUpdate(),e.notifyResize?.()}),this._lastGridHeight=t}),this._resizeObserver.observe(e))}updated(e){super.updated(e),this._applyCellPartNameGenerator(),this.grid?.clearCache(),this.grid?.requestContentUpdate(),this.grid?.recalculateColumnWidths(),this.pagesRequested=[]}navigateToRowRoute(e){let t=(this.shadowRoot?.querySelector(`vaadin-grid`))?.getEventContext?.(e)?.item;if(!t||du(t)||e.composedPath().some(e=>e?.tagName&&/^(A|BUTTON|INPUT|VAADIN-BUTTON|VAADIN-CHECKBOX)$/.test(e.tagName)))return;let n=on(this.metadata?.rowRoute,t,this.state,this.data);n&&sn(this,n)}render(){let e=this.data[this.id],r=e?.page,i=this.metadata?.groupBy,a=this.metadata?.infiniteScrolling?void 0:r?.content?pu(r.content,i,e?.groups):r?.content,o=_u((this.metadata?.columns??[]).flatMap(e=>e.metadata?.type===j.GridGroupColumn?(e.metadata.columns??[]).map(e=>e.metadata):[e.metadata]),e,i),s=``;return this.metadata?.wrapCellContent&&(s+=` wrap-cell-content`),this.metadata?.compact&&(s+=` compact`),this.metadata?.noBorder&&(s+=` no-border`),this.metadata?.noRowBorder&&(s+=` no-row-borders`),this.metadata?.columnBorders&&(s+=` column-borders`),this.metadata?.rowStripes&&(s+=` row-stripes`),T`
            <vaadin-grid
                    ...
                    @selected-items-changed="${e=>{let t=(e.detail.value??[]).filter(e=>!du(e));this.emptyArray(this.state[this.id+`_selected_items`])&&this.emptyArray(t)||(this.state[this.id+`_selected_items`]=t,this.metadata?.onRowSelectionChangedActionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.metadata?.onRowSelectionChangedActionId},bubbles:!0,composed:!0})))}}"
                    @active-item-changed="${C(this.metadata?.detailPath&&!this.metadata?.useButtonForDetail?e=>{let t=e.detail.value;t&&du(t)||(this.detailsOpenedItems=t?[t]:[])}:void 0)}"
            ...
            `,[])}
                    ></vaadin-grid-column>
                `:y}
                <span slot="empty-state">${hn(this.emptyStateMessage??this.metadata?.emptyStateMessage)}</span>
  ...
  `}};k([b()],$.prototype,`id`,void 0),k([b()],$.prototype,`metadata`,void 0),k([b()],$.prototype,`baseUrl`,void 0),k([b()],$.prototype,`state`,void 0),k([b()],$.prototype,`data`,void 0),k([b()],$.prototype,`appState`,void 0),k([b()],$.prototype,`appData`,void 0),k([b()],$.prototype,`emptyStateMessage`,void 0),k([w()],$.prototype,`detailsOpenedItems`,void 0),k([S(`vaadin-grid`)],$.prototype,`grid`,void 0),$=k([_(`mateu-table`)],$);var rd=(e,t,n,r,i,a,o)=>T`
    ...
    <mateu-table id="${e.id}"
                 ...
                 @fetch-more-elements="${e.fetchMoreElements}"
                 baseUrl="${n}"
    ></mateu-table>`,ad=(e,t,n,r,i,a,o)=>{let s=t.metadata;return T`
    ...
    <div style="display: flex; gap: var(--lumo-space-xs, .25rem); align-items: center;" class="peer-nav">
        ...
        <vaadin-button theme="tertiary icon" class="peer-nav-next" title="${e.nextLabel??`Next`}"
    ...
    </div>`,cd={"vaadin:wifi":`vaadin:connect`,"vaadin:pen":`vaadin:pencil`,"vaadin:automation":`vaadin:cogs`},ld=(e,t,n)=>T`<vaadin-icon icon="${cd[e]??e}" style="${t??y}" class="${n??y}"></vaadin-icon>`,ud=(e,t,n)=>{let r=e.metadata,i=M(r.label,t,n),a=``;return r.buttonStyle&&(a+=` `+r.buttonStyle),r.color&&r.color!==`none`&&r.color!==`normal`&&(a+=` `+r.color),r.size&&r.size!==`none`&&r.size!==`normal`&&(a+=` `+r.size),T`<vaadin-button
            id="${e.id}"
            data-action-id="${r.actionId}"
            data-route="${Jr(r,t,n)??y}"
            @click="${e=>qr(e,r)}"
            ...
            title="${r.shortcut?`${i} (${Kr(r.shortcut)})`:y}"
            slot="${e.slot??y}"
    >${r.iconOnLeft?T`<vaadin-icon icon="${r.iconOnLeft}"></vaadin-icon>`:y}${i}${r.iconOnRight?T`<vaadin-icon icon="${r.iconOnRight}"></vaadin-icon>`:y}</vaadin-button>`},dd=e=>{let t=e.metadata;return T`
        ...
        ></vaadin-message-input>
    `},fd=e=>{let t=(e.metadata.items??[]).map(e=>({text:e.text,time:e.time,userName:e.userName,userImg:e.userImg,userAbbr:e.userAbbr,userColorIndex:e.userColorIndex}));return T`
        <vaadin-message-list
                markdown
                style="${e.style}" class="${e.cssClasses}"
                slot="${e.slot??y}"
                .items="${t}"
        ></vaadin-message-list>
    `},pd=(e,t)=>{e&&e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t},bubbles:!0,composed:!0}))},md=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=!1;if(s.openedCondition)try{c=Gt(s.openedCondition,r,i,a,o)}catch(e){console.error(`when evaluating `+s.openedCondition+` :`+e+`, where data is `+i+` and state is `+r)}return T`
    ...
    `}render(){let e=this.navigation,t=!!(this.overviewEditActionId||e&&(e.parentActionId||e.previousActionId||e.nextActionId)),n=!!(this.headerTitle||t||this.badges.length);return T`
            ...
            `:y}
        `}};k([b({type:Array})],hd.prototype,`panels`,void 0),k([b({type:String})],hd.prototype,`headerTitle`,void 0),k([b({type:Array})],hd.prototype,`badges`,void 0),k([b({attribute:!1})],hd.prototype,`navigation`,void 0),k([b({type:String})],hd.prototype,`overviewEditActionId`,void 0),k([S(`.rail`)],hd.prototype,`_rail`,void 0),k([S(`.section--first`)],hd.prototype,`_first`,void 0),k([w()],hd.prototype,`_less`,void 0),k([w()],hd.prototype,`_more`,void 0),hd=k([_(`mateu-vaadin-foldout`)],hd);var gd=(e,t,n,r,i,a,o)=>{let s=t.metadata;return T`
    ...
    `}};k([b({attribute:!1})],_d.prototype,`rows`,void 0),k([b({attribute:!1})],_d.prototype,`columns`,void 0),k([b()],_d.prototype,`idField`,void 0),k([b({type:Boolean})],_d.prototype,`navigable`,void 0),k([b()],_d.prototype,`selectedId`,void 0),k([w()],_d.prototype,`expandedItems`,void 0),k([S(`vaadin-grid`)],_d.prototype,`_grid`,void 0),_d=k([_(`mateu-vaadin-tree`)],_d);var vd={[j.VirtualList]:(e,t,n,r,i,a,o)=>El(e,t,n,r,i,a,o),[j.Notification]:(e,t)=>Dl(t),[j.ProgressBar]:(e,t,n,r)=>Ol(t,r),[j.Details]:(e,t,n,r,i,a,o)=>kl(e,t,n,r,i,a,o),[j.Avatar]:(e,t,n,r,i)=>Al(t,r,i),[j.AvatarGroup]:(e,t)=>jl(t),[j.Card]:(e,t,n,r,i,a,o)=>Ml(e,t,n,r,i,a,o),[j.Button]:(e,t,n,r,i)=>ud(t,r,i),[j.MessageInput]:(e,t)=>dd(t),[j.MessageList]:(e,t)=>fd(t),[j.ConfirmDialog]:(e,t,n,r,i,a,o)=>md(e,t,n,r,i,a,o),[j.FormLayout]:(e,t,n,r,i,a,o)=>Fl(e,t,n,r,i,a,o),[j.HorizontalLayout]:(e,t,n,r,i,a,o)=>zl(e,t,n,r,i,a,o),[j.VerticalLayout]:(e,t,n,r,i,a,o)=>Bl(e,t,n,r,i,a,o),[j.SplitLayout]:(e,t,n,r,i,a,o)=>Vl(e,t,n,r,i,a,o),[j.MasterDetailLayout]:(e,t,n,r,i,a,o)=>Hl(e,t,n,r,i,a,o),[j.TabLayout]:(e,t,n,r,i,a,o)=>Ul(e,t,n,r,i,a,o),[j.AccordionLayout]:(e,t,n,r,i,a,o)=>Gl(e,t,n,r,i,a,o),[j.BoardLayout]:(e,t,n,r,i,a,o)=>Jl(e,t,n,r,i,a,o),[j.BoardLayoutRow]:(e,t,n,r,i,a,o)=>Yl(e,t,n,r,i,a,o),[j.BoardLayoutItem]:(e,t,n,r,i,a,o)=>Xl(e,t,n,r,i,a,o),[j.Scroller]:(e,t,n,r,i,a,o)=>ql(e,t,n,r,i,a,o),[j.MenuBar]:(e,t,n,r,i)=>$l(e,t,n,r,i),[j.ContextMenu]:(e,t,n,r,i,a,o)=>Ql(e,t,n,r,i,a,o),[j.FormField]:(e,t,n,r,i,a,o,s)=>td(e,t,n,r,i,a,o,s),[j.Grid]:(e,t,n,r,i,a,o)=>nd(e,t,n,r,i,a,o),[j.Table]:(e,t,n,r,i,a,o)=>rd(e,t,n,r,i,a,o),[j.Popover]:(e,t,n,r,i,a,o)=>ad(e,t,n,r,i,a,o),[j.FoldoutLayout]:(e,t,n,r,i,a,o)=>gd(e,t,n,r,i,a,o)},yd=class extends Tl{rendererName(){return`vaadin`}renderClientSideComponent(e,t,n,r,i,a,o,s){let c=t?.metadata?.type,l=c?vd[c]:void 0;return l&&t?l(e,t,n,r,i,a,o,s):super.renderClientSideComponent(e,t,n,r,i,a,o,s)}renderTableComponent(e,t,n,r,i,a,o){return id(e,t,n,r,a,o)}renderTreeComponent(e,t){return T`
            <mateu-vaadin-tree
                    .rows="${t.rows}"
                    .columns="${t.columns}"
                    .idField="${t.idField}"
            ...
            ></mateu-vaadin-tree>`}renderToolbarButton(e,t,n){return od(e,t,n)}renderPeerNav(e){return sd(e)}renderIcon(e,t,n){return ld(e,t,n)}renderTopNav(e,t,n){return Zl(e,t,n)}};function bd(e){switch(e){case`topStretch`:return`top-stretch`;case`topStart`:return`top-start`;case`topCenter`:return`top-center`;case`topEnd`:return`top-end`;case`middle`:return`middle`;case`bottomStart`:return`bottom-start`;case`bottomEnd`:return`bottom-end`;case`bottomStretch`:return`bottom-stretch`;case`bottomCenter`:return`bottom-center`}return`bottom-end`}function xd(e,t){if(e.onAction)return{label:e.actionLabel??`Retry`,run:e.onAction};if(e.undoActionId)return{label:e.undoLabel??`Undo`,run:()=>t.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.undoActionId,parameters:e.undoParameters??{}},bubbles:!0,composed:!0}))}}function Sd(e,t){let n=new r;n.position=bd(e.position),n.duration=e.duration??1e4,e.variant&&n.setAttribute(`theme`,e.variant),n.renderer=r=>{if(r.firstElementChild)return;let i=document.createElement(`span`);i.textContent=e.text;let a=xd(e,t),o=document.createElement(`button`);o.textContent=a.label,o.style.cssText=`margin-left: 0.75rem; background: none; border: 1px solid currentColor; border-radius: var(--lumo-border-radius-s, 4px); color: inherit; cursor: pointer; padding: 0.15rem 0.6rem; font: inherit; font-weight: 600;`,o.addEventListener(`click`,()=>{a.run(),n.opened=!1}),r.append(i,o)},document.body.appendChild(n),n.opened=!0,n.addEventListener(`opened-changed`,e=>{e.detail.value||n.remove()})}N.set(new yd),Mo({show(e,t){if(Rt(e.text,{politeness:e.variant===`error`?`assertive`:`polite`}),e.undoActionId||e.onAction){Sd(e,t);return}r.show(e.text,{position:e.position?bd(e.position):`bottom-end`,theme:e.variant,duration:e.duration})}});