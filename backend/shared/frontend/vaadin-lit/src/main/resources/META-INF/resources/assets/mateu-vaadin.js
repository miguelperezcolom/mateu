...
`,we={lon:0,lat:0},Te=e=>{if(!e)return;let t=e.split(`,`).map(e=>e.trim());if(t.length!==2)return;let n=Number(t[0]),r=Number(t[1]);if(!(t[0]===``||t[1]===``||!Number.isFinite(n)||!Number.isFinite(r)))return{lon:r,lat:n}},Ee=e=>{if(e==null||e.trim()===``)return 3;let t=Number(e);return Number.isFinite(t)?t:3};function k(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var De=class extends x{constructor(...e){super(...e),this.renderSeq=0}updated(e){super.updated(e),this.createMap()}disconnectedCallback(){super.disconnectedCallback(),this.map?.setTarget(void 0),this.map=void 0}async createMap(){let e=++this.renderSeq,[{default:t},{default:n},{default:r},{default:i},{fromLonLat:a},{default:o}]=await Promise.all([D(()=>import(`./vendor-ol.js`).then(e=>e.i),__vite__mapDeps([0,1])),D(()=>import(`./vendor-ol.js`).then(e=>e.a),__vite__mapDeps([0,1])),D(()=>import(`./vendor-ol.js`).then(e=>e.r),__vite__mapDeps([0,1])),D(()=>import(`./vendor-ol.js`).then(e=>e.t),__vite__mapDeps([0,1])),D(()=>import(`./vendor-ol.js`).then(e=>e.o),__vite__mapDeps([0,1])),D(()=>import(`./vendor-ol.js`).then(e=>e.n),__vite__mapDeps([0,1]))]);if(e!==this.renderSeq||!this.isConnected)return;if(!this.shadowRoot.querySelector(`style[data-ol]`)){let e=document.createElement(`style`);e.setAttribute(`data-ol`,``),e.textContent=o,this.shadowRoot.appendChild(e)}this.map&&=(this.map.setTarget(void 0),void 0);let s=Te(this.position)??we;this.map=new t({target:this.mapElement,layers:[new r({source:new i})],view:new n({center:a([s.lon,s.lat]),zoom:Ee(this.zoom)})})}render(){return E`<div id="map"></div>`}static{this.styles=g`
    ...
    `},Dr=e=>{let t=e.metadata;return(t?.content??t?.columns??[]).filter(e=>e&&e.metadata).map(e=>{let t=e.metadata;return{id:e.id??``,label:t?.label??e.id??``,autoWidth:t?.autoWidth,width:t?.width}})},Or=(e,t)=>{let n=e?.[t];return n==null?``:typeof n==`object`?n.text??n.label??n.value??``:String(n)},kr=(e,t,n)=>{let r=Dr(e);return E`
    ...
    `},Mr=(e,t,n,r,i,a,o)=>t.separator?E`<span style="align-self: stretch; width: 1px; background: var(--lumo-contrast-20pct, rgba(0,0,0,.2));"></span>`:t.submenus?E`
            <details style="position: relative;">
                ...
                <div style="display: flex; flex-direction: column; gap: .1rem; padding: .3rem; min-width: 10rem;
                    ...
                    ${t.submenus.map(t=>Mr(e,t,n,r,i,a,o))}
                </div>
            </details>
        `:E`
    ...
    `},Fr=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=s.content?.metadata,l=c?.type==j.Notice&&c.fullWidth===!0;return E`
        ...
        >
            ...
            `},Ir=e=>{let t=e.metadata,n=e=>{let n=e.closest(`.mateu-message-input`)?.querySelector(`input`),r=n?.value??``;!t.actionId||!r.trim()||(e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId,parameters:{message:r}},bubbles:!0,composed:!0})),n&&(n.value=``))};return E`
    ...
    `},Lr=(e,t,n,r,i,a,o)=>{let s=t.metadata;return E`<span title="${s.text}" style="${t.style}" class="${t.cssClasses}" slot="${t.slot??y}"
        >${P(e,s.wrapped,n,r,i,a,o)}</span>`},Rr=e=>{if(e instanceof CustomEvent)return e.detail;let t={};for(let n in e){let r=e[n];[`number`,`string`,`boolean`].indexOf(typeof r)>=0&&(t[n]=e[n])}return t},zr=(e,t,n,r,i)=>{let a={appState:r??{},appData:i??{}},o={};for(let r in e.attributes)o[r]=M(e.attributes[r],t,n,a);return{attributes:o,content:M(e.content,t,n,a)}},Br=(e,t,n,r)=>{for(let t in r.attributes)e.setAttribute(t,r.attributes[t]);n.style&&e.setAttribute(`style`,n.style),n.cssClasses&&e.setAttribute(`class`,n.cssClasses),n.slot&&e.setAttribute(`slot`,n.slot),r.content&&(t.html?e.innerHTML=r.content:e.append(r.content))},Vr=e=>{let t=e.name,n=e.attributes?e.attributes.import:void 0;n&&t.includes(`-`)&&!customElements.get(t)&&D(()=>import(n),[])},Hr=(e,t,n,r,i,a,o)=>{Vr(t);let s=zr(t,r,i,a,o),c=t.name;s.attributes.id&&(c=`#`+s.attributes.id);let l=n.id?`.element-container[data-element-id="${n.id}"]`:`.element-container`;return setTimeout(()=>{let r=e.shadowRoot?.querySelector(l),i=r?.querySelector(c);if(i){for(;i.firstChild;)i.removeChild(i.lastChild);Br(i,t,n,s)}else{let i=document.createElement(t.name);Br(i,t,n,s);for(let n in t.on)i.addEventListener(n,r=>{let i=Rr(r);e.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.on[n],parameters:{event:i}},bubbles:!0,composed:!0}))});r?.appendChild(i)}}),E`<div class="element-container" data-element-id="${C(n.id)}"></div>`},Ur=function(e){return e.div=`div`,e.p=`p`,e.h1=`h1`,e.h2=`h2`,e.h3=`h3`,e.h4=`h4`,e.h5=`h5`,e.h6=`h6`,e.span=`span`,e}({}),Wr=(e,t,n,r,i)=>{let a=e.metadata,o=a.attributes?.[`data-colspan`],s=Wt(a.text,t,n,r,i),c={xl:`var(--lumo-font-size-xl, 1.375rem)`,l:`var(--lumo-font-size-l, 1.125rem)`,s:`var(--lumo-font-size-s, .875rem)`,xs:`var(--lumo-font-size-xs, .8125rem)`},l=(a.size&&c[a.size]?`font-size: ${c[a.size]}; `:``)+(a.noMargins?`margin-block-start: 0; margin-block-end: 0; `:``);return Ur.h1==a.container?E`
        ...
        `:Ur.p==a.container?E`
            ...
            `},Gr=e=>{let t=e.metadata;return E`<a href="${t.url}" target="${t.target??y}"
                   rel="${t.target===`_blank`?`noopener`:y}"
                   style="${e.style}" class="${e.cssClasses}"
                   slot="${e.slot??y}">${t.text}</a>`},Kr=(e,t)=>{let n=e.toLowerCase().split(`+`);return t.ctrlKey===n.includes(`ctrl`)&&t.altKey===n.includes(`alt`)&&t.shiftKey===n.includes(`shift`)&&t.metaKey===n.includes(`meta`)},qr=(e,t)=>{if(!Kr(e,t))return!1;let n=e.toLowerCase().split(`+`),r=n[n.length-1];return!!(t.key.toLowerCase()===r||/^[a-z]$/.test(r)&&t.code===`Key`+r.toUpperCase()||/^[0-9]$/.test(r)&&(t.code===`Digit`+r||t.code===`Numpad`+r))},Jr=e=>e?e.split(`+`).map(e=>e.length<=1?e.toUpperCase():e.charAt(0).toUpperCase()+e.slice(1)).join(`+`):void 0,Yr=(e,t)=>{let n=e.currentTarget,r=n.dataset.route;if(r){sn(n,r);return}n.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:n.dataset.actionId,parameters:t.parameters},bubbles:!0,composed:!0}))},Xr=(e,t,n)=>{if(!e.route)return;let r=M(e.route,t,n);return!r||r.includes("${")?void 0:r},Zr=`display:inline-flex; align-items:center; justify-content:center; gap:.4em; box-sizing:border-box; font:inherit; font-weight:500; cursor:pointer; border-radius:var(--lumo-border-radius-m,6px); border:1px solid transparent; line-height:1; white-space:nowrap;`,Qr=e=>{let t=e.buttonStyle??``,n=e.color&&e.color!==`none`&&e.color!==`normal`?e.color:``,r=e.size,i=n===`success`?`var(--lumo-success-color,#1a7f37)`:n===`error`?`var(--lumo-error-color,#c5221f)`:n===`contrast`?`var(--lumo-contrast,#161513)`:`var(--lumo-primary-color,#3b5bdb)`,a=n===`success`?`var(--lumo-success-contrast-color,#fff)`:n===`error`?`var(--lumo-error-contrast-color,#fff)`:n===`contrast`?`var(--lumo-base-color,#fff)`:`var(--lumo-primary-contrast-color,#fff)`,o=n===`success`?`var(--lumo-success-text-color,#1a7f37)`:n===`error`?`var(--lumo-error-text-color,#c5221f)`:n===`contrast`?`var(--lumo-body-text-color,#161513)`:`var(--lumo-primary-text-color,#3b5bdb)`,s;return s=t===`primary`?`background:${i}; color:${a};`:t===`tertiary`||t===`tertiaryInline`?`background:transparent; color:${o};`:`background:var(--lumo-contrast-5pct,rgba(0,0,0,.04)); color:${o}; border-color:var(--lumo-contrast-20pct,rgba(0,0,0,.16));`,`${Zr}${s}${r===`small`?`padding:.25rem .6rem; font-size:var(--lumo-font-size-s,.875rem);`:r===`large`?`padding:.65rem 1.4rem; font-size:var(--lumo-font-size-l,1.125rem);`:`padding:.45rem 1rem; font-size:var(--lumo-font-size-m,1rem);`}`},$r=(e,t,n)=>{let r=e.metadata,i=M(r.label,t,n);return E`<button
            id="${e.id}"
            data-action-id="${r.actionId}"
            data-route="${Xr(r,t,n)??y}"
            @click="${e=>Yr(e,r)}"
            style="${Qr(r)}${e.style}"
            class="${e.cssClasses}"
            ?disabled="${r.disabled}"
            title="${r.shortcut?`${i} (${Jr(r.shortcut)})`:y}"
            slot="${e.slot??y}"
    >${r.iconOnLeft?F(r.iconOnLeft):y}${i}${r.iconOnRight?F(r.iconOnRight):y}</button>`},ei=`display:block; box-sizing:border-box; background:var(--lumo-base-color,#fff); border:1px solid var(--lumo-contrast-10pct,rgba(0,0,0,.1)); border-radius:var(--lumo-border-radius-l,12px); box-shadow:var(--lumo-box-shadow-xs,0 1px 3px rgba(0,0,0,.08)); overflow:hidden;`,ti=(e,t,n,r,i,a,o)=>{let s=t.metadata;if(!s)return E``;let c=t=>t?P(e,t,n,r,i,a,o,!1):y,l=s.header||s.headerPrefix||s.headerSuffix||s.title||s.subtitle;return E`
        <div id="${t.id??y}" style="${ei}${t.style}" class="${t.cssClasses}" slot="${t.slot??y}">
            ${s.media?c(s.media):y}
    ...
    `},ni=e=>{let t=e.metadata;return E`
        <mateu-chart 
                style="${e.style}" 
                class="${e.cssClasses}"
                slot="${e.slot??y}" 
    ...
    `},ri=e=>{let t=e.metadata;return F(t.icon,e.style,e.cssClasses,e.slot)},ii=(e,t)=>{e&&e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t},bubbles:!0,composed:!0}))},ai=`font:inherit; font-weight:500; cursor:pointer; padding:.45rem 1rem; border-radius:var(--lumo-border-radius-m,6px);`,oi=`${ai} background:var(--lumo-contrast-5pct,rgba(0,0,0,.04)); color:var(--lumo-body-text-color,#161513); border:1px solid var(--lumo-contrast-20pct,rgba(0,0,0,.16));`,si=`${ai} background:var(--lumo-primary-color,#3b5bdb); color:var(--lumo-primary-contrast-color,#fff); border:1px solid transparent;`,ci=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=!1;if(s.openedCondition)try{c=Gt(s.openedCondition,r,i,a,o)}catch(e){console.error(`when evaluating `+s.openedCondition+` :`+e+`, where data is `+i+` and state is `+r)}return c?E`
        <div class="mateu-confirm-dialog ${t.cssClasses??``}"
            ...
            <div style="background:var(--lumo-base-color,#fff); color:var(--lumo-body-text-color,#161513); border-radius:var(--lumo-border-radius-l,12px); box-shadow:var(--lumo-box-shadow-l,0 8px 24px rgba(0,0,0,.2)); width:100%; max-width:min(90vw,32rem); padding:1.5rem; box-sizing:border-box;">
                ...
                <div style="display:flex; gap:.5rem; justify-content:flex-end; margin-top:1.25rem;">
                    ${s.canCancel?E`<button style="${oi}" @click="${e=>ii(e.currentTarget,s.cancelActionId)}">${s.rejectText&&!s.canReject?s.rejectText:`Cancel`}</button>`:y}
                    ${s.canReject?E`<button style="${oi}" @click="${e=>ii(e.currentTarget,s.rejectActionId)}">${s.rejectText||`No`}</button>`:y}
                    <button style="${si}" @click="${e=>ii(e.currentTarget,s.confirmActionId)}">${s.confirmText||`OK`}</button>
                </div>
            </div>
        </div>
    `:E``},li=e=>{let t=e.metadata,n;return t.position&&(n={Top:`top`,Bottom:`bottom`,TopLeft:`top-left`,TopRight:`top-right`,BottomLeft:`bottom-left`,BottomRight:`bottom-right`}[t.position]),E`
    ...
    `},ui=(e,t,n,r,i,a,o)=>{let s=t.metadata;return E`
        ...
        <mateu-drawer
            ...
            .appdata="${a}"
        ></mateu-drawer>
            `,pi=e=>`mfe_`+[e.baseUrl,e.route,e.consumedRoute,e.serverSideType].map(e=>e??``).join(`|`).replace(/[^a-zA-Z0-9]/g,`_`),mi=e=>{let t=e.metadata;return E`
        <mateu-api-caller>
    ...
    `},_i=(e,t={})=>{let n=e.metadata,r=n.valueKey?t[n.valueKey]:n.value,i=n.max&&n.max!=0?n.max:1,a=!n.indeterminate&&r!=null;return E`
    ...
    `},yi=e=>{let t=e.metadata;return E`
    ...
    </div>`},Si=(e,t,n,r,i,a,o)=>{let s=t.metadata;return E`
        <skeleton-carousel 
                id="${t.id}"
                ?dots = "${s.dots}" 
                ?nav = "${s.nav}" 
    ...
    `},Ci=(e,t,n,r)=>{let i=e.metadata;return E`
        ...
        ${e.submenus?E`
                <details open>
                    ...
                    <div style="display:flex; flex-direction:column; gap:0.25rem; padding-left:0.5rem;">
                        ${e.submenus.map(e=>wi(e))}
                    </div>
                </details>
            `:E`
                <a href="${e.path}">${e.label}</a>
        `}
        `,Ti=(e,t,n,r,i,a,o)=>{let s=t.metadata;return E`<div
                slot="${t.slot??y}"
                style="${t.style}" class="${t.cssClasses}"
        >${s.content?v(s.content):y}${t.children?.map(t=>P(e,t,n,r,i,a,o))}</div>
    `},Ei=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=s.title?.includes("${")?e._evalTemplate(s.title):s.title;return E`<div
                id="${t.id??y}"
                slot="${t.slot??y}"
    ...
    `},Di=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=s.title?.includes("${")?e._evalTemplate(s.title):s.title;return E`
        <div
                slot="${t.slot??y}"
                style="${t.style}" class="${t.cssClasses}"
        >
    ...
    `},Oi=(e,t,n)=>{n.dispatchEvent(new CustomEvent(`value-changed`,{detail:{fieldId:e,value:t},bubbles:!0,composed:!0}))},ki=e=>t=>{let n=t.target,r=n.type===`checkbox`?n.checked:n.value;Oi(e.fieldId,r,n)},Ai=(e,t)=>{let n=e.metadata,r=t?.[n.fieldId]??``,i=n,a=i.dataType,o=i.stereotype,s=!!i.readOnly,c=!!i.disabled,l=i.options,u=n.label?E`<label style="display:block; font-size: var(--lumo-font-size-s,.875rem); color: var(--lumo-secondary-text-color,#667); margin-bottom:.15rem;">${n.label}</label>`:y,d=`width:100%; box-sizing:border-box; padding:.4rem .6rem; border:1px solid var(--lumo-contrast-30pct,rgba(0,0,0,.3)); border-radius: var(--lumo-border-radius-m,6px); font:inherit; background: var(--lumo-base-color,#fff); color: var(--lumo-body-text-color,#1a1a1a);`,f;return f=s||o===`plainText`?E`<div style="padding:.4rem 0;">${String(r??``)}</div>`:a===`boolean`||a===`bool`||o===`checkbox`||o===`badge`?E`<input type="checkbox" ?checked="${!!r}" ?disabled="${c}" @change="${ki(n)}">`:l&&l.length?E`
            <select style="${d}" ?disabled="${c}" @change="${ki(n)}">
                <option value="">—</option>
                ${l.map(e=>E`<option value="${e.value}" ?selected="${e.value===r}">${e.label}</option>`)}
            </select>`:o===`textarea`||o===`richText`||o===`html`?E`<textarea style="${d}" rows="3" ?disabled="${c}" @input="${ki(n)}">${String(r??``)}</textarea>`:E`<input type="${a===`integer`||a===`number`||a===`double`||a===`money`?`number`:a===`date`?`date`:a===`datetime`?`datetime-local`:a===`time`?`time`:o===`password`?`password`:a===`email`?`email`:`text`}" style="${d}" .value="${String(r??``)}"
                              placeholder="${i.placeholder??y}" ?disabled="${c}" @input="${ki(n)}">`,E`
        <div id="${e.id??y}" style="${e.style}" class="${e.cssClasses}" slot="${e.slot??y}">
            ${u}
            ${f}
        </div>
    `},ji=e=>{let t=e.metadata;if((t?.level??0)>0)return e;let n=e=>{if(e?.metadata?.type===j.EntityHeader)return e;let t=e?.metadata?.content,r=[...e?.children??[],...Array.isArray(t)?t:t?[t]:[]];for(let e of r){let t=n(e);if(t)return t}},r;for(let t of e.children??[])if(r=n(t),r)break;if(!r)return e;let i=r.metadata;r.__hoistedToPageHeader=!0;let a=[...(i.facts??[]).filter(e=>e.label||e.value).map(e=>({title:e.label??``,text:e.value??``})),...i.metricLabel?[{title:i.metricLabel,text:i.metricValue??``}]:[]],o=(i.badges??[]).filter(e=>e.label).map(e=>({text:e.label,color:e.color})),s={...t,title:i.title||t.title,subtitle:i.subtitle??t.subtitle,kpis:[...t.kpis??[],...a],kpisBelow:!0,badges:[...t.badges??[],...o]};return{...e,metadata:s}},Mi=(e,t,n,r,i,a,o,s)=>{let c=ji(t),l=c.metadata,u=l?.fabs??[];return E`<mateu-page
            .component="${c}"
            baseUrl="${n}"
            .state="${r}"
            .data="${i}"
...
`)}
    ...
    `},Ni=(e,t,n,r,i,a,o,s)=>E`<mateu-table-crud
            id="${t.id}"
            baseUrl="${n}"
            .component="${t}"
            .metadata="${t.metadata}"
    ...
    >
        ${t.children?.map(t=>P(e,t,n,r,i,a,o))}
    </mateu-table-crud>`,Pi=e=>{let t=e.metadata;return E`
        <mateu-bpmn
                style="${e.style}"
                class="${e.cssClasses}"
                slot="${e.slot??y}"
    ...
    `},Fi=(e,t,n)=>E`<mateu-chat sseUrl="${e.metadata.sseUrl}"
                            style="${e.style}" 
                            class="${e.cssClasses}" 
                            slot="${e.slot??y}"></mateu-chat>`,Ii=e=>{let t=e.metadata;return E`
        <mateu-workflow
                style="${e.style??y}"
                class="${e.cssClasses??y}"
                slot="${e.slot??y}"
        ...
        ></mateu-workflow>
    `},Li=e=>{let t=e.metadata;return E`
        <mateu-form-editor
                style="${e.style??y}"
                class="${e.cssClasses??y}"
                slot="${e.slot??y}"
    ...
    box-sizing: border-box;
`,zi=e=>e==`up`?`var(--lumo-success-text-color, #1a7f37)`:e==`down`?`var(--lumo-error-text-color, #c5221f)`:`var(--lumo-secondary-text-color, #666)`,Bi=e=>e==`up`?`▲`:e==`down`?`▼`:``,Vi=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},Hi=e=>{let t=e.metadata,n=!!t.actionId;return E`
        <div class="mateu-metric-card ${e.cssClasses??``}"
             style="${Ri} display: flex; flex-direction: column; gap: .25rem; min-width: 11rem; flex: 1; ${n?`cursor: pointer;`:``} ${e.style??``}"
             slot="${e.slot??y}"
             role="${n?`button`:y}"
             @click="${e=>Vi(e,t)}"
        >
            ...
            ${t.trend||t.trendLabel?E`
                <span style="font-size: var(--lumo-font-size-s, .875rem); color: ${zi(t.trend)};">
                    ${Bi(t.trend)} ${t.trendLabel??y}
                </span>
            `:y}
    ...
    `,Wi=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=s.colSpan&&s.colSpan>1?`grid-column: span ${s.colSpan};`:``,l=s.rowSpan&&s.rowSpan>1?`grid-row: span ${s.rowSpan};`:``,u=t.children??[];return u.length===1&&u[0].metadata?.type===`MetricCard`?E`
            <div style="min-width: 0; ${c} ${l} ${t.style??``}" slot="${t.slot??y}">
                ${P(e,u[0],n,r,i,a,o)}
            </div>`:E`
        <div class="mateu-dashboard-panel ${t.cssClasses??``}"
             style="${Ri} display: flex; flex-direction: column; gap: .5rem; min-width: 0; ${c} ${l} ${t.style??``}"
             slot="${t.slot??y}"
        >
            ${s.title?E`
                <div>
    ...
    `},Gi=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=s.columns&&s.columns>0?`repeat(${s.columns}, minmax(0, 1fr))`:`repeat(auto-fit, minmax(20rem, 1fr))`;return E`
    ...
    `}render(){if(this.expandedPanel!=null&&this.panels[this.expandedPanel]){let e=this.panels[this.expandedPanel];return E`
        ...
        `}};k([b({type:Array})],Ki.prototype,`panels`,void 0),k([b({type:String})],Ki.prototype,`headerTitle`,void 0),k([b({type:Array})],Ki.prototype,`badges`,void 0),k([b({type:String,reflect:!0})],Ki.prototype,`orientation`,void 0),k([b({attribute:!1})],Ki.prototype,`navigation`,void 0),k([b({type:String})],Ki.prototype,`overviewEditActionId`,void 0),k([w()],Ki.prototype,`openPanels`,void 0),k([w()],Ki.prototype,`expandedPanel`,void 0),Ki=k([_(`mateu-foldout`)],Ki);var qi=(e,t,n,r,i,a,o)=>{let s=t.metadata;return E`
        <mateu-foldout
                .panels="${s.panels??[]}"
    ...
    `},Yi=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.children??[],l=e=>c.filter(t=>(t.slot??``).startsWith(e)),u=l(`main-`),d=l(`aside-`),f=l(`footer-`),p=s.asideWidth&&s.asideWidth.trim()?s.asideWidth:`32%`,m=s.asidePosition===`start`,h=s.asideSticky!==!1,ee=t=>t.map(t=>P(e,t,n,r,i,a,o)),te=E`
    ...
    `},Xi=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=!!s.image,l=c?`background-image: linear-gradient(rgba(0,0,0,.35), rgba(0,0,0,.35)), url('${s.image}'); background-size: cover; background-position: center; color: #fff;`:``,u=s.centered===!1?`flex-start`:`center`,d=s.centered===!1?`left`:`center`;return E`
...
`,Zi=1440*60*1e3,Qi=class extends x{constructor(...e){super(...e),this.tasks=[],this.onTaskSelectionActionId=``}selectTask(e){this.onTaskSelectionActionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.onTaskSelectionActionId,parameters:{_clickedTaskId:e.id}},bubbles:!0,composed:!0}))}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            font-size: var(--lumo-font-size-s, .875rem);
    ...
    `}range(){let e=this.tasks.flatMap(e=>[e.start,e.end]).filter(e=>!!e).map(e=>new Date(e+`T00:00:00`).getTime());return e.length?{min:Math.min(...e)-Zi,max:Math.max(...e)+2*Zi}:null}months(e,t){let n=[],r=new Date(e);for(r.setDate(1);r.getTime()<=t;){let i=Math.max(r.getTime(),e),a=new Date(r.getFullYear(),r.getMonth()+1,1),o=Math.min(a.getTime(),t);n.push({label:r.toLocaleDateString(void 0,{month:`short`,year:`2-digit`}),from:i,to:o}),r.setMonth(r.getMonth()+1)}return n}render(){let e=this.range();if(!e)return E``;let t=e.max-e.min,n=n=>(n-e.min)/t*100,r=Date.now();return E`
            <div class="frame">
                ...
                ${this.tasks.map(i=>{let a=new Date(i.start+`T00:00:00`).getTime(),o=new Date(i.end+`T00:00:00`).getTime()+Zi;return E`
        ...
        `}};k([b({type:Array})],Qi.prototype,`tasks`,void 0),k([b()],Qi.prototype,`onTaskSelectionActionId`,void 0),Qi=k([_(`mateu-gantt`)],Qi);var $i=e=>{let t=e.metadata;return E`
        <mateu-gantt
                .tasks="${t.tasks??[]}"
                ...
                slot="${e.slot??y}"
        ></mateu-gantt>
    `},z,ea=class extends x{static{z=this}constructor(...e){super(...e),this.resources=[],this.blocks=[],this.drag=null,this.dragStartX=0,this.dragStartY=0,this.laneRects=[],this.onDragKeydown=e=>{e.key===`Escape`&&this.drag&&(e.stopPropagation(),this.endDrag())}}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            font-size: var(--lumo-font-size-s, .875rem);
    ...
    `}static parse(e){return new Date(e+`T00:00:00`)}static iso(e){let t=e=>String(e).padStart(2,`0`);return`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}`}static addDays(e,t){return new Date(e.getFullYear(),e.getMonth(),e.getDate()+t)}static daysBetween(e,t){return Math.round((t.getTime()-e.getTime())/864e5)}window(){if(this.from&&this.to){let e=z.parse(this.from),t=z.daysBetween(e,z.parse(this.to))+1;return t>0?{from:e,days:t}:null}let e=this.blocks.flatMap(e=>[e.start,e.end]).filter(e=>!!e).map(e=>z.parse(e));if(!e.length)return null;let t=new Date(Math.min(...e.map(e=>e.getTime()))),n=new Date(Math.max(...e.map(e=>e.getTime())));return{from:t,days:z.daysBetween(t,n)+1}}onBlockPointerDown(e,t,n){if(!this.moveActionId&&!this.selectActionId||(e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),this.dragStartX=e.clientX,this.dragStartY=e.clientY,!this.window()))return;let r=z.parse(t.start),i=z.parse(t.end),a=Math.max(1,z.daysBetween(r,i)+1);this.laneRects=[...this.renderRoot.querySelectorAll(`.lane[data-resource-id]`)].map(e=>({resourceId:e.dataset.resourceId,rect:e.getBoundingClientRect()}));let o=this.dayAt(t.resourceId,e.clientX)??n;this.drag={blockId:t.id,duration:a,grabOffsetDays:o-n,originResourceId:t.resourceId,originStartIdx:n,targetResourceId:t.resourceId,targetStartIdx:n,moved:!1},window.addEventListener(`keydown`,this.onDragKeydown)}dayAt(e,t){let n=this.laneRects.find(t=>t.resourceId===e),r=this.window();if(!n||!r||n.rect.width===0)return null;let i=Math.floor((t-n.rect.left)/n.rect.width*r.days);return Math.max(0,Math.min(r.days-1,i))}onBlockPointerMove(e){if(!this.drag||!this.drag.moved&&Math.abs(e.clientX-this.dragStartX)<4&&Math.abs(e.clientY-this.dragStartY)<4||!this.moveActionId)return;let t=this.window();if(!t)return;let n=this.laneRects.find(t=>e.clientY>=t.rect.top&&e.clientY<=t.rect.bottom)??this.laneRects.find(e=>e.resourceId===this.drag.targetResourceId);if(!n)return;let r=this.dayAt(n.resourceId,e.clientX);if(r==null)return;let i=Math.max(0,Math.min(t.days-this.drag.duration,r-this.drag.grabOffsetDays));this.drag={...this.drag,moved:!0,targetResourceId:n.resourceId,targetStartIdx:i}}onBlockPointerUp(e){let t=this.drag;if(this.endDrag(),!t)return;if(!t.moved){this.selectActionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.selectActionId,parameters:{_blockId:e.id}},bubbles:!0,composed:!0}));return}if(!this.moveActionId||t.targetResourceId===t.originResourceId&&t.targetStartIdx===t.originStartIdx)return;let n=this.window();if(!n)return;let r=z.addDays(n.from,t.targetStartIdx),i=z.addDays(r,t.duration-1);this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.moveActionId,parameters:{_blockId:t.blockId,_resourceId:t.targetResourceId,_start:z.iso(r),_end:z.iso(i)}},bubbles:!0,composed:!0}))}endDrag(){this.drag=null,window.removeEventListener(`keydown`,this.onDragKeydown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`keydown`,this.onDragKeydown)}render(){let e=this.window();if(!e||!this.resources.length)return E``;let t=[...Array(e.days).keys()].map(t=>z.addDays(e.from,t)),n=new Date,r=z.daysBetween(e.from,new Date(n.getFullYear(),n.getMonth(),n.getDate())),i=r>=0&&r<e.days,a=[],o;return this.resources.forEach(n=>{n.group&&n.group!==o&&a.push(E`<div class="group">${n.group}</div>`),o=n.group,a.push(this.renderRow(n,e,t,i?r:null))}),E`
        ...
        `}};k([b({type:Array})],ea.prototype,`resources`,void 0),k([b({type:Array})],ea.prototype,`blocks`,void 0),k([b()],ea.prototype,`from`,void 0),k([b()],ea.prototype,`to`,void 0),k([b()],ea.prototype,`moveActionId`,void 0),k([b()],ea.prototype,`selectActionId`,void 0),k([w()],ea.prototype,`drag`,void 0),ea=z=k([_(`mateu-planning-board`)],ea);var ta=e=>{let t=e.metadata;return E`
        <mateu-planning-board
                ...
                slot="${e.slot??y}"
        ></mateu-planning-board>
    `},na=class extends x{constructor(...e){super(...e),this.columns=[]}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            font-size: var(--lumo-font-size-s, .875rem);
    ...
    `}clickCard(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{_clickedCard:e}},bubbles:!0,composed:!0}))}render(){return E`
        ...
        `}};k([b({type:Array})],na.prototype,`columns`,void 0),na=k([_(`mateu-kanban`)],na);var ra=e=>E`
        <mateu-kanban
                ...
                slot="${e.slot??y}"
        ></mateu-kanban>
    `,ia=class extends x{constructor(...e){super(...e),this.items=[]}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            font-size: var(--lumo-font-size-s, .875rem);
    ...
    `}clickItem(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{_clickedItem:e}},bubbles:!0,composed:!0}))}render(){return E`
        ...
        `}};k([b({type:Array})],ia.prototype,`items`,void 0),ia=k([_(`mateu-timeline`)],ia);var aa=e=>E`
        <mateu-timeline
                ...
                slot="${e.slot??y}"
        ></mateu-timeline>
    `,oa=class extends x{constructor(...e){super(...e),this.steps=[],this.vertical=!1}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            font-size: var(--lumo-font-size-s, .875rem);
    ...
    `}updated(){let e=this.steps.length;if(e===0)return;let t=this.steps.findIndex(e=>e.status===`current`),n=this.steps.every(e=>e.status===`done`),r=t>=0?t+1:n?e:0;this.dispatchEvent(new CustomEvent(`mateu-guided-progress`,{detail:{current:r,total:e,steps:this.steps.map(e=>({id:e.id,title:e.title,status:e.status??`upcoming`}))},bubbles:!0,composed:!0}))}render(){return E`
        ...
        `}};k([b({type:Array})],oa.prototype,`steps`,void 0),k([b({type:Boolean,reflect:!0})],oa.prototype,`vertical`,void 0),oa=k([_(`mateu-progress-steps`)],oa);var sa=e=>{let t=e.metadata;return E`
        <mateu-progress-steps
                ...
                slot="${e.slot??y}"
        ></mateu-progress-steps>
    `},ca=class extends x{constructor(...e){super(...e),this.spark=[]}static{this.styles=g`
        :host {
            display: block;
        }
        .tile {
    ...
    `}sparkline(){let e=this.spark;if(!e||e.length<2)return y;let t=Math.min(...e),n=Math.max(...e)-t||1,r=80/(e.length-1),i=e.map((e,i)=>[2+i*r,2+26*(1-(e-t)/n)]),a=i.map(([e,t],n)=>`${n===0?`M`:`L`}${e.toFixed(1)} ${t.toFixed(1)}`).join(` `),o=`${a} L${i[i.length-1][0].toFixed(1)} 30 L${i[0][0].toFixed(1)} 30 Z`,s=this.trend===`down`?`var(--lumo-error-color, #e11d48)`:this.trend===`flat`?`var(--lumo-secondary-text-color, #888)`:`var(--lumo-success-color, #12b76a)`;return T`
        ...
        `}};k([b()],ca.prototype,`label`,void 0),k([b()],ca.prototype,`value`,void 0),k([b()],ca.prototype,`unit`,void 0),k([b()],ca.prototype,`delta`,void 0),k([b()],ca.prototype,`trend`,void 0),k([b({type:Array})],ca.prototype,`spark`,void 0),k([b()],ca.prototype,`actionId`,void 0),ca=k([_(`mateu-stat`)],ca);var la=e=>{let t=e.metadata;return E`
        <mateu-stat
                label="${t.label??y}"
                value="${t.value??y}"
                unit="${t.unit??y}"
                ...
                slot="${e.slot??y}"
        ></mateu-stat>
    `},ua=class extends x{constructor(...e){super(...e),this.events=[]}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            font-size: var(--lumo-font-size-s, .875rem);
    ...
    `}clickEvent(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{_clickedEvent:e}},bubbles:!0,composed:!0}))}render(){let e=this.month?new Date(this.month+`T00:00:00`):new Date,t=e.getFullYear(),n=e.getMonth(),r=new Date(t,n,1),i=(r.getDay()+6)%7,a=new Date(t,n+1,0).getDate(),o=new Date,s=e=>o.getFullYear()===t&&o.getMonth()===n&&o.getDate()===e,c={};for(let e of this.events){if(!e.date)continue;let r=new Date(e.date+`T00:00:00`);r.getFullYear()===t&&r.getMonth()===n&&(c[r.getDate()]??=[]).push(e)}let l=[`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`,`Sun`],u=[];for(let e=0;e<i;e++)u.push(E`<div class="cell blank"></div>`);for(let e=1;e<=a;e++)u.push(E`
        ...
        `}};k([b()],ua.prototype,`month`,void 0),k([b({type:Array})],ua.prototype,`events`,void 0),ua=k([_(`mateu-calendar`)],ua);var da=e=>{let t=e.metadata;return E`
        <mateu-calendar
                month="${t.month??y}"
                .events="${t.events??[]}"
                style="${e.style??y}"
                ...
                slot="${e.slot??y}"
        ></mateu-calendar>
    `},fa=class extends x{constructor(...e){super(...e),this.plans=[]}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
        }
    ...
    `}cta(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){return E`
        ...
        `}};k([b({type:Array})],fa.prototype,`plans`,void 0),fa=k([_(`mateu-pricing-table`)],fa);var pa=e=>E`
        <mateu-pricing-table
                ...
                slot="${e.slot??y}"
        ></mateu-pricing-table>
    `,ma=class extends x{static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            overflow-x: auto;
    ...
    `}clickNode(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{_clickedNode:e}},bubbles:!0,composed:!0}))}renderNode(e){let t=e.avatar,n=t&&(t.startsWith(`http`)||t.startsWith(`data:`));return E`
        ...
        `}render(){return this.root?E`<div class="tree"><ul>${this.renderNode(this.root)}</ul></div>`:E``}};k([b({attribute:!1})],ma.prototype,`root`,void 0),ma=k([_(`mateu-org-chart`)],ma);var ha=e=>E`
        <mateu-org-chart
                ...
                slot="${e.slot??y}"
        ></mateu-org-chart>
    `,ga=1440*60*1e3,_a=class extends x{constructor(...e){super(...e),this.cells=[]}static{this.styles=g`
        :host {
            display: block;
            width: 100%;
            overflow-x: auto;
    ...
    `}color(e,t){if(e<=0||t<=0)return`var(--lumo-contrast-10pct, #ebedf0)`;let n=e/t;return`color-mix(in srgb, var(--lumo-primary-color, #1a73e8) ${Math.round((n>.75?1:n>.5?.75:n>.25?.5:.3)*100)}%, transparent)`}render(){let e=this.cells.filter(e=>!!e.date);if(!e.length)return E``;let t=e.map(e=>new Date(e.date+`T00:00:00`).getTime()),n=Math.min(...t),r=Math.max(...t),i=new Date(n);i.setDate(i.getDate()-(i.getDay()+6)%7);let a={};for(let t of e)a[t.date]=t;let o=Math.max(...e.map(e=>e.value??0),1),s=[];for(let e=i.getTime();e<=r;e+=ga){let t=new Date(e),n=t.toISOString().slice(0,10),r=a[n],i=r?.value??0,c=(t.getDay()+6)%7+1,l=r?.label??`${n}: ${i}`;s.push(E`
        ...
        `}};k([b({type:Array})],_a.prototype,`cells`,void 0),_a=k([_(`mateu-heatmap`)],_a);var va=e=>E`
        <mateu-heatmap
                ...
                slot="${e.slot??y}"
        ></mateu-heatmap>
    `,ya=class extends x{constructor(...e){super(...e),this.stages=[]}static{this.styles=g`
    ...
    `}render(){let e=this.stages;if(!e.length)return E``;let t=e[0].value??0,n=Math.max(...e.map(e=>e.value??0),1);return E`
        ...
        `}};k([b({type:Array})],ya.prototype,`stages`,void 0),ya=k([_(`mateu-funnel`)],ya);var ba=e=>E`
        <mateu-funnel
                ...
                slot="${e.slot??y}"
        ></mateu-funnel>
    `,xa=class extends x{constructor(...e){super(...e),this.values=[],this.labels=[],this.area=!1}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
    ...
    `}render(){let e=this.values;if(!e||e.length<2)return E``;let t=Math.min(...e),n=Math.max(...e),r=n-t||1,i=584/(e.length-1),a=e.map((e,n)=>[8+n*i,8+144*(1-(e-t)/r)]),o=a.map(([e,t],n)=>`${n===0?`M`:`L`}${e.toFixed(1)} ${t.toFixed(1)}`).join(` `),s=`${o} L${a[a.length-1][0].toFixed(1)} 152 L${a[0][0].toFixed(1)} 152 Z`,c=this.color||`var(--lumo-primary-color, #1a73e8)`,l=e.indexOf(n),u=e.indexOf(t);return E`
        ...
        `}};k([b()],xa.prototype,`heading`,void 0),k([b({type:Array})],xa.prototype,`values`,void 0),k([b({type:Array})],xa.prototype,`labels`,void 0),k([b()],xa.prototype,`color`,void 0),k([b({type:Boolean})],xa.prototype,`area`,void 0),xa=k([_(`mateu-trend-chart`)],xa);var Sa=e=>{let t=e.metadata;return E`
        <mateu-trend-chart
                heading="${t.title??y}"
                color="${t.color??y}"
                ?area="${t.area??!1}"
                ...
                slot="${e.slot??y}"
        ></mateu-trend-chart>
    `},Ca=class extends x{constructor(...e){super(...e),this.features=[],this.columns=0}static{this.styles=g`
    ...
    `}clickFeature(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){return E`
        ...
        `}};k([b({type:Array})],Ca.prototype,`features`,void 0),k([b({type:Number})],Ca.prototype,`columns`,void 0),Ca=k([_(`mateu-feature-grid`)],Ca);var wa=e=>{let t=e.metadata;return E`
        <mateu-feature-grid
                .features="${t.features??[]}"
                .columns="${t.columns??0}"
                style="${e.style??y}"
                ...
                slot="${e.slot??y}"
        ></mateu-feature-grid>
    `},Ta=class extends x{constructor(...e){super(...e),this.items=[]}static{this.styles=g`
        :host { display: block; width: 100%; }
    ...
    `}stars(e){let t=Math.max(0,Math.min(5,e||0));return`★`.repeat(t)+`☆`.repeat(5-t)}render(){return E`
        ...
        `}};k([b({type:Array})],Ta.prototype,`items`,void 0),Ta=k([_(`mateu-testimonials`)],Ta);var Ea=e=>E`
        <mateu-testimonials
                .items="${e.metadata.items??[]}"
                style="${e.style??y}"
                class="${e.cssClasses??y}"
                slot="${e.slot??y}"
        ></mateu-testimonials>
    `,Da=class extends x{constructor(...e){super(...e),this.items=[],this.openSet=new Set,this.seeded=!1}static{this.styles=g`
    ...
    `}seed(){this.seeded||(this.seeded=!0,this.items.forEach((e,t)=>{e.open&&this.openSet.add(t)}))}toggle(e){this.openSet.has(e)?this.openSet.delete(e):this.openSet.add(e),this.requestUpdate()}render(){return this.seed(),E`
        ...
        `}};k([b({type:Array})],Da.prototype,`items`,void 0),k([w()],Da.prototype,`openSet`,void 0),Da=k([_(`mateu-faq`)],Da);var Oa=e=>E`
        <mateu-faq
                .items="${e.metadata.items??[]}"
                style="${e.style??y}"
                class="${e.cssClasses??y}"
    ...
    `}themeVars(){switch(this.theme){case`success`:return`--accent: var(--lumo-success-color, #12b76a); --bg: var(--lumo-success-color-10pct, rgba(18,183,106,.1));`;case`warning`:return`--accent: #f59e0b; --bg: rgba(245,158,11,.12);`;case`danger`:return`--accent: var(--lumo-error-color, #e11d48); --bg: var(--lumo-error-color-10pct, rgba(225,29,72,.1));`;default:return`--accent: var(--lumo-primary-color, #1a73e8); --bg: var(--lumo-primary-color-10pct, rgba(26,115,232,.1));`}}cta(){this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId},bubbles:!0,composed:!0}))}render(){return E`
        ...
        `}};k([b()],ka.prototype,`heading`,void 0),k([b()],ka.prototype,`description`,void 0),k([b()],ka.prototype,`icon`,void 0),k([b()],ka.prototype,`ctaLabel`,void 0),k([b()],ka.prototype,`actionId`,void 0),k([b()],ka.prototype,`theme`,void 0),ka=k([_(`mateu-callout-card`)],ka);var Aa=e=>{let t=e.metadata;return E`
        <mateu-callout-card
                heading="${t.title??y}"
                ...
                slot="${e.slot??y}"
        ></mateu-callout-card>
    `},ja=class extends x{constructor(...e){super(...e),this.comments=[]}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
    ...
    `}renderComment(e){let t=e.avatar&&(e.avatar.startsWith(`http`)||e.avatar.startsWith(`data:`));return E`
        ...
        `}render(){return E`<div class="thread">${this.comments.map(e=>this.renderComment(e))}</div>`}};k([b({type:Array})],ja.prototype,`comments`,void 0),ja=k([_(`mateu-comment-thread`)],ja);var Ma=e=>E`
        <mateu-comment-thread
                ...
                slot="${e.slot??y}"
        ></mateu-comment-thread>
    `,Na={pdf:`📕`,image:`🖼️`,img:`🖼️`,doc:`📘`,docx:`📘`,word:`📘`,xls:`📗`,xlsx:`📗`,excel:`📗`,sheet:`📗`,zip:`🗜️`,archive:`🗜️`,video:`🎬`,audio:`🎵`,code:`💻`,csv:`📄`,txt:`📄`},Pa=class extends x{constructor(...e){super(...e),this.files=[]}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
        .list {
            border: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1));
            border-radius: var(--lumo-border-radius-l, 12px);
        ...
        ${R}
    `}icon(e){return e&&Na[e.toLowerCase()]||`📄`}clickFile(e,t){e.url||e.actionId&&(t.preventDefault(),this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{_file:e}},bubbles:!0,composed:!0})))}render(){return E`
            <div class="list">
        ...
        `}};k([b({type:Array})],Pa.prototype,`files`,void 0),Pa=k([_(`mateu-file-list`)],Pa);var Fa=e=>E`
        <mateu-file-list
                ...
                slot="${e.slot??y}"
        ></mateu-file-list>
    `,Ia=class extends x{constructor(...e){super(...e),this.items=[],this.localDone=new Map}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
    ...
    `}isDone(e,t){return this.localDone.has(t)?!!this.localDone.get(t):!!e.done}toggle(e,t){let n=!this.isDone(e,t);this.localDone.set(t,n),this.requestUpdate(),e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{_item:e,_done:n}},bubbles:!0,composed:!0}))}render(){let e=this.items.length,t=this.items.filter((e,t)=>this.isDone(e,t)).length,n=e>0?Math.round(t/e*100):0;return E`
            ...
            ${this.items.map((e,t)=>{let n=this.isDone(e,t);return E`
                ...
                `})}
        `}};k([b()],Ia.prototype,`heading`,void 0),k([b({type:Array})],Ia.prototype,`items`,void 0),k([w()],Ia.prototype,`localDone`,void 0),Ia=k([_(`mateu-checklist`)],Ia);var La=e=>{let t=e.metadata;return E`
        <mateu-checklist
                heading="${t.title??y}"
                .items="${t.items??[]}"
                style="${e.style??y}"
                ...
                slot="${e.slot??y}"
        ></mateu-checklist>
    `},Ra=class extends x{static{this.styles=g`
        :host { display: block; width: 100%; }
        .card {
            border: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1));
            border-radius: var(--lumo-border-radius-l, 14px);
    ...
    `}render(){let e=this.trend??`flat`;return E`
        ...
        `}};k([b()],Ra.prototype,`heading`,void 0),k([b()],Ra.prototype,`leftLabel`,void 0),k([b()],Ra.prototype,`leftValue`,void 0),k([b()],Ra.prototype,`rightLabel`,void 0),k([b()],Ra.prototype,`rightValue`,void 0),k([b()],Ra.prototype,`delta`,void 0),k([b()],Ra.prototype,`trend`,void 0),Ra=k([_(`mateu-comparison-card`)],Ra);var za=e=>{let t=e.metadata;return E`
...
`,Va=new Intl.NumberFormat(`de-DE`,{minimumFractionDigits:2,maximumFractionDigits:2}),Ha=e=>Number.isFinite(e)?Va.format(e):``,Ua=(e,t)=>{let n=e<0?`-`:``,r=Ha(Math.abs(e));return t?`${n}${t} ${r}`:`${n}${r}`},Wa=(e,t)=>t?`${Ha(e)} ${t}`:Ha(e),Ga=class extends x{constructor(...e){super(...e),this.title=``,this.badges=[],this.facts=[]}static{this.styles=[Ba,g`
        :host { display: block; width: 100%; }
        .card {
            display: flex;
            align-items: stretch;
    ...
    `]}render(){let e=!!(this.metricLabel||this.metricValue||this.metricCaption);return E`
        ...
        `}};k([b()],Ga.prototype,`title`,void 0),k([b({type:Array})],Ga.prototype,`badges`,void 0),k([b()],Ga.prototype,`subtitle`,void 0),k([b({type:Array})],Ga.prototype,`facts`,void 0),k([b()],Ga.prototype,`metricLabel`,void 0),k([b()],Ga.prototype,`metricValue`,void 0),k([b()],Ga.prototype,`metricCaption`,void 0),Ga=k([_(`mateu-entity-header`)],Ga);var Ka=e=>{if(e.__hoistedToPageHeader)return E``;let t=e.metadata;return E`
        <mateu-entity-header
                .title="${t.title??``}"
                .badges="${t.badges??[]}"
                .subtitle="${t.subtitle}"
                ...
                slot="${e.slot??y}"
        ></mateu-entity-header>
    `},qa=class extends x{constructor(...e){super(...e),this.value=0,this.max=0}static{this.styles=g`
        :host { display: block; width: 100%; }
    ...
    `}fillColor(){return this.dangerAt!=null&&this.value>=this.dangerAt?`error`:this.warnAt!=null&&this.value>=this.warnAt?`warning`:this.warnAt!=null||this.dangerAt!=null?`success`:`primary`}render(){let e=this.max>0?Math.min(Math.max(this.value/this.max,0),1):0,t=Math.round(e*100);return E`
        ...
        `}};k([b()],qa.prototype,`label`,void 0),k([b({type:Number})],qa.prototype,`value`,void 0),k([b({type:Number})],qa.prototype,`max`,void 0),k([b()],qa.prototype,`unit`,void 0),k([b()],qa.prototype,`caption`,void 0),k([b({type:Number})],qa.prototype,`warnAt`,void 0),k([b({type:Number})],qa.prototype,`dangerAt`,void 0),qa=k([_(`mateu-meter`)],qa);var Ja=e=>{let t=e.metadata;return E`
        <mateu-meter
                .label="${t.label}"
                .value="${t.value??0}"
                .max="${t.max??0}"
                ...
                slot="${e.slot??y}"
        ></mateu-meter>
    `},Ya=class extends x{constructor(...e){super(...e),this.total=0,this.done=0}static{this.styles=g`
        :host { display: block; width: 100%; }
        .banner {
    ...
    `}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){let e=this.total>0&&this.done>=this.total,t=!e&&!!this.actionLabel&&!!this.actionId;return E`
        ...
        `}};k([b()],Ya.prototype,`label`,void 0),k([b({type:Number})],Ya.prototype,`total`,void 0),k([b({type:Number})],Ya.prototype,`done`,void 0),k([b()],Ya.prototype,`actionLabel`,void 0),k([b()],Ya.prototype,`actionId`,void 0),Ya=k([_(`mateu-task-progress`)],Ya);var Xa=e=>{let t=e.metadata;return E`
        <mateu-task-progress
                .label="${t.label}"
                .total="${t.total??0}"
                .done="${t.done??0}"
                ...
                slot="${e.slot??y}"
        ></mateu-task-progress>
    `},Za=class extends x{constructor(...e){super(...e),this.items=[],this.compact=!1,this.frameless=!1,this.columns=0,this.itemHeadingLevel=3}static{this.styles=[Ba,R,g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
        .list {
            border: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1));
            border-radius: var(--lumo-border-radius-l, 12px);
    ...
    `]}runAction(e,t){t&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}rowClicked(e){this.rowActionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.rowActionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}renderItemAction(e,t,n,r){return!t||!n?y:r?E`
        ...
        `}};k([b({type:Array})],Za.prototype,`items`,void 0),k([b({type:Boolean})],Za.prototype,`compact`,void 0),k([b({type:Boolean})],Za.prototype,`frameless`,void 0),k([b()],Za.prototype,`rowActionId`,void 0),k([b({type:Number})],Za.prototype,`columns`,void 0),k([b({type:Number})],Za.prototype,`itemHeadingLevel`,void 0),Za=k([_(`mateu-status-list`)],Za);var Qa=e=>{let t=e.metadata;return E`
        <mateu-status-list
                .items="${t.items??[]}"
                ?compact="${t.compact??!1}"
                ...
                slot="${e.slot??y}"
        ></mateu-status-list>
    `},$a=class extends x{constructor(...e){super(...e),this.items=[]}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
        ul {
    ...
    `}render(){return E`
        ...
        `}};k([b({type:Array})],$a.prototype,`items`,void 0),$a=k([_(`mateu-bulleted-list`)],$a);var eo=e=>E`
        <mateu-bulleted-list
                .items="${e.metadata.items??[]}"
                style="${e.style??y}"
                class="${e.cssClasses??y}"
                slot="${e.slot??y}"
        ></mateu-bulleted-list>
    `,to=e=>{let t=e.metadata.attributes?.[`data-colspan`];return E`
        <hr style="border: none; border-top: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1)); width: 100%; margin: var(--lumo-space-s, .5rem) 0; ${e.style??``}"
            ...
            data-colspan="${C(t)}"
            slot="${e.slot??y}"/>
    `},no=new Map,ro=e=>no.get(e),io=(e,t)=>t!=null&&e!=null&&!e.has(t),ao=typeof HTMLElement<`u`?HTMLElement:class{},oo=class extends ao{static get observedAttributes(){return[`type`,`renderer`]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){let e=this.getAttribute(`type`)??`unknown`,t=this.getAttribute(`renderer`)??`unknown`;this.shadowRoot||this.attachShadow({mode:`open`}),this.shadowRoot.innerHTML=`
            <style>
                :host { display: block; }
                .mateu-unsupported {
                    box-sizing: border-box;
        ...
        `}};typeof customElements<`u`&&!customElements.get(`mateu-unsupported`)&&customElements.define(`mateu-unsupported`,oo);var so=new Set,co=(e,t,n)=>{let r=`${n}/${t}`;return so.has(r)||(so.add(r),console.warn(`[mateu] Component type "${t}" is not supported by the "${n}" renderer — rendering <mateu-unsupported> placeholder.`)),E`<mateu-unsupported
            type="${t}"
            renderer="${n}"
            data-component-id="${e?.id??y}"
            slot="${e?.slot??y}"
    ></mateu-unsupported>`},lo=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.children?.map(t=>P(e,t,n,r,i,a,o,!1))??[],l=ro(s.name);return l?l(s.props??{},c):co(t,`${j.CustomComponent}:${s.name}`,`custom-component-registry`)},uo={info:`ℹ`,success:`✓`,warning:`!`,danger:`!`},B=class extends x{constructor(...e){super(...e),this.text=``,this.theme=`info`,this.noIcon=!1,this.slim=!1,this.fullWidth=!1,this.hasContent=!1,this.inlineContent=!1}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
        .notice {
            display: flex;
            align-items: center;
    ...
    `}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId},bubbles:!0,composed:!0}))}render(){let e=!!this.text&&!!this.text.trim();if(!e&&!this.hasContent)return E``;let t=[`info`,`success`,`warning`,`danger`].includes(this.theme)?this.theme:`info`;return E`
            <div class="notice ${t} ${this.slim?`slim`:``}">
                ${this.noIcon?y:E`<span class="icon ${this.icon?`custom`:``}">${this.icon||uo[t]}</span>`}
        ...
        `}};k([b()],B.prototype,`text`,void 0),k([b()],B.prototype,`theme`,void 0),k([b()],B.prototype,`icon`,void 0),k([b({type:Boolean})],B.prototype,`noIcon`,void 0),k([b()],B.prototype,`actionLabel`,void 0),k([b()],B.prototype,`actionId`,void 0),k([b()],B.prototype,`status`,void 0),k([b({type:Boolean})],B.prototype,`slim`,void 0),k([b({type:Boolean})],B.prototype,`fullWidth`,void 0),k([b({type:Boolean})],B.prototype,`hasContent`,void 0),k([b({type:Boolean})],B.prototype,`inlineContent`,void 0),B=k([_(`mateu-notice`)],B);var fo=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=Wt(s.text??``,r,i,a,o)??``,l=t.children??[];return E`
        <mateu-notice
                text="${c}"
                theme="${s.theme??`info`}"
    ...
    `},po=class extends x{constructor(...e){super(...e),this.groups=[]}static{this.styles=[Ba,R,g`
        :host { display: block; width: 100%; }
    ...
    `]}willUpdate(e){e.has(`groups`)&&(this.selectedId=this.groups.flatMap(e=>e.items??[]).find(e=>e.selected)?.id)}itemAction(e,t,n){e.stopPropagation(),t&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t,parameters:{_item:n}},bubbles:!0,composed:!0}))}select(e){this.selectedId=e,this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{_item:e}},bubbles:!0,composed:!0}))}render(){return E`
        ...
        `}};k([b()],po.prototype,`actionId`,void 0),k([b({type:Array})],po.prototype,`groups`,void 0),k([w()],po.prototype,`selectedId`,void 0),po=k([_(`mateu-task-queue`)],po);var mo=e=>{let t=e.metadata;return E`
        <mateu-task-queue
                .actionId="${t.actionId}"
                .groups="${t.groups??[]}"
                style="${e.style??y}"
                ...
                slot="${e.slot??y}"
        ></mateu-task-queue>
    `},ho=class extends x{constructor(...e){super(...e),this.columns=0,this.items=[]}static{this.styles=[Ba,R,g`
    ...
    `]}willUpdate(e){e.has(`items`)&&(this.selectedId=this.items.find(e=>e.selected)?.id)}select(e){e.disabled||(this.selectedId=e.id,this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{_item:e.id}},bubbles:!0,composed:!0})))}render(){return E`
        ...
        `}};k([b()],ho.prototype,`actionId`,void 0),k([b({type:Number})],ho.prototype,`columns`,void 0),k([b()],ho.prototype,`recommendedLabel`,void 0),k([b({type:Array})],ho.prototype,`items`,void 0),k([w()],ho.prototype,`selectedId`,void 0),ho=k([_(`mateu-resource-grid`)],ho);var go=e=>{let t=e.metadata;return E`
        <mateu-resource-grid
                .actionId="${t.actionId}"
                .columns="${t.columns??0}"
    ...
    `}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return E`
        ...
        <mateu-offer-card
                ...
                slot="${e.slot??y}"
        ></mateu-offer-card>
    `},vo=class extends x{constructor(...e){super(...e),this.items=[],this.added=new Set}static{this.styles=g`
        :host { display: block; width: 100%; }
    ...
    `}willUpdate(e){e.has(`items`)&&(this.added=new Set(this.items.filter(e=>e.added).map(e=>e.id)))}total(){return this.items.filter(e=>e.id!=null&&this.added.has(e.id)).reduce((e,t)=>e+(t.price??0),0)}toggle(e){if(e.id==null)return;let t=new Set(this.added),n=!t.has(e.id);n?t.add(e.id):t.delete(e.id),this.added=t,this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{_item:e.id,_added:n,_total:this.total()}},bubbles:!0,composed:!0}))}render(){return E`
            <div class="header">
                ...
                <span class="total">${Ua(this.total(),this.currency)}</span>
            </div>
            <div class="grid">
                ${this.items.map(e=>{let t=e.id!=null&&this.added.has(e.id);return E`
                        <div class="card ${t?`added`:``}">
                            ...
                            ${e.includedLabel?E`<span class="included">${e.includedLabel}</span>`:E`
                                    ${e.price==null?y:E`
                                        <span class="price">${Ua(e.price,this.currency)}${e.unit?` / ${e.unit}`:``}</span>
                                    `}
        ...
        `}};k([b()],vo.prototype,`totalLabel`,void 0),k([b()],vo.prototype,`currency`,void 0),k([b()],vo.prototype,`actionId`,void 0),k([b({type:Array})],vo.prototype,`items`,void 0),k([w()],vo.prototype,`added`,void 0),vo=k([_(`mateu-addon-picker`)],vo);var yo=e=>{let t=e.metadata;return E`
        <mateu-addon-picker
                ...
                slot="${e.slot??y}"
        ></mateu-addon-picker>
    `},bo=class extends x{constructor(...e){super(...e),this.lines=[]}static{this.styles=g`
        :host {
    ...
    `}computedTotal(){return this.total==null?this.lines.filter(e=>!e.included).reduce((e,t)=>e+(t.amount??0),0):this.total}render(){return E`
            ${this.lines.map(e=>E`
                <div class="row">
                    ...
                    ${e.included?E`<span class="included-label">${e.includedLabel||`Included`}</span>`:E`<span class="amount ${(e.amount??0)<0?`negative`:``}">${Ua(e.amount??0,this.currency)}</span>`}
                </div>
            `)}
            <div class="total-row">
                <span class="total-label">${this.totalLabel||`Total`}</span>
                <span class="total">${Ua(this.computedTotal(),this.currency)}</span>
            </div>
        `}};k([b()],bo.prototype,`currency`,void 0),k([b()],bo.prototype,`totalLabel`,void 0),k([b({type:Array})],bo.prototype,`lines`,void 0),k([b({type:Number})],bo.prototype,`total`,void 0),bo=k([_(`mateu-ledger`)],bo);var xo=e=>{let t=e.metadata;return E`
        <mateu-ledger
                .currency="${t.currency}"
                .totalLabel="${t.totalLabel}"
                .lines="${t.lines??[]}"
                ...
                slot="${e.slot??y}"
        ></mateu-ledger>
    `},So=class extends x{constructor(...e){super(...e),this.methods=[]}static{this.styles=g`
        :host { display: block; width: 100%; }
    ...
    `}willUpdate(e){e.has(`selected`)&&(this.selectedId=this.selected)}confirm(){this.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.actionId,parameters:{_method:this.selectedId}},bubbles:!0,composed:!0}))}pick(e){this.selectedId=e,this.methodActionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:this.methodActionId,parameters:{_method:e}},bubbles:!0,composed:!0}))}render(){return E`
        ...
        `}};k([b()],So.prototype,`actionId`,void 0),k([b()],So.prototype,`methodActionId`,void 0),k([b({type:Array})],So.prototype,`methods`,void 0),k([b()],So.prototype,`selected`,void 0),k([b()],So.prototype,`contextLabel`,void 0),k([b()],So.prototype,`contextValue`,void 0),k([b()],So.prototype,`confirmLabel`,void 0),k([w()],So.prototype,`selectedId`,void 0),So=k([_(`mateu-payment-picker`)],So);var Co=e=>{let t=e.metadata;return E`
        <mateu-payment-picker
                ...
                slot="${e.slot??y}"
        ></mateu-payment-picker>
    `},wo=class extends x{constructor(...e){super(...e),this.items=[]}static{this.styles=g`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
        .list {
            border: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1));
            border-radius: var(--lumo-border-radius-l, 12px);
    ...
    `}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return E`
        ...
        `}};k([b({type:Array})],wo.prototype,`items`,void 0),wo=k([_(`mateu-process-monitor`)],wo);var To=e=>E`
        <mateu-process-monitor
                ...
                slot="${e.slot??y}"
        ></mateu-process-monitor>
    `,Eo=(e,t)=>{let n=e.style;return e.id&&(n&&!n.endsWith(`;`)&&(n+=`;`),n??=``,t[e.id+`.hidden`]==1&&(n+=`display: none;`)),n},Do=(e,t)=>{let n={...e.metadata};if(e.id&&n){if(n.type==j.Button){let r=n;t[e.id+`.disabled`]==1&&(r.disabled=!0)}if(n.type==j.FormField){let r=n;t[e.id+`.disabled`]==1&&(r.disabled=!0)}}return n},H=e=>t=>e(t.container,t.component,t.baseUrl,t.state,t.data,t.appState,t.appData),Oo={[j.Bpmn]:({component:e})=>Pi(e),[j.Workflow]:({component:e})=>Ii(e),[j.FormEditor]:({component:e})=>Li(e),[j.Page]:H(Mi),[j.Div]:H(Ti),[j.Directory]:({component:e,baseUrl:t,state:n,data:r})=>Ci(e,t,n,r),[j.FormLayout]:H(sr),[j.HorizontalLayout]:H(pr),[j.VerticalLayout]:H(mr),[j.SplitLayout]:H(hr),[j.MasterDetailLayout]:H(gr),[j.TabLayout]:H(_r),[j.AccordionLayout]:H(vr),[j.BoardLayout]:H(Cr),[j.BoardLayoutRow]:H(wr),[j.BoardLayoutItem]:H(Tr),[j.Scroller]:H(br),[j.FullWidth]:H(xr),[j.Container]:H(Sr),[j.Form]:({container:e,component:t,baseUrl:n,state:r,data:i,appState:a,appData:o})=>{let s=t.metadata;return E`<mateu-form
            id="${t.id}"
        baseUrl="${n}"
            .component="${t}"
            .values="${r}"
...
`)}
            ...
            </mateu-form>`},[j.Table]:({component:e,state:t,data:n})=>kr(e,(e.id?n?.[e.id]:void 0)?.page?.content??Ar(e,t)),[j.Crud]:H(Ni),[j.App]:({container:e,component:t,baseUrl:n,state:r,data:i,appState:a,appData:o})=>E`
            <mateu-app
                        id="${t.id}"
                        baseUrl="${n}"
                        .component="${t}"
            ...
            >
             ${t.children?.map(t=>P(e,t,n,r,i,a,o))}
         </mateu-app>`,[j.Element]:({container:e,component:t,state:n,data:r,appState:i,appData:a})=>Hr(e,t.metadata,t,n,r,i,a),[j.FormField]:({component:e,state:t})=>Ai(e,t),[j.Text]:({component:e,state:t,data:n,appState:r,appData:i})=>Wr(e,t,n,r,i),[j.Avatar]:({component:e,state:t,data:n})=>Xt(e,t,n),[j.Chat]:({component:e,state:t,data:n})=>Fi(e,t,n),[j.AvatarGroup]:({component:e})=>Qt(e),[j.Badge]:({component:e,state:t,data:n})=>$t(e,t,n),[j.Breadcrumbs]:({component:e})=>xi(e),[j.Anchor]:({component:e})=>Gr(e),[j.Button]:({component:e,state:t,data:n})=>$r(e,t,n),[j.Card]:H(ti),[j.Chart]:({component:e})=>ni(e),[j.Icon]:({component:e})=>ri(e),[j.ConfirmDialog]:H(ci),[j.ContextMenu]:H(Pr),[j.CookieConsent]:({component:e})=>li(e),[j.Details]:H(ui),[j.Dialog]:({component:e,baseUrl:t,state:n,data:r,appState:i,appData:a})=>di(e,t,n,r,i,a),[j.Drawer]:({component:e,baseUrl:t,state:n,data:r,appState:i,appData:a})=>fi(e,t,n,r,i,a),[j.Image]:({component:e})=>bi(e),[j.Map]:({component:e})=>yi(e),[j.Markdown]:({component:e})=>hi(e),[j.MicroFrontend]:({component:e})=>mi(e),[j.Notification]:({component:e})=>gi(e),[j.ProgressBar]:({component:e,state:t})=>_i(e,t),[j.Popover]:H(vi),[j.CarouselLayout]:H(Si),[j.Tooltip]:H(Lr),[j.MessageInput]:({component:e})=>Ir(e),[j.MessageList]:({component:e})=>jr(e),[j.CustomField]:H(Fr),[j.MenuBar]:({container:e,component:t,baseUrl:n,state:r,data:i})=>Nr(e,t,n,r,i),[j.Grid]:({component:e,state:t})=>kr(e,Ar(e,t)),[j.VirtualList]:H(Er),[j.FormSection]:H(Ei),[j.FormSubSection]:H(Di),[j.MetricCard]:({component:e})=>Hi(e),[j.Scoreboard]:H(Ui),[j.DashboardPanel]:H(Wi),[j.DashboardLayout]:H(Gi),[j.ResponsiveGrid]:H(Ji),[j.FoldoutLayout]:H(qi),[j.ContentLayout]:H(Yi),[j.HeroSection]:H(Xi),[j.EmptyState]:({component:e})=>vn(e),[j.Skeleton]:({component:e})=>yn(e),[j.Gantt]:({component:e})=>$i(e),[j.PlanningBoard]:({component:e})=>ta(e),[j.Kanban]:({component:e})=>ra(e),[j.Timeline]:({component:e})=>aa(e),[j.ProgressSteps]:({component:e})=>sa(e),[j.Stat]:({component:e})=>la(e),[j.Calendar]:({component:e})=>da(e),[j.PricingTable]:({component:e})=>pa(e),[j.OrgChart]:({component:e})=>ha(e),[j.Heatmap]:({component:e})=>va(e),[j.Funnel]:({component:e})=>ba(e),[j.TrendChart]:({component:e})=>Sa(e),[j.FeatureGrid]:({component:e})=>wa(e),[j.Testimonials]:({component:e})=>Ea(e),[j.Faq]:({component:e})=>Oa(e),[j.CalloutCard]:({component:e})=>Aa(e),[j.CommentThread]:({component:e})=>Ma(e),[j.FileList]:({component:e})=>Fa(e),[j.Checklist]:({component:e})=>La(e),[j.ComparisonCard]:({component:e})=>za(e),[j.EntityHeader]:({component:e})=>Ka(e),[j.Meter]:({component:e})=>Ja(e),[j.TaskProgress]:({component:e})=>Xa(e),[j.StatusList]:({component:e})=>Qa(e),[j.BulletedList]:({component:e})=>eo(e),[j.Separator]:({component:e})=>to(e),[j.CustomComponent]:H(lo),[j.Notice]:H(fo),[j.TaskQueue]:({component:e})=>mo(e),[j.ResourceGrid]:({component:e})=>go(e),[j.OfferCard]:({component:e})=>_o(e),[j.AddOnPicker]:({component:e})=>yo(e),[j.Ledger]:({component:e})=>xo(e),[j.PaymentPicker]:({component:e})=>Co(e),[j.ProcessMonitor]:({component:e})=>To(e)},ko=(e,t,n,r,i,a,o,s)=>{if(!t?.metadata)return t==null?(console.warn(`No metadata for component`,t),E`<p>No metadata for component</p>`):ko(e,{id:se(),metadata:t,type:A.ClientSide},n,r,i,a,o,s);let c=t.metadata.type,l={...t,style:Eo(t,i),metadata:Do(t,i)},u=Oo[c];return u?u({container:e,component:l,baseUrl:n,state:r,data:i,appState:a,appData:o,labelAlreadyRendered:s}):E`<p ${l?.slot??y}>Unknown metadata type ${c} for component ${l?.id}</p>`},Ao=function(e){return e.NONE=`NONE`,e.INFO=`INFO`,e.SUCCESS=`SUCCESS`,e.WARNING=`WARNING`,e.DANGER=`DANGER`,e}({}),jo=(e,t,n)=>{let r=e[n.path];return r?E`<span theme="badge pill ${Mo(r.type)}">${r.message}</span>`:E``},Mo=e=>{switch(e){case Ao.SUCCESS:return`success`;case Ao.WARNING:return`warning`;case Ao.DANGER:return`error`;case Ao.NONE:return`contrast`}return``},U=class extends x{constructor(...e){super(...e),this.id=``,this.baseUrl=``,this.state={},this.data={},this.appState={},this.appData={},this.respondToVisibility=(e,t)=>{var n={root:document.documentElement};new IntersectionObserver(e=>{e.forEach(e=>{t(e.intersectionRatio>0)})},n).observe(e)},this.keepAsking=!1,this.askToUpper=()=>{let e=this.data[this.id]?.page,t=e?.content?.length/e?.pageSize;this.dispatchEvent(new CustomEvent(`fetch-more-elements`,{detail:{params:{page:t,pageSize:this.metadata?.pageSize},callback:()=>{this.keepAsking&&this.askToUpper()}},bubbles:!0,composed:!0}))},this.renderItem=e=>e.card?ko(this,e.card,this.baseUrl,this.state,this.data,this.appState,this.appData,!1):e.title?E`<div class="neutral-card">
                ${e.image?E`<img class="card-media" src="${e.image}" alt="" />`:y}
                <div class="card-body">
                    <div class="card-head">
                        ${e.title?E`<span class="card-title">${e.title}</span>`:y}
                        ${e.status?E`<span theme="badge ${Mo(e.status.type)}">${e.status.message}</span>`:y}
                    </div>
    ...
    `}};k([b({attribute:!1})],Xo.prototype,`app`,void 0),k([b()],Xo.prototype,`baseUrl`,void 0),k([w()],Xo.prototype,`open`,void 0),k([w()],Xo.prototype,`queryText`,void 0),k([w()],Xo.prototype,`dataHits`,void 0),k([w()],Xo.prototype,`loading`,void 0),k([w()],Xo.prototype,`selectedIndex`,void 0),k([w()],Xo.prototype,`fabOffset`,void 0),k([S(`.cc-input`)],Xo.prototype,`inputEl`,void 0),Xo=k([_(`mateu-command-center`)],Xo);var Zo=null;function Qo(e){let t=e.component?.metadata;t&&(t.commandCenterEnabled||t.chromeless)&&t.variant!==`MEDIATOR`?((!Zo||!Zo.isConnected)&&(Zo=document.createElement(`mateu-command-center`),e.renderRoot.appendChild(Zo)),Zo.app=t,Zo.baseUrl=e.baseUrl??``):Zo&&e.renderRoot.contains(Zo)&&(Zo.remove(),Zo=null)}var $o=class extends x{constructor(...e){super(...e),this.fetchStarted=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!0},this.fetchFinished=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1},this.fetchFailed=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1;let t=e.detail??{},n=t.failure??St(t.reason,{online:Ot.isOnline()});if(n.kind===`cancelled`)return;let r=t.retry;Fo({text:n.message,variant:`error`,duration:r?8e3:5e3,position:`bottomEnd`,...r?{actionLabel:`Retry`,onAction:r}:{}},this)}}connectedCallback(){super.connectedCallback(),this.addEventListener(`backend-called-event`,this.fetchStarted),this.addEventListener(`backend-succeeded-event`,this.fetchFinished),this.addEventListener(`backend-cancelled-event`,this.fetchFinished),this.addEventListener(`backend-failed-event`,this.fetchFailed)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`backend-called-event`,this.fetchStarted),this.removeEventListener(`backend-succeeded-event`,this.fetchFinished),this.removeEventListener(`backend-cancelled-event`,this.fetchFinished),this.removeEventListener(`backend-failed-event`,this.fetchFailed)}render(){return E`<div class="loader-container">
...
`,i=!0)}i&&this.updateMessage(a,o)}o||this.updateMessage(a,`⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).`)}catch(e){console.error(`Error en el flujo SSE:`,e);let t=e?.message??String(e);(t===`Failed to fetch`||t===`network error`||t===`Load failed`)&&!o?this.updateMessage(a,`⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible.`):this.updateMessage(a,`⚠️ Error: `+t)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value=``)},250),this.messageInputElement?.removeAttribute(`disabled`),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent(`close-requested`,{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{let e=this.messageInputElement?.value?.trim()??``;e&&this.send(new CustomEvent(`submit`,{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key===`Enter`&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback(),this.probeLocalAgent();let e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){let t=new e;this.recognition=t,t.lang=`es-ES`,t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=e=>{console.error(`Error de reconocimiento: `+e.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:`smooth`})},0)}addMessage(e,t){let n={text:e,time:new Date().toLocaleTimeString(),userName:t.includes(`agent`)?`Asistente`:`Tú`,userColorIndex:t.includes(`agent`)?2:1};return this.items=[...this.items,n],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((n,r)=>r===e?{...n,text:t}:n),this.scrollBottom()}tryParseCustomEvent(e){let t=e.trim();if(!t.startsWith(`{`))return null;try{let e=JSON.parse(t);if(typeof e.event==`string`)return{event:e.event,detail:e.detail??{}}}catch{}return null}tryParseTokenUsage(e){let t=e.trim();if(!t.startsWith(`{`))return null;try{let e=JSON.parse(t);if(`inputTokens`in e||`outputTokens`in e||`totalTokens`in e)return e}catch{}return null}buildMenuContext(e,t=[]){let n=[];for(let r of e){if(r.separator||r.remote)continue;let e=[...t,r.label];if(r.submenus&&r.submenus.length>0)n.push(...this.buildMenuContext(r.submenus,e));else{let t={path:e,navigation:{route:r.route,consumedRoute:r.consumedRoute,actionId:r.actionId??``,baseUrl:r.baseUrl,serverSideType:r.serverSideType,uriPrefix:r.uriPrefix}};r.description&&(t.description=r.description),n.push(t)}}return n}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return E`
                    ...
                    <div class="message-list" role="list">
                        ${this.items.map(e=>E`
                            <div class="message" role="listitem">
                                <div class="avatar" style="background: ${Os(e.userColorIndex)};">${ks(e.userName)}</div>
  ...
  `}};k([b()],As.prototype,`type`,void 0),k([b()],As.prototype,`data`,void 0),k([b()],As.prototype,`options`,void 0),k([S(`#chart`)],As.prototype,`chartElement`,void 0),As=k([_(`mateu-chart`)],As);var js=class extends x{updated(e){super.updated(e),this.chart&&=(this.chart.destroy(),void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){let{default:t}=await D(async()=>{let{default:e}=await import(`./vendor-diagrams.js`).then(e=>e.t);return{default:e}},__vite__mapDeps([4,1,2]));if(e!==this.xml)return;this.chart&&this.chart.destroy();let n={container:this.divElement};this.chart=new t(n),this.chart.importXML(e)}handleSlotChange(){}render(){return E`
       ...
       `}static{this.styles=g`
  `}};k([b()],js.prototype,`xml`,void 0),k([S(`#canvas`)],js.prototype,`divElement`,void 0),js=k([_(`mateu-bpmn`)],js);var Ms=160,Ns=56,Ps=220,Fs=110,Is=60,Ls={ACTION:`#3B82F6`,JOIN:`#8B5CF6`,FORK:`#F59E0B`,END:`#EF4444`,USER_TASK:`#10B981`,PROCESS:`#6366F1`},Rs={ACTION:`▶`,JOIN:`⟨`,FORK:`⟩`,END:`◼`,USER_TASK:`👤`,PROCESS:`⚙`},zs=[`ACTION`,`JOIN`,`FORK`,`END`,`USER_TASK`,`PROCESS`];function Bs(){return`step-`+Math.random().toString(36).slice(2,8)}var Vs=class extends x{constructor(...e){super(...e),this.value=`{"name":"New Workflow","steps":[]}`,this.wf={name:`New Workflow`,steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;let t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener(`mousemove`,this.onMouseMove),window.removeEventListener(`mouseup`,this.onMouseUp)}}updated(e){if(e.has(`value`)){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){let e=this.wf.steps??[],t={};e.forEach(e=>{t[e.id]=0});let n=!0;for(;n;)n=!1,e.forEach(e=>{if(e.preconditionStepId!=null&&t[e.preconditionStepId]!==void 0){let r=t[e.preconditionStepId]+1;r>t[e.id]&&(t[e.id]=r,n=!0)}});let r={};e.forEach(e=>{let n=t[e.id]??0;(r[n]??=[]).push(e.id)});let i={...this.positions},a=!1;Object.entries(r).forEach(([e,t])=>{let n=Number(e);t.forEach((e,t)=>{i[e]||(i[e]={x:Is+n*Ps,y:Is+t*Fs},a=!0)})}),a&&(this.positions=i)}emit(){let e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent(`value-changed`,{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(n=>n.id===e?{...n,...t}:n)},this.emit()}addStep(){let e=Bs(),t={id:e,type:`ACTION`,name:`New Step`};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};let n=Object.values(this.positions).map(e=>e.y),r=n.length?Math.max(...n)+Fs:Is;this.positions={...this.positions,[e]:{x:Is,y:r}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(t=>t.id!==e).map(t=>t.preconditionStepId===e?{...t,preconditionStepId:void 0}:t)};let{[e]:t,...n}=this.positions;this.positions=n,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;let n=this.positions[t]??{x:0,y:0},r=this.toSvgPoint(e);this.dragOffset={x:r.x-n.x,y:r.y-n.y},this.svgEl=e.currentTarget.closest(`svg`),window.addEventListener(`mousemove`,this.onMouseMove),window.addEventListener(`mouseup`,this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};let t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){let e=Object.values(this.positions),t=e.length?Math.max(...e.map(e=>e.x))+Ms+Is:600,n=e.length?Math.max(...e.map(e=>e.y))+Ns+Is:400;return{w:Math.max(t,600),h:Math.max(n,400)}}render(){let{w:e,h:t}=this.canvasSize(),n=this.wf.steps??[];return E`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return T``;let t=this.positions[e.preconditionStepId],n=this.positions[e.id];if(!t||!n)return T``;let r=t.x+Ms,i=t.y+Ns/2,a=n.x,o=n.y+Ns/2,s=(r+a)/2;return T`
            <path d="M${r},${i} C${s},${i} ${s},${o} ${a},${o}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){let t=this.positions[e.id]??{x:Is,y:Is},n=Ls[e.type]??`#64748b`,r=Rs[e.type]??`•`,i=this.selectedId===e.id;return T`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${t=>this.onNodeMouseDown(t,e.id)}"
               @click="${t=>{t.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${Ms}" height="${Ns}" rx="8"
                      fill="white"
                      stroke="${i?n:`#e2e8f0`}"
                ...
                <div class="prop-body">
                    ...
                    ${n(`Type`,E`
                        <select class="inp" @change="${t=>this.updateStep(e.id,{type:t.target.value})}">
                            ${zs.map(t=>E`<option value="${t}" ?selected="${e.type===t}">${t}</option>`)}
                        </select>`)}
        ...
        `}exportJson(){let e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:`application/json`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=(this.wf.name??`workflow`).replace(/\s+/g,`-`).toLowerCase()+`.json`,r.click(),URL.revokeObjectURL(n)}static{this.styles=[hs,g`
    ...
    `]}};k([b()],Vs.prototype,`value`,void 0),k([w()],Vs.prototype,`wf`,void 0),k([w()],Vs.prototype,`positions`,void 0),k([w()],Vs.prototype,`selectedId`,void 0),k([w()],Vs.prototype,`showMeta`,void 0),Vs=k([_(`mateu-workflow`)],Vs);var Hs=[`string`,`integer`,`number`,`bool`,`date`,`time`,`dateTime`,`dateRange`,`money`,`file`,`array`,`status`,`component`,`menu`,`range`,`action`,`actionGroup`],Us=[`regular`,`radio`,`checkbox`,`textarea`,`toggle`,`combobox`,`select`,`email`,`password`,`richText`,`listBox`,`html`,`markdown`,`image`,`icon`,`link`,`money`,`grid`,`color`,`choice`,`popover`,`slider`,`button`,`stars`],Ws={string:`#3B82F6`,integer:`#8B5CF6`,number:`#6366F1`,bool:`#10B981`,date:`#F59E0B`,time:`#F59E0B`,dateTime:`#F59E0B`,dateRange:`#F59E0B`,money:`#EF4444`,file:`#64748B`,array:`#0EA5E9`,status:`#EC4899`,component:`#14B8A6`,menu:`#94A3B8`,range:`#A855F7`,action:`#F97316`,actionGroup:`#FB923C`};function Gs(){return`field-`+Math.random().toString(36).slice(2,8)}var Ks=class extends x{constructor(...e){super(...e),this.value=`{"name":"New Form","fields":[]}`,this.form={name:`New Form`,fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has(`value`))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){let e=this.shadowRoot?.querySelector(`.field-list`);!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=oe.create(e,{animation:150,handle:`.drag-handle`,ghostClass:`sortable-ghost`,onEnd:e=>{let{oldIndex:t,newIndex:n}=e;if(t===void 0||n===void 0||t===n)return;let r=[...this.form.fields],[i]=r.splice(t,1);r.splice(n,0,i),this.form={...this.form,fields:r},this.emit()}}))}emit(){let e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent(`value-changed`,{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(n=>n.id===e?{...n,...t}:n)},this.emit()}addField(){let e=Gs(),t={id:e,label:`New Field`,dataType:`string`};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){let t=this.form.fields.find(t=>t.id===e);if(!t)return;let n={...t,id:Gs(),label:t.label+` (copy)`},r=this.form.fields.findIndex(t=>t.id===e),i=[...this.form.fields];i.splice(r+1,0,n),this.form={...this.form,fields:i},this.selectedId=n.id,this.emit()}render(){return E`
        ...
        `}renderRow(e){let t=Ws[e.dataType]??`#64748b`;return E`
        ...
        `}exportJson(){let e=JSON.stringify(this.form,null,2),t=new Blob([e],{type:`application/json`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=(this.form.name??`form`).replace(/\s+/g,`-`).toLowerCase()+`.json`,r.click(),URL.revokeObjectURL(n)}static{this.styles=[hs,R,g`
        :host { display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif); }
        ...
        textarea.inp { resize: vertical; }
        input[readonly].inp { background: #f8fafc; color: #94a3b8; }
    `]}};k([b()],Ks.prototype,`value`,void 0),k([w()],Ks.prototype,`form`,void 0),k([w()],Ks.prototype,`selectedId`,void 0),k([w()],Ks.prototype,`showMeta`,void 0),Ks=k([_(`mateu-form-editor`)],Ks);var qs=class extends x{constructor(...e){super(...e),this.appState={},this.appData={},this.open=!1,this.activeTab=`appstate`,this.hoveredTag=``,this.hoveredId=``,this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null,this._prevTarget=null,this._onMouseover=e=>{let t=e.target;for(;t&&!(t.tagName?.toLowerCase().startsWith(`mateu-`)&&t!==this);)t=t.parentElement;if(t===this||t===null){t===null&&this._prevTarget&&(this._prevTarget.style.outline=``,this._prevTarget.style.outlineOffset=``,this._prevTarget=null,this.hoveredTag=``,this.hoveredId=``,this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null);return}t!==this._prevTarget&&(this._prevTarget&&(this._prevTarget.style.outline=``,this._prevTarget.style.outlineOffset=``),this._prevTarget=t,t.style.outline=`2px solid #0070f3`,t.style.outlineOffset=`-2px`,this.hoveredTag=t.tagName.toLowerCase(),this.hoveredId=t.id||``,this.hoveredState=t.state,this.hoveredData=t.data,this.hoveredMeta=t.component?.metadata)}}connectedCallback(){super.connectedCallback(),document.addEventListener(`mouseover`,this._onMouseover,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`mouseover`,this._onMouseover,!0),this._prevTarget&&=(this._prevTarget.style.outline=``,null)}_fmt(e){try{return JSON.stringify(e,null,2)??`null`}catch{return String(e)}}_renderTab(e,t){return E`
    ...
    `}};k([b()],qs.prototype,`appState`,void 0),k([b()],qs.prototype,`appData`,void 0),k([w()],qs.prototype,`open`,void 0),k([w()],qs.prototype,`activeTab`,void 0),k([w()],qs.prototype,`hoveredTag`,void 0),k([w()],qs.prototype,`hoveredId`,void 0),k([w()],qs.prototype,`hoveredState`,void 0),k([w()],qs.prototype,`hoveredData`,void 0),k([w()],qs.prototype,`hoveredMeta`,void 0),qs=k([_(`mateu-debug-overlay`)],qs);var Js=(e,t)=>{let n=t?.initiatorState;return n&&typeof n==`object`?{...n}:{...e??{}}},Ys=e=>{if(e)try{return JSON.parse(e)}catch{return{value:e}}else return{}},Xs=function(e){return e.required=`required`,e.disabled=`disabled`,e.hidden=`hidden`,e.pattern=`pattern`,e.minValue=`minValue`,e.maxValue=`maxValue`,e.minLength=`minLength`,e.maxLength=`maxLength`,e.css=`css`,e.style=`style`,e.theme=`theme`,e.errorMessage=`errorMessage`,e.description=`description`,e.none=`none`,e}({}),Zs=function(e){return e.Continue=`Continue`,e.Stop=`Stop`,e}({}),Qs=12e4,$s=(e,t)=>`${e??`_`}::${t}`,ec=new class{constructor(){this.started=new Map,this.listeners=new Set}begin(e,t=Date.now()){let n=this.started.get(e);return n!==void 0&&t-n<Qs?!1:(this.started.set(e,t),this.emit(),!0)}end(e){this.started.delete(e)&&this.emit()}isPending(e,t=Date.now()){let n=this.started.get(e);return n!==void 0&&t-n<Qs}snapshot(){return new Set(this.started.keys())}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}reset(){this.started.clear(),this.emit()}emit(){let e=this.snapshot();this.listeners.forEach(t=>t(e))}},tc=`data-mateu-pending-styles`,nc=`
[data-mateu-pending] {
    pointer-events: none;
    cursor: progress;
...
`),variant:`error`,position:`bottomEnd`,duration:Math.max(3e3,1500+n.length*1e3)},this),this.focusFirstInvalidField()},this.notify=e=>{Fo({text:e,variant:`error`,position:`bottomEnd`,duration:3e3},this)},this.handleRestAction=(e,t)=>{let n=()=>{let t=M(e.successMessage,this.state,this.data);t&&Fo({text:t,variant:`success`,position:`bottomEnd`,duration:3e3},this);let n=M(e.successRoute,this.state,this.data);if(!(!n||n.includes("${"))){if(this.sameRoute(n)){this.refreshListing();return}sn(this,n)}},r=t=>{if(e.resultPath!=null){let n=Bn(t,e.resultPath);n&&typeof n==`object`&&(this.state={...this.state,...n})}n()},i=e=>{console.warn(`mateu: rest action failed`,e),Fo({text:`Request failed`,variant:`error`,position:`bottomEnd`,duration:3e3},this)},a=(e,t)=>{let n=e?.appData?._restfetchError;if(n){Fo({text:`Request failed${typeof n?.status==`number`&&n.status>0?` (HTTP ${n.status})`:``}`,variant:`error`,position:`bottomEnd`,duration:3e3},this);return}t(e?.appData?._restfetch)},o=!!be(e.source)?.proxy,s=t===`__restdata__`?`data`:`action`;if(e.forEachSelectedRow){let r=this.state.crud_selected_items??[];if(!r.length){this.notify(`You first need to select some rows`);return}if(o){this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:`__restfetch__`,parameters:{_sourceKind:s,_sourceId:t,_forEachSelectedRow:!0},callback:e=>a(e,()=>n()),callbackonly:!0},bubbles:!0,composed:!0}));return}Promise.all(r.map(t=>Un(e.source,e=>M(e,{...this.state,...t},this.data)))).then(()=>n()).catch(i);return}if(o){this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:`__restfetch__`,parameters:{_sourceKind:s,_sourceId:t},callback:e=>a(e,r),callbackonly:!0},bubbles:!0,composed:!0}));return}Un(e.source,e=>M(e,this.state,this.data),void 0,e=>M(e,me(this.state),me(this.data))).then(r).catch(i)},this.callAfterConfirmation=(e,t)=>{let{header:n,message:r,confirmationText:i,denialText:a}=mc(e),o=document.createElement(`div`);o.style.cssText=`position:fixed;inset:0;z-index:1100;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.35);padding:1rem;`;let s=document.createElement(`div`);s.style.cssText=`background:var(--lumo-base-color,#fff);color:var(--lumo-body-text-color,#1a1a1a);border-radius:var(--lumo-border-radius-l,12px);box-shadow:var(--lumo-box-shadow-xl,0 12px 40px rgba(0,0,0,.3));padding:1.2rem;max-width:min(90vw,26rem);`;let c=()=>{o.parentElement&&document.body.removeChild(o)},l=`font:inherit;font-weight:600;padding:.45rem 1rem;border-radius:var(--lumo-border-radius-m,6px);cursor:pointer;`;ne(E`
        ...
        `,s),o.appendChild(s),o.addEventListener(`click`,e=>{e.target===o&&c()}),document.body.appendChild(o)},this.requestActionCallToServerOrBubble=(e,t,n,r)=>{if(n&&n.bubble){let t={...e.parameters};t.initiatorState||=this.state,this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{...e,_originElement:r,parameters:t},bubbles:!0,composed:!0}))}else this.requestActionCallToServer(e,t,n,r)},this.requestActionCallToServer=(e,t,n,r)=>{if(n&&n.href){window.location.href=n.href;return}if(n&&n.js)try{Function(`state`,`data`,`appState`,`appData`,`component`,n.js).call(this,this.state??{},this.data??{},this.appState??{},this.appData??{},this.component),this.state={...this.state},this.data={...this.data}}catch(e){console.error(`when evaluating `+n.js,e,this.component,this.state,this.data)}if(n&&n.customEvent&&this.dispatchEvent(new CustomEvent(n.customEvent.name,{detail:n.customEvent.detail,bubbles:!0,composed:!0})),n&&(n.js||n.customEvent)||dc(n,e=>this.applyCommand(e)))return;if(n&&n.restAction){this.handleRestAction(n.restAction,n.id);return}if(e.actionId==`search`){let t=e.parameters?._searchState;t?this.state={...this.state,...t}:this.state.size||(this.state={...this.state,size:10,page:0,sort:[]})}let i=e.background??n?.background;if(!i){if(!Tt(e.actionId,n?.idempotent)&&!ec.begin($s(this.id,e.actionId)))return;let t=uc(r);this._pendingOrigins.set(e.actionId,t),oc(t)}let a=Js(this.state,e.parameters);this.dispatchEvent(new CustomEvent(`server-side-action-requested`,{detail:{route:this.route,consumedRoute:this.consumedRoute,componentState:a,parameters:e.parameters??{},actionId:e.actionId,serverSideType:t.serverSideType,serverSideComponentRoute:t.route,initiatorComponentId:e.initiatorComponentId??t.id,initiator:this,background:i,sse:n?.sse,timeoutMillis:n?.timeoutMillis,idempotent:n?.idempotent,callback:e.callback,callbackonly:e.callbackonly,callbackToken:e.callbackToken??this.callbackToken},bubbles:!0,composed:!0}))},this.handleBackendSucceeded=e=>{e.detail.actionId&&this.component.triggers?.filter(e=>e.type==zo.OnSuccess).filter(t=>e.detail.actionId==t.calledActionId).forEach(t=>{if(!t.condition||this._evalExpr(t.condition))if(e.preventDefault(),e.stopPropagation(),t.timeoutMillis>0){let e=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId,background:t.background,callbackToken:e},bubbles:!0,composed:!0}))},t.timeoutMillis)}else this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId,background:t.background},bubbles:!0,composed:!0}))})},this.handleBackendFailed=e=>{e.detail.actionId&&this.component.triggers?.filter(e=>e.type==zo.OnError).filter(t=>e.detail.actionId==t.calledActionId).forEach(t=>{(!t.condition||this._evalExpr(t.condition))&&(e.preventDefault(),e.stopPropagation(),this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId},bubbles:!0,composed:!0})))})},this._pendingOrigins=new Map,this._backendSettledListener=e=>{((typeof e.composedPath==`function`?e.composedPath():[])[0]??e.target)===this&&this._releasePending(e.detail?.actionId)},this._keydownListener=e=>{if(this._handleTabShortcut(e))return;let t=this.component;if(t)for(let n of t.actions??[]){let t=n.shortcut||(n.runOnEnter?`enter`:null);if(t&&this._shortcutMatchesEvent(t,e)){e.preventDefault(),this.manageActionRequestedEvent(new CustomEvent(`action-requested`,{detail:{actionId:n.id},bubbles:!0,composed:!0}));return}}}}createRenderRoot(){return N.mustUseShadowRoot()?super.createRenderRoot():this}updated(e){super.updated(e),e.has(`state`)&&this.state&&JSON.stringify(this.state)!=JSON.stringify({})&&this.onChange(),e.has(`component`)&&(fc(this,this.component?.sizing),this.formerState={...this.state},this.component?.confirmOnNavigationIfDirty&&this.dispatchEvent(new CustomEvent(`clean`,{detail:{},bubbles:!0,composed:!0})),setTimeout(()=>this.triggerOnLoad()))}sameRoute(e){let t=e=>e.replace(/^\/+/,``).replace(/\/+$/,``).split(`?`)[0];return t(e)===t(window.location.pathname)}refreshListing(){let e=null,t=n=>{let r=n.querySelector?.(`mateu-table-crud`);r&&(e=r),n.querySelectorAll?.(`*`).forEach(e=>{e.shadowRoot&&t(e.shadowRoot)})};t(this.renderRoot),e?.search?.()}focusFirstInvalidField(){let e=t=>requestAnimationFrame(()=>{let n=this.findFirstInvalid(this.renderRoot);if(n){n.focus?.(),n.scrollIntoView?.({block:`center`,behavior:`smooth`});return}t>0&&e(t-1)});e(3)}findFirstInvalid(e){if(!e?.querySelectorAll)return null;for(let t of Array.from(e.querySelectorAll(`*`))){if(t.invalid===!0)return t;if(t.shadowRoot){let e=this.findFirstInvalid(t.shadowRoot);if(e)return e}}return null}_releasePending(e){(e===void 0?Array.from(this._pendingOrigins.keys()):[e]).forEach(e=>{ec.end($s(this.id,e)),sc(this._pendingOrigins.get(e)),this._pendingOrigins.delete(e)})}_shortcutMatchesEvent(e,t){return qr(e,t)}_collectShortcutTabs(){let e=this.renderRoot;if(!e)return[];let t=Array.from(e.querySelectorAll(`vaadin-tab[data-shortcut]`));return e.querySelectorAll(`mateu-drawer, mateu-dialog`).forEach(e=>{let n=e.shadowRoot;n&&t.push(...Array.from(n.querySelectorAll(`vaadin-tab[data-shortcut]`)))}),t}_handleTabShortcut(e){let t=this._collectShortcutTabs();if(t.length===0)return!1;for(let n of Array.from(t)){let t=n.dataset.shortcut;if(!t||!this._shortcutMatchesEvent(t,e))continue;let r=n.closest(`vaadin-tabs`);if(!r)continue;let i=Array.from(r.querySelectorAll(`vaadin-tab`)).indexOf(n);if(!(i<0))return e.preventDefault(),r.selected=i,!0}return!1}connectedCallback(){super.connectedCallback(),this.addEventListener(`backend-call-succeeded`,this.handleBackendSucceeded),this.addEventListener(`backend-call-failed`,this.handleBackendFailed),this.addEventListener(`backend-succeeded-event`,this._backendSettledListener),this.addEventListener(`backend-failed-event`,this._backendSettledListener),this.addEventListener(`backend-cancelled-event`,this._backendSettledListener),document.addEventListener(`keydown`,this._keydownListener)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`backend-call-succeeded`,this.handleBackendSucceeded),this.removeEventListener(`backend-call-failed`,this.handleBackendFailed),this.removeEventListener(`backend-succeeded-event`,this._backendSettledListener),this.removeEventListener(`backend-failed-event`,this._backendSettledListener),this.removeEventListener(`backend-cancelled-event`,this._backendSettledListener),document.removeEventListener(`keydown`,this._keydownListener),this._releasePending()}render(){return E`<div>
            ...
            `:y}</div>`}_render(){if(this.component?.type==A.ClientSide){let e=this.component;return e.metadata?.type==j.Page?Mi(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):e.metadata?.type==j.Crud?Ni(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):N.get()?.renderClientSideComponent(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!1)}return E`
            <mateu-api-caller 
            ...
            ${this.component?.children?.map(e=>{if(e.type==A.ClientSide){let t=e;if(t.metadata?.type==j.Page)return Mi(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0);if(t.metadata?.type==j.Crud)return Ni(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0)}return P(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData)})}
            </mateu-api-caller>
        `}static{this.styles=g`
        :host {
        }
...
`);e=a.pop()??``;for(let e of a){let t=e.trim();if(t)if(t.startsWith(`data:`)){let e=JSON.parse(t.substring(5).trim());f&&f(e),p||this.handleUIIncrement(e,u,m),e.messages&&e.messages.length==1&&e.messages[0].variant==`error`&&u.shadowRoot?.dispatchEvent(new CustomEvent(`backend-call-failed`,{detail:{actionId:i},bubbles:!0,composed:!0}))}else{let e=t;try{let n=JSON.parse(t);e=n.message,n._embedded?.errors?.length>0&&n._embedded.errors[0].message&&(e=n._embedded.errors[0].message)}catch{}throw Error(e)}}}}d||u.dispatchEvent(new CustomEvent(`backend-succeeded-event`,{bubbles:!0,composed:!0,detail:{actionId:i}})),u.shadowRoot?.dispatchEvent(new CustomEvent(`backend-call-succeeded`,{detail:{actionId:i},bubbles:!0,composed:!0}))}).catch(e=>{u.dispatchEvent(new CustomEvent(`backend-failed-event`,{bubbles:!0,composed:!0,detail:{actionId:i,reason:this.serialize(e),retry:ee}})),u.shadowRoot?.dispatchEvent(new CustomEvent(`backend-call-failed`,{detail:{actionId:i},bubbles:!0,composed:!0}))})}}serialize(e){return e?.message?e:JSON.stringify(e)}},bc={fixed:`fixed`,fullWidth:`full`,edgeToEdge:`edge`},xc=new Set([j.Gantt,j.PlanningBoard,j.Kanban,j.Bpmn,j.Workflow,j.Map]),Sc={landing:`fixed`,form:`fixed`,process:`fixed`},Cc=e=>e?bc[e]:void 0,wc=e=>e.type==A.ClientSide?e.metadata:void 0,Tc=e=>{let t=wc(e);if(t?.type==j.Page){let e=Cc(t.pageWidth);if(e)return e}for(let t of e.children??[]){let e=Tc(t);if(e)return e}},Ec=e=>{let t=e.pageType;if(t)return t;let n=e=>{let t=wc(e);if(t?.type==j.Page&&t.pageType)return t.pageType;for(let t of e.children??[]){let e=n(t);if(e)return e}};return n(e)},Dc=e=>{let t=wc(e);if(t?.type!=j.Crud)return!1;let n=t;return n.compact?!0:(n.columns??[]).some(e=>e.metadata?.editable)},Oc=(e,t)=>t(e)||(e.children??[]).some(e=>Oc(e,t)),kc=e=>!!e&&Oc(e,e=>wc(e)?.type==j.HeroSection),Ac=e=>wc(e)?.type==j.App||(e.children??[]).some(e=>wc(e)?.type==j.App),jc=(e,t)=>e?(Cc(e.pageWidth)??Tc(e))||(t?.top&&Ac(e)?`edge`:Sc[Ec(e)??``]||(Oc(e,e=>{let t=wc(e)?.type;return t!=null&&xc.has(t)})?`edge`:Oc(e,Dc)?`full`:`fixed`)):`fixed`,Mc=`mateu-route-structure-cache`,Nc=1,Pc=50,Fc=(()=>{try{return localStorage.getItem(`mateu-route-structure-cache-off`)!==`1`}catch{return!0}})(),Ic=()=>{try{return JSON.parse(localStorage.getItem(Mc)??`{}`)}catch{return{}}},Lc=e=>{try{localStorage.setItem(Mc,JSON.stringify(e))}catch{try{let t=Object.entries(e).sort((e,t)=>t[1].t-e[1].t).slice(0,Math.floor(Pc/2));localStorage.setItem(Mc,JSON.stringify(Object.fromEntries(t)))}catch{}}},Rc=e=>{let t=e.initialState&&Object.keys(e.initialState).length?`#`+Vc(JSON.stringify(e.initialState)):``;return[e.baseUrl,e.consumedRoute??``,e.route??``,e.serverSideType??``].join(`|`)+t},zc=e=>{if(!Fc)return;let t=Ic()[e];if(!(!t||t.v!==Nc))return{component:t.component,hash:t.hash}},Bc=(e,t,n)=>{if(!Fc)return;let r=Ic();r[e]={v:Nc,t:Date.now(),component:t,hash:n};let i=Object.keys(r);if(i.length>Pc){let e=i.sort((e,t)=>r[e].t-r[t].t).slice(0,i.length-Pc);for(let t of e)delete r[t]}Lc(r)},Vc=e=>{let t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return(t>>>0).toString(36)},Hc=30,Uc=new Map,Wc=!0,Gc=e=>{if(Wc)return Uc.get(e)},Kc=(e,t)=>{if(Wc&&(Uc.delete(e),Uc.set(e,t),Uc.size>Hc)){let e=Uc.keys().next().value;e!==void 0&&Uc.delete(e)}},qc,X=class extends zt{static{qc=this}constructor(...e){super(...e),this.consumedRoute=``,this.serverSideType=void 0,this.uriPrefix=void 0,this.overrides=void 0,this.homeRoute=void 0,this.route=void 0,this.top=void 0,this.appState={},this.appData={},this.preventNavigation=!1,this.overridesParsed={},this.fragment=void 0,this.showSkeleton=!1,this.pendingRouteFocus=!1,this.hasRenderedContent=!1,this.loadLifecycleListener=e=>{if(((typeof e.composedPath==`function`?e.composedPath():[])[0]??e.target)===this)if(clearTimeout(this.skeletonTimer),e.type===`backend-called-event`){if(this.fragment?.component)return;this.skeletonTimer=setTimeout(()=>{this.showSkeleton=!0},qc.SKELETON_DELAY_MS)}else this.showSkeleton=!1},this.actionRequestedListener=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.manageActionEvent(e))},this.historyPushed=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.preventNavigation=!0,this.route=e.detail.route)},this.routeChangedListener=e=>{if(e instanceof CustomEvent){e.preventDefault(),e.stopPropagation();let t=e.detail.route;typeof t==`string`&&(t===``||t.startsWith(`/`))&&this.consumedRoute&&this.consumedRoute!==`_empty`&&this.consumedRoute.startsWith(`/`)&&!t.startsWith(this.consumedRoute)&&(t=this.consumedRoute+t),this.uriPrefix&&(t=t.startsWith(`/`)&&this.uriPrefix.endsWith(`/`)?this.uriPrefix+t.substring(1):!t.startsWith(`/`)&&!this.uriPrefix.endsWith(`/`)?this.uriPrefix+`/`+t:this.uriPrefix+t),this.dispatchEvent(new CustomEvent(`url-update-requested`,{detail:{route:t},bubbles:!0,composed:!0}))}},this.backendFailedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&e.detail.actionId==``&&(this.fragment={targetComponentId:this.id,data:{},state:{},component:{type:A.ClientSide,metadata:{type:j.Element,name:`div`,content:`Not found`},id:`fieldId`},action:We.Replace,containerId:void 0})},this.detail1=void 0,this.manageActionEvent=e=>{e.preventDefault(),e.stopPropagation(),this.detail1=e.detail;let t=this.detail1;if(e.type==`server-side-action-requested`){let e=vc;t.sse&&(e=yc),e.runAction(Mt,this.baseUrl,t.route??``,t.consumedRoute,t.actionId,t.initiatorComponentId,this.getCustomisedAppState(),t.serverSideType,t.componentState,t.parameters,t.initiator,t.background,t.callback,t.callbackonly,t.callbackToken,{timeoutMillis:t.timeoutMillis,idempotent:t.idempotent,knownStructureHash:t.knownStructureHash})}},this.getCustomisedAppState=()=>{let e={...O.value};if(this.overrides){let t=Ys(this.overrides);e={...e,...t}}return e}}manageActionRequestedEvent(e){throw Error(`Method not implemented.`)}createRenderRoot(){return N.mustUseShadowRoot()?super.createRenderRoot():this}structureCacheKey(){return Rc({baseUrl:this.baseUrl,consumedRoute:this.consumedRoute,route:this.route,serverSideType:this.serverSideType,initialState:this.initialState})}focusNewContent(){requestAnimationFrame(()=>{let e=this.renderRoot?.querySelector?.(`h1, h2, [role="heading"]`)??this;e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`-1`),e.focus?.({preventScroll:!0})})}static{this.SKELETON_DELAY_MS=400}connectedCallback(){super.connectedCallback(),this.overridesParsed=Ys(this.overrides),this.addEventListener(`server-side-action-requested`,this.actionRequestedListener),this.addEventListener(`backend-call-failed`,this.backendFailedListener),this.addEventListener(`history-pushed`,this.historyPushed),this.addEventListener(`route-changed`,this.routeChangedListener),this.addEventListener(`backend-called-event`,this.loadLifecycleListener),this.addEventListener(`backend-succeeded-event`,this.loadLifecycleListener),this.addEventListener(`backend-failed-event`,this.loadLifecycleListener),this.addEventListener(`backend-cancelled-event`,this.loadLifecycleListener)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`server-side-action-requested`,this.actionRequestedListener),this.removeEventListener(`backend-call-failed`,this.backendFailedListener),this.removeEventListener(`history-pushed`,this.historyPushed),this.removeEventListener(`route-changed`,this.routeChangedListener),this.removeEventListener(`backend-called-event`,this.loadLifecycleListener),this.removeEventListener(`backend-succeeded-event`,this.loadLifecycleListener),this.removeEventListener(`backend-failed-event`,this.loadLifecycleListener),this.removeEventListener(`backend-cancelled-event`,this.loadLifecycleListener),clearTimeout(this.skeletonTimer)}shouldUpdate(e){if(this.fragment?.component&&[...e.keys()].every(e=>e===`appState`||e===`appData`)){let t=this.renderRoot.querySelector(`mateu-component`);if(t)return e.has(`appState`)&&(t.appState=this.appState),e.has(`appData`)&&(t.appData=this.appData),!1}return!0}updated(e){if((e.has(`id`)||e.has(`baseurl`)||e.has(`route`)||e.has(`consumedRoute`)||e.has(`instant`))&&!this.preventNavigation){this.callbackToken=this.instant||se();let e=this.structureCacheKey(),t=e===this.lastAuthoritativeKey?void 0:Gc(e);if(t)queueMicrotask(()=>this.applyFragment(t));else{if(e!==this.lastAuthoritativeKey){let t=zc(e);this.currentStructureHash=t?.hash,t&&(this.fragment={targetComponentId:this.id,component:t.component,state:{},data:{},action:We.Replace,containerId:void 0},this.stampPageChrome())}this.manageActionEvent(new CustomEvent(`server-side-action-requested`,{detail:{route:this.route,consumedRoute:this.consumedRoute,userData:void 0,actionId:``,serverSideType:this.serverSideType,initiatorComponentId:this.id,initiator:this,componentState:this.initialState,knownStructureHash:this.currentStructureHash,callbackToken:this.callbackToken},bubbles:!0,composed:!0}))}}e.has(`route`)&&this.top&&(this.preventNavigation||(this.pendingRouteFocus=!0),this.preventNavigation||this.dispatchEvent(new CustomEvent(`route-changed`,{detail:{route:this.route},bubbles:!0,composed:!0}))),this.preventNavigation&&=!1}applyFragment(e){if(!e.component&&this.fragment?.component){this.fragment={...this.fragment,state:{...this.fragment.state??{},...e.state??{}},data:{...this.fragment.data??{},...e.data??{}}},this.stampPageChrome();return}if(this.fragment=e,e.component){if(e.action!==We.Add){let t=this.structureCacheKey(),n=e.component.structureHash;Bc(t,e.component,n),this.lastAuthoritativeKey=t,this.currentStructureHash=n,e.component.staticView&&Kc(t,e)}this.pendingRouteFocus&&this.hasRenderedContent&&this.focusNewContent(),this.pendingRouteFocus=!1,this.hasRenderedContent=!0}this.stampPageChrome()}stampPageChrome(){let e=this.fragment?.component;!e||e===this.lastStampedComponent||(this.lastStampedComponent=e,this.dataset.pageWidth=jc(e,{top:this.top}),this.dataset.pageType=Ec(e)??``,this.dataset.hasWelcomeBanner=String(kc(e)))}render(){return!this.fragment?.component&&this.showSkeleton?E`
  ...
  `}};k([b()],X.prototype,`consumedRoute`,void 0),k([b()],X.prototype,`serverSideType`,void 0),k([b()],X.prototype,`uriPrefix`,void 0),k([b()],X.prototype,`overrides`,void 0),k([b()],X.prototype,`homeRoute`,void 0),k([b()],X.prototype,`route`,void 0),k([b()],X.prototype,`top`,void 0),k([b()],X.prototype,`instant`,void 0),k([b()],X.prototype,`initialState`,void 0),k([b()],X.prototype,`appState`,void 0),k([b()],X.prototype,`appData`,void 0),k([w()],X.prototype,`fragment`,void 0),k([w()],X.prototype,`showSkeleton`,void 0),X=qc=k([_(`mateu-ux`)],X);function Jc(e){let t=`var(--lumo-space-m, 1rem)`,n={left:`50%`,transform:`translateX(-50%)`};switch(e){case`topStart`:return{top:t,left:t};case`topCenter`:return{top:t,...n};case`topEnd`:return{top:t,right:t};case`topStretch`:return{top:t,left:t,right:t};case`middle`:return{top:`50%`,left:`50%`,transform:`translate(-50%, -50%)`};case`bottomStart`:return{bottom:t,left:t};case`bottomCenter`:return{bottom:t,...n};case`bottomStretch`:return{bottom:t,left:t,right:t};default:return{bottom:t,right:t}}}function Yc(e){switch(e){case`success`:return{bg:`var(--lumo-success-color, #2e7d32)`,fg:`#fff`};case`error`:return{bg:`var(--lumo-error-color, #c62828)`,fg:`#fff`};case`warning`:return{bg:`var(--lumo-warning-color, #f9a825)`,fg:`#1a1a1a`};case`contrast`:return{bg:`var(--lumo-contrast-90pct, #1a1a1a)`,fg:`#fff`};default:return{bg:`var(--lumo-base-color, #fff)`,fg:`var(--lumo-body-text-color, #1a1a1a)`}}}var Xc={show(e,t){let{bg:n,fg:r}=Yc(e.variant),i=Jc(e.position),a=document.createElement(`div`),o=e.variant===`error`;a.setAttribute(`role`,o?`alert`:`status`),a.setAttribute(`aria-live`,o?`assertive`:`polite`),a.setAttribute(`aria-atomic`,`true`),Object.assign(a.style,{position:`fixed`,zIndex:`2000`,display:`flex`,alignItems:`center`,gap:`0.75rem`,maxWidth:`min(90vw, 28rem)`,padding:`0.7rem 1rem`,borderRadius:`var(--lumo-border-radius-m, 8px)`,boxShadow:`var(--lumo-box-shadow-m, 0 4px 16px rgba(0,0,0,0.2))`,background:n,color:r,font:`inherit`,fontSize:`var(--lumo-font-size-s, 0.875rem)`,opacity:`0`,transition:`opacity 0.2s ease`,...i});let s=document.createElement(`span`);s.textContent=e.text,a.appendChild(s);let c=()=>{a.style.opacity=`0`,setTimeout(()=>a.remove(),200)},l=e.onAction?{label:e.actionLabel??`Retry`,run:e.onAction}:e.undoActionId?{label:e.undoLabel??`Undo`,run:()=>t.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.undoActionId,parameters:e.undoParameters??{}},bubbles:!0,composed:!0}))}:void 0;if(l){let e=document.createElement(`button`);e.textContent=l.label,e.style.cssText=`margin-left: 0.25rem; background: none; border: 1px solid currentColor; border-radius: var(--lumo-border-radius-s, 4px); color: inherit; cursor: pointer; padding: 0.15rem 0.6rem; font: inherit; font-weight: 600;`,e.addEventListener(`click`,()=>{l.run(),c()}),a.appendChild(e)}document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity=`1`});let u=e.duration??(l?1e4:5e3);u>0&&setTimeout(c,u)}};function Zc(){Po(Xc)}var Qc=class extends x{constructor(...e){super(...e),this.online=!0,this.recovered=!1}connectedCallback(){super.connectedCallback(),this.online=Ot.isOnline(),this.unsubscribe=Ot.subscribe(e=>{let t=!this.online;this.online=e,e&&t&&(this.recovered=!0,clearTimeout(this.recoveredTimer),this.recoveredTimer=setTimeout(()=>{this.recovered=!1},4e3))})}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.(),clearTimeout(this.recoveredTimer),this.releaseSpace()}updated(){let e=this.renderRoot.querySelector(`.bar`);if(!e){this.releaseSpace();return}document.body.style.setProperty(`padding-block-start`,`${e.offsetHeight}px`)}releaseSpace(){typeof document<`u`&&document.body?.style.removeProperty(`padding-block-start`)}render(){if(this.online&&!this.recovered)return y;let e=!this.online;return E`<div class="bar ${e?`offline`:`back`}" role="status" aria-live="polite">
    ...
    `}};k([w()],Qc.prototype,`online`,void 0),k([w()],Qc.prototype,`recovered`,void 0),Qc=k([_(`mateu-connectivity-banner`)],Qc);var $c=null;function el(){if(!(typeof document>`u`)&&!($c&&$c.isConnected)){if(!document.body){document.addEventListener(`DOMContentLoaded`,()=>el(),{once:!0});return}$c=document.createElement(`mateu-connectivity-banner`),document.body.appendChild($c)}}var tl,nl=class extends x{static{tl=this}constructor(...e){super(...e),this.skip=()=>{let e=this.findContent();e&&(e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`-1`),e.focus(),e.scrollIntoView({block:`start`}))}}static{this.TARGETS=[`.app-content`,`mateu-page`,`mateu-ux`,`mateu-component`]}findContent(){let e=new Set,t=n=>{if(e.has(n))return null;e.add(n);for(let e of tl.TARGETS){let t=n.querySelector?.(e);if(t&&t!==this)return t}for(let e of Array.from(n.querySelectorAll?.(`*`)??[]))if(e.shadowRoot){let n=t(e.shadowRoot);if(n)return n}return null};return t(document)}render(){return E`<button class="skip" @click="${this.skip}">Skip to content</button>`}static{this.styles=g`
        :host {
            position: fixed;
            inset-block-start: 0;
  ...
  `}};k([b()],sl.prototype,`baseUrl`,void 0),k([b()],sl.prototype,`route`,void 0),k([b()],sl.prototype,`consumedRoute`,void 0),k([b()],sl.prototype,`config`,void 0),k([b()],sl.prototype,`top`,void 0),k([b()],sl.prototype,`pathPrefix`,void 0),k([b()],sl.prototype,`bundleUrl`,void 0),k([w()],sl.prototype,`instant`,void 0),k([b({type:Boolean})],sl.prototype,`debug`,void 0),sl=k([_(`mateu-ui`)],sl);var cl,ll=class extends x{static{cl=this}constructor(...e){super(...e),this.baseUrl=``,this.opened=!1,this.searchText=``}static{this.SEARCHABLE_THRESHOLD=7}connectedCallback(){super.connectedCallback(),Re()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick(),this.searchTimer&&clearTimeout(this.searchTimer)}currentValue(){return String(Pe()[this.selector.fieldName]??``)}currentLabel(){let e=this.currentValue();if(!e)return`—`;let t=(this.searchedOptions??this.selector.options)?.find(t=>String(t.value)===e);if(t)return t.label;let n=Fe()[this.selector.fieldName];return n===void 0?e:String(n)}pick(e,t){Ie(this.selector.fieldName,e,t),window.location.reload()}detachOutsideClick(){this.outsideClick&&=(document.removeEventListener(`mousedown`,this.outsideClick),void 0)}openPanel(){this.opened||(this.opened=!0,this.searchText=``,this.searchedOptions=void 0,this.remoteSearch(),this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener(`mousedown`,this.outsideClick),this.updateComplete.then(()=>this.renderRoot.querySelector(`input.picker-search`)?.focus()))}closePanel(){this.detachOutsideClick(),this.opened=!1}onSearchInput(e){this.searchText=e.target.value,this.searchTimer&&clearTimeout(this.searchTimer),this.searchTimer=setTimeout(()=>this.remoteSearch(),300)}async remoteSearch(){let e=this.app;if(e?.serverSideType)try{let t=await Mt.runAction(this.baseUrl??``,e.rootRoute??e.initialRoute??``,``,`_appcontext-search-${this.selector.fieldName}`,`appcontext-${this.selector.fieldName}`,void 0,e.serverSideType,{},{searchText:this.searchText},this,!0);for(let e of t?.fragments??[]){let t=e.data?.[`_appcontext_${this.selector.fieldName}`]?.content;if(Array.isArray(t)){this.searchedOptions=t.map(e=>({value:e.value,label:e.label??String(e.value)}));return}}}catch{}}visibleOptions(){let e=this.searchedOptions??this.selector.options??[],t=this.searchText.trim().toLowerCase();return t?e.filter(e=>e.label.toLowerCase().includes(t)):e}renderPanel(){let e=this.currentValue(),t=this.visibleOptions();return E`
    ...
    `}};k([b()],ll.prototype,`selector`,void 0),k([b()],ll.prototype,`app`,void 0),k([b()],ll.prototype,`baseUrl`,void 0),k([w()],ll.prototype,`opened`,void 0),k([w()],ll.prototype,`searchText`,void 0),k([w()],ll.prototype,`searchedOptions`,void 0),ll=cl=k([_(`mateu-app-context-picker`)],ll);var ul=class extends x{constructor(...e){super(...e),this.baseUrl=``,this.opened=!1,this.notifications=[],this.fetched=!1}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}updated(){!this.fetched&&this.app?.serverSideType&&(this.fetched=!0,this.refresh())}unreadCount(){return this.notifications.filter(e=>e.unread).length}async runNotificationsAction(e,t){let n=this.app;if(n?.serverSideType)try{let r=await Mt.runAction(this.baseUrl??``,n.rootRoute??n.initialRoute??``,``,e,`notification-bell`,void 0,n.serverSideType,{},t,this,!0);for(let e of r?.fragments??[]){let t=e.data?._notifications;if(Array.isArray(t)){this.notifications=t;return}}}catch{}}refresh(){return this.runNotificationsAction(`_notifications-list`,{})}markRead(e){return this.runNotificationsAction(`_notifications-read`,{ids:e})}detachOutsideClick(){this.outsideClick&&=(document.removeEventListener(`mousedown`,this.outsideClick),void 0)}openPanel(){this.opened||(this.opened=!0,this.refresh(),this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener(`mousedown`,this.outsideClick))}closePanel(){this.detachOutsideClick(),this.opened=!1}async entryClicked(e){e.unread&&await this.markRead([e.id]);let t=e.route;if(t){if(!es.confirmLeave())return;this.closePanel(),this.dispatchEvent(new CustomEvent(`route-changed`,{detail:{route:t},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`navigate-to-requested`,{detail:{route:t},bubbles:!0,composed:!0}))}}renderEntry(e){return E`
        ...
        ${R}
    `}};k([b()],ul.prototype,`app`,void 0),k([b()],ul.prototype,`baseUrl`,void 0),k([w()],ul.prototype,`opened`,void 0),k([w()],ul.prototype,`notifications`,void 0),ul=k([_(`mateu-notification-bell`)],ul);var dl=e=>{if(!e||!(`querySelectorAll`in e))return null;for(let t of e.querySelectorAll(`*`)){if(t.tagName?.toLowerCase()===`mateu-component`)return t;let e=dl(t.shadowRoot);if(e)return e}return null},fl=async(e,t,n)=>{let r=dl(t.renderRoot??t);await yc.runAction(Mt,t.baseUrl??``,e.rootRoute||`_no_route`,``,n,r?.id??`app-header-action`,{},e.serverSideType??``,{},{},r??t,!0,void 0,!1,``)},pl=async(e,t,n)=>{try{await fl(e,t,n)}catch(e){Fo({text:`La acción falló: `+e,position:`bottomStart`,duration:6e3,variant:`error`},t)}},ml=(e,t)=>{let n=e.contextSelectors??[],r=e.contextActions??[];return n.length===0&&r.length===0&&!e.notificationsEnabled?y:E`${e.notificationsEnabled?E`
        ...
        <button class="app-header-action-btn" style="margin-left: 0.5rem; flex-shrink: 0;"
            @click="${()=>n.actionId&&pl(e,t,n.actionId)}" title="${n.label}">${n.icon?F(n.icon):y}${n.label}</button>`)}`},hl=(e,t)=>E`
    <button class="mateu-nav-item ${e.selected?`mateu-nav-item--active`:``}"
            ?disabled="${e.disabled}"
            @click="${()=>t(e)}">${e.text}</button>`,gl=(e,t,n=``)=>E`
    <nav class="mateu-nav ${n}">
        ${e.map(e=>(e.children?.length??0)>0?E`<details class="mateu-nav-group">
                       ...
                       <div class="mateu-nav-panel">
                           ${e.children.map(e=>hl(e,t))}
                       </div>
                   </details>`:hl(e,t))}
    </nav>`,_l=(e,t)=>n=>t.call(e,{detail:{value:n}}),vl=(e,t)=>e.themeToggle?E`
    ...
    `:y,yl=(e,t)=>{t.filter!=e.detail.value&&(t.filter=e.detail.value)},bl=(e,t,n)=>{let r=xl(e,t,n),i=Z(t,n);return r==`list`||r==i?`new`:r},xl=(e,t,n)=>{let r=e?._route;if(r!=null&&(r===``||r.startsWith(`/`))){let e=n.homeRoute??``,i=e.indexOf(`?`),a=i>=0?e.substring(i+1):``,o=Z(t,n)+r;return a?o+(o.indexOf(`?`)>=0?`&`:`?`)+a:o}return t.selectedRoute?t.selectedRoute:n.homeRoute},Z=(e,t)=>e.selectedRoute?e.selectedConsumedRoute??t.route:t.homeConsumedRoute,Sl=(e,t)=>e.selectedRoute?e.selectedBaseUrl??e.baseUrl:e.baseUrl||t.homeBaseUrl,Cl=(e,t)=>e.selectedRoute?e.selectedServerSideType??t.serverSideType:t.homeServerSideType,wl=(e,t)=>e.selectedRoute?e.selectedUriPrefix:t.homeUriPrefix,Tl=(e,t)=>`ux_`+((Z(e,t)||`root`)+`|`+(Cl(e,t)??``)).replace(/[^a-zA-Z0-9]/g,`_`),El=(e,t,n,r,i,a,o)=>{t.variant!==Nt.MENU_ON_TOP&&t.menu?.some(e=>e.remote)&&(t={...t,variant:Nt.MENU_ON_TOP});let s=Tl(e,t);if(t.chromeless)return E`
        ...
        `;let c=e.mapItems(t.menu,e.filter?.toLowerCase()??``),l=Z(e,t),u=bl(r,e,t),d=u&&u!==`new`&&u.startsWith(l+`/`)?u.substring(l.length+1).split(`/`)[0]:void 0;return E`
...
`:y}
                            ...
                            ${t.menu&&t.totalMenuOptions>10?E`
                                <div style="position: sticky; top: 0; z-index: 2; background: var(--lumo-base-color); padding: .25rem 0 .5rem;">
                                    <input class="drawer-search" placeholder="Search…" style="width: calc(100% - 20px); margin: 0 10px;"
                                           @input="${t=>yl({detail:{value:t.target.value}},e)}">
                                </div>
                                `:y}
                            <nav class="side-nav">
            ...
            ${t.variant==Nt.MENU_ON_TOP?E`
                <div class="m-vl" style="width: 100%; height: 100vh; overflow: hidden;">
                    <div class="m-hl"
                        ...
                        ${(()=>{let t=_l(e,e.itemSelected);return N.get()?.renderTopNav?.(c,t,`menu-on-top`)??gl(c,t,`menu-on-top`)})()}
            ...
            ${t.variant==Nt.TILES?E`
                <div class="m-vl" style="width: 100%; height: 100vh; overflow: hidden;">
                    <div class="m-hl"
                        ...
                        ${gl(e.mapItemsForTiles(t.menu),_l(e,e.itemSelectedTiles),`menu-on-top`)}
                        <div class="m-hl" style="margin-left: auto; flex-shrink: 0; align-items: center;">
                            <slot name="widgets"></slot>
                            ${ml(t,e)}${vl(t,e)}
                        </div>
            ...
            <slot></slot>
       `},Dl=class{renderFilterBar(e,t,n,r,i,a,o,s){let c=t?.metadata;return E`
            <mateu-filter-bar
                .metadata="${c}"
        ...
        ></mateu-pagination>
        `}renderTableComponent(e,t,n,r,i,a,o){return kr(t,(e.data?.[e.id])?.page?.content??[],r[t?.id]?.emptyStateMessage)}rendererName(){return this.constructor?.name??`unknown`}supportedClientSideTypes(){}renderClientSideComponent(e,t,n,r,i,a,o,s){let c=t?.metadata?.type??t?.type,l=Object.values(j).includes(c)?c:void 0;return io(this.supportedClientSideTypes(),l)?co(t,l,this.rendererName()):ko(e,t,n,r,i,a,o,s)}renderAppComponent(e,t,n,r,i,a,o){return El(e,t?.metadata,n,r,i,a,o)}},Ol=(e,t,n,r,i,a,o)=>E`
        <vaadin-virtual-list
                ...
                slot="${t.slot??y}"
        ></vaadin-virtual-list>
    `,kl=e=>{let t=e.metadata;return E`
        <vaadin-notification
                .opened="${!0}"
                slot="${e.slot??y}"
                style="${e.style}"
                ...
                `,[])}
        ></vaadin-notification>
    `},Al=(e,t={})=>{let n=e.metadata,r=n.valueKey?t[n.valueKey]:n.value;return E`
        <div style="${e.style}">
        <vaadin-progress-bar
    ...
    `},jl=(e,t,n,r,i,a,o)=>{let s=t.metadata;return E`
        <vaadin-details
                ?opened="${s.opened}"
                style="${t.style}"
                class="${t.cssClasses}"
        ...
        >
            ...
            `},Ml=(e,t,n)=>{let r=e.metadata;return E`<vaadin-avatar
            img="${r.image}"
            name="${Zt(r.name,t,n)}"
            abbr="${r.abbreviation}"
            style="${e.style}" class="${e.cssClasses}"
            slot="${e.slot??y}"
    ></vaadin-avatar>`},Nl=e=>{let t=e.metadata;return E`<vaadin-avatar-group max-items-visible="${t.maxItemsVisible}"
                                     .items="${t.avatars}"
                                     style="${e.style}" class="${e.cssClasses}"
                                     slot="${e.slot??y}">
    </vaadin-avatar-group>`},Pl=(e,t,n,r,i,a,o)=>{let s=t.metadata;if(!s)return E``;let c=``;return s.variants?.map(e=>e==`stretchMedia`?`stretch-media`:e==`coverMedia`?`cover-media`:e).forEach(e=>c+=` `+e),c=c.trim(),E`
        <vaadin-card
                style="${t.style}"
                class="${t.cssClasses}"
                theme="${c}"
    ...
    `}render(){return E`
        ...
        `}};k([b({type:Array})],Il.prototype,`tabLabels`,void 0),k([w()],Il.prototype,`mode`,void 0),k([w()],Il.prototype,`selected`,void 0),Il=k([_(`mateu-adaptive-tabs`)],Il);var Ll=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style;c??=``,s.columnSpacing&&(c+=`--vaadin-form-layout-column-spacing: `+s.columnSpacing+`;`);let l=s.itemRowSpacing&&s.itemRowSpacing!==`0`?s.itemRowSpacing:`var(--lumo-space-m)`;return c+=`--vaadin-form-layout-row-spacing: `+l+`;`,s.itemLabelSpacing&&(c+=`--vaadin-form-layout-label-spacing: `+s.itemLabelSpacing+`;`),s.labelsAside&&(c+=`--vaadin-form-item-label-width: 10rem;`),s.fullWidth&&(c+=`width: 100%;`),E`
            ...
            `},Rl=(e,t,n,r,i,a,o,s)=>n.type==A.ClientSide&&n.metadata?.type==j.FormRow?Bl(e,t,n,r,i,a,o,s):e.labelsAside?zl(t,n,r,i,a,o,s):P(t,n,r,i,a,o,s),zl=(e,t,n,r,i,a,o)=>{if(t.type==A.ClientSide&&t.metadata?.type==j.FormField&&t.metadata.label){let s=t.metadata,c=s.label?.includes("${")?e._evalTemplate(s.label):s.label;return E`
                       <vaadin-form-item data-colspan="${s.colspan}">
                           <label slot="label">${c}</label>
                           ${P(e,t,n,r,i,a,o,!0)}
                       </vaadin-form-item>
                   `}return P(e,t,n,r,i,a,o)},Bl=(e,t,n,r,i,a,o,s)=>E`
        <vaadin-form-row>
            ${n.children?.map(n=>Rl(e,t,n,r,i,a,o,s))}
        </vaadin-form-row>
            `,Vl=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=(s.padding?` padding`:``)+(s.spacing?` spacing`:``)+(s.spacingVariant?` spacing-`+s.spacingVariant:``)+(s.wrap?` wrap`:``),l=t.style;return s.fullWidth&&(l=l?`width: 100%;`+l:`width: 100%;`),s.justification&&(l=l?`justify-content: `+s.justification+`;`+l:`justify-content: `+s.justification+`;`),s.verticalAlignment&&(l=l?`align-items: `+s.verticalAlignment+`;`+l:`align-items: `+s.verticalAlignment+`;`),E`
               <vaadin-horizontal-layout 
                       style="${l}" 
                       class="${t.cssClasses}"
                       theme="${c}"
    ...
    `},Ul=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style;return s.fullWidth&&(c=c?`width: 100%;`+c:`width: 100%;`),E`
               <vaadin-split-layout 
                       style="${c}" 
                       class="${t.cssClasses}"
            ...
            `},Wl=(e,t,n,r,i,a,o)=>{let s=t.children&&t.children.length>1?t.children[1]:null,c=i?.detailComponent??null,l=!!i?.hasDetail||!!s,u=c??s;return E`
        ...
        <div tab="${s?.includes("${")?e._evalTemplate(s):s}" style="padding: var(--lumo-space-m) 0;">
            ...
            `},ql=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=t.style;s.fullWidth&&(c=c?`width: 100%;`+c:`width: 100%;`);let l=0;if(t.children){for(let e=0;e<t.children.length;e++)if(t.children[e].metadata?.active){l=e;break}}return E`
               <vaadin-accordion
                       style="${t.style}"
                       class="${t.cssClasses}"
                       opened="${l}"
    ...
    </vaadin-menu-bar>`,eu=(e,t,n,r,i,a,o)=>{let s=t.metadata;return E`
        <vaadin-context-menu .items=${ru(e,s.menu,n,r,i,a,o)} 
                             style="${t.style}" 
                             class="${t.cssClasses}"
    ...
    `}};k([b()],lu.prototype,`fieldId`,void 0),k([b()],lu.prototype,`value`,void 0),k([b()],lu.prototype,`accept`,void 0),k([b({type:Boolean})],lu.prototype,`editable`,void 0),lu=su=k([_(`mateu-file-upload`)],lu);var uu=e=>e==null||typeof e==`string`&&e.trim()===``,du=(e,t)=>{if(uu(e))return null;let n=t?parseInt(String(e),10):Number(e);return Number.isNaN(n)?null:n},fu=(e,t)=>uu(e)&&uu(t)?!0:e==t,pu=e=>!!e&&typeof e==`object`&&`__mateuGroup`in e,mu=e=>String(e??``),hu=(e,t,n)=>{let r=e??[];if(!t||!n||n.length===0)return r;let i=[],a,o=!1;return r.forEach((e,s)=>{let c=mu(e?.[t]);if(!o||c!==a){let e=n.find(e=>mu(e.value)===c)??{value:c,count:r.filter(e=>mu(e?.[t])===c).length,aggregates:{}};i.push({__mateuGroup:e,__mateuGroupBy:t,_rowNumber:`__mateuGroup:${s}:${c}`}),o=!0,a=c}i.push(e)}),i},gu=(e,t)=>e==null?``:t.dataType===`money`||t.stereotype===`money`?new Intl.NumberFormat(`de-DE`,{minimumFractionDigits:2,maximumFractionDigits:2}).format(e):t.aggregate===`count`?new Intl.NumberFormat(void 0,{maximumFractionDigits:0}).format(Math.round(e)):new Intl.NumberFormat(void 0,{maximumFractionDigits:2}).format(e),_u=(e,t)=>e&&t.includes(e)?e:t.find(e=>!!e),vu=(e,t,n)=>{let r=e.__mateuGroup;return t.id===n?`${r.value} (${r.count})`:t.aggregate?gu(r.aggregates?.[t.id],t):``},yu=(e,t,n)=>{let r=t?.aggregates;if(!r||!e.some(e=>e.aggregate))return;let i={};e.forEach(e=>{e.aggregate&&r[e.id]!=null&&(i[e.id]=gu(r[e.id],e))});let a=e[0];if(a&&i[a.id]===void 0){let e=t?.page?.totalElements;i[a.id]=n&&a.id===n&&e!=null?`Total (${e})`:`Total`}return i},bu=(e,t,n)=>{let r=e[n.path]??``,i=t.captionPath?e[t.captionPath]:void 0,a=t.leadingPath?e[t.leadingPath]:void 0;return E`
        <span style="display: flex; align-items: center; gap: var(--lumo-space-s); overflow: hidden;">
        ...
        </span>`},xu=(e,t,n)=>F(e[n.path]?`vaadin:check`:`vaadin:minus`,`height: 16px; width: 16px; color: var(--lumo-body-text-color);`),Su=(e,t,n,r,i)=>{let a=e[n.path],o=a;return r==`money`&&a&&a.locale&&a.currency?o=new Intl.NumberFormat(a.locale,{style:`currency`,currency:a.currency}).format(a.value):i==`money`&&(o=new Intl.NumberFormat(`de-DE`,{minimumFractionDigits:2,maximumFractionDigits:2}).format(a)),E`${o}`},Cu=(e,t,n)=>{e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId,parameters:n},bubbles:!0,composed:!0}))},wu=(e,t,n,r,i,a)=>{let o=n.xcolumn??a;if(o.text)return o.actionId?E`<a href="javascript: void(0);" @click="${t=>Cu(n,o,e)}">${o.text}</a>`:E`<a href="${e[n.path]}">${o.text}</a>`;if(r==`string`){if(o.actionId)return E`<a href="javascript: void(0);" @click="${t=>Cu(n,o,e)}">${e[n.path]}</a>`;let t=e[n.path];return E`<a href="${t}">${t}</a>`}let s=e[n.path];return E`<a href="${s.href}">${s.text}</a>`},Tu=(e,t,n,r,i)=>{let a=e[n.path];return r==`string`?a.split(`,`).map(e=>F(e,`width: 16px;`)):a.split(`,`).map(e=>F(e.icon,`width: 16px;`))},Eu=(e,t,n,r,i)=>{let a=e[n.path];return E`${v(a)}`},Du=(e,t,n,r,i,a)=>r==`string`?E`<img src="${e[n.path]}" style="${`max-height: 40px; `+(a.style??``)}">`:E`<img src="${e[n.path].src}" style="${a.style??``}">`,Ou=e=>{let t={_clickedRow:e.target.row};e.target?.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:`action-on-row-`+e.detail.value.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},ku=e=>{let t={_clickedRow:e.target.row},n=e.target.action;e.target?.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:`action-on-row-`+n.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},Au=e=>{let t=document.createElement(`vaadin-context-menu-item`),n=document.createElement(`vaadin-icon`);return n.style.color=`var(--lumo-secondary-text-color)`,n.style.marginInlineEnd=`var(--lumo-space-s)`,n.style.padding=`var(--lumo-space-xs)`,n.setAttribute(`icon`,e.icon),t.appendChild(n),e.label&&t.appendChild(document.createTextNode(e.label)),t.disabled=e.disabled,t},ju=(e,t,n)=>{let r=e[n.path]?.actions?.map(e=>e.icon?{component:Au(e),methodNameInCrud:e.methodNameInCrud}:{...e,text:e.label});return!r||r.length==0?E``:E`
                                     <vaadin-menu-bar
         ...
         <vaadin-button theme="tertiary" title="Select" @click="${ku}" .row="${e}" .action="${{actionId:n.path,icon:``,label:`Select`,disabled:!1,methodNameInCrud:`select`}}">
             Select
         </vaadin-button>
    `;let r=n.path&&e[n.path]?.methodNameInCrud?e[n.path]:e.action;return r?E`
         <vaadin-button theme="tertiary${r.icon&&!r.label?` icon`:``}" title="${r.label||y}" @click="${ku}" .row="${e}" .action="${r}">
             ${r.icon?E`<vaadin-icon icon="${r.icon}"></vaadin-icon>`:y}
             ${r.label?r.label:y}
         </vaadin-button>
    `:E``},Nu=(e,t,n)=>{e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.actionId,parameters:n},bubbles:!0,composed:!0}))},Pu=(e,t,n,r,i,a)=>{let o=n.xcolumn??a;if(o.actionId)return E`
            <vaadin-button theme="tertiary" @click="${t=>Nu(n,o,e)}" .row="${e}">
                ${o.text||e[n.path]}
            </vaadin-button>
        `;let s=e[n.path];return E`<a href="${s}">${o.text||s}</a>`},Fu=(e,t,n,r,i,a,o,s,c)=>{let l=e[n.path];return P(r,l,i,a,o,s,c)},Iu=new WeakMap,Lu=(e,t)=>Iu.get(e)?.[t],Ru=(e,t,n)=>{let r=Iu.get(e);r||(r={},Iu.set(e,r)),r[t]=n},zu=(e,t=!1)=>du(e,t),Bu=(e,t,n,r)=>{let i=n?.field?.fieldId,a=a=>{if(e[t.id]===a||e[t.id]==null&&(a===``||a==null))return;if(e[t.id]=a,!i){n.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:`update-row`,parameters:{_editedRow:{...e}}},bubbles:!0,composed:!0}));return}let o=(n?.state??r)[i];n.dispatchEvent(new CustomEvent(`value-changed`,{detail:{fieldId:i,value:Array.isArray(o)?[...o]:o},bubbles:!0,composed:!0}))},o=e[t.id],s=o==null?``:String(o);switch(t.editorType){case`boolean`:return E`<vaadin-checkbox ?checked=${!!o} @checked-changed=${e=>a(e.detail.value)}></vaadin-checkbox>`;case`integer`:return E`<vaadin-integer-field theme="small" style="width:100%;" .value=${s} @change=${e=>a(zu(e.target.value,!0))}></vaadin-integer-field>`;case`number`:return E`<vaadin-number-field theme="small" style="width:100%;" .value=${s} @change=${e=>a(zu(e.target.value))}></vaadin-number-field>`;case`date`:return E`<vaadin-date-picker theme="small" style="width:100%;" .value=${s} @value-changed=${e=>a(e.detail.value)}></vaadin-date-picker>`;case`time`:return E`<vaadin-time-picker theme="small" style="width:100%;" .value=${s} @value-changed=${e=>a(e.detail.value)}></vaadin-time-picker>`;case`datetime`:return E`<vaadin-date-time-picker theme="small" style="width:100%;" .value=${s} @value-changed=${e=>a(e.detail.value)}></vaadin-date-time-picker>`;case`select`:return E`<vaadin-combo-box
                ...
                @selected-item-changed=${n=>{let r=n.detail.value,i=r?r.value:null;String(i??``)!==s&&(r&&Ru(e,t.id,r.label),a(i))}}></vaadin-combo-box>`}default:return E`<vaadin-text-field theme="small" style="width:100%;" .value=${s} @change=${e=>a(e.target.value)}></vaadin-text-field>`}},Vu=e=>m(()=>E`<span title="${e}" style="white-space:normal;overflow-wrap:break-word;">${e}</span>`,[e]),Hu=e=>e===void 0?y:d(()=>E`<span style="font-weight: 600; white-space: nowrap;">${e}</span>`,[e]),Uu=e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget?.dispatchEvent(new CustomEvent(`sort-direction-changed`,{detail:{grid:e.currentTarget.parentElement},bubbles:!0,composed:!0}))},Wu=(e,t,n,r,i,a,o,s)=>E`
<vaadin-grid-column-group header="${M(e.label,r,i)}">
    ${e.columns.map(e=>Ku(e.metadata,t,n,r,i,a,o,s?.[e.metadata?.id]))}
</vaadin-grid-column-group>
`,Gu=(e,t,n,r,i,a,o,s)=>j.GridGroupColumn==e.metadata?.type?Wu(e.metadata,t,n,r,i,a,o,s):Ku(e.metadata,t,n,r,i,a,o,s?.[e.metadata?.id]),Ku=(e,n,r,i,a,o,s,c)=>{let l=M(e.label,i,a);return e.sortable?E`
                        <vaadin-grid-sort-column
                                ...
                                width="${e.width??y}"
                                @direction-changed="${Uu}"
                                data-data-type="${e.dataType}"
                                data-stereotype="${e.stereotype}"
                                ${Vu(l)}
                                ${Hu(c)}
                                ${t((t,c,l)=>qu(t,c,l,e,n,r,i,a,o,s),[e,i,a])}
                        ></vaadin-grid-sort-column>
                    `:e.filterable?E`
                    ...
                    `:E`
                        <vaadin-grid-column
                                ...
                                ${t((t,c,l)=>qu(t,c,l,e,n,r,i,a,o,s),[e,i,a])}
                        ></vaadin-grid-column>
                    `},qu=(e,t,n,r,i,a,o,s,c,l)=>{let u=n.dataset.dataType??``,d=n.dataset.stereotype??``;if(pu(e)){let t=i?.metadata,n=(t?.columns??[]).flatMap(e=>e?.metadata?.type===j.GridGroupColumn?(e.metadata.columns??[]).map(e=>e?.metadata?.id):[e?.metadata?.id]),a=vu(e,r,_u(e.__mateuGroupBy,n)),o=e.__mateuGroup.hiddenActions??[],s=r.id===n[n.length-1]?(t?.groupActions??[]).filter(e=>!o.includes(e.actionId??e.id)):[];return s.length?E`<span style="display: flex; align-items: center; justify-content: flex-end; gap: var(--lumo-space-s); overflow: hidden;">
                ...
                `)}
            </span>`:E`<span title="${a}" style="font-weight: 600; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; display: block;">${a}</span>`}if(r.editable)return Bu(e,r,i,o);if(u==`status`)return jo(e,t,n);if(d==`primary`)return bu(e,r,n);if(u==`bool`)return xu(e,t,n);if(u==`money`||d==`money`)return Su(e,t,n,u,d);if(u==`link`||d==`link`)return wu(e,t,n,u,d,r);if(u==`icon`||d==`icon`)return Tu(e,t,n,u,d);if(d==`html`)return Eu(e,t,n,u,d);if(d==`image`)return Du(e,t,n,u,d,r);if(u==`menu`)return ju(e,t,n);if(u==`component`)return Fu(e,t,n,i,a,o,s,c,l);if(u==`action`)return Mu(e,t,n);if(u==`actionGroup`)return ju(e,t,n);if(d==`button`||r.actionId)return Pu(e,t,n,u,d,r);let f=e[n.path],p=i?.metadata?.rowRoute;if(r.identifier&&p){let t=on(p,e,o,s);if(t)return E`<a href="${`/`+t.replace(/^\/+/,``)}" title="${f}"
    ...
    `}};k([b()],Xu.prototype,`field`,void 0),k([b()],Xu.prototype,`state`,void 0),k([b()],Xu.prototype,`data`,void 0),k([b()],Xu.prototype,`appState`,void 0),k([b()],Xu.prototype,`appData`,void 0),k([b()],Xu.prototype,`selectedItems`,void 0),k([w()],Xu.prototype,`detailsOpenedItems`,void 0),Xu=k([_(`mateu-grid`)],Xu);var Zu=class extends x{constructor(...e){super(...e),this.getNewValue=e=>{if(this.field?.dataType==`array`){if(!this.value)return[e];let t=this.value;return t.indexOf(e)>=0?t.filter(t=>t!==e):[...t,e]}return e}}render(){let e=this.field?.options;if(this.field?.remoteCoordinates){let t=this.field.remoteCoordinates;this.data?.[this.field.fieldId]&&this.data[this.field.fieldId].content&&this.data[this.field.fieldId].totalElements?e=this.data[this.field.fieldId].content:this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t.action,parameters:{searchText:``,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0}))}return E`
       ...
       `}static{this.styles=g`
        ...
        ${R}
    `}};k([b()],Zu.prototype,`field`,void 0),k([b()],Zu.prototype,`baseUrl`,void 0),k([b()],Zu.prototype,`state`,void 0),k([b()],Zu.prototype,`data`,void 0),k([b()],Zu.prototype,`value`,void 0),Zu=k([_(`mateu-choice`)],Zu);var Qu,$u=class extends x{static{Qu=this}constructor(...e){super(...e),this.commit=e=>{this.value=e,this.dispatchEvent(new CustomEvent(`value-changed`,{detail:{value:{...e},fieldId:this.fieldId}}))},this.currencyChanged=e=>{let t=this.value??Qu.EMPTY;!e.detail.value||e.detail.value===t.currency||this.commit({...t,currency:e.detail.value})},this.valueChanged=e=>{let t=this.value??Qu.EMPTY,n=du(e.detail.value,!1)??0;n!==t.value&&this.commit({...t,value:n})}}static{this.EMPTY={value:0,currency:`EUR`,locale:`es-ES`}}render(){return E`
            <vaadin-number-field
                    id="${this.fieldId}"
                    label="${this.label}"
...
`}copyValue(e){navigator.clipboard.writeText(e).then(()=>r.show(`Copied`,{position:`bottom-end`,theme:`success`,duration:2e3})).catch(()=>{})}renderFileField(e,t,n,r){if(!this.field)return E``;let i=t?.map(e=>({id:e.id,name:e.name,type:``,uploadTarget:``,complete:!0}))??[];return E`
            ...
            `}renderStringField(e,t,n,r){if(!this.field)return E``;if(this.field?.stereotype==`searchable`)return E`
              ...
              ${e.description}
                ...
                `;if(this.field?.stereotype==`fileUpload`){let e=cu(this.field.attributes,`accept`);return E`
                    <vaadin-custom-field
                            id="${this.field.fieldId}"
                            label="${n}"
                            .helperText="${this.helperText()}"
...
`;if(this.field?.stereotype==`listBox`){if(this.field?.remoteCoordinates){let e=this.field.remoteCoordinates;return this.data[this.id]&&this.data[this.id].searchSignature&&this.data[this.id].searchSignature!=``&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements||this.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.action,parameters:{searchText:``,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0})),E`
            ...
            ></mateu-money-field>`}renderStatusField(e,t,n,r){if(!this.field)return E``;let i=t;return E`
                <vaadin-custom-field
                        ...
                        data-colspan="${this.field.colspan}"
                >
                    ${i?E`<span theme="badge pill ${Mo(i.type)}">${i.message}</span>`:E``}                    
                </vaadin-custom-field>
  ...
  `}};k([w()],Q.prototype,`ui5FieldComponentsReady`,void 0),k([b()],Q.prototype,`component`,void 0),k([b()],Q.prototype,`field`,void 0),k([b()],Q.prototype,`baseUrl`,void 0),k([b()],Q.prototype,`state`,void 0),k([b()],Q.prototype,`data`,void 0),k([b()],Q.prototype,`appState`,void 0),k([b()],Q.prototype,`appData`,void 0),k([b()],Q.prototype,`labelAlreadyRendered`,void 0),k([w()],Q.prototype,`colorPickerOpened`,void 0),k([w()],Q.prototype,`colorPickerValue`,void 0),k([w()],Q.prototype,`controlOwnsValidity`,void 0),k([w()],Q.prototype,`filteredIcons`,void 0),k([w()],Q.prototype,`navLinkOffset`,void 0),Q=k([_(`mateu-field`)],Q);var rd=(e,t,n,r,i,a,o,s)=>{let c=t.metadata;return E`
        <mateu-field
                ...
                .appState="${a}"
                .appdata="${o}"
                style="${Eo(t,i)}" class="${t.cssClasses}"
                slot="${t.slot??y}"
    ...
    `},id=(e,n,r,i,a,o,s)=>{let c=n.metadata;if(c.tree)return E`
        ...
        >
            ...
            <vaadin-grid-column path="${n.id}"
                                ...
                                width="${l?.width??y}"
                                .column="${n.metadata}"
                                ${t((t,n,c)=>qu(t,n,c,l,e,r,i,a,o,s),[])}></vaadin-grid-column>
`:E`
...
`})}
  ...
  `}};k([b()],$.prototype,`id`,void 0),k([b()],$.prototype,`metadata`,void 0),k([b()],$.prototype,`baseUrl`,void 0),k([b()],$.prototype,`state`,void 0),k([b()],$.prototype,`data`,void 0),k([b()],$.prototype,`appState`,void 0),k([b()],$.prototype,`appData`,void 0),k([b()],$.prototype,`emptyStateMessage`,void 0),k([w()],$.prototype,`detailsOpenedItems`,void 0),k([S(`vaadin-grid`)],$.prototype,`grid`,void 0),$=k([_(`mateu-table`)],$);var ad=(e,t,n,r,i,a,o)=>E`
    ...
    <mateu-table id="${e.id}"
                 ...
                 @fetch-more-elements="${e.fetchMoreElements}"
                 baseUrl="${n}"
    ></mateu-table>`,sd=(e,t,n,r,i,a,o)=>{let s=t.metadata;return E`
    ...
    </div>`,ud={"vaadin:wifi":`vaadin:connect`,"vaadin:pen":`vaadin:pencil`,"vaadin:automation":`vaadin:cogs`},dd=(e,t,n)=>E`<vaadin-icon icon="${ud[e]??e}" style="${t??y}" class="${n??y}"></vaadin-icon>`,fd=(e,t,n)=>{let r=e.metadata,i=M(r.label,t,n),a=``;return r.buttonStyle&&(a+=` `+r.buttonStyle),r.color&&r.color!==`none`&&r.color!==`normal`&&(a+=` `+r.color),r.size&&r.size!==`none`&&r.size!==`normal`&&(a+=` `+r.size),E`<vaadin-button
            id="${e.id}"
            data-action-id="${r.actionId}"
            data-route="${Xr(r,t,n)??y}"
            @click="${e=>Yr(e,r)}"
    ...
    >${r.iconOnLeft?E`<vaadin-icon icon="${r.iconOnLeft}"></vaadin-icon>`:y}${i}${r.iconOnRight?E`<vaadin-icon icon="${r.iconOnRight}"></vaadin-icon>`:y}</vaadin-button>`},pd=e=>{let t=e.metadata;return E`
        ...
        ></vaadin-message-input>
    `},md=e=>{let t=(e.metadata.items??[]).map(e=>({text:e.text,time:e.time,userName:e.userName,userImg:e.userImg,userAbbr:e.userAbbr,userColorIndex:e.userColorIndex}));return E`
        <vaadin-message-list
                markdown
                style="${e.style}" class="${e.cssClasses}"
                slot="${e.slot??y}"
                .items="${t}"
        ></vaadin-message-list>
    `},hd=(e,t)=>{e&&e.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:t},bubbles:!0,composed:!0}))},gd=(e,t,n,r,i,a,o)=>{let s=t.metadata,c=!1;if(s.openedCondition)try{c=Gt(s.openedCondition,r,i,a,o)}catch(e){console.error(`when evaluating `+s.openedCondition+` :`+e+`, where data is `+i+` and state is `+r)}return E`
    ...
    `}render(){let e=this.navigation,t=!!(this.overviewEditActionId||e&&(e.parentActionId||e.previousActionId||e.nextActionId)),n=!!(this.headerTitle||t||this.badges.length);return E`
            ...
            `:y}
        `}};k([b({type:Array})],_d.prototype,`panels`,void 0),k([b({type:String})],_d.prototype,`headerTitle`,void 0),k([b({type:Array})],_d.prototype,`badges`,void 0),k([b({attribute:!1})],_d.prototype,`navigation`,void 0),k([b({type:String})],_d.prototype,`overviewEditActionId`,void 0),k([S(`.rail`)],_d.prototype,`_rail`,void 0),k([S(`.section--first`)],_d.prototype,`_first`,void 0),k([w()],_d.prototype,`_less`,void 0),k([w()],_d.prototype,`_more`,void 0),_d=k([_(`mateu-vaadin-foldout`)],_d);var vd=(e,t,n,r,i,a,o)=>{let s=t.metadata;return E`
    ...
    `}};k([b({attribute:!1})],yd.prototype,`rows`,void 0),k([b({attribute:!1})],yd.prototype,`columns`,void 0),k([b()],yd.prototype,`idField`,void 0),k([b({type:Boolean})],yd.prototype,`navigable`,void 0),k([b()],yd.prototype,`selectedId`,void 0),k([w()],yd.prototype,`expandedItems`,void 0),k([S(`vaadin-grid`)],yd.prototype,`_grid`,void 0),yd=k([_(`mateu-vaadin-tree`)],yd);var bd={[j.VirtualList]:(e,t,n,r,i,a,o)=>Ol(e,t,n,r,i,a,o),[j.Notification]:(e,t)=>kl(t),[j.ProgressBar]:(e,t,n,r)=>Al(t,r),[j.Details]:(e,t,n,r,i,a,o)=>jl(e,t,n,r,i,a,o),[j.Avatar]:(e,t,n,r,i)=>Ml(t,r,i),[j.AvatarGroup]:(e,t)=>Nl(t),[j.Card]:(e,t,n,r,i,a,o)=>Pl(e,t,n,r,i,a,o),[j.Button]:(e,t,n,r,i)=>fd(t,r,i),[j.MessageInput]:(e,t)=>pd(t),[j.MessageList]:(e,t)=>md(t),[j.ConfirmDialog]:(e,t,n,r,i,a,o)=>gd(e,t,n,r,i,a,o),[j.FormLayout]:(e,t,n,r,i,a,o)=>Ll(e,t,n,r,i,a,o),[j.HorizontalLayout]:(e,t,n,r,i,a,o)=>Vl(e,t,n,r,i,a,o),[j.VerticalLayout]:(e,t,n,r,i,a,o)=>Hl(e,t,n,r,i,a,o),[j.SplitLayout]:(e,t,n,r,i,a,o)=>Ul(e,t,n,r,i,a,o),[j.MasterDetailLayout]:(e,t,n,r,i,a,o)=>Wl(e,t,n,r,i,a,o),[j.TabLayout]:(e,t,n,r,i,a,o)=>Gl(e,t,n,r,i,a,o),[j.AccordionLayout]:(e,t,n,r,i,a,o)=>ql(e,t,n,r,i,a,o),[j.BoardLayout]:(e,t,n,r,i,a,o)=>Xl(e,t,n,r,i,a,o),[j.BoardLayoutRow]:(e,t,n,r,i,a,o)=>Zl(e,t,n,r,i,a,o),[j.BoardLayoutItem]:(e,t,n,r,i,a,o)=>Ql(e,t,n,r,i,a,o),[j.Scroller]:(e,t,n,r,i,a,o)=>Yl(e,t,n,r,i,a,o),[j.MenuBar]:(e,t,n,r,i)=>tu(e,t,n,r,i),[j.ContextMenu]:(e,t,n,r,i,a,o)=>eu(e,t,n,r,i,a,o),[j.FormField]:(e,t,n,r,i,a,o,s)=>rd(e,t,n,r,i,a,o,s),[j.Grid]:(e,t,n,r,i,a,o)=>id(e,t,n,r,i,a,o),[j.Table]:(e,t,n,r,i,a,o)=>ad(e,t,n,r,i,a,o),[j.Popover]:(e,t,n,r,i,a,o)=>sd(e,t,n,r,i,a,o),[j.FoldoutLayout]:(e,t,n,r,i,a,o)=>vd(e,t,n,r,i,a,o)},xd=class extends Dl{rendererName(){return`vaadin`}renderClientSideComponent(e,t,n,r,i,a,o,s){let c=t?.metadata?.type,l=c?bd[c]:void 0;return l&&t?l(e,t,n,r,i,a,o,s):super.renderClientSideComponent(e,t,n,r,i,a,o,s)}renderTableComponent(e,t,n,r,i,a,o){return od(e,t,n,r,a,o)}renderTreeComponent(e,t){return E`
            <mateu-vaadin-tree
                    .rows="${t.rows}"
                    .columns="${t.columns}"
                    .idField="${t.idField}"
            ...
            ></mateu-vaadin-tree>`}renderToolbarButton(e,t,n){return cd(e,t,n)}renderPeerNav(e){return ld(e)}renderIcon(e,t,n){return dd(e,t,n)}renderTopNav(e,t,n){return $l(e,t,n)}};function Sd(e){switch(e){case`topStretch`:return`top-stretch`;case`topStart`:return`top-start`;case`topCenter`:return`top-center`;case`topEnd`:return`top-end`;case`middle`:return`middle`;case`bottomStart`:return`bottom-start`;case`bottomEnd`:return`bottom-end`;case`bottomStretch`:return`bottom-stretch`;case`bottomCenter`:return`bottom-center`}return`bottom-end`}function Cd(e,t){if(e.onAction)return{label:e.actionLabel??`Retry`,run:e.onAction};if(e.undoActionId)return{label:e.undoLabel??`Undo`,run:()=>t.dispatchEvent(new CustomEvent(`action-requested`,{detail:{actionId:e.undoActionId,parameters:e.undoParameters??{}},bubbles:!0,composed:!0}))}}function wd(e,t){let n=new r;n.position=Sd(e.position),n.duration=e.duration??1e4,e.variant&&n.setAttribute(`theme`,e.variant),n.renderer=r=>{if(r.firstElementChild)return;let i=document.createElement(`span`);i.textContent=e.text;let a=Cd(e,t),o=document.createElement(`button`);o.textContent=a.label,o.style.cssText=`margin-left: 0.75rem; background: none; border: 1px solid currentColor; border-radius: var(--lumo-border-radius-s, 4px); color: inherit; cursor: pointer; padding: 0.15rem 0.6rem; font: inherit; font-weight: 600;`,o.addEventListener(`click`,()=>{a.run(),n.opened=!1}),r.append(i,o)},document.body.appendChild(n),n.opened=!0,n.addEventListener(`opened-changed`,e=>{e.detail.value||n.remove()})}N.set(new xd),Po({show(e,t){if(Rt(e.text,{politeness:e.variant===`error`?`assertive`:`polite`}),e.undoActionId||e.onAction){wd(e,t);return}r.show(e.text,{position:e.position?Sd(e.position):`bottom-end`,theme:e.variant,duration:e.duration})}});