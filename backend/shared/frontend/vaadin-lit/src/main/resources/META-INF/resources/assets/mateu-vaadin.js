...
import{f as Ls,m as Rs,o as Ds,b as As,e as Ye,i as Fs,s as Ns,j as qs,k as Ms,t as Us,u as js,l as Bs,_ as ie,n as He,p as Vs,q as ja,v as Ji,N as Gt,w as ri,x as Yi,y as mi,z as Ws,A as Qi,B as Hs}from"./vendor-vaadin.js";import{a as $,j as u,k as Ce,i as _,x as o,m as x,r as b,A as l,p as ye,l as E,D as Xi,b as N,q as Gs}from"./vendor-lit.js";import{S as Ks,a as Js,n as pe,b as Ys}from"./vendor.js";import"./vendor-ui5.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=a(i);fetch(i.href,r)}})();const Zi=document.createElement("style");Zi.innerHTML=`
${Ls.cssText}
${Rs.cssText}
${Ds.cssText}
${As.cssText}
...
`},bi=(e,t,a,s,i,r,n)=>m.GridGroupColumn==e.metadata?.type?qr(e.metadata,t,a,s,i,r,n):ls(e.metadata,t,a,s,i,r,n),ls=(e,t,a,s,i,r,n)=>{const d=xe(e.label,s,i);return e.sortable?o`
                        <vaadin-grid-sort-column
                                ...
                                ${oi(d)}
                                ${He((c,h,p)=>_a(c,h,p,e,t,a,s,i,r,n),[])}
                        ></vaadin-grid-sort-column>
                    `:e.filterable?o`
...
`;if(this.field?.stereotype=="listBox"){if(this.field?.remoteCoordinates){const i=this.field.remoteCoordinates,r="";return this.data[this.id]&&(this.data[this.id].searchSignature||r)&&this.data[this.id].searchSignature!=r&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements||this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:i.action,parameters:{searchText:r,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0})),o`
  ...
  `;le([u()],H.prototype,"component",2);le([u()],H.prototype,"field",2);le([u()],H.prototype,"baseUrl",2);le([u()],H.prototype,"state",2);le([u()],H.prototype,"data",2);le([u()],H.prototype,"appState",2);le([u()],H.prototype,"appData",2);le([u()],H.prototype,"labelAlreadyRendered",2);le([b()],H.prototype,"colorPickerOpened",2);le([b()],H.prototype,"colorPickerValue",2);le([b()],H.prototype,"filteredIcons",2);le([b()],H.prototype,"navLinkOffset",2);H=le([x("mateu-field")],H);const Xr=(e,t,a)=>{const s=e.metadata;return o`<span theme="badge ${s.color} ${s.pill?"pill":""} ${s.small?"small":""} ${s.primary?"primary":""}"
    ...
    `}}render(){const e=this.metadata;if(!e)return o``;const t=e.toolbar??[],a=t.filter(d=>Ni(d.actionId)),s=t.filter(d=>!Ni(d.actionId)),i=a.length>0&&s.length>0?o`<span class="toolbar-divider"></span>`:l,r=e.avatar||e.title||e.subtitle||e.kpis?.length>0||e.header?.length>0||t.length>0,n=e.level??0;return n>0?this.setAttribute("data-nested",""):this.removeAttribute("data-nested"),o`
        ...
        ${Ye}
    `;Rt([u()],Ke.prototype,"metadata",2);Rt([u()],Ke.prototype,"baseUrl",2);Rt([u()],Ke.prototype,"state",2);Rt([u()],Ke.prototype,"data",2);Rt([u()],Ke.prototype,"appState",2);Rt([u()],Ke.prototype,"appData",2);Ke=Rt([x("mateu-content-header")],Ke);var io=Object.defineProperty,so=Object.getOwnPropertyDescriptor,ga=(e,t,a,s)=>{for(var i=s>1?void 0:s?so(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&io(t,a,i),i};let Et=class extends Ga{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={}}render(){const e=this.component?.metadata;return o`
    ...
    `},qo=(e,t,a,s,i,r,n)=>{const d=t.metadata;if(d.tree){const h=async(p,f)=>{const v=p.parentItem?p.parentItem.children:d.page.content;f(v,v.length)};return o`
        ...
        >
            ...
            <vaadin-grid-column path="${p.id}"
                                ...
                                width="${v?.width??l}"
                                .column="${p.metadata}"
                                ${He((C,w,g)=>_a(C,w,g,v,e,a,s,i,r,n),[])}></vaadin-grid-column>
`:o`
...
`})}
    ...
    `},Uo=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        ...
        <vaadin-menu-bar .items=${$i(e,r.options,a,s,i,V,na)}
            ...
            `},qi=(e,t,a,s,i,r,n)=>{const d=document.createElement("vaadin-context-menu-item");return Xi(k(e,t,a,s,i,r,n),d),d},$i=(e,t,a,s,i,r,n)=>t.map(d=>d.submenus?{text:d.component?void 0:d.label,route:d.path,checked:d.selected,disabled:d.disabled,className:d.className,component:d.component?qi(e,d.component,a,s,i,r,n):void 0,children:$i(e,d.submenus,a,s,i,r,n)}:d.separator?{component:"hr"}:{text:d.component?void 0:d.label,route:d.path,checked:d.selected,disabled:d.disabled,className:d.className,component:d.component?qi(e,d.component,a,s,i,r,n):void 0}),Bo=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.content?.metadata,h=c?.type==m.Notice&&c.fullWidth===!0;return o`
...
`,jl=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}),pi=e=>jl.format(e),Fa=(e,t)=>{const a=e<0?"-":"",s=pi(Math.abs(e));return t?`${a}${t} ${s}`:`${a}${s}`},Bl=(e,t)=>t?`${pi(e)} ${t}`:pi(e);var Vl=Object.defineProperty,Wl=Object.getOwnPropertyDescriptor,ft=(e,t,a,s)=>{for(var i=s>1?void 0:s?Wl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Vl(t,a,i),i};let Ae=class extends _{constructor(){super(...arguments),this.title="",this.badges=[],this.facts=[]}render(){const e=!!(this.metricLabel||this.metricValue||this.metricCaption);return o`
            <div class="card">
                <div class="main">
                    <div class="title-row">
    ...
    `;Qt([u()],lt.prototype,"label",2);Qt([u({type:Number})],lt.prototype,"total",2);Qt([u({type:Number})],lt.prototype,"done",2);Qt([u()],lt.prototype,"actionLabel",2);Qt([u()],lt.prototype,"actionId",2);lt=Qt([x("mateu-task-progress")],lt);const Xl=e=>{const t=e.metadata;return o`
        <mateu-task-progress
                ...
                slot="${e.slot??l}"
        ></mateu-task-progress>
    `};var Zl=Object.defineProperty,ed=Object.getOwnPropertyDescriptor,_i=(e,t,a,s)=>{for(var i=s>1?void 0:s?ed(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Zl(t,a,i),i};let ma=class extends _{constructor(){super(...arguments),this.items=[],this.compact=!1}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}render(){return o`
    ...
    `];_i([u({type:Array})],ma.prototype,"items",2);_i([u({type:Boolean})],ma.prototype,"compact",2);ma=_i([x("mateu-status-list")],ma);const td=e=>{const t=e.metadata;return o`
        <mateu-status-list
                .items="${t.items??[]}"
                ?compact="${t.compact??!1}"
                style="${e.style??l}"
    ...
    `};var sd=Object.defineProperty,rd=Object.getOwnPropertyDescriptor,Qe=(e,t,a,s)=>{for(var i=s>1?void 0:s?rd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&sd(t,a,i),i};const od={info:"ℹ",success:"✓",warning:"!",danger:"!"};let we=class extends _{constructor(){super(...arguments),this.text="",this.theme="info",this.slim=!1,this.fullWidth=!1,this.hasContent=!1}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId},bubbles:!0,composed:!0}))}render(){const e=!!this.text&&!!this.text.trim();if(!e&&!this.hasContent)return o``;const t=["info","success","warning","danger"].includes(this.theme)?this.theme:"info";return o`
            <div class="notice ${t} ${this.slim?"slim":""}">
                ...
                ${this.actionLabel&&this.actionId?o`<vaadin-button theme="small" @click="${()=>this.runAction()}">${this.actionLabel}</vaadin-button>`:l}
            </div>
        `}};we.styles=$`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
        .notice {
...
`,ea=e=>N`
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
         stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${e}</svg>`,Si=ea(N`
    <circle cx="12" cy="12" r="3"></circle>
    <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 1 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"></path>`),Ii=ea(N`
    <line x1="12" y1="5" x2="12" y2="19"></line>
    <line x1="5" y1="12" x2="19" y2="12"></line>`),Ei=ea(N`
