...
`;return o`
    ...
    `;Mi([m()],Wt.prototype,"variant",2);Mi([m({type:Number})],Wt.prototype,"count",2);Wt=Mi([_("mateu-skeleton")],Wt);const As=(e,t)=>{t&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},vt=(e,t,i,a,s,r)=>o`
        <div class="mateu-empty-state"
            ...
            ${s&&r?o`
                <vaadin-button theme="tertiary" style="margin-top: .25rem;" @click="${n=>As(n,s)}">${r}</vaadin-button>
            `:d}
        </div>
  ...
  ${t.children?.map(u=>b(e,u,i,a,s,r,n))}
    ...
    `},Dr=e=>{const t=e.metadata;return o`
        ...
        <img src="${t.src}" style="${e.style}" class="${e.cssClasses}"
             slot="${e.slot??d}">
            `},Ar=e=>{const t=e.metadata;return o`<vaadin-horizontal-layout theme="spacing"
                                          slot="${e.slot??d}">
...
`:d}
    ...
    <div style="display: flex; gap: 0.75rem; padding: 0.25rem 0; flex-wrap: wrap;">
        ...
        <ui5-input
            ...
            value="${l??""}"
            style="width: 100%;"
        >${di(l,!0)}</ui5-input>`)},Go=(e,t,i,a,s,r,n)=>{const l=i.fieldId??"";if(i.stereotype=="searchable"){const u=v=>zi(v.currentTarget,"code-"+l,{code:v.currentTarget.value}),p=v=>zi(v.currentTarget,"codesearch-"+l,{});return I(t,i,a,r,o`
            ...
            <mateu-markdown .content="${s??""}"></mateu-markdown>`);if(i.stereotype=="combobox")return I(t,i,a,r,pa(i,a,s,Fe(e,i,a,l,n)));if(i.stereotype=="listBox")return I(t,i,a,r,Ba(i,s,Fe(e,i,a,l,n),!1));if(i.stereotype=="radio")return I(t,i,a,r,Ao(i,s,Fe(e,i,a,l,n)));if(i.stereotype=="popover"){const u=Fe(e,i,a,l,n),p=`${a}_popover`,v=y=>{const $=y.target.getRootNode().querySelector(`#${CSS.escape(p)}`);$&&($.opener=y.currentTarget,$.open=!$.open)},f=u.find(y=>y.value===s)?.label??s??"";return I(t,i,a,r,o`
        ...
        >${di(s,i.readOnly)}</ui5-input>`)},Ko=(e,t,i,a,s)=>{const r=t.metadata,n=r?.fieldId??"",l=a&&n in a?a[n]:r?.initialValue,c=t.id||n,u=r.label+"",p=ye(u,a,s),v=!p||p=="null"||p=="undefined"?void 0:p,f=r.dataType,y=r.stereotype;if(y=="badge")return Wo(t,l,v??r.fieldId??"");if(y=="plainText")return Vo(t,r,c,l,v,a,s);if(r.readOnly&&y!="grid"&&f!="status"&&f!="money")return Ho(t,r,c,l,v,a,s);if(y=="grid"&&r.columns&&r.columns.length>0)return I(t,r,c,v,jo(r,l));if(f=="file"||y=="file")return I(t,r,c,v,o`
            ...
            <div style="${t.style??d}">
                <ui5-checkbox
                    ...
                    @change="${wa}"
                ></ui5-checkbox>
            </div>`;if(f=="array"){if(y=="choice")return I(t,r,c,v,Ai(r,l,Fe(e,r,c,n,s),!0));if(y=="listBox")return I(t,r,c,v,Ba(r,l,Fe(e,r,c,n,s),!0));if(y=="combobox"){const x=Fe(e,r,c,n,s),$=Array.isArray(l)?l:[];return I(t,r,c,v,o`
                <ui5-multi-combobox
                    id="${c}"
                    ?disabled="${r.disabled}"
                    ?readonly="${r.readOnly}"
  ...
  `;Ye([g()],Pe.prototype,"filter",2);Ye([g()],Pe.prototype,"instant",2);Ye([g()],Pe.prototype,"selectedConsumedRoute",2);Ye([g()],Pe.prototype,"selectedRoute",2);Ye([g()],Pe.prototype,"selectedUriPrefix",2);Ye([g()],Pe.prototype,"selectedBaseUrl",2);Ye([g()],Pe.prototype,"selectedServerSideType",2);Ye([g()],Pe.prototype,"selectedParams",2);Pe=Ye([_("mateu-sapui5-app")],Pe);const Vl=(e,t,i,a,s)=>{const r=t.metadata;return o`
    ...
    `,v=f=>{f.preventDefault();const x=f.currentTarget.getRootNode().querySelector(`#${CSS.escape(c)}`);x&&(x.opener=f.currentTarget,x.open=!0)};return o`
        ...
        <div style="display: flex; flex-direction: column; gap: 0.75rem; padding: 0.5rem; ${e.style??""}"
            ...
            `)}
        </div>`},Ad=e=>{const t=i=>{const s=i.target.parentElement?.querySelector("ui5-input"),r=s?.value??"";r&&(i.target.dispatchEvent(new CustomEvent("submit",{detail:{value:r},bubbles:!0,composed:!0})),s&&(s.value=""))};return o`
