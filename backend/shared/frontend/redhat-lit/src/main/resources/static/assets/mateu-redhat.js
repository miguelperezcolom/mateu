...
import{d as o,A as l,a as w,j as p,r as b,i as _,k as x,m as ye,D as qs,c as P,w as H,p as Fe,q as Br}from"./vendor-lit.js";import{v as Vr,b as st,e as Hr,f as Wr,_ as ue,n as Us,p as js,N as jt,i as Tt,j as yi,k as Bs,l as Ni,m as Ji,o as Gr}from"./vendor-vaadin.js";import{S as Kr,n as Q,a as Yr,b as Jr}from"./vendor.js";import"./vendor-ui5.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=a(i);fetch(i.href,r)}})();class Xr{constructor(){this.afterRenderHook=void 0,this.useShadowRoot=!0,this.componentRenderer=void 0}set(t){if(this.componentRenderer=t,typeof window<"u"){const a=t.supportedClientSideTypes?.();window.__mateuRendererInfo={name:t.rendererName?.()??t.constructor?.name??"unknown",supportedTypes:a?[...a].sort():null}}}get(){return this.componentRenderer}setUseShadowRoot(t){this.useShadowRoot=t}mustUseShadowRoot(){return this.useShadowRoot}setAfterRenderHook(t){this.afterRenderHook=t}getAfterRenderHook(){return this.afterRenderHook}}const W=new Xr;var h=(e=>(e.Page="Page",e.Div="Div",e.Element="Element",e.MicroFrontend="MicroFrontend",e.Form="Form",e.Crud="Crud",e.Result="Result",e.Card="Card",e.Directory="Directory",e.Stepper="Stepper",e.HorizontalLayout="HorizontalLayout",e.VerticalLayout="VerticalLayout",e.SplitLayout="SplitLayout",e.MasterDetailLayout="MasterDetailLayout",e.TabLayout="TabLayout",e.AccordionLayout="AccordionLayout",e.FormLayout="FormLayout",e.FormRow="FormRow",e.FormItem="FormItem",e.BoardLayout="BoardLayout",e.BoardLayoutRow="BoardLayoutRow",e.BoardLayoutItem="BoardLayoutItem",e.Scroller="Scroller",e.FullWidth="FullWidth",e.Container="Container",e.FormField="FormField",e.Table="Table",e.App="App",e.Text="Text",e.Avatar="Avatar",e.Chat="Chat",e.AvatarGroup="AvatarGroup",e.Badge="Badge",e.Breadcrumbs="Breadcrumbs",e.Anchor="Anchor",e.Button="Button",e.Chart="Chart",e.Icon="Icon",e.ConfirmDialog="ConfirmDialog",e.ContextMenu="ContextMenu",e.CookieConsent="CookieConsent",e.Details="Details",e.Dialog="Dialog",e.Drawer="Drawer",e.Image="Image",e.Map="Map",e.Markdown="Markdown",e.Notification="Notification",e.ProgressBar="ProgressBar",e.Popover="Popover",e.CarouselLayout="CarouselLayout",e.Tooltip="Tooltip",e.MessageInput="MessageInput",e.MessageList="MessageList",e.CustomField="CustomField",e.MenuBar="MenuBar",e.Grid="Grid",e.GridColumn="GridColumn",e.GridGroupColumn="GridGroupColumn",e.VirtualList="VirtualList",e.FormSection="FormSection",e.FormSubSection="FormSubSection",e.Bpmn="Bpmn",e.Workflow="Workflow",e.WorkflowElk="WorkflowElk",e.FormEditor="FormEditor",e.MetricCard="MetricCard",e.Scoreboard="Scoreboard",e.DashboardPanel="DashboardPanel",e.DashboardLayout="DashboardLayout",e.FoldoutLayout="FoldoutLayout",e.HeroSection="HeroSection",e.EmptyState="EmptyState",e.Skeleton="Skeleton",e.Gantt="Gantt",e.PlanningBoard="PlanningBoard",e.Kanban="Kanban",e.Timeline="Timeline",e.ProgressSteps="ProgressSteps",e.Stat="Stat",e.Calendar="Calendar",e.PricingTable="PricingTable",e.OrgChart="OrgChart",e.Heatmap="Heatmap",e.Funnel="Funnel",e.TrendChart="TrendChart",e.FeatureGrid="FeatureGrid",e.Testimonials="Testimonials",e.Faq="Faq",e.CalloutCard="CalloutCard",e.CommentThread="CommentThread",e.FileList="FileList",e.Checklist="Checklist",e.ComparisonCard="ComparisonCard",e.EntityHeader="EntityHeader",e.Meter="Meter",e.TaskProgress="TaskProgress",e.StatusList="StatusList",e.BulletedList="BulletedList",e.Separator="Separator",e.Notice="Notice",e.TaskQueue="TaskQueue",e.ResourceGrid="ResourceGrid",e.OfferCard="OfferCard",e.AddOnPicker="AddOnPicker",e.Ledger="Ledger",e.PaymentPicker="PaymentPicker",e.ProcessMonitor="ProcessMonitor",e))(h||{}),pe=(e=>(e.ServerSide="ServerSide",e.ClientSide="ClientSide",e))(pe||{});const Mt=(e,t,a,s,i,r,n,d,c)=>(t.slot=d,k(e,t,a,s,i,r,n,c)),k=(e,t,a,s,i,r,n,d)=>{if(!t)return o``;if(t.type==pe.ClientSide)return W.get().renderClientSideComponent(e,t,a,s,i,r,n,d);const c=e.route,u=e.consumedRoute;return o`
    ...
    `;xi([p({type:Array})],da.prototype,"tabLabels",2);xi([b()],da.prototype,"mode",2);xi([b()],da.prototype,"selected",2);da=xi([x("mateu-adaptive-tabs")],da);const ao=(e,t,a,s,i,r,n)=>{const d=t.metadata;let c=t.style;return c==null&&(c=""),d.columnSpacing&&(c+="--vaadin-form-layout-column-spacing: "+d.columnSpacing+";"),d.itemRowSpacing&&(c+="--vaadin-form-layout-row-spacing: "+d.itemRowSpacing+";"),d.itemLabelSpacing&&(c+="--vaadin-form-layout-label-spacing: "+d.itemLabelSpacing+";"),d.labelsAside&&(c+="--vaadin-form-item-label-width: 92px;"),d.fullWidth&&(c+="width: 100%;"),o`
               <vaadin-form-layout 
                       ...
                       slot="${t.slot||l}"
               >
                   ${t.children?.map(u=>Vs(d,e,u,a,s,i,r,n))}
               </vaadin-form-layout>
            `},Vs=(e,t,a,s,i,r,n,d)=>a.type==pe.ClientSide&&a.metadata?.type==h.FormRow?so(e,t,a,s,i,r,n,d):e.labelsAside?io(t,a,s,i,r,n,d):k(t,a,s,i,r,n,d),io=(e,t,a,s,i,r,n)=>{if(t.type==pe.ClientSide&&t.metadata?.type==h.FormField&&t.metadata.label){const d=t.metadata,c=d.label?.includes("${")?e._evalTemplate(d.label):d.label;return o`
    ...
    `},no=(e,t,a,s,i,r,n)=>{const d=t.metadata;let c=t.style;return d.fullWidth&&(c=c?"width: 100%;"+c:"width: 100%;"),o`
        ...
        >
            <vaadin-tabs slot="tabs"
                         ...
                         @items-changed=${v}
            >
                ${t.children?.map(f=>f).map(f=>{const g=f.metadata.label,y=g?.includes("${")?e._evalTemplate(g):g,$=f.metadata.shortcut;return o`
                    <vaadin-tab id="${y}"
                                style="${f.style}"
                                class="${f.cssClasses}"
                                data-shortcut="${$??l}"
        ...
        >
            ...
            `},ca=(e,t)=>new Function(...Object.keys(t),"return `"+e+"`")(...Object.values(t)),ba=(e,t,a)=>({state:e??{},data:t??{},...a});function Re(e,t,a,s){if(!e?.includes("${"))return e;try{return ca(e,ba(t,a,s))}catch(i){return console.warn(`Mateu: could not interpolate "${e}":`,i),e}}const qt=(e,t,a)=>{if(e&&e.indexOf("${")>=0)try{return ca(e,ba(t,a))}catch(s){return s.message}return e},wi=(e,t,a,s,i)=>{if(!e)return e;const r=ba(t,a,{appState:s??{},appData:i??{}});let n=e;try{if(n=ca(e,r),n.includes("${"))try{n=ca(n,r)}catch(d){n="when evaluating nested "+e+" :"+d+", where data is "+a+" and state is "+t+" and app state is "+s+" and app data is "+i,console.error(d,n,t,a,s,i)}}catch(d){n="when evaluating "+e+" :"+d+", where data is "+a+" and state is "+t+" and app state is "+s+" and app data is "+i,console.error(d,n,t,a,s,i)}return n},Hs=(e,t,a,s,i,r)=>{const n=ba(t,a,{appState:s??{},appData:i??{},...r}),d=ca(e,n);return new Function(...Object.keys(n),`return (${d})`)(...Object.values(n))},Ws=(e,t,a,s)=>{const i=ba(t,a,s);return new Function(...Object.keys(i),`return (${e})`)(...Object.values(i))},yo=(e,t,a,s)=>ca(e,ba(t,a,s)),xo=(e,t,a)=>{const s=e.metadata;return o`<vaadin-avatar
            img="${s.image}"
            name="${Ve(s.name,t,a)}"
            abbr="${s.abbreviation}"
            style="${e.style}" class="${e.cssClasses}"
            slot="${e.slot??l}"
    ></vaadin-avatar>`},Ve=(e,t,a)=>typeof e=="string"&&e.includes("${")?Re(e,t,a):e,wo=e=>{const t=e.metadata;return o`<vaadin-avatar-group max-items-visible="${t.maxItemsVisible}"
                                     .items="${t.avatars}"
                                     style="${e.style}" class="${e.cssClasses}"
                                     slot="${e.slot??l}">
...
`;return o`
    ...
    `;Xi([p()],Ra.prototype,"variant",2);Xi([p({type:Number})],Ra.prototype,"count",2);Ra=Xi([x("mateu-skeleton")],Ra);const So=(e,t)=>{t&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},Ut=(e,t,a,s,i,r)=>o`
    ...
    `}const s=a.path&&e[a.path]?.methodNameInCrud?e[a.path]:e.action;if(!s)return o``;const i=s.icon&&!s.label;return o`
         <vaadin-button theme="tertiary${i?" icon":""}" title="${s.label||l}" @click="${gs}" .row="${e}" .action="${s}">
    ...
    `},Mo=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},qo=(e,t,a,s,i,r)=>{const n=a.xcolumn??r;if(n.actionId){const c=n.text||e[a.path];return o`
        ...
        `}const d=e[a.path];return o`<a href="${d}">${n.text||d}</a>`},Uo=(e,t,a,s,i,r,n,d,c)=>{const u=e[a.path];return k(s,u,i,r,n,d,c)},Hi=new WeakMap,jo=(e,t)=>Hi.get(e)?.[t],Bo=(e,t,a)=>{let s=Hi.get(e);s||(s={},Hi.set(e,s)),s[t]=a},ys=e=>{if(e==null||e==="")return null;const t=Number(e);return Number.isNaN(t)?null:t},Vo=(e,t,a,s)=>{const i=a?.field?.fieldId,r=c=>{if(e[t.id]===c||e[t.id]==null&&(c===""||c==null))return;if(e[t.id]=c,!i){a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"update-row",parameters:{_editedRow:{...e}}},bubbles:!0,composed:!0}));return}const m=(a?.state??s)[i];a.dispatchEvent(new CustomEvent("value-changed",{detail:{fieldId:i,value:Array.isArray(m)?[...m]:m},bubbles:!0,composed:!0}))},n=e[t.id],d=n==null?"":String(n);switch(t.editorType){case"boolean":return o`<vaadin-checkbox ?checked=${!!n} @checked-changed=${c=>r(c.detail.value)}></vaadin-checkbox>`;case"integer":return o`<vaadin-integer-field theme="small" style="width:100%;" .value=${d} @change=${c=>r(ys(c.target.value))}></vaadin-integer-field>`;case"number":return o`<vaadin-number-field theme="small" style="width:100%;" .value=${d} @change=${c=>r(ys(c.target.value))}></vaadin-number-field>`;case"date":return o`<vaadin-date-picker theme="small" style="width:100%;" .value=${d} @value-changed=${c=>r(c.detail.value)}></vaadin-date-picker>`;case"time":return o`<vaadin-time-picker theme="small" style="width:100%;" .value=${d} @value-changed=${c=>r(c.detail.value)}></vaadin-time-picker>`;case"datetime":return o`<vaadin-date-time-picker theme="small" style="width:100%;" .value=${d} @value-changed=${c=>r(c.detail.value)}></vaadin-date-time-picker>`;case"select":return o`<vaadin-combo-box
                ...
                .dataProvider=${(y,$)=>{a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:u,parameters:{searchText:y.filter,size:y.pageSize,page:y.page},callback:E=>{const q=E?.fragments?.[0]?.data?.[m];$(q?.content??[],q?.totalElements??0)},callbackonly:!0},bubbles:!0,composed:!0}))}}
                .selectedItem=${f}
                @selected-item-changed=${y=>{const $=y.detail.value,E=$?$.value:null;String(E??"")!==d&&($&&Bo(e,t.id,$.label),r(E))}}></vaadin-combo-box>`}default:return o`<vaadin-text-field theme="small" style="width:100%;" .value=${d} @change=${c=>r(c.target.value)}></vaadin-text-field>`}},qi=e=>Hr(()=>o`<span title="${e}" style="white-space:normal;overflow-wrap:break-word;">${e}</span>`,[e]),Ui=e=>e!==void 0?Wr(()=>o`<span style="font-weight: 600; white-space: nowrap;">${e}</span>`,[e]):l,Ho=e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget?.dispatchEvent(new CustomEvent("sort-direction-changed",{detail:{grid:e.currentTarget.parentElement},bubbles:!0,composed:!0}))},Wo=(e,t,a,s,i,r,n,d)=>{const c=Re(e.label,s,i);return o`
<vaadin-grid-column-group header="${c}">
    ${e.columns.map(u=>Qs(u.metadata,t,a,s,i,r,n,d?.[u.metadata?.id]))}
</vaadin-grid-column-group>
`},Qi=(e,t,a,s,i,r,n,d)=>h.GridGroupColumn==e.metadata?.type?Wo(e.metadata,t,a,s,i,r,n,d):Qs(e.metadata,t,a,s,i,r,n,d?.[e.metadata?.id]),Qs=(e,t,a,s,i,r,n,d)=>{const c=Re(e.label,s,i);return e.sortable?o`
                        <vaadin-grid-sort-column
                                ...
                                ${qi(c)}
                                ${Ui(d)}
                                ${st((u,m,v)=>ai(u,m,v,e,t,a,s,i,r,n),[])}
                        ></vaadin-grid-sort-column>
                    `:e.filterable?o`
                    ...
                    `:o`
                        <vaadin-grid-column
                                ...
                                ${st((u,m,v)=>ai(u,m,v,e,t,a,s,i,r,n),[])}
                        ></vaadin-grid-column>
                    `},ai=(e,t,a,s,i,r,n,d,c,u)=>{const m=a.dataset.dataType??"",v=a.dataset.stereotype??"";if(Oa(e)){const g=i?.metadata,y=(g?.columns??[]).flatMap(C=>C?.metadata?.type===h.GridGroupColumn?(C.metadata.columns??[]).map(A=>A?.metadata?.id):[C?.metadata?.id]),$=Ys(e.__mateuGroupBy,y),E=Js(e,s,$),q=e.__mateuGroup.hiddenActions??[],V=s.id===y[y.length-1]?(g?.groupActions??[]).filter(C=>!q.includes(C.actionId??C.id)):[];return V.length?o`<span style="display: flex; align-items: center; justify-content: flex-end; gap: var(--lumo-space-s); overflow: hidden;">
                ${E?o`<span style="font-weight: 600;">${E}</span>`:l}
                ${V.map(C=>o`
                    <vaadin-button theme="tertiary small" style="flex-shrink: 0;"
                        @click="${A=>{A.stopPropagation(),A.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-"+(C.actionId??C.id),parameters:{_groupValue:e.__mateuGroup.value}},bubbles:!0,composed:!0}))}}">${C.label??C.caption??""}</vaadin-button>
                `)}
            </span>`:o`<span title="${E}" style="font-weight: 600; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; display: block;">${E}</span>`}if(s.editable)return Vo(e,s,i,n);if(m=="status")return Po(e,t,a);if(m=="bool")return To(e,t,a);if(m=="money"||v=="money")return Oo(e,t,a,m,v);if(m=="link"||v=="link")return Ro(e,t,a,m,v,s);if(m=="icon"||v=="icon")return zo(e,t,a,m);if(v=="html")return Lo(e,t,a);if(v=="image")return Do(e,t,a,m,v,s);if(m=="menu")return $s(e,t,a);if(m=="component")return Uo(e,t,a,i,r,n,d,c,u);if(m=="action")return No(e,t,a);if(m=="actionGroup")return $s(e,t,a);if(v=="button"||s.actionId)return qo(e,t,a,m,v,s);const f=e[a.path];return o`<span title="${f}" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; display: block;">${f}</span>`},Go=(e,t,a,s,i,r,n)=>{const d=t.metadata;if(d.tree){const u=async(m,v)=>{const f=m.parentItem?m.parentItem.children:d.page.content;v(f,f.length)};return o`
        ...
        >
            ...
            <vaadin-grid-column path="${m.id}"
                                ...
                                width="${f?.width??l}"
                                .column="${m.metadata}"
                                ${st((g,y,$)=>ai(g,y,$,f,e,a,s,i,r,n),[])}></vaadin-grid-column>
`:o`
...
`})}
    ...
    `}let c=d.page?.content;return t.id&&s&&s[t.id]&&(c=s[t.id]),c||(c=[]),o`
        <vaadin-grid 
                ...
                all-rows-visible
        >
            ${d?.content?.map(u=>Qi(u,e,a,s,i,r,n))}
        </vaadin-grid>
    `},Ko=e=>{const a=(e.metadata.items??[]).map(s=>({text:s.text,time:s.time,userName:s.userName,userImg:s.userImg,userAbbr:s.userAbbr,userColorIndex:s.userColorIndex}));return o`
        <vaadin-message-list
                ...
                .items="${a}"
        ></vaadin-message-list>
    `},gt=new Kr,Y={value:{}},za={value:{}},Yo=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        <vaadin-context-menu .items=${Zi(e,d.menu,a,s,i,r,n)} 
                             style="${t.style}" 
                             class="${t.cssClasses}"
        ...
        <vaadin-menu-bar .items=${Zi(e,r.options,a,s,i,Y,za)}
                         style="${t.style}" class="${t.cssClasses}"
                         slot="${t.slot??l}">
        </vaadin-menu-bar>
            `},xs=(e,t,a,s,i,r,n)=>{const d=document.createElement("vaadin-context-menu-item");return qs(k(e,t,a,s,i,r,n),d),d},Zi=(e,t,a,s,i,r,n)=>t.map(d=>d.submenus?{text:d.component?void 0:d.label,route:d.path,checked:d.selected,disabled:d.disabled,className:d.className,component:d.component?xs(e,d.component,a,s,i,r,n):void 0,children:Zi(e,d.submenus,a,s,i,r,n)}:d.separator?{component:"hr"}:{text:d.component?void 0:d.label,route:d.path,checked:d.selected,disabled:d.disabled,className:d.className,component:d.component?xs(e,d.component,a,s,i,r,n):void 0}),Xo=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.content?.metadata,u=c?.type==h.Notice&&c.fullWidth===!0;return o`
    ...
    `},en=e=>{if(e instanceof CustomEvent)return e.detail;const t={};for(const a in e){const s=e[a];["number","string","boolean"].indexOf(typeof s)>=0&&(t[a]=e[a])}return t},ws=(e,t,a)=>{for(let s in t.attributes)e.setAttribute(s,t.attributes[s]);a.style&&e.setAttribute("style",a.style),a.cssClasses&&e.setAttribute("class",a.cssClasses),a.slot&&e.setAttribute("slot",a.slot),t.content&&(t.html?e.innerHTML=t.content:e.append(t.content))},tn=e=>{const t=e.name;t.startsWith("vaadin-chart")&&!customElements.get(t)&&ue(()=>import("./vendor-highcharts.js"),__vite__mapDeps([0,1,2,3]));const a=e.attributes?e.attributes.import:void 0;a&&t.includes("-")&&!customElements.get(t)&&import(a)},an=(e,t,a)=>{tn(t);let s=t.name;return t.attributes&&t.attributes.id&&(s="#"+t.attributes.id),setTimeout(()=>{const i=e.shadowRoot?.querySelector(".element-container")?.querySelector(s);if(i){for(;i.firstChild;)i.removeChild(i.lastChild);ws(i,t,a)}else{const r=document.createElement(t.name);ws(r,t,a);for(let n in t.on)r.addEventListener(n,d=>{const c=en(d);e.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.on[n],parameters:{event:c}},bubbles:!0,composed:!0}))});e.shadowRoot?.querySelector(".element-container")?.appendChild(r)}}),o`<div class="element-container"></div>`};var qe=(e=>(e.div="div",e.p="p",e.h1="h1",e.h2="h2",e.h3="h3",e.h4="h4",e.h5="h5",e.h6="h6",e.span="span",e))(qe||{});const sn=(e,t,a,s,i)=>{const r=e.metadata,n=r.attributes?.["data-colspan"],d=wi(r.text,t,a,s,i),c={xl:"var(--lumo-font-size-xl, 1.375rem)",l:"var(--lumo-font-size-l, 1.125rem)",s:"var(--lumo-font-size-s, .875rem)",xs:"var(--lumo-font-size-xs, .8125rem)"},u=(r.size&&c[r.size]?`font-size: ${c[r.size]}; `:"")+(r.noMargins?"margin-block-start: 0; margin-block-end: 0; ":"");return qe.h1==r.container?o`
...
id="${e.id}"
    ...
    `},mn=(e,t,a,s,i,r,n)=>{const d=t.metadata;let c=!1;if(d.openedCondition)try{c=Hs(d.openedCondition,s,i,r,n)}catch(u){console.error("when evaluating "+d.openedCondition+" :"+u+", where data is "+i+" and state is "+s)}return o`
...
>
  ${t.children?.map(u=>k(e,u,a,s,i,r,n))}
    ...
    `},Wi=(e,t,a,s,i,r,n,d)=>{const c=t.metadata,u=c?.fabs??[];return o`<mateu-page
            .component="${t}"
            baseUrl="${a}"
            .state="${s}"
            .data="${i}"
    ...
    >
        ${t.children?.map(m=>k(e,m,a,s,i,r,n))}
        ${c?.buttons?.map(m=>o`
                   ${k(e,{id:m.actionId,metadata:m,type:pe.ClientSide,slot:"buttons"},void 0,s,i,r,n)}
`)}
        ${u.map((m,v)=>o`
    ...
    `},Gi=(e,t,a,s,i,r,n,d)=>o`<mateu-table-crud
            id="${t.id}"
            baseUrl="${a}"
            .component="${t}"
            .metadata="${t.metadata}"
...
`,Fn=e=>e=="up"?"var(--lumo-success-text-color, #1a7f37)":e=="down"?"var(--lumo-error-text-color, #c5221f)":"var(--lumo-secondary-text-color, #666)",Nn=e=>e=="up"?"▲":e=="down"?"▼":"",Mn=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},qn=e=>{const t=e.metadata,a=!!t.actionId;return o`
        <div class="mateu-metric-card ${e.cssClasses??""}"
             style="${ar} display: flex; flex-direction: column; gap: .25rem; min-width: 11rem; flex: 1; ${a?"cursor: pointer;":""} ${e.style??""}"
             slot="${e.slot??l}"
             role="${a?"button":l}"
             @click="${s=>Mn(s,t)}"
        >
    ...
    `,jn=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.colSpan&&d.colSpan>1?`grid-column: span ${d.colSpan};`:"",u=d.rowSpan&&d.rowSpan>1?`grid-row: span ${d.rowSpan};`:"";return o`
        <div class="mateu-dashboard-panel ${t.cssClasses??""}"
             style="${ar} display: flex; flex-direction: column; gap: .5rem; min-width: 0; ${c} ${u} ${t.style??""}"
             slot="${t.slot??l}"
        >
            ${d.title?o`
                <div>
    ...
    `;es([p({type:Array})],La.prototype,"panels",2);es([b()],La.prototype,"openPanels",2);La=es([x("mateu-foldout")],La);const Wn=(e,t,a,s,i,r,n)=>{const d=t.metadata;return o`
        <mateu-foldout
                .panels="${d.panels??[]}"
                style="${t.style}"
                class="${t.cssClasses}"
    ...
    `};var Kn=Object.defineProperty,Yn=Object.getOwnPropertyDescriptor,ir=(e,t,a,s)=>{for(var i=s>1?void 0:s?Yn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Kn(t,a,i),i};const ji=1440*60*1e3;let ii=class extends _{constructor(){super(...arguments),this.tasks=[]}range(){const e=this.tasks.flatMap(t=>[t.start,t.end]).filter(t=>!!t).map(t=>new Date(t+"T00:00:00").getTime());return e.length?{min:Math.min(...e)-ji,max:Math.max(...e)+2*ji}:null}months(e,t){const a=[],s=new Date(e);for(s.setDate(1);s.getTime()<=t;){const i=Math.max(s.getTime(),e),r=new Date(s.getFullYear(),s.getMonth()+1,1),n=Math.min(r.getTime(),t);a.push({label:s.toLocaleDateString(void 0,{month:"short",year:"2-digit"}),from:i,to:n}),s.setMonth(s.getMonth()+1)}return a}render(){const e=this.range();if(!e)return o``;const t=e.max-e.min,a=i=>(i-e.min)/t*100,s=Date.now();return o`
            <div class="frame">
                ...
                ${this.tasks.map(i=>{const r=new Date(i.start+"T00:00:00").getTime(),n=new Date(i.end+"T00:00:00").getTime()+ji;return o`
    ...
    `;ir([p({type:Array})],ii.prototype,"tasks",2);ii=ir([x("mateu-gantt")],ii);const Jn=e=>{const t=e.metadata;return o`
        <mateu-gantt
                .tasks="${t.tasks??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;Ot([p({type:Array})],z.prototype,"resources",2);Ot([p({type:Array})],z.prototype,"blocks",2);Ot([p()],z.prototype,"from",2);Ot([p()],z.prototype,"to",2);Ot([p()],z.prototype,"moveActionId",2);Ot([p()],z.prototype,"selectActionId",2);Ot([b()],z.prototype,"drag",2);z=Ot([x("mateu-planning-board")],z);const Zn=e=>{const t=e.metadata;return o`
        <mateu-planning-board
                ...
                slot="${e.slot??l}"
        ></mateu-planning-board>
    `};var el=Object.defineProperty,tl=Object.getOwnPropertyDescriptor,sr=(e,t,a,s)=>{for(var i=s>1?void 0:s?tl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&el(t,a,i),i};let si=class extends _{constructor(){super(...arguments),this.columns=[]}clickCard(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedCard:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="board">
    ...
    `;sr([p({type:Array})],si.prototype,"columns",2);si=sr([x("mateu-kanban")],si);const al=e=>{const t=e.metadata;return o`
        <mateu-kanban
                .columns="${t.columns??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-kanban>
    `};var il=Object.defineProperty,sl=Object.getOwnPropertyDescriptor,rr=(e,t,a,s)=>{for(var i=s>1?void 0:s?sl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&il(t,a,i),i};let ri=class extends _{constructor(){super(...arguments),this.items=[]}clickItem(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedItem:e}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="feed">
                ${this.items.map(e=>o`
    ...
    `;rr([p({type:Array})],ri.prototype,"items",2);ri=rr([x("mateu-timeline")],ri);const rl=e=>{const t=e.metadata;return o`
        <mateu-timeline
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-timeline>
    `};var ol=Object.defineProperty,nl=Object.getOwnPropertyDescriptor,ts=(e,t,a,s)=>{for(var i=s>1?void 0:s?nl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ol(t,a,i),i};let Da=class extends _{constructor(){super(...arguments),this.steps=[],this.vertical=!1}render(){return o`
            <div class="steps">
    ...
    `;ts([p({type:Array})],Da.prototype,"steps",2);ts([p({type:Boolean,reflect:!0})],Da.prototype,"vertical",2);Da=ts([x("mateu-progress-steps")],Da);const ll=e=>{const t=e.metadata;return o`
        <mateu-progress-steps
                ...
                slot="${e.slot??l}"
        ></mateu-progress-steps>
    `};var dl=Object.defineProperty,cl=Object.getOwnPropertyDescriptor,Rt=(e,t,a,s)=>{for(var i=s>1?void 0:s?cl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&dl(t,a,i),i};let He=class extends _{constructor(){super(...arguments),this.spark=[]}sparkline(){const e=this.spark;if(!e||e.length<2)return l;const t=84,a=30,s=2,i=Math.min(...e),n=Math.max(...e)-i||1,d=(t-s*2)/(e.length-1),c=e.map((f,g)=>{const y=s+g*d,$=s+(a-s*2)*(1-(f-i)/n);return[y,$]}),u=c.map(([f,g],y)=>`${y===0?"M":"L"}${f.toFixed(1)} ${g.toFixed(1)}`).join(" "),m=`${u} L${c[c.length-1][0].toFixed(1)} ${a} L${c[0][0].toFixed(1)} ${a} Z`,v=this.trend==="down"?"var(--lumo-error-color, #e11d48)":this.trend==="flat"?"var(--lumo-secondary-text-color, #888)":"var(--lumo-success-color, #12b76a)";return H`
    ...
    `;Rt([p()],He.prototype,"label",2);Rt([p()],He.prototype,"value",2);Rt([p()],He.prototype,"unit",2);Rt([p()],He.prototype,"delta",2);Rt([p()],He.prototype,"trend",2);Rt([p({type:Array})],He.prototype,"spark",2);Rt([p()],He.prototype,"actionId",2);He=Rt([x("mateu-stat")],He);const ul=e=>{const t=e.metadata;return o`
        <mateu-stat
                label="${t.label??l}"
                value="${t.value??l}"
                unit="${t.unit??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-stat>
    `};var pl=Object.defineProperty,hl=Object.getOwnPropertyDescriptor,as=(e,t,a,s)=>{for(var i=s>1?void 0:s?hl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&pl(t,a,i),i};let Aa=class extends _{constructor(){super(...arguments),this.events=[]}clickEvent(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedEvent:e}},bubbles:!0,composed:!0}))}render(){const e=this.month?new Date(this.month+"T00:00:00"):new Date,t=e.getFullYear(),a=e.getMonth(),s=new Date(t,a,1),i=(s.getDay()+6)%7,r=new Date(t,a+1,0).getDate(),n=new Date,d=f=>n.getFullYear()===t&&n.getMonth()===a&&n.getDate()===f,c={};for(const f of this.events){if(!f.date)continue;const g=new Date(f.date+"T00:00:00");g.getFullYear()===t&&g.getMonth()===a&&(c[g.getDate()]??=[]).push(f)}const u=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],m=[];for(let f=0;f<i;f++)m.push(o`<div class="cell blank"></div>`);for(let f=1;f<=r;f++)m.push(o`
    ...
    `;as([p()],Aa.prototype,"month",2);as([p({type:Array})],Aa.prototype,"events",2);Aa=as([x("mateu-calendar")],Aa);const ml=e=>{const t=e.metadata;return o`
        <mateu-calendar
                month="${t.month??l}"
                .events="${t.events??[]}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-calendar>
    `};var vl=Object.defineProperty,fl=Object.getOwnPropertyDescriptor,or=(e,t,a,s)=>{for(var i=s>1?void 0:s?fl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&vl(t,a,i),i};let oi=class extends _{constructor(){super(...arguments),this.plans=[]}cta(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){return o`
            <div class="plans">
                ${this.plans.map(e=>o`
    ...
    `;or([p({type:Array})],oi.prototype,"plans",2);oi=or([x("mateu-pricing-table")],oi);const bl=e=>{const t=e.metadata;return o`
        <mateu-pricing-table
                .plans="${t.plans??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-pricing-table>
    `};var gl=Object.defineProperty,$l=Object.getOwnPropertyDescriptor,nr=(e,t,a,s)=>{for(var i=s>1?void 0:s?$l(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&gl(t,a,i),i};let ni=class extends _{clickNode(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedNode:e}},bubbles:!0,composed:!0}))}renderNode(e){const t=e.avatar,a=t&&(t.startsWith("http")||t.startsWith("data:"));return o`
            <li>
        ...
        `}render(){return this.root?o`<div class="tree"><ul>${this.renderNode(this.root)}</ul></div>`:o``}};ni.styles=w`
        :host {
            display: block;
            width: 100%;
            overflow-x: auto;
    ...
    `;nr([p({attribute:!1})],ni.prototype,"root",2);ni=nr([x("mateu-org-chart")],ni);const yl=e=>{const t=e.metadata;return o`
        <mateu-org-chart
                .root="${t.root}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;lr([p({type:Array})],li.prototype,"cells",2);li=lr([x("mateu-heatmap")],li);const _l=e=>{const t=e.metadata;return o`
        <mateu-heatmap
                .cells="${t.cells??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-heatmap>
    `};var Cl=Object.defineProperty,Sl=Object.getOwnPropertyDescriptor,dr=(e,t,a,s)=>{for(var i=s>1?void 0:s?Sl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Cl(t,a,i),i};let di=class extends _{constructor(){super(...arguments),this.stages=[]}render(){const e=this.stages;if(!e.length)return o``;const t=e[0].value??0,a=Math.max(...e.map(s=>s.value??0),1);return o`
            <div class="funnel">
    ...
    `;dr([p({type:Array})],di.prototype,"stages",2);di=dr([x("mateu-funnel")],di);const Il=e=>{const t=e.metadata;return o`
        <mateu-funnel
                .stages="${t.stages??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-funnel>
    `};var El=Object.defineProperty,Pl=Object.getOwnPropertyDescriptor,ga=(e,t,a,s)=>{for(var i=s>1?void 0:s?Pl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&El(t,a,i),i};let yt=class extends _{constructor(){super(...arguments),this.values=[],this.labels=[],this.area=!1}render(){const e=this.values;if(!e||e.length<2)return o``;const t=600,a=160,s=8,i=Math.min(...e),r=Math.max(...e),n=r-i||1,d=(t-s*2)/(e.length-1),c=e.map((y,$)=>{const E=s+$*d,q=s+(a-s*2)*(1-(y-i)/n);return[E,q]}),u=c.map(([y,$],E)=>`${E===0?"M":"L"}${y.toFixed(1)} ${$.toFixed(1)}`).join(" "),m=`${u} L${c[c.length-1][0].toFixed(1)} ${a-s} L${c[0][0].toFixed(1)} ${a-s} Z`,v=this.color||"var(--lumo-primary-color, #1a73e8)",f=e.indexOf(r),g=e.indexOf(i);return o`
            ...
            <svg viewBox="0 0 ${t} ${a}" preserveAspectRatio="none">
                ...
                ${c.map((y,$)=>$===f||$===g?H`<circle cx="${y[0]}" cy="${y[1]}" r="3.2" fill="${v}"><title>${this.labels[$]??""}: ${e[$]}</title></circle>`:H`<circle cx="${y[0]}" cy="${y[1]}" r="6" fill="transparent"><title>${this.labels[$]??""}: ${e[$]}</title></circle>`)}
            </svg>
    ...
    `;ga([p()],yt.prototype,"heading",2);ga([p({type:Array})],yt.prototype,"values",2);ga([p({type:Array})],yt.prototype,"labels",2);ga([p()],yt.prototype,"color",2);ga([p({type:Boolean})],yt.prototype,"area",2);yt=ga([x("mateu-trend-chart")],yt);const Tl=e=>{const t=e.metadata;return o`
        <mateu-trend-chart
                heading="${t.title??l}"
                color="${t.color??l}"
                ?area="${t.area??!1}"
                ...
                slot="${e.slot??l}"
        ></mateu-trend-chart>
    `};var Ol=Object.defineProperty,Rl=Object.getOwnPropertyDescriptor,is=(e,t,a,s)=>{for(var i=s>1?void 0:s?Rl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ol(t,a,i),i};let Fa=class extends _{constructor(){super(...arguments),this.features=[],this.columns=0}clickFeature(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){const e=this.columns&&this.columns>0?`repeat(${this.columns}, minmax(0, 1fr))`:"repeat(auto-fit, minmax(15rem, 1fr))";return o`
    ...
    `;is([p({type:Array})],Fa.prototype,"features",2);is([p({type:Number})],Fa.prototype,"columns",2);Fa=is([x("mateu-feature-grid")],Fa);const zl=e=>{const t=e.metadata;return o`
        <mateu-feature-grid
                .features="${t.features??[]}"
                .columns="${t.columns??0}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-feature-grid>
    `};var Ll=Object.defineProperty,Dl=Object.getOwnPropertyDescriptor,cr=(e,t,a,s)=>{for(var i=s>1?void 0:s?Dl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ll(t,a,i),i};let ci=class extends _{constructor(){super(...arguments),this.items=[]}stars(e){const t=Math.max(0,Math.min(5,e||0));return"★".repeat(t)+"☆".repeat(5-t)}render(){return o`
            <div class="grid">
    ...
    `;cr([p({type:Array})],ci.prototype,"items",2);ci=cr([x("mateu-testimonials")],ci);const Al=e=>{const t=e.metadata;return o`
        <mateu-testimonials
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-testimonials>
    `};var Fl=Object.defineProperty,Nl=Object.getOwnPropertyDescriptor,ss=(e,t,a,s)=>{for(var i=s>1?void 0:s?Nl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Fl(t,a,i),i};let Na=class extends _{constructor(){super(...arguments),this.items=[],this.openSet=new Set,this.seeded=!1}seed(){this.seeded||(this.seeded=!0,this.items.forEach((e,t)=>{e.open&&this.openSet.add(t)}))}toggle(e){this.openSet.has(e)?this.openSet.delete(e):this.openSet.add(e),this.requestUpdate()}render(){return this.seed(),o`
            <div class="list">
    ...
    `;ss([p({type:Array})],Na.prototype,"items",2);ss([b()],Na.prototype,"openSet",2);Na=ss([x("mateu-faq")],Na);const Ml=e=>{const t=e.metadata;return o`
        <mateu-faq
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;Zt([p()],rt.prototype,"heading",2);Zt([p()],rt.prototype,"description",2);Zt([p()],rt.prototype,"icon",2);Zt([p()],rt.prototype,"ctaLabel",2);Zt([p()],rt.prototype,"actionId",2);Zt([p()],rt.prototype,"theme",2);rt=Zt([x("mateu-callout-card")],rt);const jl=e=>{const t=e.metadata;return o`
        <mateu-callout-card
                heading="${t.title??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-callout-card>
    `};var Bl=Object.defineProperty,Vl=Object.getOwnPropertyDescriptor,ur=(e,t,a,s)=>{for(var i=s>1?void 0:s?Vl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Bl(t,a,i),i};let ui=class extends _{constructor(){super(...arguments),this.comments=[]}renderComment(e){const t=e.avatar&&(e.avatar.startsWith("http")||e.avatar.startsWith("data:"));return o`
            <div class="comment">
        ...
        `}render(){return o`<div class="thread">${this.comments.map(e=>this.renderComment(e))}</div>`}};ui.styles=w`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
    ...
    `;ur([p({type:Array})],ui.prototype,"comments",2);ui=ur([x("mateu-comment-thread")],ui);const Hl=e=>{const t=e.metadata;return o`
        <mateu-comment-thread
                ...
                slot="${e.slot??l}"
        ></mateu-comment-thread>
    `};var Wl=Object.defineProperty,Gl=Object.getOwnPropertyDescriptor,pr=(e,t,a,s)=>{for(var i=s>1?void 0:s?Gl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Wl(t,a,i),i};const Kl={pdf:"📕",image:"🖼️",img:"🖼️",doc:"📘",docx:"📘",word:"📘",xls:"📗",xlsx:"📗",excel:"📗",sheet:"📗",zip:"🗜️",archive:"🗜️",video:"🎬",audio:"🎵",code:"💻",csv:"📄",txt:"📄"};let pi=class extends _{constructor(){super(...arguments),this.files=[]}icon(e){return e&&Kl[e.toLowerCase()]||"📄"}clickFile(e,t){e.url||e.actionId&&(t.preventDefault(),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_file:e}},bubbles:!0,composed:!0})))}render(){return o`
            <div class="list">
    ...
    `;pr([p({type:Array})],pi.prototype,"files",2);pi=pr([x("mateu-file-list")],pi);const Yl=e=>{const t=e.metadata;return o`
        <mateu-file-list
                .files="${t.files??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;_i([p()],ua.prototype,"heading",2);_i([p({type:Array})],ua.prototype,"items",2);_i([b()],ua.prototype,"localDone",2);ua=_i([x("mateu-checklist")],ua);const Ql=e=>{const t=e.metadata;return o`
        <mateu-checklist
                heading="${t.title??l}"
                .items="${t.items??[]}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-checklist>
    `};var Zl=Object.defineProperty,ed=Object.getOwnPropertyDescriptor,zt=(e,t,a,s)=>{for(var i=s>1?void 0:s?ed(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Zl(t,a,i),i};let We=class extends _{render(){const e=this.trend??"flat";return o`
            <div class="card">
                ${this.heading?o`<div class="title">${this.heading}</div>`:l}
                <div class="row">
                    <div class="side">
        ...
        @media (prefers-color-scheme: dark) { .card { background: var(--lumo-contrast-5pct, #2a2a2a); } }
    `;zt([p()],We.prototype,"heading",2);zt([p()],We.prototype,"leftLabel",2);zt([p()],We.prototype,"leftValue",2);zt([p()],We.prototype,"rightLabel",2);zt([p()],We.prototype,"rightValue",2);zt([p()],We.prototype,"delta",2);zt([p()],We.prototype,"trend",2);We=zt([x("mateu-comparison-card")],We);const td=e=>{const t=e.metadata;return o`
...
`,ad=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}),Ki=e=>ad.format(e),hi=(e,t)=>{const a=e<0?"-":"",s=Ki(Math.abs(e));return t?`${a}${t} ${s}`:`${a}${s}`},id=(e,t)=>t?`${Ki(e)} ${t}`:Ki(e);var sd=Object.defineProperty,rd=Object.getOwnPropertyDescriptor,Lt=(e,t,a,s)=>{for(var i=s>1?void 0:s?rd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&sd(t,a,i),i};let Ge=class extends _{constructor(){super(...arguments),this.title="",this.badges=[],this.facts=[]}render(){const e=!!(this.metricLabel||this.metricValue||this.metricCaption);return o`
            <div class="card">
                <div class="main">
                    <div class="title-row">
    ...
    `];Lt([p()],Ge.prototype,"title",2);Lt([p({type:Array})],Ge.prototype,"badges",2);Lt([p()],Ge.prototype,"subtitle",2);Lt([p({type:Array})],Ge.prototype,"facts",2);Lt([p()],Ge.prototype,"metricLabel",2);Lt([p()],Ge.prototype,"metricValue",2);Lt([p()],Ge.prototype,"metricCaption",2);Ge=Lt([x("mateu-entity-header")],Ge);const od=e=>{const t=e.metadata;return o`
        <mateu-entity-header
                .title="${t.title??""}"
                .badges="${t.badges??[]}"
                .subtitle="${t.subtitle}"
                ...
                slot="${e.slot??l}"
        ></mateu-entity-header>
    `};var nd=Object.defineProperty,ld=Object.getOwnPropertyDescriptor,Dt=(e,t,a,s)=>{for(var i=s>1?void 0:s?ld(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&nd(t,a,i),i};let Ke=class extends _{constructor(){super(...arguments),this.value=0,this.max=0}fillColor(){return this.dangerAt!=null&&this.value>=this.dangerAt?"error":this.warnAt!=null&&this.value>=this.warnAt?"warning":this.warnAt!=null||this.dangerAt!=null?"success":"primary"}render(){const e=this.max>0?Math.min(Math.max(this.value/this.max,0),1):0,t=Math.round(e*100);return o`
            <div class="meter">
                ${this.label?o`<span class="label">${this.label}</span>`:l}
    ...
    `;Dt([p()],Ke.prototype,"label",2);Dt([p({type:Number})],Ke.prototype,"value",2);Dt([p({type:Number})],Ke.prototype,"max",2);Dt([p()],Ke.prototype,"unit",2);Dt([p()],Ke.prototype,"caption",2);Dt([p({type:Number})],Ke.prototype,"warnAt",2);Dt([p({type:Number})],Ke.prototype,"dangerAt",2);Ke=Dt([x("mateu-meter")],Ke);const dd=e=>{const t=e.metadata;return o`
        <mateu-meter
                .label="${t.label}"
                .value="${t.value??0}"
                .max="${t.max??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-meter>
    `};var cd=Object.defineProperty,ud=Object.getOwnPropertyDescriptor,$a=(e,t,a,s)=>{for(var i=s>1?void 0:s?ud(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&cd(t,a,i),i};let xt=class extends _{constructor(){super(...arguments),this.total=0,this.done=0}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){const e=this.total>0&&this.done>=this.total,t=!e&&!!this.actionLabel&&!!this.actionId;return o`
    ...
    `;$a([p()],xt.prototype,"label",2);$a([p({type:Number})],xt.prototype,"total",2);$a([p({type:Number})],xt.prototype,"done",2);$a([p()],xt.prototype,"actionLabel",2);$a([p()],xt.prototype,"actionId",2);xt=$a([x("mateu-task-progress")],xt);const pd=e=>{const t=e.metadata;return o`
        <mateu-task-progress
                .label="${t.label}"
                .total="${t.total??0}"
                .done="${t.done??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-task-progress>
    `};var hd=Object.defineProperty,md=Object.getOwnPropertyDescriptor,ja=(e,t,a,s)=>{for(var i=s>1?void 0:s?md(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&hd(t,a,i),i};let Bt=class extends _{constructor(){super(...arguments),this.items=[],this.compact=!1,this.frameless=!1}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}rowClicked(e){this.rowActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.rowActionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}render(){return o`
    ...
    `];ja([p({type:Array})],Bt.prototype,"items",2);ja([p({type:Boolean})],Bt.prototype,"compact",2);ja([p({type:Boolean})],Bt.prototype,"frameless",2);ja([p()],Bt.prototype,"rowActionId",2);Bt=ja([x("mateu-status-list")],Bt);const vd=e=>{const t=e.metadata;return o`
        <mateu-status-list
                .items="${t.items??[]}"
                ?compact="${t.compact??!1}"
                ...
                slot="${e.slot??l}"
        ></mateu-status-list>
    `};var fd=Object.defineProperty,bd=Object.getOwnPropertyDescriptor,hr=(e,t,a,s)=>{for(var i=s>1?void 0:s?bd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&fd(t,a,i),i};let mi=class extends _{constructor(){super(...arguments),this.items=[]}render(){return o`
            <ul>
    ...
    `;hr([p({type:Array})],mi.prototype,"items",2);mi=hr([x("mateu-bulleted-list")],mi);const gd=e=>{const t=e.metadata;return o`
        <mateu-bulleted-list
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;Ce([p()],oe.prototype,"text",2);Ce([p()],oe.prototype,"theme",2);Ce([p()],oe.prototype,"icon",2);Ce([p({type:Boolean})],oe.prototype,"noIcon",2);Ce([p()],oe.prototype,"actionLabel",2);Ce([p()],oe.prototype,"actionId",2);Ce([p()],oe.prototype,"status",2);Ce([p({type:Boolean})],oe.prototype,"slim",2);Ce([p({type:Boolean})],oe.prototype,"fullWidth",2);Ce([p({type:Boolean})],oe.prototype,"hasContent",2);Ce([p({type:Boolean})],oe.prototype,"inlineContent",2);oe=Ce([x("mateu-notice")],oe);const kd=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=wi(d.text??"",s,i,r,n)??"",u=t.children??[];return o`
        <mateu-notice
                text="${c}"
                theme="${d.theme??"info"}"
    ...
    `];ya([p()],wt.prototype,"actionId",2);ya([p({type:Number})],wt.prototype,"columns",2);ya([p()],wt.prototype,"recommendedLabel",2);ya([p({type:Array})],wt.prototype,"items",2);ya([b()],wt.prototype,"selectedId",2);wt=ya([x("mateu-resource-grid")],wt);const Pd=e=>{const t=e.metadata;return o`
        <mateu-resource-grid
                .actionId="${t.actionId}"
                .columns="${t.columns??0}"
                ...
                ${this.items.map(e=>{const t=e.id!=null&&this.added.has(e.id);return o`
                        <div class="card ${t?"added":""}">
                            ...
                            ${e.includedLabel?o`<span class="included">${e.includedLabel}</span>`:o`
                                    ${e.price!=null?o`
                                        <span class="price">${hi(e.price,this.currency)}${e.unit?` / ${e.unit}`:""}</span>
                                    `:l}
    ...
    `;xa([p()],kt.prototype,"totalLabel",2);xa([p()],kt.prototype,"currency",2);xa([p()],kt.prototype,"actionId",2);xa([p({type:Array})],kt.prototype,"items",2);xa([b()],kt.prototype,"added",2);kt=xa([x("mateu-addon-picker")],kt);const Dd=e=>{const t=e.metadata;return o`
        <mateu-addon-picker
                ...
                slot="${e.slot??l}"
        ></mateu-addon-picker>
    `};var Ad=Object.defineProperty,Fd=Object.getOwnPropertyDescriptor,Ba=(e,t,a,s)=>{for(var i=s>1?void 0:s?Fd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ad(t,a,i),i};let Vt=class extends _{constructor(){super(...arguments),this.lines=[]}computedTotal(){return this.total!=null?this.total:this.lines.filter(e=>!e.included).reduce((e,t)=>e+(t.amount??0),0)}render(){return o`
            ${this.lines.map(e=>o`
                <div class="row">
                    <span class="dot"></span>
                    <span class="concept">${e.concept}</span>
                    ${e.included?o`<span class="included-label">${e.includedLabel||"Included"}</span>`:o`<span class="amount ${(e.amount??0)<0?"negative":""}">${hi(e.amount??0,this.currency)}</span>`}
                </div>
            `)}
            <div class="total-row">
                <span class="total-label">${this.totalLabel||"Total"}</span>
                <span class="total">${hi(this.computedTotal(),this.currency)}</span>
            </div>
        `}};Vt.styles=w`
        :host {
    ...
    `;Ba([p()],Vt.prototype,"currency",2);Ba([p()],Vt.prototype,"totalLabel",2);Ba([p({type:Array})],Vt.prototype,"lines",2);Ba([p({type:Number})],Vt.prototype,"total",2);Vt=Ba([x("mateu-ledger")],Vt);const Nd=e=>{const t=e.metadata;return o`
        <mateu-ledger
                .currency="${t.currency}"
                .totalLabel="${t.totalLabel}"
                .lines="${t.lines??[]}"
    ...
    `;lt([p()],ze.prototype,"actionId",2);lt([p()],ze.prototype,"methodActionId",2);lt([p({type:Array})],ze.prototype,"methods",2);lt([p()],ze.prototype,"selected",2);lt([p()],ze.prototype,"contextLabel",2);lt([p()],ze.prototype,"contextValue",2);lt([p()],ze.prototype,"confirmLabel",2);lt([b()],ze.prototype,"selectedId",2);ze=lt([x("mateu-payment-picker")],ze);const Ud=e=>{const t=e.metadata;return o`
        <mateu-payment-picker
                ...
                slot="${e.slot??l}"
        ></mateu-payment-picker>
    `};var jd=Object.defineProperty,Bd=Object.getOwnPropertyDescriptor,mr=(e,t,a,s)=>{for(var i=s>1?void 0:s?Bd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&jd(t,a,i),i};let vi=class extends _{constructor(){super(...arguments),this.items=[]}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return o`
            <div class="list">
                ${this.items.map(e=>o`
                    <div class="row">
    ...
    `;mr([p({type:Array})],vi.prototype,"items",2);vi=mr([x("mateu-process-monitor")],vi);const Vd=e=>{const t=e.metadata;return o`
        <mateu-process-monitor
                ...
                slot="${e.slot??l}"
        ></mateu-process-monitor>
    `},Hd=(e,t)=>{let a=e.style;return e.id&&(a&&!a.endsWith(";")&&(a+=";"),a==null&&(a=""),t[e.id+".hidden"]==!0&&(a+="display: none;")),a},Wd=(e,t)=>{let a={...e.metadata};if(e.id&&a){if(a.type==h.Button){const s=a;t[e.id+".disabled"]==!0&&(s.disabled=!0)}if(a.type==h.FormField){const s=a;t[e.id+".disabled"]==!0&&(s.disabled=!0)}}return a},O=e=>t=>e(t.container,t.component,t.baseUrl,t.state,t.data,t.appState,t.appData),Gd={[h.Bpmn]:({component:e})=>Rn(e),[h.Workflow]:({component:e})=>Ln(e),[h.WorkflowElk]:({component:e})=>Dn(e),[h.FormEditor]:({component:e})=>An(e),[h.Page]:O(Wi),[h.Div]:O(Pn),[h.Directory]:({component:e,baseUrl:t,state:a,data:s})=>En(e),[h.FormLayout]:O(ao),[h.HorizontalLayout]:O(ro),[h.VerticalLayout]:O(oo),[h.SplitLayout]:O(no),[h.MasterDetailLayout]:O(lo),[h.TabLayout]:O(co),[h.AccordionLayout]:O(po),[h.BoardLayout]:O(bo),[h.BoardLayoutRow]:O(go),[h.BoardLayoutItem]:O($o),[h.Scroller]:O(mo),[h.FullWidth]:O(vo),[h.Container]:O(fo),[h.Form]:({container:e,component:t,baseUrl:a,state:s,data:i,appState:r,appData:n})=>{const d=t.metadata;return o`<mateu-form
            id="${t.id}"
        baseUrl="${a}"
            .component="${t}"
            .values="${s}"
            ...
            >
                ${t.children?.map(c=>k(e,c,a,s,i,r,n))}
            ${d?.buttons?.map(c=>o`
               ${k(e,{id:c.actionId,metadata:c,type:pe.ClientSide,slot:"buttons"},void 0,s,i,r,n)}
`)}
        ...
        baseUrl="${a}"
            ...
            >
             ${t.children?.map(d=>k(e,d,a,s,i,r,n))}
            </mateu-table>`,[h.Crud]:O(Gi),[h.App]:({container:e,component:t,baseUrl:a,state:s,data:i,appState:r,appData:n})=>o`
            <mateu-app
                        id="${t.id}"
                        baseUrl="${a}"
                        .component="${t}"
    ...
    <mateu-field
        ...
        `},[h.Text]:({component:e,state:t,data:a,appState:s,appData:i})=>sn(e,t,a,s,i),[h.Avatar]:({component:e,state:t,data:a})=>xo(e,t,a),[h.Chat]:({component:e,state:t,data:a})=>zn(e),[h.AvatarGroup]:({component:e})=>wo(e),[h.Badge]:({component:e,state:t,data:a})=>rn(e,t,a),[h.Breadcrumbs]:({component:e})=>Sn(e),[h.Anchor]:({component:e})=>nn(e),[h.Button]:({component:e,state:t,data:a})=>cn(e,t,a),[h.Card]:O(un),[h.Chart]:({component:e})=>pn(e),[h.Icon]:({component:e})=>hn(e),[h.ConfirmDialog]:O(mn),[h.ContextMenu]:O(Yo),[h.CookieConsent]:({component:e})=>vn(e),[h.Details]:O(fn),[h.Dialog]:({component:e,baseUrl:t,state:a,data:s,appState:i,appData:r})=>bn(e,t,a,s,i,r),[h.Drawer]:({component:e,baseUrl:t,state:a,data:s,appState:i,appData:r})=>gn(e,t,a,s,i,r),[h.Image]:({component:e})=>Cn(e),[h.Map]:({component:e})=>_n(e),[h.Markdown]:({component:e})=>yn(e),[h.MicroFrontend]:({component:e})=>$n(e),[h.Notification]:({component:e})=>xn(e),[h.ProgressBar]:({component:e,state:t})=>wn(e,t),[h.Popover]:O(kn),[h.CarouselLayout]:O(In),[h.Tooltip]:O(Zo),[h.MessageInput]:({component:e})=>Qo(e),[h.MessageList]:({component:e})=>Ko(e),[h.CustomField]:O(Xo),[h.MenuBar]:({container:e,component:t,baseUrl:a,state:s,data:i})=>Jo(e,t,a,s,i),[h.Grid]:O(Go),[h.VirtualList]:O(ko),[h.FormSection]:O(Tn),[h.FormSubSection]:O(On),[h.MetricCard]:({component:e})=>qn(e),[h.Scoreboard]:O(Un),[h.DashboardPanel]:O(jn),[h.DashboardLayout]:O(Bn),[h.FoldoutLayout]:O(Wn),[h.HeroSection]:O(Gn),[h.EmptyState]:({component:e})=>Io(e),[h.Skeleton]:({component:e})=>Eo(e),[h.Gantt]:({component:e})=>Jn(e),[h.PlanningBoard]:({component:e})=>Zn(e),[h.Kanban]:({component:e})=>al(e),[h.Timeline]:({component:e})=>rl(e),[h.ProgressSteps]:({component:e})=>ll(e),[h.Stat]:({component:e})=>ul(e),[h.Calendar]:({component:e})=>ml(e),[h.PricingTable]:({component:e})=>bl(e),[h.OrgChart]:({component:e})=>yl(e),[h.Heatmap]:({component:e})=>_l(e),[h.Funnel]:({component:e})=>Il(e),[h.TrendChart]:({component:e})=>Tl(e),[h.FeatureGrid]:({component:e})=>zl(e),[h.Testimonials]:({component:e})=>Al(e),[h.Faq]:({component:e})=>Ml(e),[h.CalloutCard]:({component:e})=>jl(e),[h.CommentThread]:({component:e})=>Hl(e),[h.FileList]:({component:e})=>Yl(e),[h.Checklist]:({component:e})=>Ql(e),[h.ComparisonCard]:({component:e})=>td(e),[h.EntityHeader]:({component:e})=>od(e),[h.Meter]:({component:e})=>dd(e),[h.TaskProgress]:({component:e})=>pd(e),[h.StatusList]:({component:e})=>vd(e),[h.BulletedList]:({component:e})=>gd(e),[h.Separator]:({component:e})=>$d(e),[h.Notice]:O(kd),[h.TaskQueue]:({component:e})=>Sd(e),[h.ResourceGrid]:({component:e})=>Pd(e),[h.OfferCard]:({component:e})=>Rd(e),[h.AddOnPicker]:({component:e})=>Dd(e),[h.Ledger]:({component:e})=>Nd(e),[h.PaymentPicker]:({component:e})=>Ud(e),[h.ProcessMonitor]:({component:e})=>Vd(e)},rs=(e,t,a,s,i,r,n,d)=>{if(!t?.metadata)return t==null?(console.warn("No metadata for component",t),o`<p>No metadata for component</p>`):rs(e,{id:Q(),metadata:t,type:pe.ClientSide},a,s,i,r,n,d);const c=t.metadata.type,u={...t,style:Hd(t,i),metadata:Wd(t,i)},m=Gd[c];return m?m({container:e,component:u,baseUrl:a,state:s,data:i,appState:r,appData:n,labelAlreadyRendered:d}):o`<p ${u?.slot??l}>Unknown metadata type ${c} for component ${u?.id}</p>`};var xe=(e=>(e.HAMBURGUER_MENU="HAMBURGUER_MENU",e.MENU_ON_LEFT="MENU_ON_LEFT",e.MENU_ON_TOP="MENU_ON_TOP",e.TABS="TABS",e.TILES="TILES",e.RAIL="RAIL",e.AUTO="AUTO",e.MEDIATOR="MEDIATOR",e))(xe||{});const os="mateu-app-context",vr="mateu-app-context-labels",fr=e=>{try{return JSON.parse(localStorage.getItem(e)??"{}")}catch{return{}}},ks=(e,t)=>{try{localStorage.setItem(e,JSON.stringify(t))}catch{}},Ii=()=>fr(os),ns=()=>fr(vr),br=(e,t,a)=>{const s=Ii(),i=ns();t==null||t===""?(delete s[e],delete i[e]):(s[e]=t,a!==void 0&&(i[e]=a)),ks(os,s),ks(vr,i)};let _s=!1;const gr=()=>{_s||(_s=!0,window.addEventListener("storage",e=>{e.key===os&&e.newValue!==e.oldValue&&window.location.reload()}))},Kd=(e,t)=>new Promise((a,s)=>{let i=!1;const r={retry:()=>{i||(i=!0,t().then(a,s))},giveUp:()=>{i||(i=!0,s(e))}},n=new CustomEvent("mateu-session-expired",{detail:r,cancelable:!0,bubbles:!1});typeof document<"u"&&!document.dispatchEvent(n)||r.giveUp()}),Yd=(e,t)=>e.includes("json")?!0:t!==null&&typeof t=="object",Jd=(e,t)=>{const a=e.finalUrl;if(!a)return;const s=typeof window<"u"?window.location.href:void 0;let i;try{i=new URL(e.requestedUrl,s).href}catch{return}if(i!==a&&!Yd(e.contentType??"",e.data))return a};let la=[];class Xd{constructor(){this.axiosInstance=Yr.create({timeout:6e4}),this.axiosInstance.interceptors.request.use(t=>(this.addAuthToken(t),this.addSessionId(t),t)),this.axiosInstance.interceptors.response.use(t=>{const a=Jd({requestedUrl:this.axiosInstance.getUri(t.config),finalUrl:t.request?.responseURL,contentType:String(t.headers?.["content-type"]??""),data:t.data});if(a)throw window.location.assign(a),Object.assign(new Error("session lost — redirecting to "+a),{code:"ERR_CANCELED"});return t},t=>{const a=t;if(a?.response?.status===401&&a.config&&!a.config.__mateuRetried){const s=a.config;return s.__mateuRetried=!0,Kd(t,()=>this.axiosInstance.request(s))}throw t})}addSessionId(t){let a=sessionStorage.getItem("__mateu_sesion_id");a||(a=Q(),sessionStorage.setItem("__mateu_sesion_id",a)),t.headers["X-Session-Id"]=a}addAuthToken(t){const a=localStorage.getItem("__mateu_auth_token");a&&(t.headers.Authorization="Bearer "+a)}async wrap(t,a,s,i){return s||a.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),t.then(r=>(a.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:i}})),r)).catch(r=>{throw r?.code=="ERR_CANCELED"?a.dispatchEvent(new CustomEvent("backend-cancelled-event",{bubbles:!0,composed:!0,detail:{}})):a.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:i,reason:this.serialize(r)}})),r})}serialize(t){return t?.message?t:JSON.stringify(t)}async get(t){const a=new AbortController;return la=[...la,a],this.axiosInstance.get(t,{signal:a.signal})}async post(t,a){const s=new AbortController;return la=[...la,s],this.axiosInstance.post(t,a,{signal:s.signal})}async abortAll(){la.forEach(t=>t.abort()),la=[]}async runAction(t,a,s,i,r,n,d,c,u,m,v){return a&&a.startsWith("/")&&(a=a.substring(1)),n={...Ii(),...n},await this.wrap(this.post(t+"/mateu/v3/sync/"+(a&&a!=""?a:"_no_route"),{serverSideType:d,appState:n,componentState:c,parameters:u,initiatorComponentId:r,consumedRoute:s,route:a&&a!=""?"/"+a:"",actionId:i}).then(f=>f.data),m,v,i)}}const ea=new Xd;var Qd=Object.defineProperty,Zd=Object.getOwnPropertyDescriptor,Ei=(e,t,a,s)=>{for(var i=s>1?void 0:s?Zd(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Qd(t,a,i),i};let _t=class extends _{constructor(){super(...arguments),this.baseUrl="",this.dataProvider=async(e,t)=>{const a=e.filter??"",i=await this.remoteSearch(a)??(this.selector.options??[]).filter(r=>r.label.toLowerCase().includes(a.toLowerCase()));t(i,i.length)}}connectedCallback(){super.connectedCallback(),gr()}currentValue(){return String(Ii()[this.selector.fieldName]??"")}currentLabel(){const e=this.currentValue();if(!e)return"";const t=(this.selector.options??[]).find(s=>String(s.value)===e);if(t)return t.label;const a=ns()[this.selector.fieldName];return a!==void 0?String(a):e}pick(e,t){String(e??"")!==this.currentValue()&&(br(this.selector.fieldName,e,t),window.location.reload())}async remoteSearch(e){const t=this.app;if(t?.serverSideType)try{const a=await ea.runAction(this.baseUrl??"",t.rootRoute??t.initialRoute??"","",`_appcontext-search-${this.selector.fieldName}`,`appcontext-${this.selector.fieldName}`,void 0,t.serverSideType,{},{searchText:e},this,!0);for(const s of a?.fragments??[]){const n=s.data?.[`_appcontext_${this.selector.fieldName}`]?.content;if(Array.isArray(n))return n.map(d=>({value:d.value,label:d.label??String(d.value)}))}}catch{}}renderSelect(){const e=[{label:"—",value:""},...(this.selector.options??[]).map(t=>({label:t.label,value:String(t.value)}))];return o`
            ...
            </label>`}};_t.SEARCHABLE_THRESHOLD=7;_t.styles=w`
        :host {
            display: inline-flex;
            flex-shrink: 0;
        }
    ...
    `;Va([p()],Ht.prototype,"app",2);Va([p()],Ht.prototype,"baseUrl",2);Va([b()],Ht.prototype,"opened",2);Va([b()],Ht.prototype,"notifications",2);Ht=Va([x("mateu-notification-bell")],Ht);class ic{async handle(t,a){return await t.runAction(a.baseUrl,a.route,a.consumedRoute,a.actionId,a.initiatorComponentId,a.appState,a.serverSideType,a.componentState,a.parameters,a.initiator,a.background)}}const sc=new ic;class rc{constructor(){this.mapPosition=t=>{switch(t){case"topStretch":return"top-stretch";case"topStart":return"top-start";case"topCenter":return"top-center";case"topEnd":return"top-end";case"middle":return"middle";case"bottomStart":return"bottom-start";case"bottomEnd":return"bottom-end";case"bottomStretch":return"bottom-stretch";case"bottomCenter":return"bottom-center"}return"bottom-end"},this.handleUIIncrement=(t,a,s)=>{if(t?.fragments?.forEach(i=>{gt.next({command:void 0,fragment:i,ui:void 0,error:void 0,callbackToken:s})}),t?.appState&&(Y.value={...t.appState},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))),t?.appData){const i=t?.appData;za.value={...t.appData,...i},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))}t?.messages?.forEach(i=>{jt.show(i.text,{position:i.position?this.mapPosition(i.position):void 0,theme:i.variant,duration:i.duration})}),t?.banners&&t.banners.length>0&&document.dispatchEvent(new CustomEvent("page-banners-received",{detail:{banners:t.banners,append:t.appendBanners??!1},bubbles:!1,composed:!1})),t?.commands?.forEach(i=>{gt.next({command:i,fragment:void 0,ui:void 0,error:void 0,callbackToken:s})})}}async runAction(t,a,s,i,r,n,d,c,u,m,v,f,g,y,$){try{const E=await sc.handle(t,{baseUrl:a,route:s,consumedRoute:i,actionId:r,appState:Y.value,initiatorComponentId:n,componentState:u,parameters:m,serverSideType:c,initiator:v,background:f});g&&g(E),y||this.handleUIIncrement(E,v,$),E.messages&&E.messages.length==1&&E.messages[0].variant=="error"&&v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:r,evevntId:Q()},bubbles:!0,composed:!0}))}catch(E){console.warn("Action request failed",E),v.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:r,reason:this.serialize(E)}})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))}}serialize(t){return t?.message?t:JSON.stringify(t)}}const oc=new rc;class nc{constructor(){this.mapPosition=t=>{switch(t){case"topStretch":return"top-stretch";case"topStart":return"top-start";case"topCenter":return"top-center";case"topEnd":return"top-end";case"middle":return"middle";case"bottomStart":return"bottom-start";case"bottomEnd":return"bottom-end";case"bottomStretch":return"bottom-stretch";case"bottomCenter":return"bottom-center"}return"bottom-end"},this.handleUIIncrement=(t,a,s)=>{if(t?.messages?.forEach(i=>{if(i.undoActionId){this.showUndoableMessage(i,a);return}jt.show(i.text,{position:i.position?this.mapPosition(i.position):"bottom-end",theme:i.variant,duration:i.duration})}),t?.banners&&t.banners.length>0&&document.dispatchEvent(new CustomEvent("page-banners-received",{detail:{banners:t.banners,append:t.appendBanners??!1},bubbles:!1,composed:!1})),t?.commands?.forEach(i=>{gt.next({command:i,fragment:void 0,ui:void 0,error:void 0,callbackToken:s})}),t?.fragments?.forEach(i=>{gt.next({command:void 0,fragment:i,ui:void 0,error:void 0,callbackToken:s})}),t?.appState&&(Y.value={...t.appState},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))),t?.appData){const i=t?.appData;za.value={...t.appData,...i},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))}}}async runAction(t,a,s,i,r,n,d,c,u,m,v,f,g,y,$){if(s){s=s||"_no_route",s&&s.startsWith("/")&&(s=s.substring(1));const E={serverSideType:c,appState:Y.value,componentState:u,parameters:m,initiatorComponentId:n,consumedRoute:i,route:"/"+s,actionId:r};f||v.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),fetch(a+"/mateu/v3/sse/"+s,{method:"POST",headers:{Accept:"text/event-stream","Content-Type":"application/json"},body:JSON.stringify(E)}).then(async q=>{const V=q.body?.pipeThrough(new TextDecoderStream).getReader();if(V){let C="";for(;;){const{value:A,done:G}=await V.read();if(G)break;C+=A;const X=C.split(`

`);C=X.pop()??"";for(const ae of X){const ie=ae.trim();if(ie)if(ie.startsWith("data:")){const ge=JSON.parse(ie.substring(5).trim());g&&g(ge),y||this.handleUIIncrement(ge,v,$),ge.messages&&ge.messages.length==1&&ge.messages[0].variant=="error"&&v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))}else{let ge=ie;try{const S=JSON.parse(ie);ge=S.message,S._embedded?.errors?.length>0&&S._embedded.errors[0].message&&(ge=S._embedded.errors[0].message)}catch{}throw new Error(ge)}}}}f||v.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:r}})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:r},bubbles:!0,composed:!0}))}).catch(q=>{v.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:r,reason:this.serialize(q)}})),v.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))})}}serialize(t){return t?.message?t:JSON.stringify(t)}showUndoableMessage(t,a){const s=new jt;s.position=t.position?this.mapPosition(t.position):"bottom-end",s.duration=t.duration??1e4,t.variant&&s.setAttribute("theme",t.variant),s.renderer=i=>{if(i.firstElementChild)return;const r=document.createElement("span");r.textContent=t.text;const n=document.createElement("button");n.textContent=t.undoLabel??"Undo",n.style.cssText="margin-left: 0.75rem; background: none; border: 1px solid currentColor; border-radius: var(--lumo-border-radius-s, 4px); color: inherit; cursor: pointer; padding: 0.15rem 0.6rem; font: inherit; font-weight: 600;",n.addEventListener("click",()=>{a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.undoActionId,parameters:t.undoParameters??{}},bubbles:!0,composed:!0})),s.opened=!1}),i.append(r,n)},document.body.appendChild(s),s.opened=!0,s.addEventListener("opened-changed",i=>{i.detail.value||s.remove()})}}const $r=new nc,yr=e=>{if(!e||!("querySelectorAll"in e))return null;for(const t of e.querySelectorAll("*")){if(t.tagName?.toLowerCase()==="mateu-component")return t;const a=yr(t.shadowRoot);if(a)return a}return null},xr=async(e,t,a)=>{const s=t.renderRoot??t,i=yr(s);await $r.runAction(ea,t.baseUrl??"",e.rootRoute||"_no_route","",a,i?.id??"app-header-action",{},e.serverSideType??"",{},{},i??t,!0,void 0,!1,"")},Cs=async(e,t,a)=>{try{await xr(e,t,a)}catch(s){jt.show("La acción falló: "+s,{position:"bottom-start",duration:6e3,theme:"error"})}},Ia=(e,t)=>{const a=e.contextSelectors??[],s=e.contextActions??[];return a.length===0&&s.length===0&&!e.notificationsEnabled?l:o`${e.notificationsEnabled?o`
    ...
    `:l,lc=(e,t)=>{t.filter!=e.detail.value&&(t.filter=e.detail.value)},Ss=(e,t,a)=>{const s=at(e,t,a),i=re(t,a);return s=="list"||s==i?"new":s},at=(e,t,a)=>{const s=e?._route;if(s!=null&&(s===""||s.startsWith("/"))){const i=a.homeRoute??"",r=i.indexOf("?"),n=r>=0?i.substring(r+1):"",d=re(t,a)+s;if(!n)return d;const c=d.indexOf("?")>=0?"&":"?";return d+c+n}return t.selectedRoute?t.selectedRoute:a.homeRoute},re=(e,t)=>e.selectedRoute?e.selectedConsumedRoute??t.route:t.homeConsumedRoute,Ue=(e,t)=>e.selectedRoute?e.selectedBaseUrl??e.baseUrl:t.homeBaseUrl,je=(e,t)=>e.selectedRoute?e.selectedServerSideType??t.serverSideType:t.homeServerSideType,Be=(e,t)=>e.selectedRoute?e.selectedUriPrefix:t.homeUriPrefix,dc=(e,t,a,s,i,r,n)=>{const d=e.mapItems(t.menu,e.filter?.toLowerCase()??""),c=re(e,t),u=Ss(s,e,t),m=u&&u!=="new"&&u.startsWith(c+"/")?u.substring(c.length+1).split("/")[0]:void 0;return o`
...
`:l}
                ...
                <vaadin-app-layout style="${t?.style}" class="${t?.cssClasses}" .drawerOpened=${!t.drawerClosed}>
                    ...
                    <vaadin-scroller slot="drawer" class="p-s"
                        ...
                        ${t.menu&&t.totalMenuOptions>10?o`
                            <vaadin-text-field style="width: calc(100% - 20px); padding-left: 10px; padding-right: 10px;" @value-changed="${v=>lc(v,e)}">
            ...
            <slot></slot>
       `},cc=(e,t)=>t!=null&&e!=null&&!e.has(t),uc=typeof HTMLElement<"u"?HTMLElement:class{};class pc extends uc{static get observedAttributes(){return["type","renderer"]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){const t=this.getAttribute("type")??"unknown",a=this.getAttribute("renderer")??"unknown";this.shadowRoot||this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host { display: block; }
                .mateu-unsupported {
                    box-sizing: border-box;
        ...
        `}}typeof customElements<"u"&&!customElements.get("mateu-unsupported")&&customElements.define("mateu-unsupported",pc);const Is=new Set,hc=(e,t,a)=>{const s=`${a}/${t}`;return Is.has(s)||(Is.add(s),console.warn(`[mateu] Component type "${t}" is not supported by the "${a}" renderer — rendering <mateu-unsupported> placeholder.`)),o`<mateu-unsupported
            type="${t}"
            renderer="${a}"
            data-component-id="${e?.id??l}"
            slot="${e?.slot??l}"
    ></mateu-unsupported>`};class mc{renderFilterBar(t,a,s,i,r,n,d,c){const u=a?.metadata,m=f=>{const{fieldId:g,value:y}=f.detail;t.state={...t.state,[g]:y}},v=f=>{const{fieldIds:g}=f.detail,y={};g.forEach($=>{y[$]=void 0}),y.searchText=void 0,t.state={...t.state,...y}};return o`
            <mateu-filter-bar
                .metadata="${u}"
    ...
    `;Ti([p()],ha.prototype,"position",2);Ti([p()],ha.prototype,"zoom",2);Ti([Fe("#map")],ha.prototype,"mapElement",2);ha=Ti([x("mateu-map")],ha);const kc=typeof HTMLElement<"u"?HTMLElement:class{};class _c extends kc{static get observedAttributes(){return["content"]}#e;#t=0;get content(){return this.#e}set content(t){this.#e=t,this.#a()}attributeChangedCallback(t,a,s){this.content=s??void 0}connectedCallback(){this.style.display="block",this.#a()}async#a(){if(!this.isConnected)return;const t=this.#e??"",a=++this.#t,[{marked:s},{default:i}]=await Promise.all([ue(()=>import("./vendor.js").then(r=>r.f),[]),ue(()=>import("./vendor.js").then(r=>r.c),[])]);a===this.#t&&(this.innerHTML=i.sanitize(await s.parse(t),{USE_PROFILES:{html:!0,svg:!0,svgFilters:!0},CUSTOM_ELEMENT_HANDLING:{tagNameCheck:r=>!0}}))}}typeof customElements<"u"&&!customElements.get("mateu-markdown")&&customElements.define("mateu-markdown",_c);var Cc=Object.defineProperty,Sc=Object.getOwnPropertyDescriptor,Wa=(e,t,a,s)=>{for(var i=s>1?void 0:s?Sc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Cc(t,a,i),i};let Wt=class extends _{constructor(){super(...arguments),this.fieldId="",this.signing=!1,this.hasStrokes=!1,this.drawing=!1,this.startStroke=e=>{const t=e.target;this.ensureCanvasSize(t),t.setPointerCapture(e.pointerId),this.drawing=!0;const a=t.getContext("2d");a.lineWidth=2,a.lineCap="round",a.lineJoin="round",a.strokeStyle=getComputedStyle(this).getPropertyValue("--lumo-body-text-color")||"#1a1a1a";const[s,i]=this.pointerPosition(e);a.beginPath(),a.moveTo(s,i),e.preventDefault()},this.stroke=e=>{if(!this.drawing)return;const a=e.target.getContext("2d"),[s,i]=this.pointerPosition(e);a.lineTo(s,i),a.stroke(),this.hasStrokes=!0,e.preventDefault()},this.endStroke=e=>{this.drawing=!1,e.target.releasePointerCapture(e.pointerId)}}emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e,fieldId:this.fieldId},bubbles:!0,composed:!0}))}canvas(){return this.renderRoot.querySelector("canvas")}pointerPosition(e){const a=e.target.getBoundingClientRect();return[e.clientX-a.left,e.clientY-a.top]}ensureCanvasSize(e){const t=e.getBoundingClientRect();(e.width!==Math.round(t.width)||e.height!==Math.round(t.height))&&(e.width=Math.round(t.width),e.height=Math.round(t.height))}clear(){const e=this.canvas();e&&e.getContext("2d").clearRect(0,0,e.width,e.height),this.hasStrokes=!1}accept(){const e=this.canvas();!e||!this.hasStrokes||(this.signing=!1,this.emit(e.toDataURL("image/png")))}renderPad(){return o`
            <canvas class="pad"
    ...
    `;Ga([p()],Gt.prototype,"fieldId",2);Ga([p()],Gt.prototype,"value",2);Ga([b()],Gt.prototype,"cameraOpen",2);Ga([b()],Gt.prototype,"cameraError",2);Gt=Ga([x("mateu-camera-capture")],Gt);var Oc=Object.defineProperty,Rc=Object.getOwnPropertyDescriptor,Ka=(e,t,a,s)=>{for(var i=s>1?void 0:s?Rc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Oc(t,a,i),i};const kr=(e,t)=>{if(!e)return;if(Array.isArray(e)){const s=e.find(i=>i.key==t);return s?.value!=null?String(s.value):void 0}const a=e[t];return a!=null?String(a):void 0};let Ct=class extends _{constructor(){super(...arguments),this.fieldId="",this.editable=!0,this.filePicked=e=>{const t=e.target,a=t.files?.[0];if(!a)return;const s=new FileReader;s.onload=()=>{const i=s.result,r=i.indexOf(","),n=i.substring(0,r).replace(";base64",`;name=${encodeURIComponent(a.name)};base64`);this.emit(n+i.substring(r))},s.readAsDataURL(a),t.value=""}}static fileName(e){if(!e)return"";if(e.startsWith("data:")){const t=e.indexOf(","),s=e.substring(5,t<0?e.length:t).split(";").find(i=>i.startsWith("name="));if(s)try{return decodeURIComponent(s.substring(5))}catch{return s.substring(5)}return"Attached file"}return e.split("/").pop()||e}emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e,fieldId:this.fieldId},bubbles:!0,composed:!0}))}triggerPick(){this.renderRoot.querySelector("input[type=file]")?.click()}render(){const e=this.value!=null&&this.value!=="",t=Ct.fileName(this.value),a=e&&this.value.startsWith("data:"),s=e?o`<span class="file" title="${t}">📄 ${a?o`<a href="${this.value}" download="${t}">${t}</a>`:o`<a href="${this.value}" target="_blank">${t}</a>`}</span>`:l;return this.editable?o`
            ...
            </div>`:o`${e?s:o`<span class="empty">—</span>`}`}};Ct.styles=w`
        :host {
            display: block;
        }
        .row {
    ...
    `;Ka([p()],Ct.prototype,"fieldId",2);Ka([p()],Ct.prototype,"value",2);Ka([p()],Ct.prototype,"accept",2);Ka([p({type:Boolean})],Ct.prototype,"editable",2);Ct=Ka([x("mateu-file-upload")],Ct);var zc=Object.defineProperty,Lc=Object.getOwnPropertyDescriptor,At=(e,t,a,s)=>{for(var i=s>1?void 0:s?Lc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&zc(t,a,i),i};const Dc=()=>{let e=document.activeElement;for(;e?.shadowRoot?.activeElement;)e=e.shadowRoot.activeElement;return e},Ac=(e,t)=>{let a=t;for(;a;){if(a===e)return!0;a=a.assignedSlot??a.parentNode??a.host??null}return!1};let Ye=class extends Ha{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={},this.detailsOpenedItems=[],this.hoveredItem=null,this.onGridHoverMove=e=>{const t=e.currentTarget,a=t.getEventContext(e)?.item??null;a!==this.hoveredItem&&(this.hoveredItem=a,t.generateCellPartNames())},this.onGridHoverLeave=e=>{this.hoveredItem!==null&&(this.hoveredItem=null,e.currentTarget.generateCellPartNames())},this.hoverCellPartNameGenerator=(e,t)=>t?.item!=null&&t.item===this.hoveredItem?"hovered-cell":"",this._onRowKey=e=>{const t=this.field?.rowSelectionShortcut;if(!t||!this.field?.onItemSelectionActionId||!this._isRowShortcutRelevant()||!Zs(t,e))return;const a=/^(?:Digit|Numpad)([1-9])$/.exec(e.code);if(!a)return;const s=this.currentItems(),i=parseInt(a[1],10)-1;i>=s.length||(e.preventDefault(),this.selectRow(s[i]))},this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._onRowKey)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._onRowKey)}currentItems(){return this.field?.remoteCoordinates?this.data?.[this.id]?.content??[]:this.field?.fieldId&&this.state?this.state[this.field.fieldId]??[]:[]}selectRow(e){!e||!this.field?.onItemSelectionActionId||(this.selectedItems=[e],this.state[this.id+"_selected_items"]=[e],this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.field.onItemSelectionActionId,parameters:{_clickedRow:e}},bubbles:!0,composed:!0})))}_isRowShortcutRelevant(){if(this.offsetParent===null&&this.getClientRects().length===0)return!1;const e=Dc();if(e&&e!==document.body&&!Ac(this,e)){const t=e.tagName?.toLowerCase()??"";if(e.isContentEditable||/^(input|textarea|select)$/.test(t)||t.startsWith("vaadin-")&&/(field|combo|picker|area|select)/.test(t))return!1}return!0}handleItemToggle(e){const{item:t,selected:a,shiftKey:s}=e.detail;if(this.rangeStartItem??=t,s){let i=[];this.field?.fieldId&&this.state&&this.state[this.field.fieldId]&&(i=this.state[this.field.fieldId]);const[r,n]=[this.rangeStartItem,t].map(u=>i.indexOf(u)).sort((u,m)=>u-m),d=i.slice(r,n+1),c=new Set(this.selectedItems);d.forEach(u=>{a?c.add(u):c.delete(u)}),this.selectedItems=[...c],this.state[this.id+"_selected_items"]=this.selectedItems}this.rangeStartItem=t}render(){let e=[];this.field?.fieldId&&this.state&&this.state[this.field.fieldId]&&(e=this.state[this.field.fieldId]);const t=this.state[this.field?.fieldId+"_show_detail"]||this.state._show_detail&&this.state._show_detail[this.field.fieldId];if(this.field?.remoteCoordinates){const a=this.field.remoteCoordinates,s="";this.data[this.id]&&(this.data[this.id].searchSignature||s)&&this.data[this.id].searchSignature!=s&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements?e=this.data[this.id].content:this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a.action,parameters:{searchText:s,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0}))}if(Array.isArray(e)&&e.forEach((a,s)=>{a&&typeof a=="object"&&a._rowNumber===void 0&&(a._rowNumber=s)}),this.field?.inlineEditing)return this.renderMaster(e);if(this.field?.formPosition&&this.field?.formPosition.startsWith("modal")){const a=this;return o`
            ...
            <vaadin-grid
                    ...
                    ${P(this.field?.detailPath?Bs(a=>o`${k(this,a[this.field?.detailPath],this.baseUrl,this.state,this.data,this.appState,this.appData)}`):void 0)}
    ...
    `;At([p()],Ye.prototype,"field",2);At([p()],Ye.prototype,"state",2);At([p()],Ye.prototype,"data",2);At([p()],Ye.prototype,"appState",2);At([p()],Ye.prototype,"appData",2);At([p()],Ye.prototype,"selectedItems",2);At([b()],Ye.prototype,"detailsOpenedItems",2);Ye=At([x("mateu-grid")],Ye);var Fc=Object.defineProperty,Nc=Object.getOwnPropertyDescriptor,wa=(e,t,a,s)=>{for(var i=s>1?void 0:s?Nc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Fc(t,a,i),i};let St=class extends _{constructor(){super(...arguments),this.getNewValue=e=>{if(this.field?.dataType=="array"){if(!this.value)return[e];const t=this.value;return t.indexOf(e)>=0?t.filter(a=>a!==e):[...t,e]}return e}}render(){let e=this.field?.options;if(this.field?.remoteCoordinates){const a=this.field.remoteCoordinates;this.data?.[this.field.fieldId]&&this.data[this.field.fieldId].content&&this.data[this.field.fieldId].totalElements?e=this.data[this.field.fieldId].content:this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a.action,parameters:{searchText:"",fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0}))}const t=this.field?.attributes?.divStyle;return o`
  ...
  `;wa([p()],St.prototype,"field",2);wa([p()],St.prototype,"baseUrl",2);wa([p()],St.prototype,"state",2);wa([p()],St.prototype,"data",2);wa([p()],St.prototype,"value",2);St=wa([x("mateu-choice")],St);var Mc=Object.defineProperty,qc=Object.getOwnPropertyDescriptor,Qe=(e,t,a,s)=>{for(var i=s>1?void 0:s?qc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Mc(t,a,i),i};let we=class extends _{constructor(){super(...arguments),this.currencyChanged=e=>{this.value||(this.value={value:0,currency:"EUR",locale:"es-ES"}),this.value.currency=e.detail.value,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:{...this.value},fieldId:this.fieldId}}))},this.valueChanged=e=>{this.value||(this.value={value:0,currency:"EUR",locale:"es-ES"}),e.detail.value&&(this.value.value=e.detail.value?parseFloat(e.detail.value):0,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:{...this.value},fieldId:this.fieldId}})))}}render(){return o`
            <vaadin-number-field
                    id="${this.fieldId}"
                    label="${this.label}"
...
`,this.filteredIcons=[],this.navLinkOffset=null,this.iconFilterChanged=e=>{this.filteredIcons=Ps.filter(t=>!e.detail.value||t.indexOf(e.detail.value)>=0)}}remoteComboDataProvider(e){return(t,a)=>{const{filter:s,page:i,pageSize:r}=t,n=s??"";this._comboFilter=n,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e,parameters:{searchText:s,fieldId:this.field?.fieldId,size:r,page:i,sort:void 0},callback:d=>{if(n===this._comboFilter)if(d?.messages?.forEach(c=>{jt.show(c.text,{position:c.position?this.mapPosition(c.position):void 0,theme:c.variant,duration:c.duration})}),!d.fragments||d.fragments.length==0)this.comboData=[],a([],0);else{const c=d.fragments[0].data?.[this.id];this.comboData=c?.content,a(c?.content,c?.totalElements)}},callbackonly:!0},bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.rendered=!1}renderNavLink(){const e=this.field?.link;if(!e?.href)return l;const t=Re(e.href,this.state,this.data)??e.href,a=Re(e.title,this.state,this.data)||t,s=e.icon||(t.startsWith("http")?"vaadin:external-link":"vaadin:link"),i=this.navLinkOffset??"calc(var(--lumo-font-size-s) * 1.6 + (var(--lumo-size-m) - var(--lumo-icon-size-s)) / 2)";return o`<a
        ...
        ><vaadin-icon icon="${s}" style="width: var(--lumo-icon-size-s); height: var(--lumo-icon-size-s);"></vaadin-icon></a>`}positionNavLink(){const e=this.renderRoot?.querySelector("a[data-navlink]");e&&setTimeout(()=>{const t=e.parentElement,a=t?.firstElementChild?.firstElementChild;if(!t||!a)return;const i=(a.shadowRoot?.querySelector('[part="input-field"]')??a).getBoundingClientRect();if(i.height===0)return;const r=Math.max(0,i.top+i.height/2-e.offsetHeight/2-t.getBoundingClientRect().top),n=`${Math.round(r)}px`;this.navLinkOffset!==n&&(this.navLinkOffset=n)})}helperText(){return this.helperShownInControl=!0,Ve(this.field?.description??"",this.state,this.data)??""}render(){const e=this.field?.fieldId??"";this.rendered=!0;const t=this.renderNavLink();this.helperShownInControl=!1;const a=this.renderField(),s=this.field?.description&&!this.helperShownInControl?Ve(this.field.description,this.state,this.data):void 0;return o`<div style="display: block;">
            ...
            >${v?o`<span style="color: var(--lumo-secondary-text-color, #888); white-space: nowrap;">${s}</span>`:l}${m}</div>`}renderBulletedListField(e,t,a,s){if(!this.field)return o``;const i=Ve(t,this.state,this.data),r=Array.isArray(i)?i.map(n=>String(n)):i!=null&&i!==""?[String(i)]:[];return o`<vaadin-custom-field
                    id="${this.field.fieldId}"
                    label="${a}"
                    .helperText="${this.helperText()}"
                    data-colspan="${this.field?.colspan}"
...
`}renderFileField(e,t,a,s){if(!this.field)return o``;const i=t?.map(r=>({id:r.id,name:r.name,type:"",uploadTarget:"",complete:!0}))??[];return o`
  ...
  ${yi(this.renderColorPicker,[])}
  ${Ji(this.renderColorPickerFooter,[])}
></vaadin-dialog>
                `:o`
                <vaadin-text-field
                        id="${this.field.fieldId}"
...
`;if(this.field?.stereotype=="listBox"){if(this.field?.remoteCoordinates){const i=this.field.remoteCoordinates,r="";return this.data[this.id]&&(this.data[this.id].searchSignature||r)&&this.data[this.id].searchSignature!=r&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements||this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:i.action,parameters:{searchText:r,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0})),o`
            ...
            ></mateu-money-field>`}renderStatusField(e,t,a,s){if(!this.field)return o``;const i=t;return o`
                <vaadin-custom-field
                        ...
                        data-colspan="${this.field.colspan}"
                >
                    ${i?o`<span theme="badge pill ${ki(i.type)}">${i.message}</span>`:o``}                    
                </vaadin-custom-field>
  ...
  `;ve([p()],ee.prototype,"component",2);ve([p()],ee.prototype,"field",2);ve([p()],ee.prototype,"baseUrl",2);ve([p()],ee.prototype,"state",2);ve([p()],ee.prototype,"data",2);ve([p()],ee.prototype,"appState",2);ve([p()],ee.prototype,"appData",2);ve([p()],ee.prototype,"labelAlreadyRendered",2);ve([b()],ee.prototype,"colorPickerOpened",2);ve([b()],ee.prototype,"colorPickerValue",2);ve([b()],ee.prototype,"filteredIcons",2);ve([b()],ee.prototype,"navLinkOffset",2);ee=ve([x("mateu-field")],ee);var Bc=Object.defineProperty,Vc=Object.getOwnPropertyDescriptor,aa=(e,t,a,s)=>{for(var i=s>1?void 0:s?Vc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Bc(t,a,i),i};const Hc=e=>{const t=[];return e.color&&e.color!=="normal"&&e.color!=="none"&&t.push(e.color),e.buttonStyle&&t.push(e.buttonStyle==="tertiaryInline"?"tertiary-inline":e.buttonStyle),e.size&&e.size!=="none"&&e.size!=="normal"&&t.push(e.size),t.length?t.join(" "):void 0},Ts=e=>e==="back"||e==="backToList"||!!e&&e.startsWith("cancel");let nt=class extends _{constructor(){super(...arguments),this.appState={},this.appData={},this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.evalLabel=e=>Re(e,this.state,this.data),this.renderBtn=e=>{if((this.data??{})[e.actionId+".hidden"])return l;const t=this.evalLabel(e.label),a=W.get()?.renderToolbarButton?.(e,t,()=>this.handleButtonClick(e.actionId));return a||o`
        <vaadin-button
                data-action-id="${e.id}"
                theme="${Hc(e)||l}"
    ...
    `}}render(){const e=this.metadata;if(!e)return o``;const t=e.toolbar??[],a=t.filter(d=>Ts(d.actionId)),s=t.filter(d=>!Ts(d.actionId)),i=a.length>0&&s.length>0?o`<span class="toolbar-divider"></span>`:l,r=e.avatar||e.title||e.subtitle||e.kpis?.length>0||e.header?.length>0||t.length>0,n=e.level??0;return n>0?this.setAttribute("data-nested",""):this.removeAttribute("data-nested"),o`
        ...
        ${Tt}
    `;aa([p()],nt.prototype,"metadata",2);aa([p()],nt.prototype,"baseUrl",2);aa([p()],nt.prototype,"state",2);aa([p()],nt.prototype,"data",2);aa([p()],nt.prototype,"appState",2);aa([p()],nt.prototype,"appData",2);nt=aa([x("mateu-content-header")],nt);var Wc=Object.defineProperty,Gc=Object.getOwnPropertyDescriptor,Ya=(e,t,a,s)=>{for(var i=s>1?void 0:s?Gc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Wc(t,a,i),i};let Kt=class extends Ha{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={}}render(){const e=this.component?.metadata;return o`
    ...
    `;Ya([p()],Kt.prototype,"state",2);Ya([p()],Kt.prototype,"data",2);Ya([p()],Kt.prototype,"appState",2);Ya([p()],Kt.prototype,"appData",2);Kt=Ya([x("mateu-form")],Kt);var Kc=Object.defineProperty,Yc=Object.getOwnPropertyDescriptor,Ne=(e,t,a,s)=>{for(var i=s>1?void 0:s?Yc(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Kc(t,a,i),i};let he=class extends _{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.detailsOpenedItems=[],this.pagesRequested=[],this.emptyArray=e=>!e||e.length==0,this.dataProvider=(e,t)=>{const a=this.data[this.id]?.page;if(this.metadata?.infiniteScrolling&&e.page>0){let s=!1;a&&a.content&&(a.content.length>=(e.page+1)*e.pageSize||a.content.length==a.totalElements)&&(t(a.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),a.totalElements),s=!0,this.grid&&this.grid.recalculateColumnWidths()),s||this.pagesRequested.find(i=>i==e.page)||(this.pagesRequested.push(e.page),this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:e,callback:()=>{this.data[this.id]?.page?.content&&(t(this.data[this.id].page.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),this.data[this.id].page.totalElements),this.grid&&this.grid.recalculateColumnWidths())}},bubbles:!0,composed:!0})))}else{const s=this.metadata?.infiniteScrolling?a?.totalElements:a?.content?.length??0;t(a?.content??[],s),this.grid&&this.grid.recalculateColumnWidths()}},this._onActionRequested=e=>{const t=e.detail,a=this.identifierFieldName;if(!a||!t.parameters||t.actionId?.startsWith("action-on-row-"))return;const s=t.parameters[a];s!==void 0&&(this.state._selectedId=String(s),this._applyCellPartNameGenerator(),this.grid?.requestContentUpdate())},this.tooltipGenerator=e=>{let t="";const{column:a,item:s}=e,i=this.metadata?.columns?.find(r=>r.metadata.id==a?.path);if(i?.metadata){const r=(i?.metadata).tooltipPath;r&&a&&s&&(t=s[r])}return t}}get identifierFieldName(){const e=this.metadata?.columns?.find(a=>a.metadata?.identifier);if(e)return e.metadata?.id;if(this.metadata?.columns?.find(a=>a.metadata?.id==="id"))return"id"}_applyCellPartNameGenerator(){if(!this.grid)return;const e=this.identifierFieldName,t=this.state?._selectedId??this.appState?._splitDetailId,a=!!this.metadata?.groupBy;e&&t!==void 0||a?this.grid.cellPartNameGenerator=(s,i)=>{const r=i.item;return Oa(r)?"mateu-group-row":e&&t!==void 0&&String(r[e])===String(t)?"selected-row":""}:this.grid.cellPartNameGenerator=null}connectedCallback(){super.connectedCallback(),this.addEventListener("action-requested",this._onActionRequested)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("action-requested",this._onActionRequested)}updated(e){super.updated(e),this._applyCellPartNameGenerator(),this.grid?.clearCache(),this.grid?.requestContentUpdate(),this.grid?.recalculateColumnWidths(),this.pagesRequested=[]}render(){const e=this.data[this.id],t=e?.page,a=this.metadata?.groupBy,s=this.metadata?.infiniteScrolling?void 0:t?.content?Gs(t.content,a,e?.groups):t?.content,i=(this.metadata?.columns??[]).flatMap(c=>c.metadata?.type===h.GridGroupColumn?(c.metadata.columns??[]).map(u=>u.metadata):[c.metadata]),r=Xs(i,e,a);let n="";this.metadata?.wrapCellContent&&(n+=" wrap-cell-content"),this.metadata?.compact&&(n+=" compact"),this.metadata?.noBorder&&(n+=" no-border"),this.metadata?.noRowBorder&&(n+=" no-row-borders"),this.metadata?.columnBorders&&(n+=" column-borders"),this.metadata?.rowStripes&&(n+=" row-stripes");const d=this.state[this.id+"_selected_items"]||[];return o`
            <vaadin-grid
                    ...
                    @active-item-changed="${P(this.metadata?.detailPath&&!this.metadata?.useButtonForDetail?c=>{if(this.metadata?.detailPath){const u=c.detail.value;if(u&&Oa(u))return;u?this.detailsOpenedItems=[u]:this.detailsOpenedItems=[]}}:void 0)}"
                    .detailsOpenedItems="${this.detailsOpenedItems}"
                    ${P(this.metadata?.detailPath?Bs(c=>o`${k(this,c[this.metadata?.detailPath],this.baseUrl,this.state,this.data,this.appState,this.appData)}`):void 0)}
                    theme="${n}"
  ...
  `;Ne([p()],he.prototype,"id",2);Ne([p()],he.prototype,"metadata",2);Ne([p()],he.prototype,"baseUrl",2);Ne([p()],he.prototype,"state",2);Ne([p()],he.prototype,"data",2);Ne([p()],he.prototype,"appState",2);Ne([p()],he.prototype,"appData",2);Ne([p()],he.prototype,"emptyStateMessage",2);Ne([b()],he.prototype,"detailsOpenedItems",2);Ne([Fe("vaadin-grid")],he.prototype,"grid",2);he=Ne([x("mateu-table")],he);const _r="mateu-saved-views",Oi=()=>{try{return JSON.parse(localStorage.getItem(_r)??"{}")}catch{return{}}},ls=e=>{try{localStorage.setItem(_r,JSON.stringify(e))}catch{}},Cr=e=>Oi()[e]??[],Jc=(e,t)=>{const a=t.name?.trim();if(!a||Object.keys(t.values??{}).length===0)return;const s=Oi(),i=(s[e]??[]).filter(r=>r.name!==a);i.push({...t,name:a}),s[e]=i,ls(s)},Xc=(e,t)=>{const a=Oi(),s=(a[e]??[]).filter(i=>i.name!==t);s.length===0?delete a[e]:a[e]=s,ls(a)},Qc=(e,t)=>{const a=Oi();a[e]=(a[e]??[]).map(s=>({...s,isDefault:s.name===t?!s.isDefault:!1})),ls(a)},Zc=e=>Cr(e).find(t=>t.isDefault);var eu=Object.defineProperty,tu=Object.getOwnPropertyDescriptor,Se=(e,t,a,s)=>{for(var i=s>1?void 0:s?tu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&eu(t,a,i),i};let ne=class extends _{constructor(){super(...arguments),this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.searchOnly=!1,this.panelOpened=!1,this.viewsOpened=!1,this.draftText="",this.openPanel=()=>{this.panelOpened||this.filters.length===0||(this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick))},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1,this.activeFilter=void 0},this.clearAllFilters=()=>{const e=this.filters.flatMap(a=>this.isRangeFilter(a)?[`${a.fieldId}_from`,`${a.fieldId}_to`]:[a.fieldId]),t={searchText:void 0};e.forEach(a=>{t[a]=void 0}),this.state={...this.state,...t},this.dispatchEvent(new CustomEvent("filter-reset-requested",{detail:{fieldIds:e},bubbles:!0,composed:!0})),this.requestSearch()},this.keepFocus=e=>e.preventDefault()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}get filters(){return this.metadata?.filters??[]}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}requestSearch(){this.closePanel(),this.dispatchEvent(new CustomEvent("search-requested",{detail:{},bubbles:!0,composed:!0}))}emitValueChanged(e,t){this.state={...this.state,[e]:t},this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t,fieldId:e},bubbles:!0,composed:!0}))}applyFilter(e,t){this.emitValueChanged(e,t),this.requestSearch()}removeChip(e){const t=this.filters.find(a=>a.fieldId===e);t&&this.isRangeFilter(t)?(this.emitValueChanged(`${e}_from`,void 0),this.emitValueChanged(`${e}_to`,void 0)):this.emitValueChanged(e,e==="searchText"?"":void 0),this.requestSearch()}commitText(e){this.emitValueChanged("searchText",e.value),this.draftText="",e.value="",this.requestSearch()}get viewsScope(){return window.location.pathname}allFilterKeys(){return["searchText",...this.filters.flatMap(e=>this.isRangeFilter(e)?[`${e.fieldId}_from`,`${e.fieldId}_to`]:[e.fieldId])]}snapshotValues(){const e={};return this.state.searchText&&(e.searchText=this.state.searchText),this.filters.forEach(t=>{if(this.isSet(t))if(this.isRangeFilter(t)){const a=this.rangeBound(t,"from"),s=this.rangeBound(t,"to");a&&(e[`${t.fieldId}_from`]=a),s&&(e[`${t.fieldId}_to`]=s)}else this.isMultiFilter(t)?e[t.fieldId]=this.multiValues(t):e[t.fieldId]=this.state[t.fieldId]}),e}applyView(e){const t=this.allFilterKeys(),a={};t.forEach(s=>{a[s]=void 0}),this.state={...this.state,...a},this.dispatchEvent(new CustomEvent("filter-reset-requested",{detail:{fieldIds:t},bubbles:!0,composed:!0})),Object.entries(e.values).forEach(([s,i])=>this.emitValueChanged(s,i)),this.viewsOpened=!1,this.detachOutsideClick(),this.requestSearch()}saveCurrentView(e){const t=e.value.trim();t&&(Jc(this.viewsScope,{name:t,values:this.snapshotValues()}),e.value="",this.requestUpdate())}firstUpdated(){if(window.location.search)return;const e=Zc(this.viewsScope);e&&setTimeout(()=>{this.state.searchText||this.filters.some(a=>this.isSet(a))||this.applyView(e)},0)}isBooleanFilter(e){return e.dataType==="boolean"||e.dataType==="bool"||e.stereotype==="checkbox"||e.stereotype==="toggle"}isNumericFilter(e){return["integer","decimal","number","money"].includes(e.dataType??"")}isRangeFilter(e){return e.stereotype==="dateRange"||e.stereotype==="numberRange"}isMultiFilter(e){return e.stereotype==="multiSelect"}hasOptions(e){return(e.options?.length??0)>0}multiValues(e){const t=this.state[e.fieldId];return Array.isArray(t)?t.map(String):typeof t=="string"&&t!==""?t.split(",").map(a=>a.trim()).filter(a=>a):[]}rangeBound(e,t){const a=this.state[`${e.fieldId}_${t}`];return a==null?"":String(a)}isSet(e){if(this.isRangeFilter(e))return this.rangeBound(e,"from")!==""||this.rangeBound(e,"to")!=="";if(this.isMultiFilter(e))return this.multiValues(e).length>0;const t=this.state[e.fieldId];return t!=null&&t!==""&&!Number.isNaN(t)}getFilterDisplayValue(e,t){if(e.options?.length){const a=e.options.find(s=>s.value===String(t));if(a)return a.label??a.value}return typeof t=="boolean"?t?"Yes":"No":String(t)}conditionDisplay(e){if(this.isRangeFilter(e)){const t=this.rangeBound(e,"from"),a=this.rangeBound(e,"to");return t&&a?`${t} – ${a}`:t?`≥ ${t}`:`≤ ${a}`}return this.isMultiFilter(e)?this.multiValues(e).map(t=>this.getFilterDisplayValue(e,t)).join(", "):this.getFilterDisplayValue(e,this.state[e.fieldId])}labelOf(e){return Re(e.label,this.state,this.data)||e.fieldId}panelRow(e,t,a="panel-row"){return o`
                ...
                ${e.map(a=>o`
                    <div class="panel-row view-row" @mousedown="${this.keepFocus}">
                        ...
                        <button class="chip-remove" aria-label="Delete view ${a.name}"
                                @click="${()=>{Xc(this.viewsScope,a.name),this.requestUpdate()}}">✕</button>
                    </div>`)}
                ${t?o`
    ...
    `;Se([p()],ne.prototype,"metadata",2);Se([p()],ne.prototype,"baseUrl",2);Se([b()],ne.prototype,"state",2);Se([b()],ne.prototype,"data",2);Se([p()],ne.prototype,"appState",2);Se([p()],ne.prototype,"appData",2);Se([p({type:Boolean})],ne.prototype,"searchOnly",2);Se([b()],ne.prototype,"panelOpened",2);Se([b()],ne.prototype,"viewsOpened",2);Se([b()],ne.prototype,"activeFilter",2);Se([b()],ne.prototype,"draftText",2);ne=Se([x("mateu-filter-bar")],ne);const Sr="mateu-column-prefs",ds=()=>{try{const e=JSON.parse(localStorage.getItem(Sr)??"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}},Ir=e=>{try{localStorage.setItem(Sr,JSON.stringify(e))}catch{}},cs=e=>{if(!e||typeof e!="object")return;const t=a=>Array.isArray(a)?a.filter(s=>typeof s=="string"):[];return{hidden:t(e.hidden),order:t(e.order)}},Er=e=>cs(ds()[e]),au=(e,t)=>{const a=ds(),s=cs(t);s.hidden.length===0&&s.order.length===0?delete a[e]:a[e]=s,Ir(a)},iu=e=>{const t=ds();delete t[e],Ir(t)},Pr=e=>e?!!e.identifier||e.dataType==="action"||e.dataType==="actionGroup"||e.dataType==="menu"||e.id==="select"||e.id==="menu":!1,Tr=(e,t,a=s=>s)=>{const s=cs(t);if(!s||s.hidden.length===0&&s.order.length===0)return e;const i=v=>a(v)?.id??v.id,r=new Set(s.hidden),n=e.filter(v=>{const f=i(v);return!f||!r.has(f)||Pr(a(v))});if(s.order.length===0)return n.length===e.length?e:n;const d=new Map;n.forEach(v=>{const f=i(v);f&&!d.has(f)&&d.set(f,v)});const c=[],u=new Set;return s.order.forEach(v=>{const f=d.get(v);f&&!u.has(f)&&(c.push(f),u.add(f))}),n.forEach(v=>{u.has(v)||(c.push(v),u.add(v))}),c.length===e.length&&c.every((v,f)=>v===e[f])?e:c};var su=Object.defineProperty,ru=Object.getOwnPropertyDescriptor,Ja=(e,t,a,s)=>{for(var i=s>1?void 0:s?ru(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&su(t,a,i),i};let Yt=class extends _{constructor(){super(...arguments),this.columns=[],this.scope="",this.panelOpened=!1,this.revision=0,this.togglePanel=()=>{if(this.panelOpened){this.closePanel();return}this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick)},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1},this.reset=()=>{iu(this.scope),this.revision++,this.dispatchEvent(new CustomEvent("column-prefs-changed",{bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}get prefs(){return Er(this.scope)??{hidden:[],order:[]}}effectiveEntries(e){return Tr(this.columns,{hidden:[],order:e.order})}commit(e){au(this.scope,e),this.revision++,this.dispatchEvent(new CustomEvent("column-prefs-changed",{bubbles:!0,composed:!0}))}toggleVisibility(e){const t=this.prefs,a=t.hidden.includes(e)?t.hidden.filter(s=>s!==e):[...t.hidden,e];this.commit({...t,hidden:a})}move(e,t){const a=this.prefs,s=[...this.effectiveEntries(a)],i=s.findIndex(d=>d.id===e);if(i<0)return;let r=i+t;for(;r>=0&&r<s.length&&s[r].protected;)r+=t;if(r<0||r>=s.length)return;const n=s[i];s[i]=s[r],s[r]=n,this.commit({...a,order:s.map(d=>d.id)})}render(){this.revision;const e=this.prefs,t=this.effectiveEntries(e).filter(s=>!s.protected);if(t.length===0)return o``;const a=e.hidden.length>0||e.order.length>0;return o`
            <div class="chooser">
                <button
    ...
    `;Ja([p()],Yt.prototype,"columns",2);Ja([p()],Yt.prototype,"scope",2);Ja([b()],Yt.prototype,"panelOpened",2);Ja([b()],Yt.prototype,"revision",2);Yt=Ja([x("mateu-column-chooser")],Yt);var ou=Object.defineProperty,nu=Object.getOwnPropertyDescriptor,Xa=(e,t,a,s)=>{for(var i=s>1?void 0:s?nu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ou(t,a,i),i};let Jt=class extends _{constructor(){super(...arguments),this.totalElements=0,this.pageSize=100,this.pageNumber=0,this.totalPages=0}updated(e){super.updated(e),(e.has("totalElements")||e.has("pageSize"))&&(this.totalPages=Math.ceil(this.totalElements/this.pageSize))}dispatch(e){this.dispatchEvent(new CustomEvent("page-changed",{bubbles:!0,composed:!0,detail:{page:e}}))}render(){if(!this.totalElements)return l;const e=this.totalPages>1,t=this.pageNumber,a=t===0,s=t>=this.totalPages-1;return o`
    ...
    `;Xa([p()],Jt.prototype,"totalElements",2);Xa([p()],Jt.prototype,"pageSize",2);Xa([p()],Jt.prototype,"pageNumber",2);Xa([b()],Jt.prototype,"totalPages",2);Jt=Xa([x("mateu-pagination")],Jt);var lu=Object.defineProperty,du=Object.getOwnPropertyDescriptor,Ie=(e,t,a,s)=>{for(var i=s>1?void 0:s?du(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&lu(t,a,i),i};let le=class extends _{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.dataProvider=(e,t)=>{const a=this.data[this.id]?.page;t(a?.content??[],a?.content?.length??0)},this.respondToVisibility=(e,t)=>{var a={root:document.documentElement},s=new IntersectionObserver(i=>{i.forEach(r=>{t(r.intersectionRatio>0)})},a);s.observe(e)},this.keepAsking=!1,this.askToUpper=()=>{const e=this.data[this.id]?.page,t=e?.content?.length/e?.pageSize;this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:{page:t,pageSize:this.metadata?.pageSize},callback:()=>{this.keepAsking&&this.askToUpper()}},bubbles:!0,composed:!0}))},this.renderItem=e=>e.card?rs(this,e.card,this.baseUrl,this.state,this.data,this.appState,this.appData,!1):e.title?o`<vaadin-card
        >
                ...
                `:l}
                ${e.status?o`
                    <span slot="header-suffix" theme="badge ${ki(e.status.type)}">${e.status.message}</span>
                `:l}
                ${e.image?o`
    ...
    `;Ie([p()],le.prototype,"id",2);Ie([p()],le.prototype,"metadata",2);Ie([p()],le.prototype,"baseUrl",2);Ie([p()],le.prototype,"state",2);Ie([p()],le.prototype,"data",2);Ie([p()],le.prototype,"appState",2);Ie([p()],le.prototype,"appData",2);Ie([p()],le.prototype,"emptyStateMessage",2);Ie([b()],le.prototype,"keepAsking",2);Ie([Fe("#ask-for-more")],le.prototype,"askForMore",2);Ie([b()],le.prototype,"hasMore",2);le=Ie([x("mateu-card-list")],le);var Or=(e=>(e.none="none",e.success="success",e.error="error",e.warning="warning",e.contrast="contrast",e.normal="normal",e))(Or||{}),Rr=(e=>(e.primary="primary",e.secondary="secondary",e.tertiary="tertiary",e.tertiaryInline="tertiaryInline",e))(Rr||{});const cu=76;function Os(e){if(e.weight!=null)return e.weight;const t=e.stereotype??"";if(t==="icon")return 1;if(t==="image")return 4;if(t==="html"||t==="richText"||t==="markdown"||t==="textarea")return 5;if(t==="link")return 2.5;if(t==="combobox"||t==="select")return 2;const a=e.dataType??"";return a==="bool"?1:a==="status"||a==="integer"?1.5:a==="number"||a==="date"||a==="money"?2:a==="dateTime"||a==="dateRange"?2.5:3}function uu(e,t){if(e.length===0)return"table";const a=e.reduce((c,u)=>c+Os(u),0),s=t/cu,i=a/s;if(i<=1)return"table";const r=e.filter(c=>c.identifier||(c.priority??Number.MAX_SAFE_INTEGER)<=2),n=r.reduce((c,u)=>c+Os(u),0);return i>1.6||e.length>10?"masterDetail":r.length>0&&n<=8?"list":e.some(c=>c.stereotype==="image"||c.stereotype==="html")||r.length===0&&e.length>=4&&e.length<=8?"cards":"masterDetail"}function Ri(e){return e.filter(t=>t.identifier||(t.priority??Number.MAX_SAFE_INTEGER)<=2).sort((t,a)=>(t.priority??Number.MAX_SAFE_INTEGER)-(a.priority??Number.MAX_SAFE_INTEGER))}function pu(e){const t=Ri(e);return t.length>0?t:e.slice(0,3)}var hu=Object.defineProperty,mu=Object.getOwnPropertyDescriptor,Ee=(e,t,a,s)=>{for(var i=s>1?void 0:s?mu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&hu(t,a,i),i};const vu={asc:"ascending",desc:"descending"};let de=class extends _{constructor(){super(...arguments),this.component=void 0,this.standalone=!1,this.state={},this.data={},this.appState={},this.appData={},this.showImportDialog=!1,this.availableWidthPx=1024,this.selectedItem=null,this._columnPrefsRevision=0,this._prefsRevisionApplied=-1,this.search=()=>{const e=this.component.metadata;this.state={...this.state,size:e.pageSize,page:0,crud_selected_items:[]},this._syncStateToUrl(e),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}}},bubbles:!0,composed:!0}))},this.notify=e=>{jt.show(e,{position:"bottom-end",theme:"error",duration:3e3})},this.handleSearchRequested=e=>{this.state={...this.state,crud_selected_items:[]};const t=this.component.metadata;this._syncStateToUrl(t),!t.infiniteScrolling&&this.data?.[this.id]?.page&&(this.data[this.id].page.content=[]),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}},callback:e},bubbles:!0,composed:!0}))},this.fetchMoreElements=e=>{const{params:t,callback:a}=e.detail;this.state={...this.state,size:t.pageSize,page:t.page},this.handleSearchRequested(a)},this.directionChanged=e=>{const t=e.detail.grid._sorters;this.state={...this.state,sort:t.map(a=>({fieldId:a.__data.path,direction:a.__data.direction?vu[a.__data.direction]:void 0}))},this.handleSearchRequested(void 0)},this._initializedForComponentId=void 0,this.evalLabel=e=>Re(e,this.state,this.data),this.handleToolbarButtonClick=e=>{if(e==="import"){this.showImportDialog=!0;return}this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.handleImportUploadSuccess=e=>{const t=e.detail.xhr.responseText;this.showImportDialog=!1,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"process-import",parameters:{fileId:t}},bubbles:!0,composed:!0}))}}get columnPrefsScope(){return window.location.pathname}get effectiveComponent(){const e=this.component,t=e?.metadata;if(!e||!t?.columns)return e;if(this._prefsSource===e&&this._prefsRevisionApplied===this._columnPrefsRevision)return this._prefsApplied;const a=Er(this.columnPrefsScope),s=Tr(t.columns,a,i=>i.metadata??{});return this._prefsApplied=s===t.columns?e:{...e,metadata:{...t,columns:s}},this._prefsSource=e,this._prefsRevisionApplied=this._columnPrefsRevision,this._prefsApplied}get columnChooserEntries(){return(this.component?.metadata?.columns??[]).map(t=>{const a=t.metadata??{},s=a.id??t.id;return s?{id:s,label:a.label??s,protected:Pr(a)}:void 0}).filter(t=>!!t)}renderColumnChooser(){const e=this.columnChooserEntries;return e.filter(t=>!t.protected).length===0?l:o`
            <mateu-column-chooser
                .columns="${e}"
                .scope="${this.columnPrefsScope}"
                @column-prefs-changed="${t=>{t.stopPropagation(),this._columnPrefsRevision++}}"
            ></mateu-column-chooser>
        `}get cols(){return this.effectiveComponent?.metadata?.columns?.map(t=>t.metadata)??[]}get identifierFieldName(){const e=this.cols.find(t=>t.identifier);return e?e.id:this.cols.find(t=>t.id==="id")?.id}get effectiveGridLayout(){const e=this.component?.metadata,t=e?.gridLayout??"auto";return t==="auto"?e?.crudlType==="card"?"cards":uu(this.cols,this.availableWidthPx):t}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{const t=e[0]?.contentRect.width;t&&Math.abs(t-this.availableWidthPx)>10&&(this.availableWidthPx=t)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}_filterIds(e){return new Set(["searchText",...(e.filters??[]).flatMap(t=>t.stereotype==="dateRange"||t.stereotype==="numberRange"?[`${t.fieldId}_from`,`${t.fieldId}_to`]:[t.fieldId])])}_syncStateToUrl(e){const t=this._filterIds(e),a=new URLSearchParams(window.location.search);t.forEach(d=>a.delete(d)),a.delete("page"),a.delete("sort"),t.forEach(d=>{const c=this.state[d];c!=null&&c!==""&&a.set(d,String(c))});const s=this.state.page;s&&s>0&&a.set("page",String(s));const i=this.state.sort;if(i&&i.length>0){const d=i.filter(c=>c.fieldId&&c.direction).map(c=>`${c.fieldId}:${c.direction}`).join(",");d&&a.set("sort",d)}const r=a.toString(),n=r?`${window.location.pathname}?${r}`:window.location.pathname;window.location.pathname+window.location.search!==n&&history.replaceState(null,"",n)}_initStateFromUrl(e,t){const a=new URLSearchParams(window.location.search),s=this._filterIds(e),i={...t};a.forEach((d,c)=>{s.has(c)&&(i[c]=d)});const r=a.get("page");if(r!==null){const d=parseInt(r,10);!isNaN(d)&&d>0&&(i.page=d)}const n=a.get("sort");if(n){const d=n.split(",").map(c=>{const[u,m]=c.split(":");return u&&m?{fieldId:u,direction:m}:null}).filter(Boolean);d.length>0&&(i.sort=d)}return i}pageChanged(e){this.state={...this.state,page:e.detail.page},this.handleSearchRequested(void 0)}updated(e){if(super.updated(e),e.has("component")){const t=this.component?.id;if(t!==this._initializedForComponentId){this._initializedForComponentId=t;const a=this.component?.metadata,s=a.initialPage&&a.initialPage>0?a.initialPage:0;this.state=this._initStateFromUrl(a,{...this.state,size:a.pageSize,page:s,sort:[]}),(this.state.page!==s||this.state.sort?.length>0||[...this._filterIds(a)].some(r=>this.state[r]!=null))&&this.handleSearchRequested(void 0)}}}render(){const e=S=>{const F=[];return S.color&&S.color!==Or.normal&&F.push(S.color),S.buttonStyle&&F.push(S.buttonStyle===Rr.tertiaryInline?"tertiary-inline":S.buttonStyle),F.length?F.join(" "):void 0},t=S=>S==="back"||S==="backToList"||!!S&&S.startsWith("cancel"),a=S=>{const F=W.get()?.renderToolbarButton?.(S,this.evalLabel(S.label),()=>this.handleToolbarButtonClick(S.actionId));return F||o`
                <vaadin-button
                        data-action-id="${S.id}"
                        theme="${e(S)||l}"
                        @click="${()=>this.handleToolbarButtonClick(S.actionId)}"
                >${this.evalLabel(S.label)}</vaadin-button>
            `};if(!this.component)return o`no component`;const s=this.effectiveComponent,i=s.metadata;i.serverSideOrdering=!0;const r=i?.toolbar??[],n=r.filter(S=>t(S.actionId)),d=r.filter(S=>!t(S.actionId)),c=n.length>0&&d.length>0,u=!!i?.title||!!i?.subtitle||r.length>0,m=this.effectiveGridLayout,v=this.cols,f=Ri(v),y=this.data[this.id]?.page?.content??[],$=this.state[this.component?.id]?.emptyStateMessage,E=(S,F)=>{const R=F[S.id];if(R==null)return o``;if(S.dataType==="status"){const L=ki(R.type);return o`<span theme="badge pill ${L}">${R.message}</span>`}return S.dataType==="bool"?o`${R?"✓":"✗"}`:typeof R=="object"?o`${R.label??R.name??R.message??""}`:o`${R}`},q=()=>{const S=this.identifierFieldName,F=this.state._selectedId??this.appState?._splitDetailId,R=f.find(T=>T.identifier)??f[0],L=T=>T.dataType==="action"||T.dataType==="actionGroup"||T.dataType==="menu"||T.stereotype==="button",tt=f.filter(T=>T!==R&&!L(T)),ra=v.filter(T=>L(T)),ht=(T,se,$e)=>{T.stopPropagation(),T.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:se,parameters:{_clickedRow:$e}},bubbles:!0,composed:!0}))},oa=T=>{const se=[];for(const $e of ra){const N=T[$e.id];if($e.dataType==="action"){const D=N?.methodNameInCrud?N:T.action?.methodNameInCrud?T.action:{methodNameInCrud:$e.id,label:$e.label,icon:null};se.push(o`
                            <vaadin-button theme="tertiary small" title="${D.label||l}"
                                @click="${I=>ht(I,"action-on-row-"+D.methodNameInCrud,T)}">
                                ${D.icon?o`<vaadin-icon icon="${D.icon}"></vaadin-icon>`:l}
                                ${D.label??l}
                            </vaadin-button>`)}else($e.dataType==="actionGroup"||$e.dataType==="menu")&&(N?.actions??[]).forEach(I=>se.push(o`
                            <vaadin-button theme="tertiary small" title="${I.label||l}"
                                @click="${K=>ht(K,"action-on-row-"+I.methodNameInCrud,T)}">
                ...
                <vaadin-list-box style="width: 100%;">
                    ${y.length===0?o`<vaadin-item disabled>${Ut($)}</vaadin-item>`:l}
                    ${y.map(T=>o`
                        <vaadin-item
                            ?selected="${S&&F!==void 0&&String(T[S])===String(F)}"
                            ...
                            style="cursor: pointer;"
                        >
                            <div style="font-weight: 600;">${R?T[R.id]??"":""}</div>
                            <div style="font-size: var(--lumo-font-size-s); color: var(--lumo-secondary-text-color); display: flex; flex-wrap: wrap; gap: var(--lumo-space-xs); align-items: center;">
                                ${tt.map(se=>o`<span>${se.label}: ${E(se,T)}</span>`)}
                            </div>
                            ${oa(T)}
                        </vaadin-item>
                    `)}
                </vaadin-list-box>`},V=(S,F,R)=>{const L=this.identifierFieldName;L&&R[L]!==void 0&&(this.state={...this.state,_selectedId:String(R[L])}),S.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:F,parameters:R},bubbles:!0,composed:!0}))},C=()=>{const S=this.identifierFieldName,F=this.state._selectedId??this.appState?._splitDetailId,R=v.slice(0,6),L=R.filter(I=>I.stereotype==="image"),tt=R.find(I=>I.identifier)??R[0],ra=I=>!!I.actionId,ht=I=>I.dataType==="action"||I.dataType==="actionGroup"||I.dataType==="menu"||I.stereotype==="button",oa=R.find(I=>I.id==="select"&&I.dataType==="action"),T=!!oa,se=R.filter(I=>I!==tt&&!L.includes(I)&&!ra(I)&&!ht(I)),$e=R.filter(I=>ht(I)&&!(T&&I===oa)),N=(I,K,mt)=>{I.stopPropagation(),I.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:K,parameters:{_clickedRow:mt}},bubbles:!0,composed:!0}))},D=I=>{const K=[];for(const mt of $e){const Fi=I[mt.id];if(mt.dataType==="action"){const na=Fi?.methodNameInCrud?Fi:I.action?.methodNameInCrud?I.action:{methodNameInCrud:mt.id,label:mt.label,icon:null};K.push(o`
                            <vaadin-button theme="tertiary" title="${na.label||l}"
                                @click="${Nt=>N(Nt,"action-on-row-"+na.methodNameInCrud,I)}">
                                ${na.icon?o`<vaadin-icon icon="${na.icon}"></vaadin-icon>`:l}
                                ${na.label??l}
                            </vaadin-button>`)}else(mt.dataType==="actionGroup"||mt.dataType==="menu")&&(Fi?.actions??[]).forEach(Nt=>K.push(o`
                            <vaadin-button theme="tertiary" title="${Nt.label||l}"
                                @click="${jr=>N(jr,"action-on-row-"+Nt.methodNameInCrud,I)}">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: var(--lumo-space-m); padding: var(--lumo-space-s) 0;">
                    ${y.length===0?o`<div style="grid-column: 1 / -1;">${Ut($)}</div>`:l}
                    ${y.map(I=>o`
                        <vaadin-card
                            clickable
                            ?data-selected="${S&&F!==void 0&&String(I[S])===String(F)}"
                            style="cursor: pointer;"
                            @click="${K=>T?N(K,"action-on-row-select",I):V(K.target,"view",I)}"
                        >
                            ${L.length?o`<img slot="media" src="${I[L[0].id]??""}" alt="" style="width: 100%; max-height: 160px; object-fit: cover;" />`:l}
                            ${tt?o`<div slot="title">${I[tt.id]??""}</div>`:l}
                    ...
                    `)}
                </div>`},A=()=>{const S=pu(v),F=S.find(L=>L.identifier)??S[0],R=S.filter(L=>L!==F);return o`
                        ...
                        <vaadin-list-box style="width: 100%;">
                            ...
                            ${y.map(L=>o`
                                <vaadin-item
                                    ...
                                    style="cursor: pointer;"
                                >
                                    <div style="font-weight: 600;">${F?L[F.id]??"":""}</div>
                                    <div style="font-size: var(--lumo-font-size-s); color: var(--lumo-secondary-text-color); display: flex; flex-wrap: wrap; gap: var(--lumo-space-xs); align-items: center;">
                                        ${R.map(tt=>o`${E(tt,L)} `)}
                                    </div>
                                </vaadin-item>
                ...
                </div>`},G=()=>{const S=this.identifierFieldName,F=this.state._selectedId??this.appState?._splitDetailId,R=v[0],L=v.slice(1),tt=!!R?.actionId,ra=N=>(N??[]).map(D=>{const I=Array.isArray(D.children)?D.children:[];return I.length>0?{...D,children:ra(I)}:{...D,children:void 0}}),ht=ra(y),oa=(N,D)=>{const I=N.parentItem?N.parentItem.children??[]:ht;D(I,I.length)},T=(N,D)=>{for(const I of N??[]){if(S&&String(I[S])===D)return I;const K=T(I.children,D);if(K)return K}},se=S&&F!==void 0?T(ht,String(F)):void 0,$e=(N,D,I)=>{N.stopPropagation(),S&&D[S]!==void 0&&(this.state={...this.state,_selectedId:String(D[S])}),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:I,parameters:D},bubbles:!0,composed:!0}))};return o`
                <vaadin-grid
                    style="width: 100%;"
                    all-rows-visible
                    ...
                    .selectedItems="${se?[se]:[]}"
                >
                    ${R?o`<vaadin-grid-tree-column path="${R.id}" header="${R.label??l}" flex-grow="1"></vaadin-grid-tree-column>`:l}
                    ${tt?o`
                    <vaadin-grid-column width="6rem" flex-grow="0" text-align="end" ${st(N=>N?.viewable===!1?l:o`
                        <vaadin-button theme="tertiary small" @click="${D=>$e(D,N,"view")}">View</vaadin-button>
                    `,[])}></vaadin-grid-column>`:l}
                    ${L.map(N=>N.id==="select"?o`<vaadin-grid-column width="7rem" flex-grow="0" text-align="end" header="${N.label??l}" ${st(D=>o`
                            <vaadin-button theme="tertiary small" @click="${I=>{I.stopPropagation(),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-select",parameters:{_clickedRow:D}},bubbles:!0,composed:!0}))}}">Select</vaadin-button>
                        `,[])}></vaadin-grid-column>`:o`<vaadin-grid-column path="${N.id}" header="${N.label??l}" auto-width></vaadin-grid-column>`)}
                    <span slot="empty-state">${Ut($)}</span>
                </vaadin-grid>`},X=W.get()?.rendersCrudLayouts?.()===!0,ae=o`
            ${i.infiniteScrolling?o`
                <div>${this.data[this.id]?.page?.totalElements} items found.</div>
            `:l}
            ${!X&&m==="list"?q():!X&&m==="cards"?i.contentHeight?o`
                <vaadin-scroller style="width: 100%; height: ${i.contentHeight};">
                    ${C()}
                </vaadin-scroller>
            `:C():!X&&m==="masterDetail"?A():!X&&m==="tree"?G():W.get()?.renderTableComponent(this,s,this.baseUrl,this.state,this.data,this.appState,this.appData)}
            <slot></slot>
        `,ie=i.infiniteScrolling?l:W.get()?.renderPagination(this,this.component),ge=o`
            <vaadin-dialog
        ...
        `}createRenderRoot(){return W.mustUseShadowRoot()?super.createRenderRoot():this}};de.styles=w`
        ${Tt}
    ...
    `;Ee([p()],de.prototype,"component",2);Ee([p()],de.prototype,"baseUrl",2);Ee([p({type:Boolean})],de.prototype,"standalone",2);Ee([p()],de.prototype,"state",2);Ee([p()],de.prototype,"data",2);Ee([p()],de.prototype,"appState",2);Ee([p()],de.prototype,"appData",2);Ee([b()],de.prototype,"showImportDialog",2);Ee([b()],de.prototype,"availableWidthPx",2);Ee([b()],de.prototype,"selectedItem",2);Ee([b()],de.prototype,"_columnPrefsRevision",2);de=Ee([x("mateu-table-crud")],de);var bt=(e=>(e.OnLoad="OnLoad",e.OnSuccess="OnSuccess",e.OnError="OnError",e.OnValueChange="OnValueChange",e.OnCustomEvent="OnCustomEvent",e.AutoSave="AutoSave",e))(bt||{}),fu=Object.defineProperty,zi=(e,t,a,s)=>{for(var i=void 0,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(t,a,i)||i);return i&&fu(t,a,i),i};class Ft extends Ha{constructor(){super(...arguments),this.state={},this.data={},this.appData={},this.appState={},this.triggerOnLoad=()=>{const t=this.component;this.registerCustomEventListeners(),t.triggers?.filter(a=>a.type==bt.OnLoad).forEach(a=>{if((!a.condition||this._evalExpr(a.condition))&&!a.triggered){const i=a;i.triggered=!0;var s=i.times-1;i.timeoutMillis>0?this.scheduleOnload(i,s,this.id):this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:i.actionId},bubbles:!0,composed:!0}))}})},this.scheduleOnload=(t,a,s)=>{if(s!=this.component?.id)return;const i=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,callbackToken:i},bubbles:!0,composed:!0}))},t.timeoutMillis)},this._registeredCustomEventListeners=[],this.customEventManager=t=>{if(!(t instanceof CustomEvent))return;const a=t,i=(this.component.triggers??[]).filter(r=>r.type==bt.OnCustomEvent).filter(r=>r.eventName==a.type).filter(r=>r.source!=="COMPONENT"||a.detail?.__source===r.from);i.length!==0&&(i.some(r=>!r.source||r.source==="SELF")&&(t.stopPropagation(),t.preventDefault()),i.forEach(r=>{(!r.condition||this._evalExpr(r.condition))&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.actionId,parameters:a.detail},bubbles:!0,composed:!0}))}))}}_interpolationExtra(){return{appState:this.appState??{},appData:this.appData??{},component:this.component}}_evalExpr(t){return Ws(t,this.state??{},this.data??{},this._interpolationExtra())}_evalTemplate(t){return yo(t,this.state??{},this.data??{},this._interpolationExtra())}applyFragment(t){if(this.id==t.targetComponentId){if(t.component)if(Ma.Add==t.action)this.component&&this.component.children?.push(t.component);else{if(this.callbackToken=Q(),t.component?.type==pe.ServerSide)if(this.component){const s=this.component,i=t.component;s.actions=i.actions,s.type=i.type,s.rules=i.rules,s.triggers=i.triggers,s.serverSideType=i.serverSideType,s.route=i.route,s.initialData=i.initialData,s.validations=i.validations,s.cssClasses=i.cssClasses,s.slot=i.slot,s.style=i.style,s.children=i.children,(s.serverSideType!=i.serverSideType||s.id!=i.id)&&setTimeout(()=>this.triggerOnLoad())}else this.component=t.component,setTimeout(()=>this.triggerOnLoad());else{const s=[t.component];this.component&&(this.component.children=s)}t.action!==Ma.ReplaceKeepData&&(this.state={},this.data={})}if(t.state&&(this.state={...this.state,...t.state}),t.data){for(const s in t.data){const i=t.data[s]?.page;i?.pageNumber>0&&this.data[s]&&this.data[s].page.content&&(i.content?i.content=[...this.data[s].page.content,...i.content]:i.content=[...this.data[s].page.content])}this.data={...this.data,...t.data}}this.registerCustomEventListeners();const a=W.getAfterRenderHook();a&&setTimeout(()=>a(this)),this.requestUpdate()}}registerCustomEventListeners(){this._registeredCustomEventListeners.forEach(({target:a,name:s})=>a.removeEventListener(s,this.customEventManager)),this._registeredCustomEventListeners=[],this.component?.triggers?.filter(a=>a.type==bt.OnCustomEvent).forEach(a=>{const s=a.source==="DOCUMENT"||a.source==="COMPONENT"?document:this;s.addEventListener(a.eventName,this.customEventManager),this._registeredCustomEventListeners.push({target:s,name:a.eventName})})}disconnectedCallback(){this._registeredCustomEventListeners.forEach(({target:t,name:a})=>t.removeEventListener(a,this.customEventManager)),this._registeredCustomEventListeners=[],super.disconnectedCallback()}connectedCallback(){super.connectedCallback(),this.component&&this.registerCustomEventListeners()}}zi([p()],Ft.prototype,"state");zi([p()],Ft.prototype,"data");zi([p()],Ft.prototype,"appData");zi([p()],Ft.prototype,"appState");var bu=Object.defineProperty,gu=Object.getOwnPropertyDescriptor,Li=(e,t,a,s)=>{for(var i=s>1?void 0:s?gu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&bu(t,a,i),i};let ma=class extends _{constructor(){super(...arguments),this.notificationOpened=!1,this.fetchStarted=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!0},this.fetchFinished=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1},this.fetchFailed=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1,this.error=e.detail.reason,this.openNotification()},this.openNotification=()=>{this.notificationOpened=!0},this.closeNotification=()=>{this.notificationOpened=!1},this.notificationRenderer=()=>o`
    <vaadin-horizontal-layout theme="spacing" style="align-items: center;">
...
`:o`<vaadin-button theme="tertiary" 
  ...
  `;zr([p()],fi.prototype,"target",2);fi=zr([x("mateu-event-interceptor")],fi);var Cu=Object.defineProperty,Su=Object.getOwnPropertyDescriptor,Lr=(e,t,a,s)=>{for(var i=s>1?void 0:s?Su(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Cu(t,a,i),i};let bi=class extends Ft{constructor(){super(...arguments),this.opened=!0,this.close=()=>{this.opened=!1,setTimeout(()=>this.parentElement?.removeChild(this),500)}}applyFragment(e){super.applyFragment(e);const t=e.state?._closeAfterMillis;t&&setTimeout(()=>this.close(),t)}updated(e){if(super.updated(e),e.has("component")&&this.component){const t=this.component.metadata;this.state=t.initialData}}render(){const e=this.component.metadata;let t="";e.noPadding&&(t+=" no-padding");const a=wi(e.headerTitle,this.state,this.data,this.appState,this.appData);return o`
        <vaadin-dialog
                ...
                ${e.footer?Ji(()=>o`<mateu-event-interceptor .target="${this}" style="width: 100%;">${k(this,e.footer,this.baseUrl,this.state,this.data,this.appState,this.appData)}</mateu-event-interceptor>`,[this.state,this.data]):l}
                ${e.content?yi(()=>o`<mateu-event-interceptor .target="${this}" style="--mateu-section-border: none; width: 100%;">${k(this,e.content,this.baseUrl,this.state,this.data,this.appState,this.appData)}</mateu-event-interceptor>`,[this.state,this.data]):l}
       ...
       `}};bi.styles=w`
  `;Lr([b()],bi.prototype,"opened",2);bi=Lr([x("mateu-dialog")],bi);var Iu=Object.defineProperty,Eu=Object.getOwnPropertyDescriptor,Dr=(e,t,a,s)=>{for(var i=s>1?void 0:s?Eu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Iu(t,a,i),i};let gi=class extends Ft{constructor(){super(...arguments),this.opened=!1,this.close=()=>{this.opened=!1,setTimeout(()=>this.parentElement?.removeChild(this),300)},this._escListener=e=>{if(e.key!=="Escape")return;const a=this.getRootNode().querySelectorAll("mateu-drawer, mateu-dialog");a[a.length-1]===this&&(e.stopPropagation(),this.close())}}firstUpdated(){requestAnimationFrame(()=>this.opened=!0)}applyFragment(e){super.applyFragment(e);const t=e.state?._closeAfterMillis;t&&setTimeout(()=>this.close(),t)}updated(e){if(super.updated(e),e.has("component")&&this.component){const t=this.component.metadata;this.state=t.initialData}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._escListener)}disconnectedCallback(){document.removeEventListener("keydown",this._escListener),super.disconnectedCallback()}render(){const e=this.component.metadata,t=e.position??"end",a=wi(e.headerTitle,this.state,this.data,this.appState,this.appData);return o`
        ${e.modeless?l:o`
  ...
  `;Dr([b()],gi.prototype,"opened",2);gi=Dr([x("mateu-drawer")],gi);var Pu=Object.defineProperty,Tu=Object.getOwnPropertyDescriptor,ce=(e,t,a,s)=>{for(var i=s>1?void 0:s?Tu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Pu(t,a,i),i};function Rs(e){if(e.parentElement)return e.parentElement;const t=e.getRootNode();return t instanceof ShadowRoot?t.host:null}let J=class extends _{constructor(){super(...arguments),this.appState={},this.appData={},this.standalone=!1,this.actionBanners=[],this.dismissedStaticBannerIndices=new Set,this._tocEntries=[],this._activeToc=0,this._tocVisible=!1,this._tocRebuildScheduled=!1,this._headerH=0,this._onResize=()=>this._layoutStickyTops(),this._tocLocked=!1,this._unlockToc=e=>{if(e&&e.type==="keydown"){const t=e;if(t.ctrlKey&&t.altKey&&!t.shiftKey&&!t.metaKey&&/^(?:Digit|Numpad)[1-9]$/.test(t.code))return}this._tocLocked=!1},this._actionBannerTimers=[],this._staticBannerTimers=[],this._bannersHandler=e=>{const t=e.detail,a=t.banners??[],s=t.append??!1;s?this.actionBanners=[...this.actionBanners,...a]:(this._clearActionBannerTimers(),this.actionBanners=a);const i=s?this.actionBanners.length-a.length:0;a.forEach((r,n)=>{if(r.timeoutSeconds&&r.timeoutSeconds>0){const d=i+n;this._actionBannerTimers.push(setTimeout(()=>{this.actionBanners=this.actionBanners.filter((c,u)=>u!==d)},r.timeoutSeconds*1e3))}})},this._onTocKey=e=>{if(!this._tocVisible||!e.ctrlKey||!e.altKey||e.shiftKey||e.metaKey)return;const t=/^(?:Digit|Numpad)([1-9])$/.exec(e.code);if(!t)return;const a=parseInt(t[1],10)-1;a>=this._tocEntries.length||(e.preventDefault(),this._scrollToSection(a))},this._onScrollSpy=()=>{if(this._tocLocked)return;const e=this._sectionCards();if(!e.length)return;const t=12,a=this.shadowRoot?.querySelector("mateu-content-header");let s=a?a.getBoundingClientRect().bottom:0;for(const n of e){if(!n.classList.contains("mateu-section--sticky"))continue;const d=n.getBoundingClientRect();d.top<=s+t+2&&(s=Math.max(s,d.bottom))}const i=s+t+4;let r=0;this._tocEntries.forEach((n,d)=>{n.el.getBoundingClientRect().top<=i&&(r=d)}),this._activeToc=r}}connectedCallback(){super.connectedCallback(),document.addEventListener("page-banners-received",this._bannersHandler),window.addEventListener("resize",this._onResize),document.addEventListener("keydown",this._onTocKey)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("page-banners-received",this._bannersHandler),window.removeEventListener("resize",this._onResize),document.removeEventListener("keydown",this._onTocKey),this._clearAllTimers(),this._teardownScrollSpy()}updated(e){super.updated(e),e.has("component")&&e.get("component")!==void 0&&(this._clearAllTimers(),this.actionBanners=[],this.dismissedStaticBannerIndices=new Set),e.has("component")&&(this._scheduleStaticBannerTimeouts(),this.dispatchEvent(new CustomEvent("compact-changed",{detail:{compact:!!this.component?.style?.includes("--mateu-compact:1")},bubbles:!0,composed:!0})),this._scheduleTocRebuild())}_scheduleStaticBannerTimeouts(){this._staticBannerTimers.forEach(a=>clearTimeout(a)),this._staticBannerTimers=[],(this.component?.metadata?.banners??[]).forEach((a,s)=>{a.timeoutSeconds&&a.timeoutSeconds>0&&this._staticBannerTimers.push(setTimeout(()=>{this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,s])},a.timeoutSeconds*1e3))})}_clearActionBannerTimers(){this._actionBannerTimers.forEach(e=>clearTimeout(e)),this._actionBannerTimers=[]}_clearAllTimers(){this._clearActionBannerTimers(),this._staticBannerTimers.forEach(e=>clearTimeout(e)),this._staticBannerTimers=[]}_dismissActionBanner(e){this.actionBanners=this.actionBanners.filter((t,a)=>a!==e)}_dismissStaticBanner(e){this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,e])}bannerThemeClass(e){const t=e.theme?.toLowerCase()??"info";return t==="none"?"":t}_evalBannerText(e){return Re(e,this.state,this.data)}_renderBanner(e,t){const a=this._evalBannerText(e.title),s=this._evalBannerText(e.description);return o`
    ...
    `;ce([p()],J.prototype,"component",2);ce([p()],J.prototype,"baseUrl",2);ce([p()],J.prototype,"state",2);ce([p()],J.prototype,"data",2);ce([p()],J.prototype,"appState",2);ce([p()],J.prototype,"appData",2);ce([p()],J.prototype,"value",2);ce([p({type:Boolean})],J.prototype,"standalone",2);ce([b()],J.prototype,"actionBanners",2);ce([b()],J.prototype,"dismissedStaticBannerIndices",2);ce([b()],J.prototype,"_tocEntries",2);ce([b()],J.prototype,"_activeToc",2);ce([b()],J.prototype,"_tocVisible",2);J=ce([x("mateu-page")],J);const Di=w`
    .nbtn {
        display: inline-flex;
        align-items: center;
        gap: .35em;
...
`,A=!0)}A&&this.updateMessage(r,n)}n||this.updateMessage(r,"⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).")}catch(d){console.error("Error en el flujo SSE:",d);const c=d?.message??String(d);(c==="Failed to fetch"||c==="network error"||c==="Load failed")&&!n?this.updateMessage(r,"⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible."):this.updateMessage(r,"⚠️ Error: "+c)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value="")},250),this.messageInputElement?.removeAttribute("disabled"),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent("close-requested",{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{const e=this.messageInputElement?.value?.trim()??"";e&&this.send(new CustomEvent("submit",{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key==="Enter"&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback(),this.probeLocalAgent();const e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){const t=new e;this.recognition=t,t.lang="es-ES",t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=a=>{console.error("Error de reconocimiento: "+a.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:"smooth"})},0)}addMessage(e,t){const a={text:e,time:new Date().toLocaleTimeString(),userName:t.includes("agent")?"Asistente":"Tú",userColorIndex:t.includes("agent")?2:1};return this.items=[...this.items,a],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((a,s)=>s===e?{...a,text:t}:a),this.scrollBottom()}tryParseCustomEvent(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if(typeof a.event=="string")return{event:a.event,detail:a.detail??{}}}catch{}return null}tryParseTokenUsage(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if("inputTokens"in a||"outputTokens"in a||"totalTokens"in a)return a}catch{}return null}buildMenuContext(e,t=[]){const a=[];for(const s of e){if(s.separator||s.remote)continue;const i=[...t,s.label];if(s.submenus&&s.submenus.length>0)a.push(...this.buildMenuContext(s.submenus,i));else{const r={path:i,navigation:{route:s.route,consumedRoute:s.consumedRoute,actionId:s.actionId??"",baseUrl:s.baseUrl,serverSideType:s.serverSideType,uriPrefix:s.uriPrefix}};s.description&&(r.description=s.description),a.push(r)}}return a}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return o`
                    ...
                    <div class="message-list" role="list">
                        ${this.items.map(e=>o`
                            <div class="message" role="listitem">
                                <div class="avatar" style="background: ${Au(e.userColorIndex)};">${Fu(e.userName)}</div>
    ...
    `];j([p({attribute:!1})],M.prototype,"contextProvider",2);j([p()],M.prototype,"localAgentUrl",2);j([p({attribute:!1})],M.prototype,"mcpUrl",2);j([b()],M.prototype,"localAgentAlive",2);j([p()],M.prototype,"sseUrl",2);j([p()],M.prototype,"uploadUrl",2);j([p({attribute:!1})],M.prototype,"menu",2);j([b()],M.prototype,"attachments",2);j([b()],M.prototype,"uploading",2);j([Fe(".file-input")],M.prototype,"fileInputElement",2);j([p({type:Boolean,reflect:!0})],M.prototype,"expanded",2);j([p()],M.prototype,"items",2);j([Fe(".scroll-container")],M.prototype,"scrollContainer",2);j([Fe(".msg-input")],M.prototype,"messageInputElement",2);j([b()],M.prototype,"recognition",2);j([b()],M.prototype,"listening",2);j([b()],M.prototype,"recognitionAvailable",2);j([b()],M.prototype,"loading",2);j([b()],M.prototype,"elapsedSeconds",2);j([b()],M.prototype,"tokenUsage",2);M=j([x("mateu-chat")],M);var Nu=Object.defineProperty,Mu=Object.getOwnPropertyDescriptor,Qa=(e,t,a,s)=>{for(var i=s>1?void 0:s?Mu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Nu(t,a,i),i};let Xt=class extends _{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.data&&this.createChart(this.data)}async createChart(e){const[{default:t}]=await Promise.all([ue(()=>import("./vendor-chartjs.js").then(s=>s.a),[]),ue(()=>import("./vendor-chartjs.js").then(s=>s.c),[])]);if(e!==this.data)return;this.chart&&this.chart.destroy();const a={type:this.type,data:this.data,options:this.options};this.chart=new t(this.chartElement,a)}handleSlotChange(){}render(){return o`
            <div class="container">
       ...
       `}};Xt.styles=w`
  `;Qa([p()],Xt.prototype,"type",2);Qa([p()],Xt.prototype,"data",2);Qa([p()],Xt.prototype,"options",2);Qa([Fe("#chart")],Xt.prototype,"chartElement",2);Xt=Qa([x("mateu-chart")],Xt);var qu=Object.defineProperty,Uu=Object.getOwnPropertyDescriptor,ms=(e,t,a,s)=>{for(var i=s>1?void 0:s?Uu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&qu(t,a,i),i};let qa=class extends _{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){const{default:t}=await ue(async()=>{const{default:s}=await import("./vendor-diagrams.js").then(i=>i.i);return{default:s}},__vite__mapDeps([4,3,1,2]));if(e!==this.xml)return;this.chart&&this.chart.destroy();const a={container:this.divElement};this.chart=new t(a),this.chart.importXML(e)}handleSlotChange(){}render(){return o`
       ...
       `}};qa.styles=w`
  `;ms([p()],qa.prototype,"xml",2);ms([Fe("#canvas")],qa.prototype,"divElement",2);qa=ms([x("mateu-bpmn")],qa);var ju=Object.defineProperty,Bu=Object.getOwnPropertyDescriptor,_a=(e,t,a,s)=>{for(var i=s>1?void 0:s?Bu(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ju(t,a,i),i};const Bi=160,Me=56,Vu=220,Ls=110,vt=60,Hu={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},Wu={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},Gu=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];function Ku(){return"step-"+Math.random().toString(36).slice(2,8)}let It=class extends _{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.wf={name:"New Workflow",steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value")){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){const e=this.wf.steps??[],t={};e.forEach(n=>{t[n.id]=0});let a=!0;for(;a;)a=!1,e.forEach(n=>{if(n.preconditionStepId!=null&&t[n.preconditionStepId]!==void 0){const d=t[n.preconditionStepId]+1;d>t[n.id]&&(t[n.id]=d,a=!0)}});const s={};e.forEach(n=>{const d=t[n.id]??0;(s[d]??=[]).push(n.id)});const i={...this.positions};let r=!1;Object.entries(s).forEach(([n,d])=>{const c=Number(n);d.forEach((u,m)=>{i[u]||(i[u]={x:vt+c*Vu,y:vt+m*Ls},r=!0)})}),r&&(this.positions=i)}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addStep(){const e=Ku(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(i=>i.y),s=a.length?Math.max(...a)+Ls:vt;this.positions={...this.positions,[e]:{x:vt,y:s}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(s=>s.id!==e).map(s=>s.preconditionStepId===e?{...s,preconditionStepId:void 0}:s)};const{[e]:t,...a}=this.positions;this.positions=a,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},s=this.toSvgPoint(e);this.dragOffset={x:s.x-a.x,y:s.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(s=>s.x))+Bi+vt:600,a=e.length?Math.max(...e.map(s=>s.y))+Me+vt:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return H``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return H``;const s=t.x+Bi,i=t.y+Me/2,r=a.x,n=a.y+Me/2,d=(s+r)/2;return H`
            <path d="M${s},${i} C${d},${i} ${d},${n} ${r},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:vt,y:vt},a=Hu[e.type]??"#64748b",s=Wu[e.type]??"•",i=this.selectedId===e.id;return H`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${r=>this.onNodeMouseDown(r,e.id)}"
               @click="${r=>{r.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${Bi}" height="${Me}" rx="8"
                      fill="white"
                      stroke="${i?a:"#e2e8f0"}"
        ...
        `}exportJson(){const e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),s=document.createElement("a");s.href=a,s.download=(this.wf.name??"workflow").replace(/\s+/g,"-").toLowerCase()+".json",s.click(),URL.revokeObjectURL(a)}};It.styles=[Di,w`
    ...
    `];_a([p()],It.prototype,"value",2);_a([b()],It.prototype,"wf",2);_a([b()],It.prototype,"positions",2);_a([b()],It.prototype,"selectedId",2);_a([b()],It.prototype,"showMeta",2);It=_a([x("mateu-workflow")],It);var Yu=Object.defineProperty,Ju=Object.getOwnPropertyDescriptor,dt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ju(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Yu(t,a,i),i};const Ea=160,Te=56,ft=60,Xu={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},Qu={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},Zu=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];let Vi;const ep=()=>(Vi||(Vi=ue(()=>import("./vendor-diagrams.js").then(e=>e.e),__vite__mapDeps([4,3,1,2])).then(e=>new e.default)),Vi);function tp(){return"step-"+Math.random().toString(36).slice(2,8)}let Le=class extends _{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.readOnly=!1,this.wf={name:"New Workflow",steps:[]},this.positions={},this.layoutReady=!1,this.selectedId=null,this.showMeta=!1,this.layoutError=null,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.elkPositioned=new Set,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.elkPositioned.add(this.draggingId),this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value"))try{const t=JSON.parse(this.value),a=new Set((this.wf.steps??[]).map(r=>r.id)),s=new Set((t.steps??[]).map(r=>r.id)),i=a.size!==s.size||[...s].some(r=>!a.has(r))||[...s].some(r=>{const n=(this.wf.steps??[]).find(c=>c.id===r),d=(t.steps??[]).find(c=>c.id===r);return n?.preconditionStepId!==d?.preconditionStepId});this.wf=t,(i||!this.layoutReady)&&this.runElkLayout()}catch{}}async runElkLayout(){const e=this.wf.steps??[];if(e.length===0){this.positions={},this.layoutReady=!0;return}const t={id:"root",layoutOptions:{"elk.algorithm":"layered","elk.direction":"RIGHT","elk.spacing.nodeNode":"40","elk.layered.spacing.nodeNodeBetweenLayers":"80","elk.edgeRouting":"ORTHOGONAL","elk.layered.nodePlacement.strategy":"BRANDES_KOEPF"},children:e.map(a=>({id:a.id,width:Ea,height:Te})),edges:e.filter(a=>a.preconditionStepId).map(a=>({id:`${a.preconditionStepId}->${a.id}`,sources:[a.preconditionStepId],targets:[a.id]}))};try{const s=await(await ep()).layout(t),i={...this.positions};for(const r of s.children??[])(!this.elkPositioned.has(r.id)||!i[r.id])&&(i[r.id]={x:(r.x??0)+ft,y:(r.y??0)+ft},this.elkPositioned.add(r.id));this.positions=i,this.layoutReady=!0,this.layoutError=null}catch(a){this.layoutError=a?.message??"ELK layout failed",this.layoutReady=!0}}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){const a=this.wf.steps.map(r=>r.id===e?{...r,...t}:r),s=this.wf.steps.find(r=>r.id===e),i=t.preconditionStepId!==void 0&&t.preconditionStepId!==s?.preconditionStepId;this.wf={...this.wf,steps:a},i&&(this.elkPositioned.clear(),this.runElkLayout()),this.emit()}addStep(){const e=tp(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(s=>s.x);this.positions={...this.positions,[e]:{x:a.length?Math.max(...a)+Ea+80:ft,y:ft}},this.selectedId=e,this.elkPositioned.clear(),this.runElkLayout(),this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(s=>s.id!==e).map(s=>s.preconditionStepId===e?{...s,preconditionStepId:void 0}:s)};const{[e]:t,...a}=this.positions;this.positions=a,this.elkPositioned.delete(e),this.selectedId===e&&(this.selectedId=null),this.runElkLayout(),this.emit()}onNodeMouseDown(e,t){if(this.readOnly)return;e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},s=this.toSvgPoint(e);this.dragOffset={x:s.x-a.x,y:s.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}relayout(){this.elkPositioned.clear(),this.runElkLayout()}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(s=>s.x))+Ea+ft:600,a=e.length?Math.max(...e.map(s=>s.y))+Te+ft:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){if(!this.layoutReady)return o`<div class="loading">Computing layout…</div>`;const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return H``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return H``;const s=t.x+Ea,i=t.y+Te/2,r=a.x,n=a.y+Te/2,d=(s+r)/2;return H`
            <path d="M${s},${i} C${d},${i} ${d},${n} ${r},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:ft,y:ft},a=Xu[e.type]??"#64748b",s=Qu[e.type]??"•",i=this.selectedId===e.id,r=e.name.length>16?e.name.slice(0,15)+"…":e.name;return H`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${n=>this.onNodeMouseDown(n,e.id)}"
               @click="${n=>{n.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${Ea}" height="${Te}" rx="8"
                      fill="white"
                      stroke="${i?a:"#e2e8f0"}"
                      stroke-width="${i?2.5:1.5}"
                      filter="url(#shadow)"/>
        ...
        `}exportJson(){const e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),s=document.createElement("a");s.href=a,s.download=(this.wf.name??"workflow").replace(/\s+/g,"-").toLowerCase()+".json",s.click(),URL.revokeObjectURL(a)}};Le.styles=[Di,w`
        :host {display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif);}
        ...
        textarea.inp {resize: vertical;}
        input[readonly].inp {background: #f8fafc; color: #94a3b8;}
    `];dt([p()],Le.prototype,"value",2);dt([p({type:Boolean})],Le.prototype,"readOnly",2);dt([b()],Le.prototype,"wf",2);dt([b()],Le.prototype,"positions",2);dt([b()],Le.prototype,"layoutReady",2);dt([b()],Le.prototype,"selectedId",2);dt([b()],Le.prototype,"showMeta",2);dt([b()],Le.prototype,"layoutError",2);Le=dt([x("mateu-workflow-elk")],Le);var ap=Object.defineProperty,ip=Object.getOwnPropertyDescriptor,Za=(e,t,a,s)=>{for(var i=s>1?void 0:s?ip(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ap(t,a,i),i};const sp=["string","integer","number","bool","date","time","dateTime","dateRange","money","file","array","status","component","menu","range","action","actionGroup"],rp=["regular","radio","checkbox","textarea","toggle","combobox","select","email","password","richText","listBox","html","markdown","image","icon","link","money","grid","color","choice","popover","slider","button","stars"],op={string:"#3B82F6",integer:"#8B5CF6",number:"#6366F1",bool:"#10B981",date:"#F59E0B",time:"#F59E0B",dateTime:"#F59E0B",dateRange:"#F59E0B",money:"#EF4444",file:"#64748B",array:"#0EA5E9",status:"#EC4899",component:"#14B8A6",menu:"#94A3B8",range:"#A855F7",action:"#F97316",actionGroup:"#FB923C"};function Ds(){return"field-"+Math.random().toString(36).slice(2,8)}let Qt=class extends _{constructor(){super(...arguments),this.value='{"name":"New Form","fields":[]}',this.form={name:"New Form",fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has("value"))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){const e=this.shadowRoot?.querySelector(".field-list");!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=Jr.create(e,{animation:150,handle:".drag-handle",ghostClass:"sortable-ghost",onEnd:t=>{const{oldIndex:a,newIndex:s}=t;if(a===void 0||s===void 0||a===s)return;const i=[...this.form.fields],[r]=i.splice(a,1);i.splice(s,0,r),this.form={...this.form,fields:i},this.emit()}}))}emit(){const e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addField(){const e=Ds(),t={id:e,label:"New Field",dataType:"string"};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){const t=this.form.fields.find(r=>r.id===e);if(!t)return;const a={...t,id:Ds(),label:t.label+" (copy)"},s=this.form.fields.findIndex(r=>r.id===e),i=[...this.form.fields];i.splice(s+1,0,a),this.form={...this.form,fields:i},this.selectedId=a.id,this.emit()}render(){return o`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderRow(e){const t=op[e.dataType]??"#64748b",a=this.selectedId===e.id;return o`
        ...
        `}exportJson(){const e=JSON.stringify(this.form,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),s=document.createElement("a");s.href=a,s.download=(this.form.name??"form").replace(/\s+/g,"-").toLowerCase()+".json",s.click(),URL.revokeObjectURL(a)}};Qt.styles=[Di,w`
        :host { display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif); }
    ...
    `;et([p()],_e.prototype,"appState",2);et([p()],_e.prototype,"appData",2);et([b()],_e.prototype,"open",2);et([b()],_e.prototype,"activeTab",2);et([b()],_e.prototype,"hoveredTag",2);et([b()],_e.prototype,"hoveredId",2);et([b()],_e.prototype,"hoveredState",2);et([b()],_e.prototype,"hoveredData",2);et([b()],_e.prototype,"hoveredMeta",2);_e=et([x("mateu-debug-overlay")],_e);var Oe=(e=>(e.SetAppDataValue="SetAppDataValue",e.SetAppStateValue="SetAppStateValue",e.SetDataValue="SetDataValue",e.RunAction="RunAction",e.RunJS="RunJS",e.SetAttributeValue="SetAttributeValue",e.SetStateValue="SetStateValue",e.SetCssClass="SetCssClass",e.SetStyle="SetStyle",e))(Oe||{}),Ar=(e=>(e.required="required",e.disabled="disabled",e.hidden="hidden",e.pattern="pattern",e.minValue="minValue",e.maxValue="maxValue",e.minLength="minLength",e.maxLength="maxLength",e.css="css",e.style="style",e.theme="theme",e.errorMessage="errorMessage",e.description="description",e.none="none",e))(Ar||{}),Fr=(e=>(e.Continue="Continue",e.Stop="Stop",e))(Fr||{}),dp=Object.defineProperty,cp=Object.getOwnPropertyDescriptor,Ai=(e,t,a,s)=>{for(var i=s>1?void 0:s?cp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&dp(t,a,i),i};let Pa=null,va=class extends Ft{constructor(){super(...arguments),this.baseUrl="",this.route="",this.consumedRoute="",this.formerState={},this.applyRules=()=>{const e=this.component.rules;if(e&&e.length>0){const t=this.state,a=this.data,s=this.appState,i=this.appData,r=this.component,n=y=>Ws(y,t,a,{appState:s,appData:i,component:r}),d=y=>Hs(y,t,a,s,i,{component:r}),c=["state","data","appState","appData","component"],u=[t,a,s,i,r],m={...this.state},v={...this.data};let f=!1,g=!1;for(let y=0;y<e.length;y++){const $=e[y];try{if(n($.filter)){if(Oe.SetStateValue==$.action||Oe.SetDataValue==$.action){const E=Oe.SetStateValue==$.action?m:v,q=$.fieldName.split(",");for(let V=0;V<q.length;V++){const C=q[V];if(!E[C]||E[C]!=$.value){const A=$.expression?d($.expression):$.value,G=Ar.none==$.fieldAttribute?C:C+"."+$.fieldAttribute;A!=E[G]&&(E[G]=A,Oe.SetStateValue==$.action&&(f=!0),Oe.SetDataValue==$.action&&(g=!0))}}}if(Oe.RunAction==$.action&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:$.actionId},bubbles:!0,composed:!0})),Oe.RunJS==$.action&&new Function(...c,$.value)(...u),Oe.SetAttributeValue==$.action){const E=$.expression?n($.expression):$.value;if($.fieldAttribute=="disabled"){E?this.shadowRoot?.getElementById($.fieldName)?.setAttribute($.fieldAttribute,"disabled"):this.shadowRoot?.getElementById($.fieldName)?.removeAttribute($.fieldAttribute);continue}this.shadowRoot?.getElementById($.fieldName)?.setAttribute($.fieldAttribute,E)}if(Oe.SetCssClass==$.action&&this.shadowRoot?.getElementById($.fieldName)?.setAttribute("class",$.value),Oe.SetStyle==$.action&&this.shadowRoot?.getElementById($.fieldName)?.style.setProperty($.expression,$.value),Fr.Stop==$.result)break}}catch(E){console.error("rule failed",$,E)}}f&&(this.state=m),g&&(this.data=v),f&&this.checkValidations()}},this.skipValidation=(e,t)=>e&&t.fieldId&&!e.includes(t.fieldId)||!e&&t.fieldId&&t.fieldId.includes("-"),this.checkValidations=e=>{const t=e?e.split(","):void 0,a=this.component.validations;let s=!0,i=!1;const r=this.data??{},n={...this.data??{},errors:{}};if(a){for(let d=0;d<a.length;d++){const c=a[d];if(this.skipValidation(t,c))continue;const u=(c.fieldId??"_component").split(",");for(let m=0;m<u.length;m++){const v=u[m];n.errors[v]=[]}}for(let d=0;d<a.length;d++){const c=a[d];if(!this.skipValidation(t,c))try{const u=c.condition&&c.condition.includes("${")?this._evalTemplate(c.condition):this._evalExpr(c.condition);if(c.condition&&!u){s=!1;const v=(c.fieldId??"_component").split(",");for(let f=0;f<v.length;f++){const g=v[f];let y=n.errors[g];if(y||(n.errors[g]=[]),y=n.errors[g],!r[g]){let $=c.message;try{$=this._evalTemplate(c.message)}catch{}y.push($)}}}}catch(u){console.error("validation failed",c,u)}}for(let d=0;d<a.length;d++){const c=a[d];if(this.skipValidation(t,c))continue;const u=(c.fieldId??"_component").split(",");for(let m=0;m<u.length;m++){const v=u[m];if(r.errors?[v].join(","):n.errors==""&&[v].join(",")){i=!0;break}}}(r.errors?["_component"].join(","):n.errors==""&&["_component"].join(","))&&(i=!0)}n._valid=s,n._valid!=r._valid&&(i=!0),i&&(this.data=n)},this._autoSaveTimers=new Map,this.onChange=()=>{this.applyRules()},this.closeModalRequestedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&this.closeModal()},this.resetFilters=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail,a={};t.fieldIds.forEach(s=>{a[s]=void 0}),a.searchText=void 0,this.state={...this.state,...a}}},this.dataChangedListener=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail,a={};a[t.key]=t.value,e.type=="data-changed"&&(this.data={...this.data,...a})}},this.valueChangedListener=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail;if(e.type=="value-changed"){const a={...this.state};a[t.fieldId]=t.value,this.state=a,(this.state[t.fieldId]||this.formerState[t.fieldId])&&this.state[t.fieldId]!=this.formerState[t.fieldId]&&this.component?.confirmOnNavigationIfDirty&&this.dispatchEvent(new CustomEvent("dirty",{detail:e.detail,bubbles:!0,composed:!0}));const s=this.component;s.triggers?.filter(i=>i.type==bt.OnValueChange).filter(i=>!i.propertyName||t.fieldId==i.propertyName).forEach(i=>{(!i.condition||this._evalExpr(i.condition))&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:i.actionId},bubbles:!0,composed:!0}))}),s.triggers?.filter(i=>i.type==bt.AutoSave).forEach(i=>{const r=i.actionId,n=this._autoSaveTimers.get(r);n!==void 0&&clearTimeout(n),this._autoSaveTimers.set(r,setTimeout(()=>{this._autoSaveTimers.delete(r),this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:i.actionId},bubbles:!0,composed:!0}))},i.debounceMillis??800))})}}},this.actionRequestedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&this.manageActionRequestedEvent(e)},this.manageActionRequestedEvent=e=>{const t=e.detail;if(e.type=="action-requested"){e.preventDefault(),e.stopPropagation();const a=this.component,s=a.actions?.find(i=>i.id==t.actionId||i.id.endsWith("*")&&t.actionId.startsWith(i.id.replace("*","")));if(s){if(s&&s.rowsSelectedRequired&&(!this.state.crud_selected_items||this.state.crud_selected_items.length==0)){this.notify("You first need to select some rows");return}if(s&&s.validationRequired){const r=Pa??this;if(Pa=null,r.checkValidations(s.fieldsToValidate),!r.data._valid){r.notifyValidationErrors();return}}Pa=null;const i={...t,initiatorComponentId:this.id};s&&s.confirmationRequired?this.callAfterConfirmation(s,()=>this.requestActionCallToServerOrBubble(i,a,s)):this.requestActionCallToServerOrBubble(i,a,s)}else{const i={...t.parameters};i.initiatorState||(i.initiatorState=this.state),Pa||(Pa=this),this.dispatchEvent(new CustomEvent(e.type,{detail:{...e.detail,parameters:i},bubbles:!0,composed:!0}))}}},this.buildFieldLabelMap=()=>{const e={},t=a=>{if(a)for(const s of a){const i=s.metadata;if(i?.type===h.FormField){const r=i;r.fieldId&&r.label&&(e[r.fieldId]=r.label)}t(s.children)}};return t(this.component?.children),e},this.notifyValidationErrors=()=>{const e=this.data?.errors??{},t=this.buildFieldLabelMap(),a=[];if(Object.entries(e).forEach(([i,r])=>{if(!Array.isArray(r))return;const n=i==="_component"?void 0:t[i]??i;r.forEach(d=>{d&&!a.some(c=>c.label===n&&c.msg===d)&&a.push({label:n,msg:d})})}),a.length===0){this.notify("There are validation errors");return}const s=document.createElement("vaadin-notification");s.position="bottom-end",s.setAttribute("theme","error"),s.duration=Math.max(3e3,1500+a.length*1e3),s.renderer=i=>{qs(o`
            ...
            `:l}</div>`}_render(){if(this.component?.type==pe.ClientSide){const e=this.component;return e.metadata?.type==h.Page?Wi(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):e.metadata?.type==h.Crud?Gi(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):W.get()?.renderClientSideComponent(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!1)}return o`
            <mateu-api-caller 
            ...
            ${this.component?.children?.map(e=>{if(e.type==pe.ClientSide){const t=e;if(t.metadata?.type==h.Page)return Wi(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0);if(t.metadata?.type==h.Crud)return Gi(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0)}return k(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData)})}
            </mateu-api-caller>
        `}};va.styles=w`
        :host {
        }
  ...
  `;fe([p()],te.prototype,"consumedRoute",2);fe([p()],te.prototype,"serverSideType",2);fe([p()],te.prototype,"uriPrefix",2);fe([p()],te.prototype,"overrides",2);fe([p()],te.prototype,"homeRoute",2);fe([p()],te.prototype,"route",2);fe([p()],te.prototype,"top",2);fe([p()],te.prototype,"instant",2);fe([p()],te.prototype,"initialState",2);fe([p()],te.prototype,"appState",2);fe([p()],te.prototype,"appData",2);fe([b()],te.prototype,"fragment",2);te=fe([x("mateu-ux")],te);var mp=Object.defineProperty,Pe=(e,t,a,s)=>{for(var i=void 0,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(t,a,i)||i);return i&&mp(t,a,i),i};class be extends Ha{constructor(){super(...arguments),this.baseUrl="",this.route="",this.consumedRoute="",this.state={},this.appState={},this.appData={},this.selectedRoute=void 0,this.selectedConsumedRoute=void 0,this.selectedBaseUrl=void 0,this.selectedServerSideType=void 0,this.selectedUriPrefix=void 0,this.instant=void 0,this.lastActionServerSideType=void 0,this.lastActionInitiatorComponentId=void 0,this.captureActionSST=t=>{const a=t.detail;typeof a?.serverSideComponentRoute=="string"&&a.serverSideComponentRoute.indexOf("_embeddedMediator=1")>=0||a?.serverSideType&&(this.lastActionServerSideType=a.serverSideType,this.lastActionInitiatorComponentId=a.initiatorComponentId)},this.handleUnhandledAction=t=>{if(this.appMetadata()?.variant==xe.MEDIATOR)return;const a=t.detail;t.preventDefault(),t.stopPropagation();const s=this.renderRoot?.querySelector("#"+this.contentUxId);!s||typeof s.manageActionEvent!="function"||(this.lastActionServerSideType=this.selectedServerSideType,this.lastActionInitiatorComponentId=s.id,s.manageActionEvent(new CustomEvent("server-side-action-requested",{detail:{route:s.route??this.selectedRoute??"",consumedRoute:s.consumedRoute??this.selectedConsumedRoute??"",componentState:a.parameters?.initiatorState??{},parameters:a.parameters,actionId:a.actionId,serverSideType:this.selectedServerSideType??"",initiatorComponentId:s.id,initiator:s}})))},this.updateRoute=t=>{t.preventDefault(),t.stopPropagation();const a=t.detail;this.selectedConsumedRoute=a.consumedRoute,this.selectedBaseUrl=a.baseUrl,this.selectedRoute=a.route,this.selectedServerSideType=a.serverSideType,this.selectedUriPrefix=a.uriPrefix,this.instant=Q()}}appMetadata(){return this.component?.metadata}isActive(t){const a=this.appMetadata();return this.selectedRoute===t.path?!0:!this.selectedRoute&&this.route===this.consumedRoute&&t.path===a?.homeRoute}get contentUxId(){return this._contentUxId||(this._contentUxId="ux_"+(this.route||"root").replace(/[^a-zA-Z0-9]/g,"_")+"_app"),this._contentUxId}connectedCallback(){super.connectedCallback(),this.addEventListener("server-side-action-requested",this.captureActionSST,!0),this.addEventListener("action-requested",this.handleUnhandledAction),this.innerFragmentSubscription=gt.subscribe(t=>{const a=t.fragment;if(a&&this.lastActionInitiatorComponentId&&a.targetComponentId===this.lastActionInitiatorComponentId&&a.state?._route!==void 0){const s=a.state._route;if(s!==""&&!s.startsWith("/")){this.lastActionInitiatorComponentId=void 0,this.lastActionServerSideType=void 0;return}const i=a.state._componentRoute||"",r=this.appMetadata(),n=this.renderRoot?.querySelector("#"+this.contentUxId),d=n?.consumedRoute&&n.consumedRoute!=="_empty"?n.consumedRoute:"",c=i||this.selectedConsumedRoute||d||r?.homeConsumedRoute||"",u=c+s;this.lastActionInitiatorComponentId=void 0,u!==this.selectedRoute&&(this.selectedConsumedRoute=c,this.selectedRoute=u,this.lastActionServerSideType&&(this.selectedServerSideType=this.lastActionServerSideType),this.state&&this.state._route!=null&&(this.state._route=void 0),this.instant=Q()),this.lastActionServerSideType=void 0}})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("server-side-action-requested",this.captureActionSST,!0),this.removeEventListener("action-requested",this.handleUnhandledAction),this.innerFragmentSubscription?.unsubscribe()}navigate(t){const a=this.appMetadata();if(a?.variant!=xe.MEDIATOR&&!t.actionId&&(!t.baseUrl||t.baseUrl===this.baseUrl)&&(!t.serverSideType||t.serverSideType===a?.serverSideType)&&t.path!=null){if(!$t.confirmLeave())return;this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:t.path},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("navigate-to-requested",{detail:{route:t.path},bubbles:!0,composed:!0}));return}this.selectedConsumedRoute=t.consumedRoute,this.selectedBaseUrl=t.baseUrl,this.selectedRoute=t.path,this.selectedServerSideType=t.serverSideType,this.selectedUriPrefix=t.uriPrefix,this.instant=Q(),this.route=t.path??this.route,this.dispatchEvent(new CustomEvent("update-route",{detail:{route:t.path},bubbles:!0,composed:!0}))}renderContent(){const t=this.appMetadata();if(!t)return o`${l}`;const a=this;return o`
            ...
            <label class="root">
                ...
                ${this.opened?this.renderPanel():l}
            </label>`:o``}};De.SEARCHABLE_THRESHOLD=7;De.styles=w`
        :host {
            display: inline-flex;
            position: relative;
            flex-shrink: 0;
    ...
    `;ia([p()],De.prototype,"selector",2);ia([p()],De.prototype,"app",2);ia([p()],De.prototype,"baseUrl",2);ia([b()],De.prototype,"opened",2);ia([b()],De.prototype,"searchText",2);ia([b()],De.prototype,"searchedOptions",2);De=ia([x("mateu-app-context-picker")],De);var bp=Object.defineProperty,gp=Object.getOwnPropertyDescriptor,Nr=(e,t,a,s)=>{for(var i=s>1?void 0:s?gp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&bp(t,a,i),i};let Yi=class extends be{constructor(){super(...arguments),this.openHeaderMenu=void 0,this.runHeaderAction=async(e,t)=>{if(t)try{await xr(e,this,t)}catch(a){const s=document.createElement("div");s.className="pf-v6-c-alert pf-m-danger",s.style.cssText="position: fixed; bottom: 1rem; left: 1rem; z-index: 10000; background: var(--pf-t--global--color--status--danger--default, #b1380b); color: #fff; padding: .75rem 1rem; border-radius: 8px; box-shadow: 0 4px 12px rgba(0,0,0,.25); font-size: .875rem;",s.textContent="La acción falló: "+a,document.body.appendChild(s),setTimeout(()=>s.remove(),6e3)}},this.headerButtonStyle="background: var(--pf-t--global--color--brand--default, #0066cc); color: #fff; border: 1px solid transparent; border-radius: 999px; height: 2rem; padding: 0 .875rem; font-family: inherit; font-size: .8125rem; cursor: pointer; white-space: nowrap;",this.renderContextActions=e=>o`
    ...
    `,this.renderItem=e=>e.submenus&&e.submenus.length>0?o`
            ...
            </div>`}};Nr([b()],Yi.prototype,"openHeaderMenu",2);Yi=Nr([x("mateu-redhat-app")],Yi);const $p=(e,t,a,s,i)=>{const r=t.metadata;return o`
        <mateu-redhat-app
                id="${e.id}_ux"
                route="${r.homeRoute}"
                ...
                style="width: 100%;"
        ></mateu-redhat-app>
    `},Et=(e,t,a)=>e?e.includes("${")?new Function("state","data","return `"+e+"`")(t??{},a??{}):e:"",Ca=(e,t,a,s,i,r,n)=>(t.children??[]).map(d=>k(e,d,a,s,i,r,n)),yp=e=>{const t=e.color;return t==="primary"?"pf-m-primary":t==="error"||t==="danger"?"pf-m-danger":t==="success"?"pf-m-primary":"pf-m-secondary"},xp=(e,t,a)=>{const s=e.metadata,i=Et(s.label,t,a);return o`
        <button id="${e.id}" type="button"
                class="pf-v6-c-button ${yp(s)}"
                data-action-id="${s.actionId}"
                ?disabled="${s.disabled}"
                slot="${e.slot??l}"
                @click="${r=>er(r,s)}">
            <span class="pf-v6-c-button__text">${i}</span>
        </button>`},wp=e=>{switch(e){case"h1":return"pf-m-2xl";case"h2":return"pf-m-xl";case"h3":return"pf-m-lg";case"h4":case"h5":case"h6":return"pf-m-md";default:return null}},kp=(e,t,a)=>{const s=e.metadata,i=Et(s.text,t,a),r=wp(s.container);return r?o`<h2 class="pf-v6-c-title ${r}" style="${e.style??""}">${i}</h2>`:o`<div class="pf-v6-c-content" style="${e.style??""}"><p>${i}</p></div>`},Mr=e=>{const t=e?.metadata?.type;return t==="FormRow"||t==="FormItem"?(e.children??[]).flatMap(Mr):[e]},_p=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=(t.children??[]).flatMap(Mr),u=Math.max(1,Math.min(d.maxColumns??1,c.length)),m=v=>{const f=v?.metadata;if(f?.type!=="FormField")return"min-width:0;";const g=f?.colspan??1;return f?.stereotype==="grid"&&g<=1?"min-width:0; grid-column: 1 / -1;":g>1?`min-width:0; grid-column: span ${Math.min(g,u)};`:"min-width:0;"};return o`
        ...
        </div>`},Cp=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=t.children??[],u=c.filter($=>$.slot!=="buttons"&&$.slot!=="toolbar"),m=c.filter($=>$.slot==="toolbar"),v=c.filter($=>$.slot==="buttons"),f=Et(d.title,s,i),g=Et(d.subtitle,s,i),y=$=>k(e,$,a,s,i,r,n);return o`
        <div>
            ${d.noHeader?l:o`
        ...
        </div>`},Sp=(e,t,a,s,i,r,n)=>{const d=Et(t.metadata.title,s,i);return o`
        ...
        </div>`},Ip=(e,t,a,s,i,r,n)=>{const d=Et(t.metadata.title,s,i);return o`
        <div style="margin:.5rem 0;" slot="${t.slot??l}">
            ${d?o`<h3 class="pf-v6-c-title pf-m-md" style="margin-bottom:.5rem;">${d}</h3>`:l}
            ${Ca(e,t,a,s,i,r,n)}
        </div>`},Ep=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=m=>m?k(e,m,a,s,i,r,n):l,u=typeof d.title=="string"?d.title:"";return o`
        ...
        </div>`},Pp=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d?.spacing===!1?"0":"var(--pf-t--global--spacer--md, 1rem)";return o`<div style="display:flex; flex-direction:row; gap:${c}; ${d?.wrap?"flex-wrap:wrap;":""} ${d?.fullWidth?"width:100%;":""} ${t.style??""}" slot="${t.slot??l}">${Ca(e,t,a,s,i,r,n)}</div>`},Tp=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d?.spacing===!1?"0":"var(--pf-t--global--spacer--sm, .75rem)";return o`<div style="display:flex; flex-direction:column; gap:${c}; ${d?.fullWidth?"width:100%;":""} ${t.style??""}" slot="${t.slot??l}">${Ca(e,t,a,s,i,r,n)}</div>`},Op=(e,t,a,s,i,r,n)=>{const d=t.metadata?.orientation==="vertical"?"column":"row";return o`<div style="display:flex; flex-direction:${d}; gap:1rem; width:100%; ${t.style??""}" slot="${t.slot??l}">
        ${(t.children??[]).map(c=>o`<div style="flex:1; min-width:0;">${k(e,c,a,s,i,r,n)}</div>`)}
    </div>`},Rp=e=>{const t=e.metadata,a=t.color;return o`<span class="pf-v6-c-label ${a==="success"?"pf-m-green":a==="error"||a==="danger"?"pf-m-red":a==="warning"?"pf-m-gold":a==="info"?"pf-m-blue":""}" slot="${e.slot??l}"><span class="pf-v6-c-label__content">${t.text??""}</span></span>`},zp=e=>{const t=e.metadata;return o`<a class="pf-v6-c-button pf-m-link pf-m-inline" href="${t.url??"#"}" slot="${e.slot??l}"><span class="pf-v6-c-button__text">${t.text??t.url??""}</span></a>`},Fs=(e,t)=>{t&&e?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t,parameters:{}},bubbles:!0,composed:!0}))},qr=(e,t,a)=>o`
    <div class="pf-v6-c-backdrop" style="position:fixed; inset:0; display:flex; align-items:center; justify-content:center; z-index:1000;">
    ...
    </div>`,Lp=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=u=>u?k(e,u,a,s,i,r,n):l;return qr(Et(d.headerTitle,s,i),o`${c(d.content)}${Ca(e,t,a,s,i,r,n)}`,c(d.footer))},Dp=(e,t,a,s,i,r,n)=>{const d=t.metadata,c=d.content?k(e,d.content,a,s,i,r,n):l,u=(m,v,f)=>o`<button class="pf-v6-c-button ${f}" type="button" @click="${g=>Fs(g.target,v)}"><span class="pf-v6-c-button__text">${m}</span></button>`;return qr(Et(d.header,s,i),c,o`
        <button class="pf-v6-c-button pf-m-primary" type="button" @click="${m=>Fs(m.target,d.confirmActionId)}"><span class="pf-v6-c-button__text">${d.confirmText??"OK"}</span></button>
        ${d.canReject?u(d.rejectText??"No",d.rejectActionId,"pf-m-secondary"):l}
        ${d.canCancel?u(d.cancelText??"Cancel",d.cancelActionId,"pf-m-link"):l}`)},Ap=(e,t)=>{const a=e?.data?.[t?.id??""]?.page??{},s=a.totalElements??0,i=a.pageSize??10,r=a.pageNumber??0,n=Math.max(1,Math.ceil(s/(i||1))),d=c=>e.pageChanged?.({detail:{page:c}});return s===0?o``:o`
        ...
        </div>`},Fp=e=>e==="SUCCESS"?"pf-m-green":e==="DANGER"?"pf-m-red":e==="WARNING"?"pf-m-gold":e==="INFO"?"pf-m-blue":"pf-m-outline",Np=e=>{if(!e)return o``;const t=e.message??String(e);return o`<span class="pf-v6-c-label pf-m-compact ${Fp(e.type)}"><span class="pf-v6-c-label__content">${t}</span></span>`},Mp=(e,t)=>{const a=e[t.id];return a==null?"":t.dataType==="bool"||typeof a=="boolean"?a?"✓":"✗":String(typeof a=="object"?a.message??a.label??a.text??a.name??a.value??"":a)},qp=e=>{if(e==null)return"";const t=Number(e);return isNaN(t)?String(e):new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(t)},it=(e,t,a)=>o`
    <button class="pf-v6-c-button pf-m-link pf-m-inline" type="button" title="${t||l}" @click="${a}">
        <span class="pf-v6-c-button__text">${e}</span>
    </button>`,fa=(e,t,a)=>{const s=t.dataType??"",i=t.stereotype??"",r=e[t.id];if(s==="status")return Np(r);if(s==="bool")return o`${r?"✓":"✗"}`;if(s==="money"||i==="money")return o`${qp(r)}`;if(s==="link"||i==="link"){const n=typeof r=="object"?r?.text??"":t.text||(r??"");if(t.actionId)return it(String(n),t.label,c=>{c.stopPropagation(),a(t.actionId,e)});const d=typeof r=="object"?r?.href??r?.url??"":r??"";return o`<a href="${d}">${n||d}</a>`}if(i==="html")return o`${ye(r??"")}`;if(i==="image"){const n=typeof r=="object"?r?.url??r?.src??"":r??"";return n?o`<img src="${n}" alt="" style="max-height: 3rem; object-fit: contain;" />`:o``}if(s==="action"){if(t.id==="select")return it("Select","Select",d=>{d.stopPropagation(),a("action-on-row-select",{_clickedRow:e})});const n=r?.methodNameInCrud?r:e.action?.methodNameInCrud?e.action:{methodNameInCrud:t.id,label:t.label};return it(n.label??"",n.label,d=>{d.stopPropagation(),a("action-on-row-"+n.methodNameInCrud,{_clickedRow:e})})}if(s==="actionGroup"||s==="menu"){const n=typeof r=="object"&&r?.actions?r.actions:Array.isArray(r)?r:[];return o`${n.map(d=>it(d.label??d.text??d.methodNameInCrud??"",d.label,c=>{c.stopPropagation(),a("action-on-row-"+d.methodNameInCrud,{_clickedRow:e})}))}`}if(i==="button"||t.actionId){const n=t.text||(r??t.label??"");return it(String(n),t.label,d=>{d.stopPropagation(),a(t.actionId??t.id,e)})}return r==null?o``:typeof r=="object"?o`${r.label??r.name??r.message??""}`:o`${r}`},Ua=e=>e.dataType==="action"||e.dataType==="actionGroup"||e.dataType==="menu"||e.stereotype==="button",ei=e=>o`
    <div class="pf-v6-c-empty-state pf-m-sm">
    ...
    </div>`,Up=e=>(e.metadata?.columns??[]).map(t=>t.metadata),vs=e=>e.find(t=>t.identifier)?.id??e.find(t=>t.id==="id")?.id,Sa=e=>(t,a)=>e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t,parameters:a},bubbles:!0,composed:!0})),fs=(e,t,a,s="view")=>{const i=vs(t);i&&a[i]!==void 0&&(e.state={...e.state,_selectedId:String(a[i])}),Sa(e)(s,a)},$i=(e,t,a)=>{const s=vs(t),i=e.state?._selectedId??e.appState?._splitDetailId;return!!s&&i!==void 0&&String(a[s])===String(i)},Ur=(e,t,a)=>{const s=[];for(const i of e){const r=t[i.id];if(i.dataType==="action"){const n=r?.methodNameInCrud?r:t.action?.methodNameInCrud?t.action:{methodNameInCrud:i.id,label:i.label};s.push(it(n.label??"",n.label,d=>{d.stopPropagation(),a("action-on-row-"+n.methodNameInCrud,{_clickedRow:t})}))}else(i.dataType==="actionGroup"||i.dataType==="menu")&&(r?.actions??[]).forEach(d=>s.push(it(d.label??"",d.label,c=>{c.stopPropagation(),a("action-on-row-"+d.methodNameInCrud,{_clickedRow:t})})))}return s.length?o`
        <div style="display: flex; flex-wrap: wrap; gap: .5rem; margin-top: .25rem;">${s}</div>`:l},jp=(e,t,a,s,i,r)=>{const n=Sa(e),d=e?.data?.[e.id],c=r?.groupBy,u=Gs(a,c,d?.groups),m=Xs(t,d,c),v=Ys(c,t.map(C=>C.id)),f=e.id+"_selected_items",g=e?.state?.[f]??[],y=C=>{e.state[f]=C,e.requestUpdate?.()},$=(C,A)=>{y(A?[...g.filter(G=>G!==C),C]:g.filter(G=>G!==C))},E=a.length>0&&a.every(C=>g.includes(C)),q=i?o`
        <th class="pf-v6-c-table__th pf-v6-c-table__check" role="columnheader" scope="col">
            <input type="checkbox" aria-label="Select all rows"
                   .checked="${E}"
                   @change="${C=>y(C.target.checked?[...a]:[])}" />
        </th>`:l,V=C=>i?o`
        <td class="pf-v6-c-table__td pf-v6-c-table__check" role="cell">
            <input type="checkbox" aria-label="Select row"
                   .checked="${g.includes(C)}"
        ...
        <table class="pf-v6-c-table pf-m-grid-md" role="grid">
            <thead class="pf-v6-c-table__thead"><tr class="pf-v6-c-table__tr" role="row">
                ${q}
                ${t.map(C=>o`<th class="pf-v6-c-table__th" role="columnheader" scope="col">${C.label??""}</th>`)}
            </tr></thead>
            <tbody class="pf-v6-c-table__tbody" role="rowgroup">
                ${a.length===0?o`<tr class="pf-v6-c-table__tr" role="row"><td class="pf-v6-c-table__td" role="cell" colspan="${t.length+(i?1:0)}">${ei(s)}</td></tr>`:l}
                ${u.map(C=>Oa(C)?o`<tr class="pf-v6-c-table__tr" role="row"
                    ...
                    ${t.map(A=>o`<td class="pf-v6-c-table__td" role="cell" style="font-weight: 600;">${Js(C,A,v)}</td>`)}
                </tr>`:o`<tr class="pf-v6-c-table__tr" role="row">
                    ${V(C)}
                    ${t.map(A=>o`<td class="pf-v6-c-table__td" role="cell" data-label="${A.label??""}">${fa(C,A,n)}</td>`)}
                </tr>`)}
            </tbody>
            ${m?o`
            <tfoot class="pf-v6-c-table__tfoot" role="rowgroup">
                <tr class="pf-v6-c-table__tr" role="row" style="border-top: 2px solid var(--pf-t--global--border--color--default, #c7c7c7);">
                    ...
                    ${t.map(C=>o`<td class="pf-v6-c-table__td" role="cell" style="font-weight: 700;">${m[C.id]??""}</td>`)}
                </tr>
            </tfoot>`:l}
        </table>`},Bp=(e,t,a,s)=>{const i=Sa(e),r=Ri(t),n=r.find(u=>u.identifier)??r[0],d=r.filter(u=>u!==n&&!Ua(u)),c=t.filter(u=>Ua(u));return o`
        <ul class="pf-v6-c-data-list pf-m-compact" role="list" style="width: 100%;">
            ${a.length===0?o`<li class="pf-v6-c-data-list__item">${ei(s)}</li>`:l}
            ${a.map(u=>o`
                <li class="pf-v6-c-data-list__item ${$i(e,t,u)?"pf-m-selected":""}"
                    style="cursor: pointer; ${$i(e,t,u)?"background: var(--pf-t--global--background--color--action--plain--clicked, #f0f0f0);":""}"
                    @click="${()=>fs(e,t,u)}">
            ...
            `)}
        </ul>`},Vp=(e,t,a,s)=>{const i=Sa(e),r=t.slice(0,6),n=r.filter(g=>g.stereotype==="image"),d=r.find(g=>g.identifier)??r[0],c=g=>!!g.actionId,u=r.find(g=>g.id==="select"&&g.dataType==="action"),m=!!u,v=r.filter(g=>g!==d&&!n.includes(g)&&!c(g)&&!Ua(g)),f=r.filter(g=>Ua(g)&&!(m&&g===u));return o`
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 1rem; padding: .5rem 0;">
            ${a.length===0?o`<div style="grid-column: 1 / -1;">${ei(s)}</div>`:l}
            ${a.map(g=>o`
                <div class="pf-v6-c-card pf-m-clickable ${$i(e,t,g)?"pf-m-selected":""}"
                     style="cursor: pointer;"
                     @click="${()=>m?i("action-on-row-select",{_clickedRow:g}):fs(e,t,g)}">
            ...
            `)}
        </div>`},Hp=(e,t,a,s)=>{const i=Sa(e),r=Ri(t),n=r.find(u=>u.identifier)??r[0],d=r.filter(u=>u!==n),c=e.selectedItem;return o`
        ...
        </div>`},Ns=new WeakMap,Wp=(e,t,a,s)=>{const i=Sa(e),r=vs(t),n=t[0],d=t.slice(1),c=!!n?.actionId,u=Ns.get(e)??new Set;Ns.set(e,u);const m=y=>r&&y[r]!==void 0?String(y[r]):y,v=(y,$)=>{y.stopPropagation();const E=m($);u.has(E)?u.delete(E):u.add(E),e.requestUpdate()},f=(y,$)=>{y.stopPropagation(),fs(e,t,$)},g=(y,$)=>{const E=Array.isArray(y.children)?y.children:[],q=E.length>0,V=u.has(m(y));return o`
            <div>
                <div style="display: flex; align-items: center; gap: .5rem; padding: .375rem .5rem .375rem ${.5+$*1.5}rem; border-bottom: 1px solid var(--pf-t--global--border--color--default, #e0e0e0); ${$i(e,t,y)?"background: var(--pf-t--global--background--color--action--plain--clicked, #f0f0f0);":""}">
                    ${q?o`
                        <button class="pf-v6-c-button pf-m-plain" type="button" aria-expanded="${!V}"
                                style="padding: 0 .25rem; width: 1.5rem;"
                                @click="${C=>v(C,y)}">${V?"▸":"▾"}</button>
                    `:o`<span style="display: inline-block; width: 1.5rem;"></span>`}
                    <span style="flex: 1;">${n?y[n.id]??"":""}</span>
                    ${d.filter(C=>C.id!=="select").map(C=>y[C.id]!=null&&!Ua(C)?o`<span style="font-size: .875rem; color: var(--pf-t--global--text--color--subtle, #4d4d4d);">${C.label}: ${Mp(y,C)}</span>`:l)}
                    ${c&&y?.viewable!==!1?it("View","View",C=>f(C,y)):l}
                    ${d.some(C=>C.id==="select")?it("Select","Select",C=>{C.stopPropagation(),i("action-on-row-select",{_clickedRow:y})}):l}
                </div>
                ${q&&!V?E.map(C=>g(C,$+1)):l}
            </div>`};return o`
        <div role="tree" style="width: 100%;">
            ${a.length===0?ei(s):a.map(y=>g(y,0))}
        </div>`},Gp=(e,t)=>{const a=e?.effectiveGridLayout??"table",s=Up(t),i=e?.data?.[e.id]?.page?.content??[],r=e?.state?.[t.id??""]?.emptyStateMessage??t.metadata?.emptyStateMessage;return a==="list"?Bp(e,s,i,r):a==="cards"?Vp(e,s,i,r):a==="masterDetail"?Hp(e,s,i,r):a==="tree"?Wp(e,s,i,r):jp(e,s,i,r,!!t.metadata?.rowsSelectionEnabled,t.metadata)};var Kp=Object.defineProperty,Yp=Object.getOwnPropertyDescriptor,sa=(e,t,a,s)=>{for(var i=s>1?void 0:s?Yp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Kp(t,a,i),i};let Pt=class extends _{constructor(){super(...arguments),this.onInput=e=>this.emit(e.target.value),this.onNumber=e=>{const t=e.target.value;this.emit(t===""?null:Number(t))},this.onCheck=e=>this.emit(e.target.checked)}createRenderRoot(){return this}get value(){const e=this.field?.fieldId;return e&&this.state&&e in this.state?this.state[e]:this.field?.initialValue??""}emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e,fieldId:this.field?.fieldId},bubbles:!0,composed:!0}))}get options(){return this.field?.options??[]}isCheckbox(){return this.field?.dataType==="bool"||this.field?.stereotype==="toggle"}inputType(){const e=this.field?.stereotype,t=this.field?.dataType;return e==="email"?"email":e==="password"?"password":t==="integer"||t==="number"?"number":t==="date"?"date":t==="dateTime"?"datetime-local":t==="time"?"time":"text"}renderGrid(e){const t=d=>d.flatMap(c=>c.children?.length?t(c.children):[c]),a=t(e.columns??[]).map(d=>d.metadata).filter(Boolean),s=Array.isArray(this.value)?this.value:e.remoteCoordinates?this.data?.[e.fieldId??""]?.content??[]:[],i=(d,c)=>this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:d,parameters:c},bubbles:!0,composed:!0})),r=e.onItemSelectionActionId,n=r?d=>i(r,{_clickedRow:d}):void 0;return o`
            ...
            </div>`}};sa([p({attribute:!1})],Pt.prototype,"field",2);sa([p({attribute:!1})],Pt.prototype,"state",2);sa([p({attribute:!1})],Pt.prototype,"data",2);sa([p({attribute:!1})],Pt.prototype,"appState",2);sa([p({attribute:!1})],Pt.prototype,"appData",2);sa([p({attribute:!1})],Pt.prototype,"labelAlreadyRendered",2);Pt=sa([x("mateu-redhat-field")],Pt);function Ms(e){const t=typeof e=="number"?e:parseFloat(String(e??""));if(isNaN(t))return String(e??"");try{return new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(t)}catch{return t.toFixed(2)}}var Jp=Object.defineProperty,Xp=Object.getOwnPropertyDescriptor,ct=(e,t,a,s)=>{for(var i=s>1?void 0:s?Xp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Jp(t,a,i),i};let Je=class extends _{constructor(){super(...arguments),this.selected=0}createRenderRoot(){return this}label(e){const t=e?.metadata?.label;return t&&typeof t=="string"&&t.includes("${")&&this.container?._evalTemplate?this.container._evalTemplate(t):t??""}render(){const e=this.component?.children??[],t=e[this.selected];return o`
            <div>
            ...
            </div>`}};ct([p({attribute:!1})],Je.prototype,"component",2);ct([p({attribute:!1})],Je.prototype,"container",2);ct([p()],Je.prototype,"baseUrl",2);ct([p({attribute:!1})],Je.prototype,"compState",2);ct([p({attribute:!1})],Je.prototype,"compData",2);ct([p({attribute:!1})],Je.prototype,"appState",2);ct([p({attribute:!1})],Je.prototype,"appData",2);ct([b()],Je.prototype,"selected",2);Je=ct([x("mateu-redhat-tabs")],Je);var Qp=Object.defineProperty,Zp=Object.getOwnPropertyDescriptor,ut=(e,t,a,s)=>{for(var i=s>1?void 0:s?Zp(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Qp(t,a,i),i};let Xe=class extends _{constructor(){super(...arguments),this.open={},this.initialized=!1}createRenderRoot(){return this}label(e){const t=e?.metadata?.label;return t&&typeof t=="string"&&t.includes("${")&&this.container?._evalTemplate?this.container._evalTemplate(t):t??""}render(){const e=this.component?.children??[];return this.initialized||(e.forEach((t,a)=>{t?.metadata?.active&&(this.open[a]=!0)}),this.initialized=!0),o`
            ...
            </div>`}};ut([p({attribute:!1})],Xe.prototype,"component",2);ut([p({attribute:!1})],Xe.prototype,"container",2);ut([p()],Xe.prototype,"baseUrl",2);ut([p({attribute:!1})],Xe.prototype,"compState",2);ut([p({attribute:!1})],Xe.prototype,"compData",2);ut([p({attribute:!1})],Xe.prototype,"appState",2);ut([p({attribute:!1})],Xe.prototype,"appData",2);ut([b()],Xe.prototype,"open",2);Xe=ut([x("mateu-redhat-accordion")],Xe);const eh=new Set([h.App,h.Form,h.FormField,h.FormLayout,h.FormSection,h.FormSubSection,h.Card,h.Button,h.Text,h.HorizontalLayout,h.VerticalLayout,h.SplitLayout,h.Badge,h.Anchor,h.Dialog,h.Drawer,h.ConfirmDialog,h.TabLayout,h.AccordionLayout,h.Page,h.Crud,h.Element,h.Div,h.Image,h.MicroFrontend,h.Markdown,h.Chart,h.ProgressBar,h.CustomField,h.MessageList,h.MessageInput,h.MetricCard,h.Scoreboard,h.DashboardPanel,h.DashboardLayout,h.FoldoutLayout,h.HeroSection,h.EmptyState,h.Skeleton,h.Gantt,h.PlanningBoard,h.Kanban,h.Timeline,h.ProgressSteps,h.Stat,h.Calendar,h.PricingTable,h.OrgChart,h.Heatmap,h.Funnel,h.TrendChart,h.FeatureGrid,h.Testimonials,h.Faq,h.CalloutCard,h.CommentThread,h.FileList,h.Checklist,h.ComparisonCard,h.EntityHeader,h.Meter,h.TaskProgress,h.StatusList,h.BulletedList,h.Separator,h.Notice,h.TaskQueue,h.ResourceGrid,h.OfferCard,h.AddOnPicker,h.Ledger,h.PaymentPicker,h.ProcessMonitor]);class th extends mc{rendererName(){return"redhat"}supportedClientSideTypes(){return eh}renderClientSideComponent(t,a,s,i,r,n,d,c){const u=a?.metadata?.type,m=a;return h.App==u?$p(t,m,s):h.Form==u?Cp(t,m,s,i,r,n,d):h.FormField==u?o`<mateu-redhat-field id="${m.id}" .component="${m}" .field="${m.metadata}" .state="${i}" .data="${r}" .appState="${n}" .appData="${d}" .labelAlreadyRendered="${c}"></mateu-redhat-field>`:h.FormLayout==u?_p(t,m,s,i,r,n,d):h.FormSection==u?Sp(t,m,s,i,r,n,d):h.FormSubSection==u?Ip(t,m,s,i,r,n,d):h.Card==u?Ep(t,m,s,i,r,n,d):h.Button==u?xp(m,i,r):h.Text==u?kp(m,i,r):h.HorizontalLayout==u?Pp(t,m,s,i,r,n,d):h.VerticalLayout==u?Tp(t,m,s,i,r,n,d):h.SplitLayout==u?Op(t,m,s,i,r,n,d):h.Badge==u?Rp(m):h.Anchor==u?zp(m):h.Dialog==u?Lp(t,m,s,i,r,n,d):h.ConfirmDialog==u?Dp(t,m,s,i,r,n,d):h.TabLayout==u?o`<mateu-redhat-tabs .component="${m}" .container="${t}" baseUrl="${s}" .compState="${i}" .compData="${r}" .appState="${n}" .appData="${d}"></mateu-redhat-tabs>`:h.AccordionLayout==u?o`<mateu-redhat-accordion .component="${m}" .container="${t}" baseUrl="${s}" .compState="${i}" .compData="${r}" .appState="${n}" .appData="${d}"></mateu-redhat-accordion>`:super.renderClientSideComponent(t,a,s,i,r,n,d,c)}rendersCrudLayouts(){return!0}renderTableComponent(t,a){return Gp(t,a)}renderToolbarButton(t,a,s){const i=t,r=i.color==="error"||i.color==="danger"||i.variant==="error"||i.variant==="danger"?"danger":i.buttonStyle==="primary"||i.color==="primary"?"primary":"secondary";return o`
            <button type="button"
  ...
  `;pt([p()],Ae.prototype,"baseUrl",2);pt([p()],Ae.prototype,"route",2);pt([p()],Ae.prototype,"consumedRoute",2);pt([p()],Ae.prototype,"config",2);pt([p()],Ae.prototype,"top",2);pt([p()],Ae.prototype,"pathPrefix",2);pt([b()],Ae.prototype,"instant",2);pt([p({type:Boolean})],Ae.prototype,"debug",2);Ae=pt([x("mateu-ui")],Ae);
