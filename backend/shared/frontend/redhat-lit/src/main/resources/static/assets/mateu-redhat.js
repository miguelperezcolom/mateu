...
import{d as o,A as d,a as _,j as u,r as v,i as I,k as C,m as $e,D as di,c as R,p as ze,w as H,q as Ai}from"./vendor-lit.js";import{v as Fi,b as Me,e as Ni,_ as te,n as ci,p as hi,f as st,i as da,j as ui,N as Kt,k as $a,l as Ea,m as qi}from"./vendor-vaadin.js";import{S as Mi,n as G,a as Ui,b as Bi}from"./vendor.js";import"./vendor-ui5.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function a(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=a(s);fetch(s.href,r)}})();class ji{constructor(){this.afterRenderHook=void 0,this.useShadowRoot=!0,this.componentRenderer=void 0}set(t){if(this.componentRenderer=t,typeof window<"u"){const a=t.supportedClientSideTypes?.();window.__mateuRendererInfo={name:t.rendererName?.()??t.constructor?.name??"unknown",supportedTypes:a?[...a].sort():null}}}get(){return this.componentRenderer}setUseShadowRoot(t){this.useShadowRoot=t}mustUseShadowRoot(){return this.useShadowRoot}setAfterRenderHook(t){this.afterRenderHook=t}getAfterRenderHook(){return this.afterRenderHook}}const q=new ji;var p=(e=>(e.Page="Page",e.Div="Div",e.Element="Element",e.MicroFrontend="MicroFrontend",e.Form="Form",e.Crud="Crud",e.Result="Result",e.Card="Card",e.Directory="Directory",e.Stepper="Stepper",e.HorizontalLayout="HorizontalLayout",e.VerticalLayout="VerticalLayout",e.SplitLayout="SplitLayout",e.MasterDetailLayout="MasterDetailLayout",e.TabLayout="TabLayout",e.AccordionLayout="AccordionLayout",e.FormLayout="FormLayout",e.FormRow="FormRow",e.FormItem="FormItem",e.BoardLayout="BoardLayout",e.BoardLayoutRow="BoardLayoutRow",e.BoardLayoutItem="BoardLayoutItem",e.Scroller="Scroller",e.FullWidth="FullWidth",e.Container="Container",e.FormField="FormField",e.Table="Table",e.App="App",e.Text="Text",e.Avatar="Avatar",e.Chat="Chat",e.AvatarGroup="AvatarGroup",e.Badge="Badge",e.Breadcrumbs="Breadcrumbs",e.Anchor="Anchor",e.Button="Button",e.Chart="Chart",e.Icon="Icon",e.ConfirmDialog="ConfirmDialog",e.ContextMenu="ContextMenu",e.CookieConsent="CookieConsent",e.Details="Details",e.Dialog="Dialog",e.Drawer="Drawer",e.Image="Image",e.Map="Map",e.Markdown="Markdown",e.Notification="Notification",e.ProgressBar="ProgressBar",e.Popover="Popover",e.CarouselLayout="CarouselLayout",e.Tooltip="Tooltip",e.MessageInput="MessageInput",e.MessageList="MessageList",e.CustomField="CustomField",e.MenuBar="MenuBar",e.Grid="Grid",e.GridColumn="GridColumn",e.GridGroupColumn="GridGroupColumn",e.VirtualList="VirtualList",e.FormSection="FormSection",e.FormSubSection="FormSubSection",e.Bpmn="Bpmn",e.Workflow="Workflow",e.WorkflowElk="WorkflowElk",e.FormEditor="FormEditor",e.MetricCard="MetricCard",e.Scoreboard="Scoreboard",e.DashboardPanel="DashboardPanel",e.DashboardLayout="DashboardLayout",e.FoldoutLayout="FoldoutLayout",e.HeroSection="HeroSection",e.EmptyState="EmptyState",e.Skeleton="Skeleton",e.Gantt="Gantt",e))(p||{}),ae=(e=>(e.ServerSide="ServerSide",e.ClientSide="ClientSide",e))(ae||{});const ct=(e,t,a,i,s,r,n,l,c)=>(t.slot=l,$(e,t,a,i,s,r,n,c)),$=(e,t,a,i,s,r,n,l)=>{if(!t)return o``;if(t.type==ae.ClientSide)return q.get().renderClientSideComponent(e,t,a,i,s,r,n,l);const c=e.route,h=e.consumedRoute;return o`
        <mateu-component id="${t.id}"
                        ...
                        route="${c}"
                         ...
                         .appData="${n}"
        >
       </mateu-component>`},Wi=640,Vi=e=>e>0&&e<Wi?"accordion":"tabs";var Hi=Object.defineProperty,Gi=Object.getOwnPropertyDescriptor,ca=(e,t,a,i)=>{for(var s=i>1?void 0:i?Gi(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Hi(t,a,s),s};let It=class extends I{constructor(){super(...arguments),this.tabLabels=[],this.mode="tabs",this.selected=0,this.selectedChangedListener=e=>{const t=e.detail?.value;typeof t=="number"&&t>=0&&(this.selected=t)}}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{for(const t of e)this.mode=Vi(t.contentRect.width)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.resizeObserver=void 0,this.detachTabsListener()}detachTabsListener(){this.slottedTabs?.removeEventListener("selected-changed",this.selectedChangedListener),this.slottedTabs=void 0}tabsSlotChanged(e){this.detachTabsListener();const a=e.target.assignedElements().find(i=>"selected"in i);a&&(this.slottedTabs=a,a.addEventListener("selected-changed",this.selectedChangedListener),a.selected=this.selected)}select(e){this.selected=e,this.slottedTabs&&(this.slottedTabs.selected=e)}updated(){this.slottedTabs&&this.slottedTabs.selected!=this.selected&&(this.slottedTabs.selected=this.selected)}render(){return o`
    ...
    `;ca([u({type:Array})],It.prototype,"tabLabels",2);ca([v()],It.prototype,"mode",2);ca([v()],It.prototype,"selected",2);It=ca([C("mateu-adaptive-tabs")],It);const Ki=(e,t,a,i,s,r,n)=>{const l=t.metadata;let c=t.style;return c==null&&(c=""),l.columnSpacing&&(c+="--vaadin-form-layout-column-spacing: "+l.columnSpacing+";"),l.itemRowSpacing&&(c+="--vaadin-form-layout-row-spacing: "+l.itemRowSpacing+";"),l.itemLabelSpacing&&(c+="--vaadin-form-layout-label-spacing: "+l.itemLabelSpacing+";"),l.labelsAside&&(c+="--vaadin-form-item-label-width: 92px;"),l.fullWidth&&(c+="width: 100%;"),o`
               <vaadin-form-layout 
                       ...
                       slot="${t.slot||d}"
               >
                   ${t.children?.map(h=>pi(l,e,h,a,i,s,r,n))}
               </vaadin-form-layout>
            `},pi=(e,t,a,i,s,r,n,l)=>a.type==ae.ClientSide&&a.metadata?.type==p.FormRow?Yi(e,t,a,i,s,r,n,l):e.labelsAside?Ji(t,a,i,s,r,n,l):$(t,a,i,s,r,n,l),Ji=(e,t,a,i,s,r,n)=>{if(t.type==ae.ClientSide&&t.metadata?.type==p.FormField&&t.metadata.label){const l=t.metadata,c=l.label?.includes("${")?e._evalTemplate(l.label):l.label;return o`
                       <vaadin-form-item data-colspan="${l.colspan}">
                           <label slot="label">${c}</label>
                           ${$(e,t,a,i,s,r,n,!0)}
                       </vaadin-form-item>
                   `}return $(e,t,a,i,s,r,n)},Yi=(e,t,a,i,s,r,n,l)=>o`
        <vaadin-form-row>
            ${a.children?.map(c=>pi(e,t,c,i,s,r,n,l))}
        </vaadin-form-row>
            `,Xi=(e,t,a,i,s,r,n)=>{const l=t.metadata,c=(l.padding?" padding":"")+(l.spacing?" spacing":"")+(l.spacingVariant?" spacing-"+l.spacingVariant:"")+(l.wrap?" wrap":"");let h=t.style;return l.fullWidth&&(h=h?"width: 100%;"+h:"width: 100%;"),l.justification&&(h=h?"justify-content: "+l.justification+";"+h:"justify-content: "+l.justification+";"),l.verticalAlignment&&(h=h?"align-items: "+l.verticalAlignment+";"+h:"align-items: "+l.verticalAlignment+";"),o`
    ...
    `},Zi=(e,t,a,i,s,r,n)=>{const l=t.metadata;let c=t.style;return l.fullWidth&&(c=c?"width: 100%;"+c:"width: 100%;"),o`
               <vaadin-split-layout 
                       style="${c}" 
                       class="${t.cssClasses}"
            ...
            `},es=(e,t,a,i,s,r,n)=>{const l=t.children&&t.children.length>1?t.children[1]:null,c=s?.detailComponent??null,h=!!s?.hasDetail||!!l,m=c??l;return o`
               <vaadin-master-detail-layout ?has-detail="${h}"
                                            style="${t.style}"
                                            class="${t.cssClasses}"
                                            slot="${t.slot??d}">
                   <div>${$(e,t.children[0],a,i,s,r,n)}</div>
                   ${h&&m?o`<div slot="detail">${$(e,m,a,i,s,r,n)}</div>`:o`<div slot="detail" style="display: flex; align-items: center; justify-content: center; height: 100%; color: var(--lumo-secondary-text-color); font-size: var(--lumo-font-size-s);">Select an item to view details</div>`}
               </vaadin-master-detail-layout>
            `},ts=(e,t,a,i,s,r,n)=>{const l=t.metadata;let c=t.style;c==null&&(c=""),l.fullWidth&&(c+="width: 100%;");let h=l.variant;h=="equalWidth"&&(h="equal-width-tabs");const m=Math.max(0,(t.children??[]).findIndex(b=>b.metadata.active)),f=b=>{b.target.selected=m};if(l.adaptable){const b=(t.children??[]).map(S=>{const w=S.metadata.label;return w?.includes("${")?e._evalTemplate(w):w});return o`
            <mateu-adaptive-tabs
                    .tabLabels="${b}"
                    style="${c}"
                    class="${t.cssClasses}"
        ...
        >
            ...
            ${t.children?.map(b=>as(e,b,a,i,s,r,n))}
        </vaadin-tabsheet>
            `},as=(e,t,a,i,s,r,n)=>{const l=t.metadata.label,c=l?.includes("${")?e._evalTemplate(l):l;return o`
        <div tab="${c}" style="padding: var(--lumo-space-m) 0;">
                   ${t.children?.map(h=>$(e,h,a,i,s,r,n))}
               </div>
            `},is=(e,t,a,i,s,r,n)=>{const l=t.metadata;t.style,l.fullWidth;let c=0;if(t.children){for(let h=0;h<t.children.length;h++)if(t.children[h].metadata?.active){c=h;break}}return o`
               <vaadin-accordion
                       style="${t.style}"
                       class="${t.cssClasses}"
                       opened="${c}"
                       slot="${t.slot??d}"
               >
                   ${t.children?.map(h=>ss(e,h,a,i,s,r,n,l.variant))}
               </vaadin-accordion>
            `},ss=(e,t,a,i,s,r,n,l)=>{const c=t.metadata,h=c.label?.includes("${")?e._evalTemplate(c.label):c.label;return o`
        ...
        <vaadin-board-row style="${t.style}" class="${t.cssClasses}">
            ...
            `,cs=(e,t,a,i,s,r,n)=>{const l=t.metadata;return o`
        <div style="${t.style}" 
             class="${t.cssClasses}"
        ...
        >
            ...
            `},Tt=(e,t)=>new Function(...Object.keys(t),"return `"+e+"`")(...Object.values(t)),Lt=(e,t,a)=>({state:e??{},data:t??{},...a});function ye(e,t,a,i){if(!e?.includes("${"))return e;try{return Tt(e,Lt(t,a,i))}catch(s){return console.warn(`Mateu: could not interpolate "${e}":`,s),e}}const ht=(e,t,a)=>{if(e&&e.indexOf("${")>=0)try{return Tt(e,Lt(t,a))}catch(i){return i.message}return e},Ia=(e,t,a,i,s)=>{if(!e)return e;const r=Lt(t,a,{appState:i??{},appData:s??{}});let n=e;try{if(n=Tt(e,r),n.includes("${"))try{n=Tt(n,r)}catch(l){n="when evaluating nested "+e+" :"+l+", where data is "+a+" and state is "+t+" and app state is "+i+" and app data is "+s,console.error(l,n,t,a,i,s)}}catch(l){n="when evaluating "+e+" :"+l+", where data is "+a+" and state is "+t+" and app state is "+i+" and app data is "+s,console.error(l,n,t,a,i,s)}return n},mi=(e,t,a,i,s,r)=>{const n=Lt(t,a,{appState:i??{},appData:s??{},...r}),l=Tt(e,n);return new Function(...Object.keys(n),`return (${l})`)(...Object.values(n))},vi=(e,t,a,i)=>{const s=Lt(t,a,i);return new Function(...Object.keys(s),`return (${e})`)(...Object.values(s))},hs=(e,t,a,i)=>Tt(e,Lt(t,a,i)),us=(e,t,a)=>{const i=e.metadata;return o`<vaadin-avatar
            img="${i.image}"
            name="${Xe(i.name,t,a)}"
            abbr="${i.abbreviation}"
            style="${e.style}" class="${e.cssClasses}"
            slot="${e.slot??d}"
    ></vaadin-avatar>`},Xe=(e,t,a)=>typeof e=="string"&&e.includes("${")?ye(e,t,a):e,ps=e=>{const t=e.metadata;return o`<vaadin-avatar-group max-items-visible="${t.maxItemsVisible}"
                                     .items="${t.avatars}"
                                     style="${e.style}" class="${e.cssClasses}"
                                     slot="${e.slot??d}">
    </vaadin-avatar-group>`},ms=(e,t,a,i,s,r,n)=>{const l=t.metadata,c=h=>o`
            ${$(e,h,a,i,s,r,n)}
`;return o`
        <vaadin-virtual-list
                ...
                slot="${t.slot??d}"
        ></vaadin-virtual-list>
    `};var vs=Object.defineProperty,fs=Object.getOwnPropertyDescriptor,Ta=(e,t,a,i)=>{for(var s=i>1?void 0:i?fs(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&vs(t,a,s),s};let jt=class extends I{constructor(){super(...arguments),this.variant="text",this.count=3}render(){const e=Array.from({length:Math.max(1,this.count)});return this.variant=="card"?o`${e.map(()=>o`<div class="bone card" style="margin: .5em 0;"></div>`)}`:this.variant=="grid"?o`${e.map(()=>o`<div class="bone row"></div>`)}`:this.variant=="form"?o`${e.map(()=>o`
                <div class="form-pair">
                    <div class="bone label"></div>
                    <div class="bone field"></div>
                </div>
            `)}`:o`${e.map(()=>o`<div class="bone line"></div>`)}`}};jt.styles=_`
        :host {
            display: block;
            flex: 1 1 0;
            min-width: 6rem;
    ...
    `;Ta([u()],jt.prototype,"variant",2);Ta([u({type:Number})],jt.prototype,"count",2);jt=Ta([C("mateu-skeleton")],jt);const bs=(e,t)=>{t&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},ut=(e,t,a,i,s,r)=>o`
        <div class="mateu-empty-state"
            ...
            ${s&&r?o`
                <vaadin-button theme="tertiary" style="margin-top: .25rem;" @click="${n=>bs(n,s)}">${r}</vaadin-button>
            `:d}
        </div>
    `,gs=e=>{const t=e.metadata;return o`
        <div style="${e.style??d}" class="${e.cssClasses??d}" slot="${e.slot??d}">
            ${ut(void 0,t.icon,t.title,t.description,t.actionId,t.actionLabel)}
        </div>
    `},$s=e=>{const t=e.metadata;return o`
        <mateu-skeleton
                ...
                slot="${e.slot??d}"
        ></mateu-skeleton>
    `};var Bt=(e=>(e.NONE="NONE",e.INFO="INFO",e.SUCCESS="SUCCESS",e.WARNING="WARNING",e.DANGER="DANGER",e))(Bt||{});const ys=(e,t,a)=>{const i=e[a.path];return i?o`<span theme="badge pill ${ha(i.type)}">${i.message}</span>`:o``},ha=e=>{switch(e){case Bt.SUCCESS:return"success";case Bt.WARNING:return"warning";case Bt.DANGER:return"error";case Bt.NONE:return"contrast"}return""},xs=(e,t,a)=>{const s=e[a.path]?"vaadin:check":"vaadin:minus";return o`<vaadin-icon 
                    icon="${s}"
                    style="height: 16px; width: 16px; color: ${"var(--lumo-body-text-color)"};"
            ></vaadin-icon>`},ws=(e,t,a,i,s)=>{const r=e[a.path];let n=r;return i=="money"&&r&&r.locale&&r.currency?n=new Intl.NumberFormat(r.locale,{style:"currency",currency:r.currency}).format(r.value):s=="money"&&(n=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(r)),o`${n}`},Ua=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},ks=(e,t,a,i,s,r)=>{const n=a.xcolumn??r;if(n.text){if(n.actionId)return o`<a href="javascript: void(0);" @click="${h=>Ua(a,n,e)}">${n.text}</a>`;const c=e[a.path];return o`<a href="${c}">${n.text}</a>`}if(i=="string"){if(n.actionId){const h=e[a.path];return o`<a href="javascript: void(0);" @click="${m=>Ua(a,n,e)}">${h}</a>`}const c=e[a.path];return o`<a href="${c}">${c}</a>`}const l=e[a.path];return o`<a href="${l.href}">${l.text}</a>`},Ss=(e,t,a,i,s)=>i=="string"?e[a.path].split(",").map(l=>o`<vaadin-icon icon="${l}" style="width: 16px;"></vaadin-icon>`):e[a.path].split(",").map(n=>o`<vaadin-icon icon="${n.icon}" style="width: 16px;"></vaadin-icon>`),Cs=(e,t,a,i,s)=>{const r=e[a.path];return o`${$e(r)}`},_s=(e,t,a,i,s,r)=>{if(i=="string"){const l=e[a.path],c="max-height: 40px; "+(r.style??"");return o`<img src="${l}" style="${c}">`}const n=e[a.path];return o`<img src="${n.src}" style="${r.style??""}">`},Es=e=>{const t={_clickedRow:e.target.row};e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-"+e.detail.value.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},Ba=e=>{const t={_clickedRow:e.target.row},a=e.target.action;e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"action-on-row-"+a.methodNameInCrud,parameters:t},bubbles:!0,composed:!0}))},Is=e=>{const t=document.createElement("vaadin-context-menu-item"),a=document.createElement("vaadin-icon");return a.style.color="var(--lumo-secondary-text-color)",a.style.marginInlineEnd="var(--lumo-space-s)",a.style.padding="var(--lumo-space-xs)",a.setAttribute("icon",e.icon),t.appendChild(a),e.label&&t.appendChild(document.createTextNode(e.label)),t.disabled=e.disabled,t},ja=(e,t,a)=>{const i=e[a.path]?.actions?.map(s=>s.icon?{component:Is(s),methodNameInCrud:s.methodNameInCrud}:{...s,text:s.label});return!i||i.length==0?o``:o`
                                     <vaadin-menu-bar
                                         ...
                                         @item-selected="${Es}"
                                     ></vaadin-menu-bar>
                                   `},Ts=(e,t,a)=>{if(a.path=="select"){const r={actionId:a.path,icon:"",label:"Select",disabled:!1,methodNameInCrud:"select"};return o`
         <vaadin-button theme="tertiary" title="Select" @click="${Ba}" .row="${e}" .action="${r}">
             Select
         </vaadin-button>
    `}const i=a.path&&e[a.path].methodNameInCrud?e[a.path]:e.action,s=i.icon&&!i.label;return o`
         <vaadin-button theme="tertiary${s?" icon":""}" title="${i.label||d}" @click="${Ba}" .row="${e}" .action="${i}">
             ${i.icon?o`<vaadin-icon icon="${i.icon}"></vaadin-icon>`:d}
             ${i.label?i.label:d}
         </vaadin-button>
    `},Rs=(e,t,a)=>{e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:a},bubbles:!0,composed:!0}))},Ps=(e,t,a,i,s,r)=>{const n=a.xcolumn??r;if(n.actionId){const c=n.text||e[a.path];return o`
            <vaadin-button theme="tertiary" @click="${h=>Rs(a,n,e)}" .row="${e}">
                ${c}
            </vaadin-button>
        `}const l=e[a.path];return o`<a href="${l}">${n.text||l}</a>`},Os=(e,t,a,i,s,r,n,l,c)=>{const h=e[a.path];return $(i,h,s,r,n,l,c)},Sa=new WeakMap,Ls=(e,t)=>Sa.get(e)?.[t],Ds=(e,t,a)=>{let i=Sa.get(e);i||(i={},Sa.set(e,i)),i[t]=a},Wa=e=>{if(e==null||e==="")return null;const t=Number(e);return Number.isNaN(t)?null:t},zs=(e,t,a,i)=>{const s=a?.field?.fieldId,r=c=>{if(e[t.id]===c||e[t.id]==null&&(c===""||c==null))return;if(e[t.id]=c,!s){a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"update-row",parameters:{_editedRow:{...e}}},bubbles:!0,composed:!0}));return}const h=i[s];a.dispatchEvent(new CustomEvent("value-changed",{detail:{fieldId:s,value:Array.isArray(h)?[...h]:h},bubbles:!0,composed:!0}))},n=e[t.id],l=n==null?"":String(n);switch(t.editorType){case"boolean":return o`<vaadin-checkbox ?checked=${!!n} @checked-changed=${c=>r(c.detail.value)}></vaadin-checkbox>`;case"integer":return o`<vaadin-integer-field theme="small" style="width:100%;" .value=${l} @change=${c=>r(Wa(c.target.value))}></vaadin-integer-field>`;case"number":return o`<vaadin-number-field theme="small" style="width:100%;" .value=${l} @change=${c=>r(Wa(c.target.value))}></vaadin-number-field>`;case"date":return o`<vaadin-date-picker theme="small" style="width:100%;" .value=${l} @value-changed=${c=>r(c.detail.value)}></vaadin-date-picker>`;case"time":return o`<vaadin-time-picker theme="small" style="width:100%;" .value=${l} @value-changed=${c=>r(c.detail.value)}></vaadin-time-picker>`;case"datetime":return o`<vaadin-date-time-picker theme="small" style="width:100%;" .value=${l} @value-changed=${c=>r(c.detail.value)}></vaadin-date-time-picker>`;case"select":return o`<vaadin-combo-box
                ...
                .value=${l}
                @value-changed=${c=>r(c.detail.value)}></vaadin-combo-box>`;case"lookup":{const c=a?.field?.fieldId,h=`search-${c}-${t.id}`,m=`${c}-${t.id}`,b=(t.editorOptions??[]).find(w=>String(w.value)===l)??(l?{value:l,label:Ls(e,t.id)??l}:void 0);return o`<vaadin-combo-box
                theme="small" style="width:100%;"
                item-label-path="label" item-id-path="value"
                .dataProvider=${(w,g)=>{a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:h,parameters:{searchText:w.filter,size:w.pageSize,page:w.page},callback:O=>{const F=O?.fragments?.[0]?.data?.[m];g(F?.content??[],F?.totalElements??0)},callbackonly:!0},bubbles:!0,composed:!0}))}}
                .selectedItem=${b}
                @selected-item-changed=${w=>{const g=w.detail.value,O=g?g.value:null;String(O??"")!==l&&(g&&Ds(e,t.id,g.label),r(O))}}></vaadin-combo-box>`}default:return o`<vaadin-text-field theme="small" style="width:100%;" .value=${l} @change=${c=>r(c.target.value)}></vaadin-text-field>`}},ya=e=>Ni(()=>o`<span title="${e}" style="white-space:normal;overflow-wrap:break-word;">${e}</span>`,[e]),As=e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget?.dispatchEvent(new CustomEvent("sort-direction-changed",{detail:{grid:e.currentTarget.parentElement},bubbles:!0,composed:!0}))},Fs=(e,t,a,i,s,r,n)=>{const l=ye(e.label,i,s);return o`
<vaadin-grid-column-group header="${l}">
    ${e.columns.map(c=>fi(c.metadata,t,a,i,s,r,n))}
</vaadin-grid-column-group>
`},Ra=(e,t,a,i,s,r,n)=>p.GridGroupColumn==e.metadata?.type?Fs(e.metadata,t,a,i,s,r,n):fi(e.metadata,t,a,i,s,r,n),fi=(e,t,a,i,s,r,n)=>{const l=ye(e.label,i,s);return e.sortable?o`
                    ...
                    `:o`
                        <vaadin-grid-column
                                ...
                                ${Me((c,h,m)=>sa(c,h,m,e,t,a,i,s,r,n),[])}
                        ></vaadin-grid-column>
                    `},sa=(e,t,a,i,s,r,n,l,c,h)=>{const m=a.dataset.dataType??"",f=a.dataset.stereotype??"";if(i.editable)return zs(e,i,s,n);if(m=="status")return ys(e,t,a);if(m=="bool")return xs(e,t,a);if(m=="money"||f=="money")return ws(e,t,a,m,f);if(m=="link"||f=="link")return ks(e,t,a,m,f,i);if(m=="icon"||f=="icon")return Ss(e,t,a,m);if(f=="html")return Cs(e,t,a);if(f=="image")return _s(e,t,a,m,f,i);if(m=="menu")return ja(e,t,a);if(m=="component")return Os(e,t,a,s,r,n,l,c,h);if(m=="action")return Ts(e,t,a);if(m=="actionGroup")return ja(e,t,a);if(f=="button"||i.actionId)return Ps(e,t,a,m,f,i);const b=e[a.path];return o`<span title="${b}" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; display: block;">${b}</span>`},Ns=(e,t,a,i,s,r,n)=>{const l=t.metadata;if(l.tree){const h=async(m,f)=>{const b=m.parentItem?m.parentItem.children:l.page.content;f(b,b.length)};return o`
        <vaadin-grid style="${t.style}" class="${t.cssClasses}"
                     .itemHasChildrenPath="${"children"}" .dataProvider="${h}"
                     slot="${t.slot??d}"
                     all-rows-visible
        >
            ${l.content.map((m,f)=>{const b=m.metadata;return f>0?o`
            <vaadin-grid-column path="${m.id}"
                                ...
                                width="${b?.width??d}"
                                .column="${m.metadata}"
                                ${Me((S,w,g)=>sa(S,w,g,b,e,a,i,s,r,n),[])}></vaadin-grid-column>
`:o`
...
`})}
    ...
    `}let c=l.page?.content;return t.id&&i&&i[t.id]&&(c=i[t.id]),c||(c=[]),o`
        <vaadin-grid 
                ...
                all-rows-visible
        >
            ${l?.content?.map(h=>Ra(h,e,a,i,s,r,n))}
        </vaadin-grid>
    `},qs=e=>{const a=(e.metadata.items??[]).map(i=>({text:i.text,time:i.time,userName:i.userName,userImg:i.userImg,userAbbr:i.userAbbr,userColorIndex:i.userColorIndex}));return o`
        <vaadin-message-list
                markdown
                style="${e.style}" class="${e.cssClasses}"
                slot="${e.slot??d}"
                .items="${a}"
        ></vaadin-message-list>
    `},Ze=new Mi,j={value:{}},Wt={value:{}},Ms=(e,t,a,i,s,r,n)=>{const l=t.metadata;return o`
        <vaadin-context-menu .items=${Pa(e,l.menu,a,i,s,r,n)} 
                             style="${t.style}" 
                             class="${t.cssClasses}"
            ...
            `},Us=(e,t,a,i,s)=>{const r=t.metadata;return o`
        <vaadin-menu-bar .items=${Pa(e,r.options,a,i,s,j,Wt)}
                         style="${t.style}" class="${t.cssClasses}"
                         slot="${t.slot??d}">
        </vaadin-menu-bar>
            `},Va=(e,t,a,i,s,r,n)=>{const l=document.createElement("vaadin-context-menu-item");return di($(e,t,a,i,s,r,n),l),l},Pa=(e,t,a,i,s,r,n)=>t.map(l=>l.submenus?{text:l.component?void 0:l.label,route:l.path,checked:l.selected,disabled:l.disabled,className:l.className,component:l.component?Va(e,l.component,a,i,s,r,n):void 0,children:Pa(e,l.submenus,a,i,s,r,n)}:l.separator?{component:"hr"}:{text:l.component?void 0:l.label,route:l.path,checked:l.selected,disabled:l.disabled,className:l.className,component:l.component?Va(e,l.component,a,i,s,r,n):void 0}),Bs=(e,t,a,i,s,r,n)=>{const l=t.metadata;return o`
        ...
        >
            ...
            `},js=e=>{const t=e.metadata,a=i=>{const s=i.detail?.value??"";!t.actionId||!s.trim()||i.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:{message:s}},bubbles:!0,composed:!0}))};return o`
        <vaadin-message-input
                style="${e.style}" class="${e.cssClasses}"
                slot="${e.slot??d}"
                @submit="${a}"
        ></vaadin-message-input>
    `},Ws=(e,t,a,i,s,r,n)=>{const l=t.metadata;return o`
        <div id="show-notifications">${$(e,l.wrapped,a,i,s,r,n)}</div>
        <vaadin-tooltip
                style="${t.style}" class="${t.cssClasses}"
                slot="${t.slot??d}"
                for="show-notifications" text="${l.text}" position="top-start"></vaadin-tooltip>
    `},Vs=e=>{if(e instanceof CustomEvent)return e.detail;const t={};for(const a in e){const i=e[a];["number","string","boolean"].indexOf(typeof i)>=0&&(t[a]=e[a])}return t},Ha=(e,t,a)=>{for(let i in t.attributes)e.setAttribute(i,t.attributes[i]);a.style&&e.setAttribute("style",a.style),a.cssClasses&&e.setAttribute("class",a.cssClasses),a.slot&&e.setAttribute("slot",a.slot),t.content&&(t.html?e.innerHTML=t.content:e.append(t.content))},Hs=e=>{const t=e.name;t.startsWith("vaadin-chart")&&!customElements.get(t)&&te(()=>import("./vendor-highcharts.js"),__vite__mapDeps([0,1,2,3]));const a=e.attributes?e.attributes.import:void 0;a&&t.includes("-")&&!customElements.get(t)&&import(a)},Gs=(e,t,a)=>{Hs(t);let i=t.name;return t.attributes&&t.attributes.id&&(i="#"+t.attributes.id),setTimeout(()=>{const s=e.shadowRoot?.querySelector(".element-container")?.querySelector(i);if(s){for(;s.firstChild;)s.removeChild(s.lastChild);Ha(s,t,a)}else{const r=document.createElement(t.name);Ha(r,t,a);for(let n in t.on)r.addEventListener(n,l=>{const c=Vs(l);e.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.on[n],parameters:{event:c}},bubbles:!0,composed:!0}))});e.shadowRoot?.querySelector(".element-container")?.appendChild(r)}}),o`<div class="element-container"></div>`};var Ie=(e=>(e.div="div",e.p="p",e.h1="h1",e.h2="h2",e.h3="h3",e.h4="h4",e.h5="h5",e.h6="h6",e.span="span",e))(Ie||{});const Ks=(e,t,a,i,s)=>{const r=e.metadata,n=r.attributes?.["data-colspan"],l=Ia(r.text,t,a,i,s);return Ie.h1==r.container?o`
        ...
        `:Ie.p==r.container?o`
            ...
            `},Js=(e,t,a)=>{const i=e.metadata;return o`<span theme="badge ${i.color} ${i.pill?"pill":""} ${i.small?"small":""} ${i.primary?"primary":""}"
                      style="${e.style}" class="${e.cssClasses}"
                      slot="${e.slot??d}">${Xe(i.text,t,a)}</span>`},Ys=(e,t,a)=>{const i=Xe(e.text,t,a);if(!i)return d;let s=Xe(e.color,t,a);return s=="SUCCESS"&&(s="success"),s=="ERROR"&&(s="error"),s=="DANGER"&&(s="error"),s=="WARNING"&&(s="warning"),s=="INFO"&&(s="info"),s=="PRIMARY"&&(s="primary"),s=="SECONDARY"&&(s="secondary"),s=="TERTIARY"&&(s="tertiary"),s=="QUATERNARY"&&(s="quaternary"),s=="LIGHT"&&(s="light"),s=="DARK"&&(s="dark"),o`<span theme="badge ${s} ${e.pill?"pill":""} ${e.small?"small":""} ${e.primary?"primary":""}">${i}</span>`},Xs=e=>{const t=e.metadata;return o`<a href="${t.url}" style="${e.style}" class="${e.cssClasses}"
                   slot="${e.slot??d}">${t.text}</a>`},bi=(e,t)=>{const a=e.toLowerCase().split("+");return t.ctrlKey===a.includes("ctrl")&&t.altKey===a.includes("alt")&&t.shiftKey===a.includes("shift")&&t.metaKey===a.includes("meta")},Qs=(e,t)=>{if(!bi(e,t))return!1;const a=e.toLowerCase().split("+"),i=a[a.length-1];return!!(t.key.toLowerCase()===i||/^[a-z]$/.test(i)&&t.code==="Key"+i.toUpperCase()||/^[0-9]$/.test(i)&&(t.code==="Digit"+i||t.code==="Numpad"+i))},Zs=e=>e?e.split("+").map(t=>t.length<=1?t.toUpperCase():t.charAt(0).toUpperCase()+t.slice(1)).join("+"):void 0,gi=(e,t)=>{const a=e.target.dataset.actionId;e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a,parameters:t.parameters},bubbles:!0,composed:!0}))},er=(e,t,a)=>{const i=e.metadata,s=ye(i.label,t,a);let r="";return i.buttonStyle&&(r+=" "+i.buttonStyle),i.color&&i.color!=="none"&&i.color!=="normal"&&(r+=" "+i.color),i.size&&i.size!=="none"&&i.size!=="normal"&&(r+=" "+i.size),o`<vaadin-button
id="${e.id}"
            ...
            theme="${r}"
            ?disabled="${i.disabled}"
            title="${i.shortcut?`${s} (${Zs(i.shortcut)})`:d}"
            slot="${e.slot??d}"
    >${i.iconOnLeft?o`<vaadin-icon icon="${i.iconOnLeft}"></vaadin-icon>`:d}${s}${i.iconOnRight?o`<vaadin-icon icon="${i.iconOnRight}"></vaadin-icon>`:d}</vaadin-button>`},tr=(e,t,a,i,s,r,n)=>{const l=t.metadata;if(!l)return o``;let c="";return l.variants?.map(h=>h=="stretchMedia"?"stretch-media":h=="coverMedia"?"cover-media":h).forEach(h=>c+=" "+h),c=c.trim(),o`
        <vaadin-card
                style="${t.style}" 
                class="${t.cssClasses}" 
                theme="${c}"
                slot="${t.slot??d}"
        >
            ${l.media?ct(e,l.media,a,i,s,r,n,"media",!1):d}
            ${l.title?ct(e,l.title,a,i,s,r,n,"title",!1):d}
            ${l.subtitle?ct(e,l.subtitle,a,i,s,r,n,"subtitle",!1):d}
            ${l.header?ct(e,l.header,a,i,s,r,n,"header",!1):d}
            ${l.headerPrefix?ct(e,l.headerPrefix,a,i,s,r,n,"header-prefix",!1):d}
            ${l.headerSuffix?ct(e,l.headerSuffix,a,i,s,r,n,"header-suffix",!1):d}
            ${l.footer?ct(e,l.footer,a,i,s,r,n,"footer",!1):d}
    ...
    `},sr=(e,t,a,i,s,r,n)=>{const l=t.metadata;let c=!1;if(l.openedCondition)try{c=mi(l.openedCondition,i,s,r,n)}catch(h){console.error("when evaluating "+l.openedCondition+" :"+h+", where data is "+s+" and state is "+i)}return o`
...
>
  ${t.children?.map(h=>$(e,h,a,i,s,r,n))}
            ...
            `},rr=e=>{const t=e.metadata;let a;return t.position&&(a={Top:"top",Bottom:"bottom",TopLeft:"top-left",TopRight:"top-right",BottomLeft:"bottom-left",BottomRight:"bottom-right"}[t.position]),o`
    ...
    `},or=(e,t,a,i,s,r,n)=>{const l=t.metadata;return o`
        <vaadin-details 
                ?opened="${l.opened}" 
                style="${t.style}" 
                class="${t.cssClasses}"
        ...
        <mateu-drawer
            ...
            .appdata="${r}"
        ></mateu-drawer>
            `,dr=e=>{const t=e.metadata;return o`
        <mateu-api-caller>
        ...
        <vaadin-notification
                ...
                `,[])}
        ></vaadin-notification>
            `},ur=(e,t={})=>{const a=e.metadata,i=a.valueKey?t[a.valueKey]:a.value;return o`
        <div style="${e.style}">
        <vaadin-progress-bar
    ...
    `},mr=e=>{const t=e.metadata;return o`
        ...
        <img src="${t.src}" style="${e.style}" class="${e.cssClasses}"
             slot="${e.slot??d}">
            `},fr=e=>{const t=e.metadata;return o`<vaadin-horizontal-layout theme="spacing"
                                          slot="${e.slot??d}">
    ...
    </vaadin-horizontal-layout>`},br=(e,t,a,i,s,r,n)=>{const l=t.metadata;return o`
        <skeleton-carousel 
                id="${t.id}"
                ?dots = "${l.dots}" 
                ?nav = "${l.nav}" 
    ...
    `},gr=(e,t,a,i)=>{const s=e.metadata;return o`
        ...
        ${e.submenus?o`
                <vaadin-details summary="${e.label}" opened>
                    <vaadin-vertical-layout theme="spacing">
                        ${e.submenus.map(t=>$i(t))}
                    </vaadin-vertical-layout>
                </vaadin-details>
            `:o`
                <a href="${e.path}">${e.label}</a>
        `}
        `,$r=(e,t,a,i,s,r,n)=>{const l=t.metadata;return o`<div
                slot="${t.slot??d}"
                style="${t.style}" class="${t.cssClasses}"
        >${l.content?$e(l.content):d}${t.children?.map(c=>$(e,c,a,i,s,r,n))}</div>
    `},yr=(e,t,a,i,s,r,n)=>{const l=t.metadata,c=l.title?.includes("${")?e._evalTemplate(l.title):l.title;return o`<vaadin-card
                slot="${t.slot??d}"
    ...
    `},xr=(e,t,a,i,s,r,n)=>{const l=t.metadata,c=l.title?.includes("${")?e._evalTemplate(l.title):l.title;return o`
        <div
                slot="${t.slot??d}"
                style="${t.style}" class="${t.cssClasses}"
        >
    ...
    `},Ca=(e,t,a,i,s,r,n,l)=>{const c=t.metadata,h=c?.fabs??[];return o`<mateu-page
            .component="${t}"
            baseUrl="${a}"
            .state="${i}"
            .data="${s}"
    ...
    >
        ${t.children?.map(m=>$(e,m,a,i,s,r,n))}
        ${c?.buttons?.map(m=>o`
                   ${$(e,{id:m.actionId,metadata:m,type:ae.ClientSide,slot:"buttons"},void 0,i,s,r,n)}
`)}
        ${h.map((m,f)=>o`
    ...
    `},_a=(e,t,a,i,s,r,n,l)=>o`<mateu-table-crud
            id="${t.id}"
            baseUrl="${a}"
            .component="${t}"
            .metadata="${t.metadata}"
    ...
    >
        ${t.children?.map(c=>$(e,c,a,i,s,r,n))}
    </mateu-table-crud>`,wr=e=>{const t=e.metadata;return o`
        <mateu-bpmn
                style="${e.style}"
                class="${e.cssClasses}"
                slot="${e.slot??d}"
    ...
    `},kr=(e,t,a)=>{const i=e.metadata;return o`<mateu-chat sseUrl="${i.sseUrl}"
                            style="${e.style}" 
                            class="${e.cssClasses}" 
                            slot="${e.slot??d}"></mateu-chat>`},Sr=e=>{const t=e.metadata;return o`
        <mateu-workflow
                style="${e.style??d}"
                class="${e.cssClasses??d}"
                slot="${e.slot??d}"
...
`,Er=e=>e=="up"?"var(--lumo-success-text-color, #1a7f37)":e=="down"?"var(--lumo-error-text-color, #c5221f)":"var(--lumo-secondary-text-color, #666)",Ir=e=>e=="up"?"▲":e=="down"?"▼":"",Tr=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},Rr=e=>{const t=e.metadata,a=!!t.actionId;return o`
        <div class="mateu-metric-card ${e.cssClasses??""}"
             style="${yi} display: flex; flex-direction: column; gap: .25rem; min-width: 11rem; flex: 1; ${a?"cursor: pointer;":""} ${e.style??""}"
             slot="${e.slot??d}"
             role="${a?"button":d}"
             @click="${i=>Tr(i,t)}"
        >
            ...
            ${t.trend||t.trendLabel?o`
                <span style="font-size: var(--lumo-font-size-s, .875rem); color: ${Er(t.trend)};">
                    ${Ir(t.trend)} ${t.trendLabel??d}
                </span>
            `:d}
    ...
    `,Or=(e,t,a,i,s,r,n)=>{const l=t.metadata,c=l.colSpan&&l.colSpan>1?`grid-column: span ${l.colSpan};`:"",h=l.rowSpan&&l.rowSpan>1?`grid-row: span ${l.rowSpan};`:"";return o`
        <div class="mateu-dashboard-panel ${t.cssClasses??""}"
             style="${yi} display: flex; flex-direction: column; gap: .5rem; min-width: 0; ${c} ${h} ${t.style??""}"
             slot="${t.slot??d}"
        >
            ${l.title?o`
                <div>
    ...
    `},Lr=(e,t,a,i,s,r,n)=>{const l=t.metadata,c=l.columns&&l.columns>0?`repeat(${l.columns}, minmax(0, 1fr))`:"repeat(auto-fit, minmax(20rem, 1fr))";return o`
    ...
    `};var Dr=Object.defineProperty,zr=Object.getOwnPropertyDescriptor,Oa=(e,t,a,i)=>{for(var s=i>1?void 0:i?zr(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Dr(t,a,s),s};let Vt=class extends I{constructor(){super(...arguments),this.panels=[],this.openPanels=new Set,this.initialized=!1}willUpdate(){!this.initialized&&this.panels.length&&(this.openPanels=new Set(this.panels.map((e,t)=>e.open?t:-1).filter(e=>e>=0)),this.initialized=!0)}toggle(e){const t=new Set(this.openPanels);t.has(e)?t.delete(e):t.add(e),this.openPanels=t}render(){return o`
    ...
    `;Oa([u({type:Array})],Vt.prototype,"panels",2);Oa([v()],Vt.prototype,"openPanels",2);Vt=Oa([C("mateu-foldout")],Vt);const Ar=(e,t,a,i,s,r,n)=>{const l=t.metadata;return o`
        <mateu-foldout
                .panels="${l.panels??[]}"
                style="${t.style}"
                class="${t.cssClasses}"
    ...
    `},Fr=(e,t,a,i,s,r,n)=>{const l=t.metadata,c=!!l.image,h=c?`background-image: linear-gradient(rgba(0,0,0,.35), rgba(0,0,0,.35)), url('${l.image}'); background-size: cover; background-position: center; color: #fff;`:"",m=l.centered===!1?"flex-start":"center",f=l.centered===!1?"left":"center";return o`
        <div class="mateu-hero ${t.cssClasses??""}"
             style="display: flex; flex-direction: column; align-items: ${m}; justify-content: center; gap: var(--lumo-space-m, 1rem); text-align: ${f}; padding: var(--lumo-space-xl, 2.5rem) var(--lumo-space-l, 1.5rem); border-radius: var(--lumo-border-radius-l, 12px); min-height: ${l.height??"12rem"}; box-sizing: border-box; ${h} ${t.style??""}"
             slot="${t.slot??d}"
        >
    ...
    `};var Nr=Object.defineProperty,qr=Object.getOwnPropertyDescriptor,xi=(e,t,a,i)=>{for(var s=i>1?void 0:i?qr(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Nr(t,a,s),s};const xa=1440*60*1e3;let ra=class extends I{constructor(){super(...arguments),this.tasks=[]}range(){const e=this.tasks.flatMap(t=>[t.start,t.end]).filter(t=>!!t).map(t=>new Date(t+"T00:00:00").getTime());return e.length?{min:Math.min(...e)-xa,max:Math.max(...e)+2*xa}:null}months(e,t){const a=[],i=new Date(e);for(i.setDate(1);i.getTime()<=t;){const s=Math.max(i.getTime(),e),r=new Date(i.getFullYear(),i.getMonth()+1,1),n=Math.min(r.getTime(),t);a.push({label:i.toLocaleDateString(void 0,{month:"short",year:"2-digit"}),from:s,to:n}),i.setMonth(i.getMonth()+1)}return a}render(){const e=this.range();if(!e)return o``;const t=e.max-e.min,a=s=>(s-e.min)/t*100,i=Date.now();return o`
            <div class="frame">
                ...
                ${this.tasks.map(s=>{const r=new Date(s.start+"T00:00:00").getTime(),n=new Date(s.end+"T00:00:00").getTime()+xa;return o`
    ...
    `;xi([u({type:Array})],ra.prototype,"tasks",2);ra=xi([C("mateu-gantt")],ra);const Mr=e=>{const t=e.metadata;return o`
        <mateu-gantt
                .tasks="${t.tasks??[]}"
                style="${e.style??d}"
                class="${e.cssClasses??d}"
                slot="${e.slot??d}"
        ></mateu-gantt>
    `},Ur=(e,t)=>{let a=e.style;return e.id&&(a&&!a.endsWith(";")&&(a+=";"),a==null&&(a=""),t[e.id+".hidden"]==!0&&(a+="display: none;")),a},Br=(e,t)=>{let a={...e.metadata};if(e.id&&a){if(a.type==p.Button){const i=a;t[e.id+".disabled"]==!0&&(i.disabled=!0)}if(a.type==p.FormField){const i=a;t[e.id+".disabled"]==!0&&(i.disabled=!0)}}return a},T=e=>t=>e(t.container,t.component,t.baseUrl,t.state,t.data,t.appState,t.appData),jr={[p.Bpmn]:({component:e})=>wr(e),[p.Workflow]:({component:e})=>Sr(e),[p.WorkflowElk]:({component:e})=>Cr(e),[p.FormEditor]:({component:e})=>_r(e),[p.Page]:T(Ca),[p.Div]:T($r),[p.Directory]:({component:e,baseUrl:t,state:a,data:i})=>gr(e),[p.FormLayout]:T(Ki),[p.HorizontalLayout]:T(Xi),[p.VerticalLayout]:T(Qi),[p.SplitLayout]:T(Zi),[p.MasterDetailLayout]:T(es),[p.TabLayout]:T(ts),[p.AccordionLayout]:T(is),[p.BoardLayout]:T(ls),[p.BoardLayoutRow]:T(ds),[p.BoardLayoutItem]:T(cs),[p.Scroller]:T(rs),[p.FullWidth]:T(os),[p.Container]:T(ns),[p.Form]:({container:e,component:t,baseUrl:a,state:i,data:s,appState:r,appData:n})=>{const l=t.metadata;return o`<mateu-form
            id="${t.id}"
        baseUrl="${a}"
            .component="${t}"
            .values="${i}"
            ...
            >
                ${t.children?.map(c=>$(e,c,a,i,s,r,n))}
            ${l?.buttons?.map(c=>o`
               ${$(e,{id:c.actionId,metadata:c,type:ae.ClientSide,slot:"buttons"},void 0,i,s,r,n)}
`)}

            </mateu-form>`},[p.Table]:({container:e,component:t,baseUrl:a,state:i,data:s,appState:r,appData:n})=>o`<mateu-table
                        id="${t.id}"
        baseUrl="${a}"
            .metadata="${t.metadata}"
            .state="${i}"
            ...
            >
             ${t.children?.map(l=>$(e,l,a,i,s,r,n))}
            </mateu-table>`,[p.Crud]:T(_a),[p.App]:({container:e,component:t,baseUrl:a,state:i,data:s,appState:r,appData:n})=>o`
            <mateu-app
                        id="${t.id}"
                        baseUrl="${a}"
                        .component="${t}"
            ...
            >
             ${t.children?.map(l=>$(e,l,a,i,s,r,n))}
         </mateu-app>`,[p.Element]:({container:e,component:t})=>Gs(e,t.metadata,t),[p.FormField]:({container:e,component:t,baseUrl:a,state:i,data:s,appState:r,appData:n,labelAlreadyRendered:l})=>{const c=t.metadata;return o`
    <mateu-field
                   id="${t.id}"
                   .component="${t}"
            .field="${t.metadata}"
        ...
        `},[p.Text]:({component:e,state:t,data:a,appState:i,appData:s})=>Ks(e,t,a,i,s),[p.Avatar]:({component:e,state:t,data:a})=>us(e,t,a),[p.Chat]:({component:e,state:t,data:a})=>kr(e),[p.AvatarGroup]:({component:e})=>ps(e),[p.Badge]:({component:e,state:t,data:a})=>Js(e,t,a),[p.Breadcrumbs]:({component:e})=>fr(e),[p.Anchor]:({component:e})=>Xs(e),[p.Button]:({component:e,state:t,data:a})=>er(e,t,a),[p.Card]:T(tr),[p.Chart]:({component:e})=>ar(e),[p.Icon]:({component:e})=>ir(e),[p.ConfirmDialog]:T(sr),[p.ContextMenu]:T(Ms),[p.CookieConsent]:({component:e})=>rr(e),[p.Details]:T(or),[p.Dialog]:({component:e,baseUrl:t,state:a,data:i,appState:s,appData:r})=>nr(e,t,a,i,s,r),[p.Drawer]:({component:e,baseUrl:t,state:a,data:i,appState:s,appData:r})=>lr(e,t,a,i,s,r),[p.Image]:({component:e})=>vr(e),[p.Map]:({component:e})=>mr(e),[p.Markdown]:({component:e})=>cr(e),[p.MicroFrontend]:({component:e})=>dr(e),[p.Notification]:({component:e})=>hr(e),[p.ProgressBar]:({component:e,state:t})=>ur(e,t),[p.Popover]:T(pr),[p.CarouselLayout]:T(br),[p.Tooltip]:T(Ws),[p.MessageInput]:({component:e})=>js(e),[p.MessageList]:({component:e})=>qs(e),[p.CustomField]:T(Bs),[p.MenuBar]:({container:e,component:t,baseUrl:a,state:i,data:s})=>Us(e,t,a,i,s),[p.Grid]:T(Ns),[p.VirtualList]:T(ms),[p.FormSection]:T(yr),[p.FormSubSection]:T(xr),[p.MetricCard]:({component:e})=>Rr(e),[p.Scoreboard]:T(Pr),[p.DashboardPanel]:T(Or),[p.DashboardLayout]:T(Lr),[p.FoldoutLayout]:T(Ar),[p.HeroSection]:T(Fr),[p.EmptyState]:({component:e})=>gs(e),[p.Skeleton]:({component:e})=>$s(e),[p.Gantt]:({component:e})=>Mr(e)},La=(e,t,a,i,s,r,n,l)=>{if(!t?.metadata)return t==null?(console.warn("No metadata for component",t),o`<p>No metadata for component</p>`):La(e,{id:G(),metadata:t,type:ae.ClientSide},a,i,s,r,n,l);const c=t.metadata.type,h={...t,style:Ur(t,s),metadata:Br(t,s)},m=jr[c];return m?m({container:e,component:h,baseUrl:a,state:i,data:s,appState:r,appData:n,labelAlreadyRendered:l}):o`<p ${h?.slot??d}>Unknown metadata type ${c} for component ${h?.id}</p>`};var de=(e=>(e.HAMBURGUER_MENU="HAMBURGUER_MENU",e.MENU_ON_LEFT="MENU_ON_LEFT",e.MENU_ON_TOP="MENU_ON_TOP",e.TABS="TABS",e.TILES="TILES",e.RAIL="RAIL",e.AUTO="AUTO",e.MEDIATOR="MEDIATOR",e))(de||{});const Da="mateu-app-context",wi="mateu-app-context-labels",ki=e=>{try{return JSON.parse(localStorage.getItem(e)??"{}")}catch{return{}}},Ga=(e,t)=>{try{localStorage.setItem(e,JSON.stringify(t))}catch{}},za=()=>ki(Da),Si=()=>ki(wi),Wr=(e,t,a)=>{const i=za(),s=Si();t==null||t===""?(delete i[e],delete s[e]):(i[e]=t,a!==void 0&&(s[e]=a)),Ga(Da,i),Ga(wi,s)};let Ka=!1;const Vr=()=>{Ka||(Ka=!0,window.addEventListener("storage",e=>{e.key===Da&&e.newValue!==e.oldValue&&window.location.reload()}))};let _t=[];class Hr{constructor(){this.axiosInstance=Ui.create({timeout:6e4}),this.axiosInstance.interceptors.request.use(t=>(this.addAuthToken(t),this.addSessionId(t),t))}addSessionId(t){let a=sessionStorage.getItem("__mateu_sesion_id");a||(a=G(),sessionStorage.setItem("__mateu_sesion_id",a)),t.headers["X-Session-Id"]=a}addAuthToken(t){const a=localStorage.getItem("__mateu_auth_token");a&&(t.headers.Authorization="Bearer "+a)}async wrap(t,a,i,s){return i||a.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),t.then(r=>(a.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:s}})),r)).catch(r=>{throw r?.code=="ERR_CANCELED"?a.dispatchEvent(new CustomEvent("backend-cancelled-event",{bubbles:!0,composed:!0,detail:{}})):a.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:s,reason:this.serialize(r)}})),r})}serialize(t){return t?.message?t:JSON.stringify(t)}async get(t){const a=new AbortController;return _t=[..._t,a],this.axiosInstance.get(t,{signal:a.signal})}async post(t,a){const i=new AbortController;return _t=[..._t,i],this.axiosInstance.post(t,a,{signal:i.signal})}async abortAll(){_t.forEach(t=>t.abort()),_t=[]}async runAction(t,a,i,s,r,n,l,c,h,m,f){return a&&a.startsWith("/")&&(a=a.substring(1)),n={...za(),...n},await this.wrap(this.post(t+"/mateu/v3/sync/"+(a&&a!=""?a:"_no_route"),{serverSideType:l,appState:n,componentState:c,parameters:h,initiatorComponentId:r,consumedRoute:i,route:a&&a!=""?"/"+a:"",actionId:s}).then(b=>b.data),m,f,s)}}const Aa=new Hr;var Gr=Object.defineProperty,Kr=Object.getOwnPropertyDescriptor,$t=(e,t,a,i)=>{for(var s=i>1?void 0:i?Kr(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Gr(t,a,s),s};let xe=class extends I{constructor(){super(...arguments),this.baseUrl="",this.opened=!1,this.searchText=""}connectedCallback(){super.connectedCallback(),Vr()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick(),this.searchTimer&&clearTimeout(this.searchTimer)}currentValue(){return String(za()[this.selector.fieldName]??"")}currentLabel(){const e=this.currentValue();if(!e)return"—";const t=(this.searchedOptions??this.selector.options)?.find(i=>String(i.value)===e);if(t)return t.label;const a=Si()[this.selector.fieldName];return a!==void 0?String(a):e}pick(e,t){Wr(this.selector.fieldName,e,t),window.location.reload()}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}openPanel(){this.opened||(this.opened=!0,this.searchText="",this.searchedOptions=void 0,this.remoteSearch(),this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick),this.updateComplete.then(()=>this.renderRoot.querySelector("input.picker-search")?.focus()))}closePanel(){this.detachOutsideClick(),this.opened=!1}onSearchInput(e){this.searchText=e.target.value,this.searchTimer&&clearTimeout(this.searchTimer),this.searchTimer=setTimeout(()=>this.remoteSearch(),300)}async remoteSearch(){const e=this.app;if(e?.serverSideType)try{const t=await Aa.runAction(this.baseUrl??"",e.rootRoute??e.initialRoute??"","",`_appcontext-search-${this.selector.fieldName}`,`appcontext-${this.selector.fieldName}`,void 0,e.serverSideType,{},{searchText:this.searchText},this,!0);for(const a of t?.fragments??[]){const r=a.data?.[`_appcontext_${this.selector.fieldName}`]?.content;if(Array.isArray(r)){this.searchedOptions=r.map(n=>({value:n.value,label:n.label??String(n.value)}));return}}}catch{}}visibleOptions(){const e=this.searchedOptions??this.selector.options??[],t=this.searchText.trim().toLowerCase();return t?e.filter(a=>a.label.toLowerCase().includes(t)):e}renderPanel(){const e=this.currentValue(),t=this.visibleOptions(),a=this.searchText!==""||t.length>xe.SEARCHABLE_THRESHOLD;return o`
            <div class="panel">
                ${a?o`
            ...
            </label>`:o``}};xe.SEARCHABLE_THRESHOLD=7;xe.styles=_`
        :host {
            display: inline-flex;
            position: relative;
            flex-shrink: 0;
    ...
    `;$t([u()],xe.prototype,"selector",2);$t([u()],xe.prototype,"app",2);$t([u()],xe.prototype,"baseUrl",2);$t([v()],xe.prototype,"opened",2);$t([v()],xe.prototype,"searchText",2);$t([v()],xe.prototype,"searchedOptions",2);xe=$t([C("mateu-app-context-picker")],xe);const qt=(e,t)=>{const a=e.contextSelectors??[];return a.length===0?d:o`${a.map(i=>o`
        <mateu-app-context-picker .selector="${i}" .app="${e}" .baseUrl="${t.baseUrl??""}"></mateu-app-context-picker>`)}`},ia=(e,t)=>e.themeToggle?o`
    ...
    `:d,Jr=(e,t)=>{t.filter!=e.detail.value&&(t.filter=e.detail.value)},Ja=(e,t,a)=>{const i=qe(e,t,a),s=Y(t,a);return i=="list"||i==s?"new":i},qe=(e,t,a)=>{const i=e?._route;if(i!=null&&(i===""||i.startsWith("/"))){const s=a.homeRoute??"",r=s.indexOf("?"),n=r>=0?s.substring(r+1):"",l=Y(t,a)+i;if(!n)return l;const c=l.indexOf("?")>=0?"&":"?";return l+c+n}return t.selectedRoute?t.selectedRoute:a.homeRoute},Y=(e,t)=>e.selectedRoute?e.selectedConsumedRoute??t.route:t.homeConsumedRoute,Te=(e,t)=>e.selectedRoute?e.selectedBaseUrl??e.baseUrl:t.homeBaseUrl,Re=(e,t)=>e.selectedRoute?e.selectedServerSideType??t.serverSideType:t.homeServerSideType,Pe=(e,t)=>e.selectedRoute?e.selectedUriPrefix:t.homeUriPrefix,Yr=(e,t,a,i,s,r,n)=>{const l=e.mapItems(t.menu,e.filter?.toLowerCase()??""),c=Y(e,t),h=Ja(i,e,t),m=h&&h!=="new"&&h.startsWith(c+"/")?h.substring(c.length+1).split("/")[0]:void 0;return o`
...
`:d}
                ...
                <vaadin-app-layout style="${t?.style}" class="${t?.cssClasses}" .drawerOpened=${!t.drawerClosed}>
                    ...
                    <vaadin-scroller slot="drawer" class="p-s"
                        ...
                        ${t.menu&&t.totalMenuOptions>10?o`
                            <vaadin-text-field style="width: calc(100% - 20px); padding-left: 10px; padding-right: 10px;" @value-changed="${f=>Jr(f,e)}">
            ...
            <slot></slot>
       `},Xr=(e,t)=>t!=null&&e!=null&&!e.has(t),Qr=typeof HTMLElement<"u"?HTMLElement:class{};class Zr extends Qr{static get observedAttributes(){return["type","renderer"]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){const t=this.getAttribute("type")??"unknown",a=this.getAttribute("renderer")??"unknown";this.shadowRoot||this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host { display: block; }
                .mateu-unsupported {
                    box-sizing: border-box;
        ...
        `}}typeof customElements<"u"&&!customElements.get("mateu-unsupported")&&customElements.define("mateu-unsupported",Zr);const Ya=new Set,eo=(e,t,a)=>{const i=`${a}/${t}`;return Ya.has(i)||(Ya.add(i),console.warn(`[mateu] Component type "${t}" is not supported by the "${a}" renderer — rendering <mateu-unsupported> placeholder.`)),o`<mateu-unsupported
            type="${t}"
            renderer="${a}"
            data-component-id="${e?.id??d}"
            slot="${e?.slot??d}"
    ></mateu-unsupported>`};class to{renderFilterBar(t,a,i,s,r,n,l,c){const h=a?.metadata,m=b=>{const{fieldId:S,value:w}=b.detail;t.state={...t.state,[S]:w}},f=b=>{const{fieldIds:S}=b.detail,w={};S.forEach(g=>{w[g]=void 0}),w.searchText=void 0,t.state={...t.state,...w}};return o`
            <mateu-filter-bar
                .metadata="${h}"
    ...
    `;pa([u()],Rt.prototype,"position",2);pa([u()],Rt.prototype,"zoom",2);pa([ze("#map")],Rt.prototype,"mapElement",2);Rt=pa([C("mateu-map")],Rt);const uo=typeof HTMLElement<"u"?HTMLElement:class{};class po extends uo{static get observedAttributes(){return["content"]}#e;#t=0;get content(){return this.#e}set content(t){this.#e=t,this.#a()}attributeChangedCallback(t,a,i){this.content=i??void 0}connectedCallback(){this.style.display="block",this.#a()}async#a(){if(!this.isConnected)return;const t=this.#e??"",a=++this.#t,[{marked:i},{default:s}]=await Promise.all([te(()=>import("./vendor.js").then(r=>r.f),[]),te(()=>import("./vendor.js").then(r=>r.c),[])]);a===this.#t&&(this.innerHTML=s.sanitize(await i.parse(t),{CUSTOM_ELEMENT_HANDLING:{tagNameCheck:r=>!0}}))}}typeof customElements<"u"&&!customElements.get("mateu-markdown")&&customElements.define("mateu-markdown",po);var mo=Object.defineProperty,vo=Object.getOwnPropertyDescriptor,Yt=(e,t,a,i)=>{for(var s=i>1?void 0:i?vo(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&mo(t,a,s),s};let pt=class extends I{constructor(){super(...arguments),this.fieldId="",this.signing=!1,this.hasStrokes=!1,this.drawing=!1,this.startStroke=e=>{const t=e.target;this.ensureCanvasSize(t),t.setPointerCapture(e.pointerId),this.drawing=!0;const a=t.getContext("2d");a.lineWidth=2,a.lineCap="round",a.lineJoin="round",a.strokeStyle=getComputedStyle(this).getPropertyValue("--lumo-body-text-color")||"#1a1a1a";const[i,s]=this.pointerPosition(e);a.beginPath(),a.moveTo(i,s),e.preventDefault()},this.stroke=e=>{if(!this.drawing)return;const a=e.target.getContext("2d"),[i,s]=this.pointerPosition(e);a.lineTo(i,s),a.stroke(),this.hasStrokes=!0,e.preventDefault()},this.endStroke=e=>{this.drawing=!1,e.target.releasePointerCapture(e.pointerId)}}emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e,fieldId:this.fieldId},bubbles:!0,composed:!0}))}canvas(){return this.renderRoot.querySelector("canvas")}pointerPosition(e){const a=e.target.getBoundingClientRect();return[e.clientX-a.left,e.clientY-a.top]}ensureCanvasSize(e){const t=e.getBoundingClientRect();(e.width!==Math.round(t.width)||e.height!==Math.round(t.height))&&(e.width=Math.round(t.width),e.height=Math.round(t.height))}clear(){const e=this.canvas();e&&e.getContext("2d").clearRect(0,0,e.width,e.height),this.hasStrokes=!1}accept(){const e=this.canvas();!e||!this.hasStrokes||(this.signing=!1,this.emit(e.toDataURL("image/png")))}renderPad(){return o`
            <canvas class="pad"
    ...
    `;Xt([u()],mt.prototype,"fieldId",2);Xt([u()],mt.prototype,"value",2);Xt([v()],mt.prototype,"cameraOpen",2);Xt([v()],mt.prototype,"cameraError",2);mt=Xt([C("mateu-camera-capture")],mt);var yo=Object.defineProperty,xo=Object.getOwnPropertyDescriptor,rt=(e,t,a,i)=>{for(var s=i>1?void 0:i?xo(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&yo(t,a,s),s};const wo=()=>{let e=document.activeElement;for(;e?.shadowRoot?.activeElement;)e=e.shadowRoot.activeElement;return e},ko=(e,t)=>{let a=t;for(;a;){if(a===e)return!0;a=a.assignedSlot??a.parentNode??a.host??null}return!1};let Oe=class extends Jt{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={},this.detailsOpenedItems=[],this.hoveredItem=null,this.onGridHoverMove=e=>{const t=e.currentTarget,a=t.getEventContext(e)?.item??null;a!==this.hoveredItem&&(this.hoveredItem=a,t.generateCellPartNames())},this.onGridHoverLeave=e=>{this.hoveredItem!==null&&(this.hoveredItem=null,e.currentTarget.generateCellPartNames())},this.hoverCellPartNameGenerator=(e,t)=>t?.item!=null&&t.item===this.hoveredItem?"hovered-cell":"",this._onRowKey=e=>{const t=this.field?.rowSelectionShortcut;if(!t||!this.field?.onItemSelectionActionId||!this._isRowShortcutRelevant()||!bi(t,e))return;const a=/^(?:Digit|Numpad)([1-9])$/.exec(e.code);if(!a)return;const i=this.currentItems(),s=parseInt(a[1],10)-1;s>=i.length||(e.preventDefault(),this.selectRow(i[s]))},this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._onRowKey)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._onRowKey)}currentItems(){return this.field?.remoteCoordinates?this.data?.[this.id]?.content??[]:this.field?.fieldId&&this.state?this.state[this.field.fieldId]??[]:[]}selectRow(e){!e||!this.field?.onItemSelectionActionId||(this.selectedItems=[e],this.state[this.id+"_selected_items"]=[e],this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.field.onItemSelectionActionId,parameters:{_clickedRow:e}},bubbles:!0,composed:!0})))}_isRowShortcutRelevant(){if(this.offsetParent===null&&this.getClientRects().length===0)return!1;const e=wo();if(e&&e!==document.body&&!ko(this,e)){const t=e.tagName?.toLowerCase()??"";if(e.isContentEditable||/^(input|textarea|select)$/.test(t)||t.startsWith("vaadin-")&&/(field|combo|picker|area|select)/.test(t))return!1}return!0}handleItemToggle(e){const{item:t,selected:a,shiftKey:i}=e.detail;if(this.rangeStartItem??=t,i){let s=[];this.field?.fieldId&&this.state&&this.state[this.field.fieldId]&&(s=this.state[this.field.fieldId]);const[r,n]=[this.rangeStartItem,t].map(h=>s.indexOf(h)).sort((h,m)=>h-m),l=s.slice(r,n+1),c=new Set(this.selectedItems);l.forEach(h=>{a?c.add(h):c.delete(h)}),this.selectedItems=[...c],this.state[this.id+"_selected_items"]=this.selectedItems}this.rangeStartItem=t}render(){let e=[];this.field?.fieldId&&this.state&&this.state[this.field.fieldId]&&(e=this.state[this.field.fieldId]);const t=this.state[this.field?.fieldId+"_show_detail"]||this.state._show_detail&&this.state._show_detail[this.field.fieldId];if(this.field?.remoteCoordinates){const a=this.field.remoteCoordinates,i="";this.data[this.id]&&(this.data[this.id].searchSignature||i)&&this.data[this.id].searchSignature!=i&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements?e=this.data[this.id].content:this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a.action,parameters:{searchText:i,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0}))}if(Array.isArray(e)&&e.forEach((a,i)=>{a&&typeof a=="object"&&a._rowNumber===void 0&&(a._rowNumber=i)}),this.field?.inlineEditing)return this.renderMaster(e);if(this.field?.formPosition&&this.field?.formPosition.startsWith("modal")){const a=this;return o`
            ...
            <vaadin-grid
                    ...
                    ${R(this.field?.detailPath?ui(a=>o`${$(this,a[this.field?.detailPath],this.baseUrl,this.state,this.data,this.appState,this.appData)}`):void 0)}
            ...
            >
                ...
                `}
                ${this.field?.columns?.map(a=>Ra(a,this,this.baseUrl,this.state,this.data,this.appState,this.appData))}
            ...
            ${this.field?.readOnly?d:this.field?.inlineEditing?o`
                ...
                `}
        </vaadin-vertical-layout>`}};Oe.styles=_`
        ${st}
    ...
    `;rt([u()],Oe.prototype,"field",2);rt([u()],Oe.prototype,"state",2);rt([u()],Oe.prototype,"data",2);rt([u()],Oe.prototype,"appState",2);rt([u()],Oe.prototype,"appData",2);rt([u()],Oe.prototype,"selectedItems",2);rt([v()],Oe.prototype,"detailsOpenedItems",2);Oe=rt([C("mateu-grid")],Oe);var So=Object.defineProperty,Co=Object.getOwnPropertyDescriptor,Dt=(e,t,a,i)=>{for(var s=i>1?void 0:i?Co(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&So(t,a,s),s};let et=class extends I{constructor(){super(...arguments),this.getNewValue=e=>{if(this.field?.dataType=="array"){if(!this.value)return[e];const t=this.value;return t.indexOf(e)>=0?t.filter(a=>a!==e):[...t,e]}return e}}render(){let e=this.field?.options;if(this.field?.remoteCoordinates){const a=this.field.remoteCoordinates;this.data?.[this.field.fieldId]&&this.data[this.field.fieldId].content&&this.data[this.field.fieldId].totalElements?e=this.data[this.field.fieldId].content:this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a.action,parameters:{searchText:"",fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0}))}const t=this.field?.attributes?.divStyle;return o`
  ...
  `;Dt([u()],et.prototype,"field",2);Dt([u()],et.prototype,"baseUrl",2);Dt([u()],et.prototype,"state",2);Dt([u()],et.prototype,"data",2);Dt([u()],et.prototype,"value",2);et=Dt([C("mateu-choice")],et);var _o=Object.defineProperty,Eo=Object.getOwnPropertyDescriptor,Ae=(e,t,a,i)=>{for(var s=i>1?void 0:i?Eo(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&_o(t,a,s),s};let ce=class extends I{constructor(){super(...arguments),this.currencyChanged=e=>{this.value||(this.value={value:0,currency:"EUR",locale:"es-ES"}),this.value.currency=e.detail.value,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:{...this.value},fieldId:this.fieldId}}))},this.valueChanged=e=>{this.value||(this.value={value:0,currency:"EUR",locale:"es-ES"}),e.detail.value&&(this.value.value=e.detail.value?parseFloat(e.detail.value):0,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:{...this.value},fieldId:this.fieldId}})))}}render(){return o`
            <vaadin-number-field
                    id="${this.fieldId}"
                    label="${this.label}"
...
`,this.comboRenderer=e=>o`
        ...
        `:d}
                            ...
                            `:e.label}
`,this.filteredIcons=[],this.navLinkOffset=null,this.iconFilterChanged=e=>{this.filteredIcons=Qa.filter(t=>!e.detail.value||t.indexOf(e.detail.value)>=0)}}remoteComboDataProvider(e){return(t,a)=>{const{filter:i,page:s,pageSize:r}=t,n=i??"";this._comboFilter=n,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e,parameters:{searchText:i,fieldId:this.field?.fieldId,size:r,page:s,sort:void 0},callback:l=>{if(n===this._comboFilter)if(l?.messages?.forEach(c=>{Kt.show(c.text,{position:c.position?this.mapPosition(c.position):void 0,theme:c.variant,duration:c.duration})}),!l.fragments||l.fragments.length==0)this.comboData=[],a([],0);else{const c=l.fragments[0].data?.[this.id];this.comboData=c?.content,a(c?.content,c?.totalElements)}},callbackonly:!0},bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.rendered=!1}renderNavLink(){const e=this.field?.link;if(!e?.href)return d;const t=ye(e.href,this.state,this.data)??e.href,a=ye(e.title,this.state,this.data)||t,i=e.icon||(t.startsWith("http")?"vaadin:external-link":"vaadin:link"),s=this.navLinkOffset??"calc(var(--lumo-font-size-s) * 1.6 + (var(--lumo-size-m) - var(--lumo-icon-size-s)) / 2)";return o`<a
                data-navlink
                href="${t}"
                title="${a}"
        ...
        ><vaadin-icon icon="${i}" style="width: var(--lumo-icon-size-s); height: var(--lumo-icon-size-s);"></vaadin-icon></a>`}positionNavLink(){const e=this.renderRoot?.querySelector("a[data-navlink]");e&&setTimeout(()=>{const t=e.parentElement,a=t?.firstElementChild?.firstElementChild;if(!t||!a)return;const s=(a.shadowRoot?.querySelector('[part="input-field"]')??a).getBoundingClientRect();if(s.height===0)return;const r=Math.max(0,s.top+s.height/2-e.offsetHeight/2-t.getBoundingClientRect().top),n=`${Math.round(r)}px`;this.navLinkOffset!==n&&(this.navLinkOffset=n)})}helperText(){return this.helperShownInControl=!0,Xe(this.field?.description??"",this.state,this.data)??""}render(){const e=this.field?.fieldId??"";this.rendered=!0;const t=this.renderNavLink();this.helperShownInControl=!1;const a=this.renderField(),i=this.field?.description&&!this.helperShownInControl?Xe(this.field.description,this.state,this.data):void 0;return o`<div style="display: block;">
...
`}renderFileField(e,t,a,i){if(!this.field)return o``;const s=t?.map(r=>({id:r.id,name:r.name,type:"",uploadTarget:"",complete:!0}))??[];return o`
  ...
  ${Ea(this.renderColorPickerFooter,[])}
></vaadin-dialog>
                `:o`
                <vaadin-text-field
                        id="${this.field.fieldId}"
...
`;if(this.field?.stereotype=="listBox"){if(this.field?.remoteCoordinates){const s=this.field.remoteCoordinates,r="";return this.data[this.id]&&(this.data[this.id].searchSignature||r)&&this.data[this.id].searchSignature!=r&&(this.data[this.id]=void 0),this.data[this.id]&&this.data[this.id].content&&this.data[this.id].totalElements||this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:s.action,parameters:{searchText:r,fieldId:this.field?.fieldId,size:200,page:0,sort:void 0}},bubbles:!0,composed:!0})),o`
            ...
            ></mateu-money-field>`}renderStatusField(e,t,a,i){if(!this.field)return o``;const s=t;return o`
                <vaadin-custom-field
                        ...
                        data-colspan="${this.field.colspan}"
                >
                    ${s?o`<span theme="badge pill ${ha(s.type)}">${s.message}</span>`:o``}                    
                </vaadin-custom-field>
  ...
  `;oe([u()],K.prototype,"component",2);oe([u()],K.prototype,"field",2);oe([u()],K.prototype,"baseUrl",2);oe([u()],K.prototype,"state",2);oe([u()],K.prototype,"data",2);oe([u()],K.prototype,"appState",2);oe([u()],K.prototype,"appData",2);oe([u()],K.prototype,"labelAlreadyRendered",2);oe([v()],K.prototype,"colorPickerOpened",2);oe([v()],K.prototype,"colorPickerValue",2);oe([v()],K.prototype,"filteredIcons",2);oe([v()],K.prototype,"navLinkOffset",2);K=oe([C("mateu-field")],K);var Ro=Object.defineProperty,Po=Object.getOwnPropertyDescriptor,xt=(e,t,a,i)=>{for(var s=i>1?void 0:i?Po(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Ro(t,a,s),s};const Oo=e=>{const t=[];return e.color&&e.color!=="normal"&&e.color!=="none"&&t.push(e.color),e.buttonStyle&&t.push(e.buttonStyle==="tertiaryInline"?"tertiary-inline":e.buttonStyle),e.size&&e.size!=="none"&&e.size!=="normal"&&t.push(e.size),t.length?t.join(" "):void 0},Za=e=>e==="back"||e==="backToList"||!!e&&e.startsWith("cancel");let Be=class extends I{constructor(){super(...arguments),this.appState={},this.appData={},this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.evalLabel=e=>ye(e,this.state,this.data),this.renderBtn=e=>{if((this.data??{})[e.actionId+".hidden"])return d;const t=this.evalLabel(e.label),a=q.get()?.renderToolbarButton?.(e,t,()=>this.handleButtonClick(e.actionId));return a||o`
        <vaadin-button
                data-action-id="${e.id}"
                theme="${Oo(e)||d}"
    ...
    `}}render(){const e=this.metadata;if(!e)return o``;const t=e.toolbar??[],a=t.filter(l=>Za(l.actionId)),i=t.filter(l=>!Za(l.actionId)),s=a.length>0&&i.length>0?o`<span class="toolbar-divider"></span>`:d,r=e.avatar||e.title||e.subtitle||e.kpis?.length>0||e.header?.length>0||t.length>0,n=e.level??0;return n>0?this.setAttribute("data-nested",""):this.removeAttribute("data-nested"),o`
            ...
            `:r?o`
                <vaadin-horizontal-layout theme="spacing" style="width: 100%; align-items: center;" class="form-header">
                    ...
                    <div style="flex: 1; min-width: 0; overflow: hidden;">
                        ${e?.title&&n==0?o`<h2 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${$e(ht(e?.title,this.state??{},this.data??{}))}</h2>`:d}
                        ${e?.title&&n==1?o`<h3 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${$e(ht(e?.title,this.state??{},this.data??{}))}</h3>`:d}
                        ${e?.title&&n==2?o`<h4 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${$e(ht(e?.title,this.state??{},this.data??{}))}</h4>`:d}
                        ${e?.title&&n==3?o`<h5 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${$e(ht(e?.title,this.state??{},this.data??{}))}</h5>`:d}
                        ${e?.title&&n>3?o`<h6 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${$e(ht(e?.title,this.state??{},this.data??{}))}</h6>`:d}

                        ${e?.subtitle?o`<span style="display: inline-block; margin-block-end: 0.83em;">${$e(ht(e?.subtitle,this.state??{},this.data??{}))}</span>`:d}
                    </div>
                    <vaadin-horizontal-layout theme="spacing" style="align-items: center;">
                        ${e?.kpis?.map(l=>o`
                            <vaadin-vertical-layout style="align-items: center">
                                <div>${this.evalLabel(l.title)}</div>
                                <div>${$e(ht(l.text,this.state??{},this.data??{}))}</div>
                            </vaadin-vertical-layout>
                        `)}
                        ${e?.header?.map(l=>$(this,l,this.baseUrl,this.state??{},this.data??{},this.appState,this.appData))}
                        ${a.map(this.renderBtn)}
            ...
            ${e.badges&&e.badges.length>0?o`
                <vaadin-horizontal-layout style="padding-bottom: var(--lumo-space-s);">
                    ${e.badges.map(l=>Ys(l,this.state??{},this.data??{}))}
                </vaadin-horizontal-layout>
            `:d}
        `}};Be.styles=_`
        :host {
        ...
        ${st}
    `;xt([u()],Be.prototype,"metadata",2);xt([u()],Be.prototype,"baseUrl",2);xt([u()],Be.prototype,"state",2);xt([u()],Be.prototype,"data",2);xt([u()],Be.prototype,"appState",2);xt([u()],Be.prototype,"appData",2);Be=xt([C("mateu-content-header")],Be);var Lo=Object.defineProperty,Do=Object.getOwnPropertyDescriptor,Qt=(e,t,a,i)=>{for(var s=i>1?void 0:i?Do(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Lo(t,a,s),s};let vt=class extends Jt{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={}}render(){const e=this.component?.metadata;return o`
    ...
    `;Qt([u()],vt.prototype,"state",2);Qt([u()],vt.prototype,"data",2);Qt([u()],vt.prototype,"appState",2);Qt([u()],vt.prototype,"appData",2);vt=Qt([C("mateu-form")],vt);var zo=Object.defineProperty,Ao=Object.getOwnPropertyDescriptor,Se=(e,t,a,i)=>{for(var s=i>1?void 0:i?Ao(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&zo(t,a,s),s};let ie=class extends I{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.detailsOpenedItems=[],this.pagesRequested=[],this.emptyArray=e=>!e||e.length==0,this.dataProvider=(e,t)=>{const a=this.data[this.id]?.page;if(this.metadata?.infiniteScrolling&&e.page>0){let i=!1;a&&a.content&&(a.content.length>=(e.page+1)*e.pageSize||a.content.length==a.totalElements)&&(t(a.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),a.totalElements),i=!0,this.grid&&this.grid.recalculateColumnWidths()),i||this.pagesRequested.find(s=>s==e.page)||(this.pagesRequested.push(e.page),this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:e,callback:()=>{this.data[this.id]?.page?.content&&(t(this.data[this.id].page.content.slice(e.page*e.pageSize,(e.page+1)*e.pageSize),this.data[this.id].page.totalElements),this.grid&&this.grid.recalculateColumnWidths())}},bubbles:!0,composed:!0})))}else{const i=this.metadata?.infiniteScrolling?a?.totalElements:a?.content?.length??0;t(a?.content??[],i),this.grid&&this.grid.recalculateColumnWidths()}},this._onActionRequested=e=>{const t=e.detail,a=this.identifierFieldName;if(!a||!t.parameters||t.actionId?.startsWith("action-on-row-"))return;const i=t.parameters[a];i!==void 0&&(this.state._selectedId=String(i),this._applyCellPartNameGenerator(),this.grid?.requestContentUpdate())},this.tooltipGenerator=e=>{let t="";const{column:a,item:i}=e,s=this.metadata?.columns?.find(r=>r.metadata.id==a?.path);if(s?.metadata){const r=(s?.metadata).tooltipPath;r&&a&&i&&(t=i[r])}return t}}get identifierFieldName(){const e=this.metadata?.columns?.find(a=>a.metadata?.identifier);if(e)return e.metadata?.id;if(this.metadata?.columns?.find(a=>a.metadata?.id==="id"))return"id"}_applyCellPartNameGenerator(){if(!this.grid)return;const e=this.identifierFieldName,t=this.state?._selectedId??this.appState?._splitDetailId;e&&t!==void 0?this.grid.cellPartNameGenerator=(a,i)=>String(i.item[e])===String(t)?"selected-row":"":this.grid.cellPartNameGenerator=null}connectedCallback(){super.connectedCallback(),this.addEventListener("action-requested",this._onActionRequested)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("action-requested",this._onActionRequested)}updated(e){super.updated(e),this._applyCellPartNameGenerator(),this.grid?.clearCache(),this.grid?.recalculateColumnWidths(),this.pagesRequested=[]}render(){const e=this.data[this.id]?.page;let t="";this.metadata?.wrapCellContent&&(t+=" wrap-cell-content"),this.metadata?.compact&&(t+=" compact"),this.metadata?.noBorder&&(t+=" no-border"),this.metadata?.noRowBorder&&(t+=" no-row-borders"),this.metadata?.columnBorders&&(t+=" column-borders"),this.metadata?.rowStripes&&(t+=" row-stripes");const a=this.state[this.id+"_selected_items"]||[];return o`
            <vaadin-grid
                    ...
                    .detailsOpenedItems="${this.detailsOpenedItems}"
                    ${R(this.metadata?.detailPath?ui(i=>o`${$(this,i[this.metadata?.detailPath],this.baseUrl,this.state,this.data,this.appState,this.appData)}`):void 0)}
                    theme="${t}"
            ...
            >
                ...
                `:d}
                ${this.metadata?.columns?.map(i=>Ra(i,this,this.baseUrl,this.state,this.data,this.appState,this.appData))}
                ${this.metadata?.useButtonForDetail?o`
                    <vaadin-grid-column
                            width="44px"
                            flex-grow="0"
                            ${Me((i,{detailsOpened:s})=>o`
              <vaadin-button
                theme="tertiary icon"
  ...
  `;Se([u()],ie.prototype,"id",2);Se([u()],ie.prototype,"metadata",2);Se([u()],ie.prototype,"baseUrl",2);Se([u()],ie.prototype,"state",2);Se([u()],ie.prototype,"data",2);Se([u()],ie.prototype,"appState",2);Se([u()],ie.prototype,"appData",2);Se([u()],ie.prototype,"emptyStateMessage",2);Se([v()],ie.prototype,"detailsOpenedItems",2);Se([ze("vaadin-grid")],ie.prototype,"grid",2);ie=Se([C("mateu-table")],ie);var Fo=Object.defineProperty,No=Object.getOwnPropertyDescriptor,Ce=(e,t,a,i)=>{for(var s=i>1?void 0:i?No(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Fo(t,a,s),s};let se=class extends I{constructor(){super(...arguments),this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.searchOnly=!1,this.panelOpened=!1,this.draftText="",this.openPanel=()=>{this.panelOpened||this.filters.length===0||(this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick))},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1,this.activeFilter=void 0},this.clearAllFilters=()=>{const e=this.filters.flatMap(a=>this.isRangeFilter(a)?[`${a.fieldId}_from`,`${a.fieldId}_to`]:[a.fieldId]),t={searchText:void 0};e.forEach(a=>{t[a]=void 0}),this.state={...this.state,...t},this.dispatchEvent(new CustomEvent("filter-reset-requested",{detail:{fieldIds:e},bubbles:!0,composed:!0})),this.requestSearch()},this.keepFocus=e=>e.preventDefault()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}get filters(){return this.metadata?.filters??[]}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}requestSearch(){this.closePanel(),this.dispatchEvent(new CustomEvent("search-requested",{detail:{},bubbles:!0,composed:!0}))}emitValueChanged(e,t){this.state={...this.state,[e]:t},this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t,fieldId:e},bubbles:!0,composed:!0}))}applyFilter(e,t){this.emitValueChanged(e,t),this.requestSearch()}removeChip(e){const t=this.filters.find(a=>a.fieldId===e);t&&this.isRangeFilter(t)?(this.emitValueChanged(`${e}_from`,void 0),this.emitValueChanged(`${e}_to`,void 0)):this.emitValueChanged(e,e==="searchText"?"":void 0),this.requestSearch()}commitText(e){this.emitValueChanged("searchText",e.value),this.draftText="",e.value="",this.requestSearch()}isBooleanFilter(e){return e.dataType==="boolean"||e.dataType==="bool"||e.stereotype==="checkbox"||e.stereotype==="toggle"}isNumericFilter(e){return["integer","decimal","number","money"].includes(e.dataType??"")}isRangeFilter(e){return e.stereotype==="dateRange"||e.stereotype==="numberRange"}isMultiFilter(e){return e.stereotype==="multiSelect"}hasOptions(e){return(e.options?.length??0)>0}multiValues(e){const t=this.state[e.fieldId];return Array.isArray(t)?t.map(String):typeof t=="string"&&t!==""?t.split(",").map(a=>a.trim()).filter(a=>a):[]}rangeBound(e,t){const a=this.state[`${e.fieldId}_${t}`];return a==null?"":String(a)}isSet(e){if(this.isRangeFilter(e))return this.rangeBound(e,"from")!==""||this.rangeBound(e,"to")!=="";if(this.isMultiFilter(e))return this.multiValues(e).length>0;const t=this.state[e.fieldId];return t!=null&&t!==""&&!Number.isNaN(t)}getFilterDisplayValue(e,t){if(e.options?.length){const a=e.options.find(i=>i.value===String(t));if(a)return a.label??a.value}return typeof t=="boolean"?t?"Yes":"No":String(t)}conditionDisplay(e){if(this.isRangeFilter(e)){const t=this.rangeBound(e,"from"),a=this.rangeBound(e,"to");return t&&a?`${t} – ${a}`:t?`≥ ${t}`:`≤ ${a}`}return this.isMultiFilter(e)?this.multiValues(e).map(t=>this.getFilterDisplayValue(e,t)).join(", "):this.getFilterDisplayValue(e,this.state[e.fieldId])}labelOf(e){return ye(e.label,this.state,this.data)||e.fieldId}panelRow(e,t,a="panel-row"){return o`
    ...
    `;Ce([u()],se.prototype,"metadata",2);Ce([u()],se.prototype,"baseUrl",2);Ce([v()],se.prototype,"state",2);Ce([v()],se.prototype,"data",2);Ce([u()],se.prototype,"appState",2);Ce([u()],se.prototype,"appData",2);Ce([u({type:Boolean})],se.prototype,"searchOnly",2);Ce([v()],se.prototype,"panelOpened",2);Ce([v()],se.prototype,"activeFilter",2);Ce([v()],se.prototype,"draftText",2);se=Ce([C("mateu-filter-bar")],se);var qo=Object.defineProperty,Mo=Object.getOwnPropertyDescriptor,Zt=(e,t,a,i)=>{for(var s=i>1?void 0:i?Mo(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&qo(t,a,s),s};let ft=class extends I{constructor(){super(...arguments),this.totalElements=0,this.pageSize=100,this.pageNumber=0,this.totalPages=0}updated(e){super.updated(e),(e.has("totalElements")||e.has("pageSize"))&&(this.totalPages=Math.ceil(this.totalElements/this.pageSize))}dispatch(e){this.dispatchEvent(new CustomEvent("page-changed",{bubbles:!0,composed:!0,detail:{page:e}}))}render(){if(!this.totalElements)return d;const e=this.totalPages>1,t=this.pageNumber,a=t===0,i=t>=this.totalPages-1;return o`
    ...
    `;Zt([u()],ft.prototype,"totalElements",2);Zt([u()],ft.prototype,"pageSize",2);Zt([u()],ft.prototype,"pageNumber",2);Zt([v()],ft.prototype,"totalPages",2);ft=Zt([C("mateu-pagination")],ft);var Uo=Object.defineProperty,Bo=Object.getOwnPropertyDescriptor,pe=(e,t,a,i)=>{for(var s=i>1?void 0:i?Bo(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Uo(t,a,s),s};let X=class extends I{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.dataProvider=(e,t)=>{const a=this.data[this.id]?.page;t(a?.content??[],a?.content?.length??0)},this.respondToVisibility=(e,t)=>{var a={root:document.documentElement},i=new IntersectionObserver(s=>{s.forEach(r=>{t(r.intersectionRatio>0)})},a);i.observe(e)},this.keepAsking=!1,this.askToUpper=()=>{const e=this.data[this.id]?.page,t=e?.content?.length/e?.pageSize;this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:{page:t,pageSize:this.metadata?.pageSize},callback:()=>{this.keepAsking&&this.askToUpper()}},bubbles:!0,composed:!0}))},this.renderItem=e=>e.card?La(this,e.card,this.baseUrl,this.state,this.data,this.appState,this.appData,!1):e.title?o`<vaadin-card
        >
                ${e.title?o`
                ...
                `:d}
                ${e.status?o`
                    <span slot="header-suffix" theme="badge ${ha(e.status.type)}">${e.status.message}</span>
                `:d}
                ${e.image?o`
    ...
    `;pe([u()],X.prototype,"id",2);pe([u()],X.prototype,"metadata",2);pe([u()],X.prototype,"baseUrl",2);pe([u()],X.prototype,"state",2);pe([u()],X.prototype,"data",2);pe([u()],X.prototype,"appState",2);pe([u()],X.prototype,"appData",2);pe([u()],X.prototype,"emptyStateMessage",2);pe([v()],X.prototype,"keepAsking",2);pe([ze("#ask-for-more")],X.prototype,"askForMore",2);pe([v()],X.prototype,"hasMore",2);X=pe([C("mateu-card-list")],X);var _i=(e=>(e.none="none",e.success="success",e.error="error",e.warning="warning",e.contrast="contrast",e.normal="normal",e))(_i||{}),Ei=(e=>(e.primary="primary",e.secondary="secondary",e.tertiary="tertiary",e.tertiaryInline="tertiaryInline",e))(Ei||{});const jo=76;function ei(e){if(e.weight!=null)return e.weight;const t=e.stereotype??"";if(t==="icon")return 1;if(t==="image")return 4;if(t==="html"||t==="richText"||t==="markdown"||t==="textarea")return 5;if(t==="link")return 2.5;if(t==="combobox"||t==="select")return 2;const a=e.dataType??"";return a==="bool"?1:a==="status"||a==="integer"?1.5:a==="number"||a==="date"||a==="money"?2:a==="dateTime"||a==="dateRange"?2.5:3}function Wo(e,t){if(e.length===0)return"table";const a=e.reduce((c,h)=>c+ei(h),0),i=t/jo,s=a/i;if(s<=1)return"table";const r=e.filter(c=>c.identifier||(c.priority??Number.MAX_SAFE_INTEGER)<=2),n=r.reduce((c,h)=>c+ei(h),0);return s>1.6||e.length>10?"masterDetail":r.length>0&&n<=8?"list":e.some(c=>c.stereotype==="image"||c.stereotype==="html")||r.length===0&&e.length>=4&&e.length<=8?"cards":"masterDetail"}function Vo(e){return e.filter(t=>t.identifier||(t.priority??Number.MAX_SAFE_INTEGER)<=2).sort((t,a)=>(t.priority??Number.MAX_SAFE_INTEGER)-(a.priority??Number.MAX_SAFE_INTEGER))}var Ho=Object.defineProperty,Go=Object.getOwnPropertyDescriptor,_e=(e,t,a,i)=>{for(var s=i>1?void 0:i?Go(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Ho(t,a,s),s};const Ko={asc:"ascending",desc:"descending"};let re=class extends I{constructor(){super(...arguments),this.component=void 0,this.standalone=!1,this.state={},this.data={},this.appState={},this.appData={},this.showImportDialog=!1,this.availableWidthPx=1024,this.selectedItem=null,this.search=()=>{const e=this.component.metadata;this.state={...this.state,size:e.pageSize,page:0,crud_selected_items:[]},this._syncStateToUrl(e),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}}},bubbles:!0,composed:!0}))},this.notify=e=>{Kt.show(e,{position:"bottom-end",theme:"error",duration:3e3})},this.handleSearchRequested=e=>{this.state={...this.state,crud_selected_items:[]};const t=this.component.metadata;this._syncStateToUrl(t),!t.infiniteScrolling&&this.data?.[this.id]?.page&&(this.data[this.id].page.content=[]),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}},callback:e},bubbles:!0,composed:!0}))},this.fetchMoreElements=e=>{const{params:t,callback:a}=e.detail;this.state={...this.state,size:t.pageSize,page:t.page},this.handleSearchRequested(a)},this.directionChanged=e=>{const t=e.detail.grid._sorters;this.state={...this.state,sort:t.map(a=>({fieldId:a.__data.path,direction:a.__data.direction?Ko[a.__data.direction]:void 0}))},this.handleSearchRequested(void 0)},this._initializedForComponentId=void 0,this.evalLabel=e=>ye(e,this.state,this.data),this.handleToolbarButtonClick=e=>{if(e==="import"){this.showImportDialog=!0;return}this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.handleImportUploadSuccess=e=>{const t=e.detail.xhr.responseText;this.showImportDialog=!1,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"process-import",parameters:{fileId:t}},bubbles:!0,composed:!0}))}}get cols(){return this.component?.metadata?.columns?.map(t=>t.metadata)??[]}get identifierFieldName(){const e=this.cols.find(t=>t.identifier);return e?e.id:this.cols.find(t=>t.id==="id")?.id}get effectiveGridLayout(){const e=this.component?.metadata,t=e?.gridLayout??"auto";return t==="auto"?e?.crudlType==="card"?"cards":Wo(this.cols,this.availableWidthPx):t}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{const t=e[0]?.contentRect.width;t&&Math.abs(t-this.availableWidthPx)>10&&(this.availableWidthPx=t)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}_filterIds(e){return new Set(["searchText",...(e.filters??[]).flatMap(t=>t.stereotype==="dateRange"||t.stereotype==="numberRange"?[`${t.fieldId}_from`,`${t.fieldId}_to`]:[t.fieldId])])}_syncStateToUrl(e){const t=this._filterIds(e),a=new URLSearchParams(window.location.search);t.forEach(l=>a.delete(l)),a.delete("page"),a.delete("sort"),t.forEach(l=>{const c=this.state[l];c!=null&&c!==""&&a.set(l,String(c))});const i=this.state.page;i&&i>0&&a.set("page",String(i));const s=this.state.sort;if(s&&s.length>0){const l=s.filter(c=>c.fieldId&&c.direction).map(c=>`${c.fieldId}:${c.direction}`).join(",");l&&a.set("sort",l)}const r=a.toString(),n=r?`${window.location.pathname}?${r}`:window.location.pathname;window.location.pathname+window.location.search!==n&&history.replaceState(null,"",n)}_initStateFromUrl(e,t){const a=new URLSearchParams(window.location.search),i=this._filterIds(e),s={...t};a.forEach((l,c)=>{i.has(c)&&(s[c]=l)});const r=a.get("page");if(r!==null){const l=parseInt(r,10);!isNaN(l)&&l>0&&(s.page=l)}const n=a.get("sort");if(n){const l=n.split(",").map(c=>{const[h,m]=c.split(":");return h&&m?{fieldId:h,direction:m}:null}).filter(Boolean);l.length>0&&(s.sort=l)}return s}pageChanged(e){this.state={...this.state,page:e.detail.page},this.handleSearchRequested(void 0)}updated(e){if(super.updated(e),e.has("component")){const t=this.component?.id;if(t!==this._initializedForComponentId){this._initializedForComponentId=t;const a=this.component?.metadata,i=a.initialPage&&a.initialPage>0?a.initialPage:0;this.state=this._initStateFromUrl(a,{...this.state,size:a.pageSize,page:i,sort:[]}),(this.state.page!==i||this.state.sort?.length>0||[...this._filterIds(a)].some(r=>this.state[r]!=null))&&this.handleSearchRequested(void 0)}}}render(){const e=y=>{const P=[];return y.color&&y.color!==_i.normal&&P.push(y.color),y.buttonStyle&&P.push(y.buttonStyle===Ei.tertiaryInline?"tertiary-inline":y.buttonStyle),P.length?P.join(" "):void 0},t=y=>y==="back"||y==="backToList"||!!y&&y.startsWith("cancel"),a=y=>{const P=q.get()?.renderToolbarButton?.(y,this.evalLabel(y.label),()=>this.handleToolbarButtonClick(y.actionId));return P||o`
                <vaadin-button
                        data-action-id="${y.id}"
                        theme="${e(y)||d}"
                        @click="${()=>this.handleToolbarButtonClick(y.actionId)}"
                >${this.evalLabel(y.label)}</vaadin-button>
            `};if(!this.component)return o`no component`;const i=this.component.metadata;i.serverSideOrdering=!0;const s=i?.toolbar??[],r=s.filter(y=>t(y.actionId)),n=s.filter(y=>!t(y.actionId)),l=r.length>0&&n.length>0,c=!!i?.title||!!i?.subtitle||s.length>0,h=this.effectiveGridLayout,m=this.cols,f=Vo(m),b=this.data[this.id]?.page?.content??[],S=this.state[this.component?.id]?.emptyStateMessage,w=(y,P)=>{const k=P[y.id];if(k==null)return o``;if(y.dataType==="status"){const B=ha(k.type);return o`<span theme="badge pill ${B}">${k.message}</span>`}return y.dataType==="bool"?o`${k?"✓":"✗"}`:typeof k=="object"?o`${k.label??k.name??k.message??""}`:o`${k}`},g=()=>{const y=this.identifierFieldName,P=this.state._selectedId??this.appState?._splitDetailId,k=f.find(E=>E.identifier)??f[0],B=E=>E.dataType==="action"||E.dataType==="actionGroup"||E.dataType==="menu"||E.stereotype==="button",lt=f.filter(E=>E!==k&&!B(E)),kt=m.filter(E=>B(E)),Ge=(E,J,le)=>{E.stopPropagation(),E.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:J,parameters:{_clickedRow:le}},bubbles:!0,composed:!0}))},St=E=>{const J=[];for(const le of kt){const D=E[le.id];if(le.dataType==="action"){const L=D?.methodNameInCrud?D:E.action?.methodNameInCrud?E.action:{methodNameInCrud:le.id,label:le.label,icon:null};J.push(o`
                            <vaadin-button theme="tertiary small" title="${L.label||d}"
                                @click="${x=>Ge(x,"action-on-row-"+L.methodNameInCrud,E)}">
                                ${L.icon?o`<vaadin-icon icon="${L.icon}"></vaadin-icon>`:d}
                                ${L.label??d}
                            </vaadin-button>`)}else(le.dataType==="actionGroup"||le.dataType==="menu")&&(D?.actions??[]).forEach(x=>J.push(o`
                            <vaadin-button theme="tertiary small" title="${x.label||d}"
                                @click="${M=>Ge(M,"action-on-row-"+x.methodNameInCrud,E)}">
                ...
                <vaadin-list-box style="width: 100%;">
                    ${b.length===0?o`<vaadin-item disabled>${ut(S)}</vaadin-item>`:d}
                    ${b.map(E=>o`
                        <vaadin-item
                            ?selected="${y&&P!==void 0&&String(E[y])===String(P)}"
                            @click="${()=>{y&&E[y]!==void 0&&(this.state={...this.state,_selectedId:String(E[y])}),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"view",parameters:E},bubbles:!0,composed:!0}))}}"
                            style="cursor: pointer;"
                        >
                            ...
                            <div style="font-size: var(--lumo-font-size-s); color: var(--lumo-secondary-text-color); display: flex; flex-wrap: wrap; gap: var(--lumo-space-xs); align-items: center;">
                                ${lt.map(J=>o`<span>${J.label}: ${w(J,E)}</span>`)}
                            </div>
                            ${St(E)}
                        </vaadin-item>
                    `)}
                </vaadin-list-box>`},O=(y,P,k)=>{const B=this.identifierFieldName;B&&k[B]!==void 0&&(this.state={...this.state,_selectedId:String(k[B])}),y.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:P,parameters:k},bubbles:!0,composed:!0}))},F=()=>{const y=this.identifierFieldName,P=this.state._selectedId??this.appState?._splitDetailId,k=m.slice(0,6),B=k.filter(x=>x.stereotype==="image"),lt=k.find(x=>x.identifier)??k[0],kt=x=>!!x.actionId,Ge=x=>x.dataType==="action"||x.dataType==="actionGroup"||x.dataType==="menu"||x.stereotype==="button",St=k.find(x=>x.id==="select"&&x.dataType==="action"),E=!!St,J=k.filter(x=>x!==lt&&!B.includes(x)&&!kt(x)&&!Ge(x)),le=k.filter(x=>Ge(x)&&!(E&&x===St)),D=(x,M,Ke)=>{x.stopPropagation(),x.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:M,parameters:{_clickedRow:Ke}},bubbles:!0,composed:!0}))},L=x=>{const M=[];for(const Ke of le){const ga=x[Ke.id];if(Ke.dataType==="action"){const Ct=ga?.methodNameInCrud?ga:x.action?.methodNameInCrud?x.action:{methodNameInCrud:Ke.id,label:Ke.label,icon:null};M.push(o`
                            <vaadin-button theme="tertiary" title="${Ct.label||d}"
                                @click="${dt=>D(dt,"action-on-row-"+Ct.methodNameInCrud,x)}">
                                ${Ct.icon?o`<vaadin-icon icon="${Ct.icon}"></vaadin-icon>`:d}
                                ${Ct.label??d}
                            </vaadin-button>`)}else(Ke.dataType==="actionGroup"||Ke.dataType==="menu")&&(ga?.actions??[]).forEach(dt=>M.push(o`
                            <vaadin-button theme="tertiary" title="${dt.label||d}"
                                @click="${zi=>D(zi,"action-on-row-"+dt.methodNameInCrud,x)}">
                                ${dt.icon?o`<vaadin-icon icon="${dt.icon}"></vaadin-icon>`:d}
                                ${dt.label??d}
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: var(--lumo-space-m); padding: var(--lumo-space-s) 0;">
                    ${b.length===0?o`<div style="grid-column: 1 / -1;">${ut(S)}</div>`:d}
                    ${b.map(x=>o`
                        <vaadin-card
                            clickable
                            ?data-selected="${y&&P!==void 0&&String(x[y])===String(P)}"
                            style="cursor: pointer;"
                            @click="${M=>E?D(M,"action-on-row-select",x):O(M.target,"view",x)}"
                        >
                            ${B.length?o`<img slot="media" src="${x[B[0].id]??""}" alt="" style="width: 100%; max-height: 160px; object-fit: cover;" />`:d}
                            ${lt?o`<div slot="title">${x[lt.id]??""}</div>`:d}
                    ...
                    `)}
                </div>`},U=()=>{const y=f.find(k=>k.identifier)??f[0],P=f.filter(k=>k!==y);return o`
                        ...
                        <vaadin-list-box style="width: 100%;">
                            ...
                            ${b.map(k=>o`
                                <vaadin-item
                                    ...
                                    style="cursor: pointer;"
                                >
                                    <div style="font-weight: 600;">${y?k[y.id]??"":""}</div>
                                    <div style="font-size: var(--lumo-font-size-s); color: var(--lumo-secondary-text-color); display: flex; flex-wrap: wrap; gap: var(--lumo-space-xs); align-items: center;">
                                        ${P.map(B=>o`${w(B,k)} `)}
                                    </div>
                                </vaadin-item>
                ...
                </div>`},A=()=>{const y=this.identifierFieldName,P=this.state._selectedId??this.appState?._splitDetailId,k=m[0],B=m.slice(1),lt=!!k?.actionId,kt=D=>(D??[]).map(L=>{const x=Array.isArray(L.children)?L.children:[];return x.length>0?{...L,children:kt(x)}:{...L,children:void 0}}),Ge=kt(b),St=(D,L)=>{const x=D.parentItem?D.parentItem.children??[]:Ge;L(x,x.length)},E=(D,L)=>{for(const x of D??[]){if(y&&String(x[y])===L)return x;const M=E(x.children,L);if(M)return M}},J=y&&P!==void 0?E(Ge,String(P)):void 0,le=(D,L,x)=>{D.stopPropagation(),y&&L[y]!==void 0&&(this.state={...this.state,_selectedId:String(L[y])}),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:x,parameters:L},bubbles:!0,composed:!0}))};return o`
                <vaadin-grid
                    style="width: 100%;"
                    all-rows-visible
                ...
                >
                    ...
                    ${lt?o`
                    <vaadin-grid-column width="6rem" flex-grow="0" text-align="end" ${Me(D=>D?.viewable===!1?d:o`
                        <vaadin-button theme="tertiary small" @click="${L=>le(L,D,"view")}">View</vaadin-button>
                    `,[])}></vaadin-grid-column>`:d}
                    ${B.map(D=>D.id==="select"?o`<vaadin-grid-column width="7rem" flex-grow="0" text-align="end" header="${D.label??d}" ${Me(L=>o`
                    ...
                    <span slot="empty-state">${ut(S)}</span>
                </vaadin-grid>`},V=q.get()?.rendersCrudLayouts?.()===!0,nt=o`
            ...
            <slot></slot>
        `,Nt=i.infiniteScrolling?d:q.get()?.renderPagination(this,this.component),aa=o`
            <vaadin-dialog
        ...
        `;return this.standalone?o`
                ...
                <div style="border: var(--mateu-section-border, 1px solid var(--lumo-contrast-20pct)); border-radius: var(--lumo-border-radius-l); overflow: hidden; max-height: calc(100dvh - 12rem); width: 100%; box-sizing: border-box; padding: var(--lumo-space-m); display: flex; flex-direction: column;">
                    ...
                    <div style="flex: 1; overflow-y: auto; min-height: 0;">${nt}</div>
                    <div style="flex-shrink: 0;">${Nt}</div>
                </div>
            `:o`
            ${aa}
            ${c?o`
        ...
        `}createRenderRoot(){return q.mustUseShadowRoot()?super.createRenderRoot():this}};re.styles=_`
        ${st}
    ...
    `;_e([u()],re.prototype,"component",2);_e([u()],re.prototype,"baseUrl",2);_e([u({type:Boolean})],re.prototype,"standalone",2);_e([u()],re.prototype,"state",2);_e([u()],re.prototype,"data",2);_e([u()],re.prototype,"appState",2);_e([u()],re.prototype,"appData",2);_e([v()],re.prototype,"showImportDialog",2);_e([v()],re.prototype,"availableWidthPx",2);_e([v()],re.prototype,"selectedItem",2);re=_e([C("mateu-table-crud")],re);var Qe=(e=>(e.OnLoad="OnLoad",e.OnSuccess="OnSuccess",e.OnError="OnError",e.OnValueChange="OnValueChange",e.OnCustomEvent="OnCustomEvent",e.AutoSave="AutoSave",e))(Qe||{}),Jo=Object.defineProperty,ma=(e,t,a,i)=>{for(var s=void 0,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=n(t,a,s)||s);return s&&Jo(t,a,s),s};class ot extends Jt{constructor(){super(...arguments),this.state={},this.data={},this.appData={},this.appState={},this.triggerOnLoad=()=>{const t=this.component;this.registerCustomEventListeners(),t.triggers?.filter(a=>a.type==Qe.OnLoad).forEach(a=>{if((!a.condition||this._evalExpr(a.condition))&&!a.triggered){const s=a;s.triggered=!0;var i=s.times-1;s.timeoutMillis>0?this.scheduleOnload(s,i,this.id):this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:s.actionId},bubbles:!0,composed:!0}))}})},this.scheduleOnload=(t,a,i)=>{if(i!=this.component?.id)return;const s=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,callbackToken:s},bubbles:!0,composed:!0}))},t.timeoutMillis)},this._registeredCustomEventListeners=[],this.customEventManager=t=>{if(!(t instanceof CustomEvent))return;const a=t,s=(this.component.triggers??[]).filter(r=>r.type==Qe.OnCustomEvent).filter(r=>r.eventName==a.type).filter(r=>r.source!=="COMPONENT"||a.detail?.__source===r.from);s.length!==0&&(s.some(r=>!r.source||r.source==="SELF")&&(t.stopPropagation(),t.preventDefault()),s.forEach(r=>{(!r.condition||this._evalExpr(r.condition))&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.actionId,parameters:a.detail},bubbles:!0,composed:!0}))}))}}_interpolationExtra(){return{appState:this.appState??{},appData:this.appData??{},component:this.component}}_evalExpr(t){return vi(t,this.state??{},this.data??{},this._interpolationExtra())}_evalTemplate(t){return hs(t,this.state??{},this.data??{},this._interpolationExtra())}applyFragment(t){if(this.id==t.targetComponentId){if(t.component)if(Ht.Add==t.action)this.component&&this.component.children?.push(t.component);else{if(this.callbackToken=G(),t.component?.type==ae.ServerSide)if(this.component){const i=this.component,s=t.component;i.actions=s.actions,i.type=s.type,i.rules=s.rules,i.triggers=s.triggers,i.serverSideType=s.serverSideType,i.route=s.route,i.initialData=s.initialData,i.validations=s.validations,i.cssClasses=s.cssClasses,i.slot=s.slot,i.style=s.style,i.children=s.children,(i.serverSideType!=s.serverSideType||i.id!=s.id)&&setTimeout(()=>this.triggerOnLoad())}else this.component=t.component,setTimeout(()=>this.triggerOnLoad());else{const i=[t.component];this.component&&(this.component.children=i)}t.action!==Ht.ReplaceKeepData&&(this.state={},this.data={})}if(t.state&&(this.state={...this.state,...t.state}),t.data){for(const i in t.data){const s=t.data[i]?.page;s?.pageNumber>0&&this.data[i]&&this.data[i].page.content&&(s.content?s.content=[...this.data[i].page.content,...s.content]:s.content=[...this.data[i].page.content])}this.data={...this.data,...t.data}}this.registerCustomEventListeners();const a=q.getAfterRenderHook();a&&setTimeout(()=>a(this)),this.requestUpdate()}}registerCustomEventListeners(){this._registeredCustomEventListeners.forEach(({target:a,name:i})=>a.removeEventListener(i,this.customEventManager)),this._registeredCustomEventListeners=[],this.component?.triggers?.filter(a=>a.type==Qe.OnCustomEvent).forEach(a=>{const i=a.source==="DOCUMENT"||a.source==="COMPONENT"?document:this;i.addEventListener(a.eventName,this.customEventManager),this._registeredCustomEventListeners.push({target:i,name:a.eventName})})}disconnectedCallback(){this._registeredCustomEventListeners.forEach(({target:t,name:a})=>t.removeEventListener(a,this.customEventManager)),this._registeredCustomEventListeners=[],super.disconnectedCallback()}connectedCallback(){super.connectedCallback(),this.component&&this.registerCustomEventListeners()}}ma([u()],ot.prototype,"state");ma([u()],ot.prototype,"data");ma([u()],ot.prototype,"appData");ma([u()],ot.prototype,"appState");var Yo=Object.defineProperty,Xo=Object.getOwnPropertyDescriptor,va=(e,t,a,i)=>{for(var s=i>1?void 0:i?Xo(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Yo(t,a,s),s};let Pt=class extends I{constructor(){super(...arguments),this.notificationOpened=!1,this.fetchStarted=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!0},this.fetchFinished=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1},this.fetchFailed=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1,this.error=e.detail.reason,this.openNotification()},this.openNotification=()=>{this.notificationOpened=!0},this.closeNotification=()=>{this.notificationOpened=!1},this.notificationRenderer=()=>o`
    <vaadin-horizontal-layout theme="spacing" style="align-items: center;">
...
`:o`<vaadin-button theme="tertiary" 
  ...
  `;Ii([u()],oa.prototype,"target",2);oa=Ii([C("mateu-event-interceptor")],oa);var rn=Object.defineProperty,on=Object.getOwnPropertyDescriptor,Ti=(e,t,a,i)=>{for(var s=i>1?void 0:i?on(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&rn(t,a,s),s};let na=class extends ot{constructor(){super(...arguments),this.opened=!0,this.close=()=>{this.opened=!1,setTimeout(()=>this.parentElement?.removeChild(this),500)}}applyFragment(e){super.applyFragment(e);const t=e.state?._closeAfterMillis;t&&setTimeout(()=>this.close(),t)}updated(e){if(super.updated(e),e.has("component")&&this.component){const t=this.component.metadata;this.state=t.initialData}}render(){const e=this.component.metadata;let t="";e.noPadding&&(t+=" no-padding");const a=Ia(e.headerTitle,this.state,this.data,this.appState,this.appData);return o`
        <vaadin-dialog
                ...
                width="${e.width??d}"
                height="${e.height??d}"
                ${e.header||e.closeButtonOnHeader?qi(()=>o`<mateu-event-interceptor .target="${this}" style="width: 100%;">${e.header?$(this,e.header,this.baseUrl,this.state,this.data,this.appState,this.appData):d}${e.closeButtonOnHeader?o`
                            <vaadin-button theme="tertiary" @click="${this.close}">
                                <vaadin-icon icon="lumo:cross"></vaadin-icon>
                            </vaadin-button>
                        `:d}</mateu-event-interceptor>`,[this.state,this.data]):d}
                ${e.footer?Ea(()=>o`<mateu-event-interceptor .target="${this}" style="width: 100%;">${$(this,e.footer,this.baseUrl,this.state,this.data,this.appState,this.appData)}</mateu-event-interceptor>`,[this.state,this.data]):d}
                ${e.content?da(()=>o`<mateu-event-interceptor .target="${this}" style="--mateu-section-border: none; width: 100%;">${$(this,e.content,this.baseUrl,this.state,this.data,this.appState,this.appData)}</mateu-event-interceptor>`,[this.state,this.data]):d}
       ...
       `}};na.styles=_`
  `;Ti([v()],na.prototype,"opened",2);na=Ti([C("mateu-dialog")],na);var nn=Object.defineProperty,ln=Object.getOwnPropertyDescriptor,Ri=(e,t,a,i)=>{for(var s=i>1?void 0:i?ln(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&nn(t,a,s),s};let la=class extends ot{constructor(){super(...arguments),this.opened=!1,this.close=()=>{this.opened=!1,setTimeout(()=>this.parentElement?.removeChild(this),300)},this._escListener=e=>{if(e.key!=="Escape")return;const a=this.getRootNode().querySelectorAll("mateu-drawer, mateu-dialog");a[a.length-1]===this&&(e.stopPropagation(),this.close())}}firstUpdated(){requestAnimationFrame(()=>this.opened=!0)}applyFragment(e){super.applyFragment(e);const t=e.state?._closeAfterMillis;t&&setTimeout(()=>this.close(),t)}updated(e){if(super.updated(e),e.has("component")&&this.component){const t=this.component.metadata;this.state=t.initialData}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._escListener)}disconnectedCallback(){document.removeEventListener("keydown",this._escListener),super.disconnectedCallback()}render(){const e=this.component.metadata,t=e.position??"end",a=Ia(e.headerTitle,this.state,this.data,this.appState,this.appData);return o`
        ${e.modeless?d:o`
  ...
  `;Ri([v()],la.prototype,"opened",2);la=Ri([C("mateu-drawer")],la);var dn=Object.defineProperty,cn=Object.getOwnPropertyDescriptor,ee=(e,t,a,i)=>{for(var s=i>1?void 0:i?cn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&dn(t,a,s),s};function ti(e){if(e.parentElement)return e.parentElement;const t=e.getRootNode();return t instanceof ShadowRoot?t.host:null}let W=class extends I{constructor(){super(...arguments),this.appState={},this.appData={},this.standalone=!1,this.actionBanners=[],this.dismissedStaticBannerIndices=new Set,this._tocEntries=[],this._activeToc=0,this._tocVisible=!1,this._tocRebuildScheduled=!1,this._headerH=0,this._onResize=()=>this._layoutStickyTops(),this._tocLocked=!1,this._unlockToc=e=>{if(e&&e.type==="keydown"){const t=e;if(t.ctrlKey&&t.altKey&&!t.shiftKey&&!t.metaKey&&/^(?:Digit|Numpad)[1-9]$/.test(t.code))return}this._tocLocked=!1},this._actionBannerTimers=[],this._staticBannerTimers=[],this._bannersHandler=e=>{const t=e.detail,a=t.banners??[],i=t.append??!1;i?this.actionBanners=[...this.actionBanners,...a]:(this._clearActionBannerTimers(),this.actionBanners=a);const s=i?this.actionBanners.length-a.length:0;a.forEach((r,n)=>{if(r.timeoutSeconds&&r.timeoutSeconds>0){const l=s+n;this._actionBannerTimers.push(setTimeout(()=>{this.actionBanners=this.actionBanners.filter((c,h)=>h!==l)},r.timeoutSeconds*1e3))}})},this._onTocKey=e=>{if(!this._tocVisible||!e.ctrlKey||!e.altKey||e.shiftKey||e.metaKey)return;const t=/^(?:Digit|Numpad)([1-9])$/.exec(e.code);if(!t)return;const a=parseInt(t[1],10)-1;a>=this._tocEntries.length||(e.preventDefault(),this._scrollToSection(a))},this._onScrollSpy=()=>{if(this._tocLocked)return;const e=this._sectionCards();if(!e.length)return;const t=12,a=this.shadowRoot?.querySelector("mateu-content-header");let i=a?a.getBoundingClientRect().bottom:0;for(const n of e){if(!n.classList.contains("mateu-section--sticky"))continue;const l=n.getBoundingClientRect();l.top<=i+t+2&&(i=Math.max(i,l.bottom))}const s=i+t+4;let r=0;this._tocEntries.forEach((n,l)=>{n.el.getBoundingClientRect().top<=s&&(r=l)}),this._activeToc=r}}connectedCallback(){super.connectedCallback(),document.addEventListener("page-banners-received",this._bannersHandler),window.addEventListener("resize",this._onResize),document.addEventListener("keydown",this._onTocKey)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("page-banners-received",this._bannersHandler),window.removeEventListener("resize",this._onResize),document.removeEventListener("keydown",this._onTocKey),this._clearAllTimers(),this._teardownScrollSpy()}updated(e){super.updated(e),e.has("component")&&e.get("component")!==void 0&&(this._clearAllTimers(),this.actionBanners=[],this.dismissedStaticBannerIndices=new Set),e.has("component")&&(this._scheduleStaticBannerTimeouts(),this.dispatchEvent(new CustomEvent("compact-changed",{detail:{compact:!!this.component?.style?.includes("--mateu-compact:1")},bubbles:!0,composed:!0})),this._scheduleTocRebuild())}_scheduleStaticBannerTimeouts(){this._staticBannerTimers.forEach(a=>clearTimeout(a)),this._staticBannerTimers=[],(this.component?.metadata?.banners??[]).forEach((a,i)=>{a.timeoutSeconds&&a.timeoutSeconds>0&&this._staticBannerTimers.push(setTimeout(()=>{this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,i])},a.timeoutSeconds*1e3))})}_clearActionBannerTimers(){this._actionBannerTimers.forEach(e=>clearTimeout(e)),this._actionBannerTimers=[]}_clearAllTimers(){this._clearActionBannerTimers(),this._staticBannerTimers.forEach(e=>clearTimeout(e)),this._staticBannerTimers=[]}_dismissActionBanner(e){this.actionBanners=this.actionBanners.filter((t,a)=>a!==e)}_dismissStaticBanner(e){this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,e])}bannerThemeClass(e){const t=e.theme?.toLowerCase()??"info";return t==="none"?"":t}_evalBannerText(e){return ye(e,this.state,this.data)}_renderBanner(e,t){const a=this._evalBannerText(e.title),i=this._evalBannerText(e.description);return o`
        ...
        `;return o`<vaadin-vertical-layout style="width: 100%;">${s}</vaadin-vertical-layout>`}};W.styles=_`
        :host {
            width: 100%;
        }
    ...
    `;ee([u()],W.prototype,"component",2);ee([u()],W.prototype,"baseUrl",2);ee([u()],W.prototype,"state",2);ee([u()],W.prototype,"data",2);ee([u()],W.prototype,"appState",2);ee([u()],W.prototype,"appData",2);ee([u()],W.prototype,"value",2);ee([u({type:Boolean})],W.prototype,"standalone",2);ee([v()],W.prototype,"actionBanners",2);ee([v()],W.prototype,"dismissedStaticBannerIndices",2);ee([v()],W.prototype,"_tocEntries",2);ee([v()],W.prototype,"_activeToc",2);ee([v()],W.prototype,"_tocVisible",2);W=ee([C("mateu-page")],W);const fa=_`
    .nbtn {
        display: inline-flex;
        align-items: center;
        gap: .35em;
...
`,O=!0)}O&&this.updateMessage(a,i)}i||this.updateMessage(a,"⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).")}catch(s){console.error("Error en el flujo SSE:",s);const r=s?.message??String(s);(r==="Failed to fetch"||r==="network error"||r==="Load failed")&&!i?this.updateMessage(a,"⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible."):this.updateMessage(a,"⚠️ Error: "+r)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value="")},250),this.messageInputElement?.removeAttribute("disabled"),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent("close-requested",{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{const e=this.messageInputElement?.value?.trim()??"";e&&this.send(new CustomEvent("submit",{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key==="Enter"&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback();const e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){const t=new e;this.recognition=t,t.lang="es-ES",t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=a=>{console.error("Error de reconocimiento: "+a.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:"smooth"})},0)}addMessage(e,t){const a={text:e,time:new Date().toLocaleTimeString(),userName:t.includes("agent")?"Asistente":"Tú",userColorIndex:t.includes("agent")?2:1};return this.items=[...this.items,a],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((a,i)=>i===e?{...a,text:t}:a),this.scrollBottom()}tryParseCustomEvent(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if(typeof a.event=="string")return{event:a.event,detail:a.detail??{}}}catch{}return null}tryParseTokenUsage(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const a=JSON.parse(t);if("inputTokens"in a||"outputTokens"in a||"totalTokens"in a)return a}catch{}return null}buildMenuContext(e,t=[]){const a=[];for(const i of e){if(i.separator||i.remote)continue;const s=[...t,i.label];if(i.submenus&&i.submenus.length>0)a.push(...this.buildMenuContext(i.submenus,s));else{const r={path:s,navigation:{route:i.route,consumedRoute:i.consumedRoute,actionId:i.actionId??"",baseUrl:i.baseUrl,serverSideType:i.serverSideType,uriPrefix:i.uriPrefix}};i.description&&(r.description=i.description),a.push(r)}}return a}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return o`
                    ...
                    <div class="message-list" role="list">
                        ${this.items.map(e=>o`
                            <div class="message" role="listitem">
                                <div class="avatar" style="background: ${fn(e.userColorIndex)};">${bn(e.userName)}</div>
    ...
    `];me([u()],Q.prototype,"sseUrl",2);me([u({attribute:!1})],Q.prototype,"menu",2);me([u()],Q.prototype,"items",2);me([ze(".scroll-container")],Q.prototype,"scrollContainer",2);me([ze(".msg-input")],Q.prototype,"messageInputElement",2);me([v()],Q.prototype,"recognition",2);me([v()],Q.prototype,"listening",2);me([v()],Q.prototype,"recognitionAvailable",2);me([v()],Q.prototype,"loading",2);me([v()],Q.prototype,"elapsedSeconds",2);me([v()],Q.prototype,"tokenUsage",2);Q=me([C("mateu-chat")],Q);var gn=Object.defineProperty,$n=Object.getOwnPropertyDescriptor,ea=(e,t,a,i)=>{for(var s=i>1?void 0:i?$n(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&gn(t,a,s),s};let bt=class extends I{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.data&&this.createChart(this.data)}async createChart(e){const[{default:t}]=await Promise.all([te(()=>import("./vendor-chartjs.js").then(i=>i.a),[]),te(()=>import("./vendor-chartjs.js").then(i=>i.c),[])]);if(e!==this.data)return;this.chart&&this.chart.destroy();const a={type:this.type,data:this.data,options:this.options};this.chart=new t(this.chartElement,a)}handleSlotChange(){}render(){return o`
            <div class="container">
       ...
       `}};bt.styles=_`
  `;ea([u()],bt.prototype,"type",2);ea([u()],bt.prototype,"data",2);ea([u()],bt.prototype,"options",2);ea([ze("#chart")],bt.prototype,"chartElement",2);bt=ea([C("mateu-chart")],bt);var yn=Object.defineProperty,xn=Object.getOwnPropertyDescriptor,Ma=(e,t,a,i)=>{for(var s=i>1?void 0:i?xn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&yn(t,a,s),s};let Gt=class extends I{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){const{default:t}=await te(async()=>{const{default:i}=await import("./vendor-diagrams.js").then(s=>s.i);return{default:i}},__vite__mapDeps([4,3,1,2]));if(e!==this.xml)return;this.chart&&this.chart.destroy();const a={container:this.divElement};this.chart=new t(a),this.chart.importXML(e)}handleSlotChange(){}render(){return o`
       ...
       `}};Gt.styles=_`
  `;Ma([u()],Gt.prototype,"xml",2);Ma([ze("#canvas")],Gt.prototype,"divElement",2);Gt=Ma([C("mateu-bpmn")],Gt);var wn=Object.defineProperty,kn=Object.getOwnPropertyDescriptor,At=(e,t,a,i)=>{for(var s=i>1?void 0:i?kn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&wn(t,a,s),s};const wa=160,Ee=56,Sn=220,ii=110,Je=60,Cn={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},_n={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},En=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];function In(){return"step-"+Math.random().toString(36).slice(2,8)}let tt=class extends I{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.wf={name:"New Workflow",steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value")){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){const e=this.wf.steps??[],t={};e.forEach(n=>{t[n.id]=0});let a=!0;for(;a;)a=!1,e.forEach(n=>{if(n.preconditionStepId!=null&&t[n.preconditionStepId]!==void 0){const l=t[n.preconditionStepId]+1;l>t[n.id]&&(t[n.id]=l,a=!0)}});const i={};e.forEach(n=>{const l=t[n.id]??0;(i[l]??=[]).push(n.id)});const s={...this.positions};let r=!1;Object.entries(i).forEach(([n,l])=>{const c=Number(n);l.forEach((h,m)=>{s[h]||(s[h]={x:Je+c*Sn,y:Je+m*ii},r=!0)})}),r&&(this.positions=s)}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addStep(){const e=In(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(s=>s.y),i=a.length?Math.max(...a)+ii:Je;this.positions={...this.positions,[e]:{x:Je,y:i}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(i=>i.id!==e).map(i=>i.preconditionStepId===e?{...i,preconditionStepId:void 0}:i)};const{[e]:t,...a}=this.positions;this.positions=a,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},i=this.toSvgPoint(e);this.dragOffset={x:i.x-a.x,y:i.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(i=>i.x))+wa+Je:600,a=e.length?Math.max(...e.map(i=>i.y))+Ee+Je:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return H``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return H``;const i=t.x+wa,s=t.y+Ee/2,r=a.x,n=a.y+Ee/2,l=(i+r)/2;return H`
            <path d="M${i},${s} C${l},${s} ${l},${n} ${r},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:Je,y:Je},a=Cn[e.type]??"#64748b",i=_n[e.type]??"•",s=this.selectedId===e.id;return H`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${r=>this.onNodeMouseDown(r,e.id)}"
               @click="${r=>{r.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${wa}" height="${Ee}" rx="8"
                      fill="white"
                      stroke="${s?a:"#e2e8f0"}"
                ...
                <div class="prop-body">
                    ...
                    ${a("Type",o`
                        <select class="inp" @change="${i=>this.updateStep(e.id,{type:i.target.value})}">
                            ${En.map(i=>o`<option value="${i}" ?selected="${e.type===i}">${i}</option>`)}
                        </select>`)}
        ...
        `}exportJson(){const e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),i=document.createElement("a");i.href=a,i.download=(this.wf.name??"workflow").replace(/\s+/g,"-").toLowerCase()+".json",i.click(),URL.revokeObjectURL(a)}};tt.styles=[fa,_`
    ...
    `];At([u()],tt.prototype,"value",2);At([v()],tt.prototype,"wf",2);At([v()],tt.prototype,"positions",2);At([v()],tt.prototype,"selectedId",2);At([v()],tt.prototype,"showMeta",2);tt=At([C("mateu-workflow")],tt);var Tn=Object.defineProperty,Rn=Object.getOwnPropertyDescriptor,je=(e,t,a,i)=>{for(var s=i>1?void 0:i?Rn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Tn(t,a,s),s};const Mt=160,be=56,Ye=60,Pn={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},On={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},Ln=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];let ka;const Dn=()=>(ka||(ka=te(()=>import("./vendor-diagrams.js").then(e=>e.e),__vite__mapDeps([4,3,1,2])).then(e=>new e.default)),ka);function zn(){return"step-"+Math.random().toString(36).slice(2,8)}let we=class extends I{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.readOnly=!1,this.wf={name:"New Workflow",steps:[]},this.positions={},this.layoutReady=!1,this.selectedId=null,this.showMeta=!1,this.layoutError=null,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.elkPositioned=new Set,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.elkPositioned.add(this.draggingId),this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value"))try{const t=JSON.parse(this.value),a=new Set((this.wf.steps??[]).map(r=>r.id)),i=new Set((t.steps??[]).map(r=>r.id)),s=a.size!==i.size||[...i].some(r=>!a.has(r))||[...i].some(r=>{const n=(this.wf.steps??[]).find(c=>c.id===r),l=(t.steps??[]).find(c=>c.id===r);return n?.preconditionStepId!==l?.preconditionStepId});this.wf=t,(s||!this.layoutReady)&&this.runElkLayout()}catch{}}async runElkLayout(){const e=this.wf.steps??[];if(e.length===0){this.positions={},this.layoutReady=!0;return}const t={id:"root",layoutOptions:{"elk.algorithm":"layered","elk.direction":"RIGHT","elk.spacing.nodeNode":"40","elk.layered.spacing.nodeNodeBetweenLayers":"80","elk.edgeRouting":"ORTHOGONAL","elk.layered.nodePlacement.strategy":"BRANDES_KOEPF"},children:e.map(a=>({id:a.id,width:Mt,height:be})),edges:e.filter(a=>a.preconditionStepId).map(a=>({id:`${a.preconditionStepId}->${a.id}`,sources:[a.preconditionStepId],targets:[a.id]}))};try{const i=await(await Dn()).layout(t),s={...this.positions};for(const r of i.children??[])(!this.elkPositioned.has(r.id)||!s[r.id])&&(s[r.id]={x:(r.x??0)+Ye,y:(r.y??0)+Ye},this.elkPositioned.add(r.id));this.positions=s,this.layoutReady=!0,this.layoutError=null}catch(a){this.layoutError=a?.message??"ELK layout failed",this.layoutReady=!0}}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){const a=this.wf.steps.map(r=>r.id===e?{...r,...t}:r),i=this.wf.steps.find(r=>r.id===e),s=t.preconditionStepId!==void 0&&t.preconditionStepId!==i?.preconditionStepId;this.wf={...this.wf,steps:a},s&&(this.elkPositioned.clear(),this.runElkLayout()),this.emit()}addStep(){const e=zn(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const a=Object.values(this.positions).map(i=>i.x);this.positions={...this.positions,[e]:{x:a.length?Math.max(...a)+Mt+80:Ye,y:Ye}},this.selectedId=e,this.elkPositioned.clear(),this.runElkLayout(),this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(i=>i.id!==e).map(i=>i.preconditionStepId===e?{...i,preconditionStepId:void 0}:i)};const{[e]:t,...a}=this.positions;this.positions=a,this.elkPositioned.delete(e),this.selectedId===e&&(this.selectedId=null),this.runElkLayout(),this.emit()}onNodeMouseDown(e,t){if(this.readOnly)return;e.preventDefault(),this.draggingId=t;const a=this.positions[t]??{x:0,y:0},i=this.toSvgPoint(e);this.dragOffset={x:i.x-a.x,y:i.y-a.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}relayout(){this.elkPositioned.clear(),this.runElkLayout()}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(i=>i.x))+Mt+Ye:600,a=e.length?Math.max(...e.map(i=>i.y))+be+Ye:400;return{w:Math.max(t,600),h:Math.max(a,400)}}render(){if(!this.layoutReady)return o`<div class="loading">Computing layout…</div>`;const{w:e,h:t}=this.canvasSize(),a=this.wf.steps??[];return o`
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return H``;const t=this.positions[e.preconditionStepId],a=this.positions[e.id];if(!t||!a)return H``;const i=t.x+Mt,s=t.y+be/2,r=a.x,n=a.y+be/2,l=(i+r)/2;return H`
            <path d="M${i},${s} C${l},${s} ${l},${n} ${r},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:Ye,y:Ye},a=Pn[e.type]??"#64748b",i=On[e.type]??"•",s=this.selectedId===e.id,r=e.name.length>16?e.name.slice(0,15)+"…":e.name;return H`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${n=>this.onNodeMouseDown(n,e.id)}"
               @click="${n=>{n.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${Mt}" height="${be}" rx="8"
                      fill="white"
                      stroke="${s?a:"#e2e8f0"}"
                      stroke-width="${s?2.5:1.5}"
                      filter="url(#shadow)"/>
        ...
        `}exportJson(){const e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),i=document.createElement("a");i.href=a,i.download=(this.wf.name??"workflow").replace(/\s+/g,"-").toLowerCase()+".json",i.click(),URL.revokeObjectURL(a)}};we.styles=[fa,_`
        :host {display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif);}
        ...
        textarea.inp {resize: vertical;}
        input[readonly].inp {background: #f8fafc; color: #94a3b8;}
    `];je([u()],we.prototype,"value",2);je([u({type:Boolean})],we.prototype,"readOnly",2);je([v()],we.prototype,"wf",2);je([v()],we.prototype,"positions",2);je([v()],we.prototype,"layoutReady",2);je([v()],we.prototype,"selectedId",2);je([v()],we.prototype,"showMeta",2);je([v()],we.prototype,"layoutError",2);we=je([C("mateu-workflow-elk")],we);var An=Object.defineProperty,Fn=Object.getOwnPropertyDescriptor,ta=(e,t,a,i)=>{for(var s=i>1?void 0:i?Fn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&An(t,a,s),s};const Nn=["string","integer","number","bool","date","time","dateTime","dateRange","money","file","array","status","component","menu","range","action","actionGroup"],qn=["regular","radio","checkbox","textarea","toggle","combobox","select","email","password","richText","listBox","html","markdown","image","icon","link","money","grid","color","choice","popover","slider","button","stars"],Mn={string:"#3B82F6",integer:"#8B5CF6",number:"#6366F1",bool:"#10B981",date:"#F59E0B",time:"#F59E0B",dateTime:"#F59E0B",dateRange:"#F59E0B",money:"#EF4444",file:"#64748B",array:"#0EA5E9",status:"#EC4899",component:"#14B8A6",menu:"#94A3B8",range:"#A855F7",action:"#F97316",actionGroup:"#FB923C"};function si(){return"field-"+Math.random().toString(36).slice(2,8)}let gt=class extends I{constructor(){super(...arguments),this.value='{"name":"New Form","fields":[]}',this.form={name:"New Form",fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has("value"))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){const e=this.shadowRoot?.querySelector(".field-list");!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=Bi.create(e,{animation:150,handle:".drag-handle",ghostClass:"sortable-ghost",onEnd:t=>{const{oldIndex:a,newIndex:i}=t;if(a===void 0||i===void 0||a===i)return;const s=[...this.form.fields],[r]=s.splice(a,1);s.splice(i,0,r),this.form={...this.form,fields:s},this.emit()}}))}emit(){const e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(a=>a.id===e?{...a,...t}:a)},this.emit()}addField(){const e=si(),t={id:e,label:"New Field",dataType:"string"};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){const t=this.form.fields.find(r=>r.id===e);if(!t)return;const a={...t,id:si(),label:t.label+" (copy)"},i=this.form.fields.findIndex(r=>r.id===e),s=[...this.form.fields];s.splice(i+1,0,a),this.form={...this.form,fields:s},this.selectedId=a.id,this.emit()}render(){return o`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderRow(e){const t=Mn[e.dataType]??"#64748b",a=this.selectedId===e.id;return o`
        ...
        `}exportJson(){const e=JSON.stringify(this.form,null,2),t=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(t),i=document.createElement("a");i.href=a,i.download=(this.form.name??"form").replace(/\s+/g,"-").toLowerCase()+".json",i.click(),URL.revokeObjectURL(a)}};gt.styles=[fa,_`
        :host { display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif); }
        ...
        textarea.inp { resize: vertical; }
        input[readonly].inp { background: #f8fafc; color: #94a3b8; }
    `];ta([u()],gt.prototype,"value",2);ta([v()],gt.prototype,"form",2);ta([v()],gt.prototype,"selectedId",2);ta([v()],gt.prototype,"showMeta",2);gt=ta([C("mateu-form-editor")],gt);var Un=Object.defineProperty,Bn=Object.getOwnPropertyDescriptor,Ne=(e,t,a,i)=>{for(var s=i>1?void 0:i?Bn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Un(t,a,s),s};let ue=class extends I{constructor(){super(...arguments),this.appState={},this.appData={},this.open=!1,this.activeTab="appstate",this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null,this._prevTarget=null,this._onMouseover=e=>{let t=e.target;for(;t&&!(t.tagName?.toLowerCase().startsWith("mateu-")&&t!==this);)t=t.parentElement;if(t===this||t===null){t===null&&this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset="",this._prevTarget=null,this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null);return}t!==this._prevTarget&&(this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset=""),this._prevTarget=t,t.style.outline="2px solid #0070f3",t.style.outlineOffset="-2px",this.hoveredTag=t.tagName.toLowerCase(),this.hoveredId=t.id||"",this.hoveredState=t.state,this.hoveredData=t.data,this.hoveredMeta=t.component?.metadata)}}connectedCallback(){super.connectedCallback(),document.addEventListener("mouseover",this._onMouseover,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mouseover",this._onMouseover,!0),this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget=null)}_fmt(e){try{return JSON.stringify(e,null,2)??"null"}catch{return String(e)}}_renderTab(e,t){return o`
    ...
    `;Ne([u()],ue.prototype,"appState",2);Ne([u()],ue.prototype,"appData",2);Ne([v()],ue.prototype,"open",2);Ne([v()],ue.prototype,"activeTab",2);Ne([v()],ue.prototype,"hoveredTag",2);Ne([v()],ue.prototype,"hoveredId",2);Ne([v()],ue.prototype,"hoveredState",2);Ne([v()],ue.prototype,"hoveredData",2);Ne([v()],ue.prototype,"hoveredMeta",2);ue=Ne([C("mateu-debug-overlay")],ue);var ge=(e=>(e.SetAppDataValue="SetAppDataValue",e.SetAppStateValue="SetAppStateValue",e.SetDataValue="SetDataValue",e.RunAction="RunAction",e.RunJS="RunJS",e.SetAttributeValue="SetAttributeValue",e.SetStateValue="SetStateValue",e.SetCssClass="SetCssClass",e.SetStyle="SetStyle",e))(ge||{}),Pi=(e=>(e.required="required",e.disabled="disabled",e.hidden="hidden",e.pattern="pattern",e.minValue="minValue",e.maxValue="maxValue",e.minLength="minLength",e.maxLength="maxLength",e.css="css",e.style="style",e.theme="theme",e.errorMessage="errorMessage",e.description="description",e.none="none",e))(Pi||{}),Oi=(e=>(e.Continue="Continue",e.Stop="Stop",e))(Oi||{}),jn=Object.defineProperty,Wn=Object.getOwnPropertyDescriptor,ba=(e,t,a,i)=>{for(var s=i>1?void 0:i?Wn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&jn(t,a,s),s};let Ut=null,Ot=class extends ot{constructor(){super(...arguments),this.baseUrl="",this.route="",this.consumedRoute="",this.formerState={},this.applyRules=()=>{const e=this.component.rules;if(e&&e.length>0){const t=this.state,a=this.data,i=this.appState,s=this.appData,r=this.component,n=w=>vi(w,t,a,{appState:i,appData:s,component:r}),l=w=>mi(w,t,a,i,s,{component:r}),c=["state","data","appState","appData","component"],h=[t,a,i,s,r],m={...this.state},f={...this.data};let b=!1,S=!1;for(let w=0;w<e.length;w++){const g=e[w];try{if(n(g.filter)){if(ge.SetStateValue==g.action||ge.SetDataValue==g.action){const O=ge.SetStateValue==g.action?m:f,F=g.fieldName.split(",");for(let U=0;U<F.length;U++){const A=F[U];if(!O[A]||O[A]!=g.value){const V=g.expression?l(g.expression):g.value,nt=Pi.none==g.fieldAttribute?A:A+"."+g.fieldAttribute;V!=O[nt]&&(O[nt]=V,ge.SetStateValue==g.action&&(b=!0),ge.SetDataValue==g.action&&(S=!0))}}}if(ge.RunAction==g.action&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:g.actionId},bubbles:!0,composed:!0})),ge.RunJS==g.action&&new Function(...c,g.value)(...h),ge.SetAttributeValue==g.action){const O=g.expression?n(g.expression):g.value;if(g.fieldAttribute=="disabled"){O?this.shadowRoot?.getElementById(g.fieldName)?.setAttribute(g.fieldAttribute,"disabled"):this.shadowRoot?.getElementById(g.fieldName)?.removeAttribute(g.fieldAttribute);continue}this.shadowRoot?.getElementById(g.fieldName)?.setAttribute(g.fieldAttribute,O)}if(ge.SetCssClass==g.action&&this.shadowRoot?.getElementById(g.fieldName)?.setAttribute("class",g.value),ge.SetStyle==g.action&&this.shadowRoot?.getElementById(g.fieldName)?.style.setProperty(g.expression,g.value),Oi.Stop==g.result)break}}catch(O){console.error("rule failed",g,O)}}b&&(this.state=m),S&&(this.data=f),b&&this.checkValidations()}},this.skipValidation=(e,t)=>e&&t.fieldId&&!e.includes(t.fieldId)||!e&&t.fieldId&&t.fieldId.includes("-"),this.checkValidations=e=>{const t=e?e.split(","):void 0,a=this.component.validations;let i=!0,s=!1;const r=this.data??{},n={...this.data??{},errors:{}};if(a){for(let l=0;l<a.length;l++){const c=a[l];if(this.skipValidation(t,c))continue;const h=(c.fieldId??"_component").split(",");for(let m=0;m<h.length;m++){const f=h[m];n.errors[f]=[]}}for(let l=0;l<a.length;l++){const c=a[l];if(!this.skipValidation(t,c))try{const h=c.condition&&c.condition.includes("${")?this._evalTemplate(c.condition):this._evalExpr(c.condition);if(c.condition&&!h){i=!1;const f=(c.fieldId??"_component").split(",");for(let b=0;b<f.length;b++){const S=f[b];let w=n.errors[S];if(w||(n.errors[S]=[]),w=n.errors[S],!r[S]){let g=c.message;try{g=this._evalTemplate(c.message)}catch{}w.push(g)}}}}catch(h){console.error("validation failed",c,h)}}for(let l=0;l<a.length;l++){const c=a[l];if(this.skipValidation(t,c))continue;const h=(c.fieldId??"_component").split(",");for(let m=0;m<h.length;m++){const f=h[m];if(r.errors?[f].join(","):n.errors==""&&[f].join(",")){s=!0;break}}}(r.errors?["_component"].join(","):n.errors==""&&["_component"].join(","))&&(s=!0)}n._valid=i,n._valid!=r._valid&&(s=!0),s&&(this.data=n)},this._autoSaveTimers=new Map,this.onChange=()=>{this.applyRules()},this.closeModalRequestedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&this.closeModal()},this.resetFilters=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail,a={};t.fieldIds.forEach(i=>{a[i]=void 0}),a.searchText=void 0,this.state={...this.state,...a}}},this.dataChangedListener=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail,a={};a[t.key]=t.value,e.type=="data-changed"&&(this.data={...this.data,...a})}},this.valueChangedListener=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent){const t=e.detail;if(e.type=="value-changed"){const a={...this.state};a[t.fieldId]=t.value,this.state=a,(this.state[t.fieldId]||this.formerState[t.fieldId])&&this.state[t.fieldId]!=this.formerState[t.fieldId]&&this.component?.confirmOnNavigationIfDirty&&this.dispatchEvent(new CustomEvent("dirty",{detail:e.detail,bubbles:!0,composed:!0}));const i=this.component;i.triggers?.filter(s=>s.type==Qe.OnValueChange).filter(s=>!s.propertyName||t.fieldId==s.propertyName).forEach(s=>{(!s.condition||this._evalExpr(s.condition))&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:s.actionId},bubbles:!0,composed:!0}))}),i.triggers?.filter(s=>s.type==Qe.AutoSave).forEach(s=>{const r=s.actionId,n=this._autoSaveTimers.get(r);n!==void 0&&clearTimeout(n),this._autoSaveTimers.set(r,setTimeout(()=>{this._autoSaveTimers.delete(r),this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:s.actionId},bubbles:!0,composed:!0}))},s.debounceMillis??800))})}}},this.actionRequestedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&this.manageActionRequestedEvent(e)},this.manageActionRequestedEvent=e=>{const t=e.detail;if(e.type=="action-requested"){e.preventDefault(),e.stopPropagation();const a=this.component,i=a.actions?.find(s=>s.id==t.actionId||s.id.endsWith("*")&&t.actionId.startsWith(s.id.replace("*","")));if(i){if(i&&i.rowsSelectedRequired&&(!this.state.crud_selected_items||this.state.crud_selected_items.length==0)){this.notify("You first need to select some rows");return}if(i&&i.validationRequired){const r=Ut??this;if(Ut=null,r.checkValidations(i.fieldsToValidate),!r.data._valid){r.notifyValidationErrors();return}}Ut=null;const s={...t,initiatorComponentId:this.id};i&&i.confirmationRequired?this.callAfterConfirmation(i,()=>this.requestActionCallToServerOrBubble(s,a,i)):this.requestActionCallToServerOrBubble(s,a,i)}else{const s={...t.parameters};s.initiatorState||(s.initiatorState=this.state),Ut||(Ut=this),this.dispatchEvent(new CustomEvent(e.type,{detail:{...e.detail,parameters:s},bubbles:!0,composed:!0}))}}},this.buildFieldLabelMap=()=>{const e={},t=a=>{if(a)for(const i of a){const s=i.metadata;if(s?.type===p.FormField){const r=s;r.fieldId&&r.label&&(e[r.fieldId]=r.label)}t(i.children)}};return t(this.component?.children),e},this.notifyValidationErrors=()=>{const e=this.data?.errors??{},t=this.buildFieldLabelMap(),a=[];if(Object.entries(e).forEach(([s,r])=>{if(!Array.isArray(r))return;const n=s==="_component"?void 0:t[s]??s;r.forEach(l=>{l&&!a.some(c=>c.label===n&&c.msg===l)&&a.push({label:n,msg:l})})}),a.length===0){this.notify("There are validation errors");return}const i=document.createElement("vaadin-notification");i.position="bottom-end",i.setAttribute("theme","error"),i.duration=Math.max(3e3,1500+a.length*1e3),i.renderer=s=>{di(o`
            ...
            `:d}</div>`}_render(){if(this.component?.type==ae.ClientSide){const e=this.component;return e.metadata?.type==p.Page?Ca(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):e.metadata?.type==p.Crud?_a(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):q.get()?.renderClientSideComponent(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!1)}return o`
            <mateu-api-caller 
            ...
            ${this.component?.children?.map(e=>{if(e.type==ae.ClientSide){const t=e;if(t.metadata?.type==p.Page)return Ca(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0);if(t.metadata?.type==p.Crud)return _a(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0)}return $(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData)})}
            </mateu-api-caller>
        `}};Ot.styles=_`
        :host {
        }
  ...
  `;ba([u()],Ot.prototype,"baseUrl",2);ba([u()],Ot.prototype,"route",2);ba([u()],Ot.prototype,"consumedRoute",2);Ot=ba([C("mateu-component")],Ot);const ri=e=>{if(e)try{return JSON.parse(e)}catch{return{value:e}}else return{}};class Vn{async handle(t,a){return await t.runAction(a.baseUrl,a.route,a.consumedRoute,a.actionId,a.initiatorComponentId,a.appState,a.serverSideType,a.componentState,a.parameters,a.initiator,a.background)}}const Hn=new Vn;class Gn{constructor(){this.mapPosition=t=>{switch(t){case"topStretch":return"top-stretch";case"topStart":return"top-start";case"topCenter":return"top-center";case"topEnd":return"top-end";case"middle":return"middle";case"bottomStart":return"bottom-start";case"bottomEnd":return"bottom-end";case"bottomStretch":return"bottom-stretch";case"bottomCenter":return"bottom-center"}return"bottom-end"},this.handleUIIncrement=(t,a,i)=>{if(t?.fragments?.forEach(s=>{Ze.next({command:void 0,fragment:s,ui:void 0,error:void 0,callbackToken:i})}),t?.appState&&(j.value={...t.appState},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))),t?.appData){const s=t?.appData;Wt.value={...t.appData,...s},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))}t?.messages?.forEach(s=>{Kt.show(s.text,{position:s.position?this.mapPosition(s.position):void 0,theme:s.variant,duration:s.duration})}),t?.banners&&t.banners.length>0&&document.dispatchEvent(new CustomEvent("page-banners-received",{detail:{banners:t.banners,append:t.appendBanners??!1},bubbles:!1,composed:!1})),t?.commands?.forEach(s=>{Ze.next({command:s,fragment:void 0,ui:void 0,error:void 0,callbackToken:i})})}}async runAction(t,a,i,s,r,n,l,c,h,m,f,b,S,w,g){try{const O=await Hn.handle(t,{baseUrl:a,route:i,consumedRoute:s,actionId:r,appState:j.value,initiatorComponentId:n,componentState:h,parameters:m,serverSideType:c,initiator:f,background:b});S&&S(O),w||this.handleUIIncrement(O,f,g),O.messages&&O.messages.length==1&&O.messages[0].variant=="error"&&f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0})),f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:r,evevntId:G()},bubbles:!0,composed:!0}))}catch(O){console.warn("Action request failed",O),f.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:r,reason:this.serialize(O)}})),f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))}}serialize(t){return t?.message?t:JSON.stringify(t)}}const Kn=new Gn,Jn=Kn;class Yn{constructor(){this.mapPosition=t=>{switch(t){case"topStretch":return"top-stretch";case"topStart":return"top-start";case"topCenter":return"top-center";case"topEnd":return"top-end";case"middle":return"middle";case"bottomStart":return"bottom-start";case"bottomEnd":return"bottom-end";case"bottomStretch":return"bottom-stretch";case"bottomCenter":return"bottom-center"}return"bottom-end"},this.handleUIIncrement=(t,a,i)=>{if(t?.messages?.forEach(s=>{Kt.show(s.text,{position:s.position?this.mapPosition(s.position):"bottom-end",theme:s.variant,duration:s.duration})}),t?.banners&&t.banners.length>0&&document.dispatchEvent(new CustomEvent("page-banners-received",{detail:{banners:t.banners,append:t.appendBanners??!1},bubbles:!1,composed:!1})),t?.commands?.forEach(s=>{Ze.next({command:s,fragment:void 0,ui:void 0,error:void 0,callbackToken:i})}),t?.fragments?.forEach(s=>{Ze.next({command:void 0,fragment:s,ui:void 0,error:void 0,callbackToken:i})}),t?.appState&&(j.value={...t.appState},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))),t?.appData){const s=t?.appData;Wt.value={...t.appData,...s},a.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))}}}async runAction(t,a,i,s,r,n,l,c,h,m,f,b,S,w,g){if(i){i=i||"_no_route",i&&i.startsWith("/")&&(i=i.substring(1));const O={serverSideType:c,appState:j.value,componentState:h,parameters:m,initiatorComponentId:n,consumedRoute:s,route:"/"+i,actionId:r};b||f.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),fetch(a+"/mateu/v3/sse/"+i,{method:"POST",headers:{Accept:"text/event-stream","Content-Type":"application/json"},body:JSON.stringify(O)}).then(async F=>{const U=F.body?.pipeThrough(new TextDecoderStream).getReader();if(U){let A="";for(;;){const{value:V,done:nt}=await U.read();if(nt)break;A+=V;const Nt=A.split(`

`);A=Nt.pop()??"";for(const aa of Nt){const y=aa.trim();if(y)if(y.startsWith("data:")){const P=JSON.parse(y.substring(5).trim());S&&S(P),w||this.handleUIIncrement(P,f,g),P.messages&&P.messages.length==1&&P.messages[0].variant=="error"&&f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))}else{let P=y;try{const k=JSON.parse(y);P=k.message,k._embedded?.errors?.length>0&&k._embedded.errors[0].message&&(P=k._embedded.errors[0].message)}catch{}throw new Error(P)}}}}b||f.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:r}})),f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:r},bubbles:!0,composed:!0}))}).catch(F=>{f.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:r,reason:this.serialize(F)}})),f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:r},bubbles:!0,composed:!0}))})}}serialize(t){return t?.message?t:JSON.stringify(t)}}const Xn=new Yn;var Qn=Object.defineProperty,Zn=Object.getOwnPropertyDescriptor,ve=(e,t,a,i)=>{for(var s=i>1?void 0:i?Zn(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Qn(t,a,s),s};let Z=class extends ua{constructor(){super(...arguments),this.consumedRoute="",this.serverSideType=void 0,this.uriPrefix=void 0,this.overrides=void 0,this.homeRoute=void 0,this.route=void 0,this.top=void 0,this.appState={},this.appData={},this.preventNavigation=!1,this.overridesParsed={},this.fragment=void 0,this.actionRequestedListener=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.manageActionEvent(e))},this.historyPushed=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.preventNavigation=!0,this.route=e.detail.route)},this.routeChangedListener=e=>{if(e instanceof CustomEvent){e.preventDefault(),e.stopPropagation();let t=e.detail.route;typeof t=="string"&&(t===""||t.startsWith("/"))&&this.consumedRoute&&this.consumedRoute!=="_empty"&&this.consumedRoute.startsWith("/")&&!t.startsWith(this.consumedRoute)&&(t=this.consumedRoute+t),this.uriPrefix&&(t.startsWith("/")&&this.uriPrefix.endsWith("/")?t=this.uriPrefix+t.substring(1):!t.startsWith("/")&&!this.uriPrefix.endsWith("/")?t=this.uriPrefix+"/"+t:t=this.uriPrefix+t),this.dispatchEvent(new CustomEvent("url-update-requested",{detail:{route:t},bubbles:!0,composed:!0}))}},this.backendFailedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&e.detail.actionId==""&&(this.fragment={targetComponentId:this.id,data:{},state:{},component:{type:ae.ClientSide,metadata:{type:p.Element,name:"div",content:"Not found"},id:"fieldId"},action:Ht.Replace,containerId:void 0})},this.detail1=void 0,this.manageActionEvent=e=>{e.preventDefault(),e.stopPropagation(),this.detail1=e.detail;const t=this.detail1;if(e.type=="server-side-action-requested"){let a=Jn;t.sse&&(a=Xn),a.runAction(Aa,this.baseUrl,t.route??"",t.consumedRoute,t.actionId,t.initiatorComponentId,this.getCustomisedAppState(),t.serverSideType,t.componentState,t.parameters,t.initiator,t.background,t.callback,t.callbackonly,t.callbackToken)}},this.getCustomisedAppState=()=>{let e={...j.value};if(this.overrides){const t=ri(this.overrides);e={...e,...t}}return e}}manageActionRequestedEvent(e){throw new Error("Method not implemented.")}createRenderRoot(){return q.mustUseShadowRoot()?super.createRenderRoot():this}connectedCallback(){super.connectedCallback(),this.overridesParsed=ri(this.overrides),this.addEventListener("server-side-action-requested",this.actionRequestedListener),this.addEventListener("backend-call-failed",this.backendFailedListener),this.addEventListener("history-pushed",this.historyPushed),this.addEventListener("route-changed",this.routeChangedListener),window.Vaadin.featureFlags.masterDetailLayoutComponent=!0}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("server-side-action-requested",this.actionRequestedListener),this.removeEventListener("backend-call-failed",this.backendFailedListener),this.removeEventListener("history-pushed",this.historyPushed),this.removeEventListener("route-changed",this.routeChangedListener)}shouldUpdate(e){if(this.fragment?.component&&[...e.keys()].every(a=>a==="appState"||a==="appData")){const a=this.renderRoot.querySelector("mateu-component");if(a)return e.has("appState")&&(a.appState=this.appState),e.has("appData")&&(a.appData=this.appData),!1}return!0}updated(e){(e.has("id")||e.has("baseurl")||e.has("route")||e.has("consumedRoute")||e.has("instant"))&&(this.preventNavigation||(this.callbackToken=this.instant||G(),this.manageActionEvent(new CustomEvent("server-side-action-requested",{detail:{route:this.route,consumedRoute:this.consumedRoute,userData:void 0,actionId:"",serverSideType:this.serverSideType,initiatorComponentId:this.id,initiator:this,callbackToken:this.callbackToken},bubbles:!0,composed:!0})))),e.has("route")&&this.top&&(this.preventNavigation||this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:this.route},bubbles:!0,composed:!0}))),this.preventNavigation&&(this.preventNavigation=!1)}applyFragment(e){if(!e.component&&this.fragment?.component){this.fragment={...this.fragment,state:{...this.fragment.state??{},...e.state??{}},data:{...this.fragment.data??{},...e.data??{}}};return}this.fragment=e}render(){return o`
  ...
  `;ve([u()],Z.prototype,"consumedRoute",2);ve([u()],Z.prototype,"serverSideType",2);ve([u()],Z.prototype,"uriPrefix",2);ve([u()],Z.prototype,"overrides",2);ve([u()],Z.prototype,"homeRoute",2);ve([u()],Z.prototype,"route",2);ve([u()],Z.prototype,"top",2);ve([u()],Z.prototype,"instant",2);ve([u()],Z.prototype,"appState",2);ve([u()],Z.prototype,"appData",2);ve([v()],Z.prototype,"fragment",2);Z=ve([C("mateu-ux")],Z);var el=Object.defineProperty,fe=(e,t,a,i)=>{for(var s=void 0,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=n(t,a,s)||s);return s&&el(t,a,s),s};class ne extends Jt{constructor(){super(...arguments),this.baseUrl="",this.route="",this.consumedRoute="",this.state={},this.appState={},this.appData={},this.selectedRoute=void 0,this.selectedConsumedRoute=void 0,this.selectedBaseUrl=void 0,this.selectedServerSideType=void 0,this.selectedUriPrefix=void 0,this.instant=void 0,this.lastActionServerSideType=void 0,this.lastActionInitiatorComponentId=void 0,this.captureActionSST=t=>{const a=t.detail;typeof a?.serverSideComponentRoute=="string"&&a.serverSideComponentRoute.indexOf("_embeddedMediator=1")>=0||a?.serverSideType&&(this.lastActionServerSideType=a.serverSideType,this.lastActionInitiatorComponentId=a.initiatorComponentId)},this.handleUnhandledAction=t=>{if(this.appMetadata()?.variant==de.MEDIATOR)return;const a=t.detail;t.preventDefault(),t.stopPropagation();const i=this.renderRoot?.querySelector("#"+this.contentUxId);!i||typeof i.manageActionEvent!="function"||(this.lastActionServerSideType=this.selectedServerSideType,this.lastActionInitiatorComponentId=i.id,i.manageActionEvent(new CustomEvent("server-side-action-requested",{detail:{route:i.route??this.selectedRoute??"",consumedRoute:i.consumedRoute??this.selectedConsumedRoute??"",componentState:a.parameters?.initiatorState??{},parameters:a.parameters,actionId:a.actionId,serverSideType:this.selectedServerSideType??"",initiatorComponentId:i.id,initiator:i}})))},this.updateRoute=t=>{t.preventDefault(),t.stopPropagation();const a=t.detail;this.selectedConsumedRoute=a.consumedRoute,this.selectedBaseUrl=a.baseUrl,this.selectedRoute=a.route,this.selectedServerSideType=a.serverSideType,this.selectedUriPrefix=a.uriPrefix,this.instant=G()}}appMetadata(){return this.component?.metadata}isActive(t){const a=this.appMetadata();return this.selectedRoute===t.path?!0:!this.selectedRoute&&this.route===this.consumedRoute&&t.path===a?.homeRoute}get contentUxId(){return this._contentUxId||(this._contentUxId="ux_"+(this.route||"root").replace(/[^a-zA-Z0-9]/g,"_")+"_app"),this._contentUxId}connectedCallback(){super.connectedCallback(),this.addEventListener("server-side-action-requested",this.captureActionSST,!0),this.addEventListener("action-requested",this.handleUnhandledAction),this.innerFragmentSubscription=Ze.subscribe(t=>{const a=t.fragment;if(a&&this.lastActionInitiatorComponentId&&a.targetComponentId===this.lastActionInitiatorComponentId&&a.state?._route!==void 0){const i=a.state._route;if(i!==""&&!i.startsWith("/")){this.lastActionInitiatorComponentId=void 0,this.lastActionServerSideType=void 0;return}const s=a.state._componentRoute||"",r=this.appMetadata(),n=this.renderRoot?.querySelector("#"+this.contentUxId),l=n?.consumedRoute&&n.consumedRoute!=="_empty"?n.consumedRoute:"",c=s||this.selectedConsumedRoute||l||r?.homeConsumedRoute||"",h=c+i;this.lastActionInitiatorComponentId=void 0,h!==this.selectedRoute&&(this.selectedConsumedRoute=c,this.selectedRoute=h,this.lastActionServerSideType&&(this.selectedServerSideType=this.lastActionServerSideType),this.state&&this.state._route!=null&&(this.state._route=void 0),this.instant=G()),this.lastActionServerSideType=void 0}})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("server-side-action-requested",this.captureActionSST,!0),this.removeEventListener("action-requested",this.handleUnhandledAction),this.innerFragmentSubscription?.unsubscribe()}navigate(t){const a=this.appMetadata();if(a?.variant!=de.MEDIATOR&&!t.actionId&&(!t.baseUrl||t.baseUrl===this.baseUrl)&&(!t.serverSideType||t.serverSideType===a?.serverSideType)&&t.path!=null){if(!Et.confirmLeave())return;this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:t.path},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("navigate-to-requested",{detail:{route:t.path},bubbles:!0,composed:!0}));return}this.selectedConsumedRoute=t.consumedRoute,this.selectedBaseUrl=t.baseUrl,this.selectedRoute=t.path,this.selectedServerSideType=t.serverSideType,this.selectedUriPrefix=t.uriPrefix,this.instant=G(),this.route=t.path??this.route,this.dispatchEvent(new CustomEvent("update-route",{detail:{route:t.path},bubbles:!0,composed:!0}))}renderContent(){const t=this.appMetadata();if(!t)return o`${d}`;const a=this;return o`
            <mateu-api-caller style="width: 100%;">
                ...
                ></mateu-ux>
            </mateu-api-caller>`}}fe([u()],ne.prototype,"baseUrl");fe([u()],ne.prototype,"route");fe([u()],ne.prototype,"consumedRoute");fe([u({attribute:!1})],ne.prototype,"state");fe([u({attribute:!1})],ne.prototype,"appState");fe([u({attribute:!1})],ne.prototype,"appData");fe([v()],ne.prototype,"selectedRoute");fe([v()],ne.prototype,"selectedConsumedRoute");fe([v()],ne.prototype,"selectedBaseUrl");fe([v()],ne.prototype,"selectedServerSideType");fe([v()],ne.prototype,"selectedUriPrefix");fe([v()],ne.prototype,"instant");var tl=Object.getOwnPropertyDescriptor,al=(e,t,a,i)=>{for(var s=i>1?void 0:i?tl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=n(s)||s);return s};let oi=class extends ne{constructor(){super(...arguments),this.renderItem=e=>e.submenus&&e.submenus.length>0?o`
            ...
            </li>`}createRenderRoot(){return this}render(){const e=this.component?.metadata;if(!e)return d;if(e.variant===de.MEDIATOR)return this.renderContent();const t=(e.menu??[]).length>0;return o`
            ...
            </div>`}};oi=al([C("mateu-redhat-app")],oi);const il=(e,t,a,i,s)=>{const r=t.metadata;return o`
        <mateu-redhat-app
                id="${e.id}_ux"
                route="${r.homeRoute}"
                ...
                style="width: 100%;"
        ></mateu-redhat-app>
    `},at=(e,t,a)=>e?e.includes("${")?new Function("state","data","return `"+e+"`")(t??{},a??{}):e:"",Ft=(e,t,a,i,s,r,n)=>(t.children??[]).map(l=>$(e,l,a,i,s,r,n)),sl=e=>{const t=e.color;return t==="primary"?"pf-m-primary":t==="error"||t==="danger"?"pf-m-danger":t==="success"?"pf-m-primary":"pf-m-secondary"},rl=(e,t,a)=>{const i=e.metadata,s=at(i.label,t,a);return o`
        <button id="${e.id}" type="button"
                class="pf-v6-c-button ${sl(i)}"
                data-action-id="${i.actionId}"
                ?disabled="${i.disabled}"
                slot="${e.slot??d}"
                @click="${r=>gi(r,i)}">
            <span class="pf-v6-c-button__text">${s}</span>
        </button>`},ol=e=>{switch(e){case"h1":return"pf-m-2xl";case"h2":return"pf-m-xl";case"h3":return"pf-m-lg";case"h4":case"h5":case"h6":return"pf-m-md";default:return null}},nl=(e,t,a)=>{const i=e.metadata,s=at(i.text,t,a),r=ol(i.container);return r?o`<h2 class="pf-v6-c-title ${r}" style="${e.style??""}">${s}</h2>`:o`<div class="pf-v6-c-content" style="${e.style??""}"><p>${s}</p></div>`},Li=e=>{const t=e?.metadata?.type;return t==="FormRow"||t==="FormItem"?(e.children??[]).flatMap(Li):[e]},ll=(e,t,a,i,s,r,n)=>{const l=t.metadata,c=(t.children??[]).flatMap(Li),h=Math.max(1,Math.min(l.maxColumns??1,c.length));return o`
        <div class="pf-v6-c-form" style="display:grid; width:100%; flex:1 1 auto; grid-template-columns: repeat(${h}, minmax(0,1fr)); gap: var(--pf-t--global--spacer--md, 1rem) var(--pf-t--global--spacer--xl, 1.5rem); align-items:start;">
            ${c.map(m=>o`<div style="min-width:0;">${$(e,m,a,i,s,r,n)}</div>`)}
        </div>`},dl=(e,t,a,i,s,r,n)=>{const l=t.metadata,c=t.children??[],h=c.filter(g=>g.slot!=="buttons"&&g.slot!=="toolbar"),m=c.filter(g=>g.slot==="toolbar"),f=c.filter(g=>g.slot==="buttons"),b=at(l.title,i,s),S=at(l.subtitle,i,s),w=g=>$(e,g,a,i,s,r,n);return o`
        <div>
            ${l.noHeader?d:o`
                <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-bottom: var(--pf-t--global--spacer--md, 1rem);">
                    <div>
                        ${b?o`<h1 class="pf-v6-c-title pf-m-xl">${b}</h1>`:d}
                        ${S?o`<div class="pf-v6-c-content"><small>${S}</small></div>`:d}
                    </div>
                    ${m.length?o`<div class="pf-v6-c-action-list">${m.map(w)}</div>`:d}
                </div>`}
            ${h.map(w)}
            ${f.length?o`
        ...
        </div>`},cl=(e,t,a,i,s,r,n)=>{const l=at(t.metadata.title,i,s);return o`
        <div class="pf-v6-c-card pf-m-bordered" style="margin-bottom: var(--pf-t--global--spacer--md, 1rem);" slot="${t.slot??d}">
            ...
            <div class="pf-v6-c-card__body">${Ft(e,t,a,i,s,r,n)}</div>
        </div>`},hl=(e,t,a,i,s,r,n)=>{const l=at(t.metadata.title,i,s);return o`
        <div style="margin:.5rem 0;" slot="${t.slot??d}">
            ${l?o`<h3 class="pf-v6-c-title pf-m-md" style="margin-bottom:.5rem;">${l}</h3>`:d}
            ${Ft(e,t,a,i,s,r,n)}
        </div>`},ul=(e,t,a,i,s,r,n)=>{const l=t.metadata,c=m=>m?$(e,m,a,i,s,r,n):d,h=typeof l.title=="string"?l.title:"";return o`
        <div class="pf-v6-c-card" slot="${t.slot??d}">
            ${h?o`<div class="pf-v6-c-card__title"><h2 class="pf-v6-c-card__title-text">${h}</h2></div>`:d}
        ...
        </div>`},pl=(e,t,a,i,s,r,n)=>{const l=t.metadata,c=l?.spacing===!1?"0":"var(--pf-t--global--spacer--md, 1rem)";return o`<div style="display:flex; flex-direction:row; gap:${c}; ${l?.wrap?"flex-wrap:wrap;":""} ${l?.fullWidth?"width:100%;":""} ${t.style??""}" slot="${t.slot??d}">${Ft(e,t,a,i,s,r,n)}</div>`},ml=(e,t,a,i,s,r,n)=>{const l=t.metadata,c=l?.spacing===!1?"0":"var(--pf-t--global--spacer--sm, .75rem)";return o`<div style="display:flex; flex-direction:column; gap:${c}; ${l?.fullWidth?"width:100%;":""} ${t.style??""}" slot="${t.slot??d}">${Ft(e,t,a,i,s,r,n)}</div>`},vl=(e,t,a,i,s,r,n)=>{const l=t.metadata?.orientation==="vertical"?"column":"row";return o`<div style="display:flex; flex-direction:${l}; gap:1rem; width:100%; ${t.style??""}" slot="${t.slot??d}">
        ${(t.children??[]).map(c=>o`<div style="flex:1; min-width:0;">${$(e,c,a,i,s,r,n)}</div>`)}
    </div>`},fl=e=>{const t=e.metadata,a=t.color;return o`<span class="pf-v6-c-label ${a==="success"?"pf-m-green":a==="error"||a==="danger"?"pf-m-red":a==="warning"?"pf-m-gold":a==="info"?"pf-m-blue":""}" slot="${e.slot??d}"><span class="pf-v6-c-label__content">${t.text??""}</span></span>`},bl=e=>{const t=e.metadata;return o`<a class="pf-v6-c-button pf-m-link pf-m-inline" href="${t.url??"#"}" slot="${e.slot??d}"><span class="pf-v6-c-button__text">${t.text??t.url??""}</span></a>`},ni=(e,t)=>{t&&e?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t,parameters:{}},bubbles:!0,composed:!0}))},Di=(e,t,a)=>o`
    <div class="pf-v6-c-backdrop" style="position:fixed; inset:0; display:flex; align-items:center; justify-content:center; z-index:1000;">
    ...
    </div>`,gl=(e,t,a,i,s,r,n)=>{const l=t.metadata,c=h=>h?$(e,h,a,i,s,r,n):d;return Di(at(l.headerTitle,i,s),o`${c(l.content)}${Ft(e,t,a,i,s,r,n)}`,c(l.footer))},$l=(e,t,a,i,s,r,n)=>{const l=t.metadata,c=l.content?$(e,l.content,a,i,s,r,n):d,h=(m,f,b)=>o`<button class="pf-v6-c-button ${b}" type="button" @click="${S=>ni(S.target,f)}"><span class="pf-v6-c-button__text">${m}</span></button>`;return Di(at(l.header,i,s),c,o`
        ...
        ${l.canCancel?h(l.cancelText??"Cancel",l.cancelActionId,"pf-m-link"):d}`)},yl=e=>e==null?"":typeof e=="object"?e.text??e.label??e.name??JSON.stringify(e):String(e),xl=(e,t)=>{const a=t.metadata,i=(a.columns??[]).map(r=>r.metadata),s=e?.data?.[e.id]?.page?.content??[];return o`
        <table class="pf-v6-c-table pf-m-grid-md" role="grid">
            <thead><tr role="row">${i.map(r=>o`<th role="columnheader" scope="col">${r.label??""}</th>`)}</tr></thead>
            <tbody role="rowgroup">
                ${s.length===0?o`<tr role="row"><td role="cell" colspan="${i.length}"><div class="pf-v6-c-content" style="text-align:center; padding:1rem;">${a.emptyStateMessage??"No items."}</div></td></tr>`:d}
                ${s.map(r=>o`<tr role="row">${i.map(n=>o`<td role="cell" data-label="${n.label??""}">${yl(r[n.id])}</td>`)}</tr>`)}
            </tbody>
        </table>`},wl=(e,t)=>{const a=e?.data?.[t?.id??""]?.page??{},i=a.totalElements??0,s=a.pageSize??10,r=a.pageNumber??0,n=Math.max(1,Math.ceil(i/(s||1))),l=c=>e.pageChanged?.({detail:{page:c}});return i===0?o``:o`
        <div class="pf-v6-c-pagination pf-m-bottom" style="display:flex; justify-content:flex-end; align-items:center; gap:.5rem; padding:.5rem 0;">
        ...
        </div>`};var kl=Object.defineProperty,Sl=Object.getOwnPropertyDescriptor,wt=(e,t,a,i)=>{for(var s=i>1?void 0:i?Sl(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&kl(t,a,s),s};let it=class extends I{constructor(){super(...arguments),this.onInput=e=>this.emit(e.target.value),this.onNumber=e=>{const t=e.target.value;this.emit(t===""?null:Number(t))},this.onCheck=e=>this.emit(e.target.checked)}createRenderRoot(){return this}get value(){const e=this.field?.fieldId;return e&&this.state&&e in this.state?this.state[e]:this.field?.initialValue??""}emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e,fieldId:this.field?.fieldId},bubbles:!0,composed:!0}))}get options(){return this.field?.options??[]}isCheckbox(){return this.field?.dataType==="bool"||this.field?.stereotype==="toggle"}inputType(){const e=this.field?.stereotype,t=this.field?.dataType;return e==="email"?"email":e==="password"?"password":t==="integer"||t==="number"?"number":t==="date"?"date":t==="dateTime"?"datetime-local":t==="time"?"time":"text"}control(){const e=this.field,t=e.disabled||e.readOnly,a=!t;if(e.stereotype==="grid")return o`<mateu-grid id="${e.fieldId}" .field="${e}" .state="${this.state}" .data="${this.data}"
                                    .appState="${this.appState}" .appdata="${this.appData}"></mateu-grid>`;if(e.stereotype==="badge"){const s=!!this.value;return o`<span class="pf-v6-c-label ${s?"pf-m-green":""}" style="${s?"":"opacity:.4;"}">
                <span class="pf-v6-c-label__content">${e.label??e.fieldId??""}</span></span>`}if(e.stereotype==="plainText"){const s=e.dataType==="money"?li(this.value):e.dataType==="bool"||e.dataType==="boolean"?this.value?"✓":"✗":this.value??"";return o`<div class="pf-v6-c-content"><p>${s}</p></div>`}if(e.stereotype==="money"&&!a)return o`<div class="pf-v6-c-content"><p>${li(this.value)}</p></div>`;if(e.stereotype==="signature")return o`<mateu-signature-pad .fieldId="${e.fieldId}" .value="${this.value??""}" .editable="${a}"></mateu-signature-pad>`;if(e.stereotype==="camera")return o`<mateu-camera-capture .fieldId="${e.fieldId}" .value="${this.value??""}" .editable="${a}"></mateu-camera-capture>`;if(e.stereotype==="treeSelect")return o`<mateu-tree-select .fieldId="${e.fieldId}" .value="${this.value??""}" .options="${this.options}" .leavesOnly="${e.treeLeavesOnly===!0}"></mateu-tree-select>`;if((e.stereotype==="image"||e.stereotype==="uploadableImage")&&this.value)return o`<img src="${this.value}" style="max-width: 100%; max-height: 200px; border-radius: 4px;" />`;if(this.isCheckbox())return o`<div class="pf-v6-c-check">
            ...
            </div>`}};wt([u({attribute:!1})],it.prototype,"field",2);wt([u({attribute:!1})],it.prototype,"state",2);wt([u({attribute:!1})],it.prototype,"data",2);wt([u({attribute:!1})],it.prototype,"appState",2);wt([u({attribute:!1})],it.prototype,"appData",2);wt([u({attribute:!1})],it.prototype,"labelAlreadyRendered",2);it=wt([C("mateu-redhat-field")],it);function li(e){const t=typeof e=="number"?e:parseFloat(String(e??""));if(isNaN(t))return String(e??"");try{return new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(t)}catch{return t.toFixed(2)}}var Cl=Object.defineProperty,_l=Object.getOwnPropertyDescriptor,We=(e,t,a,i)=>{for(var s=i>1?void 0:i?_l(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Cl(t,a,s),s};let Le=class extends I{constructor(){super(...arguments),this.selected=0}createRenderRoot(){return this}label(e){const t=e?.metadata?.label;return t&&typeof t=="string"&&t.includes("${")&&this.container?._evalTemplate?this.container._evalTemplate(t):t??""}render(){const e=this.component?.children??[],t=e[this.selected];return o`
            <div>
                ...
                <div style="padding: var(--pf-t--global--spacer--md, 1rem) 0;">
                    ${(t?.children??[]).map(a=>$(this.container,a,this.baseUrl,this.compState,this.compData,this.appState,this.appData))}
                </div>
            </div>`}};We([u({attribute:!1})],Le.prototype,"component",2);We([u({attribute:!1})],Le.prototype,"container",2);We([u()],Le.prototype,"baseUrl",2);We([u({attribute:!1})],Le.prototype,"compState",2);We([u({attribute:!1})],Le.prototype,"compData",2);We([u({attribute:!1})],Le.prototype,"appState",2);We([u({attribute:!1})],Le.prototype,"appData",2);We([v()],Le.prototype,"selected",2);Le=We([C("mateu-redhat-tabs")],Le);var El=Object.defineProperty,Il=Object.getOwnPropertyDescriptor,Ve=(e,t,a,i)=>{for(var s=i>1?void 0:i?Il(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&El(t,a,s),s};let De=class extends I{constructor(){super(...arguments),this.open={},this.initialized=!1}createRenderRoot(){return this}label(e){const t=e?.metadata?.label;return t&&typeof t=="string"&&t.includes("${")&&this.container?._evalTemplate?this.container._evalTemplate(t):t??""}render(){const e=this.component?.children??[];return this.initialized||(e.forEach((t,a)=>{t?.metadata?.active&&(this.open[a]=!0)}),this.initialized=!0),o`
                ...
                ${e.map((t,a)=>{const i=!!this.open[a];return o`
                        ...
                        <div class="pf-v6-c-accordion__expandable-content ${i?"pf-m-expanded":""}" ?hidden="${!i}">
                            <div class="pf-v6-c-accordion__expandable-content-body">
                                ${i?(t?.children??[]).map(s=>$(this.container,s,this.baseUrl,this.compState,this.compData,this.appState,this.appData)):d}
                            </div>
                        </div>`})}
            </div>`}};Ve([u({attribute:!1})],De.prototype,"component",2);Ve([u({attribute:!1})],De.prototype,"container",2);Ve([u()],De.prototype,"baseUrl",2);Ve([u({attribute:!1})],De.prototype,"compState",2);Ve([u({attribute:!1})],De.prototype,"compData",2);Ve([u({attribute:!1})],De.prototype,"appState",2);Ve([u({attribute:!1})],De.prototype,"appData",2);Ve([v()],De.prototype,"open",2);De=Ve([C("mateu-redhat-accordion")],De);const Tl=new Set([p.App,p.Form,p.FormField,p.FormLayout,p.FormSection,p.FormSubSection,p.Card,p.Button,p.Text,p.HorizontalLayout,p.VerticalLayout,p.SplitLayout,p.Badge,p.Anchor,p.Dialog,p.Drawer,p.ConfirmDialog,p.TabLayout,p.AccordionLayout,p.Page,p.Crud,p.Element,p.Div,p.Image,p.MicroFrontend,p.Markdown,p.Chart,p.ProgressBar,p.CustomField,p.MessageList,p.MessageInput,p.MetricCard,p.Scoreboard,p.DashboardPanel,p.DashboardLayout,p.FoldoutLayout,p.HeroSection,p.EmptyState,p.Skeleton,p.Gantt]);class Rl extends to{rendererName(){return"redhat"}supportedClientSideTypes(){return Tl}renderClientSideComponent(t,a,i,s,r,n,l,c){const h=a?.metadata?.type,m=a;return p.App==h?il(t,m,i):p.Form==h?dl(t,m,i,s,r,n,l):p.FormField==h?o`<mateu-redhat-field id="${m.id}" .component="${m}" .field="${m.metadata}" .state="${s}" .data="${r}" .appState="${n}" .appData="${l}" .labelAlreadyRendered="${c}"></mateu-redhat-field>`:p.FormLayout==h?ll(t,m,i,s,r,n,l):p.FormSection==h?cl(t,m,i,s,r,n,l):p.FormSubSection==h?hl(t,m,i,s,r,n,l):p.Card==h?ul(t,m,i,s,r,n,l):p.Button==h?rl(m,s,r):p.Text==h?nl(m,s,r):p.HorizontalLayout==h?pl(t,m,i,s,r,n,l):p.VerticalLayout==h?ml(t,m,i,s,r,n,l):p.SplitLayout==h?vl(t,m,i,s,r,n,l):p.Badge==h?fl(m):p.Anchor==h?bl(m):p.Dialog==h?gl(t,m,i,s,r,n,l):p.ConfirmDialog==h?$l(t,m,i,s,r,n,l):p.TabLayout==h?o`<mateu-redhat-tabs .component="${m}" .container="${t}" baseUrl="${i}" .compState="${s}" .compData="${r}" .appState="${n}" .appData="${l}"></mateu-redhat-tabs>`:p.AccordionLayout==h?o`<mateu-redhat-accordion .component="${m}" .container="${t}" baseUrl="${i}" .compState="${s}" .compData="${r}" .appState="${n}" .appData="${l}"></mateu-redhat-accordion>`:super.renderClientSideComponent(t,a,i,s,r,n,l,c)}renderTableComponent(t,a){return xl(t,a)}renderFilterBar(t,a,i,s,r,n,l,c){return super.renderFilterBar(t,a,i,s,r,n,l,c)}renderPagination(t,a){return wl(t,a)}}q.set(new Rl);q.setUseShadowRoot(!1);var Pl=Object.defineProperty,Ol=Object.getOwnPropertyDescriptor,He=(e,t,a,i)=>{for(var s=i>1?void 0:i?Ol(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&Pl(t,a,s),s};let ke=class extends I{constructor(){super(...arguments),this.baseUrl="",this.route=void 0,this.consumedRoute="_empty",this.config=void 0,this.top="true",this.pathPrefix=void 0,this.debug=!1,this._lastUrl="",this.routeChangedListener=e=>{if(e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&this.top=="true"){let t=e.detail.route,a=this.baseUrl??"";!t||t.startsWith("/")?a=window.location.origin+(this.pathPrefix??""):(t=(this.pathPrefix??"")+t,a.indexOf("://")<0&&(a.startsWith("/")||(a="/"+a),a=window.location.origin+a)),t.startsWith(this.pathPrefix+"/")&&(t=t.substring(this.pathPrefix?.length)),a.endsWith("/")&&t.startsWith("/")&&(t=t.substring(1));let i=new URL(a+t);if((window.location.pathname||i.pathname)&&window.location.pathname!=i.pathname){let s=i.pathname;i.search&&(s+=i.search),s&&!s.startsWith("/")&&(s="/"+s),window.history.pushState({},"",s),this._lastUrl=window.location.href}}},this.navigateToRequestedListener=e=>{if(e.preventDefault(),e.stopPropagation(),Et.markClean(),e instanceof CustomEvent){let t=e.detail.route;const a=this.renderRoot.querySelector("mateu-ux");a&&(a.setAttribute("route",t),a.setAttribute("instant",G()))}}}createRenderRoot(){return q.mustUseShadowRoot()?super.createRenderRoot():this}connectedCallback(){if(super.connectedCallback(),Et.install(),this._lastUrl=window.location.href,window.onpopstate=e=>{if(!Et.confirmLeave()){window.history.pushState({},"",this._lastUrl);return}const t=e.target;this.loadUrl(t)},this.top=="true"?this.loadUrl(window):this.route&&(this.consumedRoute=""),this.config)try{const e=JSON.parse(this.config);j.value={...j.value,...e}}catch{j.value={...j.value,config:this.config}}this.addEventListener("url-update-requested",this.routeChangedListener),this.addEventListener("navigate-to-requested",this.navigateToRequestedListener)}disconnectedCallback(){super.disconnectedCallback(),this.upstreamSubscription?.unsubscribe(),this.removeEventListener("url-update-requested",this.routeChangedListener),this.removeEventListener("navigate-to-requested",this.navigateToRequestedListener)}loadUrl(e){if(this.route=this.extractRouteFromUrl(e),this.setAttribute("route",this.route),this.instant=G(),this._lastUrl=e.location.href,e.location.search){const a=new URLSearchParams(e.location.search).get("overrides");if(a&&(this.config=a,this.config))try{const i=JSON.parse(this.config);j.value={...j.value,...i}}catch{j.value={...j.value,config:this.config}}}}extractRouteFromUrl(e){return this.addQueryParams(this.extractRouteWithoutParamsFromUrl(e),e.location)}extractRouteWithoutParamsFromUrl(e){const t=this.extractGrossRouteFromUrl(e);return this.pathPrefix&&t.startsWith(this.pathPrefix)?t.substring(this.pathPrefix.length):t=="/"?"":t}addQueryParams(e,t){return e+(t.search?""+t.search:"")}extractGrossRouteFromUrl(e){const t=e.location.pathname,a=this.baseUrl&&(this.baseUrl.startsWith("http://")||this.baseUrl.startsWith("https://"))?this.baseUrl.substring(this.getContextPathStartingIndex(this.baseUrl)):this.baseUrl;return t.startsWith(a)?t.substring(a.length):t}getContextPathStartingIndex(e){return e.startsWith("http:")?e.indexOf("/",7):e.startsWith("https:")?e.indexOf("/",8):0}render(){return o`
           <mateu-api-caller>
                <mateu-ux id="_ux"
                          baseurl="${this.baseUrl}"
                          route="${this.route}"
  ...
  `;He([u()],ke.prototype,"baseUrl",2);He([u()],ke.prototype,"route",2);He([u()],ke.prototype,"consumedRoute",2);He([u()],ke.prototype,"config",2);He([u()],ke.prototype,"top",2);He([u()],ke.prototype,"pathPrefix",2);He([v()],ke.prototype,"instant",2);He([u({type:Boolean})],ke.prototype,"debug",2);ke=He([C("mateu-ui")],ke);
