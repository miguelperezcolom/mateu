...
`,Zs={lon:0,lat:0},wa=3,eo=e=>{if(!e)return;const t=e.split(",").map(s=>s.trim());if(t.length!==2)return;const r=Number(t[0]),a=Number(t[1]);if(!(t[0]===""||t[1]===""||!Number.isFinite(r)||!Number.isFinite(a)))return{lon:a,lat:r}},to=e=>{if(e==null||e.trim()==="")return wa;const t=Number(e);return Number.isFinite(t)?t:wa};var ro=Object.defineProperty,ao=Object.getOwnPropertyDescriptor,Fr=(e,t,r,a)=>{for(var s=a>1?void 0:a?ao(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&ro(t,r,s),s};let jt=class extends C{constructor(){super(...arguments),this.renderSeq=0}updated(e){super.updated(e),this.createMap()}disconnectedCallback(){super.disconnectedCallback(),this.map?.setTarget(void 0),this.map=void 0}async createMap(){const e=++this.renderSeq,[{default:t},{default:r},{default:a},{default:s},{fromLonLat:o},{default:n}]=await Promise.all([xe(()=>import("./vendor-ol.js").then(c=>c.M),[]),xe(()=>import("./vendor-ol.js").then(c=>c.V),[]),xe(()=>import("./vendor-ol.js").then(c=>c.T),[]),xe(()=>import("./vendor-ol.js").then(c=>c.O),[]),xe(()=>import("./vendor-ol.js").then(c=>c.p),[]),xe(()=>import("./vendor-ol.js").then(c=>c.o),[])]);if(e!==this.renderSeq||!this.isConnected)return;if(!this.shadowRoot.querySelector("style[data-ol]")){const c=document.createElement("style");c.setAttribute("data-ol",""),c.textContent=n,this.shadowRoot.appendChild(c)}this.map&&(this.map.setTarget(void 0),this.map=void 0);const d=eo(this.position)??Zs;this.map=new t({target:this.mapElement,layers:[new a({source:new s})],view:new r({center:o([d.lon,d.lat]),zoom:to(this.zoom)})})}render(){return i`<div id="map"></div>`}};jt.styles=$`
    ...
    `},this.renderPeerNav=e=>{const t=M.get()?.renderPeerNav?.(e);return t||i`
        ...
        ${ur}
    `;At([u()],Ke.prototype,"metadata",2);At([u()],Ke.prototype,"baseUrl",2);At([u()],Ke.prototype,"state",2);At([u()],Ke.prototype,"data",2);At([u()],Ke.prototype,"appState",2);At([u()],Ke.prototype,"appData",2);Ke=At([x("mateu-content-header")],Ke);var Io=Object.defineProperty,Po=Object.getOwnPropertyDescriptor,pr=(e,t,r,a)=>{for(var s=a>1?void 0:a?Po(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Io(t,r,s),s};let xt=class extends na{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={}}render(){const e=this.component?.metadata;return i`
...
`,on=e=>e=="up"?"var(--lumo-success-text-color, #1a7f37)":e=="down"?"var(--lumo-error-text-color, #c5221f)":"var(--lumo-secondary-text-color, #666)",nn=e=>e=="up"?"▲":e=="down"?"▼":"",ln=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},dn=e=>{const t=e.metadata,r=!!t.actionId;return i`
    ...
    `;pt([u()],Me.prototype,"label",2);pt([u()],Me.prototype,"value",2);pt([u()],Me.prototype,"unit",2);pt([u()],Me.prototype,"delta",2);pt([u()],Me.prototype,"trend",2);pt([u({type:Array})],Me.prototype,"spark",2);pt([u()],Me.prototype,"actionId",2);Me=pt([x("mateu-stat")],Me);const Ln=e=>{const t=e.metadata;return i`
        <mateu-stat
                label="${t.label??l}"
                value="${t.value??l}"
                unit="${t.unit??l}"
    ...
    `;Lt([u()],Ye.prototype,"heading",2);Lt([u()],Ye.prototype,"description",2);Lt([u()],Ye.prototype,"icon",2);Lt([u()],Ye.prototype,"ctaLabel",2);Lt([u()],Ye.prototype,"actionId",2);Lt([u()],Ye.prototype,"theme",2);Ye=Lt([x("mateu-callout-card")],Ye);const ul=e=>{const t=e.metadata;return i`
        <mateu-callout-card
                heading="${t.title??l}"
    ...
    `;Hr([u()],Ft.prototype,"heading",2);Hr([u({type:Array})],Ft.prototype,"items",2);Hr([b()],Ft.prototype,"localDone",2);Ft=Hr([x("mateu-checklist")],Ft);const xl=e=>{const t=e.metadata;return i`
        <mateu-checklist
                ...
                slot="${e.slot??l}"
        ></mateu-checklist>
    `};var wl=Object.defineProperty,kl=Object.getOwnPropertyDescriptor,mt=(e,t,r,a)=>{for(var s=a>1?void 0:a?kl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&wl(t,r,s),s};let je=class extends C{render(){const e=this.trend??"flat";return i`
            <div class="card">
                ${this.heading?i`<div class="title">${this.heading}</div>`:l}
                <div class="row">
                    <div class="side">
        ...
        @media (prefers-color-scheme: dark) { .card { background: var(--lumo-contrast-5pct, #2a2a2a); } }
    `;mt([u()],je.prototype,"heading",2);mt([u()],je.prototype,"leftLabel",2);mt([u()],je.prototype,"leftValue",2);mt([u()],je.prototype,"rightLabel",2);mt([u()],je.prototype,"rightValue",2);mt([u()],je.prototype,"delta",2);mt([u()],je.prototype,"trend",2);je=mt([x("mateu-comparison-card")],je);const Cl=e=>{const t=e.metadata;return i`
...
`,Sl=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}),sa=e=>Sl.format(e),Ar=(e,t)=>{const r=e<0?"-":"",a=sa(Math.abs(e));return t?`${r}${t} ${a}`:`${r}${a}`},_l=(e,t)=>t?`${sa(e)} ${t}`:sa(e);var El=Object.defineProperty,Il=Object.getOwnPropertyDescriptor,ht=(e,t,r,a)=>{for(var s=a>1?void 0:a?Il(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&El(t,r,s),s};let Ne=class extends C{constructor(){super(...arguments),this.title="",this.badges=[],this.facts=[]}render(){const e=!!(this.metricLabel||this.metricValue||this.metricCaption);return i`
    ...
    `];fr([u({type:Array})],Ct.prototype,"items",2);fr([u({type:Boolean})],Ct.prototype,"compact",2);fr([u({type:Boolean})],Ct.prototype,"frameless",2);fr([u()],Ct.prototype,"rowActionId",2);Ct=fr([x("mateu-status-list")],Ct);const Ml=e=>{const t=e.metadata;return i`
        <mateu-status-list
                .items="${t.items??[]}"
                ?compact="${t.compact??!1}"
...
`:l}
  ...
  ></oj-sp-scoreboard-metric-card>`}function uu(e,t){const r=t.metadata,a=r.badges??[],s=r.facts??[];return i`<div class="mateu-rw-entity-header">
  ...
  </div>`}const mu=Symbol("ojListeners");class hu extends Va{constructor(t){if(super(t),t.type!==Wa.ELEMENT)throw new Error("applyOj can only be used on an element binding")}render(t){return l}update(t,[r]){const a=t.element;for(const[o,n]of Object.entries(r.props??{}))n!==void 0&&(a[o]=n);for(const[o,n]of Object.entries(r.attrs??{}))n===void 0?a.removeAttribute(o):a.setAttribute(o,n);const s=a[mu]??={};for(const[o,n]of Object.entries(r.events??{})){const d=s[o];d&&a.removeEventListener(o,d),a.addEventListener(o,n),s[o]=n}return l}}const fu=Ha(hu);function ct(e,t){const r=Qs(e);return Xs`<${r} ${fu({props:t.props,attrs:t.attrs,events:t.events})}>${t.children??l}</${r}>`}function vu(e,t,r,a,s,o,n){const d=t.metadata,c=t.children??[],p=c.find(y=>y.slot==="overview"),h=d.panels??[],f=y=>y?w(e,y,r,a,s,o,n):l,v=h.findIndex(y=>y.open!==!1);return ct("oj-sp-foldout-layout",{props:{orientation:d.orientation==="horizontal"?"horizontal":"vertical",selectedPanel:v>=0?v:0},attrs:{class:t.cssClasses||void 0,style:`min-height: 32rem; ${t.style||""}`},children:i`
      ${p?i`<div slot="overview">${f(p)}</div>`:l}
      ${h.map((y,S)=>ct("oj-sp-foldout-panel-summarizing",{props:{panelTitle:y.title??""},children:i`
            <div>${f(c.find(g=>g.slot===`panel-${S}`))}</div>
            ${y.subtitle?i`<div slot="summary">${y.subtitle}</div>`:l}
          `}))}
    `})}function bu(e,t,r,a,s,o,n){const d=t.metadata,c=t.children??[];return ct("oj-sp-welcome-page",{props:{pageTitle:d.title??"",descriptionText:d.subtitle??"",illustrationBackground:d.image??void 0},attrs:{"display-options.responsive-padding":"on",class:t.cssClasses||void 0,style:t.style||void 0},children:c.length?i`<div class="oj-flex oj-sm-flex-wrap oj-sm-align-items-center" style="gap: 0.75rem;">
          ${c.map(p=>w(e,p,r,a,s,o,n))}
        </div>`:l})}function gu(e){const t=e.metadata,a=!!(t.actionId&&t.actionLabel)?{label:t.actionLabel,display:"on",type:"callToAction"}:null;return ct("oj-sp-empty-state",{props:{primaryText:t.title??"",secondaryText:t.description??"",primaryAction:a},attrs:{slot:e.slot||void 0,class:e.cssClasses||void 0,style:e.style||void 0},events:{spPrimaryAction:s=>{t.actionId&&s.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))}},children:l})}function yu(e,t,r,a,s,o,n){const c=t.metadata.title??"",p=c.includes("${")?e._evalTemplate(c):c,h=t.children?.length?i`${t.children.map(f=>w(e,f,r,a,s,o,n))}`:l;return ct("oj-sp-section",{props:{sectionTitle:p,level:"section"},attrs:{slot:t.slot||void 0,class:t.cssClasses||void 0,style:t.style||void 0},children:h})}function $u(e){const t=e.metadata,r=t.breadcrumbs??[],a=window.__mateuArrayDataProvider;if(!a)return i`<div style="display:flex; align-items:center; gap:0.5rem;" slot="${e.slot??l}">
      ${r.map(c=>i`<a href="${c.link??"#"}">${c.text}</a><span>/</span>`)}
      <span>${t.currentItemText}</span>
    </div>`;const s=r.slice().reverse(),o=[{id:"__current__",displayName:t.currentItemText},...s.map((c,p)=>({id:`c${p}`,displayName:c.text}))],n=new Map(s.map((c,p)=>[`c${p}`,c.link])),d=new a(o,{keyAttributes:"id"});return ct("oj-sp-breadcrumb-container",{props:{data:d},attrs:{slot:e.slot||void 0,class:e.cssClasses||void 0,style:e.style||void 0},events:{spAction:c=>{const p=c.detail?.id,h=p?n.get(p):void 0;if(!h)return;const f=c.target;f.dispatchEvent(new CustomEvent("route-changed",{detail:{route:h},bubbles:!0,composed:!0})),f.dispatchEvent(new CustomEvent("navigate-to-requested",{detail:{route:h},bubbles:!0,composed:!0}))}}})}function xu(e){const t=e.metadata;return ct("oj-c-avatar",{props:{initials:t.abbreviation||void 0,src:t.image||void 0,size:"md"},attrs:{slot:e.slot||void 0,title:t.name||void 0,class:e.cssClasses||void 0,style:e.style||void 0}})}function wu(e){const t=e.metadata,r=t.max&&t.max>0?t.max:100,a=t.indeterminate?-1:t.value??0;return ct("oj-c-progress-bar",{props:{value:a,max:r},attrs:{slot:e.slot||void 0,class:e.cssClasses||void 0,style:e.style||void 0}})}const ku={[m.FormField]:(e,t,r,a,s,o,n,d)=>ou(e,t,r,a,s,o,n,d),[m.Button]:(e,t,r,a,s)=>iu(t,a,s),[m.DashboardLayout]:(e,t,r,a,s,o,n)=>nu(e,t,r,a,s,o,n),[m.Scoreboard]:(e,t,r,a,s,o,n)=>lu(e,t,r,a,s,o,n),[m.DashboardPanel]:(e,t,r,a,s,o,n)=>du(e,t,r,a,s,o,n),[m.MetricCard]:(e,t)=>cu(e,t),[m.EntityHeader]:(e,t)=>uu(e,t),[m.Card]:(e,t,r,a,s,o,n)=>pu(e,t,r,a,s,o,n),[m.FoldoutLayout]:(e,t,r,a,s,o,n)=>vu(e,t,r,a,s,o,n),[m.HeroSection]:(e,t,r,a,s,o,n)=>bu(e,t,r,a,s,o,n),[m.EmptyState]:(e,t)=>gu(t),[m.FormSection]:(e,t,r,a,s,o,n)=>yu(e,t,r,a,s,o,n),[m.Breadcrumbs]:(e,t)=>$u(t),[m.Avatar]:(e,t)=>xu(t),[m.ProgressBar]:(e,t)=>wu(t)};class Cu extends Qc{rendererName(){return"redwood"}renderClientSideComponent(t,r,a,s,o,n,d,c){const p=r?.metadata?.type??r?.type,h=Object.values(m).includes(p)?p:void 0,f=h?ku[h]:void 0;return f&&r?f(t,r,a,s,o,n,d,c):super.renderClientSideComponent(t,r,a,s,o,n,d,c)}renderAppComponent(t,r,a,s,o,n,d){const c=r?.metadata;if(!c)return super.renderAppComponent(t,r,a,s,o,n,d);if(c.chromeless)return super.renderAppComponent(t,r,a,s,o,n,d);const p=Hs(t,{...c,chromeless:!0},a,s,o,n,d);return i`
    ...
    `}renderIcon(t,r,a){const s=(t||"").replace(/^(vaadin|lumo):/,""),o=Su[s];return i`<span class="mateu-icon ${a??""}" data-icon="${t}" aria-hidden="true"
                      style="display:inline-flex; align-items:center; justify-content:center; width:1em; height:1em; line-height:1; ${r??""}"
                >${o??"•"}</span>`}}const Su={menu:"☰",search:"🔍","sun-o":"☀",moon:"🌙","comments-o":"💬",comment:"💬",plus:"+",minus:"−",check:"✓",close:"✕",edit:"✎",trash:"🗑",dashboard:"▦",bell:"🔔",user:"👤",cog:"⚙",filter:"≡",download:"⤓",upload:"⤑",refresh:"↻","angle-left":"‹","angle-right":"›","angle-down":"⌄","angle-up":"⌃",ellipsis:"⋯","ellipsis-dots-v":"⋮"};M.set(new Cu);M.setUseShadowRoot(!1);
