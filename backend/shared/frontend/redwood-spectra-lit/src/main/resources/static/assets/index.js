...
import{S as Zs,a as eo,n as ke,b as to}from"./vendor.js";import{i as x,n as u,e as Ie,a as k,b as i,t as $,A as l,o as je,r as b,c as D,w as K,d as ro,D as ao,f as Ja,g as Xa,h as Qa,u as so,s as oo}from"./vendor-lit.js";import{_ as xe}from"./mateu-redwood-spectra.js";import"./vendor-vaadin.js";const yt=new Zs,G={value:{}},Sr={value:{}},hr=x`
  [theme~='badge'] {
    display: inline-flex;
    align-items: center;
...
`,io={lon:0,lat:0},Ia=3,no=e=>{if(!e)return;const t=e.split(",").map(s=>s.trim());if(t.length!==2)return;const r=Number(t[0]),a=Number(t[1]);if(!(t[0]===""||t[1]===""||!Number.isFinite(r)||!Number.isFinite(a)))return{lon:a,lat:r}},lo=e=>{if(e==null||e.trim()==="")return Ia;const t=Number(e);return Number.isFinite(t)?t:Ia};var co=Object.defineProperty,uo=Object.getOwnPropertyDescriptor,Vr=(e,t,r,a)=>{for(var s=a>1?void 0:a?uo(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&co(t,r,s),s};let Mt=class extends k{constructor(){super(...arguments),this.renderSeq=0}updated(e){super.updated(e),this.createMap()}disconnectedCallback(){super.disconnectedCallback(),this.map?.setTarget(void 0),this.map=void 0}async createMap(){const e=++this.renderSeq,[{default:t},{default:r},{default:a},{default:s},{fromLonLat:o},{default:n}]=await Promise.all([xe(()=>import("./vendor-ol.js").then(c=>c.M),[]),xe(()=>import("./vendor-ol.js").then(c=>c.V),[]),xe(()=>import("./vendor-ol.js").then(c=>c.T),[]),xe(()=>import("./vendor-ol.js").then(c=>c.O),[]),xe(()=>import("./vendor-ol.js").then(c=>c.p),[]),xe(()=>import("./vendor-ol.js").then(c=>c.o),[])]);if(e!==this.renderSeq||!this.isConnected)return;if(!this.shadowRoot.querySelector("style[data-ol]")){const c=document.createElement("style");c.setAttribute("data-ol",""),c.textContent=n,this.shadowRoot.appendChild(c)}this.map&&(this.map.setTarget(void 0),this.map=void 0);const d=no(this.position)??io;this.map=new t({target:this.mapElement,layers:[new a({source:new s})],view:new r({center:o([d.lon,d.lat]),zoom:lo(this.zoom)})})}render(){return i`<div id="map"></div>`}};Mt.styles=x`
        :host {
            display: block;
            width: 100%;
            height: 25rem;
    ...
    `;Vr([u()],Mt.prototype,"position",2);Vr([u()],Mt.prototype,"zoom",2);Vr([Ie("#map")],Mt.prototype,"mapElement",2);Mt=Vr([$("mateu-map")],Mt);const po=typeof HTMLElement<"u"?HTMLElement:class{};class mo extends po{static get observedAttributes(){return["content"]}#e;#t=0;get content(){return this.#e}set content(t){this.#e=t,this.#r()}attributeChangedCallback(t,r,a){this.content=a??void 0}connectedCallback(){this.style.display="block",this.#r()}async#r(){if(!this.isConnected)return;const t=this.#e??"",r=++this.#t,[{marked:a},{default:s}]=await Promise.all([xe(()=>import("./vendor.js").then(o=>o.m),__vite__mapDeps([0,1])),xe(()=>import("./vendor.js").then(o=>o.p),__vite__mapDeps([0,1]))]);r===this.#t&&(this.innerHTML=s.sanitize(await a.parse(t),{USE_PROFILES:{html:!0,svg:!0,svgFilters:!0},CUSTOM_ELEMENT_HANDLING:{tagNameCheck:o=>!0}}))}}typeof customElements<"u"&&!customElements.get("mateu-markdown")&&customElements.define("mateu-markdown",mo);var Y=(e=>(e.ServerSide="ServerSide",e.ClientSide="ClientSide",e))(Y||{}),m=(e=>(e.Page="Page",e.Div="Div",e.Element="Element",e.MicroFrontend="MicroFrontend",e.Form="Form",e.Crud="Crud",e.Result="Result",e.Card="Card",e.Directory="Directory",e.Stepper="Stepper",e.HorizontalLayout="HorizontalLayout",e.VerticalLayout="VerticalLayout",e.SplitLayout="SplitLayout",e.MasterDetailLayout="MasterDetailLayout",e.TabLayout="TabLayout",e.AccordionLayout="AccordionLayout",e.FormLayout="FormLayout",e.FormRow="FormRow",e.FormItem="FormItem",e.BoardLayout="BoardLayout",e.BoardLayoutRow="BoardLayoutRow",e.BoardLayoutItem="BoardLayoutItem",e.Scroller="Scroller",e.FullWidth="FullWidth",e.Container="Container",e.FormField="FormField",e.Table="Table",e.App="App",e.Text="Text",e.Avatar="Avatar",e.Chat="Chat",e.AvatarGroup="AvatarGroup",e.Badge="Badge",e.Breadcrumbs="Breadcrumbs",e.Anchor="Anchor",e.Button="Button",e.Chart="Chart",e.Icon="Icon",e.ConfirmDialog="ConfirmDialog",e.ContextMenu="ContextMenu",e.CookieConsent="CookieConsent",e.Details="Details",e.Dialog="Dialog",e.Drawer="Drawer",e.Image="Image",e.Map="Map",e.Markdown="Markdown",e.Notification="Notification",e.ProgressBar="ProgressBar",e.Popover="Popover",e.CarouselLayout="CarouselLayout",e.Tooltip="Tooltip",e.MessageInput="MessageInput",e.MessageList="MessageList",e.CustomField="CustomField",e.MenuBar="MenuBar",e.Grid="Grid",e.GridColumn="GridColumn",e.GridGroupColumn="GridGroupColumn",e.VirtualList="VirtualList",e.FormSection="FormSection",e.FormSubSection="FormSubSection",e.Bpmn="Bpmn",e.Workflow="Workflow",e.FormEditor="FormEditor",e.MetricCard="MetricCard",e.Scoreboard="Scoreboard",e.DashboardPanel="DashboardPanel",e.DashboardLayout="DashboardLayout",e.FoldoutLayout="FoldoutLayout",e.HeroSection="HeroSection",e.EmptyState="EmptyState",e.Skeleton="Skeleton",e.Gantt="Gantt",e.PlanningBoard="PlanningBoard",e.Kanban="Kanban",e.Timeline="Timeline",e.ProgressSteps="ProgressSteps",e.Stat="Stat",e.Calendar="Calendar",e.PricingTable="PricingTable",e.OrgChart="OrgChart",e.Heatmap="Heatmap",e.Funnel="Funnel",e.TrendChart="TrendChart",e.FeatureGrid="FeatureGrid",e.Testimonials="Testimonials",e.Faq="Faq",e.CalloutCard="CalloutCard",e.CommentThread="CommentThread",e.FileList="FileList",e.Checklist="Checklist",e.ComparisonCard="ComparisonCard",e.EntityHeader="EntityHeader",e.Meter="Meter",e.TaskProgress="TaskProgress",e.StatusList="StatusList",e.BulletedList="BulletedList",e.Separator="Separator",e.Notice="Notice",e.TaskQueue="TaskQueue",e.ResourceGrid="ResourceGrid",e.OfferCard="OfferCard",e.AddOnPicker="AddOnPicker",e.Ledger="Ledger",e.PaymentPicker="PaymentPicker",e.ProcessMonitor="ProcessMonitor",e))(m||{});const ua="mateu-app-context",Za="mateu-app-context-labels",es=e=>{try{return JSON.parse(localStorage.getItem(e)??"{}")}catch{return{}}},Pa=(e,t)=>{try{localStorage.setItem(e,JSON.stringify(t))}catch{}},pa=()=>es(ua),ts=()=>es(Za),ho=(e,t,r)=>{const a=pa(),s=ts();t==null||t===""?(delete a[e],delete s[e]):(a[e]=t,r!==void 0&&(s[e]=r)),Pa(ua,a),Pa(Za,s)};let Oa=!1;const fo=()=>{Oa||(Oa=!0,window.addEventListener("storage",e=>{e.key===ua&&e.newValue!==e.oldValue&&window.location.reload()}))},vo=(e,t)=>new Promise((r,a)=>{let s=!1;const o={retry:()=>{s||(s=!0,t().then(r,a))},giveUp:()=>{s||(s=!0,a(e))}},n=new CustomEvent("mateu-session-expired",{detail:o,cancelable:!0,bubbles:!1});typeof document<"u"&&!document.dispatchEvent(n)||o.giveUp()}),bo=(e,t)=>e.includes("json")?!0:t!==null&&typeof t=="object",go=(e,t)=>{const r=e.finalUrl;if(!r)return;const a=typeof window<"u"?window.location.href:void 0;let s;try{s=new URL(e.requestedUrl,a).href}catch{return}if(s!==r&&!bo(e.contentType??"",e.data))return r};class yo{constructor(){this.windowMs=4e3,this.threshold=12,this.events=[],this.reported=new Set}check(t,r=Date.now()){this.events.push({sig:t,t:r});const a=r-this.windowMs;this.events=this.events.filter(o=>o.t>=a);let s=0;for(const o of this.events)o.sig===t&&s++;if(s>=this.threshold){const o=!this.reported.has(t);return this.reported.add(t),{blocked:!0,firstTrip:o}}return this.reported.delete(t),{blocked:!1,firstTrip:!1}}reset(){this.events=[],this.reported.clear()}configure(t){t.windowMs!==void 0&&(this.windowMs=t.windowMs),t.threshold!==void 0&&(this.threshold=t.threshold)}}const $o=new yo;let Ut=[];class xo{constructor(){this.axiosInstance=eo.create({timeout:6e4}),this.axiosInstance.interceptors.request.use(t=>(this.addAuthToken(t),this.addSessionId(t),t)),this.axiosInstance.interceptors.response.use(t=>{const r=go({requestedUrl:this.axiosInstance.getUri(t.config),finalUrl:t.request?.responseURL,contentType:String(t.headers?.["content-type"]??""),data:t.data});if(r)throw window.location.assign(r),Object.assign(new Error("session lost — redirecting to "+r),{code:"ERR_CANCELED"});return t},t=>{const r=t;if(r?.response?.status===401&&r.config&&!r.config.__mateuRetried){const a=r.config;return a.__mateuRetried=!0,vo(t,()=>this.axiosInstance.request(a))}throw t})}addSessionId(t){let r=sessionStorage.getItem("__mateu_sesion_id");r||(r=ke(),sessionStorage.setItem("__mateu_sesion_id",r)),t.headers["X-Session-Id"]=r}addAuthToken(t){const r=localStorage.getItem("__mateu_auth_token");r&&(t.headers.Authorization="Bearer "+r)}async wrap(t,r,a,s){return a||r.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),t.then(o=>(r.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:s}})),o)).catch(o=>{throw o?.code=="ERR_CANCELED"?r.dispatchEvent(new CustomEvent("backend-cancelled-event",{bubbles:!0,composed:!0,detail:{}})):r.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:s,reason:this.serialize(o)}})),o})}serialize(t){return t?.message?t:JSON.stringify(t)}async get(t){const r=new AbortController;return Ut=[...Ut,r],this.axiosInstance.get(t,{signal:r.signal})}async post(t,r){const a=new AbortController;return Ut=[...Ut,a],this.axiosInstance.post(t,r,{signal:a.signal})}async abortAll(){Ut.forEach(t=>t.abort()),Ut=[]}async runAction(t,r,a,s,o,n,d,c,p,h,f){r&&r.startsWith("/")&&(r=r.substring(1));const v=[t,r,a,d??"",s,o].join(""),y=$o.check(v);return y.blocked?(await this.abortAll(),y.firstTrip&&console.error("[mateu] request loop detected — aborting repeated request",v),{messages:y.firstTrip?[{title:"",text:"A repeating request was detected and stopped to protect the server. Reload the page or navigate elsewhere.",position:"bottom-end",variant:"error",duration:6e3}]:[],commands:[],fragments:[],banners:[],appendBanners:!1,appData:void 0,appState:void 0}):(n={...pa(),...n},await this.wrap(this.post(t+"/mateu/v3/sync/"+(r&&r!=""?r:"_no_route"),{serverSideType:d,appState:n,componentState:c,parameters:p,initiatorComponentId:o,consumedRoute:a,route:r&&r!=""?"/"+r:"",actionId:s}).then(C=>C.data),h,f,s))}}const Tt=new xo;var ar=(e=>(e.Add="Add",e.Replace="Replace",e.ReplaceKeepData="ReplaceKeepData",e))(ar||{}),Ke=(e=>(e.HAMBURGUER_MENU="HAMBURGUER_MENU",e.MENU_ON_LEFT="MENU_ON_LEFT",e.MENU_ON_TOP="MENU_ON_TOP",e.TABS="TABS",e.TILES="TILES",e.RAIL="RAIL",e.AUTO="AUTO",e.MEDIATOR="MEDIATOR",e))(Ke||{}),wo=Object.defineProperty,rs=(e,t,r,a)=>{for(var s=void 0,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=n(t,r,s)||s);return s&&wo(t,r,s),s};class Wr extends k{constructor(){super(...arguments),this.id="",this.baseUrl="",this.callbackToken="",this.createElement=t=>{const r=t.data,a=document.createElement(r.name);for(let s in r.attributes)a.setAttribute(s,r.attributes[s]);for(let s in r.on)a.addEventListener(s,o=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.on[s],parameters:{event:o}},bubbles:!0,composed:!0}))});return a},this.closeModal=()=>{const t=(this.shadowRoot??this).querySelectorAll("mateu-dialog, mateu-drawer");if(t&&t.length>0){t[t.length-1].close(),this.removeTopOverlayChild();return}this.dispatchEvent(new CustomEvent("close-modal-requested",{bubbles:!0,composed:!0}))},this.changeFavicon=t=>{let r=document.querySelector('link[rel="icon"]');r!==null?r.setAttribute("href",t):(r=document.createElement("link"),r.setAttribute("rel","icon"),r.setAttribute("href",t),document.head.appendChild(r))}}connectedCallback(){super.connectedCallback(),this.upstreamSubscription=yt.subscribe(t=>{if(t.command){const r=t.command;this.id==r.targetComponentId&&this.applyCommand(r)}if((!t.callbackToken||!this.callbackToken||t.callbackToken===this.callbackToken)&&t.fragment){const r=t.fragment;this.id==r.targetComponentId&&(this.applyFragment(r),this.completeMenu(r))}})}completeMenu(t){if(t.component&&t.component.type==Y.ClientSide){const r=t.component,a=r.metadata;if(a?.type==m.App){const s=a,o=this.getRemoteMenus(s.menu);if(o.length>0){const n=o.map(d=>Tt.runAction(d.baseUrl,d.route,"_empty","",d.baseUrl+"#"+d.route,void 0,void 0,void 0,d.params,this,!0));Promise.all(n).then(d=>{s.menu=this.updateMenu(s.menu,d.map(c=>c.fragments).filter(c=>c).map(c=>c).flat()),s.variant=Ke.MENU_ON_TOP,yt.next({fragment:{component:r,data:void 0,state:void 0,action:ar.Replace,targetComponentId:this.id,containerId:void 0},callbackToken:this.callbackToken})})}}}}updateMenu(t,r){const a=[];return t.forEach(s=>{if(s.remote){const o=r.find(n=>n.targetComponentId==s.baseUrl+"#"+s.route);if(o&&o.component?.type==Y.ClientSide){const n=o.component;if(n.metadata?.type==m.App){const d=n.metadata,c=s.serverSideType&&s.serverSideType!=""?s.serverSideType:d.serverSideType;this.changeBaseUrl(d.menu,s.baseUrl,c,s.route,d.route),a.push(...d.menu)}}}else a.push(s)}),a}changeBaseUrl(t,r,a,s,o){t.forEach(n=>{n.baseUrl||(n.submenus&&n.submenus.length>0?this.changeBaseUrl(n.submenus,r,a,s,o):(n.consumedRoute=o??"",n.baseUrl=r,n.serverSideType=a,n.uriPrefix=s))})}getRemoteMenus(t){const r=[];return t.forEach(a=>{a.remote&&r.push(a)}),r}disconnectedCallback(){super.disconnectedCallback(),this.upstreamSubscription?.unsubscribe()}applyCommand(t){if(t.type=="SetWindowTitle"&&(document.title=t.data),t.type=="SetFavicon"&&this.changeFavicon(t.data),t.type=="DispatchEvent"&&this.dispatchNamedEvent(t.data),t.type=="NavigateTo"){const r=t.data;r&&(r.startsWith("http:")||r.startsWith("https:")?window.open(t.data,"_blank"):window.location.href=t.data)}if(t.type=="PushStateToHistory"){const r=t.data;r!==void 0&&this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:r},bubbles:!0,composed:!0}))}if(t.type=="RunAction"){const r=t.data;if(r&&r.actionId)if(r.targetComponentId){const a={command:{type:"RunAction",data:{actionId:r.actionId},targetComponentId:r.targetComponentId},fragment:void 0,ui:void 0,error:void 0,callbackToken:""};setTimeout(()=>yt.next(a))}else this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.actionId,parameters:{}},bubbles:!0,composed:!0}))}if(t.type=="MarkAsDirty"&&this.dispatchEvent(new CustomEvent("dirty",{detail:{},bubbles:!0,composed:!0})),t.type=="MarkAsClean"&&this.dispatchEvent(new CustomEvent("clean",{detail:{},bubbles:!0,composed:!0})),t.type=="DownloadFile"){const r=t.data;if(r&&r.base64Content){const a=atob(r.base64Content),s=new Uint8Array(a.length);for(let c=0;c<a.length;c++)s[c]=a.charCodeAt(c);const o=new Blob([s],{type:r.mimeType}),n=URL.createObjectURL(o),d=document.createElement("a");d.href=n,d.download=r.filename??"export",d.click(),URL.revokeObjectURL(n)}}if(t.type=="CloseModal"&&(this.closeModal(),this.dispatchNamedEvent(t.data)),t.type=="AddContentToHead"){const r=t.data;if(r&&r.name){if(r.attributes&&r.attributes.id&&document.getElementById(r.attributes.id))return;document.head.appendChild(this.createElement(t))}}if(t.type=="AddContentToBody"){const r=t.data;if(r&&r.name){if(r.attributes&&r.attributes.id&&document.getElementById(r.attributes.id))return;document.body.appendChild(this.createElement(t))}}}dispatchNamedEvent(t){if(t&&t.eventName){const r=this.component,a=r?.emitsName??r?.serverSideType;let s=t.payload??t.detail;a&&s&&typeof s=="object"&&(s={...s,__source:a}),this.dispatchEvent(new CustomEvent(t.eventName,{detail:s,bubbles:!0,composed:!0}))}}removeTopOverlayChild(){const t=this.component?.children;if(t)for(let r=t.length-1;r>=0;r--){const a=t[r]?.metadata?.type;if(a==m.Drawer||a==m.Dialog){t.splice(r,1);return}}}}rs([u()],Wr.prototype,"id");rs([u()],Wr.prototype,"baseUrl");var ko=Object.defineProperty,_o=(e,t,r,a)=>{for(var s=void 0,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=n(t,r,s)||s);return s&&ko(t,r,s),s};class ma extends Wr{applyFragment(t){}manageActionRequestedEvent(t){}}_o([u()],ma.prototype,"component");const Nt=(e,t)=>new Function(...Object.keys(t),"return `"+e+"`")(...Object.values(t)),Vt=(e,t,r)=>({state:e??{},data:t??{},...r});function zt(e,t,r,a){if(!e?.includes("${"))return e;try{return Nt(e,Vt(t,r,a))}catch(s){return console.warn(`Mateu: could not interpolate "${e}":`,s),e}}const at=(e,t,r)=>{if(e&&e.indexOf("${")>=0)try{return Nt(e,Vt(t,r))}catch(a){return a.message}return e},sr=(e,t,r,a,s)=>{if(!e)return e;const o=Vt(t,r,{appState:a??{},appData:s??{}});let n=e;try{if(n=Nt(e,o),n.includes("${"))try{n=Nt(n,o)}catch(d){n="when evaluating nested "+e+" :"+d+", where data is "+r+" and state is "+t+" and app state is "+a+" and app data is "+s,console.error(d,n,t,r,a,s)}}catch(d){n="when evaluating "+e+" :"+d+", where data is "+r+" and state is "+t+" and app state is "+a+" and app data is "+s,console.error(d,n,t,r,a,s)}return n},as=(e,t,r,a,s,o)=>{const n=Vt(t,r,{appState:a??{},appData:s??{},...o}),d=Nt(e,n);return new Function(...Object.keys(n),`return (${d})`)(...Object.values(n))},ss=(e,t,r,a)=>{const s=Vt(t,r,a);return new Function(...Object.keys(s),`return (${e})`)(...Object.values(s))},Co=(e,t,r,a)=>Nt(e,Vt(t,r,a)),ia="display:inline-flex; align-items:center; justify-content:center; width:2rem; height:2rem; border-radius:50%; background:var(--lumo-contrast-10pct,#e0e0e0); color:var(--lumo-secondary-text-color,#555); font-size:.8rem; font-weight:600; overflow:hidden; flex:none;",os=(e,t)=>t||(typeof e=="string"&&e?e.trim().split(/\s+/).map(r=>r[0]).slice(0,2).join("").toUpperCase():""),So=(e,t,r)=>{const a=e.metadata,s=Er(a.name,t,r);return i`<span style="${ia}${e.style}" class="${e.cssClasses}"
        ...
        <mateu-component id="${t.id}"
                        ...
                        route="${c}"
                         ...
                         .appData="${n}"
        >
       </mateu-component>`};var To=Object.defineProperty,zo=Object.getOwnPropertyDescriptor,At=(e,t,r,a)=>{for(var s=a>1?void 0:a?zo(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&To(t,r,s),s};const Ao=e=>{const t=[];return e.color&&e.color!=="normal"&&e.color!=="none"&&t.push(e.color),e.buttonStyle&&t.push(e.buttonStyle==="tertiaryInline"?"tertiary-inline":e.buttonStyle),e.size&&e.size!=="none"&&e.size!=="normal"&&t.push(e.size),t.length?t.join(" "):void 0},Ro=e=>{const t=Ao(e)??"",r=[];return t.includes("primary")&&r.push("primary"),t.includes("tertiary")&&r.push("tertiary"),(t.includes("error")||e.color==="error")&&r.push("danger"),r.join(" ")},Ta=e=>e==="back"||e==="backToList"||!!e&&e.startsWith("cancel");let Ye=class extends k{constructor(){super(...arguments),this.appState={},this.appData={},this.handleButtonClick=e=>{this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.evalLabel=e=>zt(e,this.state,this.data),this.renderBtn=e=>{if((this.data??{})[e.actionId+".hidden"])return l;const t=this.evalLabel(e.label),r=U.get()?.renderToolbarButton?.(e,t,()=>this.handleButtonClick(e.actionId));return r||i`
        <button class="mtb ${Ro(e)}"
                data-action-id="${e.id}"
                @click="${()=>this.handleButtonClick(e.actionId)}"
                ?disabled="${e.disabled}"
        >${t}</button>
    `},this.renderPeerNav=e=>{const t=U.get()?.renderPeerNav?.(e);return t||i`
        ...
        `}}render(){const e=this.metadata;if(!e)return i``;const t=e.peerNav&&(e.peerNav.prevRoute||e.peerNav.nextRoute)?e.peerNav:void 0,r=e.toolbar??[],a=r.filter(c=>Ta(c.actionId)),s=r.filter(c=>!Ta(c.actionId)),o=a.length>0&&s.length>0?i`<span class="toolbar-divider"></span>`:l,n=e.avatar||e.title||e.subtitle||e.kpis?.length>0||e.header?.length>0||r.length>0||!!t,d=e.level??0;return d>0?this.setAttribute("data-nested",""):this.removeAttribute("data-nested"),i`
            ...
            `:n?i`
                <div style="display: flex; gap: var(--lumo-space-m, 1rem); width: 100%; align-items: center;" class="form-header">
                    ...
                    <div style="flex: 1; min-width: 0; overflow: hidden;">
                        ${e?.title&&d==0?i`<h2 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${je(at(e?.title,this.state??{},this.data??{}))}</h2>`:l}
                        ${e?.title&&d==1?i`<h3 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${je(at(e?.title,this.state??{},this.data??{}))}</h3>`:l}
                        ${e?.title&&d==2?i`<h4 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${je(at(e?.title,this.state??{},this.data??{}))}</h4>`:l}
                        ${e?.title&&d==3?i`<h5 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${je(at(e?.title,this.state??{},this.data??{}))}</h5>`:l}
                        ${e?.title&&d>3?i`<h6 style="margin: 0; margin-block-end: 0px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%;">${je(at(e?.title,this.state??{},this.data??{}))}</h6>`:l}

                        ${e?.subtitle?i`<span style="display: inline-block; margin-block-end: 0.83em;">${je(at(e?.subtitle,this.state??{},this.data??{}))}</span>`:l}
                        ${e?.timestamp?i`<span class="page-timestamp" style="display: block; color: var(--lumo-secondary-text-color, #6b7280); font-size: var(--lumo-font-size-s, .875rem);">${je(at(e.timestamp,this.state??{},this.data??{}))}</span>`:l}
                    </div>
                    <div style="display: flex; gap: var(--lumo-space-m, 1rem); align-items: center;">
                        ${e?.kpis?.map(c=>i`
                            <div style="display: flex; flex-direction: column; align-items: center;">
                                <div>${this.evalLabel(c.title)}</div>
                                <div>${je(at(c.text,this.state??{},this.data??{}))}</div>
                            </div>
                        `)}
                        ${e?.header?.map(c=>w(this,c,this.baseUrl,this.state??{},this.data??{},this.appState,this.appData))}
                        ${t?this.renderPeerNav(t):l}
        ...
        ${hr}
    `;At([u()],Ye.prototype,"metadata",2);At([u()],Ye.prototype,"baseUrl",2);At([u()],Ye.prototype,"state",2);At([u()],Ye.prototype,"data",2);At([u()],Ye.prototype,"appState",2);At([u()],Ye.prototype,"appData",2);Ye=At([$("mateu-content-header")],Ye);var Do=Object.defineProperty,Lo=Object.getOwnPropertyDescriptor,fr=(e,t,r,a)=>{for(var s=a>1?void 0:a?Lo(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Do(t,r,s),s};let xt=class extends ma{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={}}render(){const e=this.component?.metadata;return i`
    ...
    `;fr([u()],xt.prototype,"state",2);fr([u()],xt.prototype,"data",2);fr([u()],xt.prototype,"appState",2);fr([u()],xt.prototype,"appData",2);xt=fr([$("mateu-form")],xt);var jo=Object.defineProperty,Uo=Object.getOwnPropertyDescriptor,ha=(e,t,r,a)=>{for(var s=a>1?void 0:a?Uo(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&jo(t,r,s),s};let or=class extends k{constructor(){super(...arguments),this.variant="text",this.count=3}render(){const e=Array.from({length:Math.max(1,this.count)});return this.variant=="card"?i`${e.map(()=>i`<div class="bone card" style="margin: .5em 0;"></div>`)}`:this.variant=="grid"?i`${e.map(()=>i`<div class="bone row"></div>`)}`:this.variant=="form"?i`${e.map(()=>i`
                <div class="form-pair">
                    <div class="bone label"></div>
                    <div class="bone field"></div>
                </div>
            `)}`:i`${e.map(()=>i`<div class="bone line"></div>`)}`}};or.styles=x`
        :host {
            display: block;
            flex: 1 1 0;
            min-width: 6rem;
    ...
    `;ha([u()],or.prototype,"variant",2);ha([u({type:Number})],or.prototype,"count",2);or=ha([$("mateu-skeleton")],or);const Mo=(e,t)=>{t&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},tr=(e,t,r,a,s,o)=>i`
        <div class="mateu-empty-state"
            ...
            ${s&&o?i`
                <button style="margin-top: .25rem; font: inherit; font-weight: 500; cursor: pointer; padding: .4rem .9rem; border: none; border-radius: var(--lumo-border-radius-m, 6px); background: transparent; color: var(--lumo-primary-text-color, #3b5bdb);"
                        @click="${n=>Mo(n,s)}">${o}</button>
            `:l}
        </div>
    `,No=e=>{const t=e.metadata;return i`
        <div style="${e.style??l}" class="${e.cssClasses??l}" slot="${e.slot??l}">
            ${tr(void 0,t.icon,t.title,t.description,t.actionId,t.actionLabel)}
        </div>
    `},Fo=e=>{const t=e.metadata;return i`
        <mateu-skeleton
    ...
    `},H=(e,t,r,a)=>{if(!e)return i``;const s=U.get()?.renderIcon;if(s){const o=s.call(U.get(),e,t,r);return a?i`<span slot="${a}">${o}</span>`:o}return i`<span class="mateu-icon ${r??""}" data-icon="${e}" aria-hidden="true"
        ...
        `,()=>r(a.value)))}`}renderActiveFilterWidget(e){if(this.isRangeFilter(e))return this.renderRangeWidget(e);if(this.isMultiFilter(e))return this.renderMultiWidget(e);if(this.hasOptions(e))return i`${e.options.map(a=>this.panelRow(a.label??a.value,()=>this.applyFilter(e.fieldId,a.value)))}`;if(this.isBooleanFilter(e))return i`
            ...
            </div>`}renderViewsPanel(){if(!this.viewsOpened)return l;const e=ns(this.viewsScope),t=!!this.state.searchText||this.filters.some(r=>this.isSet(r));return i`
                ...
                ${e.map(r=>i`
                    <div class="panel-row view-row" @mousedown="${this.keepFocus}">
                        ...
                        <button class="view-star ${r.isDefault?"view-star--on":""}"
                                ...
                                @click="${()=>{Ho(this.viewsScope,r.name),this.requestUpdate()}}">★</button>
                        <button class="chip-remove" aria-label="Delete view ${r.name}"
                                @click="${()=>{qo(this.viewsScope,r.name),this.requestUpdate()}}">✕</button>
                    </div>`)}
                ${t?i`
    ...
    `;ve([u()],re.prototype,"metadata",2);ve([u()],re.prototype,"baseUrl",2);ve([b()],re.prototype,"state",2);ve([b()],re.prototype,"data",2);ve([u()],re.prototype,"appState",2);ve([u()],re.prototype,"appData",2);ve([u({type:Boolean})],re.prototype,"searchOnly",2);ve([b()],re.prototype,"panelOpened",2);ve([b()],re.prototype,"viewsOpened",2);ve([b()],re.prototype,"activeFilter",2);ve([b()],re.prototype,"draftText",2);re=ve([$("mateu-filter-bar")],re);const ls="mateu-column-prefs",va=()=>{try{const e=JSON.parse(localStorage.getItem(ls)??"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}},ds=e=>{try{localStorage.setItem(ls,JSON.stringify(e))}catch{}},ba=e=>{if(!e||typeof e!="object")return;const t=r=>Array.isArray(r)?r.filter(a=>typeof a=="string"):[];return{hidden:t(e.hidden),order:t(e.order)}},cs=e=>ba(va()[e]),Ko=(e,t)=>{const r=va(),a=ba(t);a.hidden.length===0&&a.order.length===0?delete r[e]:r[e]=a,ds(r)},Yo=e=>{const t=va();delete t[e],ds(t)},us=e=>e?!!e.identifier||e.dataType==="action"||e.dataType==="actionGroup"||e.dataType==="menu"||e.id==="select"||e.id==="menu":!1,ps=(e,t,r=a=>a)=>{const a=ba(t);if(!a||a.hidden.length===0&&a.order.length===0)return e;const s=f=>r(f)?.id??f.id,o=new Set(a.hidden),n=e.filter(f=>{const v=s(f);return!v||!o.has(v)||us(r(f))});if(a.order.length===0)return n.length===e.length?e:n;const d=new Map;n.forEach(f=>{const v=s(f);v&&!d.has(v)&&d.set(v,f)});const c=[],p=new Set;return a.order.forEach(f=>{const v=d.get(f);v&&!p.has(v)&&(c.push(v),p.add(v))}),n.forEach(f=>{p.has(f)||(c.push(f),p.add(f))}),c.length===e.length&&c.every((f,v)=>f===e[v])?e:c};var Jo=Object.defineProperty,Xo=Object.getOwnPropertyDescriptor,vr=(e,t,r,a)=>{for(var s=a>1?void 0:a?Xo(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Jo(t,r,s),s};let wt=class extends k{constructor(){super(...arguments),this.columns=[],this.scope="",this.panelOpened=!1,this.revision=0,this.togglePanel=()=>{if(this.panelOpened){this.closePanel();return}this.panelOpened=!0,this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick)},this.closePanel=()=>{this.detachOutsideClick(),this.panelOpened=!1},this.reset=()=>{Yo(this.scope),this.revision++,this.dispatchEvent(new CustomEvent("column-prefs-changed",{bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick()}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}get prefs(){return cs(this.scope)??{hidden:[],order:[]}}effectiveEntries(e){return ps(this.columns,{hidden:[],order:e.order})}commit(e){Ko(this.scope,e),this.revision++,this.dispatchEvent(new CustomEvent("column-prefs-changed",{bubbles:!0,composed:!0}))}toggleVisibility(e){const t=this.prefs,r=t.hidden.includes(e)?t.hidden.filter(a=>a!==e):[...t.hidden,e];this.commit({...t,hidden:r})}move(e,t){const r=this.prefs,a=[...this.effectiveEntries(r)],s=a.findIndex(d=>d.id===e);if(s<0)return;let o=s+t;for(;o>=0&&o<a.length&&a[o].protected;)o+=t;if(o<0||o>=a.length)return;const n=a[s];a[s]=a[o],a[o]=n,this.commit({...r,order:a.map(d=>d.id)})}render(){this.revision;const e=this.prefs,t=this.effectiveEntries(e).filter(a=>!a.protected);if(t.length===0)return i``;const r=e.hidden.length>0||e.order.length>0;return i`
            <div class="chooser">
                <button
    ...
    `;vr([u()],wt.prototype,"columns",2);vr([u()],wt.prototype,"scope",2);vr([b()],wt.prototype,"panelOpened",2);vr([b()],wt.prototype,"revision",2);wt=vr([$("mateu-column-chooser")],wt);var Qo=Object.defineProperty,Zo=Object.getOwnPropertyDescriptor,br=(e,t,r,a)=>{for(var s=a>1?void 0:a?Zo(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Qo(t,r,s),s};let kt=class extends k{constructor(){super(...arguments),this.totalElements=0,this.pageSize=100,this.pageNumber=0,this.totalPages=0}updated(e){super.updated(e),(e.has("totalElements")||e.has("pageSize"))&&(this.totalPages=Math.ceil(this.totalElements/this.pageSize))}dispatch(e){this.dispatchEvent(new CustomEvent("page-changed",{bubbles:!0,composed:!0,detail:{page:e}}))}render(){if(!this.totalElements)return l;const e=this.totalPages>1,t=this.pageNumber,r=t===0,a=t>=this.totalPages-1;return i`
            <div class="bar">
                ${e?i`
    ...
    `},hs=(e,t,r,a,s,o,n,d)=>{if(r.type==Y.ClientSide&&r.metadata?.type==m.FormRow)return ri(e,t,r,a,s,o,n,d);const c=ei(r),p=e.labelsAside?ti(t,r,a,s,o,n,d):w(t,r,a,s,o,n,d);return i`<div style="grid-column: span ${c}; min-width: 0;">${p}</div>`},ei=e=>{if(e.type==Y.ClientSide){const t=e.metadata;if(t?.type==m.FormField)return t.colspan||1}return 1},ti=(e,t,r,a,s,o,n)=>{if(t.type==Y.ClientSide&&t.metadata?.type==m.FormField&&t.metadata.label){const d=t.metadata,c=d.label?.includes("${")?e._evalTemplate(d.label):d.label;return i`
        ...
        `}return w(e,t,r,a,s,o,n)},ri=(e,t,r,a,s,o,n,d)=>i`
        <div style="grid-column: 1 / -1; display: flex; gap: ${Wt}; flex-wrap: wrap;">
            ${r.children?.map(c=>i`<div style="flex: 1 1 ${100/Math.max(1,r.children.length)}%; min-width: min(100%, 13rem);">${hs(e,t,c,a,s,o,n,d)}</div>`)}
        </div>
    `,fs=(e,t,r,a,s,o,n,d)=>{const c=r.metadata;let p=`display: flex; flex-direction: ${e};`;c.spacing&&(p+=` gap: ${Wt};`),c.padding&&(p+=" padding: var(--lumo-space-m, 1rem);"),c.wrap&&(p+=" flex-wrap: wrap;"),c.fullWidth&&(p+=" width: 100%;"),c.justification&&(p+=` justify-content: ${c.justification};`);const h=e==="row"?c.verticalAlignment:c.horizontalAlignment;return h&&(p+=` align-items: ${h};`),p+=r.style??"",i`
        <div style="${p}" class="${r.cssClasses}" slot="${r.slot??l}">
            ${r.children?.map(f=>w(t,f,a,s,o,n,d))}
        </div>
    `},ai=(e,t,r,a,s,o,n)=>fs("row",e,t,r,a,s,o,n),si=(e,t,r,a,s,o,n)=>fs("column",e,t,r,a,s,o,n),oi=(e,t,r,a,s,o,n)=>{const d=t.metadata;let p=`display: flex; flex-direction: ${d.orientation==="vertical"?"column":"row"}; gap: var(--lumo-space-s, 0.5rem);`;return d.fullWidth&&(p+=" width: 100%;"),p+=t.style??"",i`
    ...
    `},ii=(e,t,r,a,s,o,n)=>{const d=t.children&&t.children.length>1?t.children[1]:null,c=s?.detailComponent??null,p=!!s?.hasDetail||!!d,h=c??d;return i`
    ...
    `},ni=(e,t,r,a,s,o,n)=>{let d=t.style??"";t.metadata.fullWidth&&(d+=" width: 100%;");const c=Math.max(0,(t.children??[]).findIndex(p=>p.metadata.active));return i`
            ...
            ${t.children?.map((p,h)=>{const f=p,v=f.metadata.label,y=v?.includes("${")?e._evalTemplate(v):v;return i`
                    <details ?open="${h===c}" style="border-bottom: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1));">
                        ...
                        <div style="padding: var(--lumo-space-m, 1rem) 0;">
                            ${f.children?.map(C=>w(e,C,r,a,s,o,n))}
                        </div>
                    </details>
                `})}
        </div>
    `},li=(e,t,r,a,s,o,n)=>{const d=t.metadata;let c=t.style??"";return d.fullWidth&&(c+=" width: 100%;"),i`
        <div style="${c}" class="${t.cssClasses}" slot="${t.slot??l}">
            ${t.children?.map(p=>di(e,p,r,a,s,o,n,d.variant))}
        </div>
    `},di=(e,t,r,a,s,o,n,d)=>{const c=t.metadata,p=c.label?.includes("${")?e._evalTemplate(c.label):c.label;return i`
    ...
    `},bi=e=>{const t=e.metadata;return(t?.content??t?.columns??[]).filter(a=>a&&a.metadata).map(a=>{const s=a.metadata;return{id:a.id??"",label:s?.label??a.id??"",autoWidth:s?.autoWidth,width:s?.width}})},za=(e,t)=>{const r=e?.[t];return r==null?"":typeof r=="object"?r.text??r.label??r.value??"":String(r)},na=(e,t,r)=>{const a=bi(e),s="text-align:left; padding:.45rem .6rem; border-bottom:2px solid var(--lumo-contrast-20pct,rgba(0,0,0,.2)); font-weight:600; white-space:nowrap; color: var(--lumo-secondary-text-color,#556);",o="padding:.4rem .6rem; border-bottom:1px solid var(--lumo-contrast-10pct,rgba(0,0,0,.08)); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:24rem;";return i`
        <div style="overflow:auto; width:100%; ${e.style}" class="${e.cssClasses}" slot="${e.slot??l}">
            <table style="border-collapse:collapse; width:100%; font-size: var(--lumo-font-size-s,.875rem);">
                ...
                <tbody>
                    ${(t??[]).length===0?i`<tr><td colspan="${Math.max(1,a.length)}" style="padding:1.5rem; text-align:center; color: var(--lumo-secondary-text-color,#888);">${r??"No data."}</td></tr>`:t.map(n=>i`<tr>${a.map(d=>i`<td style="${o}" title="${za(n,d.id)}">${za(n,d.id)}</td>`)}</tr>`)}
                </tbody>
            </table>
        </div>
    `},Aa=(e,t)=>{const r=e.metadata;return e.id&&t&&t[e.id]?t[e.id]:r?.page?.content??[]},gi=e=>{const r=e.metadata.items??[];return i`
    ...
    `},vs=(e,t,r,a,s,o,n)=>t.separator?i`<span style="align-self: stretch; width: 1px; background: var(--lumo-contrast-20pct, rgba(0,0,0,.2));"></span>`:t.submenus?i`
            <details style="position: relative;">
                ...
                <div style="display: flex; flex-direction: column; gap: .1rem; padding: .3rem; min-width: 10rem;
                    ...
                    ${t.submenus.map(d=>vs(e,d,r,a,s,o,n))}
                </div>
            </details>
        `:i`
    ...
    `,yi=(e,t,r,a,s,o,n)=>{const d=t.metadata;return i`
        <div style="display: flex; flex-wrap: wrap; gap: .25rem; align-items: center; ${t.style}"
             class="${t.cssClasses}" slot="${t.slot??l}">
            ${d.options?.map(c=>vs(e,c,r,a,s,{},{}))}
        </div>
    `},$i=(e,t,r,a,s,o,n)=>{const d=t.metadata;return i`
        <div style="${t.style}" class="${t.cssClasses}" slot="${t.slot??l}">
            ${w(e,d.wrapped,r,a,s,o,n)}
        </div>
    `},xi=(e,t,r,a,s,o,n)=>{const d=t.metadata,c=d.content?.metadata,p=c?.type==m.Notice&&c.fullWidth===!0;return i`
        ...
        >
            ...
            `},wi=e=>{const t=e.metadata,r=a=>{const s=a.closest(".mateu-message-input")?.querySelector("input"),o=s?.value??"";!t.actionId||!o.trim()||(a.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,parameters:{message:o}},bubbles:!0,composed:!0})),s&&(s.value=""))};return i`
    ...
    `},ki=(e,t,r,a,s,o,n)=>{const d=t.metadata;return i`<span title="${d.text}" style="${t.style}" class="${t.cssClasses}" slot="${t.slot??l}"
        >${w(e,d.wrapped,r,a,s,o,n)}</span>`},_i=e=>{if(e instanceof CustomEvent)return e.detail;const t={};for(const r in e){const a=e[r];["number","string","boolean"].indexOf(typeof a)>=0&&(t[r]=e[r])}return t},Ra=(e,t,r)=>{for(let a in t.attributes)e.setAttribute(a,t.attributes[a]);r.style&&e.setAttribute("style",r.style),r.cssClasses&&e.setAttribute("class",r.cssClasses),r.slot&&e.setAttribute("slot",r.slot),t.content&&(t.html?e.innerHTML=t.content:e.append(t.content))},Ci=e=>{const t=e.name,r=e.attributes?e.attributes.import:void 0;r&&t.includes("-")&&!customElements.get(t)&&import(r)},Si=(e,t,r)=>{Ci(t);let a=t.name;return t.attributes&&t.attributes.id&&(a="#"+t.attributes.id),setTimeout(()=>{const s=e.shadowRoot?.querySelector(".element-container")?.querySelector(a);if(s){for(;s.firstChild;)s.removeChild(s.lastChild);Ra(s,t,r)}else{const o=document.createElement(t.name);Ra(o,t,r);for(let n in t.on)o.addEventListener(n,d=>{const c=_i(d);e.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.on[n],parameters:{event:c}},bubbles:!0,composed:!0}))});e.shadowRoot?.querySelector(".element-container")?.appendChild(o)}}),i`<div class="element-container"></div>`};var Le=(e=>(e.div="div",e.p="p",e.h1="h1",e.h2="h2",e.h3="h3",e.h4="h4",e.h5="h5",e.h6="h6",e.span="span",e))(Le||{});const Ei=(e,t,r,a,s)=>{const o=e.metadata,n=o.attributes?.["data-colspan"],d=sr(o.text,t,r,a,s),c={xl:"var(--lumo-font-size-xl, 1.375rem)",l:"var(--lumo-font-size-l, 1.125rem)",s:"var(--lumo-font-size-s, .875rem)",xs:"var(--lumo-font-size-xs, .8125rem)"},p=(o.size&&c[o.size]?`font-size: ${c[o.size]}; `:"")+(o.noMargins?"margin-block-start: 0; margin-block-end: 0; ":"");return Le.h1==o.container?i`
        ...
        `:Le.p==o.container?i`
            ...
            `:Le.div==o.container?i`
               <div style="${p}${e.style}" class="${e.cssClasses}"
                    id="${D(e.id)}"
                    data-colspan="${D(n)}"
                    slot="${e.slot??l}">${d?je(d):l}</div>
            `:Le.span==o.container?i`
            ...
            `},Ii=e=>{const t=e.metadata;return i`<a href="${t.url}" target="${t.target??l}"
                   rel="${t.target==="_blank"?"noopener":l}"
                   style="${e.style}" class="${e.cssClasses}"
                   slot="${e.slot??l}">${t.text}</a>`},Pi=(e,t)=>{const r=e.toLowerCase().split("+");return t.ctrlKey===r.includes("ctrl")&&t.altKey===r.includes("alt")&&t.shiftKey===r.includes("shift")&&t.metaKey===r.includes("meta")},Oi=(e,t)=>{if(!Pi(e,t))return!1;const r=e.toLowerCase().split("+"),a=r[r.length-1];return!!(t.key.toLowerCase()===a||/^[a-z]$/.test(a)&&t.code==="Key"+a.toUpperCase()||/^[0-9]$/.test(a)&&(t.code==="Digit"+a||t.code==="Numpad"+a))},Ti=e=>e?e.split("+").map(t=>t.length<=1?t.toUpperCase():t.charAt(0).toUpperCase()+t.slice(1)).join("+"):void 0,zi=(e,t)=>{const r=e.currentTarget.dataset.actionId;e.currentTarget?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:r,parameters:t.parameters},bubbles:!0,composed:!0}))},Ai="display:inline-flex; align-items:center; justify-content:center; gap:.4em; box-sizing:border-box; font:inherit; font-weight:500; cursor:pointer; border-radius:var(--lumo-border-radius-m,6px); border:1px solid transparent; line-height:1; white-space:nowrap;",Ri=e=>{const t=e.buttonStyle??"",r=e.color&&e.color!=="none"&&e.color!=="normal"?e.color:"",a=e.size,s=r==="success"?"var(--lumo-success-color,#1a7f37)":r==="error"?"var(--lumo-error-color,#c5221f)":r==="contrast"?"var(--lumo-contrast,#161513)":"var(--lumo-primary-color,#3b5bdb)",o=r==="success"?"var(--lumo-success-contrast-color,#fff)":r==="error"?"var(--lumo-error-contrast-color,#fff)":r==="contrast"?"var(--lumo-base-color,#fff)":"var(--lumo-primary-contrast-color,#fff)",n=r==="success"?"var(--lumo-success-text-color,#1a7f37)":r==="error"?"var(--lumo-error-text-color,#c5221f)":r==="contrast"?"var(--lumo-body-text-color,#161513)":"var(--lumo-primary-text-color,#3b5bdb)";let d;return t==="primary"?d=`background:${s}; color:${o};`:t==="tertiary"||t==="tertiaryInline"?d=`background:transparent; color:${n};`:d=`background:var(--lumo-contrast-5pct,rgba(0,0,0,.04)); color:${n}; border-color:var(--lumo-contrast-20pct,rgba(0,0,0,.16));`,`${Ai}${d}${a==="small"?"padding:.25rem .6rem; font-size:var(--lumo-font-size-s,.875rem);":a==="large"?"padding:.65rem 1.4rem; font-size:var(--lumo-font-size-l,1.125rem);":"padding:.45rem 1rem; font-size:var(--lumo-font-size-m,1rem);"}`},Di=(e,t,r)=>{const a=e.metadata,s=zt(a.label,t,r);return i`<button
            id="${e.id}"
            ...
            class="${e.cssClasses}"
            ?disabled="${a.disabled}"
            title="${a.shortcut?`${s} (${Ti(a.shortcut)})`:l}"
            slot="${e.slot??l}"
    >${a.iconOnLeft?H(a.iconOnLeft):l}${s}${a.iconOnRight?H(a.iconOnRight):l}</button>`},Li="display:block; box-sizing:border-box; background:var(--lumo-base-color,#fff); border:1px solid var(--lumo-contrast-10pct,rgba(0,0,0,.1)); border-radius:var(--lumo-border-radius-l,12px); box-shadow:var(--lumo-box-shadow-xs,0 1px 3px rgba(0,0,0,.08)); overflow:hidden;",ji=(e,t,r,a,s,o,n)=>{const d=t.metadata;if(!d)return i``;const c=h=>h?w(e,h,r,a,s,o,n,!1):l,p=d.header||d.headerPrefix||d.headerSuffix||d.title||d.subtitle;return i`
        <div style="${Li}${t.style}" class="${t.cssClasses}" slot="${t.slot??l}">
            ${d.media?c(d.media):l}
    ...
    `},Mi=e=>{const t=e.metadata;return H(t.icon,e.style,e.cssClasses,e.slot)},aa=(e,t)=>{e&&e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},bs="font:inherit; font-weight:500; cursor:pointer; padding:.45rem 1rem; border-radius:var(--lumo-border-radius-m,6px);",Da=`${bs} background:var(--lumo-contrast-5pct,rgba(0,0,0,.04)); color:var(--lumo-body-text-color,#161513); border:1px solid var(--lumo-contrast-20pct,rgba(0,0,0,.16));`,Ni=`${bs} background:var(--lumo-primary-color,#3b5bdb); color:var(--lumo-primary-contrast-color,#fff); border:1px solid transparent;`,Fi=(e,t,r,a,s,o,n)=>{const d=t.metadata;let c=!1;if(d.openedCondition)try{c=as(d.openedCondition,a,s,o,n)}catch(p){console.error("when evaluating "+d.openedCondition+" :"+p+", where data is "+s+" and state is "+a)}return c?i`
        <div class="mateu-confirm-dialog ${t.cssClasses??""}"
            ...
            <div style="background:var(--lumo-base-color,#fff); color:var(--lumo-body-text-color,#161513); border-radius:var(--lumo-border-radius-l,12px); box-shadow:var(--lumo-box-shadow-l,0 8px 24px rgba(0,0,0,.2)); width:100%; max-width:min(90vw,32rem); padding:1.5rem; box-sizing:border-box;">
                ...
                <div style="display:flex; gap:.5rem; justify-content:flex-end; margin-top:1.25rem;">
                    ${d.canCancel?i`<button style="${Da}" @click="${p=>aa(p.currentTarget,d.cancelActionId)}">${d.rejectText&&!d.canReject?d.rejectText:"Cancel"}</button>`:l}
                    ${d.canReject?i`<button style="${Da}" @click="${p=>aa(p.currentTarget,d.rejectActionId)}">${d.rejectText||"No"}</button>`:l}
                    <button style="${Ni}" @click="${p=>aa(p.currentTarget,d.confirmActionId)}">${d.confirmText||"OK"}</button>
                </div>
            </div>
        </div>
    `:i``},Bi=e=>{const t=e.metadata;let r;return t.position&&(r={Top:"top",Bottom:"bottom",TopLeft:"top-left",TopRight:"top-right",BottomLeft:"bottom-left",BottomRight:"bottom-right"}[t.position]),i`
    ...
    `},qi=(e,t,r,a,s,o,n)=>{const d=t.metadata;return i`
        <details
                ?open="${d.opened}"
                style="${t.style}"
                class="${t.cssClasses}"
        ...
        ></mateu-ux>
            ...
            `},Gi=e=>{const t=e.metadata;return i`
        <mateu-markdown .content=${t.markdown}
                        style="${e.style}" class="${e.cssClasses}"
                        slot="${e.slot??l}"></mateu-markdown>
            `},Ki=e=>{const t=e.metadata;return i`
        <div
            role="status"
            slot="${e.slot??l}"
            class="${e.cssClasses}"
    ...
    `},Yi=(e,t={})=>{const r=e.metadata,a=r.valueKey?t[r.valueKey]:r.value,s=r.max&&r.max!=0?r.max:1,o=!r.indeterminate&&a!=null;return i`
    ...
    `},tn=(e,t,r,a)=>{const s=e.metadata;return i`
        ...
        ${e.submenus?i`
                <details open>
                    ...
                    <div style="display:flex; flex-direction:column; gap:0.25rem; padding-left:0.5rem;">
                        ${e.submenus.map(t=>gs(t))}
                    </div>
                </details>
            `:i`
                <a href="${e.path}">${e.label}</a>
        `}
        `,rn=(e,t,r,a,s,o,n)=>{const d=t.metadata;return i`<div
                slot="${t.slot??l}"
                style="${t.style}" class="${t.cssClasses}"
        >${d.content?je(d.content):l}${t.children?.map(c=>w(e,c,r,a,s,o,n))}</div>
    `},an=(e,t,r,a,s,o,n)=>{const d=t.metadata,c=d.title?.includes("${")?e._evalTemplate(d.title):d.title;return i`<div
                slot="${t.slot??l}"
    ...
    `},sn=(e,t,r,a,s,o,n)=>{const d=t.metadata,c=d.title?.includes("${")?e._evalTemplate(d.title):d.title;return i`
        <div
                slot="${t.slot??l}"
                style="${t.style}" class="${t.cssClasses}"
        >
    ...
    `},on=(e,t,r)=>{r.dispatchEvent(new CustomEvent("value-changed",{detail:{fieldId:e,value:t},bubbles:!0,composed:!0}))},_r=e=>t=>{const r=t.target,a=r.type==="checkbox"?r.checked:r.value;on(e.fieldId,a,r)},nn=(e,t)=>{const r=e.metadata,a=t?.[r.fieldId]??"",s=r,o=s.dataType,n=s.stereotype,d=!!s.readOnly,c=!!s.disabled,p=s.options,h=r.label?i`<label style="display:block; font-size: var(--lumo-font-size-s,.875rem); color: var(--lumo-secondary-text-color,#667); margin-bottom:.15rem;">${r.label}</label>`:l,f="width:100%; box-sizing:border-box; padding:.4rem .6rem; border:1px solid var(--lumo-contrast-30pct,rgba(0,0,0,.3)); border-radius: var(--lumo-border-radius-m,6px); font:inherit; background: var(--lumo-base-color,#fff); color: var(--lumo-body-text-color,#1a1a1a);";let v;return d||n==="plainText"?v=i`<div style="padding:.4rem 0;">${String(a??"")}</div>`:o==="boolean"||n==="checkbox"||n==="badge"?v=i`<input type="checkbox" ?checked="${!!a}" ?disabled="${c}" @change="${_r(r)}">`:p&&p.length?v=i`
            <select style="${f}" ?disabled="${c}" @change="${_r(r)}">
                <option value="">—</option>
                ${p.map(y=>i`<option value="${y.value}" ?selected="${y.value===a}">${y.label}</option>`)}
            </select>`:n==="textarea"||n==="richText"||n==="html"?v=i`<textarea style="${f}" rows="3" ?disabled="${c}" @input="${_r(r)}">${String(a??"")}</textarea>`:v=i`<input type="${o==="integer"||o==="number"||o==="double"||o==="money"?"number":o==="date"?"date":o==="datetime"?"datetime-local":o==="time"?"time":n==="password"?"password":o==="email"?"email":"text"}" style="${f}" .value="${String(a??"")}"
                              placeholder="${s.placeholder??l}" ?disabled="${c}" @input="${_r(r)}">`,i`
        <div style="${e.style}" class="${e.cssClasses}" slot="${e.slot??l}">
            ${h}
            ${v}
        </div>
    `},la=(e,t,r,a,s,o,n,d)=>{const c=t.metadata,p=c?.fabs??[];return i`<mateu-page
            .component="${t}"
            baseUrl="${r}"
            .state="${a}"
            .data="${s}"
...
`)}
    ...
    `},da=(e,t,r,a,s,o,n,d)=>i`<mateu-table-crud
            id="${t.id}"
            baseUrl="${r}"
            .component="${t}"
            .metadata="${t.metadata}"
    ...
    >
        ${t.children?.map(c=>w(e,c,r,a,s,o,n))}
    </mateu-table-crud>`,ln=e=>{const t=e.metadata;return i`
        <mateu-bpmn
                style="${e.style}"
                class="${e.cssClasses}"
                slot="${e.slot??l}"
    ...
    `},dn=(e,t,r)=>{const a=e.metadata;return i`<mateu-chat sseUrl="${a.sseUrl}"
                            style="${e.style}" 
                            class="${e.cssClasses}" 
                            slot="${e.slot??l}"></mateu-chat>`},cn=e=>{const t=e.metadata;return i`
        <mateu-workflow
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ...
        ></mateu-workflow>
    `},un=e=>{const t=e.metadata;return i`
        <mateu-form-editor
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
    ...
    box-sizing: border-box;
`,pn=e=>e=="up"?"var(--lumo-success-text-color, #1a7f37)":e=="down"?"var(--lumo-error-text-color, #c5221f)":"var(--lumo-secondary-text-color, #666)",mn=e=>e=="up"?"▲":e=="down"?"▼":"",hn=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},fn=e=>{const t=e.metadata,r=!!t.actionId;return i`
        <div class="mateu-metric-card ${e.cssClasses??""}"
             style="${ys} display: flex; flex-direction: column; gap: .25rem; min-width: 11rem; flex: 1; ${r?"cursor: pointer;":""} ${e.style??""}"
             slot="${e.slot??l}"
             role="${r?"button":l}"
             @click="${a=>hn(a,t)}"
        >
            ...
            ${t.trend||t.trendLabel?i`
                <span style="font-size: var(--lumo-font-size-s, .875rem); color: ${pn(t.trend)};">
                    ${mn(t.trend)} ${t.trendLabel??l}
                </span>
            `:l}
    ...
    `,bn=(e,t,r,a,s,o,n)=>{const d=t.metadata,c=d.colSpan&&d.colSpan>1?`grid-column: span ${d.colSpan};`:"",p=d.rowSpan&&d.rowSpan>1?`grid-row: span ${d.rowSpan};`:"";return i`
        <div class="mateu-dashboard-panel ${t.cssClasses??""}"
             style="${ys} display: flex; flex-direction: column; gap: .5rem; min-width: 0; ${c} ${p} ${t.style??""}"
             slot="${t.slot??l}"
        >
            ${d.title?i`
                <div>
    ...
    `},gn=(e,t,r,a,s,o,n)=>{const d=t.metadata,c=d.columns&&d.columns>0?`repeat(${d.columns}, minmax(0, 1fr))`:"repeat(auto-fit, minmax(20rem, 1fr))";return i`
    ...
    `};var yn=Object.defineProperty,$n=Object.getOwnPropertyDescriptor,Xe=(e,t,r,a)=>{for(var s=a>1?void 0:a?$n(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&yn(t,r,s),s};let _e=class extends k{constructor(){super(...arguments),this.panels=[],this.headerTitle="",this.badges=[],this.orientation="vertical",this.navigation=null,this.overviewEditActionId="",this.openPanels=new Set,this.expandedPanel=null,this._onPopState=()=>{const e=decodeURIComponent((location.hash||"").replace(/^#/,""));if(e.startsWith("expand=")){const t=e.slice(7),r=this.panels.findIndex((a,s)=>this.panelAnchor(a,s)===t);this.expandedPanel=r>=0?r:null}else this.expandedPanel=null},this.initialized=!1}navAction(e){e&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e,parameters:{}},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._onPopState)}disconnectedCallback(){window.removeEventListener("popstate",this._onPopState),super.disconnectedCallback()}willUpdate(){if(!this.initialized&&this.panels.length){this.openPanels=new Set(this.panels.map((t,r)=>t.open?r:-1).filter(t=>t>=0));const e=decodeURIComponent((location.hash||"").replace(/^#/,""));if(e.startsWith("expand=")){const t=e.slice(7),r=this.panels.findIndex((a,s)=>this.panelAnchor(a,s)===t);r>=0&&(this.expandedPanel=r)}else if(e){const t=this.panels.findIndex((r,a)=>this.panelAnchor(r,a)===e);t>=0&&this.openPanels.add(t)}this.initialized=!0}}firstUpdated(){const e=decodeURIComponent((location.hash||"").replace(/^#/,""));if(!e)return;const t=this.renderRoot.querySelector(`[data-anchor="${CSS.escape(e)}"]`);t&&t.scrollIntoView({block:"nearest"})}panelAnchor(e,t){return(e.title??"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")||`panel-${t}`}bookmarkPanel(e){const t=this.panelAnchor(this.panels[e],e);try{history.replaceState(history.state,"","#"+t)}catch{}}clearBookmark(e){const t=this.panelAnchor(this.panels[e],e);if(decodeURIComponent((location.hash||"").replace(/^#/,""))===t)try{history.replaceState(history.state,"",location.pathname+location.search)}catch{}}expandPanel(e,t){t?.stopPropagation(),this.expandedPanel=e;const r=this.panelAnchor(this.panels[e],e);try{history.pushState(history.state,"","#expand="+r)}catch{}}collapsePanel(){try{history.back()}catch{this.expandedPanel=null}}toggle(e){const t=new Set(this.openPanels);t.has(e)?(t.delete(e),this.clearBookmark(e)):(t.add(e),this.bookmarkPanel(e)),this.openPanels=t}render(){if(this.expandedPanel!=null&&this.panels[this.expandedPanel]){const t=this.panels[this.expandedPanel];return i`
    ...
    `;Xe([u({type:Array})],_e.prototype,"panels",2);Xe([u({type:String})],_e.prototype,"headerTitle",2);Xe([u({type:Array})],_e.prototype,"badges",2);Xe([u({type:String,reflect:!0})],_e.prototype,"orientation",2);Xe([u({attribute:!1})],_e.prototype,"navigation",2);Xe([u({type:String})],_e.prototype,"overviewEditActionId",2);Xe([b()],_e.prototype,"openPanels",2);Xe([b()],_e.prototype,"expandedPanel",2);_e=Xe([$("mateu-foldout")],_e);const xn=(e,t,r,a,s,o,n)=>{const d=t.metadata;return i`
        <mateu-foldout
                .panels="${d.panels??[]}"
    ...
    `},wn=(e,t,r,a,s,o,n)=>{const d=t.metadata,c=!!d.image,p=c?`background-image: linear-gradient(rgba(0,0,0,.35), rgba(0,0,0,.35)), url('${d.image}'); background-size: cover; background-position: center; color: #fff;`:"",h=d.centered===!1?"flex-start":"center",f=d.centered===!1?"left":"center";return i`
    ...
    `};var kn=Object.defineProperty,_n=Object.getOwnPropertyDescriptor,ga=(e,t,r,a)=>{for(var s=a>1?void 0:a?_n(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&kn(t,r,s),s};const sa=1440*60*1e3;let ir=class extends k{constructor(){super(...arguments),this.tasks=[],this.onTaskSelectionActionId=""}selectTask(e){this.onTaskSelectionActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.onTaskSelectionActionId,parameters:{_clickedTaskId:e.id}},bubbles:!0,composed:!0}))}range(){const e=this.tasks.flatMap(t=>[t.start,t.end]).filter(t=>!!t).map(t=>new Date(t+"T00:00:00").getTime());return e.length?{min:Math.min(...e)-sa,max:Math.max(...e)+2*sa}:null}months(e,t){const r=[],a=new Date(e);for(a.setDate(1);a.getTime()<=t;){const s=Math.max(a.getTime(),e),o=new Date(a.getFullYear(),a.getMonth()+1,1),n=Math.min(o.getTime(),t);r.push({label:a.toLocaleDateString(void 0,{month:"short",year:"2-digit"}),from:s,to:n}),a.setMonth(a.getMonth()+1)}return r}render(){const e=this.range();if(!e)return i``;const t=e.max-e.min,r=s=>(s-e.min)/t*100,a=Date.now();return i`
            <div class="frame">
                ...
                ${this.tasks.map(s=>{const o=new Date(s.start+"T00:00:00").getTime(),n=new Date(s.end+"T00:00:00").getTime()+sa;return i`
    ...
    `;ga([u({type:Array})],ir.prototype,"tasks",2);ga([u()],ir.prototype,"onTaskSelectionActionId",2);ir=ga([$("mateu-gantt")],ir);const Cn=e=>{const t=e.metadata;return i`
        <mateu-gantt
                .tasks="${t.tasks??[]}"
    ...
    `};var Sn=Object.defineProperty,En=Object.getOwnPropertyDescriptor,ut=(e,t,r,a)=>{for(var s=a>1?void 0:a?En(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Sn(t,r,s),s};let R=class extends k{constructor(){super(...arguments),this.resources=[],this.blocks=[],this.drag=null,this.dragStartX=0,this.dragStartY=0,this.laneRects=[],this.onDragKeydown=e=>{e.key==="Escape"&&this.drag&&(e.stopPropagation(),this.endDrag())}}static parse(e){return new Date(e+"T00:00:00")}static iso(e){const t=r=>String(r).padStart(2,"0");return`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}`}static addDays(e,t){return new Date(e.getFullYear(),e.getMonth(),e.getDate()+t)}static daysBetween(e,t){return Math.round((t.getTime()-e.getTime())/864e5)}window(){if(this.from&&this.to){const a=R.parse(this.from),s=R.daysBetween(a,R.parse(this.to))+1;return s>0?{from:a,days:s}:null}const e=this.blocks.flatMap(a=>[a.start,a.end]).filter(a=>!!a).map(a=>R.parse(a));if(!e.length)return null;const t=new Date(Math.min(...e.map(a=>a.getTime()))),r=new Date(Math.max(...e.map(a=>a.getTime())));return{from:t,days:R.daysBetween(t,r)+1}}onBlockPointerDown(e,t,r){if(!this.moveActionId&&!this.selectActionId||(e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),this.dragStartX=e.clientX,this.dragStartY=e.clientY,!this.window()))return;const o=R.parse(t.start),n=R.parse(t.end),d=Math.max(1,R.daysBetween(o,n)+1);this.laneRects=[...this.renderRoot.querySelectorAll(".lane[data-resource-id]")].map(p=>({resourceId:p.dataset.resourceId,rect:p.getBoundingClientRect()}));const c=this.dayAt(t.resourceId,e.clientX)??r;this.drag={blockId:t.id,duration:d,grabOffsetDays:c-r,originResourceId:t.resourceId,originStartIdx:r,targetResourceId:t.resourceId,targetStartIdx:r,moved:!1},window.addEventListener("keydown",this.onDragKeydown)}dayAt(e,t){const r=this.laneRects.find(o=>o.resourceId===e),a=this.window();if(!r||!a||r.rect.width===0)return null;const s=Math.floor((t-r.rect.left)/r.rect.width*a.days);return Math.max(0,Math.min(a.days-1,s))}onBlockPointerMove(e){if(!this.drag||!this.drag.moved&&Math.abs(e.clientX-this.dragStartX)<4&&Math.abs(e.clientY-this.dragStartY)<4||!this.moveActionId)return;const t=this.window();if(!t)return;const r=this.laneRects.find(o=>e.clientY>=o.rect.top&&e.clientY<=o.rect.bottom)??this.laneRects.find(o=>o.resourceId===this.drag.targetResourceId);if(!r)return;const a=this.dayAt(r.resourceId,e.clientX);if(a==null)return;const s=Math.max(0,Math.min(t.days-this.drag.duration,a-this.drag.grabOffsetDays));this.drag={...this.drag,moved:!0,targetResourceId:r.resourceId,targetStartIdx:s}}onBlockPointerUp(e){const t=this.drag;if(this.endDrag(),!t)return;if(!t.moved){this.selectActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.selectActionId,parameters:{_blockId:e.id}},bubbles:!0,composed:!0}));return}if(!this.moveActionId||t.targetResourceId===t.originResourceId&&t.targetStartIdx===t.originStartIdx)return;const r=this.window();if(!r)return;const a=R.addDays(r.from,t.targetStartIdx),s=R.addDays(a,t.duration-1);this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.moveActionId,parameters:{_blockId:t.blockId,_resourceId:t.targetResourceId,_start:R.iso(a),_end:R.iso(s)}},bubbles:!0,composed:!0}))}endDrag(){this.drag=null,window.removeEventListener("keydown",this.onDragKeydown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onDragKeydown)}render(){const e=this.window();if(!e||!this.resources.length)return i``;const t=[...Array(e.days).keys()].map(d=>R.addDays(e.from,d)),r=new Date,a=R.daysBetween(e.from,new Date(r.getFullYear(),r.getMonth(),r.getDate())),s=a>=0&&a<e.days,o=[];let n;return this.resources.forEach(d=>{d.group&&d.group!==n&&o.push(i`<div class="group">${d.group}</div>`),n=d.group,o.push(this.renderRow(d,e,t,s?a:null))}),i`
        ...
        `}isWeekend(e){return e.getDay()===0||e.getDay()===6}renderRow(e,t,r,a){const s=100/t.days,o=this.blocks.filter(d=>d.resourceId===e.id&&d.start&&d.end),n=this.drag?.moved&&this.drag.targetResourceId===e.id?this.drag:null;return i`
            ...
            <div class="lane" data-resource-id="${e.id}">
                ...
                ${o.map(d=>{const c=R.daysBetween(t.from,R.parse(d.start)),p=R.daysBetween(t.from,R.parse(d.end));if(p<0||c>=t.days)return l;const h=Math.max(0,c),f=Math.min(t.days-1,p),v=this.drag?.moved&&this.drag.blockId===d.id;return i`
    ...
    `;ut([u({type:Array})],R.prototype,"resources",2);ut([u({type:Array})],R.prototype,"blocks",2);ut([u()],R.prototype,"from",2);ut([u()],R.prototype,"to",2);ut([u()],R.prototype,"moveActionId",2);ut([u()],R.prototype,"selectActionId",2);ut([b()],R.prototype,"drag",2);R=ut([$("mateu-planning-board")],R);const In=e=>{const t=e.metadata;return i`
        <mateu-planning-board
                ...
                slot="${e.slot??l}"
        ></mateu-planning-board>
    `};var Pn=Object.defineProperty,On=Object.getOwnPropertyDescriptor,$s=(e,t,r,a)=>{for(var s=a>1?void 0:a?On(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Pn(t,r,s),s};let Ir=class extends k{constructor(){super(...arguments),this.columns=[]}clickCard(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedCard:e}},bubbles:!0,composed:!0}))}render(){return i`
            <div class="board">
    ...
    `;$s([u({type:Array})],Ir.prototype,"columns",2);Ir=$s([$("mateu-kanban")],Ir);const Tn=e=>{const t=e.metadata;return i`
        <mateu-kanban
                .columns="${t.columns??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-kanban>
    `};var zn=Object.defineProperty,An=Object.getOwnPropertyDescriptor,xs=(e,t,r,a)=>{for(var s=a>1?void 0:a?An(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&zn(t,r,s),s};let Pr=class extends k{constructor(){super(...arguments),this.items=[]}clickItem(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedItem:e}},bubbles:!0,composed:!0}))}render(){return i`
            <div class="feed">
                ${this.items.map(e=>i`
    ...
    `;xs([u({type:Array})],Pr.prototype,"items",2);Pr=xs([$("mateu-timeline")],Pr);const Rn=e=>{const t=e.metadata;return i`
        <mateu-timeline
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-timeline>
    `};var Dn=Object.defineProperty,Ln=Object.getOwnPropertyDescriptor,ya=(e,t,r,a)=>{for(var s=a>1?void 0:a?Ln(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Dn(t,r,s),s};let nr=class extends k{constructor(){super(...arguments),this.steps=[],this.vertical=!1}render(){return i`
            <div class="steps">
    ...
    `;ya([u({type:Array})],nr.prototype,"steps",2);ya([u({type:Boolean,reflect:!0})],nr.prototype,"vertical",2);nr=ya([$("mateu-progress-steps")],nr);const jn=e=>{const t=e.metadata;return i`
        <mateu-progress-steps
                ...
                slot="${e.slot??l}"
        ></mateu-progress-steps>
    `};var Un=Object.defineProperty,Mn=Object.getOwnPropertyDescriptor,pt=(e,t,r,a)=>{for(var s=a>1?void 0:a?Mn(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Un(t,r,s),s};let Ue=class extends k{constructor(){super(...arguments),this.spark=[]}sparkline(){const e=this.spark;if(!e||e.length<2)return l;const t=84,r=30,a=2,s=Math.min(...e),n=Math.max(...e)-s||1,d=(t-a*2)/(e.length-1),c=e.map((v,y)=>{const C=a+y*d,g=a+(r-a*2)*(1-(v-s)/n);return[C,g]}),p=c.map(([v,y],C)=>`${C===0?"M":"L"}${v.toFixed(1)} ${y.toFixed(1)}`).join(" "),h=`${p} L${c[c.length-1][0].toFixed(1)} ${r} L${c[0][0].toFixed(1)} ${r} Z`,f=this.trend==="down"?"var(--lumo-error-color, #e11d48)":this.trend==="flat"?"var(--lumo-secondary-text-color, #888)":"var(--lumo-success-color, #12b76a)";return K`
    ...
    `;pt([u()],Ue.prototype,"label",2);pt([u()],Ue.prototype,"value",2);pt([u()],Ue.prototype,"unit",2);pt([u()],Ue.prototype,"delta",2);pt([u()],Ue.prototype,"trend",2);pt([u({type:Array})],Ue.prototype,"spark",2);pt([u()],Ue.prototype,"actionId",2);Ue=pt([$("mateu-stat")],Ue);const Nn=e=>{const t=e.metadata;return i`
        <mateu-stat
                label="${t.label??l}"
                value="${t.value??l}"
                unit="${t.unit??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-stat>
    `};var Fn=Object.defineProperty,Bn=Object.getOwnPropertyDescriptor,$a=(e,t,r,a)=>{for(var s=a>1?void 0:a?Bn(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Fn(t,r,s),s};let lr=class extends k{constructor(){super(...arguments),this.events=[]}clickEvent(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedEvent:e}},bubbles:!0,composed:!0}))}render(){const e=this.month?new Date(this.month+"T00:00:00"):new Date,t=e.getFullYear(),r=e.getMonth(),a=new Date(t,r,1),s=(a.getDay()+6)%7,o=new Date(t,r+1,0).getDate(),n=new Date,d=v=>n.getFullYear()===t&&n.getMonth()===r&&n.getDate()===v,c={};for(const v of this.events){if(!v.date)continue;const y=new Date(v.date+"T00:00:00");y.getFullYear()===t&&y.getMonth()===r&&(c[y.getDate()]??=[]).push(v)}const p=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],h=[];for(let v=0;v<s;v++)h.push(i`<div class="cell blank"></div>`);for(let v=1;v<=o;v++)h.push(i`
    ...
    `;$a([u()],lr.prototype,"month",2);$a([u({type:Array})],lr.prototype,"events",2);lr=$a([$("mateu-calendar")],lr);const qn=e=>{const t=e.metadata;return i`
        <mateu-calendar
                month="${t.month??l}"
                .events="${t.events??[]}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-calendar>
    `};var Hn=Object.defineProperty,Vn=Object.getOwnPropertyDescriptor,ws=(e,t,r,a)=>{for(var s=a>1?void 0:a?Vn(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Hn(t,r,s),s};let Or=class extends k{constructor(){super(...arguments),this.plans=[]}cta(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){return i`
            <div class="plans">
                ${this.plans.map(e=>i`
    ...
    `;ws([u({type:Array})],Or.prototype,"plans",2);Or=ws([$("mateu-pricing-table")],Or);const Wn=e=>{const t=e.metadata;return i`
        <mateu-pricing-table
                .plans="${t.plans??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-pricing-table>
    `};var Gn=Object.defineProperty,Kn=Object.getOwnPropertyDescriptor,ks=(e,t,r,a)=>{for(var s=a>1?void 0:a?Kn(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Gn(t,r,s),s};let Tr=class extends k{clickNode(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedNode:e}},bubbles:!0,composed:!0}))}renderNode(e){const t=e.avatar,r=t&&(t.startsWith("http")||t.startsWith("data:"));return i`
            <li>
        ...
        `}render(){return this.root?i`<div class="tree"><ul>${this.renderNode(this.root)}</ul></div>`:i``}};Tr.styles=x`
        :host {
            display: block;
            width: 100%;
            overflow-x: auto;
    ...
    `;ks([u({attribute:!1})],Tr.prototype,"root",2);Tr=ks([$("mateu-org-chart")],Tr);const Yn=e=>{const t=e.metadata;return i`
        <mateu-org-chart
                .root="${t.root}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-org-chart>
    `};var Jn=Object.defineProperty,Xn=Object.getOwnPropertyDescriptor,_s=(e,t,r,a)=>{for(var s=a>1?void 0:a?Xn(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Jn(t,r,s),s};const Qn=1440*60*1e3;let zr=class extends k{constructor(){super(...arguments),this.cells=[]}color(e,t){if(e<=0||t<=0)return"var(--lumo-contrast-10pct, #ebedf0)";const r=e/t,a=r>.75?1:r>.5?.75:r>.25?.5:.3;return`color-mix(in srgb, var(--lumo-primary-color, #1a73e8) ${Math.round(a*100)}%, transparent)`}render(){const e=this.cells.filter(c=>!!c.date);if(!e.length)return i``;const t=e.map(c=>new Date(c.date+"T00:00:00").getTime()),r=Math.min(...t),a=Math.max(...t),s=new Date(r);s.setDate(s.getDate()-(s.getDay()+6)%7);const o={};for(const c of e)o[c.date]=c;const n=Math.max(...e.map(c=>c.value??0),1),d=[];for(let c=s.getTime();c<=a;c+=Qn){const p=new Date(c),h=p.toISOString().slice(0,10),f=o[h],v=f?.value??0,y=(p.getDay()+6)%7+1,C=f?.label??`${h}: ${v}`;d.push(i`
    ...
    `;_s([u({type:Array})],zr.prototype,"cells",2);zr=_s([$("mateu-heatmap")],zr);const Zn=e=>{const t=e.metadata;return i`
        <mateu-heatmap
                .cells="${t.cells??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-heatmap>
    `};var el=Object.defineProperty,tl=Object.getOwnPropertyDescriptor,Cs=(e,t,r,a)=>{for(var s=a>1?void 0:a?tl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&el(t,r,s),s};let Ar=class extends k{constructor(){super(...arguments),this.stages=[]}render(){const e=this.stages;if(!e.length)return i``;const t=e[0].value??0,r=Math.max(...e.map(a=>a.value??0),1);return i`
            <div class="funnel">
    ...
    `;Cs([u({type:Array})],Ar.prototype,"stages",2);Ar=Cs([$("mateu-funnel")],Ar);const rl=e=>{const t=e.metadata;return i`
        <mateu-funnel
                .stages="${t.stages??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-funnel>
    `};var al=Object.defineProperty,sl=Object.getOwnPropertyDescriptor,Gt=(e,t,r,a)=>{for(var s=a>1?void 0:a?sl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&al(t,r,s),s};let it=class extends k{constructor(){super(...arguments),this.values=[],this.labels=[],this.area=!1}render(){const e=this.values;if(!e||e.length<2)return i``;const t=600,r=160,a=8,s=Math.min(...e),o=Math.max(...e),n=o-s||1,d=(t-a*2)/(e.length-1),c=e.map((C,g)=>{const I=a+g*d,j=a+(r-a*2)*(1-(C-s)/n);return[I,j]}),p=c.map(([C,g],I)=>`${I===0?"M":"L"}${C.toFixed(1)} ${g.toFixed(1)}`).join(" "),h=`${p} L${c[c.length-1][0].toFixed(1)} ${r-a} L${c[0][0].toFixed(1)} ${r-a} Z`,f=this.color||"var(--lumo-primary-color, #1a73e8)",v=e.indexOf(o),y=e.indexOf(s);return i`
            ...
            <svg viewBox="0 0 ${t} ${r}" preserveAspectRatio="none">
                ...
                ${c.map((C,g)=>g===v||g===y?K`<circle cx="${C[0]}" cy="${C[1]}" r="3.2" fill="${f}"><title>${this.labels[g]??""}: ${e[g]}</title></circle>`:K`<circle cx="${C[0]}" cy="${C[1]}" r="6" fill="transparent"><title>${this.labels[g]??""}: ${e[g]}</title></circle>`)}
            </svg>
    ...
    `;Gt([u()],it.prototype,"heading",2);Gt([u({type:Array})],it.prototype,"values",2);Gt([u({type:Array})],it.prototype,"labels",2);Gt([u()],it.prototype,"color",2);Gt([u({type:Boolean})],it.prototype,"area",2);it=Gt([$("mateu-trend-chart")],it);const ol=e=>{const t=e.metadata;return i`
        <mateu-trend-chart
                heading="${t.title??l}"
                color="${t.color??l}"
                ?area="${t.area??!1}"
                ...
                slot="${e.slot??l}"
        ></mateu-trend-chart>
    `};var il=Object.defineProperty,nl=Object.getOwnPropertyDescriptor,xa=(e,t,r,a)=>{for(var s=a>1?void 0:a?nl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&il(t,r,s),s};let dr=class extends k{constructor(){super(...arguments),this.features=[],this.columns=0}clickFeature(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){const e=this.columns&&this.columns>0?`repeat(${this.columns}, minmax(0, 1fr))`:"repeat(auto-fit, minmax(15rem, 1fr))";return i`
    ...
    `;xa([u({type:Array})],dr.prototype,"features",2);xa([u({type:Number})],dr.prototype,"columns",2);dr=xa([$("mateu-feature-grid")],dr);const ll=e=>{const t=e.metadata;return i`
        <mateu-feature-grid
                .features="${t.features??[]}"
                .columns="${t.columns??0}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-feature-grid>
    `};var dl=Object.defineProperty,cl=Object.getOwnPropertyDescriptor,Ss=(e,t,r,a)=>{for(var s=a>1?void 0:a?cl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&dl(t,r,s),s};let Rr=class extends k{constructor(){super(...arguments),this.items=[]}stars(e){const t=Math.max(0,Math.min(5,e||0));return"★".repeat(t)+"☆".repeat(5-t)}render(){return i`
            <div class="grid">
    ...
    `;Ss([u({type:Array})],Rr.prototype,"items",2);Rr=Ss([$("mateu-testimonials")],Rr);const ul=e=>{const t=e.metadata;return i`
        <mateu-testimonials
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-testimonials>
    `};var pl=Object.defineProperty,ml=Object.getOwnPropertyDescriptor,wa=(e,t,r,a)=>{for(var s=a>1?void 0:a?ml(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&pl(t,r,s),s};let cr=class extends k{constructor(){super(...arguments),this.items=[],this.openSet=new Set,this.seeded=!1}seed(){this.seeded||(this.seeded=!0,this.items.forEach((e,t)=>{e.open&&this.openSet.add(t)}))}toggle(e){this.openSet.has(e)?this.openSet.delete(e):this.openSet.add(e),this.requestUpdate()}render(){return this.seed(),i`
            <div class="list">
    ...
    `;wa([u({type:Array})],cr.prototype,"items",2);wa([b()],cr.prototype,"openSet",2);cr=wa([$("mateu-faq")],cr);const hl=e=>{const t=e.metadata;return i`
        <mateu-faq
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;Rt([u()],Je.prototype,"heading",2);Rt([u()],Je.prototype,"description",2);Rt([u()],Je.prototype,"icon",2);Rt([u()],Je.prototype,"ctaLabel",2);Rt([u()],Je.prototype,"actionId",2);Rt([u()],Je.prototype,"theme",2);Je=Rt([$("mateu-callout-card")],Je);const bl=e=>{const t=e.metadata;return i`
        <mateu-callout-card
                heading="${t.title??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-callout-card>
    `};var gl=Object.defineProperty,yl=Object.getOwnPropertyDescriptor,Es=(e,t,r,a)=>{for(var s=a>1?void 0:a?yl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&gl(t,r,s),s};let Dr=class extends k{constructor(){super(...arguments),this.comments=[]}renderComment(e){const t=e.avatar&&(e.avatar.startsWith("http")||e.avatar.startsWith("data:"));return i`
            <div class="comment">
        ...
        `}render(){return i`<div class="thread">${this.comments.map(e=>this.renderComment(e))}</div>`}};Dr.styles=x`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
    ...
    `;Es([u({type:Array})],Dr.prototype,"comments",2);Dr=Es([$("mateu-comment-thread")],Dr);const $l=e=>{const t=e.metadata;return i`
        <mateu-comment-thread
                ...
                slot="${e.slot??l}"
        ></mateu-comment-thread>
    `};var xl=Object.defineProperty,wl=Object.getOwnPropertyDescriptor,Is=(e,t,r,a)=>{for(var s=a>1?void 0:a?wl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&xl(t,r,s),s};const kl={pdf:"📕",image:"🖼️",img:"🖼️",doc:"📘",docx:"📘",word:"📘",xls:"📗",xlsx:"📗",excel:"📗",sheet:"📗",zip:"🗜️",archive:"🗜️",video:"🎬",audio:"🎵",code:"💻",csv:"📄",txt:"📄"};let Lr=class extends k{constructor(){super(...arguments),this.files=[]}icon(e){return e&&kl[e.toLowerCase()]||"📄"}clickFile(e,t){e.url||e.actionId&&(t.preventDefault(),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_file:e}},bubbles:!0,composed:!0})))}render(){return i`
            <div class="list">
    ...
    `;Is([u({type:Array})],Lr.prototype,"files",2);Lr=Is([$("mateu-file-list")],Lr);const _l=e=>{const t=e.metadata;return i`
        <mateu-file-list
                .files="${t.files??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;Kr([u()],Ft.prototype,"heading",2);Kr([u({type:Array})],Ft.prototype,"items",2);Kr([b()],Ft.prototype,"localDone",2);Ft=Kr([$("mateu-checklist")],Ft);const El=e=>{const t=e.metadata;return i`
        <mateu-checklist
                heading="${t.title??l}"
                .items="${t.items??[]}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-checklist>
    `};var Il=Object.defineProperty,Pl=Object.getOwnPropertyDescriptor,mt=(e,t,r,a)=>{for(var s=a>1?void 0:a?Pl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Il(t,r,s),s};let Me=class extends k{render(){const e=this.trend??"flat";return i`
            <div class="card">
                ${this.heading?i`<div class="title">${this.heading}</div>`:l}
                <div class="row">
                    <div class="side">
        ...
        @media (prefers-color-scheme: dark) { .card { background: var(--lumo-contrast-5pct, #2a2a2a); } }
    `;mt([u()],Me.prototype,"heading",2);mt([u()],Me.prototype,"leftLabel",2);mt([u()],Me.prototype,"leftValue",2);mt([u()],Me.prototype,"rightLabel",2);mt([u()],Me.prototype,"rightValue",2);mt([u()],Me.prototype,"delta",2);mt([u()],Me.prototype,"trend",2);Me=mt([$("mateu-comparison-card")],Me);const Ol=e=>{const t=e.metadata;return i`
...
`,Tl=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}),ca=e=>Tl.format(e),jr=(e,t)=>{const r=e<0?"-":"",a=ca(Math.abs(e));return t?`${r}${t} ${a}`:`${r}${a}`},zl=(e,t)=>t?`${ca(e)} ${t}`:ca(e);var Al=Object.defineProperty,Rl=Object.getOwnPropertyDescriptor,ht=(e,t,r,a)=>{for(var s=a>1?void 0:a?Rl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Al(t,r,s),s};let Ne=class extends k{constructor(){super(...arguments),this.title="",this.badges=[],this.facts=[]}render(){const e=!!(this.metricLabel||this.metricValue||this.metricCaption);return i`
            <div class="card">
                <div class="main">
                    <div class="title-row">
    ...
    `];ht([u()],Ne.prototype,"title",2);ht([u({type:Array})],Ne.prototype,"badges",2);ht([u()],Ne.prototype,"subtitle",2);ht([u({type:Array})],Ne.prototype,"facts",2);ht([u()],Ne.prototype,"metricLabel",2);ht([u()],Ne.prototype,"metricValue",2);ht([u()],Ne.prototype,"metricCaption",2);Ne=ht([$("mateu-entity-header")],Ne);const Dl=e=>{const t=e.metadata;return i`
        <mateu-entity-header
                .title="${t.title??""}"
                .badges="${t.badges??[]}"
                .subtitle="${t.subtitle}"
                ...
                slot="${e.slot??l}"
        ></mateu-entity-header>
    `};var Ll=Object.defineProperty,jl=Object.getOwnPropertyDescriptor,ft=(e,t,r,a)=>{for(var s=a>1?void 0:a?jl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Ll(t,r,s),s};let Fe=class extends k{constructor(){super(...arguments),this.value=0,this.max=0}fillColor(){return this.dangerAt!=null&&this.value>=this.dangerAt?"error":this.warnAt!=null&&this.value>=this.warnAt?"warning":this.warnAt!=null||this.dangerAt!=null?"success":"primary"}render(){const e=this.max>0?Math.min(Math.max(this.value/this.max,0),1):0,t=Math.round(e*100);return i`
            <div class="meter">
                ${this.label?i`<span class="label">${this.label}</span>`:l}
                <span class="value">${zl(this.value,this.unit)}</span>
                <div class="track">
    ...
    `;ft([u()],Fe.prototype,"label",2);ft([u({type:Number})],Fe.prototype,"value",2);ft([u({type:Number})],Fe.prototype,"max",2);ft([u()],Fe.prototype,"unit",2);ft([u()],Fe.prototype,"caption",2);ft([u({type:Number})],Fe.prototype,"warnAt",2);ft([u({type:Number})],Fe.prototype,"dangerAt",2);Fe=ft([$("mateu-meter")],Fe);const Ul=e=>{const t=e.metadata;return i`
        <mateu-meter
                .label="${t.label}"
                .value="${t.value??0}"
                .max="${t.max??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-meter>
    `};var Ml=Object.defineProperty,Nl=Object.getOwnPropertyDescriptor,Kt=(e,t,r,a)=>{for(var s=a>1?void 0:a?Nl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Ml(t,r,s),s};let nt=class extends k{constructor(){super(...arguments),this.total=0,this.done=0}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){const e=this.total>0&&this.done>=this.total,t=!e&&!!this.actionLabel&&!!this.actionId;return i`
    ...
    `;Kt([u()],nt.prototype,"label",2);Kt([u({type:Number})],nt.prototype,"total",2);Kt([u({type:Number})],nt.prototype,"done",2);Kt([u()],nt.prototype,"actionLabel",2);Kt([u()],nt.prototype,"actionId",2);nt=Kt([$("mateu-task-progress")],nt);const Fl=e=>{const t=e.metadata;return i`
        <mateu-task-progress
                .label="${t.label}"
                .total="${t.total??0}"
                .done="${t.done??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-task-progress>
    `};var Bl=Object.defineProperty,ql=Object.getOwnPropertyDescriptor,gr=(e,t,r,a)=>{for(var s=a>1?void 0:a?ql(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Bl(t,r,s),s};let _t=class extends k{constructor(){super(...arguments),this.items=[],this.compact=!1,this.frameless=!1}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}rowClicked(e){this.rowActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.rowActionId,parameters:{_item:e.id}},bubbles:!0,composed:!0}))}render(){return i`
    ...
    `];gr([u({type:Array})],_t.prototype,"items",2);gr([u({type:Boolean})],_t.prototype,"compact",2);gr([u({type:Boolean})],_t.prototype,"frameless",2);gr([u()],_t.prototype,"rowActionId",2);_t=gr([$("mateu-status-list")],_t);const Hl=e=>{const t=e.metadata;return i`
        <mateu-status-list
                .items="${t.items??[]}"
                ?compact="${t.compact??!1}"
                ...
                slot="${e.slot??l}"
        ></mateu-status-list>
    `};var Vl=Object.defineProperty,Wl=Object.getOwnPropertyDescriptor,Ps=(e,t,r,a)=>{for(var s=a>1?void 0:a?Wl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Vl(t,r,s),s};let Ur=class extends k{constructor(){super(...arguments),this.items=[]}render(){return i`
            <ul>
    ...
    `;Ps([u({type:Array})],Ur.prototype,"items",2);Ur=Ps([$("mateu-bulleted-list")],Ur);const Gl=e=>{const t=e.metadata;return i`
        <mateu-bulleted-list
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-bulleted-list>
    `},Kl=e=>{const r=e.metadata.attributes?.["data-colspan"];return i`
        <hr style="border: none; border-top: 1px solid var(--lumo-contrast-10pct, rgba(0,0,0,.1)); width: 100%; margin: var(--lumo-space-s, .5rem) 0; ${e.style??""}"
            ...
            data-colspan="${D(r)}"
            slot="${e.slot??l}"/>
    `};var Yl=Object.defineProperty,Jl=Object.getOwnPropertyDescriptor,be=(e,t,r,a)=>{for(var s=a>1?void 0:a?Jl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Yl(t,r,s),s};const Xl={info:"ℹ",success:"✓",warning:"!",danger:"!"};let ae=class extends k{constructor(){super(...arguments),this.text="",this.theme="info",this.noIcon=!1,this.slim=!1,this.fullWidth=!1,this.hasContent=!1,this.inlineContent=!1}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId},bubbles:!0,composed:!0}))}render(){const e=!!this.text&&!!this.text.trim();if(!e&&!this.hasContent)return i``;const t=["info","success","warning","danger"].includes(this.theme)?this.theme:"info";return i`
            <div class="notice ${t} ${this.slim?"slim":""}">
                ${this.noIcon?l:i`<span class="icon ${this.icon?"custom":""}">${this.icon||Xl[t]}</span>`}
    ...
    `};var Zl=Object.defineProperty,ed=Object.getOwnPropertyDescriptor,Jr=(e,t,r,a)=>{for(var s=a>1?void 0:a?ed(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Zl(t,r,s),s};let Bt=class extends k{constructor(){super(...arguments),this.groups=[]}willUpdate(e){e.has("groups")&&(this.selectedId=this.groups.flatMap(t=>t.items??[]).find(t=>t.selected)?.id)}select(e){this.selectedId=e,this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{_item:e}},bubbles:!0,composed:!0}))}render(){return i`
            <div class="rail">
                ${this.groups.map(e=>i`
                    <div class="group">
    ...
    `];Jr([u()],Bt.prototype,"actionId",2);Jr([u({type:Array})],Bt.prototype,"groups",2);Jr([b()],Bt.prototype,"selectedId",2);Bt=Jr([$("mateu-task-queue")],Bt);const td=e=>{const t=e.metadata;return i`
        <mateu-task-queue
                .actionId="${t.actionId}"
                .groups="${t.groups??[]}"
                style="${e.style??l}"
    ...
    `];Yt([u()],lt.prototype,"actionId",2);Yt([u({type:Number})],lt.prototype,"columns",2);Yt([u()],lt.prototype,"recommendedLabel",2);Yt([u({type:Array})],lt.prototype,"items",2);Yt([b()],lt.prototype,"selectedId",2);lt=Yt([$("mateu-resource-grid")],lt);const sd=e=>{const t=e.metadata;return i`
        <mateu-resource-grid
                .actionId="${t.actionId}"
                .columns="${t.columns??0}"
                ...
                slot="${e.slot??l}"
        ></mateu-resource-grid>
    `};var od=Object.defineProperty,id=Object.getOwnPropertyDescriptor,de=(e,t,r,a)=>{for(var s=a>1?void 0:a?id(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&od(t,r,s),s};let J=class extends k{constructor(){super(...arguments),this.title="",this.features=[],this.current=!1,this.added=!1}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return i`
                ...
                ${this.items.map(e=>{const t=e.id!=null&&this.added.has(e.id);return i`
                        <div class="card ${t?"added":""}">
                            ...
                            ${e.includedLabel?i`<span class="included">${e.includedLabel}</span>`:i`
                                    ${e.price!=null?i`
                                        <span class="price">${jr(e.price,this.currency)}${e.unit?` / ${e.unit}`:""}</span>
                                    `:l}
    ...
    `;Jt([u()],dt.prototype,"totalLabel",2);Jt([u()],dt.prototype,"currency",2);Jt([u()],dt.prototype,"actionId",2);Jt([u({type:Array})],dt.prototype,"items",2);Jt([b()],dt.prototype,"added",2);dt=Jt([$("mateu-addon-picker")],dt);const cd=e=>{const t=e.metadata;return i`
        <mateu-addon-picker
                ...
                slot="${e.slot??l}"
        ></mateu-addon-picker>
    `};var ud=Object.defineProperty,pd=Object.getOwnPropertyDescriptor,yr=(e,t,r,a)=>{for(var s=a>1?void 0:a?pd(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&ud(t,r,s),s};let Ct=class extends k{constructor(){super(...arguments),this.lines=[]}computedTotal(){return this.total!=null?this.total:this.lines.filter(e=>!e.included).reduce((e,t)=>e+(t.amount??0),0)}render(){return i`
            ${this.lines.map(e=>i`
                <div class="row">
                    <span class="dot"></span>
                    <span class="concept">${e.concept}</span>
                    ${e.included?i`<span class="included-label">${e.includedLabel||"Included"}</span>`:i`<span class="amount ${(e.amount??0)<0?"negative":""}">${jr(e.amount??0,this.currency)}</span>`}
                </div>
            `)}
            <div class="total-row">
                <span class="total-label">${this.totalLabel||"Total"}</span>
                <span class="total">${jr(this.computedTotal(),this.currency)}</span>
            </div>
        `}};Ct.styles=x`
        :host {
    ...
    `;yr([u()],Ct.prototype,"currency",2);yr([u()],Ct.prototype,"totalLabel",2);yr([u({type:Array})],Ct.prototype,"lines",2);yr([u({type:Number})],Ct.prototype,"total",2);Ct=yr([$("mateu-ledger")],Ct);const md=e=>{const t=e.metadata;return i`
        <mateu-ledger
                .currency="${t.currency}"
                .totalLabel="${t.totalLabel}"
                .lines="${t.lines??[]}"
    ...
    `;Qe([u()],Ce.prototype,"actionId",2);Qe([u()],Ce.prototype,"methodActionId",2);Qe([u({type:Array})],Ce.prototype,"methods",2);Qe([u()],Ce.prototype,"selected",2);Qe([u()],Ce.prototype,"contextLabel",2);Qe([u()],Ce.prototype,"contextValue",2);Qe([u()],Ce.prototype,"confirmLabel",2);Qe([b()],Ce.prototype,"selectedId",2);Ce=Qe([$("mateu-payment-picker")],Ce);const vd=e=>{const t=e.metadata;return i`
        <mateu-payment-picker
                ...
                slot="${e.slot??l}"
        ></mateu-payment-picker>
    `};var bd=Object.defineProperty,gd=Object.getOwnPropertyDescriptor,Os=(e,t,r,a)=>{for(var s=a>1?void 0:a?gd(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&bd(t,r,s),s};let Mr=class extends k{constructor(){super(...arguments),this.items=[]}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return i`
            <div class="list">
                ${this.items.map(e=>i`
                    <div class="row">
    ...
    `;Os([u({type:Array})],Mr.prototype,"items",2);Mr=Os([$("mateu-process-monitor")],Mr);const yd=e=>{const t=e.metadata;return i`
        <mateu-process-monitor
                ...
                slot="${e.slot??l}"
        ></mateu-process-monitor>
    `},$d=(e,t)=>{let r=e.style;return e.id&&(r&&!r.endsWith(";")&&(r+=";"),r==null&&(r=""),t[e.id+".hidden"]==!0&&(r+="display: none;")),r},xd=(e,t)=>{let r={...e.metadata};if(e.id&&r){if(r.type==m.Button){const a=r;t[e.id+".disabled"]==!0&&(a.disabled=!0)}if(r.type==m.FormField){const a=r;t[e.id+".disabled"]==!0&&(a.disabled=!0)}}return r},O=e=>t=>e(t.container,t.component,t.baseUrl,t.state,t.data,t.appState,t.appData),wd={[m.Bpmn]:({component:e})=>ln(e),[m.Workflow]:({component:e})=>cn(e),[m.FormEditor]:({component:e})=>un(e),[m.Page]:O(la),[m.Div]:O(rn),[m.Directory]:({component:e,baseUrl:t,state:r,data:a})=>tn(e),[m.FormLayout]:O(ms),[m.HorizontalLayout]:O(ai),[m.VerticalLayout]:O(si),[m.SplitLayout]:O(oi),[m.MasterDetailLayout]:O(ii),[m.TabLayout]:O(ni),[m.AccordionLayout]:O(li),[m.BoardLayout]:O(mi),[m.BoardLayoutRow]:O(hi),[m.BoardLayoutItem]:O(fi),[m.Scroller]:O(ci),[m.FullWidth]:O(ui),[m.Container]:O(pi),[m.Form]:({container:e,component:t,baseUrl:r,state:a,data:s,appState:o,appData:n})=>{const d=t.metadata;return i`<mateu-form
            id="${t.id}"
        baseUrl="${r}"
            .component="${t}"
            .values="${a}"
...
`)}
            ...
            </mateu-form>`},[m.Table]:({component:e,state:t,data:r})=>na(e,(e.id?r?.[e.id]:void 0)?.page?.content??Aa(e,t)),[m.Crud]:O(da),[m.App]:({container:e,component:t,baseUrl:r,state:a,data:s,appState:o,appData:n})=>i`
            <mateu-app
                        id="${t.id}"
                        baseUrl="${r}"
                        .component="${t}"
            ...
            >
             ${t.children?.map(d=>w(e,d,r,a,s,o,n))}
         </mateu-app>`,[m.Element]:({container:e,component:t})=>Si(e,t.metadata,t),[m.FormField]:({component:e,state:t})=>nn(e,t),[m.Text]:({component:e,state:t,data:r,appState:a,appData:s})=>Ei(e,t,r,a,s),[m.Avatar]:({component:e,state:t,data:r})=>So(e,t,r),[m.Chat]:({component:e,state:t,data:r})=>dn(e),[m.AvatarGroup]:({component:e})=>Eo(e),[m.Badge]:({component:e,state:t,data:r})=>Io(e,t,r),[m.Breadcrumbs]:({component:e})=>Zi(e),[m.Anchor]:({component:e})=>Ii(e),[m.Button]:({component:e,state:t,data:r})=>Di(e,t,r),[m.Card]:O(ji),[m.Chart]:({component:e})=>Ui(e),[m.Icon]:({component:e})=>Mi(e),[m.ConfirmDialog]:O(Fi),[m.ContextMenu]:O($i),[m.CookieConsent]:({component:e})=>Bi(e),[m.Details]:O(qi),[m.Dialog]:({component:e,baseUrl:t,state:r,data:a,appState:s,appData:o})=>Hi(e,t,r,a,s,o),[m.Drawer]:({component:e,baseUrl:t,state:r,data:a,appState:s,appData:o})=>Vi(e,t,r,a,s,o),[m.Image]:({component:e})=>Qi(e),[m.Map]:({component:e})=>Xi(e),[m.Markdown]:({component:e})=>Gi(e),[m.MicroFrontend]:({component:e})=>Wi(e),[m.Notification]:({component:e})=>Ki(e),[m.ProgressBar]:({component:e,state:t})=>Yi(e,t),[m.Popover]:O(Ji),[m.CarouselLayout]:O(en),[m.Tooltip]:O(ki),[m.MessageInput]:({component:e})=>wi(e),[m.MessageList]:({component:e})=>gi(e),[m.CustomField]:O(xi),[m.MenuBar]:({container:e,component:t,baseUrl:r,state:a,data:s})=>yi(e,t,r,a,s),[m.Grid]:({component:e,state:t})=>na(e,Aa(e,t)),[m.VirtualList]:O(vi),[m.FormSection]:O(an),[m.FormSubSection]:O(sn),[m.MetricCard]:({component:e})=>fn(e),[m.Scoreboard]:O(vn),[m.DashboardPanel]:O(bn),[m.DashboardLayout]:O(gn),[m.FoldoutLayout]:O(xn),[m.HeroSection]:O(wn),[m.EmptyState]:({component:e})=>No(e),[m.Skeleton]:({component:e})=>Fo(e),[m.Gantt]:({component:e})=>Cn(e),[m.PlanningBoard]:({component:e})=>In(e),[m.Kanban]:({component:e})=>Tn(e),[m.Timeline]:({component:e})=>Rn(e),[m.ProgressSteps]:({component:e})=>jn(e),[m.Stat]:({component:e})=>Nn(e),[m.Calendar]:({component:e})=>qn(e),[m.PricingTable]:({component:e})=>Wn(e),[m.OrgChart]:({component:e})=>Yn(e),[m.Heatmap]:({component:e})=>Zn(e),[m.Funnel]:({component:e})=>rl(e),[m.TrendChart]:({component:e})=>ol(e),[m.FeatureGrid]:({component:e})=>ll(e),[m.Testimonials]:({component:e})=>ul(e),[m.Faq]:({component:e})=>hl(e),[m.CalloutCard]:({component:e})=>bl(e),[m.CommentThread]:({component:e})=>$l(e),[m.FileList]:({component:e})=>_l(e),[m.Checklist]:({component:e})=>El(e),[m.ComparisonCard]:({component:e})=>Ol(e),[m.EntityHeader]:({component:e})=>Dl(e),[m.Meter]:({component:e})=>Ul(e),[m.TaskProgress]:({component:e})=>Fl(e),[m.StatusList]:({component:e})=>Hl(e),[m.BulletedList]:({component:e})=>Gl(e),[m.Separator]:({component:e})=>Kl(e),[m.Notice]:O(Ql),[m.TaskQueue]:({component:e})=>td(e),[m.ResourceGrid]:({component:e})=>sd(e),[m.OfferCard]:({component:e})=>nd(e),[m.AddOnPicker]:({component:e})=>cd(e),[m.Ledger]:({component:e})=>md(e),[m.PaymentPicker]:({component:e})=>vd(e),[m.ProcessMonitor]:({component:e})=>yd(e)},ka=(e,t,r,a,s,o,n,d)=>{if(!t?.metadata)return t==null?(console.warn("No metadata for component",t),i`<p>No metadata for component</p>`):ka(e,{id:ke(),metadata:t,type:Y.ClientSide},r,a,s,o,n,d);const c=t.metadata.type,p={...t,style:$d(t,s),metadata:xd(t,s)},h=wd[c];return h?h({container:e,component:p,baseUrl:r,state:a,data:s,appState:o,appData:n,labelAlreadyRendered:d}):i`<p ${p?.slot??l}>Unknown metadata type ${c} for component ${p?.id}</p>`};var rr=(e=>(e.NONE="NONE",e.INFO="INFO",e.SUCCESS="SUCCESS",e.WARNING="WARNING",e.DANGER="DANGER",e))(rr||{});const Ts=e=>{switch(e){case rr.SUCCESS:return"success";case rr.WARNING:return"warning";case rr.DANGER:return"error";case rr.NONE:return"contrast"}return""};var kd=Object.defineProperty,_d=Object.getOwnPropertyDescriptor,ge=(e,t,r,a)=>{for(var s=a>1?void 0:a?_d(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&kd(t,r,s),s};let se=class extends k{constructor(){super(...arguments),this.id="",this.baseUrl="",this.state={},this.data={},this.appState={},this.appData={},this.respondToVisibility=(e,t)=>{var r={root:document.documentElement},a=new IntersectionObserver(s=>{s.forEach(o=>{t(o.intersectionRatio>0)})},r);a.observe(e)},this.keepAsking=!1,this.askToUpper=()=>{const e=this.data[this.id]?.page,t=e?.content?.length/e?.pageSize;this.dispatchEvent(new CustomEvent("fetch-more-elements",{detail:{params:{page:t,pageSize:this.metadata?.pageSize},callback:()=>{this.keepAsking&&this.askToUpper()}},bubbles:!0,composed:!0}))},this.renderItem=e=>e.card?ka(this,e.card,this.baseUrl,this.state,this.data,this.appState,this.appData,!1):e.title?i`<div class="neutral-card">
                ${e.image?i`<img class="card-media" src="${e.image}" alt="" />`:l}
                <div class="card-body">
                    <div class="card-head">
                        ${e.title?i`<span class="card-title">${e.title}</span>`:l}
                        ${e.status?i`<span theme="badge ${Ts(e.status.type)}">${e.status.message}</span>`:l}
                    </div>
    ...
    `;ge([u()],se.prototype,"id",2);ge([u()],se.prototype,"metadata",2);ge([u()],se.prototype,"baseUrl",2);ge([u()],se.prototype,"state",2);ge([u()],se.prototype,"data",2);ge([u()],se.prototype,"appState",2);ge([u()],se.prototype,"appData",2);ge([u()],se.prototype,"emptyStateMessage",2);ge([b()],se.prototype,"keepAsking",2);ge([Ie("#ask-for-more")],se.prototype,"askForMore",2);ge([b()],se.prototype,"hasMore",2);se=ge([$("mateu-card-list")],se);const Cd={show:e=>console.debug("[mateu] no notifier registered, dropping toast:",e.text)};let zs=Cd;function Sd(e){zs=e}function St(e,t){zs.show(e,t)}var As=(e=>(e.none="none",e.success="success",e.error="error",e.warning="warning",e.contrast="contrast",e.normal="normal",e))(As||{}),Rs=(e=>(e.primary="primary",e.secondary="secondary",e.tertiary="tertiary",e.tertiaryInline="tertiaryInline",e))(Rs||{});const Ed=76;function La(e){if(e.weight!=null)return e.weight;const t=e.stereotype??"";if(t==="icon")return 1;if(t==="image")return 4;if(t==="html"||t==="richText"||t==="markdown"||t==="textarea")return 5;if(t==="link")return 2.5;if(t==="combobox"||t==="select")return 2;const r=e.dataType??"";return r==="bool"?1:r==="status"||r==="integer"?1.5:r==="number"||r==="date"||r==="money"?2:r==="dateTime"||r==="dateRange"?2.5:3}function Id(e,t){if(e.length===0)return"table";const r=e.reduce((c,p)=>c+La(p),0),a=t/Ed,s=r/a;if(s<=1)return"table";if(s>1.6||e.length>10)return"masterDetail";const o=e.filter(c=>c.identifier||(c.priority??Number.MAX_SAFE_INTEGER)<=2),n=o.reduce((c,p)=>c+La(p),0);return o.length>0&&n<=8?"list":e.some(c=>c.stereotype==="image"||c.stereotype==="html")||o.length===0&&e.length>=4&&e.length<=8?"cards":"masterDetail"}function Ds(e){return e.filter(t=>t.identifier||(t.priority??Number.MAX_SAFE_INTEGER)<=2).sort((t,r)=>(t.priority??Number.MAX_SAFE_INTEGER)-(r.priority??Number.MAX_SAFE_INTEGER))}function Pd(e){const t=Ds(e);return t.length>0?t:e.slice(0,3)}var Od=Object.defineProperty,Td=Object.getOwnPropertyDescriptor,ye=(e,t,r,a)=>{for(var s=a>1?void 0:a?Td(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Od(t,r,s),s};const zd={asc:"ascending",desc:"descending"};let oe=class extends k{constructor(){super(...arguments),this.component=void 0,this.standalone=!1,this.state={},this.data={},this.appState={},this.appData={},this.showImportDialog=!1,this.availableWidthPx=1024,this.selectedItem=null,this._columnPrefsRevision=0,this._prefsRevisionApplied=-1,this.search=()=>{const e=this.component.metadata;this.state={...this.state,size:e.pageSize,page:0,crud_selected_items:[]},this._syncStateToUrl(e),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}}},bubbles:!0,composed:!0}))},this.notify=e=>{St({text:e,position:"bottomEnd",variant:"error",duration:3e3},this)},this.handleSearchRequested=e=>{this.state={...this.state,crud_selected_items:[]};const t=this.component.metadata;this._syncStateToUrl(t),!t.infiniteScrolling&&this.data?.[this.id]?.page&&(this.data[this.id].page.content=[]),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"search",parameters:{crudId:this.id,_searchState:{...this.state}},callback:e},bubbles:!0,composed:!0}))},this.fetchMoreElements=e=>{const{params:t,callback:r}=e.detail;this.state={...this.state,size:t.pageSize,page:t.page},this.handleSearchRequested(r)},this.directionChanged=e=>{const t=e.detail.grid._sorters;this.state={...this.state,sort:t.map(r=>({fieldId:r.__data.path,direction:r.__data.direction?zd[r.__data.direction]:void 0}))},this.handleSearchRequested(void 0)},this._initializedForComponentId=void 0,this.evalLabel=e=>zt(e,this.state,this.data),this.handleToolbarButtonClick=e=>{if(e==="import"){this.showImportDialog=!0;return}this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e},bubbles:!0,composed:!0}))},this.handleImportUploadSuccess=e=>{const t=e.detail.xhr.responseText;this.showImportDialog=!1,this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"process-import",parameters:{fileId:t}},bubbles:!0,composed:!0}))}}get columnPrefsScope(){return window.location.pathname}get effectiveComponent(){const e=this.component,t=e?.metadata;if(!e||!t?.columns)return e;if(this._prefsSource===e&&this._prefsRevisionApplied===this._columnPrefsRevision)return this._prefsApplied;const r=cs(this.columnPrefsScope),a=ps(t.columns,r,s=>s.metadata??{});return this._prefsApplied=a===t.columns?e:{...e,metadata:{...t,columns:a}},this._prefsSource=e,this._prefsRevisionApplied=this._columnPrefsRevision,this._prefsApplied}get columnChooserEntries(){return(this.component?.metadata?.columns??[]).map(t=>{const r=t.metadata??{},a=r.id??t.id;return a?{id:a,label:r.label??a,protected:us(r)}:void 0}).filter(t=>!!t)}renderColumnChooser(){const e=this.columnChooserEntries;return e.filter(t=>!t.protected).length===0?l:i`
            <mateu-column-chooser
                .columns="${e}"
                .scope="${this.columnPrefsScope}"
                @column-prefs-changed="${t=>{t.stopPropagation(),this._columnPrefsRevision++}}"
            ></mateu-column-chooser>
        `}get cols(){return this.effectiveComponent?.metadata?.columns?.map(t=>t.metadata)??[]}get identifierFieldName(){const e=this.cols.find(t=>t.identifier);return e?e.id:this.cols.find(t=>t.id==="id")?.id}get effectiveGridLayout(){const e=this.component?.metadata,t=e?.gridLayout??"auto";return t==="auto"?e?.crudlType==="card"?"cards":Id(this.cols,this.availableWidthPx):t}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{const t=e[0]?.contentRect.width;t&&Math.abs(t-this.availableWidthPx)>10&&(this.availableWidthPx=t)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}_filterIds(e){return new Set(["searchText",...(e.filters??[]).flatMap(t=>t.stereotype==="dateRange"||t.stereotype==="numberRange"?[`${t.fieldId}_from`,`${t.fieldId}_to`]:[t.fieldId])])}_syncStateToUrl(e){const t=this._filterIds(e),r=new URLSearchParams(window.location.search);t.forEach(d=>r.delete(d)),r.delete("page"),r.delete("sort"),t.forEach(d=>{const c=this.state[d];c!=null&&c!==""&&r.set(d,String(c))});const a=this.state.page;a&&a>0&&r.set("page",String(a));const s=this.state.sort;if(s&&s.length>0){const d=s.filter(c=>c.fieldId&&c.direction).map(c=>`${c.fieldId}:${c.direction}`).join(",");d&&r.set("sort",d)}const o=r.toString(),n=o?`${window.location.pathname}?${o}`:window.location.pathname;window.location.pathname+window.location.search!==n&&history.replaceState(null,"",n)}_initStateFromUrl(e,t){const r=new URLSearchParams(window.location.search),a=this._filterIds(e),s={...t};r.forEach((d,c)=>{a.has(c)&&(s[c]=d)});const o=r.get("page");if(o!==null){const d=parseInt(o,10);!isNaN(d)&&d>0&&(s.page=d)}const n=r.get("sort");if(n){const d=n.split(",").map(c=>{const[p,h]=c.split(":");return p&&h?{fieldId:p,direction:h}:null}).filter(Boolean);d.length>0&&(s.sort=d)}return s}pageChanged(e){this.state={...this.state,page:e.detail.page},this.handleSearchRequested(void 0)}updated(e){if(super.updated(e),e.has("component")){const t=this.component?.id;if(t!==this._initializedForComponentId){this._initializedForComponentId=t;const r=this.component?.metadata,a=r.initialPage&&r.initialPage>0?r.initialPage:0;this.state=this._initStateFromUrl(r,{...this.state,size:r.pageSize,page:a,sort:[]}),(this.state.page!==a||this.state.sort?.length>0||[...this._filterIds(r)].some(o=>this.state[o]!=null))&&this.handleSearchRequested(void 0)}}}render(){const e=_=>{const z=[];return _.color&&_.color!==As.normal&&z.push(_.color),_.buttonStyle&&z.push(_.buttonStyle===Rs.tertiaryInline?"tertiary-inline":_.buttonStyle),z.length?z.join(" "):void 0},t=_=>_==="back"||_==="backToList"||!!_&&_.startsWith("cancel"),r=_=>{const z=U.get()?.renderToolbarButton?.(_,this.evalLabel(_.label),()=>this.handleToolbarButtonClick(_.actionId));return z||i`
                <button class="crud-btn"
                        data-action-id="${_.id}"
                        theme="${e(_)||l}"
                        @click="${()=>this.handleToolbarButtonClick(_.actionId)}"
                >${this.evalLabel(_.label)}</button>
            `};if(!this.component)return i`no component`;const a=this.effectiveComponent,s=a.metadata;s.serverSideOrdering=!0;const o=s?.toolbar??[],n=o.filter(_=>t(_.actionId)),d=o.filter(_=>!t(_.actionId)),c=n.length>0&&d.length>0,p=!!s?.title||!!s?.subtitle||o.length>0,h=this.effectiveGridLayout,f=this.cols,v=Ds(f),C=this.data[this.id]?.page?.content??[],g=this.state[this.component?.id]?.emptyStateMessage,I=(_,z)=>{const E=z[_.id];if(E==null)return i``;if(_.dataType==="status"){const T=Ts(E.type);return i`<span theme="badge pill ${T}">${E.message}</span>`}return _.dataType==="bool"?i`${E?"✓":"✗"}`:typeof E=="object"?i`${E.label??E.name??E.message??""}`:i`${E}`},j=()=>{const _=this.identifierFieldName,z=this.state._selectedId??this.appState?._splitDetailId,E=v.find(P=>P.identifier)??v[0],T=P=>P.dataType==="action"||P.dataType==="actionGroup"||P.dataType==="menu"||P.stereotype==="button",Pe=v.filter(P=>P!==E&&!T(P)),Lt=f.filter(P=>T(P)),tt=(P,A,N)=>{P.stopPropagation(),P.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:A,parameters:{_clickedRow:N}},bubbles:!0,composed:!0}))},bt=P=>{const A=[];for(const N of Lt){const F=P[N.id];if(N.dataType==="action"){const Oe=F?.methodNameInCrud?F:P.action?.methodNameInCrud?P.action:{methodNameInCrud:N.id,label:N.label,icon:null};A.push(i`
                            <button class="crud-btn" theme="tertiary small" title="${Oe.label||l}"
                                @click="${S=>tt(S,"action-on-row-"+Oe.methodNameInCrud,P)}">
                                ${Oe.icon?H(Oe.icon):l}
                                ${Oe.label??l}
                            </button>`)}else(N.dataType==="actionGroup"||N.dataType==="menu")&&(F?.actions??[]).forEach(S=>A.push(i`
                            <button class="crud-btn" theme="tertiary small" title="${S.label||l}"
                                @click="${ee=>tt(ee,"action-on-row-"+S.methodNameInCrud,P)}">
                                ${S.icon?H(S.icon):l}
                                ${S.label??l}
                ...
                <div class="m-listbox" style="width: 100%;">
                    ${C.length===0?i`<div class="m-item" disabled>${tr(g)}</div>`:l}
                    ${C.map(P=>i`
                        <div class="m-item"
                            ?selected="${_&&z!==void 0&&String(P[_])===String(z)}"
                    ...
                    `)}
                </div>`},ue=(_,z,E)=>{const T=this.identifierFieldName;T&&E[T]!==void 0&&(this.state={...this.state,_selectedId:String(E[T])}),_.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:z,parameters:E},bubbles:!0,composed:!0}))},Q=()=>{const _=this.identifierFieldName,z=this.state._selectedId??this.appState?._splitDetailId,E=f.slice(0,6),T=E.filter(S=>S.stereotype==="image"),Pe=E.find(S=>S.identifier)??E[0],Lt=S=>!!S.actionId,tt=S=>S.dataType==="action"||S.dataType==="actionGroup"||S.dataType==="menu"||S.stereotype==="button",bt=E.find(S=>S.id==="select"&&S.dataType==="action"),P=!!bt,A=E.filter(S=>S!==Pe&&!T.includes(S)&&!Lt(S)&&!tt(S)),N=E.filter(S=>tt(S)&&!(P&&S===bt)),F=(S,ee,rt)=>{S.stopPropagation(),S.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:ee,parameters:{_clickedRow:rt}},bubbles:!0,composed:!0}))},Oe=S=>{const ee=[];for(const rt of N){const ra=S[rt.id];if(rt.dataType==="action"){const jt=ra?.methodNameInCrud?ra:S.action?.methodNameInCrud?S.action:{methodNameInCrud:rt.id,label:rt.label,icon:null};ee.push(i`
                            <button class="crud-btn" theme="tertiary" title="${jt.label||l}"
                                @click="${gt=>F(gt,"action-on-row-"+jt.methodNameInCrud,S)}">
                                ${jt.icon?H(jt.icon):l}
                                ${jt.label??l}
                            </button>`)}else(rt.dataType==="actionGroup"||rt.dataType==="menu")&&(ra?.actions??[]).forEach(gt=>ee.push(i`
                            <button class="crud-btn" theme="tertiary" title="${gt.label||l}"
                                @click="${Qs=>F(Qs,"action-on-row-"+gt.methodNameInCrud,S)}">
                                ${gt.icon?H(gt.icon):l}
                                ${gt.label??l}
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: var(--lumo-space-m); padding: var(--lumo-space-s) 0;">
                    ${C.length===0?i`<div style="grid-column: 1 / -1;">${tr(g)}</div>`:l}
                    ${C.map(S=>i`
                        <div class="crud-card"
                            ?data-selected="${_&&z!==void 0&&String(S[_])===String(z)}"
                            style="cursor: pointer;"
                            @click="${ee=>P?F(ee,"action-on-row-select",S):ue(ee.target,"view",S)}"
                        >
                            ${T.length?i`<img src="${S[T[0].id]??""}" alt="" style="width: 100%; max-height: 160px; object-fit: cover; border-radius: var(--lumo-border-radius-m, 8px);" />`:l}
                            ${Pe?i`<div class="crud-card-title">${S[Pe.id]??""}</div>`:l}
                    ...
                    `)}
                </div>`},We=()=>{const _=Pd(f),z=_.find(T=>T.identifier)??_[0],E=_.filter(T=>T!==z);return i`
                ...
                </div>`},ne=()=>{const _=this.identifierFieldName,z=this.state._selectedId??this.appState?._splitDetailId,E=f[0],T=f.slice(1),Pe=!!E?.actionId,Lt=A=>(A??[]).map(N=>{const F=Array.isArray(N.children)?N.children:[];return F.length>0?{...N,children:Lt(F)}:{...N,children:void 0}}),tt=Lt(C),bt=(A,N,F)=>{A.stopPropagation(),_&&N[_]!==void 0&&(this.state={...this.state,_selectedId:String(N[_])}),this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:F,parameters:N},bubbles:!0,composed:!0}))},P=(A,N)=>i`
                <tr class="${_&&z!==void 0&&String(A[_])===String(z)?"selected":""}"
            ...
            `;return i`
                <table class="crud-table">
                    ...
                    <tbody>
                        ${tt.length===0?i`<tr><td colspan="99" style="padding: 1.5rem; text-align: center; color: var(--lumo-secondary-text-color, #888);">${tr(g)}</td></tr>`:l}
                        ${tt.map(A=>P(A,0))}
                    </tbody>
                </table>`},W=U.get()?.rendersCrudLayouts?.()===!0,le=()=>{const _=U.get();return _?.renderTreeComponent?_.renderTreeComponent(this,{rows:C,columns:f.map(z=>({id:z.id,label:z.label})),idField:this.identifierFieldName,navigable:!!f[0]?.actionId,selectedId:this.state._selectedId??this.appState?._splitDetailId}):ne()},Z=i`
            ${s.infiniteScrolling?i`
                <div>${this.data[this.id]?.page?.totalElements} items found.</div>
            `:l}
            ${!W&&h==="list"?j():!W&&h==="cards"?s.contentHeight?i`
                <div class="m-scroll" style="width: 100%; height: ${s.contentHeight};">
                    ${Q()}
                </div>
            `:Q():!W&&h==="masterDetail"?We():!W&&h==="tree"?le():U.get()?.renderTableComponent(this,a,this.baseUrl,this.state,this.data,this.appState,this.appData)}
            <slot></slot>
        `,pe=s.infiniteScrolling?l:U.get()?.renderPagination(this,this.component),et=this.showImportDialog?i`
            <div class="crud-modal-backdrop" @click="${_=>{_.target===_.currentTarget&&(this.showImportDialog=!1)}}">
                <div class="crud-modal">
                    ...
                    <input type="file" @change="${_=>{const z=_.target.files?.[0];if(z){const E=new FormData;E.append("file",z),fetch("/upload",{method:"POST",body:E}).then(T=>T.json()).then(T=>this.handleImportUploadSuccess({detail:T})).catch(()=>this.notify("Import failed"))}}}">
        ...
        `:l;return this.standalone?i`
                ...
                <div style="border: var(--mateu-section-border, none); background: var(--mateu-section-bg, transparent); overflow: hidden; max-height: calc(100dvh - 12rem); width: 100%; box-sizing: border-box; padding: var(--mateu-section-padding, 0); display: flex; flex-direction: column;">
                    ...
                    <div style="flex-shrink: 0; display: flex; align-items: center; gap: var(--lumo-space-s, 0.5rem);">
                        <div style="flex: 1; min-width: 0;">${U.get()?.renderFilterBar(this,this.component,this.baseUrl,this.state,this.data,this.appState,this.appData,!0)}</div>
            ...
            <div style="border: var(--mateu-section-border, none); background: var(--mateu-section-bg, transparent); overflow: hidden; max-height: calc(100dvh - 12rem); padding: var(--mateu-section-padding, 0); display: flex; flex-direction: column;">
                <div style="flex-shrink: 0; display: flex; align-items: center; gap: var(--lumo-space-s, 0.5rem);">
                    <div style="flex: 1; min-width: 0;">${U.get()?.renderFilterBar(this,this.component,this.baseUrl,this.state,this.data,this.appState,this.appData)}</div>
                    ${this.renderColumnChooser()}
                </div>
                <div style="flex: 1; overflow-y: auto; min-height: 0;">${Z}</div>
                <div style="flex-shrink: 0;">${pe}</div>
            </div>
        `}createRenderRoot(){return U.mustUseShadowRoot()?super.createRenderRoot():this}};oe.styles=x`
        ${hr}
    ...
    `;ye([u()],oe.prototype,"component",2);ye([u()],oe.prototype,"baseUrl",2);ye([u({type:Boolean})],oe.prototype,"standalone",2);ye([u()],oe.prototype,"state",2);ye([u()],oe.prototype,"data",2);ye([u()],oe.prototype,"appState",2);ye([u()],oe.prototype,"appData",2);ye([b()],oe.prototype,"showImportDialog",2);ye([b()],oe.prototype,"availableWidthPx",2);ye([b()],oe.prototype,"selectedItem",2);ye([b()],oe.prototype,"_columnPrefsRevision",2);oe=ye([$("mateu-table-crud")],oe);var ot=(e=>(e.OnLoad="OnLoad",e.OnSuccess="OnSuccess",e.OnError="OnError",e.OnValueChange="OnValueChange",e.OnCustomEvent="OnCustomEvent",e.AutoSave="AutoSave",e))(ot||{}),Ad=Object.defineProperty,Xr=(e,t,r,a)=>{for(var s=void 0,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=n(t,r,s)||s);return s&&Ad(t,r,s),s};class vt extends ma{constructor(){super(...arguments),this.state={},this.data={},this.appData={},this.appState={},this.triggerOnLoad=()=>{const t=this.component;this.registerCustomEventListeners(),t.triggers?.filter(r=>r.type==ot.OnLoad).forEach(r=>{if((!r.condition||this._evalExpr(r.condition))&&!r.triggered){const s=r;s.triggered=!0;var a=s.times-1;s.timeoutMillis>0?this.scheduleOnload(s,a,this.id):this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:s.actionId},bubbles:!0,composed:!0}))}})},this.scheduleOnload=(t,r,a)=>{if(a!=this.component?.id)return;const s=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId,callbackToken:s},bubbles:!0,composed:!0}))},t.timeoutMillis)},this._registeredCustomEventListeners=[],this.customEventManager=t=>{if(!(t instanceof CustomEvent))return;const r=t,s=(this.component.triggers??[]).filter(o=>o.type==ot.OnCustomEvent).filter(o=>o.eventName==r.type).filter(o=>o.source!=="COMPONENT"||r.detail?.__source===o.from);s.length!==0&&(s.some(o=>!o.source||o.source==="SELF")&&(t.stopPropagation(),t.preventDefault()),s.forEach(o=>{(!o.condition||this._evalExpr(o.condition))&&this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:o.actionId,parameters:r.detail},bubbles:!0,composed:!0}))}))}}_interpolationExtra(){return{appState:this.appState??{},appData:this.appData??{},component:this.component}}_evalExpr(t){return ss(t,this.state??{},this.data??{},this._interpolationExtra())}_evalTemplate(t){return Co(t,this.state??{},this.data??{},this._interpolationExtra())}applyFragment(t){if(this.id==t.targetComponentId){if(t.component)if(ar.Add==t.action)this.component&&this.component.children?.push(t.component);else{if(this.callbackToken=ke(),t.component?.type==Y.ServerSide)if(this.component){const a=this.component,s=t.component;a.actions=s.actions,a.type=s.type,a.rules=s.rules,a.triggers=s.triggers,a.serverSideType=s.serverSideType,a.route=s.route,a.initialData=s.initialData,a.validations=s.validations,a.cssClasses=s.cssClasses,a.slot=s.slot,a.style=s.style,a.children=s.children,(a.serverSideType!=s.serverSideType||a.id!=s.id)&&setTimeout(()=>this.triggerOnLoad())}else this.component=t.component,setTimeout(()=>this.triggerOnLoad());else{const a=[t.component];this.component&&(this.component.children=a)}t.action!==ar.ReplaceKeepData&&(this.state={},this.data={})}if(t.state&&(this.state={...this.state,...t.state}),t.data){for(const a in t.data){const s=t.data[a]?.page;s?.pageNumber>0&&this.data[a]&&this.data[a].page.content&&(s.content?s.content=[...this.data[a].page.content,...s.content]:s.content=[...this.data[a].page.content])}this.data={...this.data,...t.data}}this.registerCustomEventListeners();const r=U.getAfterRenderHook();r&&setTimeout(()=>r(this)),this.requestUpdate()}}registerCustomEventListeners(){this._registeredCustomEventListeners.forEach(({target:r,name:a})=>r.removeEventListener(a,this.customEventManager)),this._registeredCustomEventListeners=[],this.component?.triggers?.filter(r=>r.type==ot.OnCustomEvent).forEach(r=>{const a=r.source==="DOCUMENT"||r.source==="COMPONENT"?document:this;a.addEventListener(r.eventName,this.customEventManager),this._registeredCustomEventListeners.push({target:a,name:r.eventName})})}disconnectedCallback(){this._registeredCustomEventListeners.forEach(({target:t,name:r})=>t.removeEventListener(r,this.customEventManager)),this._registeredCustomEventListeners=[],super.disconnectedCallback()}connectedCallback(){super.connectedCallback(),this.component&&this.registerCustomEventListeners()}}Xr([u()],vt.prototype,"state");Xr([u()],vt.prototype,"data");Xr([u()],vt.prototype,"appData");Xr([u()],vt.prototype,"appState");const Ls="mateu-recent-routes",Rd=8;function js(){try{return JSON.parse(localStorage.getItem(Ls)??"{}")}catch{return{}}}function Dd(e){try{localStorage.setItem(Ls,JSON.stringify(e))}catch{}}function ja(e){return js()[e||"_"]??[]}function Ld(e,t){if(!t?.route||!t.label)return;const r=e||"_",a=js(),o=(a[r]??[]).filter(n=>n.route!==t.route);o.unshift({route:t.route,label:t.label}),a[r]=o.slice(0,Rd),Dd(a)}var jd=Object.defineProperty,Ud=Object.getOwnPropertyDescriptor,qe=(e,t,r,a)=>{for(var s=a>1?void 0:a?Ud(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&jd(t,r,s),s};let me=class extends k{constructor(){super(...arguments),this.baseUrl="",this.open=!1,this.queryText="",this.dataHits=[],this.loading=!1,this.selectedIndex=0,this.fabOffset=0,this.keydownHandler=null}connectedCallback(){super.connectedCallback(),this.keydownHandler=e=>{(e.metaKey||e.ctrlKey)&&(e.key==="k"||e.key==="K")?(e.preventDefault(),this.toggle()):e.key==="Escape"&&this.open&&this.close()},document.addEventListener("keydown",this.keydownHandler),this.setupFabObserver()}disconnectedCallback(){super.disconnectedCallback(),this.keydownHandler&&document.removeEventListener("keydown",this.keydownHandler),clearTimeout(this.searchTimer),this.fabObserver?.disconnect(),this.fabObserver=void 0}setupFabObserver(){const e=this.getRootNode(),t=e instanceof ShadowRoot?e:document.body;this.measureFabStack(),this.fabObserver?.disconnect(),this.fabObserver=new MutationObserver(()=>this.measureFabStack()),this.fabObserver.observe(t,{childList:!0,subtree:!0})}measureFabStack(){const r=(this.getRootNode().querySelectorAll?.(".ai-fab, .app-fab, .page-fab").length??0)*4;r!==this.fabOffset&&(this.fabOffset=r)}updated(e){e.has("open")&&this.open&&requestAnimationFrame(()=>this.inputEl?.focus())}toggle(){this.open?this.close():this.openCenter()}openCenter(){this.open=!0,this.queryText="",this.dataHits=[],this.selectedIndex=0}close(){this.open=!1,this.queryText="",this.dataHits=[],clearTimeout(this.searchTimer)}flattenMenu(e,t){const r=[];for(const a of e??[])if(!a.separator)if(a.submenus&&a.submenus.length>0){const s=t?`${t} › ${a.label}`:a.label;r.push(...this.flattenMenu(a.submenus,s))}else a.route!==void 0&&a.route!==null&&r.push({label:a.label,breadcrumb:t,route:a.route});return r}onInput(e){this.queryText=e,this.selectedIndex=0;const t=e.trim();if(clearTimeout(this.searchTimer),!t||!this.app?.globalSearchEnabled){this.dataHits=[],this.loading=!1;return}this.loading=!0,this.searchTimer=setTimeout(()=>this.fetchGlobalSearch(t),250)}async fetchGlobalSearch(e){const t=this.app;if(!t?.globalSearchEnabled){this.loading=!1;return}try{const a=(await Tt.runAction(this.baseUrl??"",t.rootRoute??"","","_globalsearch","command-center",void 0,t.serverSideType,{},{searchText:e},this,!0))?.fragments?.map(s=>s.data).find(s=>s&&s._globalsearch);this.dataHits=a?._globalsearch??[]}catch{this.dataHits=[]}finally{this.loading=!1}}navigateTo(e,t){Ld(this.app?.serverSideType??"",{route:e,label:t}),this.close();for(const r of["route-changed","navigate-to-requested"])this.dispatchEvent(new CustomEvent(r,{detail:{route:e},bubbles:!0,composed:!0}))}askAi(){const e=this.queryText.trim();this.close(),this.dispatchEvent(new CustomEvent("mateu-open-ai",{detail:{query:e},bubbles:!0,composed:!0}))}visibleTargets(e){if(!this.queryText.trim()){const t=this.flattenMenu(this.app?.menu,"").map(a=>({route:a.route,label:a.label})),r=ja(this.app?.serverSideType??"");return[...t,...r]}return[...e.map(t=>({route:t.route,label:t.label})),...this.dataHits.map(t=>({route:t.route,label:t.label}))]}onKeydown(e,t){if(e.key==="ArrowDown")e.preventDefault(),this.selectedIndex=Math.min(this.selectedIndex+1,t.length-1);else if(e.key==="ArrowUp")e.preventDefault(),this.selectedIndex=Math.max(this.selectedIndex-1,0);else if(e.key==="Enter"){const r=t[this.selectedIndex];r&&this.navigateTo(r.route,r.label)}}render(){return i`
        ...
        `}renderDefault(){const e=this.flattenMenu(this.app?.menu,""),t=ja(this.app?.serverSideType??"");let r=-1;return i`
    ...
    `;qe([u({attribute:!1})],me.prototype,"app",2);qe([u()],me.prototype,"baseUrl",2);qe([b()],me.prototype,"open",2);qe([b()],me.prototype,"queryText",2);qe([b()],me.prototype,"dataHits",2);qe([b()],me.prototype,"loading",2);qe([b()],me.prototype,"selectedIndex",2);qe([b()],me.prototype,"fabOffset",2);qe([Ie(".cc-input")],me.prototype,"inputEl",2);me=qe([$("mateu-command-center")],me);let Te=null;function Md(e){const t=e.component?.metadata;!!(t&&(t.commandCenterEnabled||t.chromeless)&&t.variant!=="MEDIATOR")?((!Te||!Te.isConnected)&&(Te=document.createElement("mateu-command-center"),e.renderRoot.appendChild(Te)),Te.app=t,Te.baseUrl=e.baseUrl??""):Te&&e.renderRoot.contains(Te)&&(Te.remove(),Te=null)}var Nd=Object.defineProperty,Fd=Object.getOwnPropertyDescriptor,Us=(e,t,r,a)=>{for(var s=a>1?void 0:a?Fd(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Nd(t,r,s),s};let Nr=class extends k{constructor(){super(...arguments),this.fetchStarted=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!0},this.fetchFinished=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1},this.fetchFailed=e=>{e.preventDefault(),e.stopPropagation(),this.loading=!1;const t=e.detail.reason,r=t?.message??String(t);St({text:r,variant:"error",duration:3e3,position:"bottomEnd"},this)}}connectedCallback(){super.connectedCallback(),this.addEventListener("backend-called-event",this.fetchStarted),this.addEventListener("backend-succeeded-event",this.fetchFinished),this.addEventListener("backend-cancelled-event",this.fetchFailed),this.addEventListener("backend-failed-event",this.fetchFailed)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("backend-succeeded-event",this.fetchStarted),this.removeEventListener("backend-succeeded-event",this.fetchFinished),this.removeEventListener("backend-cancelled-event",this.fetchFailed),this.removeEventListener("backend-failed-event",this.fetchFailed)}render(){return i`<div class="loader-container">
...
`):e?.cssText??"";if(!t)return;const r=document.createElement("style");r.id="mateu-app-light-styles",r.textContent=t,document.head.appendChild(r)}fetchGlobalSearch(e){const t=this.component?.metadata;if(t?.globalSearchEnabled){if(clearTimeout(this._globalSearchTimer),!e){this.commandPaletteDataHits=[];return}this._globalSearchTimer=setTimeout(async()=>{try{const a=(await Tt.runAction(this.baseUrl??"",t.rootRoute??"","","_globalsearch","cmd-palette",void 0,t.serverSideType,{},{searchText:e},this,!0))?.fragments?.map(s=>s.data).find(s=>s&&s._globalsearch);this.commandPaletteDataHits=a?._globalsearch??[]}catch{this.commandPaletteDataHits=[]}},250)}}connectedCallback(){super.connectedCallback(),this.isDark=document.documentElement.getAttribute("theme")==="dark",this._commandPaletteHandler=e=>{this.component?.metadata?.commandCenterEnabled||((e.metaKey||e.ctrlKey)&&e.key==="k"&&(e.preventDefault(),this.commandPaletteOpen=!this.commandPaletteOpen,this.commandPaletteQuery="",this.commandPaletteSelectedIndex=0),e.key==="Escape"&&this.commandPaletteOpen&&(this.commandPaletteOpen=!1,this.commandPaletteQuery=""))},document.addEventListener("keydown",this._commandPaletteHandler),$t.install(),this.addEventListener("compact-changed",this._compactHandler),this.addEventListener("mateu-open-ai",this._openAiHandler)}disconnectedCallback(){super.disconnectedCallback(),this._commandPaletteHandler&&document.removeEventListener("keydown",this._commandPaletteHandler),this.removeEventListener("compact-changed",this._compactHandler),this.removeEventListener("mateu-open-ai",this._openAiHandler)}updated(e){if(super.updated(e),Md(this),this.component){const r=this.component.metadata;if(r){const a=r;if(a.favicon){let s=document.querySelector("link[rel~='icon']");s||(s=document.createElement("link"),s.rel="icon",document.head.appendChild(s)),s.href=a.favicon}e.has("component")&&(this.selectedRoute=a.homeRoute,this.selectedConsumedRoute=a.homeConsumedRoute,this.selectedServerSideType=a.homeServerSideType,this.selectedBaseUrl=a.homeBaseUrl,this.selectedUriPrefix=a.homeUriPrefix)}}e.has("commandPaletteOpen")&&this.commandPaletteOpen&&setTimeout(()=>{this.renderRoot.querySelector(".cmd-input")?.focus()},0)}render(){return U.get()?.renderAppComponent(this,this.component,this.baseUrl,this.state,this.data,this.appState,this.appData)}};L.lightDomStylesInjected=!1;L.styles=x`
  ...
  `;Ms([u()],Fr.prototype,"target",2);Fr=Ms([$("mateu-event-interceptor")],Fr);var Yd=Object.defineProperty,Jd=Object.getOwnPropertyDescriptor,Ns=(e,t,r,a)=>{for(var s=a>1?void 0:a?Jd(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Yd(t,r,s),s};let Br=class extends vt{constructor(){super(...arguments),this.opened=!0,this.close=()=>{this.opened=!1,setTimeout(()=>this.parentElement?.removeChild(this),500)},this.onKeydown=e=>{e.key==="Escape"&&this.opened&&(e.stopPropagation(),this.close())}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeydown)}applyFragment(e){super.applyFragment(e);const t=e.state?._closeAfterMillis;t&&setTimeout(()=>this.close(),t)}updated(e){if(super.updated(e),e.has("component")&&this.component){const t=this.component.metadata;this.state=t.initialData}}render(){if(!this.opened)return i``;const e=this.component.metadata,t=sr(e.headerTitle,this.state,this.data,this.appState,this.appData),r=!!(t||e.header||e.closeButtonOnHeader),a=[e.width?`width:${e.width};`:"min-width:min(90vw,28rem);",e.height?`height:${e.height};`:"",e.top?`margin-top:${e.top};`:""].join("");return i`
    ...
    `;Ns([b()],Br.prototype,"opened",2);Br=Ns([$("mateu-dialog")],Br);var Xd=Object.defineProperty,Qd=Object.getOwnPropertyDescriptor,Qr=(e,t,r,a)=>{for(var s=a>1?void 0:a?Qd(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Xd(t,r,s),s};let we=class extends vt{constructor(){super(...arguments),this.opened=!1,this.maximizeSteps=0,this.collapsed=!1,this.close=()=>{this.opened=!1,setTimeout(()=>this.parentElement?.removeChild(this),300)},this._escListener=e=>{if(e.key!=="Escape")return;const r=this.getRootNode().querySelectorAll("mateu-drawer, mateu-dialog");r[r.length-1]===this&&(e.stopPropagation(),this.close())}}effectiveWidth(e){if(e.width)return e.width;if(!e.size)return;const t=we.SIZE_LADDER,r=Math.max(0,t.indexOf(e.size)),a=Math.min(t.length-1,r+this.maximizeSteps);return we.SIZE_WIDTHS[t[a]]}canMaximize(e){if(!e.maximizable)return!1;const t=we.SIZE_LADDER;return Math.max(0,t.indexOf(e.size??"m"))+this.maximizeSteps<t.length-1}firstUpdated(){requestAnimationFrame(()=>this.opened=!0)}applyFragment(e){super.applyFragment(e);const t=e.state?._closeAfterMillis;t&&setTimeout(()=>this.close(),t)}updated(e){if(super.updated(e),e.has("component")&&this.component){const t=this.component.metadata;this.state=t.initialData}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._escListener)}disconnectedCallback(){document.removeEventListener("keydown",this._escListener),super.disconnectedCallback()}render(){const e=this.component.metadata,t=e.position??"end",r=sr(e.headerTitle,this.state,this.data,this.appState,this.appData),a=sr(e.subtitle,this.state,this.data,this.appState,this.appData),s=this.effectiveWidth(e),o=e.peerNav&&(e.peerNav.prevRoute||e.peerNav.nextRoute)?e.peerNav:void 0;return i`
       ...
       `}};we.SIZE_LADDER=["s","m","l","xl"];we.SIZE_WIDTHS={s:"464px",m:"648px",l:"968px",xl:"90vw"};we.styles=x`
        .drawer-close {
            border: none;
            background: transparent;
            cursor: pointer;
  ...
  `;Qr([b()],we.prototype,"opened",2);Qr([b()],we.prototype,"maximizeSteps",2);Qr([b()],we.prototype,"collapsed",2);we=Qr([$("mateu-drawer")],we);var Zd=Object.defineProperty,ec=Object.getOwnPropertyDescriptor,ie=(e,t,r,a)=>{for(var s=a>1?void 0:a?ec(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Zd(t,r,s),s};function Ua(e){if(e.parentElement)return e.parentElement;const t=e.getRootNode();return t instanceof ShadowRoot?t.host:null}let V=class extends k{constructor(){super(...arguments),this.appState={},this.appData={},this.standalone=!1,this.actionBanners=[],this.dismissedStaticBannerIndices=new Set,this._tocEntries=[],this._activeToc=0,this._tocVisible=!1,this._tocRebuildScheduled=!1,this._headerH=0,this._onResize=()=>this._layoutStickyTops(),this._tocLocked=!1,this._unlockToc=e=>{if(e&&e.type==="keydown"){const t=e;if(t.ctrlKey&&t.altKey&&!t.shiftKey&&!t.metaKey&&/^(?:Digit|Numpad)[1-9]$/.test(t.code))return}this._tocLocked=!1},this._actionBannerTimers=[],this._staticBannerTimers=[],this._bannersHandler=e=>{const t=e.detail,r=t.banners??[],a=t.append??!1;a?this.actionBanners=[...this.actionBanners,...r]:(this._clearActionBannerTimers(),this.actionBanners=r);const s=a?this.actionBanners.length-r.length:0;r.forEach((o,n)=>{if(o.timeoutSeconds&&o.timeoutSeconds>0){const d=s+n;this._actionBannerTimers.push(setTimeout(()=>{this.actionBanners=this.actionBanners.filter((c,p)=>p!==d)},o.timeoutSeconds*1e3))}})},this._onTocKey=e=>{if(!this._tocVisible||!e.ctrlKey||!e.altKey||e.shiftKey||e.metaKey)return;const t=/^(?:Digit|Numpad)([1-9])$/.exec(e.code);if(!t)return;const r=parseInt(t[1],10)-1;r>=this._tocEntries.length||(e.preventDefault(),this._scrollToSection(r))},this._onScrollSpy=()=>{if(this._tocLocked)return;const e=this._sectionCards();if(!e.length)return;const t=12,r=this.shadowRoot?.querySelector("mateu-content-header");let a=r?r.getBoundingClientRect().bottom:0;for(const n of e){if(!n.classList.contains("mateu-section--sticky"))continue;const d=n.getBoundingClientRect();d.top<=a+t+2&&(a=Math.max(a,d.bottom))}const s=a+t+4;let o=0;this._tocEntries.forEach((n,d)=>{n.el.getBoundingClientRect().top<=s&&(o=d)}),this._activeToc=o}}connectedCallback(){super.connectedCallback(),document.addEventListener("page-banners-received",this._bannersHandler),window.addEventListener("resize",this._onResize),document.addEventListener("keydown",this._onTocKey)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("page-banners-received",this._bannersHandler),window.removeEventListener("resize",this._onResize),document.removeEventListener("keydown",this._onTocKey),this._clearAllTimers(),this._teardownScrollSpy()}updated(e){if(super.updated(e),e.has("component")&&e.get("component")!==void 0&&(this._clearAllTimers(),this.actionBanners=[],this.dismissedStaticBannerIndices=new Set),e.has("component")){const t=this.component?.metadata?.level??0;this.toggleAttribute("data-nested",t>0),this._scheduleStaticBannerTimeouts(),this.dispatchEvent(new CustomEvent("compact-changed",{detail:{compact:!!this.component?.style?.includes("--mateu-compact:1")},bubbles:!0,composed:!0})),this._scheduleTocRebuild()}}_scheduleStaticBannerTimeouts(){this._staticBannerTimers.forEach(r=>clearTimeout(r)),this._staticBannerTimers=[],(this.component?.metadata?.banners??[]).forEach((r,a)=>{r.timeoutSeconds&&r.timeoutSeconds>0&&this._staticBannerTimers.push(setTimeout(()=>{this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,a])},r.timeoutSeconds*1e3))})}_clearActionBannerTimers(){this._actionBannerTimers.forEach(e=>clearTimeout(e)),this._actionBannerTimers=[]}_clearAllTimers(){this._clearActionBannerTimers(),this._staticBannerTimers.forEach(e=>clearTimeout(e)),this._staticBannerTimers=[]}_dismissActionBanner(e){this.actionBanners=this.actionBanners.filter((t,r)=>r!==e)}_dismissStaticBanner(e){this.dismissedStaticBannerIndices=new Set([...this.dismissedStaticBannerIndices,e])}bannerThemeClass(e){const t=e.theme?.toLowerCase()??"info";return t==="none"?"":t}_evalBannerText(e){return zt(e,this.state,this.data)}_renderBanner(e,t){const r=this._evalBannerText(e.title),a=this._evalBannerText(e.description);return i`
        ...
        `;return i`<div style="display: flex; flex-direction: column; width: 100%;">${s}</div>`}};V.styles=x`
...
`,We=!0)}We&&this.updateMessage(o,n)}n||this.updateMessage(o,"⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).")}catch(d){console.error("Error en el flujo SSE:",d);const c=d?.message??String(d);(c==="Failed to fetch"||c==="network error"||c==="Load failed")&&!n?this.updateMessage(o,"⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible."):this.updateMessage(o,"⚠️ Error: "+c)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value="")},250),this.messageInputElement?.removeAttribute("disabled"),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent("close-requested",{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{const e=this.messageInputElement?.value?.trim()??"";e&&this.send(new CustomEvent("submit",{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key==="Enter"&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback(),this.probeLocalAgent();const e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){const t=new e;this.recognition=t,t.lang="es-ES",t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=r=>{console.error("Error de reconocimiento: "+r.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:"smooth"})},0)}addMessage(e,t){const r={text:e,time:new Date().toLocaleTimeString(),userName:t.includes("agent")?"Asistente":"Tú",userColorIndex:t.includes("agent")?2:1};return this.items=[...this.items,r],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((r,a)=>a===e?{...r,text:t}:r),this.scrollBottom()}tryParseCustomEvent(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const r=JSON.parse(t);if(typeof r.event=="string")return{event:r.event,detail:r.detail??{}}}catch{}return null}tryParseTokenUsage(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const r=JSON.parse(t);if("inputTokens"in r||"outputTokens"in r||"totalTokens"in r)return r}catch{}return null}buildMenuContext(e,t=[]){const r=[];for(const a of e){if(a.separator||a.remote)continue;const s=[...t,a.label];if(a.submenus&&a.submenus.length>0)r.push(...this.buildMenuContext(a.submenus,s));else{const o={path:s,navigation:{route:a.route,consumedRoute:a.consumedRoute,actionId:a.actionId??"",baseUrl:a.baseUrl,serverSideType:a.serverSideType,uriPrefix:a.uriPrefix}};a.description&&(o.description=a.description),r.push(o)}}return r}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return i`
                    ...
                    <div class="message-list" role="list">
                        ${this.items.map(e=>i`
                            <div class="message" role="listitem">
                                <div class="avatar" style="background: ${oc(e.userColorIndex)};">${ic(e.userName)}</div>
    ...
    `];B([u({attribute:!1})],M.prototype,"contextProvider",2);B([u()],M.prototype,"localAgentUrl",2);B([u({attribute:!1})],M.prototype,"mcpUrl",2);B([b()],M.prototype,"localAgentAlive",2);B([u()],M.prototype,"sseUrl",2);B([u()],M.prototype,"uploadUrl",2);B([u({attribute:!1})],M.prototype,"menu",2);B([b()],M.prototype,"attachments",2);B([b()],M.prototype,"uploading",2);B([Ie(".file-input")],M.prototype,"fileInputElement",2);B([u({type:Boolean,reflect:!0})],M.prototype,"expanded",2);B([u()],M.prototype,"items",2);B([Ie(".scroll-container")],M.prototype,"scrollContainer",2);B([Ie(".msg-input")],M.prototype,"messageInputElement",2);B([b()],M.prototype,"recognition",2);B([b()],M.prototype,"listening",2);B([b()],M.prototype,"recognitionAvailable",2);B([b()],M.prototype,"loading",2);B([b()],M.prototype,"elapsedSeconds",2);B([b()],M.prototype,"tokenUsage",2);M=B([$("mateu-chat")],M);var nc=Object.defineProperty,lc=Object.getOwnPropertyDescriptor,$r=(e,t,r,a)=>{for(var s=a>1?void 0:a?lc(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&nc(t,r,s),s};let Et=class extends k{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.data&&this.createChart(this.data)}async createChart(e){const[{default:t}]=await Promise.all([xe(()=>import("./vendor-chartjs.js").then(a=>a.a),[]),xe(()=>import("./vendor-chartjs.js").then(a=>a.c),[])]);if(e!==this.data)return;this.chart&&this.chart.destroy();const r={type:this.type,data:this.data,options:this.options};this.chart=new t(this.chartElement,r)}handleSlotChange(){}render(){return i`
       ...
       `}};Et.styles=x`
  `;$r([u()],Et.prototype,"type",2);$r([u()],Et.prototype,"data",2);$r([u()],Et.prototype,"options",2);$r([Ie("#chart")],Et.prototype,"chartElement",2);Et=$r([$("mateu-chart")],Et);var dc=Object.defineProperty,cc=Object.getOwnPropertyDescriptor,Ca=(e,t,r,a)=>{for(var s=a>1?void 0:a?cc(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&dc(t,r,s),s};let ur=class extends k{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){const{default:t}=await xe(async()=>{const{default:a}=await import("./vendor-diagrams.js");return{default:a}},__vite__mapDeps([2,0,1]));if(e!==this.xml)return;this.chart&&this.chart.destroy();const r={container:this.divElement};this.chart=new t(r),this.chart.importXML(e)}handleSlotChange(){}render(){return i`
       ...
       `}};ur.styles=x`
  `;Ca([u()],ur.prototype,"xml",2);Ca([Ie("#canvas")],ur.prototype,"divElement",2);ur=Ca([$("mateu-bpmn")],ur);var uc=Object.defineProperty,pc=Object.getOwnPropertyDescriptor,Qt=(e,t,r,a)=>{for(var s=a>1?void 0:a?pc(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&uc(t,r,s),s};const oa=160,ze=56,mc=220,Na=110,st=60,hc={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},fc={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},vc=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];function bc(){return"step-"+Math.random().toString(36).slice(2,8)}let ct=class extends k{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.wf={name:"New Workflow",steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value")){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){const e=this.wf.steps??[],t={};e.forEach(n=>{t[n.id]=0});let r=!0;for(;r;)r=!1,e.forEach(n=>{if(n.preconditionStepId!=null&&t[n.preconditionStepId]!==void 0){const d=t[n.preconditionStepId]+1;d>t[n.id]&&(t[n.id]=d,r=!0)}});const a={};e.forEach(n=>{const d=t[n.id]??0;(a[d]??=[]).push(n.id)});const s={...this.positions};let o=!1;Object.entries(a).forEach(([n,d])=>{const c=Number(n);d.forEach((p,h)=>{s[p]||(s[p]={x:st+c*mc,y:st+h*Na},o=!0)})}),o&&(this.positions=s)}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(r=>r.id===e?{...r,...t}:r)},this.emit()}addStep(){const e=bc(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const r=Object.values(this.positions).map(s=>s.y),a=r.length?Math.max(...r)+Na:st;this.positions={...this.positions,[e]:{x:st,y:a}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(a=>a.id!==e).map(a=>a.preconditionStepId===e?{...a,preconditionStepId:void 0}:a)};const{[e]:t,...r}=this.positions;this.positions=r,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;const r=this.positions[t]??{x:0,y:0},a=this.toSvgPoint(e);this.dragOffset={x:a.x-r.x,y:a.y-r.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(a=>a.x))+oa+st:600,r=e.length?Math.max(...e.map(a=>a.y))+ze+st:400;return{w:Math.max(t,600),h:Math.max(r,400)}}render(){const{w:e,h:t}=this.canvasSize(),r=this.wf.steps??[];return i`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return K``;const t=this.positions[e.preconditionStepId],r=this.positions[e.id];if(!t||!r)return K``;const a=t.x+oa,s=t.y+ze/2,o=r.x,n=r.y+ze/2,d=(a+o)/2;return K`
            <path d="M${a},${s} C${d},${s} ${d},${n} ${o},${n}"
                  fill="none" stroke="#94a3b8" stroke-width="2"
                  marker-end="url(#arrow)"/>
        `}renderNode(e){const t=this.positions[e.id]??{x:st,y:st},r=hc[e.type]??"#64748b",a=fc[e.type]??"•",s=this.selectedId===e.id;return K`
            <g transform="translate(${t.x},${t.y})"
               style="cursor:grab"
               @mousedown="${o=>this.onNodeMouseDown(o,e.id)}"
               @click="${o=>{o.stopPropagation(),this.selectedId=e.id}}">
                <rect width="${oa}" height="${ze}" rx="8"
                      fill="white"
                      stroke="${s?r:"#e2e8f0"}"
                ...
                <div class="prop-body">
                    ...
                    ${r("Type",i`
                        <select class="inp" @change="${a=>this.updateStep(e.id,{type:a.target.value})}">
                            ${vc.map(a=>i`<option value="${a}" ?selected="${e.type===a}">${a}</option>`)}
                        </select>`)}
        ...
        `}exportJson(){const e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:"application/json"}),r=URL.createObjectURL(t),a=document.createElement("a");a.href=r,a.download=(this.wf.name??"workflow").replace(/\s+/g,"-").toLowerCase()+".json",a.click(),URL.revokeObjectURL(r)}};ct.styles=[_a,x`
    ...
    `];Qt([u()],ct.prototype,"value",2);Qt([b()],ct.prototype,"wf",2);Qt([b()],ct.prototype,"positions",2);Qt([b()],ct.prototype,"selectedId",2);Qt([b()],ct.prototype,"showMeta",2);ct=Qt([$("mateu-workflow")],ct);var gc=Object.defineProperty,yc=Object.getOwnPropertyDescriptor,xr=(e,t,r,a)=>{for(var s=a>1?void 0:a?yc(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&gc(t,r,s),s};const $c=["string","integer","number","bool","date","time","dateTime","dateRange","money","file","array","status","component","menu","range","action","actionGroup"],xc=["regular","radio","checkbox","textarea","toggle","combobox","select","email","password","richText","listBox","html","markdown","image","icon","link","money","grid","color","choice","popover","slider","button","stars"],wc={string:"#3B82F6",integer:"#8B5CF6",number:"#6366F1",bool:"#10B981",date:"#F59E0B",time:"#F59E0B",dateTime:"#F59E0B",dateRange:"#F59E0B",money:"#EF4444",file:"#64748B",array:"#0EA5E9",status:"#EC4899",component:"#14B8A6",menu:"#94A3B8",range:"#A855F7",action:"#F97316",actionGroup:"#FB923C"};function Fa(){return"field-"+Math.random().toString(36).slice(2,8)}let It=class extends k{constructor(){super(...arguments),this.value='{"name":"New Form","fields":[]}',this.form={name:"New Form",fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has("value"))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){const e=this.shadowRoot?.querySelector(".field-list");!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=to.create(e,{animation:150,handle:".drag-handle",ghostClass:"sortable-ghost",onEnd:t=>{const{oldIndex:r,newIndex:a}=t;if(r===void 0||a===void 0||r===a)return;const s=[...this.form.fields],[o]=s.splice(r,1);s.splice(a,0,o),this.form={...this.form,fields:s},this.emit()}}))}emit(){const e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(r=>r.id===e?{...r,...t}:r)},this.emit()}addField(){const e=Fa(),t={id:e,label:"New Field",dataType:"string"};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){const t=this.form.fields.find(o=>o.id===e);if(!t)return;const r={...t,id:Fa(),label:t.label+" (copy)"},a=this.form.fields.findIndex(o=>o.id===e),s=[...this.form.fields];s.splice(a+1,0,r),this.form={...this.form,fields:s},this.selectedId=r.id,this.emit()}render(){return i`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderRow(e){const t=wc[e.dataType]??"#64748b",r=this.selectedId===e.id;return i`
        ...
        `}exportJson(){const e=JSON.stringify(this.form,null,2),t=new Blob([e],{type:"application/json"}),r=URL.createObjectURL(t),a=document.createElement("a");a.href=r,a.download=(this.form.name??"form").replace(/\s+/g,"-").toLowerCase()+".json",a.click(),URL.revokeObjectURL(r)}};It.styles=[_a,x`
        :host { display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif); }
        ...
        textarea.inp { resize: vertical; }
        input[readonly].inp { background: #f8fafc; color: #94a3b8; }
    `];xr([u()],It.prototype,"value",2);xr([b()],It.prototype,"form",2);xr([b()],It.prototype,"selectedId",2);xr([b()],It.prototype,"showMeta",2);It=xr([$("mateu-form-editor")],It);var kc=Object.defineProperty,_c=Object.getOwnPropertyDescriptor,Ve=(e,t,r,a)=>{for(var s=a>1?void 0:a?_c(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&kc(t,r,s),s};let fe=class extends k{constructor(){super(...arguments),this.appState={},this.appData={},this.open=!1,this.activeTab="appstate",this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null,this._prevTarget=null,this._onMouseover=e=>{let t=e.target;for(;t&&!(t.tagName?.toLowerCase().startsWith("mateu-")&&t!==this);)t=t.parentElement;if(t===this||t===null){t===null&&this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset="",this._prevTarget=null,this.hoveredTag="",this.hoveredId="",this.hoveredState=null,this.hoveredData=null,this.hoveredMeta=null);return}t!==this._prevTarget&&(this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget.style.outlineOffset=""),this._prevTarget=t,t.style.outline="2px solid #0070f3",t.style.outlineOffset="-2px",this.hoveredTag=t.tagName.toLowerCase(),this.hoveredId=t.id||"",this.hoveredState=t.state,this.hoveredData=t.data,this.hoveredMeta=t.component?.metadata)}}connectedCallback(){super.connectedCallback(),document.addEventListener("mouseover",this._onMouseover,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mouseover",this._onMouseover,!0),this._prevTarget&&(this._prevTarget.style.outline="",this._prevTarget=null)}_fmt(e){try{return JSON.stringify(e,null,2)??"null"}catch{return String(e)}}_renderTab(e,t){return i`
...
`);St({text:a,variant:"error",position:"bottomEnd",duration:Math.max(3e3,1500+r.length*1e3)},this)},this.notify=e=>{St({text:e,variant:"error",position:"bottomEnd",duration:3e3},this)},this.callAfterConfirmation=(e,t)=>{let r="One moment, please",a="Are you sure?",s="Yes",o="No";e.confirmationTexts&&(r=e.confirmationTexts.title,a=e.confirmationTexts.message,s=e.confirmationTexts.confirmationText,o=e.confirmationTexts.denialText);const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;z-index:1100;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.35);padding:1rem;";const d=document.createElement("div");d.style.cssText="background:var(--lumo-base-color,#fff);color:var(--lumo-body-text-color,#1a1a1a);border-radius:var(--lumo-border-radius-l,12px);box-shadow:var(--lumo-box-shadow-xl,0 12px 40px rgba(0,0,0,.3));padding:1.2rem;max-width:min(90vw,26rem);";const c=()=>{n.parentElement&&document.body.removeChild(n)},p="font:inherit;font-weight:600;padding:.45rem 1rem;border-radius:var(--lumo-border-radius-m,6px);cursor:pointer;";ao(i`
        ...
        `,d),n.appendChild(d),n.addEventListener("click",h=>{h.target===n&&c()}),document.body.appendChild(n)},this.requestActionCallToServerOrBubble=(e,t,r)=>{if(r&&r.bubble){const a={...e.parameters};a.initiatorState||(a.initiatorState=this.state),this.dispatchEvent(new CustomEvent("action-requested",{detail:{...e,parameters:a},bubbles:!0,composed:!0}))}else this.requestActionCallToServer(e,t,r)},this.requestActionCallToServer=(e,t,r)=>{if(r&&r.href){window.location.href=r.href;return}if(r&&r.js)try{new Function("state","data","appState","appData","component",r.js).call(this,this.state??{},this.data??{},this.appState??{},this.appData??{},this.component),this.state={...this.state},this.data={...this.data}}catch(a){console.error("when evaluating "+r.js,a,this.component,this.state,this.data)}if(r&&r.customEvent&&this.dispatchEvent(new CustomEvent(r.customEvent.name,{detail:r.customEvent.detail,bubbles:!0,composed:!0})),!(r&&(r.js||r.customEvent))){if(e.actionId=="search"){const a=e.parameters?._searchState;a?this.state={...this.state,...a}:this.state.size||(this.state={...this.state,size:10,page:0,sort:[]})}this.dispatchEvent(new CustomEvent("server-side-action-requested",{detail:{route:this.route,consumedRoute:this.consumedRoute,componentState:{...this.state},parameters:e.parameters??{},actionId:e.actionId,serverSideType:t.serverSideType,serverSideComponentRoute:t.route,initiatorComponentId:e.initiatorComponentId??t.id,initiator:this,background:r?.background,sse:r?.sse,callback:e.callback,callbackonly:e.callbackonly,callbackToken:e.callbackToken??this.callbackToken},bubbles:!0,composed:!0}))}},this.handleBackendSucceeded=e=>{e.detail.actionId&&this.component.triggers?.filter(a=>a.type==ot.OnSuccess).filter(a=>e.detail.actionId==a.calledActionId).forEach(a=>{if(!a.condition||this._evalExpr(a.condition))if(e.preventDefault(),e.stopPropagation(),a.timeoutMillis>0){const s=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.actionId,callbackToken:s},bubbles:!0,composed:!0}))},a.timeoutMillis)}else this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.actionId},bubbles:!0,composed:!0}))})},this.handleBackendFailed=e=>{e.detail.actionId&&this.component.triggers?.filter(a=>a.type==ot.OnError).filter(a=>e.detail.actionId==a.calledActionId).forEach(a=>{(!a.condition||this._evalExpr(a.condition))&&(e.preventDefault(),e.stopPropagation(),this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.actionId},bubbles:!0,composed:!0})))})},this._keydownListener=e=>{if(this._handleTabShortcut(e))return;const t=this.component;if(t)for(const r of t.actions??[]){const a=r.shortcut||(r.runOnEnter?"enter":null);if(a&&this._shortcutMatchesEvent(a,e)){e.preventDefault(),this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.id},bubbles:!0,composed:!0}));return}}}}createRenderRoot(){return U.mustUseShadowRoot()?super.createRenderRoot():this}updated(e){super.updated(e),e.has("state")&&this.state&&JSON.stringify(this.state)!=JSON.stringify({})&&this.onChange(),e.has("component")&&(this.formerState={...this.state},this.component?.confirmOnNavigationIfDirty&&this.dispatchEvent(new CustomEvent("clean",{detail:{},bubbles:!0,composed:!0})),setTimeout(()=>this.triggerOnLoad()))}_shortcutMatchesEvent(e,t){return Oi(e,t)}_collectShortcutTabs(){const e=this.renderRoot;if(!e)return[];const t=Array.from(e.querySelectorAll("vaadin-tab[data-shortcut]"));return e.querySelectorAll("mateu-drawer, mateu-dialog").forEach(r=>{const a=r.shadowRoot;a&&t.push(...Array.from(a.querySelectorAll("vaadin-tab[data-shortcut]")))}),t}_handleTabShortcut(e){const t=this._collectShortcutTabs();if(t.length===0)return!1;for(const r of Array.from(t)){const a=r.dataset.shortcut;if(!a||!this._shortcutMatchesEvent(a,e))continue;const s=r.closest("vaadin-tabs");if(!s)continue;const o=Array.from(s.querySelectorAll("vaadin-tab")).indexOf(r);if(!(o<0))return e.preventDefault(),s.selected=o,!0}return!1}connectedCallback(){super.connectedCallback(),this.addEventListener("backend-call-succeeded",this.handleBackendSucceeded),this.addEventListener("backend-call-failed",this.handleBackendFailed),document.addEventListener("keydown",this._keydownListener)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("backend-call-succeeded",this.handleBackendSucceeded),this.removeEventListener("backend-call-failed",this.handleBackendFailed),document.removeEventListener("keydown",this._keydownListener)}render(){return i`<div>
            ...
            `:l}</div>`}_render(){if(this.component?.type==Y.ClientSide){const e=this.component;return e.metadata?.type==m.Page?la(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):e.metadata?.type==m.Crud?da(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):U.get()?.renderClientSideComponent(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!1)}return i`
            <mateu-api-caller 
            ...
            ${this.component?.children?.map(e=>{if(e.type==Y.ClientSide){const t=e;if(t.metadata?.type==m.Page)return la(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0);if(t.metadata?.type==m.Crud)return da(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0)}return w(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData)})}
            </mateu-api-caller>
        `}};qt.styles=x`
        :host {
        }
  ...
  `;Zr([u()],qt.prototype,"baseUrl",2);Zr([u()],qt.prototype,"route",2);Zr([u()],qt.prototype,"consumedRoute",2);qt=Zr([$("mateu-component")],qt);const Ba=e=>{if(e)try{return JSON.parse(e)}catch{return{value:e}}else return{}};class Ec{async handle(t,r){return await t.runAction(r.baseUrl,r.route,r.consumedRoute,r.actionId,r.initiatorComponentId,r.appState,r.serverSideType,r.componentState,r.parameters,r.initiator,r.background)}}const Ic=new Ec;class Pc{constructor(){this.handleUIIncrement=(t,r,a)=>{if(t?.fragments?.forEach(s=>{yt.next({command:void 0,fragment:s,ui:void 0,error:void 0,callbackToken:a})}),t?.appState&&(G.value={...t.appState},r.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))),t?.appData){const s=t?.appData;Sr.value={...t.appData,...s},r.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))}t?.messages?.forEach(s=>{St({text:s.text,position:s.position,variant:s.variant,duration:s.duration,undoLabel:s.undoLabel,undoActionId:s.undoActionId,undoParameters:s.undoParameters},r)}),t?.banners&&t.banners.length>0&&document.dispatchEvent(new CustomEvent("page-banners-received",{detail:{banners:t.banners,append:t.appendBanners??!1},bubbles:!1,composed:!1})),t?.commands?.forEach(s=>{yt.next({command:s,fragment:void 0,ui:void 0,error:void 0,callbackToken:a})})}}async runAction(t,r,a,s,o,n,d,c,p,h,f,v,y,C,g){try{const I=await Ic.handle(t,{baseUrl:r,route:a,consumedRoute:s,actionId:o,appState:G.value,initiatorComponentId:n,componentState:p,parameters:h,serverSideType:c,initiator:f,background:v});y&&y(I),C||this.handleUIIncrement(I,f,g),I.messages&&I.messages.length==1&&I.messages[0].variant=="error"&&f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:o},bubbles:!0,composed:!0})),f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:o,evevntId:ke()},bubbles:!0,composed:!0}))}catch(I){console.warn("Action request failed",I),f.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:o,reason:this.serialize(I)}})),f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:o},bubbles:!0,composed:!0}))}}serialize(t){return t?.message?t:JSON.stringify(t)}}const Oc=new Pc,Tc=Oc;class zc{constructor(){this.handleUIIncrement=(t,r,a)=>{if(t?.messages?.forEach(s=>{St({text:s.text,position:s.position,variant:s.variant,duration:s.duration,undoLabel:s.undoLabel,undoActionId:s.undoActionId,undoParameters:s.undoParameters},r)}),t?.banners&&t.banners.length>0&&document.dispatchEvent(new CustomEvent("page-banners-received",{detail:{banners:t.banners,append:t.appendBanners??!1},bubbles:!1,composed:!1})),t?.commands?.forEach(s=>{yt.next({command:s,fragment:void 0,ui:void 0,error:void 0,callbackToken:a})}),t?.fragments?.forEach(s=>{yt.next({command:void 0,fragment:s,ui:void 0,error:void 0,callbackToken:a})}),t?.appState&&(G.value={...t.appState},r.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))),t?.appData){const s=t?.appData;Sr.value={...t.appData,...s},r.dispatchEvent(new CustomEvent("app-data-updated",{bubbles:!0,composed:!0}))}}}async runAction(t,r,a,s,o,n,d,c,p,h,f,v,y,C,g){if(a){a=a||"_no_route",a&&a.startsWith("/")&&(a=a.substring(1));const I={serverSideType:c,appState:G.value,componentState:p,parameters:h,initiatorComponentId:n,consumedRoute:s,route:"/"+a,actionId:o};v||f.dispatchEvent(new CustomEvent("backend-called-event",{bubbles:!0,composed:!0,detail:{}})),fetch(r+"/mateu/v3/sse/"+a,{method:"POST",headers:{Accept:"text/event-stream","Content-Type":"application/json"},body:JSON.stringify(I)}).then(async j=>{const ue=j.body?.pipeThrough(new TextDecoderStream).getReader();if(ue){let Q="";for(;;){const{value:We,done:ne}=await ue.read();if(ne)break;Q+=We;const W=Q.split(`

`);Q=W.pop()??"";for(const le of W){const Z=le.trim();if(Z)if(Z.startsWith("data:")){const pe=JSON.parse(Z.substring(5).trim());y&&y(pe),C||this.handleUIIncrement(pe,f,g),pe.messages&&pe.messages.length==1&&pe.messages[0].variant=="error"&&f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:o},bubbles:!0,composed:!0}))}else{let pe=Z;try{const et=JSON.parse(Z);pe=et.message,et._embedded?.errors?.length>0&&et._embedded.errors[0].message&&(pe=et._embedded.errors[0].message)}catch{}throw new Error(pe)}}}}v||f.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:o}})),f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:o},bubbles:!0,composed:!0}))}).catch(j=>{f.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:o,reason:this.serialize(j)}})),f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:o},bubbles:!0,composed:!0}))})}}serialize(t){return t?.message?t:JSON.stringify(t)}}const Ws=new zc,Ac={fixed:"fixed",fullWidth:"full",edgeToEdge:"edge"},Rc=new Set([m.Gantt,m.PlanningBoard,m.Kanban,m.Bpmn,m.Workflow,m.Map]),Dc={landing:"fixed",form:"fixed",process:"fixed"},Gs=e=>e?Ac[e]:void 0,Pt=e=>e.type==Y.ClientSide?e.metadata:void 0,Ks=e=>{const t=Pt(e);if(t?.type==m.Page){const r=Gs(t.pageWidth);if(r)return r}for(const r of e.children??[]){const a=Ks(r);if(a)return a}},Ys=e=>{const t=e.pageType;if(t)return t;const r=a=>{const s=Pt(a);if(s?.type==m.Page&&s.pageType)return s.pageType;for(const o of a.children??[]){const n=r(o);if(n)return n}};return r(e)},Lc=e=>{const t=Pt(e);if(t?.type!=m.Crud)return!1;const r=t;return r.compact?!0:(r.columns??[]).some(a=>a.metadata?.editable)},qr=(e,t)=>t(e)||(e.children??[]).some(r=>qr(r,t)),jc=e=>!!e&&qr(e,t=>Pt(t)?.type==m.HeroSection),Uc=e=>Pt(e)?.type==m.App?!0:(e.children??[]).some(t=>Pt(t)?.type==m.App),Mc=(e,t)=>{if(!e)return"fixed";const r=Gs(e.pageWidth)??Ks(e);if(r)return r;if(t?.top&&Uc(e))return"edge";const a=Dc[Ys(e)??""];return a||(qr(e,s=>{const o=Pt(s)?.type;return o!=null&&Rc.has(o)})?"edge":qr(e,Lc)?"full":"fixed")};var Nc=Object.defineProperty,Fc=Object.getOwnPropertyDescriptor,ce=(e,t,r,a)=>{for(var s=a>1?void 0:a?Fc(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Nc(t,r,s),s};let X=class extends Wr{constructor(){super(...arguments),this.consumedRoute="",this.serverSideType=void 0,this.uriPrefix=void 0,this.overrides=void 0,this.homeRoute=void 0,this.route=void 0,this.top=void 0,this.appState={},this.appData={},this.preventNavigation=!1,this.overridesParsed={},this.fragment=void 0,this.actionRequestedListener=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.manageActionEvent(e))},this.historyPushed=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.preventNavigation=!0,this.route=e.detail.route)},this.routeChangedListener=e=>{if(e instanceof CustomEvent){e.preventDefault(),e.stopPropagation();let t=e.detail.route;typeof t=="string"&&(t===""||t.startsWith("/"))&&this.consumedRoute&&this.consumedRoute!=="_empty"&&this.consumedRoute.startsWith("/")&&!t.startsWith(this.consumedRoute)&&(t=this.consumedRoute+t),this.uriPrefix&&(t.startsWith("/")&&this.uriPrefix.endsWith("/")?t=this.uriPrefix+t.substring(1):!t.startsWith("/")&&!this.uriPrefix.endsWith("/")?t=this.uriPrefix+"/"+t:t=this.uriPrefix+t),this.dispatchEvent(new CustomEvent("url-update-requested",{detail:{route:t},bubbles:!0,composed:!0}))}},this.backendFailedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&e.detail.actionId==""&&(this.fragment={targetComponentId:this.id,data:{},state:{},component:{type:Y.ClientSide,metadata:{type:m.Element,name:"div",content:"Not found"},id:"fieldId"},action:ar.Replace,containerId:void 0})},this.detail1=void 0,this.manageActionEvent=e=>{e.preventDefault(),e.stopPropagation(),this.detail1=e.detail;const t=this.detail1;if(e.type=="server-side-action-requested"){let r=Tc;t.sse&&(r=Ws),r.runAction(Tt,this.baseUrl,t.route??"",t.consumedRoute,t.actionId,t.initiatorComponentId,this.getCustomisedAppState(),t.serverSideType,t.componentState,t.parameters,t.initiator,t.background,t.callback,t.callbackonly,t.callbackToken)}},this.getCustomisedAppState=()=>{let e={...G.value};if(this.overrides){const t=Ba(this.overrides);e={...e,...t}}return e}}manageActionRequestedEvent(e){throw new Error("Method not implemented.")}createRenderRoot(){return U.mustUseShadowRoot()?super.createRenderRoot():this}connectedCallback(){super.connectedCallback(),this.overridesParsed=Ba(this.overrides),this.addEventListener("server-side-action-requested",this.actionRequestedListener),this.addEventListener("backend-call-failed",this.backendFailedListener),this.addEventListener("history-pushed",this.historyPushed),this.addEventListener("route-changed",this.routeChangedListener)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("server-side-action-requested",this.actionRequestedListener),this.removeEventListener("backend-call-failed",this.backendFailedListener),this.removeEventListener("history-pushed",this.historyPushed),this.removeEventListener("route-changed",this.routeChangedListener)}shouldUpdate(e){if(this.fragment?.component&&[...e.keys()].every(r=>r==="appState"||r==="appData")){const r=this.renderRoot.querySelector("mateu-component");if(r)return e.has("appState")&&(r.appState=this.appState),e.has("appData")&&(r.appData=this.appData),!1}return!0}updated(e){(e.has("id")||e.has("baseurl")||e.has("route")||e.has("consumedRoute")||e.has("instant"))&&(this.preventNavigation||(this.callbackToken=this.instant||ke(),this.manageActionEvent(new CustomEvent("server-side-action-requested",{detail:{route:this.route,consumedRoute:this.consumedRoute,userData:void 0,actionId:"",serverSideType:this.serverSideType,initiatorComponentId:this.id,initiator:this,componentState:this.initialState,callbackToken:this.callbackToken},bubbles:!0,composed:!0})))),e.has("route")&&this.top&&(this.preventNavigation||this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:this.route},bubbles:!0,composed:!0}))),this.preventNavigation&&(this.preventNavigation=!1)}applyFragment(e){if(!e.component&&this.fragment?.component){this.fragment={...this.fragment,state:{...this.fragment.state??{},...e.state??{}},data:{...this.fragment.data??{},...e.data??{}}};return}this.fragment=e,e.component&&(this.dataset.pageWidth=Mc(e.component,{top:this.top}),this.dataset.pageType=Ys(e.component)??"",this.dataset.hasWelcomeBanner=String(jc(e.component)))}render(){return i`
  ...
  `;Ze([u()],Se.prototype,"baseUrl",2);Ze([u()],Se.prototype,"route",2);Ze([u()],Se.prototype,"consumedRoute",2);Ze([u()],Se.prototype,"config",2);Ze([u()],Se.prototype,"top",2);Ze([u()],Se.prototype,"pathPrefix",2);Ze([b()],Se.prototype,"instant",2);Ze([u({type:Boolean})],Se.prototype,"debug",2);Se=Ze([$("mateu-ui")],Se);var Kc=Object.defineProperty,Yc=Object.getOwnPropertyDescriptor,Dt=(e,t,r,a)=>{for(var s=a>1?void 0:a?Yc(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Kc(t,r,s),s};let Ee=class extends k{constructor(){super(...arguments),this.baseUrl="",this.opened=!1,this.searchText=""}connectedCallback(){super.connectedCallback(),fo()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick(),this.searchTimer&&clearTimeout(this.searchTimer)}currentValue(){return String(pa()[this.selector.fieldName]??"")}currentLabel(){const e=this.currentValue();if(!e)return"—";const t=(this.searchedOptions??this.selector.options)?.find(a=>String(a.value)===e);if(t)return t.label;const r=ts()[this.selector.fieldName];return r!==void 0?String(r):e}pick(e,t){ho(this.selector.fieldName,e,t),window.location.reload()}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}openPanel(){this.opened||(this.opened=!0,this.searchText="",this.searchedOptions=void 0,this.remoteSearch(),this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick),this.updateComplete.then(()=>this.renderRoot.querySelector("input.picker-search")?.focus()))}closePanel(){this.detachOutsideClick(),this.opened=!1}onSearchInput(e){this.searchText=e.target.value,this.searchTimer&&clearTimeout(this.searchTimer),this.searchTimer=setTimeout(()=>this.remoteSearch(),300)}async remoteSearch(){const e=this.app;if(e?.serverSideType)try{const t=await Tt.runAction(this.baseUrl??"",e.rootRoute??e.initialRoute??"","",`_appcontext-search-${this.selector.fieldName}`,`appcontext-${this.selector.fieldName}`,void 0,e.serverSideType,{},{searchText:this.searchText},this,!0);for(const r of t?.fragments??[]){const o=r.data?.[`_appcontext_${this.selector.fieldName}`]?.content;if(Array.isArray(o)){this.searchedOptions=o.map(n=>({value:n.value,label:n.label??String(n.value)}));return}}}catch{}}visibleOptions(){const e=this.searchedOptions??this.selector.options??[],t=this.searchText.trim().toLowerCase();return t?e.filter(r=>r.label.toLowerCase().includes(t)):e}renderPanel(){const e=this.currentValue(),t=this.visibleOptions(),r=this.searchText!==""||t.length>Ee.SEARCHABLE_THRESHOLD;return i`
            ...
            </label>`:i``}};Ee.SEARCHABLE_THRESHOLD=7;Ee.styles=x`
        :host {
            display: inline-flex;
            position: relative;
            flex-shrink: 0;
    ...
    `;wr([u()],Ot.prototype,"app",2);wr([u()],Ot.prototype,"baseUrl",2);wr([b()],Ot.prototype,"opened",2);wr([b()],Ot.prototype,"notifications",2);Ot=wr([$("mateu-notification-bell")],Ot);const Js=e=>{if(!e||!("querySelectorAll"in e))return null;for(const t of e.querySelectorAll("*")){if(t.tagName?.toLowerCase()==="mateu-component")return t;const r=Js(t.shadowRoot);if(r)return r}return null},Qc=async(e,t,r)=>{const a=t.renderRoot??t,s=Js(a);await Ws.runAction(Tt,t.baseUrl??"",e.rootRoute||"_no_route","",r,s?.id??"app-header-action",{},e.serverSideType??"",{},{},s??t,!0,void 0,!1,"")},qa=async(e,t,r)=>{try{await Qc(e,t,r)}catch(a){St({text:"La acción falló: "+a,position:"bottomStart",duration:6e3,variant:"error"},t)}},er=(e,t)=>{const r=e.contextSelectors??[],a=e.contextActions??[];return r.length===0&&a.length===0&&!e.notificationsEnabled?l:i`${e.notificationsEnabled?i`
        ...
        <details class="mateu-nav-group" style="margin-left: 0.5rem; flex-shrink: 0;">
            ...
            <div class="mateu-nav-panel" style="right: 0; left: auto;">
                ${s.children.map(o=>i`
                    <button class="mateu-nav-item" @click="${()=>o.actionId&&qa(e,t,o.actionId)}">${o.label}</button>`)}
            </div>
        </details>`:i`
        <button class="app-header-action-btn" style="margin-left: 0.5rem; flex-shrink: 0;"
            @click="${()=>s.actionId&&qa(e,t,s.actionId)}" title="${s.label}">${s.icon?H(s.icon):l}${s.label}</button>`)}`},Ha=(e,t)=>i`
    <button class="mateu-nav-item ${e.selected?"mateu-nav-item--active":""}"
            ?disabled="${e.disabled}"
            @click="${()=>t(e)}">${e.text}</button>`,Va=(e,t,r="")=>i`
    <nav class="mateu-nav ${r}">
        ${e.map(a=>(a.children?.length??0)>0?i`<details class="mateu-nav-group">
                       ...
                       <div class="mateu-nav-panel">
                           ${a.children.map(s=>Ha(s,t))}
                       </div>
                   </details>`:Ha(a,t))}
    </nav>`,Wa=(e,t)=>r=>t.call(e,{detail:{value:r}}),Cr=(e,t)=>e.themeToggle?i`
    ...
    `:l,Zc=(e,t)=>{t.filter!=e.detail.value&&(t.filter=e.detail.value)},Ga=(e,t,r)=>{const a=Ge(e,t,r),s=te(t,r);return a=="list"||a==s?"new":a},Ge=(e,t,r)=>{const a=e?._route;if(a!=null&&(a===""||a.startsWith("/"))){const s=r.homeRoute??"",o=s.indexOf("?"),n=o>=0?s.substring(o+1):"",d=te(t,r)+a;if(!n)return d;const c=d.indexOf("?")>=0?"&":"?";return d+c+n}return t.selectedRoute?t.selectedRoute:r.homeRoute},te=(e,t)=>e.selectedRoute?e.selectedConsumedRoute??t.route:t.homeConsumedRoute,Ae=(e,t)=>e.selectedRoute?e.selectedBaseUrl??e.baseUrl:t.homeBaseUrl,Re=(e,t)=>e.selectedRoute?e.selectedServerSideType??t.serverSideType:t.homeServerSideType,De=(e,t)=>e.selectedRoute?e.selectedUriPrefix:t.homeUriPrefix,Xs=(e,t,r,a,s,o,n)=>{if(t.chromeless)return i`
        ...
        `;const d=e.mapItems(t.menu,e.filter?.toLowerCase()??""),c=te(e,t),p=Ga(a,e,t),h=p&&p!=="new"&&p.startsWith(c+"/")?p.substring(c.length+1).split("/")[0]:void 0;return i`
...
`:l}
                            ...
                            ${t.menu&&t.totalMenuOptions>10?i`
                                <div style="position: sticky; top: 0; z-index: 2; background: var(--lumo-base-color); padding: .25rem 0 .5rem;">
                                    <input class="drawer-search" placeholder="Search…" style="width: calc(100% - 20px); margin: 0 10px;"
                                           @input="${f=>Zc({detail:{value:f.target.value}},e)}">
                                </div>
                                `:l}
                            <nav class="side-nav">
            ...
            ${t.variant==Ke.MENU_ON_TOP?i`
                <div class="m-vl" style="width: 100%; height: 100vh; overflow: hidden;">
                    <div class="m-hl"
                        ...
                        ${(()=>{const f=Wa(e,e.itemSelected);return U.get()?.renderTopNav?.(d,f,"menu-on-top")??Va(d,f,"menu-on-top")})()}
            ...
            ${t.variant==Ke.TILES?i`
                <div class="m-vl" style="width: 100%; height: 100vh; overflow: hidden;">
                    <div class="m-hl"
                        ...
                        ${Va(e.mapItemsForTiles(t.menu),Wa(e,e.itemSelectedTiles),"menu-on-top")}
                        <div class="m-hl" style="flex-shrink: 0; align-items: center;">
                            <slot name="widgets"></slot>
                            ${er(t,e)}${Cr(t,e)}
                        </div>
            ...
            <slot></slot>
       `},eu=(e,t)=>t!=null&&e!=null&&!e.has(t),tu=typeof HTMLElement<"u"?HTMLElement:class{};class ru extends tu{static get observedAttributes(){return["type","renderer"]}connectedCallback(){this.render()}attributeChangedCallback(){this.render()}render(){const t=this.getAttribute("type")??"unknown",r=this.getAttribute("renderer")??"unknown";this.shadowRoot||this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host { display: block; }
                .mateu-unsupported {
                    box-sizing: border-box;
        ...
        `}}typeof customElements<"u"&&!customElements.get("mateu-unsupported")&&customElements.define("mateu-unsupported",ru);const Ka=new Set,au=(e,t,r)=>{const a=`${r}/${t}`;return Ka.has(a)||(Ka.add(a),console.warn(`[mateu] Component type "${t}" is not supported by the "${r}" renderer — rendering <mateu-unsupported> placeholder.`)),i`<mateu-unsupported
            type="${t}"
            renderer="${r}"
            data-component-id="${e?.id??l}"
            slot="${e?.slot??l}"
    ></mateu-unsupported>`};class su{renderFilterBar(t,r,a,s,o,n,d,c){const p=r?.metadata,h=v=>{const{fieldId:y,value:C}=v.detail;t.state={...t.state,[y]:C}},f=v=>{const{fieldIds:y}=v.detail,C={};y.forEach(g=>{C[g]=void 0}),C.searchText=void 0,t.state={...t.state,...C}};return i`
            <mateu-filter-bar
                .metadata="${p}"
        ...
        ></mateu-pagination>
        `}renderTableComponent(t,r,a,s,o,n,d){const c=t.data?.[t.id]?.page?.content??[];return na(r,c,s[r?.id]?.emptyStateMessage)}rendererName(){return this.constructor?.name??"unknown"}supportedClientSideTypes(){}renderClientSideComponent(t,r,a,s,o,n,d,c){const p=r?.metadata?.type??r?.type,h=Object.values(m).includes(p)?p:void 0;return eu(this.supportedClientSideTypes(),h)?au(r,h,this.rendererName()):ka(t,r,a,s,o,n,d,c)}renderAppComponent(t,r,a,s,o,n,d){return Xs(t,r?.metadata,a,s,o,n,d)}}var ou=Object.defineProperty,iu=Object.getOwnPropertyDescriptor,ea=(e,t,r,a)=>{for(var s=a>1?void 0:a?iu(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&ou(t,r,s),s};let pr=class extends k{constructor(){super(...arguments),this.columns=[],this.rows=[],this.emptyMessage="",this.displayProps=[]}createRenderRoot(){return this}willUpdate(e){(e.has("columns")||e.has("rows"))&&this.rebuild()}rebuild(){const e=window;if(!e.__mateuJsonMetadataProvider||!e.__mateuArrayDataProvider)return;const t={};this.columns.forEach(a=>{t[a.id]={type:a.type,labelHint:a.label,sortable:"enabled",readonly:!0}}),this.provider=new e.__mateuJsonMetadataProvider({data:{properties:t}}),this.displayProps=this.columns.map(a=>a.id);const r=(this.rows??[]).map((a,s)=>{const o={__key:String(s)},n=a;return this.columns.forEach(d=>{const c=n?.[d.id];o[d.id]=c&&typeof c=="object"?c.text??c.label??c.value??"":c}),o});this.dp=new e.__mateuArrayDataProvider(r,{keyAttributes:"__key"})}onRowAction(e){const t=e.detail,r=t?.context?.key??t?.key,a=r!=null?Number(r):NaN,s=Number.isInteger(a)?this.rows?.[a]:void 0;s!=null&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:"view",parameters:s},bubbles:!0,composed:!0}))}render(){return this.rows?.length?!this.provider||!this.dp?i`<div style="padding:1rem;"></div>`:i`<oj-dynamic-table
      ...
      .readonly=${!0}
      style="width:100%;"
      @ojRowAction=${e=>this.onRowAction(e)}
    ></oj-dynamic-table>`:i`<div
        style="padding:1.5rem; text-align:center; color:var(--lumo-secondary-text-color,#888);"
      >
        ${this.emptyMessage||"No data."}
      </div>`}};ea([u({attribute:!1})],pr.prototype,"columns",2);ea([u({attribute:!1})],pr.prototype,"rows",2);ea([u()],pr.prototype,"emptyMessage",2);pr=ea([$("mateu-spectra-table")],pr);const nu={fixed:"fixedWidth",full:"fullWidth",edge:"edgeToEdge"},Ya=Symbol("pageLayoutSyncSetup");class lu extends Xa{constructor(t){if(super(t),t.type!==Qa.ELEMENT)throw new Error("pageLayoutSync is an element directive")}render(){return l}update(t){const r=t.element;if(r[Ya])return l;r[Ya]=!0;const a=()=>r.querySelector("mateu-ux"),s=()=>{const c=a()?.getAttribute("data-page-width"),p=c?nu[c]:void 0;p&&(r.pageLayout=p);const h=r.querySelector(".oj-sp-rw-ask-oracle-page-container");h&&p&&(p==="fullWidth"||p==="edgeToEdge"?(h.style.setProperty("--oj-sp-simple-uishell-max-content-width","100%"),h.style.setProperty("--oj-sp-simple-uishell-max-content-width-margin","0"),h.style.setProperty("--oj-sp-simple-uishell-max-content-width-padding",p==="edgeToEdge"?"0":"24px")):(h.style.removeProperty("--oj-sp-simple-uishell-max-content-width"),h.style.removeProperty("--oj-sp-simple-uishell-max-content-width-margin"),h.style.removeProperty("--oj-sp-simple-uishell-max-content-width-padding")))};let o,n=0;const d=setInterval(()=>{const c=a();c&&!o&&(o=new MutationObserver(s),o.observe(c,{attributes:!0,attributeFilter:["data-page-width"]}),s()),(o||++n>60)&&clearInterval(d)},250);return l}}const du=Ja(lu);var cu=Object.defineProperty,uu=Object.getOwnPropertyDescriptor,ta=(e,t,r,a)=>{for(var s=a>1?void 0:a?uu(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&cu(t,r,s),s};let mr=class extends k{constructor(){super(...arguments),this.menu=[],this.appTitle="",this.open=!1}createRenderRoot(){return this}disconnectedCallback(){super.disconnectedCallback(),this.closePalette()}updated(e){this.open&&!this.overlay&&this.openPalette(),!this.open&&this.overlay&&this.closePalette()}toMapTree(e,t="m"){const r=[];return e.forEach((a,s)=>{if(a.separator)return;const o=`${t}-${s}`;r.push({id:o,label:a.label??"",url:a.route??"",children:a.submenus?.length?this.toMapTree(a.submenus,o):[]})}),r}buildRootTree(){const e=(this.menu??[]).filter(s=>!s.separator),t=e.filter(s=>!s.submenus?.length),r=e.filter(s=>s.submenus?.length),a=[];return t.length&&a.push({id:"__general__",label:this.appTitle||"Menú",url:"",children:t.map((s,o)=>({id:`leaf-${o}`,label:s.label??"",url:s.route??"",children:[]}))}),r.forEach((s,o)=>{const n=`grp-${o}`;a.push({id:n,label:s.label??"",url:s.route??"",children:this.toMapTree(s.submenus??[],n)})}),a}navigate(e){this.open=!1,this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:e},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("navigate-to-requested",{detail:{route:e},bubbles:!0,composed:!0}))}openPalette(){const e=window.__mateuArrayTreeDataProvider;if(!e)return;const t=document.createElement("div");t.className="mateu-spectra-nav-overlay",t.setAttribute("style","position:fixed; inset:0; z-index:9999;");const r=document.createElement("button");r.setAttribute("aria-label","Close"),r.textContent="✕",r.setAttribute("style","position:fixed; top:1rem; right:1.25rem; z-index:10000; width:2.25rem; height:2.25rem; border:none; border-radius:50%; background:rgba(255,255,255,.15); color:#fff; font-size:1.1rem; cursor:pointer;"),r.addEventListener("click",()=>this.open=!1);const a=document.createElement("oj-sp-ask-oracle-product-map");a.setAttribute("style","display:block; width:100%; height:100%;"),a.data=new e(this.buildRootTree(),{keyAttributes:"id",childrenAttribute:"children"}),a.optionsKeys={label:"label",url:"url"},a.addEventListener("ojSpNavigate",s=>{const o=s.detail,n=o?.url??o?.data?.url??o?.item?.url??(typeof o=="string"?o:void 0);n&&this.navigate(n)}),t.append(a,r),document.body.appendChild(t),this.overlay=t,this._esc=s=>{s.key==="Escape"&&(this.open=!1)},document.addEventListener("keydown",this._esc)}closePalette(){this._esc&&document.removeEventListener("keydown",this._esc),this._esc=void 0,this.overlay?.remove(),this.overlay=void 0}render(){return i`
      <button
    ...
    `}};ta([u({attribute:!1})],mr.prototype,"menu",2);ta([u({attribute:!1})],mr.prototype,"appTitle",2);ta([b()],mr.prototype,"open",2);mr=ta([$("mateu-spectra-nav")],mr);function pu(e){const t=window.__mateuArrayDataProvider;return t?new t(e.map(r=>({value:r.value,label:r.label})),{keyAttributes:"value"}):void 0}function mu(e,t,r,a,s,o,n,d){const c=t.metadata,p=a,h=p&&c.fieldId in p?p[c.fieldId]:c.initialValue,f=h==null?"":String(h),v=(j,ue)=>{j==null||String(j)===f||ue?.dispatchEvent(new CustomEvent("value-changed",{detail:{fieldId:c.fieldId,value:j},bubbles:!0,composed:!0}))},y=c.label||c.fieldId,C=d||!c.label?"none":"top",g=t.slot??l;return c.readOnly||c.stereotype==="plainText"?i`<div class="mateu-rw-field-plain" slot=${g}>${f}</div>`:c.options?.length?i`<oj-c-select-single
      ...
      .value=${f}
      ?disabled=${!!c.disabled}
      @valueChanged=${j=>v(j.detail?.value,j.currentTarget)}
    ...
    ?disabled=${!!c.disabled}
    @valueChanged=${j=>v(j.detail?.value,j.currentTarget)}
  ></oj-c-input-text>`}function hu(e,t,r){const a=e.metadata,s=zt(a.label??"",t,r),o=a.buttonStyle==="primary"?"callToAction":a.buttonStyle==="tertiary"?"borderless":"outlined",n=d=>d.currentTarget?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:a.actionId,parameters:a.parameters},bubbles:!0,composed:!0}));return i`<oj-c-button
    id=${e.id??l}
    slot=${e.slot??l}
    label=${s}
    chroming=${o}
    ?disabled=${!!a.disabled}
    @ojAction=${n}
  ></oj-c-button>`}const Sa=(e,t,r,a,s,o,n)=>(t.children??[]).map(d=>w(e,d,r,a,s,o,n));function fu(e,t,r,a,s,o,n){const d=t.metadata,c=d.columns&&d.columns>0?`repeat(${d.columns}, minmax(0, 1fr))`:"repeat(auto-fit, minmax(20rem, 1fr))";return i`<div
    style="display:grid; grid-template-columns:${c}; gap:1rem; padding:1rem; align-items:start; width:100%; box-sizing:border-box;"
  >
    ${Sa(e,t,r,a,s,o,n)}
  </div>`}function vu(e,t,r,a,s,o,n){return i`<div class="mateu-rw-scoreboard" style="grid-column:1 / -1;">
    ${Sa(e,t,r,a,s,o,n)}
  </div>`}function bu(e,t,r,a,s,o,n){const d=t.metadata,c=[];return d.colSpan&&d.colSpan>1&&c.push(`grid-column: span ${d.colSpan}`),d.rowSpan&&d.rowSpan>1&&c.push(`grid-row: span ${d.rowSpan}`),i`<oj-sp-dashboard-panel
    class="mateu-rw-panel"
    .panelTitle=${d.title??""}
    .panelSubtitle=${d.subtitle??""}
    style=${c.length?c.join("; "):l}
    >${Sa(e,t,r,a,s,o,n)}</oj-sp-dashboard-panel
  >`}function gu(e,t){const r=t.metadata,a=`${r.value??""}${r.unit?" "+r.unit:""}`,s=r.trendLabel||r.description||"",o=r.trend==="up"?"success":r.trend==="down"?"danger":"neutral",n=`flex:1 1 12rem; min-width:12rem;${r.actionId?" cursor:pointer;":""}`,d=r.actionId?c=>c.currentTarget?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:r.actionId,parameters:{}},bubbles:!0,composed:!0})):void 0;return i`<oj-sp-scoreboard-metric-card
    style=${n}
    .cardTitle=${r.title??""}
    .metricText=${a}
    .metaText=${s}
    .trendColor=${o}
    @click=${d}
  ></oj-sp-scoreboard-metric-card>`}function yu(e,t){const r=t.metadata,a=r.badges??[],s=r.facts??[];return i`<div class="mateu-rw-entity-header">
    <div class="rw-eh-top">
  ...
  </div>`}function $u(e,t,r,a,s,o,n){const d=t.metadata,c=p=>p?w(e,p,r,a,s,o,n):l;return i`<div class="mateu-rw-card ${t.cssClasses||""}" style=${t.style||l}>
  ...
  </div>`}const xu=Symbol("ojListeners");class wu extends Xa{constructor(t){if(super(t),t.type!==Qa.ELEMENT)throw new Error("applyOj can only be used on an element binding")}render(t){return l}update(t,[r]){const a=t.element;for(const[o,n]of Object.entries(r.props??{}))n!==void 0&&(a[o]=n);for(const[o,n]of Object.entries(r.attrs??{}))n===void 0?a.removeAttribute(o):a.setAttribute(o,n);const s=a[xu]??={};for(const[o,n]of Object.entries(r.events??{})){const d=s[o];d&&a.removeEventListener(o,d),a.addEventListener(o,n),s[o]=n}return l}}const ku=Ja(wu);function Be(e,t){const r=oo(e);return so`<${r} ${ku({props:t.props,attrs:t.attrs,events:t.events})}>${t.children??l}</${r}>`}function _u(e,t,r,a,s,o,n){const d=t.metadata,c=t.children??[],p=c.find(y=>y.slot==="overview"),h=d.panels??[],f=y=>y?w(e,y,r,a,s,o,n):l,v=h.findIndex(y=>y.open!==!1);return Be("oj-sp-foldout-layout",{props:{orientation:d.orientation==="horizontal"?"horizontal":"vertical",selectedPanel:v>=0?v:0},attrs:{class:t.cssClasses||void 0,style:`min-height: 32rem; ${t.style||""}`},children:i`
      ${p?i`<div slot="overview">${f(p)}</div>`:l}
      ${h.map((y,C)=>Be("oj-sp-foldout-panel-summarizing",{props:{panelTitle:y.title??""},children:i`
            <div>${f(c.find(g=>g.slot===`panel-${C}`))}</div>
            ${y.subtitle?i`<div slot="summary">${y.subtitle}</div>`:l}
          `}))}
    `})}function Cu(e,t,r,a,s,o,n){const d=t.metadata,c=t.children??[];return Be("oj-sp-welcome-page",{props:{pageTitle:d.title??"",descriptionText:d.subtitle??"",illustrationBackground:d.image??void 0},attrs:{"display-options.responsive-padding":"on",class:t.cssClasses||void 0,style:t.style||void 0},children:c.length?i`<div class="oj-flex oj-sm-flex-wrap oj-sm-align-items-center" style="gap: 0.75rem;">
          ${c.map(p=>w(e,p,r,a,s,o,n))}
        </div>`:l})}function Su(e){const t=e.metadata,a=!!(t.actionId&&t.actionLabel)?{label:t.actionLabel,display:"on",type:"callToAction"}:null;return Be("oj-sp-empty-state",{props:{primaryText:t.title??"",secondaryText:t.description??"",primaryAction:a},attrs:{slot:e.slot||void 0,class:e.cssClasses||void 0,style:e.style||void 0},events:{spPrimaryAction:s=>{t.actionId&&s.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))}},children:l})}function Eu(e,t,r,a,s,o,n){const c=t.metadata.title??"",p=c.includes("${")?e._evalTemplate(c):c,h=t.children?.length?i`${t.children.map(f=>w(e,f,r,a,s,o,n))}`:l;return Be("oj-sp-section",{props:{sectionTitle:p,level:"section"},attrs:{slot:t.slot||void 0,class:t.cssClasses||void 0,style:t.style||void 0},children:h})}function Iu(e){const t=e.metadata,r=t.breadcrumbs??[],a=window.__mateuArrayDataProvider;if(!a)return i`<div style="display:flex; align-items:center; gap:0.5rem;" slot="${e.slot??l}">
      ${r.map(c=>i`<a href="${c.link??"#"}">${c.text}</a><span>/</span>`)}
      <span>${t.currentItemText}</span>
    </div>`;const s=r.slice().reverse(),o=[{id:"__current__",displayName:t.currentItemText},...s.map((c,p)=>({id:`c${p}`,displayName:c.text}))],n=new Map(s.map((c,p)=>[`c${p}`,c.link])),d=new a(o,{keyAttributes:"id"});return Be("oj-sp-breadcrumb-container",{props:{data:d},attrs:{slot:e.slot||void 0,class:e.cssClasses||void 0,style:e.style||void 0},events:{spAction:c=>{const p=c.detail?.id,h=p?n.get(p):void 0;if(!h)return;const f=c.target;f.dispatchEvent(new CustomEvent("route-changed",{detail:{route:h},bubbles:!0,composed:!0})),f.dispatchEvent(new CustomEvent("navigate-to-requested",{detail:{route:h},bubbles:!0,composed:!0}))}}})}function Pu(e){const t=e.metadata;return Be("oj-c-avatar",{props:{initials:t.abbreviation||void 0,src:t.image||void 0,size:"md"},attrs:{slot:e.slot||void 0,title:t.name||void 0,class:e.cssClasses||void 0,style:e.style||void 0}})}function Ou(e){const t=e.metadata,r=t.max&&t.max>0?t.max:100,a=t.indeterminate?-1:t.value??0;return Be("oj-c-progress-bar",{props:{value:a,max:r},attrs:{slot:e.slot||void 0,class:e.cssClasses||void 0,style:e.style||void 0}})}const Tu={success:"success",error:"danger",warning:"warning",contrast:"info",normal:"neutral"};function zu(e){const t=e.metadata,r=Tu[String(t.color??"normal")]??"neutral";return Be("oj-c-badge",{props:{label:t.text??"",variant:r,size:t.small?"sm":void 0},attrs:{slot:e.slot||void 0,class:e.cssClasses||void 0,style:e.style||void 0}})}function Au(e){const t=e.metadata,r=t.value??0,a=t.max&&t.max>0?t.max:100;let s;t.dangerAt!=null&&r>=t.dangerAt?s="#C74634":t.warnAt!=null&&r>=t.warnAt&&(s="#946f00");const o=[t.unit?`${r} ${t.unit}`:void 0,t.caption].filter(Boolean).join(" · ");return i`<div
    slot="${e.slot??l}"
    class="${e.cssClasses??l}"
    style="${e.style??""}"
  >
  ...
  </div>`}var Ru=Object.defineProperty,Du=Object.getOwnPropertyDescriptor,kr=(e,t,r,a)=>{for(var s=a>1?void 0:a?Du(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Ru(t,r,s),s};let Ht=class extends k{constructor(){super(...arguments),this.labels=[],this.panels=[],this.initialIndex=0,this.selected=0,this.seeded=!1}createRenderRoot(){return this}willUpdate(e){this.seeded||(this.selected=this.initialIndex??0,this.seeded=!0)}render(){const e=this.labels.map((t,r)=>({itemKey:r,label:t}));return i`
      <oj-c-tab-bar
        .data=${e}
        .selection=${this.selected}
        layout="stretch"
        @ojSelectionAction=${t=>{const r=t.detail?.value;typeof r=="number"&&(this.selected=r)}}
      ></oj-c-tab-bar>
      <div style="padding-top: var(--lumo-space-m, 1rem);">${this.panels[this.selected]}</div>
    `}};kr([u({attribute:!1})],Ht.prototype,"labels",2);kr([u({attribute:!1})],Ht.prototype,"panels",2);kr([u({attribute:!1})],Ht.prototype,"initialIndex",2);kr([b()],Ht.prototype,"selected",2);Ht=kr([$("mateu-spectra-tabs")],Ht);function Lu(e,t,r,a,s,o,n){const d=t.children??[],c=v=>v.includes("${")?e._evalTemplate(v):v,p=d.map(v=>c(v.metadata.label??"")),h=Math.max(0,d.findIndex(v=>v.metadata.active)),f=d.map(v=>i`${v.children?.map(y=>w(e,y,r,a,s,o,n))}`);return i`<div
    slot="${t.slot??l}"
    class="${t.cssClasses??l}"
    style="${t.style??""}"
  >
    <mateu-spectra-tabs .labels=${p} .panels=${f} .initialIndex=${h}></mateu-spectra-tabs>
  </div>`}var ju=Object.defineProperty,Uu=Object.getOwnPropertyDescriptor,Ea=(e,t,r,a)=>{for(var s=a>1?void 0:a?Uu(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&ju(t,r,s),s};let Hr=class extends k{constructor(){super(...arguments),this.fields=[],this.value={}}createRenderRoot(){return this}willUpdate(e){e.has("fields")&&this.rebuild()}rebuild(){const e=window.__mateuJsonMetadataProvider;if(!e)return;const t={};this.fields.forEach(r=>{t[r.id]={type:r.type,labelHint:r.label,required:!!r.required,readonly:!!r.readOnly}}),this.provider=new e({data:{properties:t}})}onValueChanged(e){const t=e.detail?.value;t&&this.fields.forEach(r=>{const a=t[r.id];a!==this.value?.[r.id]&&this.dispatchEvent(new CustomEvent("value-changed",{detail:{fieldId:r.id,value:a},bubbles:!0,composed:!0}))})}render(){return this.provider?i`<oj-dynamic-form
      .metadata=${this.provider}
      .value=${this.value}
      .displayProperties=${this.fields.map(e=>e.id)}
      operation="edit"
      label-edge="top"
      max-columns="2"
      style="width:100%;"
      @valueChanged=${e=>this.onValueChanged(e)}
    ></oj-dynamic-form>`:i`<div></div>`}};Ea([u({attribute:!1})],Hr.prototype,"fields",2);Ea([u({attribute:!1})],Hr.prototype,"value",2);Hr=Ea([$("mateu-spectra-form")],Hr);const Mu=new Set(["string","integer","number","double","money","boolean","date","datetime","date-time"]),Nu={integer:"integer",number:"number",double:"number",money:"number",boolean:"boolean",date:"date",datetime:"date-time","date-time":"date-time"},Fu=new Set(["","regular","plainText","money"]);function Bu(e){const t=[],r={};let a=!0;const s=o=>{for(const n of o??[]){if(!a)return;const d=n.metadata?.type??n.type;if(d==="FormField"){const c=n.metadata;if(!!c.stereotype&&!Fu.has(c.stereotype)||(c.options?.length??0)>0||(c.columns?.length??0)>0||c.createForm||c.editor||!Mu.has(c.dataType??"string")){a=!1;return}t.push({id:c.fieldId,label:c.label||c.fieldId,type:Nu[c.dataType??"string"]??"string",required:c.required,readOnly:c.readOnly}),r[c.fieldId]=c.initialValue}else if(d==="FormRow"||d==="FormLayout"||d==="VerticalLayout"||d==="HorizontalLayout")s(n.children);else{a=!1;return}}};return s(e),{fields:t,values:r,flat:a}}function qu(e,t,r,a,s,o,n){const{fields:d,values:c,flat:p}=Bu(t.children);if(!p||d.length===0)return ms(e,t,r,a,s,o,n);const h=a,f={};return d.forEach(v=>{f[v.id]=h&&v.id in h?h[v.id]:c[v.id]}),i`<div slot="${t.slot??l}" style="width:100%; ${t.style??""}" class="${t.cssClasses??l}">
    <mateu-spectra-form .fields=${d} .value=${f}></mateu-spectra-form>
  </div>`}const Hu={[m.FormField]:(e,t,r,a,s,o,n,d)=>mu(e,t,r,a,s,o,n,d),[m.Button]:(e,t,r,a,s)=>hu(t,a,s),[m.DashboardLayout]:(e,t,r,a,s,o,n)=>fu(e,t,r,a,s,o,n),[m.Scoreboard]:(e,t,r,a,s,o,n)=>vu(e,t,r,a,s,o,n),[m.DashboardPanel]:(e,t,r,a,s,o,n)=>bu(e,t,r,a,s,o,n),[m.MetricCard]:(e,t)=>gu(e,t),[m.EntityHeader]:(e,t)=>yu(e,t),[m.Card]:(e,t,r,a,s,o,n)=>$u(e,t,r,a,s,o,n),[m.FoldoutLayout]:(e,t,r,a,s,o,n)=>_u(e,t,r,a,s,o,n),[m.HeroSection]:(e,t,r,a,s,o,n)=>Cu(e,t,r,a,s,o,n),[m.EmptyState]:(e,t)=>Su(t),[m.FormSection]:(e,t,r,a,s,o,n)=>Eu(e,t,r,a,s,o,n),[m.Breadcrumbs]:(e,t)=>Iu(t),[m.Avatar]:(e,t)=>Pu(t),[m.ProgressBar]:(e,t)=>Ou(t),[m.Badge]:(e,t)=>zu(t),[m.Meter]:(e,t)=>Au(t),[m.TabLayout]:(e,t,r,a,s,o,n)=>Lu(e,t,r,a,s,o,n),[m.FormLayout]:(e,t,r,a,s,o,n)=>qu(e,t,r,a,s,o,n)};class Vu extends su{rendererName(){return"redwood"}renderClientSideComponent(t,r,a,s,o,n,d,c){const p=r?.metadata?.type??r?.type,h=Object.values(m).includes(p)?p:void 0,f=h?Hu[h]:void 0;return f&&r?f(t,r,a,s,o,n,d,c):super.renderClientSideComponent(t,r,a,s,o,n,d,c)}renderAppComponent(t,r,a,s,o,n,d){const c=r?.metadata;if(!c)return super.renderAppComponent(t,r,a,s,o,n,d);if(c.chromeless)return super.renderAppComponent(t,r,a,s,o,n,d);const p=Xs(t,{...c,chromeless:!0},a,s,o,n,d),h=c.homeRoute||c.route||"",f=v=>{const y=v.currentTarget;y.dispatchEvent(new CustomEvent("route-changed",{detail:{route:h},bubbles:!0,composed:!0})),y.dispatchEvent(new CustomEvent("navigate-to-requested",{detail:{route:h},bubbles:!0,composed:!0}))};return i`
      <oj-sp-simple-ui-shell ${du()}>
        <oj-sp-global-header slot="globalHeader" @ojSpHomeClick=${f}>
          <span
            slot="start"
    ...
    `}rendersCrudLayouts(){return!0}renderTableComponent(t,r,a,s,o,n,d){const c=t.data?.[t.id]?.page?.content??[],p=Gu(r,c),h=s?.[r?.id??""]?.emptyStateMessage;return i`<mateu-spectra-table
      .columns=${p}
      .rows=${c}
      .emptyMessage=${h??""}
    ></mateu-spectra-table>`}renderToolbarButton(t,r,a){return i`<oj-c-button
      label=${r}
      chroming="outlined"
      @ojAction=${()=>a()}
    ></oj-c-button>`}renderIcon(t,r,a){const s=(t||"").replace(/^(vaadin|lumo):/,""),o=Wu[s];return i`<span class="mateu-icon ${a??""}" data-icon="${t}" aria-hidden="true"
                      style="display:inline-flex; align-items:center; justify-content:center; width:1em; height:1em; line-height:1; ${r??""}"
                >${o??"•"}</span>`}}const Wu={menu:"☰",search:"🔍","sun-o":"☀",moon:"🌙","comments-o":"💬",comment:"💬",plus:"+",minus:"−",check:"✓",close:"✕",edit:"✎",trash:"🗑",dashboard:"▦",bell:"🔔",user:"👤",cog:"⚙",filter:"≡",download:"⤓",upload:"⤑",refresh:"↻","angle-left":"‹","angle-right":"›","angle-down":"⌄","angle-up":"⌃",ellipsis:"⋯","ellipsis-dots-v":"⋮"};function Gu(e,t){const r=e?.metadata,a=r?.content??r?.columns??[],s=t?.[0]??{};return a.filter(o=>o&&o.metadata).map(o=>{const n=o.id??"",d=o.metadata?.label??n,c=s?.[n];let p="string";return typeof c=="number"?p=Number.isInteger(c)?"integer":"number":typeof c=="boolean"&&(p="boolean"),{id:n,label:d,type:p}})}U.set(new Vu);U.setUseShadowRoot(!1);
