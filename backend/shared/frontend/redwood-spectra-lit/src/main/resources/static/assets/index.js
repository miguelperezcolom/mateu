...
import{S as Ks,a as Ys,n as ke,b as Js}from"./vendor.js";import{i as $,n as u,e as Ie,a as C,b as i,t as x,A as l,o as Ue,r as b,c as D,w as K,d as Xs,D as Qs,f as Wa,g as Ga,h as Ka,u as Zs,s as eo}from"./vendor-lit.js";import{_ as xe}from"./mateu-redwood-spectra.js";import"./vendor-vaadin.js";const yt=new Ks,G={value:{}},Cr={value:{}},pr=$`
  [theme~='badge'] {
    display: inline-flex;
    align-items: center;
...
`,to={lon:0,lat:0},Ca=3,ro=e=>{if(!e)return;const t=e.split(",").map(s=>s.trim());if(t.length!==2)return;const r=Number(t[0]),a=Number(t[1]);if(!(t[0]===""||t[1]===""||!Number.isFinite(r)||!Number.isFinite(a)))return{lon:a,lat:r}},ao=e=>{if(e==null||e.trim()==="")return Ca;const t=Number(e);return Number.isFinite(t)?t:Ca};var so=Object.defineProperty,oo=Object.getOwnPropertyDescriptor,qr=(e,t,r,a)=>{for(var s=a>1?void 0:a?oo(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&so(t,r,s),s};let Mt=class extends C{constructor(){super(...arguments),this.renderSeq=0}updated(e){super.updated(e),this.createMap()}disconnectedCallback(){super.disconnectedCallback(),this.map?.setTarget(void 0),this.map=void 0}async createMap(){const e=++this.renderSeq,[{default:t},{default:r},{default:a},{default:s},{fromLonLat:o},{default:n}]=await Promise.all([xe(()=>import("./vendor-ol.js").then(c=>c.M),[]),xe(()=>import("./vendor-ol.js").then(c=>c.V),[]),xe(()=>import("./vendor-ol.js").then(c=>c.T),[]),xe(()=>import("./vendor-ol.js").then(c=>c.O),[]),xe(()=>import("./vendor-ol.js").then(c=>c.p),[]),xe(()=>import("./vendor-ol.js").then(c=>c.o),[])]);if(e!==this.renderSeq||!this.isConnected)return;if(!this.shadowRoot.querySelector("style[data-ol]")){const c=document.createElement("style");c.setAttribute("data-ol",""),c.textContent=n,this.shadowRoot.appendChild(c)}this.map&&(this.map.setTarget(void 0),this.map=void 0);const d=ro(this.position)??to;this.map=new t({target:this.mapElement,layers:[new a({source:new s})],view:new r({center:o([d.lon,d.lat]),zoom:ao(this.zoom)})})}render(){return i`<div id="map"></div>`}};Mt.styles=$`
    ...
    `},this.renderPeerNav=e=>{const t=j.get()?.renderPeerNav?.(e);return t||i`
        ...
        ${pr}
    `;At([u()],Ye.prototype,"metadata",2);At([u()],Ye.prototype,"baseUrl",2);At([u()],Ye.prototype,"state",2);At([u()],Ye.prototype,"data",2);At([u()],Ye.prototype,"appState",2);At([u()],Ye.prototype,"appData",2);Ye=At([x("mateu-content-header")],Ye);var Oo=Object.defineProperty,To=Object.getOwnPropertyDescriptor,mr=(e,t,r,a)=>{for(var s=a>1?void 0:a?To(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Oo(t,r,s),s};let xt=class extends da{constructor(){super(...arguments),this.state={},this.data={},this.appState={},this.appData={}}render(){const e=this.component?.metadata;return i`
    ...
    `;ca([u()],or.prototype,"variant",2);ca([u({type:Number})],or.prototype,"count",2);or=ca([x("mateu-skeleton")],or);const Lo=(e,t)=>{t&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},tr=(e,t,r,a,s,o)=>i`
    ...
    `},Ro=e=>{const t=e.metadata;return i`
        <mateu-skeleton
    ...
    `},Di=e=>{const t=e.metadata;return H(t.icon,e.style,e.cssClasses,e.slot)},Zr=(e,t)=>{e&&e.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t},bubbles:!0,composed:!0}))},ps="font:inherit; font-weight:500; cursor:pointer; padding:.45rem 1rem; border-radius:var(--lumo-border-radius-m,6px);",Ta=`${ps} background:var(--lumo-contrast-5pct,rgba(0,0,0,.04)); color:var(--lumo-body-text-color,#161513); border:1px solid var(--lumo-contrast-20pct,rgba(0,0,0,.16));`,Ri=`${ps} background:var(--lumo-primary-color,#3b5bdb); color:var(--lumo-primary-contrast-color,#fff); border:1px solid transparent;`,Ui=(e,t,r,a,s,o,n)=>{const d=t.metadata;let c=!1;if(d.openedCondition)try{c=Za(d.openedCondition,a,s,o,n)}catch(p){console.error("when evaluating "+d.openedCondition+" :"+p+", where data is "+s+" and state is "+a)}return c?i`
        <div class="mateu-confirm-dialog ${t.cssClasses??""}"
            ...
            <div style="background:var(--lumo-base-color,#fff); color:var(--lumo-body-text-color,#161513); border-radius:var(--lumo-border-radius-l,12px); box-shadow:var(--lumo-box-shadow-l,0 8px 24px rgba(0,0,0,.2)); width:100%; max-width:min(90vw,32rem); padding:1.5rem; box-sizing:border-box;">
                ...
                <div style="display:flex; gap:.5rem; justify-content:flex-end; margin-top:1.25rem;">
                    ${d.canCancel?i`<button style="${Ta}" @click="${p=>Zr(p.currentTarget,d.cancelActionId)}">${d.rejectText&&!d.canReject?d.rejectText:"Cancel"}</button>`:l}
                    ${d.canReject?i`<button style="${Ta}" @click="${p=>Zr(p.currentTarget,d.rejectActionId)}">${d.rejectText||"No"}</button>`:l}
                    <button style="${Ri}" @click="${p=>Zr(p.currentTarget,d.confirmActionId)}">${d.confirmText||"OK"}</button>
                </div>
            </div>
        </div>
    ...
    `},tn=(e,t,r)=>{r.dispatchEvent(new CustomEvent("value-changed",{detail:{fieldId:e,value:t},bubbles:!0,composed:!0}))},wr=e=>t=>{const r=t.target,a=r.type==="checkbox"?r.checked:r.value;tn(e.fieldId,a,r)},rn=(e,t)=>{const r=e.metadata,a=t?.[r.fieldId]??"",s=r,o=s.dataType,n=s.stereotype,d=!!s.readOnly,c=!!s.disabled,p=s.options,h=r.label?i`<label style="display:block; font-size: var(--lumo-font-size-s,.875rem); color: var(--lumo-secondary-text-color,#667); margin-bottom:.15rem;">${r.label}</label>`:l,f="width:100%; box-sizing:border-box; padding:.4rem .6rem; border:1px solid var(--lumo-contrast-30pct,rgba(0,0,0,.3)); border-radius: var(--lumo-border-radius-m,6px); font:inherit; background: var(--lumo-base-color,#fff); color: var(--lumo-body-text-color,#1a1a1a);";let v;return d||n==="plainText"?v=i`<div style="padding:.4rem 0;">${String(a??"")}</div>`:o==="boolean"||n==="checkbox"||n==="badge"?v=i`<input type="checkbox" ?checked="${!!a}" ?disabled="${c}" @change="${wr(r)}">`:p&&p.length?v=i`
            <select style="${f}" ?disabled="${c}" @change="${wr(r)}">
                <option value="">—</option>
                ${p.map(y=>i`<option value="${y.value}" ?selected="${y.value===a}">${y.label}</option>`)}
            </select>`:n==="textarea"||n==="richText"||n==="html"?v=i`<textarea style="${f}" rows="3" ?disabled="${c}" @input="${wr(r)}">${String(a??"")}</textarea>`:v=i`<input type="${o==="integer"||o==="number"||o==="double"||o==="money"?"number":o==="date"?"date":o==="datetime"?"datetime-local":o==="time"?"time":n==="password"?"password":o==="email"?"email":"text"}" style="${f}" .value="${String(a??"")}"
                              placeholder="${s.placeholder??l}" ?disabled="${c}" @input="${wr(r)}">`,i`
        <div style="${e.style}" class="${e.cssClasses}" slot="${e.slot??l}">
            ${h}
            ${v}
        </div>
    `},sa=(e,t,r,a,s,o,n,d)=>{const c=t.metadata,p=c?.fabs??[];return i`<mateu-page
            .component="${t}"
            baseUrl="${r}"
            .state="${a}"
            .data="${s}"
...
`)}
    ...
    `},oa=(e,t,r,a,s,o,n,d)=>i`<mateu-table-crud
            id="${t.id}"
            baseUrl="${r}"
            .component="${t}"
            .metadata="${t.metadata}"
...
`,ln=e=>e=="up"?"var(--lumo-success-text-color, #1a7f37)":e=="down"?"var(--lumo-error-text-color, #c5221f)":"var(--lumo-secondary-text-color, #666)",dn=e=>e=="up"?"▲":e=="down"?"▼":"",cn=(e,t)=>{t.actionId&&e.target?.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:t.actionId},bubbles:!0,composed:!0}))},un=e=>{const t=e.metadata,r=!!t.actionId;return i`
    ...
    `};var yn=Object.defineProperty,$n=Object.getOwnPropertyDescriptor,ha=(e,t,r,a)=>{for(var s=a>1?void 0:a?$n(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&yn(t,r,s),s};const ea=1440*60*1e3;let ir=class extends C{constructor(){super(...arguments),this.tasks=[],this.onTaskSelectionActionId=""}selectTask(e){this.onTaskSelectionActionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.onTaskSelectionActionId,parameters:{_clickedTaskId:e.id}},bubbles:!0,composed:!0}))}range(){const e=this.tasks.flatMap(t=>[t.start,t.end]).filter(t=>!!t).map(t=>new Date(t+"T00:00:00").getTime());return e.length?{min:Math.min(...e)-ea,max:Math.max(...e)+2*ea}:null}months(e,t){const r=[],a=new Date(e);for(a.setDate(1);a.getTime()<=t;){const s=Math.max(a.getTime(),e),o=new Date(a.getFullYear(),a.getMonth()+1,1),n=Math.min(o.getTime(),t);r.push({label:a.toLocaleDateString(void 0,{month:"short",year:"2-digit"}),from:s,to:n}),a.setMonth(a.getMonth()+1)}return r}render(){const e=this.range();if(!e)return i``;const t=e.max-e.min,r=s=>(s-e.min)/t*100,a=Date.now();return i`
            <div class="frame">
                ...
                ${this.tasks.map(s=>{const o=new Date(s.start+"T00:00:00").getTime(),n=new Date(s.end+"T00:00:00").getTime()+ea;return i`
    ...
    `;ha([u({type:Array})],ir.prototype,"tasks",2);ha([u()],ir.prototype,"onTaskSelectionActionId",2);ir=ha([x("mateu-gantt")],ir);const xn=e=>{const t=e.metadata;return i`
        <mateu-gantt
                .tasks="${t.tasks??[]}"
    ...
    `;ut([u({type:Array})],L.prototype,"resources",2);ut([u({type:Array})],L.prototype,"blocks",2);ut([u()],L.prototype,"from",2);ut([u()],L.prototype,"to",2);ut([u()],L.prototype,"moveActionId",2);ut([u()],L.prototype,"selectActionId",2);ut([b()],L.prototype,"drag",2);L=ut([x("mateu-planning-board")],L);const Cn=e=>{const t=e.metadata;return i`
        <mateu-planning-board
                ...
                slot="${e.slot??l}"
        ></mateu-planning-board>
    `};var _n=Object.defineProperty,Sn=Object.getOwnPropertyDescriptor,fs=(e,t,r,a)=>{for(var s=a>1?void 0:a?Sn(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&_n(t,r,s),s};let Sr=class extends C{constructor(){super(...arguments),this.columns=[]}clickCard(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedCard:e}},bubbles:!0,composed:!0}))}render(){return i`
            <div class="board">
    ...
    `;fs([u({type:Array})],Sr.prototype,"columns",2);Sr=fs([x("mateu-kanban")],Sr);const En=e=>{const t=e.metadata;return i`
        <mateu-kanban
                .columns="${t.columns??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-kanban>
    `};var In=Object.defineProperty,Pn=Object.getOwnPropertyDescriptor,vs=(e,t,r,a)=>{for(var s=a>1?void 0:a?Pn(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&In(t,r,s),s};let Er=class extends C{constructor(){super(...arguments),this.items=[]}clickItem(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedItem:e}},bubbles:!0,composed:!0}))}render(){return i`
            <div class="feed">
                ${this.items.map(e=>i`
    ...
    `;vs([u({type:Array})],Er.prototype,"items",2);Er=vs([x("mateu-timeline")],Er);const On=e=>{const t=e.metadata;return i`
        <mateu-timeline
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-timeline>
    `};var Tn=Object.defineProperty,zn=Object.getOwnPropertyDescriptor,fa=(e,t,r,a)=>{for(var s=a>1?void 0:a?zn(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Tn(t,r,s),s};let nr=class extends C{constructor(){super(...arguments),this.steps=[],this.vertical=!1}render(){return i`
            <div class="steps">
    ...
    `;fa([u({type:Array})],nr.prototype,"steps",2);fa([u({type:Boolean,reflect:!0})],nr.prototype,"vertical",2);nr=fa([x("mateu-progress-steps")],nr);const An=e=>{const t=e.metadata;return i`
    ...
    `;pt([u()],je.prototype,"label",2);pt([u()],je.prototype,"value",2);pt([u()],je.prototype,"unit",2);pt([u()],je.prototype,"delta",2);pt([u()],je.prototype,"trend",2);pt([u({type:Array})],je.prototype,"spark",2);pt([u()],je.prototype,"actionId",2);je=pt([x("mateu-stat")],je);const Rn=e=>{const t=e.metadata;return i`
        <mateu-stat
                label="${t.label??l}"
                value="${t.value??l}"
                unit="${t.unit??l}"
    ...
    `;va([u()],lr.prototype,"month",2);va([u({type:Array})],lr.prototype,"events",2);lr=va([x("mateu-calendar")],lr);const Mn=e=>{const t=e.metadata;return i`
        <mateu-calendar
                month="${t.month??l}"
                .events="${t.events??[]}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-calendar>
    `};var Nn=Object.defineProperty,Fn=Object.getOwnPropertyDescriptor,bs=(e,t,r,a)=>{for(var s=a>1?void 0:a?Fn(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Nn(t,r,s),s};let Ir=class extends C{constructor(){super(...arguments),this.plans=[]}cta(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId},bubbles:!0,composed:!0}))}render(){return i`
            <div class="plans">
                ${this.plans.map(e=>i`
    ...
    `;bs([u({type:Array})],Ir.prototype,"plans",2);Ir=bs([x("mateu-pricing-table")],Ir);const Bn=e=>{const t=e.metadata;return i`
        <mateu-pricing-table
                .plans="${t.plans??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-pricing-table>
    `};var qn=Object.defineProperty,Hn=Object.getOwnPropertyDescriptor,gs=(e,t,r,a)=>{for(var s=a>1?void 0:a?Hn(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&qn(t,r,s),s};let Pr=class extends C{clickNode(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{_clickedNode:e}},bubbles:!0,composed:!0}))}renderNode(e){const t=e.avatar,r=t&&(t.startsWith("http")||t.startsWith("data:"));return i`
            <li>
        ...
        `}render(){return this.root?i`<div class="tree"><ul>${this.renderNode(this.root)}</ul></div>`:i``}};Pr.styles=$`
        :host {
            display: block;
            width: 100%;
            overflow-x: auto;
    ...
    `;gs([u({attribute:!1})],Pr.prototype,"root",2);Pr=gs([x("mateu-org-chart")],Pr);const Vn=e=>{const t=e.metadata;return i`
        <mateu-org-chart
                .root="${t.root}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;ys([u({type:Array})],Or.prototype,"cells",2);Or=ys([x("mateu-heatmap")],Or);const Yn=e=>{const t=e.metadata;return i`
        <mateu-heatmap
                .cells="${t.cells??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
                slot="${e.slot??l}"
        ></mateu-heatmap>
    `};var Jn=Object.defineProperty,Xn=Object.getOwnPropertyDescriptor,$s=(e,t,r,a)=>{for(var s=a>1?void 0:a?Xn(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Jn(t,r,s),s};let Tr=class extends C{constructor(){super(...arguments),this.stages=[]}render(){const e=this.stages;if(!e.length)return i``;const t=e[0].value??0,r=Math.max(...e.map(a=>a.value??0),1);return i`
            <div class="funnel">
    ...
    `;$s([u({type:Array})],Tr.prototype,"stages",2);Tr=$s([x("mateu-funnel")],Tr);const Qn=e=>{const t=e.metadata;return i`
        <mateu-funnel
                .stages="${t.stages??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;ba([u({type:Array})],dr.prototype,"features",2);ba([u({type:Number})],dr.prototype,"columns",2);dr=ba([x("mateu-feature-grid")],dr);const sl=e=>{const t=e.metadata;return i`
        <mateu-feature-grid
                .features="${t.features??[]}"
                .columns="${t.columns??0}"
                style="${e.style??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-feature-grid>
    `};var ol=Object.defineProperty,il=Object.getOwnPropertyDescriptor,xs=(e,t,r,a)=>{for(var s=a>1?void 0:a?il(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&ol(t,r,s),s};let zr=class extends C{constructor(){super(...arguments),this.items=[]}stars(e){const t=Math.max(0,Math.min(5,e||0));return"★".repeat(t)+"☆".repeat(5-t)}render(){return i`
            <div class="grid">
    ...
    `;xs([u({type:Array})],zr.prototype,"items",2);zr=xs([x("mateu-testimonials")],zr);const nl=e=>{const t=e.metadata;return i`
        <mateu-testimonials
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;ga([u({type:Array})],cr.prototype,"items",2);ga([b()],cr.prototype,"openSet",2);cr=ga([x("mateu-faq")],cr);const cl=e=>{const t=e.metadata;return i`
        <mateu-faq
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;Lt([u()],Je.prototype,"heading",2);Lt([u()],Je.prototype,"description",2);Lt([u()],Je.prototype,"icon",2);Lt([u()],Je.prototype,"ctaLabel",2);Lt([u()],Je.prototype,"actionId",2);Lt([u()],Je.prototype,"theme",2);Je=Lt([x("mateu-callout-card")],Je);const ml=e=>{const t=e.metadata;return i`
        <mateu-callout-card
                heading="${t.title??l}"
                ...
                slot="${e.slot??l}"
        ></mateu-callout-card>
    `};var hl=Object.defineProperty,fl=Object.getOwnPropertyDescriptor,ws=(e,t,r,a)=>{for(var s=a>1?void 0:a?fl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&hl(t,r,s),s};let Ar=class extends C{constructor(){super(...arguments),this.comments=[]}renderComment(e){const t=e.avatar&&(e.avatar.startsWith("http")||e.avatar.startsWith("data:"));return i`
            <div class="comment">
        ...
        `}render(){return i`<div class="thread">${this.comments.map(e=>this.renderComment(e))}</div>`}};Ar.styles=$`
        :host { display: block; width: 100%; font-size: var(--lumo-font-size-s, .875rem); }
    ...
    `;ws([u({type:Array})],Ar.prototype,"comments",2);Ar=ws([x("mateu-comment-thread")],Ar);const vl=e=>{const t=e.metadata;return i`
...
`,El=new Intl.NumberFormat("de-DE",{minimumFractionDigits:2,maximumFractionDigits:2}),ia=e=>El.format(e),Dr=(e,t)=>{const r=e<0?"-":"",a=ia(Math.abs(e));return t?`${r}${t} ${a}`:`${r}${a}`},Il=(e,t)=>t?`${ia(e)} ${t}`:ia(e);var Pl=Object.defineProperty,Ol=Object.getOwnPropertyDescriptor,ht=(e,t,r,a)=>{for(var s=a>1?void 0:a?Ol(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Pl(t,r,s),s};let Ne=class extends C{constructor(){super(...arguments),this.title="",this.badges=[],this.facts=[]}render(){const e=!!(this.metricLabel||this.metricValue||this.metricCaption);return i`
    ...
    `;ft([u()],Fe.prototype,"label",2);ft([u({type:Number})],Fe.prototype,"value",2);ft([u({type:Number})],Fe.prototype,"max",2);ft([u()],Fe.prototype,"unit",2);ft([u()],Fe.prototype,"caption",2);ft([u({type:Number})],Fe.prototype,"warnAt",2);ft([u({type:Number})],Fe.prototype,"dangerAt",2);Fe=ft([x("mateu-meter")],Fe);const Ll=e=>{const t=e.metadata;return i`
        <mateu-meter
                ...
                slot="${e.slot??l}"
        ></mateu-meter>
    `};var Dl=Object.defineProperty,Rl=Object.getOwnPropertyDescriptor,Kt=(e,t,r,a)=>{for(var s=a>1?void 0:a?Rl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Dl(t,r,s),s};let nt=class extends C{constructor(){super(...arguments),this.total=0,this.done=0}runAction(){this.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:this.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){const e=this.total>0&&this.done>=this.total,t=!e&&!!this.actionLabel&&!!this.actionId;return i`
    ...
    `];vr([u({type:Array})],Ct.prototype,"items",2);vr([u({type:Boolean})],Ct.prototype,"compact",2);vr([u({type:Boolean})],Ct.prototype,"frameless",2);vr([u()],Ct.prototype,"rowActionId",2);Ct=vr([x("mateu-status-list")],Ct);const Nl=e=>{const t=e.metadata;return i`
        <mateu-status-list
                .items="${t.items??[]}"
                ?compact="${t.compact??!1}"
                ...
                slot="${e.slot??l}"
        ></mateu-status-list>
    `};var Fl=Object.defineProperty,Bl=Object.getOwnPropertyDescriptor,Cs=(e,t,r,a)=>{for(var s=a>1?void 0:a?Bl(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Fl(t,r,s),s};let Rr=class extends C{constructor(){super(...arguments),this.items=[]}render(){return i`
            <ul>
    ...
    `;Cs([u({type:Array})],Rr.prototype,"items",2);Rr=Cs([x("mateu-bulleted-list")],Rr);const ql=e=>{const t=e.metadata;return i`
        <mateu-bulleted-list
                .items="${t.items??[]}"
                style="${e.style??l}"
                class="${e.cssClasses??l}"
    ...
    `;br([u()],_t.prototype,"currency",2);br([u()],_t.prototype,"totalLabel",2);br([u({type:Array})],_t.prototype,"lines",2);br([u({type:Number})],_t.prototype,"total",2);_t=br([x("mateu-ledger")],_t);const dd=e=>{const t=e.metadata;return i`
        <mateu-ledger
                .currency="${t.currency}"
                .totalLabel="${t.totalLabel}"
                .lines="${t.lines??[]}"
    ...
    `;Qe([u()],_e.prototype,"actionId",2);Qe([u()],_e.prototype,"methodActionId",2);Qe([u({type:Array})],_e.prototype,"methods",2);Qe([u()],_e.prototype,"selected",2);Qe([u()],_e.prototype,"contextLabel",2);Qe([u()],_e.prototype,"contextValue",2);Qe([u()],_e.prototype,"confirmLabel",2);Qe([b()],_e.prototype,"selectedId",2);_e=Qe([x("mateu-payment-picker")],_e);const pd=e=>{const t=e.metadata;return i`
        <mateu-payment-picker
                ...
                slot="${e.slot??l}"
        ></mateu-payment-picker>
    `};var md=Object.defineProperty,hd=Object.getOwnPropertyDescriptor,_s=(e,t,r,a)=>{for(var s=a>1?void 0:a?hd(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&md(t,r,s),s};let Ur=class extends C{constructor(){super(...arguments),this.items=[]}runAction(e){e.actionId&&this.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:e.actionId,parameters:{}},bubbles:!0,composed:!0}))}render(){return i`
            <div class="list">
                ${this.items.map(e=>i`
                    <div class="row">
    ...
    `;_s([u({type:Array})],Ur.prototype,"items",2);Ur=_s([x("mateu-process-monitor")],Ur);const fd=e=>{const t=e.metadata;return i`
...
`)}
            ...
            </mateu-form>`},[m.Table]:({component:e,state:t,data:r})=>aa(e,(e.id?r?.[e.id]:void 0)?.page?.content??Pa(e,t)),[m.Crud]:O(oa),[m.App]:({container:e,component:t,baseUrl:r,state:a,data:s,appState:o,appData:n})=>i`
            <mateu-app
                        id="${t.id}"
                        baseUrl="${r}"
                        .component="${t}"
        ...
        `}get cols(){return this.effectiveComponent?.metadata?.columns?.map(t=>t.metadata)??[]}get identifierFieldName(){const e=this.cols.find(t=>t.identifier);return e?e.id:this.cols.find(t=>t.id==="id")?.id}get effectiveGridLayout(){const e=this.component?.metadata,t=e?.gridLayout??"auto";return t==="auto"?e?.crudlType==="card"?"cards":Cd(this.cols,this.availableWidthPx):t}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{const t=e[0]?.contentRect.width;t&&Math.abs(t-this.availableWidthPx)>10&&(this.availableWidthPx=t)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect()}_filterIds(e){return new Set(["searchText",...(e.filters??[]).flatMap(t=>t.stereotype==="dateRange"||t.stereotype==="numberRange"?[`${t.fieldId}_from`,`${t.fieldId}_to`]:[t.fieldId])])}_syncStateToUrl(e){const t=this._filterIds(e),r=new URLSearchParams(window.location.search);t.forEach(d=>r.delete(d)),r.delete("page"),r.delete("sort"),t.forEach(d=>{const c=this.state[d];c!=null&&c!==""&&r.set(d,String(c))});const a=this.state.page;a&&a>0&&r.set("page",String(a));const s=this.state.sort;if(s&&s.length>0){const d=s.filter(c=>c.fieldId&&c.direction).map(c=>`${c.fieldId}:${c.direction}`).join(",");d&&r.set("sort",d)}const o=r.toString(),n=o?`${window.location.pathname}?${o}`:window.location.pathname;window.location.pathname+window.location.search!==n&&history.replaceState(null,"",n)}_initStateFromUrl(e,t){const r=new URLSearchParams(window.location.search),a=this._filterIds(e),s={...t};r.forEach((d,c)=>{a.has(c)&&(s[c]=d)});const o=r.get("page");if(o!==null){const d=parseInt(o,10);!isNaN(d)&&d>0&&(s.page=d)}const n=r.get("sort");if(n){const d=n.split(",").map(c=>{const[p,h]=c.split(":");return p&&h?{fieldId:p,direction:h}:null}).filter(Boolean);d.length>0&&(s.sort=d)}return s}pageChanged(e){this.state={...this.state,page:e.detail.page},this.handleSearchRequested(void 0)}updated(e){if(super.updated(e),e.has("component")){const t=this.component?.id;if(t!==this._initializedForComponentId){this._initializedForComponentId=t;const r=this.component?.metadata,a=r.initialPage&&r.initialPage>0?r.initialPage:0;this.state=this._initStateFromUrl(r,{...this.state,size:r.pageSize,page:a,sort:[]}),(this.state.page!==a||this.state.sort?.length>0||[...this._filterIds(r)].some(o=>this.state[o]!=null))&&this.handleSearchRequested(void 0)}}}render(){const e=k=>{const z=[];return k.color&&k.color!==Is.normal&&z.push(k.color),k.buttonStyle&&z.push(k.buttonStyle===Ps.tertiaryInline?"tertiary-inline":k.buttonStyle),z.length?z.join(" "):void 0},t=k=>k==="back"||k==="backToList"||!!k&&k.startsWith("cancel"),r=k=>{const z=j.get()?.renderToolbarButton?.(k,this.evalLabel(k.label),()=>this.handleToolbarButtonClick(k.actionId));return z||i`
            ...
            `};if(!this.component)return i`no component`;const a=this.effectiveComponent,s=a.metadata;s.serverSideOrdering=!0;const o=s?.toolbar??[],n=o.filter(k=>t(k.actionId)),d=o.filter(k=>!t(k.actionId)),c=n.length>0&&d.length>0,p=!!s?.title||!!s?.subtitle||o.length>0,h=this.effectiveGridLayout,f=this.cols,v=Os(f),_=this.data[this.id]?.page?.content??[],g=this.state[this.component?.id]?.emptyStateMessage,I=(k,z)=>{const E=z[k.id];if(E==null)return i``;if(k.dataType==="status"){const T=Ss(E.type);return i`<span theme="badge pill ${T}">${E.message}</span>`}return k.dataType==="bool"?i`${E?"✓":"✗"}`:typeof E=="object"?i`${E.label??E.name??E.message??""}`:i`${E}`},U=()=>{const k=this.identifierFieldName,z=this.state._selectedId??this.appState?._splitDetailId,E=v.find(P=>P.identifier)??v[0],T=P=>P.dataType==="action"||P.dataType==="actionGroup"||P.dataType==="menu"||P.stereotype==="button",Pe=v.filter(P=>P!==E&&!T(P)),Rt=f.filter(P=>T(P)),tt=(P,A,N)=>{P.stopPropagation(),P.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:A,parameters:{_clickedRow:N}},bubbles:!0,composed:!0}))},bt=P=>{const A=[];for(const N of Rt){const F=P[N.id];if(N.dataType==="action"){const Oe=F?.methodNameInCrud?F:P.action?.methodNameInCrud?P.action:{methodNameInCrud:N.id,label:N.label,icon:null};A.push(i`
                ...
                <div class="m-listbox" style="width: 100%;">
                    ...
                    `)}
                </div>`},ue=(k,z,E)=>{const T=this.identifierFieldName;T&&E[T]!==void 0&&(this.state={...this.state,_selectedId:String(E[T])}),k.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:z,parameters:E},bubbles:!0,composed:!0}))},Q=()=>{const k=this.identifierFieldName,z=this.state._selectedId??this.appState?._splitDetailId,E=f.slice(0,6),T=E.filter(S=>S.stereotype==="image"),Pe=E.find(S=>S.identifier)??E[0],Rt=S=>!!S.actionId,tt=S=>S.dataType==="action"||S.dataType==="actionGroup"||S.dataType==="menu"||S.stereotype==="button",bt=E.find(S=>S.id==="select"&&S.dataType==="action"),P=!!bt,A=E.filter(S=>S!==Pe&&!T.includes(S)&&!Rt(S)&&!tt(S)),N=E.filter(S=>tt(S)&&!(P&&S===bt)),F=(S,ee,rt)=>{S.stopPropagation(),S.currentTarget.dispatchEvent(new CustomEvent("action-requested",{detail:{actionId:ee,parameters:{_clickedRow:rt}},bubbles:!0,composed:!0}))},Oe=S=>{const ee=[];for(const rt of N){const Qr=S[rt.id];if(rt.dataType==="action"){const Ut=Qr?.methodNameInCrud?Qr:S.action?.methodNameInCrud?S.action:{methodNameInCrud:rt.id,label:rt.label,icon:null};ee.push(i`
                            <button class="crud-btn" theme="tertiary" title="${Ut.label||l}"
                                @click="${gt=>F(gt,"action-on-row-"+Ut.methodNameInCrud,S)}">
                                ${Ut.icon?H(Ut.icon):l}
                                ${Ut.label??l}
                            </button>`)}else(rt.dataType==="actionGroup"||rt.dataType==="menu")&&(Qr?.actions??[]).forEach(gt=>ee.push(i`
...
`,Xt=e=>K`
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
         stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${e}</svg>`,Rs=Xt(K`
...
`,We=!0)}We&&this.updateMessage(o,n)}n||this.updateMessage(o,"⚠️ El agente no devolvió ninguna respuesta. Comprueba que el LLM está configurado correctamente (API key).")}catch(d){console.error("Error en el flujo SSE:",d);const c=d?.message??String(d);(c==="Failed to fetch"||c==="network error"||c==="Load failed")&&!n?this.updateMessage(o,"⚠️ No se recibió respuesta del agente. El servidor cerró la conexión sin enviar datos — comprueba que el LLM tiene la API key configurada y está disponible."):this.updateMessage(o,"⚠️ Error: "+c)}finally{this.stopLoading(),setTimeout(()=>{this.messageInputElement&&(this.messageInputElement.value="")},250),this.messageInputElement?.removeAttribute("disabled"),this.messageInputElement?.focus()}},this.closeChat=()=>{this.dispatchEvent(new CustomEvent("close-requested",{bubbles:!0,composed:!0}))},this.submitFromInput=()=>{const e=this.messageInputElement?.value?.trim()??"";e&&this.send(new CustomEvent("submit",{detail:{value:e},bubbles:!0,composed:!0}))},this.onInputKeydown=e=>{e.key==="Enter"&&(e.preventDefault(),this.submitFromInput())}}connectedCallback(){super.connectedCallback(),this.probeLocalAgent();const e=window.SpeechRecognition||window.webkitSpeechRecognition;if(e){const t=new e;this.recognition=t,t.lang="es-ES",t.onend=()=>{setTimeout(()=>{if(this.listening&&this.recognition)try{this.recognition.start()}catch{}},250)},this.recognitionAvailable=!0,t.onresult=this.onSpeechResult,t.onerror=r=>{console.error("Error de reconocimiento: "+r.error),this.listening&&this.recognition&&setTimeout(()=>{this.recognition.start()},250)}}}scrollBottom(){setTimeout(()=>{this.scrollContainer&&this.scrollContainer.scrollTo({top:this.scrollContainer.scrollHeight,behavior:"smooth"})},0)}addMessage(e,t){const r={text:e,time:new Date().toLocaleTimeString(),userName:t.includes("agent")?"Asistente":"Tú",userColorIndex:t.includes("agent")?2:1};return this.items=[...this.items,r],this.scrollBottom(),this.items.length-1}updateMessage(e,t){this.items=this.items.map((r,a)=>a===e?{...r,text:t}:r),this.scrollBottom()}tryParseCustomEvent(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const r=JSON.parse(t);if(typeof r.event=="string")return{event:r.event,detail:r.detail??{}}}catch{}return null}tryParseTokenUsage(e){const t=e.trim();if(!t.startsWith("{"))return null;try{const r=JSON.parse(t);if("inputTokens"in r||"outputTokens"in r||"totalTokens"in r)return r}catch{}return null}buildMenuContext(e,t=[]){const r=[];for(const a of e){if(a.separator||a.remote)continue;const s=[...t,a.label];if(a.submenus&&a.submenus.length>0)r.push(...this.buildMenuContext(a.submenus,s));else{const o={path:s,navigation:{route:a.route,consumedRoute:a.consumedRoute,actionId:a.actionId??"",baseUrl:a.baseUrl,serverSideType:a.serverSideType,uriPrefix:a.uriPrefix}};a.description&&(o.description=a.description),r.push(o)}}return r}startLoading(){this.loading=!0,this.elapsedSeconds=0,this._elapsedTimer=setInterval(()=>{this.elapsedSeconds++},1e3)}stopLoading(){this.loading=!1,clearInterval(this._elapsedTimer),this._elapsedTimer=void 0}render(){return i`
  ...
  `;gr([u()],Et.prototype,"type",2);gr([u()],Et.prototype,"data",2);gr([u()],Et.prototype,"options",2);gr([Ie("#chart")],Et.prototype,"chartElement",2);Et=gr([x("mateu-chart")],Et);var oc=Object.defineProperty,ic=Object.getOwnPropertyDescriptor,xa=(e,t,r,a)=>{for(var s=a>1?void 0:a?ic(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&oc(t,r,s),s};let ur=class extends C{updated(e){super.updated(e),this.chart&&(this.chart.destroy(),this.chart=void 0),this.xml&&this.createViewer(this.xml)}async createViewer(e){const{default:t}=await xe(async()=>{const{default:a}=await import("./vendor-diagrams.js");return{default:a}},__vite__mapDeps([2,0,1]));if(e!==this.xml)return;this.chart&&this.chart.destroy();const r={container:this.divElement};this.chart=new t(r),this.chart.importXML(e)}handleSlotChange(){}render(){return i`
       ...
       `}};ur.styles=$`
  `;xa([u()],ur.prototype,"xml",2);xa([Ie("#canvas")],ur.prototype,"divElement",2);ur=xa([x("mateu-bpmn")],ur);var nc=Object.defineProperty,lc=Object.getOwnPropertyDescriptor,Qt=(e,t,r,a)=>{for(var s=a>1?void 0:a?lc(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&nc(t,r,s),s};const ta=160,ze=56,dc=220,Ra=110,st=60,cc={ACTION:"#3B82F6",JOIN:"#8B5CF6",FORK:"#F59E0B",END:"#EF4444",USER_TASK:"#10B981",PROCESS:"#6366F1"},uc={ACTION:"▶",JOIN:"⟨",FORK:"⟩",END:"◼",USER_TASK:"👤",PROCESS:"⚙"},pc=["ACTION","JOIN","FORK","END","USER_TASK","PROCESS"];function mc(){return"step-"+Math.random().toString(36).slice(2,8)}let ct=class extends C{constructor(){super(...arguments),this.value='{"name":"New Workflow","steps":[]}',this.wf={name:"New Workflow",steps:[]},this.positions={},this.selectedId=null,this.showMeta=!1,this.draggingId=null,this.dragOffset={x:0,y:0},this.svgEl=null,this.onMouseMove=e=>{if(!this.draggingId||!this.svgEl)return;const t=this.toSvgPoint(e);this.positions={...this.positions,[this.draggingId]:{x:Math.max(0,t.x-this.dragOffset.x),y:Math.max(0,t.y-this.dragOffset.y)}}},this.onMouseUp=()=>{this.draggingId=null,window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}}updated(e){if(e.has("value")){try{this.wf=JSON.parse(this.value)}catch{}this.autoLayout()}}autoLayout(){const e=this.wf.steps??[],t={};e.forEach(n=>{t[n.id]=0});let r=!0;for(;r;)r=!1,e.forEach(n=>{if(n.preconditionStepId!=null&&t[n.preconditionStepId]!==void 0){const d=t[n.preconditionStepId]+1;d>t[n.id]&&(t[n.id]=d,r=!0)}});const a={};e.forEach(n=>{const d=t[n.id]??0;(a[d]??=[]).push(n.id)});const s={...this.positions};let o=!1;Object.entries(a).forEach(([n,d])=>{const c=Number(n);d.forEach((p,h)=>{s[p]||(s[p]={x:st+c*dc,y:st+h*Ra},o=!0)})}),o&&(this.positions=s)}emit(){const e=JSON.stringify(this.wf,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateWf(e){this.wf={...this.wf,...e},this.emit()}updateStep(e,t){this.wf={...this.wf,steps:this.wf.steps.map(r=>r.id===e?{...r,...t}:r)},this.emit()}addStep(){const e=mc(),t={id:e,type:"ACTION",name:"New Step"};this.wf={...this.wf,steps:[...this.wf.steps??[],t]};const r=Object.values(this.positions).map(s=>s.y),a=r.length?Math.max(...r)+Ra:st;this.positions={...this.positions,[e]:{x:st,y:a}},this.selectedId=e,this.emit()}deleteStep(e){this.wf={...this.wf,steps:this.wf.steps.filter(a=>a.id!==e).map(a=>a.preconditionStepId===e?{...a,preconditionStepId:void 0}:a)};const{[e]:t,...r}=this.positions;this.positions=r,this.selectedId===e&&(this.selectedId=null),this.emit()}onNodeMouseDown(e,t){e.preventDefault(),this.draggingId=t;const r=this.positions[t]??{x:0,y:0},a=this.toSvgPoint(e);this.dragOffset={x:a.x-r.x,y:a.y-r.y},this.svgEl=e.currentTarget.closest("svg"),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp)}toSvgPoint(e){if(!this.svgEl)return{x:0,y:0};const t=this.svgEl.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}canvasSize(){const e=Object.values(this.positions),t=e.length?Math.max(...e.map(a=>a.x))+ta+st:600,r=e.length?Math.max(...e.map(a=>a.y))+ze+st:400;return{w:Math.max(t,600),h:Math.max(r,400)}}render(){const{w:e,h:t}=this.canvasSize(),r=this.wf.steps??[];return i`
            <div class="root">
                ${this.renderToolbar()}
        ...
        `}renderArrow(e){if(!e.preconditionStepId)return K``;const t=this.positions[e.preconditionStepId],r=this.positions[e.id];if(!t||!r)return K``;const a=t.x+ta,s=t.y+ze/2,o=r.x,n=r.y+ze/2,d=(a+o)/2;return K`
        ...
        `}exportJson(){const e=JSON.stringify(this.wf,null,2),t=new Blob([e],{type:"application/json"}),r=URL.createObjectURL(t),a=document.createElement("a");a.href=r,a.download=(this.wf.name??"workflow").replace(/\s+/g,"-").toLowerCase()+".json",a.click(),URL.revokeObjectURL(r)}};ct.styles=[$a,$`
    ...
    `];Qt([u()],ct.prototype,"value",2);Qt([b()],ct.prototype,"wf",2);Qt([b()],ct.prototype,"positions",2);Qt([b()],ct.prototype,"selectedId",2);Qt([b()],ct.prototype,"showMeta",2);ct=Qt([x("mateu-workflow")],ct);var hc=Object.defineProperty,fc=Object.getOwnPropertyDescriptor,yr=(e,t,r,a)=>{for(var s=a>1?void 0:a?fc(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&hc(t,r,s),s};const vc=["string","integer","number","bool","date","time","dateTime","dateRange","money","file","array","status","component","menu","range","action","actionGroup"],bc=["regular","radio","checkbox","textarea","toggle","combobox","select","email","password","richText","listBox","html","markdown","image","icon","link","money","grid","color","choice","popover","slider","button","stars"],gc={string:"#3B82F6",integer:"#8B5CF6",number:"#6366F1",bool:"#10B981",date:"#F59E0B",time:"#F59E0B",dateTime:"#F59E0B",dateRange:"#F59E0B",money:"#EF4444",file:"#64748B",array:"#0EA5E9",status:"#EC4899",component:"#14B8A6",menu:"#94A3B8",range:"#A855F7",action:"#F97316",actionGroup:"#FB923C"};function Ua(){return"field-"+Math.random().toString(36).slice(2,8)}let It=class extends C{constructor(){super(...arguments),this.value='{"name":"New Form","fields":[]}',this.form={name:"New Form",fields:[]},this.selectedId=null,this.showMeta=!1,this.sortable=null,this.listEl=null}updated(e){if(e.has("value"))try{this.form=JSON.parse(this.value)}catch{}this.attachSortable()}disconnectedCallback(){super.disconnectedCallback(),this.sortable?.destroy(),this.sortable=null}attachSortable(){const e=this.shadowRoot?.querySelector(".field-list");!e||e===this.listEl||(this.listEl=e,this.sortable?.destroy(),this.sortable=Js.create(e,{animation:150,handle:".drag-handle",ghostClass:"sortable-ghost",onEnd:t=>{const{oldIndex:r,newIndex:a}=t;if(r===void 0||a===void 0||r===a)return;const s=[...this.form.fields],[o]=s.splice(r,1);s.splice(a,0,o),this.form={...this.form,fields:s},this.emit()}}))}emit(){const e=JSON.stringify(this.form,null,2);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}updateForm(e){this.form={...this.form,...e},this.emit()}updateField(e,t){this.form={...this.form,fields:this.form.fields.map(r=>r.id===e?{...r,...t}:r)},this.emit()}addField(){const e=Ua(),t={id:e,label:"New Field",dataType:"string"};this.form={...this.form,fields:[...this.form.fields,t]},this.selectedId=e,this.emit()}deleteField(e){this.form={...this.form,fields:this.form.fields.filter(t=>t.id!==e)},this.selectedId===e&&(this.selectedId=null),this.emit()}duplicateField(e){const t=this.form.fields.find(o=>o.id===e);if(!t)return;const r={...t,id:Ua(),label:t.label+" (copy)"},a=this.form.fields.findIndex(o=>o.id===e),s=[...this.form.fields];s.splice(a+1,0,r),this.form={...this.form,fields:s},this.selectedId=r.id,this.emit()}render(){return i`
        ...
        `}exportJson(){const e=JSON.stringify(this.form,null,2),t=new Blob([e],{type:"application/json"}),r=URL.createObjectURL(t),a=document.createElement("a");a.href=r,a.download=(this.form.name??"form").replace(/\s+/g,"-").toLowerCase()+".json",a.click(),URL.revokeObjectURL(r)}};It.styles=[$a,$`
        :host { display: block; height: 100%; font-family: var(--lumo-font-family, sans-serif); }
...
`);St({text:a,variant:"error",position:"bottomEnd",duration:Math.max(3e3,1500+r.length*1e3)},this)},this.notify=e=>{St({text:e,variant:"error",position:"bottomEnd",duration:3e3},this)},this.callAfterConfirmation=(e,t)=>{let r="One moment, please",a="Are you sure?",s="Yes",o="No";e.confirmationTexts&&(r=e.confirmationTexts.title,a=e.confirmationTexts.message,s=e.confirmationTexts.confirmationText,o=e.confirmationTexts.denialText);const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;z-index:1100;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.35);padding:1rem;";const d=document.createElement("div");d.style.cssText="background:var(--lumo-base-color,#fff);color:var(--lumo-body-text-color,#1a1a1a);border-radius:var(--lumo-border-radius-l,12px);box-shadow:var(--lumo-box-shadow-xl,0 12px 40px rgba(0,0,0,.3));padding:1.2rem;max-width:min(90vw,26rem);";const c=()=>{n.parentElement&&document.body.removeChild(n)},p="font:inherit;font-weight:600;padding:.45rem 1rem;border-radius:var(--lumo-border-radius-m,6px);cursor:pointer;";Qs(i`
        ...
        `,d),n.appendChild(d),n.addEventListener("click",h=>{h.target===n&&c()}),document.body.appendChild(n)},this.requestActionCallToServerOrBubble=(e,t,r)=>{if(r&&r.bubble){const a={...e.parameters};a.initiatorState||(a.initiatorState=this.state),this.dispatchEvent(new CustomEvent("action-requested",{detail:{...e,parameters:a},bubbles:!0,composed:!0}))}else this.requestActionCallToServer(e,t,r)},this.requestActionCallToServer=(e,t,r)=>{if(r&&r.href){window.location.href=r.href;return}if(r&&r.js)try{new Function("state","data","appState","appData","component",r.js).call(this,this.state??{},this.data??{},this.appState??{},this.appData??{},this.component),this.state={...this.state},this.data={...this.data}}catch(a){console.error("when evaluating "+r.js,a,this.component,this.state,this.data)}if(r&&r.customEvent&&this.dispatchEvent(new CustomEvent(r.customEvent.name,{detail:r.customEvent.detail,bubbles:!0,composed:!0})),!(r&&(r.js||r.customEvent))){if(e.actionId=="search"){const a=e.parameters?._searchState;a?this.state={...this.state,...a}:this.state.size||(this.state={...this.state,size:10,page:0,sort:[]})}this.dispatchEvent(new CustomEvent("server-side-action-requested",{detail:{route:this.route,consumedRoute:this.consumedRoute,componentState:{...this.state},parameters:e.parameters??{},actionId:e.actionId,serverSideType:t.serverSideType,serverSideComponentRoute:t.route,initiatorComponentId:e.initiatorComponentId??t.id,initiator:this,background:r?.background,sse:r?.sse,callback:e.callback,callbackonly:e.callbackonly,callbackToken:e.callbackToken??this.callbackToken},bubbles:!0,composed:!0}))}},this.handleBackendSucceeded=e=>{e.detail.actionId&&this.component.triggers?.filter(a=>a.type==ot.OnSuccess).filter(a=>e.detail.actionId==a.calledActionId).forEach(a=>{if(!a.condition||this._evalExpr(a.condition))if(e.preventDefault(),e.stopPropagation(),a.timeoutMillis>0){const s=this.callbackToken;setTimeout(()=>{this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.actionId,callbackToken:s},bubbles:!0,composed:!0}))},a.timeoutMillis)}else this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.actionId},bubbles:!0,composed:!0}))})},this.handleBackendFailed=e=>{e.detail.actionId&&this.component.triggers?.filter(a=>a.type==ot.OnError).filter(a=>e.detail.actionId==a.calledActionId).forEach(a=>{(!a.condition||this._evalExpr(a.condition))&&(e.preventDefault(),e.stopPropagation(),this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:a.actionId},bubbles:!0,composed:!0})))})},this._keydownListener=e=>{if(this._handleTabShortcut(e))return;const t=this.component;if(t)for(const r of t.actions??[]){const a=r.shortcut||(r.runOnEnter?"enter":null);if(a&&this._shortcutMatchesEvent(a,e)){e.preventDefault(),this.manageActionRequestedEvent(new CustomEvent("action-requested",{detail:{actionId:r.id},bubbles:!0,composed:!0}));return}}}}createRenderRoot(){return j.mustUseShadowRoot()?super.createRenderRoot():this}updated(e){super.updated(e),e.has("state")&&this.state&&JSON.stringify(this.state)!=JSON.stringify({})&&this.onChange(),e.has("component")&&(this.formerState={...this.state},this.component?.confirmOnNavigationIfDirty&&this.dispatchEvent(new CustomEvent("clean",{detail:{},bubbles:!0,composed:!0})),setTimeout(()=>this.triggerOnLoad()))}_shortcutMatchesEvent(e,t){return Si(e,t)}_collectShortcutTabs(){const e=this.renderRoot;if(!e)return[];const t=Array.from(e.querySelectorAll("vaadin-tab[data-shortcut]"));return e.querySelectorAll("mateu-drawer, mateu-dialog").forEach(r=>{const a=r.shadowRoot;a&&t.push(...Array.from(a.querySelectorAll("vaadin-tab[data-shortcut]")))}),t}_handleTabShortcut(e){const t=this._collectShortcutTabs();if(t.length===0)return!1;for(const r of Array.from(t)){const a=r.dataset.shortcut;if(!a||!this._shortcutMatchesEvent(a,e))continue;const s=r.closest("vaadin-tabs");if(!s)continue;const o=Array.from(s.querySelectorAll("vaadin-tab")).indexOf(r);if(!(o<0))return e.preventDefault(),s.selected=o,!0}return!1}connectedCallback(){super.connectedCallback(),this.addEventListener("backend-call-succeeded",this.handleBackendSucceeded),this.addEventListener("backend-call-failed",this.handleBackendFailed),document.addEventListener("keydown",this._keydownListener)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("backend-call-succeeded",this.handleBackendSucceeded),this.removeEventListener("backend-call-failed",this.handleBackendFailed),document.removeEventListener("keydown",this._keydownListener)}render(){return i`<div>
            ...
            `:l}</div>`}_render(){if(this.component?.type==Y.ClientSide){const e=this.component;return e.metadata?.type==m.Page?sa(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):e.metadata?.type==m.Crud?oa(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!0):j.get()?.renderClientSideComponent(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData,!1)}return i`
            <mateu-api-caller 
            ...
            ${this.component?.children?.map(e=>{if(e.type==Y.ClientSide){const t=e;if(t.metadata?.type==m.Page)return sa(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0);if(t.metadata?.type==m.Crud)return oa(this,t,this.baseUrl,this.state,this.data,this.appState,this.appData,!0)}return w(this,e,this.baseUrl,this.state,this.data,this.appState,this.appData)})}
            </mateu-api-caller>
        `}};qt.styles=$`
        :host {
        }
...
`);Q=W.pop()??"";for(const le of W){const Z=le.trim();if(Z)if(Z.startsWith("data:")){const pe=JSON.parse(Z.substring(5).trim());y&&y(pe),_||this.handleUIIncrement(pe,f,g),pe.messages&&pe.messages.length==1&&pe.messages[0].variant=="error"&&f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:o},bubbles:!0,composed:!0}))}else{let pe=Z;try{const et=JSON.parse(Z);pe=et.message,et._embedded?.errors?.length>0&&et._embedded.errors[0].message&&(pe=et._embedded.errors[0].message)}catch{}throw new Error(pe)}}}}v||f.dispatchEvent(new CustomEvent("backend-succeeded-event",{bubbles:!0,composed:!0,detail:{actionId:o}})),f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-succeeded",{detail:{actionId:o},bubbles:!0,composed:!0}))}).catch(U=>{f.dispatchEvent(new CustomEvent("backend-failed-event",{bubbles:!0,composed:!0,detail:{actionId:o,reason:this.serialize(U)}})),f.shadowRoot?.dispatchEvent(new CustomEvent("backend-call-failed",{detail:{actionId:o},bubbles:!0,composed:!0}))})}}serialize(t){return t?.message?t:JSON.stringify(t)}}const Fs=new Ic,Pc={fixed:"fixed",fullWidth:"full",edgeToEdge:"edge"},Oc=new Set([m.Gantt,m.PlanningBoard,m.Kanban,m.Bpmn,m.Workflow,m.Map]),Tc={landing:"fixed",form:"fixed",process:"fixed"},Bs=e=>e?Pc[e]:void 0,Pt=e=>e.type==Y.ClientSide?e.metadata:void 0,qs=e=>{const t=Pt(e);if(t?.type==m.Page){const r=Bs(t.pageWidth);if(r)return r}for(const r of e.children??[]){const a=qs(r);if(a)return a}},Hs=e=>{const t=e.pageType;if(t)return t;const r=a=>{const s=Pt(a);if(s?.type==m.Page&&s.pageType)return s.pageType;for(const o of a.children??[]){const n=r(o);if(n)return n}};return r(e)},zc=e=>{const t=Pt(e);if(t?.type!=m.Crud)return!1;const r=t;return r.compact?!0:(r.columns??[]).some(a=>a.metadata?.editable)},Fr=(e,t)=>t(e)||(e.children??[]).some(r=>Fr(r,t)),Ac=e=>!!e&&Fr(e,t=>Pt(t)?.type==m.HeroSection),Lc=e=>Pt(e)?.type==m.App?!0:(e.children??[]).some(t=>Pt(t)?.type==m.App),Dc=(e,t)=>{if(!e)return"fixed";const r=Bs(e.pageWidth)??qs(e);if(r)return r;if(t?.top&&Lc(e))return"edge";const a=Tc[Hs(e)??""];return a||(Fr(e,s=>{const o=Pt(s)?.type;return o!=null&&Oc.has(o)})?"edge":Fr(e,zc)?"full":"fixed")};var Rc=Object.defineProperty,Uc=Object.getOwnPropertyDescriptor,ce=(e,t,r,a)=>{for(var s=a>1?void 0:a?Uc(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Rc(t,r,s),s};let X=class extends Hr{constructor(){super(...arguments),this.consumedRoute="",this.serverSideType=void 0,this.uriPrefix=void 0,this.overrides=void 0,this.homeRoute=void 0,this.route=void 0,this.top=void 0,this.appState={},this.appData={},this.preventNavigation=!1,this.overridesParsed={},this.fragment=void 0,this.actionRequestedListener=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.manageActionEvent(e))},this.historyPushed=e=>{e instanceof CustomEvent&&(e.preventDefault(),e.stopPropagation(),this.preventNavigation=!0,this.route=e.detail.route)},this.routeChangedListener=e=>{if(e instanceof CustomEvent){e.preventDefault(),e.stopPropagation();let t=e.detail.route;typeof t=="string"&&(t===""||t.startsWith("/"))&&this.consumedRoute&&this.consumedRoute!=="_empty"&&this.consumedRoute.startsWith("/")&&!t.startsWith(this.consumedRoute)&&(t=this.consumedRoute+t),this.uriPrefix&&(t.startsWith("/")&&this.uriPrefix.endsWith("/")?t=this.uriPrefix+t.substring(1):!t.startsWith("/")&&!this.uriPrefix.endsWith("/")?t=this.uriPrefix+"/"+t:t=this.uriPrefix+t),this.dispatchEvent(new CustomEvent("url-update-requested",{detail:{route:t},bubbles:!0,composed:!0}))}},this.backendFailedListener=e=>{e.preventDefault(),e.stopPropagation(),e instanceof CustomEvent&&e.detail.actionId==""&&(this.fragment={targetComponentId:this.id,data:{},state:{},component:{type:Y.ClientSide,metadata:{type:m.Element,name:"div",content:"Not found"},id:"fieldId"},action:ar.Replace,containerId:void 0})},this.detail1=void 0,this.manageActionEvent=e=>{e.preventDefault(),e.stopPropagation(),this.detail1=e.detail;const t=this.detail1;if(e.type=="server-side-action-requested"){let r=Ec;t.sse&&(r=Fs),r.runAction(Tt,this.baseUrl,t.route??"",t.consumedRoute,t.actionId,t.initiatorComponentId,this.getCustomisedAppState(),t.serverSideType,t.componentState,t.parameters,t.initiator,t.background,t.callback,t.callbackonly,t.callbackToken)}},this.getCustomisedAppState=()=>{let e={...G.value};if(this.overrides){const t=ja(this.overrides);e={...e,...t}}return e}}manageActionRequestedEvent(e){throw new Error("Method not implemented.")}createRenderRoot(){return j.mustUseShadowRoot()?super.createRenderRoot():this}connectedCallback(){super.connectedCallback(),this.overridesParsed=ja(this.overrides),this.addEventListener("server-side-action-requested",this.actionRequestedListener),this.addEventListener("backend-call-failed",this.backendFailedListener),this.addEventListener("history-pushed",this.historyPushed),this.addEventListener("route-changed",this.routeChangedListener)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("server-side-action-requested",this.actionRequestedListener),this.removeEventListener("backend-call-failed",this.backendFailedListener),this.removeEventListener("history-pushed",this.historyPushed),this.removeEventListener("route-changed",this.routeChangedListener)}shouldUpdate(e){if(this.fragment?.component&&[...e.keys()].every(r=>r==="appState"||r==="appData")){const r=this.renderRoot.querySelector("mateu-component");if(r)return e.has("appState")&&(r.appState=this.appState),e.has("appData")&&(r.appData=this.appData),!1}return!0}updated(e){(e.has("id")||e.has("baseurl")||e.has("route")||e.has("consumedRoute")||e.has("instant"))&&(this.preventNavigation||(this.callbackToken=this.instant||ke(),this.manageActionEvent(new CustomEvent("server-side-action-requested",{detail:{route:this.route,consumedRoute:this.consumedRoute,userData:void 0,actionId:"",serverSideType:this.serverSideType,initiatorComponentId:this.id,initiator:this,componentState:this.initialState,callbackToken:this.callbackToken},bubbles:!0,composed:!0})))),e.has("route")&&this.top&&(this.preventNavigation||this.dispatchEvent(new CustomEvent("route-changed",{detail:{route:this.route},bubbles:!0,composed:!0}))),this.preventNavigation&&(this.preventNavigation=!1)}applyFragment(e){if(!e.component&&this.fragment?.component){this.fragment={...this.fragment,state:{...this.fragment.state??{},...e.state??{}},data:{...this.fragment.data??{},...e.data??{}}};return}this.fragment=e,e.component&&(this.dataset.pageWidth=Dc(e.component,{top:this.top}),this.dataset.pageType=Hs(e.component)??"",this.dataset.hasWelcomeBanner=String(Ac(e.component)))}render(){return i`
  ...
  `;Ze([u()],Se.prototype,"baseUrl",2);Ze([u()],Se.prototype,"route",2);Ze([u()],Se.prototype,"consumedRoute",2);Ze([u()],Se.prototype,"config",2);Ze([u()],Se.prototype,"top",2);Ze([u()],Se.prototype,"pathPrefix",2);Ze([b()],Se.prototype,"instant",2);Ze([u({type:Boolean})],Se.prototype,"debug",2);Se=Ze([x("mateu-ui")],Se);var Hc=Object.defineProperty,Vc=Object.getOwnPropertyDescriptor,Dt=(e,t,r,a)=>{for(var s=a>1?void 0:a?Vc(t,r):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(a?n(t,r,s):n(s))||s);return a&&s&&Hc(t,r,s),s};let Ee=class extends C{constructor(){super(...arguments),this.baseUrl="",this.opened=!1,this.searchText=""}connectedCallback(){super.connectedCallback(),co()}disconnectedCallback(){super.disconnectedCallback(),this.detachOutsideClick(),this.searchTimer&&clearTimeout(this.searchTimer)}currentValue(){return String(la()[this.selector.fieldName]??"")}currentLabel(){const e=this.currentValue();if(!e)return"—";const t=(this.searchedOptions??this.selector.options)?.find(a=>String(a.value)===e);if(t)return t.label;const r=Xa()[this.selector.fieldName];return r!==void 0?String(r):e}pick(e,t){lo(this.selector.fieldName,e,t),window.location.reload()}detachOutsideClick(){this.outsideClick&&(document.removeEventListener("mousedown",this.outsideClick),this.outsideClick=void 0)}openPanel(){this.opened||(this.opened=!0,this.searchText="",this.searchedOptions=void 0,this.remoteSearch(),this.outsideClick=e=>{e.composedPath().includes(this)||this.closePanel()},document.addEventListener("mousedown",this.outsideClick),this.updateComplete.then(()=>this.renderRoot.querySelector("input.picker-search")?.focus()))}closePanel(){this.detachOutsideClick(),this.opened=!1}onSearchInput(e){this.searchText=e.target.value,this.searchTimer&&clearTimeout(this.searchTimer),this.searchTimer=setTimeout(()=>this.remoteSearch(),300)}async remoteSearch(){const e=this.app;if(e?.serverSideType)try{const t=await Tt.runAction(this.baseUrl??"",e.rootRoute??e.initialRoute??"","",`_appcontext-search-${this.selector.fieldName}`,`appcontext-${this.selector.fieldName}`,void 0,e.serverSideType,{},{searchText:this.searchText},this,!0);for(const r of t?.fragments??[]){const o=r.data?.[`_appcontext_${this.selector.fieldName}`]?.content;if(Array.isArray(o)){this.searchedOptions=o.map(n=>({value:n.value,label:n.label??String(n.value)}));return}}}catch{}}visibleOptions(){const e=this.searchedOptions??this.selector.options??[],t=this.searchText.trim().toLowerCase();return t?e.filter(r=>r.label.toLowerCase().includes(t)):e}renderPanel(){const e=this.currentValue(),t=this.visibleOptions(),r=this.searchText!==""||t.length>Ee.SEARCHABLE_THRESHOLD;return i`
    ...
    </nav>`,Ba=(e,t)=>r=>t.call(e,{detail:{value:r}}),kr=(e,t)=>e.themeToggle?i`
...
`:l}
    ...
    `}};wa([u({attribute:!1})],Br.prototype,"menu",2);wa([b()],Br.prototype,"open",2);Br=wa([x("mateu-spectra-nav")],Br);function iu(e){const t=window.__mateuArrayDataProvider;return t?new t(e.map(r=>({value:r.value,label:r.label})),{keyAttributes:"value"}):void 0}function nu(e,t,r,a,s,o,n,d){const c=t.metadata,p=a,h=p&&c.fieldId in p?p[c.fieldId]:c.initialValue,f=h==null?"":String(h),v=(U,ue)=>{U==null||String(U)===f||ue?.dispatchEvent(new CustomEvent("value-changed",{detail:{fieldId:c.fieldId,value:U},bubbles:!0,composed:!0}))},y=c.label||c.fieldId,_=d||!c.label?"none":"top",g=t.slot??l;return c.readOnly||c.stereotype==="plainText"?i`<div class="mateu-rw-field-plain" slot=${g}>${f}</div>`:c.options?.length?i`<oj-c-select-single
