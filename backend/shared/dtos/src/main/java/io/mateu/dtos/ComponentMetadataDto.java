...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = PlanningBoardDto.class, name = "PlanningBoard"),
  ...
  @JsonSubTypes.Type(value = BulletedListDto.class, name = "BulletedList"),
  @JsonSubTypes.Type(value = SeparatorDto.class, name = "Separator"),
  @JsonSubTypes.Type(value = CustomComponentDto.class, name = "CustomComponent"),
  @JsonSubTypes.Type(value = NoticeDto.class, name = "Notice"),
...
@Schema(
    oneOf = {
      ...
      ContentLayoutDto.class,
      HeroSectionDto.class,
      EmptyStateDto.class,
      SkeletonDto.class,
      GanttDto.class,
      PlanningBoardDto.class,
      KanbanDto.class,
      TimelineDto.class,
      ...
      StatusListDto.class,
      BulletedListDto.class,
      SeparatorDto.class,
      CustomComponentDto.class,
      NoticeDto.class,
      TaskQueueDto.class,
