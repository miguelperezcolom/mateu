...
import io.mateu.core.infra.declarative.orchestrators.crudorchestrator.actionhandlers.DeleteActionHandler;
...
class DeleteActionHandlerTest {
  ...
  private final DeleteActionHandler handler = new DeleteActionHandler();
