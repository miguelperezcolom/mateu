...
public abstract class CrudOrchestrator<
  ...
  private final List<CrudOrchestratorActionHandler> actionHandlers = List.of(
  ...
  public Class<?> viewClass() {
      return getGenericClass(this.getClass(), io.mateu.core.infra.declarative.orchestrators.crudorchestrator.CrudOrchestrator.class, "View");
  }
  ...
  public Class<Filters> filtersClass() {
      return getGenericClass(this.getClass(), io.mateu.core.infra.declarative.orchestrators.crudorchestrator.CrudOrchestrator.class, "Filters");
  }

  public Class<Row> rowClass() {
      return getGenericClass(this.getClass(), io.mateu.core.infra.declarative.orchestrators.crudorchestrator.CrudOrchestrator.class, "Row");
  }
  ...
  public abstract String getIdFieldForRow();
    ...
    public abstract Object search(String searchText, Object filters, Pageable pageable, HttpRequest httpRequest);
