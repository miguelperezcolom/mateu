...
import static io.mateu.core.infra.declarative.ExtendedGenericCrud.addData;
...
public class GenericForm implements
        TriggersSupplier,
        ActionSupplier,
        ...
        getAllMethods(getClass()).stream()
                ...
                .forEach(
                        method -> {
                            toolbar.add(
                                    new Button(
                                            toUpperCaseFirst(method.getName()), method.getName()));
                        });
        return toolbar;
    }
