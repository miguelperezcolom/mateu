...
class AutoNamedView<T extends Named> implements NamedView<T>, ModelSupplier {
...
public abstract class AutoCrudAdapter<T extends Named>
    implements CrudAdapter<
        NamedView<T>, NamedView<T>, NamedView<T>, T, T, String> {
  ...
  public NamedView<T> getCreationForm(HttpRequest httpRequest) {
    var instance = MateuBeanProvider.getBean(InstanceFactory.class)
