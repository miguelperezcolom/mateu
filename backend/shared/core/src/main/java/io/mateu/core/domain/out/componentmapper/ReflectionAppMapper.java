...
public class ReflectionAppMapper {
    ...
    private static Collection<? extends Component> getWidgets(Object instance,
                                                              String baseUrl,
                                                              String route,
                                                              String initiatorComponentId,
                                                              HttpRequest httpRequest) {
        ...
        return getAllFields(instance.getClass()).stream()
                ...
                .map(field -> mapToWidget(field, instance, baseUrl, route, initiatorComponentId, httpRequest))
                .filter(Objects::nonNull)
                .toList();
    }

    @SneakyThrows
    private static Component mapToWidget(Field field, Object instance,
                                         String baseUrl,
                                         String route,
                                         String initiatorComponentId,
                                         HttpRequest httpRequest) {
    ...
    private static Collection<? extends Actionable> getMenu(Object instance, HttpRequest httpRequest) {
    ...
    private static String getPageTitle(Object instance) {
        ...
        if (instance.getClass().isAnnotationPresent(MateuUI.class) || instance.getClass().isAnnotationPresent(Route.class)) {
