...
public class CreateViewWith2FromsHomeJourneyTest {
    ...
    private void assertStore(Map<String, Object> store, String journeyId) {
        assertNotNull(store);
        var viewJson = new String(getClass().getResourceAsStream("viewwith2forms-view.json").readAllBytes(),
                StandardCharsets.UTF_8);
        var json = new String(getClass().getResourceAsStream("viewwith2forms.json").readAllBytes(),
                StandardCharsets.UTF_8)
