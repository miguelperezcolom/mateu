...
public record ResponsiveGridMetadataDto(string? GridTemplateColumns, string? Gap, IReadOnlyList<int>? ColSpans = null, string? StackBelow = null, string? GridTemplateAreas = null) : ComponentMetadataDto;
