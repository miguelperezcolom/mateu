...
public class MDDLink extends Data {
    ...
    public MDDLink(Class entityClass, io.mateu.mdd.core.app.ActionType actionType, Data data) {
    ...
    public MDDLink(String caption, Class entityClass, io.mateu.mdd.core.app.ActionType actionType, Data data) {
        setCaption(caption);
        setEntityClassName(entityClass.getName());
        setViewClassName(entityClass.getName());
        setData(data);
    ...
    public MDDLink(Class entityClass, Class viewClass, Data data) {
        ...
        setData(data);
        setActionType(io.mateu.mdd.core.app.ActionType.OPENVIEW);
    }
    ...
    public io.mateu.mdd.core.app.ActionType getActionType() {
        switch(getString("_actiontype")) {
            case "openeditor": return io.mateu.mdd.core.app.ActionType.OPENEDITOR;
            case "openlist": return io.mateu.mdd.core.app.ActionType.OPENLIST;
            case "openview": return io.mateu.mdd.core.app.ActionType.OPENVIEW;
            default: return io.mateu.mdd.core.app.ActionType.OPENLIST;
        }
    }
