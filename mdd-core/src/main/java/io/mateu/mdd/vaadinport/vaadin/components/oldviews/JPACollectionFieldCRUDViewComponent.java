...
public class JPACollectionFieldCRUDViewComponent extends CRUDViewComponent {
    ...
    public JPACollectionFieldCRUDViewComponent(FieldInterfaced field, EditorViewComponent evfc, boolean addingToCollection) throws IllegalAccessException, InstantiationException {
